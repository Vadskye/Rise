...
\parhead{4th -- Timetheft} As a standard action, the spellwarped can attempt to steal time from an adjacent creature. If the target fails a Will save, it skips its next movement phase and the spellwarped regains a spellwarp point. A bloodied target skips its next action phase instead.
