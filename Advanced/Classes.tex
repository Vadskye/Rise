...
\subcf{7th -- Fuel the Flame} As a standard action, the spellwarped can draw power from a nonmagical fire within \rngmed range of him. If he does so, he gains temporary hit points equal to his spellwarped level for 5 minutes. The fire must be at least Medium size or larger -- a torch is insufficient. If the fire is Large size or smaller, the spellwarped extinguishes the fire when he uses this ability.
