...
\parhead{10th -- Rapid Acceleration} This power functions like the accelerate creature power, except that it costs two spellwarp points and can be used as a move action. If the spellwarped uses this power on himself, it only requires a swift action to activate.
