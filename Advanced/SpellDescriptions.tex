...
\spellschool{Transmutation (Augment)}
\spelllvl{Clr 4, Drd 4, Sor/Wiz 4}
\begin{spelleffect}
...
\spellsectioncomma{Totemic Mind}{Mass Greater}
\spellschool{Transmutation (Augment)}
\spelllvl{Clr 8, Drd 8, Sor/Wiz 8}
\begin{spelleffect}
    This spell functions like \spell{greater totemic mind}, except that it affects multiple creatures. Each affected creature must have the same attribute or attributes increased.
\end{spelleffect}
...
\spellschool{Transmutation (Augment)}
\spelllvl{Clr 4, Drd 4, Sor/Wiz 4, Strength 4}
\begin{spelleffect}
...
\spellsectioncomma{Totemic Power}{Mass Greater}
\spellschool{Transmutation (Augment)}
\spelllvl{Clr 8, Drd 8, Sor/Wiz 8, Strength 8}
\begin{spelleffect}
    This spell functions like \spell{greater totemic power}, except that it affects multiple creatures. Each affected creature must have the same attribute or attributes increased.
\end{spelleffect}
