...
\begin{dtable}
    ...
    \end{tabularx}
    1 Triggered by a commonly taken or simple action, such as attacking or casting a spell.
    2 Triggered by an unusual circumstance, such as getting a critical hit.
