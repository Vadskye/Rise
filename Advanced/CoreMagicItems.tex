...
\appdescription{Bashing}{4,500}{7th}{Shield}{Faint Transmutation (Augment)}{6th}{\x} When a shield with this ability is used to perform a shield bash, it deals damage as if it were two size categories larger (so a Medium light shield deals 1d6 damage, and a Medium heavy shield deals 1d8 damage). 

\mitemreq{Transmutation}{Augment}{3}{6th}{Craft (as shield) 10}

\appdescription{Energy Resistance, Lesser}{1,000}{4th}{Armor}{Faint Abjuration (Shielding)}{2nd}{Immediate (triggered) 1/day} When you take energy damage, you can activate this armor to reduce the damage by 5 \add half your character level.
...
\appdescription{Gloves of Dexterity}{2,000}{5th}{Arms}{Faint Transmutation (Augment)}{2nd}{Standard (specific action) 3/day} By rubbing your gloved palms together (a standard action), you command these gauntlets to grant you a \plus2 enhancement bonus to Dexterity for 5 rounds. Unless you can defend yourself without the use of your hands, you provoke attacks of opportunity when activating this item.

\mitemreq{Transmutation}{Augment}{1}{2nd}{Craft (leather or textiles) 6}

\appdescription{Gloves of Dexterity, Greater}{16,000}{12th}{Arms}{Moderate Transmutation (Augment)}{8th}{Standard (specific action) 3/day} These gloves function like \magicitem{gloves of dexterity}, except that they grant a \plus4 enhancement bonus to Dexterity instead.

\mitemreq{Transmutation}{Augment}{4}{8th}{Craft (leather or textiles) 12}

\appdescription{Gauntlets of Ogre Strength}{2,000}{5th}{Arms}{Faint Transmutation (Augment)}{2nd}{Standard (specific action) 3/day} By striking your gauntleted fists against each other in front of you (a standard action), you command these gauntlets to grant you a \plus2 enhancement bonus to Strength for 5 rounds. Unless you can defend yourself without the use of your hands, you provoke attacks of opportunity when activating this item.

\mitemreq{Transmutation}{Augment}{1}{2nd}{Craft (metal) 6}

\appdescription{Gauntlets of Giant Strength}{16,000}{12th}{Arms}{Moderate Transmutation (Augment)}{8th}{Standard (specific action) 3/day} These gauntlets function like \magicitem{gauntlets of ogre strength}, except that they grant a \plus4 enhancement bonus to Strength instead.

\mitemreq{Transmutation}{Augment}{4}{8th}{Craft (metal) 12}

\subsection{Head}

\appdescription{Circlet of Wisdom}{2,000}{5th}{Head}{Faint Transmutation (Augment)}{2nd}{Standard (specific action) 3/day} By bowing your head and closing your eyes in contemplation (a standard action), you command this circlet to grant you a \plus2 enhancement bonus to Wisdom for 5 rounds. Unless you can defend yourself while blind, you provoke attacks of opportunity when activating this item.

\mitemreq{Transmutation}{Augment}{1}{2nd}{Craft (metal) 6}

\appdescription{Circlet of Wisdom, Greater}{16,000}{12th}{Head}{Moderate Transmutation (Augment)}{8th}{Standard (specific action) 3/day} This circlet functions like a \magicitem{circlet of wisdom}, except that it grants a \plus4 enhancement bonus to Wisdom instead.

\mitemreq{Transmutation}{Augment}{4}{8th}{Craft (metal) 12}

\appdescription{Headband of Intellect}{2,000}{5th}{Head}{Faint Transmutation (Augment)}{2nd}{Standard (specific action) 3/day} By stroking your chin or beard thoughtfully with one hand (a standard action), you command this headband to grant you a \plus2 enhancement bonus to Intelligence for 5 rounds.

\mitemreq{Transmutation}{Augment}{1}{2nd}{Craft (metal) 6}

\appdescription{Headband of Intellect, Greater}{16,000}{12th}{Head}{Moderate Transmutation (Augment)}{8th}{Standard (specific action) 3/day} This headband functions like a \magicitem{headband of intellect}, except that it grants a \plus4 enhancement bonus to Intelligence instead.

\mitemreq{Transmutation}{Augment}{4}{8th}{Craft (metal) 12}

\subsection{Legs}

\appdescription{Boots of Elvenkind}{2,800}{6th}{Legs}{Faint Transmutation (Augment)}{4th}{Standard (specific action) 3/day} While wearing these boots, you gain a \plus2 enhancement bonus to Stealth checks. In addition, by crouching down and touching the top of one of the boots, you can command the boots to grant you a \plus5 enhancement bonus to Stealth checks. The bonus lasts for as long as you remain crouching, and for 5 rounds thereafter. You can move at half speed while crouching. 

\mitemreq{Transmutation}{Augment}{2}{4th}{Craft (leather) 8}

\appdescription{Boots of Mobility}{10,000}{10th}{Legs}{Faint Transmutation (Augment)}{5th}{\x} While wearing these boots, you gain a \plus5 enhancement bonus to Acrobatics and Athletics checks.

\mitemreq{Transmutation}{Augment}{1}{5th}{Craft (leather) 9}

\appdescription{Boots of Speed}{16,000}{12th}{Legs}{Moderate Transmutation (Temporal)}{8th}{Swift (specific action) 1/day} By clicking your heels together (a swift action), you can command these boots to grant you the effects of the \spell{haste} spell for 5 rounds.
...
\appdescription{Belt of Constitution}{2,000}{5th}{Torso}{Faint Transmutation (Augment)}{2nd}{Standard (specific action) 3/day} By tightening the straps on this belt with both hands (a standard action), you command it to grant you a \plus2 enhancement bonus to Constitution for 5 rounds. Unless you can defend yourself without the use of your hands, you provoke attacks of opportunity when activating this item.

\mitemreq{Transmutation}{Augment}{1}{2nd}{Craft (textiles) 6}

\appdescription{Belt of Constitution, Greater}{16,000}{12th}{Torso}{Moderate Transmutation (Augment)}{8th}{Standard (specific action) 3/day} This belt functions like a \magicitem{belt of constitution}, except that it grants a \plus4 enhancement bonus to Constitution instead.

\mitemreq{Transmutation}{Augment}{4}{8th}{Craft (textiles) 12}

\appdescription{Cloak of Charisma}{2,000}{5th}{Torso}{Faint Transmutation (Augment)}{2nd}{Standard (specific action) 3/day} By flourishing this cloak with one hand (a standard action), you command it to grant you a \plus2 enhancement bonus to Charisma for 5 rounds.

\mitemreq{Transmutation}{Augment}{1}{2nd}{Craft (textiles) 6}

\appdescription{Cloak of Charisma, Greater}{16,000}{12th}{Torso}{Moderate Transmutation (Augment)}{8th}{Standard (specific action) 3/day} This cloak functions like a \magicitem{cloak of charisma}, except that it grants a \plus4 enhancement bonus to Charisma instead.
...
\impdescription{Poisoning, Greater}{32,000}{15th}{Moderate Conjuration/Transmutation (Creation, Temporal)}{8th}{Swift (specific action) 3/day and standard (specific action)} This ability functions like the poisoning weapon ability, except that it can duplicate liquid poisons of up to 2,000 gp per dose. In addition, up to five different poisons can be stored within the weapon. When you coat the weapon with poison, you may choose which poison to use. 

\mitemreq{Conjuration, Transmutation}{4}{8th}{Craft (as weapon) 12}

\impdescription{Returning}{2,000}{5th}{Faint Conjuration (Translocation) [Teleportation]}{4th}{\x} After being thrown, a returning weapon teleports back to the creature that threw it. It returns to the thrower just before the creature's next turn (and is therefore ready to use again in that turn).
...
%be based on.
\impdescription{Soulreaving}{32,000}{15th}{Strong Necromancy (Soul)}{16th}{\x and standard (specific action)} This ghostly, translucent weapon strikes directly at the target's soul. It ignores all damage reduction, but it does not deal hit point damage. In fact, a creature struck by the weapon only feels the weapon pass through it harmlessly. Damage that would be dealt by the weapon is delayed for up to 24 hours. While the damage is delayed, it cannot be cured.
...
\impdescription{Thundering}{16,000}{2nd}{Faint Evocation (Energy) [Sonic]}{2nd}{Immediate (triggered) 1/day} When you strike a foe with this weapon, you can detonate a deafening roll of thunder, deafening the struck foe and all other creatures within a \areasmall radius of you. You are immune to the deafening effect.

\mitemreqdesc{Evocation}{Energy}{Sonic}{4}{8th}{Craft (as weapon) 8}

\impdescription{Vampiric}{4,000}{9th}{Faint Necromancy (Life)}{4th}{Move (specific action) 3/day} If you lick the striking part of this weapon (a move action), you regain hit points equal to the damage dealt by the weapon on its last successful attack. If the weapon has not dealt damage in the past round, you regain no hit points.
...
\impdescription{Enlarging}{2,000}{5th}{Faint Universal}{2nd}{Immediate (specific action) 1/day} As you cast a spell, you can activate this wand to double the range of the spell.

\mitemreq{No school}{}{1}{2nd}{(as wand) 6}

\impdescription{Flaming}{2,000}{5th}{Faint Evocation (Energy) [Fire]}{2nd}{Immediate (triggered) 1/day} As you cast a spell, you can activate this wand to ignite a single creature affected by the spell for 5 rounds.
...
\impdescriptiondc{Shocking}{4,000}{9th}{Faint Evocation (Energy) [Electricity]}{8th}{Immediate (triggered) 1/day}{Fortitude DC 12} As you cast a spell, you can activate this wand to stagger a single creature affected by the spell for 5 rounds. The target receives a Fortitude save to avoid being staggered.
