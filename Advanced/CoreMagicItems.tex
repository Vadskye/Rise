...
\appdescription{Bashing}{2,000}{6th}{Shield}{Faint Transmutation (Augment)}{2nd}{\x} When a shield with this ability is used to perform a shield bash, it deals damage as if it were two size categories larger (so a Medium light shield deals 1d6 damage, and a Medium heavy shield deals 1d8 damage). 

\mitemreq{Transmutation}{Augment}{2}{4th}{(as shield) 8}
...
\appdescription{Ghost Touch}{2,000}{6th}{Armor, Shield}{Faint Conjuration (Translocation) [Planar]}{4th}{\x} This armor or shield seems almost translucent. Both its enhancement bonus and its armor bonus count against the attacks of incorporeal creatures. It can be picked up, moved, and worn by incorporeal creatures at any time. Incorporeal creatures gain the armor or shield's enhancement bonus against both corporeal and incorporeal attacks, and they can still pass freely through solid objects.

\mitemreq{Conjuration}{Translocation}{2}{4th}{(as armor) 8}

\appdescription{Glamered}{2,000}{6th}{Armor}{Faint Illusion (Glamer)}{4th}{\x} A suit of armor with this ability appears normal. Upon command, the armor appears to change shape and form to assume the appearance of a normal set of clothing. The armor retains all its properties (including weight and sound) when glamered. Only a \spell{true seeing} spell or similar magic reveals the true nature of the armor when disguised.

\mitemreq{Illusion}{Glamer}{2}{4th}{(as armor) 8}

\appdescription{Invulnerability}{8,000}{9th}{Armor}{Moderate Abjuration (Shielding)}{6th}{\x} This suit of armor grants the wearer damage reduction equal to his character level. The damage reduction is overcome by adamantine weapons.
...
\begin{tabularx}{\columnwidth}{>{\lcol}X l l}
  ...
  Flaming & 1,000 gp & 4th \\
  Freezing & 1,000 gp & 4th \\
