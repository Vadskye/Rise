...
Invisible &  \multicolumn{2}{c}{\x See Concealment \x} \\
Overwhelmed & special\fn{4} & special\fn{4} \\
Pinned & \minus4\fn{3} & \plus0\fn{3} \\
Prone & \minus4 & \plus4 \\
...
Concealment represents anything which makes it more difficult to see your target, such as dim lighting. A creature with concealment from you gains a \plus4 circumstance bonus to Armor Class.
