...
\parhead{Enhancement Bonus} You can have enhancement bonuses to all physical defenses, or to a specific physical defense. As normal, these enhancement bonuses do not stack with each other; only the highest applicable bonus is used.
