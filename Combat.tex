...
\begin{figure}[h]
\centering Base defense bonus \add Dexterity \add half Wisdom \add dodge modifier \add enhancement bonus \add size modifier \add other bonuses and penalties
\end{figure}
\parhead{Base Defense Bonus} Your base defense bonus comes from your classes. See \pcref{Base Special Defense Progressions}, for more details.
...
\begin{figure}[h]
\centering Base defense bonus \add Constitution \add half Strength \add enhancement bonus \add other bonuses and penalties
\end{figure}
\parhead{Base Defense Bonus} Your base defense bonus comes from your classes. See \pcref{Base Special Defense Progressions}, for more details.
...
\begin{figure}[h]
\centering Base defense bonus \add Charisma \add half Intelligence \add enhancement bonus \add other bonuses and penalties
\end{figure}
\parhead{Base Defense Bonus} Your base defense bonus comes from your classes. See \pcref{Base Special Defense Progressions}, for more details.
