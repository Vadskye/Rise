...
\begin{itemize*}
    ...
    \item You are vulnerable (\minus2 penalty to attacks, defenses, and checks) against creatures you are not grappling with.
...
Sometimes, creatures are not aware that combat is taking place when the combat starts. This most commonly happens with ambushes. Any creature that is not aware of the combat continues continues taking whatever actions it would normally be taking until it becomes aware of the combat. A creature that is not aware it is in combat can't take attacks of opportunity.
