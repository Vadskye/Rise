...
\begin{figure}[h]
    \centering 10 \add Base defense bonus or defense attribute \meh{\add enhancement bonus} \add size modifier \add other bonuses and penalties
\end{figure}
...
\begin{dtable!*}
    ...
    \begin{tabularx}{\textwidth}{l l l l l >{\lcol}X}
        ...
        Armor defense & Half base attack bonus  & Dex or Con & Yes & Yes & Yes \\
        Maneuver defense & Base attack bonus    & Str or Dex & No  & Yes & Special \\
        Fortitude defense & Base Fortitude bonus& Con        & No  & No  & No  \\
        Reflex defense & Base Reflex bonus      & Dex or Per & No  & Yes & Yes \\
        Will defense & Base Will bonus          & Wil        & No  & No  & No  \\
    \end{tabularx}
\end{dtable!*}
...
\parhead{Withdraw}\label{Withdraw} As a move action, you can move up to half your speed. Before you do so, you can designate one creature who threatens you. This movement does not provoke attacks of opportunity from that creature. If you can make multiple attacks from a high base attack bonus, you can ignore one additional opponent of your choice per attack you can make.
...
When you take damage that would reduce your hit points to 0, you become staggered. While staggered, you can only act during the action phase.
...
As a standard action, you can focus entirely on defense, granting you a \plus4 bonus to your physical defenses for 1 round. While using the total defense action, you can't make attacks of opportunity, but you still threaten squares normally for the purpose of overwhelm penalties and similar effects.
