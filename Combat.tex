...
\parhead{Strength Bonus} When you hit with a melee or thrown weapon, including a sling, add your Strength to the damage result. A Strength penalty, but not a bonus, applies on attacks made with a bow that is not a composite bow.
...
\parhead{Making an Attack of Opportunity} An attack of opportunity is a single melee attack. You can make a number of attacks of opportunity each round equal to 1 \add your Dexterity value, but never more than one per opportunity. You don't have to make an attack of opportunity if you don't want to.
