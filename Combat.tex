...
\begin{dtable*}
    ...
    \begin{tabularx}{\textwidth}{l l l l X}
        ...
        Dirty Trick & Standard & Strength or Dexterity & Impose penalty on an foe \\
        Disarm & Standard & Strength or Dexterity & Force foe to drop item \\
        Grapple & Standard & Strength & Wrestle with an foe \\
        Overrun & Full-round & Strength & Move through an foe \\
        Shove & Standard & Strength &  Move an foe \\
        Trip & Standard & Strength or Dexterity & Trip an foe \\
    \end{tabularx}
\end{dtable*}
...
\begin{itemize*}
    ...
    \item Maneuver defense: Your Maneuver defense protects you fromd unusual physical attacks, such as attempts to trip or disarm you. Maneuver defense is a physical defense.
...
\subsection{Armor Defense}
Your Armor defense represents how hard it is for opponents to land a solid, damaging blow on you. It's the attack roll result that an opponent needs to achieve to hit you with a normal physical attack. Unlike most combat statistics, your Armor defense is made up of the sum of other modifiers, each of which can have their own independent bonuses and penalties. It is equal to the following:

\begin{figure}[h]
    \centering 10 \add half base attack bonus \add Dexterity \add armor modifier \add shield modifier \add dodge modifier \add size modifier \add other bonuses and penalties
\end{figure}

\parhead{Base Attack Bonus} Your experience and aptitude in combat affects your ability to defend yourself; experienced warriors know how to recognize and avoid or parry blows that would easily fell novices. As a result, you add half your base attack bonus to your Armor defense.
\parhead{Enhancement Bonuses} You can have separate enhancement bonuses to your armor modifier, shield modifier, and dodge modifier. All of these enhancement bonuses stack to improve your Armor defense.
...
\begin{figure}[h]
    \centering 10 \add base attack bonus \add Strength \add Dexterity \add shield modifier \add dodge modifier \add special size modifier \add other bonuses and penalties
\end{figure}

Your special size modifier is described in \tref{Size in Combat}.

\subsection{Reflex Defense}

Reflex defense is a physical defense, and is modified by effects that affect physical defenses. Your Reflex defense is calculated in the following way:

\begin{figure}[h]
\centering Base Reflex bonus \add Dexterity \add half Wisdom \add dodge modifier \add enhancement bonus \add size modifier \add other bonuses and penalties
\end{figure}
\parhead{Base Reflex Bonus} Your base Reflex bonus comes from your classes. See \pcref{Base Defense Progressions}, for more details.
\parhead{Size Modifier} You apply your size modifier to your Reflex defense.

\subsection{Fortitude Defense}

Fortitude defense is a special defense, and is modified by effects that affect special defenses. Your Fortitude defense is calculated in the following way:

\begin{figure}[h]
\centering Base Fortitude bonus \add Constitution \add half Strength \add enhancement bonus \add other bonuses and penalties
\end{figure}
\parhead{Base Fortitude Bonus} Your base Fortitude bonus comes from your classes. See \pcref{Base Defense Progressions}, for more details.

\subsection{Will Defense}

Your Will defense is a special defense, and is modified by effects that affect special defenses. It is calculated in the following way:

\begin{figure}[h]
\centering Base Will bonus \add Charisma \add half Intelligence \add enhancement bonus \add other bonuses and penalties
\end{figure}
\parhead{Base Will Bonus} Your base Will bonus comes from your classes. See \pcref{Base Defense Progressions}, for more details.
...
\begin{dtable}
    ...
    3 The defender's Reflex and physical defenses are 10 \add size modifier. \\
...
A helpless creature is completely at an opponent's mercy. Its Reflex defense is 10, and its physical defenses are equal to 10 \add its size modifier. Paralyzed, bound, and unconscious creatures are helpless, as well as creatures completely unaware of an attack.
