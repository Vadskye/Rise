...
\begin{figure}[h]
\centering Base Reflex bonus \add Dexterity \add half Wisdom \add shield modifier \add dodge modifier \add enhancement bonus \add size modifier \add other bonuses and penalties
\end{figure}
