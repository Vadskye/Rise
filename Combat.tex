...
\par Fighting in this way is difficult, and you suffer a \minus2 penalty to your attack roll. You can mitigate this penalty if your secondary weapon is light. (An unarmed strike is always considered light.) The Two-Weapon Fighting feat grants a \plus2 competence bonus to attack rolls when fighting with two weapons at once (see Two-Weapon Fighting, \pref{feat:Two-Weapon Fighting}).
