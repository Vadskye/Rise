...
\parhead{Forced Movement} You never provoke attacks of opportunity for movement you didn't take intentionally, such as from a bull rush (see \pcref{Bull Rush}).
...
A creature with a climb speed can move at the indicated speed while climbing. In addition, it has a \plus5 competence bonus to Climb checks (see \pcref{Climb}). It can always choose to take 10 on Climb checks, even if rushed or threatened, and is not flat-footed while climbing. It cannot make an accelerated climb. 
...
\par Fighting in this way is difficult, and you suffer a \minus2 penalty to your attack roll. You can mitigate this penalty if both your weapons are light. The Two-Weapon Fighting feat grants a \plus2 competence bonus to attack rolls when fighting with two weapons at once (see Two-Weapon Fighting, \pref{feat:Two-Weapon Fighting}).
