...
\section{Trait Tables}
    ...
    \begin{longtabuwrapper}
        \begin{longtabu}{>{\lcol}p{10em} >{\lcol}p{15em} >{\lcol}X >{\lcol}p{8em} >{\lcol}p{3em}}
            ...
            \featref{Boulder Toss} & Slayer 6, Strength 10 & Throw objects incredible distance & Active & \featpref{Boulder Toss} \\
            ...
            \featref{Burrower} & Slayer 2 & Gain burrow speed & Mobility & \featpref{Burrower} \\
...
\section{Trait Descriptions}
    ...
    Your \glossterm{range increment} with thrown weapons becomes 50 feet.
