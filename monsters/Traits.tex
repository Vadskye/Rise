...
\section{Trait Tables}
    ...
    \begin{longtabuwrapper}
        \begin{longtabu}{>{\lcol}p{10em} >{\lcol}p{15em} >{\lcol}X >{\lcol}p{8em} >{\lcol}p{3em}}
            ...
            \featref{Attribute Mastery} & 2nd level & Gain bonus to attribute & Augment & \featpref{Attribute Mastery} \\
            \featref{Evasive} & Dex 5 & Gain \plus2 to physical defenses & Defense & \featpref{Evasive} \\
            \featref{Damage Immunity} & 6th level & Become immune to specific damage types & Defense & \featpref{Damage Immunity} \\
            \featref{Great Fortitude} & \tdash & Gain \plus4 to Fortitude defense & Defense & \featpref{Great Fortitude} \\
            \featref{Improved Natural Armor} & \tdash & Gain \plus2 to Armor defense & Defense & \featpref{Improved Natural Armor} \\
            ...
            \featref{Instant Reflexes} & \tdash & Gain \plus4 to Reflex defense & Defense & \featpref{Instant Reflexes} \\
            \featref{Mighty Will} & \tdash & Gain \plus4 to Mental defense & Defense & \featpref{Mighty Will} \\
            ...
            \featref{Resist Damage} & 6th level & Gain damage reduction & Defense & \featpref{Resist Damage} \\
            ...
            \featref{Draining Touch} & Adept & Gain ability to deal damage with a touch & Active & \featpref{Draining Touch} \\
            \featref{Humanoid Form} & Adept 4 & Gain ability to change into humanoid form & Body & \featpref{Humanoid Form} \\
            \featref{Magical Ability} & Adept & Gain ability to mimic a spell's effects & Active & \featpref{Magical Ability} \\
            \featref{Magical Retribution} & Adept 8 & Deal damage to attackers & Defense & \featpref{Magical Retribution} \\
            \featref{Magical Strike} & Natural weapon, adept 8 & Natural weapon causes a spell's effects & Augment & \featpref{Magical Strike} \\
            \featref{Myriad Magical Abilities} & Adept 6 & Gain many abilities that mimic spell effects & Active & \featpref{Myriad Magical Abilities} \\
            \featref{Spellcaster} & Adept & Gain ability to cast spells & Active & \featpref{Spellcaster} \\

            \midrule
            \tb{Behemoth Traits}\label{Behemoth Traits} & \tb{Prerequisites} & \tb{Benefit} & \tb{Trait Types} & \tb{Page} \\
            \featref{Armored Carapace} & Behemoth 10 & Gain \plus4 to Armor defense & Defense & \featpref{Armored Carapace} \\
            \featref{Behemoth Resilience} & Behemoth 4 & Gain damage reduction & Defense & \featpref{Behemoth Resilience} \\
            \featref{Behemoth Size} & Behemoth 4 & Increase size with level & Body & \featpref{Behemoth Size} \\
            \featref{Durable} & Behemoth & Increase maximum hit points & Defense & \featpref{Durable} \\
            \featref{Retributive Spikes} & Behemoth 4 & Deal damage to melee attackers & Defense & \featpref{Retributive Spikes} \\
            \featref{Titanic Defenses} & Behemoth 8 & \plus2 to all defenses & Defense & \featpref{Titanic Defenses} \\
            \featref{Titanic Body} & Behemoth 8 & Increase size by one size category & Body & \featpref{Titanic Body} \\
            ...
            \featref{Breath Weapon: Cone} & Slayer & Gain cone-shaped breath weapon & Active & \featpref{Breath Weapon: Cone} \\
            \featref{Breath Weapon: Line} & Slayer & Gain line-shaped breath weapon & Active & \featpref{Breath Weapon: Line} \\
            \featref{Brute Force} & Slayer & Increase damage of physical attacks & Augment & \featpref{Brute Force} \\
            \featref{Burrower} & Slayer & Gain burrow speed & Mobility & \featpref{Burrower} \\
            \featref{Damaging Aura} & Slayer & Gain aura that damages nearby foes & Augment & \featpref{Energetic Aura} \\
            \featref{Damaging Ray} & Slayer & Gain ability to fire damaging ray & Active & \featpref{Damaging Ray} \\
            \featref{Endless Breath} & Breath weapon & No delay after using breath weapon & Augment & \featpref{Endless Breath} \\
            \featref{Multistrike} & Slayer 6, three hands & Attack all threatened foes & Active & \featpref{Multistrike} \\
            \featref{Natural Energy} & Natural weapon, slayer 4 & Natural weapon deals energy damage & Augment & \featpref{Natural Energy} \\
            \featref{Rend} & Slayer, two strikes, Strength 5, two natural weapons & Deal bonus damage after hitting with two weapons & Augment & \featpref{Rend} \\
        \end{longtabu}
    \end{longtabuwrapper}
...
\section{Trait Descriptions}
    ...
    \feat{Armored Carapace}{Behemoth, Defense}
    \featpre Behemoth level 10.
    \featben You gain a \plus4 bonus to Armor defense.

    \feat{Attribute Mastery}{Augment, General}
    \featpre 2nd level.
    ...
    \feat{Behemoth Resilience}{Behemoth, Defense}
    \featpre Behemoth level 4.
    \featben You gain damage reduction against either physical damage or energy damage equal to your \glossterm{power}.
    ...
    \feat{Behemoth Size}{Behemoth, Body}
    \featpre Behemoth level 4.
    ...
    \feat{Breath Weapon: Cone}{Active, Slayer}
    ...
    \feat{Breath Weapon: Line}{Active, Slayer}
    \featpre Slayer level 1.
    \parhead{Choice} Choose a damage type when you gain this trait.
    \featben You gain a breath weapon attack.
    ...
    \feat{Damage Immunity}{Defense, General}
    \featpre 6th level
    ...
    \parhead{Special} A monster can naturally be immune to one type of damage without needing this trait.
    For details, see \pcref{Starting Abilities}.

    \feat{Damaging Aura}{Augment, General}
    \featpre Slayer level 1.
    \parhead{Choice} Choose a damage type when you gain this trait.
    ...
    \feat{Damaging Ray}{Active, Slayer}
    \featpre Slayer level 1.
    \parhead{Choice} Choose a damage type when you gain this trait.
    ...
    \feat{Draining Touch}{Active, Adept}
    ...
    \feat{Increased Size}{Body, General}
    \featpre 6th level.
    \featben Your size increases by one size category.
    ...
    \feat{Innate Magic}{Augment, General}
    \featpre 4th level.
    ...
    \feat{Instant Reflexes}{Defense, General}
    \featben You gain a \plus4 bonus to Reflex defense.

    \feat{Mighty Will}{Defense, General}
    \featben You gain a \plus4 bonus to Mental defense.

    \feat{Humanoid Form}{Adept, Body}
    ...
    \feat{Magical Ability}{Active, Adept}
    \featpre Adept level 1.
    ...
    \feat{Magical Retribution}{Adept, Defense}
    ...
    \feat{Magical Strike}{Adept, Augment}
    ...
    \feat{Myriad Magical Abilities}{Active, Adept}
    ...
    \feat{Natural Grab}{Augment, General}
    ...
    \feat{Natural Shove}{Augment, General}
    ...
    \feat{Natural Trip}{Augment, General}
    \featpre At least one \glossterm{natural weapon}.
    \featben Choose one of your natural weapons.
    ...
    \feat{Natural Venom}{Augment, General}
    \featpre At least one \glossterm{natural weapon}.
    \featben Choose one of your natural weapons.
    ...
    \feat{Resist Damage}{Defense, General}
    \featpre 6th level.
    \featben You gain damage reduction against either physical damage or energy damage equal to your \glossterm{power}.
    Damage of a type of your choice, or by a special material of your choice, ignores this damage reduction and negates it for 1 round.
    ...
    \feat{Resist Magic}{Defense, General}
    \featpre 8th level.
    \featben You gain \glossterm{spell resistance} equal to 10 \add your \glossterm{power}.
    ...
    \feat{Spellfeeder}{Defense, General}
    \featpre 8th level.
    ...
    \feat{Superior Senses}{Augment, General}
    \featpre 6th level.
    ...
    \feat{Titanic Defenses}{Defense, General}
