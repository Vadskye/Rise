...
\section{Type Overviews}
    ...
    \parhead{Animate} An animate is a plant, fungus, or similar living thing with the ability to move independently.
...
\section{Type Descriptions}
    ...
    \subsection{Animal}
        ...
        \parhead{Mental} Poor.
        \parhead{Limited Intelligence} Animals have an Intelligence of \minus6 or lower.
        An animal whose Intelligence permanently increases to \minus5 or higher becomes a magical beast.

    \subsection{Animate}
        \parhead{Fortitude} Good.
        \parhead{Reflex} Poor.
        \parhead{Mental} Good.
        \parhead{Mindless} Animates are immune to Mind effects.
        \parhead{Nonsentient} Animates do not have Intelligence or Willpower attributes.
