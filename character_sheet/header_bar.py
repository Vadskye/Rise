...
def nav_row():
    return [
        ...
        radio_input(
            {"class": "nav-button nav-button-active", "name": "nostore_navrow", "value": "active"}
        ),
        span({"class": "nav-button-label"}, "Active"),
        radio_input(
            {"class": "nav-button nav-button-page2", "name": "nostore_navrow", "value": "page2"}
        ),
        span({"class": "nav-button-label"}, "Skills"),
        radio_input(
            {"class": "nav-button nav-button-page3", "name": "nostore_navrow", "value": "page3"}
        ),
        span({"class": "nav-button-label"}, "Calcs"),
        radio_input(
            {"class": "nav-button nav-button-page4", "name": "nostore_navrow", "value": "page4"}
        ),
        span({"class": "nav-button-label"}, "Identity"),
        radio_input(
            {"class": "nav-button nav-button-page5", "name": "nostore_navrow", "value": "page5"}
        ),
        span({"class": "nav-button-label"}, "Items"),
        radio_input(
            {"class": "nav-button nav-button-page6", "name": "nostore_navrow", "value": "page6"}
        ),
        span({"class": "nav-button-label"}, "Status"),
        radio_input(
            {"class": "nav-button nav-button-page7", "name": "nostore_navrow", "value": "page7"}
        ),
