...
def hit_points():
    ...
    return js_wrapper(
        ...
        f"""
            var player_hit_points_from_level = {{
                '-1': 9  ,
                0:    10 ,
                1:    11 ,
                2:    12 ,
            ...
            var monster_hit_points_from_level = {{
                '-1': 9  ,
                "0":  10 ,
                "1":  11 ,
                "2":  12 ,
            ...
            var hit_points_from_level = challenge_rating ? monster_hit_points_from_level : player_hit_points_from_level;
