...
def debuff_explanation(debuff):
    return {
        ...
        "confused": "-4 defenses and randomly attack, defend, flee, or act normally",
        "dazed": "-2 defenses",
        ...
        "frightened": "-4 Mental, -4 accuracy vs. source",
        ...
        [
            select(
                ...
                [
                    ...
                    option({"value": "mystic_insights_known"}, "Mystic insights"),
