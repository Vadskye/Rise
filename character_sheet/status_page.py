from cgi_simple import div, equation, flex_col, flex_row, labeled_text_input, number_input, plus, this_or_that, underlabel, textarea, sidelabel, fieldset, button, flex_wrapper, underlabeled_checkbox, underlabel_spaced, label, checkbox, span

def create_page():
    return flex_col({'class': 'page status-page'}, [
