...
def create_page(_destination: str) -> str:
    return flex_col(
        ...
        [
            textarea({"class": "typescript", "readonly": True, "name": "typescript_generation"}),
            flex_row(
                {"class": "reference-row"},
                [
                    flex_col(
...
def common_concepts():
    ...
    return flex_col(
        ...
        [
            ...
            p(
                """<b>Critical hit</b>: If you hit with an attack by 10 or more, you get a critical hit. Unless otherwise specified, all damaging attacks deal double damage on a critical hit."""
            ),
            p(
