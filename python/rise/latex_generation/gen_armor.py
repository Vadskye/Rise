    ...
    armor += [
        create_armor(
            ...
            description="""
                ...
                When you do, any \\glossterm<targeted> \\glossterm<magical> abilities that would target you this round also the creature using that ability in addition to you.
