...
pyromancy = MysticSphere(
    ...
    cantrips=[
        ...
        Effects(
            "Extinguish",
            "One Medium or smaller active flame within \\rngmed range",
            """
    ...
    spells=[
        ...
        Spell(
            "Cone of Conflagration",
            3,
            "Everything in a \\arealarge cone from you",
            f"""
            Make an attack vs. Reflex against each target.
            \\hit Each target takes fire damage equal to 2d6 plus half your \\glossterm<power>.
            \\glance As above, except that that each target takes half damage.
        ...
        Spell(
            "Heat Metal",
            2,
            "One Medium or smaller metal object within \\rngmed range",
            """
        ...
        Spell(
            "Flame Serpent",
            4,
            "Everything in a \\areamed, 5 ft.\\ wide shapeable line that starts within \\rngmed range",
            f"""
            Make an attack vs. Reflex against each target.
        ...
        Spell(
            "Flame Aura",
            7,
            ["Yourself", "Everything in a \\areasmall radius from you (see text)"],
            """
            You can cast this spell as a \\glossterm<minor action>.
        ...
        Spell(
            "Kindled Fireburst",
            2,
            "One Tiny or larger active fire within \\rngmed range (see text)",
            """
