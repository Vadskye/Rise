...
toxicology = MysticSphere(
    ...
    cantrips=[
        ...
        Effects(
            "Neutralize Poison",
            "Yourself or one target within \\rngmed range",
            """
    ...
    spells=[
        ...
        Spell(
            ...
            [
                ...
                "One other living creature within that range",
            ],
            """
        ...
        Spell(
            "Acidic Blood",
            3,
            ["Yourself", "Everything adjacent to you"],
            """
        ...
        Spell(
            "Acid Arrow",
            2,
            "One creature or object within \\rnglong range",
            """
            Make an attack vs. Fortitude against the target.
        ...
        Spell(
            "Acid Rain",
            4,
            "Everything in a \\areasmall radius, 30 ft.\\ high cylinder within \\rngmed range",
            """
            Make an attack vs. Fortitude against each target.
        ...
        Spell(
            "Healing Salve",
            2,
            "Yourself or one \\glossterm<ally> within your \\glossterm<reach>",
            """
