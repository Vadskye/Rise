...
photomancy = MysticSphere(
    ...
    cantrips=[
        ...
        Effects(
            "Illuminate",
            "One location within \\rngmed range",
            """
    ...
    spells=[
        Spell(
            "Color Spray",
            1,
            "Each creature within a \\areasmall cone from you",
            """
        ...
        Spell(
            "Color Blast",
            3,
            "Each creature within a \\arealarge cone from you",
            """
        ...
        Spell(
            "Prismatic Spray",
            4,
            "Each target within a \\areasmall cone from you",
            """
            Make an attack vs. Mental against each target.
        ...
        Spell(
            "Prismatic Blast",
            6,
            "Each target within a \\arealarge cone from you",
            """
        ...
        Spell(
            "Lightburst",
            1,
            "Creatures in the area (see text)",
            """
    ...
    rituals=[
        ...
        Spell(
            "False Decrepify",
            1,
            "One Medium or smaller unattended object within \\rngshort range",
            """
