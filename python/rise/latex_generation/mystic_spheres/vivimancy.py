...
vivimancy = MysticSphere(
    ...
    cantrips=[
        Effects(
            "Ablate Vital Wound",
            "Yourself or a living \\glossterm<ally> within your \\glossterm<reach>",
            """
        ...
        Effects(
            "Minor Life Infusion",
            "Yourself or a living \\glossterm<ally> within \\rngmed range",
            """
    ...
    spells=[
        ...
        Spell(
            "Draining Grasp",
            1,
            "One living creature within your \\glossterm<reach>",
            """
        ...
        Spell(
            "Cure Wound",
            2,
            "Yourself or a living \\glossterm<ally> within \\rngshort range",
            """
        ...
        Spell(
            "Circle of Death",
            3,
            "Living \\glossterm<enemies> in a \\areamed radius from you",
            """
        ...
        Spell(
            "Circle of Life",
            5,
            "Yourself and each living \\glossterm<ally> in a \\areamed radius from you",
            """
        ...
        Spell(
            "Sickening Miasma",
            1,
            "Living creatures in a \\areasmall radius within \\rngmed range",
            """
            Make an attack vs. Fortitude against each target.
        ...
        Spell(
            "Corpse Explosion",
            2,
            "One Small or larger corpse within \\rngmed range (see text)",
            """
    ...
    rituals=[
        ...
        Spell(
            "Reincarnation",
            5,
            "One Diminuitive or larger piece of a humanoid corpse",
            """
        ...
        Spell(
            "Resurrection",
            4,
            "One intact humanoid corpse within \\rngshort range",
            """
        ...
        Spell(
            ...
            6,
            "One Diminuitive or larger piece of a humanoid corpse within \\rngshort range",
            """
        ...
        Spell(
            "Soul Bind",
            6,
            "One intact corpse within \\rngshort range",
            """
        ...
        Spell(
            "Animate Dead",
            3,
            "Any number of corpses within \\rngshort range",
            """
