...
umbramancy = MysticSphere(
    ...
    cantrips=[
        ...
        Effects(
            "Suppress Light",
            "One \\glossterm<zone> within \\rngmed range",
            """
            This spell has no \\glossterm<verbal components>.
    ...
    spells=[
        ...
        Spell(
            "Bind Shadow",
            1,
            "One creature within \\rngmed range standing on the ground",
            """
