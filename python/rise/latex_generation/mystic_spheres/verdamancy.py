...
verdamancy = MysticSphere(
    ...
    cantrips=[
        Effects(
            "Fertile Patch",
            "One unattended, nonmagical 1-ft.\\ square of earth",
            """
        ...
        Effects(
            "Rapid Growth",
            "One Large or smaller inanimate plant within \\rngshort range",
            """
    ...
    spells=[
        ...
        Spell(
            "Strangling Vines",
            7,
            "One Large or smaller creature within \\rngshort range",
            """
        ...
        Spell(
            "Vineburst",
            1,
            "Creatures in a \\areasmall radius from you",
            """
        ...
        Spell(
            "Fire Seeds",
            3,
            "One unattended acorn or similar seed structure you touch",
            """
        ...
        Spell(
            "Plant Growth",
            1,
            "All plants, earth, and unworked stone in a \\areasmall radius within \\rngmed range",
            """
        ...
        Spell(
            "Blight",
            2,
            "One living creature or plant within \\rngmed range",
            """
            Make an attack vs. Fortitude against the target.
