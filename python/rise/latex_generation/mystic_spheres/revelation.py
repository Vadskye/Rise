...
revelation = MysticSphere(
    ...
    spells=[
        Spell(
            "Proficiency",
            1,
            "One weapon within \\rngmed range",
            """
        ...
        Spell(
            "Purge Invisibility",
            2,
            "Everything in a \\areamed radius \\glossterm<emanation> from you",
            """
        ...
        Spell(
            "Arcane Eye",
            2,
            "One unoccupied square within \\rngmed range",
            """
        ...
        Spell(
            "Clairvoyance",
            5,
            "One unoccupied square within \\rngmed range (see text)",
            """
        ...
        Spell(
            "Reverse Scrying",
            3,
            "One magical sensor within \\rngshort range",
            """
        ...
        Spell(
            "Sensory Chain",
            4,
            "One creature within \\rngmed range (see text)",
            """
            Make an attack vs. Mental against the target.
    ...
    rituals=[
        ...
        Spell(
            ...
            6,
            "Any creature or object on the same plane as you",
            """
        ...
        Spell(
            "Sending",
            3,
            "Any creature within 100 miles of you",
            """
        ...
        Spell(
            "Distant Sending",
            5,
            "Any creature on the same plane as you",
            """
        ...
        Spell(
            "Scry Creature",
            4,
            "One creature on the same plane as you",
            """
            Make an attack vs. Mental against the target.
            You do not need \\glossterm<line of sight> or \\glossterm<line of effect> to the target.
            However,  must specify your target with a precise mental image of its appearance.
