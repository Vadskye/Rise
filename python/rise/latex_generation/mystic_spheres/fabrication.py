...
fabrication = MysticSphere(
    ...
    spells=[
        ...
        Spell(
            "Bladestorm",
            3,
            "\\glossterm<Enemies> adjacent to you",
            """
        ...
        Spell(
            "Hail of Arrows",
            3,
            "Everything in a \\areasmall radius within \\rngmed range",
            """
            Make an attack vs. Armor against each target.
        ...
        Spell(
            "Blade Barrier",
            2,
            "Each creature that moves through the area (see text)",
            """
        ...
        Spell(
            "Forge",
            1,
            "One unoccupied square within \\rngshort range",
            """
        ...
        Spell(
            "Web",
            4,
            "All Large or smaller creatures in the area (see text)",
            """
        ...
        Spell(
            "Caltrops",
            1,
            "One 5 ft.\\ square within \\rngshort range (see text)",
            """
        ...
        Spell(
            "Daggercloud",
            4,
            "Everything in a \\areatiny radius \\glossterm<zone> within \\rngmed range (see text)",
            """
    ...
    rituals=[
        ...
        Spell(
            ...
            1,
            [
                "One Small or smaller written work within \\rngshort range",
                "One Small or smaller set of blank pages within \\rngshort range",
            ],
            """
        ...
        Spell(
            ...
            4,
            [
                "One Medium or smaller written work within \\rngshort range",
                "One Medium or smaller set of blank pages within \\rngshort range",
            ],
            """
