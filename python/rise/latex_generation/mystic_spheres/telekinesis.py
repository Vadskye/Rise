...
telekinesis=MysticSphere(
    ...
    spells=[
        ...
        """, tags=[]),
        Spell('Mass Kinetic Impedance', 1, 'Large or smaller \\glossterm<enemies> in a \\areasmall radius within \\rngmed range', """
        ...
        # """, scaling="damage", tags=[]),
        Spell('Telekinetic Throw', 2, 'One Large or smaller creature or object within \\rngmed range', """
            Make an attack vs. Mental against the target.
