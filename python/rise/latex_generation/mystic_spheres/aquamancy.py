...
aquamancy = MysticSphere(
    ...
    cantrips=[
        Effects(
            "Create Water",
            "Any number of locations within \\rngshort range",
            """
        ...
        Effects(
            "Purify Water",
            "Up to five gallons of water within \\rngshort range",
            """
    ...
    spells=[
        ...
        Spell(
            "Sphere of Constraint",
            5,
            "All creatures completely within a \\areasmall radius within \\rngmed range",
            """
        ...
        Spell(
            "Constraining Bubble",
            4,
            "One Large or smaller creature within \\rngmed range",
            """
        ...
        Spell(
            "Crushing Wave",
            1,
            "Everything in a \\areasmall, 10 ft.\\ wide line from you",
            """
            Make an attack vs. Reflex against each target.
        ...
        Spell(
            "Fountain",
            1,
            "Everything within a \\areasmall radius from you",
            """
        ...
        Spell(
            "Great Fountain",
            3,
            "\\glossterm<Enemies> within a \\areamed radius from you",
            """
            Make an attack vs. Armor against each target.
            \\hit Each target takes bludgeoning damage equal to 2d6 plus half your \\glossterm<power>.
            \\glance As above, except that that each target takes half damage.
        ...
        Spell(
            "Raging Flood",
            7,
            "Everything in a \\arealarge, 15 ft. wide line from you",
            """
            Make an attack vs. Fortitude against each target.
        ...
        Spell(
            "Wave of Dehydration",
            3,
            "Creatures in a \\arealarge, 10 ft. wide line from you",
            """
            Make an attack vs. Fortitude against each target.
        ...
        Spell(
            "Fog Cloud",
            3,
            "Everything in a \\areamed radius within \\rnglong range",
            """
    ...
    rituals=[
        Spell(
            "Dampen",
            1,
            "Up to five ritual participants",
            """
        ...
        """,
            tags=["Detection"],
            ritual_time="one minuate",
        ),
        Spell(
            "Greater Detect Water",
            3,
            None,
            """
