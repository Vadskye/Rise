...
terramancy = MysticSphere(
    ...
    cantrips=[
        Effects(
            "Shape Earth",
            "One unattended, nonmagical body of earth or unworked stone you touch",
            """
    ...
    spells=[
        ...
        Spell(
            "Earthcraft",
            1,
            "One body of earth or unworked stone within 5 feet of you",
            """
        ...
        Spell(
            "Earthcage",
            6,
            "One Large or smaller creature or object within \\rngshort range",
            """
        ...
        Spell(
            "Meld into Stone",
            3,
            "One stone object you can touch that is at least as large as your body",
            """
        ...
        Spell(
            "Tremor",
            2,
            "Large or smaller creatures in a \\areasmall radius within \\rngmed range that are standing on solid ground",
            """
        ...
        Spell(
            "Fissure",
            4,
            "Everything in a \\areasmall radius within \\rngmed range that is standing on solid ground",
            """
        ...
        Spell(
            "Earthquake",
            7,
            "Everything in a \\areamed radius within \\rnglong range that is standing on solid ground",
            """
        ...
        Spell(
            "Swallowed by Earth",
            7,
            "One creature within \\rngmed range that is standing on earth or unworked stone",
            """
        ...
        Spell(
            "Earthbind",
            3,
            "One creature within \\rngmed range that is within 100 feet of the ground",
            """
        ...
        Spell(
            "Quagmire",
            4,
            "All earth and unworked stone in a \\areasmall radius within \\rnglong range",
            """
        ...
        Spell(
            "Volcano",
            5,
            "Everything in a \\areasmall radius from a point on solid ground within \\rngmed range",
            """
