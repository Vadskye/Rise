...
summon = MysticSphere(
    ...
    cantrips=[
        ...
        """,
            scaling="damage",
            tags=["Sustain (standard)", "Manifestation"],
        ),
    ],
    ...
    spells=[
        ...
        Spell(
            "Trampling Summon",
            1,
            "Everything on solid ground in a 5 ft.\\ wide, \\areamed line from you (see text)",
            """
        ...
        Spell(
            "Ramming Summon",
            1,
            "One creature on solid ground within \\rngmed range",
            """
        ...
        Spell(
            "Trampling Behemoth",
            3,
            "Everything on solid ground in a 10 ft.\\ wide, \\arealarge line from you (see text)",
            """
        ...
        Spell(
            "Trampling Stampede",
            6,
            "Everything on solid ground in a 20 ft.\\ wide, \\areahuge line from you (see text)",
            """
        ...
        Spell(
            "Summon Pegasus",
            5,
            "One unoccupied location on stable ground within \\rngmed range",
            """
