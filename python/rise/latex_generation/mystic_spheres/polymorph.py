...
polymorph = MysticSphere(
    ...
    cantrips=[
        Effects(
            "Alter Object",
            "One unattended, nonmagical object you touch",
            """
    ...
    spells=[
        ...
        Spell(
            "Piercing Grasp",
            1,
            "One creature within your \\glossterm<reach>",
            """
        ...
        Spell(
            "Stoneskin",
            1,
            "Yourself or an \\glossterm<ally> in \\rngmed range",
            """
            You can cast this spell as a \\glossterm<minor action>.
        ...
        Spell(
            "Extruding Spikeform",
            6,
            ["Yourself", "\\glossterm<Enemies> adjacent to you (see text)"],
            """
            You can cast this spell as a \\glossterm<minor action>.
        ...
        Spell(
            "Absorb Object",
            3,
            "One Small or smaller \\glossterm<unattended> object you touch",
            """
        ...
        Spell(
            "Brief Regeneration",
            2,
            "Yourself or one living \\glossterm<ally> within \\rngshort range",
            """
        ...
        Spell(
            "Eyebite",
            4,
            "One living creature within \\rngmed range",
            """
            Make an attack vs. Fortitude against the target.
        ...
        Spell(
            "Cripple",
            7,
            "One living creature within \\rngshort range",
            """
            Make an attack vs. Fortitude against the target.
    ...
    rituals=[
        Spell(
            "Create Handholds",
            1,
            "One inanimate wall up to 50 feet high and 10 feet wide within \\rngmed range",
            """
        ...
        Spell(
            "Craft Object",
            3,
            "Any number of unattended, nonmagical objects within \\rngshort range",
            """
        ...
        Spell(
            "Mending",
            1,
            "One \\glossterm<unattended> object within \\rngshort range",
            """
        ...
        Spell(
            "Morph Weapon",
            1,
            "One unattended manufactured weapon",
            """
        ...
        Spell(
            "Exotic Morph Weapon",
            3,
            "One unattended manufatured weapon",
            """
        ...
        Spell(
            "Fortify",
            1,
            "One \\glossterm<unattended>, nonmagical object or part of an object of up to Large size.",
            """
        ...
        Spell(
            "Ironwood",
            4,
            "One Small or smaller unattended, nonmagical wooden object within \\rngshort range",
            """
        ...
        Spell(
            "Purify Sustenance",
            1,
            "All food and water in a single square within \\rngshort range",
            """
        ...
        Spell(
            "Awaken",
            6,
            "One Large or smaller \\glossterm<ally> within \\rngmed range",
            """
        ...
        Spell(
            "Air Breathing",
            3,
            "One Medium or smaller ritual participant",
            """
