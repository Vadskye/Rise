...
aeromancy = MysticSphere(
    ...
    cantrips=[
        ...
        Effects(
            "Soften Landing",
            "Yourself or an \\glossterm<ally> within \\rnglong range",
            """
    ...
    spells=[
        ...
        Spell(
            "Propulsion",
            1,
            "Yourself or one Large or smaller \\glossterm<ally> in \\rngmed range",
            """
        ...
        Spell(
            "Windsnipe",
            3,
            "One creature or object within \\rngdist range",
            """
            Make an attack vs. Armor against the target.
        ...
        Spell(
            "Blast of Wind",
            5,
            "Everything in a \\areahuge, 10 ft. wide line from you",
            """
            Make an attack vs. Fortitude against each target.
        ...
        Spell(
            "Duststorm",
            4,
            "Creatures in a \\arealarge radius within \\rnglong range",
            """
            Make an attack vs. Reflex against each target.
            \\hit Each target is \\glossterm<dazzled> until the end of the next round.
            \\crit Each target is \\glossterm<dazzled> as a \\glossterm<condition>.
