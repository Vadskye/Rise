...
\featref{Extra Rage} & Ability to rage & Can rage 1 more time per day & \featpref{Extra Rage} \\
\featref{Extra Smiting}\fn{1} & Ability to smite & Can smite 3 more times per day & \featpref{Extra Smiting} \\
\featref{Extra Wild Aspect} & Wild aspect & Can use wild aspects 3 more times per day & \featpref{Extra Wild Aspect} \\
\featref{Intense Channeling} & Channel energy 3d6 & \plus1d6 damage or healing with channel energy & \featpref{Intense Channeling} \\
\featref{Mental Discipline} & Ability to use combat discipline & Use Charisma for combat discipline & \featpref{Mental Discipline} \\
\featref{Selective Channeling} & Ability to channel energy & Can exclude two additional creatures & \featpref{Selective Channeling} \\
