...
\featref{Intense Channeling} & Channel energy 3d6 & \plus2 level when channeling energy & \featpref{Intense Channeling} \\
...
\featref{Ritual Master} & Spellcraft 8 ranks, ability to perform rituals & Perform rituals more quickly, \plus3 to ritual checks & \featpref{Ritual Master} \\
...
\tind \featref{Combat Mobility} & Dex 3, base attack bonus \plus4, Dodge & Avoid some attacks of opportunity from selected target & Defense, Mobility & \featpref{Combat Mobility} \\
\tind \tind \featref{Spring Attack} & Dex 3, base attack bonus \plus4, Dodge, Combat Mobility & Move before and after attacks & Mobility, Style & \featpref{Spring Attack} \\
...
\tind \featref{Riposte} & Dex 3, base attack bonus \plus4, Parry & Foes provoke if you parry very well & Reaction & \featpref{Riposte} \\
...
\featref{Trample} & Ride 8 ranks & Target cannot avoid mounted overrun & Mobility, Mounted & \featpref{Trample} \\
...
\parhead{Benefit} You can perform rituals in half the normal time. In addition, you gain a \plus3 bonus to checks made to perform rituals.
