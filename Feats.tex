...
{\small
    ...
    \begin{longtabu}{>{\lcol}p{10em} >{\lcol}p{15em} >{\lcol}X >{\lcol}p{6em} >{\lcol}p{3em}}
        ...
        \midrule
        \thead{Combat Feats} & \thead{Prerequisites} & \thead{Benefit} & \thead{Feat Types} & \thead{Page} \\
        \featref{Contingent Counter} & Int 5, two attacks & Prepare to attack when attack misses you & Reaction & \featpref{Contingent Counter} \\
        ...
        \featref{Tactical Prediction} & Int 5, Two attacks & Predict foe's next action & Awareness & \featpref{Tactical Prediction} \\
        ...
        \midrule
        \thead{Combat Feats} & \thead{Prerequisites} & \thead{Benefit} & \thead{Feat Types} & \thead{Page} \\
        \featref{Contingent Attack} & Int 10, three attacks & Prepare to attack as immediate action & Reaction & \featpref{Contingent Attack} \\
        ...
        \featref{Hurricane Strike} & Dex 15, Whirlwind Strike, four attacks & Two melee attacks against all threatened foes & Strike & \featpref{Hurricane Strike} \\
        \tind \featref{Mobile Hurricane} & Dex 15, Hurricane Strike, Mobile Whirlwind, Whirlwind Strike, four attacks & Use hurricane strike as standard action & Mobility & \featpref{Hurricane Strike} \\
    \end{longtabu}
    \begin{enumerate*}
