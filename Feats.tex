...
{\small
    ...
    \begin{longtabu}{>{\lcol}p{10em} >{\lcol}p{15em} >{\lcol}X >{\lcol}p{6em} >{\lcol}p{3em}}
        ...
        \featref{Dodge} & Dex 5, two attacks & Gain bonus to physical defenses & Defense, Reaction & \featpref{Dodge} \\
        \featref{Eye of the Storm} & Per 5, two attacks & Reduce overwhelm penalties & Awareness, Defense & \featpref{Eye of the Storm} \\
        \featref{Gang Up} & Per 5, two attacks & Increase overwhelm penalties foes suffer & \x & \featpref{Gang Up} \\
        ...
        \featref{Two-Weapon Rend} & Str 5, Mighty Blows, Two-Weapon Fighting, two attacks & Deal Strength damage with both weapons & Power & \featpref{Two-Weapon Rend} \\
...
{\small
    ...
    \begin{longtabu}{>{\lcol}p{10em} >{\lcol}p{15em} >{\lcol}X >{\lcol}p{6em} >{\lcol}p{3em}}
        ...
        \featref{Inescapable Bulwark} & Two attacks & Enemies you are blocking cannot move & Reaction, Style & \featpref{Inescapable Bulwark} \\
...
{\small
    \taburowcolors [2] 2{tbrown .. white}
    \begin{longtabu}{>{\lcol}p{10em} >{\lcol}p{15em} >{\lcol}X >{\lcol}p{6em} >{\lcol}p{3em}}
        \thead{Strike Feats} & \thead{Prerequisites (two attacks)} & \thead{Benefit} & \thead{Feat Types} & \thead{Page} \\
        \featref{Calculated Strike} & Int 5, two attacks & Attack can deal critical damage & Precision, Strike & \featpref{Calculated Strike} \\
        \featref{Countering Strike} & Int 5, two attacks & Bonus damage if you are attacked & Reaction, Strike & \featpref{Countering Strike} \\
        \featref{Disorienting Strike} & Two attacks & Attack disorients foe & Power, Strike & \featpref{Disorienting Strike} \\
        \featref{Driving Assault} & Str 5, two attacks & Shove foe and full attack  & Power, Maneuver, Strike & \featpref{Driving Assault} \\
        \featref{Immobilizing Strike} & Two attacks & Melee attack immobilizes foe & Strike & \featpref{Immobilizing Strike} \\
        \featref{Intimidating Strike} & Two attacks, Intimidate 8 ranks & Melee attack intimidates foe & Strike & \featpref{Intimidating Strike} \\
        \featref{Knockdown} & Str 5, two attacks & Shove foe and knock prone & Maneuver, Power, Strike & \featpref{Knockdown} \\
        \featref{Pierce Wings} & Per 5, two attacks & Ranged attack removes foe's ability to fly & Precision, Strike & \featpref{Pierce Wings} \\
        \featref{Staggering Strike} & Two attacks & Attack staggers foe & Strike & \featpref{Staggering Strike} \\
        \featref{Wall Slam} & Str 5, two attacks & Slam opponent into wall to deal bonus damage & Maneuver, Power, Strike & \featpref{Wall Slam} \\
        ...
        \tind \featref{Mobile Whirlwind} & Dex 5, Whirlwind Strike, two attacks & Use whirlwind strike as standard action & Mobility & \featpref{Mobile Whirlwind} \\

        \midrule
        \thead{Strike Feats} & \thead{Prerequisites (three attacks)} & \thead{Benefit} & \thead{Feat Types} & \thead{Page} \\
        \featref{Killing Blow} & Int 10, three attacks & Attack instantly kills foe without hit points & Precision, Strike & \featpref{Killing Blow} \\
        \featref{Legendary Strike} & Three attacks, any three Strike feats & \plus2 to hit with strikes & \x & \featpref{Legendary Strike} \\
        \featref{Patient Strike} & Int 10, two three attacks & Bonus damage if you are not attacked & Reaction, Strike & \featpref{Patient Strike} \\
        \featref{Penetrating Strike} & Three attacks & Attack removes foe's damage reduction & Strike & \featpref{Penetrating Strike} \\

        \midrule
        \thead{Strike Feats} & \thead{Prerequisites (four attacks)} & \thead{Benefit} & \thead{Feat Types} & \thead{Page} \\
        ...
        \featref{Predictive Strike} & Int 15, four attacks & Bonus damage if foe takes predicted action & Reaction, Strike & \featpref{Predictive Strike} \\
    \end{longtabu}
}%end of small text
...
\featben You treat your unarmed attack as if it were a lethal weapon.
...
If you hit, you deal damage normally, and you can make an Intimidate check against the target to demoralize it (see \pcref{Demoralize}).
...
\featben You gain a \plus2 attack bonus with strikes.
...
As a swift action, you can make a special check with a bonus equal to your base attack bonus or your Intelligence \add 2 per round you have seen the creature fight.
