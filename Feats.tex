...
\begin{itemize*}
    ...
    \item Style feats change the way a character fights. A character can only use one style at a time.
...
Deeper Spellgift & \x & \plus2 Cha for spellgift feats \\
...
\feat{Deeper Spellgift}{Spellgift}
\featben You treat your Charisma as if it were 2 higher for the purpose of spellgift feats.
