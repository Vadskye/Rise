...
{\small
    ...
    \begin{longtabu}{>{\lcol}p{10em} >{\lcol}p{15em} >{\lcol}X >{\lcol}p{6em} >{\lcol}p{3em}}
        ...
        \tind\featref{Cleaving Smite} & Smite ability, base attack bonus \plus4, Cleave & Extra attack from Cleave is also a smite & Power & \featpref{Cleaving Smite} \\
...
\parhead{Benefit} If you make a melee attack that knocks a creature unconscious or kills it, you can immediately make an extra melee attack at the same attack bonus against another creature you threaten. The extra attack must be made with the same weapon, and it includes all bonuses and penalties that applied to the original attack. You cannot move before making this extra attack. There is no limit to the number of times you can use this feat per round.
...
\parhead{Prerequisite} Dex 3.
\parhead{Benefit} You gain a \plus1 bonus to physical attacks when attacking with two weapons at once. This bonus increases to \plus2 if both weapons are light.
