...
Each performance has an effect when it is used. Some performances can also be sustained. While you are sustaining a performance, you cannot cast spells, activate magic items by spell completion (such as scrolls), or activate magic items by magic word (such as wands). You can sustain a performance for a number of minutes equal to 5 \add your Constitution before you must stop performing. 
...
\tind Deflect Arrows & Dex 3, Improved Unarmed Strike & Deflect one ranged attacks with your bare hands & Defense, Reaction \\
\tind \tind Snatch Arrows & Dex 5, Deflect Arrows, Improved Unarmed Strike & Catch a deflected ranged attack & Defense, Reaction \\
\tind Stunning Fist & Dex 3, Wis 3, Improved Unarmed Strike, base attack bonus \plus4 & Stun opponent with unarmed strike & Precision, Strike \\
...
Intimidating Strike & Base attack bonus \plus4, Intimidate 8 ranks & Attack lets you intimidate struck foe & Strike \\
Killing Blow & Base attack bonus \plus16 & Attack kills bloodied foe & Strike \\
Knockdown & Str 3, base attack bonus \plus4 & Bull rushed foe can be knocked prone \\
...
Sickening Strike & Base attack bonus \plus8 & Attack sickens foe & Strike \\
...
%\subsubsection{Legendary Dexterity [General]}
...
%\subsubsection{Legendary Intelligence [General]}
...
\featpre Perform 4 ranks.
\featben As a standard action, you can make a DC 8 Perform check to fascinate a creature within \rngmed range of you. It can make a Will save against your Perform check to resist the effect. You can sustain the performance as a standard action.

An affected creature is sits quietly and observes your performance, taking no other actions, for as long as you play. While fascinated, it takes a \minus4 penalty on checks made as reactions, such as Perception checks and initiative checks. Any potential threat allows the creature a new saving throw.Any obvious threat, such as someone drawing a weapon, casting a spell, or aiming a ranged weapon at the target, automatically breaks the effect. You can affect an additional creature at 8 Perform ranks and every 4 perform ranks thereafter.
...
\featpre Perform 4 ranks.
\featben As a standard action, you can make a DC 8 Perform check to inspire competence in any ally within \rngmed range of you, including yourself. The affected creature gains a \plus2 enhancement bonus on skill checks made with a particular skill. This bonus increases by 1 at 8 Perform ranks and every 5 Perform ranks thereafter. You can sustain the performance as a swift action.
...
\featben As a standard action, you can make a DC 12 Perform check to inspire courage in up to five allies within \rngmed range of you, including yourself. All affected creatures gain a \plus2 enhancement bonus on attack rolls and saving throws against fear. This bonus increases by 1 at 10 Perform ranks and every 4 Perform ranks thereafter. You can sustain the performance as a swift action. 

You can use any combination of performance feats you possess a number of times per day equal to the number of performance feats you have \add half your Charisma. If you fail the Perform check, the use of the ability is wasted. This is a mind-affecting ability.

\subsubsection{Inspire Greatness [Performance, Skill]}
\featpre Perform 14 ranks.
\featben As a standard action, you can make a DC 24 Perform check to inspire greatness in up to five allies within \rngmed range of you, including yourself. All affected creatures gain a \plus3 enhancement bonus to saving throws and dodge modifier. This bonus increases by 1 at 16 Perform ranks and every 4 Perform ranks thereafter. 

You can use any combination of performance feats you possess a number of times per day equal to the number of performance feats you have \add half your Charisma. If you fail the Perform check, the use of the ability is wasted. This is a mind-affecting ability.

\subsubsection{Inspire Heroics [Performance, Skill]}
\featpre Perform 18 ranks.
\featben As a standard action, you can make a DC 32 Perform check to inspire heroics in up to five allies within \rngmed range of you, including yourself. All affected creatures gain temporary hit points equal to your check result and can take an extra attack at a \minus5 penalty when making a full attack. This extra attack is not cumulative with similar effects. You can sustain the performance as a swift action.

\subsubsection{Inspire Spellpower [Performance, Skill]}
\featpre Perform 8 ranks.
\featben As a standard action, you can make a DC 16 Perform check to inspire spellpower in up to five allies within \rngmed range of you, including yourself. All affected creatures gain a \plus1 enhancement bonus to their caster level with spells and spell-like abilities. This bonus increases by 1 at 12 Perform ranks and every 4 Perform ranks thereafter. You can sustain the performance as a swift action.

You can use any combination of performance feats you possess a number of times per day equal to the number of performance feats you have \add half your Charisma. If you fail the Perform check, the use of the ability is wasted.

\subsubsection{Rapid Performance [Performance, Skill]}
\featpre Perform 12 ranks, any three Performance feats.
\featben You can use performance feats as a swift action by taking a \minus5 penalty on the Perform check to activate the ability.
...
\featben As a swift action, you can make a DC 20 Perform check to suggest an action to a single creature you are currently fascinating with the Fascinating Performance feat. This functions as the \spell{suggestion} spell, with a saving throw DC equal to your Perform check.
...
%\subsubsection{Battletrance [Combat]}
...
\subsubsection{Blind-Fight [Combat]}
...
\subsubsection{Knockdown [Combat, Maneuver, Power]}
...
\parhead{Benefit} You gain a \plus2 circumstance bonus to your Combat Maneuver Defense. In exchange, you take a \minus2 penalty to damage rolls. At base attack bonus \plus5, and every 5 base attack bonus thereafter, you increase the bonus and penalty by 1.
...
\parhead{Prerequisites} Base attack bonus \plus4
\parhead{Benefit} You gain a \plus3 circumstance bonus to Combat Maneuver Defense. In exchange, you are unable to move. At base attack bonus \plus8, and every 4 base attack bonus thereafter, you increase the bonus by 1.
...
\featpres Base attack bonus \plus4, Intimidate 8 ranks.
\featben When you attack, you may take a \minus2 penalty to hit. If you deal damage, you may make an Intimidate check as an immediate action to demoralize the foe you struck if it is within 30 feet of you. You cannot make more than one Strike each round.
...
\subsubsection{Penetrating Strike [Combat, Strike]}
\featpre Base attack bonus \plus12.
...
\subsubsection{Healing Surge [Surge]}
