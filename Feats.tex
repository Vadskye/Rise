...
{\small
    ...
    \begin{longtabu}{>{\lcol}p{10em} >{\lcol}p{15em} >{\lcol}X >{\lcol}p{3em}}
        ...
        \featref{Craftcaster} & Craft (any) 10 ranks, 2nd level spells & Increase caster level when creating, transforming objects & \featpref{Craftcaster} \\
        ...
        \featref{Rapid Metamagic} & Spellcraft 10 ranks, spellcasting ability, one metamagic feat & Apply metamagic effects more quickly & \featpref{Rapid Metamagic} \\
        ...
        \featref{Inspire Spellpower} & Perform 10 ranks  & Grant allies bonus to caster level & \featpref{Inspire Spellpower} \\
...
{\small
    ...
    \begin{longtabu}{>{\lcol}p{10em} >{\lcol}p{15em} >{\lcol}X >{\lcol}p{6em} >{\lcol}p{3em}}
        ...
        \featref{Intimidating Strike} & \x, Intimidate 10 ranks & Melee attack intimidates foe & Strike & \featpref{Intimidating Strike} \\
