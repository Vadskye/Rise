...
{\small
    ...
    \begin{longtabu}{>{\lcol}p{10em} >{\lcol}p{15em} >{\lcol}X >{\lcol}p{3em}}
        ...
        \featref{Great Fortitude} & Con 3 & \plus2 bonus to Fortitude defense & \featpref{Great Fortitude} \\
        \featref{Iron Will} & Wil 3 & \plus2 bonus to Will defense & \featpref{Iron Will} \\
        \featref{Lightning Reflexes} & Dex 3 &  \plus2 bonus to Reflex defense & \featpref{Lightning Reflexes} \\
        \featref{Mental Resilience} & Wil 3 & Gain bonus hit points & \featpref{Mental Resilience} \\
        ...
        \featref{Toughness} & Con 3 & Gain bonus hit points & \featpref{Toughness} \\
...
{\small
    ...
    \begin{longtabu}{>{\lcol}p{10em} >{\lcol}p{15em} >{\lcol}X >{\lcol}p{6em} >{\lcol}p{3em}}
        ...
        \featref{Close-Quarters Fighting} & Dex 3, attack bonus \plus2 & No penalty for squeezing or attacking while grappling & Defense & \featpref{Close-Quarters Fighting} \\
        ...
        \featref{Deadly Aim} & Per 5, two attacks & Gain bonus damage with ranged weapons & Precision & \featpref{Deadly Aim} \\
        ...
        \featref{Insightful Defense} & Per 5, two attacks & Use Perception for defenses & Awareness, Defense & \featpref{Insightful Defense} \\
        \featref{Mighty Blows} & Str 5, two attacks & Gain bonus damage with melee weapons & Power & \featpref{Mighty Blows} \\
        \featref{Mighty Shot} & Str 5, two attacks & Gain bonus damage with ranged weapons & Power & \featpref{Mighty Shot} \\
        ...
        \featref{Predictive Defense} & Int 5, two attacks & Use Intelligence for defenses & Awareness, Defense & \featpref{Predictive Defense} \\
        ...
        \featref{Weapon Finesse} & Dex 5, two attacks & Gain bonus damage with light weapons & Finesse & \featpref{Weapon Finesse} \\
        ...
        \featref{Manyshot} & Dex 10, three attacks & Shoot two projectiles simultaneously & Finesse & \featpref{Manyshot} \\
...
{\small
    ...
    \begin{longtabu}{>{\lcol}p{10em} >{\lcol}p{15em} >{\lcol}X >{\lcol}p{6em} >{\lcol}p{3em}}
        ...
        \featref{Power Attack} & Str 3 & Gain bonus damage with melee weapons & Power, Style & \featpref{Power Attack} \\
        \featref{Power Shot} & Str 3 & Gain bonus damage with ranged weapons & Power, Style & \featpref{Power Shot} \\
        \midrule
        \thead{Style Feats} & \thead{Prerequisites (two attacks)} & \thead{Benefit} & \thead{Feat Types} & \thead{Page} \\
        \featref{Covering Fire} & Per 5, two attacks & Impair struck foes & Precision, Style & \featpref{Covering Fire} \\
        \featref{Heartseeker} & Two attacks & Double critical threat range & Precision, Style & \featpref{Heartseeker} \\
        ...
        \featref{Precise Shot} & Per 5, two attacks & Ignore less than perfect cover and concealment & Precision, Style & \featpref{Precise Shot} \\
        ...
        \featref{Spring Attack} & Dex 5, two attacks, Combat Mobility & Move before and after attacks & Mobility, Style & \featpref{Spring Attack} \\
        \featref{Threatening Fire} & Dex 5, Overwhelming Fire, two attacks & Threaten adjacent creatures with a ranged weapon & Reaction, Style & \featpref{Threatening Fire} \\

        \midrule
        \thead{Style Feats} & \thead{Prerequisites (three attacks)} & \thead{Benefit} & \thead{Feat Types} & \thead{Page} \\
        \featref{Legendary Style} & Three attacks, any three Style feats & Use two styles at once & \x & \featpref{Legendary Style} \\

        \midrule
        \thead{Style Feats} & \thead{Prerequisites (four attacks)} & \thead{Benefit} & \thead{Feat Types} & \thead{Page} \\
        \featref{Counterstorm} & Per 15, four attacks & Gain bonuses against foes that miss you & Awareness, Reaction, Style & \featpref{Counterstorm} \\
    \end{longtabu}
}%end of small text
...
\feat{Blind-Fight}{Awareness, Combat}
...
\par If your Perception is 10, you can automatically pinpoint the location of any invisible creature adjacent to you.
\parhead{Normal}
...
\featpre Perception 15, four attacks.
\featben Whenever a foe misses you with a melee attack, you gain a cumulative \plus2 bonus to attack and damage on your next melee attack against that creature.
...
\feat{Deadly Aim}{Combat, Precision}
\featpres Per 5, two attacks.
\featben You gain a \plus1 bonus to physical ranged damage rolls.
This bonus increases to \plus2 at Perception 10, and to \plus3 at Perception 20.
...
This bonus increases to \plus4 at Constitution 10, and to \plus6 at Constitution 20.
...
\featpre Two attacks.
\featben While in this style, if you take the block action, all enemies you threaten are \immobilized during the current phase (see \pcref{Block}).
This effect can interrupt and prevent their movement during that phase.
\stylereq Wield a melee weapon.
You must make a melee attack each round.

\feat{Insightful Defense}{Awareness, Combat, Defense}
\featpre Perception 5, two attacks per round.
...
This bonus increases to \plus4 at Willpower 10, and to \plus6 at Willpower 20.
...
This bonus increases to \plus4 at Dexterity 10, and to \plus6 at Dexterity 20.
...
\feat{Mental Resilience}{General}
\featpre Willpower 3.
...
\featben While in this style, you gain a \plus2 bonus to physical ranged attacks when attacking targets within half of your range increment.
\stylereq Wield a ranged weapon.
...
\featpre Dexterity 5, Overwhelming Fire, two attacks.
...
\featpres Dexterity 5, two attacks.
