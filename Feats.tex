...
\parhead{Benefit} While in this style, you gain a \plus2 circumstance bonus on ranged damage rolls. In exchange, you take a \minus2 penalty on ranged attack rolls. At base attack bonus \plus4, and every 4 base attack bonus thereafter, the penalty increases by 1 and the bonus increases by 2.
...
\parhead{Benefit} While in this style, you gain a \plus3 circumstance bonus to Maneuver Class. In exchange, you are unable to move. At base attack bonus \plus8, and every 4 base attack bonus thereafter, you increase the bonus by 1.
...
\featben While in this style, as part of a standard attack, you may provoke an attack of opportunity from one opponent threatening you. You gain a \plus4 circumstance bonus to armor class against this attack. If the opponent takes the attack of opportunity, they are flat-footed against your next attack. This effect lasts for 1 round.
...
\parhead{Prerequisite} Dex 3.
\parhead{Benefit} While in this style, you gain a \plus2 circumstance bonus to attack and damage on attacks of opportunity. In exchange, you take a \minus2 penalty to attacks that are not attacks of opportunity. At base attack bonus \plus4, and every 4 base attack bonus thereafter, you increase the bonus and penalty by 1.

\feat{Overpowering Assault}{Combat, Style}
\parhead{Prerequisite} Str 3.
\parhead{Benefit} While in this style, you take a \minus2 penalty to AC and gain a \plus2 circumstance bonus to maneuvers. At base attack bonus \plus4, and every 4 base attack bonus thereafter, you increase the bonus and penalty by 1. The penalty to AC lasts until the start of the next turn after you end the style.
...
\begin{itemize*}
    ...
    \item Axes: You gain a \plus2 circumstance bonus to attack against unarmored creatures (creatures without an armor modifier to AC). 
    \item Blades, heavy: You gain a \plus2 circumstance bonus to attack against unarmored creatures (creatures without an armor modifier to AC).
    ...
    \item Flexible weapons: You gain a \plus2 circumstance bonus to attack creatures with a shield modifier to AC.
    \item Headed weapons: You gain a \plus2 circumstance bonus to attack against armored creatures (creatures with an armor modifier to AC).
    \item Monk weapons: ??
