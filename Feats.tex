...
Some style feats have style requirements. To gain the benefits of a combat style with a style requirement, a character fulfill some condition during his turn. If the condition is not met, the character automatically stops fighting in that style at the end of his turn. For example, a character using the Distracting Foe style must be wielding a melee weapon. If the character stops wielding a melee weapon, he stops using the Distracting Foe style at the end of his turn.
...
\parhead{Benefit} While in this style, you gain a \plus2 circumstance bonus to your Maneuver Class. In exchange, you take a \minus2 penalty to damage rolls. At base attack bonus \plus4, and every 4 base attack bonus thereafter, you increase the bonus and penalty by 1.
...
\parhead{Style Requirement} Must wield a melee weapon and take the standard attack or total defense actions each round.
...
\parhead{Prerequisites} Base attack bonus \plus4.
\parhead{Benefit} While in this style, foes you threaten take a \minus2 penalty to Concentration checks. In exchange, you take a \minus2 penalty to armor class against melee attacks. At base attack bonus \plus4, and every 4 base attack bonus thereafter, you increase both penalties by 1.
...
\parhead{Benefit} While in this style, as a full-round action, you can make a single melee attack against each opponent you threaten. In exchange, you take a \minus4 penalty to attack.
