...
{\small
    ...
    \begin{longtabu}{>{\lcol}p{10em} >{\lcol}p{15em} >{\lcol}X >{\lcol}p{6em} >{\lcol}p{3em}}
        ...
        \featref{Close-Quarters Fighting} & Dex 3, attack bonus \plus4 & Fight better in grapples and while squeezing & Style & \featpref{Close-Quarters Fighting} \\
