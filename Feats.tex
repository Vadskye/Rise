...
{\small
    ...
    \begin{longtabu}{>{\lcol}p{10em} >{\lcol}p{15em} >{\lcol}X >{\lcol}p{6em} >{\lcol}p{3em}}
        ...
        \featref{Riposte} & Dex 3, base attack bonus \plus2, Parry & Foes provoke if you parry very well & Reaction & \featpref{Riposte} \\
        ...
        \featref{Legendary Maneuver Master} & Base attack bonus \plus10, any three Maneuver feats & Never provoke, deal damage with very successful maneuvers & Maneuver & \featpref{Legendary Maneuver Master} \\
...
{\small
    ...
    \begin{longtabu}{>{\lcol}p{10em} >{\lcol}p{15em} >{\lcol}X >{\lcol}p{6em} >{\lcol}p{3em}}
        ...
        \midrule
        \thead{Style Feats} & \thead{Prerequisites} & \thead{Benefit} & \thead{Feat Types} & \thead{Page} \\
        \featref{Feign Weakness} & Base attack bonus \plus6 & Provoke attack to gain bonus to hit & Style & \featpref{Feign Weakness} \\
        ...
        \midrule
        \thead{Style Feats} & \thead{Prerequisites} & \thead{Benefit} & \thead{Feat Types} & \thead{Page} \\
        \featref{Counterstorm} & Base attack bonus \plus14 & Foes that miss you provoke & Reaction, Style& \featpref{Counterstorm} \\
    \end{longtabu}
}%end of small text
...
\featben Whenever a foe misses you with a melee attack, you gain a cumulative \plus2 bonus to damage on your next physical melee attack against that creature. In exchange, you cannot take the block action.
