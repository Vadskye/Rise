...
\begin{longtabu}{>{\lcol}p{10em} >{\lcol}p{15em} >{\lcol}X >{\lcol}p{3em}}
    ...
    \featref{Legendary Charisma} & 11th level, Cha 6 & \plus5 to Charisma for some purposes & \featpref{Legendary Charisma} \\
    \featref{Legendary Constitution} & 11th level, Con 6 & \plus5 to Constitution for some purposes & \featpref{Legendary Constitution} \\
    \featref{Legendary Dexterity} & 11th level, Dex 6 & \plus5 to Dexterity for some purposes & \featpref{Legendary Dexterity} \\
    \featref{Legendary Intelligence} & 11th level, Int 6 & \plus5 to Intelligence for some purposes & \featpref{Legendary Intelligence} \\
    \featref{Legendary Strength} & 11th level, Str 6 & \plus5 to Strength for some purposes & \featpref{Legendary Strength} \\
    \featref{Legendary Wisdom} & 11th level, Wis 6 & \plus5 to Wisdom for some purposes & \featpref{Legendary Wisdom} \\
    ...
    \featref{Intuitive Fighter} & Adaptive style ability & Use Wisdom for adaptive style (and battlemaster) & \featpref{Intuitive Fighter} \\
    ...
    \featref{Savvy Rogue} & Combat trick ability & Use Charisma for combat tricks & \featpref{Savvy Rogue} \\
...
{\small
    ...
    \begin{longtabu}{>{\lcol}p{10em} >{\lcol}p{15em} >{\lcol}X >{\lcol}p{6em} >{\lcol}p{3em}}
        ...
        \featref{Combat Mobility} & Dex 3, base attack bonus \plus2 & Avoid movement-based attacks of opportunity from foe & Defense, Mobility & \featpref{Combat Mobility} \\
        ...
        \featref{Improved Trip} & Base attack bonus \plus2 & \plus2 bonus to trip attacks; tripped foe provokes attacks of opportunity & Finesse, Maneuver & \featpref{Improved Trip} \\
        \featref{Intuitive Reaction} & Wis 3, base attack bonus \plus2 & Add half Wisdom to number of attacks of opportunity each round & Reaction & \featpref{Intuitive Reaction} \\
        ...
        \featref{Legendary Mobility} & Base attack bonus \plus10, any three Mobility feats & Movement does not provoke & Mobility& \featpref{Legendary Mobility} \\
...
{\small
    ...
    \begin{longtabu}{>{\lcol}p{10em} >{\lcol}p{15em} >{\lcol}X >{\lcol}p{6em} >{\lcol}p{3em}}
        ...
        \featref{Opportunist} & Dex 3, base attack bonus \plus2 & \plus2 to attack and damage on attacks of opportunity & Reaction, Style & \featpref{Opportunist} \\
        ...
        \featref{Inescapable Bulwark} & Dex 3, Base attack bonus \plus6 & Withdrawing enemies cannot avoid provoking attacks of opportunity & Reaction, Style & \featpref{Inescapable Bulwark} \\
        \featref{Intuitive Defense} & Wis 3, base attack bonus \plus6 & Add half Wisdom to defense in place of Dex & Awareness, Defense, Style & \featpref{Intuitive Defense} \\
...
\parhead{Prerequisites} Nonevil alignment, Celestial Heritage.
\parhead{Benefit} Your smite attacks with your Celestial Heritage ability gain an attack bonus equal to the number of celestial bloodline feats you possess. In addition, you can use that ability a number of times per day equal to the number of celestial bloodline feats you have \add your Charisma.
...
If you are 12th level, you gain a fly speed equal to your land speed with average maneuverability. See \pcref{Flying}, for more details. You can only fly for a number of rounds equal to 3 \add half your Charisma. After that limit is reached, you must rest for 5 minutes before flying again.

If you are 18th level, you can fly for a number of minutes equal to 3 \add half your Charisma before resting.
...
\parhead{Benefit} As a free action, you may choose a creature you can see. When you move, you do not provoke attacks of opportunity from that creature.
...
\featpre Base attack bonus \plus6.
\featben While in this style, as part of a standard attack, you may provoke an attack of opportunity from one opponent threatening you. You gain a \plus3 bonus to physical defenses against this attack. Unless the creature hits you on the attack of opportunity, you gain a \plus3 bonus to your next attack against it, provided the attack is made within 1 round. At base attack bonus \plus6, and every 4 base attack bonus thereafter, these bonuses increase by 1.
\stylereq Wield a melee weapon. You must take a standard attack action each round.
...
\parhead{Benefit} You treat your unarmed strike as if it were a lethal weapon. This allows you to defend yourself and takes attacks of opportunity while unarmed, just as if you were using another melee weapon.
...
\featpre Base attack bonus \plus6.
\featben While in this style, foes that take a withdraw action to move away from you still provoke attacks of opportunity from you. In exchange, you take a \minus4 penalty to physical defenses against attacks of opportunity you provoke by moving.
\stylereq Wield a melee weapon. You must take a standard attack or charge action each round.
...
\featpre Wis 3, base attack bonus \plus6.
...
\featpres Wisdom 3, base attack bonus \plus2.
...
\feat{Opportunist}{Combat, Reaction, Style}
\parhead{Prerequisite} Dex 3, base attack bonus \plus2.
\parhead{Benefit} While in this style, you gain a \plus2 bonus to attack and damage on attacks of opportunity. In exchange, you take a \minus2 penalty to physical attacks that are not attacks of opportunity.
\stylereq Wield a melee weapon. You must take a standard attack or charge action each round.
...
\featpre Base attack bonus \plus2.
\parhead{Benefit} While in this style, you can ignore a number of creatures equal to your Wisdom (minimum 1) when determining whether targets have active cover from you when making ranged attacks. In exchange, you must spend a full-round action to make a standard attack.
\stylereq Wield a ranged weapon. You must take a standard attack action each round.
...
\featpre Base attack bonus \plus6.
\featben While in this style, you are unable to defend yourself normally, causing you to provoke attacks of opportunity each time you attack. In exchange, you gain a \plus3 bonus to physical damage with melee attacks.
\stylereq Wield a melee weapon. You must take a standard attack or charge action each round.
