...
\stylepre Wield a melee weapon. You must take a standard attack or total defense action each round.
...
\stylepre Wield a melee weapon. You must take a standard attack, charge, or total defense action each round.
...
\stylepre Wield a ranged weapon. You must take a standard attack action each round.
...
\stylepre Wield a melee weapon. You must take a standard attack or charge action each round.
...
\parhead{Benefit} You gain a \plus1 bonus to your armor defense modifier.
...
\parhead{Benefit} You gain scaly wings that sprout from your back. These allow you to slow your fall so you fall no more than 60 feet per round, preventing you from taking falling damage. If you are 8th level, you can use the wings to glide at a rate equal to your base land speed. While gliding, you move forward each round at a rate equal to your base land speed, and you descend at a rate of 10 feet per round.
...
\stylepre Wield a melee weapon. You must take a standard attack action each round.
...
\stylepre Wield a weapon. You must take a standard attack or charge action each round.
...
\parhead{Benefit} While in this style, you can add half your Wisdom to damage with ranged attacks in addition to half your Strength. Additionally, you can ignore one creature when determining whether targets have active cover from you. In exchange, you must spend a full-round action to make a standard attack.
\stylepre Wield a ranged weapon. You must take a standard attack action each round.
...
\parhead{Benefit} As a full-round action, you can move up to your speed and make your standard attack. You must move at least 5 feet after each attack you make before you can make another attack. You cannot use this style while \encumbered.
