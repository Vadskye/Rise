...
{\small
    ...
    \begin{longtabu}{>{\lcol}p{10em} >{\lcol}p{15em} >{\lcol}X >{\lcol}p{6em} >{\lcol}p{3em}}
        ...
        \featref{Unshakeable Stance} & Base attack bonus \plus4 & Trade ability to move for bonuses against approaching foes & Defense, Style & \featpref{Unshakeable Stance} \\
...
\parhead{Prerequisites} Base attack bonus \plus4.
\parhead{Benefit} While in this style, you gain a \plus3 bonus to Maneuver Class. In exchange, you are \immobilized. At base attack bonus \plus8, and every 4 base attack bonus thereafter, you increase the bonus by 1.
\stylepre Wield a melee weapon. You must take a standard attack or total defense action each round.
