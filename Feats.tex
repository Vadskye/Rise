...
\tind Weapon Specialization\footnotetemp{1} & Base attack bonus \plus8, proficiency with weapon group, Weapon Focus with weapon group & \plus2 to attack, \minus2 with other weapons & Equipment \\
...
\featben You gain a \plus2 competence bonus to attack with weapons from the selected weapon group. In exchange, you take a \minus2 penalty to attack with with all weapons to which you have not applied any Weapon Focus feat. This penalty does not affect non-weapon attacks, such as many combat maneuvers.
