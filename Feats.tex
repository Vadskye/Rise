...
\tind Draconic Armor & Draconic Heritage & Gain natural armor \\
...
\subsubsection{Acrobatic Charge [Combat]}
\parhead{Prerequisite} Acrobatics 8 ranks.
\parhead{Benefit} Difficult terrain does not prevent you from charging.
\parhead{Normal} You cannot charge in difficult terrain.
