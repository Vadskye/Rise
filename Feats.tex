...
\parhead{Prerequisites} Base attack bonus \plus4
\parhead{Benefit} When you shove a creature, you do not need to move with it to move it beyond your reach. You also gain a \plus2 competence bonus on shove attacks.
...
\parhead{Prerequisites} Base attack bonus \plus4
\parhead{Benefit} When you perform a dirty trick on a cretaure successfully, the creature is vulnerable for 1d4 rounds. You also gain a \plus2 competence bonus on dirty trick attacks.

\feat{Improved Disarm}{Combat, Finesse}
\parhead{Prerequisites} Base attack bonus \plus4
\parhead{Benefit} When you knock an item away from a creature, you can make it land up to 15 feet away in a random direction. You also gain a \plus2 competence bonus on disarm attacks.

\feat{Improved Feint}{Combat, Finesse}
\parhead{Prerequisites} Base attack bonus \plus4
\parhead{Benefit} When you feint against a creature, it remains flat-footed until it is struck by an attack. You also gain a \plus2 competence bonus to feint attacks.
...
\parhead{Prerequisites} Base attack bonus \plus4
\parhead{Benefit} Grappling does not make you flat-footed against other creatures. You also gain a \plus2 competence bonus on grapple attacks.
...
\parhead{Prerequisites} Base attack bonus \plus4
\parhead{Benefit} When you attempt to overrun a foe, the creature may not choose to avoid you unless you let it. You also gain a \plus2 competence bonus on overrun attacks.
...
\featben You gain a \plus5 competence bonus to Charisma-based checks. 
...
\featben You gain a \plus5 competence bonus to Constitution-based checks. In addition, you treat your Constitution as being 5 higher for the purpose of feats of endurance such as holding your breath or sprinting.
...
\featben You gain a \plus5 competence bonus to Dexterity-based checks, as well as to initiative.
...
\featben You gain a \plus5 competence bonus to Intelligence-based checks. In addition, you can memorize information perfectly to recall later.
...
\featben You gain a \plus5 competence bonus to Strength-based checks. In addition, you treat your Strength as being 5 higher for the purpose of determining your carrying and lifting capacity.
...
\featben You gain a \plus5 competence bonus to Wisdom-based checks. In addition, once per day you can receive a prophetic insight into future events, as the \spell{divination} ritual.
...
\parhead{Benefit} While in this style, you get a \plus2 competence bonus on damage rolls with ranged weapons when attacking targets within half of your range increment with your weapon. In exchange, you take a \minus2 penalty to attack rolls against foes beyond that range. At base attack bonus \plus4, and every 4 base attack bonus thereafter, you increase the bonus and penalty by 1.  
...
\featben You gain a \plus2 competence bonus to your caster level with spell-like abilities from spellgift feats.

\feat{Power Attack}{Combat, Style}
\parhead{Prerequisite} Str 3.
\parhead{Benefit} While in this style, you gain a \plus2 competence bonus on melee damage rolls. In exchhange, you take a \minus2 penalty to melee attack rolls. At base attack bonus \plus4, and every 4 base attack bonus thereafter, you increase the bonus and penalty by 1. The bonus damage and penalty do not apply to maneuvers or touch attacks. The bonus damage is halved if you are dealing damage with an off-hand weapon or light weapon.
...
\featben You gain a \plus2 competence bonus to your caster level when casting spells and using spell-like abilities from the school of magic or with the spell descriptor you select. In exchange, you take a \minus2 penalty to caster level with all other spells and spell-like abilities.
