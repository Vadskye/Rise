...
{\small
    ...
    \begin{longtabu}{>{\lcol}p{10em} >{\lcol}p{15em} >{\lcol}X >{\lcol}p{3em}}
        ...
        \featref{Iron Will} & Wil 3 & \plus2 bonus to Mental defense & \featpref{Iron Will} \\
        ...
        \featref{Toughness} & Con 3 & \plus2 to Fortitude defense & \featpref{Toughness} \\
...
\featpre Willpower 10 or base Mental defense \plus10.
...
\featpres Str 5, two attacks.
\featben You increase the size of your weapon damage die with melee attacks by one size (see \tref{Weapon Damage and Size}).
You increase the size of the damage die by two sizes at Strength 10, and by three sizes at Strength 20.

\feat{Mighty Shot}
\featpres Str 5, two attacks.
\featben You increase the size of your weapon damage die with ranged attacks by one size (see \tref{Weapon Damage and Size}).
You increase the size of the damage die by two sizes at Strength 10, and by three sizes at Strength 20.
