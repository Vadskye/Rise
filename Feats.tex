...
\begin{longtabu}{>{\lcol}p{10em} >{\lcol}p{15em} >{\lcol}X >{\lcol}p{3em}}
    ...
    \featref{Legendary Liar} & Bluff 13 ranks & Lies appear to alter reality & \featpref{gLegendary Liar} \\
    \featref{Legendary Linguist} & Linguistics 13 ranks & Speak all languages & \featpref{gLegendary Liar} \\
    \featref{Legendary Perception} & Perception 13 ranks & Gain extrasensory perception & \featpref{Legendary Perception} \\
    \featref{Legendary Persuasion} & Persuasion 13 ranks & Compel listener to obey & \featpref{Legendary Perception} \\
    ...
    \featref{Legendary Rider} & Ride 13 ranks & Ride unwilling creatures & \featpref{Legendary Ride} \\
    \featref{Legendary Sense Motive} & Sense Motive 13 ranks & Read creature's mind & \featpref{Legendary Ride} \\
    ...
    \featref{Legendary Survival} & Survival 13 ranks & Ignore harmful terrain and unerringly find your way & \featpref{Legendary Stealth} \\
