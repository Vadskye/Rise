...
{\small
    ...
    \begin{longtabu}{>{\lcol}p{10em} >{\lcol}p{15em} >{\lcol}X >{\lcol}p{6em} >{\lcol}p{3em}}
        ...
        \featref{Overwhelming Fire} & Base attack bonus \plus4 & Help overwhelm foes with ranged weapons & Reaction, Style & \featpref{Overwhelming Fire} \\
...
\parhead{Benefit} While in this style, you gain a \plus2 bonus to physical ranged damage rolls. In exchange, you take a \minus2 penalty on ranged physical attacks. At base attack bonus \plus4, and every 4 base attack bonus thereafter, you increase the bonus and penalty by 1.
\stylepre Wield a ranged weapon. You must take a standard attack action each round.
...
\parhead{Benefit} While in this style, you gain a \plus2 bonus to your dodge defense modifier. In exchange, you take a \minus2 penalty on physical attacks. At base attack bonus \plus4, and every 4 base attack bonus thereafter, you increase the bonus and penalty by 1.
...
\parhead{Benefit} While in this style, foes you threaten take a \minus2 penalty to Concentration checks. In exchange, you take a \minus2 penalty to physical defenses against melee attacks. At base attack bonus \plus4, and every 4 base attack bonus thereafter, you increase both penalties by 1.
\stylepre Wield a melee weapon. You must take a standard attack or charge action each round.
...
\featpre Base attack bonus \plus4.
\featben While in this style, as part of a standard attack, you may provoke an attack of opportunity from one opponent threatening you. You gain a \plus2 bonus to physical defenses against this attack. Unless the creature hits you on the attack of opportunity, you gain a \plus2 bonus to your next attack against it, provided the attack is made within 1 round.
\stylepre Wield a melee weapon. You must take a standard attack action each round.

Your bonuses to attack and defense increase to \plus3 at base attack bonus \plus8, to \plus4 at base attack bonus \plus12, and finally to \plus5 at base attack bonus \plus16.
...
\parhead{Benefit} While in this style, you take a \minus2 penalty to physical defenses and gain a \plus2 bonus to maneuver attack. At base attack bonus \plus4, and every 4 base attack bonus thereafter, you increase the bonus and penalty by 1.
\stylepre Wield a melee weapon. You must take a standard attack or charge action each round.
