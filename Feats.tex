...
Armor Familiarity & Proficiency with armor & Reduce penalties from wearing armor \\
...
\tind Cleaving Stride & Str 3, base attack bonus \plus8, Cleave & Continue movement after dropping target \\
Combat Analysis & Base attack bonus \plus4 & Identify enemy strengths and weaknesses \\
...
Tactical Analysis & Base attack bonus \plus4 & Identify foe's strengths and weaknesses \\
Tactical Prediction & Base attack bonus \plus8, Tactical Analysis & Predict foe's next action \\
Tactical Readiness & Wis 3, base attack bonus \plus4 & Ready two actions at once \\
...
Covering Fire & \x & Targets struck by ranged attacks suffer attack penalties \\
...
Guardian & \x & Adjacent allies suffer reduced overwhelm penalties. \\
...
Precise Shot & \x & Add half Wis to damage, reduce cover penalties \\
...
Shot on the Run & Dex 3, Dodge, Mobility, base attack bonus \plus4 & Move before and after ranged attacks \\
Spring Attack & Dex 3, Dodge, Mobility, base attack bonus \plus4 & Move before and after melee attacks \\
Threatening Fire & Base attack bonus \plus4 & Help overwhelm foes with ranged weapons \\
Whirlwind Attack & Dex 5, base attack bonus \plus12 & One melee attack against each opponent within reach \\
\end{tabularx}
...
\parhead{Prerequisite} Base attack bonus \plus4
\parhead{Benefit} As a full-round action, you can make a full attack and make an Aid Another check to help an adjacent ally's attack bonus or armor class.
