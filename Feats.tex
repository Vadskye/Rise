...
{\small
    ...
    \begin{longtabu}{>{\lcol}p{10em} >{\lcol}p{15em} >{\lcol}X >{\lcol}p{6em} >{\lcol}p{3em}}
        ...
        \featref{Chargebreaker Stance} & Base attack bonus \plus4 & Trade ability to move for bonuses against approaching foes & Defense, Style & \featpref{Chargebreaker Stance} \\
