...
Exotic Weapon Proficiency\footnotetemp{1} & \x & Don't provoke when attacking with exotic weapons & Equipment \\
...
\tind \tind Extra Stunning & Stunning Fist & Can use stunning fist 3 more times per day & \x \\
...
Knockdown & Str 3, base attack bonus \plus4 & Bull rushed foe can be knocked prone & Maneuver, Power \\
...
Manyshot & Dex 7, base attack bonus \plus12 & Shoot two projectiles simultaneously & Precision, Style \\
...
\subsubsection{Extra Rage [Class]}
\parhead{Prerequisite} Ability to rage.
...
\subsubsection{Selective Channeling [Class]}
...
\subsubsection{Legendary Healer [Skill]}
...
\subsubsection{Extra Stunning [Combat]}
