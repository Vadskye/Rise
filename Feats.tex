...
\featref{Selective Channeling} & Chhannel energy ability & Can exclude two additional creatures & \featpref{Selective Channeling} \\
...
\featref{Widen Spell} & Caster level 8th & Double spell's area (\plus3) & \featpref{Widen Spell} \\
...
\parhead{Benefit} While in this style, you can add half your Wisdom to damage with ranged attacks in addition to half your Strength. In exchange, you must spend a full-round action to make a standard attack.
...
\featben Whenever you come within 10 feet of a trap, you receive an immediate Perception check to notice the trap. This check should be made secretly, so you rogue do not know whether you failed to notice a trap.
