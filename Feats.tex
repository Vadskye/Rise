...
\featref{Combat Casting} & \x &  \plus2 bonus on Concentration checks to cast spells, reroll 1/day & \featpref{Combat Casting} \\
...
\featref{Skill Focus}\fn{1} & \x &  \plus3 bonus on checks with selected skill, reroll 1/day & \featpref{Skill Focus} \\
...
\featref{Improved Initiative} & \x & \plus2 bonus on initiative checks, reroll 1/day & Reaction & \featpref{Improved Initiative} \\
...
\featref{Point Blank Shot} & \x &  \plus2 bonus on ranged damage within 30 ft. & Precision, Style & \featpref{Point Blank Shot} \\
...
\featref{Improved Dirty Trick} & Base attack bonus \plus4 & \plus2 bonus on dirty trick attacks; dirty tricks last longer & Finesse, Maneuver & \featpref{Improved Dirty Trick} \\
\featref{Improved Disarm} & Base attack bonus \plus4 & \plus2 bonus on disarm attacks; knock foe's weapon away after disarming & Finesse, Maneuver & \featpref{Improved Disarm} \\
\featref{Improved Feint} & Base attack bonus \plus4 & \plus2 bonus on feint attacks; feint lasts longer & Finesse, Maneuver & \featpref{Improved Feint} \\
\featref{Improved Grapple} & Base attack bonus \plus4 & \plus2 bonus on grapple attacks; not flat-footed while grappling & Maneuver, Power & \featpref{Improved Grapple} \\
\featref{Improved Overrun} & Base attack bonus \plus4 & \plus2 bonus on overrun attacks; target can't avoid & Maneuver, Power & \featpref{Improved Overrun} \\
\featref{Improved Shove} & Base attack bonus \plus4 & \plus2 bonus on shove attacks; move target without moving & Maneuver, Power & \featpref{Improved Bull Rush} \\
\featref{Improved Trip} & Base attack bonus \plus4 & \plus2 bonus on trip attacks; tripped foe provokes attacks of opportunity & Finesse, Maneuver & \featpref{Improved Trip} \\
...
\parhead{Benefit} You get a \plus2 bonus on Concentration checks made to cast a spell or use a spell-like ability. In addition, once per day you may reroll a Concentration check made to cast a spell.
...
\parhead{Benefit} While in this style, you gain a \plus2 bonus on physical ranged damage rolls. In exchange, you take a \minus2 penalty on ranged physical attacks. At base attack bonus \plus4, and every 4 base attack bonus thereafter, the penalty increases by 1 and the bonus increases by 2.
...
\parhead{Benefit} You gain a \plus2 bonus on defenses against poisons, spells, and spell-like effects.
...
\parhead{Prerequisites} Base attack bonus \plus4
\parhead{Benefit} When you shove a creature, you do not need to move with it to move it beyond your reach. You also gain a \plus2 bonus on shove attacks.
...
\parhead{Prerequisites} Base attack bonus \plus4
\parhead{Benefit} When you perform a dirty trick on a cretaure successfully, the creature is vulnerable for 1d4 rounds. You also gain a \plus2 bonus on dirty trick attacks.

\feat{Improved Disarm}{Combat, Finesse}
\parhead{Prerequisites} Base attack bonus \plus4
\parhead{Benefit} When you knock an item away from a creature, you can make it land up to 15 feet away in a random direction. You also gain a \plus2 bonus on disarm attacks.

\feat{Improved Feint}{Combat, Finesse}
\parhead{Prerequisites} Base attack bonus \plus4
\parhead{Benefit} When you feint against a creature, it remains flat-footed until it is struck by an attack, provided the attack is made before its next turn. You also gain a \plus2 bonus on feint attacks.
...
\parhead{Prerequisites} Base attack bonus \plus4
\parhead{Benefit} Grappling does not make you flat-footed against other creatures. You also gain a \plus2 bonus on grapple attacks.
...
\parhead{Benefit} You get a \plus2 bonus on initiative checks. In addition, once per day you may reroll an initiative check.

\feat{Improved Overrun}{Combat, Maneuver}
\parhead{Prerequisites} Base attack bonus \plus4
\parhead{Benefit} When you attempt to overrun a foe, the creature may not choose to avoid you unless you let it. You also gain a \plus2 bonus on overrun attacks.
...
\parhead{Prerequisites} Base attack bonus \plus4
\parhead{Benefit} When you successfully trip a foe, it immediately provokes an attack of opportunity from everyone threatening it, including you. These attacks are made as the creature is being tripped, so it does not have penalties for being prone. You also gain a \plus2 bonus on trip attacks.
...
\begin{itemize*}
  ...
  \item You gain a \plus5 bonus on Climb checks.
...
\begin{itemize*}
  ...
  \item You gain a \plus5 bonus on Swim checks.
...
\parhead{Benefit} While in this style, you get a \plus2 bonus on physical damage rolls with ranged weapons when attacking targets within half of your range increment. In exchange, you take a \minus2 penalty to physical attacks against foes beyond that range. At base attack bonus \plus4, and every 4 base attack bonus thereafter, you increase the bonus and penalty by 1.  
...
Choose a skill.
\parhead{Benefit} You gain a \plus3 bonus on all checks involving that skill. In addition, once per day you may reroll a skill check made with that skill.
