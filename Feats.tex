...
\subsubsection{Bardic Spellpower [General]}
...
\featben You gain a \plus5 competence bonus to Athletics checks made to jump, and you are always treated as having a running start when jumping.

When jumping, if your check result exceeds 30, you can take a standard action at the midpoint of the jump.
...
When swimming, if your check result exceeds 30, you do not suffer any penalties to melee attack rolls, checks, or armor class for being underwater. You can make a Swim check as a swift action to gain this benefit in a round when you do not make a Swim check to move.
...
\subsubsection{Spellwoven Performance [Performance, Skill]}
