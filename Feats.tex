...
Metamagic feats cannot be used to enhance spell-like abilities, magic item abilities, or other effects which are not spell

\parhead{Casting Time}
Casting a spell enhanced by a metamagic feat takes longer than casting the spell normally, as shown on \trefnp{Metamagic Spell Casting Time}.

\begin{dtable}
    \lcaption{Metamagic Spell Casting Time}
    \begin{tabularx}{\columnwidth}{l X}
        \hline
        \thead{Original Casting Time} & \thead{Modified Casting Time} \\
        Swift action & Standard action \\
        Standard action & Full-round action \\
        Full-round action or longer & Extra full-round action \\
    \end{tabularx}
\end{dtable}
...
{\small
    ...
    \begin{longtabu}{>{\lcol}p{10em} >{\lcol}p{15em} >{\lcol}X >{\lcol}p{3em}}
        ...
        \featref{Spell Focus}\fn{1} & 2nd level spells &  \plus2 spellpower with specific type of magic & \featpref{Spell Focus} \\
        \tind \featref{Spell Specialization} & 4th level spells, Spell Focus &  \plus2 spellpower with specific type of magic, \minus2 with other types.
...
{\small
    ...
    \begin{longtabu}{>{\lcol}p{10em} >{\lcol}p{15em} >{\lcol}X >{\lcol}p{6em} >{\lcol}p{3em}}
        ...
        \midrule
        \thead{Combat Feats} & \thead{Prerequisites (BAB \plus4)} & \thead{Benefit} & \thead{Feat Types} & \thead{Page} \\
        ...
        \midrule
        \thead{Combat Feats} & \thead{Prerequisites (BAB \plus8)} & \thead{Benefit} & \thead{Feat Types} & \thead{Page} \\
        ...
        \midrule
        \thead{Combat Feats} & \thead{Prerequisites (BAB \plus12)} & \thead{Benefit} & \thead{Feat Types} & \thead{Page} \\
        ...
        \midrule
        \thead{Combat Feats} & \thead{Prerequisites (BAB \plus18)} & \thead{Benefit} & \thead{Feat Types} & \thead{Page} \\
...
{\small
    ...
    \begin{longtabu}{>{\lcol}p{10em} >{\lcol}p{15em} >{\lcol}X >{\lcol}p{6em} >{\lcol}p{3em}}
        ...
        \midrule
        \thead{Style Feats} & \thead{Prerequisites (BAB \plus4)} & \thead{Benefit} & \thead{Feat Types} & \thead{Page} \\
        ...
        \midrule
        \thead{Style Feats} & \thead{Prerequisites (BAB \plus8)} & \thead{Benefit} & \thead{Feat Types} & \thead{Page} \\
...
\featpres Perception 5, base attack bonus \plus4.
...
\featpres Per 5, base attack bonus \plus4.
...
\featpre Dexterity 5, base attack bonus \plus4.
...
In addition, you gain a \plus1 bonus to spellpower with spells from the chosen domain.
...
\featben When casting a heightened spell, you gain a \plus2 bonus to spellpower.
...
\featpre Perception 5, base attack bonus \plus4.
...
You can affect one creature per two Perform ranks you have.
All affected creatures gain a \plus3 enhancement bonus to their spellpower with spells and spell-like abilities.
...
\featpres Str 5, base attack bonus \plus4.
...
\featpres Intelligence 5, base attack bonus \plus4.
\featben You can use your Perception to determine your Armor and Maneuver defenses in place of your Dexterity or Constitution.
\stylereq Wield a melee weapon.
You must make a physical attack or take the total defense action each round.
...
\featben You get a \plus2 bonus to your spellpower when casting spells and using spell-like abilities from the school of magic or with the spell descriptor you select.
\parhead{Special}
You can gain this feat multiple times.
Its effects do not stack.
...
\featben You gain a \plus2 bonus to your spellpower when casting spells and using spell-like abilities from the school of magic or with the spell descriptor you select.
...
\featpres Dex 5, Mobility, base attack bonus \plus8.
...
\featpres Dexterity 5, Overwhelming Fire, base attack bonus \plus8.
...
\featpres Str 5, Mighty Blows, Two-Weapon Fighting, base attack bonus \plus8.
...
\featpres Dexterity 5, base attack bonus \plus4.
