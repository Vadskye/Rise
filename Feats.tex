...
\parhead{Benefit} You may designate an opponent as a free action. You receive a \plus4 bonus to your dodge modifier against attacks of opportunity from that opponent that were provoked by movement. In addition, you gain a \plus4 bonus to Acrobatics checks made to tumble against that opponent (see \pcref{Tumble}).
...
\parhead{Prerequisites} Base attack bonus \plus4.
\parhead{Benefit} While wielding a ranged weapon in this style, you contribute to overwhelm penalties against all creatures within a single range increment of you. You do not contribute to overwhelm penalties against creatures with cover from you. In exchange, you take a \minus2 penalty to your physical defenses.
