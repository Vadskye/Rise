...
\begin{longtabu}{>{\lcol}p{10em} >{\lcol}p{15em} >{\lcol}X >{\lcol}p{3em}}
    ...
    \featref{Resist Maneuver} & Fighter, base attack bonus \plus4 & \plus5 to resist chosen maneuver & \featpref{Resist Maneuver} \\
...
{\small
    ...
    \begin{longtabu}{>{\lcol}p{10em} >{\lcol}p{15em} >{\lcol}X >{\lcol}p{6em} >{\lcol}p{3em}}
        ...
        \featref{Combat Mobility} & Dex 3, base attack bonus \plus4 & Avoid movement-based attacks of opportunity from foe & Defense, Mobility & \featpref{Combat Mobility} \\
        \featref{Disarming Finish} & Base attack bonus \plus4 & Automatically disarm defeated foes & Finesse & \featpref{Disarming Finish} \\
        \featref{Gang Up} & Base attack bonus \plus4 & Increase overwhelm penalties foes suffer & \x & \featpref{Gang Up} \\
        ...
        \featref{Improved Grapple} & Base attack bonus \plus4 & \plus2 bonus to grapple attacks; not vulnerable while grappling & Maneuver, Power & \featpref{Improved Grapple} \\
        ...
        \featref{Improved Shove} & Base attack bonus \plus4 & \plus2 bonus to shove attacks; move target away from you & Maneuver, Power & \featpref{Improved Shove} \\
        ...
        \featref{Eye of the Storm} & Base attack bonus \plus8 & Reduce overwhelm penalties by 1 & Awareness, Defense & \featpref{Eye of the Storm} \\
        ...
        \featref{Two-Weapon Rend} & Str 5, base attack bonus \plus8, Two-Weapon Fighting & Deal Strength damage with both weapons & Power & \featpref{Two-Weapon Rend} \\
        ...
        \featref{Whirlwind Attack} & Dex 5, base attack bonus \plus8 & One melee attack against each opponent within reach & Finesse & \featpref{Whirlwind Attack} \\
        \tind \featref{Mobile Whirlwind} & Dex 5, Whirlwind Attack, base attack bonus \plus8 & Use whirlwind attack as standard action & Finesse, Mobility & \featpref{Mobile Whirlwind} \\
        ...
        \featref{Legendary Awareness} & Base attack bonus \plus12, any three Awareness feats & Immune to being overwhelmed & Awareness & \featpref{Legendary Awareness} \\
        ...
        \featref{Legendary Finesse} & Base attack bonus \plus12, any three Finesse feats & Roll maximum damage again & Finesse & \featpref{Legendary Finesse} \\
        ...
        \featref{Legendary Reaction} & Base attack bonus \plus12, any three Reaction feats & \plus10 to initiative checks & Combat, Reaction & \featpref{Legendary Reaction} \\

        \midrule
        \thead{Combat Feats} & \thead{Prerequisites} & \thead{Benefit} & \thead{Feat Types} & \thead{Page} \\
        \featref{Executioner} & Base attack bonus \plus16, any three Reaction feats & Gain free attacks against foes near death & Reaction & \featpref{Executioner} \\
        \featref{Hurricane Attack} & Dex 7, Whirlwind Attack, base attack bonus \plus16 & Two melee attacks at all foes you threaten & Reaction & \featpref{Hurricane Attack} \\
        \tind \featref{Mobile Hurricane} & Dex 7, Hurricane Attack, Mobile Whirlwind, Whirlwind Attack, base attack bonus \plus16 & Use whirlwind attack as standard action & Reaction & \featpref{Hurricane Attack} \\
    \end{longtabu}
    \begin{enumerate*}
...
{\small
    ...
    \begin{longtabu}{>{\lcol}p{10em} >{\lcol}p{15em} >{\lcol}X >{\lcol}p{6em} >{\lcol}p{3em}}
        ...
        \featref{Opportunist} & Dex 3 & \plus2 to attack and damage on attacks of opportunity & Reaction, Style & \featpref{Opportunist} \\
        ...
        \midrule
        \thead{Style Feats} & \thead{Prerequisites} & \thead{Benefit} & \thead{Feat Types} & \thead{Page} \\
        \featref{Chargebreaker} & Base attack bonus \plus4 & Trade ability to move for bonuses against approaching foes & Reaction, Style & \featpref{Chargebreaker} \\
        \featref{Close-Quarters Fighting} & Dex 3, attack bonus \plus4 & No penalty for squeezing or attacking while grappling & Style & \featpref{Close-Quarters Fighting} \\
        ...
        \featref{Feign Weakness} & Base attack bonus \plus4 & Provoke attack to gain bonus to hit & Style & \featpref{Feign Weakness} \\
        ...
        \featref{Spring Attack} & Dex 3, base attack bonus \plus4, Combat Mobility & Move before and after attacks & Mobility, Style & \featpref{Spring Attack} \\
        ...
        \featref{Inescapable Bulwark} & Dex 3, Base attack bonus \plus8 & Withdrawing enemies cannot avoid provoking attacks of opportunity & Reaction, Style & \featpref{Inescapable Bulwark} \\
        \featref{Intuitive Defense} & Wis 3, base attack bonus \plus8 & Add half Wisdom to defense in place of Dex & Awareness, Defense, Style & \featpref{Intuitive Defense} \\
        ...
        \featref{Predictive Defense} & Int 3, base attack bonus \plus8 & Add half Int to defense in place of Dex & Awareness, Defense, Style & \featpref{Predictive Defense} \\
        \featref{Threatening Fire} & Overwhelming Fire, base attack bonus \plus8 & Threaten adjacent creatures with a ranged weapon & Reaction, Style & \featpref{Threatening Fire} \\

        \midrule
        \thead{Style Feats} & \thead{Prerequisites} & \thead{Benefit} & \thead{Feat Types} & \thead{Page} \\
        \featref{Legendary Style} & Base attack bonus \plus12, any three Style feats & Use two styles at once & \x & \featpref{Legendary Style} \\
        \featref{Manyshot} & Dex 5, base attack bonus \plus12 & Shoot two projectiles simultaneously & Precision, Style & \featpref{Manyshot} \\
...
{\small
    ...
    \begin{longtabu}{>{\lcol}p{10em} >{\lcol}p{15em} >{\lcol}X >{\lcol}p{6em} >{\lcol}p{3em}}
        ...
        \featref{Impeding Strike} & Base attack bonus \plus8 & Melee attack inhibits foe's movement & Strike & \featpref{Impeding Strike} \\
        ...
        \featref{Legendary Strike} & Base attack bonus \plus12, any three Strike feats & Use multiples strikes per round & \x & \featpref{Legendary Strike} \\
...
\parhead{Benefit} While in this style, you gain a \plus3 bonus to physical attacks against creatures that moved towards you during the current round. In exchange, you are \immobilized. At base attack bonus \plus8, and every 4 base attack bonus thereafter, you increase the bonus by 1.
...
\featpre Dex 3, base attack bonus \plus4.
...
\parhead{Prerequisites} Dex 3, base attack bonus \plus4.
...
\parhead{Benefit} While in this style, you gain a \plus2 bonus to physical ranged damage rolls. In exchange, you take a \minus2 penalty on physical ranged attacks. At base attack bonus \plus4, and every 4 base attack bonus thereafter, you increase the bonus and penalty by 1.
\stylereq Wield a ranged weapon. You must take a standard attack action each round.
...
\parhead{Benefit} While in this style, you gain a \plus2 bonus to your physical defenses. In exchange, you take a \minus2 penalty on physical attacks. At base attack bonus \plus4, and every 4 base attack bonus thereafter, you increase the bonus and penalty by 1.
\stylereq Wield a melee weapon. You must take a standard attack or total defense action each round.
...
\feat{Disarming Finish}{Combat, Finesse}
...
\parhead{Prerequisites} Base attack bonus \plus4.
\parhead{Benefit} While in this style, foes you threaten take a \minus3 penalty to Concentration checks. In exchange, you take a \minus3 penalty to physical defenses against melee attacks. At base attack bonus \plus8, and every 4 base attack bonus thereafter, you increase both penalties by 1.
\stylereq Wield a melee weapon. You must take a standard attack or charge action each round.
...
\parhead{Prerequisites} Base attack bonus \plus16, any three Reaction feats.
...
\feat{Hurricane Attack}{Combat, Reaction}
\featpres Dex 7, Whirlwind Attack, base attack bonus \plus16.
...
\featpre Base attack bonus \plus12, any three Strike feats.
...
\feat{Mobile Hurricane}{Combat, Reaction, Mobility}
\featpres Dex 5, Hurricane Attack, Mobile Whirlwind, Whirlwind Attack, base attack bonus \plus8.
\featben You can make a hurricane attack as a standard action.

\feat{Mobile Whirlwind}{Combat, Reaction, Mobility}
\featpres Dex 5, Whirlwind Attack, base attack bonus \plus8.
...
\parhead{Benefit} While in this style, you gain a \plus2 bonus to maneuver attacks. In exchange, you take a \minus2 penalty to physical defenses. At base attack bonus \plus4, and every 4 base attack bonus thereafter, you increase the bonus and penalty by 1.
\stylereq Wield a melee weapon. You must take a standard attack or charge action each round.
...
\featpre Fighter, base attack bonus \plus4.
...
\parhead{Prerequisites} Dex 3, Mobility, base attack bonus \plus4.
...
\featpre Overwhelming Fire, base attack bonus \plus8.
...
\parhead{Prerequisites} Str 5, Two-Weapon Fighting, base attack bonus \plus8.
...
\feat{Whirlwind Attack}{Combat, Reaction}
\parhead{Prerequisites} Dex 5, base attack bonus \plus8.
\parhead{Benefit} As a full-round action, you can make a single melee attack against each opponent you threaten.
