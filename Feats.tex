...
{\small
    ...
    \begin{longtabu}{>{\lcol}p{10em} >{\lcol}p{15em} >{\lcol}X >{\lcol}p{6em} >{\lcol}p{3em}}
        ...
        \tind \featref{Two-Weapon Defense} & Two-Weapon Fighting & Off-hand weapon grants \plus1 bonus to physical defenses, later \plus3 & Defense, Finesse & \featpref{Two-Weapon Defense} \\
...
\parhead{Benefit} When wielding two weapons at once, you gain a \plus1 bonus to physical defenses. This bonus increases to \plus2 once your base attack bonus reaches \plus8, and to \plus3 at base attack bonus \plus16.
