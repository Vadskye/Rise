...
\tind Spell Specialization\fn{1} & Magic level 8th, Spell Focus &  \plus4 caster level with specific type of magic, \minus2 penalty with other types. \\
...
Combat Prowess & Base attack bonus \plus8 & \plus1 to attack and damage \\
...
Weapon Focus\fn{1} & Proficiency with weapon group, base attack bonus \plus1 & \plus1 to attack and damage & Equipment \\
\tind Weapon Specialization\footnotetemp{1} & Base attack bonus \plus8, proficiency with weapon group, Weapon Focus with weapon group & \plus2 to attack and damage, \minus2 with other weapons & Equipment \\
...
\featben You gain a \plus4 competence bonus to your caster level when casting spells and using spell-like abilities from the school of magic or with the spell descriptor you select. In exchange, you take a \minus2 penalty to caster level with all spells and spell-like abilities to which you have not applied any Spell Focus feat.
...
\featben You gain a \plus1 competence bonus to attack and damage.
...
\parhead{Benefit} You gain a \plus1 competence bonus to attack and damage with weapons from the selected weapon group. At base attack bonus \plus10, your critical threat range is also doubled with those weapons. This increase doesn't stack with other effects that expand the threat range of a weapon.
...
\featben You gain a \plus2 competence bonus to attack and damage with weapons from the selected weapon group. In exchange, you take a \minus2 penalty to attack and damage with with all weapons to which you have not applied any Weapon Focus feat. This penalty does not affect non-weapon attacks, such as many combat maneuvers.
