...
{\small
    ...
    \begin{longtabu}{>{\lcol}p{10em} >{\lcol}p{15em} >{\lcol}X >{\lcol}p{6em} >{\lcol}p{3em}}
        ...
        \midrule
        \thead{Combat Feats} & \thead{Prerequisites} & \thead{Benefit} & \thead{Feat Types} & \thead{Page} \\
        \featref{Contingent Counter} & Int 3, two attacks & Prepare to attack when attack misses you & Reaction & \featpref{Contingent Counter} \\
        \featref{Driving Assault} & Str 5, two attacks & Shoved foe provokes attack from you & Power, Maneuver & \featpref{Driving Assault} \\
        \featref{Eye of the Storm} & Two attacks & Reduce overwhelm penalties by 1 & Awareness, Defense & \featpref{Eye of the Storm} \\
        \featref{Gang Up} & Two attacks & Increase overwhelm penalties foes suffer & \x & \featpref{Gang Up} \\
        \featref{Mobile Whirlwind} & Dex 5, Whirlwind Strike, two attacks & Use whirlwind strike as standard action & Mobility & \featpref{Mobile Whirlwind} \\
        \featref{Tactical Prediction} & Int 3, Two attacks & Predict foe's next action & Awareness & \featpref{Tactical Prediction} \\
        \featref{Two-Weapon Rend} & Str 5, two attacks, Two-Weapon Fighting & Deal Strength damage with both weapons & Power & \featpref{Two-Weapon Rend} \\
        \featref{Wall Slam} & Str 5, two attacks & Slam opponent into wall to deal bonus damage & Maneuver, Power & \featpref{Wall Slam} \\

        \midrule
        \thead{Combat Feats} & \thead{Prerequisites} & \thead{Benefit} & \thead{Feat Types} & \thead{Page} \\
        \featref{Contingent Attack} & Int 5, three attacks & Prepare to attack as immediate action & Reaction & \featpref{Contingent Attack} \\
        \featref{Legendary Awareness} & Three attacks, any three Awareness feats & Immune to being overwhelmed & Awareness & \featpref{Legendary Awareness} \\
        \featref{Legendary Defense} & Three attacks, any three Defense feats & \plus2 to all defenses & Defense & \featpref{Legendary Defense} \\
        \featref{Legendary Finesse} & Three attacks, any three Finesse feats & Roll maximum damage again & Finesse & \featpref{Legendary Finesse} \\
        \featref{Legendary Maneuver Master} & Three attacks, any three Maneuver feats & Deal damage with very successful maneuvers & Maneuver & \featpref{Legendary Maneuver Master} \\
        \featref{Legendary Mobility} & Three attacks, any three Mobility feats & Blocking foes do not affect you & Mobility& \featpref{Legendary Mobility} \\
        \featref{Legendary Mounted Warrior} & Three attacks, any three Mounted feats & Share damage with mount & Mounted& \featpref{Legendary Mounted Warrior} \\
        \featref{Legendary Power} & Three attacks, any three Power feats & Wield weapons as if they were less encumbering & Power& \featpref{Legendary Power} \\
        \featref{Legendary Precision} & Three attacks, any three Precision feats & Very accurate hits deal maximum damage & Precision & \featpref{Legendary Precision} \\
        \featref{Legendary Reaction} & Three attacks, any three Reaction feats & \plus10 to initiative checks & Combat, Reaction & \featpref{Legendary Reaction} \\

        \midrule
        \thead{Combat Feats} & \thead{Prerequisites} & \thead{Benefit} & \thead{Feat Types} & \thead{Page} \\
        \featref{Executioner} & Four attacks, any three Reaction feats & Gain free attacks against foes near death & Reaction & \featpref{Executioner} \\
        \featref{Hurricane Strike} & Dex 7, Whirlwind Strike, four attacks & Two melee attacks against all threatened foes & Strike & \featpref{Hurricane Strike} \\
        \tind \featref{Mobile Hurricane} & Dex 7, Hurricane Strike, Mobile Whirlwind, Whirlwind Strike, four attacks & Use hurricane strike as standard action & Mobility & \featpref{Hurricane Strike} \\
    \end{longtabu}
    \begin{enumerate*}
...
{\small
    ...
    \begin{longtabu}{>{\lcol}p{10em} >{\lcol}p{15em} >{\lcol}X >{\lcol}p{6em} >{\lcol}p{3em}}
        ...
        \midrule
        \thead{Style Feats} & \thead{Prerequisites} & \thead{Benefit} & \thead{Feat Types} & \thead{Page} \\
        \featref{Feign Weakness} & Two attacks & Lower defenses to gain damage bonus & Style & \featpref{Feign Weakness} \\
        \featref{Heartseeker} & Two attacks & Trade attack bonus to double critical threat range & Precision, Style & \featpref{Heartseeker} \\
        \featref{Inescapable Bulwark} & Dex 3, Two attacks & Enemies you are blocking cannot move & Reaction, Style & \featpref{Inescapable Bulwark} \\
        \featref{Insightful Defense} & Wis 3, two attacks & Add half Perception to defense & Awareness, Defense, Style & \featpref{Insightful Defense} \\
        \featref{Perfect Shot} & Dex 5, two attacks & Ignore less than total cover/concealment on ranged attacks & Precision, Style & \featpref{Perfect Shot} \\
        \featref{Predictive Defense} & Int 3, two attacks & Add half Int to defense in place of Dex & Awareness, Defense, Style & \featpref{Predictive Defense} \\
        \featref{Reckless Attack} & Two attacks & Trade ability to defend yourself for damage bonus & Power, Style & \featpref{Reckless Attack} \\
        \featref{Spring Attack} & Dex 3, two attacks, Combat Mobility & Move before and after attacks & Mobility, Style & \featpref{Spring Attack} \\
        \featref{Threatening Fire} & Overwhelming Fire, two attacks & Threaten adjacent creatures with a ranged weapon & Reaction, Style & \featpref{Threatening Fire} \\

        \midrule
        \thead{Style Feats} & \thead{Prerequisites} & \thead{Benefit} & \thead{Feat Types} & \thead{Page} \\
        \featref{Legendary Style} & Three attacks, any three Style feats & Use two styles at once & \x & \featpref{Legendary Style} \\
        \featref{Manyshot} & Dex 5, three attacks & Shoot two projectiles simultaneously & Precision, Style & \featpref{Manyshot} \\

        \midrule
        \thead{Style Feats} & \thead{Prerequisites} & \thead{Benefit} & \thead{Feat Types} & \thead{Page} \\
        \featref{Counterstorm} & Four attacks & Gain bonuses against foes that miss & Reaction, Style& \featpref{Counterstorm} \\
    \end{longtabu}
}%end of small text
...
{\small
    ...
    \begin{longtabu}{>{\lcol}p{10em} >{\lcol}p{15em} >{\lcol}X >{\lcol}p{6em} >{\lcol}p{3em}}
        ...
        \featref{Bewildering Strike} & Two attacks & Attack bewilders foe & Strike & \featpref{Bewildering Strike} \\
        \featref{Impeding Strike} & Two attacks & Melee attack inhibits foe's movement & Strike & \featpref{Impeding Strike} \\
        \featref{Intimidating Strike} & Two attacks, Intimidate 8 ranks & Attack lets you intimidate struck foe & Strike & \featpref{Intimidating Strike} \\
        \featref{Pierce Wings} & Two attacks & Ranged attack removes foe's ability to fly & Precision, Strike & \featpref{Pierce Wings} \\
        \featref{Sickening Strike} & Two attacks & Attack sickens foe & Strike & \featpref{Sickening Strike} \\
        \featref{Whirlwind Strike} & Dex 5, two attacks & One melee attack against each threatened opponent & Strike & \featpref{Whirlwind Strike} \\

        \midrule
        \thead{Strike Feats} & \thead{Prerequisites} & \thead{Benefit} & \thead{Feat Types} & \thead{Page} \\
        \featref{Confusing Strike} & Three attacks & Attack confuses bloodied foe & Strike & \featpref{Confusing Strike} \\
        \featref{Legendary Strike} & Three attacks, any three Strike feats & Use multiples strikes per round & \x & \featpref{Legendary Strike} \\
        \featref{Penetrating Strike} & Three attacks & Attack removes foe's damage reduction & Strike & \featpref{Penetrating Strike} \\

        \midrule
        \thead{Strike Feats} & \thead{Prerequisites} & \thead{Benefit} & \thead{Feat Types} & \thead{Page} \\
        \featref{Demolishing Strike} & Four attacks & Attack deals double damage & Strike & \featpref{Demolishing Strike} \\
        \featref{Killing Blow} & Four attacks & Attack instantly kills foe without hit points & Strike & \featpref{Killing Blow} \\
    \end{longtabu}
}%end of small text
...
\parhead{Prerequisites} Four attacks, any three Reaction feats.
...
\parhead{Prerequisite} Two attacks.
...
\featpres Dex 7, Whirlwind Strike, four attacks.
...
\featpre Three attacks, any three Mounted feats, Ride 10 ranks.
...
\parhead{Prerequisites} Dex 5, three attacks.
...
\featpres Dex 5, Hurricane Attack, Mobile Whirlwind, Whirlwind Attack, two attacks.
...
\parhead{Prerequisites} Dex 5, Precise Shot, two attacks.
...
\parhead{Prerequisites} Dex 3, Mobility, two attacks.
...
\parhead{Prerequisites} Intelligence 3, two attacks.
...
\featpre Overwhelming Fire, two attacks.
...
\parhead{Prerequisites} Str 5, Two-Weapon Fighting, two attacks.
...
\parhead{Prerequisites} Dex 5, two attacks.
