...
{\small
    ...
    \begin{longtabu}{>{\lcol}p{10em} >{\lcol}p{15em} >{\lcol}X >{\lcol}p{6em} >{\lcol}p{3em}}
        ...
        \featref{Improved Grapple} & \x & \plus2 to grapple attacks; not vulnerable while grappling & Maneuver, Power & \featpref{Improved Grapple} \\
        ...
        \featref{Deadly Aim} & Per 5 & Gain bonus damage with ranged weapons & Precision & \featpref{Deadly Aim} \\
        \featref{Dodge} & Dex 5 & Gain bonus to physical defenses & Defense, Reaction & \featpref{Dodge} \\
        \featref{Eye of the Storm} & Per 5 & Reduce overwhelm penalties & Awareness, Defense & \featpref{Eye of the Storm} \\
        \featref{Gang Up} & Per 5 & Increase overwhelm penalties foes suffer & \x & \featpref{Gang Up} \\
        \featref{Insightful Defense} & Per 5 & Use Perception for defenses & Awareness, Defense & \featpref{Insightful Defense} \\
        \featref{Mighty Blows} & Str 5 & Gain bonus damage with melee weapons & Power & \featpref{Mighty Blows} \\
        \featref{Mighty Shot} & Str 5 & Gain bonus damage with ranged weapons & Power & \featpref{Mighty Shot} \\
        \featref{Predictive Defense} & Int 5 & Use Intelligence for defenses & Awareness, Defense & \featpref{Predictive Defense} \\
        \featref{Tactical Prediction} & Int 5 & Predict foe's next action & Awareness & \featpref{Tactical Prediction} \\
        \featref{Two-Weapon Rend} & Str 5, Mighty Blows, Two-Weapon Fighting & Deal Strength damage with both weapons & Power & \featpref{Two-Weapon Rend} \\
        ...
        \featref{Legendary Awareness} & Any three Awareness feats & Immune to being overwhelmed & Awareness & \featpref{Legendary Awareness} \\
        \featref{Legendary Defense} & Any three Defense feats & \plus2 to all defenses & Defense & \featpref{Legendary Defense} \\
        \featref{Legendary Finesse} & Any three Finesse feats & Roll maximum damage again & Finesse & \featpref{Legendary Finesse} \\
        ...
        \featref{Legendary Mobility} & Any three Mobility feats & Blocking foes do not affect you & Mobility& \featpref{Legendary Mobility} \\
        ...
        \featref{Legendary Power} & Any three Power feats & Wield weapons as if they were less encumbering & Power& \featpref{Legendary Power} \\
        \featref{Legendary Precision} & Any three Precision feats & Very accurate hits deal maximum damage & Precision & \featpref{Legendary Precision} \\
        \featref{Legendary Reaction} & Any three Reaction feats & \plus10 to initiative checks & Combat, Reaction & \featpref{Legendary Reaction} \\
...
{\small
    ...
    \begin{longtabu}{>{\lcol}p{10em} >{\lcol}p{15em} >{\lcol}X >{\lcol}p{6em} >{\lcol}p{3em}}
        ...
        \featref{Covering Fire} & Per 5 & Impair struck foes & Precision, Style & \featpref{Covering Fire} \\
        ...
        \featref{Reckless Attack} & \x & Trade ability to defend yourself for damage bonus & Power, Style & \featpref{Reckless Attack} \\
...
{\small
    ...
    \begin{longtabu}{>{\lcol}p{10em} >{\lcol}p{15em} >{\lcol}X >{\lcol}p{6em} >{\lcol}p{3em}}
        ...
        \featref{Driving Assault} & Str 5 & Shove foe and full attack  & Power, Maneuver, Strike & \featpref{Driving Assault} \\
        \featref{Focused Strike} & \x & Trade attacks for attack bonus & Precision, Strike & \featpref{Focused Strike} \\
        \featref{Immobilizing Strike} & \x & Melee attack immobilizes foe & Strike & \featpref{Immobilizing Strike} \\
        \featref{Intimidating Strike} & \x, Intimidate 8 ranks & Melee attack intimidates foe & Strike & \featpref{Intimidating Strike} \\
...
\featpre Two attacks.
\featben In place of two attacks, you can make a physical attack with a \plus5 attack bonus.
If you hit, you deal damage normally.
You may trade additional attacks to make this strike.
For each attack you trade, you gain an additional \plus5 attack bonus.
...
This grants you a \plus4 attack bonus and allows you to defend yourself with it, just as if you were using another melee weapon you are proficient with.
