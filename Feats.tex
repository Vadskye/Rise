...
\parhead{Effects of Metamagic Feats on a Spell}
...
\parhead{Multiple Metamagic Feats on a Spell}
...
{\small
    ...
    \begin{longtabu}{>{\lcol}p{10em} >{\lcol}p{15em} >{\lcol}X >{\lcol}p{6em} >{\lcol}p{3em}}
        ...
        \midrule
        \thead{Combat Feats} & \thead{Prerequisites (two attacks)} & \thead{Benefit} & \thead{Feat Types} & \thead{Page} \\
        ...
        \midrule
        \thead{Combat Feats} & \thead{Prerequisites (three attacks)} & \thead{Benefit} & \thead{Feat Types} & \thead{Page} \\
        ...
        \midrule
        \thead{Combat Feats} & \thead{Prerequisites (four attacks)} & \thead{Benefit} & \thead{Feat Types} & \thead{Page} \\
...
A minimum attribute score, another feat or feats, a minimum base attack bonus, a minimum number of ranks in one or more skills, or a class level that a character must have in order to acquire this feat.
...
\parhead{Benefit}
You reduce your armor check penalty by 2 and your arcane spell failure by 5\% when using your chosen armor.
...
\parhead{Benefit}
In melee, every time you miss because of being unable to see your opponent, you can reroll your miss chance one time to see if you actually hit.
...
\parhead{Prerequisites}
Nonevil alignment, Celestial Heritage.
\parhead{Benefit}
As a standard action, you can bless your allies, as the \spell{bless}
spell.
...
Nonevil alignment, Celestial Heritage.
\parhead{Benefit}
You gain physical damage reduction 2/evil.
...
Nonevil alignment, Celestial Heritage.
\parhead{Benefit}
Your smite attacks with your Celestial Heritage ability gain an attack bonus equal to the number of celestial bloodline feats you possess.
...
Nonevil alignment, Celestial Heritage.
\parhead{Benefit}
You gain a \plus2 bonus to caster level with Evocation (Channeling) spells and spells from the Good domain.
...
\parhead{Benefit}
While in this style, you gain a \plus2 bonus to physical attack and damage against creatures that moved towards you during the current round.
...
Str 3.
\parhead{Benefit}
If you make a melee attack that knocks a creature unconscious or kills it, you can immediately make an extra melee attack against another creature you threaten.
...
\parhead{Benefit}
You gain a \plus2 bonus to Concentration checks made to cast a spell or use a spell-like ability.
...
Dex 3.
\parhead{Benefit}
At the start of each phase, you may choose a creature you can see.
You ignore that creature when determining whether you are \engaged in combat.

\feat{Covering Fire}{Combat, Style}
\parhead{Benefit}
While in this style, if you hit a creature with a physical ranged attack, it takes a \minus2 penalty to physical attacks for 1 round.
...
Dex 3.
\parhead{Benefit}
While in this style, you gain a \plus2 bonus to physical ranged damage rolls.
...
\parhead{Benefit}
While in this style, you gain a \plus2 bonus to your physical defenses.
...
Constitution 3.
\parhead{Benefit}
When you have critical damage, you suffer a penalty to attacks, checks, and defenses equal to half the amount of critical damage you have.
...
Int 3.
\parhead{Benefit}
Choose a number of Knowledge skills equal to your Intelligence.
...
\parhead{Benefit}
While in this style, foes you threaten take a \minus4 penalty to Concentration checks.
...
\parhead{Benefit}
You gain a breath weapon based on the type of dragon you chose for the Draconic Heritage feat.
...
\parhead{Benefit}
You gain low-light vision, allowing you to treat sources of light as if they had double their normal illumination range.
...
Draconic Heritage.
\parhead{Benefit}
You gain a \plus1 bonus to caster level with all spells and spell-like abilities.
...
Draconic Heritage.
\parhead{Benefit}
You gain a \plus2 bonus to Intimidate and Persuasion checks.
...
Draconic Heritage.
\parhead{Benefit}
You gain a bite natural attack that deals d8 damage for a Medium creature.
...
Dwarf.
\parhead{Benefit}
You gain a \plus2 bonus to defenses against poisons, spells, and spell-like effects.
...
\parhead{Benefit}
When casting a heightened spell, you gain a \plus2 bonus to caster level.
...
\featpre Con 3.
\parhead{Benefit}
You are not staggered when you have no hit points remaining.
...
Ability to cast 2nd level spells.
\parhead{Benefit}
When casting a substituted spell, you can choose what kind of energy damage it deals: cold, fire, or electricity.
...
\parhead{Benefit}
At the end of every round, you can make a free physical melee attack against all creatures you threaten that have no hit points remaining.

\feat{Extend Spell}{Metamagic}
\parhead{Prerequisite}
Ability to cast 2nd level spells.
\parhead{Benefit}
An extended spell has its range doubled.
...
\parhead{Benefit}
You are proficient with exotic weapons from weapon groups that you are otherwise proficient with.
...
\parhead{Benefit}
You learn a new arcane invocation.
...
Smite ability.
\parhead{Benefit}
You can smite three more times per day.
...
\featben As a standard action, you can create sound or light, as the \spell{create sound}
or \spell{dancing light}
spells.
...
\parhead{Benefit}
When counterspelling, you may attempt to counter spells of any school, regardless of which spell you cast.

\feat{Focused Mind}{Racial}
\parhead{Prerequisite}
Elf.
\parhead{Benefit}
You gain a \plus2 bonus to Will defense.
...
\parhead{Benefit}
You gain a \plus2 bonus to physical defenses against creatures of size Large or larger.
...
Two attacks.
\parhead{Benefit}
While in this style, you double your critical threat range with any weapon you wield.
...
\parhead{Benefit}
You can imbue items with magic using your spells or crafting ability.
...
Ability to cast 2nd level spells.
\parhead{Benefit}
As part of casting an imbued spellstrike spell, you can make a single attack with a weapon in your hand.
...
\parhead{Benefit}
When you shove a creature, you can move it outside of your reach.
You also gain a \plus2 bonus to shove attacks.

\feat{Improved Dirty Trick}{Combat, Maneuver}
\parhead{Benefit}
When you perform a dirty trick on a cretaure successfully, the creature is \vulnerable for 1d4 rounds.
You also gain a \plus2 bonus to dirty trick attacks.

\feat{Improved Disarm}{Combat, Finesse}
\parhead{Benefit}
When you disarm a creature, you can make the disarmed item land up to 15 feet away in a random direction.
You also gain a \plus2 bonus to disarm attacks.

\feat{Improved Feint}{Combat, Finesse}
\parhead{Benefit}
When you feint against a creature, if you beat its Armor defense by 5 or more, you deal damage with your weapon normally.
...
\parhead{Benefit}
This metamagic functions like Imbued Spellstrike, except that the imbuement lasts for 5 minutes if you have not struck a foe.
...
\parhead{Benefit}
Grappling does not make you \vulnerable against other creatures.
...
\parhead{Benefit}
When you attempt to overrun a foe, the creature may not choose to avoid you unless you let it.
...
\parhead{Benefit}
When you successfully trip a foe, you get a free melee attack against it.
...
\parhead{Benefit}
You treat your unarmed strike as if it were a lethal weapon.
...
\parhead{Benefit}
You gain a \plus2 bonus to your Will defense.
...
\parhead{Benefit}
When gaining levels in either of your chosen classes, you increase your spellcasting ability with the other class as if your class was nonmagical.
...
Dex 5, three attacks.
\parhead{Benefit}
While in this style, when you attack with a light thrown weapon or projectile weapon, you may attack with two projectiles or weapons at once.
...
\parhead{Benefit}
Each creature you conjure with a summoning spell gains a \plus2 enhancement bonus to Strength and Constitution for the duration of the spell that summoned it.
...
\featpre Ride 1 rank.
\parhead{Benefit}
The penalty you take when using a ranged weapon while mounted is decreased by 4: \minus0 instead of \minus4 if your mount is taking a double move, and \minus4 instead of \minus8 if your mount is running.
...
\featpres Str 3.
\parhead{Benefit}
While in this style, you gain a \plus2 bonus to maneuver attacks.
...
\parhead{Benefit}
While in this style, you contribute to overwhelm penalties against all creatures within a single range increment of you.
...
\parhead{Benefit}
While in this style, your ranged attacks ignore cover and concealment, except total cover and total concealment.
...
\parhead{Benefit}
While in this style, you gain a \plus2 bonus to physical attack rolls with ranged weapons when attacking targets within half of your range increment.
...
\featpres Str 3.
\parhead{Benefit}
While in this style, you gain a \plus2 bonus to physical melee damage rolls.
...
\parhead{Benefit}
While in this style, you can ignore a number of creatures equal to your Perception (minimum 1) when determining whether targets have active cover from you when making ranged attacks.
In exchange, you must spend a full-round action to make a full attack.
\stylereq Wield a ranged weapon.
You must take a full attack action each round.
...
\parhead{Benefit}
You can draw light weapons as a free action and medium weapons as a swift action.
...
Ability to cast 3rd level spells.
\parhead{Benefit}
When casting a reach spell, you can use a spell with a range of touch on a target within \rngclose range.
...
\parhead{Benefit}
As part of the action to counter a spell, you may expend an Abjuration (Negation) spell of 4th level or higher.
...
\parhead{Benefit}
While in this style, any creature you deal damage to with a physical attack takes a \minus2 penalty to physical defenses for 1 round.
...
Ability to cast 3rd level spells.
\parhead{Benefit}
When casting a shaped spell, you can exclude any number of 5-foot cubes within the spell's area.
...
\featben Three times per day, when you successfully attempt to disarm an object, you may cause it to be affected as if by the targeted version of the \spell{shatter}
...
Choose a skill.
\parhead{Benefit}
You gain a \plus3 bonus to all checks involving that skill.
...
2nd level spells.
\parhead{Benefit}
You get a \plus2 bonus to your caster level when casting spells and using spell-like abilities from the school of magic or with the spell descriptor you select.
\parhead{Special}
You can gain this feat multiple times.
Its effects do not stack.
...
\parhead{Benefit}
When mounted and using the charge action, you deal double damage with a melee weapon (or triple damage with a lance) on your attack at the end of the charge.%Spirited Charge

\feat{Spring Attack}{Combat}
\parhead{Prerequisites}
Dex 3, Mobility, two attacks.
\parhead{Benefit}
As a full-round action, you can move up to your speed and make your full attack.
...
Dwarf.
\parhead{Benefit}
You gain a \plus2 bonus to Craft and Awareness checks related to stone or metal.
...
This functions as the \spell{suggestion}
...
Intelligence 3.
\parhead{Benefit}
You can attempt to identify the strengths and weaknesses of creatures based on your combat experience.
...
\parhead{Benefit}
You can attempt to predict what your opponent will do.
As a swift action, you can make a special check with a bonus equal to your base attack bonus \add your Intelligence \add 2 per round you have seen the creature fight.
...
\parhead{Benefit}
You gain \plus3 hit points, \plus1 per level above 3.
...
\parhead{Benefit}
When wielding a weapon in both hands, you gain a \plus1 bonus to physical defenses.
...
Dex 3.
\parhead{Benefit}
You gain a \plus2 attack bonus when attacking with two weapons at once.

\feat{Two-Weapon Rend}{Combat, Power}
\parhead{Prerequisites}
Str 5, Two-Weapon Fighting, two attacks.
\parhead{Benefit}
When fighting with two weapons at once, you gain a \plus1 bonus to physical damage.
...
Craft (any) 10 ranks.
\parhead{Benefit}
You learn how to make items from any school of magic, including universal spells.
...
\parhead{Benefit}
You gain a special ability based on the weapon group chosen.
...
Choose one weapon group.
\parhead{Benefit}
You are proficient with weapons from your chosen weapon group.
This allows you to defend yourself normally with melee weapons, and to attack with exotic ranged weapons without penalty.
\parhead{Normal}
You cannot defend yourself with melee weapons you are not proficient with, and you take a \minus4 penalty to physical attacks with ranged weapons you are not proficient with.
\parhead{Special}
