...
{\small
    ...
    \begin{longtabu}{>{\lcol}p{10em} >{\lcol}p{15em} >{\lcol}X >{\lcol}p{3em}}
        ...
        \featref{Imbue Magic} & Spellpower 2 or Craft (any) 5 ranks & Create magic items & \featpref{Imbue Magic} \\
...
\featpre Spellpower 2 or Craft (any) 6 ranks.
...
\featben If your spellpower with a spell is at least twice a creature's level, it is treated as \bloodied for the purpose of determining the effects of that spell.
