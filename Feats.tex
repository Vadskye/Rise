...
{\small
    ...
    \begin{longtabu}{>{\lcol}p{10em} >{\lcol}p{15em} >{\lcol}X >{\lcol}p{6em} >{\lcol}p{3em}}
        ...
        \tind \featref{Mobile Whirlwind} & Dex 5, Whirlwind Strike, base attack bonus \plus6 & Use whirlwind strike as standard action & Mobility & \featpref{Mobile Whirlwind} \\
...
\parhead{Benefit} You have the blood of a celestial creature in your veins. Once per day, when you make an attack, you can declare the attack to be a smite attack. If you smite an evil creature, you gain a bonus to attack equal to the number of celestial bloodline feats you have, and a bonus to damage equal to your level.
...
\parhead{Benefit} While in this style, you gain a \plus3 bonus to physical attacks against creatures that moved towards you during the current round. In exchange, you are \immobilized. At base attack bonus \plus6, and every 4 base attack bonus thereafter, you increase the bonus by 1.
...
\parhead{Prerequisites} Dex 3, base attack bonus \plus2.
\parhead{Benefit} While in this style, you gain a \plus2 bonus to physical ranged damage rolls. In exchange, you take a \minus2 penalty on physical ranged attacks. At base attack bonus \plus5, and every 5 base attack bonus thereafter, you increase the bonus and penalty by 1.
\stylereq Wield a ranged weapon. You must take a standard attack action each round.
...
\featpre Base attack bonus \plus2.
\parhead{Benefit} While in this style, you gain a \plus2 bonus to your physical defenses. In exchange, you take a \minus2 penalty on physical attacks. At base attack bonus \plus5, and every 5 base attack bonus thereafter, you increase the bonus and penalty by 1.
\stylereq Wield a melee weapon. You must take a standard attack or total defense action each round.
...
\parhead{Prerequisites} Base attack bonus \plus2.
\parhead{Benefit} While in this style, foes you threaten take a \minus3 penalty to Concentration checks. In exchange, you take a \minus3 penalty to physical defenses against melee attacks. At base attack bonus \plus6, and every 4 base attack bonus thereafter, you increase both penalties by 1.
\stylereq Wield a melee weapon. You must take a standard attack or charge action each round.
...
\featpre Base attack bonus \plus2.
\parhead{Benefit} Allies adjacent to you reduce their overwhelm penalties by 2. In exchange, you take a \minus2 penalty to Maneuver defense. If this penalty reduction reduces an ally's overwhelm penalty to 0, the ally is not considered to be overwhelmed. At base attack bonus \plus5, and every 5 base attack bonus thereafter, the penalty reduction and penalty increases by 1.
\stylereq Wield a melee weapon. You must take a standard attack or total defense action each round.
...
\parhead{Benefit} While in this style, you gain a \plus2 bonus to attack and damage on attacks of opportunity. In exchange, you take a \minus2 penalty to physical attacks that are not attacks of opportunity. At base attack bonus \plus5, and every 5 base attack bonus thereafter, you increase the bonus and penalty by 1.
\stylereq Wield a melee weapon. You must take a standard attack or charge action each round.

\feat{Overpowering Assault}{Combat, Style}
\parhead{Prerequisite} Str 3.
\parhead{Benefit} While in this style, you gain a \plus2 bonus to maneuver attacks. In exchange, you take a \minus2 penalty to physical defenses. At base attack bonus \plus5, and every 5 base attack bonus thereafter, you increase the bonus and penalty by 1.
\stylereq Wield a melee weapon. You must take a standard attack or charge action each round.
...
\featpre Base attack bonus \plus2.
\parhead{Benefit} While in this style, you can ignore a number of creatures equal to your Wisdom (minimum 1) when determining whether targets have active cover from you. In exchange, you must spend a full-round action to make a standard attack.
\stylereq Wield a ranged weapon. You must take a standard attack action each round.
