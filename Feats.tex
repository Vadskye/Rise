...
\featref{Endurance} & Con 3 & Resist nonlethal damage \\
...
\featref{Legendary Charisma} & Cha 10 & \plus5 to Charisma for some purposes \\
\featref{Legendary Constitution} & Con 10 & \plus5 to Constitution for some purposes \\
\featref{Legendary Dexterity} & Dex 10 & \plus5 to Dexterity for some purposes \\
\featref{Legendary Intelligence} & Int 10 & \plus5 to Intelligence for some purposes \\
\featref{Legendary Strength} & Str 10 & \plus5 to Strength for some purposes \\
\featref{Legendary Wisdom} & Wis 10 & \plus5 to Wisdom for some purposes \\
...
\midrule
\thead{Bloodline Feats} & \thead{Prerequisites} & \thead{Benefit} \\
...
\featref{Trap Sense} & Danger sense class feature & Automatically detect traps \\
...
\featref{Versatile Crafter} & Craft (any) 8 ranks & Craft items from many subschools of magic \\

\midrule
\thead{Magic Feats} & \thead{Prerequisites} & \thead{Benefit} \\
\featref{Bardic Spellpower} & Arcane spellcasting ability & Fighter and rogue levels improve some spells \\ 
\featref{Battlecaster} & Proficiency with light armor & Reduce arcane spell failure by 10\% \\
\featref{Combat Casting} & \x &  \plus2 bonus on Concentration checks to cast spells, reroll 1/day \\
\featref{Craftcaster} & Craft (any) 8 ranks, 2nd level spells & Increase caster level when creating, transforming objects \\
\featref{Deceptive Casting} & Spellcasting ability & Trade concentration to make spells difficult to identify \\
\featref{Empathic Casting} & 3rd level Enchantment (Emotion) spell & Trade Will saves for caster level with mind-affecting spells \\
\featref{Improved Counterspell} & \x &  Counterspell with spell of same school \\
\featref{Magical Synthesis} & Levels in two magical classes & Gain magic levels in two magical classes at once \\
\featref{Mass Transporter} & 5th level Conjuration (Translocation) spell & Transport many creatures at once \\ 
\featref{Mighty Summons} & 2nd level summoning spell & Summoned creatures gain \plus2 Str, \plus2 Con \\
\featref{Rapid Metamagic} & Spellcraft 8 ranks, spellcasting ability, one metamagic feat & Apply metamagic effects more quickly \\
\featref{Residual Awareness} & Divination (Awareness) spell & Gain brief Perception bonus after casting a spell \\
\featref{Residual Knowledge} & Divination (Knowledge) spell & Gain brief Knowledge bonus after casting a spell \\
\featref{Residual Beguilement} & 3rd level Enchantment (Beguilement) spell & Gain Persuasion bonus after casting a spell \\
\featref{Residual Shield} & Abjuration (Shielding) spell & Gain benefits of spell briefly after casting on another creature \\
\featref{Resilient Magic} & 2nd level Abjuration (Negation) spell & Spells persist for 1 round after being dispelled \\
\featref{Retributive Counterspell} &  4th level spells & Countered spells rebound on original caster \\
...
\tind \featref{Spell Specialization} & Magic level 8th, Spell Focus &  \plus2 caster level with specific type of magic, \minus2 penalty with other types. \\
\featref{Wardwalker} & 3rd level Abjuration (Warding) spell & Wards you encounter trigger one round late \\

\midrule
\thead{Metamagic Feats} & \thead{Prerequisites} & \thead{Benefit} \\
\featref{Empower Spell} & 2nd level spells & Cast spell as higher level \\
...
\tind \featref{Improved Imbued Spellstrike} & 3rd level spells, Imbued Spellstrike & (\plus2) Imbue weapon with spell's power up to 5 minutes \\
...
\featref{Ledgewalker} & Acrobatics 5 ranks & Balance easily on narrow surfaces \\
...
\featref{Legendary Leaper} & Athletics 13 ranks & Make standing jumps without penalty, rebound off objects easily \\
...
\featref{Poison Expert} & Int 3 & Apply poisons more effectively \\
...
\featref{Trapfinder} & Perception 5 ranks & Find traps faster \\
...
\midrule
\thead{Spellgift Feats} & \thead{Prerequisites} & \thead{Benefit} \\
Arcane Spellgift & 2nd level, Cha 1 & Gain arcane spell as spell-like ability \\
Divine Spellgift & 2nd level, Cha 1 & Gain cleric or druid spell as spell-like ability \\
Potent Spellgift & Any spellgift feat & \plus2 caster level with spellgifts \\
...
\featref{Exotic Weapon Proficiency}\fn{1} & \x & Don't provoke when attacking with exotic weapons & Equipment \\
...
\featref{Weapon Focus} & Base attack bonus \plus4 & Special ability with weapon group & Equipment \\
...
\featref{Intuitive Defense} & Wis 3, base attack bonus \plus8 & Add half Wis to AC & Defense, Style \\
...
\featref{Predictive Defense} & Int 3, base attack bonus \plus8 & Add half Int to AC & Defense, Style \\
...
\featref{Whirlwind Attack} & Dex 5, base attack bonus \plus8 & One melee attack against each opponent within reach & Style \\
...
\featref{Penetrating Strike} & Base attack bonus \plus12 & Attack removes foe's damage reduction & Strike \\
\featref{Two-Weapon Rend} & Str 5, base attack bonus \plus12, Two-Weapon Fighting & Deal Strength damage with both weapons & Power \\
...
\featpre 8th level, Con 3
\featben Three times per day, you may heal two points of ability damage as a swift action. This healing increases by 1 at 12th level and every 4 levels thereafter. After using this ability, you cannot use it again for 5 rounds.
