...
\featref{Deathless} & Con 5 or base Fortitude save \plus10 & Immune to death effects & \featpref{Deathless} \\
\featref{Diehard} & Con 3 & Remain conscious after taking critical damage & \featpref{Diehard} \\
\featref{Fearless} & Cha 5 or base Will save \plus10 & Immune to fear and hostile morale effects & \featpref{Fearless} \\
\featref{Great Fortitude} & \x &  \plus2 bonus on Fortitude saves, reroll 1/day & \featpref{Great Fortitude} \\
\featref{Iron Will} & \x &  \plus2 bonus on Will saves, reroll 1/day & \featpref{Iron Will} \\
...
\featref{Lightning Reflexes} & \x &  \plus2 bonus on Reflex saves, reroll 1/day & \featpref{Lightning Reflexes} \\
\featref{Mental Fortress} & Cha 9 or base Will save \plus18 & Immune to hostile mind-affecting effects & \featpref{Mental Fortress} \\
\featref{Perfect Health} & Con 3 or base Fortitude save \plus6 & Immune to disease, later poison & \featpref{Perfect Health} \\
...
\featref{Inspire Courage} & Perform 6 ranks  & Grant allies bonuses to attack rolls and saves against fear & \featpref{Inspire Courage} \\
...
\featref{Dwarven Resilience} & Dwarf & \plus2 to saves against spells & \featpref{Dwarven Resilience} \\
...
\featben When you attack, you may take a \minus4 penalty to hit. If you deal damage, the foe struck must make a Will save to avoid being bewildered for 5 rounds. A vulnerable creature takes a \minus2 penalty to attack rolls, saving throws, checks, DCs, and AC. The DC is equal to 10 \add your base attack bonus \add your attack attribute (Strength or Dexterity). You cannot make more than one Strike each round.
...
\featben When you attack, you may take a penalty to hit of \minus4 or greater. If you deal damage, you may make an Intimidate check as an immediate action to demoralize the foe you struck if it is within 30 feet of you. You gain a bonus to your Intimidate equal to the penalty you took to hit. You cannot make more than one Strike each round.
