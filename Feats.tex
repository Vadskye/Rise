...
Spellgift feats grant limited spell-like abilities. You can use any combination of spell-like abilities gained from spellgift feats a number of times per day equal to the number of spellgift feats you possess. The number of spellgift feats you have cannot exceed your Charisma.
...
\begin{longtabu}{>{\lcol}p{15em} >{\lcol}p{15em} >{\lcol}X >{\lcol}p{3em}}
...
\featref{Legendary Charisma} & Cha 10 & \plus5 to Charisma for some purposes & \featpref{Legendary Charisma} \\
\featref{Legendary Constitution} & Con 10 & \plus5 to Constitution for some purposes & \featpref{Legendary Constitution} \\
\featref{Legendary Dexterity} & Dex 10 & \plus5 to Dexterity for some purposes & \featpref{Legendary Dexterity} \\
\featref{Legendary Intelligence} & Int 10 & \plus5 to Intelligence for some purposes & \featpref{Legendary Intelligence} \\
\featref{Legendary Strength} & Str 10 & \plus5 to Strength for some purposes & \featpref{Legendary Strength} \\
\featref{Legendary Wisdom} & Wis 10 & \plus5 to Wisdom for some purposes & \featpref{Legendary Wisdom} \\
...
\featref{Imbuement Admixture} & Magic level 6th & Combine multiple spells to create items & \featpref{Imbuement Admixture} \\
...
\featref{Magical Synthesis} & Levels in two magical classes & Gain magic levels in two magical classes at once & \featpref{Magical Synthesis} \\
...
\featref{Spell Focus}\fn{1} & Magic level 4th &  \plus2 caster level with specific type of magic & \featpref{Spell Focus} \\
\tind \featref{Spell Specialization} & Magic level 8th, Spell Focus &  \plus2 caster level with specific type of magic, \minus2 penalty with other types. & \featpref{Spell Specialization} \\
\featref{Wardwalker} & 3rd level Abjuration (Warding) spell & Wards you encounter trigger one round late & \featpref{Wardwalker} \\

\midrule
\thead{Metamagic Feats} & \thead{Prerequisites} & \thead{Benefit} & \thead{Page} \\
\featref{Empower Spell} & 2nd level spells & Cast spell as higher level & \featpref{Empower Spell} \\
\featref{Energetic Substitution} & 2nd level spells & (\plus1) Change spell's energy type & \featpref{Energetic Substitution} \\
\featref{Enlarge Spell} & 2nd level spells & (\plus1) Double spell's range & \featpref{Enlarge Spell} \\
\featref{Imbued Spellstrike} & 2nd level spells & (\plus1) Combine spell with weapon attack & \featpref{Imbued Spellstrike} \\
\tind \featref{Improved Imbued Spellstrike} & 3rd level spells, Imbued Spellstrike & (\plus2) Imbue weapon with spell's power up to 5 minutes & \featpref{Improved Imbued Spellstrike} \\
\featref{Quicken Spell} & 3rd level spells & (\plus2) Cast spell as swift action, but lose next action & \featpref{Quicken Spell} \\
\featref{Reach Spell} & 3rd level spells & (\plus2) Cast touch spell at Close range & \featpref{Reach Spell} \\
\featref{Shape Spell} & 3rd level spells & (\plus2) Exclude areas within spell's area & \featpref{Shape Spell} \\
\featref{Silent Spell} & 2nd level spells & (\plus1) Cast spell without verbal components & \featpref{Silent Spell} \\
\featref{Still Spell} & 2nd level spells & (\plus1) Cast spell without somatic components & \featpref{Still Spell} \\
\featref{Sustained Spell} & 2nd level spells & (\plus1) Maintain concentration as swift action & \featpref{Sustained Spell} \\
\featref{Widen Spell} & Caster level 8th & (\plus3) Double spell's area & \featpref{Widen Spell} \\
...
\featref{Poison Expert} & Int 3 & Apply poisons more effectively & \featpref{Poison Expert} \\
...
{\small
\taburowcolors [2] 2{tbrown .. white}
\begin{longtabu}{>{\lcol}p{15em} >{\lcol}p{15em} >{\lcol}X >{\lcol}p{10em} >{\lcol}p{3em}}
...
\midrule
\thead{Combat Feats} & \thead{Prerequisites} & \thead{Benefit} & \thead{Feat Type} & \thead{Page} \\
\featref{Active Defense} & Base attack bonus \plus4 & Take attacks of opportunity normally while fighting defensively & Reaction & \featpref{Active Defense} \\
...
\featref{Improved Bull Rush} & Base attack bonus \plus4 & \plus2 bonus on bull rush attacks; push target back without moving & Maneuver, Power & \featpref{Improved Bull Rush} \\
...
\featref{Improved Feint} & Base attack bonus \plus4 & \plus2 bonus on feint attacks; feint as move action & Finesse, Maneuver & \featpref{Improved Feint} \\
\featref{Improved Grapple} & Base attack bonus \plus4 & \plus2 bonus on grapple attacks; attack faster in grapple & Maneuver, Power & \featpref{Improved Grapple} \\
...
\featben You gain the ability to use a non-restricted sorcerer/wizard spell as a spell-like ability once per day. You choose which spell when you gain this feat, and that choice cannot thereafter be changed. Your effective caster level is equal to your level.
...
\featpre 2nd level, Cha 1.
\featben You gain the ability to use a cleric or druid spell as a spell-like ability once per day. You choose which spell when you gain this feat, and that choice cannot thereafter be changed. Your effective caster level is equal to your level.
