...
\subsubsection{Expert Tactician [Combat ]}
\parhead{Prerequisites} Wis 3, base attack bonus \plus4.
...
\parhead{Normal} Without this feat, you may draw a weapon as a move action, or as a swift action as part of movement, and you can draw a hidden weapon as a standard action.
...
\parhead{Benefit} You can draw a weapon as a swift action. You can draw a hidden weapon (see the Sleight of Hand skill) as a move action.
...
\parhead{Benefit} You get a \plus2 circumstance bonus on damage rolls with ranged weapons when attacking targets within one range increment. \babscalingdescription
