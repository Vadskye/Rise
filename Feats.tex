...
\featref{Great Fortitude} & \x &  \plus2 bonus to Fortitude defense, reroll 1/day & \featpref{Great Fortitude} \\
\featref{Iron Will} & \x &  \plus2 bonus to Will defense, reroll 1/day & \featpref{Iron Will} \\
...
\featref{Lightning Reflexes} & \x &  \plus2 bonus to Reflex defense, reroll 1/day & \featpref{Lightning Reflexes} \\
...
\featref{Elemental Heritage} & \x & Gain saving throw bonus based on elemental ancestor & \featpref{Elemental Heritage} \\
...
\featref{Inspire Greatness} & Perform 12 ranks  & Grant allies bonuses to saving throws and AC & \featpref{Inspire Greatness} \\
...
\featref{Divine Spellgift} & 2nd level, Cha 1 & Gain cleric or druid spell as spell-like ability & \featpref{Divine Spellgift} \\
...
\featref{Armor Proficiency (Light)} & \x &  No armor check penalty on attack rolls & Equipment & \featpref{Armor Proficiency (Light)} \\
\tind \featref{Armor Proficiency (Medium)} & Armor Proficiency (light) & No armor check penalty on attack rolls & Equipment & \featpref{Armor Proficiency (Medium)} \\
\tind \tind \featref{Armor Proficiency (Heavy)} & Armor Proficiency (medium) & No armor check penalty on attack rolls & Equipment & \featpref{Armor Proficiency (Heavy)} \\
...
\featref{Defensive Fighting} & \x & Trade attack bonus for AC & Defense, Style & \featpref{Defensive Fighting} \\
\featref{Dodge} & Dex 3 & \plus4 AC against some attacks of opportunity from selected target & Defense, Mobility & \featpref{Dodge} \\
...
\featref{Overpowering Assault} & Str 3 & Trade AC for maneuver bonus & Power, Style & \featpref{Overpowering Assault} \\
...
\featref{Shield Proficiency} & \x &  No armor check penalty on attack rolls & Equipment & \featpref{Shield Proficiency} \\
\tind \featref{Tower Shield Proficiency} & Shield Proficiency & No armor check penalty on attack rolls & Equipment & \featpref{Tower Shield Proficiency} \\
...
\tind \featref{Two-Weapon Defense} & Two-Weapon Fighting & Off-hand weapon grants \plus1 shield bonus to AC, later \plus3 & Defense, Finesse & \featpref{Two-Weapon Defense} \\
...
\featref{Reveal the Weak Point} & Base attack bonus \plus4 & Sacrifice attack and damage to penalize foe's AC & Style & \featpref{Reveal the Weak Point} \\
...
\featref{Intuitive Defense} & Wis 3, base attack bonus \plus8 & Add half Wis to AC & Defense, Style & \featpref{Intuitive Defense} \\
...
\featref{Predictive Defense} & Int 3, base attack bonus \plus8 & Add half Int to AC & Defense, Style & \featpref{Predictive Defense} \\
...
\featben You gain the ability to use a non-restricted sorcerer/wizard spell as a spell-like ability once per day. You choose which spell when you gain this feat, and that choice cannot thereafter be changed. Your effective caster level is equal to your level, and your magic attack bonus is equal to half your caster level \add your Charisma.
...
\parhead{Benefit} While in this style, if you hit a creature with a ranged attack, it takes a \minus2 penalty to attack rolls for 1 round. In exchange, you take a \minus2 penalty to damage rolls with ranged weapons. At base attack bonus \plus4, and every 4 base attack bonus thereafter, you increase the bonus and penalty by 1.
...
\parhead{Benefit} While in this style, you gain a \plus2 bonus on ranged damage rolls. In exchange, you take a \minus2 penalty on ranged attack rolls. At base attack bonus \plus4, and every 4 base attack bonus thereafter, the penalty increases by 1 and the bonus increases by 2.
...
\parhead{Benefit} While in this style, you gain a \plus2 bonus to your dodge modifier. In exchange, you take a \minus2 penalty on attack rolls. At base attack bonus \plus4, and every 4 base attack bonus thereafter, you increase the bonus and penalty by 1. If you do not wield a melee weapon and take the standard attack or total defense action during your turn, you cannot use this style.
...
\parhead{Benefit} While in this style, foes you threaten take a \minus2 penalty to Concentration checks. In exchange, you take a \minus2 penalty to armor class against melee attacks. At base attack bonus \plus4, and every 4 base attack bonus thereafter, you increase both penalties by 1. If you do not wield a melee weapon, you cannot use this style.

\feat{Divine Spellgift}{Spellgift}
\featpre 2nd level, Cha 1.
\featben You gain the ability to use a cleric or druid spell as a spell-like ability once per day. You choose which spell when you gain this feat, and that choice cannot thereafter be changed. Your effective caster level is equal to your level, and the save DC is equal to 10 \add half caster level \add your Charisma.
...
A breath weapon deals 1d6 damage per two levels and allows a Reflex save for half damage. The save DC is equal to 10 \add half your Hit Dice \add your Constitution. After using your breath weapon, you must wait 1d4 rounds before you can use it again.
...
\parhead{Benefit} You gain a \plus2 bonus on saving throws against poisons, spells, and spell-like effects.
...
\featben While in this style, as part of a standard attack, you may provoke an attack of opportunity from one opponent threatening you. You gain a \plus4 bonus to armor class against this attack. If the opponent takes the attack of opportunity, they are flat-footed against your next attack. This effect lasts for 1 round.

\feat{Focused Mind}{Racial}
\parhead{Prerequisite} Elf.
\parhead{Benefit} You gain a \plus2 bonus to Will saves. In addition, you can use your Intelligence instead of your Constitution on Concentration checks, such as when you cast spells.
...
\parhead{Benefit} You get a \plus2 bonus on all Fortitude saving throws. Once per day, you may reroll a Fortitude save. You must decide to use this ability before the results are revealed. You must take the second roll, even if it is worse.
...
\parhead{Prerequisite} Base attack bonus \plus8.
\parhead{Benefit} While in this style, you double your critical threat range with any weapon you wield. In exchange, you take a \minus4 penalty to attack rolls which are not critical threats or threat confirmations. This does not stack with any other effects which increase threat range.
...
\featpre Base attack bonus \plus8.
\featben While in this style, foes that take a withdraw action to move away from you still provoke attacks of opportunity from you. In exchange, you take a \minus4 penalty to AC.
...
\featben While in this style, you can add half your Wisdom to your AC in place of your Dexterity. This bonus does not apply if you would be denied your Dexterity to your AC, such as when you are flat-footed.
...
\parhead{Benefit} You get a \plus2 bonus on all Will saving throws. Once per day, you may reroll a Will save. You must decide to use this ability before the results are revealed. You must take the second roll, even if it is worse.
...
\parhead{Benefit} You get a \plus2 bonus on all Reflex saving throws. Once per day, you may reroll a Reflex save. You must decide to use this ability before the results are revealed. You must take the second roll, even if it is worse.
...
\parhead{Benefit} While in this style, you take a \minus2 penalty to AC and gain a \plus2 bonus to maneuvers. At base attack bonus \plus4, and every 4 base attack bonus thereafter, you increase the bonus and penalty by 1. The penalty to AC lasts until the start of the next turn after you end the style.
...
\parhead{Benefit} While in this style, you get a \plus2 bonus on damage rolls with ranged weapons when attacking targets within half of your range increment. In exchange, you take a \minus2 penalty to attack rolls against foes beyond that range. At base attack bonus \plus4, and every 4 base attack bonus thereafter, you increase the bonus and penalty by 1.  
...
\featben While in this style, you can add half your Intelligence to your AC in place of your Dexterity. This bonus does not apply if you would be denied your Dexterity to your AC, such as when you are flat-footed.
...
\featpre Base attack bonus \plus4.
\parhead{Benefit} While in this style, any creature you deal damage to takes a \minus3 penalty to AC for 1 round. In exchange, you take a \minus3 penalty to attack and damage. At base attack bonus \plus8, and every 4 base attack bonus thereafter, you increase the bonus and penalty by 1. As normal, penalties from the same source do not stack.
...
\parhead{Prerequisite} Dex 3.
\parhead{Benefit} You gain a \plus2 bonus to attack rolls when attacking with two weapons at once.
...
\begin{itemize*}
    \item Armor weapons: When you perform a shield bash, you still benefit from the shield's AC bonus. In addition, armor spikes no longer impose a penalty to your AC.
    \item Axes: You gain a \plus2 bonus to attack against unarmored creatures (creatures without an armor modifier to AC). 
    \item Blades, heavy: You gain a \plus2 bonus to attack against unarmored creatures (creatures without an armor modifier to AC).
    ...
    \item Blunt weapons: When you deal damage to a creature, it takes a \minus2 penalty to Will saves for 1 round. This penalty is not cumulative with itself.
    ...
    \item Flexible weapons: You gain a \plus2 bonus to attack creatures with a shield modifier to AC.
    \item Headed weapons: You gain a \plus2 bonus to attack against armored creatures (creatures with an armor modifier to AC).
    \item Monk weapons: ??
