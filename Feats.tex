...
\stylereq Wield a melee weapon and use Strength to attack. You must take a standard attack or charge action each round.

\feat{Precise Shot}{Combat, Style}
\featpre Base attack bonus \plus2.
\parhead{Benefit} While in this style, you can ignore a number of creatures equal to your Perception (minimum 1) when determining whether targets have active cover from you when making ranged attacks. In exchange, you must spend a full-round action to make a standard attack.
\stylereq Wield a ranged weapon. You must take a standard attack action each round.
...
\parhead{Benefit} As a full-round action, you can move up to your speed and make your standard attack. You must move at least 5 feet after each attack you make before you can make another attack. You can only use this style while \unencumbered.
