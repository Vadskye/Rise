...
\tind \featref{Deflect Arrows} & Dex 3, Improved Unarmed Strike & Deflect one ranged attacks with your bare hands & Defense, Reaction & \featpref{Deflect Arrows} \\
\tind \tind \featref{Snatch Arrows} & Dex 5, Deflect Arrows, Improved Unarmed Strike & Catch a deflected ranged attack & Defense, Reaction & \featpref{Snatch Arrows} \\
...
\featref{Point Blank Shot} & \x &  \plus2 bonus to ranged damage within 30 ft. & Precision, Style & \featpref{Point Blank Shot} \\
...
\featref{Tactical Readiness} & Int 3 & Ready two actions at once & Reaction & \featpref{Tactical Readiness} \\
...
\midrule
\thead{Combat Feats} & \thead{Prerequisites} & \thead{Benefit} & \thead{Feat Type} & \thead{Page} \\
\featref{Chargebreaker} & Base attack bonus \plus4 & Gain \plus2 to attack and damage when readying against approaching foe & Reaction & \featpref{Chargebreaker} \\
...
\featref{Cleaving Stride} & Str 3, base attack bonus \plus8, Cleave & Continue movement after dropping target & Power & \featpref{Cleaving Stride} \\
...
\featref{Heartseeker} & Base attack bonus \plus8 & Trade attack bonus to double critical threat range & Style & \featpref{Heartseeker} \\
...
\featref{Intuitive Defense} & Wis 3, base attack bonus \plus8 & Add half Wis to defense & Defense, Style & \featpref{Intuitive Defense} \\
...
\featref{Pierce Wings} & Base attack bonus \plus8 & Ranged attack removes foe's ability to fly & Strike & \featpref{Pierce Wings} \\ 
\featref{Predictive Defense} & Int 3, base attack bonus \plus8 & Add half Int to defense & Defense, Style & \featpref{Predictive Defense} \\
...
\featref{Master Tactician} & Int 3, base attack bonus \plus12 & Ready full-round actions with allies & Reaction & \featpref{Master Tactician} \\
...
\parhead{Benefit} When you ready an action to attack a foe that approaches you, you gain a \plus2 bonus to attack and damage on your attacks for the readied action.
