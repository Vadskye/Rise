...
{\small
    ...
    \begin{longtabu}{>{\lcol}p{10em} >{\lcol}p{15em} >{\lcol}X >{\lcol}p{6em} >{\lcol}p{3em}}
        ...
        \featref{Mounted Trample} & Ride 8 ranks & Target cannot avoid mounted overrun & Maneuver, Mounted & \featpref{Mounted Trample} \\
        ...
        \featref{Mounted Charge} & Ride 8 ranks & Gain bonus damage with mounted charge & Mounted, Power & \featpref{Mounted Charge} \\
...
\featpres Nonevil alignment, Celestial Heritage.
\featben You gain a \plus2 bonus to spellpower with Evocation (Channeling) spells and spells from the Good domain.
If you have three or more celestial bloodline feats, this bonus increases to \plus4.
