...
\subsubsection{Bewildering Strike [Combat, Precision, Strike]}
\featpre Base attack bonus \plus8.
...
\subsubsection{Confusing Strike [Combat, Precision, Strike]}
\featpre Base attack bonus \plus16.
\featben When you attack, you may take a \minus8 penalty to hit. If you deal damage, the foe struck must make a Will save to avoid being confused for 1 round. The DC is equal to 10 \add your base attack bonus \add your attack attribute (Strength or Dexterity). You cannot use more than one Strike feat each round.
...
\featben When you attack, you may take a \minus2 penalty to hit. If you deal damage, you may make an Intimidate check as an immediate action to demoralize the foe you struck. You cannot use more than one Strike feat each round.

\subsubsection{Penetrating Strike [Combat, Power, Strike]}
...
\subsubsection{Pierce Wings [Combat, Precision, Strike]}
\featpre Base attack bonus \plus8.
\featben When you attack with a ranged weapon, you may take a \minus4 penalty to hit. If you deal damage, the foe struck must make a Fortitude save or lose its ability to fly for 1 round. The DC is equal to 10 \add your base attack bonus \add your Wisdom. This only affects creatures who use wings or other physical means to fly, and has no effect on creatures with magical or supernatural flight. You cannot use more than one Strike feat each round.

\subsubsection{Reaping Strike [Combat, Strike]}
\featpre Base attack bonus \plus16.
...
\subsubsection{Sickening Strike [Combat, Power, Strike]}
\featpre Base attack bonus \plus8.
