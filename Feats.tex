...
Combat Finesse & \x & Add half Dexterity value to damage with light, possibly medium weapons \\
...
\tind \tind Improved Deflect Arrows & Dex 7, Deflect Arrows, Improved Unarmed Strike, base attack bonus \plus4 & Deflect ranged attacks per round equal to Dexterity modifier \\
...
Precise Shot & \x & Add half Dex value to damage, no penalty for shooting into melee \\
...
Enlarge Spell  & Caster level 1st & \plus1 & Double spell's range \\
Extend Spell  & Caster level 1st & \plus1 & Double spell's duration \\
Heighten Spell  & Caster level 4th & Variable & Cast spell as higher level \\
%Maximize Spell  & Caster level 6th & \plus3 & Maximize spell's variable, numeric effects \\
Quicken Spell  & Caster level 4th & \plus2 & Cast spell as swift action, but lose next action \\
Silent Spell  & Caster level 1st & \plus1 & Cast spell without verbal components \\
Still Spell  & Caster level 1st & \plus1 & Cast spell without somatic components \\
Widen Spell  & Caster level 6th & \plus3 & Double spell's area
\end{tabularx}
\end{dtable!*}
...
\parhead{Normal} Without this feat, a character can typically turn or rebuke undead (or other creatures) a number of times per day equal to 3 \add his or her Charisma modifier.
...
\parhead{Benefit} You can use your Intelligence modifier instead of your Constitution modifier on Concentration checks, such as when you cast spells.
...
\parhead{Benefit} Each round, you can deflect a number of arrows equal to your Dexterity modifier.%Improved Deflect Arrows
...
\parhead{Benefit} You must declare that you are using this feat before you make your attack roll (thus, a failed attack roll ruins the attempt). Stunning Fist forces a foe damaged by your unarmed attack to make a Fortitude saving throw (DC 10 \add 1/2 your character level \add your Wis modifier), in addition to dealing damage normally. A bloodied defender who fails this saving throw is stunned for 1 round (until just before your next action). A stunned character can't act, is flat-footed, and takes a \minus2 penalty to AC. A healthy defender is staggered instead, and can only take a standard action each round. You may attempt a stunning attack once per day for every two levels you have attained (but see Special), and no more than once per round. Constructs, oozes, plants, undead, incorporeal creatures, and creatures immune to critical hits cannot be stunned.
...
\parhead{Benefit} When fighting with two weapons at once, you may add your full Strength value to damage with both hands, even if you are using light weapons.
...
\parhead{Benefit} You can add half your Dexterity value to damage with ranged weapons (in addition to Strength value, if any), except for with medium and large thrown weapons. Additionally, you can shoot or throw ranged weapons at an opponent engaged in melee without taking the standard \minus4 penalty on your attack roll.
...
\parhead{Prerequisite} Caster level 1st.
\parhead{Benefit} An extended spell lasts twice as long as normal. This metamagic can only be applied to spells with a duration of \durshort, \durmed, \durlong, or \durext. An extended spell uses up a spell slot one level higher than the spell's actual level.
