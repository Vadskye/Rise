...
\featben As a standard action, you can bless your allies, as the \spell{bless}
spell.
...
\featpres
Nonevil alignment, Celestial Heritage.
\featben You gain a \plus2 bonus to caster level with Evocation (Channeling) spells and spells from the Good domain.
...
\featben While in this style, you gain a \plus2 bonus to physical attack and damage against creatures that moved towards you during the current round.
...
\featben You gain a \plus2 bonus to Concentration checks made to cast a spell or use a spell-like ability.
...
\featben While in this style, if you hit a creature with a physical ranged attack, it takes a \minus2 penalty to physical attacks for 1 round.
...
\featpres
Dex 3.
\featben While in this style, you gain a \plus2 bonus to physical ranged damage rolls.
...
\featpre Draconic Heritage.
\featben You gain a \plus1 bonus to caster level with all spells and spell-like abilities.
...
\featben When casting a heightened spell, you gain a \plus2 bonus to caster level.
...
\featpre Elf.
\featben You gain a \plus2 bonus to Will defense.
...
\featben You gain a \plus2 bonus to your Will defense.
...
\featben Each creature you conjure with a summoning spell gains a \plus2 enhancement bonus to Strength and Constitution for the duration of the spell that summoned it.
...
\featpres Str 3.
\featben While in this style, you gain a \plus2 bonus to maneuver attacks.
...
\featben While in this style, you gain a \plus2 bonus to physical attack rolls with ranged weapons when attacking targets within half of your range increment.
...
\featpres Str 3.
\featben While in this style, you gain a \plus2 bonus to physical melee damage rolls.
...
\featben While in this style, any creature you deal damage to with a physical attack takes a \minus2 penalty to physical defenses for 1 round.
...
\featben You get a \plus2 bonus to your caster level when casting spells and using spell-like abilities from the school of magic or with the spell descriptor you select.
\parhead{Special}
You can gain this feat multiple times.
Its effects do not stack.
...
\featben When mounted and using the charge action, you deal double damage with a melee weapon (or triple damage with a lance) on your attack at the end of the charge.%Spirited Charge
...
\featben You gain \plus3 hit points, \plus1 per level above 3.
...
\featpre Dex 3.
\featben You gain a \plus2 attack bonus when attacking with two weapons at once.
