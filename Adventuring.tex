...
\begin{dtable}
    ...
    \begin{tabularx}{\columnwidth}{l X X}
        \thead{Strength} & \thead{Unencumbered Weight Limit} & \thead{Maximum Weight Limit} \\
        \minus9 & 5 lb. & 10 lb. \\
        \minus8 & 10 lb. & 20 lb. \\
        \minus7 & 15 lb. & 30 lb. \\
        \minus6 & 20 lb. & 40 lb. \\
...
\parhead{Encumbrance by Weight} A creature can carry up to its unencumbered weight limit without any penalty. If it carries more than that, but less than its encumbered weight limit, it is encumbered as if it was wearing heavy armor.

\parhead{Encumbrance by Weight} If you want to determine whether your character's gear is heavy enough to slow him or her down more than the armor already does, total the weight of all the character's items, including armor, weapons, and gear. Compare this total to the character's Strength on \trefnp{Carrying Capacity}. A creature can carry up to its unencumbered weight limit without any penalty. If it carries more than that, but less than its encumbered weight limit, it is encumbered as if it was wearing heavy armor, and is treated as if it were wearing heavy armor for the purpose of class features and abilities. If it is also actually wearing armor, the penalties do not stack. 

\parhead{Lifting and Dragging} A character can lift as much as his or her maximum weight limit over his or her head.

A character can lift as much as double his or her maximum weight limit off the ground, but he or she can only stagger around with it. While overloaded in this way, the character loses any Dexterity bonus or dodge modifier to AC and can move only 5 feet per round (as a full-round action).
...
\parhead{Run} A character can only run for a number of rounds equal to 5 \add Constitution before having to rest for a minute.
