...
\par Magic items always get saving throws. A magic item's Fortitude, Reflex, and Mental defenses are equal to 12 \add one-half its caster level. An attended magic item either makes saving throws as its owner or uses its own saving throw bonus, whichever is better.
