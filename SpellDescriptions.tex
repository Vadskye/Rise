...
\begin{spelltarget}{One creature}
    ...
    \end{itemize}
\end{spelltarget}
\spellnotes This spell gives no information about a creature's strengths or abilities -- only its weaknesses. When the spell expires, the bonus to attack and damage is lost, but the knowledge remains.
