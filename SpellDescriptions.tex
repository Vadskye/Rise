...
\begin{spellsection}{Enervation}{4}
    ...
    \begin{spellcontent}
        ...
        \end{spelltargetinginfo}
        \begin{spelleffects}
            \spellsuccess If the target is living, it gains two \conditionlink{negative levels}. This imposes a \minus2 penalty to the target's attacks, special defenses, and checks, and a \minus10 penalty to its current and maximum hit points.
...
\begin{spellsection}{Resist Energy}{1}
    ...
    \begin{spellcontent}
        ...
        \begin{spelleffects}
            ...
            \spelleffect The target gains damage reduction against the chosen energy type. The value of the damage reduced each round is equal to 4 \add 1 per caster level above 2nd.
            \spelldur \durpersonallong
        \end{spelleffects}
    \end{spellcontent}
    \begin{spellfooter}
...
\begin{spellsection}{Righteous Might}{6}
    ...
    \begin{spellcontent}
        ...
        \end{spelltargetinginfo}
        \begin{spelleffects}
            \spellsuccess You become larger, as \spell{enlarge person}. In addition, you gain physical damage reduction, reducing the physical damage you take each round by 12 \add 1 per caster level above 12th. This damage reduction is overcome by evil attacks if you are good or neutral, and by good attacks if you are evil. If you are hit by an appropriately aligned attack, you cannot use your damage reduction for 1 round.
            \spelldur \durshort \dismissable
        \end{spelleffects}
    \end{spellcontent}
    \begin{spellfooter}
