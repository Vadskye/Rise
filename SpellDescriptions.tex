...
\end{spellcontent}
\begin{spellfooter}
    \spellinfo{Evoc/Transmutation (Augment, Channeling) [see text]}*{Chaos, Evil, Good, Law}
...
\end{spellcontent}
\begin{spellfooter}
    \spellinfo{Abjuration/Evoc (Energy, Shielding) [see text]}{Arcane, Protection}
...
\end{spellcontent}
\begin{spellfooter}
    \spellinfo{Evoc/Transmutation (Energy, Imbuement) [Fire]}{Fire, Nature, Wild}
...
\end{spellsubcontent}
\begin{spellfooter}
    \spellinfo{Abjuration/Evoc (Energy, Shielding) [Fire or Cold]}{Arcane, Fire}
...
\end{spellcontent}
\begin{spellfooter}
    \spellinfo{Conjuration/Evoc (Creation, Energy) [Cold, Destructive]}{Arcane, Destruction, Nature, Water}
    \spellnotes \destructivespellnotes
\end{spellfooter}
...
\end{spellcontent}
\begin{spellfooter}
    \spellinfo{Evoc/Necromancy (Control, Life) [Force]}{Arcane}
...
\end{spellcontent}
\begin{spellfooter}
    \spellinfo{Abjuration/Evoc (Control, Shielding)}{Arcane}
...
\end{dtable*}
\begin{spellfooter}
    \spellinfo{Conjuration/Evoc (Energy, Control, Creation)}{Air, Divine, Nature, War, Water}
...
\end{spellsubcontent}
\begin{spellfooter}
    \spellinfo{Abjuration/Evoc (Control, Shielding)}{Air, Nature}
...
\end{spellcontent}
\begin{spellfooter}
    \spellinfo{Evoc/Transmutation (Augment, Control) [Air]}{Air, Nature}
