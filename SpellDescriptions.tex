...
\end{spelleffect}
\begin{spellnotes}
    When you cast this spell, you make a spell check. This check is opposed by the Will defense of any creature that interacts with the effect. If you fail, the creature disbelieves the spell. In order to interact with the illusion with a Perception check, the creature must make a Perception check that beats your spell check. Anyone witnessing the subject perform an impossible action, such as attacking or climbing without the use of its hands, gains a \plus10 bonus to their Will defense against this check.
\end{spellnotes}
