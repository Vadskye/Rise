...
\begin{spelleffect}
  This spell functions like \spell{magic weapon}, except that it can also give the weapon an aligment.
\end{spelleffect}
...
\spellsr{Yes (Reflex)}
\begin{spelleffect}
    The wall provides active cover (20\% miss chance) against attacks made through it. Attacks that miss in this way harmlessly strike the wall.
\end{spelleffect}
...
\spellsection{Living Projectile}
\spellschool{Abjuration/Evocation (Control, Shielding)}
\spelllvl{Arcane 3}
\spellrng{\rngclose}
\spelltgts{One willing creature and one creature}
\spelldur{Instantaneous and 1 round}
\spellsr{Yes (Will) and No}
\begin{spelleffect}
