...
\spelltabular
\spellschool{Conj (Creation) [Acid, Fog]} & \spelllists{Arcane, Destruction} \\
\spellzone{\areamed radius cylinder, 20 ft. high} & \spellrng{\rngmed} \\
\spelldur{\durshort}
\end{tabularx}
\begin{spelleffect}
...
\longcol{\spellzone{\areasmall radius from you}} \\ 
...
\longcol{\spellemanation{\areasmall radius centered on you}} \\
\spelldur{\durlong \dismissable}
\end{tabularx}
\begin{spelleffect}
...
\spellburst{\areamed radius} & \spelltgts{All enemies in the area} \\
\spelldur{5 rounds}
\spellsr{Yes (Will)}
\end{tabularx}
\spellattack{Magic vs. Will}
...
\spellzone{\areasmall radius} & \spellrng{\rngmed} \\
\spelldur{\durshort \dismissable}
\end{tabularx}
\begin{spelleffect}
...
\spellzone{100 ft. wall, 20 ft. high \shapeable} & \spellrng{\rngmed} \\
\spelldur{\durshort \dismissable}
\spellsr{Yes (Reflex)}
\end{tabularx}
\begin{spelleffect}
...
\longcol{\spellburst{\arealarge radius centered on you}} \\
\spellsr{Yes (Will)}
\end{tabularx}
\begin{spelleffect}
...
\spellburst{\areamed cone} & \spelltgts{Everything in the area} \\
\spellsr{Yes (Reflex)}
\end{tabularx}
\spellattack{Magic vs. Reflex}
\begin{spellsuccess}
...
\spellburst{\arealarge vertical line, 5 ft. wide} & \spellrng{\rngmed} \\
...
\spellburst{\areamed radius} & \spellrng{\rngmed} \\
...
\longcol{\spelllimit{\areamed radius centered on the primary target}} \\
...
\longcol{\spellcmp{Verbal, Somatic, and Focus}} \\
\longcol{\spelllimit{\areamed radius centered on you}} \\
...
\longcol{\spellburst{\areamed cone}} \\
\longcol{\spelltgts{All creatures in the area}} \\
\spelldur{1d4 rounds}
\spellsr{Yes (Will)}
\end{tabularx}
...
\spellzone{One 5 ft. cube/caster level} & \spellrng{\rngfar} \\
\spelldur{\durmed \dismissable}
\end{tabularx}
\begin{spelleffect}
...
\longcol{\spellburst{\areamed radius}} \\
...
\longcol{\spellemanation{\arealarge cone from you}} \\
\spelldur{Concentration}
\end{tabularx}
\begin{spelleffect}
...
\spelllimit{\areamed radius centered on you} & \spellrng{\rngext} \\
...
\spellburst{\areamed radius; see text} & \spellrng{\rngmed} \\
...
\spellzone{\arealarge radius} & \spellrng{\rngfar} \\
\spelldur{1 round}
\end{tabularx}
\spellattack{Magic vs. Reflex}
\begin{spelleffect}
...
\spelltabular
\spellschool{Trans (Animation) [Earth]} & \spelllists{Earth, Nature} \\
\spelllimit{\areasmall radius} & \spellrng{\rngmed} \\
...
\spelllimit{\arealarge radius} & \spellrng{\rngmed} \\
\spelldur{\durlong \dismissable}
\end{tabularx}
\begin{spelleffect}
...
\longcol{\spelllimit{1 mile radius}} \\
\spelldur{\durlong \dismissable}
\end{tabularx}
\begin{spelleffect}
...
\spellburst{\areasmall or \areamed radius from the touched objects; see text} & \spellrng{\rngtouch} \\
...
\spellburst{\arealarge} & \spellrng{\rngmed} \\
\spellsr{Yes (Reflex)}
...
\spelltabular
\spellschool{Evoc (Energy) [Destructive, Fire]} & \spelllists{Arcane, Fire} \\
\spellburst{\areasmall radius} & \spellrng{\rngmed} \\
\spellsr{Yes (Reflex)}
...
\spellburst{\areamed radius cylinder, 40 ft. high} & \spellrng{\rngclose} \\
\spellsr{Yes (Fortitude)}
\end{tabularx}
...
\spelllimit{\areamed radius} & \spellrng{\rngclose} \\
...
\spelltabular
\spellschool{Conj (Creation)} & \spelllists{Arcane} \\
\spellzone{\areasmall radius} & \spellrng{\rngclose} \\
\spelldur{\durshort \dismissable}
\end{tabularx}
\spellattack{Magic vs. Reflex}
\begin{spelleffect}
...
\longcol{\spellzone{\arealarge line from you}} \\
\end{tabularx}
\spellattack{Special vs. Maneuver Defense}
\begin{spelleffect}
...
\spelllimit{\arealarge radius} & \spellrng{\rngfar} \\
...
\spellburst{\areasmall radius cylinder, 20 ft. high} & \spellrng{\rngmed} \\
...
\longcol{\spellburst{\arealarge line, 10 ft. wide}} \\
\spellsr{Yes (Reflex)}
\end{tabularx}
...
\spellemanation{\areasmall radius centered on touched creature} & \spellrng{Touch} \\
\spelldur{\durshort \dismissable}
\spellsr{Yes (Will)}
\end{tabularx}
\begin{spelleffect}
...
\spellburst{A \arealarge radius cylinder, 100 ft. high} & \spellrng{\rngfar} \\
\spellsr{Yes (Reflex)}
...
\spellzone{\areamed radius cylinder, 20 ft. high} & \spellrng{\rngclose} \\
...
\spelltabular
\spellschool{Evoc (Control) [Force]} & \spelllists{Arcane} \\
\longcol{\spelllimit{\arealarge radius centered on you}} \\
...
\longcol{\spellzone{\areamed radius cylinder centered on you, 20 ft. high}} \\
\end{tabularx}
\begin{spelleffect}
...
\spelltabular
\spellschool{Illus (Figment)} & \spelllists{Illus} \\
\longcol{\spelllimit{\arealarge radius}} \\
\spelldur{\durmed \dismissable}
\end{tabularx}
\begin{spelleffect}
...
\longcol{\spellburst{\arealarge cone}} \\
\spellsr{Yes (varies)}
\end{tabularx}
\spellattack{See text}
\begin{spelleffect}
...
\spelltabular
\spellschool{Evoc (Control, Energy) [Light]} & \spelllists{Arcane, Chaos} \\
\spellzone{\arealarge wall, 20 ft. high} & \spellrng{\rngclose} \\
\spelldur{\durshort \dismissable}
\spellsr{See text}
\end{tabularx}
\spellattack{See text}
...
\longcol{\spellemanation{100 foot radius centered on you}} \\
\spelldur{\durshort}
\spellsr{Yes (Will)}
...
\spelltabular
\spellschool{Div (Awareness) [Mind-Affecting]} & \spelllists{Arcane, Knowledge} \\
\longcol{\spelllimit{\areamed radius}} \\
...
\longcol{\spellzone{\arealarge radius centered on you}} \\
\spelldur{\durshort}
\spellsr{Yes (Will)}
\end{tabularx}
\begin{spelleffect}
...
\spelltabular
\spellschool{Conj (Creation) [Fog]} & \spelllists{Arcane, Nature} \\
\longcol{\spellzone{200 ft. radius cylinder centered on you, 50 ft. high}} \\
\end{tabularx}
\begin{spelleffect}
...
\spelllimit{\areamed radius} & \spellrng{\rngext} \\
\longcol{\spellburst{\arealarge vertical line of lightning, 5 ft. wide}} \\
\spellsr{Yes (Reflex)}
...
\longcol{\spellburst{\areamed radius centered on you}} \\
\spelldur{\durshort}
\spellsr{Yes (Will)}
\end{tabularx}
\spellattack{Magic vs. Will}
...
\spellburst{\areasmall radius} & \spellrng{\rngclose} \\
\spellsr{Yes (Fortitude)}
...
\spelltime{Full-round action}
\spellzone{360 ft. radius cylinder, 200 ft. high} & \spellrng{\rngfar} \\
...
\spellzone{100 ft. wall, 10 ft. high} & \spellrng{\rngmed} \\
\spelldur{\durshort \dismissable}
\end{tabularx}
\begin{spelleffect}
...
\spellzone{\arealarge wall, 5 ft. high \shapeable} & \spellrng{\rngmed} \\
\end{tabularx}
\spellattack{See text}
\begin{spelleffect}
...
\spellzone{100 ft. wall, 10 ft. high \shapeable} & \spellrng{\rngmed} \\
\spelldur{\durlong \dismissable}
\end{tabularx}
\begin{spelleffect}
