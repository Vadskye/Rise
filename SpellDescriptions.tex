...
\spelltabular
\spellschool{Abjur (Shielding)} & \spelllists{Abjur} \\
\spelltime{Immediate action} & \spellcmp{Verbal only} \\
...
\spelltabular
\spellschool{Abjur (Negation) [Magic]} & \spelllists{Abjur, Magic} \\
\spelltime{Immediate action} & \spellcmp{Verbal only} \\
...
\spelltabular
\spellschool{Conj (Creation) [Acid]} & \spelllists{Arcane} \\
\spelltgt{One creature or object} & \spellrng{\rngmed} \\
...
\spelltabular
\spellschool{Conj (Creation) [Acid]} & \spelllists{Arcane} \\
\spelltgt{One creature or object} & \spellrng{\rngfar} \\
\spelleff{One arrow of acid} & \\
\spelldur{1 round per two caster levels}
\end{tabularx}
...
\spelltabular
\spellschool{Conj (Creation) [Acid]} & \spelllists{Arcane, Destruction} \\
\spellarea{\areamed radius spread} & \spellrng{\rngmed} \\
...
\end{spelleffect}
\spelltriggeredattack{Magic vs. Fortitude}
\spelltrigger{End of round}
\spelltriggertarget{All creatures in the area}
\begin{spellsuccess}
    4d6 acid damage.
\end{spellsuccess}
\begin{spellfailure}
...
\spelltabular
\spellschool{Necro (Flesh)} & \spelllists{Arcane} \\
\spelltgt{One creature} & \spellrng{\rngmed} \\
\spelldur{\durshort}
...
\spelltabular
\spellschool{Ench (Emotion) [Mind-Affecting, Morale]} & \spelllists{Divine} \\
\spelltgt{One creature} & \spellrng{\rngclose} \\
\spelldur{\durshort}
\spellsr{Yes (Will)}
\end{tabularx}
\spellattack{Magic vs. Will (harmless)}
\begin{spellsuccess}
...
\spelltabular
\spellschool{Trans (Imbuement) [Air]} & \spelllists{Air, Divine, Nature, Travel} \\
\spelltgt{One creature} & \spellrng{\rngtouch} \\
\spelldur{\durshort}
\spellsr{Yes (Will)}
\end{tabularx}
\begin{spelleffect}
...
\spelltabular
\spellschool{Trans (Alteration)} & \spelllists{Arcane} \\
\spelltgt{One weapon} & \spellrng{Touch} \\
\spelldur{\durmed}
\spellsr{Yes (Will)}
\end{tabularx}
\spellattack{Magic vs. Will (object)}
...
\spellarea{\areamed radius limit} & \spellrng{\rngmed} \\
\longcol{\spelltgts{Five animals in the area}} \\
\end{tabularx}
\begin{spelleffect}
...
\spelltabular
\spellschool{Trans (Animation)} & \spelllists{Chaos, Trans} \\
\spellarea{\areamed radius limit} & \spellrng{\rngmed} \\
\longcol{\spelltgts{One Small object/level in the area; see text}} \\
\spelldur{\durshort}
\end{tabularx}
\begin{spelleffect}
...
\spelltabular
\spellschool{Trans (Animation)} & \spelllists{Nature, Plant} \\
\longcol{\spelltgts{One Small plant/level in the area; see text}} \\
\end{tabularx}
\begin{spelleffect}
...
\spelltabular
\spellschool{Abjur (Interdiction) [Barrier]} & \spelllists{Divine, Nature, Wild} \\
\longcol{\spellarea{\areasmall radius immobile emanation from you}} \\ 
...
\spelltabular
\spellschool{Abjur (Negation) [Magic]} & \spelllists{Abjur, Divine, Magic} \\
\longcol{\spellarea{\areasmall radius mobile emanation from you}} \\
\spelldur{\durlong \dismissable}
\end{tabularx}
\begin{spelleffect}
...
\spelltabular
\spellschool{Trans (Alteration) [Water]} & \spelllists{Nature, Water} \\
\spelltgt{One weapon} & \spellrng{\rngclose} \\
...
\spelltabular
\spellschool{Necro/Trans (Augment, Life)} & \spelllists{Arcane, Evil} \\
\spelltgt{One living creature} & \spellrng{\rngtouch} \\
...
\spelltabular
\spellschool{Ench (Emotion) [Mind-Affecting]} & \spelllists{Ench} \\
\spelltgt{One creature} & \spellrng{\rngmed} \\
\spelldur{\durshort}
\spellsr{Yes (Will)}
\end{tabularx}
...
\spelltabular
\spellschool{Ench (Emotion) [Mind-Affecting, Morale]} & \spelllists{Divine, Evil, War} \\
\spellarea{\areamed radius burst} & \\
\spellsr{Yes (Will)}
\end{tabularx}
\begin{spellsuccess}
  All enemies in the area take a \minus2 penalty to physical attacks for 5 rounds.
\end{spellsuccess}

\spellsection{Banishment}{6}
\spelldesc{You force extraplanar creatures back to their home plane.}
\spelltabular
\spellschool{Abjur/Conj (Interdiction, Translocation) [Planar]} & \spelllists{Arcane, Divine} \\
\longcol{\spellcmp{Verbal, Somatic, and Focus}} \\
\spelltgts{One creature/round} & \spellrng{\rngmed} \\
...
\spelltabular
\spellschool{Trans (Augment)} & \spelllists{Nature, Wild} \\
\spelltgt{One living creature} & \spellrng{Touch} \\
\spelldur{\durshort}
\spellsr{Yes (Fortitude)}
\end{tabularx}
\spellattack{Magic vs. Fortitude (harmless)}
\begin{spellsuccess}
...
\spelltabular
\spellschool{Necro (Life) [Curse]} & \spelllists{Death, Divine, Evil, Necro} \\
\spelltgt{One creature} & \spellrng{\rngclose} \\
\spelldur{Permanent}
\spellsr{Yes (Will)}
\end{tabularx}
...
\spelltabular
\spellschool{Conj/Trans (Animation, Creation)} & \spelllists{Arcane} \\
\spellarea{\areasmall radius spread} & \spellrng{\rngmed} \\
\longcol{\spelleff{Black tentacles in the area}} \\
\spelldur{\durshort \dismissable}
\end{tabularx}
\begin{spelleffect}
...
\spelltabular
\spellschool{Evoc (Energy) [Force, Wall]} & \spelllists{Divine, War} \\
\spelleff{Wall of whirling blades} & \spellrng{\rngmed} \\
\spelldur{\durshort \dismissable}
\spellsr{Yes (Reflex)}
\end{tabularx}
\begin{spelleffect}
    You create a wall of blades made of force energy. You can make a single straight wall up to 100 feet long, or a ringed cylinder of blades with a radius of up to 20 feet. In either case, the wall is 20 feet high. The wall provides active cover (20\% miss chance) against attacks made through it. Attacks that miss in this way harmlessly strike the wall.
\end{spelleffect}
\spelltriggeredattack{Magic vs. Reflex}
\spelltriggers{Wall is created on creature, or creature passes through wall}
\spelltriggertarget{The creature in the wall}
\begin{spellsuccess}
...
\spelltabular
\spellschool{Evoc (Channeling) [Evil]} & \spelllists{Divine, Evil} \\
...
\spelltabular
\spellschool{Ench (Emotion) [Mind-Affecting, Morale]} & \spelllists{Divine, Good, War} \\
\spellarea{\areamed radius burst} & \\
\spellsr{Yes (Will)}
\end{tabularx}
\spellattack{Magic vs. Will (harmless)}
...
\spelltabular
\spellschool{Necro (Flesh)} & \spelllists{Arcane, Divine, Death} \\
\spelltgt{One creature} & \spellrng{\rngclose} \\
\spelldur{\durshort \dismissable}
\spellsr{Yes (Fortitude)}
\end{tabularx}
...
\spelltabular
\spellschool{Conj (Translocation) [Planar]} & \spelllists{Arcane} \\
\spelltgt{You} & \spellrng{\rngpers} \\
\spelldur{\durshort \dismissable}
\end{tabularx}
\begin{spelleffect}
...
\spelltabular
\spellschool{Illus (Glamer)} & \spelllists{Arcane} \\
\spelltgt{One creature} & \spellrng{\rngclose} \\
\spelldur{\durshort \dismissable}
\spellsr{Yes (Will)}
\end{tabularx}
...
\spelltabular
\spellschool{Evoc (Energy) [Fire]} & \spelllists{Arcane, Destruction, Nature, Fire} \\
...
\spelltabular
\spellschool{Evoc (Energy) [Destructive, Electricity]} & \spelllists{Air, Nature} \\
\spelltime{Full-round action}
\spellarea{\arealarge vertical line of lightning, 5 ft. wide} & \spellrng{\rngmed} \\
...
\spellattack{Magic vs. Reflex and Fortitude}
\begin{spelleffect}
    This spell functions like \spell{call lightning}, except that your attack is also made against the target's Fortitude. If you are outdoors in a stormy area, each bolt deals 5d10 electricity damage \add d10 per four caster levels above 10th instead.
\end{spelleffect}
\spellattack{Magic vs. Fortitude}
\begin{spellsuccess}
...
\spelltabular
\spellschool{Ench (Emotion) [Mind-Affecting]} & \spelllists{Arcane} \\
\spellarea{\areamed radius spread} & \spellrng{\rngmed} \\
\spelldur{Concentration}
\spellsr{Yes (Will)}
\end{tabularx}
...
\spelltabular
\spellschool{Evoc (Energy) [Electricity]} & \spelllists{Arcane, Destruction, Nature} \\
\spellarea{\areamed radius centered on the primary target} & \spellrng{\rngmed} \\
\longcol{\spelltgts{One primary target, plus five secondary targets in the area}} \\
\spellsr{Yes (Reflex)}
...
\spelltabular
\spellschool{Trans (Alteration, Animation)} & \spelllists{Nature, Wild} \\
\longcol{\spellcmp{Verbal, Somatic, and Focus}} \\
\spelltime{Full-round action}
\spelltgt{Your touched staff} & \spellrng{\rngtouch} \\
...
\spelltabular
\spellschool{Evoc (Channeling) [Chaotic]} & \spelllists{Chaos} \\
\spelltgt{One creature} & \spellrng{\rngmed} \\
...
\spelltabular
\spellschool{Ench (Emotion) [Charm, Mind-Affecting]} & \spelllists{Ench} \\
\longcol{\spelltgt{One creature}} \\
\end{tabularx}
\begin{spellsuccess}
...
\spelltabular
\spellschool{Ench (Emotion) [Charm, Mind-Affecting]} & \spelllists{Ench} \\
\spelltgt{One humanoid} & \spellrng{\rngmed} \\
\spelldur{\durlong}
\spellsr{Yes (Will)}
\end{tabularx}
\spellattack{Magic vs. Will}
...
\spellschool{Ench (Emotion) [Charm, Mind-Affecting]} & \spelllists{Ench} \\
\spellarea{\areamed radius limit} & \spellrng{\rngmed} \\
\longcol{\spelltgts{Five creatures in the area}} \\
\end{tabularx}
\begin{spellsuccess}
...
\spelltabular
\spellschool{Necro (Vitalism) [Death, Negative]} & \spelllists{Death, Divine} \\
\longcol{\spellcmp{Verbal, Somatic, and Focus}} \\
\spellarea{\areamed radius limit} & \spellrng{\rngmed} \\
\longcol{\spelltgts{Several living creatures in the area}} \\
\spellsr{Yes (Fortitude)}
\end{tabularx}
\spellattack{Magic vs. Fortitude}
\begin{spelleffect}
...
\spelltabular
\spellschool{Evoc (Control) [Force]} & \spelllists{Evoc, Strength} \\
\spellsr{Yes (Fortitude)}
\spelldmg{2d10 force damage \add half casting attribute}
\end{tabularx}
\begin{spelleffect}
  This spell functions like \spell{interposing hand}, except that the hand can also strike foes. Each round, as a swift action, you can command the hand to attack a foe. If you do, it makes a physical attack against that foe during the action phase.
\end{spelleffect}
...
\spelltabular
\spellschool{Abjur (Shielding) [Chaotic]} & \spelllists{Chaos, Divine} \\
\longcol{\spellcmp{Verbal, Somatic, and Focus}} \\
\longcol{\spellarea{\areamed radius limit centered on you}} \\
\longcol{\spelltgts{Five creatures in the area}} \\
\spelldur{\durshort \dismissable}
\spellsr{Yes (Will)}
\end{tabularx}
...
\spelltabular
\spellschool{Conj (Creation) [Fog, Poison]} & \spelllists{Arcane} \\
\end{tabularx}
\spellattack{Magic vs. Fortitude}
\begin{spelleffect}
    This spell functions like \spell{fog cloud}, except that the fog is poisonous. At the end of each round, you attack all living creatures in the area.
...
\spelltabular
\spellschool{Illus (Figment) [Light, Sight-Dependent]} & \spelllists{Arcane} \\
\longcol{\spellarea{\areamed cone-shaped burst}} \\
\spelldur{1d4 rounds}
\spellsr{Yes (Will)}
\end{tabularx}
\spellattack{Magic vs. Will}
...
\spelltabular
\spellschool{Trans (Augment)} & \spelllists{Arcane} \\
\longcol{\spellcmp{Verbal, Somatic, and Material}} \\
\spelltgt{You} & \spellrng{\rngpers} \\
\spelldur{\durshort \dismissable}
\end{tabularx}
\begin{spelleffect}
...
\spelltabular
\spellschool{Ench (Compulsion) [Language-Dependent, Mind-Affecting, Sound-Dependent]} & \spelllists{Arcane, Divine, Law} \\
\longcol{\spellcmp{Verbal only}} \\
\spelltgt{One creature} & \spellrng{\rngmed} \\
\spelldur{1 round}
\spellsr{Yes (Will)}
\end{tabularx}
...
\spelltabular
\spellschool{Ench (Compulsion) [Language-Dependent, Mind-Affecting, Sound-Dependent]} & \spelllists{Divine, Law} \\
\spellarea{\areamed radius limit} & \spellrng{\rngmed} \\
\longcol{\spelltgts{Five creatures in the area}} \\
\end{tabularx}
\begin{spelleffect}
...
\spelltabular
\spellschool{Evoc (Energy) [Cold]} & \spelllists{Arcane, Nature} \\
\longcol{\spellarea{\areamed cone-shaped burst}} \\
\spelldur{5 rounds}
\spellsr{Yes (Reflex)}
\end{tabularx}
...
\end{spellsuccess}
\begin{spellfailure}
    Half damage, and the target is not fatigued.
\end{spellfailure}
...
\spelltabular
\spellschool{Ench (Compulsion) [Mind-Affecting]} & \spelllists{Arcane, Chaos, Trickery} \\
\spelltgt{One creature} & \spellrng{\rngmed} \\
\spelldur{\durshort}
\spellsr{Yes (Will)}
\end{tabularx}
...
\spelltabular
\spellschool{Ench (Compulsion) [Mind-Affecting]} & \spelllists{Arcane, Trickery} \\
\spellarea{\areamed radius limit} & \spellrng{\rngmed} \\
\longcol{\spelltgts{Five creatures in the area}} \\
\end{tabularx}
\begin{spelleffect}
...
\spelltabular
\spellschool{Evoc (Control) [Water]} & \spelllists{Nature, Water} \\
\spellarea{Water in one volume/caster level of 10 ft. by 10 ft. by 2 ft. (S)} & \spellrng{\rngfar} \\
\spelldur{\durmed \dismissable}
\end{tabularx}
\begin{spelleffect}
...
\spelltabular
\spellschool{Illus (Figment) [Unreal]} & \spelllists{Illus} \\
\spelleff{Illusory sounds} & \spellrng{\rngclose} \\
\spelldur{\durshort \dismissable}
\end{tabularx}
...
\spelltabular
\spellschool{Conj (Summoning)} & \spelllists{Nature} \\
\spelltime{Full-round action}
\spelleff{One swarm of centipedes per two caster levels} & \spellrng{\rngclose; see text} \\
\spelldur{\durmed}
\end{tabularx}
\begin{spelleffect}
...
\spelltabular
\spellschool{Ench (Emotion) [Mind-Affecting, Morale]} & \spelllists{Arcane} \\
\longcol{\spellarea{\areamed cone-shaped burst}} \\
\spelldur{\durmed}
\spellsr{Yes (Will)}
\end{tabularx}
...
\spelltabular
\spellschool{Evoc (Control) [Force]} & \spelllists{Evoc} \\
\spellsr{Yes (Fortitude)}
...
\spelltabular
\spellschool{Necro (Vitalism) [Positive]} & \spelllists{Divine, Life, Nature} \\
\end{tabularx}
...
\spelltabular
\spellschool{Necro (Vitalism) [Positive]} & \spelllists{Divine, Nature} \\
\spelltgt{One creature} & \spellrng{\rngclose} \\
\spellsr{Yes (Fortitude)}
\end{tabularx}
...
\spelltabular
\spellschool{Necro (Life) [Positive]} & \spelllists{Divine, Life, Nature} \\
\end{tabularx}
...
\spelltabular
\spellschool{Illus (Figment) [Light]} & \spelllists{Arcane} \\
\spellarea{\areasmall radius limit} & \spellrng{\rngmed} \\
\longcol{\spelleff{Up to four lights in the area}} \\
\spelldur{\durshort \dismissable}
\end{tabularx}
\begin{spelleffect}
...
\spelltabular
\spellschool{Div (Awareness)} & \spelllists{Arcane} \\
\spelltgt{One creature} & \spellrng{\rngtouch} \\
\spelldur{\durlong}
\spellsr{Yes (Fortitude)}
\end{tabularx}
...
\spelltabular
\spellschool{Illus (Figment) [Light]} & \spelllists{Divine} \\
...
\spelltabular
\spellschool{Ench (Inhibition) [Mind-Affecting]} & \spelllists{Arcane} \\
\spellarea{\areamed limit} & \spellrng{\rngmed} \\
\longcol{\spelltgts{Five creatures in the area}} \\
\end{tabularx}
\begin{spelleffect}
...
\spelltabular
\spellschool{Necro (Life) [Death]} & \spelllists{Death, Evil, Necro} \\
\spelltgt{Living creature} & \spellrng{\rngmed} \\
...
\spelltabular
\spellschool{Abjur/Necro (Shielding, Vitalism) [Positive]} & \spelllists{Death, Divine, Good, Protection} \\
...
\spelltabular
\spellschool{Abjur/Necro (Shielding, Vitalism) [Positive]} & \spelllists{Death, Divine} \\
\spellarea{\areamed radius limit} & \spellrng{\rngmed} \\
\longcol{\spelltgts{Five living creatures in the area}} \\
\end{tabularx}
\begin{spelleffect}
...
\spelltabular
\spellschool{Ench (Compulsion) [Mind-Affecting]} & \spelllists{Arcane} \\
\spelltgt{One creature} & \spellrng{\rngmed} \\
\spelldur{\durlong}
\spellsr{Yes (Will)}
\end{tabularx}
...
\spelltabular
\spellschool{Necro (Flesh)} & \spelllists{Divine, Nature} \\
...
\spelltabular
\spellschool {Abjur/Trans (Shielding, Temporal)} & \spelllists{Arcane} \\
\spelltgt{You} & \spellrng{Personal} \\
\spelldur{\durmed}
\end{tabularx}
\begin{spelleffect}
...
\spelltabular
\spellschool{Evoc (Energy) [Destructive, Fire]} & \spelllists{Arcane, Fire} \\
\longcol{\spellarea{\areamed radius spread}} \\
...
\spelltabular
\spellschool{Necro (Flesh) [Death]} & \spelllists{Destruction, Divine} \\
\longcol{\spellcmp{Verbal, Somatic, and Focus}} \\
\spelltgt{One creature} & \spellrng{\rngclose} \\
\spellsr{Yes (Fortitude)}
\end{tabularx}
...
\spelltabular
\spellschool{Div (Awareness) [Detection]} & \spelllists{Divine} \\
\longcol{\spellarea{\arealarge cone-shaped mobile emanation from you}} \\
\spelldur{Concentration}
\end{tabularx}
\begin{spelleffect}
...
\spelltabular
\spellschool{Evoc (Channeling) [Lawful]} & \spelllists{Divine, Law} \\
\longcol{\spellcmp{Verbal only}} \\
\longcol{\spellarea{40 foot cube-shaped spread centered on you}} \\
\spelldur{Instantaneous/5 rounds}
\spellsr{Yes (Will)}
\end{tabularx}
\begin{spellhealthy}
...
\spelltabular
\spellschool{Conj (Translocation) [Teleportation]} & \spelllists{Arcane, Travel} \\
\spelltgt{You} & \spellrng{\rngext} \\
\end{tabularx}
\begin{spelleffect}
...
\spelltabular
\spellschool{Conj (Translocation) [Teleportation]} & \spelllists{Conj, Travel} \\
\spellarea{\areamed radius limit centered on you} & \spellrng{\rngext} \\
\longcol{\spelltgts{You and up to five other willing creatures in the area}} \\
\end{tabularx}
\begin{spelleffect}
...
\spelltabular
\spellschool{Abjur (Negation)} & \spelllists{Arcane, Divine, Magic} \\
\spelltgt{One creature} & \spellrng{\rngmed} \\
...
\spelltabular
\spellschool{Div (Awareness) [Detection]} & \spelllists{Divine, Law} \\
\longcol{\spellarea{\arealarge cone-shaped mobile emanation from you}} \\
\spelldur{Concentration}
\end{tabularx}
\begin{spelleffect}
...
\spelltabular
\spellschool{Div (Knowledge)} & \spelllists{Arcane} \\
\spelltime{1 swift action}
\spelltgt{One creature} & \spellrng{\rngmed} \\
\end{tabularx}
\begin{spelleffect}
...
\spelltabular
\spellschool{Trans (Alteration)} & \spelllists{Arcane, Destruction} \\
\spelleff{Ray} & \spellrng{\rngclose} \\
\spellsr{Yes (Fortitude)}
...
\spelltabular
\spellschool{Abjur/Conj (Interdiction, Translocation) [Planar]} & \spelllists{Arcane, Divine} \\
\spelltgt{One extraplanar creature} & \spellrng{\rngclose} \\
\spellsr{Yes (Will)}
\end{tabularx}
\spellattack{Magic vs. Will}
\begin{spelleffect}
...
\spelltabular
\spellschool{Abjur (Negation) [Magic]} & \spelllists{Arcane, Divine, Magic, Nature} \\
\spellarea{\areamed radius burst; see text} & \spellrng{\rngmed} \\
\longcol{\spelltgt{One creature or object; or everything in the area}} \\
...
\spelltabular
\spellschool{Necro/Trans (Imbuement, Positive)} & \spelllists{Divine} \\
\spelltgt{One melee weapon} & \spellrng{\rngclose} \\
\spelldur{\durshort}
...
\spelltabular
\spellschool{Trans (Augment)} & \spelllists{Divine, Strength, War} \\
\spelltgt{You} & \spellrng{\rngpers} \\
\spelldur{\durshort}
\end{tabularx}
\begin{spelleffect}
...
\spelltabular
\spellschool{Ench (Compulsion) [Domination, Mind-Affecting]} & \spelllists{Ench} \\
\longcol{\spelltgt{One creature}} \\
\end{tabularx}
\begin{spelleffect}
...
\spelltabular
\spellschool{Evoc (Control) [Earth]} & \spelllists{Earth, Nature} \\
\spelltgt{One Large or smaller creature} & \spellrng{\rngmed} \\
\spelldur{\durshort}
\spellsr{Yes (Will)}
\end{tabularx}
\begin{spelleffect}
...
\spelltabular
\spellschool{Trans (Alteration, Augment) [Earth]} & \spelllists{Earth, Nature} \\
\spelleff{Earthen weapon} & \spellrng{0 ft.} \\
\spelldur{\durlong \dismissable}
\spellsr{Yes (Fortitude)}
\end{tabularx}
\begin{spelleffect}
...
\spelltabular
\spellschool{Trans (Imbuement) [Earth]} & \spelllists{Earth, Nature} \\
...
\spelltabular
\spellschool{Evoc (Control) [Earth]} & \spelllists{Destruction, Divine, Earth, Nature} \\
\spellarea{\arealarge radius spread (S)} & \spellrng{\rngfar} \\
\spelldur{1 round}
\end{tabularx}
\spellattack{Magic vs. Reflex}
\begin{spelleffect}
...
\spelltabular
\spellschool{Trans (Animation) [Earth]} & \spelllists{Earth, Nature} \\
\spelltgt{One creature or object} & \spellrng{\rngmed} \\
\spellsr{Yes (Fort)}
...
\spellschool{Trans (Animation) [Earth]} & \spelllists{Earth, Nature} \\
\spellarea{\areasmall radius limit} & \spellrng{\rngmed} \\
\longcol{\spelltgts{Enemies or objects in the area}} \\
\end{tabularx}
...
\spelltabular
\spellschool{Abjur/Div (Communication, Interdiction)} & \spelllists{Abjur, Law} \\
\longcol{\spellarea{\arealarge radius mobile emanation from you}} \\
\spelldur{\durshort}
\spellsr{Yes (Will)}
...
\spelltabular
\spellschool{Conj (Summoning) [see text]} & \spelllists{Air, Earth, Fire, Nature, Water} \\
\spelleff{Two or more summoned creatures in a \areamed radius} & \spellrng{\rngmed} \\
\spelldur{\durlong \dismissable}
\end{tabularx}
\begin{spelleffect}
...
\spelltabular
\spellschool{Abjur/Evoc (Energy, Shielding) [see text]} & \spelllists{Arcane, Protection} \\
\spelleff{Ray; see text} & \spellrng{Personal and \rngclose; see text} \\
...
\spelltabular
\spellschool{Necro (Vitalism) [Negative]} & \spelllists{Arcane, Death, Divine, Evil} \\
\end{tabularx}
\begin{spelleffect}
...
\spelltabular
\spellschool{Necro (Vitalism) [Negative]} & \spelllists{Arcane, Death} \\
\spelltgt{One creature}  & \spellrng{\rngclose} \\
\spelldur{\durshort}
\spellsr{Yes (Fortitude)}
\end{tabularx}
...
\spelltabular
\spellschool{Necro (Flesh)} & \spelllists{Arcane, Death} \\
\spelltgt{One creature} & \spellrng{\rngmed} \\
\spelldur{\durshort}
\spellsr{Yes (Fortitude)}
\end{tabularx}
...
\spelltabular
\spellschool{Trans (Polymorph) [Size-Affecting]} & \spelllists{Strength, Trans} \\
\spelltime{Full-round action}
\spelltgt{One humanoid creature} & \spellrng{\rngclose} \\
\spelldur{\durshort \dismissable}
\spellsr{Yes (Fortitude)}
\end{tabularx}
\spellattack{Magic vs. Fortitude}
...
\spellschool{Trans (Polymorph) [Size-Affecting]} & \spelllists{Strength, Trans} \\
\spellarea{\areamed radius limit} & \spellrng{\rngmed} \\
\longcol{\spelltgts{Five humanoid creatures in the area}} \\
\end{tabularx}
\begin{spelleffect}
...
\spelltabular
\spellschool{Trans (Animation)} & \spelllists{Nature, Wild} \\
\spellarea{\areasmall radius spread} & \spellrng{\rngmed} \\
\spelldur{\durshort \dismissable}
\end{tabularx}
\spellattack{Magic vs. Reflex}
...
\spelltabular
\spellschool{Abjur (Shielding)} & \spelllists{Chaos, Divine} \\
\spelltgt{One creature} & \spellrng{Touch} \\
\spelldur{\durshort \dismissable}
\end{tabularx}
\begin{spelleffect}
...
\spelltabular
\spellschool{Conj (Translocation) [Planar]} & \spelllists{Arcane, Travel} \\
\spelltgt{You} & \spellrng{\rngpers} \\
\spelldur{\durshort \dismissable}
\end{tabularx}
\begin{spelleffect}
...
\spelltabular
\spellschool{Conj (Translocation) [Planar]} & \spelllists{Arcane, Travel} \\
\spelltgts{You and up to five touched willing creatures} & \spellrng{Touch} \\
\spellsr{Yes (Will)}
\end{tabularx}
\begin{spelleffect}
...
\spelltabular
\spellschool{Trans (Temporal)} & \spelllists{Trans} \\
\spelltgt{One creature} & \spellrng{\rngclose} \\
\spelldur{\durshort \dismissable}
\spellsr{Yes (Will)}
\end{tabularx}
...
\spelltabular
\spellschool{Illus (Figment) [Light, Unreal]} & \spelllists{Nature} \\
\spellarea{\areasmall radius limit} & \spellrng{\rngmed} \\
\longcol{\spelleff{Dim lights in the area}} \\
\spelldur{\durshort \dismissable}
\spellsr{Yes (Will)}
\end{tabularx}
\begin{spelleffect}
...
\spelltabular
\spellschool{Illus (Figment)} & \spelllists{Illus} \\
\longcol{\spellarea{1 mile radius spread limit centered on you; see text}} \\
\spelldur{\durlong \dismissable}
\end{tabularx}
\begin{spelleffect}
...
\spelltabular
\spellschool{Ench (Emotion) [Fear, Mind-Affecting]} & \spelllists{Arcane} \\
\longcol{\spellarea{\areamed cone-shaped burst}} \\
\spelldur{\durshort \dismissable}
\spellsr{Yes (Will)}
\end{tabularx}
...
\spelltabular
\spellschool{Evoc (Control) [Air]} & \spelllists{Air, Evoc, Travel} \\
\longcol{\spellcmp{Verbal only}} \\
\spelltime{1 swift action}
\spellarea{\areamed radius limit} & \spellrng{\rngmed} \\
\longcol{\spelltgts{Five Medium or smaller freefalling object or creatures in the area}} \\
\spelldur{\durshort or until landing}
\spellsr{Yes (Will)}
\end{tabularx}
\spellattack{Magic vs. Will (harmless, object)}
\begin{spelleffect}
...
\spelltabular
\spellschool{Necro (Life) [Death]} & \spelllists{Arcane, Death} \\
\spelltgt{One living creature} & \spellrng{\rngclose} \\
\spellsr{Yes (Fortitude)}
\end{tabularx}
\spellattack{Magic vs. Fortitude}
...
\spelltabular
\spellschool{Evoc/Trans (Energy, Imbuement) [Fire]} & \spelllists{Fire, Nature, Wild} \\
\spellarea{\areasmall or \areamed radius burst from the touched objects; see text} & \spellrng{\rngtouch} \\
\longcol{\spelltgts{Up to four touched acorns or up to eight touched holly berries}} \\
...
\spelltabular
\spellschool{Abjur/Evoc (Energy, Shielding) [Fire or Cold]} & \spelllists{Arcane, Fire} \\
\spelltgt{You} & \spellrng{\rngpers} \\
\spelldur{\durshort \dismissable}
\spellsr{Yes (Fortitude)}
\end{tabularx}
...
\spelltriggertarget{Attacking creature}
\begin{spellsuccess}
...
\spelltabular
\spellschool{Evoc (Energy) [Fire]} & \spelllists{Destruction, Fire, Nature, War} \\
\spellarea{\arealarge spread} & \spellrng{\rngmed} \\
\spellsr{Yes (Reflex)}
...
\spelltabular
\spellschool{Evoc (Energy) [Fire]} & \spelllists{Nature, Fire} \\
\spelleff{Sword-like beam} & \spellrng{0 ft.} \\
\spelldur{\durlong \dismissable}
\spellsr{Yes (Fortitude)}
\end{tabularx}
\begin{spelleffect}
...
\spelltabular
\spellschool{Evoc (Channeling, Energy) [Destructive, Fire]} & \spelllists{Destruction, Divine, Fire, War} \\
\spellarea{\areamed radius cylinder, 40 ft. high} & \spellrng{\rngclose} \\
\spellsr{Yes (Fortitude)}
\end{tabularx}
...
\spellsection{Fly}{4}
\spelltabular
\spellschool{Trans (Imbuement)} & \spelllists{Arcane} \\
\spelltgt{One creature} & \spellrng{\rngtouch} \\
\spelldur{\durshort}
\spellsr{Yes (Fortitude)}
\end{tabularx}
...
\spelltabular
\spellschool{Conj (Creation) [Fog]} & \spelllists{Arcane, Nature, Water} \\
\spellarea{\areamed radius cylinder-shaped spread} & \spellrng{\rngmed} \\
\longcol{\spelleff{Fog in the area}} \\
\spelldur{\durshort}
\end{tabularx}
\begin{spelleffect}
...
\spelltabular
\spellschool{Evoc (Control) [Force]} & \spelllists{Evoc} \\
\spelleff{Barred cage (20 ft. cube) or windowless cell (10 ft. cube)} & \spellrng{\rngmed} \\
\spelldur{\durlong \dismissable}
\end{tabularx}
\spellattack{Magic vs. Reflex}
\begin{spelleffect}
...
\spelltabular
\spellschool{Div (Knowledge)} & \spelllists{Div, Knowledge} \\
\spelltgt{One willing creature} & \spellrng{\rngmed} \\
\spelldur{\durshort}
\spellsr{Yes (Will)}
\end{tabularx}
\begin{spelleffect}
...
\spelltabular
\spellschool{Div (Knowledge)} & \spelllists{Arcane, Knowledge, Protection} \\
\spelltgt{One creature} & \spellrng{Touch} \\
...
\spelltabular
\spellschool{Ench (Complusion)} & \spelllists{Chaos, Ench} \\
\spelltgt{One creature} & \spellrng{\rngmed} \\
\spelldur{\durlong}
\spellsr{Yes (Will)}
\end{tabularx}
...
\spelltabular
\spellschool{Trans (Imbuement)} & \spelllists{Divine, Nature, Travel} \\
\spelltgt{One creature} & \spellrng{\rngtouch} \\
\spelldur{\durshort}
\spellsr{Yes (Will)}
\end{tabularx}
...
\spelltabular
\spellschool{Trans (Polymorph)} & \spelllists{Arcane, Air, Travel} \\
\longcol{\spellcmp{Somatic only}} \\
\spelltgt{One willing corporeal creature} & \spellrng{\rngtouch} \\
\spelldur{\durshort \dismissable}
\end{tabularx}
\begin{spelleffect}
...
\spelltabular
\spellschool{Trans (Imbuement) [Air]} & \spelllists{Air, Nature} \\
\spelltgt{One creature} & \spellrng{\rngmed} \\
\spelldur{\durlong}
\spellsr{Yes (Will)}
\end{tabularx}
...
\spelltabular
\spellschool{Trans (Polymorph)} & \spelllists{Nature, Wild} \\
\spellarea{\areamed radius limit} & \spellrng{\rngclose} \\
\longcol{\spelltgts{Up to three vermin in the area}} \\
\spelldur{\durmed}
\spellsr{Yes (Fortitude)}
\end{tabularx}
\begin{spelleffect}
...
\spelltabular
\spellschool{Conj (Creation)} & \spelllists{Arcane} \\
\spellarea{\areasmall radius spread} & \spellrng{\rngmed} \\
\longcol{\spelleff{Glittering particles in the area}} \\
\spelldur{\durshort}
\end{tabularx}
\begin{spelleffect}
...
\spelltabular
\spellschool{Evoc (Control) [Force]} & \spelllists{Arcane} \\
\end{tabularx}
\spellattack{Special vs. Maneuver defense}
\begin{spelleffect}
...
\spelltabular
\spellschool{Conj (Creation)} & \spelllists{Arcane} \\
\spellarea{\areasmall radius} & \spellrng{\rngclose} \\
\spelldur{\durshort \dismissable}
\end{tabularx}
\spellattack{Magic vs. Reflex}
\begin{spelleffect}
...
\spelltabular
\spellschool{Evoc (Control) [Air]} & \spelllists{Air, Nature} \\
\longcol{\spellarea{\arealarge line-shaped immobile emanation from you}} \\
\longcol{\spelleff{Wind in the area}} \\
\end{tabularx}
\spellattack{Special vs. Maneuver Defense}
\begin{spelleffect}
...
\spelltabular
\spellschool{Necro (Vitalism) [Negative]} & \spelllists{Arcane, Death, Divine, Evil, Vitality} \\
\spelltgt{One creature} & \spellrng{\rngtouch} \\
\spellsr{Yes (Fortitude)}
...
\spelltabular
\spellschool{Trans (Temporal)} & \spelllists{Trans} \\
\spelltgts{One creature} & \spellrng{Touch} \\
\spelldur{\durshort}
\spellsr{Yes (Will)}
\end{tabularx}
\spellattack{Magic vs. Will (harmless)}
...
\spelltabular
\spellschool{Necro (Vitalism) [Positive]} & \spelllists{Divine, Good, Nature, Vitality} \\
\spelltgt{One creature} & \spellrng{\rngtouch} \\
\spellsr{Yes (Fortitude)}
\end{tabularx}
...
\spelltabular
\spellschool{Evoc (Energy) [Fire]} & \spelllists{Nature} \\
\spelltgt{One metal object of up to Medium size} & \spellrng{\rngmed} \\
\spelldur{\durshort \dismissable}
\spellsr{Yes (Fortitude)}
...
\spelltabular
\spellschool{Ench (Inhibition) [Mind-Affecting]} & \spelllists{Arcane, Law} \\
\spelltgt{One living creature} & \spellrng{\rngclose} \\
\end{tabularx}
\begin{spelleffect}
...
\spelltabular
\spellschool{Ench (Inhibition) [Mind-Affecting]} & \spelllists{Arcane, Divine, War} \\
\spelltgt{One humanoid creature} & \spellrng{\rngclose} \\
...
\spelltabular
\spellschool{Ench (Inhibition) [Mind-Affecting]} & \spelllists{Arcane, Divine} \\
\spellarea{\areamed radius limit} & \spellrng{\rngmed} \\
\longcol{\spelltgts{Five creatures in the area}} \\
\end{tabularx}
\begin{spelleffect}
...
\spelltabular
\spellschool{Abjur (Interdiction) [Good]} & \spelllists{Divine, Good} \\
\longcol{\spellcmp{Verbal, Somatic, and Focus}} \\
\longcol{\spellarea{\areamed radius limit centered on you}} \\
\longcol{\spelltgts{Five creatures in the area}} \\
\spelldur{\durshort \dismissable}
...
\spelltabular
\spellschool{Evoc (Channeling) [Good]} & \spelllists{Good} \\
\spelltgt{One creature} & \spellrng{\rngmed} \\
\spelldur{Instantaneous/5 rounds}
\spellsr{Yes (Will)}
\spelldmg{8d6 divine damage \add d6 per two caster levels above 8th}
...
\spelltabular
\spellschool{Evoc (Channeling) [Good]} & \spelllists{Good, Divine} \\
\longcol{\spellcmp{Verbal only}} \\
\longcol{\spellarea{\arealarge radius spread centered on you}} \\
\spellsr{Yes (Will)}
\end{tabularx}
\begin{spellhealthy}
...
\spelltabular
\spellschool{Necro (Flesh)} & \spelllists{Necro, Water} \\
\spellarea{\arealarge radius limit} & \spellrng{\rngfar} \\
\longcol{\spelltgts{Ten living creatures in the area}} \\
\spellsr{Yes (Fortitude)}
...
\spelltabular
\spellschool{Ench/Illus (Compulsion, Figment) [Light, Mind-Affecting]} & \spelllists{Arcane} \\
\spellarea{\areasmall radius spread} & \spellrng{\rngmed} \\
\longcol{\spelleff{Colorful lights in the area}} \\
\spelldur{\durshort}
\spellsr{Yes (Will)}
\end{tabularx}
\spellattack{Magic vs. Will}
...
\spelltabular
\spellschool{Conj/Evoc (Creation, Energy) [Cold]} & \spelllists{Arcane, Destruction, Nature, Water} \\
\spellarea{\areasmall radius cylinder, 20 ft. high} & \spellrng{\rngmed} \\
...
\spelltabular
\spellschool{Evoc (Control)} & \spelllists{Destruction, Divine} \\
\spelltgts{One corporeal creature/round} & \spellrng{\rngclose} \\
...
\spelltabular
\spellschool{Conj/Trans (Time, Translocation) [Teleportation]} & \spelllists{Arcane, Earth, Law} \\
\spelltgt{One creature} & \spellrng{\rngclose} \\
\spelldur{See text}
\spellsr{Yes (Will)}
...
\spelltabular
\spellschool{Abjur (Shielding)} & \spelllists{Arcane} \\
\spelltgt{One creature} & \spellrng{\rngclose} \\
\spelldur{\durshort}
\spellsr{Yes (Will)}
\end{tabularx}
...
\spelltabular
\spellschool{Necro (Vitalism) [Negative]} & \spelllists{Arcane, Divine} \\
...
\spelltabular
\spellschool{Ench (Compulsion) [Mind-Affecting]} & \spelllists{Chaos, Ench} \\
\spelltgt{One living creature} & \spellrng{Touch} \\
\spelldur{Permanent}
\spellsr{Yes (Will)}
\end{tabularx}
...
\spelltabular
\spellschool{Evoc (Control) [Force]} & \spelllists{Arcane} \\
\spelleff{Large hand made of force} & \spellrng{\rngmed} \\
\spelldur{\durshort \dismissable}
\spellsr{Yes (Fortitude)}
\end{tabularx}
\begin{spelleffect}
...
\spelltabular
\spellschool{Trans (Augment)} & \spelllists{Arcane, Divine, War} \\
\spelltgt{One creature} & \spellrng{\rngclose} \\
\spelldur{\durshort}
\spellsr{Yes (Will)}
\end{tabularx}
...
\spelltabular
\spellschool{Illus (Glamer)} & \spelllists{Arcane, Trickery} \\
\spelltgt{A creature or object weighing no more than 100 lb./caster level} & \spellrng{\rngclose} \\
\spelldur{\durshort \dismissable}
\spellsr{Yes (Will)}
\end{tabularx}
\spellattack{Magic vs. Will (harmless) or Magic vs. Will (harmless, object)}
\begin{spelleffect}
...
\spelltabular
\spellschool{Illus (Glamer)} & \spelllists{Illus} \\
\end{tabularx}
\begin{spelleffect}
...
\spellschool{Illus (Glamer)} & \spelllists{Arcane, Trickery} \\
\spellarea{\areamed radius limit} & \spellrng{\rngmed} \\
\longcol{\spelltgts{Five creatures or objects weighing no more than 100 lb./caster level in the area}} \\
\end{tabularx}
\begin{spelleffect}
...
\spelltabular
\spellschool{Trans (Polymorph)} & \spelllists{Arcane, Earth, Strength} \\
\spelltgt{You} & \spellrng{\rngpers} \\
\spelldur{\durshort \dismissable}
\end{tabularx}
\begin{spelleffect}
...
\spelltabular
\spellschool{Ench (Compulsion) [Mind-Affecting]} & \spelllists{Arcane, Chaos} \\
\spelltgt{One creature} & \spellrng{\rngclose} \\
\spelldur{1d4 rounds}
\spellsr{Yes (Will)}
\end{tabularx}
...
\spelltabular
\spellschool{Evoc (Control)} & \spelllists{Evoc} \\
\spelltgt{One Medium or smaller object} & \spellrng{\rngclose} \\
\spelldur{Instantaneous; see text}
\end{tabularx}
\begin{spelleffect}
...
\spelltabular
\spellschool{Evoc (Control)} & \spelllists{Arcane} \\
\spelltgt{You or one willing creature or one object (total weight up to 100 lb./caster level)} & \spellrng{\rngclose} \\
\spelldur{\durshort \dismissable}
\spellsr{Yes (Will)}
\end{tabularx}
\begin{spelleffect}
...
\spelltabular
\spellschool{Evoc/Necro (Control, Life) [Force]} & \spelllists{Arcane} \\
\spellrng{\rngmed}
...
\spelltabular
\spellschool{Evoc (Energy) [Destructive, Electricity]} & \spelllists{Arcane, Destruction, Nature} \\
\longcol{\spellarea{\arealarge line, 10 ft. wide}} \\
\spellsr{Yes (Reflex)}
\end{tabularx}
...
\spelltabular
\spellschool{Necro (Life)} & \spelllists{Necro} \\
\longcol{\spellarea{\areamed radius limit centered on you}} \\
\longcol{\spelltgts{Any two living creatures in the area}} \\
\spelldur{\durshort}
\spellsr{Yes (Will)}
\end{tabularx}
\spellattack{Magic vs. Will}
...
\spelltabular
\spellschool{Necro (Life)} & \spelllists{Arcane} \\
\longcol{\spelltgts{Five living creatures in the area}} \\
\end{tabularx}
\begin{spelleffect}
...
\spelltabular
\spellschool{Abjur/Evoc (Control, Shielding)} & \spelllists{Arcane} \\
\spelltgts{One willing creature and one creature} & \spellrng{\rngclose} \\
...
\spelltabular
\spellschool{Div (Awareness) [Detection]} & \spelllists{Arcane, Knowledge} \\
\longcol{\spellrng{\rngext}} \\
\spelldur{\durlong \dismissable}
\end{tabularx}
\begin{spelleffect}
...
\spelltabular
\spellschool{Div (Awareness) [Detection]} & \spelllists{Arcane, Divine} \\
\longcol{\spellrng{\rngmed}} \\
\spelldur{\durmed \dismissable}
\end{tabularx}
\begin{spelleffect}
...
\spelltabular
\spellschool{Div (Awareness) [Detection]} & \spelllists{Arcane, Divine, Knowledge} \\
\longcol{\spellrng{\rngext}} \\
\end{tabularx}
\begin{spelleffect}
...
\spelltabular
\spellschool{Trans (Augment)} & \spelllists{Nature, Travel} \\
\spelltgt{You} & \spellrng{\rngpers} \\
\spelldur{\durlong \dismissable}
\end{tabularx}
\begin{spelleffect}
...
\spelltabular
\spellschool{Abjur (Shielding) [Force]} & \spelllists{Arcane} \\
\spelltgt{One creature} & \spellrng{\rngclose} \\
\spelldur{\durshort or \durlong; see text \dismissable}
\spellsr{Yes (Will)}
\end{tabularx}
...
\spelltabular
\spellschool{Evoc (Control)} & \spelllists{Arcane} \\
\spelltgt{One nonmagical, unattended object weighing up to 5 lb.} & \spellrng{\rngclose} \\
\spelldur{\durshort}
\end{tabularx}
\begin{spelleffect}
...
\spelltabular
\spellschool{Abjur (Negation) [Magic]} & \spelllists{Arcane, Magic} \\
\spelltgtorarea{One magic item or \areamed radius burst} & \spellrng{\rngmed} \\
\end{tabularx}
\spellattack{Magic vs. Will (object)}
\begin{spelleffect}
...
\spelltabular
\spellschool{Abjur (Interdiction) [Barrier, Good]} & \spelllists{Arcane, Chaos, Divine, Evil, Good, Law} \\
\spellarea{\areasmall mobile emanation from touched creature} & \spellrng{Touch} \\
\spelldur{\durshort \dismissable}
\spellsr{Yes (Will)}
\end{tabularx}
\spellattack{Magic vs. Will (harmless)}
...
\spelltabular
\spellschool{Trans (Augment)} & \spelllists{Nature} \\
\spelltgt{One creature} & \spellrng{\rngclose} \\
\spelldur{\durshort}
\spellsr{Yes (Will)}
\end{tabularx}
...
\spellschool{Evoc (Control) [Force]} & \spelllists{Arcane} \\
\spellarea{\areamed radius limit} & \spellrng{\rngclose} \\
\longcol{\spelltgts{Creatures in the area}} \\
\spellsr{Yes (Fortitude)}
...
\spelltabular
\spellschool{Trans (Augment)} & \spelllists{Arcane, Divine} \\
\spelltgt{One suit of armor or shield} & \spellrng{\rngclose} \\
\spelldur{\durmed}
\spellsr{Yes (Will)}
\end{tabularx}
\spellattack{Magic vs. Will (harmless, object)}
...
\spelltabular
\spellschool{Trans (Augment)} & \spelllists{Arcane, Divine} \\
\spelltgt{One weapon or fifty projectiles (all of which must be in contact with each other at the time of casting)} & \spellrng{\rngclose} \\
\spelldur{\durshort}
\spellsr{Yes (Will)}
\end{tabularx}
\spellattack{Magic vs. Will (harmless, object)}
...
\spellsection{Maze}{8}
\spelltabular
\spellschool{Conj (Translocation) [Planar]} & \spelllists{Conj, Trickery} \\
\spelltgt{One creature} & \spellrng{\rngclose} \\
\spelldur{Instantaneous; see text}
\spellsr{Yes (Will)}
\end{tabularx}
...
\spelltabular
\spellschool{Trans (Polymorph) [Earth]} & \spelllists{Earth, Nature} \\
\spelltgt{You} & \spellrng{Personal} \\
\spelldur{\durlong}
\end{tabularx}
\begin{spelleffect}
...
\spelltabular
\spellschool{Div (Communication)} & \spelllists{Arcane} \\
\longcol{\spellcmp{Somatic only}} \\
\spellarea{\areamed radius limit} & \spellrng{\rngmed} \\
\longcol{\spelltgts{Five creatures in the area}} \\
\spelldur{\durlong}
...
\spelltabular
\spellschool{Evoc (Energy) [Fire]} & \spelllists{Destruction, Evoc, Fire} \\
\spellarea{A \arealarge radius cylinder, 100 ft. high} & \spellrng{\rngfar} \\
\spellsr{Yes (Reflex)}
...
\spelltabular
\spellschool{Conj/Ench (Creation, Inhibition) [Fog, Mind-Affecting]} & \spelllists{Arcane, Trickery} \\
\spellarea{\areamed radius cylinder-shaped spread} & \spellrng{\rngclose} \\
...
\spelltabular
\spellschool{Evoc (Channeling)} & \spelllists{Divine} \\
\spelltgteffarea{See text} & \spellrng{See text} \\
\spelldur{See text}
...
\spelltabular
\spellschool{Illus (Figment)} & \spelllists{Arcane} \\
\spelltgt{You} & \spellrng{Personal; see text} \\
\spelldur{\durshort \dismissable}
\end{tabularx}
\begin{spelleffect}
...
\spelltabular
\spellschool{Illus (Figment, Glamer) [Unreal]} & \spelllists{Arcane, Trickery} \\
\spelltgt{You} & \spellrng{Personal/\rngmed} \\
\longcol{\spelleff{One illusory double}} \\
\spelldur{\durshort \dismissable; see text}
\end{tabularx}
...
\spelltabular
\spellschool{Evoc (Control) [Force]} & \spelllists{Arcane} \\
\longcol{\spellarea{\arealarge radius limit centered on you}} \\
\longcol{\spelltgts{Any number of creatures in the area}} \\
\spellsr{Yes (Fortitude)}
...
\spelltabular
\spellschool{Div (Knowledge)} & \spelllists{Arcane, Div, Knowledge} \\
\end{tabularx}
\begin{spelleffect}
...
\spelltabular
\spellschool{Div (Knowledge)} & \spelllists{Div} \\
\end{tabularx}
\begin{spelleffect}
...
\spelltabular
\spellschool{Conj (Creation) [Fog]} & \spelllists{Arcane, Divine, Nature, Water} \\
...
\spelltabular
\spellschool{Evoc (Channeling) [Lawful]} & \spelllists{Law} \\
\spelltgt{One creature} & \spellrng{\rngmed} \\
\spelldur{Instantaneous/5 rounds}
\spellsr{Yes (Will)}
\spelldmg{8d6 divine damage \add d6 per two caster levels above 8th}
...
\spelltabular
\spellschool{Illus (Figment)} & \spelllists{Illus} \\
\longcol{\spellarea{\arealarge radius limit}} \\
\spelldur{\durmed \dismissable}
\end{tabularx}
\begin{spelleffect}
...
\spelltabular
\spellschool{Ench/Illus (Emotion, Phantasm) [Death, Fear, Mind-Affecting, Unreal]} & \spelllists{Arcane, Trickery} \\
\spelltgt{One creature} & \spellrng{\rngmed} \\
\spellsr{Yes (Will)}
\end{tabularx}
...
\spelltabular
\spellschool{Illus (Phantasm) [Unreal]} & \spelllists{Arcane, Trickery} \\
\spelltgt{One creature} & \spellrng{\rngclose} \\
\spelldur{\durmed}
\spellsr{Yes (Will)}
\end{tabularx}
...
\spelltabular
\spellschool{Illus (Phantasm) [Unreal]} & \spelllists{Arcane} \\
\spelltgt{One creature} & \spellrng{\rngmed} \\
\spelldur{\durshort}
\spellsr{Yes (Will)}
\end{tabularx}
...
\spelltabular
\spellschool{Necro (Flesh) [Poison]} & \spelllists{Death, Divine, Nature} \\
\spelltgt{One living creature} & \spellrng{Touch} \\
\spelldur{Instantaneous; see text}
\spellsr{Yes (Fortitude)}
\end{tabularx}
...
\spelltabular
\spellschool{Evoc (Energy) [Cold]} & \spelllists{Arcane, Water} \\
\spelleff{Ray} & \spellrng{\rngclose} \\
\spelldur{Instantaneous/5 rounds}
\spellsr{Yes (Fortitude)}
...
\spelltabular
\spellschool{Div (Knowledge)} & \spelllists{Arcane, Div} \\
\spelltgt{You} & \spellrng{Personal} \\
\spelldur{\durshort \dismissable}
\end{tabularx}
\begin{spelleffect}
...
\spelltabular
\spellschool{Evoc (Control, Energy) [Light]} & \spelllists{Arcane} \\
...
\spelltabular
\spellschool{Evoc (Control, Energy) [Light]} & \spelllists{Arcane, Chaos} \\
\longcol{\spellarea{\arealarge cone-shaped burst}} \\
\spellsr{Yes (varies)}
\end{tabularx}
\spellattack{See text}
\begin{spelleffect}
...
\spelltabular
\spellschool{Evoc (Control, Energy) [Light]} & \spelllists{Arcane, Chaos} \\
\spelleff{Wall up to 50 ft. wide, 30 ft. high} & \spellrng{\rngclose} \\
\spelldur{\durshort \dismissable}
\spellsr{See text}
\end{tabularx}
\spellattack{See text}
...
\spelltabular
\spellschool{Abjur (Interdiction)} & \spelllists{Abjur, Law} \\
\longcol{\spellarea{100 foot radius mobile emanation centered on you}} \\
\spelldur{\durshort}
\spellsr{Yes (Will)}
...
\spelltabular
\spellschool{Illus (Shadow)} & \spelllists{Arcane} \\
\spelleff{One shadow duplicate} & \spellrng{\rngmed} \\
\spelldur{\durshort \dismissable}
\end{tabularx}
\spellattack{Magic check vs. Perception and Will (if interacted with)}
\begin{spelleffect}
...
\spelltabular
\spellschool{Abjur (Shielding)} & \spelllists{Arcane, Divine, Nature, Protection} \\
\spelltgt{One creature} & \spellrng{Touch} \\
\spelldur{\durlong or until discharged}
\spellsr{Yes (Fortitude)}
\end{tabularx}
...
\spelltabular
\spellschool{Abjur (Interdiction) [Good]} & \spelllists{Arcane, Chaos, Divine, Evil, Good, Law} \\
\spelltgt{One creature} & \spellrng{\rngclose} \\
\spelldur{\durshort \dismissable}
\end{tabularx}
\spellattack{Magic vs. Will (harmless)}
...
\spelltabular
\spellschool{Div (Awareness) [Mind-Affecting]} & \spelllists{Arcane, Knowledge} \\
\spelltgt{One creature} & \spellrng{\rngmed} \\
\spelldur{Concentration}
\spellsr{Yes (Will)}
\end{tabularx}
...
\spelltabular
\spellschool{Div (Awareness) [Mind-Affecting]} & \spelllists{Arcane, Knowledge} \\
\longcol{\spellarea{\areamed radius limit}} \\
\longcol{\spelltgt{Five creatures in the area}} \\
\end{tabularx}
\begin{spelleffect}
...
\spelltabular
\spellschool{Trans (Polymorph) [Size-Affecting]} & \spelllists{Trans} \\
\spelltime{Full-round action}
\spelltgt{One humanoid creature} & \spellrng{\rngclose} \\
\spelldur{\durshort \dismissable}
\spellsr{Yes (Fortitude)}
...
\spelltabular
\spellschool{Abjur (Shielding) [Barrier]} & \spelllists{Arcane, Protection, Travel} \\
\longcol{\spellarea{Up to a \arealarge radius mobile emanation centered on you}} \\
\spelldur{\durshort \dismissable}
\spellsr{Yes (Will)}
\end{tabularx}
\spellattack{Magic vs. Will}
...
\spelltabular
\spellschool{Evoc (Control) [Force]} & \spelllists{Evoc} \\
\spelleff{5 ft. radius sphere, centered around creatures or objects} & \spellrng{\rngmed} \\
\spelldur{\durshort \dismissable}
\spellsr{Yes (Reflex)}
\end{tabularx}
...
\spelltabular
\spellschool{Abjur (Shielding)} & \spelllists{Arcane, Divine, Nature} \\
\end{tabularx}
\begin{spelleffect}
...
\spelltabular
\spellschool{Abjur/Illus (Figment, Shielding)} & \spelllists{Arcane} \\
\spelltgt{One creature; see text} & \spellrng{\rngclose; see text} \\
\spelldur{\durshort or until discharged/5 rounds}
\spellsr{Yes (Will)}
\end{tabularx}
\spellattack{Magic vs. Will (harmless), Magic vs. Fortitude}
\begin{spelleffect}
...
\spelltabular
\spellschool{Abjur/Necro (Life, Shielding)} & \spelllists{Arcane} \\
\spelltgt{One creature} & \spellrng{\rngclose/\rngmed} \\
\spelldur{\durshort}
\spellsr{Yes (Will)}
\end{tabularx}
\spellattack{Magic vs. Will (harmless)}
...
\spelltabular
\spellschool{Conj (Translocation) [Teleportation]} & \spelllists{Conj} \\
\spelltgt{One willing creture} & \spellrng{\rngmed} \\
\spellsr{Yes (Will)}
\end{tabularx}
\begin{spelleffect}
...
\spelltabular
\spellschool{Conj (Translocation) [Teleportation]} & \spelllists{Conj} \\
\spelltgt{One object you can hold or carry in one hand, weighing up to 10 lb./caster level} & \spellrng{\rngclose} \\
\spellsr{Yes (Will)}
\end{tabularx}
...
\spelltabular
\spellschool{Div (Awareness, Knowledge)} & \spelllists{Arcane, Div, Knowledge} \\
\spelltgt{One creature} & \spellrng{\rngmed} \\
\spelldur{\durshort}
\spellsr{Yes (Will)}
\end{tabularx}
...
\spelltabular
\spellschool{Trans} & \spelllists{Air, Arcane, Trickery} \\
\spellarea{Up to five 10 ft. cubes (S)} & \spellrng{\rngclose} \\
...
\spelltabular
\spellschool{Necro (Life, Soul)} & \spelllists{Divine} \\
\longcol{\spellcmp{Verbal, Somatic, and Material}} \\
\spelltgt{One dead creature} & \spellrng{Touch} \\
\end{tabularx}
\begin{spelleffect}
...
\spelltabular
\spellschool{Trans (Augment, Polymorph) [Size-Affecting]} & \spelllists{Divine, Good, Strength} \\
\spelltgt{You} & \spellrng{Personal} \\
\end{tabularx}
\begin{spelleffect}
...
\spelltabular
\spellschool{Abjur/Ench (Compulsion, Shielding) [Mind-Affecting]} & \spelllists{Arcane, Divine, Protection} \\
\spelltgt{One creature} & \spellrng{Touch} \\
\spelldur{\durshort}
\spellsr{Yes (Will)}
\end{tabularx}
\spellattack{Magic vs. Will (harmless) and Magic vs. Will; see text}
\begin{spelleffect}
...
\spelltabular
\spellschool{Ench/Illus (Compulsion, Figment) [Light, Mind-Affecting, Sight-Dependent]} & \spelllists{Arcane} \\
\longcol{\spellarea{\arealarge radius spread centered on you}} \\
\longcol{\spelleff{Colorful lights in the area}} \\
\spelldur{\durshort}
\spellsr{Yes (Will)}
...
\spelltabular
\spellschool{Evoc (Energy) [Fire]} & \spelllists{Arcane, Fire} \\
\spelleff{One or more rays} & \spellrng{\rngclose} \\
\spellsr{Yes (Reflex)}
...
\spelltabular
\spellschool{Conj (Creation)} & \spelllists{Arcane, Nature} \\
\longcol{\spellarea{200 ft. radius spread centered on you, 50 ft. high}} \\
\longcol{\spelleff{Fog in the area}} \\
\end{tabularx}
\begin{spelleffect}
...
\spelltabular
\spellschool{Evoc (Channeling) [Light]} & \spelllists{Divine} \\
\spelleff{Ray} & \spellrng{\rngclose} \\
...
\spelltabular
\spellschool{Div (Revelation)} & \spelllists{Arcane} \\
\spelltgt{One creature} & \spellrng{Touch} \\
\spelldur{\durlong \dismissable}
\end{tabularx}
\begin{spelleffect}
...
\spelltabular
\spellschool{Illus (Glamer) [Unreal]} & \spelllists{Arcane, Trickery} \\
\spellarea{\areamed radius limit} & \spellrng{\rngclose} \\
\longcol{\spelltgts{One creature per caster level in the area}} \\
\spelldur{\durlong \dismissable}
\spellsr{Yes}
\end{tabularx}
\spellattack{Magic vs. Will (harmless)}
...
\spelltabular
\spellschool{Illus/Trans (Polymorph, Shadow)} & \spelllists{Arcane} \\
\spelltgt{You} & \spellrng{Personal} \\
\spelldur{\durmed \dismissable}
\end{tabularx}
\begin{spelleffect}
...
\spelltabular
\spellschool{Illus (Shadow)} & \spelllists{Illus} \\
\spelleff{See text} & \spellrng{See text} \\
\spelldur{See text}
...
\spelltabular
\spellschool{Conj/Illus (Shadow, Translocation) [Planar, Unreal]} & \spelllists{Illus} \\
\spelltgt{You} & \spellrng{Personal/\rngfar; see text} \\
\longcol{\spelleff{One shadow duplicate}} \\
\spelldur{\durmed}
\end{tabularx}
...
\spelltabular
\spellschool{Abjur/Illus (Glamer, Shadow, Shielding) [Planar]} & \spelllists{Arcane} \\
\spelltgt{One creature} & \spellrng{\rngclose} \\
\spelldur{\durshort}
\spellsr{Yes (Will)}
\end{tabularx}
...
\spelltabular
\spellschool{Abjur/Necro (Life, Shielding)} & \spelllists{Arcane, Divine, Protection} \\
\spelltgts{You and one willing creature} & \spellrng{\rngmed} \\
\spelldur{\durlong \dismissable}
\spellsr{Yes (Will)}
\end{tabularx}
\begin{spelleffect}
...
\spelltabular
\spellschool{Abjur/Necro (Life, Shielding)} & \spelllists{Arcane, Divine} \\
\longcol{\spelltgts{You and one other creature}} \\
\end{tabularx}
\spellattack{Magic vs. Will}
\begin{spelleffect}
...
\spelltabular
\spellschool{Abjur (Shielding)} & \spelllists{Divine, Protection} \\
\end{tabularx}
\begin{spelleffect}
...
\spelltabular
\spellschool{Abjur (Shielding) [Lawful]} & \spelllists{Divine, Law} \\
\longcol{\spellcmp{Verbal, Somatic, and Focus}} \\
\longcol{\spellarea{\areamed radius limit centered on you}} \\
\longcol{\spelltgts{Five creatures in the area}} \\
\spelldur{\durshort \dismissable}
...
\spelltabular
\spellschool{Trans} & \spelllists{Nature} \\
\spelltgt{One touched nonmagical oak club or quarterstaff} & \spellrng{Touch} \\
\spelldur{\durshort}
\spellsr{Yes (Will)}
\end{tabularx}
\spellattack{Magic vs. Will (object)}
...
\spelltabular
\spellschool{Evoc (Energy) [Electricity]} & \spelllists{Arcane, Destruction} \\
...
\spelltabular
\spellschool{Evoc (Energy) [Sonic]} & \spelllists{Arcane, Destruction, Strength} \\
\longcol{\spellcmp{Verbal only}} \\
\longcol{\spellarea{\areamed cone-shaped burst}} \\
\spellsr{Yes (Fortitude)}
\end{tabularx}
...
\spelltabular
\spellschool{Trans (Alteration)} & \spelllists{Trans} \\
\spelltgt{One Small (or larger) nonmagical object; see text} & \spellrng{Touch} \\
...
\spelltabular
\spellschool{Illus (Glamer)} & \spelllists{Divine, Trickery} \\
\spelltgt{One creature or object} & \spellrng{\rngmed} \\
\spelldur{\durshort \dismissable}
\spellsr{Yes (Will)}
\end{tabularx}
...
\spellschool{Illus (Figment) [Unreal]} & \spelllists{Illus} \\
\spellarea{\areamed radius limit} & \spellrng{\rngmed} \\
\longcol{\spelleff{Visual figment in the area}} \\
\spelldur{\durshort}
\end{tabularx}
\spellattack{Magic check vs. Perception and Will (if interacted with)}
\begin{spelleffect}
...
\spelltabular
\spellschool{Evoc (Energy) [Electricity]} & \spelllists{Air, Arcane, Destruction, Nature} \\
\spellarea{\arealarge vertical line of lightning, 5 ft. wide, and \areamed radius limit} & \spellrng{\rngext} \\
\spellsr{Yes (Reflex)}
...
\spelltabular
\spellschool{Necro (Life) [Death]} & \spelllists{Death, Divine} \\
\spelltgt{One living creature} & \spellrng{Touch} \\
\spellsr{Yes (Fortitude)}
\end{tabularx}
\spellattack{Magic vs. Fortitude}
...
\spelltabular
\spellschool{Ench (Compulsion) [Mind-Affecting, Sleep]} & \spelllists{Arcane} \\
...
\spelltabular
\spellschool{Ench (Compulsion) [Mind-Affecting, Sleep]} & \spelllists{Arcane} \\
\longcol{\spelltgts{Five creatures within a \areamed radius limit}} \\
\end{tabularx}
\begin{spelleffect}
...
\spelltabular
\spellschool{Trans (Temporal)} & \spelllists{Arcane} \\
\spelltgt{One creature} & \spellrng{\rngmed} \\
\spelldur{\durshort}
\spellsr{Yes (Will)}
\end{tabularx}
...
\spelltabular
\spellschool{Conj (Creation)} & \spelllists{Arcane, Druid, Water} \\
\spelldur{\durmed}
\end{tabularx}
\begin{spelleffect}
...
\spelltabular
\spellschool{Ench (Compulsion) [Auditory, Mind-Affecting]} & \spelllists{Arcane} \\
\longcol{\spellarea{\areamed radius spread centered on you}} \\
\spelldur{\durshort}
\spellsr{Yes (Will)}
\end{tabularx}
\spellattack{Magic vs. Will}
...
\spelltabular
\spellschool{Necro (Soul)} & \spelllists{Necro} \\
\spelltgt{One living creature} & \spellrng{\rngfar} \\
\spellsr{Yes (Will)}
\end{tabularx}
...
\spelltabular
\spellschool{Evoc (Energy) [Sonic]} & \spelllists{Arcane} \\
\spellarea{\areasmall radius spread} & \spellrng{\rngclose} \\
\spellsr{Yes (Fortitude)}
...
\spelltabular
\spellschool{Abjur (Shielding) [Magic]} & \spelllists{Abjur, Magic, Protection} \\
\spelltgt{One creature} & \spellrng{\rngclose} \\
\spelldur{\durshort}
\spellsr{Yes (Will)}
\end{tabularx}
...
\spelltabular
\spellschool{Abjur (Negation) [Magic]} & \spelllists{Abjur} \\
\end{tabularx}
\begin{spelleffect}
...
\spelltabular
\spellschool{Abjur (Shielding) [Magic]} & \spelllists{Arcane, Magic, Protection} \\
\spelltgt{You} & \spellrng{Personal} \\
...
\spelltabular
\spellschool{Trans (Imbuement)} & \spelllists{Arcane, Nature, Travel} \\
\spelltgt{One creature} & \spellrng{Touch} \\
\spelldur{\durmed}
\spellsr{Yes (Fortitude)}
\end{tabularx}
...
\spelltabular
\spellschool{Trans (Alteration)} & \spelllists{Nature} \\
\spellarea{\areasmall radius} & \spellrng{\rngmed} \\
\spelldur{\durshort \dismissable}
\spellsr{Yes (Reflex)}
\end{tabularx}
...
\spelltabular
\spellschool{Evoc (Energy) [Force]} & \spelllists{Divine, War} \\
\spelleff{Magic weapon of force} & \spellrng{\rngmed} \\
\spelldur{\durshort \dismissable}
\spellsr{Yes (Will)}
\end{tabularx}
\begin{spelleffect}
...
\spelltabular
\spellschool{Conj (Summoning)} & \spelllists{Nature, Wild} \\
\longcol{\spelltime{Full-round action}} \\
\spellarea{\arealarge radius limit} & \spellrng{\rngfar} \\
\longcol{\spelleff{Nine or more Large summoned creatures in the area}} \\
\spelldur{\durshort \dismissable}
...
\spelltabular
\spellschool{Trans (Alteration) [Earth]} & \spelllists{Arcane, Earth, Nature, Protection} \\
\spelltgt{One creature} & \spellrng{Touch} \\
\spelldur{\durshort}
\spellsr{Yes (Fortitude)}
\end{tabularx}
...
\spelltabular
\spellschool{Conj/Evoc (Energy, Control, Creation)} & \spelllists{Air, Divine, Nature, War, Water} \\
\spelltime{Full-round action}
\spellarea{360 ft. radius cylinder, 200 ft. high} & \spellrng{\rngfar} \\
\longcol{\spelleff{Supernatural weather in the area}} \\
...
\spelltabular
\spellschool{Abjur/Evoc (Control, Shielding)} & \spelllists{Air, Nature} \\
\spelltgt{You} & \spellrng{Personal} \\
\spelldur{\durshort \dismissable}
...
\spelltabular
\spellschool{Ench (Compulsion) [Language-Dependent, Mind-Affecting, Sound-Dependent]} & \spelllists{Ench} \\
\longcol{\spellcmp{V, M}} \\
\spelltgt{One living creature} & \spellrng{\rngclose} \\
...
\spelltabular
\spellschool{Conj (Summoning) [see text]} & \spelllists{Arcane, Divine} \\
\spelltime{Full-round action}
\spelleff{One summoned creature} & \spellrng{\rngclose} \\
\spelldur{\durshort \dismissable}
\end{tabularx}
\begin{spelleffect}
...
\spelltabular
\spellschool{Conj (Summoning)} & \spelllists{Arcane, Divine} \\
\spellarea{\areamed radius limit} & \spellrng{\rngclose} \\
\longcol{\spelleff{One or more summoned creatures in the area}} \\
\end{tabularx}
\begin{spelleffect}
...
\spelltabular
\spellschool{Conj (Summoning)} & \spelllists{Arcane, Chaos, Divine, Evil, Good, Law} \\
\spellarea{\areamed radius limit} & \spellrng{\rngclose} \\
\longcol{\spelleff{One or more summoned creatures in the area}} \\
\end{tabularx}
\begin{spelleffect}
...
\spelltabular
\spellschool{Conj (Summoning)} & \spelllists{Air, Arcane, Divine, Earth, Fire, Water} \\
\spellarea{\areamed radius limit} & \spellrng{\rngclose} \\
\longcol{\spelleff{One or more summoned creatures in the area}} \\
\end{tabularx}
\begin{spelleffect}
...
\spellschool{Conj (Summoning)} & \spelllists{Nature} \\
\spellarea{\areamed radius limit} & \spellrng{\rngclose} \\
\spelleff{One or more summoned creatures in the area} & \\
\end{tabularx}
\begin{spelleffect}
...
\spelltabular
\spellschool{Conj (Summoning) [see text]} & \spelllists{Nature, Wild} \\
\spellarea{\areamed radius limit} & \spellrng{\rngclose} \\
\longcol{\spelleff{One or more summoned creatures in the area}} \\
\end{tabularx}
\begin{spelleffect}
...
\spelltabular
\spellschool{Conj (Summoning) [see text]} & \spelllists{Nature} \\
\spellarea{\areamed radius limit} & \spellrng{\rngclose} \\
\longcol{\spelleff{One or more summoned creatures in the area}} \\
\end{tabularx}
\begin{spelleffect}
...
\spelltabular
\spellschool{Evoc (Control) [Light]} & \spelllists{Nature} \\
\longcol{\spellarea{\arealarge line}} \\
\spelldur{Instantaneous/5 rounds}
\spellsr{Yes (Reflex)}
...
\spelltabular
\spellschool{Evoc (Control) [Light]} & \spelllists{Nature} \\
\spellarea{\areamed radius burst} & \spellrng{\rngmed} \\
...
\spelltabular
\spellschool{Evoc (Control)} & \spelllists{Evoc} \\
\spelltgtortgts{See text} & \spellrng{\rngmed} \\
...
\spelltabular
\spellschool{Evoc (Control)} & \spelllists{Evoc} \\
\spelltgt{One object or creature at a time} & \spellrng{\rngmed} \\
...
\spelltabular
\spellschool{Evoc (Control)} & \spelllists{Evoc} \\
\spelltgtortgts{Five objects or creatures in a \areamed radius \add one per four caster levels above 8th} & \spellrng{\rngmed} \\
\spellsr{Yes (Will)}
\end{tabularx}
\spellattack{Magic vs. Will (object); see text}
\begin{spelleffect}
...
\spelltabular
\spellschool{Trans (Augment)} & \spelllists{Arcane, Divine, Nature} \\
\spelltgt{One creature} & \spellrng{\rngtouch} \\
\spelldur{\durshort}
\spellsr{Yes (Will)}
\end{tabularx}
...
\spelltabular
\spellschool{Trans (Augment)} & \spelllists{Arcane, Divine, Nature, Strength} \\
\spelltgt{One creature} & \spellrng{\rngtouch} \\
\spelldur{\durshort}
\spellsr{Yes (Fortitude)}
\end{tabularx}
...
\spelltabular
\spellschool{Ench (Inhibition) [Mind-Affecting]} & \spelllists{Arcane} \\
\spelltgt{One creature} & \spellrng{One} \\
\spelldur{\durshort}
\spellsr{Yes (Will)}
\end{tabularx}
\spellattack{Will half}
...
\spelltabular
\spellschool{Trans (Alteration, Polymorph)} & \spelllists{Arcane} \\
\spelltgt{One creature, or one nonmagical object of up to 1000 cu. ft.} & \spellrng{\rngmed} \\
\spelldur{See text}
\spellsr{Yes (Fortitude)}
\end{tabularx}
...
\spelltabular
\spellschool{Trans (Polymorph)} & \spelllists{Arcane, Earth} \\
\spelltgt{One creature or a cylinder of stone from 1 ft. to 3 ft. in diameter and up to 10 ft. long} & \spellrng{\rngmed} \\
...
\spelltabular
\spellschool{Trans (Polymorph)} & \spelllists{Nature} \\
\spelltgt{You} & \spellrng{Personal} \\
...
\spelltabular
\spellschool{Trans (Imbuement)} & \spelllists{Nature, Earth} \\
\spelltgt{You} & \spellrng{Personal/\arealarge limit} \\
\spelldur{Concentration}
\end{tabularx}
\begin{spelleffect}
...
\spelltabular
\spellschool{Div (Awareness)} & \spelllists{Arcane, Divine, Knowledge} \\
\longcol{\spellcmp{Verbal, Somatic, and Material}} \\
\spelltgt{One creature} & \spellrng{Touch} \\
\spelldur{\durshort}
\spellsr{Yes (Will)}
...
\spelltabular
\spellschool{Div (Knowledge)} & \spelllists{Arcane} \\
\longcol{\spelltime{1 swift action}} \\
\longcol{\spellcmp{Verbal only}} \\
\spelltgt{one creature} & \spellrng{\rngmed} \\
\spelldur{See text}
\end{tabularx}
...
\spelltabular
\spellschool{Abjur (Interdiction) [Evil]} & \spelllists{Divine, Evil} \\
\longcol{\spellcmp{Verbal, Somatic, and Focus}} \\
\longcol{\spellarea{\areamed radius limit centered on you}} \\
\longcol{\spelltgts{Five creatures in the area}} \\
\spelldur{\durshort \dismissable}
...
\spelltabular
\spellschool{Evoc (Channeling) [Evil]} & \spelllists{Evil} \\
\spelltgt{One creature} & \spellrng{\rngmed} \\
\spelldur{Instantaneous/5 rounds}
\spellsr{Yes (Will)}
\spelldmg{8d6 divine damage \add d6 per two caster levels above 8th}
...
\spelltabular
\spellschool{Div/Necro (Awareness, Life)} & \spelllists{Arcane} \\
\spelltgt{One creature} & \spellrng{Touch} \\
\spelldur{\durlong \dismissable}
\spellsr{Yes (Will)}
\end{tabularx}
...
\spelltabular
\spellschool{Illus (Figment)} & \spelllists{Arcane, Trickery} \\
\longcol{\spellcmp{V, F}} \\
\spelleff{Intelligible sound, usually speech} & \spellrng{\rngclose} \\
\spelldur{\durshort \dismissable}
\end{tabularx}
\spellattack{Magic check vs. Perception and Will (if interacted with)}
\begin{spelleffect}
...
\spelltabular
\spellschool{Trans (Imbuement)} & \spelllists{Arcane} \\
\spelltgt{One nonmagical armor or shield} & \spellrng{Touch} \\
\spelldur{\durext \dismissable}
\spellsr{Yes (Will)}
\end{tabularx}
\spellattack{Magic vs. Will (harmless, object)}
...
\spelltabular
\spellschool{Necro (Life) [Death, Sound-Dependent]} & \spelllists{Death, Necro} \\
\longcol{\spellcmp{Verbal only}} \\
\longcol{\spellarea{\arealarge radius spread centered on you}} \\
\longcol{\spelltgts{Up to five living creatures in the area}} \\
...
\spelltabular
\spellschool{Evoc (Energy) [Fire, Wall]} & \spelllists{Arcane, Nature, Fire} \\
\spelleff{Opaque sheet of flame up to 100 ft. long or a ring of fire with a radius of up to 20 ft.; either form 20 ft. high} & \spellrng{\rngmed} \\
\spelldur{\durshort}
\spellsr{Yes (Reflex)}
...
\spelltabular
\spellschool{Evoc (Control) [Force, Wall]} & \spelllists{Arcane} \\
\spelleff{Wall whose area is up to ten 10 ft. squares} & \spellrng{\rngmed} \\
\spelldur{\durshort \dismissable}
\end{tabularx}
\begin{spelleffect}
...
\spelltabular
\spellschool{Conj/Trans (Alteration, Creation) [Earth, Wall]} & \spelllists{Arcane, Earth, Nature} \\
\spelleff{Stone wall whose area is up to ten 5 ft. squares (S)} & \spellrng{\rngmed} \\
\end{tabularx}
\spellattack{See text}
\begin{spelleffect}
...
\spelltabular
\spellschool{Conj (Creation) [Wall]} & \spelllists{Nature, Wild} \\
\spelleff{Wall of thorny brush, up to ten 10 ft. cubes (S)} & \spellrng{\rngmed} \\
\spelldur{\durlong \dismissable}
\end{tabularx}
\begin{spelleffect}
...
\spelltabular
\spellschool{Trans (Alteration)} & \spelllists{Destruction, Nature} \\
\spellarea{\areamed radius limit} & \spellrng{\rngclose} \\
\longcol{\spelltgt{1 Small nonmagical wooden object/caster level in the area}} \\
\spellsr{Yes (Will)}
\end{tabularx}
\spellattack{Magic vs. Will (object)}
\begin{spelleffect}
...
\spelltabular
\spellschool{Trans (Imbuement) [Water]} & \spelllists{Druid, Water} \\
...
\spelltabular
\spellschool{Necro (Flesh)} & \spelllists{Arcane, Death, War} \\
\longcol{\spellarea{\arealarge cone-shaped burst}} \\
\spelldur{\durshort}
\spellsr{Yes (Fortitude)}
\end{tabularx}
...
\spelltabular
\spellschool{Conj (Creation)} & \spelllists{Arcane} \\
\spellarea{\areamed radius spread} & \spellrng{\rngclose} \\
\longcol{\spelleff{Webs in the area}} \\
\spelldur{\durshort \dismissable}
\end{tabularx}
...
\spellsection{Wish}{9}
\spelltabular
\spellschool{Universal} & \spelllists{Arcane, Magic} \\
\longcol{\spellcmp{Verbal, Somatic, and Material}} \\
\spelltgteffarea{See text} & \spellrng{See text} \\
\spelldur{See text}
\spellsr{Yes (varies)}
...
\spelltabular
\spellschool{Conj (Translocation) [Teleportation]} & \spelllists{Divine} \\
\longcol{\spellcmp{Verbal only}} \\
\spelltgt{You} & \spellrng{Unlimited} \\
\end{tabularx}
\begin{spelleffect}
...
\spelltabular
\spellschool{Evoc/Trans (Augment, Control) [Air]} & \spelllists{Air, Nature} \\
\spelltgt{One melee weapon} & \spellrng{Touch} \\
\spelldur{\durshort}
\spellsr{Yes (Will)}
\end{tabularx}
\spellattack{Magic vs. Will (harmless)}
