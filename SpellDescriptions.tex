...
\spelldesc{You instantly create a shimmering field of magical energy, protecting you and your allies from hostile magic.}
...
\spellsr{Yes (Will)}
\begin{spelleffect}
\spell{Aid} grants temporary hit points equal to 10 \add caster level and a \plus2 bonus to attack rolls. \bonusscalingdescription
\end{spelleffect}
...
\spelldesc{You enhance your weapon while bringing it closer to your ideals.}
...
\par Should a creature be larger than the area enclosed by the barrier, any part of it that lies outside the barrier is unaffected by the field.
...
\spellschool{Transmutation (Augment) [Wood]}
\spelllvl{Drd 2, Nature 2, Trans 2}
\spellrng{\rngtouch}
\spelltgt{Living creature touched}
\spelldur{\durshort}
\spellsave{Fortitude negates (harmless)}
\spellsr{Yes (Fortitude)}
\begin{spelleffect}
The subject gains a \plus2 bonus to its natural armor modifier and physical damage reduction 2/adamantine. It ignores the first 2 points of physical damage each round, though an adamantine weapon bypasses the reduction. \bonusscalingdescription The damage reduction increases at the same rate.
\end{spelleffect}
\begin{spellnotes}
...
\spellsr{Yes (Reflex)}
\spelldmg{1d6 fire damage \add 1d6 per four caster levels above 1st}
\begin{spelleffect}
...
\spellsr{Yes (Will)}
\spelldmg{4d6 divine damage \add d6 per four caster levels above 8th}
\begin{spelleffect}
...
\par The hand attacks once per round, and its attack bonus equals your caster level \add your casting attribute modifier, which is the hand's Strength score, \minus1 for being Large.
\end{spelleffect}
\begin{spellblood}
...
\spelldur{\durshort (D)}
\begin{spelleffect}
You gain a \plus2 bonus to Strength, Dexterity, and Constitution, a \plus4 bonus to natural armor, a \plus4 bonus on Fortitude saves, and proficiency with any weapons you hold (except exotic weapons).
\end{spelleffect}
\begin{spellnotes}
...
\spelldmg{8d4 life damage \add d4 per four caster levels above 16th}
\begin{spelleffect}
...
\spellschool{Necromancy (Life) [Healing, Positive]}
\spelllvl{Brd 1, Clr 1, Drd 1, Pal 1, Rgr 1}
\spellrng{\rngtouch}
\spelltgt{Creature touched}
\spelldur{Instantaneous}
...
\spellschool{Necromancy (Life) [Healing, Positive]}
\spelllvl{Brd 2, Clr 2, Drd 2, Life 2, Pal 2, Rgr 2}
...
\spellschool{Necromancy (Life) [Healing, Positive]}
\spelllvl{Brd 3, Clr 3, Drd 3, Life 3, Pal 3, Rgr 3}
...
\spellrng{\rngtouch}
\spelltgt{Living creature touched}
\spelldur{Instantaneous/10 minutes per HV of subject; see text}
\spellsave{Fortitude negates}
\spellsr{Yes (Fortitude)}
\begin{spelleffect}
Upon casting this spell, you touch a living creature that is disabled or dying. If the subject fails its saving throw, it dies, and you gain 10 temporary hit points \plus1 per caster level. If the creature had more than 4 HV, you gain a \plus1 bous to your caster level. If the creature had more than 8 HV, you a \plus2 bonus to Strength, Dexterity, and Constitution. These effects last for 10 minutes per HV of the subject creature. If the creature had less than 1 HV, the bonuses last for 5 rounds.
\end{spelleffect}
...
\begin{spelleffect}
This spell functions like \spell{divine favor}, except that you also gain a \plus4 bonus to Strength and 2 temporary hit points per caster level.
\end{spelleffect}
...
\begin{spelleffect}
This spell grants you a powerful sixth sense in relation to yourself or another. Once foresight is cast, you receive instantaneous warnings of impending danger or harm to the subject of the spell. You are never surprised or flat-footed, and you gain a bonus on initiative checks equal to your caster level. In addition, the spell gives you a general idea of what action you might take to best protect yourself and gives you a \plus5 bonus to Reflex saves and dodge modifier. This bonus is lost whenever you would lose a Dexterity modifier to AC.
...
\spellschool{Transmutation (Imbuement)}
\spelllvl{Clr 4, Drd 4, Rgr 3, Travel 4}
\spellrng{Personal or touch}
\spelltgt{You or creature touched}
\spelldur{\durshort}
\spellsave{Will negates (harmless)}
\spellsr{Yes (Will)}
\begin{spelleffect}
This spell enables you or a creature you touch to move and attack normally for the duration of the spell, even under the influence of magic that usually impedes movement, such as paralysis, \spell{solid fog}, \spell{slow}, and \spell{web}. The subject gains a \plus20 bonus to CMD against grapple attacks, as well as on grapple attacks or Escape Artist checks made to escape a grapple or a pin.
\par The spell also allows the subject to move and attack normally while underwater, even with slashing weapons such as axes and swords or with bludgeoning weapons such as flails, hammers, and maces, provided that the weapon is wielded in the hand rather than hurled. The \spell{freedom} spell does not, however, allow water breathing.
\end{spelleffect}
...
\spellsr{Yes (Reflex)}
\spelldmg{7d6 cold damage \add d6 per four levels after 14th}
\begin{spelleffect}
...
\spellsr{Yes (Will)}
\begin{spelleffect}
The subjects gain a \plus2 bonus on attack rolls and weapon damage rolls. In addition, they gain 10 temporary hit points \add 1 per caster level.
\end{spelleffect}
\begin{spellnotes}
...
\par Its combat maneuver bonus to grapple equals your caster level \add your Intelligence, Wisdom, or Charisma modifier (for wizards, clerics, and sorcerers, respectively), \plus4 for being Large. The hand holds but does not harm creatures it grapples. Its CMD is equal to 10 \add its CMA.
\end{spelleffect}
\begin{spellnotes}
Directing the spell to a new target is a swift action.
\end{spellnotes}
...
\spellsr{Yes (Fortitude)}
\begin{spelleffect}
The subject is hasted. This has several effects.
\par When making a full attack action, a hasted creature may make one extra attack with any weapon he is holding. The attack is made using the creature's full base attack bonus, plus any modifiers appropriate to the situation. (This effect is not cumulative with similar effects, such as that provided by a weapon of speed, nor does it actually grant an extra action, so you can't use it to cast a second spell or otherwise take an extra action in the round.)
...
\end{spelleffect}
\begin{spellnotes}
\spell{Haste} dispels and counters \spell{slow}.
\end{spellnotes}
...
\spellsr{No}
\begin{spelleffect}
This spell allows you to telekinetically move yourself, another creature, or an object up and down as you wish. A creature must be willing to be levitated, and an object must be unattended or possessed by a willing creature. You can mentally direct the recipient to move up or down as much as 20 feet each round; doing so is a move action. You cannot move the recipient horizontally, but the recipient could clamber along the face of a cliff, for example, or push against a ceiling to move laterally (generally at half its base land speed).
\end{spelleffect}
...
\par Unlike mundane armor, \spell{force armor} entails no armor check penalty, arcane spell failure chance, or speed reduction. It is considered light armor for the purpose of class features and abilities, though you do not need to be proficient with it to use it. Since \spell{force armor} is made of force, incorporeal creatures can't bypass it the way they do normal armor.
\end{spelleffect}
\begin{spellnotes}
This armor is treated as a separate piece or armor from any other armor the creature is wearing, so it never stacks with existing armor bonuses.
\end{spellnotes}
...
\spellschool{Divination (Communication) [Language-Dependent]}
\spelllvl{Brd 1, Sor/Wiz 1}
\spellcmp{S}
\spellrng{\rngmed}
\spellarea{\areamed radius limit}
...
\par You gain a \plus4 bonus to Strength, but you take a \minus2 penalty to Dexterity (to a minimum Dexterity score of 1), and your speed is reduced to half normal. You can speak but cannot drink (and thus can't use potions) or play wind instruments. You have an armor check penalty of \minus4 and an arcane spell failure chance of 25%.
...
\spelldur{\durext}
\begin{spelleffect}
This spell functions like a \spell{fly} spell, except that at any point during the duration of the spell you can concentrate as a standard action to gain the ability to fly for 1 round. When using this spell for long-distance movement, you can concentrate to fly each round without taking nonlethal damage, but you cannot take a forced march. This means you can cover 60 miles in an ten-hour period of flight (or 40 miles at a speed of 40 feet).
\end{spelleffect}
...
\end{spellblood}
\begin{spellnotes}
The target must be bloodied when the spell is cast to suffer the bloodied effect. A creature whose HV exceeds your caster level are sickened instead of killed.
\end{spellnotes}
...
\spellschool{Abjuration (Shielding)}
\spelllvl{Abjur 1, Clr 2, Drd 2, Pal 2, Protection 2, Rgr 1, Sor/Wiz 2}
\spellrng{Touch}
\spelltgt{Creature touched}
\spelldur{\durlong or until discharged}
\spellsave{Fortitude negates (harmless)}
\spellsr{Yes (Fortitude)}
\begin{spelleffect}
This abjuration grants a creature limited protection from damage of whichever one of five energy types you select: acid, cold, electricity, fire, or sonic. The subject gains damage reduction 10 against the energy type chosen, meaning that each time the creature is subjected to such damage (whether from a natural or magical source), that damage is reduced by 10 points before being applied to the creature's hit points. The value of the damage reduction granted increases to 20 points at 8th level and to a maximum of 30 points at 12th level. The spell protects the recipient's equipment as well.
...
\spellschool{Abjuration (Shielding)}
\spelllvl{Clr 4, Drd 4, Pal 4, Rgr 3, Sor/Wiz 4}
\begin{spelleffect}
...
\spellsr{No}
\begin{spelleffect}
This spell functions like \spell{raise dead}, except that the affected creature suffers no negative effects for having died. However, the spell must be cast within one round of the creature's death per four caster levels. After that time, it has no effect.
\end{spelleffect}
...
\spellsave{Fortitude negates}
\spellsr{Yes (Fortitude)}
\spelldmg{d10 sonic damage}
\begin{spelleffect}
Creatures in the area take damage and are deafened for 5 rounds. A successful Fortitude save negates both effects.
\end{spelleffect}
...
\spellsr{Yes (Will)}
\begin{spelleffect}
The subject gains spell resistance 10.
\end{spelleffect}
...
\begin{spelleffect}
This spell seems to make time cease to flow for everyone but you. In fact, you speed up so greatly that all other creatures seem frozen, though they are actually still moving at their normal speeds. You are free to act for 1d3\plus1 rounds of apparent time. Normal and magical fire, cold, gas, and the like can still harm you. While the time stop is in effect, other creatures are invulnerable to your attacks and spells; you cannot target such creatures with any attack or spell. A spell that affects an area and has a duration longer than the remaining duration of the time stop have their normal effects on other creatures once the time stop ends. Most spellcasters use the additional time to improve their defenses, summon allies, or flee from combat.
\par You cannot move or harm items held, carried, or worn by a creature stuck in normal time, but you can affect any item that is not in another creature's possession.
\par You are undetectable while \spell{time stop} lasts. You cannot enter an area protected by an \spell{antimagic field} while under the effect of \spell{time stop}.
\end{spelleffect}
...
\spellsr{Yes (Will)}
\begin{spelleffect}
This spell grants creatures the mental power of a totem animal. It has three forms, each of which grants a \plus2 bonus to a mental attribute score. \bonusscalingdescription Spellcasters do not gain bonus spells due to the increased attribute score.
