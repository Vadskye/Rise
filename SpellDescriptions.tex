...
\begin{spelltarget}{You}
    \spelleffect You gain physical damage reduction 8/force. This damage reduction increases by 1 per caster level above 4th.
\end{spelltarget}
...
\begin{spelltrigger}{The primary target strikes a \bloodied undead creature for the first time in a round}
    \begin{spelltarget}*[Secondary]{One bloodied undead creature}l[Magic vs. Fortitude]
...
\spellsr{Yes (Fortitude)}
\begin{spelltarget}{You}
    \spelleffect You gain cold damage reduction 25 \add 1 per caster level above 10th, and radiate light as a torch. In addition, creatures that attack you take damage.
\end{spelltarget}
...
\spellnotes The damage reduction allows the subject to ignore the first 25 energy damage it takes each round of the appropriate type.
...
\spellsr{Yes (Fortitude)}
\begin{spelltarget}{One creature}
    \spelleffect The target gains damage reduction against a single energy type of your choice (acid, cold, electricity, fire). The damage resisted is equal to 8 \add 1 per caster level above 4th.
...
\par This spell overlaps (and does not stack with) \spell{protection from energy}. If a character is shielded by both spells, the \spellindirect{protection from energy}{protection} spell absorbs damage until its power is exhausted. A character can only be affected by one \spell{resist energy} spell at once.
...
\spellsr{Yes (Fortitude)}
\begin{spelltarget}{One creature}
    \spelleffect The target gains damage reduction against all energy types (acid, cold, electricity, fire). The damage resisted is equal to 16 \add 1 per caster level above 8th.
    \par The spell can absorb a maximum amount of damage equal to 10 points per caster level. After it absorbs its maximum amount of damage, the spell ends.
\end{spelltarget}
...
\spellsr{Yes (Will)}
\begin{spelltarget}{One creature}
    \spelleffect The target gains physical damage reduction 8/life. This damage reduction increases by 1 per two caster levels above 8th. In addition, any creature within \rngmed range of the target that deals damage to it takes life damage equal to the damage resisted by this damage reduction.
\end{spelltarget}
...
\spelldur{\durshort \dismissable}
\begin{spelltarget}{You}
    \spellsuccess You become larger, as \spell{enlarge person}. In addition, you gain physical damage reduction equal to 10 \add 1 per two caster levels above 10th. This damage reduction is overcome by evil attacks if you are good or neutral, and by good attacks if you are evil.
\end{spelltarget}
\spellnotes This spell's damage reduction allows the target to ignore the first 10 physical damage it takes each round. If it is hit by an attack that deals appropriately aligned damage, such as a weapon affected by \spell{align weapon} or a spell with the appropriate descriptor, it cannot use its damage reduction for 1 round.
...
\spellsr{Yes (Fortitude)}
\begin{spelltarget}{One creature}
    \spelleffect The target gains a \plus3 enhancement bonus to its armor modifier. This bonus increases to \plus4 at 14th caster level, and to \plus5 at 20th caster level. In addition, it gains physical damage reduction 8/adamantine. This damage reduction increases by 1 per two caster levels above 8th.
\end{spelltarget}
...
\begin{spelltarget}[Primary]{You}
    \spelleffect You gain physical damage reduction against ranged attacks, such as projectile weapons and thrown weapons. The damage reduction is equal to 35 \add 1 per caster level above 14th.
\end{spelltarget}
\begin{spelltrigger}{A creature attacks you with a melee weapon}
    \begin{spelltarget}[Secondary]{Magic vs. Fortitude}
        \spellsuccess 7d6 bludgeoning damage \add d6 per four caster levels above 14th.
    \end{spelltarget}
\end{spelltrigger}
\spellnotes This spell's damage reduction allows the subject to ignore the first 35 physical damage it takes each round from ranged attacks.
