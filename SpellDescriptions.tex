...
\end{spelleffect}
\begin{spellnotes}
  A demoralized creature is vulnerable, causing it to take a \minus2 penalty on attack rolls, saving throws, checks, DCs, and AC.
\end{spellnotes}
...
\begin{spelleffect}
  ...
  \begin{itemize*} 
    \item \plus10 ft. enhancement bonus to movement speed.
