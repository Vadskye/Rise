...
\begin{spelleffect}
  ...
  \par A \spell{blade barrier} provides cover (\plus4 bonus to AC, \plus2 bonus on Reflex defense) against attacks made through it.
\end{spelleffect}
...
\spellsr{Yes (Will)}
\begin{spelleffect}
  The subject gains concealment, granting it a \plus4 bonus to AC. This concealment allows the subject to use the Stealth skill to hide without other cover or concealment, though other restrictions apply as normal.
\end{spelleffect}
\begin{spellnotes}
...
\spellsr{Yes (Will)}
\begin{spelleffect}
  This charm makes a humanoid creature regard you as its trusted friend and ally. If it is currently faced with any obvious threat from you or your allies, such as someone drawing a weapon, casting a spell, or aiming a ranged weapon at the creature, it receives a \plus5 bonus on its saving throw.
...
\begin{spelleffect}
  ...
  \par First, each shielded creature gains a \plus5 enhancement bonus to its saving throws.
...
\begin{spelleffect}
    If the target is within 10 feet of natural earth or stone, you make a physical attack using your caster level \add your casting attribute as your attack bonus. If you hit the target's AC, it takes damage. If you also beat its Maneuver Class, it is immobilized for 5 rounds, preventing it from moving from its space.

    An immobilized creature can break free by destroying the spike. The spike has an AC of 10, and 2 hit points per caster level.
\end{spelleffect}
...
\spellsr{No}
\begin{spelleffect}
    Fog blocks sight in the area, causing all creatures within or looking through the area to treat everything they see as if it had concealment (\plus4 AC). The cloud is stationary once created.
\end{spelleffect}
\begin{spellnotes}
...
\spellsr{Yes (Will)}
\begin{spelleffect}
  The subject gains a \plus2 enhancement bonus on attack rolls, checks, and saving throws. \bonusscalingdescription
\end{spelleffect}
...
\begin{spelleffect}
  ...
  \par A duplicated spell allows saving throws and spell resistance as normal for the spell. When a limited wish spell duplicates a spell with a material component that costs more than 1,000 gp, you must provide that component (in addition to the 1,000 gp cost for this spell).
\end{spelleffect}
...
\spellsr{No; See text}
\begin{spelleffect}
  The subject gains a \plus2 enhancement bonus on saving throws. \bonusscalingdescription
...
\begin{spelleffect}
  ...
  \begin{itemize*} 
    ...
    \item \plus1 bonus to attack rolls and AC due to its decreased size.
...
\begin{spelleffect}
  ...
  \par \subspell{Revelation of Destruction} You inflict a vision of a terrible future upon the target. It takes a \minus4 penalty to attack rolls, checks, saving throws, DCs, and AC as it struggles to avoid the certainty of its own doom. If it becomes bloodied, these penalties increase by 2.
...
\begin{spellnotes}
  ...
  \par A \spell{spiritual weapon} cannot be attacked or harmed by physical attacks, but \spell{dispel magic}, \spell{disintegrate}, and similar effects can affect it. A spiritual weapon's AC against touch attacks is 12 (10 \add \plus2 bonus for Tiny size).
...
\end{spelleffect}
\begin{spellnotes}
  A very reasonable suggestion can grant a \plus2 or greater bonus on the attack. A creature that resists a \spell{suggestion} is immune to all further attempts by the same spellcaster for 24 hours.
\end{spellnotes}
