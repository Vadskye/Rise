...
\spellsr{Yes (Will)}
\begin{spelleffect}
  The subject is treated as having concealment from all creatures, granting it a \plus4 bonus to physical defenses and allowing it to hide with the Stealth skill. This spell has no effect in bright light.
\end{spelleffect}
\begin{spellnotes}
