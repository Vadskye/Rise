...
\begin{spelleffect}
    You make a ranged touch attack to deal damage to the target. The acid remains on the target after the initial impact, dealing damage each round on your turn.
\end{spelleffect}
\begin{spellnotes}
...
\spelldef{None/Fortitude negates}
\begin{spelleffect}
  This spell functions like \spell{fog cloud}, except that the fog is poisonous. When you cast this spell, and at the start of each of your turns, you make a Fortitude attack against all living creatures in the area to deal 1d4 Constitution damage.
...
\spellsr{Yes (Will)}
\begin{spelleffect}
    You make a Will attack against the subject to read its surface thoughts. A failed attack prevents you from reading its thoughts. You gain a \plus4 bonus to Bluff, Diplomacy, and Intimidate checks against creatures whose mind you are reading.
\end{spelleffect}
...
\begin{spelleffect}
  ...
  \par \subspell{Acorn Grenades} As many as four acorns turn into special splash weapons that can be hurled as far as 100 feet. When you throw an acorn, you make a ranged touch attack to strike intended target. If you miss, the acorn detonates in a random corner of the intended target square. Together, the acorns are capable of dealing 6d6 fire damage \add d6 per four caster levels above 12th, divided up among the acorns as you wish.
...
\begin{spelleffect}
    You make a ranged touch attack against the target to deal damage and dazzle it for 1 round.

    An undead creature takes 6d8 points of damage \add d8 per two caster levels above 6th, and an undead creature particularly vulnerable to bright light takes 6d10 points of damage \add d10 per two caster levels above 6th and is blinded for 1 round instead.
\end{spelleffect}
\begin{spellnotes}
...
\spellsr{Yes (Will)}
\begin{spelleffect}
    You make a melee touch attack to slow the subject for a \durshort duration.
\end{spelleffect}
\begin{spellblood}
