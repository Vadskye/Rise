...
\spelldur{1 round}
\begin{spelleffect}
  You gain magical damage reduction 5, causing you to ignore the first 5 damage dealt to you in the round if the damage is dealt by spells or spell-like abilities. This damage reduction increases by 1 per two caster levels above 2nd.
\end{spelleffect}
\begin{spellnotes}
...
\spelllvl{Clr 3, Good 3, Pal 3, War 3}
\spellrng{\rngtouch}
...
\spellsr{Yes (Will)}
\begin{spelleffect}
  The subject gains concealment (20\% miss chance) and a \plus2 bonus to Hide checks. \bonusscalingdescription This concealment is not sufficient by itself to make a Hide check.
\end{spelleffect}
\begin{spellnotes}
...
\spellschool{Evocation (Energy) [Cold]}
\spelllvl{Drd 5, Sor/Wiz 5, Water 6}
...
\spelllvl{Death 2, Evil 2, Sor/Wiz 2}
\spellrng{\rngtouch}
\spelltgt{Living creature touched}
...
\spellschool{Abjuration/Necromancy (Shielding, Vitalism) [Positive]}
\spelllvl{Clr 8, Death 8, Good 8, Protection 8}
\spellrng{\rngclose}
\spellarea{\areamed radius limit}
...
\spelldesc{You point your finger and release a black ray that drains your foe's life force away.}
\spellschool{Necromancy (Life)}
...
\spellsr{Yes (Fortitude)}
\begin{spelleffect}
  You must make a ranged touch attack to hit. If the attack succeeds, the target gains two negative levels. 
...
\spellsectioncomma{Harm}{Mass}
\spelldesc{You fill your foes with a massive influx of negative energy.}
\spellschool{Necromancy (Vitalism) [Healing, Positive]}
\spelllvl{Clr 9, Good 9, Healing 9}
\spellrng{\rngclose}
\spelltgts{One or more creatures in a \areamed radius}
\spelldmg{9d6 negative energy \add d6 per four caster levels above 18th}
\begin{spelleffect}
  This spell functions like \spell{harm}, except that it affects multiple creatures.
\end{spelleffect}
...
\spellsr{Yes (Will)}
\begin{spelleffect}
  The subject is considered to be within \rngclose range of you for determining the range of your spells. 
\end{spelleffect}
...
\begin{spelleffect}
  Two missiles of magical energy dart forth from your fingertip and strike creatures you designate in the area. A single missile can strike only one creature. For every two caster levels above 2nd, you gain an additional missile.
...
\end{spelleffect}
\begin{spellnotes}
  The subject's Strength cannot drop below \minus9.
\end{spellnotes}
...
\spellsave{None}
\spellsr{Yes (Fortitude)}
\spelldmg{2d6 cold damage \add d6 per two caster levels above 2nd}
\begin{spelleffect}
...
\spellsr{Yes (Will)}
\begin{spelleffect}
  The target takes 1 Charisma damage per two caster levels. A successful save means the target takes only 2 Charisma damage. 
\end{spelleffect}
\begin{spellnotes}
  A creature with a Charisma of \minus10 is unable to act.
\end{spellnotes}
