...
\spellsr{Yes (Will)}
\begin{spelleffect}
  The subject gains temporary hit points equal 10 \add 1 per caster level above 4th. In addition, it gains a \plus2 enhancement bonus to Will defense. \spellbonusscalingdescription  If the subject takes life damage, it loses all temporary hit points provided by this spell before applying the damage.
\end{spelleffect}
...
\spellsr{Yes (Will)}
\begin{spelleffect}
  All allies within the area gain a \plus2 enhancement bonus to physical attacks for 5 rounds. \spellbonusscalingdescription
\end{spelleffect}
...
\end{spellhealthy}
\begin{spellblood}
  As the healthy effect, and the subject is \blinded for 1 round or \deafened for the duration of the spell, as you choose.
\end{spellblood}
\begin{spellnotes}
...
\begin{spellnotes}
    ...
    Healthy creatures are not affected by this spell, and do not count against its level limit.
\end{spellnotes}
...
\spelllvl{Nature 2, Water 2}
\spellrng{\rngfar}
\spellarea{Water in one volume/caster level of 10 ft. by 10 ft. by 2 ft. (S)}
\spelldur{\durmed (D)}
\spelldef{None}
\spellsr{No}
\begin{spelleffect}
...
\spelleff{One swarm of centipedes per two caster levels}
\spelldur{\durmed}
\spelldef{None}
\spellsr{No}
\begin{spelleffect}
...
\spelldef{None, Physical vs. Reflex}
\spellsr{Yes (Fortitude)}
\begin{spelleffect}
...
\spelldmg{4d6 fire or cold damage \add d6 per four caster levels above 8th}
\begin{spelleffect}
...
\spellschool{Evocation (Channeling, Energy) [Destructive, Fire]}
...
\spelltgt{Touched creature}
\spelldur{Instantaneous}
\spelldef{Physical vs. Reflex, Magic vs. Fortitude}
\spellsr{Yes (Fortitude)}
...
\spelllvl{Nature 2}
\spellrng{\rngmed}
\spelltgt{One metal object of up to Medium size}
\spelldur{\durshort (D)}
\spelldef{Magic vs. Fortitude (object)}
\spellsr{Yes (Fortitude)}
...
\begin{spelleffect}
  ...
  \par First, each shielded creature gains a \plus5 enhancement bonus to its defenses.
  \par Second, each shielded creature gains spell resistance against evil spells and spells cast by evil creatures.
...
\spellrng{\rngclose}
\spelltgt{A creature or object weighing no more than 100 lb./caster level}
\spelldur{\durshort (D)}
...
\spelllvl{Arcane 3}
\spellrng{\rngclose}
\spelltgt{You or one willing creature or one object (total weight up to 100 lb./caster level)}
\spelldur{\durshort (D)}
\spelldef{None}
\spellsr{Yes (Will)}
\begin{spelleffect}
...
\spellschool{Evocation (Energy) [Destructive, Electricity]}
...
\spelllvl{Conj 1}
\spellrng{\rngclose}
\spelltgt{One object you can hold or carry in one hand, weighing up to 10 lb./caster level}
\spelldur{Instantaneous}
...
\spellrng{\rngclose}
\spellarea{\areamed radius limit}
\spelltgts{One creature per caster level within the area}
\spelldur{\durlong (D)}
\spelldef{Magic vs. Will (harmless)}
\spellsr{Yes}
\begin{spelleffect}
...
\spellrng{\rngclose}
\spellarea{\areamed radius limit}
\spelltgt{1 Small nonmagical wooden object/caster level within the area}
\spelldur{Instantaneous}
\spelldef{Magic vs. Will (object)}
\spellsr{Yes (Will)}
\begin{spelleffect}
