...
\begin{spelleffect}
  This spell functions like \spell{acid arrow}, except that it deals more damage, and your attack is also made against the target's Fortitude if you beat the target's Reflex.
\end{spelleffect}
\spellattack{Magic vs. Reflex}
\begin{spellsuccess}
