...
\spelllvl{Arcane 5}
\spellrng{\rngfar}
\spelldef{Reflex negates, Fortitude partial}
...
\spellsr{Yes (Will)}
\begin{spelleffect}
  Attacks with the affected weapon are made against Reflex defense. However, damage with the weapon is halved, including any bonuses to damage.
\end{spelleffect}
