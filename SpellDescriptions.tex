...
\spellschool{Enchantment (Inhibition) [Mind-Affecting]}
\spelllvl{Brd 2, Clr 2, Pal 2, Sor/Wiz 2, War 2}
\spellrng{\rngclose}
\spelltgt{One humanoid creature}
...
\spellschool{Necromancy (Vitalism) [Negative]}
\spelllvl{Clr 4, Sor/Wiz 4}
\spelldmg{8d8 negative energy damage \add d8 per two caster levels above 8th}
\begin{spelleffect}
...
\spelldmg{4d8 negative energy damage \add d8 per two caster levels above 4th}
\begin{spelleffect}
...
\spellsection{Light}
\spellschool{Illusion (Figment) [Light]}
\spelllvl{Brd 1, Clr 1, Drd 1, Pal 1, Sor/Wiz 1}
\spellrng{\rngtouch}
\spelltgt{Object touched}
\spelldur{\durlong (D)}
\spellsave{None}
...
\end{spelleffect}
\begin{spellnotes}
  This spell's damage reduction allows the subject to ignore the first 10 physical damage it takes each round. If it is hit by an attack that deals life damage, such as \spell{crush life}, it cannot use its damage reduction for 1 round.
\end{spellnotes}
