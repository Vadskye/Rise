...
\begin{spelltarget}{One creature}[Magic vs. Fortitude]
    ...
    If the target is \bloodied when the spell is cast, it loses all its hit points and takes 9 critical damage, causing it to begin dying.
\end{spelltarget}
...
\begin{spelltargets}{All nongood creatures in the area}
    ...
    \begin{itemize}
        \item Up to caster level \minus5: The creature is also \blinded for 1 round.
        \item Up to caster level \minus10: The creature is also \paralyzed for 5 rounds.
        \item Up to caster level \minus15: The creature immediately dies. A nonliving creature is destroyed.
    \end{itemize}
\end{spelltargets}
...
\begin{spelltarget}{One creature}
    ...
    If the target is \bloodied when the spell is cast, it is instead \blinded.
\end{spelltarget}
...
\begin{spelltarget}{One creature}
    ...
    If the target is \bloodied when the spell is cast, it is instead \confused.
\end{spelltarget}
...
\begin{spelltarget}{One living creature}
    ...
    If the target is \bloodied when the spell is cast, and its level does not exceed your caster level, it dies instead.
\end{spelltarget}
...
\begin{spelltarget}{One creature}
    ...
    If the target is \bloodied when the spell is cast, it is instead \stunned.
\end{spelltarget}
...
\begin{spelltarget}*{One creature}
    \spelleffect[\subspell{Revelation of Destruction}] You inflict a vision of a terrible future upon the target. It takes a \minus4 penalty to attacks, defenses, and checks as it struggles to avoid the certainty of its own doom. If it becomes \bloodied, these penalties increase by 2.
