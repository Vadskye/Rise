    ...
    \begin{spellsubcontent}
        ...
        \begin{spelleffects}
            \begin{spellattack}{Spellpower \add casting attribute vs. Maneuver defense}
                \spellsuccess The target is grappled and takes 1d8\plus4 bludgeoning damage. It remains grappled until it escapes the tentacle. The DC to escape the grapple is equal to 10 \add your spellpower \add your casting attribute.
            \end{spellattack}
        \end{spelleffects}
    \end{spellsubcontent}
    \begin{spellfooter}
        ...
        \begin{spelleffects}
            \begin{spellattack}{Magic vs. Fortitude}
                \begin{spellmargin}
                    ...
                    \spellfailure Half damage.
                \end{spellmargin}
                \spellatk Spellpower \add casting attribute \add 12 vs. Maneuver defense (shove)
                \begin{spellmargin}
