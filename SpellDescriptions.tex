...
\end{spelleffect}
\begin{spellnotes}
  A vulnerable creature takes a \minus2 penalty on attack rolls, saving throws, checks, DCs, and AC.
\end{spellnotes}
...
\end{spelleffect}
\begin{spellnotes}
    A fatigued character can neither sprint nor charge and is vulnerable, giving it a \minus2 penalty to attack rolls, saving throws, checks, DCs, and AC.
\end{spellnotes}
...
\end{spelleffect}
\begin{spellnotes}
  A vulnerable creature takes a \minus2 penalty to attack rolls, saving throws, checks, DCs, and AC. This spell can be made permanent with a \spell{permanency} ritual. A permanent \spell{stinking cloud} dispersed by wind reforms in 10 minutes.
\end{spellnotes}
...
\end{spelleffect}
\begin{spellnotes}
    An exhausted character cannot sprint or charge, moves at half speed, and takes a \minus4 penalty to attack rolls, saving throws, checks, DCs, and AC. A fatigued character can neither sprint nor charge and is vulnerable, giving it a \minus2 penalty to attack rolls, saving throws, checks, DCs, and AC.
\end{spellnotes}
...
\end{spellblood}
\begin{spellnotes}
  A vulnerable creature takes a \minus2 penalty to attack rolls, saving throws, checks, DCs, and AC. Creatures whose level exceeds your caster level are unaffected by \spell{word of chaos}.
\end{spellnotes}
