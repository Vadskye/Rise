...
\end{spelleffect}
\begin{spellnotes}
  Multiple magical effects that increase size do not stack. This spell can be made permanent with a \spell{permanency} spell.
\end{spellnotes}
...
\end{spelleffect}
\begin{spellnotes}
  Multiple magical effects that reduce size do not stack. This spell can be made permanent with a \spell{permanency} spell.
\end{spellnotes}
