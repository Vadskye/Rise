...
\spelllvl{Arcane 5}
\spellrng{\rngfar}
\spelldef{None/Fortitude negates}
\spelldmg{5d6 acid damage \add 2d6 per round}
\begin{spelleffect}
  This spell functions as \spell{acid arrow}, except that a successful Fortitude attack makes the target vulnerable for the duration of the spell.
\end{spelleffect}
\begin{spellnotes}
  A vulnerable creature takes a \minus2 penalty to attacks, defenses, and checks. If the target becomes submerged in liquid or takes at least twenty points of fire or cold damage, this spell's effect ends.
\end{spellnotes}
...
\begin{spelleffect}
  This spell functions like \spell{solid fog}, except that the fog is highly acidic. When you cast this spell, and at the start of each of your turns, you make a Fortitude attack to deal damage to all creatures and objects in the area. A failed attack deals half damage.
\end{spelleffect}
...
\spelldur{\durshort}
\spelldef{Fortitude negates (harmless)}
\spellsr{Yes (Fortitude)}
\begin{spelleffect}
...
\spellschool{Abjuration (Negation) [Magic]}
\spelllvl{Arcane 7, Divine 8, Magic 7}
...
\spellsr{Yes (Fortitude)}
\begin{spelleffect}
  The subject gains a \plus2 enhancement bonus to its armor defense modifier. \bonusscalingdescription In addition, the subject gains physical damage reduction 2/adamantine or fire. This damage reduction increases by 1 per two levels above 4th.
\end{spelleffect}
\begin{spellnotes}
...
\spelldur{\durshort (D)}
\spelldef{Reflex half or Reflex negates; see text}
\spellsr{Yes (Reflex)}
...
\begin{spelleffect}
  ...
  \par A \spell{blade barrier} provides cover (\plus4 bonus to physical defenses, \plus2 bonus to Reflex defense) against attacks made through it.
\end{spelleffect}
...
\spellschool{Enchantment (Emotion) [Mind-Affecting, Morale]}
\spelllvl{Divine 2, Good 2, Pal 2, War 2}
\spellarea{\areamed radius burst}
\spelldur{Instantaneous}
\spelldef{None}
\spellsr{Yes (Will)}
...
\spellschool{Necromancy (Flesh)}
\spelllvl{Arcane 2, Divine 3, Death 3, Pal 3}
\spellrng{Touch}
...
\end{spellblood}
\begin{spellnotes}
   The choice of bloodied conditions is made at the time the spell is cast. A vulnerable creature takes a \minus2 penalty to attacks, defenses, and checks. A blinded character cannot see. She takes a \minus2 penalty to physical attacks and defenses, and any checks which involve sight. In addition, she is flat-footed and moves at half speed. All checks and activities that rely on vision (such as reading and Spot checks) automatically fail. A blinded character has a 50\% miss chance on all attacks.

  A deafened character cannot hear. She automatically fails Listen checks, takes a \minus2 penalty to any checks which involve hearing, and has a 20\% chance of spell failure when casting spells with verbal components.
...
\spellsr{Yes (Will)}
\begin{spelleffect}
  The subject gains concealment, granting it a \plus4 bonus to its physical defenses. This concealment allows the subject to use the Stealth skill to hide without other cover or concealment, though other restrictions apply as normal.
\end{spelleffect}
\begin{spellnotes}
...
\end{spelleffect}
\begin{spellblood}
    A successful attack against a bloodied creature (after taking into account the damage dealt by the spell) staggers it for 1 round.
\end{spellblood}
\begin{spellnotes}
...
\spellsr{Yes (Will)}
\begin{spelleffect}
    If you succeed at a Will attack, the subject regards you as its trusted friend and ally. If it is currently faced with any obvious threat from you or your allies, such as someone drawing a weapon, casting a spell, or aiming a ranged weapon at the creature, you take a \minus5 penalty on the Will attack.
...
\end{spelleffect}
\begin{spellblood}
  You also make a Fortitude attack to daze the struck creature for 1 round.
\end{spellblood}
\begin{spellnotes}
...
\spelldef{None/Fortitude negates}
\begin{spelleffect}
  This spell functions like \spell{fog cloud}, except that the fog is poisonous. When you cast this spell, and at the start of each of your turns, you make a Fortitude attack against all living creatures in the area. A successful attack deals 1d4 Constitution damage.
...
\spellsr{Yes (Will)}
\begin{spelleffect}
  You make a Will attack against each creature in the area. A successful attack dazzles and bewilders the subject.
\end{spelleffect}
\begin{spellnotes}
  A dazzled creature has a 20\% miss chance on all physical attacks and takes a \minus4 penalty to Spot checks. He is also unable to see with darkvision. A bewildered creature is mentally affected in a way that detracts from its ability to act, causing it to be vulnerable. It takes a \minus2 penalty to attacks, defenses, and checks.
...
\spelllvl{Arcane 1, Divine 1, Law 1, Pal 1}
\spellcmp{Verbal only}
\spellrng{\rngmed}
\spelltgt{One creature}
\spelldur{1 round}
...
\spelldef{Reflex half/None}
\spellsr{Yes (Reflex)}
\spelldmg{5d6 cold damage \add d6 per four caster levels above 10th.}
\begin{spelleffect}
    You make a Reflex attack to deal damage to everything in the area. A failed attack deals half damage. Creatures damaged by the spell are fatigued for 5 rounds.
\end{spelleffect}
...
\spelldur{\durshort (D)}
\spelldef{Will disbelief (if interacted with)}
\spellsr{No}
\begin{spelleffect}
...
\spellsr{Yes (Will)}
\begin{spelleffect}
  Each creature in the area is vulnerable.
\end{spelleffect}
\begin{spellnotes}
  A vulnerable creature takes a \minus2 penalty on attacks, defenses, and checks.
\end{spellnotes}
...
\spelllvl{Divine 4, Life 4, Nature 4, Pal 4}
...
\spellschool{Necromancy (Vitalism) [Positive]}
\spelllvl{Divine 1, Nature 1, Pal 1}
\spellrng{\rngclose}
\spelltgt{One creature}
\spelldur{Instantaneous}
\spelldef{Fortitude half; see text}
\spellsr{Yes (Fortitude)}
...
\spelllvl{Divine 2, Life 2, Nature 2, Pal 2}
...
\spellschool{Necromancy (Vitalism) [Positive]}
\spelllvl{Divine 3, Life 3, Nature 3, Pal 3}
...
\spelllvl{Death 3, Divine 3, Good 3, Pal 3, Protection 3}
\spellrng{\rngclose}
...
\spellsr{Yes (Will)}
\begin{spelleffect}
    You make a Will attack to read the subject's surface thoughts. A failed attack prevents you from reading its thoughts. You gain a \plus4 bonus to Bluff, Diplomacy, and Intimidate checks against creatures whose mind you are reading.
\end{spelleffect}
...
\spellsr{Yes (Will)}
\begin{spelleffect}
    You make a Will attack against the subject. Success means it cannot travel extradimensionally for an hour, while failure reduces the duration to 5 rounds. Effects barred by a \spell{dimensional anchor} include \spell{astral projection}, \spell{blink}, \spell{dimension door}, \spell{ethereal jaunt}, \spell{gate}, \spell{maze}, \spell{plane shift}, \spell{shadow walk}, \spell{teleport}, and similar spell-like, psionic, or supernatural abilities.
\end{spelleffect}
\begin{spellnotes}
...
\spelleff{Ray}
\spelldur{Instantaneous}
\spelldef{Fortitude half (object)}
\spellsr{Yes (Fortitude)}
...
\begin{spelleffect}
  ...
  \par When used against an object, the ray simply disintegrates as much as one 10-foot cube of nonliving matter. Thus, the spell disintegrates only part of any very large object or structure targeted. The ray affects even objects constructed entirely of force, \spell{wall of force}, but not magical effects such as a \spell{globe of invulnerability} or an \spell{antimagic field}.
\end{spelleffect}
\begin{spellnotes}
...
\spelldur{Instantaneous}
\spelldef{Will negates; see text}
\spellsr{Yes (Will)}
\begin{spelleffect}
...
\spellschool{Abjuration (Negation) [Magic]}
\spelllvl{Arcane 3, Divine 3, Magic 3, Nature 4, Pal 3}
\spellrng{\rngmed}
...
\spelllvl{Divine 4, Pal 3}
\spellrng{\rngclose}
\spelltgt{One melee weapon}
\spelldur{\durshort}
\spelldef{Will negates (object)/Fortitude negates}
\spellsr{Yes (Will)/Yes (Fortitude)}
\begin{spelleffect}
  This spell infuses a melee weapon with positive energy, making it deadly to undead. The first time the weapon strikes a bloodied undead creature each round, you make a Fortitude attack against the creature. A successful attack means the creature is destroyed utterly. Healthy undead creatures suffer no ill effect.
\end{spelleffect}
...
\spellschool{Transmutation (Augment)}
\spelllvl{Divine 1, Pal 1, Strength 1, War 1}
\spellrng{\rngpers}
\spelltgt{You}
\spelldur{\durshort}
\begin{spelleffect}
...
\spellschool{Transmutation (Augment)}
\spelllvl{Divine 4, Pal 4, Strength 4, War 4}
\begin{spelleffect}
...
\begin{spelleffect}
  ...
  \par \subspell{Open Ground} If your Reflex attack is successful against a creature, it falls prone. In addition, fissures open in the earth, and every creature on the ground has a 25\% chance to be above one. You make a Reflex attack against each creature threatened by a fissure. A successful attack causes a creature to fall into the fissure. At the end of the spell, all fissures grind shut, dealing 8d10 bludgeoning damage \add d10 per four caster levels above 16th to any creatures trapped in them and ejecting their bodies (dead or alive).
...
\begin{spelleffect}
  ...
  \begin{itemize*} 
    ...
    \item \minus2 penalty to Stealth checks.
  \item Carrying capacity is increased (see \pcref{Carrying Capacity}).
  \end{itemize*}
...
\spellarea{\areasmall radius spread}
\spelldur{\durshort (D)}
\spelldef{Reflex partial}
\spellsr{No}
\begin{spelleffect}
    When you cast this spell, and at the start of each of your turns, you make a Reflex attack to entangle all creatures and objects in the area. An entangled creature can break free and move half its normal speed by using a standard action to make a grapple attack or an Escape Artist check that beats your Reflex attack. Creatures in the area that are not entangled can still move at only half speed through the area.
\end{spelleffect}
\begin{spellnotes}
...
\spelldef{Will negates (harmless) or Will negates (object)}
\spellsr{Yes (Will)}
\begin{spelleffect}
...
\begin{spelleffect}
  ...
  \par Each acorn explodes upon striking any hard surface. When it does, you make a Reflex attack to damage all creatures in a \areasmall radius burst. A failed attack deals half damage. You automatically succeed on this attack against a creature struck by the acorn directly.
  ...
  \par If you are within \rngmed range and speak a word of command (as a standard action), each berry instantly bursts into flame. When they do, you make a Reflex attack against every creature in a \areamed radius burst of the berries. A failed attack deals half damage.
\end{spelleffect}
\begin{spellnotes}
...
\begin{spelleffect}
  You can make a Reflex attack to deal damage to any creature that hits you with its body or a melee weapon. A failed attack deals half damage. Each individual creature can take this damage only once per round. The damage type and other effects depend on which kind of \spell{fire shield} is used. This decision must be made at the time the spell is cast.
...
\begin{spelleffect}
    This spell functions like \spell{foresight}, except that the subject is also never surprised or flat-footed.
\end{spelleffect}
...
\begin{spelleffect}
  ...
  If the \spell{freezing sphere} strikes a body of water or a liquid that is principally water (not including water-based creatures), it freezes the liquid to a depth of 6 inches over an area equal to 100 square feet (a 10-foot square) per caster level. This ice lasts for 5 rounds. Creatures that were swimming on the surface of frozen water become trapped in the ice. Attempting to break free is a full-round action. A trapped creature must make a grapple attack or an Escape Artist check that beats your Reflex attack to escape.
\end{spelleffect}
...
\spellsr{No}
\begin{spelleffect}
  The subject and all its gear become insubstantial, misty, and translucent. Its armor defense modifier becomes 0, though other defense modifiers continue to apply normally. The subject gains physical damage reduction 10/magic and becomes immune to critical hits. It can't attack or cast spells with verbal, somatic, material, or focus components while in gaseous form. (This does not rule out the use of certain spells that the subject may have prepared using the feats Silent Spell or Still Spell.) If it has a touch spell ready to use, that spell is discharged harmlessly when the gaseous form spell takes effect.
...
\spelllvl{Arcane 6}
\begin{spelleffect}
  This spell functions like \spell{interposing hand}, except the hand can also grapple one opponent that you select. You must direct the hand to grapple an opponent as a swift action. If you do, the \spell{grasping hand} may make a grapple attack as a swift action. Its maneuver modifier equals your caster level \add your casting attribute, \plus4 for being Large. Its Maneuver Class is equal to 10 \add its maneuver modifier.
...
\spellsr{No}
\begin{spelleffect}
    You make a Reflex attack to make each creature in the area prone. A creature can walk within or through the area of grease at half normal speed with a DC 10 Balance check. Failure means it can't move that round, while failure by 5 or more means it falls (see the Balance skill for details). A creature standing in a greased area is flat-footed due to the slippery surface.
...
\spelltgt{Touched creature}
\spelldur{Instantaneous}
\spelldef{Fortitude negates (harmless) or Fortitude negates; see text}
\spellsr{Yes (Fortitude)}
...
\spellschool{Enchantment (Inhibition) [Mind-Affecting]}
\spelllvl{Arcane 2, Divine 2, Pal 2, War 2}
\spellrng{\rngclose}
\spelltgt{One humanoid creature}
...
\end{spellblood}
\begin{spellnotes}
  Creatures whose level exceeds your caster level are unaffected by \spell{holy word}.
\end{spellnotes}
...
\begin{spelleffect}
    You make a Fortitude attack to deal damage to each affected creature. A failed attack deals half damage. Plants and creature with the water subtype take a \minus5 penalty on their saving throw. 
\end{spelleffect}
...
\end{spellblood}
\begin{spellnotes}
  A vulnerable creature takes a \minus2 penalty to attacks, defenses, and checks. \spell{Remove curse} and \spell{dispel magic} do not remove \spell{insanity}. \spell{Greater restoration}, \spell{heal}, \spell{limited wish}, \spell{miracle}, or \spell{wish} can restore the creature.
\end{spellnotes}
...
\spellschool{Transmutation (Augment)}
\spelllvl{Arcane 4, Divine 4, Pal 4, War 4}
\spellrng{\rngclose}
\spelltgt{One creature}
\spelldur{\durshort}
\spelldef{Will negates (harmless)}
...
\spelldur{\durshort (D)}
\spelldef{Will negates (harmless) or Will negates (harmless, object)}
\spellsr{Yes (Will)}
\begin{spelleffect}
...
\spellsr{Yes (Will)}
\begin{spelleffect}
    As you cast this spell, you choose whether to create body armor or a shield. If you choose body armor, the subject gains a \plus2 armor defense modifier. If you choose a shield, the subject gains a \plus2 shield defense modifier. The bonus granted increases to \plus3 at 8th level, to \plus4 at 14th level, and finally to \plus5 at 20th level. 
...
\spelllvl{Arcane 5, Chaos 5, Divine 5, Pal 4}
\begin{spelleffect}
...
\spelllvl{Arcane 5, Divine 5, Good 5, Pal 4}
\spellrng{Touch}
...
\spellsr{Yes (Will)}
\begin{spelleffect}
  All creatures within the area gain the effects of a \spell{protection from evil} spell. In addition, no nongood summoned creatures can enter the area.
\end{spelleffect}

\spellsection{Magic Circle against Good}
\spellschool{Abjuration (Interdiction) [Barrier, Evil]}
\spelllvl{Arcane 5, Divine 5, Evil 5}
\begin{spelleffect}
...
\spelllvl{Arcane 5, Divine 5, Chaos 5}
\begin{spelleffect}
...
\spelldur{\durmed}
\spelldef{Will negates (harmless, object)}
\spellsr{Yes (Will)}
\begin{spelleffect}
...
\end{spelleffect}
\begin{spellnotes}
    When you cast this spell, you make a Will attack. This attack is made against any creature that interacts with the effect. If you fail, the creature disbelieves the spell. In order to interact with the illusion with a Perception check, the creature must make a Perception check that beats your Will attack. 
\end{spellnotes}
...
\spelldef{None/Will negates}
\spellsr{None/Yes (Will)}
\begin{spelleffect}
  This spell functions like \spell{fog cloud}, except that the fog hampers mental ability. Once per minute, you make a Will attack against all creatures in the area. A successful attack imposes a \minus5 penalty to Wisdom. Affected creatures take the penalty as long as they remain in the fog and for 5 rounds thereafter. The fog is stationary and lasts for 1 hour (or until dispersed by wind).
\end{spelleffect}
\begin{spellnotes}
...
\spelldur{\durshort (D); see text}
\spelldef{None/Will disbelief (if interacted with); see text}
\spellsr{No}
\begin{spelleffect}
...
\begin{spelleffect}
  This spell functions like \spell{lesser moment of prescience}, except that you also gain a bonus equal to half your caster level on the roll. Alternately, you can expend the spell to protect yourself. If you do, you gain a bonus to your dodge defense modifier equal to half your caster level, and you stop being flat-footed if you were. This effect can be used even if you are flat-footed, which would normally prevent you from using immediate actions.
\end{spelleffect}
\begin{spellnotes}
...
\spelltgt{One creature}
\spelldur{Instantaneous}
\spelldef{Will disbelief and Fortitude negates; see text}
\spellsr{Yes (Will)}
\begin{spelleffect}
    You make a Will attack to make the subject shaken for 5 rounds, leaving it vulnerable.
\end{spelleffect}
\begin{spellblood}
    If you succeed at the Will attack, make a Fortitude attack. If you succeed, the target loses all its hit points and takes 9 critical damage, causing it to begin dying.
\end{spellblood}
\begin{spellnotes}
  A vulnerable creature takes a \minus2 penalty to attacks, defenses, and checks.
\end{spellnotes}
...
\spelltgt{Touched living creature}
\spelldur{Instantaneous; see text}
\spelldef{Fortitude negates; see text}
\spellsr{Yes (Fortitude)}
\begin{spelleffect}
...
\begin{spelleffect}
  This spell functions like \spell{lesser precognition}, except that it also affects your special defenses and dodge defense modifier.
\end{spelleffect}
...
\begin{spelleffect}
  This spell functions like \spell{lesser precognition}, except that it also affects your special defenses and dodge defense modifier. In addition, when making a full attack, you may make an additional attack at a \minus5 penalty.
\end{spelleffect}
...
\spelldef{Will half/Will negates}
\spelldur{\durshort}
\spellsr{Yes (Will)}
...
\spellschool{Abjuration (Shielding)}
\spelllvl{Arcane 3, Divine 3, Nature 3, Pal 3, Protection 3}
\spellrng{Touch}
\spelltgt{Touched creature}
\spelldur{\durlong or until discharged}
\spelldef{Fortitude negates (harmless)}
...
\spellschool{Abjuration (Interdiction) [Good]}
\spelllvl{Arcane 1, Divine 1, Good 1, Pal 1}
\spellrng{\rngclose}
\spelltgt{One creature}
\spelldur{\durshort (D)}
\spelldef{Will negates (harmless)}
\spellsr{No; See text}
\begin{spelleffect}
  The subject gains a \plus2 enhancement bonus to its defenses. \bonusscalingdescription
...
\spelllvl{Arcane 1, Divine 1, Evil 1}
\begin{spelleffect}
...
\spelllvl{Arcane 1, Chaos 1, Divine 1}
\begin{spelleffect}
...
\spellschool{Abjuration (Shielding)}
\spelllvl{Arcane 2, Divine 2, Nature 2, Pal 2, Protection 2}
\spellrng{Touch}
\spelltgt{Touched creature}
\spelldur{\durlong or until discharged}
\spelldef{Fortitude negates (harmless)}
...
\spellschool{Abjuration (Shielding)}
\spelllvl{Arcane 4, Divine 4, Nature 4, Pal 4}
\begin{spelleffect}
...
\spelldef{Will negates (harmless), Fortitude negates}
\spellsr{Yes (Will)}
\begin{spelleffect}
...
\spelllvl{Divine 5, Good 5, Pal 4, Strength 5}
\spellrng{Personal}
\spelltgt{You}
\begin{spelleffect}
...
\spelllvl{Arcane 1, Divine 1, Pal 1, Protection 1}
\spellrng{Touch}
\spelltgt{Touched creature}
\spelldur{\durshort}
\spelldef{Will negates (harmless) and Will negates; see text}
\spellsr{Yes (Will)}
\begin{spelleffect}
...
\end{spelleffect}
\begin{spellnotes}
  A vulnerable creature takes a \minus2 penalty to attacks, defenses, and checks. Your allies, and creatures unable to see the lights, are unaffected.
\end{spellnotes}
...
\end{spelleffect}
\begin{spellnotes}
  A dazzled creature has a 20\% miss chance on all physical attacks and takes a \minus4 penalty to Spot checks. He is also unable to see with darkvision.
\end{spellnotes}
...
\spelleff{One shadow duplicate}
\spelldur{\durmed}
\spelldef{None/Will disbelief (if interacted with)}
\spellsr{No}
\begin{spelleffect}
...
\spellschool{Abjuration/Necromancy (Life, Shielding)}
\spelllvl{Arcane 2, Divine 2, Death 2, Pal 2, Protection 2}
\spellrng{\rngmed}
...
\spelldef{Will negates}
\begin{spelleffect}
  This spell functions like \spell{share pain}, except that it can affect unwilling creatures. You must succeed at a Will attack against both subjects for the spell to work.
\end{spelleffect}
...
\spellschool{Abjuration (Shielding)}
\spelllvl{Divine 1, Pal 1, Protection 1}
\begin{spelleffect}
...
\begin{spelleffect}
    You make a touch attack to deal damage to the target. If you hit, you also make a Fortitude attack to stagger it for 1 round. You gain a \plus2 bonus to attack with this spell if the target is wearing metal armor or otherwise has a significant quantity of metal.
\end{spelleffect}
\begin{spellnotes}
   A staggered character may take a single move action or standard action each round, but not both. She cannot take full-round actions, but she may take swift actions. In addition, she is vulnerable, causing her to take a \minus2 penalty on attacks, defenses, and checks.
\end{spellnotes}
...
\spellarea{\areamed cone-shaped burst}
\spelldur{Instantaneous}
\spelldef{Fortitude half/Fortitude negates}
\spellsr{Yes (Fortitude)}
...
\spellrng{\rngmed}
\spellarea{\areamed radius mobile emanation centered on a creature, object, or point in space}
\spelldur{\durshort (D)}
\spelldef{Will negates; see text or none (object)}
\spellsr{Yes (Will); see text}
\begin{spelleffect}
  ...
  You must make a Will attack to affect an unwilling creature who enters the spell's area. A creature who successfully resists the spell can hear and make sound normally, but still cannot be hear or be heard by other creatures in the area (unless they also resisted the spell).
\end{spelleffect}
\begin{spellnotes}
...
\end{spelleffect}
\begin{spellnotes}
  A vulnerable creature takes a \minus2 penalty to attacks, defenses, and checks. This spell can be made permanent with a \spell{permanency} ritual. A permanent \spell{stinking cloud} dispersed by wind reforms in 10 minutes.
\end{spellnotes}
...
\spellsr{Yes (Fortitude)}
\begin{spelleffect}
    The subject gains a \plus3 enhancement bonus to its armor defense modifier. This bonus increases to \plus4 at 14th level, and to \plus5 at 20th level. In addition, it gains physical damage reduction 8/adamantine. This damage reduction increases by 1 per two levels above 8th.
\end{spelleffect}
\begin{spellnotes}
...
\begin{spelleffect}
    You make a Reflex attack to deal damage to everything in the area. A failed attack deals half damage. A failed attack deals half damage. Any creatures to which sunlight is harmful or unnatural instead take 5d10 points of damage \add d10 per four caster levels above 10th, and if your Reflex attack is successful, they are blinded for 5 rounds.
\end{spelleffect}
\begin{spellnotes}
...
\spelldef{Will negates (object)/None; see text}
...
\spelldef{Will negates (object); see text}
\spellsr{Yes (Will)}
\begin{spelleffect}
...
\spellsr{Yes (Will)}
\begin{spelleffect}
   Your successful melee touch attack applies a \minus4 penalty to the target's Intelligence, Wisdom, and Charisma scores. This penalty can't reduce any of these scores below \minus9.
\end{spelleffect}
\begin{spellnotes}
...
\spelldur{See text}
\spelldef{Fortitude negates (object); see text}
\spellsr{Yes (Fortitude)}
\begin{spelleffect}
...
\spellschool{Divination (Awareness)}
\spelllvl{Arcane 6, Divine 6, Knowledge 6, Law 6}
\spellcmp{Verbal, Somatic, and Material}
\spellrng{Touch}
\spelltgt{Touched creature}
\spelldur{\durshort}
...
\spelldur{See text}
\begin{spelleffect}
   The subject's next single attack roll (if it is made before the end of the next round) gains a \plus20 enhancement bonus, and ignores all miss chances. After casting this spell, you cannot cast it again for 5 rounds.
\end{spelleffect}
...
\end{spelleffect}
\begin{spellnotes}
    When you cast this spell, you make a Will attack. This attack is made against any creature that interacts with the effect. If you fail, the creature disbelieves the spell. In order to interact with the illusion with a Perception check, the creature must make a Perception check that beats your Will attack. Anyone witnessing the subject perform an impossible action, such as attacking or climbing without the use of its hands, gains a \plus10 bonus to their Will defense against this attack.
\end{spellnotes}
...
\spelllvl{Arcane 4, Nature 4, Fire 4}
\spellrng{\rngmed}
...
\begin{spelleffect}
  ...
  \par With a successful Reflex attakc, it is possible to trap mobile opponents within or under a wall of stone, provided the wall is shaped so it can hold the creatures.
\end{spelleffect}
...
\begin{spelleffect}
  This spell functions like \spell{windstrike}, except that the bull rush is much more powerful. You make a bull rush attack with an enhancement bonus equal to your caster level \add your casting attribute \add 12, treating the wind as a Gargantuan creature.
...
\end{spellblood}
\begin{spellnotes}
  A vulnerable creature takes a \minus2 penalty to attacks, defenses, and checks. Creatures whose level exceeds your caster level are unaffected by \spell{word of chaos}.
\end{spellnotes}
