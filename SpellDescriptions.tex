...
\begin{spellsection}{Bane}{1}
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Enchantment [Compulsion, Mental]}{Divine, Evil, War}
    \end{spellfooter}
\end{spellsection}

\begin{spellsection}{Bane}[Mass]{5}
    \begin{spellheader}
    %\spelldesc{}
    \end{spellheader}
    \begin{spellcontent}
...
\begin{spellsection}{Charm Monster}{4}
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Enchantment [Delusion, Mental, Subtle]}{Enchantment}
    \end{spellfooter}
\end{spellsection}
...
\begin{spellsection}{Confusion}[Mass]{6}
    \begin{spellheader}
...
%\spelldesc{You fire a coruscating ray from your hand. When it strikes your foe, he becomes weaker.}
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Necromancy [Curse, Flesh]}{Necromancy, Death}
...
\begin{spellsection}{Curse of the Wayward Mind}{8}
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Necromancy [Curse]}{Arcane}
        \spellnotes \cursespellnotes
    \end{spellfooter}
\end{spellsection}
...
\begin{spellsection}{Divine Favor}[Greater]{4}
    \begin{spellheader}
...
\begin{spellsection}{Feather Fall}{1}
    ...
    \begin{spellcontent}
        \begin{spelltargetinginfo}
            \spelltwocol{\spellrng{\rngmed}}{One freefalling object or willing creature (Medium or smaller)}
...
\begin{spellsection}{Foresight}{3}
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Divination}{Divination, Knowledge, Protection}
    \end{spellfooter}
\end{spellsection}
...
\begin{spellsection}{Horrid Wilting}{9}
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Necromancy [Flesh]}{Arcane, Water}
    \end{spellfooter}
\end{spellsection}
...
\begin{spellsection}{Phantasmal Killer}[Greater]{8}
    \begin{spellheader}
    \end{spellheader}
    \begin{spellcontent}
        \begin{spelltargetinginfo}
...
\begin{spellsection}{Reduce Person}[Mass]{4}
    \begin{spellheader}
    \end{spellheader}
    \begin{spellcontent}
        \begin{spelltargetinginfo}
...
\begin{spellsection}{Summon Nature's Army}{8}
    ...
    \begin{spellcontent}
        ...
        \end{spelltargetinginfo}
        \begin{spelleffects}
            \spellspecial This spell functions like \spellindirect{summon nature's ally i}{summon nature's ally I}, except that you can summon up to one creature per caster level from the 4th-level list or lower.
...
\begin{spellsection}{Zephyr Blade}[Greater]{5}
    \begin{spellheader}
