...
\spelldur{\durlong \dismissable}
\spellline
\spelleffect All spells, spell-like abilities, supernatural abilities, and magic items fail to function in the area. They cannot be activated from within the field, and any existing effects brought into or cast into the area are suppressed. Time spent within an \spell{antimagic field} counts against a suppressed spell's duration.
...
\spellrng{Touch}
\spelltgt{One creature}[Primary]
\spellemanation{\areasmall radius from the primary target}
\spelldur{\durshort \dismissable}
\spellsr{Yes (Will)}
...
\begin{spelltargets}*[Secondary]{All creatures in the area}
