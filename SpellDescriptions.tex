...
\spelllvl{Destruction 1, Drd 1, Fire 1, Sor/Wiz 1}
...
\spellschool{Divination (Awareness) [Mind-Affecting]}
\spelllvl{Knowledge 7, Sor/Wiz 7}
\spellsave{None}
\begin{spelleffect}
...
\spellschool{Evocation (Control) [Earth]}
\spelllvl{Destruction 8, Drd 8, Clr 8, Earth 8}
\spellrng{\rngfar}
...
\spelllvl{Drd 2, Sor/Wiz 2, Water 2}
\spellrng{\rngmed}
...
\spellschool{Divination (Knowledge)}
\spelllvl{Knowledge 5, Protection 5, Sor/Wiz 5}
\spellrng{Touch}
\spelltgt{Touched creature}
...
\spellschool{Divination (Knowledge)}
\spelllvl{Knowledge 9, Protection 9, Sor/Wiz 9}
\begin{spelleffect}
...
\spelllvl{Air 3, Sor/Wiz 3, Travel 3}
...
\spellschool{Divination (Awareness) [Detection]}
\spelllvl{Clr 4, Knowledge 4, Sor/Wiz 4}
\spellrng{\rngext}
\begin{spelleffect}
...
\spellschool{Divination (Awareness) [Detection]}
\spelllvl{Clr 3, Knowledge 3, Sor/Wiz 3}
\spellrng{\rngext}
\begin{spelleffect}
...
\spelllvl{Protection 6, Sor/Wiz 6, Travel 6}
...
\spelllvl{Clr 1, Pal 1, Protection 1, Sor/Wiz 1}
\spellrng{Touch}
\spelltgt{Touched creature}
\spelldur{\durshort}
...
\spellschool{Abjuration/Necromancy (Life, Shielding)}
\spelllvl{Clr 2, Death 2, Pal 2, Protection 2, Sor/Wiz 2}
\spellrng{\rngmed}
...
\spellschool{Transmutation (Alteration) [Earth]}
\spelllvl{Drd 4, Earth 4, Protection 4, Sor/Wiz 4}
\spellrng{Touch}
\spelltgt{Touched creature}
\spelldur{\durshort}
\spellsave{Fortitude negates (harmless)}
...
\spellschool{Conjuration (Summoning) [see text for summon monster I]}
\spelllvl{Chaos 3, Clr 3, Evil 3, Good 3, Law 3, Sor/Wiz 3}
\spellarea{\areamed radius limit}
\spelleff{One or more summoned creatures within the area}
\begin{spelleffect}
...
\spellschool{Conjuration (Summoning) [see text for summon monster I]}
\spelllvl{Air 4, Clr 5, Earth 4, Fire 4, Sor/Wiz 5, Water 4}
\spellarea{\areamed radius limit}
\spelleff{One or more summoned creatures within the area}
\begin{spelleffect}
...
\spellschool{Conjuration (Summoning) [see text for summon monster I]}
\spelllvl{Chaos 6, Clr 6, Evil 6, Good 6, Law 6, Sor/Wiz 6}
\spellarea{\areamed radius limit}
\spelleff{One or more summoned creatures within the area}
\begin{spelleffect}
...
\spellschool{Conjuration (Summoning) [see text for summon monster I]}
\spelllvl{Air 7, Clr 8, Earth 7, Fire 7, Sor/Wiz 8, Water 7}
\spellarea{\areamed radius limit}
\spelleff{One or more summoned creatures within the area}
\begin{spelleffect}
...
\spellschool{Conjuration (Summoning) [see text for summon monster I]}
\spelllvl{Chaos 9, Clr 9, Evil 9, Good 9, Law 9, Sor/Wiz 9}
\spellarea{\areamed radius limit}
\spelleff{One or more summoned creatures within the area}
\begin{spelleffect}
...
\spellschool{Transmutation (Augment)}
\spelllvl{Clr 5, Drd 5, Sor/Wiz 5}
\begin{spelleffect}
...
\spellschool{Transmutation (Augment)}
\spelllvl{Clr 5, Drd 5, Sor/Wiz 5, Strength 5}
\begin{spelleffect}
...
\spellschool{Divination (Awareness)}
\spelllvl{Clr 6, Knowledge 6, Law 6, Sor/Wiz 6}
\spellcmp{Verbal, Somatic, and Material}
\spellrng{Touch}
\spelltgt{Touched creature}
\spelldur{\durshort}
...
\spelllvl{Drd 4, Fire 4, Sor/Wiz 4}
\spellrng{\rngmed}
...
\spellrng{\rngmed}
\spellarea{\areamed radius immobile emanation from a point in space}
\spelldur{\durmed}
\spellsave{Will negates}
\spellsr{Yes (Will)}
\begin{spelleffect}
