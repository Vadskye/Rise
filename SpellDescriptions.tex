...
\begin{spelleffect}
  This spell functions as \spell{lesser cone of cold}, except that affected creatures are fatigued for 5 rounds whether or not they fail their Reflex save.
\end{spelleffect}
...
\spellsr{Yes (Fortitude)}
\begin{spelleffect}
  This spell targets a living creature that has no hit points remaining. If the target fails its saving throw, it dies, and you gain 10 temporary hit points \plus2 per caster level. In addition, if the subject had at least 4 HV, you gain a \plus2 bonus to one attribute per 4 HV the target had. \bonusscalingdescription These effects last for 10 minutes per HV of the subject creature. If the creature had less than 1 HV, the temporary hit points last for 5 rounds.
...
\begin{spelleffect}
  Any creature that hits you with its body or a melee weapon takes damage. Each individual creature can take this damage only once per round. The damage is cold damage if the shield protects you from fire-based attacks, or fire damage if the shield protects you from cold-based attacks. This decision must be made at the time the spell is cast.
...
\end{spelleffect}
\begin{spellnotes}
Creatures wielding weapons with exceptional reach are not subject to this spell's damage if they attack you.
\end{spellnotes}
...
\spelllvl{Brd 5, Ench 6}
\begin{spelleffect}
  This spell functions like \spell{heroism}, except the subject also gains temporary hit points equal to 60 \add 2 per caster level above 12th. In addition, it is immune to fear and harmful morale effects.
\end{spelleffect}
...
\spellsectioncomma{Magic Missile}{Greater}
\spellschool{Evocation (Control) [Force]}
\spelllvl{Sor/Wiz 4}
\spellrng{\rngfar}
\spelldmg{4d10 force damage \add d10 per four levels above 8th}
\begin{spelleffect}
  This spell functions like \spell{magic missile}, except that its range is much longer and you create four missiles, each of which deals 1d10 damage. 
\end{spelleffect}
...
\begin{spelleffect}
  Each target is struck by seven missiles like those created by the \spell{magic missile} spell. Each missile deals 1d10 damage. You can create one additional missile to strike each target per four levels above 14th.
\end{spelleffect}
...
\spellschool{Evocation (Energy) [Electricity]}
\spelllvl{Drd 4, Sor/Wiz 4}
\spellrng{\rngext}
\spellarea{\arealarge vertical line of lightning, 5 ft. wide, and \areamed radius limit}
\spelldur{Instantaneous}
\spellsave{Reflex half}
\spellsr{Yes (Reflex)}
\spelldmg{6d6 electricity damage \add d6 per two caster levels above 6th}
\begin{spelleffect}
