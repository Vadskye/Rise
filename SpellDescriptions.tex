...
\spellschool{Transmutation (Imbuement)}
\spelllvl{Air 1, Sor/Wiz 1, Travel 1}
\spellcmp{V}
\spelltime{1 immediate action}
\spellrng{\rngclose}
\spellarea{\areamed radius limit}
...
\spelllvl{Drd 6, Fire 6, Nature 7}
\spellrng{\rngtouch}
...
\spelllvl{Clr 6, Death 6, Evil 6, Vitality 6}
\spellrng{\rngtouch}
\spelltgt{Creature touched}
\spelldur{Instantaneous}
\spellsave{Will half/Will negates}
\spellsr{Yes (Will)}
\spelldmg{12d8 negative energy \add d8 per two caster levels above 12th}
\begin{spelleffect}
  The touched creature takes damage. In addition, it takes two points of Strength, Dexterity, and Constitution damage. A successful Will save negates the ability damage and halves the negative energy damage.
  
  For every 10 points of damage dealt in excess of the subject's hit points, this spell can instead inflict 1 point of critical damage.
\end{spelleffect}
\begin{spellnotes}
...
\spellschool{Necromancy (Vitalism) [Healing, Positive]}
\spelllvl{Clr 9, Good 9, Vitality 9}
\spellrng{\rngclose}
\spelltgts{One or more creatures in a \areamed radius}
