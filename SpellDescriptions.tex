...
\begin{spellheader}
    ...
    \spelltwocol{\spelltgts{Everything in the area}}{\spellrng{\rngmed}}
    \spellzone{\areamed radius cylinder}
\end{spellheader}
\begin{spelleffects}
...
\begin{spellheader}
    ...
    \spelltgt{The creature in the wall}
\end{spellheader}
\begin{spelleffects}
...
\begin{spellheader}
    ...
    \spelltgt{The bloodied undead creature}
\end{spellheader}
...
\begin{spellheader}
    ...
    \spellsr{No}
    \spelltgt{All creatures in the area}
    \spelltgt{All buildings and structures in the area}
    \spelltgt{All creatures in the area}
\end{spellheader}
\begin{spelleffects}
...
\begin{spellheader}
    ...
    \spelltwocol{\spellzone{\areamed radius}}{\spellrng{\rngmed}}
    \spellsr{No}
    \spelltgt{All creatures in the area within 5 feet of the ground}
\end{spellheader}
\begin{spelleffects}
...
\begin{spellheader}
    ...
    \spelltgt{The creature breaking the rule}
\end{spellheader}
\begin{spelleffects}
...
\end{spelleffects}
\begin{spellfooter}
    \spellinfo{Abjuration (Interdiction)}{Abjuration, Law}
