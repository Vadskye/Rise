...
\begin{spelleffect}
  ...
  \par This spell grants you a \plus4 bonus on any social interaction checks you make involving the subject (such as Bluff, Diplomacy, Intimidate, and Sense Motive).
\end{spelleffect}
...
\spelldur{\durshort}
\begin{spelleffect}
  You gain 5 temporary hit points \add 1 per caster level above 2nd. In addition, you gain a \plus2 enhancement bonus to Fortitude saves. \bonusscalingdescription If you take life damage, you lose all temporary hit points provided by this spell before applying the damage.
\end{spelleffect}
...
\end{spellblood}
\begin{spellnotes}
  A creature with an Intelligence score of \minus8 or lower is not affected. A creature whose type is different from the caster's receives a \plus4 bonus on its saving throw, because humor doesn't ``translate'' well.
\end{spellnotes}
\begin{spellnotes}
  A vulnerable creature takes a \minus2 penalty to attack rolls, saving throws, checks, DCs, and AC.
\end{spellnotes}
...
\begin{spelleffect}
  You gain a \plus10 enhancement bonus to Concentration checks. After you cast a spell, this spell ends.
\end{spelleffect}
...
\spellsr{Yes (Will)}
\spelldmg{4d6 sonic damage \add d6 per two levels above 4th}
\begin{spelleffect}
...
\end{spelleffect}
\begin{spellnotes}
  No special influence is established as a result of the bond. This spell can be made permanent with a \spell{permanency} ritual.
\end{spellnotes}
...
\end{spelleffect}
\begin{spellnotes}
This spell can be made permanent with a \spell{permanency} ritual. If you cast this spell multiple times, you may link each casting of the spell together such that all subjects may telepathically communicate with each other. 
\end{spellnotes}
