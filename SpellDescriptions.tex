...
\spellsr{Yes (Fortitude)}
\begin{spelleffect}
    As part of casting this spell, you can make a Disguise check with a \plus10 enhancement bonus to alter the subject's appearance. You can only alter its physical body, not its clothes or items.
\end{spelleffect}
...
\begin{spellnotes}
  ...
  \par \spellindirect{enlarge person}{Enlarge person} counters and dispels \spell{reduce person}. It can be made permanent with a \spell{permanency} spell.
\end{spellnotes}
...
\begin{spellnotes}
  ...
  \par \spellindirect{reduce person}{Reduce person} counters and dispels \spell{enlarge person}. It can be made permanent with a \spell{permanency} spell.
\end{spellnotes}
