...
\spellarea{\areamed radius burst} & \spelltgts{All enemies in the area} \\
\spelldur{5 rounds}
\spellsr{Yes (Will)}
\end{tabularx}
\spellattack{Magic vs. Will}
...
\spellarea{100 ft. wall, 20 ft. high \shapeable} & \spellrng{\rngmed} \\
\spelldur{\durshort \dismissable}
\spellsr{Yes (Reflex)}
\end{tabularx}
\begin{spelleffect}
    You create a wall of blades made of force energy. It is up to 100 feet long, and 20 feet high. The wall provides active cover (20\% miss chance) against attacks made through it. Attacks that miss in this way harmlessly strike the wall. The wall is considered difficult terrain.
\end{spelleffect}
...
\spellarea{\areamed cone-shaped burst} & \spelltgts{Everything in the area} \\
\spellsr{Yes (Reflex)}
\end{tabularx}
\spellattack{Magic vs. Reflex}
\begin{spellsuccess}
...
\spellarea{\arealarge vertical line, 5 ft. wide} & \spellrng{\rngmed} \\
...
\end{spellsuccess}
\begin{spellfailure}
    Half damage, and the target is not staggered.
\end{spellfailure}
\begin{spellnotes}
    This spell functions indoors or underground, but not underwater. \destructivespellnotes
\end{spellnotes}
...
\spellsr{Yes (Will)}
\end{tabularx}
\spellattacktargets{Magic vs. Will}{All creatures in the area}
\begin{spellsuccess}
...
\longcol{\spellarea{\areamed radius limit centered on the primary target}} \\
\longcol{\spelltgts{One primary target, plus up to five secondary targets in the area}} \\
\spellsr{Yes (Fortitude)}
\end{tabularx}
\spellattack{Magic vs. Reflex}
\begin{spellsuccess}
...
\spellcmp{Verbal, Somatic, and Focus} & \spelltime{Full-round action} \\
...
\spelltgt{One nonchaotic creature} & \spellrng{\rngmed} \\
...
\spelltabular
\spellschool{Ench (Emotion) [Charm, Mind-Affecting]} & \spelllists{Ench} \\
\spelltgt{One humanoid creature} & \spellrng{\rngmed} \\
\spelldur{\durlong}
\spellsr{Yes (Will)}
\end{tabularx}
\spellattack{Magic vs. Will}
...
\longcol{\spellcmp{Verbal, Somatic, and Focus}} \\
\spellarea{\areamed radius limit} & \spellrng{\rngmed} \\
\longcol{\spelltgts{Several bloodied living creatures in the area}} \\
\spellsr{Yes (Fortitude)}
\end{tabularx}
\begin{spelleffect}
...
\longcol{\spelltgts{All creatures in the area}} \\
\spelldur{1d4 rounds}
\spellsr{Yes (Will)}
\end{tabularx}
\spellattack{Magic vs. Will}
...
\spellarea{Water in one 5 ft. cube/caster level} & \spellrng{\rngfar} \\
\spelldur{\durmed \dismissable}
\end{tabularx}
\begin{spelleffect}
...
\spelltime{Full-round action} & \spellrng{\rngmed} \\
\spelldur{\durmed}
\end{tabularx}
\begin{spelleffect}
...
\spellarea{\arealarge radius spread} & \spellrng{\rngfar} \\
\spelldur{1 round}
\end{tabularx}
\spellattack{Magic vs. Reflex}
\begin{spelleffect}
...
\spellarea{\arealarge radius limit} & \spellrng{\rngmed} \\
\spelldur{\durlong \dismissable}
\end{tabularx}
\begin{spelleffect}
...
\longcol{\spellrng{Personal and \rngclose; see text}} \\
...
\spelltime{1 swift action}
\spellarea{\areamed radius limit} & \spellrng{\rngmed} \\
\longcol{\spelltgts{Five Medium or smaller freefalling objects or willing creatures in the area}} \\
...
\spelltabular
\spellschool{Evoc (Control, Energy) [Light]} & \spelllists{Arcane, Chaos} \\
\spellarea{\arealarge wall, 20 ft. high} & \spellrng{\rngclose} \\
\spelldur{\durshort \dismissable}
\spellsr{See text}
\end{tabularx}
\spellattack{See text}
...
\spellarea{\arealarge radius emanation} & \spellrng{\rngclose} \\
...
\spelltgts{One or more objects or creatures} & \spellrng{\rngclose} \\
\spellsr{Yes (Reflex)}
...
\spelltgtorarea{See text} & \spellrng{See text} \\
\spelldur{See text}
...
\spelltime{Full-round action} & \spellrng{\rngclose} \\
\spelldur{\durshort \dismissable}
\end{tabularx}
\begin{spelleffect}
...
\spellarea{100 ft. wall, 10 ft. high} & \spellrng{\rngmed} \\
\spelldur{\durshort \dismissable}
\end{tabularx}
\begin{spelleffect}
...
\spellarea{\arealarge wall, 5 ft. high \shapeable} & \spellrng{\rngmed} \\
\end{tabularx}
\spellattack{See text}
\begin{spelleffect}
...
\spellarea{100 ft. wall, 10 ft. high \shapeable} & \spellrng{\rngmed} \\
\spelldur{\durlong \dismissable}
\end{tabularx}
\begin{spelleffect}
