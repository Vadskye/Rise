    ...
    \begin{spellcontent}
        ...
        \begin{spelleffects}
            \begin{spellattack}{Magic vs. Reflex}
                \spellsuccess 1d6 acid damage per caster level immediately, and again at the end of the next round.
            \end{spellattack}
        \end{spelleffects}
    \end{spellcontent}
    \begin{spellfooter}
...
\begin{spellsection}{Agony}{2}
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Enchantment [Delusion, Mental]}{Arcane}
    \end{spellfooter}
\end{spellsection}
...
\begin{spellsection}{Aid}{3}
    ...
    \begin{spellcontent}
        ...
        \end{spelltargetinginfo}
        \begin{spelleffects}
            \spelleffect The target gains temporary hit points equal to your caster level. In addition, it is immune to fear effects.
            \spelldur \durpersonallong
        \end{spelleffects}
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Enchantment [Mental, Morale]}{Divine}
...
\begin{spellsection}{Assimilate}{9}
    ...
    \begin{spellcontent}
        ...
        \begin{spelleffects}
            \begin{spellattack}{Magic vs. Fortitude}
                \spellsuccess 1d10 life damage per two caster levels. If the target has no hit points remaining, it immediately dies, and you are transformed to mimic its appearance for 12 hours. This grants you a \plus10 bonus on Disguise checks made to appear as that creature.
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Necromancy/Transmutation [Alteration]}{Arcane, Evil}
    \end{spellfooter}
\end{spellsection}
...
\begin{spellsection}{Aversion}{3}
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Enchantment [Mental]}{Enchantment}
    \end{spellfooter}
\end{spellsection}
...
\begin{spellsection}{Bane}{1}
    ...
    \begin{spellcontent}
        ...
        \end{spelltargetinginfo}
        \begin{spelleffects}
            \spelleffect The next time the target takes damage, it takes an additional 1d10 divine damage per two caster levels.

            \spelldur \durshort or until discharged \dismissable
        \end{spelleffects}
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Enchantment [Mental]}{Divine, Evil, War}
    \end{spellfooter}
\end{spellsection}
...
\begin{spellsection}{Bane}[Mass]{4}
    ...
    \begin{spellcontent}
        ...
        \end{spelltargetinginfo}
        \begin{spelleffects}
            \spelleffect The next time the target takes damage, it takes an additional 1d6 divine damage per two caster levels.
            \spelldur \durshort or until discharged \dismissable
        \end{spelleffects}
    \end{spellcontent}
    \begin{spellfooter}
...
\begin{spellsection}{Bless}{1}
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Enchantment [Mental, Morale]}{Divine, Good, War}
    \end{spellfooter}
\end{spellsection}
...
\begin{spellsection}{Calm Emotions}{3}
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Enchantment [Mental]}{Arcane}
...
\begin{spellsection}{Charm Monster}{4}
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Enchantment [Charm, Mental, Subtle]}{Enchantment}
    \end{spellfooter}
\end{spellsection}
...
\begin{spellsection}{Cloak of Chaos}{8}
    ...
    \end{spellsubcontent}
    \begin{spellfooter}
        \spellinfo{Abjuration [Chaotic]}{Chaos, Divine}
    \end{spellfooter}
\end{spellsection}
...
\begin{spellsection}{Command}{1}
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Enchantment [Auditory, Compulsion, Mental, Speech]}*{Arcane, Divine, Law}
...
\begin{spellsection}{Command}[Mass]{5}
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Enchantment [Auditory, Compulsion, Mental, Speech]}{Divine, Law}
    \end{spellfooter}
\end{spellsection}
...
\begin{spellsection}{Confusion}{3}
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Enchantment [Compulsion, Mental]}{Arcane, Chaos, Trickery}
    \end{spellfooter}
\end{spellsection}
...
\begin{spellsection}{Confusion}[Mass]{7}
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Enchantment [Compulsion, Mental]}{Arcane, Trickery}
    \end{spellfooter}
\end{spellsection}
...
\begin{spellsection}{Cure Critical Wounds}{4}
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Necromancy [Positive]}{Divine, Life, Nature}
    \end{spellfooter}
\end{spellsection}
...
\begin{spellsection}{Cure Light Wounds}{1}
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Necromancy [Positive]}{Divine, Nature}
    \end{spellfooter}
\end{spellsection}
...
\begin{spellsection}{Curse of Blood and Bone}{3}
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Necromancy [Curse, Flesh]}{Death, Divine, Evil, Necromancy}
...
%\spelldesc{You fire a coruscating ray from your hand. When it strikes your foe, he becomes weaker.}
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Necromancy [Curse, Flesh]}{Arcane, Death}
...
\begin{spellsection}{Curse of the Wayward Mind}{8}
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Enchantment [Curse, Compulsion, Mental]}{Arcane}
        \spellnotes \cursespellnotes
    \end{spellfooter}
\end{spellsection}
...
\begin{spellsection}{Death Knell}{6}
    ...
    \begin{spellcontent}
        ...
        \begin{spelleffects}
            \begin{spellattack}{Magic vs. Fortitude}
                ...
                If the target dies in this way, you gain temporary hit points equal to your caster level. These temporary hit points last for 1 round per level the target had.
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Necromancy [Death]}{Death, Evil, Necromancy}
...
\begin{spellsection}{Death Ward}{3}
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Abjuration/Necromancy [Positive, Shielding]}*{Death, Divine, Good, Protection}
...
\begin{spellsection}{Death Ward}[Mass]{7}
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Abjuration/Necromancy [Positive, Shielding]}*{Death, Divine}
    \end{spellfooter}
\end{spellsection}
...
\begin{spellsection}{Deep Slumber}{9}
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Enchantment [Compulsion, Mental]}{Arcane}
...
\begin{spellsection}{Destruction}{7}
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Necromancy [Death, Flesh]}{Destruction, Divine}
    \end{spellfooter}
\end{spellsection}
...
\begin{spellsection}{Discordant Song}{8}
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Enchantment [Auditory, Compulsion, Mental]}{Arcane}
    \end{spellfooter}
\end{spellsection}
...
\begin{spellsection}{Dominate Monster}{7}
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Enchantment [Compulsion, Mental]}{Enchantment}
    \end{spellfooter}
\end{spellsection}
...
\begin{spellsection}{Dominate Person}{5}
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Enchantment [Compulsion, Mental, Subtle]}{Enchantment}
...
\begin{spellsection}{Earth's Pull}{1}
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Evocation [Earth]}{Earth, Nature}
    ...
    \begin{spellcontent}
        ...
        \begin{spelleffects}
            \begin{spellattack}{Caster level \add casting attribute vs. Armor defense}
                \spellsuccess 1d6 piercing damage per caster level.
            \end{spellattack}
        \end{spelleffects}
    \end{spellcontent}
    \begin{spellfooter}
...
\begin{spellsection}{Earthspike}[Mass]{4}
    ...
    \begin{spellcontent}
        ...
        \begin{spelleffects}
            \begin{spellattack}{Caster level \add casting attribute vs. Armor defense}
                \spellsuccess 1d6 piercing damage per two caster levels.
            \end{spellattack}
        \end{spelleffects}
    \end{spellcontent}
    \begin{spellfooter}
...
\begin{spellsection}{Enervation}{4}
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Necromancy [Negative]}{Arcane, Death, Divine, Evil}
...
\begin{spellsection}{Enlarge Monster}{4}
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Transmutation [Alteration, Sizing]}{Nature, Wild}
...
\begin{spellsection}{Fear}{2}
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Enchantment [Fear, Mental]}{Arcane}
    \end{spellfooter}
\end{spellsection}
...
\begin{spellsection}{Feather Fall}{1}
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Evocation [Air]}{Air, Evocation, Travel}
...
\begin{spellsection}{Finger of Death}{7}
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Necromancy [Death]}{Arcane, Death}
    \end{spellfooter}
\end{spellsection}
...
\begin{spellsection}{Foresight}{3}
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Divination}{Arcane, Knowledge, Protection}
    \end{spellfooter}
\end{spellsection}
...
\begin{spellsection}{Harm}{6}
    ...
    \begin{spellcontent}
        ...
        \begin{spelleffects}
            \begin{spellattack}{Magic vs. Fortitude}
                \spelleffect If the target is undead, it is healed for 1d10 damage per two caster levels.
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Necromancy [Negative]}{Arcane, Death, Divine, Evil, Vitality}
    \end{spellfooter}
\end{spellsection}
...
\begin{spellsection}{Heal}{6}
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Necromancy [Positive]}{Divine, Good, Nature, Vitality}
    \end{spellfooter}
\end{spellsection}
    ...
    \begin{spellcontent}
        ...
        \begin{spelleffects}
            \begin{spellattack}{Magic vs. Will}
                ...
                \spellsuccess The target and everything touching it takes 1d6 fire damage per two caster levels immediately, and again at the end of the next round.
...
\begin{spellsection}{Heroism}{4}
    ...
    \begin{spellcontent}
        ...
        \end{spelltargetinginfo}
        \begin{spelleffects}
            \spelleffect The target becomes immune to fear and gains temporary hit points equal to your caster level. In addition, it gains a legend point for attacks.
            \spelldur \durshort \dismissable
        \end{spelleffects}
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Enchantment [Mental, Morale]}{Arcane}
    \end{spellfooter}
\end{spellsection}
...
\begin{spellsection}{Heroism}[Greater]{8}
    ...
    \begin{spellcontent}
        ...
        \end{spelltargetinginfo}
        \begin{spelleffects}
            \spellspecial This spell functions as \spell{heroism}, except that it affects multiple targets, and each target gains temporary hit points equal to your caster level.
        \end{spelleffects}
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Enchantment [Mental, Morale]}{Arcane}
...
\begin{spellsection}{Hold Monster}{4}
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Enchantment [Compulsion, Mental]}{Arcane, Law}
    \end{spellfooter}
\end{spellsection}
...
\begin{spellsection}{Hold Person}{2}
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Enchantment [Compulsion, Mental]}{Arcane, Divine, Law, War}
    \end{spellfooter}
\end{spellsection}
...
\begin{spellsection}{Hold Person}[Mass]{6}
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Enchantment [Compulsion, Mental]}{Arcane, Divine}
    \end{spellfooter}
\end{spellsection}
...
\begin{spellsection}{Holy Aura}{8}
    ...
    \end{spellsubcontent}
    \begin{spellfooter}
        \spellinfo{Abjuration [Good, Shielding]}{Divine, Good}
    \end{spellfooter}
\end{spellsection}
...
\begin{spellsection}{Hypnotic Pattern}{2}
    ...
    \end{spellsubcontent}
    \begin{spellfooter}
        \spellinfo{Enchantment/Illusion [Compulsion, Figment, Light, Mental, Visual]}*{Arcane}
    \end{spellfooter}
\end{spellsection}
...
\begin{spellsection}{Inflict Critical Wounds}{4}
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Necromancy [Negative]}{Arcane, Divine}
    \end{spellfooter}
\end{spellsection}
...
\begin{spellsection}{Irresistible Dance}{9}
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Enchantment [Compulsion, Mental]}{Arcane, Chaos}
    \end{spellfooter}
\end{spellsection}
...
\begin{spellsection}{Lifeseeking Missile}{3}
    ...
    \begin{spellcontent}
        ...
        \end{spelltargetinginfo}
        \begin{spelleffects}
            \spellspecial You create one missile per two caster levels. Each missile can deal d10 force damage to a single creature.
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Evocation/Necromancy [Force, Life]}{Arcane}
    \end{spellfooter}
\end{spellsection}
...
\begin{spellsection}{Meteor Swarm}{9}
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Evocation [Destructive, Fire]}{Destruction, Fire}
...
\begin{spellsection}{Mirror Image}{2}
    ...
    \begin{spellcontent}
        ...
        \end{spelltargetinginfo}
        \begin{spelleffects}
            \spelleffect You gain one image per two caster levels. As long as you have images remaining, targeted attacks against you have a 50\% miss chance. If you run out of images, the spell is expended.
...
\begin{spellsection}{Phantasmal Killer}{4}
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Enchantment/Illusion [Death, Fear, Mental]}*{Arcane, Trickery}
    \end{spellfooter}
\end{spellsection}
...
\begin{spellsection}{Power Word Daze}{2}
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Enchantment [Compulsion, Mental]}{Arcane, Death}
    \end{spellfooter}
\end{spellsection}
...
\begin{spellsection}{Read Mind}{3}
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Divination [Mental]}{Arcane, Knowledge}
    \end{spellfooter}
\end{spellsection}
...
\begin{spellsection}{Regeneration}[Lesser]{1}
    ...
    \begin{spellcontent}
        ...
        \end{spelltargetinginfo}
        \begin{spelleffects}
            \spelleffect At the end of every round, the target regains one hit point per caster level.
            \spelldur 5 rounds.
        \end{spelleffects}
    \end{spellcontent}
    \begin{spellfooter}
...
\begin{spellsection}{Regeneration}{7}
    ...
    \begin{spellcontent}
        ...
        \end{spelltargetinginfo}
        \begin{spelleffects}
            \spelleffect At the end of every round, the target regains one hit point per caster level. In addition, the target is immune to being sickened, nauseated, staggered, or poisoned.
...
\begin{spellsection}{Revivify}{5}
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Necromancy [Life]}{Divine}
...
\begin{spellsection}{Sanctuary}{1}
    ...
    \end{spellsubcontent}
    \begin{spellfooter}
        \spellinfo{Abjuration/Enchantment [Compulsion, Mental, Shielding]}{Arcane, Divine, Protection}
...
\begin{spellsection}{Searing Light}{3}
    ...
    \begin{spellcontent}
        ...
        \begin{spelleffects}
            \begin{spellattack}{Magic vs. Reflex}
                \spellsuccess \spelldmg{3}{divine}.
                \spellfailure As above, but half damage.
...
\begin{spellsection}{Shield of Law}{8}
    ...
    \end{spellsubcontent}
    \begin{spellfooter}
        \spellinfo{Abjuration [Lawful, Shielding]}{Divine, Law}
    \end{spellfooter}
\end{spellsection}
...
\begin{spellsection}{Sleep}{1}
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Enchantment [Delusion, Mental, Sleep]}{Arcane}
    \end{spellfooter}
\end{spellsection}
...
\begin{spellsection}{Sound Burst}{2}
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Evocation [Destructive, Sonic]}{Arcane}
    \end{spellfooter}
\end{spellsection}
...
\begin{spellsection}{Spelltheft}[Greater]{8}
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Abjuration [Antimagic]}{Abjuration}
    \end{spellfooter}
\end{spellsection}
...
\begin{spellsection}{Spell Turning}{7}
    ...
    \begin{spellcontent}
        ...
        \begin{spelleffects}
            ...
            After you reflect one spell per five caster levels, the spell ends.
...
\begin{spellsection}{Stoneskin}{4}
    ...
    \begin{spellcontent}
        ...
        \end{spelltargetinginfo}
        \begin{spelleffects}
            \spelleffect The target gains damage reduction against physical damage equal to half your caster level. Adamantine weapons ignore this damage reduction and negate it for 1 round.
            \spelldur \durpersonallong
        \end{spelleffects}
    \end{spellcontent}
    \begin{spellfooter}
...
\begin{spellsection}{Stormlord}{7}
    ...
    \end{spellsubcontent}
    \begin{spellfooter}
        \spellinfo{Abjuration/Evocation [Shielding]}{Air, Nature}
    \end{spellfooter}
\end{spellsection}
...
\begin{spellsection}{Suggestion}{6}
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Enchantment [Auditory, Delusion, Mental, Speech, Subtle]}{Enchantment}
...
\begin{spellsection}{Unholy Aura}{8}
    ...
    \end{spellsubcontent}
    \begin{spellfooter}
        \spellinfo{Abjuration [Evil, Shielding]}{Divine, Evil}
    \end{spellfooter}
\end{spellsection}
...
\begin{spellsection}{Unliving Eyes}{5}
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Necromancy/Transmutation [Augment, Life]}{Arcane}
    \end{spellfooter}
\end{spellsection}
...
\begin{spellsection}{Unliving Heart}{2}
    ...
    \begin{spellcontent}
        ...
        \end{spelltargetinginfo}
        \begin{spelleffects}
            \spelleffect You gain temporary hit points equal to your caster level. If you take life damage, you lose all temporary hit points provided by this spell before applying the damage.
...
\begin{spellsection}{Wail of the Banshee}{9}
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Necromancy [Auditory, Death]}{Death, Necromancy}
    \end{spellfooter}
\end{spellsection}
...
\begin{spellsection}{Water Walk}{3}
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Transmutation [Augment, Water]}{Druid, Water}
    \end{spellfooter}
\end{spellsection}
...
\begin{spellsection}{Weird}{9}
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Enchantment/Illusion [Death, Fear, Mental, Unreal]}{Arcane, Trickery}
    \end{spellfooter}
\end{spellsection}
...
\begin{spellsection}{Windstrike, Greater}{5}
    ...
    \begin{spellcontent}
        ...
        \begin{spelleffects}
            \begin{spellattack}{Magic vs. Fortitude}
                \begin{spellmargin}
                    \spellsuccess \spelldmg{5}{bludgeoning}.
                    \spellfailure Half damage.
                \end{spellmargin}
...
\begin{spellsection}{Word of Recall}{6}
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Conjuration [Teleportation]}{Divine}
    \end{spellfooter}
\end{spellsection}
