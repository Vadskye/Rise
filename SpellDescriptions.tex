...
\spelldur{1 hour or until discharged}
\spellsr{Yes (Reflex)}
\spellline
\spelleffect You can imbue up to four acorns, holly berries, or other seeds with fiery energy capable of dealing up to 6d6 damage \add d6 per four caster levels above 12th. You may freely decide the distribution of damage between the target berries.
...
\spellburst{\areamed radius centered on a detonating seed}
\begin{spelltarget}*{Everything in the area}[Magic vs. Reflex]
