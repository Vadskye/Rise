...
\begin{spelleffect}
    If the target's level does not exceed your caster level, it is \sickened for 5 rounds.
...
\spelldur{Instantaneous/5 rounds}
\begin{spelleffect}
    If the target's level does not exceed your caster level, it is \deafened for 5 rounds.
...
\spelltgts{All nonlawful creatures in the area}
\begin{spelleffect}
    If the target's level does not exceed your caster level, it is \vulnerable for 5 rounds.
