...
\begin{spelleffect}
    Each target is struck by seven missiles like those created by the \spell{magic missile} spell. Each missile deals 1d4 damage. Each target is struck by one additional missile per four levels above 14th.
\end{spelleffect}
