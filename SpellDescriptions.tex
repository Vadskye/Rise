...
\spellsr{No}
\begin{spelltarget}{One creature or object}[Magic vs. Reflex]
    \spelleffect The target takes a \minus3 magic penalty to Armor defense for 5 rounds. This penalty increases by 1 at 14th caster level, and every 6 caster levels thereafter.
    \spellsuccess[Reflex] 5d6 acid damage immediately, and 5d6 acid damage at the end of the next round.
    \spellfailure[Reflex] 5d6 acid damage.
\end{spelltarget}
...
\spellrng{\rngclose}
\spelldur{\durshort or \durlong; see text \dismissable}
\spellspecial When you cast this spell, you choose whether to create body armor or a shield. In addition, if you are the target, this spell lasts for \durlong duration. On any other creature, it lasts for \durshort duration.
\begin{spelltarget}{One creature}
