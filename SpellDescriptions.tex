...
\spellschool{Necromancy (Flesh)}
\spelllvl{Clr 3, Pal 3, Sor/Wiz 2}
\spellrng{Touch}
\spelltgt{Creature touched}
\spelldur{\durlong (D)}
...
\end{spelleffect}
\begin{spellnotes}
  Fire spells do not function underwater. A \spell{flame weapon} can ignite combustible materials such as parchment, straw, dry sticks, and cloth.
\end{spellnotes}
