...
\begin{spellblood}
    You make a Reflex attack to deal damage to each creature struck by the bolt. A successful attack also staggers the creature for 1 round, while a failed attack deals half damage.
\end{spellblood}
\begin{spelleffect}
...
\begin{spelleffect}
    Everything in the area takes damage. Creatures damaged by the spell are fatigued for 5 rounds.
\end{spelleffect}
...
\spelltgt{One creature}
\spelldur{Instantaneous}
\spelldef{Fortitude half (harmless) or Fortitude half; see text}
\spellsr{Yes (Fortitude)}
