...
\spellattack{Magic vs. Reflex}
\begin{spelleffect}
  This spell functions as \spell{acid arrow}, except that your attack is also made against the target's Fortitude.
\end{spelleffect}
...
\spellattack{Magic vs. Fortitude}
\begin{spelleffect}
    This spell functions like \spell{solid fog}, except that the fog is highly acidic. At the end of each round, you attack everything in the area.
\end{spelleffect}
\spellattack{Magic vs. Fortitude}
\begin{spellsuccess}
...
\spellattack{Magic vs. Fortitude}
\begin{spellsuccess}
    The target takes damage. If the target has no hit points remaining after taking damage from this spell, it is entirely assimilated into your form, leaving behind only a trace of fine dust. An assimilated creature's equipment is unaffected.
...
\spellattack{Special vs. AD, Magic vs. Fortitude}
\begin{spelleffect}
