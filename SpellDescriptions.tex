...
\spellsr{Yes (Will)}
\begin{spelleffect}
  The subject gains a \plus2 bonus to attack rolls and temporary hit points equal to 10 \add twice your caster level. \bonusscalingdescription
\end{spelleffect}
...
\spellsr{Yes (Reflex)}
\spelldmg{7d6 cold damage \add d6 per four levels above 14th}
\begin{spelleffect}
...
\spelllvl{Brd 5, Ench 6}
\begin{spelleffect}
  This spell functions like \spell{heroism}, except the subject also gains temporary hit points equal to 30 \add twice your caster level. In addition, it is immune to fear and harmful morale effects.
\end{spelleffect}
...
\spellsr{Yes (Will)}
\begin{spelleffect}
  You imbue the subject with magic, granting its armor and shield (if any) a \plus2 enhancement bonus, giving its bearer a \plus2 bonus to AC. \bonusscalingdescription
\end{spelleffect}
\begin{spellnotes}
...
\spellsr{Yes (Will)}
\begin{spelleffect}
  The subject gains a \plus2 shield modifier to AC. \bonusscalingdescription The subject is not encumbered or hindered in any way by the shield. The bonus provided by the shield applies against incorporeal touch attacks, since it is a force effect.
\end{spelleffect}
\begin{spellnotes}
