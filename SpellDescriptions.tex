...
\begin{spellheader}
    ...
    \spelltwocol{\spelltgt{Five animals in the area}}{\spellrng{\rngmed}}
...
\begin{spellheader}
    ...
    \spellinfo{Necro/Trans (Life, Polymorph)}{Arcane, Evil}
\end{spellheader}
\begin{spelleffects}
    \spellrng{\rngclose}
...
\begin{spellheader}
    ...
    \spellinfo{Conjuration/Trans (Animation, Creation)}{Arcane}
...
\begin{spellheader}
    ...
    \spellinfo{Abjuration/Necro (Shielding, Vitalism) [Positive]}{Death, Divine, Good, Protection}
    \spellrng{\rngclose}
    \spelldur{\durshort}
\end{spellheader}
\begin{spelleffects}
...
\begin{spellheader}
    ...
    \spellinfo{Abjuration/Necro (Shielding, Vitalism) [Positive]}{Death, Divine}
    \spelltwocol{\spelllimit{\areamed radius}}{\spellrng{\rngmed}}
    \spelldur{\durshort}
\end{spellheader}
\begin{spelleffects}
...
\begin{spellheader}
    ...
    \spellinfo{Abjuration/Trans (Shielding, Temporal)}{\spelllists{Arcane}}
    \spelldur{\durmed}
\end{spellheader}
\begin{spelleffects}
    \begin{spelltarget}{You}
...
\begin{spellheader}
    ...
    \spellinfo{Conjuration/Trans (Time, Translocation) [Teleportation]}{Arcane, Earth, Law}
    \spellrng{\rngclose}
    \spelldur{See text}
\end{spellheader}
\begin{spelleffects}
...
\begin{spellheader}
    \spellinfo{Abjuration/Necro (Life, Shielding)}{Arcane}
    \spellrng{\rngclose}
    \spelldur{\durshort}
\end{spellheader}
\begin{spelleffects}
...
\begin{spellheader}
    \spellinfo{Abjuration/Necro (Life, Shielding)}{Arcane, Divine, Protection}
    \spellrng{\rngmed}
...
\begin{spellheader}
    \spellinfo{Abjuration/Necro (Life, Shielding)}{Arcane, Divine, Evil}
    \spellrng{\rngmed}
...
\begin{spellheader}
    \spellinfo{Conjuration/Trans (Alteration, Creation) [Earth, Wall]}{Arcane, Earth, Nature}
