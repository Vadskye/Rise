...
\begin{spellsection}{Ablate Impact}{2}
    ...
    \begin{spellcontent}
        ...
        \begin{spelleffects}
            \spelleffect You gain damage reduction against physical damage equal to twice your caster level. Force damage ignores this damage reduction and negates it for 1 round.
...
\begin{spellsection}{Ablative Shield}{1}
    ...
    \begin{spellcontent}
        ...
        \end{spelltargetinginfo}
        \begin{spelleffects}
            \spelleffect You gain damage reduction against spells equal to twice your caster level. Force damage ignores this damage reduction and negates it for 1 round.
            \spelldur Until end of round
        \end{spelleffects}
    \end{spellcontent}
    \begin{spellfooter}
...
\begin{spellsection}{Acid Arrow}[Greater]{5}
    \begin{spellheader}
        \spelldesc{You fire a magical arrow of acid from your hand that speeds to its target.}
    \end{spellheader}
    \begin{spellcontent}
...
\begin{spellsection}{Aid}{3}
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Ench (Emotion) [Mental, Morale]}{Divine}
...
\begin{spellsection}{Assimilate}{9}
    ...
    \begin{spellcontent}
        ...
        \begin{spelleffects}
            \begin{spellattack}{Magic vs. Fortitude}
                \spellsuccess 9d10 life damage \add d10 per four caster levels above 18th. If the target has no hit points remaining, it immediately dies, and you are transformed to mimic its appearance for 12 hours. This grants you a \plus10 bonus on Disguise checks made to appear as that creature.
...
\begin{spellsection}{Aversion}{3}
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Ench (Emotion) [Mental]}{Ench}
    \end{spellfooter}
\end{spellsection}
...
\begin{spellsection}{Bane}{1}
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Ench (Emotion) [Mental]}{Divine, Evil, War}
    \end{spellfooter}
\end{spellsection}
...
\begin{spellsection}{Barkskin}{2}
    ...
    \begin{spellcontent}
        ...
        \end{spelltargetinginfo}
        \begin{spelleffects}
            \spelleffect The target gains damage reduction against physical damage equal to half your caster level. Slashing weapons and fire damage ignore this damage reduction and negate it for 1 round.
            \spelldur \durshort
        \end{spelleffects}
    \end{spellcontent}
    \begin{spellfooter}
...
\begin{spellsection}{Black Tentacles}{7}
    \begin{spellheader}
...
\begin{spellsection}{Bless}{1}
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Ench (Emotion) [Mental, Morale]}{Divine, Good, War}
    \end{spellfooter}
\end{spellsection}

\begin{spellsection}{Bless}[Mass]{4}
    \begin{spellheader}
...
\begin{spellsection}{Calm Emotions}{3}
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Ench (Emotion) [Mental]}{Arcane}
...
\begin{spellsection}{Charm Monster}{4}
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Ench (Emotion) [Charm, Mental, Subtle]}{Ench}
    \end{spellfooter}
\end{spellsection}
...
\begin{spellsection}{Color Spray}{1}
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Illus (Figment) [Light, Visual]}{Arcane}
...
\begin{spellsection}{Command}{1}
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Ench (Compulsion) [Auditory, Mental, Speech]}*{Arcane, Divine, Law}
...
\begin{spellsection}{Command}[Mass]{5}
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Ench (Compulsion) [Auditory, Mental, Speech]}{Divine, Law}
    \end{spellfooter}
\end{spellsection}
...
\begin{spellsection}{Confusion}{3}
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Ench (Compulsion) [Mental]}{Arcane, Chaos, Trickery}
    \end{spellfooter}
\end{spellsection}

\begin{spellsection}{Confusion}[Mass]{7}
    \begin{spellheader}
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Ench (Compulsion) [Mental]}{Arcane, Trickery}
    \end{spellfooter}
\end{spellsection}
...
\begin{spellsection}{Curse of the Wayward Mind}{8}
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Ench (Compulsion) [Mental]}{Arcane}
        \spellnotes \cursespellnotes
    \end{spellfooter}
\end{spellsection}
...
\begin{spellsection}{Detect Alignment}{3}
    \begin{spellheader}
...
\begin{spellsection}{Discordant Song}{8}
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Ench (Compulsion) [Auditory, Mental]}{Arcane}
    \end{spellfooter}
\end{spellsection}
...
\begin{spellsection}{Disjoin Magic}{9}
    ...
    \begin{spellsubcontent}
        ...
        \end{spelltargetinginfo}
        \begin{spelleffects}
            \begin{spellattack}{Caster level vs. 10 \add the caster level of the target object}
                ...
                \spellspecial If the item is an artifact, there is only a 1\% chance per caster level that the spell works. If you destroy an artifact in this way, you permanently lose the ability to cast this spell.
            \end{spellattack}
        \end{spelleffects}
    \end{spellsubcontent}
    \begin{spellfooter}
...
\begin{spellsection}{Dispel Magic}[Greater]{6}
    \begin{spellheader}
    \end{spellheader}
    \begin{spellcontent}
        \begin{spelltargetinginfo}
...
\begin{spellsection}{Dominate Monster}{7}
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Ench (Compulsion) [Domination, Mental]}{Ench}
    \end{spellfooter}
\end{spellsection}
...
\begin{spellsection}{Dominate Person}{5}
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Ench (Compulsion) [Mental, Subtle]}{Ench}
...
\begin{spellsection}{Earthspike}[Mass]{4}
    \begin{spellheader}
    \end{spellheader}
    \begin{spellcontent}
        \begin{spelltargetinginfo}
...
\begin{spellsection}{Energy Conversion}{8}
    ...
    \begin{spellcontent}
        \begin{spelleffects}
            \spelleffect You gain damage reduction against all energy types (acid, cold, electricity, fire) equal to twice your caster level.
...
\begin{spellsection}{Enervation}{4}
    ...
    \begin{spellcontent}
        ...
        \begin{spelleffects}
            ...
            If the target is undead, it gains damage reduction against physical damage equal to your caster level. Positive damage ignores this damage reduction and negates it for 1 round.
        \end{spelleffects}
    \end{spellcontent}
    \begin{spellfooter}
...
\begin{spellsection}{Enervation}[Greater]{8}
    \begin{spellheader}
        \spelldesc{Your foe's body loses its color momentarily as you drain its life force away.}
    \end{spellheader}
    \begin{spellcontent}
        ...
        \end{spelltargetinginfo}
        \begin{spelleffects}
            \spelleffect If the target is undead, it gains a legend point for physical attacks and damage reduction against physical damage equal to your caster level. Positive damage ignores this damage reduction and negates it for 1 round.
...
\begin{spellsection}{Enlarge Monster}{4}
    ...
    \begin{spellcontent}
        \begin{spelltargetinginfo}
            \spelltwocol{\spelltgts{One creature (Large or smaller)}}{\spellrng{\rngclose}}
            \spelltime{Full-round action}
        \end{spelltargetinginfo}
        \begin{spelleffects}
            \spellspecial This spell functions as \spell{enlarge person}, except that the target can be a creature of any type.
        \end{spelleffects}
    \end{spellcontent}
    \begin{spellfooter}
...
\begin{spellsection}{Enlarge Monster}[Mass]{7}
    \begin{spellheader}
    \end{spellheader}
    \begin{spellcontent}
        \begin{spelltargetinginfo}
...
\begin{spellsection}{Enlarge Person}[Mass]{6}
    \begin{spellheader}
    \end{spellheader}
    \begin{spellcontent}
        \begin{spelltargetinginfo}
...
\begin{spellsection}{Entangle}[Greater]{4}
    \begin{spellheader}
...
\begin{spellsection}{Fear}{2}
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Ench (Emotion) [Fear, Mental]}{Arcane}
    \end{spellfooter}
\end{spellsection}
...
\begin{spellsection}{Feeblemind}{8}
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Ench (Inhibition) [Mental]}{Arcane}
    \end{spellfooter}
\end{spellsection}
...
\begin{spellsection}{Fire Shield}{4}
    ...
    \begin{spellcontent}
        \begin{spelleffects}
            \spelleffect You gain damage reduction against cold damage equal to twice your caster level. In addition, you radiate light as a torch.
            \spelldur \durshort \dismissable
        \end{spelleffects}
    \end{spellcontent}
    \begin{spellsubcontent}
...
\begin{spellsection}{Fog Shield}{5}
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Abjuration/Conjuration (Creation, Shielding) [Fog]}{Arcane, Divine, Nature, Water}
        \spellsr{No}
        \spellnotes \fogspellnotes \fogwindspellnotes
    \end{spellfooter}
\end{spellsection}
...
\begin{spellsection}{Haste}{4}
    ...
    \begin{spellcontent}
        ...
        \end{spelltargetinginfo}
        \begin{spelleffects}
            \spelleffect The target's speed increases, as \spell{lesser haste}. In addition, it the ability to make an additional attack at a \minus5 penalty when it takes a standard attack action.
            \spelldur \durshort
        \end{spelleffects}
    \end{spellcontent}
    \begin{spellfooter}
...
\begin{spellsection}{Heroism}{4}
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Ench (Emotion) [Mental, Morale]}{Arcane}
    \end{spellfooter}
\end{spellsection}

\begin{spellsection}{Heroism}[Greater]{8}
    \begin{spellheader}
    \end{spellheader}
    \begin{spellcontent}
        \begin{spelltargetinginfo}
...
\begin{spellsection}{Hold Monster}{4}
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Ench (Inhibition) [Mental]}{Arcane, Law}
    \end{spellfooter}
\end{spellsection}
...
\begin{spellsection}{Hold Person}{2}
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Ench (Inhibition) [Mental]}{Arcane, Divine, Law, War}
    \end{spellfooter}
\end{spellsection}

\begin{spellsection}{Hold Person}[Mass]{6}
    \begin{spellheader}
    \end{spellheader}
    \begin{spellcontent}
        \begin{spelltargetinginfo}
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Ench (Inhibition) [Mental]}{Arcane, Divine}
    \end{spellfooter}
\end{spellsection}
...
\begin{spellsection}{Hypnotic Pattern}{2}
    ...
    \end{spellsubcontent}
    \begin{spellfooter}
        \spellinfo{Ench/Illus (Compulsion, Figment) [Light, Mental, Visual]}*{Arcane}
    \end{spellfooter}
\end{spellsection}

\begin{spellsection}{Hypnotic Pattern}[Greater]{6}
    \begin{spellheader}
...
\begin{spellsection}{Inertial Shield}{2}
    ...
    \begin{spellcontent}
        ...
        \end{spelltargetinginfo}
        \begin{spelleffects}
            \spelleffect The target gains damage reduction against physical damage equal to your caster level. Force damage ignores this damage reduction and negates it for 1 round.
            \spelldur \durshort
        \end{spelleffects}
    \end{spellcontent}
    \begin{spellfooter}
...
\begin{spellsection}{Iron Body}{8}
    ...
    \begin{spellcontent}
        ...
        \begin{spelleffects}
            ...
            \par You gain damage reduction against physical damage equal to your caster level. Adamantine weapons ignore this damage reduction and negate it for 1 round.
...
\begin{spellsection}{Irresistible Dance}{9}
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Ench (Compulsion) [Mental]}{Arcane, Chaos}
    \end{spellfooter}
\end{spellsection}
...
\begin{spellsection}{Knock}{2}
    ...
    \begin{spellcontent}
        ...
        \begin{spelleffects}
            ...
            In addition, if the target object is locked, you can immediately make a Disable Device check to open the lock as if you had rolled a 20 on the check. You get a bonus on the Disable Device check equal to half your caster level.
        \end{spelleffects}
    \end{spellcontent}
    \begin{spellfooter}
...
\begin{spellsection}{Longstrider}{1}
    ...
    \begin{spellcontent}
        ...
        \end{spelltargetinginfo}
        \begin{spelleffects}
            \spelleffect You gain a \plus30 foot bonus to your speed in all your movement modes, up to a maximum of double your original speed.
            \spelldur \durlong \dismissable
        \end{spelleffects}
    \end{spellcontent}
    \begin{spellfooter}
...
\begin{spellsection}{Manipulate Probability}[Lesser]{1}
    \begin{spellheader}
    \end{spellheader}
    \begin{spellcontent}
        \begin{spelltargetinginfo}
...
\begin{spellsection}{Meld into Plants}{3}
    ...
    \begin{spellcontent}
        ...
        \end{spelltargetinginfo}
        \begin{spelleffects}
            \spellspecial This spell functions as \spell{meld into stone}, except that you meld into a plant instead of stone.
        \end{spelleffects}
    \end{spellcontent}
    \begin{spellfooter}
...
\begin{spellsection}{Meteor Swarm}{9}
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Evocation (Energy) [Fire]}{Destruction, Fire}
...
\begin{spellsection}{Mirror Image}{2}
    ...
    \begin{spellcontent}
        ...
        \end{spelltargetinginfo}
        \begin{spelleffects}
            \spelleffect You gain two images \add one per four caster levels above 2nd. As long as you have images remaining, targeted attacks against you have a 50\% miss chance. If you run out of images, the spell is expended.
...
\begin{spellsection}{Mirror Image}[Greater]{5}
    \begin{spellheader}
    \end{spellheader}
    \begin{spellcontent}
        \begin{spelltargetinginfo}
...
\begin{spellsection}{Missile Storm}[Greater]{8}
    \begin{spellheader}
    ...
    \begin{spellcontent}
        ...
        \begin{spelleffects}
            \begin{spellattack}{Magic vs. Will and Fortitude}
                ...
                \spellcritical[Will and Fortitude] The target dies.
                \spellfailure The target is \shaken for 5 rounds.
            \end{spellattack}
        \end{spelleffects}
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Ench/Illus (Emotion, Phantasm) [Death, Fear, Mental]}*{Arcane, Trickery}
    \end{spellfooter}
\end{spellsection}
...
\begin{spellsection}{Poison}{4}
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Necromancy (Flesh) [Physical, Poison]}{Death, Divine, Nature}
        \spellnotes \physicalspellnotes
    \end{spellfooter}
\end{spellsection}
...
\begin{spellsection}{Precognition}[Greater]{9}
    \begin{spellheader}
    \end{spellheader}
    \begin{spellcontent}
        \begin{spelltargetinginfo}
...
\begin{spellsection}{Precognition}[Lesser]{1}
    \begin{spellheader}
    \end{spellheader}
    \begin{spellcontent}
        \begin{spelltargetinginfo}
...
\begin{spellsection}{Read Mind}{3}
    \begin{spellheader}
    \end{spellheader}
    \begin{spellcontent}
        \begin{spelltargetinginfo}
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Divination (Awareness) [Mental]}{Arcane, Knowledge}
        \spellsr{No}
    \end{spellfooter}
\end{spellsection}
...
\begin{spellsection}{Read Mind}[Mass]{8}
    \begin{spellheader}
    \end{spellheader}
    \begin{spellcontent}
        \begin{spelltargetinginfo}
        ...
        \begin{spelleffects}
            \begin{spellattack}{Magic vs. Will}
                \spellsuccess You can read the target's surface thoughts, as \spell{read mind}.
            \end{spellattack}
        \end{spelleffects}
    \end{spellcontent}
    \begin{spellfooter}
...
\begin{spellsection}{Reduce Person}[Mass]{5}
    \begin{spellheader}
    \end{spellheader}
    \begin{spellcontent}
        \begin{spelltargetinginfo}
...
\begin{spellsection}{Regeneration}[Lesser]{1}
    ...
    \begin{spellcontent}
        ...
        \end{spelltargetinginfo}
        \begin{spelleffects}
            \spelleffect At the end of every round, the target regains 2 hit points \add 1 per two caster levels above 2nd.
            \spelldur 5 rounds.
        \end{spelleffects}
    \end{spellcontent}
    \begin{spellfooter}
...
\begin{spellsection}{Regeneration}{7}
    ...
    \begin{spellcontent}
        ...
        \end{spelltargetinginfo}
        \begin{spelleffects}
            \spelleffect At the end of every round, the target regains 14 hit points \add 1 per two caster levels above 14th. In addition, the target is immune to being sickened, nauseated, staggered, or poisoned.
...
\begin{spellsection}{Resist Energy}{1}
    ...
    \begin{spellcontent}
        ...
        \begin{spelleffects}
            ...
            \spelleffect The target gains damage reduction against the chosen energy type equal to twice your caster level.
            \spelldur \durpersonallong
        \end{spelleffects}
    \end{spellcontent}
    \begin{spellfooter}
...
\begin{spellsection}{Resist Energy}[Greater]{3}
    \begin{spellheader}
    \end{spellheader}
    \begin{spellcontent}
        \begin{spelltargetinginfo}
        ...
        \end{spelltargetinginfo}
        \begin{spelleffects}
            \spelleffect The target gains damage reduction against all energy types (acid, cold, electricity, fire) equal to twice your caster level.
            \spelldur \durpersonallong
        \end{spelleffects}
    \end{spellcontent}
    \begin{spellfooter}
...
\begin{spellsection}{Retributive Shield}{5}
    ...
    \begin{spellcontent}
        ...
        \end{spelltargetinginfo}
        \begin{spelleffects}
            \spelleffect The target gains damage reduction against physical damage equal to your caster level. Life damage ignores this damage reduction and negates it for 1 round.
...
\begin{spellsection}{Righteous Might}{6}
    \begin{spellheader}
    \end{spellheader}
    \begin{spellcontent}
        \begin{spelltargetinginfo}
        ...
        \end{spelltargetinginfo}
        \begin{spelleffects}
            \spellsuccess You become larger, as \spell{enlarge person}. In addition, you gain damage reduction against physical damage equal to your caster level. Appropriately aligned damage ignores this damage reduction and negates it for 1 round. Evil attacks fldkjsfsdklf damage reduction is overcome by evil attacks if you are good or neutral, and by good attacks if you are evil. If you are hit by an appropriately aligned attack, you cannot use your damage reduction for 1 round.
            \spelldur \durshort \dismissable
        \end{spelleffects}
    \end{spellcontent}
    \begin{spellfooter}
...
\begin{spellsection}{Sanctuary}{1}
    ...
    \end{spellsubcontent}
    \begin{spellfooter}
        \spellinfo{Abjuration/Ench (Compulsion, Shielding) [Mental]}{Arcane, Divine, Protection}
...
\begin{spellsection}{Shield of Faith}{2}
    \begin{spellheader}
    ...
    \begin{spellcontent}
        ...
        \end{spelltargetinginfo}
        \begin{spelleffects}
            \spelleffect The target gains a shield with a \plus2 defense bonus. Unlike a mundane shield, this shield does not require a free hand and has no armor check penalty or arcane spell failure chance.
            \spelldur \durpersonallong
        \end{spelleffects}
    \end{spellcontent}
    \begin{spellfooter}
...
\begin{spellsection}{Shout}[Greater]{6}
    \begin{spellheader}
    \end{spellheader}
    \begin{spellcontent}
        \begin{spelltargetinginfo}
...
\begin{spellsection}{Shrink Item}{3}
    ...
    \begin{spellcontent}
        \begin{spelltargetinginfo}
            ...
            \spellspecial You can target a Large object at 10th caster level, a Huge object at 16th caster level, or a Gargantuan object at 24th caster level.
        \end{spelltargetinginfo}
        \begin{spelleffects}
...
\begin{spellsection}{Silence}{5}
    ...
    \begin{spellcontent}
        ...
        \end{spelltargetinginfo}
        \begin{spelleffects}
            \spellspecial This spell functions as \spell{silence}, except that it affects multiple creatures.
        \end{spelleffects}
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Illus (Glamer)}{Divine, Trickery}
...
\begin{spellsection}{Sleep}{1}
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Ench (Compulsion) [Mental, Sleep]}{Arcane}
    \end{spellfooter}
\end{spellsection}
...
\begin{spellsection}{Sleep}[Mass]{4}
    ...
    \begin{spellcontent}
        ...
        \end{spelltargetinginfo}
        \begin{spelleffects}
            \spellspecial This spell functions as \spell{sleep}, except that it affects multiple targets.
        \end{spelleffects}
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Ench (Compulsion) [Mental, Sleep]}{Arcane}
...
\begin{spellsection}{Slow}[Mass]{6}
    ...
    \begin{spellcontent}
        ...
        \end{spelltargetinginfo}
        \begin{spelleffects}
            \spellspecial This spell functions as \spell{slow}, except that it affects multiple targets.
        \end{spelleffects}
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Transmutation (Temporal)}{Arcane}
...
\begin{spellsection}{Solid Fog}{6}
    ...
    \begin{spellcontent}
        ...
        \end{spelltargetinginfo}
        \begin{spelleffects}
            \spelleffect Fog blocks sight in the area, as \spell{fog cloud}. The fog is so thick that all creatures in the area suffer penalties as if they were fighting underwater. Attacks entering or passing through the area are similarly penalized.

            In addition, all creatures in the area move at a speed of 5 feet, regardless of their normal speed. A creature or object that falls into solid fog is slowed, so that each 10 feet of vapor that it passes through reduces falling damage by 1d6.
            \par A creature in the fog can take a full-round action to make a Strength check. It treats is check result as its speed when when moving in the fog (up to a maximum of its normal movement speed).
            \spelldur \durshort
        \end{spelleffects}
    \end{spellcontent}
    \begin{spellfooter}
...
\begin{spellsection}{Stoneskin}{4}
    ...
    \begin{spellcontent}
        ...
        \end{spelltargetinginfo}
        \begin{spelleffects}
            \spelleffect The target gains physical damage reduction, reducing the damage it takes each round from physical attacks by 8 \add 1 per two caster levels above 8th. If it is hit by an adamantine weapon, it cannot use its damage reduction for 1 round.
            \spelldur \durpersonallong
        \end{spelleffects}
    \end{spellcontent}
    \begin{spellfooter}
...
\begin{spellsection}{Stormlord}{7}
    \begin{spellheader}
    ...
    \begin{spellsubcontent}
        ...
        \begin{spelleffects}
            \begin{spellattack}{Magic vs. Fortitude}
                \spellsuccess \spelldamage{7}{bludgeoning}[d6].
                \spellfailure Half damage.
            \end{spellattack}
        \end{spelleffects}
    \end{spellsubcontent}
...
\begin{spellsection}{Strip the Flesh}{6}
    ...
    \begin{spellcontent}
        ...
        \begin{spelleffects}
            \begin{spellattack}{Magic vs. Fortitude}
                \spellsuccess \spelldamage{7}{slashing}. In addition, all damage the target takes is doubled for 5 rounds. This does not apply to the initial damage dealt by this spell.
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Necromancy (Flesh) [Physical]}{Arcane}
        \spellnotes The doubling of damage can be negated by a Heal check against a DC equal to 10 \add your caster level.
...
\begin{spellsection}{Suggestion}{6}
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Ench (Compulsion) [Auditory, Mental, Speech]}{Ench}
...
\begin{spellsection}{Suggestion}[Mass]{9}
    ...
    \begin{spellcontent}
        ...
        \end{spelltargetinginfo}
        \begin{spelleffects}
            \spellspecial This spell functions as \spell{suggestion}, except that it affects multiple creatures.
        \end{spelleffects}
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Ench (Compulsion) [Auditory, Mental, Speech]}{Ench}
...
\begin{spellsection}{True Strike}{6}
    \begin{spellheader}
    ...
    \begin{spellcontent}
        ...
        \end{spelltargetinginfo}
        \begin{spelleffects}
            \spelleffect The target's next physical attack gains a \plus20 bonus, and ignores all miss chances. 
...
\begin{spellsection}{Unliving Heart}{2}
    \begin{spellheader}
    ...
    \begin{spellcontent}
        ...
        \end{spelltargetinginfo}
        \begin{spelleffects}
            \spelleffect You gain 8 temporary hit points \add 1 per two caster levels above 4th. If you take life damage, you lose all temporary hit points provided by this spell before applying the damage.
...
\begin{spellsection}{Wail of the Banshee}{9}
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Necromancy (Life) [Auditory, Death]}{Death, Necromancy}
    \end{spellfooter}
\end{spellsection}
...
\begin{spellsection}{Wall of Fire}[Greater]{5}
    \begin{spellheader}
    \end{spellheader}
    \begin{spellcontent}
        \begin{spelltargetinginfo}
        ...
        \end{spelltargetinginfo}
        \begin{spelleffects}
            \spellspecial This spell functions as \spell{wall of fire}, except that it is larger and can be shaped. The damage dealt to a creature passing through the wall is \spelldamage{5}{fire}[d6].
            \spelldur \durshort
        \end{spelleffects}
    \end{spellcontent}
    \begin{spellfooter}
...
\begin{spellsection}{Wall of Thorns}[Greater]{6}
    \begin{spellheader}
    \end{spellheader}
    \begin{spellcontent}
        \begin{spelltargetinginfo}
        ...
        \end{spelltargetinginfo}
        \begin{spelleffects}
            \spellspecial This spell functions as \spell{wall of thorns}, except that it is larger and can be shaped. The damage dealt to a creature passing through the wall is \spelldamage{6}{piercing}[d6].
            \spelldur \durshort
        \end{spelleffects}
    \end{spellcontent}
    \begin{spellsubcontent}
...
\begin{spellsection}{Waves of Fatigue}[Greater]{7}
    \begin{spellheader}
    \end{spellheader}
    \begin{spellcontent}
        \begin{spelltargetinginfo}
...
\begin{spellsection}{Waves of Fatigue}[Lesser]{4}
    \begin{spellheader}
    \end{spellheader}
    \begin{spellcontent}
        \begin{spelltargetinginfo}
...
\begin{spellsection}{Weird}{9}
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Enchantment/Illusion (Emotion, Phantasm) [Death, Fear, Mental, Unreal]}{Arcane, Trickery}
    \end{spellfooter}
\end{spellsection}
    ...
    \begin{spellcontent}
        ...
        \begin{spelleffects}
            \begin{spellattack}{Magic vs. Fortitude}
                ...
                \spellfailure Half damage.
            \end{spellattack}
            \begin{spellattack}{Caster level \add casting attribute vs. Maneuver defense (shove)}
...
\begin{spellsection}{Windstrike, Greater}{5}
    \begin{spellheader}
...
\begin{spellsection}{Zephyr Blade}[Greater]{6}
    \begin{spellheader}
