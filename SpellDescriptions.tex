...
\spelldef{Physical vs. Reflex, Magic vs. Reflex; see text}
\spellsr{Yes (Reflex)}
...
\spelllvl{Arcane 4, Fire 4}
\spellrng{\rngpers/\rngclose}
\spelltgt{You/One or more creatures}
\spelldur{\durshort (D)}
\spelldef{Magic vs. Reflex}
...
\spelldur{Instantaneous}
\spelldef{Magic vs. Reflex/Reflex negates}
\spellsr{Yes (Reflex)}
...
\spelldur{\durshort (D)}
\spelldef{Magic vs. Reflex; see text}
\spellsr{No}
