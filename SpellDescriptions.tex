...
\spellsr{Yes (Will)}
\begin{spelleffect}
  The subject gains temporary hit points equal 10 \add 1 per caster level above 4th. In addition, it gains a \plus2 enhancement bonus to Will saves. \bonusscalingdescription  If the subject takes life damage, it loses all temporary hit points provided by this spell before applying the damage.
\end{spelleffect}
...
\begin{spelleffect}
  ...
  \par A \spell{blade barrier} provides cover (\plus4 bonus to AC, \plus2 bonus on Reflex saves) against attacks made through it.
\end{spelleffect}
...
\spellsave{Will negates (harmless), Fortitude negates}
\spellsr{Yes (Will)}
\begin{spelleffect}
