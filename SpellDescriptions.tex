...
\end{tabularx}
\spelltriggeredattack{Magic vs. Fortitude}
\spelltrigger{Creature within \rngclose range of the subject attacks it with a melee weapon. Activating the trigger requires an immediate action from the subject, and discharges the spell.}
\spelltriggertarget{Attacking creature}
\begin{spellsuccess}
