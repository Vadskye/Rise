...
\spelldur{Concentration (up to 5 rounds)}
\spelltarget{Everything in the area}
...
\end{spelltarget}
\begin{spelltrigger}*{The shielded creature is attacked}
    \begin{spelltarget}*{The attacking creature}[Magic vs. Will]
        \spellsuccess The target is unable to attack the shielded creature. It can attack a different creature instead.
    \end{spelltarget}
\end{spelltrigger}
