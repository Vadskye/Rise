...
\spelldur{\durlong}
\begin{spelleffect}
    You gain a \plus3 enhancement bonus to your physical defenses. This bonus increases to \plus4 at 14th level, and to \plus5 at 20th level.
\end{spelleffect}
\begin{spellnotes}
...
\spelldur{\durshort}
\spelldef{None and Will half; see text}
\spellsr{Yes (Will)}
...
\begin{spelleffect}
    ...
    Once the rule is established, any creature within the area who breaks the rule takes damage. You know whenever a creature in the area breaks the rule. If you break the rule, you take damage and the spell ends.
\end{spelleffect}
\begin{spellnotes}
...
\spelllvl{Arcane 5, Chaos 5, Divine 5, Evil 5, Good 5, Law 5, Pal 4}
\spellrng{Touch}
...
\spellschool{Abjuration (Interdiction) [Good]}
\spelllvl{Arcane 1, Chaos 1, Divine 1, Evil 1, Good 1, Law 1, Pal 1}
\spellrng{\rngclose}
\spelltgt{One creature}
\spelldur{\durshort (D)}
\spelldef{Will negates (harmless)}
