...
\begin{figure}[h]
    \centering Constitution or half base Fortitude bonus \add 5 \add other bonuses or penalties
\end{figure}

Your base Fortitude bonus is simply your Fortitude bonus from class levels, and is not affected by spells or other temporary effects which can modify your defenses.
