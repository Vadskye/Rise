...
\begin{itemize}
    ...
    \item Half Intelligence is added to Will defense, which can affect your hit points.
\end{itemize}
...
\begin{itemize}
    \item Willpower can be used for Will defense, which can affect your hit points.
\end{itemize}
...
\begin{dtable*}
    ...
    \begin{dtabularx}{\textwidth}{l >{\lcol}p{10em} X}
        ...
        Hit points            & Immediately & A wizard casts \spell{totemic power} to increase his Constitution. His maximum and current hit points immediately increase for the duration of the spell, then drop to their original values when the spell ends. \\
...
\begin{figure}[h]
    \centering Half Fortitude defense or half Will defense \add other bonuses or penalties
\end{figure}

\parhead{Temporary Modifiers} Temporary effects which alter your Fortitude or Will defenses, including changes to your Constitution or Willpower, do not alter your maximum or current hit points.
