...
\parhead{Block} As a move action, you can remain stationary to block the movement of nearby foes. You are \immobilized for the rest of the round, but all squares you threaten are considered \difficultterrain.
