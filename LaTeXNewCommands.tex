...
\newcommand{\sickened}{\conditionlink{sickened} \reminder{mmove at half speed}\xspace}
...
\newcommand{\stunned}{\conditionlink{stunned} \reminder{unable to take actions}}
...
{
    \pgfmathparse{int(round(#1))}\pgfmathresult
}
