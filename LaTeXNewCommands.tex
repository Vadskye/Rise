...
\newcommand{\bewildered}{bewildered (\vulneffect)}
\newcommand{\confused}{confused (randomly babbles, flees, attacks nearest, or acts normally)}
\newcommand{\dazed}{dazed (unable to act)}
\newcommand{\ignited}{ignited (d6 damage/round, Dex DC 10 to extinguish, \vulneffect)}
\newcommand{\shaken}{shaken (\vulneffect)}
\newcommand{\sickened}{sickened (\vulneffect)}
\newcommand{\slowed}{slowed (unable to act in movement phase, \minus2 to physical attacks, defenses, and checks)}
\newcommand{\staggered}{staggered (unable to act in movement phase, \vulnerrect)}
\newcommand{\vulnerable}{vulnerable (\vulneffect)}
