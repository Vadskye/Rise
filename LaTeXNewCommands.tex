...
\DeclareDocumentCommand{\good}{m}
{
    \plus \imath{(#1*5/4)+4}
}

\DeclareDocumentCommand{\avg}{m}
{
    \plus \imath{(#1*1/1)+3}
}

\DeclareDocumentCommand{\poor}{m}
{
    \plus \imath{(#1*3/4)+1}
}
...
\DeclareDocumentCommand{\bab}{m o}
{
    ...
    \ifcase\imathresult \relax \or
        \plus #1 % case 0
    \or
        \plus #1 / \plus #1 % case 1
    \or
        \plus #1 / \plus #1 / \plus #1 % case 2
    \or
        \plus #1 / \plus #1 / \plus #1 / \plus #1 % case 3
    \or 
        \plus #1 / \plus #1 / \plus #1 / \plus #1 / \plus #1 % case 3
    \fi
}
...
\DeclareDocumentCommand{\allprogressionrow}{m}
{
    \nth{#1} & \good{#1} & \avg{#1} & \poor{#1}
}
