...
{
    1d6~#2~damage~per~two~caster~levels
    %\IfNoValueTF{#3}
    %{#1d10~#2~damage~\add~d10~per~four~caster~levels~above~\mathnth{2*#1}}
    %{#1#3~#2~damage~\add~#3~per~four~caster~levels~above~\mathnth{2*#1}}
}
