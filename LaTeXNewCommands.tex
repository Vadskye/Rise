...
\newcommand{\spelltriggeredattack}[1]{\parheadni{Triggered Attack} #1}
\newcommand{\spelltrigger}[1]{\parhead{Trigger} #1}
\newcommand{\spelltriggertarget}[1]{\parhead{Target} #1}
\newcommand{\spelltriggers}[1]{\parhead{Triggers} #1}
\newcommand{\spellfocus}[1]{\par\noindent \textit{Focus:} #1}
\newcommand{\spellmat}[1]{\par\noindent \textit{Material Components:} #1}

\newcommand{\spelllvl}[1]{\thead{Level:} #1}
\newcommand{\spellschool}[1]{#1}
\newcommand{\spelllists}[1]{\thead{Lists:} #1}
\newcommand{\spellcmp}[1]{\thead{Components:} #1}
\newcommand{\spelltime}[1]{\thead{Casting Time:} #1}
\newcommand{\spellrng}[1]{\thead{Range:} #1}
\newcommand{\spellarea}[1]{\thead{Area:} #1}
\newcommand{\spelleff}[1]{\thead{Manifestation:} #1}
\newcommand{\spelltgt}[1]{\thead{Target:} #1}
\newcommand{\spelltgts}[1]{\thead{Targets:} #1}
\newcommand{\spelltgtortgts}[1]{\thead{Target or Targets:} #1}
\newcommand{\spelltgtorarea}[1]{\thead{Target or Area:} #1}
\newcommand{\spelltgteffarea}[1]{\thead{Target or Area:} #1}

\newcommand{\longcol}[1]{\multicolumn{2}{l}{#1}}
\newcommand{\spelldur}[1]{\longcol{\thead{Duration:} #1} \\}
\newcommand{\spellsr}[1]{\longcol{\thead{Spell Resistance:} #1} \\}
\newcommand{\spellefflong}[1]{\longcol{\thead{Manifestation:} #1}\\}
...
\newcommand{\spelltabular}{\par\noindent\hangindent=1em\begin{tabularx}{\columnwidth}{>{\lcol}X l}}
