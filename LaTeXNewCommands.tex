...
\newcommand{\spelllvl}[1]{\parheadni{Level} #1}
\newcommand{\spellschool}[1]{\par\noindent #1}
...
\newcommand{\spelleff}[1]{\parheadni{Manifestation} #1}
...
\newcommand{\spellskill}[1]{\parheadni{Skill} #1}

\newcommand{\rngpers}{Personal}
\newcommand{\rngtouch}{Touch}
\newcommand{\rngclose}{Close (30 ft.)\xspace}
\newcommand{\rngmed}{Medium (100 ft.)\xspace}
\newcommand{\rnglong}{Long (300 ft.)\xspace}
\newcommand{\rngfar}{Long (300 ft.)\xspace}
\newcommand{\rngext}{Extreme (1,000 ft.)\xspace}
\newcommand{\areasmall}{Small (10 ft.)\xspace}
\newcommand{\areamed}{Medium (20 ft.)\xspace}
\newcommand{\arealarge}{Large (50 ft.)\xspace}
\newcommand{\durshort}{Short (Concentration \add 5 rounds)\xspace}
\newcommand{\durmed}{Medium (5 minutes)\xspace}
\newcommand{\durlong}{Long (1 hour)\xspace}
\newcommand{\durext}{Extreme (12 hours)\xspace}
...
\newcommand{\bloodied}{\conditionlink{bloodied} (half hit points)}
\newcommand{\confused}{\conditionlink{confused} (randomly babbles, flees, attacks nearest, or acts normally)\xspace}
\newcommand{\dazzled}{\conditionlink{dazzled} (20\% miss chance, \minus4 to visual Perception)\xspace}
\newcommand{\entangled}{\conditionlink{entangled} (move at half speed, unable to sprint or charge, \minus2 to physical attacks, defenses, and checks)\xspace}
\newcommand{\fatigued}{\conditionlink{fatigued} (unable to sprint or charge, \vulneffect)\xspace}
...
\newcommand{\paralyzed}{\conditionlink{paralyzed} (helpless, unable to move)}
