...
\newcommand{\unencumbered}{\conditionlink{unencumbered} \reminder{not carrying a heavy load or wearing medium or heavy armor}}
\newcommand{\monkunencumbered}{not wearing armor or encumbered by weight (see \pcref{Encumbrance)}
...
\newcommand{\cursespellnotes}{Curses cannot be dispelled.\xspace}
...
\newcommand{\sensorspellnotes}{A magic sensor is a floating, invisible sphere approximately one inch in diameter. It has 1 hit point and an Armor defense of 8. Its special defenses are the same as yours. It is unable to enter another plane of existence, even through a \spell{gate} or similar magical portal.}
\newcommand{\norepeatnotes}{You can only affect any individual creature with this spell once per 24 hours.\xspace}
