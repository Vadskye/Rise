...
\newcommand{\armdescription}[5]{\my{\subsubsection{#1} \parhead{Bonus} \plus #2 \parhead{Caster Level} #3 \parhead{Aura} #4 \parhead{Activation} #5 \par}}
...
\newcommand{\monrng}[1]{\par \textbf{Ranged} #1}
...
\newcommand{\spelltime}[1]{\parhead{Time} #1}
