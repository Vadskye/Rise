...
\newcommand{\vulnerableexplanation}{A vulnerable creature takes a \minus2 penalty to attacks, defenses, and checks.}
\newcommand{\vulneffect}{\minus2 to attacks, defenses, and checks}
\newcommand{\conditionlink}[1]{\hyperlink{condition:#1}{#1}}
\newcommand{\bewildered}{\conditionlink{bewildered} (\vulneffect)}
\newcommand{\blinded}{\conditionlink{blinded} (unable to see, moves at half speed, defenseless)}
\newcommand{\confused}{\conditionlink{confused} (randomly babbles, flees, attacks nearest, or acts normally)}
\newcommand{\frightened}{\conditionlink{frightened} (flees, \vulneffect)}
\newcommand{\dazed}{\conditionlink{dazed} (unable to act)}
\newcommand{\deafened}{\conditionlink{deafened} (unable to hear)}
\newcommand{\ignited}{\conditionlink{ignited} (d6 damage/round, Dex DC 10 to extinguish, \vulneffect)}
\newcommand{\nauseated}{\conditionlink{nauseated} (unable to act in action phase, \vulneffect)}
\newcommand{\shaken}{\conditionlink{shaken} (\vulneffect)}
\newcommand{\sickened}{\conditionlink{sickened} (\vulneffect)}
\newcommand{\slowed}{\conditionlink{slowed} (unable to act in movement phase, \minus2 to physical attacks, defenses, and checks)}
\newcommand{\staggered}{\conditionlink{staggered} (unable to act in movement phase, \vulneffect)}
\newcommand{\stunned}{unable to act, \vulneffect}
\newcommand{\vulnerable}{\conditionlink{vulnerable} (\vulneffect)}
