...
\newcommand{\unaware}{\conditionlink{unaware} \reminder{critically threatened on every attack}}
...
{
    \IfNoValueTF{#3}
    {#1d10~#2~damage~\add~d10~per~two~spellpower}
    {#1#3~#2~damage~\add~#3~per~two~spellpower}
}
