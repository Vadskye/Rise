...
\parhead{Demoralized} A demoralized character is filled with doubt and uncertainty, making it vulnerable. It is vulnerable, causing it to take a \minus2 penalty to attack rolls, saving throws, checks, DCs, and AC.
...
\parhead{Ignited} An ignited creature has been set on fire. It is vulnerable, causing it to take a \minus2 penalty to attack rolls, saving throws, checks, DCs, and AC. In addition, at the end of its turn, it takes d6 damage per round from the fire. If the creature takes a move action, it can attempt a DC 15 Reflex save to put out the flames. This action requires a free hand. Dropping prone as part of the action gives a \plus4 circumstance bonus on this save.
