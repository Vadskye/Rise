...
\condition{Prone} The creature is on the ground. A prone creature takes a \minus4 penalty to physical attacks. It takes a \minus4 penalty to physical defenses against melee attacks, but gains a \plus4 bonus to physical defenses against ranged attacks.
