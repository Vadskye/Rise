...
\parhead{Slowed} A slowed creature cannot act during the movement phase. It cannot take full-round actions, but it may take swift actions. Additionally, it takes a \minus2 penalty to physical attacks, defenses, and checks.
...
\parhead{Staggered} A staggered creature cannot act during the movement phase. In addition, it is \vulnerable. A creature with 0 hit points is staggered.
