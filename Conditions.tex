...
\condition{Shaken} A shaken creature is unable to move closer than 30 feet towards the source of its fear. If it is already within that range, it can move sideways or away from the source of its fear, but not towards it. It can otherwise act normally.
