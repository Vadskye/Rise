...
\parhead{Invisible} An invisible creature or object cannot be seen. Other creatures are defenseless against an invisible creature, causing them to provoke attacks of opportunity for its actions. Attackers suffer a 50\% miss chance even if they know the location of the invisible creature. See \pcref{Perception} and \pcref{Stealth}, for how to identify invisible creatures.
