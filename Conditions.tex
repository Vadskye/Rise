...
\parhead{Deafened} A deafened character cannot hear. She automatically fails Listen checks, takes a \minus4 penalty to any checks which involve hearing, and has a 20\% chance of spell failure when casting spells with verbal components.
