...
\skill{Analysis}{Int}
  ...
  \subsection{Common Analysis Tasks}
    ...
    You can make another check when the ability ends if you didn't understand it initialy.
...
\skill{Awareness}{Per}
  ...
  \subsection{Common Awareness Tasks}
    ...
    \parhead{Notice Ability} If you succeed at an Awareness check, you can notice a creature using an ability.
    Unless otherwise noted in an ability's description, any active ability has some combination of visual and auditory effects that require a \glossterm{difficulty value} 5 Awareness check to notice.
