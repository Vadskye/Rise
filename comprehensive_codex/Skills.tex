...
\skill{Endurance}{Con}
  ...
  \subsection{Common Endurance Tasks}\label{Common Endurance Tasks}
    ...
    For example, a human can normally sprint for 10 turns without rest.
    If they pass a DV 10 Endurance \glossterm{extended check}, they could sprint for an additional 5 turns.
    After that time, they would need to make a DV 15 Endurance \glossterm{extended check} for the next 5 turns, then DV 20, and so on.
