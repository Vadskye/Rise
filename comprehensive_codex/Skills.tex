...
\skill{Knowledge}{Int}
  ...
  \begin{raggeditemize}
    \item Arcana (arcane spells, dragons, highly magical creatures, constructs)
    ...
    \item Nature (nature spells, animals, fae, plants, terrain and climate)
    \item Planes (divine and pact spells, specific planes, planeforged, teleportation)
    \item Souls (undead, deities, the afterlife, resurrection)
  \end{raggeditemize}
