...
\skill{Ride}{Dex}
  ...
  \subsection{Common Ride Modifiers}
    ...
    If it takes a standard action other than movement, such as attacking, the DV to ride it that turn increases by 5.
    If it uses a \glossterm{movement mode} other than a walk speed, the DV to ride it that turn increases by 10.
