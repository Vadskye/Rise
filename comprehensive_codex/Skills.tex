...
\skill{Climb}{Str}
  ...
  \subsection{Climb Speed}\label{Climb Speed}
    ...
    However, it can climb with its \glossterm{speed} as part of normal movement abilities rather than relying on the \ability{climb forward} ability.
...
\skill{Swim}{Str}
  ...
  \subsection{Swim Speed}\label{Swim Speed}
    ...
    However, it can swim with its \glossterm{speed} as part of normal movement abilities rather than relying on the \ability{swim forward} ability.
