  ...
  \subsection{Armor Table}
    ...
    \begin{dtable!*}
      ...
      \begin{dtabularx}{\textwidth}{l c c c c c c c >{\lcol}X c}
        \tb{Armor}             & \tb{Armor}   & \tb{Reflex} & \tb{Durability} & \tb{Vital Rolls} & \tb{Speed}   & \tb{Dex Bonus} & \tb{Dex Skills} & \tb{Material} & \tb{Item Rank (Cost)}  \tableheaderrule
        Light armor            &              &             &                 &                  &              &                &                 &               &            \\
        % 6 Armor + 1 dur = 7 points                                                                                                                
        \tind Buff leather     & \plus2       & \tdash      & \tdash          & \tdash           & \tdash       & \tdash         & \tdash          & Leather       & 1 (4 gp)   \\
        % 6 Armor + 2 dur - 1 rank = 7 points                                                                                                       
        \tind Mail shirt       & \plus2       & \tdash      & \plus1          & \tdash           & \tdash       & \tdash         & \tdash          & Metal         & 2 (20 gp)  \\
        % 6 Armor + 2 vit - 1 dex = 7 points                                                                                                        
        \tind Rawhide          & \plus2       & \tdash      & \tdash          & \plus1           & \tdash       & \tdash         & \minus1         & Leather       & 1 (4 gp)   \\
        \tind Buckler          & \plus1       & \plus1      & \tdash          & \tdash           & \tdash       & \tdash         & \tdash          & Metal or wood & 0 (1 gp)   \\
        Medium armor           &              &             &                 &                  &              &                &                 &               &            \\
        % 12 Armor + 2 dur + 2 vit - 2 dex = 14 points                                                                                              
        \tind Leather lamellar & \plus4       & \tdash      & \plus1          & \plus1           & \tdash       & \mult1/2       & \minus2         & Leather       & 1 (4 gp)   \\
        % 12 Armor + 3 dur + 2 vit - 3 dex = 14 points                                                                                              
        \tind Scale            & \plus4       & \tdash      & \plus2          & \plus1           & \tdash       & \mult1/2       & \minus3         & Metal         & 1 (4 gp)   \\
        % 12 Armor + 4 dur + 2 vit - 3 dex - 1 rank = 14 points                                                                                     
        \tind Brigandine       & \plus4       & \tdash      & \plus3          & \plus1           & \tdash       & \mult1/2       & \minus3         & Metal         & 2 (20 gp)  \\
        \tind Standard shield  & \plus2       & \plus2      & \tdash          & \tdash           & \tdash       & \mult1/2       & \tdash          & Metal or wood & 0 (1 gp)   \\
        Heavy armor            &              &             &                 &                  &              &                &                 &               &            \\
        % 15 Armor + 5 dur + 4 vit - 4 dex = 20 points                                                                                              
        \tind Breastplate      & \plus5       & \tdash      & \plus4          & \plus2           & \minus10 ft. & \mult1/2       & \minus4         & Metal         & 1 (4 gp)   \\
        % 15 Armor + 7 dur + 4 vit - 5 dex - 1 rank = 20 points                                                                                     
        \tind Half plate       & \plus5       & \tdash      & \plus6          & \plus2           & \minus10 ft. & \mult1/2       & \minus5         & Metal         & 2 (20 gp)  \\
        % 15 Armor + 8 dur + 4 vit - 5 dex - 2 rank = 20 points                                                                                     
        \tind Full plate       & \plus5       & \tdash      & \plus7          & \plus2           & \minus10 ft. & \mult1/2       & \minus5         & Metal         & 3 (100 gp) \\
        \tind Tower shield     & \plus3\fn{2} & \plus3      & \tdash          & \tdash           & \tdash       & \mult1/2       & \minus1         & Metal or wood & 1 (4 gp)   \\
        Extras                 &              &             &                 &                  &              &                &                 &               &            \\
        \tind Shield spikes    & \tdash       & \tdash      & \tdash          & \tdash           & \tdash       & \tdash         & \minus1         & Metal         & 1 (4 gp)   \\
      \end{dtabularx}
    \end{dtable!*}
