...
\sectiongraphic*{Weapons}{width=\columnwidth}{equipment/weapons}
  ...
  \subsection{Weapon Tags}\label{Weapon Tags}
    ...
    % TODO: wording
    In addition, being \grappled does not prevent you from making \glossterm{strikes} using your hands that are holding a Maneuverable weapon.
  ...
  \subsection{Armor Table}
    ...
    \begin{dtable!*}
      ...
      \begin{dtabularx}{\textwidth}{l c c c c c c >{\lcol}X c}
        ...
        \tind Mail shirt       & \plus2       & \plus5                 & \tdash           & \plus1           & \tdash       & \tdash         & Metal         & 2 (20 gp)   \\
