...
\sectiongraphic*{Weapons}{width=\columnwidth}{equipment/weapons}
  ...
  \subsection{Weapon Tags}\label{Weapon Tags}
    ...
    % That's a 40% chance for a regular hit and a 30% chance for a crit, so 1x hit damage per round.
  ...
  \subsection{Weapon Special Materials}\label{Weapon Special Materials}
    ...
    \subsubsection{Weapon Special Material Prices}
      ...
      \begin{activeability}{Dragonfang Breath}{Standard action}
        \abilitycost You can't use this ability with this weapon next round.
        \rankline
