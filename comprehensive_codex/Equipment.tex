...
\sectiongraphic*{Weapons}{width=\columnwidth}{equipment/weapons}
  ...
  \subsection{Weapon Tags}\label{Weapon Tags}
    ...
    \weapontagdef{Grappling} You gain a \plus2 bonus to \glossterm{accuracy} on \glossterm{melee} \glossterm{strikes} using this weapon against creatures who are \grappled by you.
