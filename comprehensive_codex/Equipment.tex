    ...
    \subsubsection{Trade Goods}
      ...
      \begin{dtable}
        ...
        \begin{dtabularx}{\columnwidth}{l >{\lcol}X}
          ...
          1.5 gp & One pound of saffron or cloves, or one ox \\
        \end{dtabularx}
      \end{dtable}
    ...
    \begin{longcolumn}
      \begin{longtablewrapper}
        ...
        \begin{longtable}{p{12em} l l l >{\lcol}p{24em}}
          ...
          \tind Spiked standard shield      & \plus0        & 1d8         & 1 (4 gp)                    & \tdash                                      \\
          ...
          \tind Lance (5)\fn{2}             & \plus0        & 1d10        & 0 (1 gp)                    & Ammunition, Long, Mounted                   \\
          \tind Spear                       & \plus1        & 1d6         & 0 (1 gp)                    & Thrown (30/60), Versatile Grip              \\
    ...
    \begin{longcolumn}
      \begin{longtablewrapper}
        ...
        \begin{longtable}{p{12em} l l l >{\lcol}p{24em}}
          ...
          Blades                         &               &             &                             &                                    \\
          \tind Boot dagger\fn{2}        & \plus1        & 1d4         & 0 (1 gp)                   & Compact, Light                     \\
          ...
          \tind Gnomish trick mace       & \plus2        & 1d4         & 0 (1 gp)                   & Light, Maneuverable                \\
          ...
          \tind Pistol crossbow\fn{2}    & \plus1        & 1d4         & 1 (4 gp)                   & Compact, Light, Projectile (30/90) \\
          ...
          Monk weapons                   &               &             &                             &                                    \\
          \tind Hook sword               & \plus1        & 1d6         & 1 (4 gp)                   & Light, Maneuverable                \\
    ...
    \subsubsection{Weapon Special Material Prices}
      ...
      \begin{dtable!*}
        ...
        \begin{dtabularx}{\textwidth}{l >{\lcol}X l}
          ...
          \tind Adamantine, pure    & \plus2d6 \glossterm{extra damage}, double damage to objects, extra weight    & 8 (312,500 gp) \\
          % just vulnerabilities
          \tind Cold iron           & Common vulnerabilities                                                       & 2 (20 gp)     \\
          % crit accuracy
          \tind Diamondsteel        & \plus2 accuracy with critical hits                                           & 4 (500 gp)   \\
          \tind Diamondsteel, pure  & \plus4 accuracy with critical hits                                           & 7 (62,500 gp) \\
          % energy damage
          ...
          \tind Mithral, pure       & \plus1 accuracy, lighter                                                     & 7 (62,500 gp) \\
          % just vulnerabilities  
      ...
      \parhead{Adamantine, Pure} A pure adamantine weapon deals 2d6 \glossterm{extra damage}.
  ...
  \subsection{Armor Table}
    ...
    \begin{dtable!*}
      ...
      \begin{dtabularx}{\textwidth}{l c c c c c c >{\lcol}X c}
        ...
        Light armor            &              &                        &                  &                  &              &                &               &              \\
        \tind Padded           & \plus2       & \plus3                 & \tdash           & \tdash           & \tdash       & \tdash         & Leather       & 0 (1 gp)    \\
        \tind Buff leather     & \plus2       & \plus4                 & \tdash           & \plus1           & \tdash       & \tdash         & Leather       & 1 (4 gp)    \\
        \tind Mail shirt       & \plus2       & \plus4                 & \tdash           & \plus1           & \tdash       & \tdash         & Metal         & 1 (4 gp)    \\
        \tind Buckler          & \plus1       & \tdash                 & \tdash           & \tdash           & \tdash       & \tdash         & Metal or wood & 0 (1 gp)    \\
        Medium armor           &              &                        &                  &                  &              &                &               &              \\
        \tind Leather lamellar & \plus4       & \plus4                 & \plus1           & \plus2           & \tdash       & \mult1/2       & Leather       & 1 (4 gp)    \\
        \tind Scale            & \plus4       & \plus5                 & \plus1           & \plus4           & \tdash       & \mult1/2       & Metal         & 1 (4 gp)    \\
        \tind Brigandine       & \plus4       & \plus6                 & \plus1           & \plus4           & \tdash       & \mult1/2       & Metal         & 2 (20 gp)   \\
        \tind Standard shield  & \plus2       & \tdash                 & \tdash           & \tdash\fn{1}     & \tdash       & \mult1/2       & Metal or wood & 0 (1 gp)    \\
        Heavy armor            &              &                        &                  &                  &              &                &               &              \\
        \tind Layered hide     & \plus5       & \plus8                 & \plus2           & \plus4           & \minus10 ft. & \mult1/2       & Leather       & 1 (4 gp)    \\
        \tind Half plate       & \plus5       & \plus10                & \plus2           & \plus6           & \minus10 ft. & \mult1/2       & Metal         & 2 (20 gp)   \\
        \tind Full plate       & \plus5       & \plus12                & \plus2           & \plus6           & \minus10 ft. & \mult1/2       & Metal         & 3 (100 gp) \\
        \tind Tower shield     & \plus3\fn{2} & \tdash                 & \tdash           & \plus2\fn{1}     & \tdash       & \mult1/2       & Metal or wood & 1 (4 gp)    \\
        Extras                 &              &                        &                  &                  &              &                &               &              \\
        \tind Shield spikes    & \tdash       & \tdash                 & \tdash           & \plus1           & \tdash       & \tdash         & Metal         & 1 (4 gp)    \\
      \end{dtabularx}
