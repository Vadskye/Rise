...
\sectiongraphic*{Weapons}{width=\columnwidth}{equipment/weapons}
  ...
  \subsection{Weapon Tags}\label{Weapon Tags}
    ...
    While holding a Heavy weapon in two hands, you add your full \glossterm{power} to damage with \glossterm{strikes} using the weapon, rather than only half your power as normal (see \pcref{Strikes}).
    ...
    While holding a Versatile Grip weapon in two hands, you add your full \glossterm{power} to damage with \glossterm{strikes} using the weapon, rather than only half your power as normal (see \pcref{Strikes}).
