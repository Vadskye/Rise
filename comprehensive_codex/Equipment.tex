...
\section{Wealth and Item Ranks}\label{Wealth}\label{Wealth and Item Ranks}
  ...
  In general, gold pieces are a more useful concept at low levels, and item ranks are more useful at high levels.
  ...
  \subsection{Buying and Selling Items}
    ...
    Items with a rank of 4 or higher are exceptionally rare.
...
\section{Using Items}
  ...
  \subsection{Manipulating Objects}\label{Manipulating Objects}
    ...
    \subsubsection{Manipulating Objects as a Free Action}
      ...
      You can only use one free action \glossterm{object manipulation} per turn.
      However, you can use a minor action or a standard action in place of a free action for this purpose, allowing you to manipulate up to three objects per turn.
      ...
      Simply dropping an object in your hands is so trivial that it does not count against your one free action object manipulation per turn.
  ...
  \subsection{Magic Item Limitations}
    ...
    \subsubsection{Item Attunement}\label{Item Attunement}
      ...
      \begin{attuneability}{Item Attunement}{Standard action}
...
\sectiongraphic*{Weapons}{width=\columnwidth}{equipment/weapons}
  ...
  In addition, each weapon has a particular \glossterm{accuracy} modifier and defines the \glossterm{weapon damage} for attacks using that weapon.
  ...
  \subsection{Weapon Groups}\label{Weapon Groups}
    ...
    \begin{dtable!*}
      ...
      \begin{dtabularx}{\textwidth}{l >{\lcol}X >{\lcol}X}
        ...
        Club-like weapons & Cavalry mace, club, greatclub, greatmace, morning star, sap, torch      & Culacula, knobkerrie, totokia, trick mace                                 \\
        ...
        Polearms          & Bardiche, halberd, javelin, lance, poleaxe, quarterstaff, scythe, spear & Cavalry lance, fauchard, glaive, longhammer, pike, twinspear, war scythe \\
  ...
  \subsection{Weapon Tags}\label{Weapon Tags}
    ...
    \weapontagdef{Bow} This weapon is a bow used to shoot arrows.
    You need two hands to shoot a bow.
    ...
    This is not considered an independent action, so you can fire a bow any number of times per turn.
    \weapontagdef{Clinch} You gain a \plus2 accuracy bonus with this weapon against creatures that are \grappled by you or are grappling you.
    ...
    \weapontagdef{Heavy} Heavy weapons are larger than other weapons.
    ...
    This cannot be used if the weapon always requires two hands to shoot, such as a titanbow.
    If your Strength is 6 or higher, this accuracy penalty is removed.

    While holding a Heavy weapon in two hands, you add your full \glossterm{power} to your \glossterm{strike damage} with the weapon, rather than only half your power as normal (see \pcref{Strike Damage}).
    % Assume you have a 70% chance to hit (+0 vs 4 Armor).
    % +3 accuracy takes you to 1x hit damage per turn.
    % +6 accuracy for crits means you crit on 8/9/10.
    % That's a 40% chance for a regular hit and a 30% chance for a crit, so 1x hit damage per turn.
    % Therefore, +2 accuracy with crits is worth about +1 global accuracy.
    \weapontagdef{Impact} When you miss by 5 or less with an Impact weapon, you still deal half damage.
    ...
    \weapontagdef{Keen} You gain a \plus2 \glossterm{accuracy} bonus with this weapon for the purpose of determining whether you get a \glossterm{critical hit}.
    ...
    \weapontagdef{Long}\label{Long Weapon} This weapon can be used to make melee \glossterm{strikes} against targets within 10 feet of you.
    ...
    \weapontagdef{Mounted}\label{Mounted Weapon} If you are mounted, and your mount moves in the same turn that you make a \glossterm{strike} with a Mounted weapon, you gain a \plus2 \glossterm{accuracy} bonus with the strike.
    \weapontagdef{Parrying} This weapon grants you a \plus1 bonus to your Armor and Reflex defenses while you wield it in at least one hand.
    ...
    You take a \minus4 accuracy penalty with Projectile weapons against creatures within 5 feet of you.
    While riding a moving mount, you take a \minus4 accuracy penalty with Projectile weapons, and your range limits are halved.
    \weapontagdef{Subdual} All damage dealt by this weapon is \glossterm{subdual damage} (see \pcref{Subdual Damage}).
    ...
    If a weapon or strike has the Sweeping tag from multiple sources, add the values together to determine the total Sweeping value.
    ...
    While holding a Versatile Grip weapon in two hands, you add your full \glossterm{power} to your \glossterm{strike damage} with the weapon, rather than only half your power as normal (see \pcref{Strike Damage}).
    \weapontagdef{Versatile Stance} This weapon is more effective if you can use your whole body to support it.
    While you are \trait{quadrupedal} or \trait{multipedal}, you add your full \glossterm{power} to your \glossterm{strike damage} with the weapon, rather than only half your power as normal (see \pcref{Strike Damage}).
  ...
  \subsection{Weapon Table}
    ...
    All weapons also have the \atPhysical tag.
    This is omitted from the tables for brevity.
    ...
    \begin{longcolumn}
      \begin{longtablewrapper}
        ...
        \begin{longtable}{p{12em} l l l >{\lcol}p{24em}}
          ...
          Axes                               &               &             &                             &                                                                                             \\
          \tind Battleaxe                    & \plus0        & 1d6         & 0 (1 gp)                    & \weapontag{Keen}, \weapontag{Versatile Grip}                                                                  \\
          \tind Greataxe                     & \plus0        & 1d8         & 0 (1 gp)                    & \weapontag{Heavy}, \weapontag{Keen}                                                                           \\
          ...
          \tind Shortbow\fn{2}               & \plus0        & 1d6         & 1 (4 gp)                    & \weapontag{Bow}, \weapontag{Projectile} (60/180)                                            \\
          ...
          \tind Greatclub                    & \plus0        & 1d10        & 0 (1 gp)                    & \weapontag{Heavy}                                                      \\
          ...
          \tind Sap                          & \plus0        & 1d4         & 0 (1 gp)                    & \weapontag{Light}, \weapontag{Subdual}                                \\
          ...
          \tind Pellet crossbow\fn{2}        & \plus1        & 1d4         & 1 (4 gp)                    & \weapontag{Projectile} (60/180), \weapontag{Subdual}                                       \\
          ...
          Headed weapons                     &               &             &                             &                                                                                             \\
          % Darts should be a classic sneak attack weapon, so 30/60 is better than dealing with 1d3.
          \tind Dart (10)                    & \plus0        & 1d4         & \tdash                      & \weapontag{Ammunition}, \weapontag{Compact}, \weapontag{Light}, \weapontag{Thrown} (30/60) \\
          \tind Light hammer                 & \plus0        & 1d4         & 0 (1 gp)                    & \weapontag{Impact}, \weapontag{Light}                                                      \\
          % -1a for an extra improvement
          \tind Pick                         & \minus1       & 1d8         & 0 (1 gp)                    & \weapontag{Keen}, \weapontag{Versatile Grip}                                               \\
          % Only one improvement because simple
          \tind Sickle                       & \plus0        & 1d4         & 0 (1 gp)                    & \weapontag{Light}                                                                           \\
          \tind Sledgehammer                 & \minus1       & 1d10        & 0 (1 gp)                    & \weapontag{Heavy}, \weapontag{Impact}                                                      \\
          \tind Warhammer                    & \minus1       & 1d8         & 0 (1 gp)                    & \weapontag{Impact}, \weapontag{Versatile Grip}                                             \\

          Monk weapons                       &               &             &                             &                                                                                             \\
          % -1d for an extra improvement
          \tind Jitte                        & \plus1        & 1d3         & 0 (1 gp)                    & \weapontag{Light}, \weapontag{Subdual}                                                     \\
          \tind Kama                         & \plus0        & 1d4         & 0 (1 gp)                    & \weapontag{Keen}, \weapontag{Light}                                                        \\
          ...
          % +1a/-1d compared to darts
          \tind Shuriken (10)                & \plus1        & 1d3         & 0 (1 gp)                    & \weapontag{Ammunition}, \weapontag{Compact}, \weapontag{Light}, \weapontag{Thrown} (30/60)  \\
          \tind Two-section staff            & \plus1        & 1d6         & 0 (1 gp)                    & \weapontag{Heavy}, \weapontag{Long}                                                         \\

          Polearms                           &               &             &                             &                                                                                             \\
          \tind Bardiche                     & \minus1       & 1d10        & 0 (1 gp)                    & \weapontag{Heavy}, \weapontag{Sweeping} (1)                                                 \\
          \tind Halberd                      & \plus0        & 1d8         & 0 (1 gp)                    & \weapontag{Heavy}, \weapontag{Long}                                                         \\
          \tind Javelin\fn{2}                & \plus0        & 1d6         & 0 (1 gp)                    & \weapontag{Thrown} (60/120)                                                                 \\
          \tind Lance                        & \plus0        & 1d6         & 0 (1 gp)                    & \weapontag{Mounted}                    \\
          \tind Poleaxe                      & \plus0        & 1d8         & 0 (1 gp)                    & \weapontag{Heavy}, \weapontag{Maneuverable}                                                 \\
          \tind Quarterstaff                 & \plus0        & 1d8         & \tdash                      & \weapontag{Heavy}                                                         \\
          ...
          \tind Spear\fn{2}                  & \plus0        & 1d6         & \tdash                      & \weapontag{Long}, \weapontag{Thrown} (30/60), \weapontag{Versatile Grip}                    \\
    ...
    \begin{longcolumn}
      \begin{longtablewrapper}
        ...
        \begin{longtable}{p{12em} l l l >{\lcol}p{24em}}
          ...
          Armor                           &               &             &                             &                                                                         \\
          \tind Armblade\fn{2}            & \plus0        & 1d4         & 1 (4 gp)                    & \weapontag{Clinch}, \weapontag{Keen}, \weapontag{Light}               \\
          \tind Spiked knee\fn{2}         & \minus1       & 1d4         & 1 (4 gp)                    & \weapontag{Clinch}, \weapontag{Impact}, \weapontag{Light}             \\
          \tind Tower shield              & \plus0        & 1d6         & 1 (4 gp)                    & \weapontag{Heavy}, \weapontag{Impact}                                  \\
          \tind Spiked tower shield       & \plus0        & 1d8         & 1 (4 gp)                    & \weapontag{Heavy}, \weapontag{Impact}                                  \\
          Axes                            &               &             &                             &                                                                         \\
          ...
          \tind Head axe                  & \plus0        & 1d8         & 1 (4 gp)                    & \weapontag{Keen}, \weapontag{Versatile Grip}                                             \\
          \tind Orcish greataxe           & \minus1       & 1d10        & 1 (4 gp)                    & \weapontag{Heavy}, \weapontag{Keen}, \weapontag{Sweeping} (1)        \\
          Blades                          &               &             &                             &                                                                         \\
          \tind Boot dagger\fn{2}         & \plus0        & 1d4         & 1 (4 gp)                    & \weapontag{Compact}, \weapontag{Light}                                  \\
          \tind Epee                      & \plus1        & 1d6         & 0 (1 gp)                    & \weapontag{Parrying}                                                       \\
          ...
          \tind Titanbow\fn{2}            & \minus2       & 2d6         & 2 (20 gp)                   & \weapontag{Bow}, \weapontag{Projectile} (60/180)     \\
          \tind Greatarrows (20)          & \plus0        & \tdash      & 0 (1 gp)                    & \weapontag{Ammunition}                                                                      \\
          Club-like weapons               &               &             &                             &                                                                         \\
          \tind Culacula                  & \plus0        & 1d8         & 1 (4 gp)                    & \weapontag{Heavy}, \weapontag{Impact}, \weapontag{Parrying}            \\
          ...
          \tind Trick mace                & \plus1        & 1d4         & 1 (4 gp)                    & \weapontag{Light}, \weapontag{Maneuverable}                             \\
          Crossbows                       &               &             &                             &                                                                         \\
          ...
          \tind Longhammer                & \plus0        & 1d8         & 1 (4 gp)                    & \weapontag{Heavy}, \weapontag{Long}, \weapontag{Impact}             \\
          % The extra range counts as one improvement
          \tind Pike\fn{2}                & \plus0        & 1d8         & 1 (4 gp)                    & \weapontag{Heavy}, \weapontag{Long}                                     \\
          \tind Twinspear                 & \plus1        & 1d4         & 1 (4 gp)                    & \weapontag{Light}, \weapontag{Long}                                     \\
    ...
    \begin{dtable}
      ...
      \begin{dtabularx}{\columnwidth}{p{8em} l l >{\lcol}X}
        ...
        Beak\fn{2}              & \plus1        & 1d6         & \weapontag{Versatile Stance}    \\
        Bite                    & \plus0        & 1d8         & \weapontag{Versatile Stance} \\
        Claw\fn{1}              & \plus1        & 1d4         & \weapontag{Light}     \\
        Horn                    & \plus0        & 1d6         & \weapontag{Keen}, \weapontag{Versatile Stance}    \\
        Punch/kick\fn{1} \fn{2} & \plus0        & 1d3         & \weapontag{Subdual}   \\
        Ram                     & \plus0        & 1d6         & \weapontag{Impact}, \weapontag{Versatile Stance}  \\
        Slam\fn{1}              & \minus1       & 1d10        & \tdash    \\
        Stinger                 & \plus1        & 1d6         & \weapontag{Versatile Stance}    \\
  ...
  \subsection{Individual Weapon Descriptions}
    ...
    When you attack with an armblade, you cannot use the arm it is attached to for any other combat purpose in the same turn.
    You can use that arm to hold items, but not to maintain a grapple or perform similar actions.
    \parhead{Beak} While you are flying or gliding, you gain the full power bonus from this weapon's \weapontag{Versatile Stance} tag.
    ...
    Attacking with a boot dagger does not require a \glossterm{free hand}, but you must make a Poise check with a \glossterm{difficulty value} of 10 during whenever you attack with it.
    ...
    \parhead{Javelin} Unlike most Thrown weapons, a javelin cannot be used effectively in melee.
    If you make a melee attack with a javelin, you treat it as an improvised weapon (see \pcref{Improvised Weapons}).
    ...
    \par A netted creature can escape with a \glossterm{difficulty value} 8 Flexibility check (see \pcref{Flexibility}). The net has 8 hit points and can be \glossterm{broken} with a \glossterm{difficulty value} 8 Might check as a standard action.
    ...
    If you are trained in the Poise skill, have a Dexterity of at least 3, or are currently flying or gliding, you can make it a kick instead.
    ...
    In order to attack with a talon, you must be trained in the Poise skill, have a Dexterity of at least 3, or be currently flying or gliding.
    ...
    If your Strength is at least 5, the accuracy penalty of a titanbow is reduced to \minus1.
    If it is at least 10, the accuracy penalty is removed.

    A titanbow cannot be used to fire ordinary arrows.
    Instead, it can only be used to fire greatarrows, which are larger and more expensive.
  ...
  \subsection{Weapon Special Materials}\label{Weapon Special Materials}
    ...
    A weapon that is made from a special material cannot have any magic item properties.
    ...
    \subsubsection{Weapon Special Material Prices}
      ...
      \begin{dtable!*}
        ...
        \begin{dtabularx}{\textwidth}{l >{\lcol}X l}
          ...
          % just vulnerabilities  
          Silver              & Common vulnerabilities                                                     & 2 (20 gp)      \\
          Sanctified silver   & \plus2 \glossterm{extra damage}, common vulnerabilities                    & 6 (12,500 gp)  \\
          % +2dr for -1a
          Starmetal           & \plus2 \glossterm{extra damage}, \minus1 accuracy, extra weight            & 3 (100 gp)     \\
          Starmetal, pure     & \plus1d6 \glossterm{extra damage}, \minus1 accuracy, extra weight          & 6 (12,500 gp)  \\
          % Very heavy
          Voidstone           & \plus1d4 \glossterm{extra damage}, extremely heavy, \atEarth tag           & 4 (500 gp)     \\
          Voidstone, pure     & \plus1d10 \glossterm{extra damage}, extremely heavy, \atEarth tag          & 7 (12,500 gp)  \\
        \end{dtabularx}
      \end{dtable!*}
      ...
      \parhead{Cold Iron} Cold iron is difficult to affect with magic, and can be harmful to creatures that are strongly composed of magic.
      % TODO: who else is vulnerable to cold iron and why?
      Many fey creatures are \vulnerable to cold iron weapons.
      ...
      \begin{activeability}{Dragonfang Breath}{Standard action}
        \abilitycost You \briefly can't use this ability with this weapon.
        \rankline
        % TODO: math to make sure this is right? It's probably right, especially with the cooldown.
        ...
        If the dragon's breath weapon is normally \magical, this ability is also magical, so you use your \glossterm{magical power} to determine your damage with the strike.
        \miss Half damage.
      \end{activeability}

      % Battleaxe: 1d8 damage
      % 1H mithral greataxe: 1d10 damage. So you're basically paying a special material cost for +1 weapon damage.
      ...
      \parhead{Sanctified Silver} A sanctified silver weapon deals 2 \glossterm{extra damage}.
      It is also silver, so any creature that is vulnerable to silver weapons is also vulnerable to sanctified silver.

      \parhead{Silver} Silver has purifying properties.
      Diseased and festering creatures, such as vampires and werewolves, are \vulnerable to silver weapons.

      \parhead{Starmetal} A starmetal weapon deals 2 \glossterm{extra damage}.
      However, it also has a \minus1 accuracy penalty.
      Unlike other weapons, starmetal weapons are not \glossterm{lightweight}, so \abilitytag{Heavy} starmetal weapons typically require a minimum Strength of 2.

      \parhead{Starmetal, Pure} A pure starmetal weapon deals 1d6 \glossterm{extra damage}.
      However, it also has a \minus1 accuracy penalty.
      Unlike other weapons, pure starmetal weapons are not \glossterm{lightweight}, so \abilitytag{Heavy} pure starmetal weapons typically require a minimum Strength of 2.

      % TODO: this still allows voidstone javelins, which are an expensive but scary way to deal damage at long range?
      \parhead{Voidstone} A voidstone weapon deals 1d4 \glossterm{extra damage}, and all strikes with it have the \atEarth tag.
      In addition, it is staggeringly heavy.
      If the weapon was previously \weapontag{Light}, it loses that tag.
      If it was previously a \weapontag{Heavy} or \weapontag{Projectile} weapon, it takes a \minus1 accuracy penalty.
      Otherwise, it gains the \weapontag{Heavy} tag.

      Unlike other weapons, voidstone weapons are \glossterm{heavyweight}.
      That means a normal voidstone weapon requires a minimum Strength of 2, and a voidstone weapon that would normally have the \abilitytag{Heavy} tag requires a minimum Strength of 5.

      \parhead{Voidstone, Pure} A pure voidstone weapon deals 1d10 \glossterm{extra damage}, and all strikes with it have the \atEarth tag.
      In addition, it is staggeringly heavy, as voidstone.
...
\sectiongraphic*{Armor}{width=\columnwidth}{equipment/armor}
  ...
  \subsection{Armor Mechanics}
    ...
    \subsubsection{Armor Proficiency}\label{Armor Proficiency}
      ...
      In addition, you apply that armor's normal bonus to Armor defense as a penalty to your \glossterm{accuracy}.
    ...
    \subsubsection{Getting Into And Out Of Armor}
      ...
      \parhead{Don} This column tells how long it takes a character to put the armor on. (One minute is 10 turns.)
    ...
    \subsubsection{Weight and Size}
      ...
      All body armor and shields except for heavy body armor are \glossterm{lightweight} objects.
    ...
    \subsubsection{Barding}\label{Barding}
      ...
      The Armor defense bonus provided by barding is reduced by 1.
    ...
    \subsubsection{Using Multiple Armors}
      ...
      The Armor bonuses do not stack, but you use the highest Armor bonus from all of your shields.
  ...
  \subsection{Armor Table}
    \par Here is the format for armor entries (given as column headings on \trefnp{Armor}, below).
    ...
    \parhead{Dex Skills} This modifier applies to your Dexterity-based skills.
    If you use multiple armor pieces that modify this bonus, add the modifiers together.
    For example, a creature using full plate and a tower shield would have a \minus5 penalty to Dexterity-based skills.
    ...
    \begin{dtable!*}
      \tablebookmark{Armor}{armor}
      \lcaption{Armor}
      \begin{dtabularx}{\textwidth}{l c c c c c c >{\lcol}X c}
        \tb{Armor}             & \tb{Armor}   & \tb{Durability} & \tb{Vital Rolls} & \tb{Speed}   & \tb{Dex Bonus} & \tb{Dex Skills} & \tb{Material} & \tb{Item Rank (Cost)}  \tableheaderrule
        Light armor            &              &                 &                  &              &                &                 &               &            \\
        % 6 Armor + 1 dur = 7 points                                                                                                                
        \tind Buff leather     & \plus1       & \tdash          & \tdash           & \tdash       & \tdash         & \tdash          & Leather       & 1 (4 gp)   \\
        % 6 Armor + 2 dur - 1 rank = 7 points                                                                                                       
        \tind Mail shirt       & \plus1       & \plus1          & \tdash           & \tdash       & \tdash         & \tdash          & Metal         & 2 (20 gp)  \\
        % 6 Armor + 2 vit - 1 dex = 7 points                                                                                                        
        \tind Rawhide          & \plus1       & \tdash          & \plus1           & \tdash       & \tdash         & \minus1         & Leather       & 1 (4 gp)   \\
        \tind Buckler          & \plus1       & \tdash          & \tdash           & \tdash       & \tdash         & \tdash          & Metal or wood & 0 (1 gp)   \\
        Medium armor           &              &                 &                  &              &                &                 &               &            \\
        % 12 Armor + 2 dur + 2 vit - 1 dex - 1 rank = 14 points                                                                                     
        \tind Leather lamellar & \plus3       & \plus1          & \plus1           & \tdash       & \mult1/2       & \minus1         & Leather       & 1 (4 gp)   \\
        % 12 Armor + 3 dur + 2 vit - 2 dex - 1 rank = 14 points                                                                                     
        \tind Scale            & \plus3       & \plus2          & \plus1           & \tdash       & \mult1/2       & \minus2         & Metal         & 1 (4 gp)   \\
        % 12 Armor + 4 dur + 2 vit - 2 dex - 2 rank = 14 points                                                                                     
        \tind Brigandine       & \plus3       & \plus3          & \plus1           & \tdash       & \mult1/2       & \minus2         & Metal         & 2 (20 gp)  \\
        \tind Standard shield  & \plus2       & \tdash          & \tdash           & \tdash       & \mult1/2       & \tdash          & Metal or wood & 0 (1 gp)   \\
        Heavy armor            &              &                 &                  &              &                &                 &               &            \\
        % 15 Armor + 5 dur + 4 vit - 3 dex - 1 rank = 20 points                                                                                     
        \tind Breastplate      & \plus4       & \plus4          & \plus2           & \minus10 ft. & \mult1/2       & \minus3         & Metal         & 1 (4 gp)   \\
        % 15 Armor + 7 dur + 4 vit - 4 dex - 2 rank = 20 points                                                                                     
        \tind Half plate       & \plus4       & \plus6          & \plus2           & \minus10 ft. & \mult1/2       & \minus4         & Metal         & 2 (20 gp)  \\
        % 15 Armor + 8 dur + 4 vit - 4 dex - 3 rank = 20 points                                                                                     
        \tind Full plate       & \plus4       & \plus7          & \plus2           & \minus10 ft. & \mult1/2       & \minus4         & Metal         & 3 (100 gp) \\
        \tind Tower shield     & \plus2\fn{2} & \tdash          & \tdash           & \tdash       & \mult1/2       & \minus1         & Metal or wood & 1 (4 gp)   \\
        Extras                 &              &                 &                  &              &                &                 &               &            \\
        \tind Shield spikes    & \tdash       & \tdash          & \tdash           & \tdash       & \tdash         & \minus1         & Metal         & 1 (4 gp)   \\
      \end{dtabularx}
    \end{dtable!*}

  \subsection{Individual Armor Descriptions}
    Any special benefits or accessories to the types of armor found on \trefnp{Armor} are described below.
    \parhead{Buckler} This small metal shield is worn strapped to your forearm.
    At the start of your turn, you choose whether you treat the hand using a buckler as a \glossterm{free hand}.
    If you do, you can wield weapons or otherwise take actions using the arm bearing the buckler, but do not gain any benefits from the buckler until your next turn.
    ...
    A captured suit can be resized to fit a new owner with 8 hours of work and a \glossterm{difficulty value} 10 Craft (metalworking) check.
    The new owner must still be of the same size category and general body shape, such as humanoid, that the suit was originally designed for.
    ...
    While wielding a tower shield, you can take cover behind it as a \glossterm{standard action}.
    When you do, you \briefly are \shielded against all attacks, and you have \glossterm{cover} against all attacks that you are aware of.
  ...
  \subsectiongraphic*{Armor Special Materials}{width=\columnwidth}{equipment/armor special materials}
    ...
    Body armor that is made from a special material cannot have any magic item properties.
    ...
    \subsubsection{Armor Special Material Prices}
      ...
      \begin{dtable!*}
        ...
        \begin{dtabularx}{\textwidth}{l l l l >{\ccol}X l}
          \tb{Material}              & \tb{Durability} & \tb{Dex Skills} & \tb{Special Effect}                      & \tb{Material} & \tb{Item Rank (Cost)} \tableheaderrule
          % This is about 10 HP at r5 and 32 HP at r8.
          % That's probably okay given the Reflex and Strength costs.
          Adamantine\fn{1}           & \plus2          & \minus2         & Very heavy                               & Metal         & 5 (2,500 gp)   \\
          Adamantine, pure\fn{1}     & \plus4          & \minus2         & Very heavy                               & Metal         & 8 (312,500 gp) \\
          % magic defense                                                                                                                  
          Cold iron\fn{1}            & \minus1         & \tdash          & \minus1 Armor,  \plus1 defenses vs magic & Metal         & 2 (20 gp)      \\
          Cold iron, pure\fn{1}      & \minus2         & \tdash          & \minus1 Armor,  \plus2 defenses vs magic & Metal         & 5 (2,500 gp)   \\
          ...
          Dragonhide\fn{1}           & \plus1          & \tdash          & Resistant to specific energy type       & Leather       & 4 (500 gp)     \\
          ...
          Dragonscale\fn{1}          & \plus1          & \tdash          & Resistant to specific energy type       & Metal         & 4 (500 gp)     \\
          Dragonscale, ancient\fn{1} & \plus1          & \tdash          & Immune to specific energy type           & Metal         & 6 (12,500 gp)  \\
          % leather Reflex bonus                                                             
          Elvenweave                 & \tdash          & \plus1          & \tdash                                   & Leather       & 3 (100 gp)     \\
          Elvenweave, pure           & \plus1          & \plus1          & \tdash                                   & Leather       & 5 (2,500 gp)   \\
          % metal Reflex bonus                                            
          Mithral                    & \plus1          & \plus1          & \tdash                                   & Metal         & 4 (500 gp)     \\
          Mithral, pure              & \plus2          & \plus1          & \tdash                                   & Metal         & 7 (62,500 gp)  \\
          % stealth leather
          Shadeweave                 & \minus1         & \plus1          & \plus3 Stealth                           & Leather       & 4 (500 gp)     \\
          Shadeweave, umbral         & \minus1         & \plus1          & \plus5 Stealth                           & Leather       & 6 (12,500 gp)  \\
          % early metal resistance, dex skill penalty                                                                                                               
          Starmetal\fn{1}            & \plus1          & \minus2         & Very heavy                               & Metal         & 2 (20 gp)      \\
          Starmetal, pure\fn{1}      & \plus2          & \minus2         & Very heavy                               & Metal         & 4 (500 gp)     \\
        ...
        \end{dtabularx}
        1. This armor has special rules. \\
      \end{dtable!*}
      ...
      It also provides a \plus2 \glossterm{durability} bonus and a \minus2 penalty to Dexterity-based skills.

      \parhead{Adamantine, Pure} Pure adamantine body armor is heavier than other armor, as described by adamantine armor.
      It also provides a \plus4 \glossterm{durability} bonus and a \minus2 penalty to Dexterity-based skills.

      \parhead{Cold Iron} Cold iron armor grants you a \plus1 bonus to your defenses against \magical abilities.
      However, it provides \minus1 Armor defense and \minus1 \glossterm{durability} (minimum 0).

      \parhead{Cold Iron, Pure} Pure cold iron armor grants you a \plus2 bonus to your defenses against \magical abilities.
      However, it provides \minus1 Armor defense and \minus2 \glossterm{durability} (minimum 0).
      ...
      It also provides a \plus1 \glossterm{durability} bonus and makes you \resistant to attacks with that dragon's ability tag (see \tref{Dragon Types}).

      \parhead{Dragonhide, Ancient} Each ancient dragonhide body armor is made from the hide of a particular type of dragon.
      It also provides a \plus1 \glossterm{durability} bonus and makes you \buff{immune} to attacks with that dragon's ability tag (see \tref{Dragon Types}).
      ...
      It provides a \plus1 bonus to Dexterity-based skills, but reduces the \glossterm{durability} from the armor by 1 (minimum 0).
      ...
      In addition, it provides a \plus1 \glossterm{durability} bonus and a \minus2 penalty to your Dexterity-based skills.

      \parhead{Starmetal, Pure} Pure starmetal body armor is heavier than other armor, as described by adamantine armor.
      In addition, it provides a \plus2 \glossterm{durability} bonus and a \minus2 penalty to your Dexterity-based skills.
