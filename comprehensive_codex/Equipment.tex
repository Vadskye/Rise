...
\sectiongraphic*{Weapons}{width=\columnwidth}{equipment/weapons}
  ...
  \subsection{Weapon Tags}\label{Weapon Tags}
    ...
    \weapontagdef{Impact} When you miss by 4 or less with an Impact weapon, you still deal half damage.
...
\sectiongraphic*{Armor}{width=\columnwidth}{equipment/armor}
  ...
  \subsection{Individual Armor Descriptions}
    ...
    % TODO: it would be nice if you could take cover behind a tower shield somehow.
    ...
    When you do, you \briefly have \glossterm{cover} against all attacks that you are aware of.
