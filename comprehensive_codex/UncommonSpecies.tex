...
\sectiongraphic*{Tiefling}{width=\columnwidth}{optional rules/tiefling}
  ...
  \subsection{Tiefling Archetype}
    ...
    \magicalcf{Tif}[4]{Infernal Ancestry\plus} The benefits of your \textit{infernal ancestry} ability improve.
      \begin{itemize}
        ...
        \item Tempting Allure: You can charm creatures.
          \begin{magicalsustainability}{Charming Temptation}{\abilitytag{Emotion}, \abilitytag{Subtle}}
            \abilityusagetime Standard action.
            \rankline
    ...
    \magicalcf{Tif}[6]{Abysswalker\plus} Teleporting a given distance only costs movement equal to that distance.
    In addition, you can teleport in this way any number of times per phase.

    \magicalcf{Tif}[7]{Infernal Ancestry\plus\plus} The benefits of your \textit{infernal ancestry} ability reach their peak.
      \begin{itemize}
