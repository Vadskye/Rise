...
\section{Automaton}
  ...
  \subsection{Automaton Archetype}
    ...
    \cf{Aut}[7]{Steel To The Core} You are always \honed.
    When an ability would cause you to become honed, such as your \ability{steeling slash} ability, you become \braced instead.
