...
\section{Automaton}
  ...
  \subsection{Automaton Archetype}
    ...
    \cf{Aut}[1]{Modular Carapace} You can adjust the density and layering of your hardened exterior to augment your defenses.
      ...
      \begin{itemize}
        ...
        \item Medium armor: You gain a \plus5 bonus to your Armor defense, a \plus1 bonus to \glossterm{vital rolls}, and a damage resistance bonus equal to four times your rank in this archetype.
          However, your Dexterity bonus to your Armor defense is halved, and you cannot wear body armor.
        \item Heavy armor: You gain a \plus6 bonus to your Armor defense, a \plus2 bonus to \glossterm{vital rolls}, and a damage resistance bonus equal to six times your rank in this archetype.
    ...
    \cf{Aut}[2]{Modular Weaponry} You can customize your arms to augment your combat prowess.
      ...
      \begin{itemize}
        ...
        \item Blade: You convert one of your arms into a blade natural weapon.
          It has a \plus1 accuracy bonus, deals 1d8 damage, and has the \weapontag{Keen} and \weapontag{Sweeping} (1) weapon tags (see \pcref{Weapon Tags}).
        ...
        \item Bulk: You convert one of your arms into a bulky, overburdened slam natural weapon.
          It deals 1d10 damage and has the \weapontag{Impact} and \weapontag{Resonating} weapon tags.
          However, that arm no longer has a \glossterm{free hand}.
  ...
  \subsection{Base Class Effects}
    ...
    \cf{Aut}{Attributes} You gain a \plus1 bonus to your Constitution and Intelligence.
    ...
    \cf{Aut}{Resources}
      You learn four \glossterm{trained skills} from among your \glossterm{class skills} (see \pcref{Skills}). You also gain an additional \glossterm{attunement point}.
  ...
  \begin{itemize}
    \itemhead{Alter Shape} A changling can change its body using the \ability{alter shape} ability.
      \begin{activeability}{Alter Shape}
        ...
        This effect lasts until you \glossterm{dismiss} it as a \glossterm{free action}, or until you use this ability again.
      \end{activeability}
...
\section{Dragon}
  ...
  \begin{itemize}
    ...
    \itemhead{Draconic Wings} Dragons have scaly wings that sprout from their backs.
      These wings grant them a \glossterm{glide speed} equal to the \glossterm{base speed} for their size (see \pcref{Aerial Movement}).
    ...
    \itemhead{Multipedal} Dragons are \trait{multipedal}, which grants them a \plus10 foot bonus to their \glossterm{land speed} and a \plus5 bonus to the Balance skill.
  \end{itemize}
  ...
  \subsection{Dragon Archetype}
    ...
    \magicalcf{Dgn}[2]{Draconic Flight} Your wings grow larger, granting you a limited ability to fly.
      You gain a \glossterm{fly speed} equal to the \glossterm{base speed} for your size with a maximum height of 10 feet (see \pcref{Flight}).
    ...
    \magicalcf{Dgn}[6]{Draconic Flight+} The maximum height from your \textit{draconic flight} ability increases to 30 feet.
  ...
  \subsection{Base Class Effects}
    ...
    \cf{Drg}{Attributes} You gain a \plus1 bonus to your Strength and Constitution. In addition, you gain a \plus1 bonus to either your Intelligence or your Willpower.
    ...
    \cf{Drg}{Resources}
      You learn five \glossterm{trained skills} from among your \glossterm{class skills} (see \pcref{Skills}).
...
\section{Dryaidi}
  ...
  \subsection{Dryad Archetype}
    ...
    \magicalcf{Dry}[3]{Tree Stride+} You can \glossterm{teleport} between living trees instead of moving using your \glossterm{land speed}.
  ...
  \subsection{Base Class Effects}
    ...
    \cf{Dry}{Attributes}
      You gain a \plus1 bonus to your Dexterity and Perception. In addition, you gain a \plus1 bonus to either your Intelligence or your Willpower.

    \cf{Dry}{Hit Points}
      You have 6 hit points \add  your Constitution, plus 1 hit point per level beyond 1.
      This increases as your level increases, as indicated below.
      \begin{itemize}
        \itemhead{Level 7} 14 hit points \add twice your Constitution, plus 2 hit points per level beyond 7.
        \itemhead{Level 13} 30 hit points \add four times your Constitution, plus 4 hit points per level beyond 13.
        \itemhead{Level 19} 60 hit points \add eight times your Constitution, plus 8 hit points per level beyond 19.
      \end{itemize}
...
\section{Harpy}
  ...
  \subsection{Harpy Archetype}
    ...
    \cf{Hrp}[2]{Flight} You gain a \glossterm{fly speed} equal to the \glossterm{base speed} for your size with a maximum height of 10 feet (see \pcref{Flight}).
      As a \glossterm{free action}, you can increase your \glossterm{fatigue level} by one to ignore this height limit until the end of the round.
    ...
    \cf{Hrp}[6]{Sharp Talons+} Your talons deal 1d8 damage and gain the \weapontag{Keen} \glossterm{weapon tag}.
  ...
  \subsection{Base Class Effects}
    ...
    \cf{Hrp}{Attributes} You gain a \plus1 bonus to your Strength, Dexterity, and Perception.
...
\section{Incarnation}
  ...
  \subsection{Incarnation Archetype}
    ...
    \cf{Inc}[2]{Essence Flare} Whenever you use the \ability{total defense} or \ability{recover} abilities, you \glossterm{briefly} become \impervious to damaging attacks.
    ...
    \cf{Inc}[5]{Essence Infusion+} You become \glossterm{immune} instead of impervious to attacks with the tag from your \textit{essence infusion} ability.
    ...
    \cf{Inc}[6]{Deep Tether+} You gain a special ability depending on whether you are tethered or untethered.
      \begin{raggeditemize}
        \item Tethered: The fatigue tolerance bonus increases to \plus2.
          In addition, when you use the \ability{desperate exertion} ability to affect an attack with your \textit{essential infusion} tag, you can use this ability.
    ...
    \cf{Inc}[7]{Essence Incarnate}
      \begin{magicalactiveability}{Essence Incarnate}[\abilitytag{Swift}]
        ...
        \begin{raggeditemize}
          \item Tethered: You \glossterm{briefly} make attack and damage rolls twice, keeping the higher result, with abilities that have your \textit{essence infusion} tag.
  ...
  \subsection{Base Class Effects}
    ...
    \cf{Inc}{Attributes}
      If you are tethered, you gain a \plus1 bonus to your Constitution, and a \plus1 bonus to either your Strength or Dexterity.
      If you are untethered, you gain a \plus1 bonus to your Willpower, and a \plus1 bonus to either your Intelligence or Perception.
    ...
    \cf{Inc}{Resources}
      You learn three \glossterm{trained skills} from among your \glossterm{class skills} (see \pcref{Skills}).
      You also gain two additional \glossterm{attunement points}.
...
\section{Naiadi}
  ...
  \begin{itemize}
    \itemhead{Create Water} A naiadi can cast the \spell{create water} cantrip.
      ...
      This doubling is multiplicative with \ability{freshwater fountain} and any other ability which increases the water volume.
    ...
    \itemhead{Naiad Archetype} Naiads may choose three class archetypes, as normal.
  ...
  \subsection{Naiad Archetype}
    ...
    \magicalcf{Nai}[1]{Water Bond} You can form a bond with a fresh stream, lake, or other Gargantuan or larger body of fresh water (not salt water).
      ...
      As long as your bonded water remains clean, pure, and large enough to be a valid subject of bonding, you gain a \plus1 bonus to your Mental defense and \glossterm{magical power}.
      ...
      % TODO: redesign away from generic accuracy bonus
    ...
    \magicalcf{Nai}[4]{Water Bond+} The bonuses from your \textit{water bond} ability increase to \plus2.
    In addition, while your water bond is active, the bonuses from your \textit{enchanting appearance} ability are doubled.

    \magicalcf{Nai}[5]{Fluidseeker+} The accuracy bonus from your \textit{fluidseeker} ability increases to \plus2.

    \magicalcf{Nai}[5]{Freshwater Fountain+} The multiplier from your \textit{freshwater fountain} ability increases to five times the normal volume of water.

    \magicalcf{Nai}[6]{Aqueous Form+} When you cast the \spell{aqueous form} spell, it does not have the \abilitytag{Attune} tag.
      Instead, it lasts until you \glossterm{dismiss} it.

    \magicalcf{Nai}[7]{Supreme Water Bond} The bonuses from your \textit{water bond} ability increase to \plus3.
...
\sectiongraphic*{Oozeborn}{width=\columnwidth}{optional rules/oozeborn}
  ...
  \subsection{Base Class Effects}
    ...
    \cf{Ooz}{Attributes}
      You gain a \plus1 bonus to your Strength, Dexterity, and Constitution.
...
\section{Sapling}
  ...
  \subsection{Base Class Effects}
    ...
    \cf{Tre}{Attributes}
      You gain a \plus1 bonus to your Constitution. In addition, you gain a \plus1 bonus to either your Strength or your Willpower.
    ...
    \cf{Tre}{Resources}
      You learn four \glossterm{trained skills} from among your \glossterm{class skills} (see \pcref{Skills}).
  ...
  \subsection{Tiefling Archetype}
    \magicalcf{Tif}[1]{Abyssal Hop}
      \begin{magicalactiveability}{Abyssal Hop}[\atFire]
        ...
        \rank{5} The damage bonus increases to 1d6 per 3 power.
      ...
      \begin{itemize}
        \item Infernal Rebuke: You can set fire to your foes.
          \begin{magicalactiveability}{Infernal Rebuke}[\atFire]
            ...
            \rank{3} The damage bonus from your power increases to 1d6 per 3 power.
            \rank{4} The damage bonus increases to 1d6 per 2 power.
            \rank{5} The damage bonus increases to 1d8 per 2 power.
            \rank{6} The damage bonus increases to 1d10 per 2 power.
    ...
    \magicalcf{Tif}[3]{Abysswalker} You can use your \ability{abyssal hop} ability to teleport as a \glossterm{movement} instead of as a standard action.
      When you do, you do not deal damage at your destination, and you \glossterm{briefly} cannot use that ability as a movement again.
    ...
    \cf{Tif}[5]{Greater Hellfire Tolerance} You become \trait{immune} to \atFire attacks.
...
\section{Troll}
  ...
  \subsection{Troll Archetype}
    ...
    \cf{Trl}[2]{Tough Hide} You gain a bonus equal to three times your rank in this archetype to your \glossterm{hit points}.
      In addition, you gain a \plus1 bonus to your \glossterm{vital rolls} (see \pcref{Vital Wounds}).
  ...
  \subsection{Base Class Effects}
    ...
    \cf{Trl}{Attributes}
      You gain a \plus1 bonus to your Strength and Constitution.
    ...
    \cf{Trl}{Resources}
      You learn three \glossterm{trained skills} from among your \glossterm{class skills} (see \pcref{Skills}).
      You also gain an additional \glossterm{attunement point}.

    \cf{Trl}{Weapon Proficiencies}
      You are proficient with simple weapons and club-like weapons.

    \cf{Trl}{Armor Proficiencies}
      You are proficient with light armor, leather lamellar, and layered hide.
...
\section{Vampire}
  ...
  \begin{itemize}
    ...
    \itemhead{Running Water} Whenever a vampire touches or flies over running water, it takes 10 damage and \glossterm{briefly} becomes \immobilized.
  ...
  \subsection{Base Class Effects}
    ...
    \cf{Vmp}{Attributes}
      You gain a \plus1 bonus to your Dexterity. In addition, you gain a \plus1 bonus to either your Strength or your Intelligence.
