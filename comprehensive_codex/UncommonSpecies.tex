...
\section{Automaton}
  ...
  \subsection{Automaton Archetype}
    ...
    \magicalcf{Aut}[3]{Imbued Carapace} When you gain this ability, choose one magic body armor property for each of your three \ability{modular carapace} types (see \tref{Magic Body Armor}).
      ...
      Whenever you gain a rank in this archetype, you can choose a different property for each of your carapace types.
