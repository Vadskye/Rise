  ...
  \subsection{Sample Animal Hybrids}
    ...
    \begin{raggeditemize}
      ...
      \itemhead{Winged Agility} A hybrid bee has wings that are not strong enough to help it fly.
        ...
        While it is able to use its wings, it gains a \plus3 bonus to the Balance skill and a \plus5 foot bonus to its maximum horizontal jump distance (see \pcref{Jumping}).
    \end{raggeditemize}
...
\section{Harpy}\label{Harpy}
  ...
  \begin{raggeditemize}
    ...
    \itemhead{Winged Agility} While a harpy is able to use its wings, it gains a \plus2 bonus to Armor defense, a \plus3 bonus to the Balance skill, and a \plus5 foot bonus to its maximum horizontal jump distance (see \pcref{Jumping}).
  \end{raggeditemize}
  \parhead{Automatic Languages} Common.
