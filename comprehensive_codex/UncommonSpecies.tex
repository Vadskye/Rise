...
\section{Automaton}
  ...
  \subsection{Base Class Effects}
    ...
    \cf{Aut}{Resources}
      You learn three \glossterm{trained skills} from among your \glossterm{class skills} (see \pcref{Skills}). You also gain an additional \glossterm{attunement point}.
...
\section{Dryaidi}
  ...
  \subsection{Base Class Effects}
    ...
    \cf{Dry}{Resources}
      You learn five \glossterm{trained skills} from among your \glossterm{class skills} (see \pcref{Skills}). You also gain an additional \glossterm{attunement point}.
  ...
  \subsection{Harpy Archetype}
    ...
    \magicalcf{Hrp}[1]{Luring Song}
      \begin{magicalactiveability}{Luring Song}[\abilitytag{Auditory}, \abilitytag{Compulsion}]
        ...
        In addition, you begin a vocal performance (see \pcref{Performance}).
...
\section{Naiadi}
  ...
  \subsection{Naiad Archetype}
    ...
    \magicalcf{Nai}[4]{Water Bond+} The bonuses from your \textit{water bond} ability increase to \plus2 Mental defense and three times your rank in this archetype to your hit points.

    \magicalcf{Nai}[5]{Fluidseeker+} The accuracy bonus from your \textit{fluidseeker} ability increases to \plus2.

    \magicalcf{Nai}[5]{Freshwater Fountain+} The multiplier from your \textit{freshwater fountain} ability increases to twenty times the normal volume of water.
...
\section{Vampire}
  ...
  The creature's heart keeps pumping, its skin remains normal in appearance, and so on, giving the dead creature a convincing imitation of life.
  ...
  \begin{itemize}
    ...
    \itemhead{True Sunlight} Whenever a vampire is exposed to true sunlight, it takes 20 damage and becomes \blinded as a condition.
