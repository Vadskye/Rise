...
\section{Dryaidi}
  ...
  \subsection{Base Class Effects}
    ...
    \cf{Dry}{Defenses}
      ...
      In addition, you gain a \plus4 bonus to your Fortitude and Mental defenses.
...
\section{Harpy}
  ...
  \subsection{Base Class Effects}
    ...
    \cf{Hrp}{Defenses}
      You gain a \plus3 bonus to your Brawn, Fortitude, and Mental defenses.
      In addition, you gain a \plus5 bonus to your Reflex defense.
...
\section{Naiadi}
  ...
  \subsection{Base Class Effects}
    ...
    \cf{Nai}{Defenses}
      You gain a \plus3 bonus to your Brawn, Fortitude, and Reflex defenses.
      In addition, you gain a \plus5 bonus to your Mental defense.
...
\sectiongraphic*{Oozeborn}{width=\columnwidth}{optional rules/oozeborn}
  ...
  \subsection{Base Class Effects}
    ...
    \cf{Ooz}{Defenses}
      ...
      In addition, you gain a \plus5 bonus to your Fortitude defense.
...
\section{Troll}
  ...
  \subsection{Base Class Effects}
    ...
    \cf{Trl}{Defenses}
      You gain a \plus3 bonus to your Brawn, Mental, and Reflex defenses.
      In addition, you gain a \plus4 bonus to your Fortitude defense and a \plus1 bonus to your \glossterm{vital rolls}.
  ...
  \subsection{Vampire Archetype}
    ...
    \magicalcf{Vmp}[6]{Dominating Gaze}
      \begin{magicalactiveability}{Dominating Gaze}[\abilitytag{Emotion}, \abilitytag{Visual}]
        \abilityusagetime Standard action.
        \rankline
        Make an attack vs. Mental against all \glossterm{enemies} within a \medarea \glossterm{cone} from you.
