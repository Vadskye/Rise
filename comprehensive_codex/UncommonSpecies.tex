...
\section{Automaton}
  ...
  \subsection{Automaton Archetype}
    ...
    \cf{Aut}[1]{Modular Carapace} You can adjust the density and layering of your hardened exterior to augment your defenses.
      ...
      \begin{itemize}
        \item Light armor: You gain a \plus3 bonus to your Armor defense, and a bonus to your maximum damage resistance bonus to three times your rank in this archetype.
        ...
        \item Medium armor: You gain a \plus5 bonus to your Armor defense, a \plus1 bonus to \glossterm{vital rolls}, and a bonus to your maximum damage resistance equal to four times your rank in this archetype.
          However, your Dexterity bonus to your Armor defense is halved, and you cannot wear body armor.
        \item Heavy armor: You gain a \plus6 bonus to your Armor defense, a \plus2 bonus to \glossterm{vital rolls}, and a bonus to your maximum damage resistance equal to six times your rank in this archetype.
    ...
    \cf{Aut}[2]{Modular Weaponry} You can customize your arms to augment your combat prowess.
      ...
      \begin{itemize}
        ...
        \item Slim: You trim away the excess protection from both of your arms to make their movements more precise.
          You gain a \plus1 accuracy bonus with \glossterm{strikes} and \atBrawling abilities.
...
\section{Harpy}
  ...
  \subsection{Harpy Archetype}
    ...
    \cf{Hrp}[2]{Flight} You gain an average \glossterm{fly speed} with a maximum height of 10 feet (see \pcref{Flight}).
      As a \glossterm{free action}, you can increase your \glossterm{fatigue level} by one to ignore this height limit until the end of the round.
  ...
  \begin{itemize}
    ...
    \itemhead{Ingrain} A sapling can bury its roots into the ground.
      \begin{activeability}{Ingrain}
        ...
        It gains a \plus2 bonus to its Armor, Brawn, and Fortitude defenses.
...
\sectiongraphic*{Tiefling}{width=\columnwidth}{optional rules/tiefling}
  ...
  \subsection{Tiefling Archetype}
    ...
    \cf{Tif}[1]{Infernal Resilience} You gain a bonus equal to twice your rank in this archetype to your maximum \glossterm{damage resistance}.
