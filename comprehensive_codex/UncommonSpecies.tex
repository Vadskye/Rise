...
\section{Naiadi}
  ...
  \subsection{Naiad Archetype}
    ...
    \magicalcf{Nai}[1]{Water Bond} You can form a bond with a fresh stream, lake, or other Gargantuan or larger body of fresh water (not salt water).
      ...
      As long as your bonded water remains clean, pure, and large enough to be a valid subject of bonding, you gain a \plus2 \glossterm{enhancement bonus} to your Mental defense and \glossterm{vital rolls}.
    ...
    \magicalcf{Nai}[2]{Fluid Force} While your \textit{water bond} is active, all of your \magical attacks have the \atWater tag.
    In addition, you gain a \plus1 bonus to your \glossterm{magical power} and \glossterm{mundane power}.
    ...
    \begin{raggeditemize}
      ...
      \itemhead{Lake} You gain a bonus equal to three times your rank in this archetype to your \glossterm{hit points}.
      \itemhead{River or stream} You gain a \plus2 bonus to your Reflex defense.
        In addition, when you \ability{sprint} downhill, you gain a \plus10 foot bonus to your land speed.
    ...
    \begin{raggeditemize}
      ...
      \itemhead{River or stream} You gain a \plus10 foot \glossterm{enhancement bonus} to your speed with all movement modes.
  ...
  \subsection{Base Class Effects}
    ...
    \cf{Nai}{Defenses}
      You gain a \plus1 bonus to your Reflex and Mental defenses.
