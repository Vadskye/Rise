...
\section{Chimera}
  ...
  \begin{raggeditemize}
    ...
    If body parts are removed by a species, any abilities from other species that require those body parts are also removed.
    For example, a dragon harpy chimera would have two sets of wings, talons, and a bite natural weapon.
    However, it would not have claws, since its arms were removed by the harpy Wings ability.
    The Armor defense bonus from Draconic Scales would not stack with the Armor defense bonus from Winged Agility.
  \end{raggeditemize}
  \parhead{Automatic Languages} Common.
  ...
  \begin{dtable}
    ...
    \begin{dtabularx}{\columnwidth}{l >{\lcol}X}
      ...
      Harpy        & Limited Equipment, Prehensile Talons, Wings, Winged Agility (see \pcref{Harpy}) \\
