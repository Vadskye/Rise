...
o
    ...
    \magicalcf{Aut}[3]{Steeling Slash}
    \begin{activeability}{Steeling Slash}
        ...
        Then, you are \glossterm{briefly} \steeled.
    ...
    \magicalcf{Aut}[4]{Embedded Apparel} You can embed magic apparel into your body with an hour of work.
      ...
      This allows you to use one additional apparel item from each body slot.
    ...
    \cf{Aut}[7]{Steel To The Core} You are always \steeled.
    When an ability would cause you to become steeled, such as your \ability{steeling slash} ability, you become \braced instead.
      ...
      \begin{itemize}
        \item Infernal Rebuke: You can set fire to your foes.
          \begin{magicalactiveability}{Infernal Rebuke}[\atFire]
            ...
            You gain a \plus2 \glossterm{accuracy} bonus with this attack if the target attacked you during the previous round.
            \hit \damagerankthree.
