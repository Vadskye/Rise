...
\sectiongraphic*{Tiefling}{width=\columnwidth}{optional rules/tiefling}
  ...
  \subsection{Tiefling Archetype}
    ...
    \magicalcf{Tif}[3]{Abysswalker} You can use your \ability{abyssal hop} ability to teleport as a \glossterm{move action} instead of as a standard action.
      When you do, you do not deal damage at your destination, and you \glossterm{briefly} cannot use that ability as a move action again.
