\section{Poison}\label{Poison}
  ...
  \subsection{Poison Effects}\label{Poison Effects}
    ...
    On a critical hit, the poison also escalates.
    On a miss, the poison has no effect on you.

    While a creature is poisoned, the poison makes an attack against its Fortitude at the end of each of its turns.
    On a hit, the poison escalates.
    On a critical hit, the poison escalates again.
