...
\section{Advanced Movement}
  ...
  \subsection{Jumping}\label{Jumping}
    ...
    If your destination square is in midair, you do not start falling until the end of your turn.
    This allows you to jump using a \glossterm{move action} and then take a \glossterm{standard action} while midair.
