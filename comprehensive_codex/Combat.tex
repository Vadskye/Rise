...
\section{Combat Time}\label{Combat Time}
  ...
  \subsection{Turns}\label{Turns}
    ...
    Within your turn, you can take actions in any order.
    Once you have started an action, you must complete it before you use another action.
    For example, you can't use a \glossterm{standard action} halfway through the resolution of your \glossterm{move action} to move, attack, and then move away.
    As a special case, you can use \glossterm{free actions} and \glossterm{minor actions} during the resolution of \glossterm{move actions}.
...
\section{Initiative}\label{Initiative}
  ...
  \subsection{Initiative Groups}\label{Initiative Groups}
    ...
    Within an initiative group, each creature can take their turn in any order.
    Once one creature starts its turn, it must finish its turn before any other creature in its initiative group can act.
    After all creatures in an initiative group have acted, the next initiative group can act.

  \subsection{Initiative Example}
    Alice, Bob, Carol, and Dave are player characters in an adventuring party.
    They come across a group of goblins led by a shaman.
    Alice and Dave decide to act independently, while Bob declares Carol as his leader.
    The goblins all declare their shaman as their leader.
  ...
  \subsection{Deciding Turn Order}\label{Deciding Turn Order}
    Try not to spend too much time on the exact order of everyone's turns within your initiative group.
