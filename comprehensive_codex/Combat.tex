...
\section{Using Abilities}\label{Using Abilities}
  ...
  \subsection{Ability Targeting}
    ...
    \subsubsection{Targeting Proxy}\label{Targeting Proxy}
     Some effects allow you to use a creature, object, or location as a \glossterm{targeting proxy} when using abilities.
     When you use an ability through a targeting proxy, the ability takes effect as if you were in the targeting proxy's place.
     The ability's maximum range is measured from the targeting proxy rather than you.
