...
\section{Movement and Positioning}\label{Movement and Positioning}
  ...
  \subsection{Movement Speed}\label{Movement Speed}
    ...
    At the start of each round, your available movement speed becomes equal to your total movement speed.
    Any movement you make during that round subtracts from your available movement speed until it reaches 0.
    ...
    \subsubsection{Shared Movement Speed Limits}\label{Shared Movement Speed Limits}
      Any non-forced movement that moves you subtracts from your available movement speed, even if you aren't the one causing the movement.
      If your available movement speed reaches zero, you can't be moved any farther by non-forced movement, even if you're being carried by an ally.
  ...
  \subsection{Move Action Abilities}\label{Move Action Abilities}
    ...
    \begin{activeability}{Block}{Move action}
      ...
      If you beat it on the initiative check, it must spend additional movement equal to your remaining speed in order to move from its space.
      This consumes all of your remaining speed.
    ...
    \begin{activeability}{Climb Forward}{Move action}
      ...
      % TODO: a slow climb speed technically subtracts more from your speed than not having a climb speed?
  ...
  \subsection{Combining Movement Modes}
    ...
    Each distance moved subtracts from your available speed during that turn, using the appropriate modifiers for fast or slow movement modes.
  ...
  \subsection{Jumping}\label{Jumping}
    ...
    Modifiers to your available speed, such as the \ability{sprint} ability, do not affect your jumping distance.
...
\section{Universal Combat Abilities}\label{Universal Combat Abilities}
  ...
  \begin{dtable!*}
    ...
    \begin{dtabularx}{\textwidth}{l l X l}
      ...
      Jog                & Standard         & Triple your available speed                   & \tdash                                         \\
      ...
      Sprint             & Free             & Double your available speed                   & \tdash                                         \\
  ...
  \begin{activeability}{Jog}{Standard action}
    \rankline
    You gain a bonus to your \glossterm{available speed} this round equal to twice your speed.
  \end{activeability}
  ...
  \begin{activeability}{Sprint}{Free action}
    ...
    \rankline
    You gain a bonus to your \glossterm{available speed} this round equal to your speed.
  \end{activeability}
