...
\section{Combat Time}\label{Combat Time}
  ...
  \subsection{Initiative}\label{Initiative}
    When you first become aware of a combat, you determine your initiative order.
    You can roll initiative yourself, or choose an \glossterm{ally} to lead you.
    You or your chosen leader 
    Your initiative modifier is normally equal to the highest of your Dexterity, Perception, and Intelligence.
    Each creature in the combat takes a turn in order of their initiative.
  ...
  \subsection{Phases}\label{Phases}
    ...
    Phases do not represent a specific amount of time.
    ...
    \subsubsection{The Action Phase}\label{The Action Phase}
      ...
      Alternatively, you can use a \glossterm{move action} or an additional \glossterm{minor action} in place of your standard action.
  ...
  \subsection{Resolving Actions}\label{Resolving Actions}
    ...
    Once all allied groups have locally resolved their actions, the results of all those actions are announced.
    ...
    This might seem strange if you're used to other games that always resolve one action at a time.
    However, this situation is not uncommon in fantasy fiction, and it's certainly possible in real life.
    ...
    \subsubsection{Swift Abilities}\label{Swift Abilities}
      ...
      For example, the \textit{reckless attack} ability immediately reduces your defenses, which affects attacks against you during the current phase, and makes a \glossterm{strike} with the normal timing.
    ...
    \subsubsection{Deciding Action Order}\label{Deciding Action Order}
      Try not to spend too much time on the exact order of everyone's actions within your allied group.
    ...
    \subsubsection{Group Size Limits}\label{Group Size Limits}
      There is a limit to how many creatures can coordinate in combat.
      In general, no more than twenty creatures can constitute an allied group that resolves sequentially with itself.
  ...
  \subsection{Conflicting Actions}\label{Conflicting Actions}
    ...
    Both creatures simply move as far as they can, and the creatures' relative \glossterm{speeds} determine who is more successful.
    ...
    This can help prevent melee characters from feeling stuck or useless.
