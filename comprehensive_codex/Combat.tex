...
\section{Aerial Movement}\label{Aerial Movement}
  ...
  A flying or gliding creature must make a \glossterm{movement} using its fly or glide speed during its turn.
  If it does not move during a turn, it falls by 300 feet at the end of that turn (see \pcref{Falling Damage}).
  ...
  \subsection{Gliding}\label{Gliding}
    A creature with a glide speed can use a \glossterm{move action} to fall slowly while controlling its direction.
  ...
  \subsection{Flight}\label{Flight}
    ...
    It can also remain in place, though it must still make a \glossterm{movement} each turn to avoid falling.
