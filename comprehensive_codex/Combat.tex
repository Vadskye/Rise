...
\section{Movement and Positioning}\label{Movement and Positioning}
  ...
  \subsection{Movements}\label{Movements}
    ...
    You can also move during the \glossterm{action phase} with the \ability{sprint} ability (see \pcref{Sprint}), or by simply taking a \glossterm{move action} in place of your standard action.

    When a creature makes a movement, it travels a distance in feet equal to its \glossterm{movement speed}, assuming it has a relevant \glossterm{movement mode}.
