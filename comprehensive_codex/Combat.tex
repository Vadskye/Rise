  ...
  \subsection{Dual Strikes}\label{Dual Strikes}
    ...
    \begin{raggeditemize}
      ...
      \item Throwing axe and handaxe: \minus1 accuracy, 1d6\plus1d4 damage, Thrown (30/60)
        % = +2a light, -3a base
      \item Warhammer and light hammer: \minus1 accuracy, 1d8\plus1d6 damage, Impact+ (glance if miss by 8 or less), Versatile Grip (irrelevant unless you have three hands)
    \end{raggeditemize}
