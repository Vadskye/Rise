...
\section{Combat Time}\label{Combat Time}
  ...
  \subsection{Rounds}\label{Rounds}
    ...
    During each round, each creature in the combat takes one \glossterm{turn}.
    The order of those turns is determined by rolling \glossterm{initiative} (see \pcref{Initiative}).
    Once everyone has taken a turn, the round ends and the next round begins.
  ...
  \subsection{Turns}\label{Turns}
    ...
    Once you have taken all of the actions you intend to take, your turn is done.

    You typically share a turn with other members of your party rather than having your own turn to yourself.
    For details, see \pcref{Initiative Groups}.
...
\section{Initiative}\label{Initiative}
  ...
  You just roll 1d10 and add your initiative modifier.

  Your initiative modifier is normally equal to half the highest of your Dexterity, Perception, and Intelligence.
  ...
  \subsection{Initiative Groups}\label{Initiative Groups}
  ...
  \subsection{Initiative Example}
    ...
    There are three turns in the final combat order:

    \begin{enumerate}
      \item Bob and Carol
      \item The troll and goblins
      \item Alice and Dave
    \end{enumerate}
  ...
  \subsection{Delaying Your Turn}
    You can freely delay your turn in a round to join a later initiative group.
...
\section{Basic Movement}\label{Basic Movement}
  ...
  \subsection{Movement Speed}\label{Movement Speed}
    Your \glossterm{speed} is how far you can move during a typical round.
    ...
    \subsubsection{Shared Movement Limits}\label{Shared Movement Limits}
      ...
      For example, you can't move your full speed onto a mount and then have that mount move with you in the same round.
...
\section{Obstacles and Cover}\label{Obstacles and Cover}
  ...
  \subsection{Cover}\label{Cover}
    ...
    If an attack would miss the defense of a creature or object behind cover, the attack is applied to the obstacle instead of the intended target.
...
\section{Special Combat Rules}
  ...
  \subsection{Mounted Combat}\label{Mounted Combat}
    ...
    \parhead{Combat while Mounted} You must make a \glossterm{difficulty value} 5 Ride check one per round as a \glossterm{free action} while riding a mount.
    Success means you can guide and stay on your mount without using your hands.
    Failure means you must use one \glossterm{free hand} to control your mount, or you fall off if you cannot free a hand.
