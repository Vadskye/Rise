...
\section{Strikes}\label{Strikes}
  ...
  \subsection{Dual Strikes}\label{Dual Strikes}
    ...
    When you make a dual strike, you take a \minus2 accuracy penalty.
    ...
    \begin{raggeditemize}
        % = +2a both weapons, +2a light, -2a base
      \item Broadsword and smallsword: \plus2 accuracy, 1d6\plus1d4 damage, Versatile Grip (irrelevant unless you have three hands)
        % = +2a both weapons, +3a light, -2a base
      \item Two kukris: \plus3 accuracy, 2d4 damage, Sweeping (2)
        % = +3a light, -2a base
      \item Two kama: \plus1 accuracy, 2d4 damage, Keen+ (\plus4 accuracy with critical hits)
        % = -2a both weapons, -2a base
      \item Two totokias: \minus4 accuracy, 2d10 damage, Impact+ (glance if miss by 8 or less)
        % = +2a light, -2a base
      \item Throwing axe and handaxe: \plus0 accuracy, 1d6\plus1d4 damage, Thrown (30/60)
        % = -1a warhammer, +2a light, -2a base
      \item Warhammer and light hammer: \minus1 accuracy, 1d8\plus1d4 damage, Impact+ (glance if miss by 8 or less), Versatile Grip (irrelevant unless you have three hands)
    \end{raggeditemize}
