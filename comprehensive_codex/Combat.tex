...
\section{Combat Time}\label{Combat Time}
  ...
  \subsection{Turns}\label{Turns}
    ...
    This means you can't use a \glossterm{move action} to move halfway through the resolution of your standard action.
...
\section{Initiative}\label{Initiative}
  ...
  Initiative order proceeds from highest to lowest.
  ...
  % TODO: solve double mounted movement without preventing "I teleport you and then you walk the rest of the way"
  % \subsubsection{Only One Movement Per Phase}\label{Only One Movement Per Phase}
  %   Any effects that would change the same creature's location in the same phase are conflicting, and only one is applied.
  ...
  %   Only the first effect that would change your location is applied, and all other effects are ignored.
...
\section{Movement and Positioning}\label{Movement and Positioning}
  ...
  \subsection{Movement Abilities}\label{Movement Abilities}
    ...
    The main requirement is that a reactive movement must have a simple criterion for determining how you move based on easily observable events.
    ...
    \begin{activeability}{Follow}{Move action}
      \rankline
      Choose a creature you can see, and the maximum distance you want to follow it at.
  ...
  \subsection{Jumping}\label{Jumping}
    ...
    Modifiers to your current speed, such as the \ability{sprint} ability, do not affect your jumping distance.
    ...
    If your destination square is in midair, you do not start falling until the next phase.
  ...
  \subsection{Jumping Speed Limits}
    The maximum distance that you can travel by jumping is equal to your remaining \glossterm{speed} during the current phase.
...
\section{Universal Combat Abilities}\label{Universal Combat Abilities}
  ...
  \begin{dtable!*}
    ...
    \begin{dtabularx}{\textwidth}{l l X l}
      ...
      Recover            & Standard         & Regain HP, remove conditions                  & \abilitytag{Swift}                             \\
  ...
  \begin{activeability}{Sprint}{Standard action}
    ...
    \abilitycost You can increase your \glossterm{fatigue level} by one to use this ability as a \glossterm{move action}.
    \rankline
    % TODO: Awkward wording
    You can immediately take a \glossterm{move action} other than this ability.
