...
\section{Universal Combat Abilities}\label{Universal Combat Abilities}
  ...
  \begin{activeability}{Charge}{Standard action}
    \rankline
    After using this ability, you \glossterm{briefly} take a \minus2 penalty to all defenses.
  ...
  \begin{activeability}{Escape Grapple}{Standard action}
    ...
    The defense of each creature is equal to the attack result of its \ability{maintain grapple} ability this round, or 0 if it did not use that ability.
  ...
  \begin{activeability}{Maintain Grapple}{\glossterm{Free action}}
    ...
    The result of this roll \glossterm{briefly} determines how difficult it is for a creature to escape the grapple using the \textit{escape grapple} ability.
