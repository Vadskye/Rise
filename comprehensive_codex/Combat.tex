...
\section{Combat Time}\label{Combat Time}
  ...
  \subsection{Simultaneous Damage and Healing}\label{Simultaneous Damage and Healing}
    ...
    For example, suppose you end your turn with 5 hit points.
    At the end of your turn, you regenerate to heal 20 hit points and burn for 10 damage.
    You would end up at 15 hit points, having not gained a vital wound.
...
\section{Initiative}\label{Initiative}
  ...
  Your initiative modifier is normally equal to the highest of your Dexterity, Perception, and Intelligence.
