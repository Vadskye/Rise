...
\section{Basic Movement}\label{Basic Movement}
  ...
  \subsection{Movement Speed}\label{Movement Speed}
    ...
    At the start of each of your turns, your available movement becomes equal to your speed.
...
\section{Universal Combat Abilities}\label{Universal Combat Abilities}
  ...
  \begin{activeability}{Charge}{Standard action}
    \rankline
    After using this ability, you \momentarily take a \minus2 penalty to all defenses.
  ...
  \begin{activeability}{Maintain Grapple}{\glossterm{Free action}}
    ...
    The result of this roll \momentarily determines how difficult it is for a creature to escape the grapple using the \textit{escape grapple} ability.
...
\section{Special Combat Rules}
  ...
  \subsection{Mounted Combat}\label{Mounted Combat}
    ...
    At the start of each of your turns, you must make a \glossterm{difficulty value} 10 Ride check to control such a horse.
