...
\sectiongraphic*{Making Attacks}{width=\columnwidth}{core mechanics/making attacks}
  ...
  \subsection{Attack Results}
    ...
    \subsubsection{Glancing Blows}\label{Glancing Blows}
      ...
      Damaging attacks deal half damage on a glancing blow unless otherwise specified.
    ...
    \subsubsection{Critical Hits}\label{Critical Hits}
      ...
      Damaging attacks deal double damage on a critical hit unless otherwise specified.
...
\section{Calculating Damage}
  This section details how damage is calculated, including special circumstances.
  ...
  \subsection{Extra Damage}\label{Extra Damage}
    ...
    Extra damage functions like inherent attack damage: it's halved on a glancing blow, doubled on critical hits, and so on. Attacks that deal double damage also double their extra damage, and some attacks specifically double any extra damage that applies to them.
...
\section{Taking Damage}\label{Taking Damage}
  ...
  \subsection{Negative Hit Points}\label{Negative Hit Points}
    ...
    This also resets vital wound thresholds, meaning you'll suffer a vital wound if your hit points go negative again in the next round.
  ...
  \subsection{Environmental Damage}\label{Environmental Damage}
    ...
    Environmental damage functions like normal damage, but your \glossterm{damage resistance} reduces it without being consumed. Any excess environmental damage reduces your \glossterm{hit points}.
...
\sectiongraphic*{Vital Wounds}{width=\columnwidth}{core mechanics/vital wounds}
  ...
  \subsection{Vital Rolls}\label{Vital Rolls}
    ...
    This includes vital wounds that do not have an additional specific effect.
...
\section{Combat Time}\label{Combat Time}
  This section details how time passes in combat.
  ...
  \subsection{Phases}\label{Phases}
    ...
    \subsubsection{The Action Phase}\label{The Action Phase}
      ...
      Alternately, you can use a \glossterm{move action} or an additional \glossterm{minor action} in place of your standard action.
  ...
  \subsection{Resolving Actions}\label{Resolving Actions}
    ...
    You resolve your actions without knowing enemy actions, as enemy actions resolve as if they occurred before yours. This means your actions cannot be interrupted by enemies, and vice-versa.
    ...
    In a typical combat, this just means that the GM will tell you what the monsters did to you after you tell the GM what you did to them.
        ...
        With this system, it's possible for two combatants to kill each other during the same phase, leaving both dead! This system allows for simultaneous mutual destruction, a common trope in fantasy fiction.
...
\section{Movement and Positioning}\label{Movement and Positioning}
  This section details how creatures move and position themselves.
  ...
  \subsection{Speed Categories}\label{Speed Categories}
    ...
    \begin{raggeditemize}
      \item Fast: Moving 10 feet with this movement mode costs 5 feet from the creature's speed.
        The first 5 feet of movement costs 5 feet of speed, and the next 5 feet are free.
...
\section{Aerial Movement}\label{Aerial Movement}
  ...
  To use a fly or glide speed, a creature must not exceed its maximum \glossterm{carrying capacity} (see \pcref{Weight Limits}) or have any \glossterm{encumbrance} (see \pcref{Encumbrance}).
  ...
  \subsection{Gliding}\label{Gliding}
    A creature with a glide speed uses a \glossterm{movement} to fall slowly while controlling its direction.
...
\section{Universal Combat Abilities}\label{Universal Combat Abilities}
  ...
  \begin{activeability}*{Charge}
    ...
    As this ability lacks the \abilitytag{Swift} tag, it does not affect attacks made against you during the current phase.
  ...
  \begin{activeability}*{Desperate Exertion}
    ...
    You can use this ability after learning the outcome of the original roll, or even its effects if normally discernible.
  ...
  \begin{activeability}*{Escape Grapple}[\abilitytag{Brawling}]
    ...
    The defense of each creature is equal to the result of its last \textit{maintain grapple} attack, or 0 if it didn\'t use that ability.
  ...
  \begin{activeability}*{Recover}[\abilitytag{Swift}]
    ...
    Then, you regain all of your \glossterm{hit points} and \glossterm{damage resistance}.
...
\section{Obstacles and Cover}\label{Obstacles and Cover}
  Obstacles can impede attacks by blocking \glossterm{line of sight} or \glossterm{line of effect}, or by providing \glossterm{cover}. This section explains how to deal with these limitations.
  ...
  \subsection{Point of Origin}\label{Point of Origin}
    ...
    Cylinders and spheres without a range radiate from your entire space. For total size, treat every grid intersection touching your space as a point of origin. For cover and similar effects, use the grid intersection closest to the target.
