...
\section{Obstacles and Cover}\label{Obstacles and Cover}
  ...
  \subsection{Point of Origin}\label{Point of Origin}
    ...
    Otherwise, non-\glossterm{emanation} abilities use a grid intersection of your choice that is touching your space, just like targeted attacks.
    Emanations are unusual, since they radiate from your whole body instead of a single point.
