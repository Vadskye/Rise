...
\section{Universal Abilities}\label{Universal Abilities}
  ...
  \subsection{Dual Strikes}\label{Dual Strikes}
    ...
    All magical properties from both weapons apply to the combined weapon if possible.
    Numeric bonuses like \glossterm{extra damage} from magical properties stack, even if you have the same magical property on both weapons..
