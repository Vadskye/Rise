...
\section{Universal Combat Abilities}\label{Universal Combat Abilities}
  ...
  \begin{dtable!*}
    ...
    \begin{dtabularx}{\textwidth}{l l X l}
      ...
      Run                & Standard         & Triple your available movement                & \tdash                                         \\
      Shove              & Move or standard & Move a foe                                    & \abilitytag{Brawling}                          \\
      Sprint             & Free             & Double your available movement                & \tdash                                         \\
      Total Defense      & Standard         & Gain \plus2 to all defenses                   & \tdash                                         \\
  ...
  \begin{activeability}{Run}{Standard action}
    \rankline
    You add twice your \glossterm{speed} to your \glossterm{available movement}.
  \end{activeability}
