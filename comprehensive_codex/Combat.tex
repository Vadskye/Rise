...
\section{Strikes}\label{Strikes}
  ...
  \subsection{Dual Strikes}\label{Dual Strikes}
    ...
    \begin{raggeditemize}
        % = +1a smallsword, +2a light, -3a base
      \item Broadsword and smallsword: \plus0 accuracy, 1d6\plus1d4 damage, Sweeping (1), Versatile Grip (irrelevant unless you have three hands)
