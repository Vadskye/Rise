...
\section{Universal Combat Abilities}\label{Universal Combat Abilities}
  ...
  % TODO: it would be nice if this removed your available movement to avoid yoyoing, but the wording is awkward.
  \begin{activeability}{Charge}{Standard action}
    \rankline
    After using this ability, you take a \minus2 penalty to all defenses until your next turn.
    ...
    \rankline
    \featlevel{12} The strike deals double damage.
