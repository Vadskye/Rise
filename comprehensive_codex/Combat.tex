...
\section{Universal Combat Abilities}\label{Universal Combat Abilities}
  ...
  \begin{dtable!*}
    ...
    \begin{dtabularx}{\textwidth}{l l X l}
      ...
      Maintain Grapple   & Free action      & Continue grappling with a foe                 & \abilitytag{Brawling}                          \\
  ...
  \begin{activeability}{Escape Grapple}{Standard action}
    ...
    The defense of each creature is equal to the attack result of its \ability{maintain grapple} ability, or 0 if it did not use that ability.
  ...
  \begin{activeability}{Maintain Grapple}{\glossterm{Free action}}
    \abilitytags \abilitytag{Brawling}
    \rankline
    % TODO: Awkward wording
    You can use this ability once per turn while you are grappling another creature.
    ...
    The result of this roll \briefly determines how difficult it is for a creature to escape the grapple using the \textit{escape grapple} ability.
    If you do not use this ability while you are in a grapple, creatures can easily escape the grapple with the \textit{escape grapple} ability.
  \end{activeability}
