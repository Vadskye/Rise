...
\section{Universal Combat Abilities}\label{Universal Combat Abilities}
  ...
  \begin{activeability}{Ready Reaction}{Standard action}
    ...
    Until your next turn, if your intended action ever becomes possible, it happens.
    ...
    This means that you can't use this ability to kill an enemy before their attack hits you, and an enemy can't invalidate your reaction by moving in range and then moving back out again in the same turn.
