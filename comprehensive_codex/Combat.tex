...
% TODO: Clean up this wording, this whole section is awkward with the movement -> move action change
  ...
  \subsection{Move Action Abilities}\label{Move Action Abilities}
    ...
    \begin{activeability}{Climb Forward}{Move action}
      ...
      Success means that you move along the surface to a location.

      % TODO: a slow climb speed technically subtracts more from your available movement than not having a climb speed?
      If you have a climb speed, you use that to determine the maximum distance you can move with this ability.
      Otherwise, you move a maximum distance equal to the vertical size of your space (see \pcref{Size Categories}).
      Critical success means you can use twice the vertical size of your space instead.
    \end{activeability}
    ...
    \begin{activeability}{Swim Forward}{Move action}
      \abilitytags \atPhysical
      \rankline
      This ability requires being immersed in a liquid like water and using two \glossterm{free hands}, or using one free hand if you take a \minus5 penalty to your Swim check.
      ...
      If you have a swim speed, you use that to determine the maximum distance you can move with this ability.
      Otherwise, you move a maximum distance equal to a quarter of your \glossterm{base speed}.
      Critical success means the maximum distance increases to half of your base speed.
    \end{activeability}
...
\section{Advanced Movement}
  ...
  \subsection{Jumping}\label{Jumping}
    ...
    If you are trained with the Jump skill, the distance you add from your Strength is instead equal to 5 feet per Strength, to a minimum of \plus5 feet.
    ...
    \subsubsection{Jumping Speed Limits}
      ...
      This limits both your maximum horizontal distance and your maximum vertical height.
  ...
  \subsection{Forced Movement}\label{Forced Movement}
    ...
    \subsubsection{Push Effects}\label{Push Effects}
      ...
      Success means that the creature does not fall, but is now hanging on the edge, making it \unsteady if it does not have a \glossterm{climb speed}.
...
\section{Universal Combat Abilities}\label{Universal Combat Abilities}
  ...
  % Is this a fling effect? What happens if you throw someone into a wall?
  \begin{activeability}{Throw}{Standard action}
    \abilitytags \atBrawling, \atPhysical
    \rankline
...
\section{Special Combat Rules}
  ...
  \subsection{Mounted Combat}\label{Mounted Combat}
    ...
    At the start of your turn, you must make a \glossterm{difficulty value} 10 Ride check to control such a horse.
    ...
    \parhead{Combat while Mounted} You must make a \glossterm{difficulty value} 5 Ride check at the start of your turn while riding a mount.
