...
\section{Universal Abilities}\label{Universal Abilities}
  ...
  \subsection{Dual Strikes}\label{Dual Strikes}
    ...
    Numeric bonuses from both weapons stack, even if you have the same magical property or weapon tag on both weapons.
    For example, using two Flaming weapons would give you 2d4 \glossterm{extra damage}, and using two Keen weapons would give you a \plus4 accuracy bonus with critical hits.
    ...
    \begin{raggeditemize}
      ...
      \item \weapontag{Light}: You gain a \plus1 accuracy bonus for each Light weapon.
      \item \weapontag{Long}: Only functions if both weapons are Long.
      \item \weapontag{Maneuverable}: Only functions if both weapons are Maneuverable.
      ...
      \item \weapontag{Resonating}: If you use two Resonating weapons, the defense penalty stacks.
    ...
    \begin{raggeditemize}
      ...
      \item Two rapiers: \plus0 accuracy, 2d4 damage, Keen+ (\plus4 accuracy with critical hits).
        % = +0a 2d10, -6a exotic base
      \item Two totokias: \minus6 accuracy, 2d10 damage, Impact+ (glance if miss by 8 or less)
