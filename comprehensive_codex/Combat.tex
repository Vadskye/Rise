...
\section{Basic Movement}\label{Basic Movement}
...
\section{Advanced Movement}
  ...
  \subsection{Jumping}\label{Jumping}
    ...
    If your destination square is \glossterm{midair}, you do not start falling or become \unsteady until the end of your turn.
