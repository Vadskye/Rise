...
\section{Initiative}\label{Initiative}
  ...
  \subsection{Delaying Your Turn}
    ...
    You can't extend the duration of \glossterm{brief} effects by delaying your turn.
...
\section{Basic Movement}\label{Basic Movement}
  ...
  \subsection{Movement Speed}\label{Movement Speed}
    ...
    At the start of each round, your available movement becomes equal to your speed.
    Any movement you make during that round subtracts from your available movement until it reaches 0.
