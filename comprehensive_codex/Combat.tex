...
\section{Calculating Damage}
  ...
  \subsection{Weapon Damage}\label{Weapon Damage}
    \glossterm{Strikes} deal damage based on the weapon you use them with.
    Your \glossterm{weapon damage} is normally equal to the weapon's damage die or dice, as defined in the Equipment chapter (see \pcref{Weapons}).
...
\section{Strikes}\label{Strikes}
  ...
  Your \glossterm{damage} with a strike is normally equal to your \glossterm{weapon damage} with the weapon you hit with, plus half your relevant \glossterm{power}.
  ...
  \begin{activeability}{Basic Strike -- Melee}{Standard action}
    ...
    % TODO: wording
    \hit You deal the target damage equal to your \glossterm{weapon damage} plus half your \glossterm{mundane power}.
  \end{activeability}
