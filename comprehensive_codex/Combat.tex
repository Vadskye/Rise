...
\section{Movement and Positioning}\label{Movement and Positioning}
  ...
  \subsection{Movement Modes}\label{Movement Modes}
    ...
    \parhead{Walking}
    A creature with a walking speed can move across mostly flat surfaces, like the ground.
  ...
  \subsection{Combining Movement Modes}
    ...
    For example, assume you have a 40 foot base speed, a average walking speed, and a slow swim speed.
...
\section{Aerial Movement}\label{Aerial Movement}
  ...
  \subsection{Flight}\label{Flight}
    ...
    \begin{sustainability}{Soaring Flight}{\atSustain (standard)}
      ...
      \rankline
      While this ability is active, you can ignore your maximum height with your fly speed.
