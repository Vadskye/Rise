...
\section{Universal Combat Abilities}\label{Universal Combat Abilities}
  ...
  \begin{dtable!*}
    ...
    \begin{dtabularx}{\textwidth}{l l X l}
      ...
      Jog                & Standard         & Triple your available movement                & \tdash                                         \\
  ...
  \begin{activeability}{Jog}{Standard action}
    \rankline
    You gain a bonus to your \glossterm{available movement} this round equal to twice your \glossterm{speed}.
  \end{activeability}
  ...
  \begin{activeability}{Shove}{Standard action}
    ...
    \hit You can move up to half your \glossterm{speed} without reducing your \glossterm{available movement}.
  ...
  \begin{activeability}{Sprint}{Free action}
    ...
    \rankline
    You gain a bonus to your \glossterm{available movement} this round equal to your \glossterm{speed}.
  \end{activeability}
