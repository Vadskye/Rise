...
\sectiongraphic*{Making Attacks}{width=\columnwidth}{combat/making attacks}
  ...
  \subsection{Attack Outcomes}
    ...
    \subsubsection{Glancing Blows}\label{Glancing Blows}
      If you make a damaging attack and the attack result is 1 or 2 lower than the target's defense, you get a \glossterm{glancing blow} against that target.
      ...
      Some abilities trigger on both glancing blows and missed attacks.
...
\section{Strikes}\label{Strikes}
  ...
  \subsection{Dual Strikes}\label{Dual Strikes}
    ...
    \begin{raggeditemize}
      ...
      \item \abilitytag{Impact}: If you use two Impact weapons, you get a glancing blow when you would miss by 8 or less.
    ...
    \begin{raggeditemize}
      ...
      \item Warhammer and light hammer: \minus2 accuracy, 1d8\plus1d4 damage, Impact+ (glance if miss by 8 or less), Versatile Grip (irrelevant unless you have three hands)
        % = +2a both weapons, +3a light, -3a base
