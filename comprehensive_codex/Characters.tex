  ...
  \subsection{Injury Point}\label{Injury Point}
    ...
    \begin{columntable}
      \begin{dtabularx}{\columnwidth}{l l X}
        ...
        1         & 5            & Half \glossterm{durability}                             \\
        2         & 5            & 1 \x \glossterm{durability}                             \\
        3         & 5            & \glossterm{durability} \add half \glossterm{durability} \\
        4         & 5            & 2 \x \glossterm{durability}                             \\
        5         & 5            & 3 \x \glossterm{durability}                             \\
        6         & 5            & 4 \x \glossterm{durability}                             \\
        7         & 5            & 5 \x \glossterm{durability}                             \\
      \end{dtabularx}
    \end{columntable}
