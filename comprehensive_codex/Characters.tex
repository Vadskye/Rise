...
\section{Combat Statistics}\label{Combat Statistics}
  ...
  \subsection{Defenses}\label{Defenses}
    ...
    \begin{itemize}
      ...
      \itemhead{Reflex} 3 \add Half level \add Dexterity
...
\sectiongraphic*{Character Advancement and Gaining Levels}{width=\columnwidth}{characters/character advancement}
  ...
  \begin{raggeditemize}
    \item At 4th level, you gain an additional \glossterm{insight point} (see \pcref{Insight Points}).
    ...
    \item At 5th level, and every 6 levels thereafter, you increase any two of your \glossterm{attributes} by 1 (see \pcref{Attributes}).
