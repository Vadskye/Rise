...
\section{Combat Statistics}\label{Combat Statistics}
  ...
  \subsection{Defenses}\label{Defenses}
    ...
    \begin{itemize}
      ...
      \itemhead{Brawn} 3 \add Half level \add Strength
      \itemhead{Fortitude} 3 \add Half level \add Constitution
      \itemhead{Reflex} 3 \add Half level \add Dexterity \add defense bonuses from equipped shield
      \itemhead{Mental} 3 \add Half level \add Willpower
    \end{itemize}
...
\section{Resources}\label{Resources}
  ...
  \subsection{Insight Points}\label{Insight Points}
    ...
    If your base insight point total is negative, it offsets any insight points you would gain from other sources, such as from being a gnome.
  ...
  \subsection{Size Categories}\label{Size Categories}
    ...
    \begin{dtable*}
      ...
      \begin{dtabularx}{\textwidth}{l l l l l l l l X}
        ...
        Fine       & 1/4 ft.          & 10 ft.          & \minus4 Str              & \minus4    & \plus4      & \plus20      & \tdash                   & Fly                   \\
        Diminutive & 1/2 ft.          & 10 ft.          & \minus3 Str              & \minus3    & \plus3      & \plus15      & \tdash                   & Mouse                 \\
        Tiny       & 1 ft.            & 20 ft.          & \minus2 Str              & \minus2    & \plus2      & \plus10      & \tdash                   & Rat                   \\
        Small      & 2-1/2 ft.        & 20 ft.          & \minus1 Str              & \minus1    & \plus1      & \plus5       & \tdash                   & Cat                   \\
        Medium     & 5 ft.            & 30 ft.          & \tdash                   & \tdash     & \tdash      & \tdash       & \tdash                   & Human                 \\
        Large      & 10 ft.           & 40 ft.          & \plus1 Str               & \plus1     & \minus1     & \minus5      & \tdash                   & Ogre                  \\
        Huge       & 20 ft.           & 50 ft.          & \plus2 Str               & \plus2     & \minus2     & \minus10     & \weapontag{Sweeping} (1) & Hill giant            \\
        Gargantuan & 40 ft.           & 60 ft.          & \plus3 Str               & \plus3     & \minus3     & \minus15     & \weapontag{Sweeping} (2) & Roc                   \\
        Colossal   & 80\add ft.       & 80 ft.          & \plus4 Str               & \plus4     & \minus4     & \minus20     & \weapontag{Sweeping} (4) & Great wyrm red dragon \\
      \end{dtabularx}
...
\sectiongraphic*{Character Advancement and Gaining Levels}{width=\columnwidth}{characters/character advancement}
  ...
  \begin{raggeditemize}
    ...
    \item At 5th, and every 6 levels thereafter, you increase any two of your \glossterm{attributes} by 1 (see \pcref{Attributes}).
    \item At 6th level, you gain a \glossterm{legacy item} (see \pcref{Legacy Items}).
      Every 3 levels thereafter, your legacy item improves, as shown in \trefnp{Character Advancement and Gaining Levels}.
  \end{raggeditemize}
  ...
  \begin{dtable}
    ...
    \begin{compresseddtabularx}{\columnwidth}{l l l X l}
      \tb{Level} & \tb{Rank} & \tb{Bonus}\fn{2} & \tb{Special}               & \tb{XP} \tableheaderrule
      1st        & 1         & \tdash           & \tdash                     & 0      \\
      2nd        & 1         & \plus1           & \tdash                     & 10     \\ % +10 xp
      3rd        & 1         & \plus1           & \tdash                     & 25     \\ % +15 xp
      4th        & 2         & \plus2           & \tdash                     & 45     \\ % +20 xp
      5th        & 2         & \plus2           & \plus1 to two attributes   & 70     \\ % +25 xp
      6th        & 2         & \plus3           & Legacy item: rank 3        & 100    \\ % +30 xp
      7th        & 3         & \plus3           & \tdash                     & 140    \\ % +40 xp
      8th        & 3         & \plus4           & \tdash                     & 200    \\ % +60 xp
      9th        & 3         & \plus4           & Legacy item: ranks 3 and 3 & 300    \\ % +100 xp
      10th       & 4         & \plus5           & \tdash                     & 450    \\ % +150 xp
      11th       & 4         & \plus5           & \plus1 to two attributes   & 700    \\ % +250 xp
      12th       & 4         & \plus6           & Legacy item: ranks 5 and 3 & 1,000  \\ % +300 xp
      13th       & 5         & \plus6           & \tdash                     & 1,400  \\ % +400 xp
      14th       & 5         & \plus7           & \tdash                     & 2,000  \\ % +600 xp
      15th       & 5         & \plus7           & Legacy item: ranks 5 and 5 & 3,000  \\ % +1000 xp
      16th       & 6         & \plus8           & \tdash                     & 4,500  \\ % +1,500 xp
      17th       & 6         & \plus8           & \plus1 to two attributes   & 7,000  \\ % +2,500 xp
      18th       & 6         & \plus9           & Legacy item: ranks 7 and 5 & 10,000 \\ % +3,000 xp
      19th       & 7         & \plus9           & \tdash                     & 14,000 \\
      20th       & 7         & \plus10          & \tdash                     & 20,000 \\
      21st       & 7         & \plus10          & Legacy item: ranks 7 and 7 & 30,000 \\
