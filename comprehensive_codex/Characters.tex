...
\section{Combat Statistics}\label{Combat Statistics}
  ...
  \subsection{Hit Points}\label{Hit Points}
    ...
    Your hit points are equal to your \glossterm{character rank} \mult your \glossterm{durability}, plus 10 additional hit points.
  ...
  \subsection{Durability}\label{Durability}
    Your \glossterm{durability} is used to calculate your \glossterm{hit points}, as described above in Hit Points.
    It is equal to your Constitution \add \glossterm{base class} durability bonus \add body armor durability bonus.
