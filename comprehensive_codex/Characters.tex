...
\section{Resources}\label{Resources}
  ...
  \subsection{Stamina}\label{Stamina}
    Throughout the day, you can expend stamina to power your abilities and exertions both in and out of combat.
    While \glossterm{hit points} are easy to restore, restoring your current \glossterm{stamina} generally requires a \glossterm{long rest}.
    Stamina is still easier to recover than \glossterm{vital wounds}.

    \subsubsection{Stamina}\label{Stamina Level}
      Your current \glossterm{stamina} measures your remaining energy.
      Some abilities cost stamina when used, such as the \ability{desperate exertion} ability (see \pcref{Universal Abilities}).

    \subsubsection{Maximum Stamina}\label{Maximum Stamina}
      Your maximum \glossterm{stamina} represents the peak amount of energy you can exert before you begin to suffer from exhaustion.
      Your maximum stamina is equal to a bonus from your \glossterm{base class} \add your Constitution.
      Some abilities can increase your maximum stamina.

    \subsubsection{Stamina Penalty}\label{Stamina Penalty}
      Expending your stamina beyond 0 is detrimental.
      If your current stamina falls below 0, you take a penalty to \glossterm{accuracy} and \glossterm{checks} equal to the amount below 0 (e.g., if you are at \minus2 stamina, you take a \minus2 penalty).
    ...
    \subsubsection{Recovering Stamina}
      When you finish a \glossterm{long rest}, your current \glossterm{stamina} is restored to your maximum stamina (see \pcref{Resting}).
      There are no other ways to recover stamina.

    \subsubsection{Paying Stamina Costs}
      Some abilities indicate that they cost a certain amount of stamina.
      That means that you reduce your stamina by the given amount after the ability resolves.
      This means you do not suffer a \glossterm{stamina penalty} from that spent stamina while using the ability.
      You can even use abilities that cause you to drop unconscious from spent stamina.
