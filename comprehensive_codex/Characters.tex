...
\section{Combat Statistics}\label{Combat Statistics}
  ...
  \subsection{Accuracy}\label{Accuracy}
    ...
    \subsubsection{Brawling Accuracy}\label{Brawling Accuracy}
      ...
      Commonly used Brawling abilities are listed in \pcref{Special Combat Abilities}.
...
\sectiongraphic*{Character Advancement and Gaining Levels}{width=\columnwidth}{characters/character advancement}
  ...
  \begin{raggeditemize}
    ...
    \item At 5th, 8th, 11th, and 17th level, you increase any two of your \glossterm{attributes} by 1 (see \pcref{Attributes}).
  ...
  \begin{dtable}
    ...
    \begin{compresseddtabularx}{\columnwidth}{l l l X l}
      \tb{Level} & \tb{Max Rank}\fn{1} & \tb{Bonus}\fn{2} & \tb{Special}                        & \tb{XP} \tableheaderrule
      1st        & 1                   & \tdash           & \tdash                              & 0      \\
      2nd        & \tdash              & \plus1           & \tdash                              & 10     \\ % +10 xp
      3rd        & \tdash              & \plus1           & \tdash                              & 25     \\ % +15 xp
      4th        & 2                   & \plus2           & \tdash                              & 45     \\ % +20 xp
      5th        & \tdash              & \plus2           & \plus1 to two attributes            & 70     \\ % +25 xp
      6th        & \tdash              & \plus3           & Legacy item: rank 3                 & 100    \\ % +30 xp
      7th        & 3                   & \plus3           & \tdash                              & 140    \\ % +40 xp
      8th        & \tdash              & \plus4           & \plus1 to two attributes            & 200    \\ % +60 xp
      9th        & \tdash              & \plus4           & Legacy item: ranks 3 and 3          & 300    \\ % +100 xp
      10th       & 4                   & \plus5           & \tdash                              & 450    \\ % +150 xp
      11th       & \tdash              & \plus5           & \plus1 to two attributes            & 700    \\ % +250 xp
      12th       & \tdash              & \plus6           & Legacy item: ranks 5 and 3          & 1,000  \\ % +300 xp
      13th       & 5                   & \plus6           & \tdash                              & 1,400  \\ % +400 xp
      14th       & \tdash              & \plus7           & \tdash                              & 2,000  \\ % +600 xp
      15th       & \tdash              & \plus7           & Legacy item: ranks 5 and 5          & 3,000  \\ % +1000 xp
      16th       & 6                   & \plus8           & \tdash                              & 4,500  \\ % +1,500 xp
      17th       & \tdash              & \plus8           & \plus1 to two attributes            & 7,000  \\ % +2,500 xp
      18th       & \tdash              & \plus9           & Legacy item: ranks 7 and 5          & 10,000 \\ % +3,000 xp
      19th       & 7                   & \plus9           & \tdash                              & 14,000 \\
      20th       & \tdash              & \plus10          & \tdash                              & 20,000 \\
      21st       & \tdash              & \plus10          & Legacy item: ranks 7 and 7          & 30,000 \\
