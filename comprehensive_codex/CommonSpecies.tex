...
\sectiongraphic*{Dwarves}{width=\columnwidth}{common species/dwarf}
  ...
  \begin{raggeditemize}
    ...
    \itemhead{Slow and Steady} Dwarves have a \minus10 foot penalty to their \glossterm{speed}.
      However, they ignore all other penalties to their speed, such as the penalty from wearing heavy body armor (see \pcref{Armor}).
      This does not affect movement through \glossterm{difficult terrain} and similar effects, since those affect movement cost rather than your character's personal speed.
  \end{raggeditemize}
...
\sectiongraphic*{Elves}{width=\columnwidth}{common species/elf}
  ...
  \parhead{Special Abilities}
  \begin{raggeditemize}
    \itemhead{Elven Perfection} Elves only reduce their \glossterm{stamina} by one when using the \ability{desperate exertion} ability to affect checks (see \pcref{Desperate Exertion}).
    ...
    \itemhead{Sure-Footed} Elves gain a \plus1 bonus to the Poise and Stealth skills (see \pcref{Poise}, and \pcref{Stealth}).
