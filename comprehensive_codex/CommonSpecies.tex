...
\sectiongraphic*{Elves}{width=\columnwidth}{common species/elf}
  ...
  \parhead{Special Abilities}
  \begin{raggeditemize}
    \itemhead{Elven Perfection} Elves only gain one \glossterm{stamina} when using the \ability{desperate exertion} ability to affect checks (see \pcref{Desperate Exertion}).
