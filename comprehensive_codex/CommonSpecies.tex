...
\sectiongraphic*{Humans}{width=\columnwidth}{characters/human}
  ...
  \begin{raggeditemize}
    \itemhead{Versatile} Humans gain a \plus1 bonus to any two attributes.
      ...
      They can be increased above 3 by other means, such as by your \glossterm{base class} or by the attribute bonus at level 3 (see \pcref{Character Advancement and Gaining Levels}).
  \end{raggeditemize}
...
\sectiongraphic*{Gnomes}{width=\columnwidth}{characters/gnome}
  ...
  \begin{raggeditemize}
    ...
    \itemhead{Tinkerer} Gnomes gain a \plus1 bonus to all Craft skills (see \pcref{Craft}).
  \end{raggeditemize}
...
\sectiongraphic*{Half-Elves}{width=\columnwidth}{characters/halfelf}
  ...
  \parhead{Size} Medium.
  \parhead{Attributes} \minus1 Constitution, \plus1 to one of the following: Dexterity, Intelligence, Perception, or Willpower.
  \parhead{Special Abilities}
  \begin{raggeditemize}
    \itemhead{Cross-Cultural Experience} Half-elves do not need to spend an \glossterm{insight point} to gain access to their first additional class (see \pcref{Multiclass Characters}).
...
\sectiongraphic*{Half-Orcs}{width=\columnwidth}{characters/halforc}
  ...
  \parhead{Special Abilities}
  \begin{raggeditemize}
    \itemhead{Cross-Cultural Experience} Half-orcs do not need to spend an \glossterm{insight point} to gain access to their first additional class (see \pcref{Multiclass Characters}).
    ...
    \itemhead{Pure Brawn} Half-orcs gain a \plus2 bonus to their Brawn defense.
  \end{raggeditemize}
