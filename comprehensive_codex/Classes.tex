...
\section{How Classes Work}
  ...
  \subsection{Archetypes}\label{Archetypes}
    ...
    \subsubsection{Archetype Ranks}\label{Archetype Ranks}
      ...
      Your rank in any individual archetype cannot exceed your \glossterm{character rank} (see \pcref{Character Rank}).
  ...
  \subsection{Late Multiclassing}
    If you have multiple archetypes when you become a multiclass character, you may exchange any number of your existing archetypes for that many archetypes from your new class.
