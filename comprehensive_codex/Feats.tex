...
\section{Feat Descriptions}
  ...
  \begin{magicalfeat}{Celestial Ancestry}{Ancestry, Magical}
    ...
    \begin{magicalactiveability}{Scouring Light}{Standard action}
      \abilitycost You \glossterm{briefly} cannot use this ability again.
      \rankline
      Make an attack vs. Reflex against all enemies in a \medarealong, 10 ft. wide line from you.
      Whether you hit or miss, each target suffers a \minus2 penalty to its Armor and Reflex defenses this round, and you \glossterm{briefly} radiate \glossterm{brilliant illumination} in a \medarea radius from you.
      \hit \damageranktwo.
      \rankline
      ...
      \featlevel{21} The damage increases to \damagerankseven.
    \end{magicalactiveability}
