...
\section{Feat Descriptions}
  ...
  \begin{magicalfeat}{Celestial Ancestry}{Ancestry, Magical}
    ...
    \magicalff[6]{Divine Radiance} You radiate \glossterm{brilliant illumination} in a \medarea radius from you.
    You can suppress or resume this illumination once per round as a \glossterm{free action}.
    ...
    \begin{magicalactiveability}{Scouring Light}{Standard action}
      ...
      Whether you hit or miss, each target suffers a \minus2 penalty to its Armor and Reflex defenses this round.
      \hit \damageranktwo.
      \rankline
  ...
  \begin{magicalfeat}{Spellsword}{Magical, Spell}
    ...
    \begin{magicalactiveability}{Spellstrike}{Standard action}
      ...
      \featlevel{18} The extra damage increases to 1d6 \add your \glossterm{power}.
    \end{magicalactiveability}

    \magicalff[12]{Spellshield} You gain a \plus1 \glossterm{enhancement bonus} to your Armor and Reflex defenses.
    If you are holding a non-weapon implement in at least one hand, this bonus increases by 1.

    \magicalff[18]{Mystic Blade} Any \glossterm{extra damage} from magic properties on one weapon you wield also applies to damaging spells you cast, even if the extra damage would normally only apply to strikes with that weapon.

    \magicalff[18]{Spellshield\plus} The bonuses increase to \plus2.
  \end{magicalfeat}
