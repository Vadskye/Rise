...
\section{Feat Descriptions}
  ...
  \begin{feat}{Battle Armory}{Combat}
    ...
    \magicalff[6]{Rapid Attunement} Once per round, you can use the \ability{item attunement} ability to attune to a weapon or armor as a \glossterm{free action} (see \pcref{Item Attunement}).
  ...
  \begin{feat}{Heavenly Warrior}{Combat}
    ...
    \begin{activeability}{Call to Heaven}{Standard action}
      ...
      This jump ignores the normal limit on jumping farther than your base speed would allow.
  ...
  \begin{feat}{Iron Will}{General}
    ...
    \ff[12]{Mental Discipline\plus} The defense bonus from your \textit{mental discipline} ability increases to \plus6.
  ...
  \begin{feat}{Swiftrunner}{General}
    ...
    \ff[1]{Burst of Speed} Once per round, when you use the \ability{sprint} or \ability{jog} abilities, you gain additional \glossterm{available movement} equal to your speed.
  ...
  \begin{feat}{Toughness}{General}
    ...
    \ff[6]{Durable} You gain a \plus4 bonus to your \glossterm{durability}.

    \ff[12]{Fortified Body\plus} The defense bonus from your \textit{fortified body} ability increases to \plus6.
  ...
  \begin{feat}{Trickshot}{Combat}
    ...
    \ff[6]{Carom} Whenever you make a \glossterm{strike} with an arrow, you can have it bounce off of one obstacle before it reaches its destination.
    You use the square on the obstacle that you bounce off of as a \glossterm{targeting proxy} for your strike.
    The obstacle takes no damage, but it must be at least Small size and stable.
    You measure the total distance travelled by the arrow from you to the obstacle, and from the obstacle to the target, to determine the range of your attack.

    You take a \minus2 accuracy penalty with the strike when you use this ability.
    If you cannot see the target, you suffer the normal 50\% miss chance for making a blind targeted attack.

    \ff[12]{Alchemical Arrow\plus} When you use an alchemical item with a rank lower than your character rank, the alchemical arrow lasts for ten minutes before it is destroyed.
    This can allow you to prepare multiple alchemical arrows before combat.
    You still cannot recover alchemical items from arrows prepared with this ability, so preparing an alchemical arrow always consumes the item.

    \ff[18]{Carom\plus} You no longer take an accuracy penalty when you use this ability.
  \end{feat}
