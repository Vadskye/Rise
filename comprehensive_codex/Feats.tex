...
\section{Feat Descriptions}
  ...
  \begin{magicalfeat}{Ghostblade}{Combat, Magical}
    ...
    \magicalff[1]{Ghost Step} When you use the \ability{jog} or \ability{sprint} abilities, you can become \trait{invisible} until the end of your turn (see \pcref{Jog}, and \pcref{Sprint}).
    ...
    \magicalff[12]{Ghost Step\plus} When you use the \ability{jog} or \ability{sprint} abilities, you can become \trait{incorporeal} until the end of your turn.
  ...
  \begin{feat}{Swiftrunner}{General}
    ...
    \ff[1]{Burst of Speed} Once per turn, when you use the \ability{sprint} or \ability{jog} abilities, you gain additional \glossterm{available movement} equal to your speed.
    ...
    \ff[12]{Water Runner} When you use the \ability{sprint} or \ability{jog} ability, you can move on water and similar liquids as if they were solid ground during that turn.

    \magicalff[18]{Cloud Runner} When you use the \ability{sprint} or \ability{jog} ability, you can clouds, fog, and similar gaseous substances as if they were solid ground during that turn.
