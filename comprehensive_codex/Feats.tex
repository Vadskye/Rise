...
\section{Feat Descriptions}
  ...
  \begin{feat}{Leadership}{Combat}
    ...
    \begin{activeability}{Bolster}{Standard action}
      \abilitytags \atAuditory, \abilitytag{Emotion}, \abilitytag{Swift}
      \abilitycost You \glossterm{briefly} cannot use this ability again.
      \rankline
      Each \glossterm{ally} within a \largearea radius from you is either \empowered or \steeled this round.
      You must make the same choice for all allies. 
      \rankline
      \featlevel{18} Each target is both empowered and steeled this round.
    \end{activeability}
  ...
  \begin{magicalfeat}{Sphere Focus: Thaumaturgy}{Casting, Magical}
    ...
    \begin{magicalactiveability}{Countermagic}{Standard action}
      \abilitytags \abilitytag{Subtle}, \abilitytag{Swift}
      \abilitycost You \glossterm{briefly} cannot use this ability again.
      \rankline
      Choose a creature within \rngmed range of you.
      If the target uses a \magical ability as a standard action or \glossterm{elite action} this round, that ability has no effect.
