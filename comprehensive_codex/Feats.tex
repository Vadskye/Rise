...
\section{Feat Descriptions}
  ...
  \begin{magicalfeat}{Celestial Ancestry}{Ancestry, Magical}
    ...
    \begin{magicalsustainability}{Scouring Light}{Standard action}
      ...
      \begin{raggeditemize}
        \item Never: \areamedlong, 5 ft. wide line
        \item Once: \areamedlong, 10 ft. wide line
  ...
  \begin{feat}{Juggernaut}{Combat}
    ...
    \ff[1]{Unstoppable} You are immune to being \slowed, and your movement speed is not reduced by \glossterm{difficult terrain}.
  ...
  \begin{feat}{Leadership}{Combat}
    ...
    \begin{activeability}{Battle Command}{Standard action}
      ...
      The target becomes \focused and gains a \plus1 accuracy bonus until the start of your next turn.
    ...
    \ff[6]{Combat Leader} You gain a \plus2 bonus to \glossterm{initiative}.
    ...
    \ff[18]{Combat Leader+} The bonus increases to \plus4.
  \end{feat}
  ...
  \begin{feat}{Precognition}{General}
    ...
    \ff[6]{Combat Prediction} You gain a \plus2 bonus to \glossterm{initiative}.

    \ff[12]{Foresight\plus} The bonus increases to \plus4.
    In addition, you are never \partiallyunaware.

    \ff[18]{Combat Prediction\plus} The bonus increases to \plus4.
  \end{feat}
  ...
  \begin{feat}{Regenerator}{General}
    ...
    \begin{activeability}{Regenerative Recovery}{Standard action}
      ...
      If you gained any \glossterm{vital wounds} last round, your healing with this ability is doubled.
  ...
  \begin{magicalfeat}{Sphere Focus: Thaumaturgy}{Casting, Magical}
    ...
    \begin{magicalactiveability}{Countermagic}{Standard action}
      ...
      Until the start of your next turn, if the target uses a \magical ability as a standard action or \glossterm{elite action}, that ability has no effect.
