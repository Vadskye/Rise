...
\section{Feat Descriptions}
  ...
  \begin{feat}{Swiftrunner}{General}
    ...
    \ff[1]{Rapid Movement} You gain a \plus10 foot bonus to your \glossterm{land speed}.

    \ff[6]{Sprinter} When you use the \textit{sprint} ability, you can move up to triple your movement speed.
