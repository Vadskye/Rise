...
\section{Feat Descriptions}
  ...
  \begin{magicalfeat}{Metacaster}{Casting, Magical}
    ...
    \magicalff[18]{Adaptive Metamagic\plus} You can choose an additional spell you know with your \textit{adaptive metamagic} ability.
  ...
  \begin{magicalfeat}{Spellsword}{Magical, Spell}
    ...
    \begin{magicalactiveability}{Spellstrike}
      ...
      \featlevel{18} The strike deals double damage.
    \end{magicalactiveability}
    ...
    \magicalff[18]{Spellsword Conduit\plus} The accuracy bonus increases to \plus4.
  \end{magicalfeat}
  ...
  \begin{magicalfeat}{Sphere Focus: Umbramancy}{Casting, Magical}
    ...
    \magicalff[1]{Lightbane} You can cast the \spell{passing shadow} \glossterm{cantrip} from the Umbramancy mystic sphere as a \glossterm{minor action}.
    ...
    \magicalff[18]{Lightbane\plus} When you cast your \textit{suppress light} cantrip, you can choose to completely block all light in the area instead of dimming it to be \glossterm{shadowy illumination}.
