...
\section{Feat Descriptions}
  ...
  \begin{feat}{Draconic Ancestry}{Ancestry}
    ...
    \ff[18]{Scales\plus} The Armor defense bonus from your \textit{scales} ability increases to \plus2.
  ...
  \begin{feat}{Duelist}{Combat}
    ...
    \ff[1]{Duel Focus} At the start of your turn, you may choose a creature you can see.
    Until your next turn, you gain a \plus1 bonus to your defenses against that creature's attacks.
  ...
  \begin{feat}{Shieldbearer}{Combat}
    ...
    \ff[12]{Shield Expertise\plus} Both Armor defense bonuses from this ability increase to \plus2.

    \ff[18]{Shield Cover} While you wield a shield, you can use your Armor defense in place of your Reflex defense against \glossterm{area} attacks.
  \end{feat}
  ...
  \begin{magicalfeat}{Wardweaver}{Casting, Magical}
    ...
    \magicalff[1]{Hardened Barriers} Objects you create using abilities with the \abilitytag{Barrier} \glossterm{ability tag} gain a bonus equal to your \glossterm{power} to their maximum \glossterm{hit points}.
    ...
    \magicalff[18]{Hardened Barriers\plus} The hit point bonus from your \textit{hardened barriers} ability increases to twice your \glossterm{power}.
  \end{magicalfeat}
