...
\section{Feat Descriptions}
  ...
  \begin{magicalfeat}{Mystic Synthesist}{Casting, Magical}
    ...
    \magicalff[12]{Unbound Creativity} You can apply two metamagic effects to your spells, rather than the normal limit of one.
    If a spell has two metamagic effects on it, you take a \minus1 accuracy penalty with it.

    \magicalff[18]{Prolific Inventor\plus} The number of additional insight points increases to two.
