...
\section{Feat Descriptions}
  ...
  \begin{feat}{Brawler}{Combat}
    ...
    \ff[1]{Unarmed Warrior} You deal 1d6 damage with the punch/kick \glossterm{natural weapon} (see \pcref{Natural Weapons}).
    ...
    \ff[12]{Unarmed Warrior\plus} The damage increases to 1d8.
    ...
    \ff[18]{Unarmed Warrior\plus\plus} The damage increases to 1d10.
  \end{feat}
  ...
  \begin{feat}{Living Weapon}{Combat}
    ...
    \ff[1]{Made of Iron} You gain a \plus4 bonus to your defenses when determining whether an attack gets a \glossterm{critical hit} against you instead of a normal hit.
    ...
    \ff[12]{Forged in the Flame of Life} You gain a \plus1 bonus to your Constitution.
