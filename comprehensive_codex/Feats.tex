...
\section{Feat Descriptions}
  ...
  \begin{feat}{Duelist}{Combat}
    ...
    \begin{activeability}{Deliver the Duel}
      ...
      If you are the creature's only \glossterm{enemy} adjacent to it, you deal 1d4 \glossterm{extra damage}.
      If that creature is not adjacent to any of its \glossterm{allies}, you deal 1d4 \glossterm{extra damage}.
      This extra damage stacks if both circumstances apply.

      \rankline
      \featlevel{9} The extra damage from both circumstances increases to 1d8.
      ...
      \featlevel{18} The extra damage from both circumstances increases to 4d6.
    \end{activeability}
