...
\section{Feat Descriptions}
  ...
  \begin{feat}{Awareness Specialization}{Skill}
    ...
    \ff[12]{Specialization\plus} The bonus from your \textit{specialization} ability increases to \plus6.
  ...
  \begin{feat}{Ride Specialization}{Skill}
    ...
    \ff[18]{Mounted Defense\plus} The defense bonus from your \textit{mounted defense} ability increases to \plus6.
  ...
  \begin{magicalfeat}{Sphere Focus: Aeromancy}{Casting, Magical}
    ...
    \magicalff[18]{Distant Winds\plus} The range bonus from your \textit{distant winds} ability increases to \plus60 feet.
  \end{magicalfeat}
