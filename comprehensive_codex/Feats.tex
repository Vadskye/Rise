...
\section{Gaining Feats}
  ...
  \subsection{Species Bonus Feats}\label{Species Bonus Feats}
    ...
    \parhead{Elf} Any Casting feat (see \pcref{Casting Feats}), or any from the following list: \featref*{Awareness Specialization} and \featref*{Poise Specialization}, \featref*{Sniper}, or \featref*{Rapid Reaction}.

    \parhead{Halfling} Any feat with a Dexterity or Willpower prerequisite, or any skill feat for a Dexterity-based skill.

    \parhead{Kobold} Any Casting feat (see \pcref{Casting Feats}), or any from the following list: \featref*{Draconic Ancestry}, \featref*{Fortune's Friend}, \featref*{Rapid Reaction}, or \featref*{Spellwarped}.

    \parhead{Mixed} Any feat.
    ...
    \subsubsection{Uncommon Species}
      ...
      \parhead{Animal Hybrid} Any feat strongly associated with the chosen animal. For example, a hybrid shark might choose from Athletics Specialization, Awareness Specialization, Living Weapon, Survival Specialization, or Swiftrunner. A hybrid wolf might choose from Awareness Specialization, Living Weapon, Rapid Reaction, Stealth Specialization, Survival Specialization, or Swiftrunner.

      \parhead{Awakened Animal} Any feat strongly associated with the chosen animal. For example, an awakened cat might choose from Awareness Specialization, Flexibility Specialization, Rapid Reaction, Stealth Specialization, or Swiftrunner.
      ...
      \parhead{Eladrin} Boongiver, Chameleon, Deception Specialization and Persuasion Specialization, Maneuverist, or Spellwarped.

      \parhead{Kit} Poise Specialization and Stealth Specialization, Deception Specialization and Social Insight Specialization, or Swiftrunner.

      \parhead{Naiadi} Boongiver, Leadership, Mental Magic, Persuasion Specialization and Social Insight Specialization, or Sphere Focus: Aquamancy.

      \parhead{Oozeborn} Blindfighter, Chameleon, Athletics Specialization and Flexibility Specialization, Juggernaut, Regenerator, Sphere Focus: Toxicology, or Toughness.
...
\section{Feat Mechanics}
  ...
  \subsection{Feat Tags}
    ...
    \parhead{Combat} Combat feats enhance your martial combat abilities.
    ...
    \parhead{Ancestry Feats} These feats allow characters with unusual ancestry to gain relevant abilities.
    ...
    \begin{longcolumn}
      \begin{longtablewrapper}
        ...
        \begin{longtable}{>{\lcol}p{13em} >{\lcol}p{10em} l >{\lcol}p{8em} >{\lcol}p{3em}}
          ...
          \featref{Beef}                                  & Str 3                            & Increase brawn and strength                & \tdash            & \featpref{Beef}                     \\
          ...
          \magicalfeatref{Entropist}                      & Con 1, Wil 2                     & Master chaos and entropy                   & Magical           & \featpref{Entropist}                        \\
          ...
          \magicalfeatref{Legacy Item}                    & \tdash                           & Gain a special magic item                  & Magical           & \featpref{Legacy Item}                             \\
          ...
          \featref{Athletics Specialization}              & Trained Athletics                & Improve use of chosen skill                & \tdash            & \featpref{Athletics Specialization}             \\
          ...
          \featref{Might Specialization}                  & Trained Might                    & Improve use of chosen skill                & \tdash            & \featpref{Might Specialization}         \\
          ...
          \featref{Poise Specialization}                  & Trained Poise                    & Improve use of chosen skill                & \tdash            & \featpref{Poise Specialization}             \\
...
\section{Feat Descriptions}
  ...
  \begin{feat}{Arbalist}{Combat}
    ...
    \ff[1]{Rapid Reload} Crossbows that normally require a \glossterm{minor action} for you to reload instead take a non-action, like bows.
    This allows you to reload them any number of times per turn.
    ...
    When you shoot a multiloaded crossbow, you take a \minus1 accuracy penalty, but the strike has an additional \glossterm{secondary target} within 15 feet of the primary target.
    ...
    \ff[12]{Rapid Reload\plus} Once per turn, you can spend one \glossterm{stamina} to reload a crossbow that would normally require a standard action to reload as a \glossterm{free action}.
  ...
  \begin{feat}{Ascetic}{General}
    ...
    \magicalff[1]{Ascetic Archetype} Choose one archetype that you have access to and do not already have any
    ranks in.
    ...
    \ff[1]{Deny Wealth} You cannot knowingly own, consume, or use any item or collection of items that is worth 1gp or more.
    ...
    If you break this prohibition under duress, including magical compulsion, these penalties only last for 24 hours.
    ...
    \magicalff[1]{Sanctified Garb} Any clothing you wear provides a \plus2 bonus to your Armor defense and a \plus1 bonus to your \glossterm{durability}.
    ...
    For example, if you attune to it twice, it would provide a \plus5 bonus to your durability.

    \ff[6]{Open Mind} You gain an additional \glossterm{insight point}.

    \magicalff[6]{Simple Life} You reduce your maximum \glossterm{attunement points} by one.
    In exchange, you gain a \plus1 bonus to your non-Armor \glossterm{defenses}.

    \magicalff[12]{Sanctified Garb\plus} The Armor defense bonus increases to \plus3.

    \magicalff[12]{Simple Life\plus} The non-Armor defense bonus increases to \plus2.

    \ff[18]{Sanctified Garb\plus} The durability bonus you gain from each attunement increases to 3.

    \magicalff[18]{Simple Life\plus\plus} The non-Armor defense bonus increases to \plus3.
  \end{feat}

  \begin{feat}{Athletics Specialization}{Skill}
    \featpre Athletics as a trained skill.

    \ff[1]{Specialization} You gain a \plus2 bonus to the Athletics skill.

    \ff[6]{Rapid Athletics} You gain a slow \glossterm{climb speed} and \glossterm{swim speed} (see \pcref{Movement Modes}).
    If you would already have a slow speed of the same type, you increase that speed to average instead.

    \ff[12]{Specialization\plus} The bonus from your \textit{specialization} ability increases to \plus4.

    \ff[18]{Earth Swimmer} You gain a slow \glossterm{burrow speed} (see \pcref{Movement Modes}).

    % TODO: wording
    \ff[18]{Endless Creature Climb} You do not suffer a cumulative penalty to your accuracy with the creature climb ability for each turn you spend climbing (see \pcref{Creature Climb}).
  \end{feat}
  ...
  \begin{feat}{Awareness Specialization}{Skill}
    ...
    \ff[6]{Extraordinary Senses} You gain one of the following senses: \sense{blindsense} (15 ft.), \sense{darkvision} (60 ft.), \sense{low-light vision}, or \sense{tremorsense} (15 ft.).
  ...
  \begin{feat}{Barbaric Ancestry}{Ancestry}
    ...
    \begin{magicalactiveability}{Ancestral Battlecry}{Standard action}
      ...
      At the end of each of your subsequent turns after you use this ability, one of the spirits disappears.
      When all of the spirits have disappeared, this effect ends.
    \end{magicalactiveability}

    \ff[6]{Blood of My Ancestors} You gain a \plus1 bonus to \glossterm{vital rolls} and a \plus2 bonus to your \glossterm{durability}.

    \magicalff[12]{Ancestral Protectors} While you have at least one ghostly spirit active from your \ability{ancestral battlecry} ability, you gain a \plus1 bonus to your Armor defense.
    In addition, you create four spirits when you use that ability rather than three.

    \magicalff[18]{Ancestral Guide} The last ghostly spirit from your \ability{ancestral battlecry} ability lasts indefinitely.
    You can dismiss it as a \glossterm{free action}.

    \ff[18]{Blood of My Ancestors\plus} The vital roll bonus increases to \plus2, and the durability bonus increases to \plus4.
  \end{feat}
  ...
  \begin{feat}{Battle Armory}{Combat}
    ...
    \ff[1]{Overburdened Quickdraw} Once per turn, you can draw or sheathe any non-shield weapon as a \glossterm{free action}.
    ...
    If you have the Armed and Ready fighter ability with the same effect, you can use both free actions separately, allowing you to draw or sheathe two weapons per turn as a free action.

    \magicalff[6]{Rapid Attunement} Once per turn, you can use the \ability{item attunement} ability to attune to a weapon or armor as a \glossterm{free action} (see \pcref{Item Attunement}).
  ...
  \begin{feat}{Beef}{General}
    \featpre Strength 3.

    \ff[1]{Staggering Brawn} You gain a \plus3 bonus to your Brawn defense.

    \ff[6]{Powerlifter} You gain a \plus1 bonus to your Strength for the purpose of determining your \glossterm{weight limits}.

    \magicalff[6]{Unbound Strength} When you use at least two \glossterm{free hands} to carry burdens, you can carry implausibly cumbersome loads without worrying about volume limits, and without incurring damage to the carried objects as a side effect of transportation.
    For example, you could pick up an entire house if your \glossterm{weight limit} was high enough, even though a house would normally fall apart under the strain if a creature tried to pick it up.

    \ff[12]{Staggering Brawn\plus} The defense bonus increases to \plus6.

    \ff[18]{Limitless Strength} You gain a \plus1 bonus to your Strength.
  \end{feat}
  ...
  \begin{feat}{Blindfighter}{Combat}
    ...
    \ff[6]{Blindsight} You gain \sense{blindsense} with a 90 foot range, allowing you to sense your surroundings without light (see \pcref{Blindsense}).
    If you already have blindsense, the range of your blindsense increases by 90 feet.
    In addition, you gain \sense{blindsight} with a 30 foot range, allowing you to see without light (see \pcref{Blindsight}).
  ...
  \begin{magicalfeat}{Blood Magic}{Casting, Magical}
    \featpre Access to a \glossterm{mystic sphere}, Constitution 2, \trait{blooded}.

    \magicalff[1]{Bloodspell} Whenever you cast a spell, you may use this ability.
    When you do, you gain a \plus1 accuracy bonus with the spell this turn.
    ...
    \magicalff[6]{Blood-Sworn Alliance} You can swear a blood oath to your allies in a ritual.
    The ritual requires you and each ally to participate in the ritual for ten minutes.
    ...
    Any participant can revoke their part of the blood oath with another ritual.
    This ritual requires one hour, and only requires that participant's presence.
    When a creature finishes the ritual, they suffer one \glossterm{vital wound} for each ally that they are revoking the blood oath with.

    \magicalff[12]{Fountain of Blood} You gain additional \glossterm{hit points} equal to twice your \glossterm{durability}.

    \magicalff[18]{Bloodspell\plus} The accuracy bonus increases to \plus2.
  \end{magicalfeat}
  ...
  \begin{magicalfeat}{Boongiver}{Casting, Magical}
    ...
    \begin{magicaltriggeredability}{Share Boon}{Triggered}
      \rankline
      You can use this ability when you cast a spell with the \abilitytag{Attune} tag.
      ...
      This ability has a \glossterm{limit} of one spell.
    ...
    \magicalff[12]{Share Boon\plus} The ability's \glossterm{limit} increases to two spells.
  ...
  \begin{feat}{Brawler}{Combat}
    ...
    \ff[1]{Brawling Expertise} You gain a \plus1 bonus to your Brawn defense and your \glossterm{brawling accuracy} (see \pcref{Brawling Accuracy}).

    \ff[1]{Unarmed Warrior} Your punch/kick \glossterm{natural weapon} becomes a \plus1 accuracy weapon that deals 1d4 damage and has the \weapontag{Light} \glossterm{weapon tag}.
    ...
    This effect does not stack with the ability of the same name from the Perfected Form monk archetype (see \pcref{Perfected Form}).

    \ff[6]{Larger than Life} You are treated as one size category larger than your actual size for the purpose of \atSizeBased \atBrawling abilities.

    \ff[12]{Unarmed Warrior\plus} Your punch/kick \glossterm{natural weapon} gains a \plus1 bonus to its \glossterm{weapon dice increment}.

    \ff[12]{Brawling Expertise\plus} The bonuses from your \textit{brawling expertise} ability increase to \plus2.
    ...
    \ff[18]{Unarmed Warrior\plus\plus} The bonus to weapon dice increment increases to \plus2.
  \end{feat}
  ...
  \begin{magicalfeat}{Celestial Ancestry}{Ancestry, Magical}
    ...
    \begin{magicalactiveability}{Celestial Benevolence}{Standard action}
        ...
        While the target is within \shortrange of you, it takes half damage from all damaging effects (minimum 1).
        Whenever it takes damage that is reduced in this way, you take the same amount of damage.
        This does not cause you to suffer any other non-damaging effects of the attack.
    ...
    % Treat as r1 area, which is a little cheating but makes the damage scaling easier
    \magicalff[6]{Scouring Light}
    \begin{magicalsustainability}{Scouring Light}{Standard action}
      \abilitytags \abilitytag{Sustain} (standard)
      \rankline
      When you use or sustain this ability, you \briefly radiate \glossterm{brilliant illumination} in a \medarea radius from you.
      Then, make an attack vs. Reflex against all enemies in an area.
      The area depends on how many times you have sustained this ability:
      \begin{raggeditemize}
        \item Never: \medarealong, 5 ft. wide line
        \item Once: \medarealong, 10 ft. wide line
        \item Two or more times: \areamed radius
      \end{raggeditemize}
      \hit \damagerankthree.
      \miss Half damage.
      \rankline
      ...
      \featlevel{21} The damage increases to \damagerankeight.
    ...
    \magicalff[18]{Celestial Benevolence\plus} You take only half of the damage that the target takes, not the same amount of damage as the target.
  \end{magicalfeat}

  \begin{feat}{Chameleon}{General}
    \featpre Disguise as a trained skill, Intelligence 2.

    \ff[1]{Adaptive Specialty} As a \glossterm{free action}, if you do not already have an adaptive specialty active, you can choose an adaptive specialty from the list below.
    You immediately gain the benefits of that adaptive specialty.
    Whenever you finish a \glossterm{short rest}, you can deactivate your adaptive specialty, losing all of its benefits.
    \begin{raggeditemize}
      \item Martial: You become proficient with all non-exotic weapons and an additional armor \glossterm{usage class} of your choice.
      ...
      \item Mystic \sparkle: You gain the ability to use wands as if you were able to cast arcane spells (see \pcref{Magic Implements}).
        Your maximum spell rank for this purpose is 1.
        This spell rank increases by 1 at 6th level, and every 3 levels thereafter.
      \item Primal: You gain a \plus2 bonus to your \glossterm{maximum stamina}.
      \item Skilled: You gain a \plus1 bonus to all skills.
    \end{raggeditemize}

    \ff[6]{Adaptive Archetype} Choose one archetype that you currently have, and two archetypes you do not have from among any of your classes.
    ...
    As a \glossterm{free action}, if you do not already have an adaptive archetype active, you can choose one of your adaptive archetypes.
    You immediately gain all benefits of that archetype.
    Whenever you finish a \glossterm{short rest}, you can deactivate your adaptive archetype, losing all of its benefits.
    ...
    \ff[12]{Universal Adaptation} You gain a \plus1 bonus to your \glossterm{mundane power} and \glossterm{magical power}.
    You also gain a \plus2 bonus to your \glossterm{durability}.
    ...
    \begin{raggeditemize}
      ...
      \item Primal: The maximum stamina bonus increases to \plus4.
  ...
  \begin{feat}{Craft Specialization}{Skill}
    ...
    \magicalff[6]{Craft Magic Item} You can use the Craft skill to craft permanent magic items.
    For details about crafting items, see \pcref{Crafting Items}.
  ...
  \begin{feat}{Deception Specialization}{Skill}
    ...
    \ff[1]{Specialization} You gain a \plus2 bonus to the Deception skill.

    \magicalff[6]{Forked Tongue}
    \begin{sustainability}{Forked Tongue}{\glossterm{Minor action}}
      \abilitytags \abilitytag{Subtle}, \abilitytag{Sustain} (minor)
      \rankline
      ...
      You can freely choose different vocal patterns each turn that you sustain this ability.
  ...
  \begin{feat}{Draconic Ancestry}{Ancestry}
    ...
    You are \resistant to attacks with that dragon's associated tag.

    \begin{columntable}
      \columncaption{Dragon Types}
      \begin{dtabularx}{\columnwidth}{l >{\lcol}X >{\lcol}X >{\lcol}X}
      \tb{Dragon} & \tb{Tag}       & \tb{Source} & \tb{Breath Weapon}        \tableheaderrule
        Black     & \atAcid        & Mundane     & \areamed, 5 ft. wide line \\
        Blue      & \atElectricity & Mundane     & \areamed, 5 ft. wide line \\
        Crystal   & \atVisual      & Magical     & \areamed, 5 ft. wide line \\
        Dream     & \atEmotion     & Magical     & \areamed, 5 ft. wide line \\
        Gold      & \atFire        & Magical     & \areamed, 5 ft. wide line \\
        Gore      & \atBlood       & Magical     & \areasmall cone           \\
        Hex       & \atCurse       & Magical     & \areasmall cone           \\
        Obsidian  & \atEarth       & Mundane     & \areasmall cone           \\
        Pearl     & \atWater       & Magical     & \areamed, 5 ft. wide line \\
        Red       & \atFire        & Mundane     & \areasmall cone           \\
        White     & \atCold        & Mundane     & \areasmall cone           \\
        Wraith    & \atSoul        & Magical     & \areamed, 5 ft. wide line \\
        Zephyr    & \atAir         & Mundane     & \areasmall cone           \\
      \end{dtabularx}
    \end{columntable}

    % Same as breath weapon from Dragon class
    \ff[1]{Draconic Breath}
    \begin{activeability}{Draconic Breath}{Standard action}
      ...
      \rankline
      \featlevel{3} The damage increases to \damagerankthree.
      \featlevel{6} The area increases.
      A line breath weapon becomes a \arealarge, 10 ft.\ wide line.
      A cone breath weapon becomes a \areamed cone.
      \featlevel{9} The damage increases to \damagerankfour.
      \featlevel{12} The damage increases to \damagerankfive.
      \featlevel{15} The damage increases to \damageranksix.
      \featlevel{18} The damage increases to \damagerankseven, and the area increases.
    ...
    \ff[6]{Wealth is Power} You gain a \plus1 bonus to your \glossterm{power}.
    While you have a wealth item with an item rank at least as high as your \glossterm{character rank}, this bonus increases to \plus2.
    The wealth item must be carried on your body, including containers on your body.
    ...
    \ff[12]{Dragon Scales} You gain a \plus1 bonus to your Armor defense.

    \ff[18]{Power of the Wyrm} You gain a \plus1 bonus to your Strength and Willpower.
  \end{feat}

  \begin{feat}{Duelist}{Combat}
    \featpre Dexterity 2, Perception 1.

    \ff[1]{Duel Focus} At the start of your turn, you may focus on a creature you can see.
    If you do, you take a \minus2 penalty to all defenses.
    In exchange, you gain a \plus2 bonus to your \glossterm{accuracy} and defenses against that creature.
    ...
    \begin{activeability}{Deliver the Duel}{Standard action}
      ...
      \rankline
      \featlevel{9} The strike deals double \glossterm{weapon damage}.
      \featlevel{12} The extra damage from both circumstances increases to 2d6.
      \featlevel{15} The extra damage from both circumstances increases to 4d6.
      \featlevel{18} The extra damage from both circumstances increases to 4d10.
    \end{activeability}
    ...
    \ff[18]{Duel Focus\plus} The accuracy and defense bonuses increase to \plus3.
  \end{feat}

  \begin{feat}{Endurance Specialization}{Skill}
    \featpre Endurance as a trained skill.

    \ff[1]{Specialization} You gain a \plus2 bonus to the Endurance skill.

    \ff[6]{Delay Condition} Whenever you gain a \glossterm{condition}, you can make an Endurance check.
    The \glossterm{difficulty value} starts at 10 and increases by 5 in your subsequent turns.
    Success means that you do not suffer the effects of the condition.
    You must repeat this check at the end of your subsequent turns to continue to delay the effects of the condition.
    Failure means that the condition has its normal effect on you.

    This ability has a \glossterm{limit} of one delayed condition.
    ...
    This ability has a \glossterm{limit} of one ignored vital wound.
  \end{feat}

  \begin{magicalfeat}{Entropist}{General, Magical}
    \featpre Constitution 1, Willpower 2.
    ...
    \begin{magicalactiveability}{Sudden Entropy}{Standard action}
      ...
      \rankline
      \featlevel{3} The damage increases to 1d8 \add power.
      \featlevel{6} The damage increases to 2d6 \add power.
      \featlevel{9} The damage increases to 1d6 \add 1d6 per 2 power.
        In addition, any \glossterm{extra damage} is doubled.
      \featlevel{12} The damage increases to 3d6 \add 1d6 per 2 power.
      \featlevel{15} The damage increases to 3d8 \add 1d8 per 2 power.
      \featlevel{18} The damage increases to 3d10 \add 1d10 per 2 power.
    \end{magicalactiveability}

    \magicalff[6]{Master of Chaos} After you roll to determine a random effect, you can spend one \glossterm{stamina} to use this ability.
    When you do, you may freely choose the random result instead of keeping your original roll.
    This includes random effects that do not explicitly tell you to roll, such as your behavior while \confused, as long as they have a percentage chance that is internal to your character.
    However, \glossterm{vital rolls} are unaffected by this ability.

    After using this ability, you \briefly roll twice for all attacks and checks and keep the lower result.
    In addition, you can't use this ability again until you finish a \glossterm{short rest}.
    ...
    \magicalff[18]{Master of Chaos\plus} After using this ability, you briefly can't use it again, but you can use it before finishing a short rest and it does not cause you to briefly reroll attacks and checks.
  \end{magicalfeat}

  \begin{feat}{Executioner}{Combat}
    \featpres Perception 2.

    \ff[1]{Marked for Execution} You consider living creatures that either have a \glossterm{vital wound} or are \glossterm{injured} to be marked for execution.
    ...
    \ff[6]{Blood Sense} You gain \sense{lifesense} with a 60 foot range, allowing you to sense the location of living things without light (see \pcref{Lifesense}).
    Your lifesense functions like \sense{lifesight} against creatures who are marked for execution, allowing you to see them perfectly.
    ...
    \ff[12]{Finishing Blow\plus} The accuracy bonus increases to \plus2.

    \ff[18]{Death is Coming} Whenever you deal damage to a creature that is marked for execution, you are \briefly \honed.
  \end{feat}

  \begin{feat}{Fateweaver}{General, Magical}
    \featpre Perception 2.

    \magicalff[1]{Inevitable Attack} Whenever you make an attack roll, your minimum attack result is equal to 5 \add your \glossterm{accuracy} with the attack, as if you had rolled a 5 on the die.
    % TODO: worth the effort to explain here? Is there an easier way to say this?
    If the attack roll is already affected by the Inevitable Spell ability from a moirai votive, the minimum attack result increases by 2.

    % Assume a 70% base hit rate, so 0.7x dpr.
    % A -2 defenses debuff increases damage to 0.9x dpr.
    ...
    \begin{magicalactiveability}{Fateseal}{Standard action}
      ...
      Whenever a creature makes an attack roll against it, their minimum attack result is equal to 5 \add their \glossterm{accuracy} with the attack, as if they had rolled a 5 on the die.
    ...
    \magicalff[12]{Inevitable Success} Whenever you make a \glossterm{check}, your minimum check result is equal to 5 \add your modifier with the check, as if you had rolled a 5 on the die.

    \magicalff[18]{Fated Victory} The minimum results from your \textit{inevitable attack} and \textit{inevitable success} abilities each increase to 7 \add your \glossterm{accuracy} or modifier.
  \end{feat}
  ...
  \begin{feat}{Flexibility Specialization}{Skill}
    ...
    \ff[1]{Specialization} You gain a \plus2 bonus to the Flexibility skill.
    ...
    \ff[6]{Rapid Squeeze} Your \glossterm{speed} is not reduced while \squeezing.
  ...
  \begin{feat}{Gestalt}{General}
    \ff[1]{Archetype Fusion} Choose one archetype that you have access to and do not already have any ranks in.
    You become rank 1 in that archetype.
    ...
    \ff[6]{Skill Fusion} Choose any two skills that have the same key attribute.
    ...
    Multiple \glossterm{enhancement bonuses} do not stack, even if you have one enhancement bonus for one skill and another enhancement bonus for the other skill.
    The only exception is that size modifiers to the Stealth skill cannot be applied to other skills in this way (see \pcref{Size and Weight}).

    \ff[12]{Archetype Fusion\plus} Choose an additional archetype that you have access to and do not already have any ranks in.
    You become rank 1 in that archetype, and you can increase your rank in that archetype further as you level up, including when you reach level 12.

    \ff[18]{Archetype Rank} You gain an additional archetype rank.
  \end{feat}

  \begin{magicalfeat}{Ghostblade}{Combat, Magical}
    \featpre Dexterity 1, Willpower 2.

    \magicalff[1]{Ghost Shroud} You can use the lower of your Dexterity and Willpower in place of your Constitution to determine your \glossterm{hit points}.
    In addition, your Constitution does not increase your \glossterm{injury point} (see \pcref{Injury Point}).

    \magicalff[1]{Ghost Step} When you use the \ability{run} or \ability{sprint} abilities, you can become \trait{invisible} until the end of your turn (see \pcref{Run}, and \pcref{Sprint}).
    ...
    \begin{magicalactiveability}{Spectral Slice}{Standard action}
      ...
      \hit If your attack also hits the target's Fortitude defense, it is \briefly \slowed.
      \injury If your attack also hits the target's Fortitude defense, it is \slowed as a \glossterm{condition}.

      \rankline
      \featlevel{9} The strike deals double \glossterm{weapon damage}.
      \featlevel{12} The strike deals \glossterm{extra damage} equal to half your \glossterm{power}.
      \featlevel{15} The extra damage increases to 2d6 \add half your \glossterm{power}.
      \featlevel{18} The extra damage increases to 4d6 \add your \glossterm{power}.
    \end{magicalactiveability}

    \magicalff[12]{Ghost Step\plus} When you use the \ability{run} or \ability{sprint} abilities, you can become \trait{incorporeal} until the end of your turn.
    While you are incorporeal in this way, you gain an average fly speed.

    \magicalff[12]{Spectral Shield} You are \resistant to all attacks by \trait{incorporeal} creatures.

    \magicalff[18]{Half Spirit} Your \glossterm{injury point} is set to 0, so you are only \glossterm{injured} while you have no remaining hit points.
  \end{magicalfeat}

  \begin{feat}{Greatweapon Warrior}{Combat}
    \featpre Strength 3.

    \ff[1]{Cleave} Whenever you make a \glossterm{melee} \glossterm{strike} using a weapon you hold in two hands, it gains the \weapontag{Sweeping} (1) tag (see \pcref{Weapon Tags}).
    If the weapon already has the Sweeping tag, you instead increase the tag's value by 2, allowing you to choose two additional secondary targets.

    \ff[6]{Great Power} You gain a \plus1 bonus to your \glossterm{magical power} and \glossterm{mundane power}.

    \ff[12]{Great Reach} Whenever you make a \glossterm{melee} \glossterm{strike} using a weapon you hold in two hands, it gains the \weapontag{Long} tag.
    If the weapon already has the Long tag, you can attack targets that are within 15 feet of you.

    \ff[18]{Great Power\plus} The bonus increases to \plus2.

    \ff[18]{Smash Away} Whenever you deal damage to a creature or object with a melee strike using a weapon you hold in two hands, you can \glossterm{push} that creature or object up to 15 feet in a straight line directly away from you.
    If the creature gained an \glossterm{injury} from your attack, you \glossterm{fling} it instead of pushing it.
    You can only move any individual creature or object in this way once per turn.
    This is a \atSizeBased effect.
  \end{feat}

  \begin{feat}{Heavenly Warrior}{Combat}
    \featpre Str 2, Athletics as a trained skill.
    ...
    \begin{activeability}{Call to Heaven}{Standard action}
      \abilitytags \atBrawling (see text), \atPhysical
      \rankline
      Make a \glossterm{brawling attack} vs. Brawn against one creature or object adjacent to you.
      If you hit, and you are strong enough to carry the target, you \glossterm{fling} it up to 10 feet directly upwards.
      This leaves it \glossterm{midair}, which normally makes it \unsteady.
      You can then jump up to their height, assuming it is within your maximum jump height.
      This jump does not reduce your \glossterm{available movement}.
      ...
      % Necessary to avoid giving allies a chance to attack while the target has the defense penalties
      After you finish using this ability, if you hit with either attack, you and the target immediately fall up to 300 feet until you hit the ground.
      This typically causes the target to take \glossterm{falling damage} (see \pcref{Falling Damage}).
      \rankline
      % This has unusually strong damage scaling at high ranks because higher rank creatures are often larger, which makes them harder to lift.
      % If you are able to use this ability, you need an extra reward.
      ...
      % This would be unreasonably high damage, but it's very hard to jump 60 feet in the air.
      \rank{7} The strike deals triple damage, and the maximum fling distance increases to 60 feet.
    \end{activeability}

    \ff[12]{Heavenly Domain} You gain a \plus2 accuracy bonus against creatures that are \glossterm{midair}.
    In addition, you are immune to \glossterm{falling damage}.

    \ff[18]{Heavenly Descent}
    \begin{triggeredability}{Heavenly Descent}{Triggered}
      Once per turn, when you land from an intentional jump, you can make an attack vs. Fortitude against each \glossterm{enemy} adjacent to you that is shorter than the apex of that jump.
  ...
  %     \abilitytags \abilitytag{Attune}, \abilitytag{Emotion}, \abilitytag{Subtle}
  ...
  \begin{feat}{Intimidate Specialization}{Skill}
    ...
    \ff[6]{Greater Demoralize} When you use the \textit{demoralize} ability, the target is frightened by you even if it is not \glossterm{injured}.
  ...
  \begin{feat}{Iron Will}{General}
    ...
    \ff[1]{Mental Discipline} You gain a \plus3 bonus to your Mental defense.

    \ff[6]{Unclouded Mind} You are immune to being \dazed and \confused.

    \ff[12]{Mental Discipline\plus} The defense bonus increases to \plus6.

    \ff[18]{Unclouded Mind\plus} You are immune to \abilitytag{Compulsion} and \abilitytag{Emotion} attacks.
  \end{feat}

  \begin{feat}{Juggernaut}{Combat}
    \featpre Strength 1, Constitution 2.

    \ff[1]{Unstoppable} You are immune to being \slowed, and your \glossterm{speed} is not reduced by \glossterm{difficult terrain}.
    ...
    \begin{activeability}{Trample}{Standard action}
      \abilitytags \abilitytag{Brawling}, \atPhysical, \abilitytag{Size-Based}
      \rankline
    ...
    \ff[12]{Sheer Power} You gain a \plus1 bonus to your \glossterm{magical power} and \glossterm{mundane power}.
    ...
    Whenever you touch a wall created by a \abilitytag{Barrier} ability, it is immediately destroyed unless its \glossterm{rank} exceeds your \glossterm{character rank}.

    \ff[18]{Sheer Power\plus} The bonuses increase to \plus2.

    % TODO: weak capstone
    \ff[18]{Unstoppable\plus} You are immune to \glossterm{teleport}, \glossterm{push}, and \glossterm{fling} effects from attacks.
  ...
  \begin{feat}{Leadership}{Combat}
    ...
    \begin{activeability}{Battle Command}{Standard action}
      ...
      The target becomes \focused and gains a \plus1 accuracy bonus until your next turn.
    ...
    \ff[6]{Combat Leader} You gain a \plus1 bonus to \glossterm{initiative}.

    \ff[12]{Encouraging Presence} As long as you are conscious, your \glossterm{allies} who can see or hear you are immune to being \frightened and \panicked.

    \ff[18]{Combat Leader+} The bonus increases to \plus2.
  \end{feat}

  \begin{magicalfeat}{Legacy Item}{General}
    \ff[1]{Legacy Item} You choose a \glossterm{mundane} weapon, body armor, shield, apparel item, or implement you own that is not made from a special material.
    That item becomes your legacy item.
    You choose a single magic item property of rank 3 or lower that does not require \glossterm{deep attunement}, and your legacy item gains that property.
    You do not have to \glossterm{attune} to your legacy item to gain its benefits, and its magical properties only function for you.
    However, you reduce your maximum \glossterm{attunement points} by one.
    ...
    For example, you can choose an amulet as your legacy item and give it the effect of the \mitem{boots of translocation}, or apply the effects of a \mitem{shield of arrow catching} to your body armor.

    If you lose your legacy item, you must retrieve it to regain its power.
    If your legacy item is \glossterm{destroyed}, you can choose a new object to be your legacy item after one week.
    The new legacy item must keep the same magic item properties as your old legacy item.

    \ff[6]{Expanded Legacy} You choose an additional magic item property of rank 3 or lower.
    Your legacy item gains that property in addition to its existing property.

    \ff[12]{Legacy Item\plus} You can replace one of the properties on your legacy item with a magic item property that is rank 5 or lower.

    \ff[18]{Legacy Item\plus\plus} You can replace one of the properties on your legacy item with a magic item property that is rank 7 or lower.
  \end{magicalfeat}

  \begin{feat}{Living Weapon}{Combat}
    \featpre Strength and Constitution sum to at least 3

    \ff[1]{My Body Is My Weapon} Your punch/kick \glossterm{natural weapon} becomes a \plus0 accuracy weapon that deals 1d8 damage and has the \weapontag{Light} \glossterm{weapon tag}.
    ...
    \magicalff[6]{Consume Weapon} Whenever you destroy a magical weapon, you can permanently consume its magical property.
    You can attune to any property you have consumed in this way as a \glossterm{minor action}.
    The property applies to all \glossterm{natural weapons} you use.

    You can only attune to one property that you have consumed in this way at a time.
    This ability has a \glossterm{limit} of consumed properties equal to the sum of your Strength and Constitution.

    \ff[12]{Made of Iron} You gain a \plus2 bonus to your defenses when determining whether an attack gets a \glossterm{critical hit} against you instead of a normal hit.

    \ff[12]{My Body Is My Weapon\plus} Your punch/kick \glossterm{natural weapon} gains a \plus1 bonus to its \glossterm{weapon dice increment}.

    \ff[18]{Made of Iron\plus} The defense bonus increases to \plus4.

    \ff[18]{My Body Is My Weapon\plus\plus} The bonus to weapon dice increment increases to \plus2.
  \end{feat}

  \begin{feat}{Maneuverist}{Combat}
    \featpre Intelligence 2.

    \ff[1]{Maneuver Access} You gain access to one \glossterm{combat style} that you did not already have access to (see \pcref{Maneuver Lists}).
  ...
  \begin{feat}{Medicine Specialization}{Skill}
    ...
    \ff[1]{Specialization} You gain a \plus2 bonus to the Medicine skill.

    % rank 3 equivalent, so dr5 healing
    \ff[6]{Healing Touch}
    \begin{activeability}{Healing Touch}{Standard action}
      \abilitycost One \glossterm{stamina} from the target.
      \rankline
      Choose yourself or a living \glossterm{ally} you \glossterm{touch}.
      The target regains \hprankfivelow.
      In addition, make a Medicine check.
      For each poison on the target, if your check result beats a \glossterm{difficulty value} equal to 10 \add twice its \glossterm{rank}, the effect is removed.

      \rankline
      \featlevel{9} The healing increases to \hpranksixlow.
      \featlevel{12} The healing increases to \hpranksevenlow.
      \featlevel{15} The healing increases to \hprankeightlow.
      \featlevel{18} The healing increases to \hprankninelow.
    \end{activeability}

    \ff[12]{Specialization\plus} The bonus from your \textit{specialization} ability increases to \plus4.

    \ff[18]{Vital Touch} When you use your \textit{healing touch} ability, the target can also remove one \glossterm{vital wound}.
    If it does, it reduces its \glossterm{stamina} by three.
  \end{feat}
  ...
  \begin{magicalfeat}{Mental Magic}{Casting, Magical}
    ...
    \magicalff[6]{Fractured Mind} Once per turn, you can sustain an ability with the \abilitytag{Sustain} (minor) tag as a \glossterm{free action}.
    ...
    Whenever you sustain a Sustain (standard) ability in this way, you reduce your \glossterm{stamina} by one.

    \magicalff[18]{Potent Mind\plus} The magical power bonus from your \textit{potent mind} ability increases to \plus2.
  \end{magicalfeat}

  \begin{feat}{Might Specialization}{Skill}
    \featpre Might as a trained skill.

    \ff[1]{Specialization} You gain a \plus2 bonus to the Might skill.

    \ff[6]{Weightlifter} You gain a \plus1 bonus to your Strength for the purpose of determining your \glossterm{weight limits}.

    \ff[12]{Specialization\plus} The bonus from your \textit{specialization} ability increases to \plus4.

    \ff[18]{Burst of Strength} You can make Might checks to break objects and effects on you as a \glossterm{minor action} if they would normally require a move action or standard action.
    This includes magical effects that can be ended with a Might check.
  \end{feat}
  ...
  \begin{magicalfeat}{Mystic Archer}{Casting, Magical}
    ...
    \begin{magicalattuneability}{Imbue Projectile}{Standard action}
      ...
      The spell's power is imbued in up to two \glossterm{projectiles} you hold.
      Unlike most \abilitytag{Attune} abilities, you can attune to this ability any number of times, choosing a different spell and up to two projectiles each time.
      ...
      Any attacks you make for the spell are \glossterm{reactive attacks}, and are rolled separately from your attack roll with the strike.

      After the spell takes effect, you \briefly can't trigger any more spells with the \ability{imbue projectile} ability.
    ...
    \magicalff[12]{Archer's Eye} You gain a \plus1 accuracy bonus.
  ...
  \begin{magicalfeat}{Mystic Synthesist}{Casting, Magical}
    ...
    \magicalff[1]{Invented Metamagic} Choose one invented metamagic ability from the list below.
    You apply that metamagic ability to one spell you know.
    You can spend \glossterm{insight points} to learn one additional invented metamagic ability per insight point.
    Each individual spell can only have one metamagic applied, including metamagic from other sources.
    ...
    \begin{raggeditemize}
      ...
      \item Delayed: The spell does not take effect immediately.
        Instead, it \glossterm{repeats} at the start of your next turn.
      \item Dominating: You use your Willpower in place of your Perception to determine your \glossterm{accuracy} with the spell.
        You can only apply this augment to non-damaging spells with the \atCompulsion or \atEmotion tags.
      \item Empowering: After you cast the spell, you are \briefly \empowered.
      \item Finesse: You use your Dexterity in place of your Perception to determine your \glossterm{accuracy} with the spell.
      \item Impactful: The spell deals \glossterm{extra damage} equal to your character rank and gains the \atImpact tag.
        You can only apply this augment to damaging spells.
      \item Point Blank: You gain a \plus2 bonus with the spell against each target that is within half the spell's maximum \glossterm{range} from you.
      ...
      \item Seeking: The spell gains a \plus1 accuracy bonus and ignores \glossterm{cover} and \glossterm{concealment}.
      \item Sympathetic: The spell includes you as a target and automatically hits you without making an attack roll.
        As long as you are not immune to the spell or any part of its effects, this grants you a \plus2 accuracy bonus with the spell against its other targets.
        You can only apply this augment to \glossterm{targeted} damaging spells.
    \end{raggeditemize}

    \magicalff[6]{Prolific Inventor} You gain an additional \glossterm{insight point}.

    \magicalff[6]{Unbound Creativity} You can apply two metamagic effects to your spells, rather than the normal limit of one.
    If a spell has two metamagic effects on it, you take a \minus1 accuracy penalty with it.
    If you have the Expert Metamage\plus wizard ability with the same effect, this accuracy penalty is removed.

    \magicalff[12]{Prolific Inventor\plus} The number of additional insight points increases to two.
  
    \magicalff[18]{Unbound Creativity\plus} The accuracy penalty is removed.
  \end{magicalfeat}

  \begin{feat}{Null}{General}
    \featpre Willpower 2.

    % TODO: should not be immune to having things thrown at you, but should be immune to being thrown by magic. How does that work? Doesn't seem to fit clearly into a tag system.
    \ff[1]{Nullify Magic} You gain a \plus4 bonus to your \glossterm{defenses} against \magical abilities.
    In exchange, you lose the benefits of all magical abilities you possess, and you reduce your maximum \glossterm{attunement points} by one.
    ...
    \begin{activeability}{Shred Magic}{Standard action}
      ...
      \begin{raggeditemize}
        ...
        \item The target is \glossterm{attuned} to any \magical items.
        \item The target is currently \glossterm{sustaining} any \magical effects.
        \item The target used a \magical ability as a \glossterm{standard action} or \glossterm{elite action} during its last turn.
      \end{raggeditemize}
    ...
    \ff[6]{Mundane Resilience} You gain a \plus1 bonus to your \glossterm{durability} and non-Armor \glossterm{defenses}.

    \ff[12]{Disruptive Presence} Whenever an \glossterm{enemy} within an \smallarea radius from you uses a \magical ability as a standard action or \glossterm{elite action}, the ability has a 20\% chance to fail with no effect.
    This can only affect any individual creature once per turn, so a creature that uses two magical abilities will have no failure chance on the second ability it uses.
    If that enemy's \glossterm{character rank} is less than your character rank, this failure chance increases to 50\%.
    This cannot cause passive abilities or triggered abilities to fail.
    Although this ability is \glossterm{mundane}, it still affects \trait{incorporeal} creatures.

    \ff[12]{Mundane Resilience\plus} The bonuses increases to \plus2.

    \ff[18]{Mundane Resilience\plus\plus} The bonuses increases to \plus3.

    \ff[18]{True Null} You are immune to all \magical abilities.
  \end{feat}
  ...
  \begin{feat}{Poise Specialization}{Skill}
    \featpre Poise as a trained skill.

    \ff[1]{Specialization} You gain a \plus2 bonus to the Poise skill.
    ...
    Failure means you fall through the surface, and you can't use this ability again this turn.
    The \glossterm{difficulty value} increases by 5 for each consecutive turn that you spend moving in this way.
  ...
  \begin{feat}{Precognition}{General}
    ...
    \ff[1]{Foresight} You gain a \plus2 bonus to Awareness.
    ...
    \ff[6]{Combat Prediction} You gain a \plus1 bonus to \glossterm{initiative}.

    \ff[12]{Foresight\plus} The bonus increases to \plus4.
    In addition, you are never \partiallyunaware.

    \ff[18]{Combat Prediction\plus} The bonus increases to \plus2.
  \end{feat}

  \begin{magicalfeat}{Prepared Spellcasting}{Magical, Spell}
    \featpre Access to a \glossterm{mystic sphere}, Intelligence 3.

    \magicalff[1]{Ritual Book} You gain the ability to perform rituals to create unique magical effects (see \pcref{Spell and Ritual Mechanics}).
    ...
    Whenever you finish a \glossterm{short rest}, you may choose one of the spells in your spellbook.
    You learn how to cast that spell until you choose a different spell with this ability.
    When you forget how to cast a spell with this ability, any of its persistent effects immediately end, and all creatures immediately stop being attuned to it.

    \magicalff[6]{Study of Magic} You gain a \plus1 bonus to your \glossterm{magical power} and a \plus2 bonus to the Knowledge (arcana) skill.

    \magicalff[12]{Spellbook\plus} Your spellbook contains up to five spells.

    \magicalff[18]{Spellbook\plus\plus} You can learn any two spells from your spellbook at once.

    \magicalff[18]{Study of Magic\plus} The power bonus increases to \plus2, and the Knowledge bonus increases to \plus4.
  \end{magicalfeat}

  \begin{feat}{Rapid Reaction}{General}
    \featpre Dexterity 2.

    \ff[1]{Lightning Reflexes} You gain a \plus3 bonus to your Reflex defense.

    \ff[1]{Sidestep} Once per turn, you can move up to five feet as a \glossterm{free action}.

    \ff[6]{Evasive Reaction} You take no damage when an area ability attacks and misses your Armor or Reflex defense.
    ...
    \ff[12]{Lightning Reflexes\plus} The bonus from your \textit{lightning reflexes} ability increases to \plus6.

    \ff[12]{Sidestep\plus} The maximum movement increases to ten feet.
  ...
  \begin{feat}{Regenerator}{General}
    ...
    \begin{activeability}{Regenerative Recovery}{Standard action}
      ...
      \rankline
      You regain \hprankthreelow.
      If you gained any \glossterm{vital wounds} since your last turn, your healing with this ability is doubled.
      If this would heal you above your maximum hit points, any excess healing applies at the end of your next turn.
      Any excess healing at that point is lost.

      \rankline
      \featlevel{3} The healing increases to \hprankfourlow.
      \featlevel{6} The healing increases to \hprankfivelow.
      \featlevel{9} The healing increases to \hpranksixlow.
      \featlevel{12} The healing increases to \hpranksevenlow.
      \featlevel{15} The healing increases to \hprankeightlow.
      \featlevel{18} The healing increases to \hprankninelow.
    ...
    If you do, you reduce your \glossterm{stamina} by three per vital wound removed this way.
    You can use this ability to remove vital wounds even once your stamina would already make you unconscious.
    This allows you to recover any number of vital wounds if you go unconscious to do so, regardless of your maximum stamina.

    \ff[18]{Battlefield Regeneration} When you use the \textit{recover} action, you can also remove a single vital wound.
    If you do, you reduce your stamina by one.

    \ff[18]{Regenerative Rest\plus} You only reduce your stamina by two per vital wound.
  \end{feat}
  ...
  \begin{feat}{Shieldbearer}{Combat}
    ...
    \begin{activeability}{Shield Slam}{Standard action}
        ...
        \featlevel{12} The strike deals double \glossterm{weapon damage}.
        \featlevel{15} The accuracy bonus increases to \plus2.
        \featlevel{18} If your Armor defense is higher than the target's Armor defense, the strike deals triple damage.
    \end{activeability}
    
    \ff[12]{Shield Cover} While you wield a shield, you take no damage when an area ability attacks and misses your Armor defense.
    This does not protect you from any non-damaging effects of those abilities, or from abilities that affect multiple specific targets without affecting an area.

    \ff[18]{Shield Expertise\plus} The bonus increases to \plus2.

    \ff[18]{Shield Proficiency\plus} You gain a \plus1 accuracy bonus with \glossterm{strikes} using shields.
  \end{feat}
  ...
  \begin{feat}{Sleight of Hand Specialization}{Skill}
    ...
    \begin{magicalattuneability}{Extradimensional Pocket}{Triggered}
      \abilitytags \abilitytag{Attune}
      \rankline
      You can use this ability when you use the \ability{conceal object} ability (see \pcref{Sleight of Hand}).
  ...
  \begin{feat}{Sniper}{Combat}
    ...
    \begin{sustainability}{Aim}{Standard action}
      ...
      At the end of your turn, if you never saw the target that turn, this effect ends.
    \end{sustainability}

    \ff[6]{Steady Shot} You can steady your aim as a \glossterm{move action}.
    This reduces your \glossterm{longshot penalty} by 2 this turn and reduces your \glossterm{available movement} to 0.

    \ff[12]{Sniper's Precision} You gain a \plus1 \glossterm{accuracy} bonus with ranged \glossterm{strikes}.

    \ff[18]{Aim\plus} When you use this ability, you are also \briefly \honed.

    \ff[18]{Steady Shot\plus} This ability also causes your ranged \glossterm{strikes} to ignore \glossterm{cover} and \glossterm{concealment}.
  \end{feat}

  \begin{feat}{Social Insight Specialization}{Skill}
    \featpre Social Insight as a trained skill.

    \ff[1]{Specialization} You gain a \plus2 bonus to the Social Insight skill.

    \magicalff[6]{Read Emotions}
    \begin{sustainability}{Read Emotions}{Standard action}
      \abilitytags \abilitytag{Emotion}, \abilitytag{Sustain} (minor), \abilitytag{Subtle}
      \rankline
  ...
  \begin{magicalfeat}{Spellsword}{Magical, Spell}
    ...
    \ff[1]{Enhanced Blade} You gain a \plus1 \glossterm{enhancement bonus} to your \glossterm{mundane power}.
    ...
    \begin{magicalactiveability}{Spellstrike}{Standard action}
      \abilitycost You \briefly can't use this ability again.
      \rankline
      You cast a spell and make a \glossterm{mundane} melee \glossterm{strike}, in either order.
      % TODO: clarify how this interacts with double standard action spells.
      % It seems like they have no targets when first cast, which makes it fine.
      The spell and the strike must affect completely different targets, with no overlap between their targets or areas (if any).
      You cannot cast a spell that would cause you to make a strike.

      \rankline
      \featlevel{9} The strike deals double \glossterm{weapon damage}.
      \featlevel{12} The strike deals \glossterm{extra damage} equal to half your \glossterm{mundane power}.
      \featlevel{15} The strike deals triple \glossterm{weapon damage}.
      \featlevel{18} The extra damage increases to 1d6 \add your \glossterm{mundane power}.
    \end{magicalactiveability}

    \magicalff[12]{Enhanced Blade\plus} The bonus increases to \plus2.

    \magicalff[12]{Mystic Blade} Whenever you cast a damaging spell, you can choose one weapon you wield and are proficient with.
    You add that weapon's accuracy and base damage as \glossterm{extra damage} to the spell.
    In addition, if the weapon has the Keen or Impact tags, you apply those tags to the spell if it did not already have them.
    This ignores any magic weapon properties the weapon has.

    \magicalff[18]{Mystic Blade\plus} You also apply any accuracy and damage from magic weapon properties, including \glossterm{extra damage} that would normally only apply to strikes with the weapon.
    Other special abilities from magic weapon properties besides accuracy and immediate, unconditional damage do not apply to the spell.
  \end{magicalfeat}
  ...
  \begin{magicalfeat}{Spellwarped}{General, Magical}
    ...
    \magicalff[6]{Spell Rank} You become a rank 2 spellcaster in your chosen mystic sphere.
    ...
    \magicalff[9]{Spell Rank} You become a rank 3 spellcaster in your chosen mystic sphere.

    \magicalff[12]{Spell Rank} You become a rank 4 spellcaster in your chosen mystic sphere.

    \magicalff[15]{Spell Rank} You become a rank 5 spellcaster in your chosen mystic sphere.

    \magicalff[18]{Spell Rank} You become a rank 6 spellcaster in your chosen mystic sphere.

    \magicalff[21]{Spell Rank} You become a rank 7 spellcaster in your chosen mystic sphere.
  \end{magicalfeat}
  ...
  \begin{magicalfeat}{Sphere Focus: Aquamancy}{Casting, Magical}
    ...
    \magicalff[1]{Aquatic Propulsion} Once per turn, after you make an attack with a spell from the \sphere{Aquamancy} \glossterm{mystic sphere}, you can \glossterm{push} yourself up to 10 feet.
    You can also use this ability with \glossterm{strikes} using natural weapons from that sphere, such as from the \spell{aqueous tentacle} spell.
    ...
    At the end of your next turn, the attack \glossterm{repeats} on the target if the bubble remains.
    If you miss with this repeat, the bubble does not reform.

    The bubble can be removed early if the target drops \prone and rolls around on the ground as a \glossterm{move action}.
    It is also removed if the target takes damage from a \atCold or \atFire ability.

    This is a metamagic effect, so you cannot apply another metamagic to the same spell.
    When you gain access to a new rank of spells, you can replace your current spell affected by this metamagic with a new spell of that rank.

    \magicalff[12]{Partially Liquid} You gain a \plus3 \glossterm{enhancement bonus} to the Flexibility skill.
    In addition, you gain a \plus2 bonus to your defenses when determining whether an attack gets a \glossterm{critical hit} against you instead of a normal hit.

    \magicalff[18]{Aquatic Propulsion\plus} The push distance increases to 20 feet.

    \magicalff[18]{Partially Liquid\plus} The defense bonus increases to \plus4.
  \end{magicalfeat}
  ...
  \begin{magicalfeat}{Sphere Focus: Channel Divinity}{Casting, Magical}
    ...
    \magicalff[1]{Divine Spark} Once per \glossterm{long rest}, you can use the \glossterm{desperate exertion} ability without spending \glossterm{stamina}.     

    \magicalff[6]{Sanctified Spell} You learn an additional spell.
    The spell can be up to rank 3, even if you do not have access to rank 3 spells.
    It loses all of the following tags, if it had them: \atAir, \atAuditory, \atCompulsion, \atCold, \atEarth, \atEmotion, \atElectricity, \atFire, \atPhysical, \atVisual, and \atWater.
    In addition, you gain a \plus1 accuracy bonus with the spell.
    ...
    \magicalff[12]{Divine Spark\plus} This ability functions once per \glossterm{short rest} instead of once per long rest.

    \magicalff[18]{Sanctified Soul} You gain a \plus1 bonus to your \glossterm{accuracy}, \glossterm{magical power}, and \glossterm{mundane power}.
    In addition, you take no penalties for being \glossterm{resurrected} (see \pcref{Resurrection}).
  \end{magicalfeat}
  ...
  \begin{magicalfeat}{Sphere Focus: Chronomancy}{Casting, Magical}
    ...
    The spell can be up to rank 3, even if you do not have access to rank 3 spells.
    You can cast the spell as a \glossterm{minor action} if you have not already cast a spell that turn.
    When you do, you \briefly become \slowed and cannot take standard actions.

    This is a metamagic effect, so you cannot apply another metamagic to the same spell.
    When you gain access to a new rank of spells, you can replace your current spell affected by this metamagic with a new spell of that rank.

    \magicalff[12]{Thief of Time} Whenever you cast a spell from the \sphere{Chronomancy} mystic sphere that deals damage to another creature or causes another creature to be \slowed, you \briefly gain a \plus10 foot bonus to your \glossterm{speed}.

    \magicalff[18]{Accelerated Mind\plus} Once per turn, you can perform a purely mental action that would normally require a \glossterm{minor action} as a \glossterm{free action}.
    This can be used to sustain spells or perform other magical feats.
    However, you cannot use the same ability twice in the same turn.
  ...
  \begin{magicalfeat}{Sphere Focus: Cryomancy}{Casting, Magical}
    ...
    \magicalff[1]{Crystal Profusion} Whenever you would gain an ice crystal from a \sphere{Cryomancy} spell, you gain an additional ice crystal.
    In addition, your maximum number of ice crystals increases to four.

    \magicalff[6]{Crystalline Spell} You learn an additional spell.
    The spell can be up to rank 3, even if you do not have access to rank 3 spells.
    Whenever you cast the spell, if you have no active ice crystals, you gain an additional ice crystal.

    \magicalff[12]{Frozen Blood} You are immune to \atCold and \atPoison attacks.

    \magicalff[18]{Budding Crystals} At the end of your turn, if you have no ice crystals and did not spend any ice crystals that turn, you gain an ice crystal.
  \end{magicalfeat}
  ...
  \begin{magicalfeat}{Sphere Focus: Electromancy}{Casting, Magical}
    ...
    \magicalff[1]{Electricity Tolerance} You are \resistant to \atElectricity attacks.

    \magicalff[1]{Extended Chain} The distance that your abilities can \glossterm{chain} increases by 15 feet.
    ...
    \magicalff[12]{Electricity Immunity} You are \buff{immune} to \atElectricity attacks.

    \magicalff[12]{Static Buildup} Whenever you use the \ability{run} or \ability{sprint} ability, you gain a \plus1 accuracy bonus with your next spell from the \sphere{Electromancy} mystic sphere.
    At the end of your next turn, this bonus ends if it was not used.
  ...
  \begin{magicalfeat}{Sphere Focus: Enchantment}{Casting, Magical}
    ...
    You treat those creatures as being \resistant instead of immune.
    This does not allow you to affect creatures who are immune to those abilities for other reasons.

    \magicalff[12]{Implanted Spell} You learn an additional \glossterm{targeted} spell with the \atCompulsion or \atEmotion tags.
    ...
    You can trigger any number of implanted spells as a \glossterm{minor action}.
    When you do, each implanted spell has its full effect on each of its targets.
    The implanted spell effect is removed after the target finishes a \glossterm{short rest} if it has not already triggered.
    ...
    \magicalff[18]{Mind Fragments\plus} You no longer treat those creatures as being resistant.
  \end{magicalfeat}
  ...
  \begin{magicalfeat}{Sphere Focus: Fabrication}{Casting, Magical}
    ...
    \magicalff[1]{Fabricated Armaments} You gain a \plus1 accuracy bonus with \glossterm{strikes} using weapons you created with spells from the Fabrication mystic sphere.
    In addition, you gain a \plus1 bonus to the Armor defense provided by body armor from the Fabrication mystic sphere.

    \magicalff[6]{Dense Fabrication} You learn an additional spell from the \sphere{Fabrication} mystic sphere.
    The spell can be up to rank 3, even if you do not have access to rank 3 spells.
    It deals \glossterm{extra damage} equal to your \glossterm{character rank}, deals double damage to objects, and the hit points of any objects it creates are doubled.

    This is a metamagic effect, so you cannot apply another metamagic to the same spell.
    When you gain access to a new rank of spells, you can replace your current spell affected by this metamagic with a new spell of that rank.

    \magicalff[12]{Fabricated Armaments\plus} The accuracy bonus from your \textit{fabricated armaments} ability increases to \plus2.

    \magicalff[18]{Dense Fabrication\plus} The extra damage increases to twice your character rank.

    \magicalff[18]{Reactive Fabrication} Whenever you attune to a spell from the \sphere{Fabrication} mystic sphere, you can designate that spell as a reactive fabrication that will instantly manifest to protect you from danger.
    If you do, whenever you would suffer a \glossterm{critical hit}, your attunement to that spell is instantly released, and the critical hit becomes a normal hit against you.
  \end{magicalfeat}
  ...
  \begin{magicalfeat}{Sphere Focus: Photomancy}{Casting, Magical}
    ...
    \magicalff[6]{Lensed Spell} You learn an additional area spell with one of the following area sizes: \smallarea, \medarea, \largearea, \hugearea, or \gargarea.
    The spell can be up to rank 3, even if you do not have access to rank 3 spells.
    The size of the area is reduced by one step, to a minimum of a \tinyarea.
    However, you gain a \plus4 accuracy bonus with the spell.

    This is a metamagic effect, so you cannot apply another metamagic to the same spell.
    When you gain access to a new rank of spells, you can replace your current spell affected by this metamagic with a new spell of that rank.

    \magicalff[12]{Luminous Precision} You gain a \plus1 accuracy bonus.
  ...
  \begin{magicalfeat}{Sphere Focus: Polymorph}{Casting, Magical}
    ...
    \magicalff[1]{Augmented Body} You gain a \plus1 \glossterm{enhancement bonus} to your \glossterm{mundane power}, Strength-based skills, Dexterity-based skills, and Constitution-based skills.

    \magicalff[6]{Fleshbending Spell} You learn an additional spell.
    The spell can be up to rank 3, even if you do not have access to rank 3 spells.
    It gains the \atLife tag.
    When you attack with the spell, compare your attack result to the Fortitude defense of each target.
    On a hit, that target takes a \minus4 penalty to its other defenses against that spell.

    This is a metamagic effect, so you cannot apply another metamagic to the same spell.
    When you gain access to a new rank of spells, you can replace your current spell affected by this metamagic with a new spell of that rank.

    \magicalff[12]{Augmented Body\plus} The bonus increases to \plus2.

    \magicalff[18]{Malleable Flesh} Whenever you make a \glossterm{vital roll}, you can increase or decrease the result by up to 2.
    In addition, you gain a \plus2 bonus to your defenses when determining whether an attack gets a \glossterm{critical hit} against you instead of a normal hit.
  \end{magicalfeat}
  ...
  \begin{magicalfeat}{Sphere Focus: Pyromancy}{Casting, Magical}
    ...
    \magicalff[1]{Fire Tolerance} You are \resistant to \atFire attacks.
    ...
    \magicalff[6]{Overheated Pyromancy} You learn an additional non-\glossterm{attunable} spell from the \sphere{Pyromancy} mystic sphere.
    The spell can be up to rank 3, even if you do not have access to rank 3 spells.
    You gain a \plus1 accuracy bonus with the spell, and it deals \glossterm{extra damage} equal to your \glossterm{character rank}.
    However, after you cast the spell, you become \briefly \vulnerable to \atCold attacks.
    ...
    \magicalff[12]{Fire Immunity} You are \buff{immune} to \atFire attacks.

    \magicalff[18]{Burning Heart} You gain a \plus1 bonus to your \glossterm{magical power}.

    \magicalff[18]{Friendly Fire\plus} Your \atFire abilities cannot damage your allies.
  \end{magicalfeat}
  ...
  \begin{magicalfeat}{Sphere Focus: Revelation}{Casting, Magical}
    ...
    Using this ability does not reduce your \glossterm{stamina}.
    ...
    If you cast the spell, then the first time you attack with it this turn, you must use this die result for the attack roll.
    ...
    If you don't like the result, you can simply choose not to cast the spell this turn, and the die result is ignored.
    Either way, you \briefly can't use this ability again.

    This is a metamagic effect, so you cannot apply another metamagic to the same spell.
    When you gain access to a new rank of spells, you can replace your current spell affected by this metamagic with a new spell of that rank.

    \magicalff[12]{Blind Seer} You gain \sense{blindsense} with a 90 foot range (see \pcref{Blindsense}).
  ...
  \begin{magicalfeat}{Sphere Focus: Telekinesis}{Casting, Magical}
    ...
    \magicalff[1]{Efficient Hand} The maximum distance you can move an object with the \spell{distant hand} \glossterm{cantrip} increases to 30 feet.
    ...
    \begin{magicalactiveability}{Violent Hand}{Standard action}
      ...
      Make a melee \glossterm{strike} using that weapon that deals double \glossterm{weapon damage}.
      ...
      \rank{12} The strike deals \glossterm{extra damage} equal to half your \glossterm{magical power}.
      \rank{15} The strike deals five times weapon damage.
      \rank{18} The strike deals eight times weapon damage.
    \end{magicalactiveability}

    \magicalff[12]{Crushing Spell} You learn an additional spell.
    The spell can be up to rank 5, even if you do not have access to rank 5 spells.
  ...
  \begin{magicalfeat}{Sphere Focus: Terramancy}{Casting, Magical}
    ...
    \magicalff[1]{Earthen Shell} You gain a \plus1 \glossterm{enhancement bonus} to your Armor defense.

    \magicalff[6]{Gravitic Spell} You learn an additional spell.
    The spell can be up to rank 3, even if you do not have access to rank 3 spells.
    When you attack with the spell, you gain a \plus1 accuracy bonus against each target for each \glossterm{weight category} by which it is larger than Small: \plus1 for Medium, \plus2 for Large, \plus3 for Huge, \plus4 for Gargantuan, and \plus5 for Colossal.

    This is a metamagic effect, so you cannot apply another metamagic to the same spell.
    When you gain access to a new rank of spells, you can replace your current spell affected by this metamagic with a new spell of that rank.

    \magicalff[12]{Stable as a Rock} You are immune to \glossterm{push}, \glossterm{fling}, \glossterm{teleport}, and \prone effects from attacks.

    \magicalff[18]{Earthen Shell\plus} The bonus increases to \plus2.

    \magicalff[18]{Stonewalker} Whenever you are \glossterm{grounded}, rocks rise up from the ground under your step, then disappear when you walk away.
  ...
  \begin{magicalfeat}{Sphere Focus: Thaumaturgy}{Casting, Magical}
    ...
    \begin{magicalactiveability}{Countermagic}{Standard action}
      ...
      Until your next turn, if the target uses a \magical ability as a standard action or \glossterm{elite action}, that ability has no effect.
      When you negate an ability in this way, if that ability's rank was higher than your \glossterm{character rank}, you reduce your \glossterm{stamina} by one.

      If a creature is capable of using multiple abilities during a single turn, only the first ability it uses can be countered.
  ...
  \begin{magicalfeat}{Sphere Focus: Toxicology}{Casting, Magical}
    ...
    This ability has a \glossterm{limit} of 3 stored doses.

    \magicalff[6]{Venomous Spell} You learn an additional spell.
    The spell can be up to rank 3, even if you do not have access to rank 3 spells.
    It gains the \atPoison tag.
    Whenever you damage a creature with that spell, you can cause the creature to become poisoned with your choice of one of the poisons you store with your \textit{poisonous blood} ability.
    This expends the dose of that poison.
    ...
    \magicalff[18]{Bloodstream Corruption} Whenever you \glossterm{injure} a living creature with a \sphere{Toxicology} spell or your \textit{venomous spell}, that creature becomes \vulnerable to all poisons as a \glossterm{condition}.
  \end{magicalfeat}
  ...
  \begin{magicalfeat}{Sphere Focus: Umbramancy}{Casting, Magical}
    ...
    \magicalff[6]{Call of the Void} You learn an additional spell.
    The spell can be up to rank 3, even if you do not have access to rank 3 spells.
    When you attack with the spell, compare your attack result to the Mental defense of each \glossterm{shadowed} target.
    On a hit, that target takes a \minus4 penalty to its other defenses against that spell.
    ...
    \magicalff[18]{Evasive Shade} While you are \glossterm{shadowed}, you take no damage when an area ability attacks and misses your Armor or Reflex defense.
    This does not protect you from any non-damaging effects of those abilities, or from abilities that affect multiple specific targets without affecting an area.
    If you have the \textit{evasion} monk or rogue ability with the same effect as this ability, you also gain a \plus2 bonus to your Armor and Reflex defenses against area attacks.
  \end{magicalfeat}
  ...
  \begin{magicalfeat}{Sphere Focus: Verdamancy}{Casting, Magical}
    ...
    The spell can be up to rank 3, even if you do not have access to rank 3 spells.
    Whenever you cast that spell, plants \briefly grow on the ground where the spell takes effect.
    ...
    \magicalff[18]{Sprouting Step} At the start of your turn, if you are \glossterm{grounded} and not already in undergrowth, \glossterm{light undergrowth} grows in your space.
  ...
  \begin{magicalfeat}{Sphere Focus: Vivimancy}{Casting, Magical}
    ...
    \magicalff[1]{Hidden Life} Your \atLife abilities from the \sphere{Vivimancy} \glossterm{mystic sphere} affect nonliving creatures other than undead, even if those creatures would normally be immune to \atLife abilities.

    \magicalff[1]{Personal Vitality} You gain a \plus2 bonus to your \glossterm{durability}.

    \magicalff[6]{Reaping Spell} You learn an additional spell.
    The spell can be up to rank 3, even if you do not have access to rank 3 spells.
    It gains a \plus5 \glossterm{accuracy} bonus against \glossterm{injured} creatures.
    When you kill a Medium or larger living creature with the spell, you are \briefly \empowered.

    This is a metamagic effect, so you cannot apply another metamagic to the same spell.
    When you gain access to a new rank of spells, you can replace your current spell affected by this metamagic with a new spell of that rank.

    \magicalff[12]{Life Suppression} You are immune to \atLife attacks.

    \magicalff[18]{Personal Vitality\plus} The durability bonus increases to \plus5.
  \end{magicalfeat}
  ...
  \begin{feat}{Survival Specialization}{Skill}
    ...
    If a skill check, such as Athletics, would normally be required to move through the terrain, this ability does not help.
  ...
  \begin{feat}{Swiftrunner}{General}
    ...
    \ff[1]{Burst of Speed} Once per turn, when you use the \ability{run} or \ability{sprint} abilities, you gain additional \glossterm{available movement} equal to your speed.

    \ff[6]{Rapid Movement} You gain a \plus10 foot bonus to your \glossterm{speed}.

    % TODO: doesn't actually help overland movement, which is odd given the name
    \ff[12]{Long-Distance Runner} You gain a \plus2 bonus to your \glossterm{maximum stamina}.

    \ff[12]{Water Runner} When you use the \ability{run} or \ability{sprint} ability, you can move on water and similar liquids as if they were solid ground during that turn.

    \magicalff[18]{Cloud Runner} When you use the \ability{run} or \ability{sprint} ability, you can clouds, fog, and similar gaseous substances as if they were solid ground during that turn.
  ...
  \begin{magicalfeat}{Telepath}{General, Magical}
    ...
    \magicalff[6]{Mindbreak}
    \begin{magicalactiveability}{Mindbreak}{Standard action}
      \abilitycost You \briefly lose your \glossterm{telepathy}, and you \briefly can't use this ability again.
      \abilitytags \abilitytag{Compulsion}, \abilitytag{Subdual}
      \rankline
      ...
      \rankline
      \featlevel{9} The damage increases to \damagerankthree.
      \featlevel{12} The damage increases to \damagerankfour.
      \featlevel{15} The damage increases to \damagerankfive.
      \featlevel{18} The damage increases to \damageranksix.
      \featlevel{21} The damage increases to \damagerankseven, and the target becomes \confused instead of dazed.
    \end{magicalactiveability}

    \magicalff[12]{Read Mind}
    \begin{magicalsustainability}{Read Mind}{Standard action}
      \abilitytags \abilitytag{Emotion}, \abilitytag{Subtle}, \abilitytag{Sustain} (standard)
      \rankline
      ...
      This takes five turns of continuous concentration, and you can only get answers to one such question each time you use this ability.
    ...
    \magicalff[12]{Telepathy\plus} Your telepathy's communication channel \glossterm{limit} increases to five.
    ...
    This functions like \sense{blindsight}, except that it only allows you to see creatures with an Intelligence of \minus2 or higher.
  ...
  \begin{feat}{Toughness}{General}
    ...
    \ff[1]{Fortified Body} You gain a \plus3 bonus to your Fortitude defense.

    \ff[6]{Durable} You gain a \plus3 bonus to your \glossterm{durability}.
    ...
    \ff[12]{Fortified Body\plus} The defense bonus increases to \plus6.

    \ff[18]{Unbreakable} Your Constitution does not increase your \glossterm{injury point}.
  \end{feat}
  ...
  \begin{feat}{Trickshot}{Combat}
    ...
    When you make a \glossterm{strike} using that arrow, the alchemical item has its normal effect on one target of the strike.
    ...
    You can intentionally miss with the arrow while still delivering the alchemical item to its intended target, allowing you to apply healing potions and similar effects from a distance.

    At the end of your next turn after you use this ability, the arrow and alchemical item are destroyed.

    \ff[6]{Carom} Whenever you make a \glossterm{strike} with an arrow, you can give the strike an additional \glossterm{secondary target} within 15 feet of the primary target.
    That extra target cannot already be a target of the strike.
    You take a \minus1 accuracy with the strike against both targets when you use this ability.

    \ff[12]{Alchemical Arrow\plus} You can use this ability as a \glossterm{minor action} if the alchemical item is at least two ranks lower than your character rank.

    \ff[18]{Carom\plus} The number of secondary targets increases to two, and the maximum distance between the primary target and each secondary target increases to 30 feet.
  \end{feat}
  ...
  \begin{feat}{Twin-Weapon Fighting}{Combat}
    ...
    \ff[1]{Twin-Weapon Stance} At the start of your turn, you can enter one of the stances below or change which stance you are in.
    ...
    % TODO: The "if you are twin-wielding" clause has weird implications for sheathing a weapon and then drawing a different weapon.
    % You shouldn't have to reattune, but that's not clear.
    ...
    Normally, weapons can only have one magical property, but this can allow you to copy multiple properties from a \magicitem{composite} weapon.
  ...
  \begin{magicalfeat}{Wardweaver}{Casting, Magical}
    ...
    \magicalff[1]{Defensive Barriers} Objects you create with \abilitytag{Barrier} abilities have minimum defenses equal to 5 \add half your level.
    If the object already has specific defenses listed, it gains a \plus2 bonus to those defenses.

    \magicalff[1]{Offensive Barriers} You gain a \plus1 accuracy bonus with \atBarrier abilities.

    \magicalff[6]{Esoteric Barrier} You learn a spell with the \abilitytag{Barrier} ability tag from any \glossterm{mystic sphere} that your \glossterm{magic source} gives access to, even if you do not have access to that mystic sphere.
    When you gain access to new spell ranks, you can change which Barrier spell you know with this ability.

    \magicalff[12]{Personal Barrier} You gain a \plus1 bonus to your Armor defense and \glossterm{durability}.

    \magicalff[18]{Defensive Barriers\plus} The minimum defenses increase to 8 \add half your level.

    \magicalff[18]{Offensive Barriers\plus} The accuracy bonus increases to \plus2.
  \end{magicalfeat}
  ...
  \begin{feat}{Weapon Focus}{Combat}
    ...
    \ff[1]{Mighty Weapon} You gain a \plus1 bonus to your \glossterm{weapon dice increment} with your focused weapon.

    \ff[6]{Precise Focus} You gain a \plus1 bonus to \glossterm{accuracy} with \glossterm{strikes} using your focused weapon.
    
    \ff[12]{Weapon Supremacy} Whenever you miss with a \glossterm{strike} using your focused weapon, you still deal half damage.
    Any effects other than damage do not apply.
    If your weapon has the \weapontag{Impact} tag, a miss that would deal half damage due to that tag instead deals full damage.

    \ff[18]{Precise Focus\plus} The accuracy bonus increases to \plus2.
  \end{feat}
  ...
  \begin{feat}{Whirlwind Warrior}{Combat}
    ...
    \begin{activeability}{Cyclone}{Standard action}
      ...
      \featlevel{12} The strike deals double \glossterm{weapon damage}.
      \featlevel{15} The strike deals quadruple \glossterm{weapon damage}.
      \featlevel{18} The extra damage increases to be equal to your power.
