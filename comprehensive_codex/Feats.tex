...
\section{Feat Descriptions}
  ...
  \begin{feat}{Ascetic}{General}
    ...
    Instead, you gain a \plus1 bonus to your non-Armor \glossterm{defenses}.
  ...
  \begin{magicalfeat}{Ghostblade}{Combat, Magical}
    ...
    Otherwise, you are \impervious to \atCold attacks and all attacks by \trait{incorporeal} creatures.
  ...
  \begin{feat}{Null}{General}
    ...
    \ff[1]{Mundane Resilience} You gain a \plus2 bonus to your \glossterm{durability}.
  ...
  \end{activeability}
    ...
    Instead, you gain a \plus1 bonus to your \glossterm{durability} and non-Armor \glossterm{defenses}.
    ...
    \ff[12]{Personal Legacy\plus} The bonuses increases to \plus2.

    \ff[18]{Personal Legacy\plus\plus} The bonuses increases to \plus3.
  ...
  \begin{magicalfeat}{Sphere Focus: Polymorph}{Casting, Magical}
    ...
    \begin{magicalattuneability}{Augmented Body}{Triggered}
      \abilitytags \abilitytag{Attune} (deep)
      \rankline
  ...
  \begin{feat}{Weapon Focus}{Combat}
    ...
    \ff[18]{Weapon Supremacy} Whenever you miss with a \glossterm{strike} using your focused weapon, you still deal half damage.
