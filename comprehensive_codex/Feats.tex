...
\section{Feat Descriptions}
  ...
  \begin{feat}{Heavenly Warrior}{Combat}
    ...
    \ff[18]{Heavenly Descent} Whenever you land from an intentional jump, each \glossterm{enemy} adjacent to you that is shorter than the apex of that jump is \glossterm{briefly} \stunned.
  \end{feat}
