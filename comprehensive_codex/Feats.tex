...
\section{Feat Descriptions}
  ...
  \begin{magicalfeat}{Blood Magic}{Casting, Magical}
    ...
    \magicalff[12]{Fountain of Blood} At the end of each round, if you did not use your \ability{bloodspell} ability that round, you regain hit points equal to your \glossterm{magical power}.
