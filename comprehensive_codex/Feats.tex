...
\section{Feat Descriptions}
  ...
  \begin{magicalfeat}{Barbaric Ancestry}{Ancestry, Magical}
    ...
    \magicalff[6]{Blood of My Ancestors} You gain a \plus1 bonus to \glossterm{vital rolls} and a bonus equal to your level to your maximum \glossterm{hit points}.
    ...
    \magicalff[18]{Blood of My Ancestors\plus} The vital roll bonus increases to \plus2, and the hit points bonus increases to twice your level.
  \end{magicalfeat}
  ...
  \begin{feat}{Chameleon}{General}
    ...
    You also gain a bonus to your maximum hit points and damage resistance equal to half your \glossterm{level}.
  ...
  \begin{magicalfeat}{Ghostblade}{Combat, Magical}
    ...
    \magicalff[18]{Half Spirit} Your maximum hit points that you gain from your base class are halved.
    You gain a bonus to your maximum damage resistance equal to the maximum hit points you lost in this way.

    \magicalff[18]{Ghostly Vitality} When your hit points become negative, your negative hit points must match the sum of your maximum \glossterm{hit points} and \glossterm{damage resistance} to inflict additional \glossterm{vital wounds} on you, rather than only matching your maximum hit points (see \pcref{Negative Hit Points}).
  \end{magicalfeat}
  ...
  \end{activeability}
    ...
    \ff[12]{Personal Legacy\plus} The defense bonus increases to \plus2.

    \ff[18]{Mundane Resilience\plus} The bonuses from your \textit{mundane resilience} ability increase to twice your level.

    \ff[18]{Personal Legacy\plus\plus} The defense bonus increases to \plus3.
