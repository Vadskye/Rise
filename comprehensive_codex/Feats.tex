...
\section{Feat Descriptions}
  ...
  \begin{feat}{Weapon Focus}{Combat}
    ...
    This does not function if your choice of legacy item is replaced with multiple weapons, such as with the Battle Armory or Twin-Weapon Fighting feats.
  ...
  \begin{feat}{Whirlwind Warrior}{Combat}
    ...
    You can only end your movement in occupied space if you would not be considered squeezing by doing so.
