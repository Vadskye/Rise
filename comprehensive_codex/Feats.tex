...
\section{Feat Descriptions}
  ...
  \begin{feat}{Greatweapon Warrior}{Combat}
    ...
    \ff[1]{Resounding Impact} Whenever you get a \glossterm{glancing blow} with a melee strike using a weapon you hold in two hands, you deal full damage instead of half damage.

    \ff[6]{Cleave} Whenever you make a \glossterm{melee} \glossterm{strike} using a weapon you hold in two hands, it gains the Sweeping (1) tag (see \pcref{Sweeping}).
    ...
    \ff[12]{Great Power} You gain a \plus1 bonus to your \glossterm{magical power} and \glossterm{mundane power}.
