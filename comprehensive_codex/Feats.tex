...
\section{Feat Descriptions}
  ...
  \begin{feat}{Greatweapon Warrior}{Combat}
    ...
    After using this ability, you \glossterm{briefly} suffer a \minus2 penalty to all defenses.

    \ff[12]{Cleave\plus} You instead gain the Sweeping (2) tag, or you increase the existing tag's value by 2.

    \ff[18]{Power Attack\plus} Whenever you deal damage to a creature or object with a \textit{power attack}, you can \glossterm{push} that creature or object up to 15 feet in a straight line directly away from you.
    If a creature gained an \glossterm{injury} from your attack, you \glossterm{fling} it instead of pushing it.
