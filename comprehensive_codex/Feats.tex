...
\section{Feat Descriptions}
  ...
  \begin{feat}{Leadership}{Combat}
    ...
    \ff[12]{Bolster}
    % Assume empower affects 3 ally actions, so it's ~1.2 EA.
    % We add a brief cooldown to make it more reasonable.
    \begin{activeability}{Bolster}{Standard action}
      \abilitytags \atAuditory, \abilitytag{Emotion}
      \abilitycost You can't use this ability next round.
      \rankline
      Each \glossterm{ally} within a \largearea radius from you is \briefly either \empowered or \steeled.
      You must make the same choice for all allies. 
      \rankline
      \featlevel{18} Each target is both empowered and steeled.
    \end{activeability}
  ...
  \begin{feat}{Rapid Reaction}{General}
    ...
    \ff[1]{Sidestep} If you have \glossterm{speed} remaining after the \glossterm{movement phase}, you may use that movement speed during the \glossterm{action phase} as a \glossterm{free action} once per round.
