...
\section{Feat Descriptions}
  ...
  \begin{feat}{Blindfighter}{Combat}
    ...
    \ff[12]{Unerring+} You are unaffected by all miss chances.
  ...
  \begin{feat}{Brawler}{Combat}
    ...
    \ff[12]{Brawling Expertise+} The bonus from your \textit{brawling expertise} ability increases to \plus2.
  ...
  \begin{feat}{Draconic Ancestry}{Ancestry}
    ...
    \ff[18]{Draconic Wings+} The height limit increases to 30 feet.
  \end{feat}
  ...
  \begin{feat}{Duelist}{Combat}
    ...
    \ff[18]{Duel Focus+} The bonus from your \textit{duel focus} ability increases to \plus2.
  \end{feat}
  ...
  \begin{feat}{Executioner}{Combat}
    ...
    \ff[18]{Finishing Blow+} The accuracy bonus increases to \plus2, or to \plus3 if you are adjacent.
  \end{feat}
  ...
  \begin{feat}{Juggernaut}{Combat}
    ...
    \ff[18]{Unstoppable+} You are immune to \glossterm{teleport}, \glossterm{knockback}, and \glossterm{push} effects from attacks.
  ...
  \begin{feat}{Rapid Reaction}{General}
    ...
    \ff[18]{Evasive Reaction+} This ability also protects you from area attacks against your Brawn, Fortitude, and Mental defenses.
    If you have the \textit{evasion+} monk or rogue ability with the same effect as this ability, you also gain a \plus2 bonus to your Brawn, Fortitude, and Mental defenses against area attacks.
  \end{feat}
  ...
  \begin{feat}{Sniper}{Combat}
    ...
    \ff[18]{Aim+} When you use this ability, you are also \glossterm{briefly} \honed.

    \ff[18]{Steady Shot+} If your location has not changed since the start of the round, your ranged \glossterm{strikes} ignore \glossterm{cover} and \glossterm{concealment}.
  \end{feat}
  ...
  \begin{feat}{Whirlwind Warrior}{Combat}
    ...
    \ff[18]{Eye of the Storm+} The bonus increases to \plus2.
  \end{feat}
