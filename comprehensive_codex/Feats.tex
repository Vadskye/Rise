...
\section{Feat Descriptions}
  ...
  \begin{feat}{Weapon Focus}{Combat}
    ...
    \ff[1]{Precise Focus} You gain a \plus1 accuracy bonus with \glossterm{strikes} using your focused weapon.
    ...
    \ff[12]{Precise Focus\plus} The accuracy bonus increases to \plus2.

    \ff[18]{Enhanced Legacy+\plus} You can change the item property, and the maximum rank increases to 7.
