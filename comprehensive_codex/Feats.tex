...
\section{Feat Descriptions}
  ...
  \begin{magicalfeat}{Legacy Item}{General}
    ...
    \ff[12]{Legacy Item\plus} You can replace your legacy item's original property with a magic item property that is rank 5 or lower.

    \ff[18]{Legacy Item\plus\plus} You can replace your legacy item's additional property with a magic item property that is rank 7 or lower.
  \end{magicalfeat}
