...
\section{Feat Descriptions}
  ...
  \begin{feat}{Leadership}{Combat}
    ...
    \ff[1]{Battle Command}
    \begin{activeability}{Battle Command}[\atAuditory]
      \abilityusagetime Standard action.
      \rankline
    ...
    \begin{activeability}{Bolster}[\atAuditory, \abilitytag{Emotion}, \abilitytag{Swift}]
      \abilitycost You \glossterm{briefly} cannot use this ability again.
      \abilityusagetime Standard action.
      \rankline
  ...
  \begin{feat}{Shieldbearer}{Combat}
    ...
    % TODO: redesign to avoid enemy-local trigger
  ...
  \begin{magicalfeat}{Sphere Focus: Summoning}{Casting, Magical}
    ...
    \magicalff[1]{Empowered Summon} Whenever you create a creature with a spell, you can choose to make it \empowered.
    You can only empower one creature at a time in this way.
    ...
    \begin{magicalactiveability}{Resummon}
      ...
      % TODO: wording
      Those creatures can immediately act if no creatures created by that spell already acted this round.
    \end{magicalactiveability}

    \magicalff[12]{Braced Summon} Whenever you create a creature with a spell, you can choose to make it \braced.
    You can only protect one creature at a time in this way.

    \magicalff[18]{Generosity} Whenever you \glossterm{attune} to an item or spell that is not a \glossterm{deep attunement}, you may use this ability.
    When you do, all creatures you create with spells gain the benefit of all effects of the chosen item or spell.
    If the item is a weapon, they benefit from its effects as if their natural weapons were that weapon.
    Summoned creatures cannot make choices or use active abilities granted by items, so they generally only benefit from passive or automatically triggered effects.

    The attunement still affects you normally.
  ...
  \begin{feat}{Toughness}{General}
    ...
    \ff[18]{Durable\plus} The durability bonus increases to \plus5.
  \end{feat}
