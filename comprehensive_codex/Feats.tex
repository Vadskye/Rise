...
\section{Feat Descriptions}
  ...
  \begin{feat}{Heavenly Warrior}{Combat}
    ...
    \begin{activeability}{Call to Heaven}{Standard action}
      ...
      If you hit, and you are strong enough to carry the target, you \glossterm{fling} it up to 10 feet vertically.
      ...
      After you finish using this ability, the target immediately falls to the ground, which typically causes it to take \glossterm{falling damage} (see \pcref{Falling Damage}).
      \rankline
