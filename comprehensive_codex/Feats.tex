...
\section{Feat Descriptions}
  ...
  \begin{magicalfeat}{Sphere Focus: Cryomancy}{Casting, Magical}
    ...
    \magicalff[1]{Frozen Blood} You are \impervious to \atCold and \atPoison attacks.
    ...
    \magicalff[12]{Frozen Blood\plus} You are immune to \atCold and \atPoison attacks.

    \magicalff[18]{Icy Carapace\plus} The number of bonus layers you gain from your \textit{icy carapace} ability increases to two.
  \end{magicalfeat}
