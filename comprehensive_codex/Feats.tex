...
\section{Feat Descriptions}
  ...
  \begin{magicalfeat}{Ghostblade}{Combat, Magical}
    ...
    Otherwise, you are \trait{impervious} to \atCold attacks and all attacks by \trait{incorporeal} creatures.
  ...
  \begin{magicalfeat}{Telepath}{General, Magical}
    ...
    This functions like \trait{blindsight}, except that it only allows you to see creatures with an Intelligence of \minus2 or higher.
