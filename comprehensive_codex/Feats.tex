...
\section{Feat Descriptions}
  ...
  \begin{feat}{Sniper}{Combat}
    ...
    \ff[6]{Steady Shot} If your location did not change since the start of the round, you reduce your \glossterm{longshot penalty} by 2.

    \ff[12]{Sniper's Precision} You gain a \plus1 bonus to \glossterm{accuracy} with ranged \glossterm{strikes}.

    \ff[18]{Steady Shot+} If your location did not change since the start of the round, you gain a \plus4 accuracy bonus with ranged \glossterm{strikes} for the purpose of determining whether you get a \glossterm{critical hit}.
  \end{feat}
