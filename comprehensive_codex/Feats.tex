...
\section{Feat Descriptions}
  ...
  \begin{feat}{Fateweaver}{General, Magical}
    ...
    \begin{magicalactiveability}{Fateseal}
      ...
      Whenever you or one of your \glossterm{allies} make an attack roll against it, if the attack result would be less than 5 \add their \glossterm{accuracy}, treat it as 5 \add their \glossterm{accuracy} instead.
