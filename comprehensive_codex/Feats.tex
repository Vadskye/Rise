...
\section{Feat Descriptions}
  ...
  \begin{feat}{Weapon Focus}{Combat}
    ...
    \ff[1]{Mighty Weapon} The \glossterm{weapon damage} of your focused weapon increases by one step in the order below:
    \begin{raggeditemize}
      \item 1d3
      \item 1d4
      \item 1d6
    ...
    \ff[6]{Precise Focus} You gain a \plus1 \glossterm{enhancement bonus} to \glossterm{accuracy} with \glossterm{strikes} using your focused weapon.
