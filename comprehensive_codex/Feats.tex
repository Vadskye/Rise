...
\section{Feat Descriptions}
  ...
  \begin{feat}{Battle Armory}{Combat}
    ...
    Instead, if you choose weapons as your legacy item category, you choose magic weapon abilities that apply to all nonmagical weapons you wield, excluding \glossterm{natural weapons}.
  ...
  \begin{magicalfeat}{Celestial Ancestry}{Ancestry, Magical}
    ...
    \begin{activeability}{Celestial Benevolence}[\abilitytag{Swift}]
        \abilityusagetime \glossterm{Free action} once per round.
        \rankline
        Choose an \glossterm{ally} adjacent to you.
        Whenever that ally would be attacked by a \glossterm{targeted} ability this round, the attack is made against you instead.
