...
\section{Feat Descriptions}
  ...
  \begin{magicalfeat}{Celestial Ancestry}{Ancestry, Magical}
    ...
    \begin{magicalsustainability}{Scouring Light}{Standard action}
      ...
      \rankline
      When you use or sustain this ability, you \glossterm{briefly} radiate \glossterm{brilliant illumination} in a \medarea radius from you.
  ...
  \begin{feat}{Executioner}{Combat}
    ...
    \ff[18]{Death is Coming} Whenever you deal damage to a creature that is marked for execution, you are \glossterm{briefly} \honed.
  \end{feat}
  ...
  \begin{magicalfeat}{Ghostblade}{Combat, Magical}
    ...
    \begin{magicalactiveability}{Spectral Slice}{Standard action}
      ...
      \hit If your attack also hits the target's Fortitude defense, it is \glossterm{briefly} \slowed.
  ...
  \begin{feat}{Leadership}{Combat}
    ...
    \begin{activeability}{Bolster}{Standard action}
      ...
      \abilitycost You \glossterm{briefly} cannot use this ability again.
      \rankline
      Each \glossterm{ally} within a \largearea radius from you is \glossterm{briefly} either \empowered or \steeled.
  ...
  \begin{magicalfeat}{Mystic Synthesist}{Casting, Magical}
    ...
    \begin{raggeditemize}
      ...
      \item Finesse: You use your Dexterity in place of your Perception to determine your \glossterm{accuracy} with the spell.
        However, when you cast the spell, you \glossterm{briefly} take a \minus1 penalty to your Armor and Reflex defenses.
  ...
  \begin{magicalfeat}{Sphere Focus: Chronomancy}{Casting, Magical}
    ...
    \magicalff[12]{Thief of Time} Whenever you cast a spell from the \sphere{Chronomancy} mystic sphere that deals damage to another creature or causes another creature to be \slowed, you \glossterm{briefly} gain a \plus10 foot bonus to your \glossterm{speed}.
  ...
  \begin{magicalfeat}{Sphere Focus: Pyromancy}{Casting, Magical}
    ...
    However, after you cast the spell, you become \glossterm{briefly} \vulnerable to \atCold attacks.
  ...
  \begin{magicalfeat}{Sphere Focus: Vivimancy}{Casting, Magical}
    ...
    When you kill a Medium or larger living creature with the spell, you are \glossterm{briefly} \empowered.
