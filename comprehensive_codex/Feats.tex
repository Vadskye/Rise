...
\section{Feat Descriptions}
  ...
  \begin{feat}{Living Weapon}{Combat}
    ...
    \ff[12]{Made of Iron} You gain a \plus4 bonus to your defenses when determining whether an attack gets a \glossterm{critical hit} against you instead of a normal hit.

    \ff[12]{My Body Is My Weapon\plus} The damage increases to 1d10.

    \ff[18]{Made of Steel} You are \steeled.
  ...
  \begin{magicalfeat}{Sphere Focus: Polymorph}{Casting, Magical}
    ...
    \magicalff[18]{Malleable Flesh} You gain a \plus10 bonus to your defenses when determining whether a \glossterm{strike} gets a \glossterm{critical hit} against you instead of a normal hit.
  \end{magicalfeat}
