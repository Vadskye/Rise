...
\section{Feat Descriptions}
  ...
  \begin{magicalfeat}{Ghostblade}{Combat, Magical}
    ...
    \magicalff[1]{Ghost Shroud} Your Constitution does not increase your \glossterm{injury point} (see \pcref{Injury Point}).
    You can also use the lower of your Dexterity and Willpower in place of your Constitution to determine your \glossterm{hit points}.
