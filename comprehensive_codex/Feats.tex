...
\section{Feat Descriptions}
  ...
  \begin{magicalfeat}{Entropist}{General, Magical}
    ...
    \magicalff[6]{Friend of Chaos} Whenever you roll to determine a random effect, such as a \glossterm{miss chance} or a sorcerer's \textit{wild magic} ability, you may \glossterm{reroll} once.
    ...
    The attacker rolls this chance instead of you, so it is not affected by your \textit{friend of chaos} ability.

    \magicalff[18]{Master of Chaos} Whenever you roll to determine a random effect, you can use this ability.
    When you do, you reduce your \glossterm{stamina} by one, and you may freely choose the random result.
