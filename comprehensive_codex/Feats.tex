...
\section{Feat Descriptions}
  ...
  \begin{magicalfeat}{Mystic Synthesist}{Casting, Magical}
    ...
    \begin{raggeditemize}
      ...
      \item Finesse: You use your Dexterity in place of your Perception to determine your \glossterm{accuracy} with the spell.
        However, when you cast the spell, you \briefly take a \minus1 penalty to your Armor and Reflex defenses.
        You can only apply this augment to non-\glossterm{attunable} spells.
      ...
      \item Sympathetic: The spell includes you as a target and automatically hits you.
        As long as you are not immune to the spell or any part of its effects, this grants you a \plus2 \glossterm{enhancement bonus} to \glossterm{accuracy} with the spell against its other targets.
        You can only apply this augment to \glossterm{targeted} damaging spells.
    \end{raggeditemize}
    ...
    \magicalff[18]{Unbound Creativity} You can apply two metamagic effects to your spells, rather than the normal limit of one.
  \end{magicalfeat}
  ...
  \begin{magicalfeat}{Sphere Focus: Terramancy}{Casting, Magical}
    ...
    The spell can be up to rank 3, even if you do not have access to rank 3 spells.
    When you attack with the spell, you gain a \plus1 accuracy bonus against each target for each \glossterm{size category} by which it is larger than Small: \plus1 for Medium, \plus2 for Large, \plus3 for Huge, \plus4 for Gargantuan, and \plus5 for Colossal.
