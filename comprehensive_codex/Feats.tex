...
\section{Feat Descriptions}
  ...
  \begin{magicalfeat}{Blood Magic}{Casting, Magical}
    ...
    \magicalff[18]{Bloodbind\plus} You are always considered to have \glossterm{line of effect} with \magical abilities to a creature bound by your \textit{bloodbind} ability, regardless of intervening obstacles.
    This allows you to cast spells on them through solid walls.

    \magicalff[18]{Bloodspell\plus} You can choose to increase the accuracy bonus to \plus5.
  ...
  \begin{feat}{Executioner}{Combat}
    ...
    \ff[18]{Finishing Blow\plus} The accuracy bonus increases to \plus2, or to \plus3 if you are adjacent.
  \end{feat}
  ...
  \begin{feat}{Heavenly Warrior}{Combat}
    ...
    \ff[12]{Featherlight Landing\plus} You are immune to \glossterm{falling damage}.
  ...
  \begin{feat}{Shieldbearer}{Combat}
    ...
    \ff[18]{Forceful Block\plus} The penalty from your \textit{forceful block} ability increases to \minus4.

    \ff[18]{Shield Expertise\plus} The Armor defense bonus from your \textit{shield expertise} ability increases to \plus2, and to \plus6 while you are affected by \ability{total defense} and related abilities.
  \end{feat}
  ...
  \begin{feat}{Sniper}{Combat}
    ...
    \begin{sustainability}{Aim}{\abilitytag{Subtle}, \abilitytag{Sustain} (minor)}
      ...
      You gain a \plus1 accuracy bonus against the target.
