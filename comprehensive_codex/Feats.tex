...
\section{Feat Descriptions}
  ...
  \begin{feat}{Heavenly Warrior}{Combat}
    ...
    \begin{activeability}{Call to Heaven}[\atBrawling (see text), \atSizeBased (see text)]
      ...
      If you hit, and the target's \glossterm{weight category} does not exceed your carrying capacity, you \glossterm{knockback} the target up to 10 feet vertically, leaving it \glossterm{midair}.
  ...
  \begin{magicalfeat}{Sphere Focus: Channel Divinity}{Casting, Magical}
    ...
    \magicalff[1]{Aspect of Divinity} You gain an bonus equal to your rank in the \sphere{channel divinity} mystic sphere to your \glossterm{hit points} and \glossterm{damage resistance}.
    ...
    \magicalff[18]{Aspect of Divinity+} The bonus increases to be equal to your level.
  \end{magicalfeat}
