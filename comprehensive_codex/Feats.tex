...
\section{Feat Descriptions}
  ...
  \begin{feat}{Rapid Reaction}{General}
    ...
    \ff[1]{Sidestep} If you have \glossterm{movement speed} remaining after the \glossterm{movement phase}, you may use that movement during the \glossterm{action phase} as a \glossterm{free action} once per round.
