...
\section{Feat Descriptions}
  ...
  \begin{magicalfeat}{Sphere Focus: Verdamancy}{Casting, Magical}
    ...
    \magicalff[6]{Residual Undergrowth} Whenever you cast a spell from the \textit{verdamancy} sphere, you may create \glossterm{light undergrowth} in the area of the spell.
    % TODO: weird wording
