...
\section{Feat Descriptions}
  ...
  \begin{magicalfeat}{Entropist}{General, Magical}
    ...
    \begin{magicalactiveability}{Sudden Entropy}{Standard action}
      ...
      \featlevel{6} The damage increases to 1d6 per 2 power.
      \featlevel{9} The damage increases to 1d6 \add 1d6 per 2 power.
        In addition, any \glossterm{extra damage} is doubled.
      \featlevel{12} The damage increases to 1d8 \add 1d8 per 2 power.
      \featlevel{15} The damage increases to 1d10 \add 1d10 per 2 power.
      \featlevel{18} The damage bonus increases to 1d6 \add 1d6 per power.
    \end{magicalactiveability}
  ...
  \begin{feat}{Shieldbearer}{Combat}
    ...
    \ff[12]{Shield Cover} While you wield a shield, you can use your Armor defense in place of your Reflex defense against \glossterm{area} attacks.
