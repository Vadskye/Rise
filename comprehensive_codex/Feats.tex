...
\section{Feat Descriptions}
  ...
  \begin{magicalfeat}{Boongiver}{Casting, Magical}
    ...
    \begin{magicalactiveability}{Share Boon}{Triggered}
      \rankline
  ...
  \begin{feat}{Heavenly Warrior}{Combat}
    ...
    \begin{activeability}{Call to Heaven}{Standard action}
      ...
      If you hit, and you are strong enough to carry the target, you \glossterm{knockback} the target up to 10 feet vertically.
      ...
      \rank{6} The maximum knockback distance increases to 40 feet.
  ...
  \begin{magicalfeat}{Sphere Focus: Terramancy}{Casting, Magical}
    ...
    \magicalff[12]{Stable as a Rock} You are immune to \glossterm{knockback}, \glossterm{push}, \glossterm{teleport}, and \prone effects from attacks.
