...
\section{Feat Descriptions}
  ...
  \begin{feat}{Heavenly Warrior}{Combat}
    ...
    \begin{activeability}{Call to Heaven}{Standard action}
      ...
      \rank{5} The strike deals double damage against \glossterm{midair} targets.
      \rank{6} The maximum fling distance increases to 40 feet.
      \rank{7} The strike deals triple damage against midair targets, and double damage otherwise.
    \end{activeability}
