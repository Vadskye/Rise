...
\section{Feat Descriptions}
  ...
  \begin{feat}{Balance Specialization}{Skill}
    ...
    Failure means you fall through the surface, and you cannot use this ability again this turn.
  ...
  \begin{feat}{Heavenly Warrior}{Combat}
    ...
    \begin{triggeredability}{Heavenly Descent}{Triggered}
      Once per round, when you land from an intentional jump, you can make an attack vs. Fortitude against each \glossterm{enemy} adjacent to you that is shorter than the apex of that jump.
  ...
  \begin{magicalfeat}{Mystic Archer}{Casting, Magical}
    ...
    \begin{magicalattuneability}{Imbue Projectile}{Standard action}
      ...
      After the spell takes effect, you can't trigger any more spells you imbued this ability until after next round.
  ...
  \begin{feat}{Rapid Reaction}{General}
    ...
    If you have the Reposition fighter ability with the same effect, you instead increase your movement with that ability by five feet.
    ...
    If you have the Reposition fighter ability, the movement bonus instead increases to ten feet.
  ...
  \begin{magicalfeat}{Sphere Focus: Aquamancy}{Casting, Magical}
    ...
    At the end of the next round, the attack \glossterm{repeats} on the target if the bubble remains.
  ...
  \begin{magicalfeat}{Sphere Focus: Revelation}{Casting, Magical}
    ...
    Either way, you can't use this ability next round.
  ...
  \begin{magicalfeat}{Telepath}{General, Magical}
    ...
    \begin{magicalactiveability}{Mindbreak}{Standard action}
      \abilitycost You \glossterm{briefly} lose your \glossterm{telepathy}, and you can't use this ability next round.
