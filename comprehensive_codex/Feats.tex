...
\section{Feat Descriptions}
  ...
  \begin{feat}{Gestalt}{General}
    \ff[1]{Archetype Fusion} Choose one archetype from your \glossterm{base class} that you do not already have any ranks in.
    ...
    \ff[12]{Archetype Fusion\plus} You can choose a second archetype from your \glossterm{base class} that you do not already have ranks in.
    This does not increase your rank in that archetype, but you become eligible to increase your rank in that archetype when you level up, including when you reach level 12.
