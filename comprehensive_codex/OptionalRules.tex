...
\section{Epic Fates}
  ...
  \subsection{Hero of Legend}
    ...
    \subsubsection{Hero of Legend Ranks}
      ...
      \parhead{Rank 2 -- Heroic Intervention} As a \glossterm{standard action}, you may choose any number of \glossterm{allies} within \longrange.
  ...
  \subsection{Slayer}
    ...
    \subsubsection{Slayer Ranks}
      ...
      This bonus stacks with other abilities with the same effect, such as \abilitytag{Keen} weapons.
...
\section{Alternate Play Styles}
  ...
  \subsection{Encumbrance}
    Normally, wearing body armor or carrying around a lot of weight doesn't directly reduce your ability to perform tasks like sneaking around or swimming.
    This is unrealistic, and just a convenience to avoid complexity.
    With this optional rule, medium body armor imposes a \minus2 penalty to Strength-based skill checks, Dexterity checks, and Dexterity-based skill checks.
    Heavy body armor imposes a \minus4 penalty to the same checks.
    This makes body armor slightly more realistic, so characters are more likely to take off heavy armor before engaging in activities that require agility.
