  ...
  \subsection{Faebonder}
    ...
    \begin{itemize}
      \item The magic source for the faebonder class is nature magic instead of pact magic.
        ...
        However, they still require both \glossterm{verbal components} and \glossterm{somatic components} to cast spells from the faebonder class (see \pcref{Ability Usage Components}).
  ...
  \subsection{Favored Soul}
    ...
    \begin{itemize}
      \item The magic source for the favored soul class is divine magic instead of pact magic.
        ...
        However, they still require both \glossterm{verbal components} and \glossterm{somatic components} to cast spells from the favored soul class (see \pcref{Ability Usage Components}).
