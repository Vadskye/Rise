...
\section{Epic Fates}
  ...
  \subsection{Ascendant}
    ...
    \subsubsection{Ascendant Ranks}
      ...
      Reforming in this way returns you to full hit points and removes all conditions and vital wounds, but your \glossterm{fatigue levels} and other effects remain the same.
  ...
  \subsection{Avatar of Life}
    ...
    \parhead{Progression} To progress towards this epic fate, you must 

    \subsubsection{Avatar of Life Ranks}
      \epicfate{1}{Vibrant Senses} You gain a \plus10 bonus to the Awareness skill.
  ...
  \subsection{Deity}
    ...
    \subsubsection{Deity Ranks}
      ...
      \epicfate{5}{Deification} You become a deity.
  ...
  \subsection{Mutant}
    ...
    \subsubsection{Mutant Ranks}
      ...
      \epicfate{2}{Regeneration} At the end of each round, you regain hit points equal to a quarter of your maximum hit points.
