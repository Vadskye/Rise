...
\section{Attributes}
  ...
  \subsection{Other Methods of Attribute Generation}
    ...
    \subsubsection{Smoothed Random Point Buy}
      ...
      \begin{columntable}
        \columncaption{Smoothed Random Point Buy Results}
...
\section{Epic Fates}
  ...
  When you reach rank 7, you may choose an epic fate that you qualify for, or you may delay choosing until you meet the prerequisites for your desired fate.
  You do not start with any ranks in your chosen epic fate.
  ...
  Epic fate abilities are beyond ordinary magic.
  They are closer to the reality-warping abilities of deities.
  Even epic fate abilities that are ostensibly \glossterm{mundane} can achieve things that would normally be impossible.
  Creatures that are immune to magic, such as high level characters with the Null feat, are still affected normally by \magical epic fate abilities.
  ...
  \subsection{Ascendant}
    ...
    \parhead{Prerequisites} You must have spent at least a week living in at least three of the following locations: Aqua, Ignis, Luna, Nexus, Terra, Ventus, and the Astral Expanse.
    ...
    \subsubsection{Ascendant Ranks}
      ...
      \magicalepicfate{1}{Energetic Soul} Whenever you use an ability, you can give that ability the \atCold, \atElectricity, and \atFire tags.
      In addition, whenever you take or deal damage from an ability that has any of those tags while not \trait{incorporeal}, you and your equipment \briefly become incorporeal.
      ...
      In this form you are considered native to the air, so flying in this way does not make you \unsteady.

      \magicalepicfate{2}{See Through the Weave} You can see everything within 120 feet of you perfectly, regardless of obstacles of any kind or light levels.
      This is similar to \sense{blindsight}, except that it also ignores solid obstacles of any kind, allowing you to have \glossterm{line of sight} through walls.
      You can perceive the presence of obstacles just as well as you can see what lies behind them.

      \magicalepicfate{3}{Reach Through the Weave} When you use any of your abilities, you can use any location within 60 feet of you as a \glossterm{targeting proxy}.
      ...
      \magicalepicfate{4}{Become Energy} You become permanently \trait{incorporeal}, along with any equipment you carry.
      The fly speed from your \textit{energetic soul} ability also becomes permanent.
      In addition, you no longer age and can never be \glossterm{injured}.

      \magicalepicfate{5}{Ascension} You cannot be killed, only dissipated.
      When you die, you automatically \glossterm{resurrect} in a new body at a random location within 100 miles of your death after 1d8 hours.
      Resurrecting in this way does not cause the normal penalties for resurrection.

  \subsection{Avatar of Life}
    You are vibrantly and fully alive in a way other people can only dream of.

    \parhead{Prerequisites} You must be alive.
    In addition, you must have some contact with Gaia, the ultimate source and destination for all life.
    This could be benevolent, such as by gaining her blessing, or hostile, such as by stealing a sliver of her power for yourself.

    \parhead{Progression} To progress towards this epic fate, you must lifebond living things that are either individually powerful or massive in number.

    \subsubsection{Avatar of Life Ranks}
      \magicalepicfate{1}{Lifebond}
      \begin{magicalactiveability}{Lifebond}{Standard action}
        \rankline
        You bond your life to one living creature or object you touch.
        If an area has many living plants living in harmony, you can lifebond to the area as a whole instead of to an individual plant.
        The maximum area size you can bond to in this way is a \hugearea radius \glossterm{zone}.
        Creating a lifebond has several effects, all of which function only while you are on the same plane as the target.
        \begin{raggeditemize}
          \item You know the exact distance and direction to the target.
          \item You know whether the target is \glossterm{injured} and how many \glossterm{vital wounds} it has.
          \item Whenever the target would lose hit points, it loses half that many hit points instead (minimum 1).
            If the target's character rank matches or exceeds twice your rank in this epic fate, you lose hit points equal to half the hit points that the target lost, which is usually a quarter of the original damage.
            This does not cause you to suffer any other non-damaging effects of any attacks.
          \item Whenever you regain hit points, the target also regains that many hit points.
            If you would regain hit points over your maximum, the target regains hit points equal to the full value you would have regained, ignoring your maximum hit points.
        \end{raggeditemize}

        This effect lasts permanently, and you can lifebond any number of living things.
        However, it cannot be \glossterm{dismissed} or removed by any means.
        The lifebond only ends when either you or the target dies.
      \end{magicalactiveability}

      \epicfate{2}{Vibrant Senses} You gain a \plus10 bonus to the Awareness skill and a \plus2 bonus to your Perception.
      In addition, you gain \glossterm{lifesense} with a 300 foot radius and \glossterm{lifesight} with a 120 foot radius.
      If you already have either of those abilities, you increase their range by that amount.
      Your lifesense and lifesight can also penetrate up to 1 foot of any solid material.

      \epicfate{3}{Burgeoning Life} Your maximum hit points are doubled.
      % Is start of turn or end of turn better?
      In addition, whenever you regain hit points, you regain the same number of hit points at the end of your next turn.
      This ability does not trigger itself.

      % Low impact because rank 4 is when Lifebond allows you to protect all of your rank 7 allies freely
      \magicalepicfate{4}{Lifebond Infusion} Creatures that you are lifebonded to gain the benefit of your \textit{vibrant senses} ability.
      Non-creatures that you are lifebonded to gain the benefit of your \textit{burgeoning life} ability, and they grow at a hundred times their normal rate while only requiring their normal nutrients.

      \magicalepicfate{5}{Bonds Beyond Death} When you die, your lifebonds do not end.
      If any part of your \glossterm{corpse} is brought to anything you are lifebonded to, you are automatically \glossterm{resurrected} after 8 hours in its presence.
      Resurrecting in this way does not cause the normal penalties for resurrection.
      In addition, any creature that you are lifebonded to can choose to sacrifice a piece of its life to resurrect you without a corpse.
      This requires 24 hours.
      If you are resurrected in this way, that creature suffers penalties as if it had also been resurrected (see \pcref{Resurrection}).

  \subsection{Axiom}
    You embody a specific universal truth or constant of the universe.
    When you gain this epic fate, you choose an axiom to adopt as your own.
    Your axiom can be a philosophical concept, a directive, or a material fact, as long as it can be expressed at its most basic level in one or two words and it is widely applicable.
    "Fight", "Choice", "Truth", "Gravity", "Change", and "Exist" are all valid examples of axioms.

    \parhead{Prerequisites} You must spend at least a week contemplating the many facets of your axiom and accepting it as your own.

    \parhead{Progression} To progress towards this epic fate, you must change the universe to more closely resemble your axiom.
    This could take many forms.
    For example, if your axiom is "Truth", you could spend time hunting down and killing all known liars and oathbreakers in a given country, or you could reform a country's educational system to correct systematic misconceptions about the world.
    To reach higher ranks, the scope and significance of your changes must increase.
    In addition, as you reach higher ranks, you become increasingly incapable of acting against your axiom.

  \subsubsection{Axiom Ranks}

    \epicfate{1}{Internalized Axiom} You gain a \plus4 bonus to one attribute and two skills that are thematically related to your chosen axiom.

    \epicfate{2}{Immutable} You become immune to \glossterm{conditions} and all debuffs defined in \pcref{Circumstances and Debuffs}.
    In addition, you no longer age.

    \magicalepicfate{3}{Walk the Affinity Web} You can intuitively sense the direction to any locations within 500 miles of you that are strongly connected to your axiom.
    In general, this can only sense locations that involve large numbers of people, such as cities, or extraordinarily powerful individuals.
    For example, an axiom of "Fight" could sense two armies fighting, but not a tavern brawl or a village defending itself from a goblin raid.
    Each location has its own distinct "signature".
    This does not give you any other information about the location by itself, but once you have been to a location, you can recognize it again with this ability.

    As a standard action, you can spend one \glossterm{stamina} to \glossterm{teleport} yourself and up to ten allies to any location that you sense with this ability.

    \magicalepicfate{4}{Axiomatic Adherence} 
      \begin{magicalactiveability}{Axiomatic Adherence}{Standard action}
        \rankline
        Make an attack against one creature within \medrange.
        The defense depends on your chosen axiom.
        If your axiom is a behavior or directive, you attack the target's Mental defense, and this ability gains the \atCompulsion tag.
        Otherwise, you attack the target's Fortitude defense.
        \hit The target embodies your axiom as a \glossterm{condition}.
        If your axiom is a behavior or directive, the target acts to maximize that axiom.
        For example, an axiom of "Fight" would compel it to fight endlessly, while an axiom of "Exist" would compel it to protect the existence of all things.

        Otherwise, the target is physically transformed to more closely resemble your axiom.
        This can make the target \blinded, \slowed, \dazed and \goaded, \panicked, or other debuffs of similar power that make sense for your axiom.
        For example, an axiom of "Gravity" might slow the target by increasing its weight.
      \end{magicalactiveability}

    \epicfate{5}{Universal Truth} You are as immortal as the concept you embody.
    When you die, you automatically \glossterm{resurrect} in a new body after 8 hours at the location in the universe that most strongly embodies your axiom.
    % TODO: adjust once new cosmology is defined
    That location does not have to be on the same plane as where you died, but it must exist outside of the Aligned Planes.
    If no location in the universe is sufficiently related to your axiom, you die permanently.
  ...
  \subsection{Deity}
    ...
    \subsubsection{Deity Ranks}
      \epicfate{1}{Domain Influence} Choose a cleric domain.
      You gain all abilities from that domain except for its mastery ability.
      In addition, your worshippers become eligible to gain cleric archetypes, though they cannot exceed a maximum rank in those archetypes of twice your rank in this epic fate (to a maximum of 7).
      ...
      \magicalepicfate{2}{Prayers} You hear all prayers directed to you.
      ...
      \epicfate{3}{Domain Masteries} You gain the mastery abilities from the domains you chose with your \textit{domain influence} and \textit{prayers} abilities.

      \epicfate{4}{Demigod} You become a demigod.
      You no longer age normally, and you cannot die from old age.
      You become a soulforged native to a Spiritual Plane matching your alignment.
      For details about the Spiritual Planes, see the Grimoire of Guidance.
      ...
      \epicfate{5}{Deification} You become a minor deity.
      You are transported to a Spiritual Plane matching your alignment, and you gain divine dominion over an amount of territory in that plane.
      While you are in your territory, you can freely reshape your territory with a thought to match your desires, and you are immune to all damage and \glossterm{conditions}.
      Unlike major deities, you are still able to leave your home plane.
      However, you suffer a \minus2 penalty to your \glossterm{maximum stamina} whenever you are not on your home plane.

      While you are on any Spiritual Plane, you can teleport to anywhere within your home plane as a \glossterm{standard action}.
  ...
  \subsection{Hero of Legend}
    ...
    \subsubsection{Hero of Legend Ranks}
      \epicfate{1}{Worthy Hero} You and all \glossterm{allies} who can see or hear you are immune to being frightened and panicked.
      In addition, you gain a \plus100 bonus to your maximum \glossterm{hit points}.

      % TODO: should this be a full activeability environment?
      \epicfate{2}{Heroic Intervention} As a \glossterm{standard action}, you may choose any number of \glossterm{allies} within \longrange.
      ...
      This ability lasts until you dismiss it as a \glossterm{free action}.

      \epicfate{3}{Invincible Hero} You gain a \plus4 bonus to all defenses.
      In addition, you cannot be \vulnerable for any reason.

      \magicalepicfate{4}{Answer the Call} You gain an intuitive sense for when people need your aid.
      ...
      \epicfate{5}{Heroic Legacy} If you die, your legend lives on.
  ...
  \subsection{Mutant}
    ...
    \subsubsection{Mutant Ranks}
      \epicfate{1}{Unnatural Arsenal} You grow an extra functioning arm and hand.
      ...
      \epicfate{2}{Regeneration} At the end of your turn, you regain hit points equal to 20 times your rank in this epic fate.
      ...
      \epicfate{3}{Monstrous Form} Your size increases by one size category.
      In addition, you gain a wide variety of movement modes.

      You gain an average \glossterm{climb speed}, an average \glossterm{swim speed}, and a slow \glossterm{burrow speed}.
      Wings also grow from your back, granting you an average \glossterm{fly speed} with a 60 foot \glossterm{height limit} (see \pcref{Flight}).

      \epicfate{4}{Two Heads Are Better Than One} You grow a second head.
      ...
      At the start of your turn, you can choose which heads are active until your next turn.
      You are only subject to the effects of the conditions affecting active heads.
      If you choose for both heads to be active, you can use an extra \glossterm{minor action} during your turn.

      \epicfate{5}{Regenerative Immortality} You can regenerate from any wounds, even lethal ones.
      When you die, your \textit{regeneration} ability continues functioning.
      ...
      A drop of blood, flake of skin, or other remnant of your corpse will always persist and regenerate eventually.
  ...
  \subsection{Paradox}
    You exist partly outside of the ordinary flow of time and destiny.
    ...
    Any type of change is acceptable, as long as it is important to history and would not have happened without your involvement.
    ...
    \subsubsection{Paradox Ranks}
      \epicfate{1}{Temporal Aberration} Your actions, and events involving you, cannot be observed in any effect that sees or predicts the future.
      ...
      Any other abilities you used during the resolution of that movement, such as the \ability{sprint} ability, still happened, so you would still lose stamina and resolve other effects.

      \epicfate{2}{A Fork In Time's Road} Whenever you would take a standard action, you can take two different standard actions and then decide which one was the action you actually took.
      ...
      Any other abilities you used during the resolution of that action, such as the \ability{desperate exertion} ability, still happened, so you would still lose stamina and resolve other effects.

      \epicfate{3}{Choose Fate} Once per \glossterm{short rest}, whenever you or any other creature you are aware of rolls an attack or check, you can choose the result of that die.
      ...
      \epicfate{4}{Paradoxical Defense} Whenever a creature attacks you, it must \glossterm{reroll} the attack roll once and keep the lower result.
      This does not protect any other targets of the attack.

      \epicfate{5}{Fixed Point} You become an immutable fact across all of time.
      You no longer age.
  ...
  \subsection{Slayer}
    ...
    \subsubsection{Slayer Ranks}
      \epicfate{1}{Lethality} The damage bonus you gain from getting a \glossterm{critical hit} is doubled.
      This means that a regular critical hit deals triple damage, a double critical deals five times normal damage, and so on.

      \epicfate{2}{Precision Killer} You gain a \plus4 bonus to your \glossterm{accuracy}.
      ...
      \epicfate{3}{Mark of the Slayer} As a \glossterm{minor action}, you can choose to mark any creature you can unambiguously identify.
      ...
      This ability has a \glossterm{limit} of one marked creature.
      You cannot mark a new creature if the previous mark is less than a week old and the marked creature still lives.
      ...
      If they are not on the same plane as you, you know which plane they are on, but not their location within that plane.
      ...
      \magicalepicfate{4}{Slayer's Journey} As a \glossterm{standard action}, you can \glossterm{teleport} yourself and up to ten \glossterm{allies} any distance within the same plane to the location of a creature affected by your \textit{mark of the slayer} ability from this epic fate.
      ...
      \epicfate{5}{Godslayer}
      Creatures cannot be immune or \glossterm{resistant} to your attacks.
      ...
      After you do this once, you become a soulforged native to your afterlife plane, since your new body is formed from the \glossterm{essentia} of that plane.
  ...
  \subsection{Undying}
    ...
    \subsubsection{Undying Ranks}

      \epicfate{1}{Death Familiarity} You become so familiar with the trauma of injury and death that your mind and body adapt to it.
      You ignore all vital wound effects other than death, and you no longer suffer a penalty when you \glossterm{resurrect}.

      \magicalepicfate{2}{Life After Death} If you die from any cause other than old age, you automatically resurrect according to nature of your chosen path to immortality.
      ...
      However, it cannot be based on the location or state of your old corpse, since that corpse is no longer ``you''.
      Your corpse can still be used for ordinary resurrection methods before this process completes.
      The timing of your resurrection may also differ based on your immortality, but you cannot complete your resurrection sooner than one day after the time of your death. After you resurrect in this way, this ability does not function for 48 hours, allowing you to be killed normally.
      ...
      \magicalepicfate{3}{Artificial Life} Whenever you resurrect with your \textit{life after death} ability, your new body gains a \plus2 bonus to two attributes of your choice.
      The attributes are determined differently for each new body.
      In addition, that resurrection functions even if the cause of your death was old age, and you can control the physical age of your new body.

      \epicfate{4}{Deathcaller} You are deeply familiar with death, and know how to most effectively inflict it on others.
      Whenever you cause a living creature to lose at least half its hit points in a single turn, you may kill that creature outright.
      In addition, your \textit{artificial life} ability affects three attributes of your choice.

      \magicalepicfate{5}{True Immortality} You become fully immortal. There is no time limit after the resurrection from your \textit{life after death} ability where you become vulnerable to a true death. In addition, the resurrection can complete as quickly as one minute after your death. If a physical component limits your immortality, such as a phylactery, it can no longer be damaged or destroyed without the direct intervention of a rank 5 Slayer.
...
\section{Alternate Play Styles}
  ...
  \subsection{Complex Cover}
    ...
    \begin{raggeditemize}
      \item Quarter cover: You have approximately a quarter of your body behind an obstacle.
        ...
        However, if you would be affected by a an attack that deals damage on a miss, the obstacle takes damage instead of you.
      \item Half cover: You have approximately half of your body behind an obstacle.
        Half cover grants a \plus2 bonus to Armor and Brawn defenses.
        It also grants the same protection as quarter cover against misses.
      \item Three-quarters cover: You have approximately three quarters of your body behind an obstacle.
        Three-quarters cover grants a \plus4 bonus to Armor and Brawn defenses.
        It also grants the same protection as quarter cover against misses.
  ...
  \subsection{Experience Points}
    ...
    % TODO: also define how much experience you get per monster
  ...
  \subsection{Rage Accuracy}
    ...
    They also \glossterm{explode} on a 10 or higher.
    A barbarian's overall accuracy and damage output with this rule are essentially equivalent to the normal rule, but they are more likely to get critical hits or completely whiff on important attacks.
  ...
  \subsection{Sleeping While Armored}
    ...
    If you take a \glossterm{long rest} while wearing medium or heavy body armor, you finish your rest with your current \glossterm{stamina} reduced by the Armor defense bonus provided by the armor.
    In addition, only half the time you spend sleeping in the armor counts as sleep for the purpose of sleep requirements (see \pcref{Sleep and Stamina}).
