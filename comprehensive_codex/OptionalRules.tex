...
\section{Epic Fates}
  ...
  Even epic fate abilities which are ostensibly \glossterm{mundane} can achieve things that would normally be impossible.
  ...
  \subsection{Avatar of Life}
    ...
    \subsubsection{Avatar of Life Ranks}
      ...
      \begin{magicalactiveability}{Lifebond}{Standard action}
        ...
        If area has many living plants living in harmony, you can lifebond to the area as a whole instead of to an individual plant.
        The maximum area size you can bond to in this way is a \hugearea radius \glossterm{zone}.
        Creating a lifebond has several effects, all of which only function while you are on the same plane as the target.
        \begin{raggeditemize}
  ...
  \subsection{Deity}
    ...
    \subsubsection{Deity Ranks}
      ...
      You become a soulforged native to an Spiritual Plane matching your alignment.
      ...
      You are transported to an Spiritual Plane matching your alignment, and you gain divine dominion over an amount of territory in that plane.
