...
\section{Epic Fates}
  ...
  \subsubsection{Axiom Ranks}
    ...
    Teleporting in this way increases your \glossterm{fatigue level} by 1.
    ...
    \magicalepicfate{4}{Axiomatic Adherence} 
      \begin{magicalactiveability}{Axiomatic Adherence}{Standard action}
        ...
        This can make the target \blinded, \slowed, \stunned and \goaded, \panicked, or other debuffs of similar power that make sense for your axiom.
  ...
  \subsection{Deity}
    ...
    \subsubsection{Deity Ranks}
      ...
      However, you suffer a \minus2 penalty to your \glossterm{fatigue tolerance} whenever you are not on your home plane.
  ...
  \subsection{Slayer}
    ...
    \subsubsection{Slayer Ranks}
      ...
      Creatures cannot be immune or \glossterm{impervious} to your attacks.
...
\section{Alternate Play Styles}
  ...
  \subsection{Sleeping While Armored}
    ...
    If you take a \glossterm{long rest} while wearing medium or heavy body armor, you finish your rest with a \glossterm{fatigue level} equal to the Armor defense bonus provided by the armor.
    In addition, only half the time you spend sleeping in the armor counts as sleep for the purpose of determining your fatigue (see \pcref{Sleep and Fatigue}).
