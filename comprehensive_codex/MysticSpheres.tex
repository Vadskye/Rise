...
\sectiongraphic*{Spell and Ritual Mechanics}{width=\columnwidth}{core mechanics/spell and ritual mechanics}
  ...
  \subsection{Learning Spells}
    ...
    This does not allow you to bypass restrictions on repeatedly casting or attuning to the same spell.
    For example, the \spell{accelerated dodge} spell \briefly prevents you from casting it again.
  ...
  \subsectiongraphic*{Rituals}{width=\columnwidth}{core mechanics/rituals}
    ...
    Like spells, rituals are \magical abilities that are grouped into \glossterm{mystic spheres}.
      ...
      % The stamina cost for 24 hour rituals is equal to (ritual rank ^ 2) * 2.
    ...
    \subsubsection{Ritual Requirements}\label{Ritual Requirements}
      ...
      \begin{raggeditemize}
        \item Stamina: Every ritual costs at least one \glossterm{stamina}, and some require much more.
          Once per minute, the ritual leader can allocate one stamina of the cost to a creature that participated during that full minute.
          Non-leading ritual participants that are suffering a \glossterm{stamina penalty} cannot have any additional stamina allocated to them from a ritual.
    ...
    \subsubsection{Ritual Participation}
      ...
      Participating in a ritual involves spending a standard action each turn, which requires both \glossterm{verbal components} and \glossterm{somatic components}.
