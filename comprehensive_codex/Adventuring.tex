...
\section{Communication and Languages}\label{Languages}\label{Communication and Languages}
  ...
  \begin{columntable}
    ...
    \begin{dtabularx}{\columnwidth}{l >{\lcol}X l}
      ...
      Abyssal              & Evil soulforged       & Abyssal   \\
      Elysian              & Good soulforged       & Elysian \\
      Moirain              & Lawful soulforged     & Moirain \\
      Protean              & Chaotic soulforged    & Protean \\
      Sylvan               & Dryads, fae           & Sylvan     \\
      Undercommon          & Underground creatures & Undercommon \\
    \end{dtabularx}
  \end{columntable}
