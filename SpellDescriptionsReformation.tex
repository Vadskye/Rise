...
\spellsr{No}
\spelldmg{3d8 acid damage per round}
\begin{spelleffect}
...
\spellsr{Yes (Reflex)}
\spelldmg{6d8 force damage \add d8 per four caster levels above 12th}
\begin{spelleffect}
...
\spellsr{Yes (Reflex)}
\spelldmg{1d8 fire damage \add 1d8 per four caster levels above 1st}
\begin{spelleffect}
...
\spellsr{Yes (Will)}
\spelldmg{4d8 divine damage \add d8 per four caster levels above 8th}
\begin{spelleffect}
...
\spellsave{Reflex half/Reflex negates}
\spellsr{Yes (Reflex)}
\spelldmg{2d8 cold damage \add d8 per four caster levels above 4th.}
\begin{spelleffect}
...
\spelldmg{5d8 cold damage \add d8 per four caster levels above 10th.}
\begin{spelleffect}
...
\spelldmg{8d8 cold damage \add d8 per four caster levels above 16th.}
\begin{spelleffect}
...
\spellsave{None}
\spellsr{Yes (Fort)}
\spelldmg{2d10 life damage \add d10 per four caster levels above 4th}
\begin{spelleffect}
...
\spellschool{Necromancy (Life)}
\spelllvl{Necro 5}
\spelldmg{5d10 life damage \add d10 per four caster levels above 10th}
\begin{spelleffect}
...
\spelldmg{8d6 life damage \add d6 per four caster levels above 16th}
\begin{spelleffect}
...
\spellsr{Yes (Will)}
\spellheal{2d8 damage \add d8 per two caster levels above 1st}
\begin{spelleffect}
...
\spelldmg{6d8 fire damage \add d8 per four caster levels above 12th}
\begin{spelleffect}
...
\spellsr{Yes (Reflex)}
\spelldmg{6d8 fire damage \add d8 per four caster levels above 12th (acorn grenades);\par
6d10 fire damage \add d10 per four caster levels above 12th (holly berry bombs)}
\begin{spelleffect}
...
\par \subspell{Acorn Grenades} As many as four acorns turn into special splash weapons that can be hurled as far as 100 feet. A ranged touch attack roll is required to strike the intended target. Together, the acorns are capable of dealing 6d6 fire damage \add d6 per four caster levels above 12th, divided up among the acorns as you wish.
...
\spellsave{Reflex half}
\spellsr{Yes (Reflex)}
\spelldmg{8d8 fire damage \add d8 per four caster levels above 16th}
\begin{spelleffect}
...
\spellsave{Reflex half}
\spellsr{Yes (Reflex)}
\spelldmg{3d8 fire damage \add d8 per four caster levels above 6th.}
\begin{spelleffect}
...
\spellsave{Reflex half}
\spellsr{Yes (Reflex)}
\spelldmg{5d8 fire and divine damage \add d8 per four caster levels above 8th; see text}
\begin{spelleffect}
...
\spellsr{Yes (Reflex)}
\spelldmg{7d8 cold damage \add d8 per four levels after 14th}
\begin{spelleffect}
...
\spellsr{Yes (Will)}
\spelldmg{12d8 \add d8 per two caster levels above 12th}
\begin{spelleffect}
...
\spellschool{Necromancy (Vitalism) [Negative]}
\spelllvl{Clr 8}
\spelldmg{8d8 negative energy damage \add d8 per four caster levels above 10th}
\begin{spelleffect}
...
\spellsave{Will half}
\spellsr{Yes (Will)}
\spelldmg{2d8 negative energy damage \add d8 per two caster levels above 1st}
\begin{spelleffect}
...
\spellsave{Will half}
\spellsr{Yes (Will)}
\spelldmg{5d8 negative energy damage \add d8 per four caster levels above 10th}
\begin{spellnotes}
...
\spellschool{Necromancy (Vitalism) [Negative]}
\spelllvl{Clr 6}
\spelldmg{6d8 negative energy damage \add d8 per four caster levels above 10th}
\begin{spelleffect}
...
\spelllvl{Clr 7}
\spelldmg{7d8 negative energy damage \add d8 per four caster levels above 10th}
\begin{spelleffect}
...
\spellsave{None}
\spellsr{Yes (Fortitude)}
\spelldmg{d10 force damage \add d10 per four levels after 1st; see text}
\begin{spelleffect}
...
\spellsave{Reflex partial}
\spellsr{Yes (Reflex)}
\spelldmg{9d8 fire damage \add d8 per four caster levels after 18th}
\begin{spelleffect}
...
\spellsave{None}
\spellsr{Yes (Fortitude)}
\spelldmg{2d6 cold damage \add d6 per two caster levels above 1st}
\begin{spelleffect}
...
\spellsave{None}
\spellsr{Yes (Fortitude)}
\spelldmg{2d6 electricity damage \add d6 per two caster levels above 1st}
\begin{spelleffect}
...
\spellsr{Yes (Fortitude)}
\spelldmg{4d8 sonic damage \add d8 per four caster levels above 8th; see text}
\begin{spelleffect}
...
\spelldmg{7d8 sonic damage \add d8 per four caster levels above 14th; see text}
\begin{spelleffect}
...
\spellsave{Fortitude half/Fortitude negates}
\spellsr{Yes (Fortitude)}
\spelldmg{2d8 sonic damage \add d8 per four levels above 4th}
\begin{spelleffect}
...
\spellsave{Reflex half; see text}
\spellsr{No}
\spelldmg{9d8 bludgeoning damage \add d8 per four levels above 18th}
\begin{spelleffect}
...
\par 3rd Round: You call three bolts of lightning down from the cloud. You decide where the bolts strike. No two bolts may be directed at the same target. Each bolt deals 9d8 electricity damage \add d6 per four levels after 18th. A creature struck can attempt a Reflex save for half damage. If you do not direct the lightning bolts, each bolt automatically targets the largest available target in the area.
\par 4th Round: Hailstones rain down, dealing 5d8 bludgeoning damage to all enemies in the area.
...
\spellsave{Reflex half/Reflex negates}
\spellsr{Yes (Reflex)}
\spelldmg{5d8 solar damage \add d8 per four caster levels above 10th; see text}
\begin{spelleffect}
Each creature in the beam takes damage and is dazzled for 1 round. Any creatures to which sunlight is harmful or unnatural instead take 5d10 points of damage \add d10 per four caster levels above 10th and are blinded for 1 round. A successful Reflex save negates the dazzling (or blindness) and reduces the damage by half.
\end{spelleffect}
\begin{spellnotes}
...
\spellrng{\rngmed}
\spellarea{\areamed radius burst}
\spelldmg{8d8 solar damage \add d8 per four caster levels above 16th; see text}
\begin{spelleffect}
...
\spelllvl{Sor/Wiz 6}
\spelltgts{You plus one willing creature per three levels in a \areamed radius }
\spelldur{\durext (D)}
\begin{spelleffect}
...
\spellsave{Reflex half or Reflex negates; see text}
\spellsr{Yes (Reflex)}
\spelldmg{5d8 \add d8 per four caster levels above 10th; see text}
\begin{spelleffect}
...
\spellsave{Reflex negates; see text}
\spellsr{Yes (Reflex)}
\spelldmg{4d8 \add d8 per four caster levels above 8th}
\begin{spelleffect}
