...
\spelldur{1 round}
\begin{spelleffect}
You gain magical damage reduction 10, causing you to ignore the first 10 damage dealt to you in the round if the damage is dealt by spells or spell-like abilities.
\end{spelleffect}
\begin{spellnotes}
Spells that are not subject to spell resistance are not affected by \spell{ablative shield}.
\par You can cast this spell instantly - quickly enough to gain its benefits in an emergency. Casting the spell is an immediate action, so you can use this spell even when it's not your turn.
\end{spellnotes}
...
\spelldmg{5d8 acid damage \add d8 per round}
\begin{spelleffect}
This spell functions as \spell{acid arrow}, except that the target is also sickened for the duration of the spell if it fails a Fortitude save.
\end{spelleffect}
...
\spellsr{No}
\spelldmg{3d10 acid damage per round}
\begin{spelleffect}
...
\spellsr{Yes (Will)}
\begin{spelleffect}
The subject gains temporary hit points equal to 10 \add 1 per caster level and a \plus2 bonus to attack rolls. \bonusscalingdescription
\end{spelleffect}
...
\spelllvl{Chaos 2, Clr 2, Evil 2, Good 2, Law 2}
\begin{spelleffect}
...
\spelllvl{Brd 6, Div 6}
\spellcmp{V, S, F}
\spellrng{\rngclose}
\spelltgt{One object or creature per round}
\spelldur{1 round/level (D)}
...
\spellschool{Abjuration (Negation) [Magic]}
\spelllvl{Clr 8, Magic 7, Sor/Wiz 7, Abjur 6}
...
\par If you concentrate on a specific creature within Medium range of you as a standard action, you can determine whether it has any spellcasting or spell-like abilities, whether these are arcane or divine (spell-like abilities register as arcane), and the strength of the most powerful spell or spell-like ability the creature currently has available for use.
\end{spelleffect}
\begin{spellnotes}
...
\par \spell{Greater arcane sight} doesn't let you identify magic items.
\end{spelleffect}
\begin{spellnotes}
Unlike \spell{arcane sight}, this spell cannot be made permanent with a permanency spell.
\end{spellnotes}
...
\spellsr{Yes (Fortitude)}
\spelldmg{18d10 life damage \add d8 per four caster levels above 18th}
...
\item The target is treated has having its normal Hit Dice for purpose of adjudicating effects based on HD, though it uses the new form's base attack bonus, base save bonuses, and all other statistics derived from Hit Dice. 
...
\spellsr{Yes (Fortitude)}
\begin{spelleffect}
The subject gains a \plus2 bonus to its natural armor modifier and physical damage reduction equal to your caster level. It ignores an amount of physical damage each round equal to your caster level, though an adamantine weapon bypasses the reduction. \bonusscalingdescription
\end{spelleffect}
\begin{spellnotes}
If the creature takes fire damage, it loses its damage reduction for 1 round (including against the initial attack, if it also dealt physical damage).
\end{spellnotes}
...
\spellsr{No}
\begin{spelleffect}
Every creature within the area of the spell must make a grapple check, opposed by the grapple check of the tentacles. Treat the tentacles attacking a particular target as a Large creature with a base attack bonus equal to your caster level and a Strength score of 19. Thus, its grapple check modifier is equal to your caster level \plus8. Roll only once each round for the entire spell effect, and apply the result to all creatures within the area of effect.
...
\spellsr{Yes (Reflex)}
\spelldmg{6d10 force damage \add d10 per four caster levels above 12th}
\begin{spelleffect}
...
\end{spellhealthy}
\begin{spellblood}
\par Each nonevil creature in the area suffers one or more of the following ill effects, depending on its Hit Dice.
\begin{dtable}
\begin{tabularx}{\columnwidth}{l >{\lcol}X}
\par \thead{HD} & \thead{Effect} \\
...
\end{spellblood}
\begin{spellnotes}
Creatures whose Hit Dice exceed your caster level are unaffected by \spell{blasphemy}.
\end{spellnotes}

\spellsection{Bless}
\spelldesc{You fill your allies with confidence, improving their prowess in combat.}
\spellschool{Enchantment (Emotion) [Mind-Affecting, Morale]}
\spelllvl{Clr 1, Good 1, Pal 1, War 1}
\spellarea{\areamed radius burst}
\spelldur{Instantaneous}
\spellsave{None}
\spellsr{Yes (Will)}
...
\spellsr{Yes (Will)}
\begin{spelleffect}
The subject gains concealment (20\% miss chance) and a \plus2 bonus to Hide checks. This concealment is not sufficient by itself to make a Hide check.
\end{spelleffect}
\begin{spellnotes}
...
\spelllvl{Destruction 1, Fire 1, Evoc 1}
\spellarea{\areamed cone-shaped burst}
\spelldur{Instantaneous}
\spellsave{Reflex half}
\spellsr{Yes (Reflex)}
\spelldmg{1d10 fire damage \add 1d10 per four caster levels above 1st}
\begin{spelleffect}
...
\begin{spellblood}
A creature struck by a bolt is also staggered for 1 round. A successful Reflex save to halves the damage and negates the staggering.
\end{spellblood}
\begin{spelleffect}
This spell functions like \spell{call lightning}, except as noted above. If you are outdoors in a stormy area, each bolt deals 5d10 electricity damage \add d10 per four caster levels above 10th instead.
\end{spelleffect}
...
\spellsave{Reflex half}
\spellsr{Yes (Reflex)}
\spelldmg{10d6 electricity damage \add d6 per two caster levels above 10th}
\begin{spelleffect}
...
\spelllvl{Chaos 4}
\spellarea{\areamed radius burst centered on you}
\spelldur{Instantaneous}
\spellsave{Will half/Will negates}
\spellsr{Yes (Will)}
\spelldmg{4d10 divine damage \add d10 per four caster levels above 8th}
\begin{spelleffect}
Nonchaotic creatures in the area take damage and are bewildered for 5 rounds. A successful Will save reduces the damage by half and negates the bewildering.
\end{spelleffect}
...
\spellsection{Chill Touch}
\spelldesc{Your hand glows with dark energy as you strike your foes, channeling negative energy into their bodies to disrupt their life force.}
\spellschool{Necromancy (Vitalism) [Negative]}
\spelllvl{Sor/Wiz 1}
\spellrng{\rngtouch}
\spelltgts{Creature or creatures touched (up to one/level)}
\spelldur{Instantaneous/5 rounds}
\spellsave{Fortitude half/Fortude negates; see text}
\spellsr{Yes (Fortitude)}
\spelldmg{1 Strength damage and d6 negative energy damage \add casting attribute value}
\begin{spelleffect}
A successful Fortitude save negates the Strength damage. You can use this melee touch attack up to one time per level. If you can make multiple attacks, you can use this touch attack on each of those attacks.
\par An undead creature you touch takes no damage of either sort, but it is sickened for 5 rounds. A successful Fortitude save negates the effect.
\end{spelleffect}
...
\end{spellblood}
\begin{spellnotes}
This spell can affect 2 HD worth of living creatures per caster level. Creatures with the fewest HD are affected first; among creatures with equal HD, those who are closest to the burst's point of origin are affected first. No creature of more HD than half your caster level can be affected, and Hit Dice that are not sufficient to affect a creature are wasted. Healthy creatures are not affected by the spell, and do not count against the spell's HD limit.
\end{spellnotes}
...
\spelllvl{Sor/Wiz 9, Strength 9}
\spellsave{None/Fortitude negates}
\spellsr{Yes (Fortitude)}
\spelldmg{2d10 force damage \add 1-1/2 casting attribute value}
\begin{spelleffect}
...
\par Second, each shielded creature gains spell resistance 10 against lawful spells and spells cast by lawful creatures.
...
\spelldur{\durshort (D)}
\begin{spelleffect}
You gain a \plus4 bonus to Strength, Dexterity, Constitution, natural armor, and Fortitude saves. In addition, you gain proficiency with any weapons you hold (except exotic weapons).
\end{spelleffect}
\begin{spellnotes}
...
\spelllvl{Brd 1, Clr 2, Knowledge 1, Sor/Wiz 2}
\spellrng{\rngpers}
\spelltgt{You}
\spelldur{\durlong}
\begin{spelleffect}
...
\end{spelleffect}
\begin{spellnotes}
This spell can be foiled by certain obscuring magic (such as the \spell{secret page} and \spell{illusory script} spells). It does not decipher codes or reveal messages concealed in otherwise normal text. You may be unable to understand dead or extremely obscure languages.

\par \spell{Comprehend languages} can be made permanent with a \spell{permanency} spell.
\end{spellnotes}
...
\spellsave{Reflex half/Reflex negates}
\spellsr{Yes (Reflex)}
\spelldmg{2d10 cold damage \add d10 per four caster levels above 4th.}
\begin{spelleffect}
Everything in the area takes damage. Creatures damaged by the spell are fatigued for 1 round. A successful Reflex save halves the damage and negates the fatigue.
\end{spelleffect}
...
\spelldmg{5d10 cold damage \add d10 per four caster levels above 10th.}
\begin{spelleffect}
This spell functions as \spell{cone of cold}, except that affected creatures are fatigued for 1 round even if they make their Reflex save, and are fatigued for 5 rounds if they fail.
\end{spelleffect}
...
\spelldmg{8d10 cold damage \add d10 per four caster levels above 16th.}
\begin{spelleffect}
This spell functions as \spell{cone of cold}, except that it affects a larger area, and affected creatures are fatigued for 5 rounds whether or not they make their Reflex save.
\end{spelleffect}
...
\spelllvl{Drd 3, Sor/Wiz 4, Water 3}
\spellrng{\rnglong}
\spellarea{Water in a volume of 10 ft./level by 10 ft./level by 2 ft./level (S)}
\spelldur{\durlong (D)}
...
\spellschool{Necromancy (Life)}
\spelllvl{Necro 5}
\spelldmg{10d6 life damage \add d6 per two caster levels above 10th}
\begin{spelleffect}
This spell functions like \spell{crush life}, except that the target is also sickened for 5 rounds.
\end{spelleffect}

\spellsectioncomma{Crush Life}{Mass}
\spelldesc{You obliterate the life force of all of your foes directly, allowing no possibility for escape.}
\spellschool{Necromancy (Unlife)}
\spelllvl{Necro 8}
\spellrng{\rnglong}
\spellarea{\arealarge radius limit}
\spelltgts{Five living creatures within the area}
\spelldmg{8d8 life damage \add d8 per four caster levels above 16th}
\begin{spelleffect}
This spell functions as \spell{crush life}, except that it affects many targets in a broad area.
\end{spelleffect}
...
\end{spelleffect}
\begin{spellnotes}
A demoralized creature takes a \minus2 penalty on attack rolls, saving throws, checks, and armor class. \spellindirect{crushing despair}{Crushing despair} counters and dispels \spell{good hope}.
\end{spellnotes}
...
\spellschool{Evocation (Control) [Force]}
\spelllvl{Sor/Wiz 8, Strength 8}
\spellsave{Fortitude partial}
\spellsr{Yes (Fortitude)}
\spelldmg{2d6 \add casting attribute value}
\begin{spelleffect}
...
\spellheal{8d10 damage \add d10 per two caster levels above 8th}
\begin{spelleffect}
...
\spellheal{8d8 damage \add d8 per four caster levels above 16th}
\begin{spelleffect}
...
\spelltgt{Creature touched}
\spelldur{Instantaneous}
\spellsave{Will half (harmless) or Will half; see text}
\spellsr{Yes (Will)}
\spellheal{2d10 damage \add d10 per two caster levels above 1st}
\begin{spelleffect}
You heal the touched creature. Since undead are powered by negative energy, this spell deals damage to them instead of curing their wounds. You must succeed on a melee touch attack to hit a target that does not allow you to touch it.
\end{spelleffect}
...
\spellsave{Will half (harmless) or Will half; see text}
\spellsr{Yes (Will)}
\spellheal{5d8 damage \add d8 per four caster levels above 10th}
\begin{spelleffect}
You heal the targets. Like other \spellindirect{cure light wounds}{cure} spells, this spell deals damage to affected undead rather than curing them.
\end{spelleffect}
...
\spellheal{4d10 damage \add d10 per two caster levels above 4th}
\begin{spelleffect}
...
\spellheal{6d8 damage \add d8 per four caster levels above 12th}
\begin{spelleffect}
...
\spellheal{6d10 damage \add d10 per two caster levels above 6th}
\begin{spelleffect}
...
\spellheal{7d8 damage \add d8 per four caster levels above 14th}
\begin{spelleffect}
...
\spellschool{Necromancy (Unlife) [Death]}
\spelllvl{Death 2, Evil 2, Necro 2}
\spellrng{\rngtouch}
\spelltgt{Living creature touched}
\spelldur{Instantaneous/10 minutes per HD of subject; see text}
\spellsave{Fortitude negates}
\spellsr{Yes (Fortitude)}
\begin{spelleffect}
Upon casting this spell, you touch a living creature that is disabled or dying. If the subject fails its saving throw, it dies, and you gain 10 temporary hit points \plus1 per caster level. If the creature had more than 4 HD, you gain a \plus1 bous to your caster level. If the creature had more than 8 HD, you a \plus2 bonus to Strength, Dexterity, and Constitution. These effects last for 10 minutes per HD of the subject creature. If the creature had less than 1 HD, the bonuses last for 5 rounds.
\end{spelleffect}

\spellsection{Death Ward}
\spellschool{Abjuration/Necromancy (Life, Shielding) [Positive]}
\spelllvl{Clr 4, Death 4, Good 4, Life 4, Necro 4, Pal 4, Protection 4}
\spellrng{\rngtouch}
\spelltgt{Living creature touched}
\spelldur{\durshort}
\spellsave{Fortitude negates (harmless)}
...
\spellschool{Abjuration/Necromancy (Life, Shielding) [Positive]}
\spelllvl{Clr 8, Good 8, Life 8, Protection 8}
\spellrng{\rngclose}
\spellarea{\areamed radius limit}
\spelltgts{Five living creatures within the area}
\begin{spelleffect}
...
\spellschool{Evocation (Energy) [Fire]}
\spelllvl{Fire 6, Evoc 6}
\spellarea{\areamed radius spread}
\spelldur{5 rounds or less; see text}
\spelldmg{6d10 fire damage \add d10 per four caster levels above 12th}
\begin{spelleffect}
...
\par If the HD or level of the aura's source is at least twice your caster level, the power of the aura increases by one step, with strong auras becoming overwhelming. If you are good, and you concentrate on a creature with an overwhelming aura, you must make a Will save or be stunned for 1 round (which typically breaks your concentration, ending the spell).
\begin{dtable}
\begin{tabularx}{\columnwidth}{l >{\lcol}X}
...
\par \subspell{Aura Strength} The strength of an undead aura is determined by the HD of the undead creature, as given on the following table:
\begin{dtable}
...
\end{spellhealthy}
\begin{spellblood}
\par Each nonlawful creature in the area suffers one or more of the following ill effects, depending on its Hit Dice.
\begin{dtable}
\begin{tabularx}{\columnwidth}{l >{\lcol}X}
\par \thead{HD} & \thead{Effect} \\
\par Equal to caster level & Staggered \\
\par Up to caster level \minus5 & Stunned, staggered \\
\par Up to caster level \minus10 & Paralyzed, slowed, deafened \\
\par Up to caster level \minus15 & Killed\fn{1}
\end{tabularx}
1 Living creatures die. Nonliving creatures are destroyed.
\end{dtable}
\par \subspell{Staggered} The creature is staggered for 5 rounds.
\par \subspell{Stunned} The creature is stunned for 1 round.
\par \subspell{Paralyzed} The creature is paralyzed and helpless for 5 rounds.
\par \subspell{Killed} Living creatures die. Nonliving creatures are destroyed.
\end{spellblood}
\begin{spellnotes}
Creatures whose Hit Dice exceed your caster level are unaffected by this spell.
\end{spellnotes}
...
\par If you arrive in a place that is already occupied by a solid body, you take 1d6 damage and are shunted to a random open space on a suitable surface within 100 feet of the intended location.
\par If there is no free space within 100 feet, you take an additional 2d6 damage and are shunted to a free space within 1,000 feet. If there is no free space within 1,000 feet, you take an additional 4d6 damage and the spell simply fails.
\end{spelleffect}
...
\end{spelleffect}
\begin{spellnotes}
A creature that interacts with the effect gets a Will save to recognize it as an illusion. In order to interact with the illusion with a Spot check, the creature must make a Spot check that beats your saving throw DC with this spell or your Disguise check (if used as part of a disguise), whichever is higher.
\end{spellnotes}
...
\spellsr{Yes (Fortitude)}
\spelldmg{12d10 physical damage \add d10 per two caster levels above 12th}
\begin{spelleffect}
...
\spellschool{Abjuration (Negation) [Magic]}
\spelllvl{Abjur 2, Brd 3, Clr 3, Drd 4, Magic 3, Pal 3, Sor/Wiz 3}
\spellrng{\rngmed}
...
\spellsr{Yes (Will)}
\begin{spelleffect}
Your mere touch can disperse the surface material of a foe or object, sending a tiny portion of it far away. This effect is disruptive; thus, your successful melee touch attack deals damage. This damage ignores the hardness of objects.
\end{spelleffect}
...
\spellschool{Transmutation (Augment)}
\spelllvl{Clr 4, Pal 3, Strength 4, War 4}
\begin{spelleffect}
This spell functions like \spell{divine favor}, except that you also gain a \plus4 bonus to Strength and 10 \add caster level temporary hit points.
\end{spelleffect}
...
\spelllvl{Destruction 8, Drd 8, Earth 7, Trans 8}
\spellrng{\rnglong}
...
\par When the spell is complete, 2d4 Large elementals appear. Five minutes later, 1d4 Huge elementals appear. Five minutes after that, one greater elemental appears. Each elemental has maximum hit points per HD. Once these creatures appear, they serve you for the duration of the spell.
...
\end{spelleffect}
\begin{spellnotes}
This spell's subtype is the same as the type of energy you discharge in a ray; thus, its subtype can change during the course of the spell's duration.
\end{spellnotes}
...
\spellsr{Yes (Fortitude)}
\begin{spelleffect}
This spell causes instant growth of a humanoid creature, doubling its height and multiplying its weight by 8. This increase changes the creature's size category to the next larger one. The target gains a \plus2 bonus to Strength and a \minus1 penalty on attack rolls and AC due to its increased size.
\par A humanoid creature whose size increases to Large has a space of 10 feet and a natural reach of 10 feet. This spell does not change the target's speed.
...
\spelldesc{You surround your ally with a magical field that glows with a chaotic blast of multicolored hues. This field deflects incoming ranged attacks, causing them to chaotically swerve away from their intended target.}
\spellschool{Abjuration (Shielding)}
\spelllvl{Chaos 1,  Clr 1}
\spellrng{\rngtouch}
\spelltgt{Touched creature}
\spelldur{\durshort (D)}
\begin{spelleffect}
Each ranged attack directed at the subject for which the attacker must make an attack roll has a 20\% miss chance (similar to the effects of concealment). Other attacks that simply work at a distance are not affected.
\end{spelleffect}

\spellsection{Ethereal Jaunt}
\spellschool{Conjuration (Translocation) [Planar]}
\spelllvl{Sor/Wiz 7, Travel 7}
\spellrng{\rngpers}
\spelltgt{You}
\spelldur{\durshort (D)}
\begin{spelleffect}
...
\spelltgts{You and up to five other willing touched creatures}
\spelldur{\durmed (D)}
\spellsr{Yes (Will)}
\begin{spelleffect}
This spell functions like \spell{ethereal jaunt}, except that you and other willing creatures joined by linked hands (along with their equipment) become ethereal. Once ethereal, the subjects need not stay together.
\end{spelleffect}
\begin{spellnotes}
...
\spelldur{\durshort (D)}
\begin{spelleffect}
This spell doubles your base land speed, to a maximum of a \plus30 foot increase. (This adjustment is treated as an enhancement bonus.) There is no effect on other modes of movement, such as burrow, climb, fly, or swim. As with any effect that increases your speed, this spell affects your jumping distance.
\end{spelleffect}
...
\spelldur{\durshort}
\begin{spelleffect}
You gain 10 temporary hit points \add 1 per caster level.
\end{spelleffect}
...
\spellsr{Yes (Will)}
\begin{spelleffect}
The subject gains a \plus2 bonus to Spot checks and takes half the normal penalty for range increments and for Spot checks made at a distance.
\end{spelleffect}
...
\spellsr{Yes (Reflex)}
\spelldmg{6d10 fire damage \add d10 per four caster levels above 12th (acorn grenades);\par
12d6 fire damage \add d6 per two caster levels above 12th (holly berry bombs)}
\begin{spelleffect}
...
\par \subspell{Acorn Grenades} As many as four acorns turn into special splash weapons that can be hurled as far as 100 feet. A ranged touch attack roll is required to strike the intended target. Together, the acorns are capable of dealing 6d8 fire damage \add d8 per four caster levels above 12th, divided up among the acorns as you wish.
...
\par \subspell{Holly Berry Bombs} You turn as many as eight holly berries into special bombs. The holly berries are usually placed by hand, since they are too light to make effective thrown weapons (they can be tossed only 5 feet). Together, the holly berries are capable of dealing 6d10 fire damage \add d10 per four caster levels above 12th, divided up among the berries as you wish.
...
\spelllvl{Fire 5, Sor/Wiz 4}
\spellrng{\rngpers}
\spelltgt{You}
\spelldur{\durshort (D)}
\spelldmg{2d6 fire or cold damage}
\begin{spelleffect}
...
\par Any creature striking you with its body or a handheld weapon deals normal damage. Its first attack each round causes the attacker to take damage. This damage is either cold damage (if the shield protects against cold-based attacks) or fire damage (if the shield protects against fire-based attacks). If the attacker has spell resistance, it applies to this effect (this spell is a Reflex effect). Creatures wielding weapons with exceptional reach are not subject to this damage if they attack you.
\par When casting this spell, you appear to immolate yourself, but the flames are thin and wispy, giving off light equal to only half the illumination of a normal torch (10 feet). The color of the flames is determined randomly (50\% chance of either color) -- blue or green if the chill shield is cast, violet or blue if the warm shield is employed. The special powers of each version are as follows.
\par \subspell{Warm Shield} The flames are warm to the touch. You take only half damage from fire-based attacks. If such an attack allows a Reflex save for half damage, you take no damage on a successful save.
\par \subspell{Chill Shield} The flames are cool to the touch. You take only half damage from cold-based attacks. If such an attack allows a Reflex save for half damage, you take no damage on a successful save.
\end{spelleffect}
...
\spellarea{\arealarge spread centered on you}
\spelldur{Instantaneous}
\spellsave{Reflex half}
\spellsr{Yes (Reflex)}
\spelldmg{8d10 fire damage \add d10 per four caster levels above 16th}
\begin{spelleffect}
...
\spellsave{Reflex half}
\spellsr{Yes (Reflex)}
\spelldmg{3d10 fire damage \add d10 per four caster levels above 6th.}
\begin{spelleffect}
...
\spellsave{Reflex half}
\spellsr{Yes (Reflex)}
\spelldmg{5d10 fire and divine damage \add d10 per four caster levels above 8th; see text}
\begin{spelleffect}
Half the damage is fire damage, but the other half results directly from divine power and is therefore not typed. Your allies in the area take only the fire damage.
\end{spelleffect}
...
\spellsr{Yes (Fortitude)}
\begin{spelleffect}
A 3 foot long beam of red-hot fire springs forth from your hand. In addition to providing illumination like a torch, you can wield this bladelike beam as if it were a scimitar. Attacks with the flame weapon are touch attacks, and deal 1d10 fire damage \add your key attribute value. Since the blade is immaterial, it is treated as a light weapon, and your Strength value does not apply to the damage. A flame weapon can ignite combustible materials such as parchment, straw, dry sticks, and cloth. Alternately, you can hurl flames from the weapon up to \rngmed range as if it were a thrown weapon.
\end{spelleffect}
\begin{spellnotes}
...
\end{spelleffect}
\begin{spellnotes}
Should the spell duration expire while the subject is still aloft, the magic fails slowly. The subject floats downward 60 feet per round for 1d6 rounds. If it reaches the ground in that amount of time, it lands safely. If not, it falls the rest of the distance, taking 1d6 damage per 10 feet of fall. Since dispelling a spell effectively ends it, the subject also descends in this way if the fly spell is dispelled, but not if it is negated by an antimagic field.
\end{spellnotes}
...
\end{spelleffect}
\begin{spellnotes}
Fog spells do not function underwater and can be dispersed by wind. A moderate wind (11\add mph) disperses the fog in 5 rounds; a strong wind (21\add mph) disperses the fog in 1 round.
\end{spellnotes}
...
\spellschool{Evocation (Control) [Force]}
\spelllvl{Sor/Wiz 6, Strength 6}
\begin{spelleffect}
This spell functions like \spell{interposing hand}, except that it can also pursue and bull rush one opponent you select. The \spell{forceful hand} gets one bull rush attack per round. This attack does not provoke an attack of opportunity. Its CMA for bull rush checks uses your caster level for its base attack bonus \add your casting attribute for its strength score, with a \plus4 bonus for being Large.
...
\par Directing the spell to a new target is a move action.
\end{spellnotes}

\spellsection{Foresight}
\spellschool{Divination (Knowledge)}
\spelllvl{Protection 9, Sor/Wiz 9}
\spellrng{Personal or touch}
\spelltgt{See text}
\spelldur{\durlong}
\spellsave{None or Will negates (harmless)}
\spellsr{No or Yes (Will)}
\begin{spelleffect}
This spell grants you a powerful sixth sense in relation to yourself or another. Once foresight is cast, you receive instantaneous warnings of impending danger or harm to the subject of the spell. You are never surprised or flat-footed, and you gain a bonus on initiative checks equal to your caster level. In addition, the spell gives you a general idea of what action you might take to best protect yourself and gives you a \plus5 bonus to Reflex saves and dodge modifier. This bonus is lost whenever you would lose a Dexterity to AC.
\par When another creature is the subject of the spell, you receive warnings about that creature. You must communicate what you learn to the other creature for the warning to be useful, and the creature can be caught unprepared in the absence of such a warning. Shouting a warning, yanking a person back, and even telepathically communicating (via an appropriate spell) can all be accomplished before some danger befalls the subject, provided you act on the warning without delay. The subject, however, does not gain the bonus to AC and Reflex saves.
\end{spelleffect}
...
\spellsr{No}
\begin{spelleffect}
The subject and all its gear become insubstantial, misty, and translucent. Its material armor (including natural armor) becomes worthless, though other modifiers continue to apply normally. The subject gains physical damage reduction 10/magic and becomes immune to poison and critical hits. It can't attack or cast spells with verbal, somatic, material, or focus components while in gaseous form. (This does not rule out the use of certain spells that the subject may have prepared using the feats Silent Spell or Still Spell.) If it has a touch spell ready to use, that spell is discharged harmlessly when the gaseous form spell takes effect.
...
\spelldesc{You instill powerful hope and confidence in your ally.}
...
\spellsr{Yes (Will)}
\begin{spelleffect}
The subjects gain 10 temporary hit points \add 1 per caster level and a \plus2 bonus on attack rolls. \bonusscalingdescription
\end{spelleffect}
\begin{spellnotes}
...
\par Its combat maneuver bonus to grapple equals your caster level \add your casting ability modifier, \plus4 for being Large. The hand holds but does not harm creatures it grapples. Its CMD is equal to 10 \add its CMA.
\end{spelleffect}
\begin{spellnotes}
Directing the spell to a new target is a swift action.
\end{spellnotes}
...
\spellsection{Harm}
\spelldesc{You fill your foe with a massive influx of negative energy, crippling its life force.}
\spellschool{Necromancy (Vitalism) [Negative]}
\spelllvl{Clr 6, Death 6, Evil 6, Necro 6}
\spellrng{\rngtouch}
\spelltgt{Creature touched}
\spelldur{Instantaneous}
\spellsave{Will half; see text}
\spellsr{Yes (Will)}
\spelldmg{12d10 \add d10 per two caster levels above 12th}
\begin{spelleffect}
For every 10 points of damage dealt in excess of the subject's hit points, this spell can instead inflict 1 point of critical damage.\end{spelleffect}
\begin{spellnotes}
...
\spellsr{Yes (Fortitude)}
\begin{spelleffect}
The subject is hasted. This has two effects. When making a full attack action, a hasted creature may make one extra attack with any weapon he is holding. The attack is made using the creature's full base attack bonus, plus any modifiers appropriate to the situation.
...
\spellsection{Heal}
\spelldesc{You fill the subject with a massive influx of positive energy, restoring its life force to its fullest.}
\spellschool{Necromancy (Vitalism) [Healing, Positive]}
\spelllvl{Clr 6, Drd 7, Good 6, Life 6}
\spellrng{\rngtouch}
\spelltgt{Creature touched}
\spelldur{Instantaneous}
\spellsave{Will negates (harmless)}
\spellsr{Yes (harmless)}
\spellheal{12d10 \add d10 per two caster levels above 12th}
\begin{spelleffect}
...
\spellsectioncomma{Heal}{Mass}
\spelldesc{You fill your allies with a massive influx of positive energy, restoring their life force to its fullest.}
\spellschool{Necromancy (Vitalism) [Healing, Positive]}
\spelllvl{Clr 9, Good 9, Healing 9}
\spellrng{\rngclose}
\spelltgts{One or more creatures in a \areamed radius}
\spellheal{9d6 \add d6 per four caster levels above 18th}
\begin{spelleffect}
This spell functions like \spell{heal}, except that it affects multiple creatures.
\end{spelleffect}

\spellsection{Heal Mount}
\spelldesc{You fill your mount with a massive influx of positive energy, restoring its life force to its fullest.}
\spellschool{Necromancy (Vitalism) [Healing, Positive]}
\spelllvl{Pal 3}
\spellcmp{V}
\spellrng{\rngtouch}
...
\spellsave{Will negates (harmless)}
\spellsr{Yes (harmless)}
\spellheal{6d10 \add d10 per two caster levels above 6th}
\begin{spelleffect}
...
\spellrng{\rngclose}
\spellarea{\areamed radius limit}
\spelltgt{Metal equipment of Five creatures within the area or 25 lb. of metal/level within the area}
\spelldur{\durshort (D)}
\spellsave{Will negates (object)}
\spellsr{Yes}
\spelldmg{d6 fire damage per round}
\begin{spelleffect}
...
\par A creature takes fire damage if its equipment is heated. It takes full damage if its armor is affected or if it is holding, touching, wearing, or carrying metal weighing one-fifth of its weight. The creature takes minimum damage if it's not wearing metal armor and the metal that it's carrying weighs less than one-fifth of its weight.
\par A creature takes damage each round if its equipment is heated. It takes full damage if its armor is affected or if it is holding, touching, wearing, or carrying metal weighing one-fifth of its weight. The creature takes minimum damage (1 point) if it's not wearing metal armor and the metal that it's carrying weighs less than one-fifth of its weight.
\end{spelleffect}
\begin{spellnotes}
If cast underwater, heat metal deals half damage and boils the surrounding water. Any cold intense enough to damage the creature negates fire damage from the spell (and vice versa) on a point-for-point basis. \spell{Heat metal} counters and dispels \spell{chill metal}.
\end{spellnotes}
...
\spellsr{Yes (Will)}
\begin{spelleffect}
The subject gains a \plus2 bonus on attack rolls and saving throws. \bonusscalingdescription
\end{spelleffect}

\spellsectioncomma{Heroism}{Greater}
\spellschool{Enchantment (Emotion) [Mind-Affecting, Morale]}
\spelllvl{Brd 5, Sor/Wiz 6}
\begin{spelleffect}
This spell functions like \spell{heroism}, except the subject also gains the same bonus to checks. In addition, it is immune to fear effects.
\end{spelleffect}
...
\spelllvl{Good 4}
\spellarea{\areamed radius burst centered on you}
\spelldur{Instantaneous and 5 rounds; see text}
\spellsave{Will half/Will negates}
\spellsr{Yes (Will)}
\spelldmg{4d10 divine damage \add d10 per four caster levels above 8th}
\begin{spelleffect}
Nongood creatures in the area take damage and are dazzled for 5 rounds. A successful Will save reduces the damage by half and negates the dazzling.
\end{spelleffect}
...
\end{spellhealthy}
\begin{spellblood}
\par Each nongood creature in the area suffers one or more of the following ill effects, depending on its Hit Dice.
\begin{dtable}
\begin{tabularx}{\columnwidth}{l >{\lcol}X}
\par \thead{HD} & \thead{Effect} \\
...
\end{spellblood}
\begin{spellnotes}
Creatures whose Hit Dice exceed your caster level are unaffected by \spell{holy word}.
\end{spellnotes}
...
\spelllvl{Drd 4, Sor/Wiz 4, Water 5}
\spellrng{\rngmed}
\spellarea{\areasmall radius cylinder, 20 ft. high}
\spelldur{Instantaneous and 1 round; see text}
\spellsave{None}
\spellsr{Yes (Reflex)}
\spelldmg{4d6 cold and bludgeoning damage \add d6 per four caster levels above 8th}
\begin{spelleffect}
All creatures within the area take damage. The area of the ice storm's effect is difficult terrain until the spell ends.
\end{spelleffect}
...
\spelldur{\durshort}
\begin{spelleffect}
You create a barrier around yourself that resists blows, cuts, stabs, and slashes, as well as providing some protection against falling. You gain physical damage reduction 8, allowing you to ignore the first 8 damage you take each round. This damage reduction increases by 1 per two caster levels above 8th. Inertial barrier also absorbs half the damage you take from any fall.
\end{spelleffect}

\spellsection{Inflict Critical Wounds}
\spellschool{Necromancy (Vitalism) [Negative]}
\spelllvl{Clr 4}
\spelldmg{8d10 negative energy damage \add d10 per four caster levels above 8th}
\begin{spelleffect}
...
\spellschool{Necromancy (Vitalism) [Negative]}
\spelllvl{Clr 8}
\spelldmg{8d10 negative energy damage \add d10 per four caster levels above 10th}
\begin{spelleffect}
...
\spellsave{Will half}
\spellsr{Yes (Will)}
\spelldmg{2d10 negative energy damage \add d10 per two caster levels above 1st}
\begin{spelleffect}
...
\spellsave{Will half}
\spellsr{Yes (Will)}
\spelldmg{5d10 negative energy damage \add d10 per four caster levels above 10th}
\begin{spellnotes}
...
\spellschool{Necromancy (Vitalism) [Negative]}
\spelllvl{Clr 2}
\spelldmg{4d10 negative energy damage \add d10 per four caster levels above 4th}
\begin{spelleffect}
...
\spellschool{Necromancy (Vitalism) [Negative]}
\spelllvl{Clr 6}
\spelldmg{6d10 negative energy damage \add d10 per four caster levels above 10th}
\begin{spelleffect}
...
\spellschool{Necromancy (Vitalism) [Negative]}
\spelllvl{Clr 3}
\spelldmg{6d10 negative energy damage \add d10 per four caster levels above 6th}
\begin{spelleffect}
...
\spelllvl{Clr 7}
\spelldmg{7d10 negative energy damage \add d10 per four caster levels above 10th}
\begin{spelleffect}
...
\par Once it has a target, nothing can fool the hand -- it sticks with the selected opponent in spite of darkness, invisibility, or any other attempt at hiding or disguise. However, you must be able to see a target to direct the hand to protect you from it. The hand does not pursue opponents.
\par An interposing hand is 10 feet long and about that wide with its fingers outstretched. It has half as many hit points as you do when you're undamaged, and its AC is 20 (\minus1 size, \plus11 natural). It takes damage as a normal creature, but most magical effects that don't cause damage do not affect it.
...
\spellrng{Personal or touch}
\spelltgt{You or a creature or object weighing no more than 100 lb./level}
\spelldur{\durshort (D)}
...
\par You gain a \plus6 bonus to your Strength score, but you take a \minus6 penalty to Dexterity as well (to a minimum Dexterity score of 1), and your speed is reduced to half normal. You have an arcane spell failure chance of 50\% and a \minus8 armor check penalty. You cannot drink (and thus can't use potions) or play wind instruments.
\par Your unarmed attacks deal damage equal to a club sized for you (1d4 for Small characters or 1d6 for Medium characters), and you are considered armed when making unarmed attacks.
...
\spellsection{Jump}
\spellschool{Transmutation (Augment)}
\spelllvl{Drd 1, Sor/Wiz 1, Strength 1}
\spellrng{\rngtouch}
\spelltgt{Creature touched}
\spelldur{\durlong (D)}
\spellsave{Fortitude negates (harmless)}
\spellsr{Yes (Fortitude)}
\begin{spelleffect}
The subject gains a \plus10 bonus on Jump checks.
\end{spelleffect}

\spellsection{Knock}
\spellschool{Transmutation (Control)}
\spelllvl{Sor/Wiz 2}
\spellcmp{V}
\spellrng{\rngclose}
\spelltgt{One Medium or smaller door, box, or chest}
\spelldur{Instantaneous; see text}
\spellsave{None}
\spellsr{No}
\begin{spelleffect}
The knock spell telekinetically opens stuck, barred, locked, held, or arcane locked doors. If the object is stuck or held, you can immediately make an Strength check to break down the door, using your caster level instead of your Strength. Others can aid you on this check as normal. In addition, if the object is locked, you can immediately make a Disable Device check to open the lock as if you had rolled a 20 on the check. You get a bonus on the Disable Device check equal to half your caster level.
\end{spelleffect}
\begin{spellnotes}
...
\spellsave{Reflex half}
\spellsr{Yes (Reflex)}
\spelldmg{3d10 electricity damage \add d10 per four caster levels above 6th}
\begin{spelleffect}
...
\end{itemize*}
\par When casting a limited wish, you do not specify the exact spell or effect you wish to duplicate. Instead, you make a wish, describing what you want to have happen, and make a DC 15 Wisdom check. If the check fails, your intent is redirected or perverted in some way. For example, a \spell{limited wish} to turn a foe to stone would normally mimic the flesh to stone effect of the \spell{transmute flesh and stone} spell. However, if the Wisdom check failed, your foe might gain the benefit of a \spell{stoneskin} spell instead.
...
\spellarea{Circle, centered on you, with a 1 mile radius}
\spelldur{\durlong (D)}
\begin{spelleffect}
...
\spellarea{Circle, centered on you, with a 500 ft. radius}
\spelldur{\durmed (D)}
\spellsave{None}
\spellsr{No}
\begin{spelleffect}
...
\spellschool{Abjuration/Evocation (Control, Shielding) [Force]}
\spelllvl{Sor/Wiz 1}
\spellrng{Personal}
\spelltgt{You}
\spelldur{\durlong (D)}
...
\par Unlike mundane armor, \spell{mage armor} entails no armor check penalty, arcane spell failure chance, or speed reduction. It is considered light armor for the purpose of class features and abilities, though you do not need to be proficient with it to use it. Since \spell{mage armor} is made of force, incorporeal creatures can't bypass it the way they do normal armor.
\end{spelleffect}
\begin{spellnotes}
This armor is treated as a separate piece or armor from any other armor the creature is wearing, so it does not stack with any existing armor modifier.
\end{spellnotes}
...
\spellsr{No}
\begin{spelleffect}
You point your finger at an object and can lift it and move it in any direction from a distance. While concentrating on the spell, you can propel the object as far as 15 feet in any direction each round, though the spell ends if the distance between you and the object ever exceeds the spell's range.
\end{spelleffect}
\begin{spellnotes}
...
\par The sword cannot be attacked or harmed by physical attacks, but \spell{dispel magic}, \spell{disintegrate}, a sphere of annihilation, or a rod of cancellation affects it. The sword's AC is 10 (10, \plus0 size bonus for being a Medium object)
...
\begin{spelleffect}
This spell functions like \spell{magic circle against evil}, except that it is similar to \spell{protection from chaos} instead of \spell{protection from evil}, and it hedges out nonchaotic summoned creatures.
\end{spelleffect}
...
\begin{spelleffect}
This spell functions like \spell{magic circle against evil}, except that it is similar to \spell{protection from law} instead of \spell{protection from evil}, and it hedges out nonlawful summoned creatures.
\end{spelleffect}
...
\spellsr{Yes (Fortitude)}
\begin{spelleffect}
This spell makes one of the subject's natural weapons a \plus2 magic weapon, granting a \plus2 bonus to attack rolls. \bonusscalingdescription
\end{spelleffect}
\begin{spellnotes}
...
\spelllvl{Sor/Wiz 1}
\spellrng{\rngmed}
\spellarea{\rngmed limit}
\spelltgts{Up to five creatures in the area}
\spelldur{Instantaneous}
\spellsave{None}
\spellsr{Yes (Fortitude)}
\spelldmg{2d6 force damage \add d6 per two caster levels after 1st; see text}
\begin{spelleffect}
A missile of magical energy darts forth from your fingertip and strikes its target. The missile strikes unerringly, even if the target is in melee combat or has less than total cover or total concealment. Specific parts of a creature can't be singled out. Inanimate objects are not damaged by the spell.

For every four caster levels beyond 1st, you gain an additional missile. If you shoot multiple missiles, you can have them strike a single creature or several creatures. A single missile can strike only one creature. You must designate targets before you check for spell resistance or roll damage.
\end{spelleffect}

\spellsection{Magic Vestment}
\spellschool{Transmutation (Augment)}
\spelllvl{Clr 1, Sor/Wiz 1, War 1}
\spellrng{Touch}
\spelltgt{Armor or shield touched}
\spelldur{\durshort}
\spellsave{Will negates (harmless, object)}
\spellsr{Yes (Will)}
\begin{spelleffect}
You imbue a suit of armor or a shield with a \plus2 enhancement bonus. \bonusscalingdescription
\end{spelleffect}
\begin{spellnotes}
...
\spellschool{Transmutation (Augment)}
\spelllvl{Clr 1, Magic 1, Sor/Wiz 1}
\spellrng{Touch}
...
\spellsr{Yes (Will)}
\begin{spelleffect}
You imbue a weapon or stack of projectiles with a \plus2 enhancement bonus. \bonusscalingdescription
\end{spelleffect}
\begin{spellnotes}
...
\spellsave{Reflex partial}
\spellsr{Yes (Reflex)}
\spelldmg{9d10 fire damage \add d10 per four caster levels after 18th}
\begin{spelleffect}
...
\spelllvl{Clr 9, Healing 9; see text}
\spellrng{See text}
...
\spelldesc{You create several illusory duplicates of yourself that make it difficult for enemies to know which image to attack.}
...
\spelldur{\durshort (D)}
\begin{spelleffect}
This spell creates two illusory duplicates of yourself that mimic your movements perfectly. Enemies attempting to attack you or cast spells at you must select which to attack. Generally, roll randomly to see whether the selected target is real or a figment. An image's AC is 10 \add your size modifier.
\par If an image is hit, it is destroyed. If you are hit, your attacker knows the attack was successful, and can ignore the images. On your turn, you can create new images (to a maximum of two images at any time), preventing your foes from knowing which image to attack.
\par You can move into and through a mirror image on your turn. When you and the mirror image separate, observers can't use vision or hearing to tell which one is you and which the image. The figments may also move through each other. The figments mimic your actions, pretending to cast spells when you cast a spell, drink potions when you drink a potion, levitate when you levitate, and so on.
...
\spelllvl{Brd 5, Illus 6, Trickery 6}
...
\par You gain physical damage reduction 10/slashing and a \plus5 bonus to natural armor. You are immune to ability damage, blindness, deafness, disease, drowning, poison, stunning, and all spells or attacks that affect your physiology or respiration, because you have no physiology or respiration while this power is in effect.
...
\par You gain a \plus4 bonus to Strength and Constitution, but you take a \minus2 penalty to Dexterity (to a minimum Dexterity score of 1), and your speed is reduced to half normal. You can speak but cannot drink (and thus can't use potions). You have an armor check penalty of \minus4 and an arcane spell failure chance of 25%.
...
\spellschool{Evocation (Channeling) [Lawful]}
\spelllvl{Law 4}
\spellarea{30 ft. cube-shaped burst centered on you}
\spelldur{Instantaneous}
\spellsave{Will half/Will negates}
\spellsr{Yes (Will)}
\spelldmg{4d10 divine damage \add d10 per four caster levels above 8th}
\begin{spelleffect}
Nonlawful creatures in the area take damage and are bewildered for 5 rounds. A successful Will save reduces the damage by half and negates the bewildering.
\end{spelleffect}
\begin{spellnotes}
A bewildered creature takes a \minus2 penalty to attack rolls, saving throws, checks, DCs, and AC.
\end{spellnotes}
...
\spellsave{None}
\spellsr{Yes (Fortitude)}
\spelldmg{16d8 cold damage \add d8 per two caster levels above 16th}
\begin{spelleffect}
The struck target takes damage and is slowed for 5 rounds. A slowed creature can take only a single move action or standard action each turn, but not both. Additionally, it takes a \minus2 penalty to attack rolls, Strength and Dexterity-based skill checks, and armor class.
\end{spelleffect}
...
\spellsr{Yes (Fortitude)}
\begin{spellhealthy}
The target is sickened for 5 rounds.
\end{spellhealthy}
\begin{spellblood}
...
\end{spellblood}
\begin{spellnotes}
The target must be bloodied when the spell is cast to suffer the bloodied effect. A creature whose HD exceeds your caster level are sickened instead of killed.
\end{spellnotes}
...
\spellsr{Yes (Will)}
\begin{spellhealthy}
The target is bewildered for 5 rounds.
\end{spellhealthy}
\begin{spellblood}
...
\spelldesc{You extend your awareness a fraction of a second into the future, allowing you to strike at your foes more accurately.}
\spellschool{Divination (Knowledge)}
\spelllvl{Div 1}
\spellrng{Personal}
\spelltgt{You}
\spelldur{\durshort (D)}
\begin{spelleffect}
You gain a \plus2 bonus to your attack rolls. \bonusscalingdescription
\end{spelleffect}

\spellsection{Precognition}
\spelldesc{You extend your awareness a fraction of a second into the future, allowing you to strike at your foes more accurately and avoid hostile effects more easily.}
\spellschool{Divination (Knowledge)}
\spelllvl{Div 2}
\begin{spelleffect}
This spell functions like \spell{lesser precognition}, but it also affects your saving throws.
\end{spelleffect}

\spellsectioncomma{Precognition}{Greater}
\spelldesc{You extend your awareness a fraction of a second into the future, allowing you to strike at your foes more accurately and avoid hostile attacks and effects more effectively.}
\spellschool{Divination (Knowledge)}
\spelllvl{Div 4}
\begin{spelleffect}
This spell functions like \spell{lesser precognition}, but it also affects your saving throws and dodge modifier.
\end{spelleffect}
...
\spellsr{See text}
\begin{spelleffect}
This spell creates a vertical, opaque wall -- a shimmering, multicolored plane of light that protects you from all forms of attack. The wall flashes with seven colors, each of which has a distinct power and purpose. The wall is immobile, and you can pass through and remain near the wall without harm. However, any other creature with less than 8 HD that is within 20 feet of the wall is blinded for 1 minute by the colors if it looks at the wall.
...
\spelllvl{Abjur 1, Clr 1, Law 1, Pal 1}
\begin{spelleffect}
...
\begin{spelleffect}
This spell functions like \spell{protection from energy}, except that it protects from all five types of energy. When the spell absorbs 10 points per caster level of damage of any type, it is discharged.
\end{spelleffect}
...
\spellschool{Abjuration (Interdiction) [Good]}
\spelllvl{Abjur 1, Clr 1, Good 1, Pal 1}
\spellrng{Touch}
\spelltgt{Creature touched}
\spelldur{\durmed (D)}
\spellsave{Will negates (harmless)}
\spellsr{No; See text}
\begin{spelleffect}
The subject gains a \plus2 bonus on saving throws against attacks made by or effects created by evil creatures. \bonusscalingdescription
...
\spelllvl{Abjur 1, Chaos 1, Clr 1}
\begin{spelleffect}
...
\pdfbookmark[2]{R}{SpellDescriptionsR}
\begin{comment}
\subsubsection{R}
\end{comment}
...
\spellsection{Ray of Frost}
\spelldesc{You fire a ray of freezing air and ice at your foe, painfully chilling him.}
\spellschool{Evocation (Energy) [Cold]}
\spelllvl{Sor/Wiz 1, Water 1}
\spellrng{\rngclose}
\spelleff{Ray}
\spelldur{Instantaneous}
\spellsave{None}
\spellsr{Yes (Fortitude)}
\spelldmg{2d8 cold damage \add d8 per two caster levels above 1st}
\begin{spelleffect}
If you succeed on a ranged touch attack with the ray, the target takes damage.
\end{spelleffect}

\spellsection{Redirection}
\spellschool{Abjuration (Shielding)}
\spelllvl{Protection 3, Abjur 3}
\spellrng{Personal}
\spelltgt{You}
\spelldur{\durshort (D)}
\begin{spelleffect}
While this spell is active, attacks made against you have a 20\% miss chance. This miss chance stacks with and is rolled before any other miss chance, such as from concealment. Any attack that misses you because of this miss chance is instead made against a new creature of your choice, other than the attacker.
\par The new target must be a creature adjacent to you that the attacker threatens (if using a melee weapon) or can target (if using a ranged weapon). The new target must also be a creature that you can see and target. If there is no such creature, the attack strikes you normally.
\end{spelleffect}
...
\spellsr{Yes (Fortitude)}
\begin{spelleffect}
This spell causes instant diminution of a humanoid creature, halving its height, length, and width and dividing its weight by 8. This decrease changes the creature's size category to the next smaller one. The target gains a \plus2 bonus to Dexterity, a \minus2 penalty to Strength (to a minimum of 1), a \plus4 inherent bonus to Hide checks, and a \plus1 inherent bonus on attack rolls and AC due to its reduced size.
...
\spellschool{Abjuration (Shielding)}
\spelllvl{Abjur 1, Clr 2, Drd 2, Pal 2, Protection 2, Sor/Wiz 2}
\spellrng{Touch}
\spelltgt{Creature touched}
\spelldur{\durlong or until discharged}
\spellsave{Fortitude negates (harmless)}
\spellsr{Yes (Fortitude)}
\begin{spelleffect}
The subject gains damage reduction 10 against whichever of the five energy types that you select: acid, cold, electricity, fire, or sonic. Each round, the subject ignores the first 10 damage of that energy type that would be dealt to it. This damage reduction increases by 5 for every two caster levels above 4th.
...
\begin{spelleffect}
You gain physical damage reduction 10/magic against the next attack against you.
\end{spelleffect}
\begin{spellnotes}
...
\spelllvl{Sor/Wiz 5}
\begin{spelleffect}
This spell functions like \spell{inertial barrier}, except that it reflects the damage back at your attackers. Any creature striking you with its body or a natural weapon takes damage equal to the amount of damage resisted by this spell.
\end{spelleffect}
...
\spelltgt{You}
\begin{spelleffect}
This spell functions like \spell{enlarge person}, except that it affects only you, regardless of your creature type. In addition, you gain a \plus4 bonus to Strength (which replaces the bonus to Strength from \spell{enlarge person}) and physical damage reduction equal to 10 \add 1 per two caster levels above 10th. This damage reduction is only overcome by the alignment most opposed to your own. If you are neutral, choose the most appropriate alignment.
\end{spelleffect}
\begin{spellnotes}
Multiple magical effects that increase size do not stack.
\end{spellnotes}
...
\spellsave{None}
\spellsr{Yes (Reflex)}
\spelldmg{4d8 fire damage \add d8 per two caster levels above 4th}
\begin{spelleffect}
...
\spellsave{Reflex partial}
\spellsr{Yes (Reflex)}
\spelldmg{6d8 divine damage \add d8 per two caster levels above 6th; see text}
\begin{spelleffect}
If you succeed on a ranged touch attack to hit with the ray, the target takes damage and is dazzled for 1 round. An undead creature takes 6d10 points of damage \add d10 per two caster levels above 6th, and an undead creature particularly vulnerable to bright light takes 12d6 points of damage \add d6 per two caster levels above 6th and is blinded for 1 round instead.
\end{spelleffect}
...
\spellschool{Illusion (Glamer) [Unreal]}
\spelllvl{Brd 5, Sor/Wiz 5, Trickery 6}
\spellrng{\rngclose}
\spellarea{\areamed radius limit}
...
\par While in your shadow body, you gain damage reduction 10/magic and darkvision out to 60 feet. You are immune to ability damage, disease, drowning, and poison. You take only half damage from acid, electricity, and fire of all kinds.
...
\begin{spelleffect}
Shadow conjuration can mimic any general sorcerer or wizard conjuration (summoning) or conjuration (creation) spell of 3rd level or lower. If you summon a creature, as with the \spell{summon monster} spells, you may only summon a creature that you know how to summon with such a spell.
...
\spelllvl{Illus 7}
\begin{spelleffect}
This spell functions like \spell{shadow conjuration}, except that it can duplicate any sorcerer or wizard conjuration (summoning) or conjuration (creation) spell of 6th level or lower.
\end{spelleffect}
\begin{spellnotes}
...
\spellsr{Yes (Will); see text}
\begin{spelleffect}
You tap energy from the Plane of Shadow to cast a quasi-real, illusory version of a general sorcerer or wizard evocation spell of 4th level or lower. (For a spell with more than one level, use the best one applicable to you.)
\par Spells that deal damage have normal effects unless an affected creature succeeds on a Will save. Each disbelieving creature takes only half damage from the attack. If the disbelieved attack has a special effect other than damage, that effect is half as strong (if applicable) or only halfas likely to occur. Regardless of the result of the save to disbelieve, an affected creature is also allowed any save (or spell resistance) that the spell being simulated allows.
\end{spelleffect}
\begin{spellnotes}
...
\spelllvl{Illus 8}
\begin{spelleffect}
This spell functions like \spell{shadow evocation}, except that it enables you to create partially real, illusory versions of sorcerer or wizard evocation spells of 7th level or lower.
\end{spelleffect}

\spellsection{Shadow Puppet}
\spellschool{Conjuration/Illusion (Shadow, Translocation) [Planar, Unreal]}
\spelllvl{Sor/Wiz 9}
\spellrng{Personal/\rnglong; see text}
\spelltgt{You}
\spelleff{One shadow duplicate}
\spelldur{\durmed}
...
\end{spelleffect}
\begin{spellnotes}
If the image moves farther than \rnglong range away from where it was originally created, or if you leave the Plane of Shadow, the image ceases to exist.
\end{spellnotes}
...
\spelllvl{Clr 2, Evil 2, Sor/Wiz 2}
\spellrng{\rngmed}
\spelltgts{You and one willing creature, or two willing creatures; see text}
\spelldur{\durlong (D)}
\spellsave{None}
\spellsr{Yes (Will)}
\begin{spelleffect}
This spell creates a connection between you and a willing subject so that some of your wounds are transferred to the subject. You take half damage (rounded up) from all attacks that deal hit point damage to you, and the subject takes the remainder. If your hit points are reduced by a lowered Constitution score, that reduction is not shared with the subject because it is not a form of hit point damage. If you are immune to the type of damage dealt, or if you convert lethal damage into nonlethal damage, the target takes no damage. When this spell ends, subsequent damage is no longer divided between the subject and you, but damage already shared is not reassigned.
\par If you and the subject move out of range of each other, the spell is suppressed until the subject gets within range of you.
\par Alternately, you can cast this spell on two willing subjects, one of which you designate to share its damage with the other. If the two subjects move out of range of each other, the spell is suppressed until the subjects get within range of each other.
\end{spelleffect}

\spellsection{Share Pain, Forced}
\spellschool{Abjuration/Necromancy (Life, Shielding)}
\spelllvl{Clr 3, Sor/Wiz 3}
\spellrng{\rngmed}
\spelltgt{One creature}
...
\spelldur{\durshort (D)}
\begin{spelleffect}
This spell functions like \spell{share pain}, except that you take no damage from all wounds and attacks that deal hit point damage, and all of that damage is taken by the willing subject.
\par Alternately, you can cast this spell on two willing subjects, one of which you designate to share its damage with the other.
\end{spelleffect}
...
\spellsr{Yes (Will)}
\spelldmg{4d8 sonic damage \add d8 per two caster levels after 4th}
\begin{spelleffect}
...
\spellsection{Shield}
\spelldesc{You create an invisible, heavy shield-sized mobile disk of force that hovers in front of you. It automatically moves to protect you from enemy blows.}
...
\spelldur{\durshort (D)}
\begin{spelleffect}
You gain a \plus2 shield modifier to AC. \bonusscalingdescription The shield has no armor check penalty or arcane spell failure chance. It is considered light armor for the purpose of class features and abilities. Unlike with a normal tower shield, you can't use the shield spell for cover. The bonus provided by he shield applies against incorporeal touch attacks, since it is a force effect.
\end{spelleffect}
\begin{spellnotes}
This shield is considered to be separate from any other shields the creature is using, so it never stacks with existing shield modifiers.
\end{spellnotes}
...
\spellsr{Yes (Will)}
\begin{spelleffect}
The subject gains a \plus2 bonus to its shield modifier. \bonusscalingdescription The subject is not encumbered or hindered in any way by the shield.
\end{spelleffect}
\begin{spellnotes}
This shield does not stack with any shield the subject uses; only the higher modifier applies.
\end{spellnotes}
...
\spellsection{Shield Other}
\spellschool{Abjuration/Necromancy (Life, Shielding)}
\spelllvl{Clr 2, Good 2, Pal 2, Protection 2, Sor/Wiz 2}
\spellrng{\rngmed}
\spelltgt{One creature}
\spelldur{\durlong (D)}
\spellsave{Will negates (harmless)}
\spellsr{Yes (Will)}
\begin{spelleffect}
This spell creates a mystic connection between you and the subject so that some of its wounds are transferred to you. The subject takes only half damage from all wounds and attacks (including that dealt by special abilities) that deal hit point damage. The amount of damage not taken by the shielded creature is taken by you. Forms of harm that do not involve hit points, such as charm effects, temporary ability damage, level draining, and death effects, are not affected. If the subject suffers a reduction of hit points from a lowered Constitution score, the reduction is not split with you because it is not hit point damage. When the spell ends, subsequent damage is no longer divided between the subject and you, but damage already split is not reassigned to the subject.
\par If you and the subject of the spell move out of range of each other, the spell is suppressed until the subject moves within range of you again.
\end{spelleffect}

\spellsectioncomma{Shield Other}{Greater}
\spellschool{Abjuration/Necromancy (Life, Shielding)}
\spelllvl{Abjur 6, Protection 6}
\spelldur{\durshort (D)}
\begin{spelleffect}
This spell functions like \spell{shield other}, except that the subject takes no damage from all wounds and attacks that deal hit point damage, and all of that damage is taken by you.
\end{spelleffect}
...
\spellsave{None}
\spellsr{Yes (Fortitude)}
\spelldmg{2d8 electricity damage \add d8 per two caster levels above 1st}
\begin{spelleffect}
...
\spellsr{Yes (Fortitude)}
\spelldmg{4d10 sonic damage \add d10 per four caster levels above 8th; see text}
\begin{spelleffect}
Any creature in the area takes damage and is deafened for 5 rounds. A successful save negates the deafness and reduces the damage by half. Any exposed brittle or crystalline object or crystalline creature takes 8d6 points of sonic damage \add d6 per two caster levels above 8th.
\end{spelleffect}
...
\spelldmg{7d10 sonic damage \add d10 per four caster levels above 14th; see text}
\begin{spelleffect}
This spell functions like \spell{shout}, except that it is larger and the deafness lasts for 5 rounds. Any exposed brittle or crystalline object or crystalline creature takes 14d6 points of sonic damage \add d6 per two caster levels above 14th.
\end{spelleffect}
...
\end{spelleffect}
\begin{spellnotes}
Creatures with HD in excess of your caster level are immune to this spell.
\end{spellnotes}
...
\spellsave{Fortitude half/Fortitude negates}
\spellsr{Yes (Fortitude)}
\spelldmg{2d10 sonic damage \add d10 per four caster levels above 4th}
\begin{spelleffect}
...
\spellsr{Yes (Will)}
\begin{spelleffect}
The shielded creature is immune to the effects of one specified spell for every four levels you have. The spells must be of 4th level or lower.
\end{spelleffect}
\begin{spellnotes}
The shielded creature effectively has unbeatable spell resistance regarding the specified spell or spells. Naturally, that immunity doesn't protect a creature from spells for which spell resistance doesn't apply. Spell immunity protects against spells, spell-like effects of magic items, and innate spell-like abilities of creatures. It does not protect against supernatural or extraordinary abilities, such as breath weapons or gaze attacks.
\par Only a particular spell can be protected against, not a certain domain or school of spells or a group of spells that are similar in effect. 
...
\spellschool{Abjuration (Shielding) [Magic]}
\spelllvl{Clr 5, Magic 5, Protection 5}
\spellrng{Touch}
\spelltgt{Creature touched}
\spelldur{\durshort}
\spellsave{Will negates (harmless)}
...
\spelltgt{One spellcaster, creature, or object}
\begin{spelleffect}
This spell functions like \spell{greater dispel magic}, except that you can choose to gain the effects of any spells you dispel as if they had been originally cast on you. The effects last for the remainder of their original durations or for 5 rounds, whichever is shorter. Spells that cannot be cast on you, such as spells which have a range of personal, are simply dispelled.
\end{spelleffect}
...
\spellschool{Abjuration (Shielding) [Magic]}
\spelllvl{Magic 7, Protection 7, Sor/Wiz 7}
\spellrng{Personal}
\spelltgt{You}
...
\par A \spell{spiritual weapon} cannot be attacked or harmed by physical attacks, but \spell{dispel magic}, \spell{disintegrate}, and similar effects can affect it. A spiritual weapon's AC against touch attacks is 12 (10 \add \plus2 for being Tiny).
...
\spellrng{\rngmed}
\spellarea{\arealarge radius limit}
\spelleff{One Large summoned creature/level within the area}
\spelldur{\durshort (D)}
\spellsave{Reflex half; see text}
\spellsr{No}
\spelldmg{9d10 bludgeoning damage \add d10 per four caster levels above 18th}
\begin{spelleffect}
This spell summons a stampede of bison to trample your foes. Creatures trampled by the herd of bison take damage from the spell.
\par The bison are summoned in a place that you designate within the spell's area, with each creature being summoned in the closest free space to the point of origin. If there is insufficient room for all of the bison to appear while standing on stable ground, the spell will summon fewer bison than the maximum. The herd of bison always moves directly away from you, trampling anything of Large size or smaller that gets in their way. If the herd is thinned to 5 bison or fewer, they stop stampeding and scatter in random directions.
...
\spellschool{Transmutation (Alteration) [Earth]}
\spelllvl{Drd 5, Earth 5, Protection 5, Strength 5, Trans 5}
\begin{spelleffect}
This spell functions like \spell{barkskin}, except that it grants physical damage reduction 10/adamantine. The subject ignores the first 10 points of damage it would take each round, though an adamantine weapon bypasses the reduction. This damage reduction increases by 1 per two caster levels above 10th.
\end{spelleffect}
\begin{spellnotes}
Unlike \spell{barkskin}, the damage reduction is not negated if the creature takes fire damage.
\end{spellnotes}
...
\par 3rd Round: You call three bolts of lightning down from the cloud. You decide where the bolts strike. No two bolts may be directed at the same target. Each bolt deals 9d10 electricity damage \add d8 per four caster levels after 18th. A creature struck can attempt a Reflex save for half damage. If you do not direct the lightning bolts, each bolt automatically targets the largest available target in the area.
\par 4th Round: Hailstones rain down, dealing 5d10 bludgeoning damage to all enemies in the area.
...
\spellrng{\rngclose}
\spelltgt{One creature}
\spelldur{Instantaneous/\durshort}
\spellsave{None/Fortitude negates}
\spellsr{Yes (Fortitude)}
\spelldmg{14d6 physical damage \add d6 per two caster levels above 14th}
\begin{spelleffect}
The target takes damage. In addition, if it fails a Fortitude save, for the duration of the spell all damage it takes is doubled. This effect does not double the initial damage dealt by this spell.
\end{spelleffect}
...
\spellsave{Reflex half/Reflex negates}
\spellsr{Yes (Reflex)}
\spelldmg{5d10 solar damage \add d10 per four caster levels above 10th; see text}
\begin{spelleffect}
Each creature in the beam takes damage and is dazzled for 1 round. Any creatures to which sunlight is harmful or unnatural instead take 10d6 points of damage \add d6 per two caster levels above 10th and are blinded for 1 round. A successful Reflex save negates the dazzling (or blindness) and reduces the damage by half.
\end{spelleffect}
\begin{spellnotes}
A dazzled creature treats everything he sees as if it has concealment (20\% miss chance), and takes a \minus4 penalty to Spot checks. He is also unable to use darkvision. \spell{Sunbeam} dispels any darkness spells of 5th level or lower within its area.
\end{spellnotes}
...
\spellrng{\rngmed}
\spellarea{\areamed radius burst}
\spelldmg{8d10 solar damage \add d10 per four caster levels above 16th; see text}
\begin{spelleffect}
This spell functions as \spell{sunbeam}, except that it affects a \areamed radius and deals more damage. Any creatures to which sunlight is harmful or unnatural take 16d6 points of damage \add d6 per two caster levels above 16th.
\end{spelleffect}
\begin{spellnotes}
...
\par If you spend at least 5 rounds concentrating on an unattended object, you can attempt to break or burst it as if making a Strength check, except that you apply your casting attribute to the check instead of your Strength.
\end{spelleffect}
...
\spellschool{Divination/Transmutation (Communciation, Imbuement)}
\spelllvl{Sor/Wiz 3}
\spellrng{\rngclose}
...
\spelllvl{Sor/Wiz 6}
\spellarea{\areamed radius limit centered on you}
\spelltgts{You up to five willing creatures in the area}
\spelldur{\durext (D)}
\begin{spelleffect}
...
\end{spelleffect}
\begin{spellnotes}
\spellindirect{telepathic bond}{Telepathic bond} can be made permanent with a \spell{permanency} ritual.
\end{spellnotes}
...
\end{spellblood}
\begin{spellnotes}
A shaken character takes a \minus2 penalty on attack rolls, saving throws, checks, DCs, and AC. A frightened creature is the same, except that it also flees from the source of its fear as best it can. If unable to flee, it may fight.
...
\spellschool{Divination (Communication)}
\spelllvl{Brd 3, Clr 4, Div 3, Knowledge 3, Sor/Wiz 4}
\spellcmp{V}
\spellrng{Touch}
\spelltgt{Creature touched}
\spelldur{\durlong}
...
\spellsr{Yes (Will)}
\begin{spelleffect}
This spell grants creatures the mental power of a totem animal. It has three forms, each of which grants a \plus4 bonus to a mental attribute score. This bonus increases to \plus6 at 10th level. Spellcasters do not gain bonus spells due to the increased attribute score.
...
\spellsr{Yes (Fortitude)}
\begin{spelleffect}
This spell grants creatures the physical power of an animal. It has three forms, each of which grants a \plus4 bonus to a mental attribute score. This bonus increases to \plus6 at 10th level.
...
\spellrng{Close}
\spelleff{Ray}
\spelldmg{8d10 life damage \add d10 per two caster levels above 8th}
\begin{spelleffect}
...
\spelldesc{You transfer the wounds that you have taken to your foe, forcing it to suffer in your stead.}
\spellschool{Necromancy (Life) [Healing]}
\spelllvl{Sor/Wiz 2}
\spellrng{Touch}
\spelltgt{Living creature touched}
...
\spellsave{Will half}
\spellsr{Yes (Will)}
\spelldmg{4d8 life damage \add d8 per two caster levels above 4th}
\begin{spelleffect}
...
\spellschool{Divination (Awareness)}
\spelllvl{Clr 6, Div 5, Knowledge 5, Sor/Wiz 6}
\spellcmp{V, S, M}
\spellrng{Touch}
\spelltgt{Creature touched}
\spelldur{\durshort}
...
\spelldmg{4d10 divine damage \add d10 per four caster levels above 8th}
\begin{spelleffect}
Nonevil creatures in the area take damage and are sickened for 5 rounds. A successful Will save reduces the damage by half and negates the sickening.
\end{spelleffect}

\spellsection{Vampiric Touch}
\spellschool{Necromancy (Life)}
\spelllvl{Death 3, Necro 3}
\spellrng{Touch}
\spelltgt{Living creature touched}
\spelldur{Instantaneous/1 hour; see text}
\spellsave{Will half}
\spellsr{Yes (Will)}
\spelldmg{6d10 life damage \add d10 per two caster levels above 6th}
\begin{spelleffect}
...
\spellsave{Reflex half or Reflex negates; see text}
\spellsr{Yes (Reflex)}
\spelldmg{5d10 \add d10 per four caster levels above 10th; see text}
\begin{spelleffect}
...
\par If you evoke the wall so that it appears where creatures are, each creature takes damage as if passing through the wall, except that a successful Reflex save negates the damage and allows the creature to choose which side of the wall to appear on. If any 5-foot length of wall takes 20 points of cold damage or more in 1 round, that length goes out. (Do not divide cold damage by 4, as normal for objects.)
\end{spelleffect}
\begin{spellnotes}
...
\spellsave{Reflex negates; see text}
\spellsr{Yes (Reflex)}
\spelldmg{4d10 \add d10 per four caster levels above 8th}
\begin{spelleffect}
...
\spelldesc{You command the air to bludgeon the target with tremendous force.}
\spellschool{Evocation (Control) [Air]}
...
\spellsave{Fortitude half}
\spellsr{Yes (Fortitude)}
\spelldmg{4d8 bludgeoning damage \add d8 per two caster levels after 4th}
\begin{spelleffect}
The target takes damage from the powerful winds. A Fortitude save halves the damage.
\end{spelleffect}
...
\spelllvl{Air 5, Drd 5}
\spellrng{\rngmed}
\spelldmg{10d8 bludgeoning damage \add d8 per two caster levels after 10th}
\begin{spelleffect}
This spell functions like \spell{windstrike}, except that it deals more damage from farther away, and the target may be sent flying. You make a bull rush attack with a bonus equal to your caster level \add your casting attribute \add 4 (the wind is treated as a Large creature). If you succeed, you may have the wind bull rush the target in any direction -- even vertically. Moving the target up takes twice as much movement as moving the target horizontally.
\end{spelleffect}
...
\end{itemize*}
\par When casting a wish, you do not specify the exact spell or effect you wish to duplicate. Instead, you make a wish, describing what you want to have happen, and make a DC 15 Wisdom check. If the check fails, your intent is redirected or perverted in some way. For example, a wish to turn a foe to stone would normally mimic the flesh to stone effect of the transmute flesh and stone spell. However, if the Wisdom check failed, your foe might gain the benefit of a stoneskin spell instead.
\par You may try to use a wish to produce greater effects than these, but doing so is dangerous. The DC of the Wisdom check increases to 20, and the negative consequences for failing the check increase in proportion to the potency of the effect you try to create.
\end{spelleffect}
\begin{spellnotes}
...
\end{spellhealthy}
\begin{spellblood}
Each nonchaotic creature in the area suffers one or more of the following ill effects, depending on its Hit Dice.
\begin{dtable}
\begin{tabularx}{\columnwidth}{l >{\lcol}X}
\par \thead{HD} & \thead{Effect} \\
...
\end{spellblood}
\begin{spellnotes}
A bewildered creature takes a \minus2 penalty to attack rolls, saving throws, checks, DCs, and AC. Creatures whose Hit Dice exceed your caster level are unaffected by \spell{word of chaos}.
\end{spellnotes}
...
\spellsr{Yes (Will)}
\begin{spelleffect}
The affected weapon gains an additional five feet of reach, extending the wielder's threatened area. Attacks outside the weapon's normal range deal half damage, but are otherwise treated exactly as if the wielder was attacking with the weapon normally.
\end{spelleffect}
\begin{spellnotes}
...
\spellsection{Zephyr Blade}{Greater}
