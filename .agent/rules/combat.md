...
*   **Damage Calculation:** Weapon damage is influenced by Power (Mundane/Magical). Weapon dice increment modifiers step base weapon damage along a 12-step ladder (1d2 to 4d10) before power and multipliers. Extra damage behaves like inherent damage (doubled on crit) and applies once per attack roll per creature, excluding poisons.
