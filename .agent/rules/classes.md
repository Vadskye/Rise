...
This is a summary of the Rise class rules.

* Classes are generally described in `comprehensive_codex/Classes.tex`.
* Rules for specific class abilities are found in `rust/src/classes/archetype_rank_abilities/` and `rust/src/classes/class.rs`.
