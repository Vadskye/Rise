...
\appdescription{Amulet of Mighty Fists}{Varies}{see text}{Torso}{Varied Transmutation (Augment)}{}{\x}
An amulet of mighty fists grants an enhancement bonus to attack and damage with natural weapons, including unarmed attacks. The price of the amulet depends on its enhancement bonus, as shown in the table below.

\begin{dtable}
    \caption{Amulet of Mighty Fists}
    \begin{tabularx}{\columnwidth}{l X X}
        \thead{Bonus} & \thead{Base Price} & \thead{Item Level} \\
        \plus1 & 200 gp & 3rd \\
        \plus2 & 1000 gp & 6th \\
