...
\tooldescription{Answerstone}{2,000}{8th}{Faint Divination (Knowledge)}{6th}{Standard (specific action)} If you shake this stone and ask a simple yes or no question (a standard action), you receive an answer of either ``yes'', ``no'', or ``unknown''. The answer has a 75\% chance of being correct. If the answerstone is incorrect, it will randomly answer either of the two remaining answers. The answerstone will always answer ``unknown'' if asked questions about events more than thirty minutes into the future or past, or farther than ten miles from its current location.

Although an answerstone is usually made of stone, it can also be made of other sturdy materials.
