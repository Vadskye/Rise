...
You are vulnerable (\minus2 to attacks, defenses, and checks) while balancing. If you take damage while balancing, you must make another Acrobatics check against the same DC to avoid falling. If you take a \minus5 penalty, you are not vulnerable while balancing. If you take a \minus5 penalty, you can move at full speed while balancing.
...
After you finish sprinting, you are fatigued for a number of rounds equal to the number of rounds you spent sprinting, making you vulnerable and preventing you from sprinting again. While vulnerable, you take a \minus2 penalty to attacks, defenses, and checks. You can sprint in any movement mode that you can use.
