...
You can automatically notice inconsistencies in illusion spells. The DC is equal to the save DC of the spell. Success means that you get a Will save to disbelieve the illusion as if you interacted with the illusion.
...
You can automatically notice when a creature is affected by mind-controlling magic -- including yourself. The DC is normally equal to the save DC of the spell. Domination effects have a DC that is 10 lower than normal.
...
You can automatically notice when people lie to you. The DC is equal to the lying creature's Bluff check. If your modifier exceeds the DC, you notice that the creature was lying. Otherwise, you do not.

\subsubsection{Discern Secret Message}
You can automatically identify hidden messages conveyed with the Bluff skill. The DC is equal to DC of the secret message. If your modifier exceeds the DC, you recognize that a hidden message is present, but not its contents. If it is greater by 5 or more, you can understand the message. Otherwise, you don't notice the hidden message.
