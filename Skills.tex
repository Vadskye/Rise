...
Athletics       & C  & cc & cc & C  & C  & cc & C  & C  & cc & cc & cc & Yes & Str\fn{1} \\
Climb           & C  & cc & cc & C  & C  & cc & C  & C  & cc & cc & cc & Yes & Str\fn{1} \\
Swim            & C  & cc & C  & C  & C  & cc & C  & C  & cc & C  & cc & Yes & Str\fn{2} \\
Acrobatics      & cc & cc & C  & C  & C  & cc & cc & C  & cc & cc & cc & Yes & Dex\fn{1} \\
Escape Artist   & cc & cc & cc & cc & C  & cc & cc & C  & cc & cc & cc & Yes & Dex\fn{1} \\
...
Perception      & C  & cc & C  & C  & C  & C  & C  & C  & cc & cc & cc & Yes & Wis \\
...
Make someone look like someone else & Disguise (Int) & Perception (Wis) \\
...
\skill{Acrobatics}{Dex; Armor Check Penalty}
...
If you take damage while balancing, you must make another Acrobatics check against the same DC to avoid falling. If you take a \minus5 penalty, you can move at full speed while balancing.

The DC varies with the surface, as follows.

\begin{itemize}
    \item Uneven floor (flagstones, sloped floor): DC 10. This only applies when sprinting or charging. Failure means you lose a move action (and possibly fall), but you can still take a standard action.
    \item Slippery floor (oil): DC 15.
    \item At least one foot wide: DC 5. 
    \item At least six inches wide: DC 10.
    \item At least two inches wide: DC 15.
    \item At least one inch wide: DC 20.
    \item Less than than one inch wide: DC 25.
\end{itemize}
...
\skill{Athletics}{Str; Armor Check Penalty}
...
You can make an Athletics check as part of movement to move faster. For every 10 points by which you beat DC 0, you double your speed during that action, as shown on \trefnp{Sprinting}. You can sprint for a number of rounds equal to 5 \add your Constitution.
...
If you act differently from the crowd you are trying to blend in with, anyone observing you gets a \plus5 bonus to find you. You may need to make Perception or Sense Motive checks to figure out how to act, depending on the situation. If you are extremely dissimilar from the crowd, such as a naked person in church or a human among halflings, anyone observing you may gain a \plus10 or greater bonus to find you. 

\subsubsection{Distract}
You can make a Bluff check to distract a creature or group of creatures you are talking with. Your Bluff check is opposed by your target's Sense Motive check. Success means it takes a \minus5 penalty to Perception checks for 1 round, as you distract them. Failure means they take no penalty. Failure by 10 or more means it realizes you were trying to distract it.
...
\begin{dtable}
    ...
    \end{tabularx}
    1 Always add any appropriate modifiers from \tref{Perception DC Modifiers} \\
...
The DCs given are for a creature with an ordinary sense of smell, like a human. A creature with the scent ability, like most animals, gains a \plus10 bonus to scent-based Perception checks. Some creatures with extraordinary smelling abilities, such as dogs, gain a \plus20 bonus to scent-based Perception checks.
...
Observers that you touch as part of the action gain a \plus10 bonus to their Perception check. If you strike them hard, as with an attack, the bonus increases to a \plus20 bonus.
