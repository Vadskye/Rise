...
You can use Bluff to convince people that you are telling the truth. It is usually used when you are lying. Using a Bluff check is part of conversation, so it takes no action in itself. You cannot normally take 10 on Bluff checks.
