...
You are flat-footed while balancing, since you can't move to avoid a blow. If you take damage while balancing, you must make another Acrobatics check against the same DC to avoid falling. If you take a \minus5 penalty, you are not flat-footed while balancing. If you take a \minus5 penalty, you can move at full speed while balancing.
...
A creature with a climb speed moves by a distance equal to its climb speed when climbing. It has a \plus5 bonus on all Climb checks. It can always take 10 on Climb checks, even if rushed or threatened, and is not flat-footed while climbing. It cannot make an accelerated climb.
