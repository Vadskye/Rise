...
Expert & 2 & 1/2 character level \add 3 & Associated class levels \add 1/2 unassociated class levels \add 3 \\
\end{tabularx}
\end{dtable}
...
A creature with a climb speed moves by a distance equal to its climb speed when climbing. It has a \plus5 bonus on all Climb checks. It can always choose to take 10 on Climb checks, even if rushed or threatened, and is not flat-footed while climbing. It cannot make an accelerated climb.
...
This check is made once every 8 hours you spend travelling overland. You can't take 10 or take 20 on checks to navigate a wilderness. If you move at half speed, you gain a \plus5 bonus on the check.
...
This check is made once every 8 hours you spend travelling overland. You can't take 10 or take 20 on checks to find sustinence in the wilderness. If you move at one-quarter speed, you gain a \plus5 bonus on the check.
...
A creature with a swim speed can move through water at its indicated speed without making Swim checks. It gains a \plus5 bonus on any Swim check to perform a special action or avoid a hazard. The creature always can choose to take 10 on a Swim check, even if distracted or endangered when swimming.
