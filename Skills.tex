...
\parhead{Hearing} The DC to hear a sound depends on the intensity of the sound, as shown on \trefnp{Hearing Base DCs}, and other modifiers given at \trefnp{Perception DC Modifiers}.
...
\parhead{Sight} The DC to see something depends on the obviousness of the sight, as shown on \trefnp{Sight Base DCs}, and other modifiers given at \trefnp{Perception DC Modifiers}.
...
\parhead{Scent} The DC to smell something depends on the intensity of the scent, as shown on \trefnp{Scent Base DCs}, and other modifiers given at \trefnp{Perception DC Modifiers}.
