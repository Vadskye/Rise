...
A creature with a climb speed moves by a distance equal to its climb speed when climbing. It has a \plus5 competence bonus on all Climb checks. It can always choose to take 10 on Climb checks, even if rushed or threatened, and is not flat-footed while climbing. It cannot make an accelerated climb.
