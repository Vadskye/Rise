...
You can make an Athletics check as a free action to move faster for 1 round. For every 5 points by which you beat DC 0, you increase your speed by 5 feet. You can sprint for a number of rounds equal to 5 \add your Constitution.

After sprinting, you are fatigued for a number of rounds equal to the number of rounds you spent sprinting, making you vulnerable. While vulnerable, you take a \minus2 penalty to attack rolls, saving throws, checks, DCs, and AC. You can sprint in any movement mode that you can use.
