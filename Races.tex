...
\section{Backgrounds}
In addition to a race, each character also has at least one background. Each background describes what a character has done before the start of the story. This grants the character some number of additional class skills.
