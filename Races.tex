...
\item A gnome with a Charisma score of at least 10 gains spell-like abilities. These can be used a number of times per day equal to half the home's character level \add Charisma value: \spell{dancing lights}, \spell{ghost sound}, and \spell{prestidigitation}. The gnome's caster level with these abilities is equal to the gnome's character level, and the save DC is equal to 10 \add half character level \add Charisma modifier.
