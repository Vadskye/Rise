...
\item Stability: A dwarf gains a \plus2 bonus to Maneuver Class to resist being overrun, shoved, or tripped when standing on the ground (but not when climbing, flying, riding, or otherwise not standing firmly on the ground).
