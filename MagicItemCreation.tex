...
\begin{dtable*}
    ...
    \begin{tabularx}{\textwidth}{X l l l l l}
        ...
        %TODO: skill bonus prices
    \end{tabularx}
\end{dtable*}

%A bonus to a specific skill costs (skill bonus squared) * 200 gp.
%Math behind this:
%A rank 4 buff, permanent, personal is 6th level, or 18,000 gp. That suggests
%that +10 to a skill is about a rank 4 buff. That seems fitting. In addition, a
%close range rank 4 buff with short duration is 2nd level, which is a
%plausible level for a spell that gives +10 to a skill. 
...
\begin{dtable*}
    ...
    \begin{tabularx}{\textwidth}{l X X X}
        ...
        1st & 100 gp (3rd) & 200 gp (3rd) & 400 gp (4th) \\
