...
\parhead{ability check:} A check of 1d20 \add the appropriate attribute modifier. 
...
\parhead{attribute modifier:} The bonus or penalty associated with a particular attribute score. Attribute modifiers apply to die rolls for character 
...
bonus equal to its Charisma modifier or \plus1, whichever is greater. 
