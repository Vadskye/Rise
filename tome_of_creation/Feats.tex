...
\section{Feat Descriptions}
  ...
  \begin{feat}{Balance Specialization}{Skill}
    ...
    \ff[6]{Precise Step} You ignore \glossterm{difficult terrain} from mundane natural sources, such as \glossterm{heavy undergrowth}.
  ...
  \begin{feat}{Heavenly Warrior}{Combat}
    ...
    % TODO: damage math in the spreadsheet. This is kind of like 1d8 extra damage, but requires two separate attacks.
    \ff[6]{Call to Heaven}
    \begin{activeability}{Call to Heaven}[\atBrawling (see text)]
      ...
      If you hit, and the target's \glossterm{weight category} does not exceed your carrying capacity, you \glossterm{knockback} the target up to 10 feet into the air.
      ...
      The first attack has the \atBrawling tag, but the strike does not.

      Typically, a creature hit by this attack will fall to the ground at the end of the round, taking \glossterm{falling damage} (see \pcref{Falling Damage}).
      \rankline
      % TODO: damage scaling using the spreadsheet
    \end{activeability}

    \ff[12]{Instant Leap} You are always considered to have a running start when jumping.
