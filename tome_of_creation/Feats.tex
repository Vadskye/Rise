...
\section{Feat Descriptions}
  ...
  \begin{feat}{Whirlwind Warrior}{Combat}
    ...
    \begin{sustainability}{Cyclone}{\abilitytag{Sustain} (standard)}
      ...
      \rankline
      \featlevel{9} The strike deals 1d4 \glossterm{extra damage}.
      \featlevel{12} The extra damage increases to 1d4 per 3 power (minimum 1d4).
      \featlevel{15} The extra damage increases to 1d6 per 3 power.
      \featlevel{18} The strike deals double \glossterm{weapon damage}.
    \end{sustainability}
