...
\sectiongraphic*{Dwarves}{width=\columnwidth}{characters/dwarf}
  ...
  \parhead{Special Abilities}
  \begin{raggeditemize}
    \itemhead{Armored From Birth} Dwarves are proficient with all \glossterm{usage classes} of body armor (see \pcref{Armor}).
...
\sectiongraphic*{Half-orc}{width=\columnwidth}{characters/halforc}
  ...
  \begin{raggeditemize}
    ...
    \itemhead{Martial Instincts} Half-orcs are proficient with all non-exotic weapons from one \glossterm{weapon group} of their choice.
...
\sectiongraphic*{Orcs}{width=\columnwidth}{characters/halforc}
  ...
  \begin{raggeditemize}
    ...
    \itemhead{Martial Upbringing} Orcs are proficient with all non-exotic weapons.
