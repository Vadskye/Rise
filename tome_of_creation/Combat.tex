...
\section{Taking Damage}\label{Taking Damage}
  ...
  \subsection{Injury}\label{Injury}
    While you are at less than your maximum hit points, you are \glossterm{injured}.
    If an attack causes you to lose hit points, it gets an \glossterm{injuring hit}.
    Some ability have special effects if they get an injuring hit.
    Being injured does not have any intrinsic effects, but some abilities have special effects on injured creatures.

    Objects cannot be injured, but they can be \glossterm{broken} or \glossterm{destroyed} (see \pcref{Breaking Objects}).
...
\section{Movement and Positioning}\label{Movement and Positioning}
  ...
  \subsection{Movement Modes}\label{Movement Modes}
    ...
    Climbing without a climb speed imposes a \minus2 penalty to your accuracy, Armor defense, and Reflex defense.
    ...
    Swimming without a swim speed imposes a \minus2 penalty to your accuracy, Armor defense, and Reflex defense.
  ...
  \subsection{Special Combat Abilities}\label{Special Combat Abilities}
    ...
    \begin{dtable!*}
      ...
      \begin{dtabularx}{\textwidth}{l l X l}
        ...
        Shove              & Movement or standard & Move a foe                                    & \abilitytag{Brawling}, \abilitytag{Size-Based} \\
    ...
    \begin{activeability}*{Ready Reaction}[\atSwift]
      ...
      For example, you could declare your intent to make a melee strike against a creature that is not close to you, or cast a targeted spell on an enemy that has \glossterm{total cover}.
