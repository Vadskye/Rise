...
\sectiongraphic*{Making Attacks}{width=\columnwidth}{core mechanics/making attacks}
  ...
  \subsection{Attack Rolls}\label{Attack Rolls}
    ...
    \subsubsection{Critical Hits}\label{Critical Hits}
      If your attack result is at least 10 higher than your target's defense, your attack is a \glossterm{critical hit} against that target.
  ...
  \subsection{Dealing Damage}
    When you deal damage, you roll the damage dice appropriate for that ability.
    Whatever you hit will track that damage appropriately.
...
\sectiongraphic*{Vital Wounds}{width=\columnwidth}{core mechanics/vital wounds}
  ...
  \subsection{Removing Vital Wounds}\label{Removing Vital Wounds}
    ...
    % TODO: remove damage types
\sectiongraphic*{Damage Types}{width=\columnwidth}{core mechanics/damage types}
  ...
  \subsection{Damage Subtypes}\label{Damage Subtypes}
  ...
  \subsection{Multiple Damage Types}\label{Multiple Damage Types}
