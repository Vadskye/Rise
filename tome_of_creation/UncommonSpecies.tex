...
\section{Harpy}
  ...
  \begin{itemize}
    ...
    \itemhead{Wings} Harpies have no arms or hands.
      ...
      These wings grant them a \glossterm{glide speed} and \glossterm{fly speed} that are both equal to the \glossterm{base speed} for their size (see \pcref{Aerial Movement}).
      The fly speed has a 5 foot height limit.
      As a \glossterm{free action}, a harpy can increase their \glossterm{fatigue level} by one to ignore this height limit until the end of the round.
  \end{itemize}
  \parhead{Automatic Languages} Common.

  \subsection{Harpy Archetype}

    \cf{Hrp}[1]{Winged Agility} While you are able to use your wings, you gain a \plus2 bonus to Armor defense, a \plus4 bonus to the Balance skill, and a \plus10 foot bonus to your maximum horizontal jump distance (see \pcref{Jumping}).
    ...
    \cf{Hrp}[4]{Winged Agility+} You can use your wings to help you maneuver on the ground more effectively, such as by briefly hovering or gliding over obstacles.
      The Balance bonus from your \textit{winged agility} ability increases to \plus8.
