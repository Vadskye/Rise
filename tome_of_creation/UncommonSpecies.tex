...
\section{Dragon}
  ...
  \begin{itemize}
    ...
    \itemhead{Draconic Wings} Dragons have scaly wings that sprout from their backs.
      ...
      As a \glossterm{free action}, a dragon can increase their \glossterm{fatigue level} by one to ignore this height limit until the end of the round.
  ...
  \subsection{Dragon Archetype}
    ...
    \cf{Dgn}[2]{Draconic Body} You gain a \plus1 bonus to your Armor defense.
      ...
      % TODO: weak
      \magicalcf{Dgn}[3]{Draconic Flight} Your wings grow larger, improving your ability to fly.
      Your maximum height increases to 15 feet.
