...
\sectiongraphic*{Weapons}{width=\columnwidth}{equipment/weapons}
  ...
  \subsection{Weapon Groups}\label{Weapon Groups}
    ...
    Proficiency with a weapon group does not grant you proficiency with exotic weapons from that group.
    ...
    \begin{longcolumn}
      \begin{longtablewrapper}
        ...
        \begin{longtable}{p{12em} l l l >{\lcol}p{24em}}
          ...
          Armor weapons                     &               &             &                             &                                                            \\
          \tind Armor spikes\fn{2}          & \tdash        & 1d4         & \tdash                      & \tdash                                                     \\
          \tind Standard shield             & \plus0        & 1d4         & 0 (10 gp)                   & \tdash                                                     \\
          \tind Spiked shield               & \plus0        & 1d6         & 1 (40 gp)                   & \tdash                                                     \\
          ...
          \tind Sling bullets (20)          & \tdash        & \tdash      & 0 (2 gp)                    & Ammunition                                                 \\
          \tind Throwing axe                & \plus0        & 1d8         & 0 (10 gp)                   & Thrown (30/60)                                             \\
        \end{longtable}
    ...
    \begin{longcolumn}
      \begin{longtablewrapper}
        ...
        \begin{longtable}{p{12em} l l l >{\lcol}p{24em}}
          ...
          Armor                          &               &             &                             &                                    \\
          \tind Armblade\fn{2}           & \plus1        & 1d4         & 1 (40 gp)                   & Grappling, Keen, Light             \\
          \tind Spiked knee\fn{2}        & \plus0        & 1d4         & 1 (40 gp)                   & Grappling, Impact, Light           \\
          \tind Tower shield             & \plus0        & 1d8         & 1 (40 gp)                   & Heavy                              \\
          \tind Spiked tower shield      & \plus0        & 1d10        & 1 (40 gp)                   & Heavy                              \\
          Axes                           &               &             &                             &                                    \\
          ...
          \tind Pellet crossbow\fn{3}    & \plus1        & 1d4         & 2 (200 gp)                  & Projectile (120/360)               \\
  ...
  \subsection{Weapon Special Materials}\label{Weapon Special Materials}
    ...
    \subsubsection{Weapon Special Material Prices}
      ...
      \parhead{Dragonfang} Attacks with a dragonfang weapon have that dragon's associated tag (see \tref{Dragon Types}).

      \parhead{Dragonfang, Ancient} Attacks with an ancient dragonfang weapon have that dragon's associated tag (see \tref{Dragon Types}).
