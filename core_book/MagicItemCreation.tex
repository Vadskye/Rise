...
\subsubsection{Using Spells}
    ...
    The spell used can have additional tags or schools. For example, \spell{fireball} also has the \glossterm{Destructive} tag, but it can still be used to craft a \mitem{flaming} weapon.

    Some magic items are more complex, requiring multiple schools or tags. You must meet all requirements for the item to craft it. It may be impossible to craft complex items without the Enchantment Admixture feat, allowing you to use multiple spells to craft an item (see page \featpref{Enchantment Admixture}.
...
\subsubsection{Crafting}
    ...
    In addition, you must know how to create items with all tags present on the item (see \pcref{Craft Magic Item}).
    You can learn additional tags with the Expanded Crafting Knowledge feat (see page \featpref{Expanded Crafting Knowledge}).
