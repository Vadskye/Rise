...
\section{Spell and Ritual Mechanics}\label{Spell and Ritual Mechanics}
    ...
    \subsection{Concentration}\label{Concentration}
        ...
        If you are distracted while using a spell or ritual, you may have to make a \glossterm{concentration} check to maintain your focus.
        ...
        Failure generally means you \glossterm{miscast} the spell or ritual (see Miscasting, below).
    ...
    \subsection{Miscasting}\label{Miscasting}
        ...
        \parhead{Impossible Spells and Rituals} Whenever you try to use a spell or ritual in an impossible way, the ability is \glossterm{miscast} instead.
    ...
    \subsection{Focused and Defensive Casting}\label{Focused and Defensive Casting}
        ...
        Whenever you use a spell or ritual, you choose whether to use \glossterm{focused casting} or \glossterm{defensive casting}.
    ...
    \subsection{Augments}\label{Augments}
        ...
        \subsubsection{Augment Descriptions}\label{Augment Descriptions}
            ...
            % TODO: Too weak at 2? Also, touch range doesn't really exist
            ...
            \augment{2}{Intensified} The damage inflicted and healing granted by the ability increases by \plus1d.
            This augment can be applied multiple times.
            Its effects stack.
...
\section{Spells}\label{Spells}
    ...
    \subsection{Cantrips}\label{Cantrips}
        ...
        Cantrips are considered to be 1st level spells for the purpose of abilities that care about spell level, such as \glossterm{augments}.
