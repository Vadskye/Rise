...
\rankline
\rank{4} On a \glossterm{crital hit}, the target is \glossterm{nauseated} instead of sickened.
\rank{6} The target is \glossterm{nauseated} instead of sickened. On a \glossterm{critical hit}, it is \glossterm{paralyzed} instead of nauseated.
...
\rank{6} The ability can also target you.
...
\rankline
\rank{4} This ability lasts until the end of the next round.
\rank{6} You can also negate a condition that would be applied to you.
\rank{8} You are also immune to conditions.
...
\rankline
\rank{4} On a \glossterm{critical hit}, the target is \glossterm{frightened} instead of shaken.
\rank{6} The target is frightened instead of shaken. On a \glossterm{critical hit}, it is \glossterm{panicked} instead of frightened.
\rank{8} The target is \glossterm{panicked} instead of frightened.
...
\rankline
\rank{4} On a \glossterm{critical hit}, the target is \glossterm{immobilized} instead of slowed.
\rank{6} The target is \glossterm{immobilized} instead of slowed. On a \glossterm{critical hit}, it is \glossterm{paralyzed} instead of immobilized.
\rank{8} The target is \glossterm{paralyzed} instead of immobilized.
...
\rankline
\rank{4} You gain a \plus1d bonus to damage with the strike.
\rank{6} On a \glossterm{critical hit}, the target is \glossterm{stunned} instead of dazed.
\rank{8} The target is stunned instead of dazed.
\parhead{Lists} Esoteric, Trick
\end{freeability}
\vspace{0.25em}
...
\rankline
\rank{4} You gain a \plus1 bonus to \glossterm{accuracy} with the strike.
\rank{6} On a \glossterm{critical hit}, the target is \glossterm{paralyzed} instead of nauseated.
\rank{8} The target is \glossterm{paralyzed} instead of nauseated.
...
\rank{6} The ability can also target you.
\rank{8} The area increses to \areahuge.
\parhead{Lists} Martial
\end{freeability}
\vspace{0.25em}
...
\rankline
\rank{4} Each struck target is \glossterm{deafened} as a \glossterm{condition}.
\rank{6} You gain a \plus1d bonus to damage.
\rank{8} The area increases to \arealarge.
\parhead{Lists} Primal
\end{freeability}
\vspace{0.25em}
