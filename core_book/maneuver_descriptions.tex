...
\begin{apability}{\hypertarget{maneuver:Agonizing Strike}{Agonizing Strike}}[\glossterm{Emotion}]
...
\begin{apability}{\hypertarget{maneuver:Daunting Blow}{Daunting Blow}}[\glossterm{Emotion}]
Make a \glossterm{strike} with a \plus1 bonus to \glossterm{accuracy}.
If the attack result hits the target's Mental defense,
...
\begin{apability}{\hypertarget{maneuver:Demoralizing Shout}{Demoralizing Shout}}[\glossterm{Emotion}]
...
\begin{apability}{\hypertarget{maneuver:Head Shot}{Head Shot}}[\glossterm{Emotion}]
