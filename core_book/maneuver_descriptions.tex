...
\rankline
\rank{4} The ability gains the \glossterm{Swift} tag, allowing it to increase your \glossterm{wound threshold} against attacks in the current phase.
\rank{6} You can use the ability twice between \glossterm{short rests}.
\rank{8} You remove an additional point of \glossterm{fatigue}.
\parhead{Lists} Esoteric, Primal, Wild
\end{freeability}
\vspace{0.25em}
