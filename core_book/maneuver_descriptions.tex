...
\rankline
\rank{4} The ability can also affect you.
\rank{6} Each target may either remove a point of \glossterm{fatigue} or remove a \glossterm{condition}.
\rank{8} Each target may both remove a point of \glossterm{fatigue} and remove a \glossterm{condition}.
...
\rank{8} The accuracy penalty is removed.
\parhead{Lists} Esoteric, Martial, Primal, Trick, Wild
\end{apability}
\vspace{0.25em}
...
\rankline
\rank{4} The damage penalty is reduced to \minus1d.
