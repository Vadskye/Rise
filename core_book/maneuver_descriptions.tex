...
\rankline
\rank{4} The target is \glossterm{nauseated} instead of sickened.
\rank{6} On a \glossterm{critical hit}, the target is is \glossterm{paralyzed} instead of nauseated.
...
Each target heals hit points equal to \glossterm{standard damage} \minus2d.
...
\rank{6} You also gain the damage bonus if the target attacked you in the previous round.
...
\rankline
\rank{4} The target is \glossterm{frightened} instead of shaken.
\rank{6} On a critical hit, the target is \glossterm{panicked} instead of frightened.
...
\rankline
\rank{4} Each target is \glossterm{frightened} instead of shaken.
\rank{6} The area increases to a \arealarge radius from you.
\rank{8} You gain a \plus2 bonus to \glossterm{accuracy} with the attack.
\parhead{Lists} Primal
\end{freeability}
\vspace{0.25em}
...
\rank{6} The area increses to a \arealarge radius from you.
