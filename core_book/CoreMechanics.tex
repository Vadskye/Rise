    ...
    \subsection{Phases}\label{Phases}
        ...
        \subsubsection{Triggered Ability Timing}\label{Triggered Ability Timing}
            ...
            \begin{itemize}
                \item Start of round
                    \begin{itemize}
                        \item Recalculate \glossterm{wound thresholds}
                    \end{itemize}
...
\section{Character Statistics}
    ...
    \subsection{Attributes}\label{Attributes}
        ...
        \subsubsection{Attribute Descriptions}
            ...
            \parhead{Constitution (Con)}\label{Constitution}
                ...
                If you have a high Constitution, you can use it to determine your \glossterm{fatigue threshold} (see \pcref{Fatigue Threshold}).
    ...
    \subsection{Taking Damage}\label{Taking Damage}
        ...
        \subsubsection{Fatigue Threshold}\label{Fatigue Threshold}
            ...
            When you take at least as much damage as your \glossterm{fatigue threshold} from a single damage roll, but less damage than your \glossterm{wound threshold}, you gain a point of \glossterm{fatigue}.
            Each point of fatigue lowers your \glossterm{wound threshold} (see below).

            \parhead{Missing Fatigue Thresholds} Objects do not generally have a \glossterm{fatigue threshold}.
            Instead, objects have a \glossterm{hardness} that serves a similar purpose (see \pcref{Hardness}).
            An object or creature without a listed \glossterm{fatigue threshold} gains a point of fatigue if it takes at least 1 damage from a single damage roll.
            It effectively has a \glossterm{fatigue threshold} of 1.

            \parhead{Minimum Fatigue Threshold} No effect can reduce a creature's \glossterm{fatigue threshold} below 1.
        ...
        \subsubsection{Wound Threshold}\label{Wound Threshold}
            ...
            It is normally equal to (your level \add 1) \x (5 \add your starting Constitution).
            Being fatigued from the current combat or exhausted from lack of rest makes you more vulnerable to serious wounds.
            For every point of \glossterm{fatigue} or \glossterm{exhaustion} that you have, you take a penalty to your \glossterm{wound threshold} equal to your level.
            ...
            When you gain or remove \glossterm{fatigue} or \glossterm{exhaustion} during a round, your \glossterm{wound threshold} is not normally recalculated until the start of the next round.
            If you use the \textit{recover} ability, it will recalculate immediately (see \pcref{Recover}).

            \parhead{Zero Wound Threshold}
            If your \glossterm{wound threshold} is reduced to 0, you gain a \glossterm{vital wound}.
            This can be caused by effects that inflict \glossterm{fatigue} without dealing damage.
            If that \glossterm{vital wound} gets a \glossterm{wound roll} less than 0, treat the roll as a 0, causing you to fall unconscious until the \glossterm{vital wound} is removed.
...
\section{Movement and Positioning}\label{Movement and Positioning}
    ...
    \subsection{Movement Abilities}\label{Movement Abilities}
        ...
        \begin{freeability}{\labeltext{Sprint}}
            ...
            % TODO: prevent infinite sprinting at 0 HP
...
\section{Universal Abilities}\label{Universal Abilities}
    ...
    \subsection{Special Combat Abilities}\label{Special Combat Abilities}
        ...
        \begin{apability}{\labeltext{Charge}}
            When you use this ability, you gain a point of \glossterm{fatigue}.
        ...
        \begin{apability}{\labeltext{Recover}}[\glossterm{Swift}]
            You remove all of your \glossterm{fatigue}.
            In addition, your \glossterm{wound threshold} changes to match your new fatigue level.
            Because this ability has the \glossterm{Swift} tag, this can increase your \glossterm{wound threshold} against attacks made against you during the current phase.
        \end{apability}
...
\section{Daily Resources}
    ...
    \subsection{Resting}\label{Resting}
        ...
        \subsubsection{Short Rest}\label{Short Rest}
            ...
            \begin{itemize}
                \item You remove all points of \glossterm{fatigue}.
