...
\section{Standard Abilities}
    ...
    \subsection{Darkvision}\label{Darkvision} A creature with darkvision can see perfectly in complete darkness.
        Darkvision always has a specific range limit.
        Beyond that range, darkvision provides no benefit.
