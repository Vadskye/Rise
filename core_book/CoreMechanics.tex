    ...
    \subsection{Attribute Descriptions}
        ...
        \parhead{Dexterity (Dex)}\label{Dexterity}
        {
            ...
            \begin{itemize}
                ...
                \item You apply your base Dexterity as a bonus or penalty to Dexterity-based \glossterm{skills}: Balance, Flexibility, Ride, Sleight of Hand, and Stealth (see \pcref{Skills}).
