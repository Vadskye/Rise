...
\section{Damage}\label{Damage}
    ...
    When you would be dealt damage, you first reduce your \glossterm{damage resistance} (see \pcref{Damage Resistance}).
    ...
    \subsection{Damage Types}\label{Damage Types}
        ...
        \subsubsection{Multiple Damage Types}\label{Multiple Damage Types}
            ...
            Defensive abilities such as being \glossterm{impervious} or immune to damage apply only if they apply to all damage types dealt by the attack.
    ...
    \subsection{Attribute Descriptions}
        ...
        \parhead{Constitution (Con)}\label{Constitution}
        {
            ...
            \begin{itemize}
                ...
                \item You gain a bonus (or penalty) to your \glossterm{damage resistance} equal to half your Constitution (see \pcref{Damage Resistance}).
...
\section{Character Statistics}
    ...
    \subsection{Damage Resistance}\label{Damage Resistance}
        ...
        In general, it is impossible to determine whether a creature has resistances simply by observing them unless there are obvious visual cues like body armor.
