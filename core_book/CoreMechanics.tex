...
\section{Attacks and Checks}\label{Attacks and Checks}
    ...
    \subsection{Attack Rolls}
        ...
        \subsubsection{Critical Success}
            ...
            For example, \glossterm{strikes} deal double damage when you get a critical success.
...
\section{Attributes}
    ...
    \subsection{Attribute Descriptions}
        ...
        \subsubsection{Strength (Str)}\label{Strength}
            ...
            \begin{itemize}
                \item Your \glossterm{accuracy} with \glossterm{strikes} using \glossterm{light weapons} (see \pcref{Strike Accuracy}).
                \item Your damage with \glossterm{strikes} (see \pcref{Strike Damage}).
        ...
        \subsubsection{Dexterity (Dex)}\label{Dexterity}
            ...
            It has the following effects:
            \begin{itemize}
                \item Dexterity affects Dexterity-based skills: Acrobatics, Escape Artist, Ride, Sleight of Hand, and Stealth skill checks (see \pcref{Skills}).
        ...
        \subsubsection{Intelligence (Int)}\label{Intelligence}
            ...
            \begin{itemize}
                ...
                \item You gain extra skill points equal to your starting Intelligence (see \pcref{Skill Points}).
                \item Your Intelligence affects Intelligence-based skills: Craft, Disguise, Heal, Knowledge, and Linguistics skill checks (see \pcref{Skills}).
        ...
        \subsubsection{Perception (Per)}\label{Perception}
            ...
            It has the following effects:
            \begin{itemize}
                \item Your Perception affects Perception-based skills: Awareness, Creature Handling, Sense Motive, Spellcraft, and Survival skill checks (see \pcref{Skills}).
            ...
            \begin{itemize}
                \item Your \glossterm{accuracy} with \glossterm{strikes} (see \pcref{Strike Accuracy}).
        ...
        \subsubsection{Willpower (Wil)}\label{Willpower}
            ...
            It has the following effects:
            \begin{itemize}
                \item You gain additional \glossterm{action points} equal to your starting Willpower.
            \end{itemize}
...
\section{Character Statistics}
    ...
    \subsection{Accuracy}\label{Accuracy}
        ...
        \subsubsection{Strike Accuracy}\label{Strike Accuracy}
            Your accuracy with a \glossterm{strike} is normally equal to the higher of your level and your Perception.
    ...
    \subsection{Damage}\label{Damage}
        ...
        \subsubsection{Ability Damage}
            Your damage dice with an \glossterm{ability} are based on the damage dice defined in the ability's description.
            Most abilities gain a \plus1d bonus to damage for every 2 \glossterm{power} you have with the ability.
        ...
        \subsubsection{Defense Values}\label{Defense Values}
            ...
            \begin{dtable!*}
                ...
                \begin{dtabularx}{\textwidth}{l l l l l >{\lcol}X}
                    \tb{Defense Name} & \tb{Base Defense Bonus} & \tb{Attributes} & \tb{Body Armor Modifier} & \tb{Shield Modifier} & \tb{Size Modifier} \\
                    \midrule
...
\section{Special Rules}
    ...
    \subsection{Combat Maneuvers}\label{Combat Maneuvers}
        ...
        \parhead{Light Maneuvers} You can use a light maneuver as a standard action.
        Before applying bonuses and penalties, your accuracy with a light maneuver is equal to your normal accuracy with strikes (see \pcref{Strike Accuracy}).
        A light maneuver is treated as a \glossterm{light weapon} for the purpose of determining your accuracy.
    ...
    \subsection{Dual Strikes}\label{Dual Strikes}
        If you are wielding two weapons at once, you can attack with both weapons whenever you make a \glossterm{strike}.
        This is called a \glossterm{dual strike}.
        When you make a dual strike, roll the attack roll twice, once for each weapon.
        If you hit with one of the weapons, you deal damage with that weapon.
        If you hit with both, you choose which weapon to deal damage with.
        If you get a \glossterm{critical success}, you deal damage with both weapons, including all modifiers.
        ...
        \parhead{Weapon Size} Making dual strikes is easiest with light weapons. You take a \minus1 penalty to accuracy if you use a non-light weapon while fighting with two weapons, or a \minus2 penalty if neither weapon is light. This penalty does not apply if you alternate attacks between your weapons, instead of attacking with both at once.

        \parhead{Unarmed Attacks} Normally, you can't make unarmed attacks as if fighting with two weapons. However, a character with the Unarmed Fighting feat gains the ability to make dual strikes with their unarmed attacks (see \featpcref{Unarmed Fighting}).

        \parhead{Example} Felix the 1st-level fighter is wielding two short swords against an evil goblin.
        The goblin has an Armor defense of 5.
        Felix has a Dexterity of 2, and is proficient with his swords, so his accuracy is \plus2.
        If he attacks with both weapons at once, he takes no penalty to his accuracy, because both weapons are light.
        He makes one attack roll for his left short sword, and one for his right short sword.
        If he rolls a 3 or higher with either attack roll, he hits the goblin.
        Since both of his weapons are identical, there is usually no need to track exactly which short sword hits the goblin.
        His Strength is 2, so he rolls 1d8 damage for either weapon.
        If he rolled a 5, he would deal 5 damage.
