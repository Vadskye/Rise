...
\section{Combat Time}\label{Combat Time}
    ...
    \subsection{Phases}\label{Phases}
        ...
        \subsubsection{Triggered Ability Timing}\label{Triggered Ability Timing}
            ...
            Here is the order in which these abilities trigger each round:
            \begin{itemize}
                \item Start of round
...
\section{Character Statistics}
    ...
    \subsection{Taking Damage}\label{Taking Damage}
        ...
        \subsubsection{Wound Threshold}\label{Wound Threshold}
            ...
            For every point of \glossterm{fatigue} and \glossterm{exhaustion} that you have, you take a penalty to your \glossterm{wound threshold} equal to your level.
        ...
        \subsubsection{Vital Wounds}\label{Vital Wounds}
            ...
            To make a \glossterm{wound roll}, roll 1d10 \sub the number of \glossterm{vital wounds} you have \add your starting Constitution.
            ...
            \begin{dtable}
                ...
                \begin{dtabularx}{\textwidth}{l X}
                    ...
                    6 & You take a \minus2 penalty to all defenses \\
                    7 & You take a \minus2 penalty to \glossterm{accuracy} \\
                    8 & Your maximum \glossterm{recovery action points} are reduced by 1 \\
    ...
    \subsection{Special Combat Abilities}\label{Special Combat Abilities}
        ...
        \begin{dtable}
            ...
            \begin{dtabularx}{\columnwidth}{>{\lcol}p{6em} l X}
                ...
                Recover       & \tdash       & Regain an \glossterm{action point} or remove \glossterm{fatigue} \\
        ...
        \parhead{Recover} As a standard action, you can use the \textit{recover} ability to briefly rest.

        \begin{freeability}{\labeltext{Recover}}
            At the end of the round, if you did not take damage this round, you may regain one spent \glossterm{recovery action point} or remove a point of \glossterm{fatigue}.
...
\section{Character Advancement}\label{Character Advancement}
    ...
    \begin{dtable}
        ...
        3. You gain access to \glossterm{insight points} at this level. \\
