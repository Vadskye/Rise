...
\section{Spell and Ritual Mechanics}\label{Spell and Ritual Mechanics}
    ...
    \subsection{Spells and Rituals}
        ...
        Every spell requires no more than a standard action to cast, and they can be used without limit (other than ordinary physical exertion).
        Rituals are slow, and they always increase the \glossterm{fatigue level} of their participants by some amount (see \pcref{Performing Rituals}).
        ...
        Although they are similar, spells and rituals are not the same.
    ...
    \subsection{Learning Rituals}
        ...
        \begin{itemize}
            ...
            \item You treat the ritual as if it was one rank higher than its actual rank.
                This means you must have access to higher rank spells to perform it, and scribing the ritual requires more expensive magical inks (see \pcref{Scribing Rituals}).
