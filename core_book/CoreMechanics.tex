...
\section{Universal Abilities}
    ...
    \subsection{Reactive Movements}
        ...
        The two most common types of reactive movements are the \textit{block}, \textit{follow}, and \textit{withdraw} abilities, but you can come up with other reactive movements.
