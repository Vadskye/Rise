...
\section{Making Checks}\label{Checks}\label{Making Checks}
    ...
    \subsection{Group Checks}
        ...
        In addition, that character gains a \plus2 bonus if at least one other character got a check result that was no more than 5 points lower than the check's difficulty value.
