...
\section{Making Attacks}\label{Attacks}
    ...
    \subsection{Dealing Damage}\label{Dealing Damage}
        ...
        \subsubsection{Damage Dice}\label{Damage Dice}
        ...
        \parhead{Attribute Dice Increments} Your attributes can add or subtract dice increments from all damage dice you roll.
        Whenever you deal damage with a \glossterm{mundane} ability, you add half your Strength in dice increments to the damage dice.
        If your Strength is negative, this can reduce your damage.
        Likewise, you add half your Willpower in dice increments to your damage with \glossterm{magical} abilities.
