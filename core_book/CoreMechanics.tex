    ...
    \subsection{Attribute Descriptions}
        ...
        \parhead{Strength (Str)}\label{Strength}
        {
            ...
            \begin{itemize}
                ...
                \item You reduce your \glossterm{encumbrance} from \glossterm{body armor} by an amount equal to your base Strength (see \pcref{Encumbrance}).
            \end{itemize}
        }
        ...
        \parhead{Dexterity (Dex)}\label{Dexterity}
        {
            ...
            It has the following effects:
            \begin{itemize}
                \item You apply your base Dexterity as a bonus or penalty to Dexterity-based \glossterm{skills}: Acrobatics, Escape Artist, Ride, Sleight of Hand, and Stealth (see \pcref{Skills}).
        ...
        \parhead{Intelligence (Int)}\label{Intelligence}
        {
            ...
            \begin{itemize}
                \item You gain \glossterm{insight points} equal to your base Intelligence (see \pcref{Insight Points}).
                ...
                \item You apply your Intelligence as a bonus or penalty to Intelligence-based \glossterm{skills}: Craft, Deduction, Disguise, Heal, Knowledge, and Linguistics (see \pcref{Skills}).
        ...
        \parhead{Perception (Per)}\label{Perception}
        {
            ...
            It has the following effects:
            \begin{itemize}
                \item You apply your Perception as a bonus or penalty to Perception-based \glossterm{skills}: Awareness, Creature Handling, Sense Motive, Spellcraft, and Survival (see \pcref{Skills}).
...
\section{Taking Damage}\label{Taking Damage}
    ...
    Depending on the amount of damage you take, you may lose a \glossterm{hit point} or even gain a \glossterm{vital wound}.
    ...
    \subsection{Resistances}\label{Resistances}
        ...
        \subsubsection{Damage Resistance}\label{Damage Resistance}
            ...
            When an attack would deal damage to you, if the damage is less than your \glossterm{damage resistance}, you take no damage from the attack.
            ...
            It effectively has a \glossterm{damage resistance} of 1.

        \subsubsection{Wound Resistance}\label{Wound Resistance}
            Your \glossterm{wound resistance} measures your ability to avoid gaining \glossterm{vital wounds} from dangerous attacks.
            When you take damage from an attack, if the damage is at least as much as your \glossterm{wound resistance}, you gain a \glossterm{vital wound} (see \pcref{Vital Wounds}).

            Your \glossterm{wound resistance} is based on your level, as defined in \tref{Character Advancement}.
            Wearing \glossterm{armor} can increase your wound resistance against \glossterm{physical damage}, and some special abilities can also increase it.
    ...
    \subsection{Becoming Bloodied}\label{Becoming Bloodied}
        ...
        At the end of each round, if you have 3 or fewer \glossterm{hit points} remaining, you become \glossterm{bloodied}.
        Likewise, if you have 4 or more \glossterm{hit points}, you stop being \glossterm{bloodied}.

        While you are bloodied, your \glossterm{wound resistance} is halved, to a minimum of your \glossterm{damage resistance} for each corresponding type of damage.
        If your maximum hit points are 3 or fewer, you are always \glossterm{bloodied}.
    ...
    \subsection{Hit Points}\label{Hit Points}
        ...
        You normally have a number of \glossterm{hit points} equal to 5 \add your base Constitution.
    ...
    \subsection{Vital Wounds}\label{Vital Wounds}
        ...
        \subsubsection{Wound Roll}\label{Wound Roll}
            To make a \glossterm{wound roll}, roll 1d10 \sub the number of \glossterm{vital wounds} you already had, ignoring the vital wound you are rolling for.
            ...
            \begin{dtable}
                ...
                \begin{dtabularx}{\textwidth}{l X}
                    ...
                    0 & You are unconscious until you take a \glossterm{short rest} \\
                    ...
                    9 & You take a \minus2 penalty to Reflex defense \\
                    10 & You take a \minus1 penalty to future \glossterm{wound rolls} \\
...
\section{Circumstances, Bonuses, and Penalties}
    ...
    \subsection{Helpless Defenders}
        ...
        % because effects that prevent unawareness often shouldn't help helpless creatures.
...
\section{Ability Mechanics}\label{Ability Mechanics}
    ...
    \subsection{Sustained Abilities}\label{Sustained Abilities}
        ...
        Taking an action to a spell is not a \glossterm{Focus} ability.
    ...
    \subsection{Ability Tags}\label{Ability Tags}
        ...
        \par Any creature trained in Spellcraft can notice the sensor by making a \glossterm{difficulty rating} 20 Spellcraft check.
        ...
        Subtle spells can still be identified with the Spellcraft skill (see \pcref{Spellcraft}), but the \glossterm{difficulty rating} is 10 higher than normal.
...
\section{Universal Abilities}\label{Universal Abilities}
    ...
    \subsection{Strikes}\label{Strikes}
        ...
        \begin{freeability}{\labeltext{Melee Strike}}
            \target{One creature or object you \glossterm{threaten} (see text)}
            Choose one or two \glossterm{melee weapons} that you can attack with.
            You must be able to \glossterm{threaten} the target with all chosen weapons.
            ...
            If the target takes damage this way, it loses an additional \glossterm{hit point}.
        \end{freeability}
        ...
        \begin{freeability}{\labeltext{Projectile Strike}}
            ...
            Choose one or two \glossterm{projectile} weapons you can attack with.
            The target must be within ten \glossterm{range increments} of you with all chosen weapons.
            For each weapon, make a \glossterm{physical attack} with that weapon against the Armor defense of the target.
            The attack takes a \minus1 penalty to \glossterm{accuracy} for for each full \glossterm{range increment} between you and the target with that weapon.
        ...
        \begin{freeability}{\labeltext{Thrown Strike}}
            ...
            Choose one or two \glossterm{thrown weapons} you can attack with.
    ...
    \subsection{Special Combat Abilities}\label{Special Combat Abilities}
        ...
        \begin{dtable}
            ...
            \begin{dtabularx}{\columnwidth}{>{\lcol}p{6em} l X}
                ...
                Cleanse\fn{1}            & \tdash       & Quickly remove all \glossterm{conditions} \\
        ...
        \begin{apability}{\labeltext{Recover}}[\glossterm{Swift}]
            ...
            If this restores you to four or more \glossterm{hit points}, you immediately stop being \glossterm{bloodied}.
...
\section{Special Rules}
    ...
    \subsection{Encumbrance}\label{Encumbrance}
        ...
        In addition, you reduce your encumbrance from \glossterm{body armor} by an amount equal to your base Strength, to a minimum of 0.
    ...
    \subsection{Drowning}\label{Drowning}
        ...
        After that time, you must roll 1d10 at the end of each round that you continue holding your breath.
        This attack gains a \plus5 bonus for each round you hold your breath beyond your limit.
        If the result exceeds your Fortitude defense, you gain a \glossterm{vital wound}.
    ...
    \subsection{Resolving Ambiguity}\label{Resolving Ambiguity}
        ...
        For example, if an ability causes you to remove your most recent \glossterm{condition}, and two \glossterm{conditions} were applied to you in the same \glossterm{phase}, you choose which condition is removed.
...
\section{Character Advancement}\label{Character Advancement}
    ...
    \begin{dtable*}
        ...
        \begin{dtabularx}{\textwidth}{*{4}{>{\lcol}l} *{4}{>{\lcol}X}}
            \tb{Level} & \tb{DR}\fn{1} & \tb{WR}\fn{2} & \tb{XP} & \tb{Max Rank}\fn{3} & \tb{Legacy Item}\fn{4} & \tb{AP}\fn{5} \tableheaderrule
            % Damage doubles every 6 levels; anchor points are 4th, 10th, 16th
            1st     & 1  & 16  & 0      & 1      & \tdash & 3
            \\ 2nd  & 2  & 18  & 20     & 2      & \tdash & \tdash
            \\ 3rd  & 3  & 21  & 50     & \tdash & \tdash & \tdash
            \\ 4th  & 4  & 24  & 90     & \tdash & \tdash & 4
            \\ 5th  & 5  & 27  & 150    & 3      & \tdash & \tdash
            \\ 6th  & 6  & 30  & 230    & \tdash & 1      & \tdash
            \\ 7th  & 7  & 34  & 350    & \tdash & \tdash & 5
            \\ 8th  & 8  & 38  & 510    & 4      & \tdash & \tdash
            \\ 9th  & 10  & 43  & 750    & \tdash & \tdash & \tdash
            \\ 10th & 12 & 48  & 1,050  & \tdash & \tdash & 6
            \\ 11th & 14 & 54  & 1,550  & 5      & \tdash & \tdash
            \\ 12th & 16 & 61  & 2,200  & \tdash & 2      & \tdash
            \\ 13th & 18 & 69  & 3,150  & \tdash & \tdash & 7
            \\ 14th & 20 & 77  & 4,450  & 6      & \tdash & \tdash
            \\ 15th & 23 & 86  & 6,350  & \tdash & \tdash & \tdash
            \\ 16th & 26 & 96  & 8,900  & \tdash & \tdash & 8
            \\ 17th & 29 & 108 & 13,000 & 7      & \tdash & \tdash
            \\ 18th & 32 & 122 & 18,000 & \tdash & 3      & \tdash
            \\ 19th & 35 & 138 & 25,500 & \tdash & \tdash & 9
            \\ 20th & 38 & 154 & 36,000 & 8      & \tdash & \tdash
        \end{dtabularx}
