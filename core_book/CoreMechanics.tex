...
\section{Fatigue}\label{Fatigue}
    ...
    \subsection{Fatigue Points}\label{Fatigue Points}
        ...
        You take a penalty to \glossterm{accuracy}, \glossterm{checks}, and \glossterm{defenses} equal to the number of fatigue points you have \sub your base Constitution.
        ...
        Some abilities can modify your fatigue penalty.
...
\section{Universal Abilities}\label{Universal Abilities}
    ...
    \subsection{Special Combat Abilities}\label{Special Combat Abilities}
        ...
        \begin{freeability}{\labeltext{Desperate Exertion}}[\glossterm{Swift}]
            ...
            When you use this ability, after resolving the rerolled attack or check, you gain a \glossterm{fatigue point} (see \pcref{Fatigue}).
        \end{freeability}
