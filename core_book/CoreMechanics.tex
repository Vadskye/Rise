...
\section{Character Statistics}
    ...
    \subsection{Attributes}\label{Attributes}
        ...
        \subsubsection{Dexterity (Dex)}\label{Dexterity}
            ...
            \begin{itemize}
                \item Your \glossterm{accuracy} with melee and thrown \glossterm{strikes} using \glossterm{light weapons} (see \pcref{Physical Accuracy}).
...
\section{Special Rules}
    ...
    \subsection{Mounted Combat}\label{Mounted Combat}
        ...
        \parhead{Casting Spells while Mounted} You can cast a spell normally if your mount moves up to a normal move (its speed) either before or after you cast.
        If you have your mount move both before and after you cast a spell, then you're casting the spell while the mount is moving, and you have to make a Concentration check due to the vigorous motion (DR 5 \add double spell level) or lose the spell.
        If the mount is sprinting, you take a \minus4 penalty to the check due to the violent motion.
