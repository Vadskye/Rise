...
\section{Damage}\label{Damage}
    ...
    \subsection{Vital Wounds}\label{Vital Wounds}
        ...
        \subsubsection{Vital Threshold}\label{Vital Threshold}
            ...
            If you lose at least as many hit points as your vital threshold from a single damage roll, you gain a \glossterm{vital wound}.
...
\section{Movement and Positioning}\label{Movement and Positioning}
    ...
    \subsection{Flying Mechanics}
        A creature with a fly speed cannot fly while it has \glossterm{encumbrance}, either from armor or from carrying weight in excess of its maximum carrying capacity (see \pcref{Carrying Capacity}).
...
\section{Universal Abilities}\label{Universal Abilities}
    ...
    \subsection{Special Combat Abilities}\label{Special Combat Abilities}
        ...
        If you do, you take a \minus20 penalty to the check.
        ...
        \begin{freeability}{\labeltext{Throw}}
            ...
            In addition, if the object's weight exceeds your light carrying capacity, you take a \minus10 penalty with the check (see \pcref{Carrying Capacity}).
    ...
    \subsection{Grappling}\label{Grappling}
        ...
        \subsubsection{Grapple Actions}\label{Grapple Actions}
            ...
            \begin{freeability}{Pin}
                ...
                If you have restraints in hand, you can use them to bind the creature, and this ability lasts until it breaks or escapes those restraints.
...
\section{Special Rules}
    ...
    \subsection{Teleportation}\label{Teleportation}
        ...
        Unless an ability specifies otherwise, anything being teleported must have both \glossterm{line of sight} and \glossterm{line of effect} to its destination.
...
\section{Character Advancement}\label{Character Advancement}
    ...
    \begin{dtable}
        ...
        \begin{dtabularx}{\columnwidth}{l >{\lcol}X l l >{\lcol}X l l}
            ...
            3rd        & \tdash              & 13      & 3                      & 1                      & 3             & 50     \\
            4th        & 2                   & 15      & 3                      & \tdash                 & 4             & 90     \\
            5th        & \tdash              & 17      & 4                      & \tdash                 & 5             & 150    \\
