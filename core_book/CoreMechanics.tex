    ...
    \subsection{Creating Poisons}\label{Creating Poisons}
        ...
        \begin{itemize}
            ...
            \itemhead{Alchemical} Alchemical poisons require alchemical materials.
                ...
                In unusual circumstances, these components can be synthesized from natural chemicals or magical materials with a Craft (alchemy) check equal to 10 \add twice the poison's \glossterm{rank}.
        \end{itemize}
