...
\section{Universal Abilities}\label{Universal Abilities}
    ...
    \subsection{Special Combat Abilities}\label{Special Combat Abilities}
        ...
        \begin{apability}{\labeltext{Desperate Exertion}}[\glossterm{Swift}]
            You reroll any \glossterm{attack} or \glossterm{check} you just made.
        \end{apability}
...
\section{Legend Points}\label{Legend Points}
    At 5th level, you gain a limited ability to change your fate with \glossterm{legend points}.
...
\section{Character Advancement}\label{Character Advancement}
    ...
    \begin{itemize}
        ...
        \item At 5th level, you gain access to \glossterm{legend points}.
    \end{itemize}
