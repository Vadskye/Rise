...
\section{Character Statistics}
    ...
    \subsection{Insight Points}\label{Insight Points}
        You can learn new special abilities by spending \glossterm{insight points}.
        Every class has at least one way to spend \glossterm{insight points} to learn additional abilities.
        The list of ways to spend \glossterm{insight points} is given below.
        \begin{itemize}
        ...
        \end{itemize}
        In addition, you can spend an \glossterm{insight point} to gain two skill points.

        A typical 1st level character has one \glossterm{insight point}.
        You can gain additional \glossterm{insight points} with a high Intelligence, and some abilities can also grant insight points.
    ...
    \subsection{Attributes}\label{Attributes}
        ...
        \subsubsection{Intelligence (Int)}\label{Intelligence}
            ...
            \begin{itemize}
                ...
                \item If your starting Intelligence is negative, you lose \glossterm{insight points} equal to your starting Intelligence, and you lose skill points equal to twice your starting Intelligence.
...
\section{Character Advancement}\label{Character Advancement}
    ...
    \begin{itemize}
        ...
        \item At 7th, 13th, and 19th level, you gain an additional \glossterm{recovery action point}.
    \end{itemize}

    \begin{dtable}
        \lcaption{Character Advancement}
        \begin{dtabularx}{\columnwidth}{*{3}{>{\lcol}l} *{4}{>{\lcol}X}}
            \tb{Level} & \tb{XP} & \tb{Feats} & \tb{Item Slots} & \tb{Legacy Item}\fn{1} & \tb{Recovery AP}
            \\\bottomrule
            1st          & 0      & \tdash\fn{2}& 1 & \tdash & 3
            \\ 2nd       & 20     & 1      & \tdash & \tdash & \tdash
            \\ 3rd\fn{3} & 50     & \tdash & 2      & \tdash & \tdash
        ...
        2. All species grant a bonus feat at 1st level. The feat must be chosen from a specific list of racial bonus feats (see \pcref{Species}). \\
