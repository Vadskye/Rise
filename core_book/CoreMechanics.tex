...
\section{Taking Damage}\label{Taking Damage}
    ...
    \subsection{Vital Wounds}\label{Vital Wounds}
        ...
        \subsubsection{Vital Roll}\label{Vital Roll}
            ...
            \parhead{Changing Vital Rolls}
            Some effects can change the \glossterm{vital roll} for \glossterm{vital wounds} you have already suffered.
            If your \glossterm{vital roll} changes retroactively, it changes the effect of that \glossterm{vital wound}.
