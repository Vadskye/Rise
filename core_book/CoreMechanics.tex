...
\section{Movement and Positioning}\label{Movement and Positioning}
    ...
    \subsection{Movement Abilities}\label{Movement Abilities}
        ...
        \begin{freeability}{\labeltext{Sprint}}[\glossterm{Swift}]
    ...
    \subsection{Movement Impediments}
        ...
        \parhead{Undergrowth} Vines, roots, and short bushes are common in forested areas.
...
\section{Ability Mechanics}\label{Ability Mechanics}
    ...
    \subsection{Ability Tags}\label{Ability Tags}
        ...
        A creature killed by a Death effect cannot be returned to life by the \spell{resurrection} ritual or similar abilities that depend on an intact corpse.
...
\section{Universal Abilities}\label{Universal Abilities}
    ...
    \subsection{Special Combat Abilities}\label{Special Combat Abilities}
        ...
        \begin{freeability}{\labeltext{Desperate Recovery}}
        ...
        \parhead{Recover} You can use the \textit{recover} ability as a \glossterm{minor action}.
        As long as you are conscious, no effect can prevent you from using this ability, even effects that prohibit using any other abilities.
        \begin{apability}{\labeltext{Recover}}
    ...
    \subsection{Grappling}\label{Grappling}
        ...
        \subsubsection{Being In A Grapple}
            ...
            \begin{itemize}
                ...
                \item Spellcasting is extremely difficult. You cannot cast \glossterm{spells} or perform \glossterm{rituals} with somatic components.
