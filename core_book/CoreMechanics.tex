...
\section{Planes}\label{Planes}
    ...
    \subsection{General Cosmology}
        ...
        These are only broad descriptions that describe the typical appearance of each aligned plane.
        They are all subdivided into layers and independent regions that have unique characteristics and magical phenomena.
        In addition, powerful deities can claim territory in aligned planes to reshape it according to their desires.
