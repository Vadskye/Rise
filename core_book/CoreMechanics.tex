...
\section{Universal Abilities}
    ...
    \subsection{Combat Maneuvers}\label{Combat Maneuvers}
        ...
        \subsubsection{Maneuver Descriptions}
            ...
            \begin{ability}{Feint}\label{Feint}
                You can use this ability during the \glossterm{action phase} to make a fake attack to leave your foe off-balance.
            ...
            \begin{ability}{Grapple}\label{Grapple}
                ...
                On a hit against both defenses, you and the target are \grappled.
    ...
    \subsection{Special Combat Abilities}
        ...
        \begin{ability}{\labeltext{Charge}}
            As a \glossterm{standard action} during the \glossterm{action phase}, you can spend an \glossterm{action point} to use this ability.
    ...
    \subsection{Special Movement Abilities}
        ...
        \begin{ability}{\labeltext{Overrun}}
            At the start of the \glossterm{movement phase}, you can spend an \glossterm{action point} to use this ability.
    ...
    \subsection{Reactive Movement Abilities}

        All creatures can use reactive movement abilities to move automatically in response to the movement of other creatures.
        ...
        \begin{ability}{\labeltext{Block}}
            At the start of each phase, you can use this ability.
        ...
        \begin{ability}{\labeltext{Follow}}
            ...
            When you do, you automatically move such that your distance to the target is no greater than your desired follow distance. For the rest of the round, whenever that creature or object moves, you move with it to stay within that follow distance.
            If the target takes an action that makes it impossible to follow with movement, such as teleporting, you cannot follow it for the rest of the current phase.
        \end{ability}
