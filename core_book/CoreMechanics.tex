...
\section{Combat Overview}
    ...
    \subsection{Special Actions}
        ...
        As a standard action, you can spend an \glossterm{action point} to revitalize yourself.
    ...
    \subsection{Attribute Descriptions}
        ...
        \subsubsection{Intelligence (Int)}\label{Intelligence}
            ...
            \begin{itemize}
                ...
                \item For every 5 Intelligence you have, you gain an additional \glossterm{action point}.
                    If your Intelligence is negative, you lose action points equal to half your Intelligence.
...
\section{Character Statistics}
    ...
    \subsection{Damage}\label{Damage}
        ...
        \subsubsection{Standard Damage}\label{Standard Damage}
            ...
            Other abilities, such as Strength or Willpower, can modify abilities that deal standard damage as normal.
...
\section{Injury, Death, and Healing}\label{Injury, Death, and Healing}
    ...
    \subsection{Hit Points}\label{Hit Points}
        ...
        \begin{figure}[h]
            \centering Fortitude or Mental defense \add Constitution \add 5 \x level
        \end{figure}
    ...
    \subsection{Vital Damage}\label{Vital Damage}
        ...
        While you have vital damage, magical healing which would normally restore hit points cannot restore your hit points, though it can stabilize you, preventing you from dying.
    ...
    \subsection{Stages of Injury}
        ...
        No bonuses or penalties apply to the roll, but \glossterm{vital damage} can penalize your Fortitude defense.
...
\section{Daily Resources}
    ...
    \subsection{Action Points}\label{Action Points}
        \glossterm{Action points} allow you to perform special actions that your character has access to.
        You have one action point at 1st level.
        At 3rd level, and every odd level thereafter, you gain an additional action point.
        You can gain additional action points from your \glossterm{base class}, from your Intelligence, and from some special abilities.
        After a \glossterm{short rest}, you regain all action points you spent since your last rest, up to a maximum equal to half of your maximum action points (minimum 1).
...
\section{Character Advancement}\label{Character Advancement}
    ...
    \begin{itemize}
        ...
        \item At 1st level, and every 4 levels thereafter, you gain an \glossterm{action point}.
