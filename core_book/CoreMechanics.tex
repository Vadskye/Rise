...
\section{Character Statistics}
    ...
    \subsection{Insight Points}\label{Insight Points}
        ...
        In addition, you can spend \glossterm{insight points} on spells from the Spellwarped feat (see \featpcref{Spellwarped}).
...
\section{Universal Abilities}\label{Universal Abilities}
    ...
    \subsection{Strikes}\label{Strikes}
        ...
        \subsubsection{Strike Damage}\label{Strike Damage}
            The damage you deal with a single \glossterm{strike} is equal to \glossterm{standard damage} based on your \glossterm{power} with \glossterm{mundane} abilities plus that weapon's damage modifier, if any (see \tref{Weapons}).
            For example, if you had a \glossterm{power} of 4, your base damage on a strike would be 2d6.
...
\section{Character Advancement}\label{Character Advancement}
    ...
    \begin{dtable}
        ...
        2. All species grant a bonus feat at 1st level. The feat must be chosen from a specific list of bonus feats unique to that species (see \pcref{Species Bonus Feats}). \\
