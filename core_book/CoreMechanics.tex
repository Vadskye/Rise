...
\section{Taking Damage}\label{Taking Damage}
    ...
    \subsection{Subdual Damage}\label{Subdual Damage}
        ...
        First, if a creature would take \glossterm{subdual damage} that is less than its \glossterm{wound resistance}, it does not take the damage and does not lose any \glossterm{hit points}.
        Second, \glossterm{vital wounds} from subdual damage cannot kill.
