...
\section{Injury, Death, and Healing}\label{Injury, Death, and Healing}
    ...
    \subsection{Vital Damage}\label{Vital Damage}
        ...
        You suffer a penalty to \glossterm{accuracy}, \glossterm{checks}, and \glossterm{defenses} equal to the amount of vital damage you have.

        You can still receive healing that restores your hit points while you have taken vital damage.
        If you take damage in excess of your hit points while you have any vital damage, any excess damage from the attack is dealt directly as vital damage.
