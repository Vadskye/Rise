...
\section{Combat Time}\label{Actions}
    ...
    \subsection{Phases}\label{Phases}
        ...
        \subsubsection{The Action Phase}\label{The Action Phase}
            During the \glossterm{action phase}, you can take one \glossterm{minor action} and your choice of a \glossterm{standard action}, a \glossterm{move action}, or an additional \glossterm{minor action}.
        ...
        \subsubsection{The Delayed Action Phase}\label{The Delayed Action Phase}
            During the \glossterm{delayed action phase}, you can take any actions that you delayed with the \textit{delay} ability (see \pcref{Delay}).
    ...
    \subsection{Resolving Actions}\label{Resolving Actions}
        ...
        \begin{enumerate*}
            ...
            \item Apply the effects of \glossterm{swift abilities}.
...
\section{Character Statistics}
    ...
    \subsection{Size in Combat}\label{Size in Combat}
        ...
        \begin{dtable*}
            ...
            \begin{dtabularx}{\textwidth}{l l l l l l l p{5.5em} X}
                \tb{Size} & \tb{Space}\fn{1} & \tb{Reach}\fn{1} & \tb{Base Speed} & \tb{Reflex Modifier} & \tb{Damage Modifier}\fn{2} & \tb{Threat Value}\fn{3} & \tb{Overwhelm Resistance}\fn{4} & \tb{Example Creature} \\
                \bottomrule
        ...
        \subsubsection{Reach}\label{Reach}
            ...
            The area within a creature's reach is called its \glossterm{threatened area}, and creatures within that area are considered \glossterm{threatened}.
...
\section{Movement and Positioning}\label{Movement and Positioning}
    ...
    \subsection{Movement Abilities}
        ...
        Unless otherwise noted, all movement abilities 
            to your maximum distance with any \glossterm{movement mode} you have towards that location.

        \begin{ability}{Hustle}
            As a \glossterm{move action}, you can use this ability.
...
\section{Universal Abilities}
    ...
    \subsection{Special Combat Abilities}
        ...
        \begin{ability}{\labeltext{Delay}}
            As a \glossterm{minor action} or \glossterm{standard action} during the \glossterm{action phase}, you can use this ability.
            If you do, you can take an action of the same type during the \glossterm{delayed action phase}.
        \end{ability}
