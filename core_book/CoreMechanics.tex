    ...
    \subsection{Vital Wounds}\label{Vital Wounds}
        ...
        \begin{dtable}
            ...
            \begin{dtabularx}{\textwidth}{l X}
                ...
                2 & Your maximum \glossterm{recovery action points} are reduced by 2 \\
                3 & You move at half speed (minimum 5 ft.) \\
                % TODO: clarify that if you remove this wound on a long rest, you also remove the exhaustion in the same rest
                4 & You gain a point of \glossterm{exhaustion} that cannot be removed \\
                5 & Your maximum \glossterm{reserve action points} are reduced by 2 \\
                6 & You take a \minus2 penalty to \glossterm{accuracy} \\
                7 & Your maximum \glossterm{recovery action points} are reduced by 1 \\
                8 & You take a \minus4 penalty to all skills \\
                9 & You take a \minus2 penalty to Fortitude and Mental defenses \\
