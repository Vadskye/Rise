...
\section{Character Advancement}\label{Character Advancement}
    ...
    \begin{itemize}
        ...
        \item At 1st level, you start with two \glossterm{item slots} (see \pcref{Item Slots}). At 5th level, and every 4 levels thereafter, you gain an additional \glossterm{item slot}.
        \item At 2nd level, and every 4 levels thereafter, you gain an \glossterm{action point} (see \pcref{Action Points}).
