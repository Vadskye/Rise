...
\section{Character Statistics}
    ...
    \subsection{Damage}\label{Damage}
        ...
        \subsubsection{Standard Damage}\label{Standard Damage}
            ...
            \begin{dtable}
                ...
                \begin{dtabularx}{\columnwidth}{l X}
                    ...
                    28--29\fn{1} & 10d10 \\
                \end{dtabularx}
                1. For every even value above 29, add a +5 bonus to the result instead of rolling additional dice.
            \end{dtable}
        ...
        \subsubsection{Power vs. Die Increments}\label{Power vs. Die Increments}
            ...
            For example, the \textit{power attack} \glossterm{maneuver} deals \plus2d more damage than a normal \glossterm{strike}.
...
\section{Taking Damage}\label{Taking Damage}
    ...
    \begin{dtable}
        ...
        \begin{dtabularx}{\columnwidth}{l *{2}{>{\ccol}X}}
            % DR is +1 every level at first, then +2 per level after 10th, with an extra + per level every 6 levels.
            % WR is +2 every level at first, then +3 per level after 3rd, with an extra + per level every 3 levels.
            % TODO: make the above logic make more sense with math
            \tb{Total}\fn{1} & \tb{Wound Resistance} & \tb{Vital Resistance} \tableheaderrule
            \minus1 or lower & 1                     & 10     \\
            0                & 1                     & 12     \\
            1                & 2                     & 14     \\
            2                & 3                     & 16     \\
            3                & 4                     & 18     \\ % vr change to +3
            4                & 5                     & 21     \\
            5                & 6                     & 24     \\
            6                & 7                     & 27     \\ % vr change to +4
            7                & 8                     & 31     \\
            8                & 9                     & 35     \\
            9                & 10                    & 39     \\ % vr change to +5
            10               & 11                    & 44     \\
            11               & 13                    & 49     \\
            12               & 15                    & 54     \\ % vr change to +6
            13               & 17                    & 60     \\
            14               & 19                    & 66     \\
            15               & 21                    & 72     \\ % vr change to +7
            16               & 23                    & 79     \\
            17               & 26                    & 86     \\
            18               & 29                    & 93     \\ % vr change to +8
            19               & 32                    & 101    \\
            20               & 35                    & 109    \\
            21               & 38                    & 117    \\ % vr change to +9
            22               & 41                    & 126    \\
            23               & 45                    & 135    \\
            24               & 49                    & 144    \\ % vr change to +10
        ...
        3. To calculate the wound resistance for a creature with an epic Constitution, increase its wound resistance by 4 per point, and its vital resistance by 10 per point.
    \end{dtable}
