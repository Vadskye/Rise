...
\section{Taking Damage}\label{Taking Damage}
    ...
    \begin{dtable}
        ...
        \begin{dtabularx}{\columnwidth}{l *{2}{>{\ccol}X}}
            ...
            \tb{Level or Con} & \tb{Wound Resistance}\fn{1} & \tb{Vital Resistance}\fn{2} \tableheaderrule
            1                 & 2             & 14     \\
            2                 & 3             & 16     \\
            3                 & 4             & 18     \\
            4                 & 5             & 21     \\
        ...
        \end{dtabularx}
        1. This is your \glossterm{damage resistance} (see \pcref{Wound Resistance}). \\
    ...
    \subsection{Wound Resistance}\label{Wound Resistance}
        ...
        It is based on the higher of your level and Constitution, as defined in \tref{Resistance Values}.
    ...
    \subsection{Vital Resistance}\label{Vital Resistance}
        ...
        Your \glossterm{vital resistance} is based on the higher of your level and Constitution, as defined in \tref{Resistance Values}.
    ...
    \subsubsection{Damage Type Resistances}\label{Damage Type Resistances}
        ...
        Your \glossterm{damage resistance} and \glossterm{vital resistance} apply against damage of any type.
    ...
    \subsection{Becoming Bloodied}\label{Becoming Bloodied}
        ...
        While you are bloodied, your \glossterm{vital resistance} is halved, to a minimum of your \glossterm{damage resistance} for each corresponding type of damage.
...
\section{Character Advancement}\label{Character Advancement}
    ...
    \begin{itemize}
        ...
        \item At 3rd level, and every 6 levels thereafter, you gain an additional \glossterm{action point} (see \pcref{Action Points}).
    ...
    \subsection{Leveling Up}
        ...
        \begin{itemize}
            ...
            \item Your \glossterm{damage resistance} and \glossterm{vital resistance} increase (see \tref{Character Advancement}).
