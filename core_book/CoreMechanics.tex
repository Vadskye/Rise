...
\section{Size Categories}\label{Size Categories}
    ...
    \begin{dtable*}
        ...
        \begin{dtabularx}{\textwidth}{l l l l l l X}
            \tb{Size}         & \tb{Space}\fn{1} & \tb{Base Speed} & \tb{Weight Limits}\fn{2} & \tb{Reflex Defense} & \tb{Stealth} & \tb{Example Creature} \tableheaderrule
            Fine              & 1/4 ft.          & 10 ft.           & \minus4 Str        & \plus4               & \minus20               & Fly                      \\
            Diminuitive       & 1/2 ft.          & 10 ft.          & \minus3 Str        & \plus3               & \minus15               & Mouse                    \\
            Tiny              & 1 ft.            & 20 ft.          & \minus2 Str        & \plus2               & \minus10               & Rat                      \\
            Small             & 2-1/2 ft.        & 20 ft.          & \minus1 Str        & \plus1               & \minus5               & Cat                      \\
            Medium            & 5 ft.            & 30 ft.          & \tdash             & \tdash               & \tdash               & Human                    \\
            Large (tall)      & 10 ft.           & 40 ft.          & \plus1 Str         & \minus1              & \plus5              & Ogre                     \\
            Large (long)      & 10 ft.           & 40 ft.          & \plus1 Str         & \minus1              & \plus5              & Horse                    \\
            Huge (tall)       & 20 ft.           & 50 ft.          & \plus2 Str         & \minus2              & \plus10              & Cloud giant              \\
            Huge (long)       & 20 ft.           & 50 ft.          & \plus2 Str         & \minus2              & \plus10              & Bulette                  \\
            Gargantuan (tall) & 40 ft.           & 60 ft.          & \plus3 Str         & \minus3              & \plus15              & 50-ft.\ animated statue  \\
            Gargantuan (long) & 40 ft.           & 60 ft.          & \plus3 Str         & \minus3              & \plus15              & Kraken                   \\
            Colossal (tall)   & 80\add ft.       & 80 ft.          & \plus4 Str         & \minus4              & \plus20              & Colossal animated object \\
            Colossal (long)   & 80\add ft.       & 80 ft.          & \plus4 Str         & \minus4              & \plus20              & Great wyrm red dragon    \\
        \end{dtabularx}
...
\section{Ability Mechanics}\label{Ability Mechanics}
    ...
    \subsection{Ability Durations}\label{Ability Durations}
        ...
        \subsubsection{Sustained Abilities}\label{Sustained Abilities}
            ...
            At the start of your action during each \glossterm{action phase}, the ability is dismissed unless you take the appropriate action to sustain the ability.
...
\section{General Calculations}
    ...
    \subsection{Doubling and Halving}\label{Doubling and Halving}
        ...
        \subsubsection{Doubling and Halving Dice Pools}
            ...
            As a result, if you get a \glossterm{critical hit} with a damaging attack, you roll twice as many dice and then double the result, which typically means you deal 4x your normal damage.
