...
\section{Character Statistics}
    ...
    \subsection{Action Points}\label{Action Points}
        ...
        A 1st level character's \glossterm{action points} are typically equal to 3 \add your starting Willpower.
...
\section{Movement and Positioning}\label{Movement and Positioning}
    ...
    \subsection{Movement Abilities}\label{Movement Abilities}
        ...
        \begin{apability}{\labeltext{Sprint}}
    ...
    \subsection{Ability Durations}
        ...
        \subsection{Attunement}\label{Attunement}
            ...
            \begin{freeability}{Release Attunement}
                You stop being attuned to one ability you have attuned to, ending its effect.
    ...
    \subsection{Resting}\label{Resting}
        ...
        \subsubsection{Short Rest}\label{Short Rest}
            ...
            \begin{itemize}
                ...
                \item You regain any \glossterm{action points} you released from \glossterm{attuned} abilities with the \textit{release attunement} ability (see \pcref{Attunement}).
...
\section{Character Advancement}\label{Character Advancement}
    ...
    \begin{itemize}
        ...
        \item At 7th level, and every 6 levels thereafter, you gain an additional \glossterm{action point}.
    \end{itemize}

    \begin{dtable}
        \lcaption{Character Advancement}
        \begin{dtabularx}{\columnwidth}{*{2}{>{\lcol}l} *{4}{>{\lcol}X}}
            \tb{Level} & \tb{XP}  & \tb{Max Rank}\fn{1} & \tb{Legacy Item}\fn{2} & \tb{AP} \tableheaderrule
            1st          & 0      & 1      & \tdash & 3
            \\ 2nd       & 20     & 2      & \tdash & \tdash
            ...
            \\ 10th      & 1,050  & \tdash & \tdash & \tdash
            \\ 11th      & 1,550  & 5      & \tdash & \tdash
            \\ 12th      & 2,200  & \tdash & 3      & \tdash
            \\ 13th      & 3,150  & \tdash & \tdash & 5
            \\ 14th      & 4,450  & 6      & \tdash & \tdash
            \\ 15th      & 6,350  & \tdash & \tdash & \tdash
            \\ 16th      & 8,900  & \tdash & 4      & \tdash
            \\ 17th      & 13,000 & 7      & \tdash & \tdash
            \\ 18th      & 18,000 & \tdash & \tdash & \tdash
            \\ 19th      & 25,500 & \tdash & \tdash & 6
            \\ 20th      & 36,000 & 8      & 5      & \tdash
        \end{dtabularx}
