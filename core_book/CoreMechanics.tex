...
\section{Circumstances, Bonuses, and Penalties}
    ...
    \subsection{Overwhelm}\label{Overwhelm}
        ...
        If there are at least two \glossterm{enemies} adjacent to you, you take a \minus2 penalty to your Armor and Reflex defenses.
        If every space adjacent to you either contains an \glossterm{enemy} or is both empty and adjacent to an \glossterm{enemy}, this penalty increases to \minus4.
...
\section{Universal Abilities}\label{Universal Abilities}
    ...
    \subsection{Special Combat Abilities}\label{Special Combat Abilities}
        ...
        \parhead{Throw} As a standard action, you can use the \textit{throw} ability to throw an object.
    ...
    \subsection{Grappling}\label{Grappling}
        ...
        \subsubsection{Grapple Actions}\label{Grapple Actions}
            ...
            \begin{freeability}{\labeltext{Escape Grapple}}
                ...
                If you do, the attack is made against each target's Reflex defense.
                Otherwise, the attack is made against each target's Fortitude defense.
