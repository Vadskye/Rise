...
\section{Character Advancement}\label{Character Advancement}
    ...
    \begin{dtable}
        ...
        \begin{dtabularx}{\columnwidth}{*{2}{>{\lcol}l} *{4}{>{\lcol}X}}
            \tb{Level} & \tb{XP}  & \tb{Item Slots} & \tb{Legacy Item}\fn{1} & \tb{Recovery AP}
            \\\bottomrule
            1st          & 0      & 1 & \tdash & 3
            \\ 2nd       & 20     & \tdash & \tdash & \tdash
            \\ 3rd\fn{2} & 50     & 2      & \tdash & \tdash
            \\ 4th       & 90     & \tdash & 1      & \tdash
