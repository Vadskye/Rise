...
\section{Character Statistics}
    ...
    \subsection{Circumstances, Bonuses, and Penalties}
        ...
        \subsubsection{Overwhelm}\label{Overwhelm}
            ...
            A creature with overwhelm resistance reduces the \glossterm{overwhelm value} of all creatures threatening it by an amount equal to its overwhelm resistance.
