    ...
    \subsection{Ability Durations}\label{Ability Durations}
        ...
        \subsubsection{Attunement}\label{Attunement}
            ...
            \subsubsection{Multiple Attunement}
                You can attune to multiple \abilitytag{Attune} (target) and abilitytagglossterm{Attune} (self) abilities, and multiple creatures can attune to different uses of abilitytag same \glossterm{Attune} (target) ability you have.
                However, you cannot attune to the same ability more than once, regardless of whether it is \abilitytag{Attune} (self) or abilitytagglossterm{Attune} (target).
