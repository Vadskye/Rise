...
\section{Attributes}\label{Attributes}
    ...
    \subsection{Attribute Descriptions}
        ...
        \parhead{Strength (Str)}\label{Strength}
        {
            ...
            \begin{itemize}
                ...
                \item You reduce your \glossterm{encumbrance} from \glossterm{body armor} by an amount equal to your starting Strength, to a minimum of 0 (see \pcref{Encumbrance}).
    ...
    \subsection{Increasing Attributes}\label{Increasing Attributes}
...
\section{Circumstances, Bonuses, and Penalties}
    ...
    \subsection{Size in Combat}\label{Size in Combat}
        Your size affects your \glossterm{space} and \glossterm{reach} in combat, your \glossterm{base speed}, your starting attributes, and how easily you are \glossterm{overwhelmed} (see \pcref{Overwhelm}).
