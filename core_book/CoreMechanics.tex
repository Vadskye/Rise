...
\section{Damage}\label{Damage}
    ...
    Bleeding causes you to lose a hit point.
    This hit point loss is in addition to the normal hit point you lose whenever you take damage.
    In addition, some special attacks have additional effects if they make you bleed.

    If the attack deals at least as much damage as your \glossterm{vital resistance}, the attack causes you to gain a \glossterm{vital wound} (see \pcref{Vital Resistance}).
    ...
    \parhead{Extraordinary Damage}
        ...
        For each multiple of your vital resistance that you take from a single attack, you gain an additional \glossterm{vital wound}.
