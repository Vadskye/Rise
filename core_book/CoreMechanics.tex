...
\section{Movement and Positioning}\label{Movement and Positioning}
    ...
    \subsection{Movement Abilities}\label{Movement Abilities}
        ...
        \begin{instantability}{\labeltext{Block}}
            Instant
            \rankline
        ...
        \begin{instantability}{\labeltext{Follow}}
            Instant
            \rankline
        ...
        \begin{instantability}{\labeltext{Withdraw}}
            Instant
            \rankline
...
\section{Universal Abilities}\label{Universal Abilities}
    ...
    \subsection{Strikes}\label{Strikes}
        ...
        \begin{instantability}{\labeltext{Melee Strike}}
            Instant
            \rankline
        ...
        \begin{instantability}{\labeltext{Projectile Strike}}
            Instant
            \rankline
            ...
            You take a \minus1 penalty to \glossterm{accuracy} for each full \glossterm{range increment} between you and the target.
            If your total penalty from range increments would exceed \minus10, the attack fails without effect.

            \hit The target takes damage from the weapon (see \pcref{Strike Damage}).
            \crit The target takes double damage from the weapon, as normal for critical hits (see \pcref{Critical Hits}).
        \end{instantability}

        \begin{instantability}{\labeltext{Thrown Strike}}
            Choose one \glossterm{thrown weapon} that you are wielding and are able to attack with.
            Make an attack vs. Armor with that weapon against anything that you have \glossterm{line of sight} and \glossterm{line of effect} to.
            You take a \minus1 penalty to \glossterm{accuracy} for each full \glossterm{range increment} between you and the target.
            If your total penalty from range increments would exceed \minus5, the attack fails without effect.
    ...
    \subsection{Special Combat Abilities}\label{Special Combat Abilities}
        ...
        \begin{instantability}{\labeltext{Charge}}
            Instant
            \rankline
        ...
        \begin{instantability}{\labeltext{Desperate Exertion}}[\abilitytag{Swift}]
            Instant
            \rankline
            After you use this ability, you gain two \glossterm{fatigue points} (see \pcref{Fatigue}).
        ...
        \begin{durationability}{Dirty Trick}\label{Dirty Trick}
            ...
            On a hit, the subject suffers a \minus2 penalty to one of the following statistics:
        ...
        \begin{instantability}{\labeltext{Overrun}}
            Instant
            \rankline
            After you use this ability, you gain a \glossterm{fatigue point}.
        ...
        \begin{instantability}{\labeltext{Recover}}
            Instant
            \rankline
        ...
        \begin{instantability}{\labeltext{Sprint}}
            Instant
            \rankline
        ...
        \begin{durationability}{\labeltext{Struggle}}
            Duration
            \rankline
        ...
        \begin{instantability}{\labeltext{Throw}}
            Instant
            \rankline
        ...
        \begin{durationability}{\labeltext{Total Defense}}[\abilitytag{Swift}]
            Duration
            \rankline
        ...
        \begin{instantability}{\labeltext{Trip}}
            Instant
            \rankline
    ...
    \subsection{Grappling}\label{Grappling}
        ...
        \subsubsection{Grapple Actions}\label{Grapple Actions}
            ...
            \begin{instantability}{\labeltext{Escape Grapple}}
                Instant
                \rankline
            ...
            \begin{instantability}{Maintain Grapple}[Swift]
                Instant
                \rankline
