...
\section{Damage}\label{Damage}
    ...
    \subsection{Damage Types}\label{Damage Types}
        ...
        \subsubsection{Damage Subtypes}\label{Damage Subtypes}
            ...
            For example, if you have \glossterm{resistances} against \glossterm{physical damage}, those resistances apply against bludgeoning damage because bludgeoning damage is a subtype of \glossterm{physical damage}.
...
\section{Character Statistics}
    ...
    \subsection{Resistances}\label{Resistances}
        Creatures can have resistances to particular damage types.
