...
\section{Character Statistics}
    ...
    \subsection{Attributes}\label{Attributes}
        ...
        \subsubsection{Attribute Descriptions}
            ...
            \parhead{Constitution (Con)}\label{Constitution}
                ...
                \begin{itemize}
                    \item You gain a bonus (or penalty) to \glossterm{wound rolls} equal to your starting Constitution (see \pcref{Vital Wounds}).
    ...
    \subsection{Taking Damage}\label{Taking Damage}
        ...
        \subsubsection{Wound Threshold}\label{Wound Threshold}
            ...
            It is calculated based on your level, as described in \tref{Character Advancement}.
            ...
            If this \glossterm{vital wound} gets a \glossterm{wound roll} less than 0, treat the roll as a 0, causing you to fall unconscious until the \glossterm{vital wound} is removed.
...
\section{Character Advancement}\label{Character Advancement}
    ...
    \begin{dtable}
        ...
        \begin{dtabularx}{\columnwidth}{*{2}{>{\lcol}l} *{3}{>{\lcol}X} p{3.5em} l}
            \tb{Level} & \tb{XP}  & \tb{Max Rank}\fn{1} & \tb{Item Slots} & \tb{Legacy Item}\fn{2} & \tb{Recovery AP} & \tb{WT}\fn{3} \tableheaderrule
            1st          & 0      & 1      & 1      & \tdash & 3      & 7
            \\ 2nd       & 20     & 2      & \tdash & \tdash & \tdash & 10
            \\ 3rd\fn{5} & 50     & \tdash & 2      & \tdash & \tdash & 13
            \\ 4th       & 90     & \tdash & \tdash & 1      & \tdash & 16
            \\ 5th       & 150    & 3      & \tdash & \tdash & \tdash & 21
            \\ 6th       & 230    & \tdash & 3      & \tdash & \tdash & 25
            \\ 7th       & 350    & \tdash & \tdash & \tdash & 4      & 29
            \\ 8th       & 510    & 4      & \tdash & 2      & \tdash & 34
            \\ 9th       & 750    & \tdash & \tdash & \tdash & \tdash & 39
            \\ 10th      & 1,050  & \tdash & 4      & \tdash & \tdash & 44
            \\ 11th      & 1,550  & 5      & \tdash & \tdash & \tdash & 49
            \\ 12th      & 2,200  & \tdash & \tdash & 3      & \tdash & 55
            \\ 13th      & 3,150  & \tdash & \tdash & \tdash & 5      & 61
            \\ 14th      & 4,450  & 6      & \tdash & \tdash & \tdash & 67
            \\ 15th      & 6,350  & \tdash & \tdash & \tdash & \tdash & 73
            \\ 16th      & 8,900  & \tdash & \tdash & 4      & \tdash & 80
            \\ 17th      & 13,000 & 7      & \tdash & \tdash & \tdash & 87
            \\ 18th      & 18,000 & \tdash & \tdash & \tdash & \tdash & 94
            \\ 19th      & 25,500 & \tdash & \tdash & \tdash & 6      & 101
            \\ 20th      & 36,000 & 8      & \tdash & 5      & \tdash & 109
        \end{dtabularx}
        ...
        3. See \pcref{Wound Threshold}. \\
        5. You gain access to \glossterm{legend points} at this level.
    \end{dtable}
