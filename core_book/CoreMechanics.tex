...
\section{Character Statistics}
    ...
    \subsection{Action Points}\label{Action Points}
        You can use some special abilities by spending \glossterm{action points}.
        In addition, you can spend \glossterm{action points} to attune to magical effects such as spells or items (see \pcref{Attunement}).
...
\section{Ability Mechanics}\label{Ability Mechanics}
    ...
    \subsection{Ability Durations}
        ...
        \subsection{Attunement}\label{Attunement}
            ...
            As long as you remain attuned to that ability, you cannot recover that \glossterm{action point} you by any means.
        ...
        \subsubsection{Long Rest}\label{Long Rest}
            ...
            \begin{itemize}
                ...
                \item You regain all spent \glossterm{action points}.
                    Being \glossterm{attuned} to effects at the start of your rest can prevent you from regaining spent \glossterm{action points} (see \pcref{Attunement}).
