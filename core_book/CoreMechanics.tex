...
\section{Attributes}\label{Attributes}
    ...
    \subsection{Attribute Descriptions}
        ...
        \parhead{Perception (Per)}\label{Perception}
        {
            ...
            It has the following effects:
            \begin{itemize}
                \item You apply your Perception as a bonus or penalty to Perception-based \glossterm{skills}: Awareness, Creature Handling, Social Insight, Spellcraft, and Survival (see \pcref{Skills}).
...
\section{Universal Abilities}\label{Universal Abilities}
    ...
    \subsection{Strikes}\label{Strikes}
        ...
        \begin{freeability}{\labeltext{Melee Strike}}
            ...
            For each weapon, make an attack with that weapon against the Armor defense of the target.
    ...
    \subsection{Special Combat Abilities}\label{Special Combat Abilities}
        ...
        \begin{freeability}{Dirty Trick}\label{Dirty Trick}
            ...
            Make a melee attack with a free hand against the Fortitude or Reflex defense of a creature you \glossterm{threaten}.
        ...
        \begin{freeability}{Grapple}\label{Grapple}
            Make a melee attack with a free hand against a creature's Fortitude and Reflex defenses.
