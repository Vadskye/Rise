...
\section{Character Statistics}
    ...
    \subsection{Accuracy}\label{Accuracy}
        ...
        If you make an attack with a weapon you are not proficient with, you take a \minus2 accuracy penalty.
...
\section{Circumstances, Bonuses, and Penalties}
    ...
    \subsection{Range Increments}\label{Range Increments}
        ...
        You take a \minus1 accuracy penalty with the ranged attack for each full range increment between you and your target.
        For example, when using a longbow with a range increment of 90 feet against a target 170 feet away, you take a \minus1 accuracy penalty.
    ...
    \subsection{Awareness and Surprise}\label{Awareness and Surprise}
        ...
        \subsubsection{Invisibility}\label{Invisibility}
            ...
            An attack into a square occupied by an invisible enemy has a 50\% miss chance, and the creature has \glossterm{concealment} against your attack, just as if you were \blinded.
...
\section{Universal Abilities}\label{Universal Abilities}
    ...
    \subsection{Special Combat Abilities}\label{Special Combat Abilities}
        ...
        \begin{instantability}{Shove}\label{Shove}
            ...
            On a hit, you can move up to half your movement speed in a straight line, \glossterm{pushing} the target as you move.
        ...
        \subsubsection{Being In A Grapple}
            ...
            \begin{itemize}
                \item You must use a free hand (or equivalent limb) to grapple, preventing you from taking any actions which would require having two free hands.
                    If you do not have a free hand, you suffer a \minus10 accuracy penalty with all \glossterm{mundane} attacks and grapple actions until you have a free hand.
                ...
                \item You take a \minus4 accuracy penalty with weapons that are not \glossterm{light weapons}, since they are too large and cumbersome to be used effectively in a grapple.
...
\section{Spell and Ritual Mechanics}\label{Spell and Ritual Mechanics}
    ...
    \subsection{Rituals}\label{Rituals}
        ...
        \subsubsection{Ritual Participants}
            ...
            Normally, a ritual participant can only contribute one \glossterm{fatigue level}.
