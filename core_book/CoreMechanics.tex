...
\section{Making Attacks}\label{Attacks}
    ...
    \subsection{Attack Rolls}\label{Attack Rolls}
        ...
        \subsubsection{Glancing Blows}\label{Glancing Blows}
            ...
            A glancing blow is still considered to be a miss for the purpose of abilities that trigger on missed attacks, such as a \mitem{hardblock shield}.
...
\section{Ability Mechanics}\label{Ability Mechanics}
    ...
    \subsection{Ability Durations}\label{Ability Durations}
        ...
        \subsubsection{Attuned Abilities}\label{Attuned Abilities}
            ...
            In addition, some attunement abilities are categorized as \glossterm{deep attunement} abilities in addition to their main attunement type.
            For details, see \pcref{Deep Attunement}, below.
        ...
        \subsubsection{Deep Attunement}\label{Deep Attunement}
            ...
            They are indicated with ``deep'' inside the tag description, such as ``\abilitytag{Attune} (deep, self)''.
            ...
            Second, you can't get back those attunement points by any means until you take a \glossterm{short rest}, even if you release the attunement.

            If a deep attunement ability has multiple people who could choose to attune to it, such as with attuned rituals, both attunement points must come from the same creature.
        ...
        \subsubsection{Sustained Abilities}\label{Sustained Abilities}
            ...
            If you do, it gains the \abilitytag{Attune} (self) tag and loses the \abilitytag{Sustain} tag, so it stays active as long as you stay attuned to it.
