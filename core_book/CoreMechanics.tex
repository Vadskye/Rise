...
\section{Attacks and Checks}\label{Attacks and Checks}
    ...
    \subsection{Strikes}
        ...
        It is a \glossterm{physical}, \glossterm{mundane} ability.
        \begin{ability}
            ...
            \begin{spelleffects}
                \begin{spellattack}{Physical vs. Armor}
                    \spellsuccess The target takes \glossterm{strike damage} with the chosen weapon (see \pcref{Strike Damage}).
...
\section{Combat Overview}
    ...
    \subsection{Special Actions}
        ...
        If you charge, you take a \minus5 penalty to \glossterm{physical defenses} until the end of the round, including during the \glossterm{action phase}.
        ...
        \begin{ability}
            \begin{spelleffects}
                \spelleffect You heal 1d4 damage \add 1d per two levels.
                In addition, you may choose one \glossterm{condition} affecting you.
                The condition's effects end.
            \end{spelleffects}
        \end{ability}
...
\section{Attributes}
    ...
    \subsection{Attribute Descriptions}
        ...
        \subsubsection{Strength (Str)}\label{Strength}
            ...
            \begin{itemize}
                \item Your \glossterm{accuracy} with \glossterm{strikes} using \glossterm{light weapons} (see \pcref{Physical Accuracy}).
        ...
        \subsubsection{Dexterity (Dex)}\label{Dexterity}
            ...
            \begin{itemize}
                \item Your \glossterm{accuracy} with \glossterm{strikes} using melee and thrown weapons (see \pcref{Physical Accuracy}).
        ...
        \subsubsection{Intelligence (Int)}\label{Intelligence}
            ...
            \begin{itemize}
                ...
                \item If your Intelligence is negative, you lose skill points equal to twice your Intelligence.
            \end{itemize}
        ...
        \subsubsection{Perception (Per)}\label{Perception}
            ...
            \begin{itemize}
                \item Your \glossterm{accuracy} with \glossterm{strikes} (see \pcref{Physical Accuracy}).
...
\section{Injury, Death, and Healing}\label{Injury, Death, and Healing}
    ...
    \subsection{Stages of Injury}
        ...
        \parhead{Staggered}
        While \glossterm{staggered}, you take a \minus5 penalty to attacks, checks, and defenses.
        These penalties replace the penalties for being \glossterm{bloodied}.
        You become staggered briefly the first time you become \glossterm{bloodied} in an encounter.
        In addition, you are \glossterm{staggered} if you have no hit points remaining.
...
\section{Special Rules}
    ...
    \subsection{Combat Maneuvers}\label{Combat Maneuvers}
        ...
        \subsubsection{Maneuver Descriptions}
            ...
            \begin{ability}
                ...
                \end{spelltargetinginfo}
                \begin{spelleffects}
                    \begin{spellattack}{Physical vs. Fortitude and Reflex}
    ...
    \subsection{Dual Strikes}\label{Dual Strikes}
        ...
        If you get a \glossterm{critical hit} with either weapon, you deal damage with both weapons, including all modifiers.
        This replaces the normal doubling of damage for critical hits.
