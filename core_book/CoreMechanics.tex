...
\section{Damage}\label{Damage}
    ...
    When you take damage, you lose a \glossterm{hit point} (see \pcref{Hit Points}).

    If you take at least as much damage as your \glossterm{bleed resistance} from a single source, you \glossterm{bleed} (see \pcref{Bleed Resistance}).
    Bleeding causes you to lose an additional hit point.
    In addition, some special attacks have additional effects if they make you bleed.

    If the attack deals at least as much damage as your \glossterm{vital resistance}, the attack \glossterm{vitally wounds} you (see \pcref{Vital Resistance}).
    Being vitally wounded by an attack causes you to lose an additional hit point and causes you to gain a \glossterm{vital wound}.
    Generally, an attack that vitally wounds you also makes you \glossterm{bleed}, which means you lose a total of three hit points from the attack.
    In addition, some special attacks have additional effects when they vitally wound you.

    \parhead{Extraordinary Damage}
        In unusual circumstances, you may take damage in a single attack that is at least double your \glossterm{vital resistance}.
        For each multiple of your vital resistance that you take from a single attack, you lose an additional \glossterm{hit point} and gain an additional \glossterm{vital wound}.
        ...
        \subsubsection{Vital Rolls}\label{Vital Rolls}
            ...
            \begin{dtable}
                ...
                \begin{dtabularx}{\textwidth}{l X}
                    ...
                    1                & You are unconscious while \glossterm{bloodied}                \\
                    2                & You take a \minus2 penalty to \glossterm{accuracy}            \\
                    3                & You take a \minus2 penalty to all \glossterm{defenses}        \\
                    4                & You take a \minus2 penalty to future \glossterm{vital rolls}  \\
                    5                & Your maximum \glossterm{hit points} are reduced by 2          \\
                    6                & You move at half speed while \glossterm{bloodied}             \\
                    7                & You take a \minus1 penalty to \glossterm{accuracy}            \\
                    8                & You take a \minus1 penalty to all \glossterm{defenses}        \\
                    9                & You take a \minus1 penalty to future \glossterm{vital rolls}  \\
                    10               & Your maximum \glossterm{hit points} are reduced by 1          \\
    ...
    \subsection{Damage Types}\label{Damage Types}
        ...
        \subsubsection{Multiple Damage Types}\label{Multiple Damage Types}
            ...
            If you were hit with a strike with that longsword, you would use the lower of your \glossterm{bleed resistance} against \glossterm{physical damage} and your \glossterm{bleed resistance} against \glossterm{energy damage} to resist the damage.
    ...
    \subsection{Special Damage Types}\label{Special Damage Types}
        ...
        \subsubsection{Environmental Damage}\label{Environmental Damage}
            ...
            Environmental damage works in the same way as normal damage, except that small amounts of environmental damage have no effect.
            If a creature would take \glossterm{environmental damage} that is less than its \glossterm{bleed resistance}, it does not take the damage and does not lose any \glossterm{hit points}.
...
\section{Attributes}\label{Attributes}
    ...
    \subsection{Attribute Descriptions}
        ...
        \parhead{Strength (Str)}\label{Strength}
        {
            ...
            \begin{itemize}
                ...
                \item You apply your base Strength as a bonus or penalty to \glossterm{power} with \glossterm{mundane} abilities, such as \glossterm{strikes} (see \pcref{Power}).
                ...
                \item If your base Strength is at least 2, you are \glossterm{trained} with your Strength-based \glossterm{class skills} (see \pcref{Class Skills}.
            \end{itemize}
        }
        ...
        \parhead{Dexterity (Dex)}\label{Dexterity}
        {
            ...
            \begin{itemize}
                ...
                \item If your base Dexterity is at least 2, you are automatically \glossterm{trained} with your Dexterity-based \glossterm{class skills} (see \pcref{Class Skills}.
            \end{itemize}
        }
        ...
        \parhead{Constitution (Con)}\label{Constitution}
        {
            ...
            It has the following effects:
            \begin{itemize}
                \item You gain a bonus (or penalty) to your \glossterm{hit points} equal to your base Constitution.
                ...
                \item Your base Constitution influences your \glossterm{resistances} (see \pcref{Resistances}).
                ...
                \item If your base Constitution is at least 2, you are automatically \glossterm{trained} with your Constitution-based \glossterm{class skills} (see \pcref{Class Skills}.
            \end{itemize}
        }
        ...
        \parhead{Intelligence (Int)}\label{Intelligence}
        {
            ...
            \begin{itemize}
                ...
                \item If your base Intelligence is at least 2, you are automatically \glossterm{trained} with your Intelligence-based \glossterm{class skills} (see \pcref{Class Skills}.
            \end{itemize}
        ...
        \parhead{Perception (Per)}\label{Perception}
        {
            ...
            \begin{itemize}
                ...
                \item If your base Perception is at least 2, you are automatically \glossterm{trained} with your Perception-based \glossterm{class skills} (see \pcref{Class Skills}.
        ...
        \parhead{Willpower (Wil)}\label{Willpower}
        {
            ...
            \begin{itemize}
                ...
                \item You apply your base Willpower as a bonus or penalty to \glossterm{power} with \glossterm{magical} abilities, such as \glossterm{spells} (see \pcref{Power}).
            \end{itemize}
        }
    ...
    \subsection{Base Attributes}\label{Base Attributes}
        ...
        \begin{dtable}
            ...
            \begin{dtabularx}{\columnwidth}{X X}
                ...
                2\add               & \plus1 per level after 1st \\
            \end{dtabularx}
        \end{dtable}
    ...
    \subsection{Determining Attributes}
        ...
        \subsubsection{Attribute Penalties}\label{Attribute Penalties}
            ...
            You cannot reduce more than two attributes below 0 in this way.
...
\section{Resources}\label{Resources}
    ...
    Insight points are spent during the character creation and leveling process, while all other resources are spent throughout the in-game time.
    ...
    \subsection{Attunement Points}\label{Attunement Points}
        ...
        A 1st level character typically has 2 \glossterm{attunement points}.
    ...
    \subsection{Fatigue}\label{Fatigue}
        ...
        \subsection{Fatigue Points}\label{Fatigue Points}
            ...
            \subsubsection{Fatigue Tolerance}\label{Fatigue Tolerance}
                You can gain a number of \glossterm{fatigue points} equal to 1 \add your base Constitution without suffering any consequences (minimum 0).
    ...
    \subsection{Hit Points}\label{Hit Points}
        ...
        You lose hit points when you take damage (see \pcref{Taking Damage}).
        ...
        This can cause you to die quickly.

        You normally have a number of \glossterm{hit points} equal to 9 \add your base Constitution.
        ...
        \subsubsection{Becoming Bloodied}\label{Becoming Bloodied}
            As your hit points get lower, you become more vulnerable to damage.
            At the end of each round, if you have half your maximum \glossterm{hit points} remaining or fewer (rounded down), you become \glossterm{bloodied}.
            Likewise, if you have more than half your maximum hit points remaining, you stop being \glossterm{bloodied}.

            While you are bloodied, your \glossterm{vital resistance} is halved, to a minimum of your \glossterm{bleed resistance} for each corresponding type of damage.
        ...
        \subsubsection{Regaining Hit Points}\label{Regaining Hit Points}
            ...
            \parhead{Limitations} Multiple effects that cause you to regain hit points in the same round do not stack.
...
\section{Character Statistics}
    ...
    \subsection{Damage}\label{Damage}
        ...
        \subsubsection{Standard Damage}\label{Standard Damage}
            ...
            Standard damage starts at 1d6 and increases by \plus1d per two power.
            ...
            \begin{dtable}
                ...
                \begin{dtabularx}{\columnwidth}{l X}
                    ...
                    24--25\fn{1} & 8d10 \\
                \end{dtabularx}
                1. For every even value above 26, add a +10 bonus to the result instead of rolling additional dice.
            \end{dtable}
        ...
        \subsubsection{Power vs. Die Increments}\label{Power vs. Die Increments}
            ...
            For example, the \textit{power strike} \glossterm{maneuver} deals \plus2d more damage than a normal \glossterm{strike}.
            Other abilities modify your \glossterm{power} directly.
            For example, the \textit{wellspring of power} wizard ability gives you a \plus1 bonus to \glossterm{power} with \glossterm{magical} abilities.
    ...
    \subsection{Resistances}\label{Resistances}
        ...
        % TODO: this table is awkwardly wide, can it have more information?
        \begin{dtable}
            \lcaption{Resistance Values}
            \begin{dtabularx}{\columnwidth}{l *{2}{>{\ccol}X}}
                \tb{Total}\fn{1} & \tb{Bleed Resistance} & \tb{Vital Resistance} \tableheaderrule
                \minus1 or lower & 1                     & 10     \\
                0                & 1                     & 11     \\
                1                & 2                     & 12     \\
                2                & 3                     & 13     \\
                3                & 4                     & 15     \\
                ...
                23               & 65                    & 150    \\
                24               & 70                    & 160    \\
                25\plus\fn{3}    & \tdash                & \tdash \\
            \end{dtabularx}
            1. This is your level \add your base Constitution. \\
            1. This is your \glossterm{bleed resistance} (see \pcref{Bleed Resistance}). \\
            2. This is your \glossterm{vital resistance} (see \pcref{Vital Resistance}). \\
            3. To calculate the bleed resistance for a creature with an epic Constitution, increase its bleed resistance by 5 per point, and its vital resistance by 10 per point.
        \end{dtable}

        \subsubsection{Bleed Resistance}\label{Bleed Resistance}
            Your \glossterm{bleed resistance} measures your ability to reduce the impact of minor damaging attacks.
            It is based on your level \add your base Constitution, as defined in \tref{Resistance Values}.
            Wearing \glossterm{armor} can increase your resistance against \glossterm{physical damage}, and some special abilities can also increase it.

            \parhead{Missing Bleed Resistance} An object or creature without a listed \glossterm{bleed resistance} loses a single \glossterm{hit point} from damaging attacks.

            \parhead{Literal Blood} Many creatures that do not have blood in exact the same sense as humans still have a bleed resistance and are said to "bleed" from damaging attacks.
            Those creatures still lose some important part of their life force or corporeal bodies when they take significant damage.
            A rare few creatures are explicitly unable to bleed, as indicated in their descriptions.

        \subsubsection{Vital Resistance}\label{Vital Resistance}
            Your \glossterm{vital resistance} measures your ability to avoid gaining \glossterm{vital wounds} from dangerous attacks.
            When you take damage from an attack, if the damage is at least as much as your \glossterm{vital resistance}, you gain a \glossterm{vital wound} (see \pcref{Vital Wounds}).

            Your \glossterm{vital resistance} is based on your level \add your base Constitution, as defined in \tref{Resistance Values}.
            Wearing \glossterm{armor} can increase your vital resistance against \glossterm{physical damage}, and some special abilities can also increase it.

            \parhead{Missing Vital Resistance} An object or creature without a listed \glossterm{vital resistance} cannot gain \glossterm{vital wounds} from taking damage directly.
        ...
        \subsubsection{Damage Type Resistances}\label{Damage Type Resistances}
            ...
            Your \glossterm{bleed resistance} and \glossterm{vital resistance} apply against damage of any type.
...
\section{Circumstances, Bonuses, and Penalties}
    ...
    \subsection{Overwhelm}\label{Overwhelm}
        ...
        \subsubsection{Size Differences}
            ...
            Creatures one \glossterm{size category} smaller than you only count as half a creature for the purpose of determining your \glossterm{overwhelm penalties}.
            Creatures two \glossterm{size categories} smaller than you count as one quarter of a creature.
            Creatures three or more \glossterm{size categories} smaller than you do not contribute to your \glossterm{overwhelm penalties} at all.
...
\section{Universal Abilities}\label{Universal Abilities}
    ...
    \subsection{Strikes}\label{Strikes}
        ...
        \begin{freeability}{\labeltext{Melee Strike}}
            \target{One creature or object within your \glossterm{reach} (see text)}
    ...
    \subsection{Special Combat Abilities}\label{Special Combat Abilities}
        ...
        \begin{dtable}
            ...
            \begin{dtabularx}{\columnwidth}{>{\lcol}p{6em} l X}
                ...
                Recover\fn{2}            & \tdash       & Regain hit points, remove conditions \\
                ...
                Trip                     & Ref          & Trip a foe                           \\
            \end{dtabularx}
            1. This ability costs a \glossterm{hit point} to use. \\
            2. This ability gives you a \glossterm{fatigue point} when used. \\
        \end{dtable}
        ...
        \begin{freeability}{\labeltext{Charge}}
            ...
            At the end of your movement, if you are at least 10 feet from your original location, you can make a melee \glossterm{strike} from your new location.
        \end{freeability}
        ...
        \begin{freeability}{Offhand Strike}
            Choose one weapon you wield.
            You cannot use this ability unless you also use a standard action during the same phase to make a \glossterm{strike} with a different weapon you are wielding.

            Make a \glossterm{strike} with your chosen weapon.
            You take a \minus2 penalty \glossterm{accuracy} and a \minus2d penalty to \glossterm{damage} with the strike.
            In addition, you take a \minus1 penalty to \glossterm{accuracy} with the strike for each non-light weapon you are wielding.
        \end{freeability}
...
\section{Special Rules}
        ...
        \subsubsection{Being In A Grapple}
            ...
            \begin{itemize}
                \item You must use a free hand (or equivalent limbs) to grapple, preventing you from taking any actions which would require having two free hands.
                    If you cannot free a hand, you suffer a \minus10 penalty to accuracy with all \glossterm{mundane} attacks until you have a free hand.
    ...
    \subsection{Traps}\label{Traps}
        ...
        \subsubsection{Detecting Traps}\label{Detecting Traps}
            ...
            Unless otherwise noted, The \glossterm{difficulty rating} to detect and disable a trap is equal to 20 \add the \glossterm{power} of the ability that created the trap.
...
\section{Character Advancement}\label{Character Advancement}
    ...
    \begin{itemize}
        ...
        \item At 3rd level, and every 3 levels thereafter, you gain an additional \glossterm{attunement point} (see \pcref{Attunement Points}).
        \item At 4th level, and every 6 levels thereafter, you gain a \glossterm{legacy item} upgrade (see \pcref{Legacy Items}).
    \end{itemize}

    \begin{dtable}
        \lcaption{Character Advancement}
        \begin{dtabularx}{\columnwidth}{*{2}{>{\lcol}l} *{4}{>{\lcol}X}}
            \tb{Level} & \tb{XP} & \tb{Max Rank}\fn{1} & \tb{Legacy Item}\fn{2} & \tb{AP}\fn{3} \tableheaderrule
            1st        & 0       & 1                   & \tdash                 & 2      \\
            2nd        & 20      & 2                   & \tdash                 & \tdash \\
            3rd        & 50      & \tdash              & \tdash                 & 3      \\
            4th        & 90      & \tdash              & 1                      & \tdash \\
    ...
    \subsection{Leveling Up}
        ...
        \begin{itemize}
            ...
            \item Your \glossterm{bleed resistance} and \glossterm{vital resistance} increase (see \tref{Resistance Values}).
