...
\section{Attacks and Checks}\label{Attacks and Checks}
    ...
    \subsection{Checks}\label{Checks}
        ...
        You compare the die result, including your check modifier, to a \glossterm{difficulty rating} that represents the difficulty of the task.
        The more difficult the task, the higher the \glossterm{difficulty rating} will be.
        If your result is at least equal to the \glossterm{difficulty rating}, the check succeeds.
...
\section{Taking Damage}\label{Taking Damage}
    ...
    If you take at least as much damage as your \glossterm{bleed resistance} from a single source, you \glossterm{bleed}.
    ...
    If the attack deals at least as much damage as your \glossterm{vital resistance}, the attack \glossterm{vitally wounds} you.
