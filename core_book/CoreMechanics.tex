    ...
    \subsection{Attributes}\label{Attributes}
        ...
        \subsubsection{Strength (Str)}\label{Strength}
            ...
            \begin{itemize}
                ...
                \item You gain a bonus (or penalty) to your \glossterm{threat} equal to your starting Strength (see \pcref{Threat}).
...
\section{Movement and Positioning}\label{Movement and Positioning}
    ...
    \subsection{Movement Abilities}
        ...
        As a \glossterm{move action}, you can use the \textit{withdraw} ability to keep away from creatures as they move.
        ...
        As a \glossterm{free action}, you can spend an \glossterm{action point} to use the \textit{sprint} ability, allowing you to briefly move more quickly.
...
\section{Special Rules}
    ...
    \subsection{Encumbrance}\label{Encumbrance}
        Wearing armor imposes an \glossterm{encumbrance penalty} based on how encumbering the armor is.
        You apply your encumbrance penalty as a modifier to all Strength-based and Dexterity-based checks you make.
        Carrying an excess weight can also apply an encumbrance penalty, as described in \pcref{Encumbrance by Weight}.

        If you have an encumbrance penalty, you are \glossterm{encumbered}.
        ...
        % This doesn't make sense - it should just have no effect on the normal process of automatically applying fatigue over time
        If you sleep while encumbered, you become \glossterm{fatigued} when you wake up.
