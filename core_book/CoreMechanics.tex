...
\section{Planes}\label{Planes}
    ...
    \subsection{General Cosmology}
        ...
        The souls of creatures with the corresponding alignment usually spend their afterlife in an appropriate Aligned Plane.
        There are nine aligned planes, one for each alignment combination (see \pcref{Alignment}).
        The three good-aligned planes are collectively called the Celestial Heavens, and the three evil-aligned planes are collecftively called the Abyss.
