...
\section{Character Statistics}
    ...
    \subsection{Defenses}\label{Defenses}
        ...
        \subsubsection{Defense Values}\label{Defense Values}
            ...
            \begin{itemize}
                \itemhead{Armor}: Level \add base Dexterity (modified depending on equipped armor) \add half base Constitution \add class defense bonus \add defense bonuses from equipped body armor and shield
