...
\section{Character Statistics}
    ...
    \subsection{Circumstances, Bonuses, and Penalties}
        ...
        \subsubsection{Overwhelm}\label{Overwhelm}
            ...
            A creature is considered overwhelmed if the combined \glossterm{threat value} of all creatures threatening it is greater than 1 (after rounding down).
            If a creature is overwhelmed, it takes a penalty to physical defenses equal to the combined \glossterm{threat value} of all creatures threatening it.
