...
\section{Being Attacked}\label{Being Attacked}
    ...
    \subsection{Hit Points}\label{Hit Points}
        ...
        \parhead{Bonuses to Hit Points} Any effect that grants you a bonus to your hit points increases both your maximum hit points and current hit points.
    ...
    \subsection{Resting}\label{Resting}
        ...
        \subsubsection{Short Rest}\label{Short Rest}
            ...
            \begin{itemize}
                ...
                \item You regain any \glossterm{attunement points} you released from \glossterm{attuned} effects (see \pcref{Attunement}).
...
\section{Standard Abilities}

    % TODO: should there be subgroups within this section, or should it be strictly alphabetical?
    % A possible subgroup would be "sensory abilities".

    \stdabilitydef{Darkvision}
    ...
    \stdabilitydef{Tremorsense}
        Tremorsense functions like blindsense, except that it requires an uninterrupted path through solid objects instead of \glossterm{line of effect}.
        This makes it incapable of sensing flying creatures, but it ignores \glossterm{cover} and can even sense through solid walls.

    \stdabilitydef{Tremorsight}
        Tremorsense functions like blindsight, except that it requires an uninterrupted path through solid objects instead of \glossterm{line of effect}.
        This makes it incapable of seeing flying creatures, but it ignores \glossterm{cover} and can even see through solid walls.
