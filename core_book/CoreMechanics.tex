...
\section{Poison}\label{Poison}
    ...
    \subsection{Poison Forms}\label{Poison Forms}
        ...
        Unless otherwise noted, a gas poison can be thrown within \closerange, and affects a \tinyarea radius.
    ...
    \subsection{Coating Weapons with Poison}\label{Coating Weapons with Poison}
        ...
        For this reason, injury-based poisons are typically used on secondary weapons that can be used after the subject is already weakened.
