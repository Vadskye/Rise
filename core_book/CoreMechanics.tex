...
\section{Combat Overview}
    ...
    \subsection{Movement and Positioning}\label{Movement and Positioning}
        ...
        \subsubsection{Sprint}\label{Sprint}
            ...
            If you do, you make a Dexterity check.
            If you beat DR 5, you double your speed during that phase.
            For every 10 points by which you beat that DR, you double your speed again: 3x speed at DR 15, 4x speed at DR 25, and so on.
...
\section{Character Statistics}
    ...
    \subsection{Circumstances, Bonuses, and Penalties}
        ...
        \subsubsection{Overwhelm}\label{Overwhelm}
            ...
            A creature is overwhelmed if the combined \glossterm{threat value} of all creatures that \glossterm{threaten} it is at least 2.
            If a creature is overwhelmed, it takes a penalty to \glossterm{physical defenses} equal to the combined \glossterm{threat value} of all creatures threatening it.
            These are called \glossterm{overwhelm penalties}.
    ...
    \subsection{Size in Combat}\label{Size in Combat}
        ...
        \begin{dtable*}
            ...
            \begin{dtabularx}{\textwidth}{l l l l l l p{5.5em} X}
                \tb{Size} & \tb{Space}\fn{1} & \tb{Reach}\fn{1} & \tb{Size Modifier}\fn{2} & \tb{Damage Modifier}\fn{3} & \tb{Threat Value}\fn{4} & \tb{Overwhelm Resistance}\fn{5} & \tb{Example Creature} \\
                \bottomrule
                ...
                Large (tall)      & 10 ft.     & 10 ft.     & \minus2 & \plus2d  & 2 & 1 & Ogre                     \\
                Large (long)      & 10 ft.     & 5 ft.      & \minus2 & \plus2d  & 2 & 1 & Horse                    \\
                Huge (tall)       & 15 ft.     & 15 ft.     & \minus4 & \plus4d  & 3 & 2 & Cloud giant              \\
                Huge (long)       & 15 ft.     & 10 ft.     & \minus4 & \plus4d  & 3 & 2 & Bulette                  \\
                Gargantuan (tall) & 20 ft.     & 20 ft.     & \minus6 & \plus6d  & 4 & 3 & 50-ft.\ animated statue  \\
                Gargantuan (long) & 20 ft.     & 15 ft.     & \minus6 & \plus6d  & 4 & 3 & Kraken                   \\
                Colossal (tall)   & 30\add ft. & 30\add ft. & \minus8 & \plus8d  & 5 & 4 & Colossal animated object \\
                Colossal (long)   & 30\add ft. & 20\add ft. & \minus8 & \plus8d  & 5 & 4 & Great wyrm red dragon    \\
            \end{dtabularx}
            ...
            4. See \pcref{Threat Value}. \\
            5. See \pcref{Overwhelm Resistance}. \\
        \end{dtable*}
