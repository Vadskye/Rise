...
\section{Combat Overview}
    ...
    \subsection{Movement and Positioning}
        ...
        \subsubsection{Movement Impediments}
            ...
            \parhead{Obstacles}
            An obstacle is anything that gets in your way. Enemies and large solid objects like walls are blocking obstacles: they completely block your movement. If you can get past an obstacle, like a low wall, that square is treated as difficult terrain. Some obstacles require a \glossterm{check} to bypass, such as an Acrobatics check (see \pcref{Acrobatics}).
...
\section{Character Advancement}\label{Character Advancement}
    ...
    \begin{itemize}
        ...
        \item At 3rd level, and every 4 levels thereafter, you gain an \glossterm{action point}.
    ...
    \begin{dtable}
        ...
        \begin{dtabularx}{\columnwidth}{*{4}{>{\lcol}l} >{\lcol}X}
            \tb{Level} & \tb{XP}   & \tb{Feats} & \tb{Action Points} & \tb{Legend Points}
            \\\bottomrule
               1st  & 0         & 1\fn{1} & 4      & \tdash
            \\ 2nd  & 2,000     & \tdash  & \tdash & \tdash
            \\ 3rd  & 5,000     & 2       & 5      & \tdash
            \\ 4th  & 9,000     & \tdash  & \tdash & 1
            \\ 5th  & 15,000    & \tdash  & \tdash & \tdash
            \\ 6th  & 23,000    & 3       & \tdash & \tdash
            \\ 7th  & 35,000    & \tdash  & 6      & \tdash
            \\ 8th  & 51,000    & \tdash  & \tdash & 2
            \\ 9th  & 75,000    & \tdash  & \tdash & \tdash
            \\ 10th & 105,000   & 4       & \tdash & \tdash
            \\ 11th & 155,000   & \tdash  & 7      & \tdash
            \\ 12th & 220,000   & \tdash  & \tdash & 3
            \\ 13th & 315,000   & \tdash  & \tdash & \tdash
            \\ 14th & 445,000   & \tdash  & \tdash & \tdash
            \\ 15th & 635,000   & \tdash  & 8      & \tdash
            \\ 16th & 890,000   & \tdash  & \tdash & 4
            \\ 17th & 1,300,000 & \tdash  & \tdash & \tdash
            \\ 18th & 1,800,000 & \tdash  & \tdash & \tdash
            \\ 19th & 2,550,000 & \tdash  & 9      & \tdash
            \\ 20th & 3,600,000 & \tdash  & \tdash & 5
        \end{dtabularx}
        1. All races also grant a bonus feat at 1st level. The feat must be chosen from a specific list of racial bonus feats (see \pcref{Races}). \\
    \end{dtable}
