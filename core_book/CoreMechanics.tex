...
\section{Universal Abilities}
    ...
    \subsection{Combat Maneuvers}\label{Combat Maneuvers}
        ...
        \subsubsection{Maneuver Descriptions}
            ...
            As a standard action during the \glossterm{action phase}, you can use the \textit{feint} ability to distract an opponent, allowing you to strike them more accurately.
    ...
    \subsection{Special Combat Abilities}
        ...
        As a standard action during the \glossterm{action phase}, you can spend an \glossterm{action point} to use the \textit{charge} ability.
        ...
        As a standard action, you can use the \textit{desperate recovery} ability to remove a \glossterm{condition} from yourself.
        ...
        As a standard action, you can spend an \glossterm{action point} to use the \textit{recover} ability.
        As long as you are conscious, no effect can prevent you from using this ability, even effects that prohibit using any other abilities.
    ...
    \subsection{Special Movement Abilities}
        ...
        At the start of each, you can spend an \glossterm{action point} to use the \textit{overrun} ability.
...
\section{Special Rules}
    ...
    \subsection{Grappling}\label{Grappling}
        ...
        \subsubsection{Grapple Actions}\label{Grapple Actions}
            ...
            As a \glossterm{move action}, you can use the \textit{move grapple} ability to move yourself and all creatures you are grappling with.
            ...
            As a standard action, you can use the \textit{pin} ability to further restrict the actions of a creature you are grappling with.

            \begin{ability}{Pin}
                Make a \glossterm{physical attack} vs. Fortitude and Reflex against a creature who is grappled by you.

                \hit The target becomes \glossterm{pinned}.
                The only physical action a pinned creature can take is to escape the grapple, though it can take mental actions.
