...
\section{Combat Overview}
    ...
    \subsection{Resolving Actions}\label{Resolving Actions}
        ...
        \begin{enumerate*}
            ...
            \item Resolve \glossterm{swift abilities}.
        ...
        \subsubsection{Swift Abilities}\label{Swift Abilities}
            ...
            These are called \glossterm{swift abilities}.
            ...
            For example, the \textit{total defense} ability is a swift ability, and it protects you from attacks made during the same phase.
        ...
        \subsubsection{Conflicting Actions}\label{Conflicting Actions}
            ...
            For example, two characters may attempt to move into the same place.
...
\section{Universal Abilities}
    ...
    \subsection{Strikes}\label{Strikes}
        ...
        \parhead{Attacking with Multiple Weapons}
        ...
        \subsubsection{Melee Strike}
        As a \glossterm{standard action}, you can use this ability.
        When you do, choose a creature you \glossterm{threaten} and one or two \glossterm{melee} weapons that you can attack with.
        ...
        \subsubsection{Projectile Strike}
        As a \glossterm{standard action}, you can use this ability.
        When you do, choose a creature you can target and one or two \glossterm{projectile} weapons you can attack with, and a creature you can see.
        ...
        \subsubsection{Thrown Strike}
        As a \glossterm{standard action}, you can use this ability.
        When you do, choose a creature you can target and one or two \glossterm{thrown} weapons you can attack with.
    ...
    \subsection{Combat Maneuvers}\label{Combat Maneuvers}
        ...
        \subsubsection{Maneuver Descriptions}
            ...
            \parhead{Dirty Trick}\label{Dirty Trick} You can use this ability to strike your foe in a sensitive spot, pull its pants down, or creatively use your environment to attack.
            If you do, make a melee \glossterm{physical attack} with a free hand against the Fortitude or Reflex defense of a creature.
            The target uses whichever defense is appropriate to the nature of the trick you describe.
            On a hit, it suffers a \minus2 penalty to one of the following statistics as a \glossterm{condition}:
            ...
            On a critical hit, the penalty is increased to \minus5.

            \parhead{Disarm}\label{Disarm} You can use this ability to strike an item your foe is wearing or holding to knock it out of their hands or damage it.
            If you do, make a melee \glossterm{physical attack} with a weapon you wield against an object.
            This attack must beat the target's Armor defense.
            If the target is \glossterm{attended} by a creature, the attack must also beat the attending creature's Reflex defense.
            ...
            \parhead{Feint}\label{Feint} You can use this ability during the \glossterm{action phase} to make a fake attack to leave your foe off-balance.
            If you do, make a melee \glossterm{physical attack} with a weapon you wield against a creature's Reflex defense.
            During the \glossterm{delayed action phase}, you can also make a melee \glossterm{strike} with the same weapon.
            % Is this order clear enough?
            On a hit, the target takes a \minus2 penalty to defenses against the delayed strike.
            On a critical hit, the the penalty is increased to \minus5.
            On a miss, you take a \minus2 penalty to accuracy with the strike.

            \parhead{Grapple}\label{Grapple} You can use this ability to physically grab and restrain your foe.
            If you do, make a melee \glossterm{physical attack} with a free hand against a creature's Fortitude and Reflex defenses.
            If you hit both defenses, you and the target are \grappled.
            For details, see \pcref{Grappling}.

            \parhead{Shove}\label{Shove} You can use this ability to shove your foe where you want it to go.
            If you do, make a melee \glossterm{physical attack} with a free hand against a creature's Fortitude defense.
            ...
            \parhead{Trip}\label{Trip} You use this ability to trip your foe.
            If you do, make a melee \glossterm{physical attack} with a free hand against a creature's Reflex defense.
            On a hit, the target becomes \prone.
            On a critical hit, if you used this ability during the \glossterm{action phase}, you can also make a melee \glossterm{strike} with a weapon you wield against the target during the \glossterm{delayed action phase}.
            You take a \minus2d penalty to damage with the strike.

    \subsection{Special Combat Actions}

        \parhead{Charge}\label{Charge} As a \glossterm{standard action} during the \glossterm{action phase}, you can spend an \glossterm{action point} to use this ability.
        ...
        If you do, at the end of the round, if you did not take damage this round, you may remove one \glossterm{condition} affecting you.
        ...
        If you do, you gain a \plus2 bonus to your defenses until the end of the round.
...
\section{Character Statistics}
    ...
    \subsection{Circumstances, Bonuses, and Penalties}
        ...
        \subsubsection{Helpless Defenders}
            ...
            You automatically hit with your weapon and score a \glossterm{critical hit}. If the creature takes damage equal to or higher than half its maximum hit points, it immediately dies.
...
\section{Special Rules}
    ...
    \subsection{Ability Timing}
        ...
        % TODO: are there any such abilities left?
...
\section{Daily Resources}
    ...
    \subsection{Action Points}\label{Action Points}
        ...
        You normally have five action points.
...
\section{Character Advancement}\label{Character Advancement}
    ...
    \begin{itemize}
        ...
        \item At 1st, 3rd, 5th, 7th, and 9th level, you gain an \glossterm{item slot}.
    ...
    \begin{dtable}
        ...
        \begin{dtabularx}{\columnwidth}{*{3}{>{\lcol}l} *{4}{>{\lcol}X}}
            ...
            \\\bottomrule
            1st     & 0      & 1\fn{2}& 1      & \tdash & \tdash
            \\ 2nd  & 20     & \tdash & \tdash & 1      & \tdash
            \\ 3rd  & 50     & 2      & 2      & \tdash & \tdash
            \\ 4th  & 90     & \tdash & \tdash & \tdash & 1
            \\ 5th  & 150    & \tdash & 3      & \tdash & \tdash
            \\ 6th  & 230    & 3      & \tdash & 2      & \tdash
            \\ 7th  & 350    & \tdash & 4      & \tdash & \tdash
            \\ 8th  & 510    & \tdash & \tdash & \tdash & 2
            \\ 9th  & 750    & \tdash & 5      & \tdash & \tdash
            \\ 10th & 1,050  & 4      & \tdash & 3      & \tdash
