    ...
    \subsection{Attribute Descriptions}
        ...
        \subsubsection{Dexterity (Dex)}\label{Dexterity}
            ...
            \begin{itemize}
                ...
                \item You gain a bonus to your Reflex defense equal to your starting Dexterity (minimum 0).
        ...
        \subsubsection{Constitution (Con)}\label{Constitution}
            ...
            \begin{itemize}
                ...
                \item You gain a bonus to your Fortitude defense equal to your starting Constitution (minimum 0).
        ...
        \subsubsection{Willpower (Wil)}\label{Willpower}
            ...
            \begin{itemize}
                ...
                \item You gain a bonus to your Mental defense equal to your starting Willpower (minimum 0).
                \item If your Willpower is negative, you take penalty to Mental defense equal to your Willpower.
            \end{itemize}
...
\section{Character Statistics}
    ...
    \subsection{Damage}\label{Damage}
        ...
        Damage is measured in damage dice.
        ...
        \subsubsection{Standard Damage}
            ...
            In either case, it starts at 1d6 and increases by \plus1d per two power or per two levels.
        ...
        \begin{dtable}
            ...
            \begin{dtabularx}{\columnwidth}{l X}
                ...
                24--25\fn{1} & 8d10 \\
            \end{dtabularx}
            1. For values above 25, increase by \plus1d at every even value.
        \end{dtable}
        ...
        \subsubsection{Strike Damage}\label{Strike Damage}
            ...
            For example, if you have a Strength of 4, your base \glossterm{strike damage} would be equal to 1d10 (1d6 \plus2d).
...
\section{Injury, Death, and Healing}\label{Injury, Death, and Healing}
    ...
    \subsection{Hit Points}\label{Hit Points}
        ...
        \begin{figure}[h]
            \centering 5 \x (level \add starting Constitution)
        \end{figure}
...
\section{Special Rules}
    ...
    \subsection{Attunement}\label{Attunement}
        ...
        All variations of a single ability are considered to be the same ability for this purpose.
        For example, you can normally only attune to a single casting of a \glossterm{spell}, regardless of which \glossterm{subspells} or \glossterm{augments} you apply to it.
