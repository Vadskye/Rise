...
\section{Taking Damage}\label{Taking Damage}
    ...
    If you are dealt damage that would reduce your hit points below 0, you gain one or more \glossterm{vital wounds} (see \pcref{Negative Hit Points}).
    ...
    \subsection{Negative Hit Points}\label{Negative Hit Points}
        ...
        At the end of each round, if your hit points are negative, you gain a \glossterm{vital wound} and your hit points are set to 0 (see \pcref{Vital Wounds}).
        % TODO: does this still need to exist? all "end of round" damage should ideally be removed
        % Damage you take at the end of the round is considered to be part of the action phase for this purpose.
        If your negative hit points equal or exceed half your maximum hit points, you gain an additional vital wound.
    ...
    \subsection{Resolving Simultaneous Damage}\label{Resolving Simultaneous Damage}
        ...
        If you regain hit points or damage resistance and take damage simultaneously, apply all healing effects before applying any damaging effects.
        ...
        Most healing effects are \abilitytag{Swift}, which avoids some of this complexity.
        Swift healing effects are fully resolved before damage is dealt, so you cannot heal beyond your maximum hit points and damage resistance.
...
\section{Size Categories}\label{Size Categories}
    ...
    \begin{dtable*}
        ...
        \begin{dtabularx}{\textwidth}{l l l l l X}
            \tb{Size}         & \tb{Space}\fn{1} & \tb{Base Speed} & \tb{Weight Limits}\fn{2} & \tb{Reflex Defense} & \tb{Example Creature} \tableheaderrule
            Fine              & 1/4 ft.          & 5 ft.           & \minus4 Str        & \plus4               & Fly                      \\
            Diminuitive       & 1/2 ft.          & 10 ft.          & \minus3 Str        & \plus3               & Mouse                    \\
            Tiny              & 1 ft.            & 15 ft.          & \minus2 Str        & \plus2               & Rat                      \\
            Small             & 2-1/2 ft.        & 20 ft.          & \minus1 Str        & \plus1               & Cat                      \\
            Medium            & 5 ft.            & 30 ft.          & \tdash             & \tdash               & Human                    \\
            Large (tall)      & 10 ft.           & 40 ft.          & \plus1 Str         & \minus1              & Ogre                     \\
            Large (long)      & 10 ft.           & 40 ft.          & \plus1 Str         & \minus1              & Horse                    \\
            Huge (tall)       & 20 ft.           & 50 ft.          & \plus2 Str         & \minus2              & Cloud giant              \\
            Huge (long)       & 20 ft.           & 50 ft.          & \plus2 Str         & \minus2              & Bulette                  \\
            Gargantuan (tall) & 40 ft.           & 60 ft.          & \plus3 Str         & \minus3              & 50-ft.\ animated statue  \\
            Gargantuan (long) & 40 ft.           & 60 ft.          & \plus3 Str         & \minus3              & Kraken                   \\
            Colossal (tall)   & 80\add ft.       & 80 ft.          & \plus4 Str         & \minus4              & Colossal animated object \\
            Colossal (long)   & 80\add ft.       & 80 ft.          & \plus4 Str         & \minus4              & Great wyrm red dragon    \\
        \end{dtabularx}
...
\section{Ability Mechanics}\label{Ability Mechanics}
    ...
    \subsection{Ability Durations}\label{Ability Durations}
        ...
        \subsubsection{Sustained Abilities}\label{Sustained Abilities}
            ...
            Sustaining an ability has the \abilitytag{Swift} tag.
            When \abilitytag{Swift} abilities resolve during each action phase, the ability is dismissed unless you take the action to sustain the ability that round.
