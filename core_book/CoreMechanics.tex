...
\section{Combat Time}\label{Combat Time}
    ...
    \subsection{Resolving Actions}\label{Resolving Actions}
        ...
        These six steps are called \glossterm{resolution steps}.
        ...
        \subsubsection{Swift Abilities}\label{Swift Abilities}
            ...
            They resolve in \glossterm{resolution step} 3, after targets are determined but before attack rolls are made.
        ...
        \subsubsection{Delayed Abilities}\label{Delayed Abilities}
            ...
            During the \glossterm{action phase}, delayed abilities stop resolving at \glossterm{resolution step} 1, before targets are chosen.
...
\section{Injury, Death, and Healing}\label{Injury, Death, and Healing}
    ...
    \subsection{Vital Damage}\label{Vital Damage}
        ...
        If you take a \glossterm{long rest}, you heal vital damage equal to your starting Constitution \add half your level, to a minimum of 1 vital damage.
    ...
    \subsection{Grappling}\label{Grappling}
        ...
        \subsubsection{Being In A Grapple}
            ...
            \begin{itemize}
                \item You must use a free hand (or equivalent limbs) to grapple, preventing you from taking any actions which would require having two free hands.
                    If you cannot free a hand, you suffer a \minus10 penalty to accuracy on all physical attacks, including grapple attacks, until you have a free hand.
        ...
        \subsubsection{Grapple Actions}\label{Grapple Actions}
            ...
            \begin{ability}{Bind Foe}
                ...
                If you have the time, you can \glossterm{take 10} on your grapple attack to secure bindings on a helpless foe, including a foe rendered helpless through this attack.
            ...
            \begin{ability}{Pin}
                As a standard action, you can use this ability.
                If you do, make a grapple vs. Fortitude and Reflex attack against a creature who is grappled by you.
                \\hit The target becomes \glossterm{pinned}.
        ...
        \subsubsection{Asymmetric Grappling}\label{Asymmetric Grappling}
            ...
            You gain a \plus5 bonus to accuracy with grapple attacks against a creature grappled by you if you are not also grappled by that creature.
