...
\section{Character Statistics}
    ...
    \subsection{Action Points}\label{Action Points}
        ...
        Abilities that require attunement \glossterm{Attune} tag (see \pcref{Ability Tags}).
        In addition, you can use some special abilities by spending \glossterm{action points}.
        Abilities that spend action points have the \glossterm{AP} tag.
        ...
        A 1st level character typically has 3 \glossterm{action points}.
        At higher levels, you gain additional \glossterm{action points} (see \pcref{Character Advancement}).
        A small number of abilities can also grant additional \glossterm{action points}.
...
\section{Taking Damage}\label{Taking Damage}
        ...
        \subsubsection{Vital Rolls}\label{Vital Rolls}
            ...
            \begin{dtable}
                ...
                \begin{dtabularx}{\textwidth}{l X}
                    ...
                    \minus1--\minus5 & You are unconscious, and at the end of the next round you die   \\
                    0                & You are unconscious                                             \\
                    1                & You move at half speed                                          \\
                    ...
                    6                & You take a \minus10 foot penalty to your \glossterm{base speed} \\
    ...
    \subsection{Special Damage Types}\label{Special Damage Types}
        ...
        \subsubsection{Subdual Damage}\label{Subdual Damage}
            ...
            A \glossterm{vital roll} below 0 from subdual damage causes the target to fall unconscious until the \glossterm{vital wound} is removed.
...
\section{Ability Mechanics}\label{Ability Mechanics}
    ...
    \subsection{Attunement}\label{Attunement}
        ...
        After you stop being attuned to that ability, you can recover that action point when you take your next \glossterm{short rest}.
    ...
    \subsection{Special Combat Abilities}\label{Special Combat Abilities}
        ...
        \begin{dtable}
            ...
            \begin{dtabularx}{\columnwidth}{>{\lcol}p{6em} l X}
                ...
                Cleanse\fn{2}            & \tdash       & Quickly remove all \glossterm{conditions} \\
                ...
                Recover\fn{2}            & \tdash       & Regain all hit points                     \\
                Shove                    & Fort         & Move a foe                                \\
                Sprint\fn{2}             & \tdash       & Move at double speed                      \\
            ...
            2. This ability costs an \glossterm{action point} to use. \\
        \end{dtable}
        ...
        \begin{apability}{\labeltext{Desperate Exertion}}[\glossterm{Swift}]
            ...
            You can use this ability multiple times to affect the same roll if you have the action points to do so, but the bonus does not stack.
        \end{apability}
...
\section{Character Advancement}\label{Character Advancement}
    ...
    \begin{itemize}
        ...
        \item At 3rd level, and every 3 levels thereafter, you gain an additional \glossterm{action point} (see \pcref{Action Points}).
    ...
    \begin{dtable}
        ...
        3. This is the number of \glossterm{action points} you have (see \pcref{Action Points}). \\
    \end{dtable}
