...
\section{Movement and Positioning}\label{Movement and Positioning}
    ...
    \subsection{Movement Modes}\label{Movement Modes}
        ...
        Flying has the \glossterm{Focus} tag, so a creature that flies during the movement phase takes \glossterm{focus penalties} for the rest of the round (see \pcref{Focus}).
