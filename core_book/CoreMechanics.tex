    ...
    \subsection{Attribute Descriptions}
        ...
        \parhead{Intelligence (Int)}\label{Intelligence}
        {
            ...
            \begin{itemize}
                ...
                \item You apply your base Intelligence as a bonus or penalty to Intelligence-based \glossterm{skills}: Craft, Deduction, Disguise, Heal, Knowledge, and Linguistics (see \pcref{Skills}).
...
\section{Taking Damage}\label{Taking Damage}
    ...
    \subsection{Vital Wounds}\label{Vital Wounds}
        ...
        \subsubsection{Vital Rolls}\label{Vital Rolls}
            ...
            \parhead{Vitality Bonuses}\label{Vitality Bonuses}
            Some effects can give you a \glossterm{vitality bonus} to the \glossterm{vital roll} for a \glossterm{vital wound} you have already suffered.
            If your \glossterm{vital roll} changes retroactively, whether through a vitality bonus or some other means, it changes the effect of that \glossterm{vital wound}.
            ...
            \begin{dtable}
                ...
                \begin{dtabularx}{\textwidth}{l X}
                    ...
                    1               & Your maximum \glossterm{hit points} are reduced by 2          \\
...
\section{Circumstances, Bonuses, and Penalties}
    ...
    \subsection{Stacking Rules}\label{Stacking Rules}
        ...
        \begin{itemize}
            ...
            \item Vitality bonuses do not stack with each other (see \pcref{Vitality Bonuses}).
