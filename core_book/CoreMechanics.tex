    ...
    \subsection{Attribute Descriptions}
        ...
        \parhead{Strength (Str)}\label{Strength}
        {
            ...
            \begin{itemize}
                ...
                \item If your base Strength is at least 2, you are \glossterm{trained} with Strength-based skills.
            \end{itemize}
        }
        ...
        \parhead{Dexterity (Dex)}\label{Dexterity}
        {
            ...
            \begin{itemize}
                ...
                \item If your base Dexterity is at least 2, you are automatically \glossterm{trained} with Dexterity-based skills.
            \end{itemize}
        }
        ...
        \parhead{Constitution (Con)}\label{Constitution}
        {
            ...
            \begin{itemize}
                ...
                \item If your base Constitution is at least 2, you are automatically \glossterm{trained} with the Constitution-based skill.
            \end{itemize}
        }
        ...
        \parhead{Intelligence (Int)}\label{Intelligence}
        {
            ...
            \begin{itemize}
                ...
                \item If your base Intelligence is at least 2, you are automatically \glossterm{trained} with Intelligence-based skills.
            \end{itemize}
        ...
        \parhead{Perception (Per)}\label{Perception}
        {
            ...
            \begin{itemize}
                ...
                \item If your base Perception is at least 2, you are automatically \glossterm{trained} with Perception-based skills.
...
\section{Taking Damage}\label{Taking Damage}
    ...
    When you are hit by a damaging attack, you lose a \glossterm{hit point} (see \pcref{Hit Points}).

    If the attack deals at least as much damage as your \glossterm{wound resistance}, the attack \glossterm{wounds} you.
    ...
    \begin{dtable}
        ...
        \begin{dtabularx}{\columnwidth}{l *{2}{>{\ccol}X}}
            \tb{Total}\fn{1} & \tb{Wound Resistance} & \tb{Vital Resistance} \tableheaderrule
        ...
        1. This is your \glossterm{wound resistance} (see \pcref{Wound Resistance}). \\
        2. This is your \glossterm{vital resistance} (see \pcref{Vital Resistance}). \\
        3. To calculate the wound resistance for a creature with an epic Constitution, increase its wound resistance by 5 per point, and its vital resistance by 10 per point.
    \end{dtable}

    \subsection{Resistances}\label{Resistances}

        \subsubsection{Wound Resistance}\label{Wound Resistance}
            Your \glossterm{wound resistance} measures your ability to reduce the impact of minor damaging attacks.
            ...
            \parhead{Missing Wound Resistance} An object or creature without a listed \glossterm{wound resistance} loses a single \glossterm{hit point} from damaging attacks.
        ...
        \subsubsection{Damage Type Resistances}\label{Damage Type Resistances}
            ...
            Your \glossterm{wound resistance} and \glossterm{vital resistance} apply against damage of any type.
    ...
    \subsection{Hit Points}\label{Hit Points}
        ...
        \subsubsection{Missing Hit Points}\label{Missing Hit Points}
            Most objects and some creatures have no \glossterm{hit points} or \glossterm{wound resistance}.
        ...
        \subsubsection{Becoming Bloodied}\label{Becoming Bloodied}
            ...
            While you are bloodied, your \glossterm{vital resistance} is halved, to a minimum of your \glossterm{wound resistance} for each corresponding type of damage.
    ...
    \subsection{Special Damage Types}\label{Special Damage Types}
        ...
        \subsubsection{Subdual Damage}\label{Subdual Damage}
            ...
            A \glossterm{vital roll} of 0 or lower from subdual damage causes the target to fall unconscious until the \glossterm{vital wound} is removed.
        ...
        \subsubsection{Environmental Damage}\label{Environmental Damage}
            ...
            If a creature would take \glossterm{environmental damage} that is less than its \glossterm{wound resistance}, it does not take the damage and does not lose any \glossterm{hit points}.
...
\section{Fatigue}\label{Fatigue}
    ...
    While \glossterm{hit points} are easy to restore, \glossterm{fatigue} generally requires a \glossterm{long rest} to remove.
...
\section{Circumstances, Bonuses, and Penalties}
    ...
    \subsection{Size in Combat}\label{Size in Combat}
        ...
        \subsubsection{Reach}\label{Reach}
            ...
            Enemies within a creature's reach are considered \glossterm{threatened} (see \pcref{Overwhelm Penalties}).
...
\section{Ability Mechanics}\label{Ability Mechanics}
    ...
    \subsection{Conditions}\label{Conditions}
        ...
        You can remove conditions by taking a \glossterm{short rest} or using the \textit{cleanse} ability (see \pcref{Cleanse}).
    ...
    \subsection{Damage Types}\label{Damage Types}
        ...
        \subsubsection{Multiple Damage Types}\label{Multiple Damage Types}
            ...
            If you were hit with a strike with that longsword, you would use the lower of your \glossterm{wound resistance} against \glossterm{physical damage} and your \glossterm{wound resistance} against \glossterm{energy damage} to resist the damage.
...
\section{Universal Abilities}\label{Universal Abilities}
    ...
    \subsection{Special Combat Abilities}\label{Special Combat Abilities}
        ...
        \begin{freeability}{\labeltext{Desperate Exertion}}[\glossterm{Swift}]
            ...
            You must reroll the entire roll, not just one die from the roll (such as if the original roll \glossterm{exploded}).
        ...
        \parhead{Offhand Strike} As a \glossterm{minor action}, you can use the \textit{offhand strike} ability to quickly attack with an offhand weapon while you attack with a primary weapon.
        \begin{freeability}{Offhand Strike}\label{Offhand Strike}
...
\section{Special Rules}
    ...
    \subsection{Teleportation}\label{Teleportation}
        ...
        \subsubsection{Teleportation Noise}\label{Teleportation Noise}
            ...
            \begin{itemize*}
                \itemhead{Fine} 30
                \itemhead{Diminutive} 25
                \itemhead{Tiny} 20
                \itemhead{Small} 15
                \itemhead{Medium} 10
                \itemhead{Large} 5
                \itemhead{Huge} 0
                \itemhead{Gargantuan} \minus5
                \itemhead{Colossal} \minus10
            \end{itemize*}
...
\section{Character Advancement}\label{Character Advancement}
    ...
    \begin{dtable}
        ...
        3. This is the number of \glossterm{attumenent points} you have (see \pcref{Attunement Points}). \\
    \end{dtable}
    ...
    \subsection{Leveling Up}
        ...
        \begin{itemize}
            ...
            \item Your \glossterm{wound resistance} and \glossterm{vital resistance} increase (see \tref{Resistance Values}).
