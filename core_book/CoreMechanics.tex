...
\section{Unusual Combat Situations}
    ...
    \subsection{Mounted Combat}\label{Mounted Combat}
        ...
        The \glossterm{difficulty rating} for all Ride checks on a mount using a fly speed is increased by 10 if the mount has poor or average maneuverablity, or by 15 if it has perfect maneuverability.
