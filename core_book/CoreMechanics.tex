...
\section{Attacks}
    ...
    \subsection{Glancing Blows}\label{Glancing Blows}
        Many attacks have a reduced effect if they miss by 2 or less instead of having no effect at all.
...
\section{Damage}\label{Damage}
    ...
    \subsection{Vital Wounds}\label{Vital Wounds}
        ...
        \subsubsection{Vital Threshold}\label{Vital Threshold}
            ...
            For each multiple of your \glossterm{vital resistance} that you take in damage from a single attack, you gain a \glossterm{vital wound}.
            ...
            \parhead{Bloodied}\label{Bloodied}
            As your hit points get lower, you become more vulnerable to vital wounds.
            ...
            While you are bloodied, your \glossterm{vital threshold} is halved.
...
\section{Attributes}\label{Attributes}
    ...
    \subsection{Attribute Descriptions}
        ...
        \parhead{Constitution (Con)}\label{Constitution}
        {
            ...
            It has the following effects:
            \begin{itemize}
                \item You gain a bonus (or penalty) to the number of hit points you gain each level equal to your base Constitution (see \pcref{Hit Points}).
...
\section{Resources}\label{Resources}
    ...
    \subsection{Fatigue}\label{Fatigue}
        ...
        \subsubsection{Fatigue Points}\label{Fatigue Points}
            ...
            \subsubsection{Fatigue Tolerance}\label{Fatigue Tolerance}
                You can gain a number of \glossterm{fatigue points} equal to 1 \add your base Constitution \add your base Willpower without suffering any consequences (minimum 0).
    ...
    \subsection{Hit Points}\label{Hit Points}
        ...
        Whenever you take damage, ignoring damage prevented by your \glossterm{resistances}, you lose that many hit points (see \pcref{Taking Damage}).
        ...
        At 1st level, you have a number of hit points equal to 10 \add twice your base Constitution.
        Each level after that, you gain a number of hit points equal to 5 \add your base Constitution.
        Some special abilities can give you additional hit points.
...
\section{Character Statistics}
    ...
    \subsection{Power}\label{Power}
        ...
        Your power with magical abilities is normally equal to your Willpower.

        \parhead{Mundane Abilities}
        Your power with mundane abilities is normally equal to your Strength.
    ...
    \subsection{Damage}\label{Damage}
        ...
        \parhead{Dealing vs. Taking Damage}
        You deal damage whenever you hit with a damaging attack, regardless of whether the target prevents the damage with its \glossterm{resistances}.
        The target of an attack only takes damage if the attack deals more damage than its remaining resistances.
        Many special abilities require the target to take damage from your attacks, which does not happen if the damage is prevented by resistances..
    ...
    \subsection{Resistances}\label{Resistances}
        ...
        Whenever you would take damage, you first reduce that damage by an amount equal to your resistance against that damage type.
        If you reduce damage to zero with your resistance, you completely prevent the damage, and you are not considered to have taken damage from the attack.
        You reduce your remaining resistance by an amount equal to the damage prevented this way.
        ...
        Many attacks have speciifc consequences if you take damage from them, and resistances can protect you from those consequences.
        ...
        All creatures have a resistance to \glossterm{physical damage} equal to their Constitution, and a resistance to \glossterm{energy damage} equal to their Willpower.
...
\section{Universal Abilities}\label{Universal Abilities}
    ...
    \subsection{Strikes}\label{Strikes}
        ...
        \subsubsection{Strike Damage}\label{Strike Damage}
            The damage you deal with a single \glossterm{strike} is equal to the weapon's damage die \add your \glossterm{power} with the strike.
            Many abilities modify the weapon damage die or the power you use to determine damage with strikes.
            Weapon damage dice are defined in the Equipment chapter (see \pcref{Weapons}).
            Almost all strikes are considered \glossterm{mundane} abilities, so you would use your \glossterm{power} with mundane abilities to determine their damage.
