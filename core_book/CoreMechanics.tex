...
\section{Ability Mechanics}\label{Ability Mechanics}
    ...
    \subsection{Area}\label{Area}
        ...
        All areas have a \glossterm{point of origin}, an area shape, a measurement of their size in feet, and an an \glossterm{area type}.
    ...
    \subsection{Combat Maneuvers}\label{Combat Maneuvers}
        ...
        \begin{dtable}
            ...
            \begin{dtabularx}{\columnwidth}{l l X}
                ...
                Trip        & Fortitude and Reflex & Trip a foe                      \\
            \end{dtabularx}
        \end{dtable}
