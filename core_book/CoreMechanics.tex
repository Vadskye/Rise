    ...
    \subsection{Attribute Descriptions}
        ...
        \parhead{Strength (Str)}\label{Strength}
        {
            ...
            \begin{itemize}
                ...
                \item Strength affects Strength-based \glossterm{skills}: Climb, Jump, and Swim (see \pcref{Skills}).
        ...
        \parhead{Dexterity (Dex)}\label{Dexterity}
        {
            ...
            It has the following effects:
            \begin{itemize}
                \item Dexterity affects Dexterity-based \glossterm{skills}: Acrobatics, Escape Artist, Ride, Sleight of Hand, and Stealth (see \pcref{Skills}).
        ...
        \parhead{Intelligence (Int)}\label{Intelligence}
        {
            ...
            \begin{itemize}
                ...
                \item Your Intelligence affects Intelligence-based \glossterm{skills}: Craft, Deduction, Disguise, Heal, Knowledge, and Linguistics (see \pcref{Skills}).
        ...
        \parhead{Perception (Per)}\label{Perception}
        {
            ...
            It has the following effects:
            \begin{itemize}
                \item Your Perception affects Perception-based \glossterm{skills}: Awareness, Creature Handling, Sense Motive, Spellcraft, and Survival (see \pcref{Skills}).
...
\section{Taking Damage}\label{Taking Damage}
    ...
    \subsection{Becoming Fragile}\label{Becoming Fragile}
        As your hit points get lower, you become more vulnerable to damage.
        At the end of each round, if you have 3 or fewer \glossterm{hit points} remaining, you become \glossterm{fragile}.
        Likewise, if you have 4 or more \glossterm{hit points}, you stop being \glossterm{fragile}.

        While you are fragile, your \glossterm{wound resistance} is halved, to a minimum of your \glossterm{damage resistance} for each corresponding type of damage.
        If your maximum hit points are 3 or fewer, you are always \glossterm{fragile}.
        Some weak monsters are always \glossterm{fragile} for this reason.
...
\section{Universal Abilities}\label{Universal Abilities}
    ...
    \subsection{Special Combat Abilities}\label{Special Combat Abilities}
        ...
        \begin{apability}{\labeltext{Recover}}[\glossterm{Swift}]
            ...
            If this restores you to four or more \glossterm{hit points}, you immediately stop being \glossterm{fragile}.
        \end{apability}
...
\section{Character Advancement}\label{Character Advancement}
    ...
    \begin{dtable*}
        ...
        \begin{dtabularx}{\textwidth}{*{4}{>{\lcol}l} *{4}{>{\lcol}X}}
            ...
            % Damage doubles every 6 levels; anchor points are 0th (12), 6th, 12th, 18th
            1st     & 0  & 14 & 0      & 1      & \tdash & 4
            \\ 2nd  & 0  & 16  & 20     & 2      & \tdash & \tdash
            \\ 3rd  & 1  & 18  & 50     & \tdash & \tdash & 5
            \\ 4th  & 2  & 21  & 90     & \tdash & \tdash & \tdash
            \\ 5th  & 3  & 24  & 150    & 3      & \tdash & \tdash
            \\ 6th  & 4  & 27  & 230    & \tdash & 1      & \tdash
            \\ 7th  & 5  & 30  & 350    & \tdash & \tdash & \tdash
            \\ 8th  & 6  & 34  & 510    & 4      & \tdash & \tdash
            \\ 9th  & 8  & 38  & 750    & \tdash & \tdash & 6
            \\ 10th & 10 & 43  & 1,050  & \tdash & \tdash & \tdash
            \\ 11th & 12 & 48  & 1,550  & 5      & \tdash & \tdash
            \\ 12th & 14 & 54  & 2,200  & \tdash & 2      & \tdash
            \\ 13th & 16 & 61  & 3,150  & \tdash & \tdash & \tdash
            \\ 14th & 18 & 69  & 4,450  & 6      & \tdash & \tdash
            \\ 15th & 21 & 77  & 6,350  & \tdash & \tdash & 7
            \\ 16th & 24 & 86  & 8,900  & \tdash & \tdash & \tdash
            \\ 17th & 27 & 96  & 13,000 & 7      & \tdash & \tdash
            \\ 18th & 30 & 108 & 18,000 & \tdash & 3      & \tdash
            \\ 19th & 33 & 122 & 25,500 & \tdash & \tdash & \tdash
            \\ 20th & 36 & 136 & 36,000 & 8      & \tdash & \tdash
        \end{dtabularx}
