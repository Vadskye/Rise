...
\section{Character Statistics}
        ...
        \subsubsection{Attribute Descriptions}
            ...
            \parhead{Constitution (Con)}\label{Constitution}
                ...
                \begin{itemize}
                    ...
                    \item You heal additional \glossterm{vital damage} when you take a \glossterm{long rest} based on your starting Constitution (see \pcref{Short Rest}).
    ...
    \subsection{Damage}\label{Damage}
        ...
        If you take damage in excess of your \glossterm{hit points}, the excess damage is dealt as \glossterm{vital damage}, which represents potentially life-threatening injuries (see \pcref{Vital Damage}).
...
\section{Universal Abilities}\label{Universal Abilities}
    ...
    \subsection{Special Combat Abilities}\label{Special Combat Abilities}
        ...
        \begin{apability}{\labeltext{Charge}}
            When you use this ability, you take \glossterm{subdual damage} equal to your level.
...
\section{Injury, Death, and Healing}\label{Injury, Death, and Healing}
    ...
    \subsection{Vital Damage}\label{Vital Damage}
        At the end of each phase, if you have taken damage in excess of your remaining hit points, the excess damage is converted into \glossterm{vital damage}.
    ...
    \subsection{Stages of Injury}
        ...
        If you end a phase with \glossterm{vital damage} and no hit points remaining, you begin \glossterm{dying}, as described below.
        ...
        \parhead{Dying}\label{Dying} At the end of each phase, if you have \glossterm{vital damage} and have no hit points remaining, you begin \glossterm{dying}.
        Immediately after you begin dying, and at the end of each \glossterm{action phase} in subsequent rounds, you make a \glossterm{stabilization check}.
        To make a stabilization check, roll 1d10 and add your Fortitude defense.
        The \glossterm{difficulty rating} of this check is 10.
        Success means that you suffer no immediate adverse effects.
        Failure means you fall unconscious.

        If you succeed at this check three times, you stabilize, and are no longer considered to be \glossterm{dying}.
        Taking additional damage after stabilizing means you begin \glossterm{dying} again, and you ignore any previous successes or failures on \glossterm{stabilization checks}.
    ...
    \subsection{Subdual Damage}\label{Subdual Damage}
        ...
        % This makes subdual damage actually better at knocking creatures unconscious than non-subdual damage, but that doesn't seem to be a narrative problem?
        At the end of each phase, if a creature has subdual damage in excess of its hit points, it immediately falls unconscious.

    \subsection{Losing Hit Points}\label{Losing Hit Points}
        ...
        Because effects that cause you to lose hit points do not deal damage, they never cause you to take \glossterm{vital damage}.
...
\section{Daily Resources}
    ...
    \subsection{Resting}\label{Resting}
        ...
        \subsubsection{Long Rest}\label{Long Rest}
            ...
            \begin{itemize}
                \item You heal \glossterm{vital damage} equal to your starting Constitution \add half your level, to a minimum of 1 vital damage.
                    The Heal skill can increase this healing (see \pcref{Accelerate Recovery}).
...
\section{Character Advancement}\label{Character Advancement}
    ...
    \begin{dtable}
        ...
        4. You gain access to \glossterm{legend points} at this level.
    \end{dtable}

    \subsection{Leveling Up}
        When you gain a level, the following things happen:
        \begin{itemize}
            \item Your hit points increase (see \pcref{Hit Points})
