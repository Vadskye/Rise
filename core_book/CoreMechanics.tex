...
\section{Character Statistics}
    ...
    \subsection{Taking Damage}\label{Taking Damage}
        ...
        \subsubsection{Wound Threshold}\label{Wound Threshold}
            ...
            If you gain or remove \glossterm{fatigue} or \glossterm{exhaustion} during a round, your \glossterm{wound threshold} is not recalculated until the start of the next round.
