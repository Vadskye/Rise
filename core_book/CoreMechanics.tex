    ...
    \subsection{Base Attributes}\label{Base Attributes}
        ...
        \begin{dtable}
            ...
            \begin{dtabularx}{\columnwidth}{l X}
                ...
                4\add               & \plus1 per level after 1st, and an additional \plus1 at every even level \\
            \end{dtabularx}
        \end{dtable}
...
\section{Resources}\label{Resources}
    ...
    \subsection{Hit Points}\label{Hit Points}
        ...
        The number of hit points you have is based on your level, as defined in \tref{Base Hit Points and Resistances}.
        ...
        \begin{dtable}
            \lcaption{Base Hit Points and Resistances}
            \begin{dtabularx}{\columnwidth}{l X X}
                \tb{Level}    & \tb{Hit Points}  & \tb{Resistances}\fn{1} \tableheaderrule
                1             & 11               & 2  \\
                2             & 12               & 3  \\
                3             & 13               & 3  \\
                4             & 15               & 3  \\
                ...
                23            & 140             & 35 \\
                24            & 155             & 39 \\
                25\plus\fn{2} & \tdash          & \tdash\\
            \end{dtabularx}
            1. This bonus applies to both your \glossterm{resistance} to \glossterm{physical damage} and your resistance to \glossterm{energy damage}.
            2. For each level beyond 25, a creature increases its maximum hit points by 15 and its maximum resistances by 4.
        \end{dtable}
        ...
        \subsubsection{Regaining Hit Points}\label{Regaining Hit Points}
            ...
            % TODO: should this stay in the new HP system?
...
\section{Character Statistics}
    ...
    \subsection{Resistances}\label{Resistances}
        ...
        The base value of your resistances is based on your level, as defined in \tref{Base Hit Points and Resistances}.
        ...
        \parhead{Common Resistance Sources}
    ...
    \subsection{Grappling}\label{Grappling}
        ...
        \subsubsection{Grapple Actions}\label{Grapple Actions}
            ...
            \begin{freeability}{Move Grapple}
                ...
                If you hit every defense and beat every attack result, you can move yourself and all other creatures grappled by you a distance up to half your speed.
            \end{freeability}
...
\section{Character Advancement}\label{Character Advancement}
    ...
    \begin{dtable}
        ...
        \begin{dtabularx}{\columnwidth}{*{2}{>{\lcol}l} *{3}{>{\lcol}X}}
            \tb{Level} & \tb{XP} & \tb{Max Rank}\fn{1} & \tb{Legacy Item}\fn{2} & \tb{Attunement Points}\fn{3} \tableheaderrule
            1st        & 0       & 1                   & \tdash                 & 1      \\
            2nd        & 20      & \tdash              & \tdash                 & 2      \\
            3rd        & 50      & \tdash              & 1                      & \tdash \\
            4th        & 90      & 2                   & \tdash                 & \tdash \\
    ...
    \subsection{Leveling Up}
        ...
        \begin{itemize}
            \item Your \glossterm{hit points} and \glossterm{resistances} increase (see \tref{Base Hit Points and Resistances}).
