...
\section{Character Statistics}
    ...
    \subsection{Power}\label{Power}
        ...
        For example, \glossterm{strikes} use your \glossterm{power} with mundane abiliites to determine how much damage they deal.
    ...
    \subsection{Damage}\label{Damage}
        ...
        \subsubsection{Strike Damage}\label{Strike Damage}
            The damage you deal with a single \glossterm{strike} from a weapon is equal to \glossterm{standard damage} based on your \glossterm{power} with \glossterm{mundane} abilities.
