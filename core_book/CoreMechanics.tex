...
\section{Attacks and Checks}\label{Attacks and Checks}
    ...
    \subsection{Strikes}
        ...
        All strikes are \glossterm{physical}, \glossterm{mundane} abilities.
...
\section{Combat Overview}
    ...
    \subsection{Special Actions}
        ...
        As a standard action, if you have no action points remaining, you can use this ability.
        Creatures without action points can also use this ability.
        \begin{ability}
            \begin{spelleffects}
...
\section{Character Statistics}
    ...
    \subsection{Damage}\label{Damage}
        ...
        \subsubsection{Strike Damage}\label{Strike Damage}
            ...
            Your \glossterm{strike damage} with a weapon is equal to the weapon's base damage die \plus1d for every 2 levels or Strength you have, whichever is higher.
            For example, if you have a Strength of 4, your damage dice with a strike using a longsword, which has a 1d8 damage die, would be 2d6.
        ...
        \subsubsection{Defense Values}\label{Defense Values}
            ...
            \begin{dtable!*}
                ...
                \begin{dtabularx}{\textwidth}{l l l l >{\lcol}X}
                    \tb{Defense Name} & \tb{Attributes} & \tb{Body Armor Modifier} & \tb{Shield Modifier} & \tb{Size Modifier} \\
                    \midrule
                    Armor defense     & Dex or Con & Yes & Yes & No  \\
                    Fortitude defense & Con or Str & No  & No  & Yes \\
                    Reflex defense    & Dex or Per & No  & Yes & Yes \\
                    Mental defense    & Wil or Int & No  & No  & No  \\
                \end{dtabularx}
            \end{dtable!*}
...
\section{Daily Resources}
    ...
    \subsection{Action Points}\label{Action Points}
        ...
        You can gain additional action points from your class, from your Intelligence, and from some special abilities.
...
\section{Character Advancement}\label{Character Advancement}
    ...
    \begin{itemize}
        ...
        % TODO: decide action point scaling
    ...
    \begin{dtable}
        ...
        \begin{dtabularx}{\columnwidth}{*{3}{>{\lcol}l} >{\lcol}X}
            ...
            3rd        & 5,000     & 2nd        & \tdash             \\
            4th        & 9,000     & \tdash     & 1st                \\
            5th        & 15,000    & \tdash     & \tdash             \\
            6th        & 23,000    & 3rd        & \tdash             \\
            7th        & 35,000    & \tdash     & \tdash             \\
            8th        & 51,000    & \tdash     & 2nd                \\
            9th        & 75,000    & \tdash     & \tdash             \\
            10th       & 105,000   & 4th        & \tdash             \\
            11th       & 155,000   & \tdash     & \tdash             \\
            12th       & 220,000   & \tdash     & 3rd                \\
            13th       & 315,000   & \tdash     & \tdash             \\
            14th       & 445,000   & \tdash     & \tdash             \\
            15th       & 635,000   & \tdash     & \tdash             \\
            16th       & 890,000   & \tdash     & 4th                \\
            17th       & 1,300,000 & \tdash     & \tdash             \\
            18th       & 1,800,000 & \tdash     & \tdash             \\
            19th       & 2,550,000 & \tdash     & \tdash             \\
            20th       & 3,600,000 & \tdash     & 5th                \\
        \end{dtabularx}
