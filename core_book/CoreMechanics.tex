...
\section{Damage}\label{Damage}
    ...
    You deal damage whenever you hit with a damaging attack, regardless of whether the target loses hit points or only \glossterm{resistances} (see \pcref{Resistances}).
        ...
        Unless otherwise specified, a creature with a fly speed has average maneuverability.
            ...
            \begin{itemize}
                \item Defense penalties: Whenever the creature flies, it takes a \minus2 penalty to Armor and Reflex defenses until the end of the round.
                    This is a \abilitytag{Swift} effect, so it affects attacks made against the creature during the phase that it flies.
...
\section{Ability Mechanics}\label{Ability Mechanics}
    ...
    \subsection{Ability Durations}
        ...
        \subsubsection{Sustained Abilities}\label{Sustained Abilities}
            ...
            Taking an action to sustain an ability is not a \abilitytag{Focus} ability, even if the ability itself has the abilitytagglossterm{Focus} tag.
...
\section{Character Statistics}
    ...
    \subsection{Resistances}\label{Resistances}
        ...
        If the damage is less than your remaining resistance, you do not lose any hit points.
...
\section{Universal Abilities}\label{Universal Abilities}
    ...
    \subsection{Special Combat Abilities}\label{Special Combat Abilities}
        ...
        \begin{freeability}{\labeltext{Desperate Exertion}}[\abilitytag{Swift}]
        ...
        \begin{freeability}{\labeltext{Total Defense}}[\abilitytag{Swift}]
...
\section{Spell and Ritual Mechanics}\label{Spell and Ritual Mechanics}
    ...
    \subsection{Ability Tags}
        All spells have the \abilitytag{Spell} \glossterm{ability tag}, and all rituals have the \abilitytag{Ritual} ability tag.
