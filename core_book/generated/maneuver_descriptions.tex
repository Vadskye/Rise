...
\rankline
\rank{4} If you have movement remaining after using this ability during the \glossterm{action phase}, you gain a \plus2 bonus to Armor and Reflex defenses in the \glossterm{delayed action phase}.
\rank{6} The damage penalty is removed.
