...
Each \glossterm{ally} that can hear you gains a \plus1 bonus to \glossterm{accuracy} with \glossterm{physical attacks} until the end of the next round.
This does not affect attacks during the current phase.

\rankline
\rank{3} The ability also affects you.
\rank{5} Each target also gains a \plus2 bonus to Mental defense.
...
\begin{freeability}{Focused Strike}[\glossterm{Focus}]
Make a melee \glossterm{strike} with a \minus1d penalty to damage.
