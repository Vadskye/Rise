...
\targets{As chosen \glossterm{strike}}
Make a \glossterm{strike} with a \minus2 penalty to \glossterm{accuracy} and a \minus2d penalty to damage using a slashing weapon.
...
Make a ranged \glossterm{strike} with a \minus1d penalty to damage using a projectile weapon against each target.
