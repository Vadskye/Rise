...
For each previous consecutive round that you used this ability, you gain a \plus1 bonus to damage with the strike, up to a maximum of \plus3.
...
Make a \glossterm{strike}.
You take a \minus2d penalty to damage with the strike, and your \glossterm{power} is halved.
If the target takes damage from the strike, it takes a \minus2 penalty to \glossterm{accuracy} against creatures other than you as a \glossterm{condition}.
...
\begin{freeability}[Rank 2]{Fearsome Battlecry}[\glossterm{Emotion}]
...
\begin{freeability}[Rank 3]{Frightening Blow}[\glossterm{Emotion}]
\targets{As chosen \glossterm{strike}}
Make a \glossterm{strike}.
You take a \minus2d penalty to damage with the strike, and your \glossterm{power} is halved.
...
\begin{freeability}[Rank 3]{Stunning Headshot}[\glossterm{Emotion}]
\targets{As chosen \glossterm{strike}}
Make a \glossterm{strike} using a bludgeoning weapon.
You take a \minus2d penalty to damage with the strike, and your \glossterm{power} is halved.
If the target loses hit points from the strike, it is \glossterm{stunned} as a \glossterm{condition}.
...
\begin{freeability}[Rank 5]{Frightening Battlecry}[\glossterm{Emotion}]
\targets{\glossterm{Enemies} in a \areamed radius from you.}
Make an attack vs. Mental against each target.
...
\targets{As chosen \glossterm{strike}}
Make a \glossterm{strike} with a \plus4 accuracy bonus.
You take a \minus2d penalty to damage with the strike, and your \glossterm{power} is halved.
...
\begin{freeability}[Rank 6]{Confusing Headshot}[\glossterm{Emotion}]
\targets{As chosen \glossterm{strike}}
Make a \glossterm{strike} using a bludgeoning weapon.
You take a \minus2d penalty to damage with the strike, and your \glossterm{power} is halved.
...
\begin{freeability}[Rank 6]{Terrifying Blow}[\glossterm{Emotion}]
\targets{As chosen \glossterm{strike}}
Make a \glossterm{strike}.
You take a \minus2d penalty to damage with the strike, and your \glossterm{power} is halved.
...
\targets{All \glossterm{enemies} within your weapon's \glossterm{reach}}
Make two melee \glossterm{strikes} with a \minus2 penalty to \glossterm{accuracy} using a slashing weapon against each target.
You take a \minus2d penalty to damage with both strikes, and your \glossterm{power} is halved.
