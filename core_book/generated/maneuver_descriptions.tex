...
\begin{freeability}[Rank 1]{Demoralizing Battlecry}[\glossterm{Emotion}]
...
\begin{freeability}[Rank 4]{Terrifying Battlecry}[\glossterm{Emotion}]
\targets{\glossterm{Enemies} in a \areamed radius from you.}
Make an attack vs. Mental against each target.
...
\begin{freeability}[Rank 5]{Demoralizing Bellow}[\glossterm{Emotion}]
\targets{\glossterm{Enemies} in a \areahuge radius from you.}
Make an attack vs. Mental against each target.
