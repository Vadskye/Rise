...
\rankline
\rank{4} The ability also affects you.
\rank{6} Each target also gains a \plus2 bonus to Mental defense.
...
\rank{6} You also reroll any \glossterm{miss chances}, such as when attacking \glossterm{invisible} creatures, and take the better result.
...
\rank{6} As part of the same condition, target also moves at half speed while you \glossterm{threaten} it.
...
\rankline
\rank{4} You also gain a \plus1 bonus to \glossterm{accuracy} with the strike.
\rank{6} You reduce your \glossterm{focus penalties} with this ability by 1.
\rank{8} The accuracy bonus increases to \plus3.
...
\rankline
\rank{4} If you have a \glossterm{vital wound}, you regain two \glossterm{hit points} instead of one.
\rank{6} You can use the ability twice between \glossterm{short rests}.
\rank{8} You remove two \glossterm{hit points} regardless of whether you have a \glossterm{vital wound}.
\parhead{Lists} Esoteric, Primal, Wild
\end{freeability}
\vspace{0.25em}
...
\rankline
\rank{4} If you have movement remaining after using this ability during the \glossterm{action phase},
you gain a \plus2 bonus to Armor and Reflex defenses in the \glossterm{delayed action phase}.
\rank{6} The damage penalty is removed.
\rank{8} The bonus to defenses increases to \plus4.
\parhead{Lists} Esoteric, Trick, Wild
\end{freeability}
\vspace{0.25em}
...
\rankline
\rank{4} You gain a \plus1 bonus to \glossterm{accuracy} with the strike.
\rank{6} If the strike deals damage, the target is also \glossterm{sickened} as a \glossterm{condition}.
\rank{8} The accuracy bonus increases to \plus3.
