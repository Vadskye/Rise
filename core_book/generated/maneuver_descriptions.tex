...
\targets{As chosen \glossterm{strike}}
Make a melee \glossterm{strike} with a \minus1d penalty to damage using a bludgeoning weapon.
...
You can make a melee \glossterm{strike} with a \minus2 penalty to \glossterm{accuracy} from any location you occupy during the leap.
...
\rank{5} Each target can ignore two conditions instead of only one.
...
\rankline
\rank{3} The maximum size category of the target increases to two size categories larger than you
\rank{5} The maximum size category of the target increases to three size categories larger than you
\rank{7} The maximum size category of the target increases to four size categories larger than you
\parhead{Lists} Esoteric, Primal, Trick, Wild
\end{freeability}
\vspace{0.25em}
...
\targets{As chosen \glossterm{strike}}
Make a \glossterm{strike} with a \minus1d penalty to damage using a slashing weapon.
...
\rank{7} This condition cannot be removed until the target regains a \glossterm{hit point}
\parhead{Lists} Esoteric, Trick, Wild
\end{freeability}
\vspace{0.25em}
...
\targets{As chosen \glossterm{strike}}
Make a \glossterm{strike} with a \minus1d penalty to damage using a bludgeoning weapon.
...
\targets{As chosen \glossterm{strike}}
Make a \glossterm{strike} with a \plus1d bonus to damage using a piercing weapon.
...
\rank{7} The accuracy bonus increases to \plus8.
\parhead{Lists} Trick
\end{freeability}
\vspace{0.25em}
