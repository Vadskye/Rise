...
\begin{freeability}{Second Wind}[\glossterm{Life}]
You remove a point of \glossterm{fatigue}.
You can only use this ability once between \glossterm{short rests}.

\rankline
\rank{4} If you have a \glossterm{vital wound}, you remove two points of \glossterm{fatigue} instead of one.
\rank{6} You can use the ability twice between \glossterm{short rests}.
\rank{8} You remove two points of \glossterm{fatigue} regardless of whether you have a \glossterm{vital wound}.
\parhead{Lists} Esoteric, Primal, Wild
\end{freeability}
\vspace{0.25em}
...
\rank{6} The target gains a point of \glossterm{exhaustion} instead of a point of \glossterm{fatigue}.
\rank{8} The target gains two additional points of \glossterm{exhaustion} instead of one.
