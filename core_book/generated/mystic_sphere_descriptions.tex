...
\lowercase{\hypertarget{spell:Shadow Double}{}}\label{spell:Shadow Double}
\begin{freeability}[Rank 1]{\hypertarget{spell:Shadow Double}{Shadow Double}}[\glossterm{Focus}, \glossterm{Sustain} (minor)]
\targetrule
...
\lowercase{\hypertarget{spell:Shadowcaster}{}}\label{spell:Shadowcaster}
\begin{attuneability}[Rank 3]{\hypertarget{spell:Shadowcaster}{Shadowcaster}}[\glossterm{Attune} (self), \glossterm{Focus}]
\target{Yourself}
...
\lowercase{\hypertarget{spell:Quickseal}{}}\label{spell:Quickseal}
\begin{freeability}[Rank 4]{\hypertarget{spell:Quickseal}{Quickseal}}[\glossterm{Focus}]
\target{Yourself or an \glossterm{ally} within \rngmed range}
The target gains a \plus1 \glossterm{vitality bonus} to one of its \glossterm{vital rolls} (see \pcref{Vital Rolls}).
