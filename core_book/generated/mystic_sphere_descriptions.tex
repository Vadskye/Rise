...
\rankline
\rank{6} The target also gains a \plus1 \glossterm{magic bonus} to \glossterm{vital rolls} on \glossterm{vital wounds} from \glossterm{physical} damage.
...
\rankline
\rank{6} The target also gains a \plus1 \glossterm{magic bonus} to \glossterm{vital rolls} on \glossterm{vital wounds} from \glossterm{energy} damage.
\rank{8} The bonus increases to be equal to your \glossterm{power}.
\end{attuneability}
\vspace{0.25em}
...
\rankline
\rank{8} The target also gains a \plus1 \glossterm{magic bonus} to \glossterm{vital rolls}.
\end{attuneability}
\vspace{0.25em}
...
\target{Yourself}
The first time you gain a \glossterm{vital wound} during this effect, you gain a \plus2 bonus to its \glossterm{vital roll}.
...
In exchange, you gain a \plus4 bonus to \glossterm{vital rolls} and become immune to \glossterm{conditions}.
...
\target{Yourself or an \glossterm{ally} within \rngclose range}
A the end of each round, the target gains a \plus1 \glossterm{vitality bonus} to one of its \glossterm{vital rolls} (see \pcref{Vital Rolls}).
...
The target gains a \plus1 \glossterm{vitality bonus} to one of its \glossterm{vital rolls}, up to a maximum result of 0 (see \pcref{Vital Rolls}).
\end{freeability}
...
\crit As above, except that the target also takes a \minus2 penalty to \glossterm{vital rolls}.
...
\target{Yourself or an \glossterm{ally} within \rngclose range}
The target gains a \plus2 \glossterm{vitality bonus} to one of its \glossterm{vital rolls} (see \pcref{Vital Rolls}).
...
When this spell resolves, and the end of each subsequent round, each target gains a \plus2 \glossterm{vitality bonus} to one of its \glossterm{vital rolls} (see \pcref{Vital Rolls}).
