...
\begin{freeability}[Rank 1]{\hypertarget{spell:Antitoxin}{Antitoxin}}[\glossterm{Focus}, \glossterm{Sustain} (minor)]
...
\begin{freeability}[Rank 1]{\hypertarget{spell:Intensify Poison}{Intensify Poison}}[\glossterm{Focus}]
\target{One living creature within \rngmed range}
Make an attack vs. Fortitude against the target.
