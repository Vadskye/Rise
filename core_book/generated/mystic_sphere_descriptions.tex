...
\rankline
\rank{3} The attack gains a \plus1d bonus to damage.
...
\begin{freeability}[Rank 3]{\hypertarget{spell:Buffeting Blast}{Buffeting Blast}}[\glossterm{Focus}]
\target{One creature or object within \rnglong range}
...
\rankline
\rank{5} The attack gains a \plus1d bonus to damage.
...
\rankline
\rank{6} The attack gains a \plus1d bonus to damage and each target is moved 50 feet instead of 20 feet.
...
\begin{freeability}[Rank 4]{\hypertarget{spell:Windsnipe}{Windsnipe}}[\glossterm{Focus}]
\target{One creature or object within 2,000 foot range}
Make an attack vs. Armor against the target.
\hit The target takes bludgeoning \glossterm{standard damage}.

\rankline
\rank{6} The attack gains a \plus1d bonus to damage.
...
\begin{freeability}[Rank 1]{\hypertarget{spell:Raging River}{Raging River}}[\glossterm{Focus}]
\targets{Everything in a \arealarge, 10 ft. wide line from you}
Make an attack vs. Fortitude against each target.
\hit Each target takes bludgeoning \glossterm{standard damage} \minus1d.
...
\targets{Everything in a \areaext, 30 ft.\ wide line from you}
Make an attack vs. Fortitude against each target.
\hit Each target takes bludgeoning \glossterm{standard damage}.
\end{freeability}
\vspace{0.25em}
...
\rankline
\rank{8} The attack gains a \plus1d bonus to damage.
\end{freeability}
\vspace{0.25em}
