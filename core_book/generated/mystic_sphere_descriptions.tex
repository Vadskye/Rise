...
\begin{freeability}[Rank 1]{\hypertarget{spell:Blessed Strike}{Blessed Strike}}[\glossterm{Focus}, \glossterm{Swift}]
\target{Yourself or an \glossterm{ally} within \rngclose range}
...
\begin{attuneability}[Rank 1]{\hypertarget{spell:Verdant Armor}{Verdant Armor}}[\glossterm{Attune} (self), \glossterm{Focus}]
\target{Yourself}
