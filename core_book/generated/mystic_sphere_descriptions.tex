...
\target{Up to five gallons of water per rank within \rngclose range}
...
Moving yourself upwards costs twice the normal movement cost.
\hit The target takes bludgeoning damage equal to your \glossterm{power} \add 1d8 per rank.
...
\rank{6} You gain a \plus5 bonus to \glossterm{reach} with attacks using the tentacle.
\rank{8} The bonus to reach increases to \plus10 feet.
...
\hit Each target takes takes bludgeoning damage equal to your \glossterm{power} \add 1d8 per rank.
...
In addition, it takes physical damage equal to your \glossterm{power} \add 1d8 per rank.
...
\begin{freeability}[Rank 4]{\hypertarget{spell:Great Flood}{Great Flood}}[\glossterm{Focus}, \glossterm{Manifestation}]
\targets{Everything in a 10 ft.\ wide line from you that extends 20 ft.\ per rank}
Make an attack vs. Reflex against each target.
\hit Each target takes bludgeoning damage equal to half your \glossterm{power} \add 1d6 per rank.
