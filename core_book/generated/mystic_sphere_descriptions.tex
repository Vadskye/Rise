...
\begin{attuneability}[\nth{1}]{\hypertarget{spell:Windblade}{Windblade}}[\glossterm{Attune} (target), \glossterm{Focus}]
...
\begin{attuneability}[\nth{3}]{\hypertarget{spell:Greater Windblade}{Greater Windblade}}[\glossterm{Attune} (target), \glossterm{Focus}]
\target{Yourself or an \glossterm{ally} within \rngclose range}
