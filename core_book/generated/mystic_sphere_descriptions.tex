...
\rankline
\rank{5} The target also gains a \plus2 \glossterm{magic bonus} to \glossterm{power} with \glossterm{strikes}.
...
Make an attack vs. Mental against the target.
\hit The target takes energy \glossterm{standard damage} \minus1d and is \glossterm{confused} as a \glossterm{condition}.
\end{freeability}
\vspace{0.25em}
...
\lowercase{\hypertarget{spell:Holy Blade}{}}\label{spell:Holy Blade}
\begin{attuneability}[Rank 7]{\hypertarget{spell:Holy Blade}{Holy Blade}}[\glossterm{Attune} (self), \glossterm{Focus}]
\target{Yourself}
...
\begin{freeability}[Rank 6]{\hypertarget{spell:Dominate}{Dominate}}[\glossterm{Compulsion}, \glossterm{Focus}]
\target{One creature within \rngclose range}
Make an attack vs. Mental against the target.
...
\begin{freeability}[Rank 7]{\hypertarget{spell:Sleep}{Sleep}}[\glossterm{Compulsion}, \glossterm{Focus}]
\target{One creature within \rngmed range}
Make an attack vs. Mental against the target.
...
\rank{8} The damage increases to \glossterm{standard damage} \plus1.
\end{freeability}
\vspace{0.25em}
...
\begin{freeability}[Rank 6]{\hypertarget{spell:Curse of Blood}{Curse of Blood}}[\glossterm{Curse}, \glossterm{Focus}]
\target{One living creature within \rngclose range}
Make an attack vs. Mental against the target.
...
\begin{freeability}{Beautify}[\glossterm{Sensation}, \glossterm{Sustain} (free), \glossterm{Visual}]
\target{Yourself}
...
\rankline
\rank{3} The bonus to Stealth increases to \plus2.
\rank{5} The bonus to Armor defense increases to \plus2.
...
\target{One creature within \rngmed range}
Make an attack vs. Mental against the target.
\hit The target takes a \minus2 penalty to \glossterm{accuracy} and visual Awareness checks as a \glossterm{condition}.
...
\rankline
\rank{3} The strike gains a \plus1 bonus to \glossterm{accuracy}.
\rank{5} The accuracy bonus increases to \plus2.
\rank{7} The accuracy bonus increases to \plus3.
\end{freeability}
\vspace{0.25em}
...
\begin{attuneability}[Rank 4]{\hypertarget{spell:Shadow Mantle}{Shadow Mantle}}[\glossterm{Attune} (target), \glossterm{Focus}]
\target{Yourself or an \glossterm{ally} within \rngmed range}
...
The target gains a \plus1 \glossterm{magic bonus} to all defenses and to the Stealth skill.

\rankline
\rank{6} The bonus to Armor defense and Stealth increases to \plus2.
\rank{8} The bonus to all defenses increases to \plus2.
\end{attuneability}
\vspace{0.25em}
...
\begin{freeability}[Rank 4]{\hypertarget{spell:Lightburst}{Lightburst}}[\glossterm{Focus}, \glossterm{Sensation}, \glossterm{Visual}]
...
Bright light illuminates a 50 foot radius around the path the ray took until the end of the round.
In addition, make an attack vs. Reflex against the target.
\hit The target takes energy \glossterm{standard damage} \plus2d.
...
\begin{freeability}[Rank 8]{\hypertarget{spell:Pillars of Light}{Pillars of Light}}[\glossterm{Focus}, \glossterm{Sensation}, \glossterm{Visual}]
\targets{All creatures in the area (see text)}
...
\begin{attuneability}[Rank 1]{\hypertarget{spell:Regeneration}{Regeneration}}[\glossterm{Attune} (target), \glossterm{Focus}]
\target{Yourself or an \glossterm{ally} within \rngclose range}
A the end of each round, the target may gain a \plus1 bonus to the \glossterm{wound roll} of its most recent \glossterm{vital wound}.
...
\lowercase{\hypertarget{spell:Scorching Ray}{}}\label{spell:Scorching Ray}
\begin{freeability}[Rank 1]{\hypertarget{spell:Scorching Ray}{Scorching Ray}}[\glossterm{Focus}]
\target{One creature within \rngclose range}
Make an attack vs. Reflex against the target.
\hit The target takes fire \glossterm{standard damage} \plus1d.
...
\begin{attuneability}[Rank 4]{\hypertarget{spell:Flame Blade}{Flame Blade}}[\glossterm{Attune} (target), \glossterm{Focus}]
\target{Yourself or an \glossterm{ally} within \rngclose range}
...
\rankline
\rank{6} The target also gains a \plus2 \glossterm{magic bonus} to \glossterm{power} with \glossterm{strikes}.
% May be too strong
...
\begin{attuneability}[Rank 5]{\hypertarget{spell:Flame Aura}{Flame Aura}}[\glossterm{Attune} (self), \glossterm{Focus}]
...
\rankline
\rank{7} The damage increases to \glossterm{standard damage} \minus1d.
\end{attuneability}
\vspace{0.25em}



\lowercase{\hypertarget{spell:Immolation}{}}\label{spell:Immolation}
\begin{freeability}[Rank 6]{\hypertarget{spell:Immolation}{Immolation}}[\glossterm{Focus}]
\target{One creature within \rngmed range}
Make an attack vs. Fortitude against the target.
\hit The target is \glossterm{ignited} as a \glossterm{condition}.
...
\begin{freeability}[Rank 1]{\hypertarget{spell:Force Wave}{Force Wave}}[\glossterm{Focus}]
\targets{Everything in a \areamed cone from you}
Make an attack vs. Armor against each target.
\hit Each target takes bludgeoning \glossterm{standard damage}.
...
\begin{freeability}[Rank 1]{\hypertarget{spell:Earthspike}{Earthspike}}[\glossterm{Focus}]
\target{One creature or object within \rngmed range}
...
\targets{All Large or smaller creatures in a \areasmall radius within \rngmed range that are standing on earth or unworked stone}
...
\begin{attuneability}[Rank 4]{\hypertarget{spell:Quagmire}{Quagmire}}[\glossterm{Attune} (self), \glossterm{Focus}]
...
\begin{freeability}[Rank 5]{\hypertarget{spell:Fissure}{Fissure}}[\glossterm{Focus}]
\targets{Everything in a \areasmall radius within \rngmed range that is standing on earth or unworked stone}
...
\begin{freeability}[Rank 7]{\hypertarget{spell:Impaling Earthspike}{Impaling Earthspike}}[\glossterm{Focus}]
\target{One creature or object within \rngmed range}
You create a spike of earth from the ground.
Make an attack vs. Armor against the target.
The target must be within 5 feet of a Small or larger body of earth or stone.
\hit The target takes piercing \glossterm{standard damage} \minus2d and is \glossterm{immobilized} as a \glossterm{condition}.
...
\begin{freeability}[Rank 3]{\hypertarget{spell:Fire Seed}{Fire Seed}}[\glossterm{Focus}, \glossterm{Sustain} (free)]
...
\rankline
\rank{5} The damage increases to \glossterm{standard damage} \plus1d. In addition, you can create up to two seed bombs.
\rank{7} The damage increases to \glossterm{standard damage} \plus2d. In addition, you can create up to three seed bombs.
\end{freeability}
\vspace{0.25em}
...
\target{One creature within \rngmed range}
Make an attack vs. Fortitude against the target.
You gain a \plus2 bonus to \glossterm{accuracy} against a creature with 3 or fewer current \glossterm{hit points}.
...
\targets{Living \glossterm{enemies} in a \areasmall radius \glossterm{zone} from your location}
...
\begin{attuneability}[Rank 3]{\hypertarget{spell:Circle of Life}{Circle of Life}}[\glossterm{Attune} (self), \glossterm{Focus}]
\target{Yourself and each living \glossterm{ally} in a \glossterm{areasmall} radius \glossterm{zone} from your location}
When this spell resolves, and the end of each \glossterm{action phase} in subsequent rounds, each target gains a \plus2 bonus to the \glossterm{wound roll} of its most recent \glossterm{vital wound}.
...
\begin{freeability}[Rank 3]{\hypertarget{spell:Drain Life}{Drain Life}}[\glossterm{Focus}]
\target{One living creature within \rngclose range}
Make an attack vs. Fortitude against the target.
...
\begin{attuneability}[Rank 3]{\hypertarget{spell:Lifegift}{Lifegift}}[\glossterm{Attune} (target), \glossterm{Focus}]
\target{Yourself or an \glossterm{ally} within \rngclose range}
...
\begin{freeability}[Rank 7]{\hypertarget{spell:Harm}{Harm}}[\glossterm{Focus}]
\target{One creature within \rngclose range}
Make an attack vs. Fortitude against the target.
...
\rank{5} The damage dealt by the weapon increases to \glossterm{standard damage} \plus1d.
\rank{7} The damage dealt by the weapon increases to \glossterm{standard damage} \plus2d.
\end{freeability}
\vspace{0.25em}
...
\rank{8} The damage dealt by the weapon increases to \glossterm{standard damage} \plus1d.
\end{freeability}
\vspace{0.25em}
