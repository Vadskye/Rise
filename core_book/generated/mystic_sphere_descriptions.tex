...
\target{Yourself or an \glossterm{ally} within \rngclose range}
A the end of each round, the target may gain a \plus1 bonus to the \glossterm{vital roll} of its most recent \glossterm{vital wound}.
...
The target gains a \plus1 bonus to the \glossterm{vital roll} of its most recent \glossterm{vital wound}, up to a maximum of 0.
The \glossterm{vital roll} for that \glossterm{vital wound} cannot be modified again.
\end{freeability}
...
\target{Yourself or an \glossterm{ally} within \rngclose range}
The target gains a \plus2 bonus to the \glossterm{vital roll} of its most recent \glossterm{vital wound}.
The \glossterm{vital roll} for that \glossterm{vital wound} cannot be modified again.
...
When this spell resolves, and the end of each subsequent round, each target gains a \plus2 bonus to the \glossterm{vital roll} of its most recent \glossterm{vital wound}.
