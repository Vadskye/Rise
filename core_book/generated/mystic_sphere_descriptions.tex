...
The damage dealt increases to \glossterm{standard damage} \plus3d and becomes damage of all types.
\end{freeability}
\vspace{0.25em}
...
\target{One creature within \rngmed range}
Make an attack vs. Mental against the target.
\hit The target takes \glossterm{standard damage} \plus1d.
\end{freeability}
\vspace{0.25em}
...
\target{One creature within \rngmed range}
This spell functions like the \spell{divine judgment} spell, except that that damage increases to \glossterm{standard damage} \plus3d.
\end{freeability}
\vspace{0.25em}
...
\begin{freeability}[\nth{1}]{\hypertarget{spell:Sickening Decay}{Sickening Decay}}[\glossterm{Focus}]
...
\target{One living creature within \rngclose range}
This spell functions like the \spell{sickening decay} spell, except that the damage increases to \glossterm{standard damage} \minus1d.
...
Weapons wielded by the target gain a \plus2 \glossterm{magic bonus} to \glossterm{power} with \glossterm{strikes}.
