...
\hit The target takes a \minus2 penalty to defenses against ranged \glossterm{physical attacks} from weapons or projectiles that are Small or smaller until it takes a \glossterm{short rest}.
...
\lowercase{\hypertarget{spell:Dehydrating Curse}{}}\label{spell:Dehydrating Curse}
\begin{freeability}[Rank 3]{\hypertarget{spell:Dehydrating Curse}{Dehydrating Curse}}[\glossterm{Curse}, \glossterm{Focus}]
\target{One creature within \rngmed range}
Make an attack vs. Mental agains the target.
...
Make an attack vs. Mental against the target.
\hit The target takes fire \glossterm{standard damage} \minus2d and is \glossterm{ignited} as a \glossterm{condition}.
...
\parhead{Mystic Sphere Lists} Arcane, Divine, Hedge, Nature
...
\parhead{Mystic Sphere Lists} Arcane, Divine, Hedge, Pact
...
\parhead{Mystic Sphere Lists} Arcane, Divine, Hedge, Nature, Pact
...
\hit Each secondary target takes cold \glossterm{standard damage} \plus1d.
...
At the end of each round, it takes cold \glossterm{standard damage} \minus1d per round since it became affectd by this condition.
...
\begin{freeability}[Rank 4]{\hypertarget{spell:Acid Rain}{Acid Rain}}[\glossterm{Focus}, \glossterm{Manifestation}]
...
\begin{freeability}[Rank 1]{\hypertarget{spell:Copy Writing}{Copy Writing}}[\glossterm{Focus}, \glossterm{Sustain} (standard)]
...
\parhead{Mystic Sphere Lists} Arcane, Hedge
...
\begin{freeability}[Rank 4]{\hypertarget{spell:Darkness}{Darkness}}[\glossterm{Focus}, \glossterm{Sensation}, \glossterm{Visual}]
\targetrule
...
\begin{freeability}[Rank 6]{\hypertarget{spell:Sunburst}{Sunburst}}[\glossterm{Focus}, \glossterm{Sensation}, \glossterm{Visual}]
\targets{All creatures in the area (see text)}
...
\parhead{Mystic Sphere Lists} Arcane, Hedge, Nature, Pact
...
\targets{Yourself or one Small or larger \glossterm{ally} within \rngclose range}
...
You gain a \plus8 \glossterm{magic bonus} to the Escape Artist skill, and are immune to \glossterm{critical hits} from \glossterm{strikes}.
...
\parhead{Mystic Sphere Lists} Arcane, Divine, Hedge
...
\parhead{Mystic Sphere Lists} Hedge, Nature
...
\parhead{Mystic Sphere Lists} Divine, Hedge, Nature
...
\begin{freeability}[Rank 4]{\hypertarget{spell:Missile Storm}{Missile Storm}}[\glossterm{Focus}, \glossterm{Manifestation}]
\targets{Everything in a \areasmall radius within \rngmed range}
Make an attack vs. Armor against each target.
\hit Each target takes piercing \glossterm{standard damage}.
