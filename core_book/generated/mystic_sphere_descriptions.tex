...
\lowercase{\hypertarget{spell:Penetrating Windstrike}{}}\label{spell:Penetrating Windstrike}
\begin{freeability}[Rank 1]{\hypertarget{spell:Penetrating Windstrike}{Penetrating Windstrike}}[\glossterm{Focus}]
...
\item You gain a \plus8 \glossterm{magic bonus} to the Escape Artist skill
...
\begin{attuneability}[Rank 3]{\hypertarget{spell:Blessing of Persistence}{Blessing of Persistence}}[\glossterm{Attune} (target), \glossterm{Focus}]
\target{Yourself or an \glossterm{ally} within \rngclose range}
...
\target{Yourself}
The first time you gain a \glossterm{vital wound} during this effect, you gain a \plus2 bonus to its \glossterm{wound roll}.
...
\begin{freeability}[Rank 5]{\hypertarget{spell:Glimpse of Divinity}{Glimpse of Divinity}}[\glossterm{Focus}]
\target{One creature within \rngclose range}
Make an attack vs. Mental against the target.
\hit The target is \glossterm{blinded} as a \glossterm{condition}.
\end{freeability}
