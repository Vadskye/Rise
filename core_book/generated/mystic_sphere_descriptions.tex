...
\rank{8} The bonus increases to \plus10.
...
\lowercase{\hypertarget{spell:Divine Wrath}{}}\label{spell:Divine Wrath}
\begin{freeability}[Rank 1]{\hypertarget{spell:Divine Wrath}{Divine Wrath}}[\glossterm{Focus}]
\target{One creature within \rngmed range}
Make an attack vs. Mental against the target.
...
\rankline
\rank{4} You gain a \plus2 \glossterm{magic bonus} to \glossterm{power} with divine spells.
\rank{6} You gain a \plus1 \glossterm{magic bonus} to \glossterm{accuracy} with divine spells.
...
\rank{6} The accuracy bonus increases to \plus6.
\rank{8} The accuracy bonus increases to \plus8.
