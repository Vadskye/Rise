...
\begin{freeability}[\nth{1}]{\hypertarget{spell:Dimensional Jaunt}{Dimensional Jaunt}}[\glossterm{Planar}]
\target{One creature within \rngmed range}
...
\begin{freeability}[\nth{2}]{\hypertarget{spell:Banishment}{Banishment}}[\glossterm{Planar}]
\target{One creature within \rngmed range}
...
\begin{freeability}[\nth{2}]{\hypertarget{spell:Dimensional Jaunt -- Plane of Earth}{Dimensional Jaunt -- Plane of Earth}}[\glossterm{Planar}]
\target{One creature within \rngmed range}
...
\begin{attuneability}[\nth{3}]{\hypertarget{spell:Blink}{Blink}}[\glossterm{Attune} (target), \glossterm{Planar}]
\target{Yourself or an \glossterm{ally} within \rngclose range}
...
\begin{freeability}[\nth{3}]{\hypertarget{spell:Dimensional Jaunt -- Plane of Fire}{Dimensional Jaunt -- Plane of Fire}}[\glossterm{Planar}]
\target{One creature within \rngmed range}
...
\begin{freeability}[\nth{5}]{\hypertarget{spell:Dimensional Jaunt -- Myriad}{Dimensional Jaunt -- Myriad}}[\glossterm{Planar}]
\target{One creature within \rngmed range}
...
\begin{attuneability}[\nth{6}]{\hypertarget{spell:Greater Blink}{Greater Blink}}[\glossterm{Attune} (target), \glossterm{Planar}]
\target{Yourself or an \glossterm{ally} within \rngclose range}
...
\begin{freeability}[\nth{7}]{\hypertarget{spell:Dimensional Jaunt -- Deep Astral Plane}{Dimensional Jaunt -- Deep Astral Plane}}[\glossterm{Planar}]
\target{One creature within \rngmed range}
...
\begin{apability}[\nth{3}]{\hypertarget{spell:Plane Shift}{Plane Shift}}[\glossterm{Planar}]
...
\begin{apability}[\nth{4}]{\hypertarget{spell:Astral Projection}{Astral Projection}}[\glossterm{Planar}]
...
\begin{apability}[\nth{5}]{\hypertarget{spell:Homeward Shift}{Homeward Shift}}[\glossterm{Planar}]
\target{Up to five Large or smaller ritual participants}
...
\begin{apability}[\nth{7}]{\hypertarget{spell:Gate}{Gate}}[\glossterm{Planar}, \glossterm{Sustain} (standard)]
\targets{Special}
...
\target{One creature within \rngmed range}
This spell functions like the \spell{inflict wounds} spell, except that the damage increases to \glossterm{standard damage} \plus2d.
...
\begin{attuneability}[\nth{4}]{\hypertarget{spell:Greater Vital Persistence}{Greater Vital Persistence}}[\glossterm{Attune} (target)]
\target{Yourself or an \glossterm{ally} within \rngclose range}
...
Primary target: One living \glossterm{ally} within \rngmed range
\par\noindent
Secondary target: One other creature within that range

Make an attack vs. Fortitude against the secondary target.
\hit The secondary target takes damage equal to \glossterm{standard damage} \plus1d.
