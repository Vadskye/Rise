...
\begin{attuneability}[Rank 1]{\hypertarget{spell:Wind Screen}{Wind Screen}}[\glossterm{Attune} (self), \glossterm{Focus}]
\target{Yourself}
...
\rankline
\rank{4} The bonus increases to \plus15 feet.
...
\begin{attuneability}[Rank 2]{\hypertarget{spell:Blessing of Recovery}{Blessing of Recovery}}[\glossterm{Attune} (target), \glossterm{Focus}]
\target{Yourself or an \glossterm{ally} within \rngmed range}
The target gains a additional \plus5 bonus to a vital wound after a \glossterm{long rest} (see \pcref{Removing Vital Wounds}).

\rankline
\rank{4} The target gains two additional \plus5 bonuses.
\rank{6} The target gains three additional \plus5 bonuses.
\rank{8} The target gains four additional \plus5 bonuses.
...
\begin{attuneability}[Rank 2]{\hypertarget{spell:Blessing of Swiftness}{Blessing of Swiftness}}[\glossterm{Attune} (target), \glossterm{Focus}]
\target{Yourself or an \glossterm{ally} within \rngmed range}
...
\rankline
\rank{4} The speed bonus increases to \plus15 feet.
...
\begin{attuneability}[Rank 3]{\hypertarget{spell:Blessing of Mental Clarity}{Blessing of Mental Clarity}}[\glossterm{Attune} (target), \glossterm{Focus}]
\target{Yourself or an \glossterm{ally} within \rngmed range}
...
\begin{attuneability}[Rank 2]{\hypertarget{spell:Faithful Endurance}{Faithful Endurance}}[\glossterm{Attune} (self), \glossterm{Focus}]
\target{Yourself}
...
\rankline
\rank{4} The bonus increases to \plus2.
...
\rankline
\rank{5} You gain a \plus1 \glossterm{magic bonus} to \glossterm{accuracy} with the attack.
\rank{7} The accuracy bonus increases to \plus2.
...
\begin{attuneability}[Rank 2]{\hypertarget{spell:Shrink}{Shrink}}[\glossterm{Attune} (target), \glossterm{Focus}]
...
\begin{attuneability}[Rank 1]{\hypertarget{spell:Reactive Deflection}{Reactive Deflection}}[\glossterm{Attune} (self), \glossterm{Focus}]
\target{Yourself}
You gain a \plus1 \glossterm{magic bonus} to Armor defense.
This bonus is increased to \plus4 against \glossterm{mundane} ranged attacks from weapons or projectiles that are Small or smaller.
...
\rankline
\rank{5} The target gains a \plus1 \glossterm{magic bonus} to \glossterm{accuracy} with \glossterm{magical} abilities.
\rank{7} The bonus increases to \plus4.
...
The target gains a \plus3 \glossterm{magic bonus} to Fortitude defense.
...
\begin{attuneability}[Rank 4]{\hypertarget{spell:Lifesteal Blade}{Lifesteal Blade}}[\glossterm{Attune} (target), \glossterm{Focus}]
\target{Yourself or a living \glossterm{ally} within \rngmed range}
