...
\begin{attuneability}[Rank 4]{\hypertarget{spell:Malleable Body}{Malleable Body}}[\glossterm{Attune} (target), \glossterm{Focus}]
\target{Yourself or one \glossterm{ally} within \rngclose range}
...
It gains a \plus8 \glossterm{magic bonus} to the Escape Artist skill, and it is immune to \glossterm{critical hits} from \glossterm{strikes}.
