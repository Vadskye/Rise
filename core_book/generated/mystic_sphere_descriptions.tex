...
\begin{attuneability}[Rank 1]{\hypertarget{spell:Flicker}{Flicker}}[\glossterm{Attune} (self), \glossterm{Focus}]
\target{Yourself}
...
\begin{attuneability}[Rank 3]{\hypertarget{spell:Controlled Flicker}{Controlled Flicker}}[\glossterm{Attune} (self), \glossterm{Focus}]
\target{Yourself}
...
\begin{attuneability}[Rank 1]{\hypertarget{spell:Climber}{Climber}}[\glossterm{Attune} (target), \glossterm{Focus}]
\target{Yourself or an \glossterm{ally} within \rngmed range}
...
\begin{attuneability}[Rank 1]{\hypertarget{spell:Runner}{Runner}}[\glossterm{Attune} (target), \glossterm{Focus}]
\target{Yourself or an \glossterm{ally} within \rngmed range}
...
\rankline
\rank{3} The bonus increases to \plus15 feet.
\rank{5} The bonus increases to \plus20 feet.
\rank{7} The bonus increases to \plus30 feet.
\end{attuneability}
\vspace{0.25em}
...
\begin{attuneability}[Rank 1]{\hypertarget{spell:Swimmer}{Swimmer}}[\glossterm{Attune} (target), \glossterm{Focus}]
\target{Yourself or an \glossterm{ally} within \rngmed range}
...
\begin{freeability}[Rank 1]{\hypertarget{spell:Withering}{Withering}}[\glossterm{Focus}]
\target{One living creature within \rngmed range}
...
\begin{freeability}[Rank 3]{\hypertarget{spell:Withering Curse}{Withering Curse}}[\glossterm{Curse}, \glossterm{Focus}]
\target{One living creature within \rngmed range}
Make an attack vs. Mental against the target.
...
\hit Each target takes \glossterm{standard damage} \plus1d of the chosen type.
...
\begin{attuneability}[Rank 1]{\hypertarget{spell:Blessing of Recovery}{Blessing of Recovery}}[\glossterm{Attune} (target), \glossterm{Focus}]
\target{Yourself or an \glossterm{ally} within \rngmed range}
...
\begin{attuneability}[Rank 1]{\hypertarget{spell:Blessing of Swiftness}{Blessing of Swiftness}}[\glossterm{Attune} (target), \glossterm{Focus}]
\target{Yourself or an \glossterm{ally} within \rngmed range}
...
\begin{freeability}[Rank 1]{\hypertarget{spell:Run}{Run}}[\glossterm{Compulsion}, \glossterm{Focus}]
\target{One creature within \rngmed range}
Make an attack vs. Mental against the target.
...
\hit Each target takes electricity \glossterm{standard damage} \plus1d.
...
\hit Each target takes acid \glossterm{standard damage} \plus1d.
...
\begin{freeability}[Rank 1]{\hypertarget{spell:Blastwave}{Blastwave}}[\glossterm{Focus}]
\targets{\glossterm{Enemies} and objects in a \areasmall radius from you}
Make an attack vs. Mental against each target.
...
\begin{freeability}[Rank 1]{\hypertarget{spell:Mind Arrow}{Mind Arrow}}[\glossterm{Focus}]
...
\begin{freeability}[Rank 1]{\hypertarget{spell:Reload}{Reload}}[\glossterm{Focus}]
\target{Yourself}
...
\begin{freeability}[Rank 1]{\hypertarget{spell:Repulsive Grasp}{Repulsive Grasp}}[\glossterm{Focus}]
...
\begin{attuneability}[Rank 1]{\hypertarget{spell:Fade Into Darkness}{Fade Into Darkness}}[\glossterm{Attune} (self), \glossterm{Focus}]
\target{Yourself}
...
\begin{freeability}[Rank 1]{\hypertarget{spell:Poison -- Sassone Leaf}{Poison -- Sassone Leaf}}[\glossterm{Focus}]
\target{One living creature within \rngmed range}
This spell functions like this \spell{poison -- nitharit} spell, except that the target becomes poisoned with sassone leaf instead (see \pcref{Poisons}).
