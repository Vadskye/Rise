...
\begin{attuneability}[Rank 2]{\hypertarget{spell:Accelerated Reaction}{Accelerated Reaction}}[\glossterm{Attune} (self), \glossterm{Focus}]
\target{Yourself}
You gain a \plus2 \glossterm{magic bonus} to Reflex defense and \glossterm{initiative} checks.

\rankline
\rank{4} The bonuses increase to \plus3.
\rank{6} The bonuses increase to \plus4.
\rank{8} The bonuses increase to \plus5.
