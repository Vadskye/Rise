...
Make an attack vs. Armor with a \plus1 bonus to \glossterm{accuracy} against the target.
\hit The target takes bludgeoning \glossterm{standard damage}.
...
\begin{attuneability}[Rank 2]{\hypertarget{spell:Aqueous Tentacles}{Aqueous Tentacles}}[\glossterm{Attune} (self), \glossterm{Focus}, \glossterm{Manifestation}]
\target{Yourself}
...
\targets{All Huge or smaller \glossterm{enemies} completely within a \areamed radius within \rngmed range}
