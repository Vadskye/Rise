...
\lowercase{\hypertarget{spell:Blessing of Preservation}{}}\label{spell:Blessing of Preservation}
\begin{attuneability}[Rank 4]{\hypertarget{spell:Blessing of Preservation}{Blessing of Preservation}}[\glossterm{Attune} (target), \glossterm{Focus}]
\target{Yourself or an \glossterm{ally} within \rngmed range}
The target gains a \plus2 \glossterm{vitality bonus} to all of its \glossterm{vital rolls}, including any new \glossterm{vital wounds} it gains while attuned to this effect.
...
\lowercase{\hypertarget{spell:Clutch of Darkness}{}}\label{spell:Clutch of Darkness}
\begin{freeability}[Rank 1]{\hypertarget{spell:Clutch of Darkness}{Clutch of Darkness}}[\glossterm{Focus}]
\target{One creature within \rngmed range}
Make an attack vs. Fortitude against the target.
You gain a \plus2 bonus to \glossterm{accuracy} with the attack if the target is not in bright light.
...
\target{Yourself or up to one Medium or smaller \glossterm{ally} within \rngmed range}
The target teleports into an unoccupied destination within range.
...
\begin{attuneability}[Rank 3]{\hypertarget{spell:Darklantern}{Darklantern}}[\glossterm{Attune} (self), \glossterm{Focus}, \glossterm{Sensation}]
