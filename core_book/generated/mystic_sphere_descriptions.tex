...
\begin{attuneability}[Rank 2]{\hypertarget{spell:Astral Instability}{Astral Instability}}[\glossterm{Attune} (self), \glossterm{Focus}]
\target{Yourself}
...
\target{One creature within \rngmed range}
Make an attack vs. Mental with a \plus4 bonus to \glossterm{accuracy} against the target.
