    ...
    \begin{spellcontent}
      \begin{spelltargetinginfo}
        \pari \textbf{HP} 52;
          ...
          \textbf{Ref} 18;
          \textbf{Ment} 25
        \pari \textbf{DR} Physical 36; Energy 33
        \pari \textbf{VR} Physical 93; Energy 90
        \pari \textbf{Strike:}
            Tentacle \plus17 (7d10 bludgeoning)
      \end{spelltargetinginfo}
    \end{spellcontent}
    \begin{monsterfooter}
      \pari \textbf{Speeds} Land 50 ft., Swim 50 ft.;
        \textbf{Space} 15 ft.;
        \textbf{Reach} 15 ft.
  ...
  \begin{freeability}{Mind Control}
      ...
      An aboleth can use this ability as a \glossterm{minor action}. The aboleth makes a \plus17 attack
    ...
    \end{freeability}
      ...
      \parhead{Psionic Barrier} 
        ...
        It gains a \plus10 \glossterm{magic bonus} to \glossterm{resistances}.
  ...
  \begin{monsection}{Orc}[Elite]{8}[1]
    ...
    \begin{spellcontent}
      \begin{spelltargetinginfo}
        ...
        \pari \textbf{Strikes:}
            Greataxe \plus9 (5d10 slashing; Sweeping 1);
  ...
  \begin{monsection}{Giant}[Hill]{7}[3]
    ...
    \begin{spellcontent}
      \begin{spelltargetinginfo}
        ...
        \pari \textbf{Strikes:}
            Greatclub \plus8 (5d10 bludgeoning; Forceful);
  ...
  \begin{monsection}{Giant}[Stone]{10}[3]
    ...
    \begin{spellcontent}
      \begin{spelltargetinginfo}
        ...
        \pari \textbf{VR} 59
        \pari \textbf{Strikes:}
            Greatclub \plus13 (9d10 bludgeoning; Forceful);
  ...
  \begin{monsection}{Minotaur}{6}[2]
    ...
    \begin{spellcontent}
      \begin{spelltargetinginfo}
        ...
        \pari \textbf{VR} 33
        \pari \textbf{Strikes:}
            Gore \plus8 (4d8 piercing; Impact);
\par Ram \plus8 (4d8 bludgeoning; Forceful)
      \end{spelltargetinginfo}
    \end{spellcontent}
    \begin{monsterfooter}
      \pari \textbf{Speed} 40 ft.;
    ...
    \begin{spellcontent}
      \begin{spelltargetinginfo}
        \pari \textbf{HP} 44;
          ...
          \textbf{Ref} 23;
          \textbf{Ment} 24
        \pari \textbf{DR} Physical 30; Energy 36
        \pari \textbf{VR} Physical 75; Energy 81
        \pari \textbf{Strike:}
            Greatmace \plus19 (9d10 bludgeoning; Impact)
      \end{spelltargetinginfo}
    \end{spellcontent}
    \begin{monsterfooter}
      \pari \textbf{Speeds} Fly 40 ft., Land 30 ft.;
        \textbf{Space} 5 ft.;
        \textbf{Reach} 5 ft.
      \pari \textbf{Awareness} \plus6
      \pari \textbf{Attributes}:
        ...
        Con 13, Int 13,
        Per 13, Wil 14
      \pari \textbf{Accuracy} 19;
        \textbf{Mundane Power} 21;
      \textbf{Magical Power} 22
  ...
  \begin{freeability}{Proclamation}
    ...
    \begin{freeability}{Glimpse Of Divinity}
      \target{One creature within \rngmed range of the astral deva}
       The astral deva makes a \plus21 attack
        vs. Mental against the target.
    ...
    \begin{freeability}{Stunning Smash}
      \target{One creature or object within \glossterm{reach}}
       The astral deva makes a \plus19
        \glossterm{strike} vs. Armor
        with its greatmace against the target.
    
    \hit The target takes 9d10 bludgeoning damage. If the target is \glossterm{wounded} by the attack, it is \glossterm{stunned} as a \glossterm{condition}.
    \end{freeability}
    ...
    \begin{spellcontent}
      \begin{spelltargetinginfo}
        \pari \textbf{HP} 44;
          ...
          \textbf{Ref} 26;
          \textbf{Ment} 27
        \pari \textbf{DR} Physical 43; Energy 51
        \pari \textbf{VR} Physical 114; Energy 122
        \pari \textbf{Strike:}
            Greatmace \plus22 (11d10 bludgeoning; Impact)
      \end{spelltargetinginfo}
    \end{spellcontent}
    \begin{monsterfooter}
      \pari \textbf{Speeds} Fly 50 ft., Land 30 ft.;
        \textbf{Space} 5 ft.;
        \textbf{Reach} 5 ft.
      ...
      \pari \textbf{Attributes}:
        ...
        Con 17, Int 17,
        Per 17, Wil 18
      \pari \textbf{Accuracy} 22;
        \textbf{Mundane Power} 25;
    ...
    \begin{spellcontent}
      \begin{spelltargetinginfo}
        \pari \textbf{HP} 44;
          ...
          \textbf{Ref} 31;
          \textbf{Ment} 32
        \pari \textbf{DR} Physical 60; Energy 70
        \pari \textbf{VR} Physical 177; Energy 187
        \pari \textbf{Strike:}
            Greatmace \plus27 (14d10 bludgeoning; Impact)
      \end{spelltargetinginfo}
    \end{spellcontent}
    \begin{monsterfooter}
      \pari \textbf{Speeds} Fly 60 ft., Land 30 ft.;
        \textbf{Space} 5 ft.;
        \textbf{Reach} 5 ft.
      ...
      \pari \textbf{Attributes}:
        ...
        Con 21, Int 21,
        Per 21, Wil 22
      \pari \textbf{Accuracy} 27;
        \textbf{Mundane Power} 31;
