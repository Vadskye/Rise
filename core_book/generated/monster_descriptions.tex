  ...
  \begin{monsection}{Lizardfolk}[Elite]{10}[2]
    ...
    \begin{spellcontent}
      \begin{spelltargetinginfo}
        ...
        \pari \textbf{VR} Physical 59; Energy 51
        \pari \textbf{Strike:}
            Spear \plus12 (4d10)
      \end{spelltargetinginfo}
    \end{spellcontent}
  ...
  \begin{monsection}{Orc}[Elite]{8}[1]
    ...
    \begin{spellcontent}
      \begin{spelltargetinginfo}
        ...
        \pari \textbf{VR} Physical 45; Energy 38
        \pari \textbf{Strikes:}
            Greataxe \plus9 (5d10, Sweeping 1);
\par Light Crossbow \plus9 (4d8)
      \end{spelltargetinginfo}
    \end{spellcontent}
    \begin{monsterfooter}
      \pari \textbf{Speed} 30 ft.;
  ...
  \begin{monsection}{Giant}[Hill]{11}[2]
    ...
    \begin{spellcontent}
      \begin{spelltargetinginfo}
        ...
        \pari \textbf{VR} Physical 68; Energy 64
        \pari \textbf{Strikes:}
            Greatclub \plus12 (8d10);
\par Boulder \plus12 (7d10)
      \end{spelltargetinginfo}
    \end{spellcontent}
    \begin{monsterfooter}
      \pari \textbf{Speed} 50 ft.;
  ...
  \begin{monsection}{Deva}{14}[2]
    ...
    \begin{spellcontent}
      \begin{spelltargetinginfo}
        ...
        \pari \textbf{VR} Physical 81; Energy 95
        \pari \textbf{Strike:}
            Mace \plus18 (8d10)
      \end{spelltargetinginfo}
    \end{spellcontent}
