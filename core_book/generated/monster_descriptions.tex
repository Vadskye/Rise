  ...
  \begin{monsubsection}{Gargantuan Centipede}{10}[4]
    ...
    \begin{spellcontent}
      \begin{spelltargetinginfo}
        ...
        \pari \textbf{Strike:}
            Bite \plus13 (9d10 bludgeoning and piercing)
      \end{spelltargetinginfo}
    \end{spellcontent}
    \begin{monsterfooter}
  ...
  \begin{monsubsection}{Colossal Centipede}{13}[4]
    ...
    \begin{spellcontent}
      \begin{spelltargetinginfo}
        ...
        \pari \textbf{Strike:}
            Bite \plus16 (14d10 bludgeoning and piercing)
      \end{spelltargetinginfo}
    \end{spellcontent}
    \begin{monsterfooter}
    ...
    \begin{spellcontent}
      \begin{spelltargetinginfo}
        \pari \textbf{HP} 0 \monsep
          ...
          \textbf{Ref} 12 \monsep
          \textbf{Ment} 7
        \pari \textbf{WR} Physical 6, Energy 5 \monsep
        \textbf{VR} Physical 18, Energy 17
