    ...
    \begin{spellcontent}
      \begin{spelltargetinginfo}
        \pari \textbf{HP} 11;
          ...
          \textbf{Ref} 21;
          \textbf{Ment} 21
        \pari \textbf{DR} 16; Physical 20
        \pari \textbf{WR} 54; Physical 58
        \pari \textbf{Strike:}
            Bite \plus18 (7d10)
      \end{spelltargetinginfo}
    \end{spellcontent}
    ...
    \begin{spellcontent}
      \begin{spelltargetinginfo}
        \pari \textbf{HP} 10;
          ...
          \textbf{Ref} 12;
          \textbf{Ment} 12
        \pari \textbf{DR} 5; Physical 9
        \pari \textbf{WR} 27; Physical 31
        \pari \textbf{Strike:}
            Bite \plus9 (4d6)
      \end{spelltargetinginfo}
    \end{spellcontent}
    ...
    \begin{spellcontent}
      \begin{spelltargetinginfo}
        \pari \textbf{HP} 10;
          ...
          \textbf{Ref} 17;
          \textbf{Ment} 17
        \pari \textbf{DR} 10; Physical 14
        \pari \textbf{WR} 38; Physical 42
        \pari \textbf{Strike:}
            Bite \plus14 (5d10)
      \end{spelltargetinginfo}
    \end{spellcontent}
    ...
    \begin{spellcontent}
      \begin{spelltargetinginfo}
        \pari \textbf{HP} 7;
          ...
          \textbf{Ref} 16;
          \textbf{Ment} 9
        \pari \textbf{DR} 4; Physical 8
        \pari \textbf{WR} 24; Physical 28
        \pari \textbf{Strike:}
            Stinger \plus9 (2d10)
      \end{spelltargetinginfo}
    \end{spellcontent}
    ...
    \begin{spellcontent}
      \begin{spelltargetinginfo}
        \pari \textbf{HP} 8;
          ...
          \textbf{Ref} 10;
          \textbf{Ment} 10
        \pari \textbf{DR} 2; Physical 6
        \pari \textbf{WR} 18; Physical 22
        \pari \textbf{Strike:}
            Bite \plus7 (2d10)
      \end{spelltargetinginfo}
    \end{spellcontent}
    ...
    \begin{spellcontent}
      \begin{spelltargetinginfo}
        \pari \textbf{HP} 6;
          ...
          \textbf{Ref} 25;
          \textbf{Ment} 20
        \pari \textbf{DR} 14; Physical 18
        \pari \textbf{WR} 48; Physical 52
        \pari \textbf{Strike:}
            Bite \plus20 (6d10)
      \end{spelltargetinginfo}
    \end{spellcontent}
    ...
    \begin{spellcontent}
      \begin{spelltargetinginfo}
        \pari \textbf{HP} 6;
          ...
          \textbf{Ref} 21;
          \textbf{Ment} 16
        \pari \textbf{DR} 8; Physical 12
        \pari \textbf{WR} 34; Physical 38
        \pari \textbf{Strike:}
            Bite \plus15 (4d10)
      \end{spelltargetinginfo}
    \end{spellcontent}
    ...
    \begin{spellcontent}
      \begin{spelltargetinginfo}
        \pari \textbf{HP} 6;
          ...
          \textbf{Ref} 13;
          \textbf{Ment} 9
        \pari \textbf{DR} 1; Physical 5
        \pari \textbf{WR} 16; Physical 20
        \pari \textbf{Strike:}
            Bite \plus7 (2d8)
      \end{spelltargetinginfo}
    \end{spellcontent}
    ...
    \begin{spellcontent}
      \begin{spelltargetinginfo}
        \pari \textbf{HP} 7;
          ...
          \textbf{Ref} 25;
          \textbf{Ment} 20
        \pari \textbf{DR} 12; Physical 14
        \pari \textbf{WR} 43; Physical 45
        \pari \textbf{Strike:}
            Slam \plus18 (4d10)
      \end{spelltargetinginfo}
    \end{spellcontent}
    ...
    \begin{spellcontent}
      \begin{spelltargetinginfo}
        \pari \textbf{HP} 7;
          ...
          \textbf{Ref} 18;
          \textbf{Ment} 14
        \pari \textbf{DR} 6; Physical 8
        \pari \textbf{WR} 30; Physical 32
        \pari \textbf{Strike:}
            Slam \plus11 (2d10)
      \end{spelltargetinginfo}
    \end{spellcontent}
