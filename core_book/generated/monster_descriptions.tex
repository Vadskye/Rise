  ...
  \begin{monsection}{Aboleth}{12}[4]
    ...
    \begin{spellcontent}
      \begin{spelltargetinginfo}
        ...
        \pari \textbf{Strike:}
            Tentacle \plus17 (8d10 bludgeoning)
  ...
  \begin{monsection}{Colossal Centipede}{13}[4]
    ...
    \begin{spellcontent}
      \begin{spelltargetinginfo}
        ...
        \pari \textbf{Strike:}
            Bite \plus18 (10d10 bludgeoning and piercing)
      \end{spelltargetinginfo}
    \end{spellcontent}
    \begin{monsterfooter}
  ...
  \begin{monsection}{Gargantuan Centipede}{10}[4]
    ...
    \begin{spellcontent}
      \begin{spelltargetinginfo}
        ...
        \pari \textbf{Strike:}
            Bite \plus14 (8d10 bludgeoning and piercing)
      \end{spelltargetinginfo}
    \end{spellcontent}
    \begin{monsterfooter}
      \pari \textbf{Speed} 60 ft. \monsep
  ...
  \begin{monsection}{Spider}[Colossal]{12}[4]
    ...
    \begin{spellcontent}
      \begin{spelltargetinginfo}
        ...
        \pari \textbf{Strike:}
            Bite \plus20 (9d10 bludgeoning and piercing)
      \end{spelltargetinginfo}
    \end{spellcontent}
    \begin{monsterfooter}
      \pari \textbf{Speed} 70 ft. \monsep
  ...
  \begin{monsection}{Spider}[Gargantuan]{9}[4]
    ...
    \begin{spellcontent}
      \begin{spelltargetinginfo}
        ...
        \textbf{VR} Physical 49, Energy 46
        \pari \textbf{Strike:}
            Bite \plus15 (7d10 bludgeoning and piercing)
      \end{spelltargetinginfo}
    \end{spellcontent}
    \begin{monsterfooter}
      \pari \textbf{Speed} 60 ft. \monsep
  ...
  \begin{monsection}{Spider}[Huge]{6}[4]
    ...
    \begin{spellcontent}
      \begin{spelltargetinginfo}
        ...
        \textbf{VR} Physical 33, Energy 30
        \pari \textbf{Strike:}
            Bite \plus12 (4d6 bludgeoning and piercing)
      \end{spelltargetinginfo}
    \end{spellcontent}
    \begin{monsterfooter}
      \pari \textbf{Speed} 50 ft. \monsep
...
\par Ram \plus8 (4d8 bludgeoning; Forceful)
    ...
    \begin{spellcontent}
      \begin{spelltargetinginfo}
        \pari \textbf{HP} 44 \monsep
          ...
          \textbf{Ref} 23 \monsep
          \textbf{Ment} 24
        \pari \textbf{WR} Physical 37, Energy 43 \monsep
        \textbf{VR} Physical 82, Energy 88
        \pari \textbf{Strike:}
            Greatmace \plus19 (10d10 bludgeoning; Impact)
      \end{spelltargetinginfo}
    \end{spellcontent}
    \begin{monsterfooter}
  ...
  \begin{freeability}{Proclamation}
    ...
    \hit The target takes 10d10 bludgeoning damage. If the target is \glossterm{wounded} by the attack, it is \glossterm{stunned} as a \glossterm{condition}.
    \end{freeability}
  ...
  \begin{monsubsection}{Planetar}{16}[4]
    ...
    \begin{spellcontent}
      \begin{spelltargetinginfo}
        ...
        \pari \textbf{Strike:}
            Greatmace \plus22 (14d10 bludgeoning; Impact)
      \end{spelltargetinginfo}
    \end{spellcontent}
    \begin{monsterfooter}
  ...
  \begin{monsubsection}{Solar}{20}[4]
    ...
    \begin{spellcontent}
      \begin{spelltargetinginfo}
        ...
        \pari \textbf{Strike:}
            Greatmace \plus27 (19d10 bludgeoning; Impact)
      \end{spelltargetinginfo}
    \end{spellcontent}
    \begin{monsterfooter}
