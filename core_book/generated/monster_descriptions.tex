  ...
  \begin{freeability}{Spit Acid}
    ...
    \begin{freeability}{Drag Prey}
      \target{One Medium or smaller creature or object within \reach}
       The ankheg makes a \plus15 attack
        vs. Fortitude against the target.
    ...
    \begin{spellcontent}
      \begin{spelltargetinginfo}
        \pari \textbf{HP} 12;
          ...
          \textbf{Ref} 15;
          \textbf{Ment} 15
        \pari \textbf{DR} Physical 23; Energy 21
        \pari \textbf{VR} Physical 68; Energy 66
        \pari \textbf{Strikes:}
            Greatclub \plus12 (8d10 bludgeoning);
\par Boulder \plus12 (7d10 bludgeoning)
      \end{spelltargetinginfo}
    \end{spellcontent}
    \begin{monsterfooter}
      \pari \textbf{Speed} 50 ft.;
  ...
  \begin{freeability}{Sweeping Smash}
      \targets{Up to three creatures or objects within \glossterm{reach}}
       The giant makes a \plus12
        \glossterm{strike} vs. Armor
