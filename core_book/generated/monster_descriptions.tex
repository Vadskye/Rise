...
\parhead{Knowledge (dungeoneering) 27} 
    ...
    \begin{spellcontent}
      \begin{spelltargetinginfo}
        ...
        \pari \textbf{Strike:}
            Tentacle \plus16 (6d10 bludgeoning)
  ...
  \begin{freeability}{Mind Control}
    ...
    \hit Each target takes 6d10 energy damage. Any target \glossterm{wounded} by this damage is \glossterm{dazed} as a \glossterm{condition}.
    \end{freeability}
  ...
  \begin{monsubsection}{Black Bear}{3}[2]
    ...
    \begin{spellcontent}
      \begin{spelltargetinginfo}
        ...
        \textbf{VR} 26
        \pari \textbf{Strike:}
            Bite \plus4 (2d8 bludgeoning and piercing)
      \end{spelltargetinginfo}
    \end{spellcontent}
    \begin{monsterfooter}
  ...
  \begin{monsection}{Cat}{1}[0.5]
    ...
    \begin{spellcontent}
      \begin{spelltargetinginfo}
        ...
        \textbf{VR} 8
        \pari \textbf{Strikes:}
            Bite \plus1 (1d6 bludgeoning and piercing);
\par Claw \plus3 (1d6 piercing and slashing)
      \end{spelltargetinginfo}
    \end{spellcontent}
    \begin{monsterfooter}
  ...
  \begin{monsubsection}{Huge Centipede}{7}[4]
    ...
    \begin{spellcontent}
      \begin{spelltargetinginfo}
        ...
        \pari \textbf{Strike:}
            Bite \plus10 (5d10 bludgeoning and piercing)
      \end{spelltargetinginfo}
    \end{spellcontent}
    \begin{monsterfooter}
  ...
  \begin{monsubsection}{Gargantuan Centipede}{10}[4]
    ...
    \begin{spellcontent}
      \begin{spelltargetinginfo}
        ...
        \pari \textbf{Strike:}
            Bite \plus13 (7d10 bludgeoning and piercing)
      \end{spelltargetinginfo}
    \end{spellcontent}
    \begin{monsterfooter}
  ...
  \begin{monsubsection}{Colossal Centipede}{13}[4]
    ...
    \begin{spellcontent}
      \begin{spelltargetinginfo}
        ...
        \pari \textbf{Strike:}
            Bite \plus16 (8d10+30 bludgeoning and piercing)
      \end{spelltargetinginfo}
    \end{spellcontent}
    \begin{monsterfooter}
...
\parhead{Knowledge (nature) 11} 
    ...
    \begin{spellcontent}
      \begin{spelltargetinginfo}
        ...
        \textbf{VR} 16
        \pari \textbf{Strike:}
            Bite \plus2 (1d8 bludgeoning and piercing)
      \end{spelltargetinginfo}
    \end{spellcontent}
    \begin{monsterfooter}
  ...
  \begin{monsection}{Raven}{1}[1]
    ...
    \begin{spellcontent}
      \begin{spelltargetinginfo}
        ...
        \textbf{VR} 14
        \pari \textbf{Strike:}
            Talon \plus4 (1d6 piercing and slashing)
      \end{spelltargetinginfo}
    \end{spellcontent}
    \begin{monsterfooter}
      \pari \textbf{Speed} 20 ft. \monsep
  ...
  \begin{monsubsection}{Huge Spider}{6}[4]
    ...
    \begin{spellcontent}
      \begin{spelltargetinginfo}
        ...
        \textbf{VR} Physical 33, Energy 30
        \pari \textbf{Strike:}
            Bite \plus11 (4d8 bludgeoning and piercing)
      \end{spelltargetinginfo}
    \end{spellcontent}
    \begin{monsterfooter}
      \pari \textbf{Speed} 50 ft. \monsep
  ...
  \begin{monsubsection}{Gargantuan Spider}{9}[4]
    ...
    \begin{spellcontent}
      \begin{spelltargetinginfo}
        ...
        \textbf{VR} Physical 49, Energy 46
        \pari \textbf{Strike:}
            Bite \plus14 (5d10 bludgeoning and piercing)
      \end{spelltargetinginfo}
    \end{spellcontent}
    \begin{monsterfooter}
      \pari \textbf{Speed} 60 ft. \monsep
  ...
  \begin{monsubsection}{Colossal Spider}{12}[4]
    ...
    \begin{spellcontent}
      \begin{spelltargetinginfo}
        ...
        \pari \textbf{Strike:}
            Bite \plus18 (8d10 bludgeoning and piercing)
      \end{spelltargetinginfo}
    \end{spellcontent}
    \begin{monsterfooter}
      \pari \textbf{Speed} 70 ft. \monsep
  ...
  \begin{monsubsection}{Colossal Object}{11}[3]
    ...
    \begin{spellcontent}
      \begin{spelltargetinginfo}
        ...
        \textbf{VR} 85
        \pari \textbf{Strike:}
            Slam \plus13 (8d10+10 bludgeoning)
      \end{spelltargetinginfo}
    \end{spellcontent}
    \begin{monsterfooter}
      \pari \textbf{Speed} 70 ft. \monsep
  ...
  \begin{monsubsection}{Maple Treant}{6}[2]
    ...
    \begin{spellcontent}
      \begin{spelltargetinginfo}
        ...
        \textbf{VR} 34
        \pari \textbf{Strike:}
            Slam \plus10 (4d8 bludgeoning; Sweeping 2)
      \end{spelltargetinginfo}
    \end{spellcontent}
    \begin{monsterfooter}
      \pari \textbf{Speed} 40 ft. \monsep
  ...
  \begin{monsubsection}{Darkroot Treant}{8}[2]
    ...
    \begin{spellcontent}
      \begin{spelltargetinginfo}
        ...
        \textbf{VR} 39
        \pari \textbf{Strike:}
            Slam \plus10 (5d10 bludgeoning; Sweeping 2)
      \end{spelltargetinginfo}
    \end{spellcontent}
    \begin{monsterfooter}
      \pari \textbf{Speed} 50 ft. \monsep
  ...
  \begin{monsubsection}{Oak Treant}{10}[2]
    ...
    \begin{spellcontent}
      \begin{spelltargetinginfo}
        ...
        \textbf{VR} 70
        \pari \textbf{Strike:}
            Slam \plus12 (6d10 bludgeoning; Sweeping 2)
      \end{spelltargetinginfo}
    \end{spellcontent}
    \begin{monsterfooter}
      \pari \textbf{Speed} 50 ft. \monsep
  ...
  \begin{monsubsection}{Cyprus Treant}{11}[2]
    ...
    \begin{spellcontent}
      \begin{spelltargetinginfo}
        ...
        \textbf{VR} 92
        \pari \textbf{Strike:}
            Slam \plus13 (8d10+10 bludgeoning; Sweeping 2)
      \end{spelltargetinginfo}
    \end{spellcontent}
    \begin{monsterfooter}
      \pari \textbf{Speed} 50 ft. \monsep
  ...
  \begin{monsubsection}{Wyrmling Black Dragon}{2}[4]
    ...
    \begin{spellcontent}
      \begin{spelltargetinginfo}
        ...
        \textbf{VR} 19
        \pari \textbf{Strikes:}
            Bite \plus5 (1d10 bludgeoning and piercing);
\par Claw \plus7 (1d6 piercing and slashing)
      \end{spelltargetinginfo}
    \end{spellcontent}
    \begin{monsterfooter}
      \pari \textbf{Speed} 20 ft. \monsep
...
\par Claw \plus10 (2d10 piercing and slashing)
      \end{spelltargetinginfo}
    \end{spellcontent}
    \begin{monsterfooter}
      \pari \textbf{Speed} 30 ft. \monsep
  ...
  \begin{monsubsection}{Young Adult Black Dragon}{8}[4]
    ...
    \begin{spellcontent}
      \begin{spelltargetinginfo}
        ...
        \textbf{VR} 48
        \pari \textbf{Strikes:}
            Bite \plus12 (5d10 bludgeoning and piercing);
\par Claw \plus14 (4d8 piercing and slashing)
      \end{spelltargetinginfo}
    \end{spellcontent}
    \begin{monsterfooter}
      \pari \textbf{Speed} 40 ft. \monsep
  ...
  \begin{monsubsection}{Adult Black Dragon}{11}[4]
    ...
    \begin{spellcontent}
      \begin{spelltargetinginfo}
        ...
        \textbf{VR} 73
        \pari \textbf{Strikes:}
            Bite \plus16 (8d10 bludgeoning and piercing);
\par Claw \plus18 (6d10 piercing and slashing)
      \end{spelltargetinginfo}
    \end{spellcontent}
    \begin{monsterfooter}
      \pari \textbf{Speed} 50 ft. \monsep
  ...
  \begin{monsubsection}{Old Black Dragon}{14}[4]
    ...
    \begin{spellcontent}
      \begin{spelltargetinginfo}
        ...
        \textbf{VR} 106
        \pari \textbf{Strikes:}
            Bite \plus19 (8d10+20 bludgeoning and piercing);
\par Claw \plus21 (8d10 piercing and slashing)
      \end{spelltargetinginfo}
    \end{spellcontent}
    \begin{monsterfooter}
      \pari \textbf{Speed} 60 ft. \monsep
  ...
  \begin{monsubsection}{Ancient Black Dragon}{17}[4]
    ...
    \begin{spellcontent}
      \begin{spelltargetinginfo}
        ...
        \textbf{VR} 136
        \pari \textbf{Strikes:}
            Bite \plus23 (8d10+50 bludgeoning and piercing);
\par Claw \plus25 (8d10+30 piercing and slashing)
      \end{spelltargetinginfo}
    \end{spellcontent}
    \begin{monsterfooter}
      \pari \textbf{Speed} 70 ft. \monsep
  ...
  \begin{monsubsection}{Wyrm Black Dragon}{20}[4]
    ...
    \begin{spellcontent}
      \begin{spelltargetinginfo}
        ...
        \textbf{VR} 168
        \pari \textbf{Strikes:}
            Bite \plus27 (8d10+70 bludgeoning and piercing);
\par Claw \plus29 (8d10+50 piercing and slashing)
      \end{spelltargetinginfo}
    \end{spellcontent}
    \begin{monsterfooter}
      \pari \textbf{Speed} 70 ft. \monsep
  ...
  \begin{monsubsection}{Great Wyrm Black Dragon}{23}[4]
    ...
    \begin{spellcontent}
      \begin{spelltargetinginfo}
        ...
        \textbf{VR} 208
        \pari \textbf{Strikes:}
            Bite \plus31 (8d10+110 bludgeoning and piercing);
\par Claw \plus33 (8d10+90 piercing and slashing)
      \end{spelltargetinginfo}
    \end{spellcontent}
    \begin{monsterfooter}
      \pari \textbf{Speed} 70 ft. \monsep
...
\parhead{Knowledge (local) 13} 
  ...
  \begin{monsubsection}{Lizardfolk Elite}{4}[2]
    \vspace{-1em}\spelltwocol{}{Medium humanoid}\vspace{-1em}
    \vspace{0em}
  ...
  \begin{monsubsection}{Orc Grunt}{2}[1]
    ...
    \begin{spellcontent}
      \begin{spelltargetinginfo}
        ...
        \pari \textbf{Strike:}
            Greataxe \plus2 (2d8 slashing; Sweeping 1)
      \end{spelltargetinginfo}
    \end{spellcontent}
    \begin{monsterfooter}
      \pari \textbf{Speed} 30 ft. \monsep
  ...
  \begin{monsubsection}{Orc Peon}{1}[0.5]
    ...
    \begin{spellcontent}
      \begin{spelltargetinginfo}
        ...
        \pari \textbf{Strike:}
            Greataxe \plus1 (2d6 slashing; Sweeping 1)
      \end{spelltargetinginfo}
    \end{spellcontent}
    \begin{monsterfooter}
      \pari \textbf{Speed} 30 ft. \monsep
  ...
  \begin{monsubsection}{Orc Veteran}{6}[2]
    ...
    \begin{spellcontent}
      \begin{spelltargetinginfo}
        ...
        \pari \textbf{Strikes:}
            Greataxe \plus7 (4d10 slashing; Sweeping 1);
\par Light Crossbow \plus7 (4d6 piercing; 50 ft. range)
      \end{spelltargetinginfo}
    \end{spellcontent}
    \begin{monsterfooter}
      \pari \textbf{Speed} 30 ft. \monsep
  ...
  \begin{monsubsection}{Orc Chieftain}{8}[4]
    ...
    \begin{spellcontent}
      \begin{spelltargetinginfo}
        ...
        \pari \textbf{Strikes:}
            Greataxe \plus11 (6d10 slashing; Sweeping 1);
\par Light Crossbow \plus11 (4d10 piercing; 50 ft. range)
      \end{spelltargetinginfo}
    \end{spellcontent}
    \begin{monsterfooter}
      \pari \textbf{Speed} 30 ft. \monsep
...
\parhead{Knowledge (arcana) 16} 
    ...
    \begin{spellcontent}
      \begin{spelltargetinginfo}
        ...
        \textbf{VR} 16
        \pari \textbf{Strikes:}
            Constrict \plus2 (2d8 bludgeoning; Grappling);
\par Tentacle \plus3 (1d8 bludgeoning)
      \end{spelltargetinginfo}
    \end{spellcontent}
    \begin{monsterfooter}
...
\par Claw \plus11 (2d10 piercing and slashing)
      \end{spelltargetinginfo}
    \end{spellcontent}
    \begin{monsterfooter}
...
\parhead{Knowledge (arcana) 17} 
    ...
    \begin{spellcontent}
      \begin{spelltargetinginfo}
        ...
        \textbf{VR} 35
        \pari \textbf{Strikes:}
            Bite \plus9 (4d6 bludgeoning and piercing);
\par Tentacle \plus10 (2d8 bludgeoning)
      \end{spelltargetinginfo}
    \end{spellcontent}
    \begin{monsterfooter}
      \pari \textbf{Speed} 40 ft. \monsep
...
\parhead{Knowledge (nature) 17} 
    ...
    \begin{spellcontent}
      \begin{spelltargetinginfo}
        ...
        \pari \textbf{Strikes:}
            Greatclub \plus7 (6d10 bludgeoning; Sweeping 2);
\par Boulder \plus7 (4d10 bludgeoning; 100 ft. range)
      \end{spelltargetinginfo}
    \end{spellcontent}
    \begin{monsterfooter}
      \pari \textbf{Speed} 50 ft. \monsep
...
\parhead{Knowledge (nature) 20} 
    ...
    \begin{spellcontent}
      \begin{spelltargetinginfo}
        ...
        \textbf{VR} 66
        \pari \textbf{Strikes:}
            Greatclub \plus12 (8d10 bludgeoning; Sweeping 2);
\par Boulder \plus12 (6d10 bludgeoning; 200 ft. range)
      \end{spelltargetinginfo}
    \end{spellcontent}
    \begin{monsterfooter}
      \pari \textbf{Speed} 60 ft. \monsep
  ...
  \begin{monsection}{Minotaur}{6}[2]
    ...
    \begin{spellcontent}
      \begin{spelltargetinginfo}
        ...
        \textbf{VR} 35
        \pari \textbf{Strikes:}
            Gore \plus7 (4d8 piercing; Impact);
\par Ram \plus7 (4d8 bludgeoning; Forceful)
      \end{spelltargetinginfo}
    \end{spellcontent}
    \begin{monsterfooter}
      \pari \textbf{Speed} 40 ft. \monsep
  ...
  \begin{monsubsection}{Ogre Ganger}{3}[1]
    ...
    \begin{spellcontent}
      \begin{spelltargetinginfo}
        ...
        \pari \textbf{Strikes:}
            Greatclub \plus3 (2d10 bludgeoning; Forceful);
\par Javelin \plus3 (2d6 piercing; 30 ft. range)
      \end{spelltargetinginfo}
    \end{spellcontent}
    \begin{monsterfooter}
      \pari \textbf{Speed} 40 ft. \monsep
...
\parhead{Knowledge (nature) 16} 
    ...
    \begin{spellcontent}
      \begin{spelltargetinginfo}
        ...
        \pari \textbf{Strikes:}
            Greatclub \plus9 (6d10 bludgeoning; Sweeping 1);
\par Javelin \plus9 (4d10 piercing; 30 ft. range)
      \end{spelltargetinginfo}
    \end{spellcontent}
    \begin{monsterfooter}
      \pari \textbf{Speed} 40 ft. \monsep
  ...
  \parhead{Crushing Sweep} 
        ...
        All planeforged have the following properties unless noted otherwise in their description:
  ...
  \begin{monsubsection}{Large Air Elemental}{5}[2]
    \vspace{-1em}\spelltwocol{}{Large planeforged}\vspace{-1em}
    \vspace{0em}
  ...
  \begin{monsubsection}{Huge Air Elemental}{8}[2]
    \vspace{-1em}\spelltwocol{}{Huge planeforged}\vspace{-1em}
    \vspace{0em}
...
\parhead{Knowledge (planes) 15} 
  ...
  \begin{monsubsection}{Astral Deva}{12}[4]
    \vspace{-1em}\spelltwocol{}{Medium planeforged}\vspace{-1em}
    \vspace{0em}
    ...
    \begin{spellcontent}
      \begin{spelltargetinginfo}
        ...
        \pari \textbf{Strike:}
            Greatmace \plus17 (8d10+20 bludgeoning; Impact)
      \end{spelltargetinginfo}
    \end{spellcontent}
    \begin{monsterfooter}
  ...
  \begin{freeability}{Proclamation}
    ...
    \hit The target takes 8d10+20 bludgeoning damage. If the target is \glossterm{wounded} by the attack, it is \glossterm{stunned} as a \glossterm{condition}.
    \end{freeability}
  ...
  \begin{monsubsection}{Planetar}{16}[4]
    ...
    \begin{spellcontent}
      \begin{spelltargetinginfo}
        ...
        \pari \textbf{Strike:}
            Greatmace \plus20 (8d10+30 bludgeoning; Impact)
      \end{spelltargetinginfo}
    \end{spellcontent}
    \begin{monsterfooter}
  ...
  \begin{monsubsection}{Solar}{20}[4]
    ...
    \begin{spellcontent}
      \begin{spelltargetinginfo}
        ...
        \pari \textbf{Strike:}
            Greatmace \plus24 (8d10+60 bludgeoning; Impact)
      \end{spelltargetinginfo}
    \end{spellcontent}
    \begin{monsterfooter}
  ...
  \begin{monsubsection}{Barbed Demon}{7}[1]
    \vspace{-1em}\spelltwocol{}{Medium planeforged}\vspace{-1em}
    \vspace{0em}
...
\parhead{Knowledge (planes) 17} 
    ...
    \begin{monsterfooter}
      ...
      \pari \textbf{Accuracy} 8 \monsep
        \textbf{Power} 11
      \pari \textbf{Alignment} Always evil
    \end{monsterfooter}
  \end{monsubsection}
  \begin{freeability}{Retributive Barbs}
      \targets{The attacking creature}
      Whenever a creature adjacent to the barbed demon makes a melee \glossterm{strike} against it,
            ...
            \par The barbed demon makes a \plus8 attack
        vs. Armor against each target.
    ...
    \begin{freeability}{Impale}
      \target{One creature within \glossterm{reach}}
       The barbed demon makes a \plus9
        \glossterm{strike} vs. Armor
        with its tentacle against the target.
    
    \hit 
            The target takes 1d10 piercing damage.
            In addition, if this attack also beats Fortitude defense, the target is \glossterm{grappled} by the barbed demon.
    \end{freeability}
...
\parhead{Knowledge (planes) 17} 
  ...
  \end{monsubsection}
  \parhead{Vile Beard} 
            Whenever the barbed demon makes a creature \glossterm{bleed} with a melee \glossterm{strike}, the filth from its beard infects the target.
...
\parhead{Knowledge (planes) 17} 
  ...
  \begin{monsubsection}{Worker}{2}[0.5]
    \vspace{-1em}\spelltwocol{}{Small planeforged}\vspace{-1em}
    \vspace{0em}
...
\parhead{Knowledge (planes) 15} 
    ...
    \begin{spellcontent}
      \begin{spelltargetinginfo}
        ...
        \textbf{VR} Physical 29, Energy 26
        \pari \textbf{Strikes:}
            Stinger \plus6 (2d10 piercing);
\par Bite \plus5 (2d10 bludgeoning and piercing)
      \end{spelltargetinginfo}
    \end{spellcontent}
    \begin{monsterfooter}
      \pari \textbf{Speed} 30 ft. \monsep
  ...
  \begin{monsubsection}{Skeleton Lizardfolk Grunt}{3}[1]
    ...
    \begin{spellcontent}
      \begin{spelltargetinginfo}
        ...
        \textbf{VR} Physical 29, Energy 23
        \pari \textbf{Strikes:}
            Spear \plus3 (1d8 piercing);
\par Claw \plus5 (1d6 piercing and slashing)
      \end{spelltargetinginfo}
    \end{spellcontent}
    \begin{monsterfooter}
      \pari \textbf{Speed} 30 ft. \monsep
  ...
  \begin{monsubsection}{Skeleton Lizardfolk Elite}{4}[2]
    \vspace{-1em}\spelltwocol{}{Medium undead}\vspace{-1em}
    \vspace{0em}
    ...
    \begin{spellcontent}
      \begin{spelltargetinginfo}
        ...
        \textbf{VR} Physical 33, Energy 27
        \pari \textbf{Strikes:}
            Spear \plus5 (2d6 piercing);
\par Claw \plus7 (1d10 piercing and slashing)
      \end{spelltargetinginfo}
    \end{spellcontent}
    \begin{monsterfooter}
      \pari \textbf{Speed} 30 ft. \monsep
