  ...
  \begin{freeability}{Mind Crush}
    ...
    \hit The target takes 7d10 energy damage and is \glossterm{confused} as a \glossterm{condition}.
    \crit 
    ...
    \begin{spellcontent}
      \begin{spelltargetinginfo}
        \pari \textbf{HP} 44;
          ...
          \textbf{Ref} 22;
          \textbf{Ment} 23
        \pari \textbf{DR} Physical 19; Energy 33
        \pari \textbf{VR} Physical 64; Energy 78
        \pari \textbf{Strike:}
            Greatmace \plus18 (8d10, Forceful bludgeoning)
      \end{spelltargetinginfo}
    \end{spellcontent}
    \begin{monsterfooter}
    ...
    \begin{spellcontent}
      \begin{spelltargetinginfo}
        \pari \textbf{HP} 44;
          ...
          \textbf{Ref} 26;
          \textbf{Ment} 27
        \pari \textbf{DR} Physical 28; Energy 42
        \pari \textbf{VR} Physical 99; Energy 113
        \pari \textbf{Strike:}
            Greatmace \plus22 (11d10, Forceful bludgeoning)
      \end{spelltargetinginfo}
    \end{spellcontent}
    \begin{monsterfooter}
      \pari \textbf{Speeds} land 30 ft., fly 40 ft.;
