  ...
  \begin{monsubsection}{Colossal Centipede}{13}[4]
    ...
    \begin{spellcontent}
      \begin{spelltargetinginfo}
        ...
        \pari \textbf{Strike:}
            Bite \plus16 (12d10 bludgeoning and piercing)
      \end{spelltargetinginfo}
    \end{spellcontent}
    \begin{monsterfooter}
  ...
  \begin{monsubsection}{Cyprus Treant}{11}[2]
    ...
    \begin{spellcontent}
      \begin{spelltargetinginfo}
        ...
        \textbf{VR} 92
        \pari \textbf{Strike:}
            Slam \plus13 (10d10 bludgeoning; Sweeping 2)
      \end{spelltargetinginfo}
    \end{spellcontent}
    \begin{monsterfooter}
      \pari \textbf{Speed} 50 ft. \monsep
...
\par Claw \plus10 (4d6 piercing and slashing)
  ...
  \end{monsubsection}
  \begin{freeability}{Acid Breath}
      \targets{Everything in a \areamed, 10 ft. wide line}
      A dragon can use its breath weapon as a \glossterm{minor action}.
      After a dragon uses its breath weapon, it cannot use it again until after the end of the next round.
  ...
  \begin{monsubsection}{Adult Black Dragon}{11}[4]
    ...
    \begin{spellcontent}
      \begin{spelltargetinginfo}
        ...
        \textbf{VR} 73
        \pari \textbf{Strikes:}
            Bite \plus16 (9d10 bludgeoning and piercing);
  ...
  \begin{monsubsection}{Old Black Dragon}{14}[4]
    ...
    \begin{spellcontent}
      \begin{spelltargetinginfo}
        ...
        \textbf{VR} 106
        \pari \textbf{Strikes:}
            Bite \plus19 (11d10 bludgeoning and piercing);
\par Claw \plus21 (9d10 piercing and slashing)
      \end{spelltargetinginfo}
    \end{spellcontent}
    \begin{monsterfooter}
      \pari \textbf{Speed} 60 ft. \monsep
  ...
  \begin{freeability}{Acid Breath}
    ...
    \hit Each target takes 9d10 acid damage.
    \end{freeability}
  ...
  \begin{monsubsection}{Ancient Black Dragon}{17}[4]
    ...
    \begin{spellcontent}
      \begin{spelltargetinginfo}
        ...
        \textbf{VR} 136
        \pari \textbf{Strikes:}
            Bite \plus23 (14d10 bludgeoning and piercing);
\par Claw \plus25 (12d10 piercing and slashing)
      \end{spelltargetinginfo}
    \end{spellcontent}
    \begin{monsterfooter}
      \pari \textbf{Speed} 70 ft. \monsep
  ...
  \begin{freeability}{Acid Breath}
    ...
    \hit Each target takes 12d10 acid damage.
    \end{freeability}
  ...
  \begin{monsubsection}{Wyrm Black Dragon}{20}[4]
    ...
    \begin{spellcontent}
      \begin{spelltargetinginfo}
        ...
        \textbf{VR} 168
        \pari \textbf{Strikes:}
            Bite \plus27 (16d10 bludgeoning and piercing);
\par Claw \plus29 (14d10 piercing and slashing)
      \end{spelltargetinginfo}
    \end{spellcontent}
    \begin{monsterfooter}
      \pari \textbf{Speed} 70 ft. \monsep
  ...
  \begin{freeability}{Acid Breath}
    ...
    \hit Each target takes 14d10 acid damage.
    \end{freeability}
  ...
  \begin{monsubsection}{Great Wyrm Black Dragon}{23}[4]
    ...
    \begin{spellcontent}
      \begin{spelltargetinginfo}
        ...
        \textbf{VR} 208
        \pari \textbf{Strikes:}
            Bite \plus31 (20d10 bludgeoning and piercing);
\par Claw \plus33 (18d10 piercing and slashing)
      \end{spelltargetinginfo}
    \end{spellcontent}
    \begin{monsterfooter}
      \pari \textbf{Speed} 70 ft. \monsep
  ...
  \begin{freeability}{Acid Breath}
    ...
    \hit Each target takes 17d10 acid damage.
    \end{freeability}
...
\par Light Crossbow \plus11 (5d10 piercing; 50 ft. range)
  ...
  \begin{freeability}{Power Smash}
    ...
    \hit The target takes 10d10 slashing damage.
    \end{freeability}
...
\parhead{Knowledge (planes) 15} 
  ...
  \begin{monsubsection}{Astral Deva}{12}[4]
    ...
    \begin{spellcontent}
      \begin{spelltargetinginfo}
        ...
        \pari \textbf{Strike:}
            Greatmace \plus17 (11d10 bludgeoning; Impact)
      \end{spelltargetinginfo}
    \end{spellcontent}
    \begin{monsterfooter}
  ...
  \begin{freeability}{Proclamation}
    ...
    \hit The target takes 11d10 bludgeoning damage. If the target is \glossterm{wounded} by the attack, it is \glossterm{stunned} as a \glossterm{condition}.
    \end{freeability}
  ...
  \begin{monsubsection}{Planetar}{16}[4]
    ...
    \begin{spellcontent}
      \begin{spelltargetinginfo}
        ...
        \pari \textbf{Strike:}
            Greatmace \plus20 (12d10 bludgeoning; Impact)
      \end{spelltargetinginfo}
    \end{spellcontent}
    \begin{monsterfooter}
  ...
  \begin{monsubsection}{Solar}{20}[4]
    ...
    \begin{spellcontent}
      \begin{spelltargetinginfo}
        ...
        \pari \textbf{Strike:}
            Greatmace \plus24 (15d10 bludgeoning; Impact)
      \end{spelltargetinginfo}
    \end{spellcontent}
    \begin{monsterfooter}
