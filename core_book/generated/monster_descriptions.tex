...
\par Claw \plus3 (1d8 piercing and slashing)
  ...
  \begin{monsection}{Cultist}{2}[1]
    ...
    \end{monsterfooter}
  \end{monsection}
  \begin{freeability}{Drain Life}[\glossterm{Focus}]
...
\par Light Crossbow \plus11 (6d10 piercing; ; 50 ft. range)
  ...
  \begin{monsection}{Pyromancer}{5}[1]
    ...
    \end{monsterfooter}
  \end{monsection}
  \begin{freeability}{Combustion}[\glossterm{Focus}]
    ...
    \begin{freeability}{Fireball}[\glossterm{Focus}]
  ...
  \begin{monsubsection}{Ogre Menace}{4}[3]
    ...
    \begin{spellcontent}
      \begin{spelltargetinginfo}
        ...
        \pari \textbf{Strikes:}
            Greatclub \plus6 (4d8 bludgeoning; Forceful);
