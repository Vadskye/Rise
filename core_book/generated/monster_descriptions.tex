...
\par Light Crossbow \plus9 (4d8 piercing)
  ...
  \begin{freeability}{Spit Acid}
    ...
    \begin{freeability}{Drag Prey}
      \target{One Medium or smaller creature or object within \reach}
...
\par Boulder \plus8 (4d8 bludgeoning; 100 ft. range)
  ...
  \begin{freeability}{Forceful Shove}
      \targets{As a greatclub strike}
      For each size category larger or smaller than the target that the hill giant is, it gains a +4 bonus or penalty to \glossterm{accuracy}. The giant makes a \plus11
        \glossterm{strike} vs. Fortitude
        with its greatclub against each target.
    
    \hit 
          Each target is knocked back 10 feet and takes 4d6  damage.
    \end{freeability}
  ...
  \begin{monsection}{Giant}[Stone]{10}[3]
    ...
    \parhead{Tactics} 
      Stone giants fight from a great distance whenever possible, using their ability to hurl great stones up to 1,000 feet.
...
\par Boulder \plus13 (7d10 bludgeoning; 200 ft. range)
  ...
  \begin{freeability}{Forceful Shove}
      \targets{As a greatclub strike}
      For each size category larger or smaller than the target that the stone giant is, it gains a +4 bonus or penalty to \glossterm{accuracy}. The giant makes a \plus17
        \glossterm{strike} vs. Fortitude
        with its greatclub against each target.
    
    \hit 
          Each target is knocked back 10 feet and takes 6d10  damage.
    \end{freeability}
