...
You gain a \plus4 \glossterm{magic bonus} to \glossterm{resistances} against \glossterm{energy damage}.
...
You gain a \plus4 \glossterm{magic bonus} to \glossterm{resistances} against \glossterm{physical damage}.
...
You gain a \plus2 \glossterm{magic bonus} to Armor defense against ranged \glossterm{strikes} from weapons or projectiles that are Small or smaller.
...
You gain a \plus4 \glossterm{magic bonus} to Armor defense against ranged \glossterm{strikes} from weapons or projectiles that are Small or smaller.
