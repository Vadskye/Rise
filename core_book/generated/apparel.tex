...
You gain a \plus1 bonus to \glossterm{wound rolls}.
...
This item functions like the \mitem{amulet of health}, except that the bonus increases to \plus2.
...
\lowercase{\hypertarget{item:Amulet of Health, Supreme}{}}\label{item:Amulet of Health, Supreme}
\hypertarget{item:Amulet of Health, Supreme}{\subsubsection{Amulet of Health, Supreme\hfill\nth{18} (190,000 gp)}}

This item functions like the \mitem{amulet of health}, except that the bonus increases to \plus3.
...
As a standard action, you can use this belt to gain a \plus1 bonus to the \glossterm{wound roll} of your most recent \glossterm{vital wound}.
...
A the end of each round, you gain a \plus2 bonus to the \glossterm{wound roll} of your most recent \glossterm{vital wound}.
The \glossterm{wound roll} for that \glossterm{vital wound} cannot be modified again.
...
This item functions like the \mitem{ring of regeneration} item, except that the bonus increases to \plus3.
