...
\hypertarget{item:Potion of Wound Closure, Epic}{\subsubsection{Potion of Wound Closure, Epic\hfill\nth{19} (56,000 gp)}}

When you drink this \glossterm{potion}, if you have a \glossterm{vital wound} with a \glossterm{wound roll} of 0, \minus1, \minus2, or \minus3, you treat that wound roll as a 1 instead (see \pcref{Vital Wounds}).
...
When you drink this \glossterm{potion}, if you have a \glossterm{vital wound} with a \glossterm{wound roll} of 0 or \minus1, you treat that wound roll as a 1 instead (see \pcref{Vital Wounds}).
...
When you drink this \glossterm{potion}, if you have a \glossterm{vital wound} with a \glossterm{wound roll} of 0, \minus1, or \minus2, you treat that wound roll as a 1 instead (see \pcref{Vital Wounds}).
