...
The fundamental assumptions that Rise makes about its fantasy world are:
...
\sectiongraphic*{Deities and Afterlifes}{width=\columnwidth}{the universe/deities and afterlifes}
  ...
  Many people know, through some chain of connections, someone who chose to become a cleric and was quickly rewarded with divine magic far beyond anything they could previously do on their own.
  ...
  There are five Spiritual Planes, with one plane for each primary alignment.
  People generally know that the five planes exist, and have an expectation of where they will go.
  In particular, it is well known that the Abyss, where evildoers go after death, is much less pleasant than the other afterlife planes.
...
\section{Affinity}\label{Affinity}
    ...
    \subsection{Sympathetic Magic}
      Sympathetic magic, which relies on similarities between distant targets, uses principles similar to affinity.
      However, it can affect objects which do not themselves have souls.
      Because affinity is a pulling force, it is generally easier to draw distant effects to you with affinity than it is to act directly on distant targets, and the same applies to sympathetic magic.
      For example, the \spell{conjoined conjuration -- Ventus} spell conjures wind from Ventus to the caster's location.
      That is much easier than sending air from your location to Ventus.
...
\section{Cosmology}\label{Cosmology}
  ...
  The Spiritual Planes are made from \glossterm{essentia}, which is the residue left behind when souls decay into nonexistence.
  ...
  Unlike the Material Plane and Spiritual Planes, the Astral Expanse has four spatial dimensions.
  ...
  To do so, they would have to move through the fourth spatial dimension.
  ...
  \subsection{Demiplanes}
    ...
    These demiplanes may be composed of ordinary material, \glossterm{essentia}, or both, and they can have widely varied properties.
  ...
  \subsection{Atmosphere}
    ...
    \begin{raggeditemize}
      ...
      \item Vacuum: The realm has no atmosphere at all.
        Everything in the realm takes 10 cold damage at the end of its turn unless it is protected from the cold.
  ...
  \subsection{Gravity Strength} The strength of gravity in a realm can take one of the following forms:
    \begin{raggeditemize}
      ...
      \item Heavy: Gravity is about twice the strength of Earth.
        ...
        All fly speeds have a \glossterm{height limit} of 5 feet, and gliding is impossible.
        % TODO: falling damage
      \item Extreme: Gravity is about four times the strength of Earth.
        ...
        Flying and gliding is impossible.
    \end{raggeditemize}
...
\section{Planets of the Material Plane}\label{Planets of the Material Plane}
  ...
  \subsection{Terra}
    Terra is an unusually large planet with intense gravity.
    Many of its inhabitants are adapted to the experience, but it is challenging for newcomers.
  ...
  \subsection{Aqua}
    ...
    Magnificent underwater cities are carved from huge rocks that float peacefully suspended in the water, or are embedded into mountains.
  ...
  \subsection{Space}
    The space between planets is vast and hostile to travellers.
    It is almost entirely empty, though asteroids and comets may pass by on rare occasions.
    There are no creatures native to space.

    Space has the following nonstandard realm traits:
    \begin{raggeditemize}
      \item Atmosphere: Vacuum.
      \item Gravity: None. If you are sufficiently close to a planet, you begin experiencing its gravity, but most of space is devoid of gravity for practical purposes.
    \end{raggeditemize}

\section{Spiritual Planes}
    The five Spiritual Planes are manifestations of the five core alignments.
    ...
    This makes them much more malleable than the Material Plane.
    ...
    \subsection{Elysium}
      ...
      Because of the world's bowl-like structure, you can see the majestic landscape spread out in every direction even from flat ground, and the view from mountains is breathtaking.
    ...
    \subsection{The Abyss}
      ...
      The cliffs are jagged and broken, with large cliff shelves between elevation changes that are relatively flat.
      Divine dominions often take advantage of those areas, and some cliff shelves can hold entire countries.
...
\section{The Astral Expanse}
  ...
  These become a hotbed of precursor cult activity if they are ever discovered.
