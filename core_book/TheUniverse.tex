...
\section{Realm Traits}
  ...
  \subsection{Gravity Direction}
    ...
    \begin{raggeditemize}
      \item Massive Gravity: Gravity pulls towards object based on their mass, as it does in the real world.
        This is the default for all locations unless otherwise specified.
      \item Fixed Gravity: Gravity points in a fixed direction and with a fixed strength at all locations in the realm.
      \item Absolute Directional Gravity: Gravity points in a consistent direction according to a rule that applies equally to everything on the realm, but which is not in a fixed direction.
      ...
      \item Subjective Gravity: Each creature in the realm chooses the direction of gravity for that creature.
  ...
  \subsection{Gravity Strength} The strength of gravity in a realm can take one of the following forms:
    \begin{raggeditemize}
      \item Normal Gravity: Gravity is about the strength of Earth.
          This is the default for all locations unless otherwise specified.
      \item No Gravity: There is no gravity in the realm.
...
\section{Spiritual Planes}
    ...
    \subsection{Elysium}
      ...
      \begin{raggeditemize}
        \item Gravity: Absolute directional. Gravity always points towards the 
