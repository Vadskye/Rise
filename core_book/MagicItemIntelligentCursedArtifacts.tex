...
When a personality conflict occurs, the possessor must make a Will saving throw (DR = item's Ego). If the possessor succeeds, she is dominant. If she fails, the item is dominant. Dominance lasts for one day or until a critical situation occurs (such as a major battle, a serious threat to either the item or the character, and so on). Should an item gain dominance, it resists the character's desires and demands concessions such as any of the following.
...
Bracers of Defenselessness:} These appear to be bracers of armor \plus5 and actually serve as such until the wearer is attacked in anger by an enemy with a Challenge Rating equal to or greater than her level. At that moment and thereafter, the bracers cause a \minus5 penalty to AD. Once their curse is activated, bracers of defenselessness can be removed only by means of a remove curse spell.
...
The broom gets two attacks per round with each end (two swats with the straw and two with the handle, for a total of four attacks per round). It attacks with a \plus5 bonus on each attack roll. The straw end causes a victim to be blinded for 1 round when it hits. The handle deals 1d6 points of damage when it hits. The broom has AD 13, 18 hit points, and hardness 4.

Moderate transmutation; CL 10th; Create Wondrous Item, fly, animate objects; Price 5,200 gp.

Cloak of Poisonousness:} This cloak is usually made of a woolen material, although it can be made of leather. A detect poison spell can reveal the presence of poison impregnated in the cloak's fabric. The garment can be handled without harm, but as soon as it is actually donned the wearer is killed instantly unless she succeeds on a DR 28 Fortitude save.
...
Crystal Hypnosis Ball:} This cursed item is indistinguishable from a normal crystal ball. However, anyone attempting to use the scrying device becomes fascinated for 1d6 minutes, and a telepathic suggestion is implanted in his mind (Will DR 19 negates).
...
Dust of Sneezing and Choking:} This fine dust appears to be dust of appearance. If cast into the air, it causes those within a 20- foot spread to fall into fits of sneezing and coughing. Those failing a DR 15 Fortitude save take 2d6 points of Constitution damage immediately. In addition, those failing a second DR 15 Fortitude save 1 minute later are dealt 1d6 points of Constitution damage. Those who succeed on either saving throw are nonetheless disabled by choking (treat as stunned) for 5d4 rounds.

Faint conjuration; CL 7th; Create Wondrous Item, poison; Price 2,400 gp.

Flask of Curses:} This item looks like an ordinary beaker, bottle, container, decanter, flask, or jug. It may contain a liquid, or it may emit smoke. When the flask is first unstoppered, all within 30 feet must make a DR 17 Will save or be cursed, taking a ?2 penalty on attack rolls, saving throws, and skill checks until a remove curse spell is cast upon them.
...
Mace of Blood:} This \plus3 heavy mace must be coated in blood every day, or its bonus fades away (until the mace is coated again). The character using this mace must make a DR 13 Will save every day it is within his possession or become chaotic evil.
...
Potion of Poison:} This potion has lost its once beneficial magical abilities and has become a potent poison. The imbiber must make a DR 16 Fortitude save or take 1d10 points of Constitution damage. A minute later he must save again (DR 16) or take 1d10 points of Constitution damage.
...
The wearer takes a \minus5 penalty on initiative checks and a ?2 penalty on all attack rolls, saves, and skill checks. If he tries to cast a spell, he must make a Concentration check (DR 20 \add spell level) or lose the spell.
...
\item Detect magic
\item Enlarge person (Fortitude DR 15 negates)
\item Hold portal
\item Light
\item Mage armor
\item Mage hand
...
\item Dispel magic
\item Fireball (10d6 damage, Reflex DR 17 half )
\item Ice storm
\item Invisibility
\item Knock
\item Lightning bolt (10d6 damage, Reflex DR 17 half )
\item Passwall
\item Pyrotechnics (Will or Fortitude DR 16 negates)
\item Wall of fire
\item Web

These powers drain 2 charges per usage:
\item Monster summoning IX
\item Plane shift (Will DR 21 negates)
\item Telekinesis (400 lb. maximum weight; Will DR 19 negates)
...
\item Black Dragon Orb:} Fly (Will DR 17 negates).
\item Blue Dragon Orb:} Haste (Fortitude DR 17 negates).
\item Brass Dragon Orb:} Teleport (Will DR 19 negates).
\item Bronze Dragon Orb:} Scrying (Will DR 18 negates).
\item Copper Dragon Orb:} Suggestion (Will DR 17 negates).
\item Gold Dragon Orb:} The owner of the gold Orb can call upon any power possessed by one of the other Orbs - including the dominate and breath weapon abilities but not AD, save bonuses, or breath weapon immunity - but can only use an individual

power once per day. She can use dominate on any other possessor of an Orb within 1 mile (Will DR 23 negates).
\item Green Dragon Orb:} Spectral hand.
\item Red Dragon Orb:} Wall of fire.
\item Silver Dragon Orb:} Cure critical wounds (Will DR 18 half ).
\item White Dragon Orb:} Protection from energy (cold) (Fortitude DR 17 negates).
...
The Shadowstaff:} This artifact was crafted centuries ago, weaving together the wispy strands of shadow itself into a twisted black staff. The Shadowstaff makes the wielder slightly shadowy and incorporeal, granting him a \plus4 bonus to AD and Reflex saves (which stacks with any other bonuses). However, in bright light (such as that of the sun, but not a torch) or in absolute darkness, the wielder takes a ?2 penalty on all attack rolls, saves, and checks. 
