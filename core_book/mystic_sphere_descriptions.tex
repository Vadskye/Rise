...
\begin{apability}{Cantrip}[\glossterm{Manifestation}, \glossterm{Water}]
...
\begin{apability}{Cantrip}[\glossterm{Planar}, \glossterm{Teleportation}]
...
\begin{apability}{Cantrip}[\glossterm{Sustain} (standard)]
Choose a willing creature in \rngclose range.
...
\begin{apability}{Cantrip}[\glossterm{Temporal}]
Make an attack vs. Mental against a creature within \rngmed range.
...
\begin{apability}{Cantrip}[\glossterm{Compulsion}, \glossterm{Mind}]
Make an attack vs. Mental against a creature within \rngmed range.
...
\begin{apability}{Corruption}[\glossterm{Life}]
...
\begin{apability}{Cantrip}[\glossterm{Cold}]
...
\begin{apability}{Cantrip}[\glossterm{Emotion}, \glossterm{Mind}]
Make an attack vs. Mental against a creature within \rngmed range.
...
\begin{apability}{Cantrip}[\glossterm{Electricity}]
Make an attack vs. Fortitude against everything in a \areamed, 5 ft.\ wide line from you.
...
\begin{apability}{Cantrip}[\glossterm{Acid}, \glossterm{Manifestation}]
...
\begin{apability}{Cantrip}[\glossterm{Sensation}, \glossterm{Visual}]
...
\begin{apability}{Cantrip}[\glossterm{Light}, \glossterm{Sensation}, \glossterm{Visual}]
...
\begin{apability}{Polymorph}[\glossterm{Shaping}]
Make an attack vs. Fortitude against a creature within \rngmed range.
\hit The target takes physical \glossterm{standard damage}.
\end{apability}
...
\begin{apability}{Cantrip}[\glossterm{Fire}]
Make an attack vs. Armor against one creature or object within \rngmed range.
...
\begin{apability}{Cantrip}[\glossterm{Scrying}, \glossterm{Sustain} (minor)]
...
\begin{apability}{Summon Monster}[\glossterm{Manifestation}, \glossterm{Sustain} (standard)]
...
\begin{apability}{Cantrip}[\glossterm{Earth}, \glossterm{Physical}]
...
\begin{apability}{Cantrip}[\glossterm{Mystic}, \glossterm{Sustain} (standard)]
...
\begin{apability}{Vital Surge}[\glossterm{Life}]
Make an attack vs. Fortitude against a creature within \rngmed range.
...
\begin{apability}{Cantrip}[\glossterm{Manifestation}]
Make an attack vs. Armor against one creature or object within \rngmed range.
\hit The target takes piercing \glossterm{standard damage}.
\end{apability}
