...
\begin{freeability}{Airborne Leap}[\glossterm{Air}]
\target{Self}
...
\target{Self or an \glossterm{ally} within \rngmed range}
...
\begin{freeability}{Slippery Escape}[\glossterm{Manifestation}, \glossterm{Water}]
\target{Self or an \glossterm{ally} within \rngclose range}
...
\begin{freeability}{Accelerated Reading}[\glossterm{Sustain} (free), \glossterm{Temporal}]
\target{Self}
...
\begin{freeability}{Accelerated Search}[\glossterm{Temporal}]
\target{Self}
...
\target{Self or \glossterm{ally} within \rngclose range}
...
\target{Location within \rngmed range}
...
\begin{freeability}{Kindle}[\glossterm{Fire}]
...
\target{Unoccupied location within \rngmed range}
...
\begin{freeability}{Rapid Growth}[\glossterm{Life}, \glossterm{Sustain} (minor)]
\target{Small or smaller inanimate plant within \rngclose range}
...
\target{Self or living \glossterm{ally} within \rngclose range}
