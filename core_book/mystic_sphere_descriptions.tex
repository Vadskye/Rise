...
\begin{attuneability}[\nth{1}]{\hypertarget{spell:Complete Mantle of Faith}{Complete Mantle of Faith}}[\glossterm{Attune} (self)]
...
\begin{attuneability}[\nth{4}]{\hypertarget{spell:Greater Complete Mantle Of Faith}{Greater Complete Mantle Of Faith}}[\glossterm{Attune} (self)]
...
\begin{apability}[\nth{2}]{\hypertarget{spell:Fearsome Flame}{Fearsome Flame}}[\glossterm{Fire}]
...
This spell functions like the \spell{inflict wounds} spell, except that you gain a \plus1d bonus to damage, and any damage dealt in excess of the target's hit points is dealt as \glossterm{vital damage}.
\end{apability}
\vspace{0.25em}
...
This spell functions like the \spell{inflict wounds} spell, except that gain a \plus1d bonus to damage and you heal hit points equal to the damage dealt.
\end{apability}
\vspace{0.25em}
