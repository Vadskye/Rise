...
\target{One Small or smaller unattended object with writing on it within \rngclose range}
...
\target{All food and water in a single square within \rngclose range}
...
\target{All creatures within a \arealarge radius from you}
Make an attack vs. Mental against each target.
...
\target{All creatures within a \areamed radius \glossterm{emanation} from you}
...
\target{All creatures within a \arealarge radius \glossterm{emanation} from you}
...
\target{All Large or smaller creatures in the area (see text)}
...
\target{One Small or smaller unattended object within \rngclose range}
...
\target{All creatures in the area (see text)}
...
\target{One \areasmall radius within \rngmed range of you, and all creatures in the area}
...
\target{One large or smaller \glossterm{ally} within \rngclose range}
This spell functions like the \spell{enlarge} spell, except that the target gains a \plus2 \glossterm{magic bonus} to Strength to match its new size.
\end{attuneability}
\vspace{0.25em}
...
\target{One Small or smaller unattended, nonmagical wooden object within \rngclose range}
...
\target{All creatures in a \areasmall radius within \rngmed range}
...
\target{All Large or smaller creatures in a \areasmall radius within \rngmed range}
...
\target{All Large or smaller creatures in a \areamed radius within \rngmed range}
...
\target{All earth and unworked stone in a \areamed radius within \rngmed range}
...
\target{All creaturesin a \areamed radius within \rngmed range}
...
\target{All plants and arable earth in a \areamed radius within \rngmed range}
...
\target{All plants and arable earth in a \arealarge radius within \rnglong range}
...
\hit The secondary target takes life damage equal to \glossterm{standard damage} \plus2d.
