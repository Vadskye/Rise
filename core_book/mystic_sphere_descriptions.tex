...
\lowercase{\hypertarget{spell:Recovering Screen}{}}\label{spell:Recovering Screen}
\begin{freeability}[\nth{1}]{\hypertarget{spell:Recovering Screen}{Recovering Screen}}[\glossterm{Air}, \glossterm{Swift}]
Until the end of the round, you gain a \plus2 bonus to Armor defense against ranged \glossterm{physical attacks} from weapons or projectiles that are Small or smaller.
...
% TODO: wording
\hit Each target takes bludgeoning \glossterm{standard damage} \minus1d and is moved 10 feet in the direction the line points away from you.
\end{apability}
\vspace{0.25em}
...
This spell functions like the \spell{windstrike} spell, except that it affects a target within \rnglong range and the damage increases to \glossterm{standard damage} \plus3d.
\end{apability}
\vspace{0.25em}
...
\begin{apability}[\nth{3}]{\hypertarget{spell:Hurricane}{Hurricane}}[\glossterm{Air}]
Make an attack vs. Fortitude against everything in a \arealarge radius from you.
\hit Each target takes bludgeoning \glossterm{standard damage} \minus1d and is moved 10 feet clockwise around you.
...
In addition, the target gains a \plus2 \glossterm{magic bonus} to \glossterm{power} with melee \glossterm{strikes}.
...
\begin{apability}[\nth{5}]{\hypertarget{spell:Greater Hurricane}{Greater Hurricane}}[\glossterm{Air}]
...
This spell functions like the \spell{windstrike} spell, except that it affects a target within \rngext range and the damage increases to \glossterm{standard damage} \plus4d.
\end{apability}
\vspace{0.25em}
...
\lowercase{\hypertarget{spell:Refreshing Drink}{}}\label{spell:Refreshing Drink}
\begin{freeability}[\nth{1}]{\hypertarget{spell:Refreshing Drink}{Refreshing Drink}}[\glossterm{Creation}, \glossterm{Swift}, \glossterm{Water}]
...
\lowercase{\hypertarget{spell:Astral Recovery}{}}\label{spell:Astral Recovery}
\begin{freeability}[\nth{1}]{\hypertarget{spell:Astral Recovery}{Astral Recovery}}[\glossterm{Planar}, \glossterm{Swift}, \glossterm{Teleportation}]
...
The damage dealt changes to fire \glossterm{standard damage} \plus3d.
...
The damage dealt increases to \glossterm{standard damage} \plus3d.
...
The damage dealt increases to \glossterm{standard damage} \plus5d and becomes damage of all types.
\end{apability}
\vspace{0.25em}
...
\lowercase{\hypertarget{spell:Ablative Recovery}{}}\label{spell:Ablative Recovery}
\begin{freeability}[\nth{1}]{\hypertarget{spell:Ablative Recovery}{Ablative Recovery}}[\glossterm{Shielding}, \glossterm{Swift}]
...
\begin{attuneability}[\nth{1}]{\hypertarget{spell:Wall of Force}{Wall of Force}}[\glossterm{Attune} (self)]
...
\begin{attuneability}[\nth{2}]{\hypertarget{spell:Expanded Wall of Force}{Expanded Wall of Force}}[\glossterm{Attune} (self)]
...
\begin{attuneability}[\nth{2}]{\hypertarget{spell:Wall of Energy Impedance}{Wall of Energy Impedance}}[\glossterm{Attune} (self)]
You create a wall of magical energy in a 10 ft.\ high, \areamed line within \rngmed range.
The wall is visible as a shimmering magical membrane that does not block sight.
...
\begin{attuneability}[\nth{3}]{\hypertarget{spell:Fortified Wall of Force}{Fortified Wall of Force}}[\glossterm{Attune} (self)]
...
\begin{attuneability}[\nth{4}]{\hypertarget{spell:Wall of Magic Impedance}{Wall of Magic Impedance}}[\glossterm{Attune} (self)]
You create a wall of magical energy in a 10 ft.\ high, \areamed line within \rngmed range.
The wall is visible as a shimmering magical membrane that does not block sight.
...
\begin{attuneability}[\nth{5}]{\hypertarget{spell:Impervious Wall of Force}{Impervious Wall of Force}}[\glossterm{Attune} (self)]
...
\lowercase{\hypertarget{spell:Recovering Blessing}{}}\label{spell:Recovering Blessing}
\begin{freeability}[\nth{1}]{\hypertarget{spell:Recovering Blessing}{Recovering Blessing}}[\glossterm{Swift}]
...
\lowercase{\hypertarget{spell:Faithful Recovery}{}}\label{spell:Faithful Recovery}
\begin{freeability}[\nth{1}]{\hypertarget{spell:Faithful Recovery}{Faithful Recovery}}[\glossterm{Shielding}, \glossterm{Swift}]
...
\lowercase{\hypertarget{spell:Accelerated Recovery}{}}\label{spell:Accelerated Recovery}
\begin{freeability}[\nth{1}]{\hypertarget{spell:Accelerated Recovery}{Accelerated Recovery}}[\glossterm{Swift}, \glossterm{Temporal}]
Until the end of the round, you gain a \plus2 bonus to Reflex defense.
At the end of the round, you regain a spent \glossterm{recovery action point}.
\end{freeability}
\vspace{0.25em}
...
\lowercase{\hypertarget{spell:Compel Recovery}{}}\label{spell:Compel Recovery}
\begin{freeability}[\nth{1}]{\hypertarget{spell:Compel Recovery}{Compel Recovery}}[\glossterm{Compulsion}, \glossterm{Swift}]
You force your mind and body to rest quickly.
Until the end of the round, you gain a \plus2 bonus to Mental defense.
At the end of the round, you regain a spent \glossterm{recovery action point}.
\end{freeability}
\vspace{0.25em}
...
\begin{apability}[\nth{4}]{\hypertarget{spell:Discordant Song}{Discordant Song}}[\glossterm{Compulsion}]
Make an attack vs. Mental against all enemies in a \areamed radius from you.
...
\lowercase{\hypertarget{spell:Corrupting Recovery}{}}\label{spell:Corrupting Recovery}
\begin{freeability}[\nth{1}]{\hypertarget{spell:Corrupting Recovery}{Corrupting Recovery}}[\glossterm{Life}]
Make an attack vs. Fortitude against a living creature within \rngclose range.
\hit As a \glossterm{condition}, the target takes a \minus2 penalty to Fortitude defense.
...
\lowercase{\hypertarget{spell:Drain Heat}{}}\label{spell:Drain Heat}
\begin{freeability}[\nth{1}]{\hypertarget{spell:Drain Heat}{Drain Heat}}[\glossterm{Cold}]
...
\begin{attuneability}[\nth{1}]{\hypertarget{spell:Fearsome Aura}{Fearsome Aura}}[\glossterm{Attune} (self), \glossterm{Emotion}]
...
\lowercase{\hypertarget{spell:Recovering Calm}{}}\label{spell:Recovering Calm}
\begin{freeability}[\nth{1}]{\hypertarget{spell:Recovering Calm}{Recovering Calm}}[\glossterm{Emotion}, \glossterm{Swift}]
...
\begin{apability}[\nth{4}]{\hypertarget{spell:Mass Enrage}{Mass Enrage}}[\glossterm{Emotion}]
...
\lowercase{\hypertarget{spell:Recovering Discharge}{}}\label{spell:Recovering Discharge}
\begin{freeability}[\nth{1}]{\hypertarget{spell:Recovering Discharge}{Recovering Discharge}}[\glossterm{Electricity}]
...
\begin{freeability}{Assist Disguise}[\glossterm{Sensation}, \glossterm{Sustain} (minor), \glossterm{Visual}]
Choose a willing creature within \rngclose range.
% TODO: wording?
...
\lowercase{\hypertarget{spell:Recovering Blur}{}}\label{spell:Recovering Blur}
\begin{freeability}[\nth{1}]{\hypertarget{spell:Recovering Blur}{Recovering Blur}}[\glossterm{Sensation}, \glossterm{Swift}, \glossterm{Visual}]
Your image blurs as you focus your magical energy on recovering.
Until the end of the round, you gain a \plus1 bonus to Armor defense.
At the end of the round, you regain a spent \glossterm{recovery action point}.
\end{freeability}
\vspace{0.25em}
...
\lowercase{\hypertarget{spell:Recovering Illumination}{}}\label{spell:Recovering Illumination}
\begin{freeability}[\nth{1}]{\hypertarget{spell:Recovering Illumination}{Recovering Illumination}}[\glossterm{Light}, \glossterm{Sensation}, \glossterm{Visual}]
...
\lowercase{\hypertarget{spell:Fortifying Recovery}{}}\label{spell:Fortifying Recovery}
\begin{freeability}[\nth{1}]{\hypertarget{spell:Fortifying Recovery}{Fortifying Recovery}}[\glossterm{Shaping}, \glossterm{Swift}]
Until the end of the round, you gain a \plus2 bonus to Fortitude defense.
At the end of the round, you regain a spent \glossterm{recovery action point}.
\end{freeability}
\vspace{0.25em}
...
\lowercase{\hypertarget{spell:Recovering Scorch}{}}\label{spell:Recovering Scorch}
\begin{freeability}[\nth{1}]{\hypertarget{spell:Recovering Scorch}{Recovering Scorch}}[\glossterm{Fire}]
Make an attack vs. Armor against one creature or object within \rngmed range.
...
\begin{apability}[\nth{2}]{\hypertarget{spell:Fearsome Flame}{Fearsome Flame}}[\glossterm{Emotion}, \glossterm{Fire}]
...
\hit Each target takes fire \glossterm{standard damage} \plus1d.
\end{apability}
\vspace{0.25em}
...
\begin{freeability}{Minor Vision}
...
\lowercase{\hypertarget{spell:Precognitive Recovery}{}}\label{spell:Precognitive Recovery}
\begin{freeability}[\nth{1}]{\hypertarget{spell:Precognitive Recovery}{Precognitive Recovery}}[\glossterm{Swift}]
Until the end of the round, you gain a \plus1 bonus to Armor defense.
At the end of the round, you regain a spent \glossterm{recovery action point}.
\end{freeability}
\vspace{0.25em}
...
\lowercase{\hypertarget{spell:Recovering Crush}{}}\label{spell:Recovering Crush}
\begin{freeability}[\nth{1}]{\hypertarget{spell:Recovering Crush}{Recovering Crush}}
Make an attack vs. Mental against one creature or object within \rngmed range.
\hit The target takes bludgeoning \glossterm{standard damage} \minus2d.
In addition, you regain a spent \glossterm{recovery action point}.
\end{freeability}
\vspace{0.25em}
...
\lowercase{\hypertarget{spell:Earthen Recovery}{}}\label{spell:Earthen Recovery}
\begin{freeability}[\nth{1}]{\hypertarget{spell:Earthen Recovery}{Earthen Recovery}}[\glossterm{Earth}, \glossterm{Swift}]
...
\lowercase{\hypertarget{spell:Thaumaturgic Recovery}{}}\label{spell:Thaumaturgic Recovery}
\begin{freeability}[\nth{1}]{\hypertarget{spell:Thaumaturgic Recovery}{Thaumaturgic Recovery}}[\glossterm{Swift}]
Until the end of the round, you gain a \plus1 bonus to \glossterm{defenses} against spells.
At the end of the round, you regain a spent \glossterm{recovery action point}.
\end{freeability}
\vspace{0.25em}
...
\lowercase{\hypertarget{spell:Verdant Recovery}{}}\label{spell:Verdant Recovery}
\begin{freeability}[\nth{1}]{\hypertarget{spell:Verdant Recovery}{Verdant Recovery}}[\glossterm{Life}]
...
\lowercase{\hypertarget{spell:Healing Recovery}{}}\label{spell:Healing Recovery}
\begin{freeability}[\nth{1}]{\hypertarget{spell:Healing Recovery}{Healing Recovery}}[\glossterm{Life}]
