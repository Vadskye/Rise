...
\begin{apability}[\nth{5}]{\hypertarget{spell:Greater Blessing of Resilience}{Greater Blessing of Resilience}}
...
\begin{apability}[\nth{7}]{\hypertarget{spell:Supreme Blessing of Resilience}{Supreme Blessing of Resilience}}
...
\begin{spellheader}
\spelldesc{Smite foes with divine power.}
\end{spellheader}
...
\begin{freeability}{Judge Unworthy}
Make an attack vs. Mental against a creature within \rngmed range.
...
\lowercase{\hypertarget{spell:Smite the Unworthy}{}}\label{spell:Smite the Unworthy}
\begin{apability}[\nth{1}]{\hypertarget{spell:Smite the Unworthy}{Smite the Unworthy}}
Make an attack vs. Mental against a creature within \rngmed range.
...
\begin{apability}[\nth{2}]{\hypertarget{spell:Corrosive Orb}{Corrosive Orb}}
