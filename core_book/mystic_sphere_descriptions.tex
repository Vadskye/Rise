...
\begin{apability}[\nth{2}]{\hypertarget{spell:Wall of Water}{Wall of Water}}[\glossterm{Manifestation}, \glossterm{Water}]
...
\begin{attuneability}[\nth{5}]{\hypertarget{spell:Resist Magic}{Resist Magic}}[\glossterm{Attune} (target), \glossterm{Shielding}]
Choose a willing creature within \rngmed range.
