...
\begin{attuneability}[\nth{3}]{\hypertarget{spell:Immunity}{Immunity}}[\glossterm{Attune} (self), \glossterm{Shielding}]
\target{Yourself}
...
\begin{attuneability}[\nth{5}]{\hypertarget{spell:Supreme Haste}{Supreme Haste}}[\glossterm{Attune} (target), \glossterm{Temporal}]
