...
This spell functions like the \spell{gust of wind} spell, except that it affects everything in a \areahuge, 10 ft. wide line from you and deals \glossterm{standard damage} \plus1d.
\end{apability}
\vspace{0.25em}
...
This spell functions like the \spell{cone of cold} spell, except that you gain a \plus1d bonus to damage and each struck target is \glossterm{immobilized} instead of \glossterm{chilled}.
\end{apability}
\vspace{0.25em}
...
This spell functions like the \spell{frostbite} spell, except that you gain a \plus1d bonus to damage and a struck target is also \glossterm{chilled} as a \glossterm{condition}.
\end{apability}
\vspace{0.25em}
