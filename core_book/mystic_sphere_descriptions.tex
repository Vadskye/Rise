...
\begin{freeability}{Ablative Shield}[\glossterm{Sustain} (standard)]
Choose a willing creature in \rngclose range.
...
\begin{freeability}{Fall}[\glossterm{Compulsion}]
Make an attack vs. Mental against a creature within \rngmed range.
...
\begin{freeability}{Cause Fear}[\glossterm{Emotion}]
Make an attack vs. Mental against a creature within \rngmed range.
...
\begin{freeability}{Precognitive Strike}[\glossterm{Swift}]
Choose a willing creature within \rngclose range.
...
\lowercase{\hypertarget{spell:Recovering Compression}{}}\label{spell:Recovering Compression}
\begin{freeability}[\nth{1}]{\hypertarget{spell:Recovering Compression}{Recovering Compression}}
Make an attack vs. Mental against one creature or object within \rngmed range.
