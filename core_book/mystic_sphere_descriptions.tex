...
\begin{attuneability}[\nth{3}]{\hypertarget{spell:Greater Wind Screen}{Greater Wind Screen}}[\glossterm{Air}, \glossterm{Attune} (target), \glossterm{Shielding}]
...
\begin{apability}[\nth{6}]{\hypertarget{spell:Stripping Cyclone}{Stripping Cyclone}}[\glossterm{Air}]
...
\begin{apability}[\nth{2}]{\hypertarget{spell:Wall of Water}{Wall of Water}}
...
\begin{apability}[\nth{6}]{\hypertarget{spell:Greater Raging River}{Greater Raging River}}[\glossterm{Manifestation}, \glossterm{Water}]
...
\begin{freeability}{Blessing of Restoration}
Choose a willing creature within \rngclose range.
...
\begin{attuneability}[\nth{5}]{\hypertarget{spell:Greater Blessed Blade}{Greater Blessed Blade}}[\glossterm{Attune} (target), \glossterm{Fire}]
...
\begin{attuneability}[\nth{1}]{\hypertarget{spell:Mantle of Faith}{Mantle of Faith}}[\glossterm{Attune} (target)]
...
\begin{apability}[\nth{7}]{\hypertarget{spell:Greater Time Lock}{Greater Time Lock}}[\glossterm{Sustain} (minor), \glossterm{Temporal}]
...
\begin{apability}[\nth{4}]{\hypertarget{spell:Crippling Decay}{Crippling Decay}}[\glossterm{Life}]
...
\begin{apability}[\nth{4}]{\hypertarget{spell:Curse of Decay}{Curse of Decay}}[\glossterm{Life}]
...
\begin{apability}[\nth{4}]{\hypertarget{spell:Freezing}{Freezing}}[\glossterm{Cold}]
...
\begin{apability}[\nth{4}]{\hypertarget{spell:Greater Cold Snap}{Greater Cold Snap}}[\glossterm{Cold}]
...
\begin{apability}[\nth{2}]{\hypertarget{spell:Forked Lightning}{Forked Lightning}}[\glossterm{Electricity}]
...
\begin{apability}[\nth{4}]{\hypertarget{spell:Greater Dynamo}{Greater Dynamo}}[\glossterm{Electricity}]
...
\begin{apability}[\nth{2}]{\hypertarget{spell:Corrosive Orb}{Corrosive Orb}}[\glossterm{Acid}, \glossterm{Manifestation}]
...
\begin{apability}[\nth{2}]{\hypertarget{spell:Wall of Fire}{Wall of Fire}}
...
\begin{apability}[\nth{3}]{\hypertarget{spell:Fearsome Flame}{Fearsome Flame}}[\glossterm{Fire}]
...
\begin{attuneability}[\nth{2}]{\hypertarget{spell:Boon of Mastery}{Boon of Mastery}}[\glossterm{Attune} (target)]
Choose a willing creature within \rngclose range.
...
\begin{attuneability}[\nth{4}]{\hypertarget{spell:Greater Precognitive Offense}{Greater Precognitive Offense}}[\glossterm{Attune} (target)]
...
\begin{attuneability}[\nth{5}]{\hypertarget{spell:Greater Boon of Mastery}{Greater Boon of Mastery}}[\glossterm{Attune} (target)]
...
\begin{apability}[\nth{2}]{\hypertarget{spell:Drain Life}{Drain Life}}[\glossterm{Life}]
...
\begin{apability}[\nth{2}]{\hypertarget{spell:Greater Cure Wounds}{Greater Cure Wounds}}[\glossterm{Life}]
...
\begin{apability}[\nth{4}]{\hypertarget{spell:Heal}{Heal}}[\glossterm{Life}]
