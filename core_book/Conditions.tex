...
\condition{pinned} A pinned creature is held completely immobile in a grapple. Like a \glossterm{helpless} creature, its physical defenses are equal to 10 \add its size modifier. Unlike a helpless creature, a pinned creature cannot be killed instantly by a coup de grace.
