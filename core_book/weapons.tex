...
\vspace{0.25em}
\spelltwocol{\textbf{Type}: Weapon}{\parhead*{Tags} \glossterm{Fire}}
\textbf{Materials}: As weapon
...
\vspace{0.25em}
\spelltwocol{\textbf{Type}: Weapon}{\parhead*{Tags} \glossterm{Cold}}
\textbf{Materials}: As weapon
...
\vspace{0.25em}
\spelltwocol{\textbf{Type}: Weapon}{\parhead*{Tags} \glossterm{Knowledge}}
\textbf{Materials}: As weapon
...
\vspace{0.25em}
\spelltwocol{\textbf{Type}: Weapon}{\parhead*{Tags} \glossterm{Shaping}}
\textbf{Materials}: As weapon
...
\vspace{0.25em}
\spelltwocol{\textbf{Type}: Weapon}{\parhead*{Tags} \glossterm{Planar}}
\textbf{Materials}: As weapon
...
\vspace{0.25em}
\spelltwocol{\textbf{Type}: Weapon}{\parhead*{Tags} \glossterm{Shielding}}
\textbf{Materials}: As weapon
...
\vspace{0.25em}
\spelltwocol{\textbf{Type}: Weapon}{\parhead*{Tags} \glossterm{Teleportation}}
\textbf{Materials}: As weapon
...
\vspace{0.25em}
\spelltwocol{\textbf{Type}: Weapon}{\parhead*{Tags} \glossterm{Electricity}}
\textbf{Materials}: As weapon
...
\vspace{0.25em}
\spelltwocol{\textbf{Type}: Weapon}{\parhead*{Tags} \glossterm{Sonic}}
\textbf{Materials}: As weapon
...
\vspace{0.25em}
\spelltwocol{\textbf{Type}: Weapon}{\parhead*{Tags} \glossterm{Life}}
\textbf{Materials}: As weapon
