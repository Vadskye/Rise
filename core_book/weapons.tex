...
If you do, you gain a \plus1d bonus to \glossterm{strike damage} with this weapon.
This is a \glossterm{swift ability}, and it lasts until the end of the round.
...
You gain a \plus1 bonus to accuracy with \glossterm{strikes} with this weapon.
