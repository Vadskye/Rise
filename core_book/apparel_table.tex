...
Gauntlet of the Ram & \nth{2} & Shoves foe when use to strike & \pageref{item:Gauntlet of the Ram} \\
...
Shield of Bashing & \nth{2} & Deals \plus2d damage & \pageref{item:Shield of Bashing} \\
...
Featherlight Armor & \nth{4} & Reduces encumbrance penalty by 2 & \pageref{item:Featherlight Armor} \\
...
Featherlight Armor, Greater & \nth{10} & Reduces encumbrance penalty by 4 & \pageref{item:Featherlight Armor, Greater} \\
...
Shield of Bashing, Greater & \nth{11} & Deals \plus3d damage & \pageref{item:Shield of Bashing, Greater} \\
