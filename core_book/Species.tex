...
\end{itemize}
\parhead{Automatic Language} Common, any two \glossterm{common languages} (see \pcref{Common Languages}).
...
\end{itemize}
\parhead{Automatic Languages} Common, Dwarven, any one \glossterm{common language} (see \pcref{Common Languages}).
...
\end{itemize}
\parhead{Automatic Languages} Common, Elven, any one \glossterm{common language} (see \pcref{Common Languages}).
...
\end{itemize}
\parhead{Automatic Languages} Common, Gnome, either Sylvan or any one \glossterm{common language} (see \pcref{Common Languages}).
...
\end{itemize}
\parhead{Automatic Languages} Common, Elven, any two \glossterm{common languages} (see \tref{Common Languages}).
...
\end{itemize}
\parhead{Automatic Languages} Common, Halfling, any one \glossterm{common language} (see \pcref{Common Languages}).
