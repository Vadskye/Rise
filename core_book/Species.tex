...
\end{itemize}
\parhead{Automatic Language} Common, any one \glossterm{common language} (see \pcref{Common Languages}).
...
\begin{itemize}
    ...
    \itemhead*{Magic Affinity}: Gnomes gain a bonus to \glossterm{power} with \glossterm{magical} abilities equal to a quarter of their level (minimum 1).
