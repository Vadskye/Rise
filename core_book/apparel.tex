...
You gain a \plus2 bonus to the Stealth skill (see \pcref{Stealth}).
...
You gain a \plus10 foot bonus to your land speed, up to a maximum of double your normal speed.
...
You gain a \plus30 foot bonus to your land speed, up to a maximum of double your normal speed.
...
You are proficient with bows.
In addition, you gain a \plus1 bonus to \glossterm{accuracy} with ranged \glossterm{strikes}.
...
You gain a \plus2 bonus to the Persuasion skill (see \pcref{Persuasion}).
...
You gain a \plus1 bonus to \glossterm{physical defenses}.
...
If you do, you gain a \plus5 bonus to Armor defense against ranged \glossterm{physical attacks} from weapons or projectiles that are Small or smaller.
...
You gain a \plus5 bonus to Armor defense against ranged \glossterm{physical attacks} from weapons or projectiles that are Small or smaller.
...
You gain a \plus1d bonus to \glossterm{strike damage} with this shield.
...
You gain a \plus2d bonus to \glossterm{strike damage} with this shield.
