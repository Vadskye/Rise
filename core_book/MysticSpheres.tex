...
\section{Categories of Magic}
    ...
    \subsection{Magic Sources}
        There are five \glossterm{magic sources} that characters can use to cast spells and perform rituals: arcane (cast by mages), divine (cast by clerics and paladins), hedge (cast by witches), nature (cast by druids), and pact (cast by warlocks).
...
\section{Spell and Ritual Mechanics}\label{Spell and Ritual Mechanics}
    ...
    \subsection{Augments}\label{Augments}
        ...
        For each augment you apply, you increase the \glossterm{rank} of the spell or ritual and all of its upgrades by an amount equal to the augment's level.
        In exchange, the ability gains the effects of that augment.
        If an augment would increase the spell or ritual's \glossterm{rank} beyond your rank in the relevant archetype, you cannot apply the augment to that ability.

        \parhead{Augments and Cantrips}
        You can apply augments to \glossterm{cantrips}.
        Cantrips are considered to have a \glossterm{rank} of 1 for this purpose.
        ...
        \subsubsection{Augment Descriptions}\label{Augment Descriptions}
            ...
            You may choose any combination of spells you know, along with any other augments, that result in a spell of the same \glossterm{rank} or lower as the spell you are casting.
            ...
            % too weak at 4?
            \augment{4}{Phasing} When determining whether you have \glossterm{line of sight} and \glossterm{line of effect} to a particular location with the spell, you can ignore a single solid obstacle up to five feet thick.
            ...
            \augment{4}{Simplified} The spell does not have the \glossterm{Focus} tag.
    ...
    \subsection{Resurrecting the Dead}\label{Resurrecting the Dead}
        ...
        \subparhead{Preventing Resurrection} Enemies can take steps to make it more difficult for a character to be returned from the dead.
        ...
        \subparhead{Involuntary Resurrection} A soul cannot be returned to life if it does not wish to be.
...
\section{Rituals}\label{Rituals}
    ...
    \subsection{Performing Rituals}
        ...
        % The action point cost for 24 hour rituals is equal to (ritual rank ^ 2) * 2.
