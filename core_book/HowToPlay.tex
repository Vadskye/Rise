...
\section{Making Checks}\label{Checks}\label{Making Checks}
  ...
  \subsection{Standard Difficulty Values}\label{Standard Difficulty Values}
    ...
    \begin{raggeditemize}
      ...
      \item Impossible (DV 25\add): No real-world human can succeed at a DV 25 check. This sort of feat is only possible for high-level Rise characters who have explicitly surpassed ordinary limitations. For example, this includes running at full speed along a slack rope (Balance) or climbing a sheer glass pane (Athletics).
    \end{raggeditemize}
