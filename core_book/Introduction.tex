...
\section{What Makes Rise Different?}
    ...
    \subsection{Minimal Resource Management}
        ...
        Small cooldowns are a fine-grained balancing tool that allow characters to have powerful abilities which would have detrimental effects for the game if they could be used on every turn.
