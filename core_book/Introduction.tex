...
\section{What Makes Rise Different?}
    ...
    Rise has five fundamental principles that differentiate it from other TTRPGs: unbounded scaling, simultaneous combat, minimal resource management, optional complexity, and a bounded action economy.
