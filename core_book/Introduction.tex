...
\section{What Makes Rise Different?}
    ...
    \subsection{Minimal Resource Management}
        ...
        The use of small cooldowns is a fine-grained balancing tool that allows characters to have powerful abilities that would have detrimental effects for the game if they were 
        Beneficial spells and magic items are 
    ...
    \subsection{Bounded Action Economy}
        ...
        Similarly, removing enemy actions completely is a good way to remove the tension from a fight before it's actually over.
