...
\section{What Makes Rise Different?}
    ...
    \subsection{Minimal Resource Management}
        ...
        The use of small cooldowns is a fine-grained balancing tool that allows characters to have powerful abilities that would have detrimental effects for the game if they could be used on every turn.
