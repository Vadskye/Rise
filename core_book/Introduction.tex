...
\section{What Makes Rise Different?}
    ...
    \subsection{Unbounded Scaling}
        ...
        Rise encourages that, and instead makes it impossible for one character to be relevant in \textit{all} contexts.
        Each character will have their own non-overlapping strengths and weaknesses, and if you try to be good at everything, you'll fall behind people who specialize in a particular area.
        ...
        Overall character power doubles approximately every two to three levels.
    ...
    \subsection{Simultaneous Combat}
        ...
        In a typical 4-5 player game with 1-2 enemy groups, you have to wait through about 5 turns before it comes back to your turn.
