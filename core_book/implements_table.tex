...
Wand of Spell Focus & \nth{7} & Grants \plus1 spellpower with a single spell & \pageref{item:Wand of Spell Focus} \\
...
Wand of Spell Focus, Greater & \nth{15} & Grants \plus2 spellpower with a single spell & \pageref{item:Wand of Spell Focus, Greater} \\
\end{longtabu}
\end{longtabuwrapper}
