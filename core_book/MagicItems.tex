...
\section{Legacy Items}\label{Legacy Items}
    ...
    At 4th level, you choose a legacy item archetype and an item you own of the appropriate type.
    That item becomes a \glossterm{legacy item}, and gains a special ability.
    ...
    % TODO: something about customization
    ...
    \subsection{Legacies}\label{Legacies}
        ...
        \subsubsection{Avenger}
            ...
            \parhead{4th -- Mark of Vengeance} Whenever a creature resolves an attack against you, it becomes marked by this ability until the end of the next round.
            You gain a \plus1 bonus to accuracy and damage with \glossterm{strikes} using this weapon against creatures marked by this ability.

            \parhead{8th -- Seek Vengeance} During the \glossterm{movement phase}, you may spend an \glossterm{action point} to use this ability instead of moving.
            ...
            \parhead{12th -- Retributive Mark} Whenever a creature becomes marked by the item's \textit{mark of vengeance} ability, it takes life damage equal to twice your level.

            \parhead{16th -- No Escape} You do not need to spend an \glossterm{action point} to use the item's \textit{seek vengeance} ability.
        ...
        \subsubsection{Peacekeeper}
            ...
            \parhead{4th -- Merciful} All damage you deal is \glossterm{nonlethal damage}, including \glossterm{strikes} and \glossterm{magical} abilities.
            ...
            \parhead{8th -- Lifesaver} As an \glossterm{immediate action}, when a creature within \rngmed range of you takes \glossterm{critical damage}, you may spend an \glossterm{action point} to use this ability.
            If you do, the creature does not take that damage, and you take it as nonlethal damage instead.

            \parhead{12th -- Geas of Peace} Whenever you knock a creature unconscious,
