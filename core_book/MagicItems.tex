...
\section{Implements}\label{Implements}
    ...
    \subsection{Implement Types}
        ...
        \subsubsection{Staffs}
            ...
            It has AD 2, a \glossterm{fatigue threshold} of 2, a \glossterm{wound threshold} of 10, hardness 5, and a break DR of 10.
        ...
        \subsubsection{Wands}
            ...
            A typical wand has AD 2, a \glossterm{fatigue threshold} of 1, a \glossterm{wound threshold} of 5, hardness 5, and a break DR of 6.

    \subsection{Implement Descriptions}

        \input{implements_table.tex}

        \input{implements.tex}
...
\section{Legacy Items}\label{Legacy Items}
    ...
    At 10th level, and every 6 levels thereafter, your legacy item increases in power again.
