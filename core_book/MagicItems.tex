...
\section{Using Magic Items}
    ...
    \subsection{Item Limitations}
        ...
        \subsubsection{Item Attunement}
            ...
            You can use the \textit{item attunement} ability to attune to items.

            \begin{ability}{Item Attunement}[\glossterm{Attune}]
                As a standard action, you can spend an \glossterm{action point} or an \glossterm{item slot} to use this ability.
                If you do, choose a magic item you are touching.
                Any abilities the target has that require attunement become active, allowing you to use its full potential.

                If you spent an \glossterm{item slot} to use this ability, attuning to this ability does not prevent you from recovering any action points.
            \end{ability}
