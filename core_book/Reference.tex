...
\section{Ability Tags}\label{Ability Tags}
    ...
    Instead of adding half your Perception to determine your \glossterm{accuracy} with a Brawling attack, you add half your Strength.
...
\section{Traits}\label{Traits}
    ...
    \traitdef{Limbless}{limbless}
        ...
        This gives them a weapon damage bonus equal to \plus1 per 3 \glossterm{power}.
