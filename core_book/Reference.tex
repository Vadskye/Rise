...
\section{Ability Tags}\label{Ability Tags}
    ...
    Any part of a Barrier ability that would extend within 5 feet of an already active Barrier ability is not created.
...
\section{Circumstances and Debuffs}\label{Circumstances and Debuffs}
    ...
    \debuffdef{frightened} A frightened creature takes a \minus4 penalty to its Mental defense.
    In addition, it takes a \minus4 penalty to \glossterm{accuracy} against the source of its fear.
    ...
    They have a 50\% miss chance with \glossterm{targeted} atacks against creatures and objects that they are partially unaware of.
    ...
    \debuffdef{shaken} A shaken creature takes a \minus2 penalty to its Mental defense.
