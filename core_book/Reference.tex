...
\section{Circumstances and Debuffs}\label{Circumstances and Debuffs}
    ...
    A creature can stand up from being prone as part of a \glossterm{move action}.
    This generally requires one \glossterm{free hand}.
    Standing up from a prone position costs half of the creature's movement during that move action.
