...
Creatures take a \minus4 penalty to Armor and Reflex defenses against attacks that they are unaware of.
For details, see \pcref{Awareness and Surprise}.
...
Subtle magical abilities can still be identified with the Spellsense skill (see \pcref{Spellsense}), but the \glossterm{difficulty value} is equal to 20 \add twice the \glossterm{rank} of the effect.
