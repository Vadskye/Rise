...
Subtle magical abilities can still be identified with the Spellsense skill (see \pcref{Spellsense}), but the \glossterm{difficulty rating} is equal to 15 \add the ability's \glossterm{power}.
