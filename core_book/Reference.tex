...
\section{Traits}\label{Traits}
  ...
  Animals are simple, \glossterm{mundane} \creaturetype{mortals}.
  ...
  \traitdef{Beast}{beast}
  Beasts are \creaturetype{mortals} that are typically more complex than animals, with a maximum Intelligence of \minus5.
  Unlike animals, they can have \magical abilities.
  ...
  They are \trait{mindless}, \trait{nonliving}, and \trait{soulless}.
  ...
  % TODO: What makes fey unique? Are they lawful or chaotic?
  \traitdef{Fey}{fey}
  ...
  An intangible creature has a physical body that is gaseous or otherwise difficult to touch.
  ...
  It is \buff{immune} to \glossterm{mundane}, \atCreation, and \atManifestation abilities.
  It gains a \plus5 bonus to Stealth and ignores the effects of abilities that only work if it has a corporeal body.
  This includes all \abilitytag{Brawling} abilities, \glossterm{difficult terrain}, being detected by \sense{tremorsense}, setting off pressure plates, and so on.
  ...
  Most creatures are living, but undead and some animates are not.
...
\section{Creature Types}\label{Creature Tags}
  ...
  Unless otherwise noted in a creature's type or description, it is a \trait{living} creature with a body, mind, and soul.
  ...
  \creaturetypedef{Animate}{animate}
  Animates are creatures composed of matter that would not ordinarily support complex life, such as wood or stone.
  Common types of animates include constructs, elementals, and oozes.

  % Is this a subcategory of beast?
  \creaturetypedef{Dragon}{dragon} A dragon is a powerful magical creature with four legs and two wings.
  Dragons are \creaturetype{immortal} creatures that can feed on magic and valuable metals, including gold. 
  ...
  \creaturetypedef{Mortal}{mortal}
  Mortals have bodies made from organic matter with flesh, blood, skin, and bones.
  Their bodies deteriorate over time, and they eventually die of old age.
  When they do, the soul native to the body typically goes to an appropriate afterlife.
  Most creatures in the universe are mortals, including all of the common species.

  \creaturetypedef{Soulforged}{soulforged}
  A soulforged is a creature that is made of \glossterm{essentia}, or soul residue.
  It is \trait{nonliving}.
  Most soulforged are from the Spiritual Planes, which are made of essentia (see \pcref{Spiritual Planes}).

  \creaturetypedef{Undead}{undead}
  ...
  Although undead are \trait{nonliving}, they are affected in unusual ways by effects that directly manipulate life energy.
