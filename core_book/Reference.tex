...
\section{Traits}\label{Traits}
  ...
  Most planebound creatures are \creaturetype{planeforged} creatures from that plane.
...
\section{Creature Types}\label{Creature Tags}
  ...
  \creaturetypedef{Planeforged}{planeforged}
  ...
  Some planeforged are \trait{planebound}, including the bodies of dead souls in their afterlife.
