...
\section{Ability Tags}\label{Ability Tags}
  ...
  \abilitytagdef{Impact} When you miss by 4 or less with a damaging Impact ability, you still deal half damage.
...
\section{Circumstances and Debuffs}\label{Circumstances and Debuffs}
  ...
  \debuffdef{sickened} A sickened creature suffers a \minus2 penalty to its Fortitude defense and has a \glossterm{damage penalty} equal to its \glossterm{character rank}.
...
\section{Traits}\label{Traits}
  ...
  Multipedal creatures gain a \plus10 foot bonus to their \glossterm{speed}, a \plus5 bonus to the Balance skill, and are immune to the \ability{trip} ability.
