...
\section{Creature Origins}\label{Creature Origins}
  ...
  Artificial creatures normally have the following traits: \trait{bloodless}, \trait{corporeal}, \trait{dynamic}, \trait{immortal}, \trait{nonliving}.
  ...
  Natural creatures normally have the following traits: \trait{blooded}, \trait{corporeal}, \trait{dynamic}, \trait{living}, \trait{mortal}.
  ...
  Undead creatures normally have the following traits: \trait{bloodless}, \trait{corporeal}, \trait{dynamic}, \trait{immortal}, \trait{nonliving}.
