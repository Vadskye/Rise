...
\section{Circumstances and Debuffs}\label{Circumstances and Debuffs}
  ...
  If a creature would be both vulnerable and \impervious to an ability, it is treated as vulnerable and not impervious.
...
\section{Traits}\label{Traits}
  ...
  Quadrupedal creatures gain a \plus10 foot bonus to their \glossterm{speed} and are \impervious to the \ability{trip} ability.
  ...
  Swarms are \impervious to \glossterm{targeted} abilities and \vulnerable to \glossterm{area} abilities.
...
\subsection{Creature Types}\label{Creature Types}
  ...
  Ghosts are \trait{incorporeal} and \impervious to \atCold and \atEarth abilities.
