...
\section{Circumstances and Debuffs}\label{Circumstances and Debuffs}
  ...
  It can stop corroding if it makes a \glossterm{difficulty value} 10 Dexterity check as a \glossterm{standard action}.
  Dropping \prone as part of this action gives a +5 bonus to this check.
  Dissolving is automatically removed if the target takes damage from a \atCold or \atFire ability, or is submerged in a non-corrosive liquid like water.
