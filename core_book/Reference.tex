...
\section{Ability Tags}\label{Ability Tags}
    ...
    \abilitytagdef{Elite} Elite abilities require an \glossterm{elite action} to use.
    They can only be used by \glossterm{elite} monsters.
...
\section{Traits}\label{Traits}
    ...
    \traitdef{Limbless}{limbless}
        A limbless creature has no arms or legs.
        Limbless creatures are immune to being \prone.
    ...
    \traitdef{Multipedal}{multipedal}
        ...
        In addition, they treat natural weapons that do not require free hands, like a bite, as if they had the \weapontag{Heavy} weapon tag and were being held in two hands.
        This gives them a weapon damage bonus equal to \plus1d per 3 \glossterm{power}.
        Some specific monsters, like horses, do not gain this benefit if they are weak or unable to effectively use their whole body to support their attacks.
