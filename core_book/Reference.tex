...
\section{Circumstances and Debuffs}\label{Circumstances and Debuffs}
  ...
  For example, an empowered creature that uses an ability which causes \glossterm{knockback} does not apply the extra damage to the knockback.
  ...
  This only affects damage caused directly by the creature, excluding conditions it inflicts.
