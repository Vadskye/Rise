...
\section{Circumstances and Debuffs}\label{Circumstances and Debuffs}
  ...
  If a blinded creature can perceive targets with other effects that do not require eyes, such as \trait{blindsight}, it can ignore these detrimental effects.
  ...
  If the dazzled creature can perceive targets with other effects that do not require eyes, such as \trait{blindsight}, it can ignore this miss chance.
...
\section{Traits}\label{Traits}
  ...
  Most sightless creatures have special senses, such as \trait{blindsight}, that allow them to attack and defend themselves normally.
