...
\section{Ability Tags}\label{Ability Tags}
  ...
  They require a DV 20 Awareness check to notice (see \pcref{Awareness}).
...
\section{Creature Origins}\label{Creature Origins}
  ...
  Artificial creatures normally have the following traits: \trait{bloodless}, \trait{corporeal}, \trait{dynamic}, \trait{immortal}, \trait{nonliving}, \trait{sighted}.
  ...
  Natural creatures normally have the following traits: \trait{blooded}, \trait{corporeal}, \trait{dynamic}, \trait{living}, \trait{mortal}, \trait{sighted}.
  ...
  Undead creatures normally have the following traits: \trait{bloodless}, \trait{corporeal}, \trait{immortal}, \trait{nonliving}, \trait{sighted}, \trait{static}.
...
\subsection{Creature Types}\label{Creature Types}
  ...
  Aberrations normally have the following traits: \trait{ensouled}.
  ...
  Animals normally have the following traits: \trait{ensouled}.
  ...
  Beasts normally have the following traits: \trait{ensouled}.
  ...
  Dragons normally have the following traits: \trait{ensouled}, \trait{immortal}.
  ...
  Fey normally have the following traits: \trait{ensouled}, \trait{immortal}.
  ...
  Ghosts normally have the following traits: \trait{ensouled}, \trait{incorporeal}.
  ...
  Humanoids normally have the following traits: \trait{ensouled}.
  ...
  Indwelt normally have the following traits: \trait{ensouled}.
  ...
  Insects normally have the following traits: \trait{ensouled}.
  ...
  Plants normally have the following traits: \trait{bloodless}, \trait{living}, \trait{soulless}.
