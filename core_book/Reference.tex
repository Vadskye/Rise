...
\section{Senses}\label{Senses}
  ...
  Tremorsense functions like \sense{blindsight}, except that it requires an uninterrupted path through solid objects instead of \glossterm{line of effect}.
...
\section{Traits}\label{Traits}
  ...
  \traitdef{Beast}{beast}
  Beasts are more typically more complex than animals, with a maximum Intelligence of \minus5.
  ...
  \traitdef{Construct}{construct} A construct is a creature that is made of nonsapient matter.
  ...
  A humanoid is an intelligent creature two arms and two legs.
