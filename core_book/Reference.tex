...
\section{Ability Tags}\label{Ability Tags}
    ...
    \abilitytagdef{Size-Limited} Size-Limited abilities have no effect on creatures or objects that are more than one size category larger than you.
    You can bypass this limitation for melee Size-Limited abilities with the \ability{creature climb} ability (see \pcref{Creature Climb}), or simply by flying close (see \pcref{Flying Mechanics}).
...
\section{Circumstances and Debuffs}\label{Circumstances and Debuffs}
    ...
    It moves at half of its normal speed, and is considered one size category smaller than normal when determining whether it is subject to melee \abilitytag{Size-Limited} effects, including critical hits.
