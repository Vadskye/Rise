...
\subsection{Creature Types}\label{Creature Types}
  ...
  \traitdef{Beast}{beast}
  Beasts are fairly unintelligent creatures, but they are smarter or more magical than animals.
  They have a maximum Intelligence of \minus5, and are incapable of speech or language.
  Beasts are typically found in the wilderness, and seem to naturally avoid civilized areas.
