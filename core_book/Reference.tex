...
\section{Ability Tags}\label{Ability Tags}
  ...
  Plugging or covering your ears makes you \impervious to Auditory effects.
...
\section{Circumstances and Debuffs}\label{Circumstances and Debuffs}
  ...
  \debuffdef{swimming} A creature that is swimming without a \glossterm{swim speed} takes a \minus2 penalty to its \glossterm{accuracy}, Armor defense, and Reflex defense.
...
\section{Traits}\label{Traits}
  ...
  It does not fall while in midair, and is unable to \glossterm{glide}.
