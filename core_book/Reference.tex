...
\section{Traits}\label{Traits}
  ...
  It does not need to eat, drink, or sleep, and is immune to \atPoison effects.
  ...
  Any damage it takes must be physically repaired like a damaged object, typically with relevant raw materials and the use of the Craft skill.
...
\section{Creature Origins}\label{Creature Origins}
  ...
  Undead creatures normally have the following traits: \trait{bloodless}, \trait{corporeal}, \trait{dynamic}, \trait{immortal}, \trait{nonliving}, \trait{sighted}.
