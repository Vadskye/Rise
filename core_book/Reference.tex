...
\section{Circumstances and Debuffs}\label{Circumstances and Debuffs}
    ...
    When a creature becomes confused, and at the beginning of each round, it randomly decides to have one of three behaviors that round: attack its \glossterm{enemies}, protect itself and its \glossterm{allies} without attacking, or act normally.
    ...
    \debuffdef{goaded} A goaded creature takes a \minus1 penalty to \glossterm{accuracy} against creatures other than the creature that goaded it it as long as it is within \rngmed range of of that creature.
    ...
    \debuffdef{slowed} A slowed creature moves at half speed and takes a \minus1 penalty to its Reflex defense.
...
\section{Traits}\label{Traits}
    ...
    \traitdef{Undead}{undead}
        ...
        They are always considered living \glossterm{allies} for the purpose of effects that would cause living creatures to regain \glossterm{hit points}.
        ...
        This damage is never resolved as a \abilitytag{Swift} effect, even if the healing ability has that tag.
