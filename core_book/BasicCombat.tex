...
\section{Movement}\label{Movement}
  ...
  If you need to move farther, you can sprint as a \glossterm{free action}, which increases your \glossterm{stamina} by one but doubles your available movement.
...
\section{Universal Combat Abilities}
  ...
  \begin{raggeditemize}
    \item Desperate Exertion: Reroll any attack or check with a \plus2 bonus, but you gain two \glossterm{stamina}.
    \item Escape Grapple: Stop being grappled.
    \item Grapple: Start grappling with a foe.
    \item Recover: Regain half of your maximum hit points and remove all conditions. However, you gain two stamina, and you can only do it once per fight.
    \item Run: Briefly double your available movement.
    \item Shove: Push a foe up to half your speed.
    \item Sprint: Doubles your available movement as a \glossterm{free action}, but increases your \glossterm{stamina} by one.
