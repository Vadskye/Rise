...
\section{Movement}\label{Movement}
  ...
  If you need to move farther, you can sprint as a \glossterm{free action}, which costs one \glossterm{stamina} and doubles your available movement.
  Alternatively, you can run as a \glossterm{standard action}, which triples your available movement but typically means you can't take other useful actions in the same turn.
  ...
  When moving or measuring distance in three dimensions (such as jumping or flying), distance is measured using the maximum of the horizontal distance and vertical distance moved.
...
\section{Universal Combat Abilities}
  ...
  \begin{raggeditemize}
    \item Desperate Exertion: Reroll any attack or check with a \plus2 bonus, but you reduce your \glossterm{stamina} by two.
    \item Escape Grapple: Stop being grappled.
    \item Grapple: Start grappling with a foe.
    \item Recover: Spend two stamina to regain half of your maximum hit points and remove all conditions. You can only do this once per short rest.
    \item Run: Briefly double your available movement.
    \item Shove: Push a foe up to half your speed.
    \item Sprint: Spend one stamina to double your available movement as a \glossterm{free action}.
...
\section{Using Abilities}\label{Using Abilities}
  ...
  \subsection{Area Abilities}\label{Area Abilities}
    ...
    \subsubsection{Measuring Areas}
      ...
      There are four common area shapes.
      ...
      \begin{raggeditemize}
        ...
        \item Cone: A 90 degree arc, measured by length. A cone's height is normally equal to its length, and it extends upwards from the point of origin.
        \item Cylinder: A circle with a height, measured by radius. A cylinder's height is normally equal to its radius. Bursts and zones extend upwards, while emanations extend both upwards and downwards.
        \item Line: A straight line, measured by length. A line is normally 5 feet wide and 5 feet high.
        \item Wall: A straight line, measured by length. A wall's height is normally equal to its length, and its width is essentially zero. A wall is always a \glossterm{zone}, not a \glossterm{burst} or an \glossterm{emanation}.
      \end{raggeditemize}
