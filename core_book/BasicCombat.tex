...
\section{Tracking Time in Combat}
  ...
  Each round of a combat is divided into two \glossterm{phases}: the movement phase and the action phase.
  After both phases are complete, the round ends and the next round begins.

  During the movement phase, everyone can use a \glossterm{move action}.
  Move actions can be used to move, but not to attack.
  During the action phase, everyone can use a \glossterm{standard action} and a \glossterm{minor action}.
  Most abilities require a standard action, including all normal attacks.
  Minor actions are less common, and are typically used as part of the text of specific abilities.
  ...
  You and your fellow player characters will take turns during each phase, but you can act in any order among yourselves.
...
\section{Movement}\label{Movement}
  As a \glossterm{move action}, your character can move up to their speed along the ground.
