...
\section{Attacks}
    ...
    \subsection{Combat Maneuvers}\label{Combat Maneuvers}
        ...
        You take a \minus4 penalty to accuracy heavy maneuvers for each size category you are smaller than your target, or a \plus4 bonus for each size category you are larger.
