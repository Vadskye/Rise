...
\section{Attacks}
    ...
    \subsection{Combat Maneuvers}\label{Combat Maneuvers}
        ...
        You take a \minus4 penalty to accuracy with heavy maneuvers for each size category you are smaller than your target, or a \plus4 bonus for each size category you are larger.
...
\section{Movement and Positioning}
    ...
    Movement almost always takes place during the \glossterm{movement phase}, during which all creatures move around simultaneously.
