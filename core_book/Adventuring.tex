...
\section{Carrying Capacity}\label{Carrying Capacity}
    ...
    \subsection{Weight Categories}\label{Weight Categories}
        ...
        Objects tend to vary more widely based on their composition.

        Objects and creatures can modify their weight category in four ways very lightweight, lightweight, heavyweight, and very heavyweight.
        \begin{itemize}
            \item Very lightweight objects have a weight category that is two categories smaller than their size category.
            \item Lightweight objects have a weight category that is one category smaller than their size category.
            \item Heavyweight objects have a weight category that is one category larger than their size category.
            \item Very heavyweight objects have a weight category that is two categories larger than their size category.
        \end{itemize}
    ...
    \begin{dtable}
        ...
        \begin{dtabularx}{\columnwidth}{X l l l l}
            \tb{Strength} & \tb{Maximum} & \tb{Push/Drag} \tableheaderrule
            -9            & Fine x4        & Diminuitive x4 \\
            -8            & Diminuitive    & Tiny           \\
            ...
            48\plus\fn{1} & \tdash         & \tdash          & \tdash & \tdash \\
        \end{dtabularx}
    ...
    Your Strength determines how much weight you can carry, as shown in \trefnp{Carrying Capacity by Strength}.
    ...
    \parhead{Multi-Legged Creatures} The figures on \trefnp{Carrying Capacity by Strength} are for bipedal creatures.
...
\section{Breaking Objects}
    ...
    \subsection{Damaging Objects}
        Objects have \glossterm{hit points} and \glossterm{resistances} like creatures.
        However, they treat all damage they take as \glossterm{environmental damage} (see \pcref{Environmental Damage}).
        That means that all damage they take is reduced by their \glossterm{resistances} without subtracting from the remaining value of those resistances.
    ...
    \subsection{Object Statistics}
        ...
        The primary material it is constructed from determines its \glossterm{resistances}, and can modify the number of hit points it has.
        ...
        \begin{dtable}
            ...
            \begin{dtabularx}{\textwidth}{l X X X}
                \tb{Material}   & \tb{Resistances}\fn{1} & \tb{Hit Points Multiplier}\fn{2} & \tb{Sunder Difficulty Rating Modifier}  & \tableheaderrule
                ...
                Wood            & 5                     & \tdash                & \tdash               \\
            \end{dtabularx}
            1. This indicates the object's \glossterm{resistances} to both \glossterm{physical damage} and \glossterm{energy damage}. \\
    ...
    \subsection{Relative Physical Resistance}\label{Relative Physical Resistance}
        When an object would take \glossterm{physical damage}, if the physical damage \glossterm{resistance} of the attacking object or creature is lower than the physical damage \glossterm{resistance} of the defender, the attacking object or creature takes the damage instead.
