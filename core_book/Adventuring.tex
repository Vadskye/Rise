...
\section{Movement}
    ...
    \subsubsection{Overland Exertion}
        ...
        Exerting yourself for an hour in between \glossterm{long rests} deals 1d6 points of \glossterm{subdual damage} \add 1d per additional hour beyond the first.
        Whenever you lose a \glossterm{hit point} in this way, you also gain a point of \glossterm{exhaustion}.
...
%(see \trefnp{Common Armor, Weapon, and Shield Hardness and Thresholds}; \trefnp{Substance Hardness and Thresholds}; and \trefnp{Object Hardness and Thresholds}).
            \parhead{Damage Resistance} An object's \glossterm{damage threshold} and \glossterm{wound threshold} depend on what it is made of and how big it is.
        ...
        \subsubsection{Damaged Objects}
            ...
            Both magical and mundane objects that have lost \glossterm{hit points} or become \glossterm{broken} can be repaired to normal for a cost equal to 10\% of their value.
        ...
        \subsubsection{Breaking Items}
            ...
            The DR to break an object with Strength is reduced by 2 for each \glossterm{hit point} the object has lost.
