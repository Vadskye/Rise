...
%(see \trefnp{Common Armor, Weapon, and Shield Hardness and Thresholds}; \trefnp{Substance Hardness and Thresholds}; and \trefnp{Object Hardness and Thresholds}).
            \parhead{Resistances} An object's \glossterm{resistances} depend on what it is made of and how big it is.

            Smaller sections of very large objects may be treated as independent objects for determining \glossterm{resistances} and tracking whether the object is \glossterm{broken} or \glossterm{destroyed}.
