...
\section{Vision and Light}\label{Vision and Light}
    ...
    \subsection{Darkvision}\label{Darkvision}
        Characters with \glossterm{darkvision} can see lit areas normally as well as dark areas within a radius defined by the ability -- usually, 50 feet.
...
\section{Breaking Objects}
    ...
    \subsection{Damaging Objects}
        Objects have \glossterm{hit points} and \glossterm{resistances}, but their resistances do not function in the same way that they do for creatures.
        The resistance of an object is not reduced by taking damage, and cannot be reduced by any other means.
        If an object takes damage from an attack in excess of its resistance, it loses \glossterm{hit points} equal to the excess damage.
        Otherwise, the attack has no effect.
    ...
    \subsection{Object Statistics}
        ...
        \begin{dtable}
            ...
            \begin{dtabularx}{\textwidth}{l X X X}
                ...
                Wood            & 5                     & \tdash                & \tdash               \\
            \end{dtabularx}
            1. This indicates the object's resistance to both \glossterm{physical damage} and \glossterm{energy damage}. \\
