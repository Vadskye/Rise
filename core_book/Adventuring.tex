...
\begin{dtable}
    ...
    \begin{dtabularx}{\columnwidth}{X l l l l}
        % TODO: better name than ``unencumbered''?
...
A creature can carry weight up to its unencumbered carrying capacity without any penalty.
If it carries more than that, but less than its maximum carrying capacity, it takes a \minus4 \glossterm{encumbrance penalty}.
This stacks with the encumbrance penalty from any armor the creature wears.

\parhead{Lifting and Dragging} You can lift as much as your maximum carrying capacity over your head.

You can lift as much as 1-1/2 your maximum carrying capacity off the ground (the sum of your unencumbered and maximum weight limits).
While overloaded in this way, you take a \minus10 \glossterm{encumbrance penalty}, you take a \minus10 penalty to \glossterm{accuracy} with physical attacks, and you can only move by spending a \glossterm{standard action} to move 5 feet.
This replaces the encumbrance penalty from carrying more than your unencumbered carrying capacity.

You can generally push or drag along the ground as much as five times your maximum carrying capacity.

\parhead{Bigger and Smaller Creatures} The figures on \trefnp{Carrying Capacity by Strength} are for Medium bipedal creatures. A larger bipedal creature can carry more weight depending on its size category, as follows: Large \mult2, Huge \mult4, Gargantuan \mult8, Colossal \mult16. A smaller creature can carry less weight depending on its size category, as follows: Small \mult3/4, Tiny \mult1/2, Diminutive \mult1/4, Fine \mult1/8.
