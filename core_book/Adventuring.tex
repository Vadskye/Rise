...
\section{Encumbrance by Weight}\label{Encumbrance by Weight}
...
While overloaded in this way, your \glossterm{encumbrance penalty} is increased by 10, you take a \minus10 penalty to \glossterm{accuracy} with physical attacks, and you can only move by spending a \glossterm{standard action} to move 5 feet.
