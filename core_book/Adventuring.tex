...
\section{Movement}
    ...
    \subsection{Overland Movement}
        ...
        \parhead{Walk} A character can walk 10 hours in a day of travel without a problem. Walking for longer than that can wear them out (see Forced March, below).
        \parhead{Hustle} A character can hustle for 1 hour without a problem. Hustling for a second hour in between sleep cycles deals 1 point of \glossterm{subdual damage}, and each additional hour deals twice the damage taken during the previous hour of hustling.
        ...
        A character can walk for more than 10 hours between \glossterm{long rests} by making a forced march. For each hour of marching beyond 10 hours, a Constitution check (DR 10, \plus2 per extra hour) is required. If the check fails, the character takes 1d6 points of subdual damage \plus1d per hour of marching. It's possible for you to march into unconsciousness by pushing yourself too hard.
...
%None of these tables exist currently. Also object thresholds are obnoxious.
%(see \trefnp{Common Armor, Weapon, and Shield Hardness and Thresholds}; \trefnp{Substance Hardness and Thresholds}; and \trefnp{Object Hardness and Thresholds}).
            \parhead{Damage Thresholds} An object's \glossterm{fatigue threshold} and \glossterm{wound threshold} depend on what it is made of and how big it is.

            Smaller sections of very large objects may be treated as independent objects for determining damage thresholds and tracking whether the object is \glossterm{broken} or \glossterm{destroyed}.
        ...
        \subsubsection{Damaged Objects}
            An object that gains a \glossterm{vital wound} becomes \glossterm{broken}.
            If it gains an additional \glossterm{vital wound}, it is \glossterm{destroyed}.
            Objects do not make \glossterm{wound rolls}, and they ignore any other effects of \glossterm{vital wounds}.

            Objects cannot suffer points of \glossterm{exhaustion}.

            Both magical and mundane objects that have taken points of \glossterm{fatigue} or become \glossterm{broken} can be repaired to normal for a cost equal to 10\% of their value.
            You must be able to craft the item originally to repair it.

            \parhead{Broken Objects}\label{Broken Objects}
            Broken objects cannot be used for their intended purpose, but still retain enough of their original form to be repaired without too much work. For example, a broken wall lies in pieces on the ground and no longer blocks passage, but can be repaired with no more effort than damaged items. Magic items that are broken retain their magical properties once fixed. Fatigued and broken (but not destroyed) objects can be repaired with the Craft skill.
        ...
        \subsubsection{Breaking Items}
            ...
            The DR to break an object with Strength is reduced by 2 for each point of \glossterm{fatigue} the object has suffered.
