...
\section{Movement}
    ...
    \subsection{Overland Movement}
        ...
        \parhead{Walk} A character can walk 10 hours in a day of travel without a problem. Walking for longer than that, or hustling faster than that, can wear them out (see \pcref{Overland Exertion}).
    ...
    \subsubsection{Overland Exertion}
        ...
        Exerting yourself for an hour in between \glossterm{long rests} deals 1d6 point of \glossterm{subdual damage}.
        Each additional hour deals \plus1d more subdual damage than the previous hour.
        This damage cannot be healed by a \glossterm{short rest}, and it ignores \glossterm{damage reduction} and \glossterm{hardness}.
        The damage progression is summarized in \tref{Overland Exertion Damage}.

        If you combine both forms of exertion, you take both increments of subdual damage in sequence, increasing each one.
        For example, if you forced march for an hour and then both forced march and hustled for an hour, you would take 1d6 point of \glossterm{subdual damage} in the first hour.
        ...
        \begin{dtable}
            \lcaption{Overland Exertion Damage}
            \begin{dtabularx}{\columnwidth}{l X}
                \tb{Hours exerted} & \tb{Damage per hour} \\
                1 & 1d6 \\
                2 & 1d8 \\
                3 & 1d10 \\
                4 & 2d6 \\
