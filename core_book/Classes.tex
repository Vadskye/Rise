...
\begin{dtabularx}{\textwidth}{l l >{\lcol}X >{\lcol}X >{\lcol}X >{\lcol}X >{\lcol}X}
    ...
    2 & 4      & Evasion             & Combat inspiration                     & Combat style rank (2), tricky force           & Greater dabbler         & Slippery mind               \\
    ...
    5 & 13     & Greater evasion     & Greater combat inspiration             & Combat style rank (5), greater tricky force   & Supreme dabbler         & Greater slippery mind       \\
...
\end{dtabularx}
    ...
    \subsection{Suave Scoundrel}
        ...
        \cf{Rog}[2]{Slippery Mind} You gain a \plus2 bonus to Mental defense.
        ...
        \cf{Rog}[5]{Greater Slippery Mind} The bonus from your \textit{slippery mind} ability increases to \plus3.
        In addition, any \glossterm{magical} abilities which detect lies are unable to detect lies you speak.
