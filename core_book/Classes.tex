...
\section{Druid}\label{Druid}
    \begin{dtable!*}
        ...
        \begin{dtabularx}{\textwidth}{c >{\lcol}X >{\lcol}X >{\lcol}X >{\lcol}X}
            ...
            \\ 2 & Mystic sphere   & Mystic knowledge            & Shifting defense           & Animal companion
            \\ 3 & Spell level (2) & Wellspring of power         & Shift body                 & Beast lore
            \\ 4 & Spell level (3) & Mystic knowledge            & Wild aspect                & Greater wild speech
            \\ 5 & Spell level (4) & Greater natural spells      & Greater shifting defense   & Beast companion
            \\ 6 & Spell level (5) & Mystic knowledge            & Greater shift body         & Beast tamer
...
\section{Paladin}\label{Paladin}
    \begin{dtable!*}
        ...
        \begin{dtabularx}{\textwidth}{c >{\lcol}X >{\lcol}X >{\lcol}X >{\lcol}X}
            ...
            \\ 5 & Devoted mind          & Spell level (4) & Greater zealous conviction & Greater stalwart champion
...
\section{Rogue}\label{Rogue}
    \begin{dtable!*}
        ...
        \begin{dtabularx}{\textwidth}{c >{\lcol}X >{\lcol}X >{\lcol}X >{\lcol}X}
            ...
            \\ 4 & Hide in plain sight         & Skill lore             & Trick manuever      & Suave lore
            \\ 5 & Greater evasion             & Greater skill exemplar &                     & Greater glibness
            \\ 6 & Assassination               & Greater dabbler        & Greater trick power & Compel belief
            \\ 7 & Greater hide in plain sight & Master of masteries    & Trick maneuver      & Slippery mind
