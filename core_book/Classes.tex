...
\section{Barbarian}\label{Barbarian}
    \begin{dtable}
        ...
        \begin{dtabularx}{\columnwidth}{c >{\lcol}X >{\lcol}X >{\lcol}X}
            ...
            \\ 4 & Soulscarred               & Deathless rage           & Athletic prowess
    ...
    \subsection{Battlerager}\label{Rage}
        ...
        \cf{Bbn}[6]{Greater Rage} The damage bonus from your \textit{rage} ability increases to \plus2d.
...
\section{Cleric}\label{Cleric}
    ...
    \subsection{Cleric Domain Abilities}\label{Cleric Domain Abilities}
        ...
        \subsubsection{Magic}
            ...
            \parhead{Essence} Whenever you cast a spell, you heal hit points equal to your \glossterm{magical power}.
            \parhead{Mastery} Whenever you are affected by a \glossterm{magical} ability, you heal hit points equal to your \glossterm{magical power}.
