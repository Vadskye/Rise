...
\section{Druid}\label{Druid}
    \begin{dtable!*}
        ...
        \begin{dtabularx}{\textwidth}{c >{\lcol}X >{\lcol}X >{\lcol}X >{\lcol}X >{\lcol}X}
            ...
            1 & Elemental balance         & Spellcasting   & Natural spells              & Wild aspects               & Natural servant         \\
...
\section{Mage}\label{Mage}
    \begin{dtable!*}
        ...
        \begin{dtabularx}{\textwidth}{c >{\lcol}X >{\lcol}X >{\lcol}X >{\lcol}X}
            \tb{Rank} & \tb{Arcane Magic} & \tb{Arcane Spell Mastery}   & \tb{Arcane Scholar}   & \tb{Innate Arcanist} \tableheaderrule
    ...
    \subsection{Arcane Magic}
        ...
        If you are a wizard, you must have an starting Intelligence of at least 1 to gain this archetype.
    ...
    \subsection{Arcane Spell Mastery}
        ...
        You must have the Arcane Magic archetype to gain the abilities from this archetype.
    ...
    \subsection{Arcane Scholar}
        ...
        You be a wizard and have the Arcane Magic archetype to gain the abilities from this archetype.
    ...
    \subsection{Innate Arcanist}
        ...
        You be a sorcerer and have the Arcane Magic archetype to gain the abilities from this archetype.
...
\section{Witch}\label{Witch}
    \begin{dtable!*}
        ...
        \begin{dtabularx}{\textwidth}{c >{\lcol}X >{\lcol}X >{\lcol}X >{\lcol}X >{\lcol}X}
            ...
            1         & Witch's brew        & Spellcasting     & Hedge spells                \\
            2         & Skilled brewer      & Mystic sphere    & Mystic knowledge            \\
            3         & Tempting concoction & Spell rank (3)   & Wellspring of power         \\
            4         & Esoteric concoction & Spell rank (4)   & Mystic knowledge            \\
            5         & Efficient brewer    & Spell rank (5)   & Greater natural spells      \\
            6         & Poison spell        & Spell rank (6)   & Mystic knowledge            \\
            7         & Blended concoction  & Spell rank (7)   & Greater wellspring of power \\
            8         &                     & Spell rank (8)   &                             \\
        \end{dtabularx}
    \end{dtable!*}
    ...
    \subsection{Nature Spellcasting}
        ...
        \cf{Wch}[2]{Mystic Sphere} You gain access to an additional nature \glossterm{mystic sphere}, including all \glossterm{cantrips} from that sphere.
        In addition, you learn an additional nature \glossterm{spell}.

        \cf{Wch}[3]{Spell Rank}[Magical] You gain the ability to cast rank 3 nature spells.

        \cf*{Wch}[4]{Spell Rank}[Magical] You gain the ability to cast rank 4 nature spells.

        \cf*{Wch}[5]{Spell Rank}[Magical] You gain the ability to cast rank 5 nature spells.

        \cf*{Wch}[6]{Spell Rank}[Magical] You gain the ability to cast rank 6 nature spells.

        \cf*{Wch}[7]{Spell Rank}[Magical] You gain the ability to cast rank 7 nature spells.

        \cf*{Wch}[8]{Spell Rank}[Magical] You gain the ability to cast rank 8 nature spells.
