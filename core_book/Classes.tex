...
\end{dtabularx}
    ...
    \subsection{Blessings of the Abyss}
        ...
        \cf{War}[2]{Abyssal Sphere} You gain access to your choice of one of the following \textit{mystic spheres}: \sphere{astromancy}, \sphere{pyromancy}, or \sphere{summoning}.
...
\begin{dtabularx}{\textwidth}{l l >{\lcol}X >{\lcol}X >{\lcol}X >{\lcol}X}
    ...
    0 & \tdash & Alchemical infusion         & Cantrips, mage armor               & Scholastic lore         & Mystic sphere               \\
