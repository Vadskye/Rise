...
\section{Ranger}\label{Ranger}
    ...
    \subsection{Beastmaster}
        ...
        \begin{attuneability}{Animal Companion}[\glossterm{Attune} (self), \glossterm{Emotion}, \glossterm{Magical}]
            ...
            \begin{itemize}
                \item Its \glossterm{wound resistance} and \glossterm{vital resistance} are equal to the normal values based on your level \add your base Constitution (see \tref{Resistance Values}).
                \item It has 10 \glossterm{hit points}.
