...
\section{Sorcerer}\label{Mage}
    \begin{dtable!*}
        ...
        \begin{dtabularx}{\textwidth}{c >{\lcol}X >{\lcol}X >{\lcol}X >{\lcol}X}
            ...
            3 & Spell rank (3), spell & Wellspring of power         & Augment              \\
            4 & Spell rank (4)        & Mystic knowledge            & Stilled caster       \\
            5 & Spell rank (5)        & Greater mage armor          & Greater innate magic \\
            6 & Spell rank (6), spell & Greater wellspring of power & Augment              \\
            7 & Spell rank (7)        & Mystic knowledge            & Spell absorption     \\
            8 & Spell rank (8)        &                             &                      \\
        \end{dtabularx}
    \end{dtable!*}
...
\section{Warlock}\label{Warlock}
    \begin{dtable!*}
        ...
        \begin{dtabularx}{\textwidth}{c >{\lcol}X >{\lcol}X >{\lcol}X >{\lcol}X}
            ...
            3 & Abyssal jaunt                & Spell rank (3), spell & Wellspring of power         & Influence possession        \\
            4 & Abyssal substitution         & Spell rank (4)        & Mystic knowledge            & Exchange soul fragment      \\
            5 & Greater fiendish resistance  & Spell rank (5)        & Greater armor tolerance     & Powerful possession         \\
            6 & Abyssal curse                & Spell rank (6), spell & Greater wellspring of power & Greater empowering whispers \\
            7 & Greater abyssal substitution & Spell rank (7)        & Mystic knowledge            & Control possession          \\
            8 &                              & Spell rank (8)        &                             &                             \\
        \end{dtabularx}
    \end{dtable!*}
...
\section{Witch}\label{Witch}
    \begin{dtable!*}
        ...
        \begin{dtabularx}{\textwidth}{c >{\lcol}X >{\lcol}X >{\lcol}X >{\lcol}X >{\lcol}X}
            ...
            3 & Tempting concoction & Spell rank (3), spell & Wellspring of power         \\
            4 & Esoteric concoction & Spell rank (4)        & Mystic knowledge            \\
            5 & Efficient brewer    & Spell rank (5)        & Greater witch's hex         \\
            6 & Poison spell        & Spell rank (6), spell & Greater wellspring of power \\
    ...
    \subsection{Hedge Spell Mastery}
        ...
        You gain your choice of one of the following abilities.
        {
            ...
            \parhead{Rituals} You gain the ability to perform hedge rituals to create unique magical effects (see \pcref{Rituals}).
                ...
                You cannot choose this ability multiple times.
            \parhead{Spell Power} Choose a hedge \glossterm{spell} you know.
                You gain a \plus2 bonus to \glossterm{power} with that spell.
                You can choose this ability multiple times, choosing a different spell each time.
            \parhead{Spell Precision} Choose a hedge \glossterm{spell} you know.
                You gain a \plus1 bonus to \glossterm{accuracy} with that spell.
                You can choose this ability multiple times, choosing a different spell each time.
        }
...
\section{Wizard}\label{Wizard}
    \begin{dtable!*}
        ...
        \begin{dtabularx}{\textwidth}{c >{\lcol}X >{\lcol}X >{\lcol}X >{\lcol}X}
            ...
            1 & Mystic spheres        & Mystic knowledge            & Scholastic lore       \\
            2 & Spells                & Mage armor                  & Ritualist               \\
            3 & Spell rank (3), spell & Wellspring of power         & Scholastic insight    \\
            4 & Spell rank (4)        & Mystic knowledge            & Ritual expertise      \\
            5 & Spell rank (5)        & Greater mage armor          & Contingency           \\
            6 & Spell rank (6), spell & Greater wellspring of power & Scholastic insight    \\
            7 & Spell rank (7)        & Mystic knowledge            & Malleable contingency \\
            8 & Spell rank (8)        &                             &                       \\
        \end{dtabularx}
    \end{dtable!*}
