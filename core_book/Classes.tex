...
\section{Barbarian}\label{Barbarian}
    \begin{dtable}
        ...
        \begin{dtabularx}{\columnwidth}{>{\ccol}p{\levelcol} >{\ccol}p{\babcolgood} *{3}{>{\ccol}p{\savecol}} >{\lcol}X}
            ...
            \barbarianprogressionrow{17} & Deathless rage                      \\
            \barbarianprogressionrow{18} & Rage feat                           \\
            \barbarianprogressionrow{19} & Supreme resilience                  \\
            \barbarianprogressionrow{20} & Endless rage, Rage \plus6
        \end{dtabularx}
    \end{dtable}
...
\section{Druid}\label{Druid}
    \begin{dtable}
        ...
        \begin{dtabularx}{\columnwidth}{>{\ccol}p{\levelcol} >{\centering}p{\babcolavg} *{3}{>{\ccol}p{\savecol}} >{\lcol}X}
            ...
            \druidprogressionrow{20} & Avatar of nature, natural aspect               \\
        \end{dtabularx}
    \end{dtable}
...
\end{comment}
    ...
    Creatig a new body in this way takes 12 straight hours of concentration.
...
\section{Fighter}\label{Fighter}
    ...
    \subsection{Class Abilities}
        ...
        If the fighter chose resilience, he gains damage reduction against physical damage equal to his character level. This allows him to ignore the first points of damage he would take each round.
...
\section{Monk}\label{Monk}
    ...
    \subsection{Class Abilities}
        ...
        As an immediate action, when the monk would take \glossterm{energy damage}, she can gain damage reduction against any single type of energy damage equal to her \ki power until the end of the round.
        She heals hit points equal to the damage resisted in this way.
        In addition, if she resists energy damage in this way, her physical attacks deal damage of that type for 5 rounds in addition to their normal damage types.
...
\section{Paladin}\label{Paladin}
    ...
    \subsection{Class Abilities}
        ...
        Unless there are extenuating circumstances, this request is almost always granted, and the paladin is resurrected in a new body at a location of the entity's choice, as the \spell{resurrection} ritual except that no part of the body is required.
