...
\section{Fighter}\label{Fighter}
    \begin{dtable}
        ...
        \begin{dtabularx}{\columnwidth}{>{\ccol}p{\levelcol} >{\lcol}X}
            ...
            \\ \nth{20} & Greater armored juggernaut, legendary discipline
        \end{dtabularx}
    \end{dtable}
    ...
    \subsection{Equipment Training}
        ...
        In addition, you gain proficinecy with one \glossterm{weapon group} that weapon belongs to.
        ...
        \cf{Ftr}[5]{Armored Juggernaut}
        You gain a \plus1 bonus to Armor defense while wearing \glossterm{body armor}.
        ...
        \cf{Ftr}[20]{Greater Armored Juggernaut}
...
\section{Monk}\label{Monk}
    \begin{dtable}
        ...
        \begin{dtabularx}{\columnwidth}{>{\ccol}p{\levelcol} >{\lcol}X}
            \tb{Level} & \tb{Abilities} \\\bottomrule
            \nth{1}     & Ki manifestation, meditate, unarmed warrior, unfettered defense
    ...
    \subsection{Transcendent Sage}
        ...
        \cf{Mnk}{Meditate} As a standard action, you can use this ability.
...
\section{Paladin}\label{Paladin}
    ...
    \subsection{Zealous Warrior}
        ...
        \cf{Pal}[8]{Unfaltering Warrior} You gain a \plus1 bonus to Armor defense.
