    ...
    \subsection{Primal Warrior}
        ...
        As a standard action, you can spend an \glossterm{action point} to use a \textit{primal exertion} ability.
        {
            \begin{ability}{Battle Cry}[\glossterm{Mind}, \glossterm{Sustain} (minor)]
                ...
                \subparhead{Rank 3} The healing increases to twice your Willpower.
                \subparhead{Rank 5} The area increases to a \areahuge radius.
                \subparhead{Rank 7} The healing increases to three times your Willpower.
            \end{ability}
            ...
            \begin{ability}{Brace for Impact}[\glossterm{Swift}]
                ...
                \subparhead{Rank 3} You can \glossterm{sustain} this ability as a standard action.
                \subparhead{Rank 5} You also gain damage reduction equal to your level.
                \subparhead{Rank 7} The damage reduction increases to twice your level.
            \end{ability}

            \begin{ability}{Certain Strike}
                Make a \glossterm{strike} with a \plus2 bonus to accuracy.

                \subparhead{Rank 3} The accuracy bonus increases to \plus3.
                \subparhead{Rank 5} The accuracy bonus increases to \plus4.
                \subparhead{Rank 7} The accuracy bonus increases to \plus5.
            \end{ability}
            ...
            \begin{ability}{Demoralizing Shout}[\glossterm{Mind}]
                ...
                \subparhead{Rank 3} If you do not hit any targets with the attack, you regain the action point spent to use this ability.
                \subparhead{Rank 5} The area increases to a \areahuge radius.
                \subparhead{Rank 7} A critical hit makes each target \panicked instead of frightened.
            ...
            \begin{ability}{Ground Pound}
                ...
                \subparhead{Rank 3} The area increases to a \areamed radius burst.
                \subparhead{Rank 5} You gain a \plus1d bonus to damage with the strike.
                \subparhead{Rank 7} The area increases to a \arealarge radius burst.
            \end{ability}
            ...
            \begin{ability}{Gut Punch}
                ...
                \subparhead{Rank 3} You gain a \plus1 bonus to accuracy with the strike.
                \subparhead{Rank 5} You gain a \plus1d bonus to damage with the strike.
                \subparhead{Rank 7} The accuracy bonus increases to \plus2.
            \end{ability}
            ...
            \begin{ability}{Leaping Strike}
                ...
                \subparhead{Rank 3} You gain a \plus1d bonus to damage with the strike per 10 feet of height you travelled downward towards your foe during the leap, up to a maximum of \plus2d.
                \subparhead{Rank 5} The maximum damage bonus increases to \plus4d.
                \subparhead{Rank 7} The maximum damage bonus increases to \plus6d.
            \end{ability}

            \begin{ability}{Potent Maneuver}
                You use a \glossterm{combat maneuver} with a \plus3 bonus to accuracy.

                \subparhead{Rank 3} The accuracy bonus increases to \plus4.
                \subparhead{Rank 5} The accuracy bonus increases to \plus5.
                \subparhead{Rank 7} The accuracy bonus increases to \plus6.
            \end{ability}

            \begin{ability}{Power Attack}
                Make a \glossterm{strike} with a \plus2d bonus to damage.

                \subparhead{Rank 3} If you miss with the strike, you regain the action point spent to use this ability.
                \subparhead{Rank 5} The damage bonus increases to \plus3d.
                \subparhead{Rank 7} The damage bonus increases to \plus4d.
            \end{ability}
            ...
            \begin{ability}{Rapid Assault}
                ...
                \subparhead{Rank 3} If you missed all of your targets, you regain the action point spent to use this ability.
                \subparhead{Rank 5} You gain a \plus1d bonus to damage with both strikes.
                \subparhead{Rank 7} The damage bonus increases to \plus2d.
            \end{ability}
            ...
            \begin{ability}{Reaping Charge}
                ...
                \subparhead{Rank 3} You do not have to choose a side of the line.
                Instead, you can attack creatures and objects that you threaten at any point during your movement.
                \subparhead{Rank 5} The damage penalty is reduced to \minus1d.
                \subparhead{Rank 7} The damage penalty is removed.
            \end{ability}
            ...
            \begin{ability}{Strip the Flesh}
                ...
                \subparhead{Rank 3} If you hit with the strike, the target continues taking the same damage at the end of each \glossterm{action phase} until it becomes \glossterm{bloodied}.
            ...
            \begin{ability}{Sweeping Strike}
                ...
                \subparhead{Rank 3} If you missed all of your targets, you regain the action point spent to use this ability.
                \subparhead{Rank 5} The damage penalty is removed.
                \subparhead{Rank 7} You gain a \plus1d bonus to damage with the strike.
            \end{ability}
            ...
            \begin{ability}{Thunderous Shout}[\glossterm{Sonic}]
                ...
                \subparhead{Rank 3} A hit also makes each target \glossterm{deafened} as a \glossterm{condition}.
                \subparhead{Rank 5} The area increases to \arealarge.
                \subparhead{Rank 7} The damage increases by \plus1d.
            \end{ability}
            ...
            \begin{ability}{Whirlwind Spin}
                ...
                \subparhead{Rank 3} The damage penalty is reduced to \minus1d.
                \subparhead{Rank 5} The damage penalty is removed.
                \subparhead{Rank 7} You gain a \plus1d bonus to damage with the strike.
            \end{ability}
        }
...
\section{Cleric}\label{Cleric}
    \begin{dtable}
        ...
        \begin{dtabularx}{\columnwidth}{c >{\lcol}X >{\lcol}X >{\lcol}X}
            ...
            1 & Spellcasting & Action point & Domains, domain gift
    ...
    \subsection{Divine Spellcasting}
        ...
        In addition, you learn an additional \glossterm{augment}.
    ...
    \subsection{Divine Spell Mastery}
        ...
        \cf{Clr}[1]{Action Point}
        You gain an additional \glossterm{action point}.

        \cf{Clr}[2]{Subspell}
        You learn one \glossterm{subspell} for a divine spell you know.
...
\section{Druid}\label{Druid}
    \begin{dtable}
        ...
        \begin{dtabularx}{\columnwidth}{c >{\lcol}X >{\lcol}X >{\lcol}X}
            ...
            1 & Spellcasting & Action point & Wild aspect
    ...
    \subsection{Nature Spell Mastery}
        ...
        \cf{Drd}[1]{Action Point}
        You gain an additional \glossterm{action point}.

        \cf{Drd}[2]{Subspell}
        You learn one \glossterm{subspell} for a nature spell you know.
        You can use that subspell when you cast that spell (see \pcref{Subspells}).
        Whenever you gain access to a new spell level, you learn one additional subspell.
        Normally, this happens every even level after 2nd level.
    ...
    \subsection{Martial Mastery}
        ...
        As a standard action, you can spend an \glossterm{action point} to use a \textit{martial exertion} ability.
        {
            ...
            \begin{ability}{Challenge}[\glossterm{Attune}]
                ...
                \subparhead{Rank 3} You gain a \plus1 bonus to accuracy with the strike.
                \subparhead{Rank 5} The accuracy bonus increases to \plus2.
                \subparhead{Rank 7} The accuracy bonus increases to \plus3.
            \end{ability}
            ...
            \begin{ability}{Counterattack}
                ...
                \subparhead{Rank 3} If the target did not attack you in the same phase, you regain the action point spent to use this ability.
                \subparhead{Rank 5} The accuracy bonus increases to \plus3 and the damage bonus increases to \plus3d.
                \subparhead{Rank 7} The accuracy bonus increases to \plus4 and the damage bonus increases to \plus4d.
            \end{ability}
            ...
            \begin{ability}{Daunting Blow}[\glossterm{Mind}]
                ...
                \subparhead{Rank 3} You gain a \plus1 bonus to accuracy on the strike.
                \subparhead{Rank 5} The accuracy bonus increases to \plus2.
                \subparhead{Rank 7} The accuracy bonus increases to \plus3.
            \end{ability}
            ...
            \begin{ability}{Rally the Troops}
                ...
                \subparhead{Rank 3} The area increases to \arealarge.
                \subparhead{Rank 5} Each target can instead remove two conditions.
                \subparhead{Rank 7} Each target can instead remove any number of conditions.
            \end{ability}
            ...
            \begin{ability}{Strip the Flesh}
                ...
                \subparhead{Rank 3} If you hit with the strike, the target continues taking the same damage at the end of each \glossterm{action phase} in subsequent rounds until it becomes \glossterm{bloodied}.
                This is a \glossterm{condition}, and can be removed by abilities that remove conditions.
                \subparhead{Rank 5} You gain a \plus1d bonus to damage with the strike.
                \subparhead{Rank 7} The damage bonus increases to \plus2d.
            \end{ability}
...
\section{Mage}\label{Mage}
    \begin{dtable}
        ...
        \begin{dtabularx}{\columnwidth}{c >{\lcol}X >{\lcol}X >{\lcol}X}
            ...
            1 & Spellcasting & Action point & Mage armor
    ...
    \subsection{Arcane Spellcasting}
        ...
        Your \glossterm{spellpower} with arcane spells is equal to your \textit{arcane power}.
        ...
        \cf{Mge}[2]{Expanded Knowledge}
        \subparhead{Sorcerer} You learn an additional arcane spell (see \pcref{Arcane Spells}).
    ...
    \subsection{Arcane Lore}
...

        {
            ...
            \parhead{Expanded Spell Knowledge} You can only gain this arcane insight if you are a sorcerer.
    ...
    \subsection{Arcane Spell Mastery}
        ...
        \cf{Mge}[1]{Action Point}
        You gain an additional \glossterm{action point}.

        \cf{Mge}[2]{Subspell}
        You learn one \glossterm{subspell} for a arcane spell you know.
        You can use that subspell when you cast that spell (see \pcref{Subspells}).
        Whenever you gain access to a new spell level, you learn one additional subspell.
        Normally, this happens every even level after 2nd level.
        ...
        \cf{Mge}[4]{Subspell}
        You learn an additional \glossterm{subspell} for a arcane spell you know.
...
\section{Monk}\label{Monk}
    \begin{dtable}
        ...
        \begin{dtabularx}{\columnwidth}{c >{\lcol}X >{\lcol}X >{\lcol}X}
            ...
            1 & Ki manifestations & Serene strike & Unarmed warrior, unfettered defense
    ...
    \subsection{Ki}
        ...
        You cannot use more than one \textit{ki manifestation} per round.
        {
            \begin{ability}{Abandon the Fragile Self}[\glossterm{Swift}]
                ...
                \subparhead{Rank 3} This ability lasts until the end of the next round.
                \subparhead{Rank 5} You can also remove one condition affecting you when you use this ability.
                \subparhead{Rank 7} You can remove two conditions instead of one.
            \end{ability}
            ...
            \begin{ability}{Burst of Blinding Speed}
                ...
                \subparhead{Rank 3} You can also ignore \glossterm{difficult terrain}.
                \subparhead{Rank 5} You can also move or stand on liquids as if they were solid.
                \subparhead{Rank 7} The speed bonus increases to \plus60 feet, up to a maximum of triple your original speed.
            \end{ability}
            ...
            \begin{ability}{Dance of Falling Feathers}
                ...
                \subparhead{Rank 3} This ability's effect lasts as long as you \glossterm{sustain} it as a \glossterm{minor action}.
                \subparhead{Rank 5} You can control the speed of your fall, up to a maximum of 120 feet per round and a minimum of 30 feet per round.
                \subparhead{Rank 7} Your maximum falling speed becomes 180 feet per round and your minimum falling speed becomes 10 feet per round.
            \end{ability}
            ...
            \begin{ability}{Elegant Whirl of Fluid Motion}
                ...
                \subparhead{Rank 3} You also gain a \plus1 bonus to Armor and Reflex defenses.
                \subparhead{Rank 5} The Acrobatics bonus increases to \plus10.
                \subparhead{Rank 7} The defense bonus increases to \plus2.
            \end{ability}
            ...
            \begin{ability}{Flash Step}[\glossterm{Teleportation}]
                ...
                \subparhead{Rank 3} The distance you can teleport is increased to half your movement speed.
                \subparhead{Rank 5} You can teleport in multiple steps within the same phase.
                Each step costs movement equal to twice the distance you teleport.
                \subparhead{Rank 7} You can attempt to teleport to locations outside of \glossterm{line of sight} and \glossterm{line of effect}.
            ...
            \begin{ability}{Ki Strike}
                ...
                \subparhead{Rank 3} Your \glossterm{reach} is increased by 5 feet for the strike.
                \subparhead{Rank 5} The bonus to your reach increases to 10 feet. 
                \subparhead{Rank 7} This ability does not cost an action point to use.
            \end{ability}
            ...
            \begin{ability}{Leap of the Heavens}
                ...
                \subparhead{Rank 3} The bonus increases to \plus10.
                \subparhead{Rank 5} The bonus increases to \plus15.
                \subparhead{Rank 7} The bonus increases to \plus20.
            \end{ability}
            ...
            \begin{ability}{Scale the Highest Tower}
                ...
                \subparhead{Rank 3} You also take no penalty for climbing without using your hands.
                \subparhead{Rank 5} The Climb bonus increases to \plus10.
                \subparhead{Rank 7} You also take no penalty for climbing with only one limb, such as an arm or leg.
            \end{ability}
            ...
            \begin{ability}{See the Flow of Life}
                ...
                \subparhead{Rank 3} Range is increased to 100 feet.
                \subparhead{Rank 5} The effect lasts as long as you \glossterm{sustain} it as a \glossterm{minor action}.
                \subparhead{Rank 7} The effect lasts as long as you \glossterm{attune} to it.
            \end{ability}
            ...
            \begin{ability}{Step Between the Mystic Worlds}[\glossterm{Swift}]
                ...
                \subparhead{Rank 3} The defense bonus is increased to \plus4.
                \subparhead{Rank 5} The defense bonus is increased to \plus6.
                \subparhead{Rank 7} You cannot be directly targeted by \glossterm{magical} abilities.
            \end{ability}
            ...
            \begin{ability}{Surpass the Mortal Limits}
                ...
                \subparhead{Rank 3} You also gain a \plus2 bonus to checks based on Strength, Dexterity, and Constitution.
                \subparhead{Rank 5} The bonus increases to \plus4.
                \subparhead{Rank 7} The bonus increases to \plus6.
            \end{ability}
    ...
    \subsection{Unfettered Warrior}
        ...
        \cf{Mnk}[1]{Unfettered Defense}[Magical]
        ...
        \cf*{Mnk}[4]{Unfettered Athletics} You gain two additional skill points.
    ...
    \subsection{Transcendent Sage}
        ...
        \cf{Mnk}[4]{Greater Serene Strike} You gain a \plus1d bonus to damage with the strike from your \textit{serene strike} ability.
...
\section{Paladin}\label{Paladin}
    ...
    \subsection{Divine Spellcasting}
        ...
        \cf*{Pal}[4]{Spell Knowledge}
        You learn an additional divine spell (see \pcref{Divine Spells}).

        \cf*{Pal}[5]{Augment}
        You learn an additional \glossterm{augment} (see \pcref{Augments}).

        \cf{Pal}[6]{Ritual Master}
        When you lead a divine ritual, each action point you spend contributes two action points to the ritual's cost.

        \cf*{Pal}[7]{Augment}
        You learn an additional \glossterm{augment} (see \pcref{Augments}).

        \cf{Pal}[8]{Mystic Supremacy}
        The maximum spell level you can cast is increased to 11.
        In addition, you learn an additional \glossterm{augment}.
...
\section{Ranger}\label{Ranger}
    ...
    \subsection{Huntmaster}
        ...
        Whenever you use your \textit{quarry} ability, you may also use one of your \textit{hunting styles}.
        {
            ...
            \subparhead{Rank 5} This effect instead applies if your quarry is within \rngmed range of at two members of your hunting party.
            \subparhead{Rank 7} This effect instead applies if your quarry is within \rnglong range of any member of your hunting party.
            ...
            \subparhead{Rank 5} The accuracy penalty is removed.
            \subparhead{Rank 7} The damage bonus is increased to \plus2d.
            ...
            \subparhead{Rank 5} Your hunting party gains a \plus1d bonus to damage against your quarry if it is \unaware of every member of the hunting party.
            \subparhead{Rank 7} The damage bonus increases to \plus2d.
            ...
            \subparhead{Rank 5} Your hunting party gains \glossterm{damage reduction} equal to half your level against your quarry's attacks.
            \subparhead{Rank 7} The damage reduction increases to be equal to your level.
            ...
            \subparhead{Rank 5} This penalty increases to \minus3.
            \subparhead{Rank 7} This penalty increases to \minus4.
            ...
            \subparhead{Rank 5} This effect instead applies if the target is within \rngmed range of at two members of your hunting party.
            \subparhead{Rank 7} This effect instead applies if your quarry is within \rnglong range of any member of your hunting party.
            ...
            \subparhead{Rank 5} The penalty increases to \minus2 if your quarry is threatened by at least two members of your hunting party.
            \subparhead{Rank 7} The penalty increases to \minus3 if your quarry is threatened by at least three members of your hunting party.
            ...
            \subparhead{Rank 5} Any vital damage dealt in this way is doubled.
            \subparhead{Rank 7} The accuracy bonus against your quarry is increased to \plus2 if it is \glossterm{bloodied}.
            ...
            \subparhead{Rank 5} Your hunting party gains a \plus1 bonus to Fortitude, Reflex, and Mental defenses against attacks from your quarry.
            \subparhead{Rank 7} The accuracy bonus against your quarry is increased to \plus2.
            ...
            \subparhead{Rank 5} The accuracy bonus against your quarry increases to \plus2.
            \subparhead{Rank 7} The defense bonus increases to \plus2.

            \subcf{Swarm Hunter}
            When you use your \textit{quarry} ability, you can target any number of creatures.
            \subparhead{Rank 5} You gain a \plus1 bonus to \glossterm{overwhelm resistance}.
            \subparhead{Rank 7} The bonus to overwhelm resistance applies to all members of your \glossterm{hunting party}.
            ...
            \subparhead{Rank 5} Your hunting party also ignores the defense bonus from \glossterm{cover} on attacks against your quarry.
            \subparhead{Rank 7} Your hunting party ignores all miss chances on attacks against your quarry.
            ...
            \subparhead{Rank 5} The quarry is \immobilized instead of moving at half speed.
            \subparhead{Rank 7} The accuracy bonus against your quarry increases to \plus2 if it is threatened by at least two members of your hunting party.
        }
...
\section{Warlock}\label{Warlock}
    \begin{dtable}
        ...
        \begin{dtabularx}{\columnwidth}{c >{\lcol}X >{\lcol}X >{\lcol}X}
            ...
            1 & Spellcasting & Whispers of the lost & Malevolent boon
    ...
    \subsection{Arcane Spellcasting}
        ...
        \cf{War}[2]{Rituals}
        You can perform arcane rituals to create unique magical effects (see \pcref{Rituals}).
        ...
        \cf*{War}[4]{Spell Knowledge}
        You learn an additional arcane spell (see \pcref{Arcane Spells}).

        \cf*{War}[5]{Augment}
        You learn an additional \glossterm{augment} (see \pcref{Augments}).

        \cf{War}[6]{Ritual Master}
        When you lead a arcane ritual, each action point you spend contributes two action points to the ritual's cost.

        \cf*{War}[7]{Augment}
        You learn an additional \glossterm{augment} (see \pcref{Augments}).

        \cf{War}[8]{Mystic Supremacy}
        The maximum spell level you can cast is increased to 11.
        In addition, you learn an additional \glossterm{augment}.
    ...
    \subsection{Pact Magic}
        ...
        Your \glossterm{power} with pact augments is equal to your \glossterm{spellpower} with the spell you apply them to.
        {
            ...
            \augment{4}{Inevitable Doom} You gain a \plus2 bonus to accuracy with the spell.
            \par This augment can be applied to any spell that makes an attack.

            \augment{4}{Infernal Potency} You gain a \plus2d bonus to damage with the spell.
            ...
            \augment{6}{Soulclaiming} Whenever a creature takes damage from the spell, its soul becomes marked by your soulkeeper as a \glossterm{condition}.
            ...
            \augment{8}{Greater Inevitable Doom} You gain a \plus4 bonus to accuracy with the spell.
            \par This augment can be applied to any spell that makes an attack.

            \augment{8}{Greater Infernal Potency} You gain a \plus4d bonus to damage with the spell.
            \par This augment can be applied to any spell that deals damage based on a dice pool.
        }

        \cf{War}[3]{Greater Malevolent Boon} You can cast spells that make attack rolls without spending \glossterm{action points}.
        ...
        \cf{War}[5]{Supreme Malevolent Boon} You can cast all spells without spending \glossterm{action points}.
        You cannot \glossterm{attune} to a spell you cast in this way.
        In addition, you cannot use this ability when casting \glossterm{subspells}.

        \cf*{War}[6]{Pact Augment} You learn an additional \textit{pact augment}.

        \cf{War}[7]{Infernal Power} You gain a \plus1 bonus to \glossterm{accuracy} with spells.
