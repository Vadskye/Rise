...
\section{Class Introductions}
    ...
    \begin{itemize}
        ...
        \item Witches are hedge spellcasters who draw their power from a pact made with natural spirits.
    \end{itemize}
...
\section{Cleric}\label{Cleric}
    \begin{dtable!*}
        ...
        \begin{dtabularx}{\textwidth}{c >{\lcol}X >{\lcol}X >{\lcol}X >{\lcol}X}
            \tb{Rank} & \tb{Divine Magic} & \tb{Divine Spell Mastery}   & \tb{Domain Influence}  & \tb{Healer} \tableheaderrule
            1 & Spellcasting   & Mystic knowledge            & Domains, domain gift  & Divine healing         \\
            2 & Mystic sphere  & Battle priest               & Domain gift           & Vital healer           \\
            ...
            5 & Spell rank (5) & Greater battle priest       & Domain essence        & Greater vital healer   \\
            6 & Spell rank (6) & Greater wellspring of power & Domain essence        & Greater divine cleanse \\
            7 & Spell rank (7) & Mystic knowledge            & Miracle               & Supreme divine healing \\
...
\section{Druid}\label{Druid}
    \begin{dtable!*}
        ...
        \begin{dtabularx}{\textwidth}{c >{\lcol}X >{\lcol}X >{\lcol}X >{\lcol}X >{\lcol}X}
            \tb{Rank} & \tb{Elementalist}         & \tb{Nature Magic} & \tb{Nature Spell Mastery}   & \tb{Shifter}               & \tb{Wildspeaker}         \tableheaderrule
            1 & Elemental balance         & Spellcasting   & Mystic knowledge            & Wild aspects               & Natural servant         \\
            2 & Elemental sphere          & Natural focus  & Natural spells              & Shifting defense           & Animal speech           \\
            ...
            6 & Elemental control         & Spell rank (6) & Greater wellspring of power & Greater shift body         & Greater wild guardian   \\
            7 & Supreme elemental balance & Spell rank (7) & Mystic knowledge            & Triple aspect, wild aspect & Supreme natural servant \\
    ...
    \subsection{Basic Class Abilities}
        ...
        \cf{Drd}{Defenses}
        You gain the following bonuses to your \glossterm{defenses}: \plus4 Fortitude, \plus4 Reflex, \plus4 Mental.
    ...
    \subsection{Wildspeaker}\label{Wildspeaker}
        ...
        \cf{Drd}[5]{Plant Speech}[Magical] When you use your \textit{wild speech} ability, you can target a plant instead of an animal.
...
\section{Monk}\label{Monk}
    ...
    \subsection{Esoteric Warrior}\label{Esoteric Warrior}
        ...
        \cf*{Mnk}[3]{Greater Unarmed Warrior} The damage bonus from your \textit{unarmed warrior} ability increases to \plus2d.
        ...
        \cf{Mnk}[6]{Supreme Unarmed Warrior} The damage bonus from your \textit{unarmed warrior} ability increases to \plus3d.
...
\section{Paladin}\label{Paladin}
    \begin{dtable!*}
        ...
        \begin{dtabularx}{\textwidth}{c >{\lcol}X >{\lcol}X >{\lcol}X >{\lcol}X}
            \tb{Rank} & \tb{Devoted Paragon}  & \tb{Divine Magic} & \tb{Stalwart Guardian}      & \tb{Zealous Warrior}       \tableheaderrule
...
\section{Ranger}\label{Ranger}
    \begin{dtable!*}
        ...
        \begin{dtabularx}{\textwidth}{c >{\lcol}X >{\lcol}X >{\lcol}X > {\lcol}X}
            \tb{Rank} & \tb{Beastmaster}         & \tb{Huntmaster} & \tb{Keen Senses}    & \tb{Wilderness Warrior} \tableheaderrule
            ...
            4 & Greater animal companion & Tracker         & Greater keen vision & Wild maneuver           \\
            ...
            7 & Supreme animal companion & Greater tracker & Supreme keen vision & Wild maneuver           \\
            8 &                          & Dual quarry     &                     &                         \\
        \end{dtabularx}
    \end{dtable!*}
    ...
    \subsection{Huntmaster}
        ...
        \cf{Rgr}[3]{Hunter's Power} You gain a \plus1 bonus to \glossterm{power} with \glossterm{mundane} abilities.
        ...
        \cf{Rgr}[6]{Greater Hunter's Power}
        The bonus from your \textit{hunter's power} ability increases to \plus2.
...
\section{Rogue}\label{Rogue}
    ...
    \subsection{Combat Trickster}
        ...
        In addition, you gain a \plus2 bonus to the Sleight of Hand skill.
    ...
    \subsection{Suave Scoundrel}
        ...
        In addition, you gain a \plus2 bonus to the Bluff, Intimidate, and Persuasion skills.
...
\section{Sorcerer}\label{Mage}
    \begin{dtable!*}
        ...
        \begin{dtabularx}{\textwidth}{c >{\lcol}X >{\lcol}X >{\lcol}X >{\lcol}X}
            \tb{Rank} & \tb{Arcane Magic}     & \tb{Arcane Spell Mastery}   & \tb{Innate Arcanist} \tableheaderrule
            1 & Mystic spheres        & Mystic knowledge            & Nonverbal caster     \\
            2 & Innate focus          & Mage armor                  & Innate magic         \\
            3 & Spell rank (3)        & Wellspring of power         & Augment              \\
            4 & Spell rank (4), spell & Mystic knowledge            & Stilled caster       \\
            5 & Spell rank (5)        & Greater mage armor          & Greater innate magic \\
            6 & Spell rank (6)        & Greater wellspring of power & Augment              \\
            7 & Spell rank (7), spell & Mystic knowledge            & Spell absorption     \\
            8 & Spell rank (8)        &                             &                      \\
        \end{dtabularx}
    \end{dtable!*}
    ...
    \classbasics{Archetypes} Sorcerers have the Arcane Magic, Arcane Spell Mastery, and Innate Arcanist \glossterm{archetypes}.
    ...
    \subsection{Basic Class Abilities}
        ...
        \cf{Sor}{Weapon and Armor Proficiencies}
    ...
    \subsection{Arcane Magic}
        ...
        \cf{Sor}[3]{Spell Rank}[Magical] You gain the ability to cast rank 3 arcane spells.

        \cf*{Sor}[4]{Spell Rank}[Magical] You gain the ability to cast rank 4 arcane spells.

        \cf{Sor}[4]{Spell} You gain an additional \glossterm{spell} for any arcane \glossterm{mystic sphere} you know.

        \cf*{Sor}[5]{Spell Rank}[Magical] You gain the ability to cast rank 5 arcane spells.

        \cf*{Sor}[6]{Spell Rank}[Magical] You gain the ability to cast rank 6 arcane spells.

        \cf*{Sor}[7]{Spell Rank}[Magical] You gain the ability to cast rank 7 arcane spells.

        \cf*{Sor}[7]{Spell} You gain an additional \glossterm{spell} for any arcane \glossterm{mystic sphere} you know.

        \cf*{Sor}[8]{Spell Rank}[Magical] You gain the ability to cast rank 8 arcane spells.
    ...
    \subsection{Arcane Spell Mastery}
        ...
        \cf{Sor}[1]{Mystic Knowledge}[Magical]
        You gain your choice of one of the following abilities.
        {
            \parhead{Focused Caster} You reduce your \glossterm{focus penalty} by 1.
                You can choose this ability multiple times.
        ...
        \cf*{Sor}[4]{Mystic Knowledge}[Magical]
        You gain an additional \textit{mystic knowledge} ability.
        ...
        \cf*{Sor}[7]{Mystic Knowledge}[Magical]
        You gain an additional \textit{mystic knowledge} ability.
    ...
    \subsection{Innate Arcanist}
        ...
        \cf{Sor}[1]{Nonverbal Caster} When you cast a spell, you can omit that spell's \glossterm{verbal components}.

        \cf{Sor}[2]{Innate Magic} You gain a bonus to \glossterm{resistances} against \glossterm{energy damage} equal to half your level.
        ...
        \cf{Sor}[4]{Stilled Caster} When you cast a spell, you can omit that spell's \glossterm{somatic components}.

        \cf{Sor}[5]{Greater Innate Magic} The bonus from your \textit{innate magic} ability increases to be equal to your level.

        \cf*{Sor}[6]{Augment} You learn an additional \glossterm{augment}.

        \cf{Sor}[7]{Spell Absorption} When a spell is used to attack you, if the attack fails to beat your defenses, you gain the ability to cast the spell once.
...
\section{Warlock}\label{Warlock}
    \begin{dtable!*}
        ...
        \begin{dtabularx}{\textwidth}{c >{\lcol}X >{\lcol}X >{\lcol}X >{\lcol}X}
            \tb{Rank} & \tb{Blessings of the Abyss}  & \tb{Pact Magic} & \tb{Pact Spell Mastery}     & \tb{Soulkeeper's Chosen} \tableheaderrule
            1 & Eldritch blast               & Spellcasting          & Mystic knowledge             & Possession                  \\
            2 & Fiendish resistance          & Soulbound focus       & Armor tolerance             & Empowering whispers         \\
            3 & Abyssal jaunt                & Spell rank (3)        & Wellspring of power         & Influence possession        \\
            4 & Abyssal substitution         & Spell rank (4), spell & Mystic knowledge             & Exchange soul fragment      \\
            5 & Greater fiendish resistance  & Spell rank (5)        & Greater armor tolerance     & Powerful possession         \\
            6 & Abyssal curse                & Spell rank (6)        & Greater wellspring of power & Greater empowering whispers \\
            7 & Greater abyssal substitution & Spell rank (7), spell & Mystic knowledge             & Control possession          \\
            8 &                              & Spell rank (8)        &                             &                             \\
        \end{dtabularx}
    \end{dtable!*}
...
\newpage
\section{Witch}\label{Witch}
    \begin{dtable!*}
        \lcaption{Witch Progression}
        \begin{dtabularx}{\textwidth}{c >{\lcol}X >{\lcol}X >{\lcol}X >{\lcol}X >{\lcol}X}
            \tb{Rank} & \tb{Brewer}         & \tb{Hedge Magic} & \tb{Hedge Spell Mastery}    \tableheaderrule
            1 & Witch's brew        & Spellcasting   & Mystic knowledge            \\
            2 & Skilled brewer      & Mystic sphere  & Witch's hex                 \\
            3 & Tempting concoction & Spell rank (3) & Wellspring of power         \\
            4 & Esoteric concoction & Spell rank (4) & Mystic knowledge            \\
            5 & Efficient brewer    & Spell rank (5) & Greater witch's hex         \\
            6 & Poison spell        & Spell rank (6) & Greater wellspring of power \\
            7 & Blended concoction  & Spell rank (7) & Mystic knowledge            \\
            8 &                     & Spell rank (8) &                             \\
        \end{dtabularx}
    \end{dtable!*}
    ...
    \classbasics{Archetypes} Witches have the Brewer, Hedge Magic, and Hedge Spell Mastery \glossterm{archetypes}.

    \subsection{Basic Class Abilities}
        If you are a witch, you gain the following abilities.
        ...
        You have the following \glossterm{class skills}:
        \begin{itemize}
            \item \subparhead{Intelligence} Craft, Deduction, Heal, Knowledge (geography, nature), Linguistics.
            \item \subparhead{Perception} Awareness, Creature Handling, Spellcraft, Survival.
            \item \subparhead{Other} Bluff, Intimidate, Persuasion, Profession.
        \end{itemize}

        \cf{Wch}{Weapon and Armor Proficiencies}
        You are proficient with simple weapons, any one other weapon group, light armor, and shields.
        ...
        \cf{Wch}{Spirit Pact} Witches draw power from the pact or pacts they make with natural spirits.
        These spirits are less than gods, but their connection to the natural world allows them to share that power with witches.
        Most natural spirits have no consistently good or evil inclinations, though many are cruel or vindictive and a rare few are actively benevolent.
        All natural spirits expect a price for their powers, but the price can vary dramatically depending on the nature of the spirit.

    \subsection{Brewer}
        This archetype improves your ability to create potions and poisons to aid your allies and harm your foes.

        \cf{Wch}[1]{Witch's Brew} You can use the \textit{witch's brew} ability with an hour of effort brewing liquid in a cauldron or similar receptacle.
        \begin{freeability}{Witch's Brew}
            Choose a \glossterm{targeted} spell you know that does not have the \glossterm{Sustain} or \glossterm{Attune} (self) tags.
            The spell becomes imbued in one ounce of the liquid that you can remove and place in a receptacle.
            You gain a \plus2 bonus to \glossterm{power} with the spell.
            A creature that drinks that liquid becomes affected by the spell as if you had cast it on the creature.
            The effects of the spell wear off after one hour, even if the spell would normally have a longer duration.

            This ability lasts until you use it again.

            \rankline
            \rank{3} You can choose up to two spells and imbue up to two one-ounce portions with any spell chosen.
            \rank{5} The bonus to \glossterm{power} increases to \plus4.
            \rank{7} You can choose up to four spells and imbue up to four one-ounce portions with any spell chosen.
        \end{freeability}

        \cf{Wch}[2]{Skilled Brewer} You gain two additional \glossterm{skill points}.
        In addition, you gain \plus1 bonus to \glossterm{potency} with any poisons you create.

        \cf{Wch}[3]{Tempting Concoction} You can use the \textit{tempting concoction} ability as a \glossterm{standard action}.
        \begin{apability}{Tempting Concoction}[\glossterm{Emotion}, \glossterm{Magical}, \glossterm{Subtle}]
            \targets{See text}
            Choose one liquid \glossterm{poison} or \textit{witch's brew} you created, or an object containing one of those liquids, within \rngclose range.
            Whenever a creature notices the chosen object, make an attack vs. Mental against it.
            If the brew or poison is not concealed inside a less suspicious object, such as an opaque liquid or an apple, you take a \minus4 penalty to \glossterm{accuracy}.
            ...
            This effect lasts until it consumes the object or until it takes a \glossterm{short rest}.
        ...
        \cf{Wch}[4]{Esoteric Concoction} You can use esoteric natural ingredients in place of expensive ingredients when creating poisons.
        ...
        Once you have decided on a replacement ingredient for a particular poison, you cannot use that ingredient as a replacement for an expensive ingredient in any other poison.

        \cf{Wch}[5]{Efficient Brewer} You can create poisons in half the normal time.
        In addition, the bonus from your \textit{skilled brewer} ability increases to \plus2.

        \cf{Wch}[6]{Poison Spell} You can use the \textit{poison spell} ability when you cast a spell that does not have the \glossterm{Attune} or \glossterm{Sustain} tags.
        \begin{freeability}{Poison Spell}
            Choose a poison in your hands.
            You infuse a dose of the poison into a spell you are casting, consuming the dose.
            The spell is diluted by the poison, giving you a \minus2 penalty to \glossterm{power} with it.
            Make an attack vs. Fortitude against each of the spell's targets.
            \hit If the target takes damage from the spell, it is also \glossterm{poisoned} by the chosen poison.
        \end{freeability}

        \cf{Wch}[7]{Blended Concoction} You can create poisons that combine two poison effects into a single dose.
    ...
    \subsection{Hedge Magic}
        This archetype grants you the ability to cast hedge spells.

        \cf{Wch}[1]{Spellcasting}[Magical]
        Your pact with natural spirits grants you the ability to use hedge magic.
        You gain access to one hedge \glossterm{mystic sphere} (see \pcref{Hedge Mystic Spheres}).
        You may spend \glossterm{insight points} to learn one additional \glossterm{mystic sphere} per two \glossterm{insight points}.
        Each \glossterm{mystic sphere} has a set of \glossterm{spells} associated with it.

        You automatically learn all \glossterm{cantrips} from any mystic sphere you have access to.
        In addition, you learn one rank 1 \glossterm{spell} from your chosen \glossterm{mystic sphere}.
        You can also spend \glossterm{insight points} to learn one additional hedge spell per \glossterm{insight point}.
        Unless otherwise noted in a spell's description, casting a spell requires a \glossterm{standard action}.
        ...
        Hedge spells require both \glossterm{verbal components} and \glossterm{somatic components }to cast (see \pcref{Casting Components}).
        For details about mystic spheres and casting spells, see \pcref{Spell and Ritual Mechanics}.

        \cf{Wch}[2]{Mystic Sphere} You gain access to an additional hedge \glossterm{mystic sphere}, including all \glossterm{cantrips} from that sphere.
        In addition, you learn an additional hedge \glossterm{spell}.

        \cf{Wch}[3]{Spell Rank}[Magical] You gain the ability to cast rank 3 hedge spells.

        \cf{Wch}[3]{Spell} You learn an additional \glossterm{spell} for any hedge \glossterm{mystic sphere} you know.

        \cf*{Wch}[4]{Spell Rank}[Magical] You gain the ability to cast rank 4 hedge spells.

        \cf*{Wch}[5]{Spell Rank}[Magical] You gain the ability to cast rank 5 hedge spells.

        \cf*{Wch}[6]{Spell Rank}[Magical] You gain the ability to cast rank 6 hedge spells.

        \cf*{Wch}[6]{Spell} You learn an additional \glossterm{spell} for any hedge \glossterm{mystic sphere} you know.

        \cf*{Wch}[7]{Spell Rank}[Magical] You gain the ability to cast rank 7 hedge spells.

        \cf*{Wch}[8]{Spell Rank}[Magical] You gain the ability to cast rank 8 hedge spells.

    \subsection{Hedge Spell Mastery}
        This archetype improves the hedge spells you cast.
        You must be able to cast hedge spells to gain the abilities from this archetype.

        \cf{Wch}[1]{Mystic Knowledge}
        You gain your choice of one of the following abilities.
        {
            \parhead{Focused Caster} You reduce your \glossterm{focus penalty} by 1.
                You can choose this ability multiple times.
                Its effects stack.
            \parhead{Insight} You learn an additional hedge \glossterm{spell} (see \pcref{Hedge Mystic Spheres}).
                You can choose this ability multiple times, gaining access to an additional spell each time.
            \parhead{Mystic Sphere Access} You gain access to an additional hedge \glossterm{mystic sphere}.
                You cannot choose this ability multiple times.
            \parhead{Rituals} You gain the ability to perform hedge rituals to create unique magical effects (see \pcref{Rituals}).
                The maximum \glossterm{rank} of hedge ritual you can learn or perform is equal to the maximum rank of divine spell that you can cast.
                You cannot choose this ability multiple times.
        }

        \cf{Wch}[2]{Witch's Hex} You gain a \plus1 bonus to \glossterm{accuracy} with \glossterm{Curse} abilities.

        \cf{Wch}[3]{Wellspring of Power}[Magical]
        You gain a \plus1 bonus to \glossterm{power} with \glossterm{magical} abilities.

        \cf*{Wch}[4]{Mystic Knowledge}[Magical]
        You gain an additional \textit{mystic knowledge} ability.

        \cf{Wch}[5]{Greater Witch's Hex} The bonus from your \textit{witch's hex} ability increases to \plus2.

        \cf{Wch}[6]{Greater Wellspring of Power}[Magical]
        The bonus from your \textit{wellspring of power} ability increases to \plus2.

        \cf*{Wch}[7]{Mystic Knowledge}[Magical]
        You gain an additional \textit{mystic knowledge} ability.
...
\section{Wizard}\label{Wizard}
    \begin{dtable!*}
        ...
        \begin{dtabularx}{\textwidth}{c >{\lcol}X >{\lcol}X >{\lcol}X >{\lcol}X}
            \tb{Rank} & \tb{Arcane Magic}     & \tb{Arcane Spell Mastery}   & \tb{Arcane Scholar}    \tableheaderrule
            1 & Mystic spheres        & Mage armor                  & Scholastic lore       \\
            2 & Spells                & Mystic knowledge            & Rituals               \\
            3 & Spell rank (3)        & Wellspring of power         & Scholastic insight    \\
            4 & Spell rank (4), spell & Mystic knowledge            & Ritual expertise      \\
            5 & Spell rank (5)        & Greater mage armor          & Contingency           \\
            6 & Spell rank (6)        & Mystic knowledge            & Scholastic insight    \\
            7 & Spell rank (7), spell & Greater wellspring of power & Malleable contingency \\
            8 & Spell rank (8)        &                             &                       \\
        \end{dtabularx}
    \end{dtable!*}
    ...
    \classbasics{Archetypes} Mages have the Arcane Magic, Arcane Spell Mastery, Arcane Scholar, and Innate Arcanist \glossterm{archetypes}.
    ...
    \subsection{Basic Class Abilities}
        ...
        \cf{Wiz}{Weapon and Armor Proficiencies}
        You are proficient with simple weapons and one other weapon group.
        You are proficient with shields, but not with any type of armor.
        Encumbrance from armor interferes with the gestures you make to cast spells, which can cause your spells with somatic components to fail (see \pcref{Somatic Component Failure}).
    ...
    \subsection{Arcane Magic}
        ...
        You must have an starting Intelligence of at least 1 to gain this archetype.
        ...
        \cf{Wiz}[3]{Spell Rank}[Magical] You gain the ability to cast rank 3 arcane spells.

        \cf*{Wiz}[4]{Spell Rank}[Magical] You gain the ability to cast rank 4 arcane spells.

        \cf{Wiz}[4]{Spell} You gain an additional \glossterm{spell} for any arcane \glossterm{mystic sphere} you know.

        \cf*{Wiz}[5]{Spell Rank}[Magical] You gain the ability to cast rank 5 arcane spells.

        \cf*{Wiz}[6]{Spell Rank}[Magical] You gain the ability to cast rank 6 arcane spells.

        \cf*{Wiz}[7]{Spell Rank}[Magical] You gain the ability to cast rank 7 arcane spells.

        \cf*{Wiz}[7]{Spell} You gain an additional \glossterm{spell} for any arcane \glossterm{mystic sphere} you know.

        \cf*{Wiz}[8]{Spell Rank}[Magical] You gain the ability to cast rank 8 arcane spells.

    \subsection{Arcane Spell Mastery}
        This archetype improves the arcane spells you cast.
        You must have the Arcane Magic archetype from the wizard class to gain the abilities from this archetype.

        \cf{Wiz}[1]{Mystic Knowledge}[Magical]
        You gain your choice of one of the following abilities.
        {
            \parhead{Focused Caster} You reduce your \glossterm{focus penalty} by 1.
                You can choose this ability multiple times.
        ...
        \cf*{Wiz}[4]{Mystic Knowledge}[Magical]
        You gain an additional \textit{mystic knowledge} ability.
        ...
        \cf*{Wiz}[7]{Mystic Knowledge}[Magical]
        You gain an additional \textit{mystic knowledge} ability.
    ...
    \subsection{Arcane Scholar}
        ...
        \cf{Wiz}[2]{Rituals} You gain the ability to perform arcane rituals to create unique magical effects (see \pcref{Rituals}).
        The maximum \glossterm{rank} of arcane ritual you can learn or perform is equal to the maximum rank of arcane spell that you can cast.
