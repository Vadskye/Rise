...
\section{Cleric}\label{Cleric}
    ...
    \subsection{Divine Spellcasting}
        ...
        \cf{Clr}[2]{Spells} You learn a number of divine \glossterm{spells} equal to your starting Intelligence \add 2 (minimum 1).
    ...
    \subsection{Divine Spell Mastery}
        ...
        You gain your choice of one of the following abilities.
        {
            ...
            \parhead{Spell Knowledge} You learn an additional \glossterm{spell} for a divine \glossterm{mystic sphere} you have access to.
                You must have the ability to cast 1st level divine \glossterm{spells} to choose this ability.
...
\section{Druid}\label{Druid}
    \begin{dtable}
        ...
        \begin{dtabularx}{\columnwidth}{c >{\lcol}X >{\lcol}X >{\lcol}X}
            \tb{Rank} & \tb{Nature Spellcasting} & \tb{Nature Spell Mastery}  & \tb{Natural Influence} \\\bottomrule
               1 & Mystic spheres         & Wellspring of magic         & Wild aspect
            \\ 2 & Spells                 & Mystic knowledge            & Wild speech
            \\ 3 & Spell level (2)        & Augments                    & Wild aspect
            \\ 4 & Spell level (3), spell & Mystic knowledge            & Natural lore
            \\ 5 & Spell level (4)        & Augment                     & Wild aspect
            \\ 6 & Spell level (5), spell & Greater wellspring of magic & Nature's champion
    ...
    \subsection{Nature Spellcasting}
        ...
        \cf{Drd}[2]{Spells} You learn a number of nature \glossterm{spells} equal to your starting Intelligence \add 2 (minimum 1).
...
\section{Mage}\label{Mage}
    ...
    \subsection{Arcane Spellcasting}
        ...
        \cf{Mge}[2]{Spells} You learn a number of arcane \glossterm{spells} equal to your starting Intelligence \add 2 (minimum 1).
