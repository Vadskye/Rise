...
\section{Druid}\label{Druid}
    \begin{dtable!*}
        ...
        \begin{dtabularx}{\textwidth}{c >{\lcol}X >{\lcol}X >{\lcol}X >{\lcol}X}
            ...
            3 & Beast lore          & Spell level (2) & Wellspring of power         & Shift body                 \\
            4 & Greater wild speech & Spell level (3) & Mystic knowledge            & Wild aspect                \\
            5 & Beast companion     & Spell level (4) & Greater natural spells      & Greater shifting defense   \\
            6 & Beast tamer         & Spell level (5) & Mystic knowledge            & Greater shift body         \\
            7 & Supreme wild speech & Spell level (6) & Greater wellspring of power & Triple aspect, wild aspect \\
            8 & True companion      & Spell level (7) &                             & Avatar of nature           \\
        \end{dtabularx}
    \end{dtable!*}
...
\section{Paladin}\label{Paladin}
    \begin{dtable!*}
        ...
        \begin{dtabularx}{\textwidth}{c >{\lcol}X >{\lcol}X >{\lcol}X >{\lcol}X}
            ...
            3         & Paragon power         & Spell level (2)          & Stalwart resilience         & Zealous power              \\
            4         & Greater aligned aura  & Spell level (3)          & Greater lay on hands        & Greater smite              \\
            5         & Devoted mind          & Spell level (4)          & Greater stalwart champion   & Greater zealous conviction \\
            6         & Greater paragon power & Spell level (5)          & Greater stalwart resilience & Greater zealous power      \\
            7         & Supreme aligned aura  & Spell level (6)          & Supreme lay on hands        & Supreme smite              \\
            8         & Aligned soul          & Spell level (7)          &                             &                            \\
        \end{dtabularx}
    \end{dtable!*}
...
\section{Warlock}\label{Warlock}
    \begin{dtable!*}
        ...
        \begin{dtabularx}{\textwidth}{c >{\lcol}X >{\lcol}X >{\lcol}X >{\lcol}X}
            ...
            3 & Abyssal jaunt                & Spell level (2)        & Wellspring of power         & Influence possession        \\
            4 & Abyssal substitution         & Spell level (3), spell & Spell knowledge             & Exchange soul fragment      \\
            5 & Greater fiendish resistance  & Spell level (4)        & Greater armor tolerance     & Powerful possession         \\
            6 & Abyssal curse                & Spell level (5)        & Spell knowledge             & Greater empowering whispers \\
            7 & Greater abyssal substitution & Spell level (6), spell & Greater wellspring of power & Control possession          \\
            8 &                              & Spell level (7)        &                             &                             \\
        \end{dtabularx}
    \end{dtable!*}
