...
\section{Barbarian}\label{Barbarian}
    ...
    \subsection{Primal Warrior}
        ...
        As a standard action, you can spend an \glossterm{action point} to use a \textit{primal exertion} ability.
        {
            ...
            \begin{ability}{Demoralizing Shout}[\glossterm{Mind}]
                ...
                At 12th level, the area increases to an \areahuge radius.
            ...
            \begin{ability}{Ground Pound}
                ...
                At 18th level, the area increases to an \arealarge radius burst.
            \end{ability}
    ...
    \subsection{Battleforged Resilience}
        ...
        \cf{Bbn}[5]{Agile Defense} You gain a \plus1 bonus to Armor defense while not \glossterm{encumbered}.
        ...
        The defense bonus from your \textit{agile defense} ability applies even if you are \glossterm{encumbered}.
        It increases to \plus2 while you are not encumbered.
...
\section{Cleric}\label{Cleric}
    ...
    \subsection{Cleric Domain Abilities}\label{Cleric Domain Abilities}
        ...
        \subsubsection{Destruction}
            \parhead{Gift} You gain the \textit{power attack} ability, as the fighter \textit{martial exertion} (see Martial Exertion, \pref{Ftr:Martial Exertion}).
...
\section{Fighter}\label{Fighter}
    \begin{dtable}
        ...
        \begin{dtabularx}{\columnwidth}{>{\ccol}p{\levelcol} >{\lcol}X}
            \tb{Level} & \tb{Abilities} \\\bottomrule
            \nth{1}     & Armor expertise, discipline, martial exertion
            \\ \nth{2}  & Weapon focus
            \\ \nth{3}  & Martial training
            \\ \nth{4}  & Disciplined defense
            \\ \nth{5}  & Greater armor expertise
            \\ \nth{6}  & Martial exertion
            \\ \nth{7}  & Greater discipline
            \\ \nth{8}  & Weapon master
            \\ \nth{9}  & Martial training
            \\ \nth{10} & Rapid warrior
            \\ \nth{11} & Supreme armor expertise
            \\ \nth{12} & Martial exertion
            \\ \nth{13} & Supreme discipline
    ...
    \subsection{Martial Mastery}
        ...
        As a standard action, you can spend an \glossterm{action point} to use a \textit{martial exertion} ability.
        {
            ...
            \begin{ability}{Challenge}[\glossterm{Mind}]
                ...
                \hit As a \glossterm{condition}, the target suffers a \minus3 penalty to accuracy on all attacks that do not include you as a target.
        ...
        \cf{Ftr}[3]{Martial Training} You gain two additional skill points that must be spent on fighter \glossterm{class skills}.

        \cf*{Ftr}[6]{Martial Exertion}
        You learn an additional \textit{martial exertion}.

        \cf*{Ftr}[9]{Martial Training} You gain two additional skill points that must be spent on fighter \glossterm{class skills}.
    ...
    \subsection{Equipment Training}
        ...
        In addition, you reduce the \glossterm{encumbrance penalty} of body armor you wear by 1.
        ...
        The \glossterm{encumbrance penalty} reduction from your \textit{armor expertise} ability increases to 2.
        ...
        The \glossterm{encumbrance penalty} reduction from your \textit{armor expertise} ability increases to 3.
    ...
    \subsection{Combat Discipline}
        ...
        \cf{Ftr}{Discipline} You gain the \textit{discipline} ability.
        \begin{ability}{Discipline}
            As a \glossterm{minor action}, you can spend an \glossterm{action point} to use this ability.
            If you do, remove one \glossterm{condition} affecting you.
        \end{ability}

        \cf{Ftr}[4]{Disciplined Defense}
        You gain a \plus1 bonus to Armor defense.

        \cf{Ftr}[7]{Greater Discipline}
        Your \textit{discipline} ability gains the \glossterm{Swift} tag, allowing it to resolve before other actions in the same phase.
        This means that if you remove a condition with that ability, the penalties from the condition do not affect your attacks or defenses during the same phase.
        ...
        \cf{Ftr}[13]{Supreme Discipline}
        When you use the \textit{discipline} ability, you can remove an additional condition.
...
\section{Mage}\label{Mage}
    ...
    \subsection{Basic Class Abilities}
        ...
        \begin{itemize}
            ...
            \item \subparhead{Perception} Awareness, Deduction, Spellcraft.
            \item \subparhead{Other} Bluff, Intimidate, Persuasion, Profession.
        \end{itemize}
    ...
    \subsection{Arcane Lore}
        ...
        \subparhead{Wizard} You gain two additional skill points that must be spent on Knowledge skills.
...
\section{Paladin}\label{Paladin}
    \begin{dtable}
        ...
        \begin{dtabularx}{\columnwidth}{>{\ccol}p{\levelcol} c >{\lcol}X}
            ...
            \\ \nth{18} & 3 & Augment, stalwart champion
    ...
    \subsection{Basic Class Abilities}
        ...
        \begin{itemize}
            ...
            \item \subparhead{Perception} Awareness, Deduction, Intimidate, Sense Motive.
            \item \subparhead{Other} Bluff, Intimidate, Persuasion, Profession.
        \end{itemize}
...
\section{Ranger}\label{Ranger}
    ...
    \subsection{Master of the Hunt}
        ...
        \cf{Rgr}{Quarry}\label{Quarry} You gain the \textit{quarry} ability.
...
\section{Rogue}\label{Rogue}
    ...
    \subsection{Basic Class Abilities}
        ...
        \begin{itemize}
            \item \subparhead{Strength} Climb, Jump, Swim.
            \item \subparhead{Dexterity} Acrobatics, Deduction, Escape Artist, Sleight of Hand, Stealth.
    ...
    \subsection{Assassin}
        ...
        \cf{Rog}[2]{Assassinate} You gain the \textit{assassinate} ability.
        ...
        \cf{Rog}[5]{Stealth Lore} You gain two extra skill points which must be spent on rogue \glossterm{class skills}.

        \cf*{Rog}[8]{Darkstalker} You gain the \textit{darkstalker} ability.
...
\section{Warlock}\label{Warlock}
    ...
    \subsection{Blessings of the Abyss}
        ...
        \cf{War}[3]{Armor Tolerance} You reduce your \glossterm{encumbrance penalty} from armor by 2 when determining your \glossterm{arcane spell failure}.

        \cf{War}[5]{Abyssal Lore} You gain two additional skill points that must be spent on warlock class skills.
