    ...
    \subsection{Basic Class Abilities}
        ...
        \subsection{Martial Mastery}
            ...
            As a standard action, you can spend an \glossterm{action point} to use a \textit{martial exertion} ability.
            {
                ...
                At 9th level, a \glossterm{critical hit} against the target's Fortitude defense makes it \nauseated instead of \sickened.
                \par At 15th level, any hit against the target's Fortitude defense makes it \nauseated instead of \sickened.
