...
\section{Barbarian}\label{Barbarian}
    \begin{dtable}
        ...
        \begin{dtabularx}{\columnwidth}{>{\ccol}p{\levelcol} >{\ccol}p{\babcolgood} c >{\lcol}X}
            ...
            \barbarianprogressionrow{11} & \plus4 & Larger than belief     \\
            \barbarianprogressionrow{12} & \plus4 & Titanic resilience     \\
            \barbarianprogressionrow{13} & \plus4 & Fury of the storm      \\
            ...
            \barbarianprogressionrow{17} & \plus5 & Titan of battle        \\
            \barbarianprogressionrow{18} & \plus5 & Deathless rage         \\
            \barbarianprogressionrow{19} & \plus5 & Endless rage           \\
