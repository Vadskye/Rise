    ...
    \subsection{Wildspeaker}\label{Wildspeaker}
        ...
        \begin{attuneability}{Natural Servant}[\glossterm{Attune} (self), \glossterm{Magical}]
            ...
            \begin{itemize}
                ...
                \item Its \glossterm{hit points} are equal to the base value for your level (see \tref{Base Hit Points and Resistances}).
                \item Its \glossterm{resistances} are equal to the base value for your level (see \pcref{Base Hit Points and Resistances}).
    ...
    \subsection{Beastmaster}
        ...
        \begin{attuneability}{Animal Companion}[\glossterm{Attune} (self), \glossterm{Emotion}, \glossterm{Magical}]
            ...
            \begin{itemize}
                ...
                \item Its \glossterm{fatigue tolerance} is 1.
                \item Its \glossterm{hit points} are equal to your Constitution \add the base value for your level (see \tref{Base Hit Points and Resistances}).
                \item Its \glossterm{resistance} to \glossterm{physical damage} is equal to your Constitution \add the base value for your level (see \tref{Base Hit Points and Resistances}).
