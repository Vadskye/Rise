    ...
    \subsection{Cleric Domain Abilities}\label{Cleric Domain Abilities}
        ...
        \subsubsection{Air}
            ...
            \begin{attuneability}{Speak with Air}[\glossterm{Attune} (self)]
                You can speak with and command air within a \arealarge \glossterm{zone} from your location.
        ...
        \subsubsection{Destruction}
            ...
            \begin{freeability}{Lay Waste}
                You make an attack vs. Fortitude against all unattended objects in a \areasmall radius.
        ...
        \subsubsection{Earth}
            ...
            \begin{attuneability}{Speak with Earth}[\glossterm{Attune} (self)]
                You can speak with earth within a \arealarge \glossterm{zone} from your location.
        ...
        \subsubsection{Fire}
            ...
            \begin{attuneability}{Speak with Fire}[\glossterm{Attune} (self)]
                You can speak with and command fire within a \arealarge radius \glossterm{zone} from your location.
        ...
        \subsubsection{Good}
            ...
            \parhead{Aspect} This domain's domain gift affects any \glossterm{ally} within a \areasmall radius \glossterm{emanation} from you.
            ...
            \begin{freeability}{Compel Good}[\glossterm{Compulsion}]
                ...
                You gain a \plus1 bonus to \glossterm{accuracy} with the attack for each rank beyond 4.
            \end{freeability}
            \parhead{Mastery} Once per round, when an \glossterm{ally} within a \arealarge radius \glossterm{emanation} from you loses one or more \glossterm{hit points}, you may lose a single hit point instead.
        ...
        \subsubsection{Knowledge}
            ...
            \begin{freeability}{Share Knowledge}
                ...
                You and your \glossterm{allies} within a \areamed radius learn the results of your check.
        ...
        \subsubsection{Law}
            ...
            \begin{freeability}{Compel Law}[\glossterm{Compulsion}]
                Make an attack vs. Mental against all creatures within a \areamed radius.
        ...
        \subsubsection{Water}
            ...
            \begin{attuneability}{Speak with Water}[\glossterm{Attune} (self)]
                You can speak with and command water within a \arealarge \glossterm{zone} from your location.
...
\end{dtabularx}
    ...
    \subsection{Elementalist}\label{Elementalist}
        ...
        \begin{freeability}{Elemental Influence}[\glossterm{Sustain} (standard)]
            You can speak with air, earth, fire, and water within a \arealarge \glossterm{zone} from your location.
    ...
    \subsection{Shifter}\label{Shifter}
...

        {
            ...
            \begin{freeability}{Plantspeaker}
                ...
                \rank{5} The movement penalties from \glossterm{undergrowth} are doubled for enemies within a \arealarge radius emanation from you.
    ...
    \subsection{Wildspeaker}\label{Wildspeaker}
        ...
        \cf{Drd}[3]{Greater Nature's Ally}[Magical] Your \glossterm{allies} within a \areamed radius \glossterm{emanation} from you also gain the benefit of your \textit{nature's ally} ability.
...
\end{dtabularx}
    ...
    \subsection{Tactician}
        ...
        Your \textit{battle tactics} affect your \glossterm{allies} within a \arealarge radius \glossterm{emanation} from you who can either see or hear you.
...
\end{dtabularx}
    ...
    \subsection{Devoted Paragon}
        ...
        You constantly radiate an aura in a \areasmall radius \glossterm{emanation} from you.
    ...
    \subsection{Bard}
        ...
        However, targets do not stop being affected by your performance simply by travelling beyond the initial range of the bardic performance ability.
        {
            ...
            \begin{freeability}{Mesmerizing Melody}[\glossterm{Auditory}, \glossterm{Emotion}, \glossterm{Sustain} (minor)]
                \targets{All creatures in a \areamed radius from you}
            ...
            \begin{freeability}{Serenade of Serenity}[\glossterm{Auditory}, \glossterm{Emotion}, \glossterm{Sustain} (minor)]
                \targets{All \glossterm{allies} within a \areamed radius \glossterm{emanation} from you}
