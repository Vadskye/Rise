...
\section{Rogue}\label{Rogue}
    ...
    \subsection{Class Abilities}
        ...
        When performing a \glossterm{maneuver} against an \overwhelmed or \unaware creature, the rogue gains a bonus to accuracy equal to the number of sneak attack dice she would roll.
