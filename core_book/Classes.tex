...
\section{Barbarian}\label{Barbarian}
    ...
    \subsection{Class Abilities}
        ...
        \end{itemize}
        You gain six \glossterm{skill points} which can only be spent on those class skills.
    ...
    \subsection{Primal Warrior}
        ...
        As a standard action, you can spend an \glossterm{action point} to use a \textit{primal exertion} ability.
        {
            ...
            At 15th level, any hit against a target means it is \frightened by you instead of shaken, and a \glossterm{critical hit} against a target means it is \panicked by you instead of frightened.
            ...
            At 15th level, the accuracy bonus increases to \plus4.
            ...
            At 15th level, the accuracy bonus increases to \plus2.
        }
        ...
        As a standard action, you can spend an \glossterm{action point} to use a \textit{primal exertion} ability.
        {
            ...
            At 15th level, the accuracy bonus increases to \plus3.
    ...
    \subsection{Class Abilities}
        ...
        \subsection{Martial Mastery}
            ...
            As a standard action, you can spend an \glossterm{action point} to use a \textit{martial exertion} ability.
            {
                ...
                At 15th level, the penalty is increased to \minus5 for any hit, and a \glossterm{critical hit} increases the penalty to \minus10.
                ...
                At 15th level, the penalties are increased to \minus5 for any hit, and a \glossterm{critical hit} increases the penalties to \minus10.
            ...
            As a standard action, you can spend an \glossterm{action point} to use a \textit{martial exertion} ability.
            {
                ...
                At 15th level, you regain the action point spent if the attack hits without being a \glossterm{critical hit}.
