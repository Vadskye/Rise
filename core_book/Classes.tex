        ...
        \begin{attuneability}{Rage}[\glossterm{Emotion}, \glossterm{Sustain} (free), \glossterm{Swift}]
            ...
            \begin{itemize}
                ...
                \item Your current \glossterm{hit points} and maximum hit points are reduced to 0.
                    This hit point loss does not cause you to gain a \glossterm{vital wound}, and you are always considered to be at your maximum hit points.
...
\begin{dtabularx}{\textwidth}{l l >{\lcol}X >{\lcol}X >{\lcol}X >{\lcol}X}
    ...
    0 & \tdash & Cantrips                        & Mystic sphere               & Domains, domain gift & Healer's wisdom         \\
...
\begin{dtabularx}{\textwidth}{l l >{\lcol}X >{\lcol}X l >{\lcol}X >{\lcol}X}
    ...
    0 & \tdash & Elemental lore            & Cantrips                        & Mystic sphere               & Shifting defense                                   & Nature's ally           \\
...
\end{dtabularx}
    ...
    \subsection{Elementalist}\label{Elementalist}
        ...
        \cf{Drd}[6]{Greater Elemental Versatility} You learn an additional spell with your \textit{elemental versatility} ability.
