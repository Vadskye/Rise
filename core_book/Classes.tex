...
\section{Cleric}\label{Cleric}
    \begin{dtable!*}
        ...
        \begin{dtabularx}{\textwidth}{c >{\lcol}X >{\lcol}X >{\lcol}X >{\lcol}X}
            ...
            \\ 4 & Spell level (3), spell & Mystic knowledge            & Domain aspect  & Greater divine healing
            \\ 5 & Spell level (4)        & Augment                     & Domain essence & Greater vital healer
            \\ 6 & Spell level (5), spell & Greater wellspring of magic & Domain essence & Greater divine cleanse
...
\section{Druid}\label{Druid}
    \begin{dtable!*}
        ...
        \begin{dtabularx}{\textwidth}{c >{\lcol}X >{\lcol}X >{\lcol}X >{\lcol}X}
            ...
            \\ 4 & Spell level (3), spell & Mystic knowledge            & Wild aspect       & Greater wild speech
            \\ 5 & Spell level (4)        & Augment                     & Nature's champion & Beast companion
            \\ 6 & Spell level (5), spell & Greater wellspring of magic & Wild aspect       & Beast tamer
...
\section{Mage}\label{Mage}
    ...
    \subsection{Arcane Spell Mastery}
        ...
        You gain your choice of one of the following abilities.
        {
            \parhead{Insight} You learn an additional arcane \glossterm{spell} (see \pcref{Arcane Mystic Spheres}).
                You can choose this ability multiple times, gaining access to an additional spell each time.
...
\section{Paladin}\label{Paladin}
    \begin{dtable!*}
        ...
        \begin{dtabularx}{\textwidth}{c >{\lcol}X >{\lcol}X >{\lcol}X >{\lcol}X}
            ...
            \\ 4 & Greater aligned resistance & Spell level (3), spell & Greater smite                                   & Greater lay on hands
            \\ 5 & Greater aligned aura       & Spell level (4)        & Greater recovering smite, greater zealous power & Greater stalwart champion
            \\ 6 & Greater paragon power      & Spell level (5), spell & Supreme smite                                   & Greater stalwart resilience
...
\section{Rogue}\label{Rogue}
    ...
    \subsection{Combat Trickster}
        ...
        \cf{Rog}[3]{Tricky Lore} You gain two additional skill points.
...
\section{Warlock}\label{Warlock}
    ...
    \subsection{Pact Spellcasting}
        ...
        \cf{War}[2] For each \glossterm{mystic sphere} you have access to, you learn one 1st level spell from that \glossterm{mystic sphere}.
