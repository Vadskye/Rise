...
\section{Fighter}\label{Fighter}
    ...
    \subsection{Combat Discipline}
        ...
        \cf{Ftr}[10]{Disciplined Defense}
        You gain a \plus1 bonus to Armor defense.

        \cf{Ftr}[13]{Greater Disciplined Threat}
