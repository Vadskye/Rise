...
\section{Class Introductions}
    ...
    \subsection{Class Description Format}
        ...
        \parhead{Class Table}
        The class's table describes its base progression for combat prowess, Fortitude defense, Reflex defense, and Mental defense.
        For details about base progressions, see \pcref{Base Progressions}.
        ...
        \subsubsection{Base Class Abilities}
            ...
            These bonuses apply regardless of the attribute or base progression used to determine the defense, and are not included in the defense values given in the class table.
...
\section{Barbarian}
    ...
    \begin{dtable}
        ...
        \begin{dtabularx}{\columnwidth}{>{\ccol}p{\levelcol} >{\ccol}p{\babcolgood} *{3}{>{\ccol}p{\savecol}} >{\lcol}X}
            ...
            \barbarianprogressionrow{3}  & Fast movement, uncanny dodge        \\
            \barbarianprogressionrow{4}  & Durable                             \\
            \barbarianprogressionrow{5}  & Rage \plus3                         \\
            \barbarianprogressionrow{6}  & Rage feat                           \\
            \barbarianprogressionrow{7}  & Battle-scarred                      \\
            ...
            \barbarianprogressionrow{11} & Adaptive rage                        \\
            \barbarianprogressionrow{12} & Fury of the storm                   \\
            \barbarianprogressionrow{13} & Tireless rage                       \\
...
\section{Cleric}
    \begin{dtable}
        ...
        \begin{dtabularx}{\columnwidth}{>{\ccol}p{2em} >{\ccol}p{\babcolavg} *{3}{>{\ccol}p{\savecol}} >{\lcol}X}
            ...
            \clericprogressionrow{2}  & Domain invocation, rituals            \\
            \clericprogressionrow{3}  & Domain spell                          \\
            \clericprogressionrow{4}  & Domain invocation                     \\
            ...
            \clericprogressionrow{10} & Devotion \plus4, intercession         \\
            ...
            \clericprogressionrow{14} & Greater domain invocation             \\
            ...
            \clericprogressionrow{20} & Devotion \plus6, miracle              \\
        \end{dtabularx}
    \end{dtable}
...
\section{Fighter}
    ...
    \subsection{Class Abilities}
        ...
        If he improves his agility, he reduces his \glossterm{encumbrance penalty} by 2 and reduces his arcane spell failure by 5\% while wearing body armor.
        ...
        If he chose agility, he reduces his \glossterm{encumbrance penalty} by 4 and decreases his arcane spell failure by 15\%.
        ...
        If he chose agility, he reduces his \glossterm{encumbrance penalty} by 6 and decreases his arcane spell failure by 30\% while wearing armor of any kind.
...
\section{Monk}
    \begin{dtable}
        ...
        \begin{dtabularx}{\columnwidth}{>{\ccol}p{\levelcol} >{\ccol}p{\babcolavg} *{3}{>{\ccol}p{\savecol}} >{\lcol}X}
            \tb{Level} & \tb{Combat Prowess} & \tb{Fort} & \tb{Ref} & \tb{Ment} & \tb{Special} \\
            \hline
            \monkprogressionrow{1}  & Enlightened defenses, \ki strike \plus1, unarmed warrior \\
            \monkprogressionrow{2}  & Manifest \ki                                  \\
            \monkprogressionrow{3}  & Wholeness of mind and body, uncanny dodge    \\
            \monkprogressionrow{4}  & Manifest \ki, \ki strike \plus2               \\
            \monkprogressionrow{5}  & Flurry of blows                              \\
            \monkprogressionrow{6}  & Manifest \ki                                  \\
            \monkprogressionrow{7}  & \Ki strike \plus3, perfect motion            \\
            \monkprogressionrow{8}  & Manifest \ki                                  \\
            \monkprogressionrow{9}  & Improved uncanny dodge, perfect soul         \\
            \monkprogressionrow{10} & Manifest \ki, \ki strike \plus4               \\
            \monkprogressionrow{11} & Flow of life                                 \\
            \monkprogressionrow{12} & Manifest \ki                                  \\
            \monkprogressionrow{13} & Perfect mind, \ki strike \plus5              \\
            \monkprogressionrow{14} & Manifest \ki                                  \\
            \monkprogressionrow{15} & Perfect body                                 \\
            \monkprogressionrow{16} & Manifest \ki, \ki strike \plus6               \\
            \monkprogressionrow{17} & Perfect life                                 \\
            \monkprogressionrow{18} & Manifest \ki                                  \\
            \monkprogressionrow{19} & \Ki strike \plus7, true perfection           \\
            \monkprogressionrow{20} & Manifest \ki, transcend mortality             \\
        \end{dtabularx}
    \end{dtable}
    ...
    \subsection{Class Abilities}
        ...
        \subcf{Balance on the Thinnest Reed}
        As a swift action, the monk can gain a \plus20 bonus to Balance checks until the end of the round.
        \subcf{Channel Energy}
        As an immediate action, when the monk would take \glossterm{energy} damage, she can gain damage reduction against any single type of energy damage equal to twice her \ki power until the end of the round.
        ...
        \cf{Mnk}[3rd]{Wholeness of Mind and Body}
...
\section{Ranger}
    ...
    \begin{dtable}
        ...
        \begin{dtabularx}{\columnwidth}{>{\ccol}p{\levelcol} >{\ccol}p{\babcolgood} *{3}{>{\ccol}p{\savecol}} >{\lcol}X}
            \tb{Level} & \tb{Combat Prowess} & \tb{Fort} & \tb{Ref} & \tb{Ment} & \tb{Special} \\
            \hline
            \rangerprogressionrow{1}  & Quarry \plus2, tenacious hunter, wild speech \\
            \rangerprogressionrow{2}  & Hunting lore, tracker                        \\
            \rangerprogressionrow{3}  & Free stride, keen vision                     \\
            \rangerprogressionrow{4}  & Terrain lore                                 \\
            \rangerprogressionrow{5}  & Quarry \plus3, rapid tracker                 \\
            \rangerprogressionrow{6}  & Hunting lore                                 \\
            \rangerprogressionrow{7}  & Blindsense                                   \\
            \rangerprogressionrow{8}  & Terrain lore                                 \\
            \rangerprogressionrow{9}  & Perfect stride                               \\
            \rangerprogressionrow{10} & Hunting lore, quarry \plus4                  \\
            \rangerprogressionrow{11} & Blindsight                                   \\
            \rangerprogressionrow{12} & Terrain lore                                 \\
            \rangerprogressionrow{13} & Unerring hunter                              \\
            \rangerprogressionrow{14} & Hunting lore                                 \\
            \rangerprogressionrow{15} & Farsight, quarry \plus5                      \\
            \rangerprogressionrow{16} & Terrain lore                                 \\
            \rangerprogressionrow{17} & Eternal quarry                               \\
            \rangerprogressionrow{18} & Hunting lore                                 \\
            \rangerprogressionrow{19} & Truesight                                    \\
            \rangerprogressionrow{20} & Quarry \plus6, terrain lore
        \end{dtabularx}
    \end{dtable}
    ...
    \subsection{Class Abilities}
        ...
        The ranger gains a \plus8 bonus to Maneuver defense against attacks that would move him.  % weird bonus
...
\section{Rogue}
    ...
    \begin{dtable}
        ...
        \begin{dtabularx}{\columnwidth}{>{\ccol}p{\levelcol} >{\ccol}p{\babcolgood} *{3}{>{\ccol}p{\savecol}} >{\lcol}X}
            ...
            \rogueprogressionrow{7}  & Sneak attack \plus4d6, improved uncanny dodge  \\
            ...
            \rogueprogressionrow{11} & Sneak attack \plus6d6, slippery mind  \\
            ...
            \rogueprogressionrow{19} & Ambush master, sneak attack \plus10d6 \\
            \rogueprogressionrow{20} & Combat trick            \\
        \end{dtabularx}
    \end{dtable}
    ...
    \subsection{Class Abilities}
        ...
        This is an ambush attack, and only works once per creature.
        In addition, it is a \glossterm{Death} effect.
...
\section{Sorcerer}
    \begin{dtable}
        ...
        \begin{dtabularx}{\columnwidth}{>{\ccol}p{\levelcol} >{\ccol}p{\babcolpoor} *{3}{>{\ccol}p{\savecol}} >{\lcol}X}
            ...
            \sorcererprogressionrow{2}  & Cantrip, personal spell     \\
            \sorcererprogressionrow{3}  & Innate magic                \\
            \sorcererprogressionrow{4}  & Personal spell              \\
            \sorcererprogressionrow{5}  & Focused casting             \\
            \sorcererprogressionrow{6}  & Personal spell              \\
            \sorcererprogressionrow{7}  & Innate magic                \\
            \sorcererprogressionrow{8}  & Personal spell              \\
            \sorcererprogressionrow{9}  & Spell resistance            \\
            \sorcererprogressionrow{10} & Personal spell              \\
            \sorcererprogressionrow{11} & Innate magic                \\
            \sorcererprogressionrow{12} & Personal spell              \\
            \sorcererprogressionrow{13} & Spontaneous personalization \\
            \sorcererprogressionrow{14} & Personal spell              \\
            \sorcererprogressionrow{15} & Innate magic                \\
            \sorcererprogressionrow{16} & Personal spell              \\
            \sorcererprogressionrow{17} & Spell absorption            \\
            \sorcererprogressionrow{18} & Personal spell              \\
            \sorcererprogressionrow{19} & Innate magic                \\
            \sorcererprogressionrow{20} & Personal spell              \\
        \end{dtabularx}
    \end{dtable}
    ...
    \subsection{Class Abilities}
        ...
        The sorcerer gains \glossterm{spell resistance} equal to 10 \add his sorcerer level or Constitution, whichever is higher.
    ...
    \subsection{Variant Sorcerer}
        ...
        \subsubsection{Warlock}
            ...
            The DR of the roll is equal to 10 \add 1 per two warlock levels.
...
\section{Spellwarped}
    ...
    \subsection{Invocations}\label{Invocations}
        ...
        \subsubsection{Alteration Invocations}
            ...
            He gains a \plus20 bonus to Maneuver defense against grapple attacks, is immune to critical hits, and can move through spaces that are no more than two inches in width without \glossterm{squeezing}.
...
\section{Wizard}
    ...
    \begin{dtable}
        ...
        \begin{dtabularx}{\columnwidth}{>{\ccol}p{\levelcol} >{\ccol}p{\babcolpoor} *{3}{>{\ccol}p{\savecol}} >{\lcol}X}
            ...
            \wizardprogressionrow{2}  & Arcane insight, cantrip           \\
            \wizardprogressionrow{3}  & Attuned spell                     \\
            \wizardprogressionrow{4}  & Arcane insight                    \\
            \wizardprogressionrow{5}  & Ritual master                     \\
            \wizardprogressionrow{6}  & Arcane insight                    \\
            \wizardprogressionrow{7}  & Attuned spell                     \\
            \wizardprogressionrow{8}  & Arcane insight                    \\
            \wizardprogressionrow{9}  & Persistent attunement             \\
            \wizardprogressionrow{10} & Arcane insight                    \\
            \wizardprogressionrow{11} & Attuned spell                     \\
            \wizardprogressionrow{12} & Arcane insight                    \\
            \wizardprogressionrow{13} & Contingency                       \\
            \wizardprogressionrow{14} & Arcane insight                    \\
            \wizardprogressionrow{15} & Attuned spell                     \\
            \wizardprogressionrow{16} & Arcane insight                    \\
            \wizardprogressionrow{17} & Augmented attunement              \\
            \wizardprogressionrow{18} & Arcane insight                    \\
            \wizardprogressionrow{19} & Attuned spell                     \\
            \wizardprogressionrow{20} & Arcane insight, chain contingency \\
        \end{dtabularx}
    \end{dtable}
...
\section{Character Advancement}\label{Character Advancement}
    ...
    \begin{dtable}
        ...
        \begin{dtabularx}{\columnwidth}{*{4}{>{\lcol}l} >{\lcol}X}
            ...
            \hline
            1st  & 0         & 1st  & \tdash              & \tdash  \\
            2nd  & 2,000     & \tdash   & \plus1 to two   & \tdash  \\
            3rd  & 5,000     & 2nd  & \plus1 to two   & \tdash  \\
            4th  & 9,000     & \tdash   & \plus1 to two   & 1st \\
            5th  & 15,000    & 3rd  & All gain \plus1 & \tdash  \\
            6th  & 23,000    & \tdash   & \plus1 to two   & \tdash  \\
            7th  & 35,000    & 4th  & \plus1 to two   & \tdash  \\
            8th  & 51,000    & \tdash   & \plus1 to two   & 2nd \\
            9th  & 75,000    & 5th  & \plus1 to two   & \tdash  \\
            10th & 105,000   & \tdash   & All gain \plus1 & \tdash  \\
            11th & 155,000   & 6th  & \plus1 to two   & \tdash  \\
            12th & 220,000   & \tdash   & \plus1 to two   & 3rd \\
            13th & 315,000   & 7th  & \plus1 to two   & \tdash  \\
            14th & 445,000   & \tdash   & \plus1 to two   & \tdash  \\
            15th & 635,000   & 8th  & All gain \plus1 & \tdash  \\
            16th & 890,000   & \tdash   & \plus1 to two   & 4th \\
            17th & 1,300,000 & 9th  & \plus1 to two   & \tdash  \\
            18th & 1,800,000 & \tdash   & \plus1 to two   & \tdash  \\
            19th & 2,550,000 & 10th & \plus1 to two   & \tdash  \\
            20th & 3,600,000 & \tdash   & All gain \plus1 & 5th \\
        \end{dtabularx}
    \end{dtable}
...
\section{Multiclass Characters}\label{Multiclass Characters}
    ...
    \subsection{Class And Level Features}
        ...
        \parhead{Defenses}
        For each defense, add the base defense bonuses granted by each class, as given on the class's chart, together.
