...
\section{Warlock}\label{Warlock}
    ...
    \subsection{Blessings of the Abyss}
        ...
        \cf{War}[4]{Abyssal Substitution} Whenever you use a \glossterm{magical} ability that deals \glossterm{energy damage} or any subtype of \glossterm{energy damage}, you may change the type of damage it deals to be untyped.
        ...
        \cf{War}[7]{Greater Abyssal Substitution} Whenever you use an ability that deals damage, you may change the type of damage it deals to be untyped.
        Any other aspects of the ability remain unchanged.
