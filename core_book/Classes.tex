...
\end{dtabularx}
    ...
    \subsection{Battlerager}\label{Rage}
        ...
        \cf{Bbn}[4]{Greater Rage} You also gain a \plus1 bonus to \glossterm{accuracy} during your \textit{rage} ability.
...
\begin{dtabularx}{\textwidth}{l l >{\lcol}X >{\lcol}X >{\lcol}X >{\lcol}X}
    ...
    4 & 10     & Spell rank (4), spell knowledge      & Mystic insight              & Domain essence       & Greater healer's wisdom, greater restoration \\
    ...
    7 & 19     & Spell rank (7), spell knowledge & Greater wellspring of power & Domain masteries     & Healing versatility, supreme restoration     \\
\end{dtabularx}
    \end{dtable!*}
...
\begin{dtabularx}{\textwidth}{l l >{\lcol}X >{\lcol}X l >{\lcol}X >{\lcol}X}
    ...
    3 & 7      & Elemental influence       & Spell rank (3)                  & Wellspring of power         & Greater shifting defense, glancing natural strikes & Greater nature's ally   \\
    ...
    6 & 16     & Elemental control         & Spell rank (6)                  & Mystic insight              & Supreme shifting defense                           & Supreme nature's ally   \\
...
\end{dtabularx}
    ...
    \subsection{Tactician}
        ...
        Your \textit{battle tactics} affect your \glossterm{allies} within a \areahuge radius \glossterm{emanation} from you who can either see or hear you.
...

        {
            ...
            \begin{freeability}{Hold The Line}[\glossterm{Sustain} (free)]
                Your \glossterm{enemies} treat all areas \glossterm{threatened} by at least two targets as \glossterm{difficult terrain}.

                \rankline
                \rank{3} This ability affects areas threatened by each target rather than areas threatened by at least two targets.
                \rank{5} Each area threatened by at least two targets is doubly difficult terrain, and costs quadruple the normal movement cost to move out of.
                \rank{7} Each area threatened by each target is doubly difficult terrain.
            \end{freeability}
...
\section{Monk}\label{Monk}
    \begin{dtable!*}
        ...
        \begin{dtabularx}{\textwidth}{l l >{\lcol}X >{\lcol}X >{\lcol}X >{\lcol}X}
            ...
            0 & \tdash  & Esoteric maneuvers                           & Ki barrier, ki manifestations        & Fast movement, unarmed warrior & Clear the mind                \\
            1 & 1  & Maneuver rank (2), esoteric maneuver         & Ki strike                            & Perfect body                   & Transcend frailty             \\
            2 & 4  & Maneuver rank (3), esoteric lore             & Ki power                             & Perfect precision              & Inner peace                   \\
            3 & 7  & Maneuver rank (4), esoteric fluidity         & Greater ki barrier, ki manifestation & Greater fast movement          & Feel the flow of life         \\
            4 & 10 & Maneuver rank (5), esoteric maneuver         & Ki focus                             & Greater perfect body           & Transcend flesh               \\
            5 & 13 & Maneuver rank (6), esoteric agility          & Greater ki power                     & Greater perfect precision      & Greater inner peace           \\
            6 & 16 & Maneuver rank (7), greater esoteric fluidity & Supreme ki barrier, ki manifestation & Supreme fast movement          & Greater feel the flow of life \\
            7 & 19 & Maneuver rank (8), esoteric supremacy        & Epic ki                              & Perfection                     & Transcendence                 \\
        \end{dtabularx}
    \end{dtable!*}
...
\section{Paladin}\label{Paladin}
    \begin{dtable!*}
        ...
        \begin{dtabularx}{\textwidth}{l l >{\lcol}X >{\lcol}X >{\lcol}X >{\lcol}X >{\lcol}X}
            ...
            0         & \tdash         & Aligned aura          & Cantrips                             & Insight point               & Lay on hands                & Smite                    \\
            1         & 1              & Aligned immunity      & Spellcasting                         & Combat caster               & Enduring defender           & Zealous offense          \\
            2         & 4              & Paragon power         & Spell rank (2)                       & Wellspring of power         & Stalwart resilience         & Zealous purge            \\
            3         & 7              & Greater aligned aura  & Spell rank (3)                       & Insight point               & Defender's boon             & Zealous fixation         \\
            4         & 10             & Devoted mind          & Spell rank (4), spell knowledge      & Greater combat caster       & Greater enduring defender   & Pass judgment            \\
            5         & 13             & Greater paragon power & Spell rank (5)                       & Greater wellspring of power & Greater stalwart resilience & Greater zealous offense  \\
            6         & 16             & Supreme aligned aura  & Spell rank (6)                       & Insight point               & Greater defender's boon     & Greater zealous fixation \\
            7         & 19             & Epic paragon          & Spell rank (7), spell knowledge & Epic divine expertise       & Epic guardian               & Epic zeal                \\
        \end{dtabularx}
    \end{dtable!*}
...
\section{Ranger}\label{Ranger}
    \begin{dtable!*}
        ...
        \begin{dtabularx}{\textwidth}{l l >{\lcol}X >{\lcol}X >{\lcol}X > {\lcol}X}
            ...
            0 & \tdash  & Animal companion         & Quarry                     & Keen vision               & Wild maneuvers                          \\
            1 & 1  & Handling lore            & Hunting style              & Farsight                  & Maneuver rank (2), wild maneuver        \\
            2 & 4  & Pack tactics             & Hunter's instincts         & Perceive weakness         & Maneuver rank (3), wild lore            \\
            3 & 7  & Greater animal companion & Endurance tracker          & Blindsight                & Maneuver rank (4), wild senses          \\
            4 & 10 & Greater handling lore    & Hunting style              & Greater farsight          & Maneuver rank (5), wild maneuver        \\
            5 & 13 & Greater pack tactics     & Greater hunter's instincts & Greater perceive weakness & Maneuver rank (6), wild agility         \\
            6 & 16 & Supreme animal companion & Greater endurance tracker  & Greater blindsight        & Maneuver rank (7), greater wild senses  \\
            7 & 19 & Twin companion           & Dual quarry                & Epic senses               & Maneuver rank (8), wilderness supremacy \\
        \end{dtabularx}
    \end{dtable!*}
...
\section{Rogue}\label{Rogue}
    \begin{dtable!*}
        ...
        \begin{dtabularx}{\textwidth}{l l >{\lcol}X >{\lcol}X >{\lcol}X >{\lcol}X}
            ...
            0 & \tdash  & Sneak attack                & Bardic performances    & Tricky manuevers                          & Skill lore              \\
            1 & 1  & Evasion                     & Bardic lore            & Maneuver rank (2), trick maneuver         & Dabbler                 \\
            2 & 4  & Darkstalker                 & Bardic combat training & Maneuver rank (3), tricky lore            & Versatile power         \\
            3 & 7  & Hide in plain sight         & Bardic performance     & Maneuver rank (4), tricky finesse         & Skill exemplar          \\
            4 & 10 & Greater evasion             & Dual performance       & Maneuver rank (5), trick maneuver         & Greater dabbler         \\
            5 & 13 & Assassination               & Loremaster             & Maneuver rank (6), tricky agility         & Greater versatile power \\
            6 & 16 & Greater hide in plain sight & Bardic performance     & Maneuver rank (7), greater tricky finesse & Greater skill exemplar  \\
            7 & 19 & Epic assassin               & Epic bardic            & Maneuver rank (8), epic trickster         & Master of all trades    \\
        \end{dtabularx}
    \end{dtable!*}
...
\section{Sorcerer}\label{Mage}
    \begin{dtable!*}
        ...
        \begin{dtabularx}{\textwidth}{l l >{\lcol}X >{\lcol}X >{\lcol}X >{\lcol}X >{\lcol}X}
            ...
            0 & \tdash & Cantrips                             & Mystic insight              & Draconic bloodline         & Innate magic               & Wildspell                                   \\
            1 & 1      & Spellcasting                         & Combat caster               & Draconic focus             & Mystic tolerance           & Chaotic miscast, wild soul                  \\
            2 & 4      & Spell rank (2)                       & Wellspring of power         & Draconic precision         & Innate enhancement         & Chaotic exertion                            \\
            3 & 7      & Spell rank (3)                       & Mystic insight              & Draconic hide              & Spell absorption           & Controlled chaos                            \\
            4 & 10     & Spell rank (4), spell knowledge      & Greater combat caster       & Draconic heart             & Greater mystic tolerance   & Greater chaotic miscast, greater wild  soul \\
            5 & 13     & Spell rank (5)                       & Greater wellspring of power & Greater draconic precision & Greater innate enhancement & Greater chaotic exertion                    \\
            6 & 16     & Spell rank (6)                       & Mystic insight              & Greater draconic hide      & Greater spell absorption   & Greater controlled chaos                    \\
            7 & 19     & Spell rank (7), spell knowledge & Epic arcane mastery         & Epic innate enhancement    & Epic wildspell             &                                             \\
        \end{dtabularx}
    \end{dtable!*}
...
\section{Warlock}\label{Warlock}
    \begin{dtable!*}
        ...
        \begin{dtabularx}{\textwidth}{l l >{\lcol}X >{\lcol}X >{\lcol}X >{\lcol}X}
            ...
            0 & \tdash & Eldritch blast               & Cantrips                                & Mystic insight              & Possession                  \\
            1 & 1      & Fiendish resistance          & Spellcasting                            & Combat caster               & Empowering whispers         \\
            2 & 4      & Abyssal jaunt                & Spell rank (2)                          & Wellspring of power         & Exchange soul fragment      \\
            3 & 7      & Abyssal substitution         & Spell rank (3)                      nce & Mystic insight              & Greater possession          \\
            4 & 10     & Greater fiendish resistance  & Spell rank (4), spell knowledge         & Greater combat caster       & Greater empowering whispers \\
            5 & 13     & Abyssal curse                & Spell rank (5)                          & Greater wellspring of power & Exchange vitality           \\
            6 & 16     & Greater abyssal substitution & Spell rank (6)                      nce & Mystic insight              & Supreme possession          \\
            7 & 19     & Abyssal apotheosis           & Spell rank (7), spell knowledge    & Epic pact mastery           & Epic possession             \\
        \end{dtabularx}
    \end{dtable!*}
...
\section{Wizard}\label{Wizard}
    \begin{dtable!*}
        ...
        \begin{dtabularx}{\textwidth}{l l >{\lcol}X >{\lcol}X >{\lcol}X >{\lcol}X}
            ...
            0 & \tdash & Portable workshop            & Cantrips                             & Scholastic lore       & Mystic insight              \\
            1 & 1      & Alchemical infusion          & Spellcasting                         & Ritualist             & Insightful caster           \\
            2 & 4      & Alchemical discovery         & Spell rank (2)                       & Scholastic insight    & Wellspring of power         \\
            3 & 7      & Alchemical expertise         & Spell rank (3)                       & Ritual expertise      & Mystic insight              \\
            4 & 10     & Experienced quaffing         & Spell rank (4), spell knowledge      & Contingency           & Greater insightful caster   \\
            5 & 13     & Alchemical discovery         & Spell rank (5)                       & Scholastic insight    & Greater wellspring of power \\
            6 & 16     & Greater alchemical expertise & Spell rank (6)                       & Malleable contingency & Mystic insight              \\
            7 & 19     & Epic alchemy                 & Spell rank (7), spell knowledge & Multiple contingency  & Epic arcane mastery         \\
        \end{dtabularx}
    \end{dtable!*}
