...
\section{Cleric}\label{Cleric}
    \begin{dtable!*}
        ...
        \begin{dtabularx}{\textwidth}{c >{\lcol}X >{\lcol}X >{\lcol}X >{\lcol}X}
            ...
            4 & Spell rank (4) & Mystic insight            & Domain aspect         & Greater divine healing \\
            ...
            7 & Spell rank (7) & Mystic insight            & Miracle               & Supreme divine healing \\
...
\section{Druid}\label{Druid}
    \begin{dtable!*}
        ...
        \begin{dtabularx}{\textwidth}{c >{\lcol}X >{\lcol}X >{\lcol}X >{\lcol}X >{\lcol}X}
            ...
            4 & Greater elemental balance & Spell rank (4) & Mystic insight            & Wild aspect                & Greater natural servant \\
            ...
            7 & Supreme elemental balance & Spell rank (7) & Mystic insight            & Triple aspect, wild aspect & Supreme natural servant \\
...
\section{Fighter}\label{Fighter}
    ...
    \subsection{Martial Maneuver Mastery}
        This archetypes improves your martial \glossterm{maneuvers}.
        You must have the Martial Warrior barbarian archetype to gain the abilities from this archetype.

        \cf{Ftr}[1]{Martial Insight} You gain your choice of one of the following abilities.
        {
            \parhead{Maneuver Known} You learn an additional martial \glossterm{maneuver} (see \pcref{Martial Maneuvers}).
                You can choose this ability multiple times, learning an additional maneuver each time.
            \parhead{Manuever Power} Choose a martial \glossterm{maneuver} you know.
            You gain a \plus2 bonus to \glossterm{power} with that maneuver.
                You can choose this ability multiple times, choosing a different maneuver each time.
            \parhead{Maneuver Precision} Choose an divine \glossterm{maneuver} you know.
                You gain a \plus1 bonus to \glossterm{accuracy} with that maneuver.
                You can choose this ability multiple times, choosing a different maneuver each time.
            \parhead{Maneuver Versatility} Choose a martial \glossterm{maneuver} you know.
                You can use that maneuver as if your weapons dealt any type of physical damage.
                You can choose this ability multiple times, choosing a different maneuver each time.
        }

        \cf{Ftr}[3]{Martial Power} You gain a \plus1 bonus to \glossterm{power} with \glossterm{mundane} abilities.

        \cf*{Ftr}[4]{Martial Insight} You gain an additional \textit{martial insight} ability. 

        \cf{Ftr}[6]{Greater Martial Power} The bonus from your \textit{martial power} ability increases to \plus2.

        \cf*{Ftr}[7]{Martial Insight} You gain an additional \textit{martial insight} ability. 
...
\section{Monk}\label{Monk}
    ...
    The intense dedication monks must have to their training means they tend to be lawful or neutral instead of chaotic, though exceptions are possible.
...
\section{Warlock}\label{Warlock}
    \begin{dtable!*}
        ...
        \begin{dtabularx}{\textwidth}{c >{\lcol}X >{\lcol}X >{\lcol}X >{\lcol}X}
            ...
            4 & Abyssal substitution         & Spell rank (4)        & Mystic insight            & Exchange soul fragment      \\
            ...
            7 & Greater abyssal substitution & Spell rank (7)        & Mystic insight            & Control possession          \\
            8 &                              & Spell rank (8)        &                             &                             \\
        \end{dtabularx}
    \end{dtable!*}
...
\section{Wizard}\label{Wizard}
    \begin{dtable!*}
        ...
        \begin{dtabularx}{\textwidth}{c >{\lcol}X >{\lcol}X >{\lcol}X >{\lcol}X}
            ...
            1         & Mystic spheres        & Mystic insight            & Scholastic lore       & Arcane brew         \\
            ...
            4         & Spell rank (4)        & Mystic insight            & Ritual expertise      & Esoteric concoction \\
            ...
            7         & Spell rank (7)        & Mystic insight            & Malleable contingency & Blended concoction  \\
            8         & Spell rank (8)        &                             &                       &                     \\
        \end{dtabularx}
    \end{dtable!*}
