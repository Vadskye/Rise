...
\section{Barbarian}\label{Barbarian}
    \begin{dtable}
        ...
        \begin{dtabularx}{\columnwidth}{>{\ccol}p{\levelcol} >{\ccol}p{\babcolgood} c >{\lcol}X}
            ...
            \barbarianprogressionrow{5}  & \plus3 & \x                           \\
            ...
            \barbarianprogressionrow{15} & \plus5 & \x                           \\
...
\section{Druid}\label{Druid}
    \begin{dtable}
        ...
        \begin{dtabularx}{\columnwidth}{>{\ccol}p{\levelcol} >{\centering}p{\babcolavg} c c >{\lcol}X}
            \tb{Level} & \tb{Combat Prowess} & \tb{Aspects} & \tb{Spells} & \tb{Special} \\
            \hline
