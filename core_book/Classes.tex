...
\section{Barbarian}\label{Barbarian}
    \begin{dtable!*}
        ...
        \begin{dtabularx}{\textwidth}{l l l >{\lcol}X >{\lcol}X >{\lcol}X >{\lcol}X}
            ...
            8 & 20 & Epic resilience                & Epic rage              & Epic savagery            & Epic primality       \\
        \end{dtabularx}
    \end{dtable!*}
    ...
    \subsection{Primal Warrior}
        ...
        \cf{Bbn}[5]{Greater Primal Lore} The bonus from your \textit{primal lore} ability increases to \plus3.

        \cf{Bbn}[6]{Greater Primal Power} The bonus from your \textit{primal power} ability increases to \plus2.

        \cf*{Bbn}[7]{Primal Maneuver}
        You learn an additional primal \glossterm{maneuver} (see \pcref{Primal Maneuvers}).

        \cf{Bbn}[8]{Epic Primality} The bonus from your \textit{primal power} ability increases to \plus6.
        In addition, the bonus to checks from your \textit{primal lore} ability increases to \plus5.
...
\section{Cleric}\label{Cleric}
    \begin{dtable!*}
        ...
        \begin{dtabularx}{\textwidth}{l l >{\lcol}X >{\lcol}X >{\lcol}X >{\lcol}X}
            ...
            8 & 20 & Spell rank (8) & Epic divine mastery         & Domain masteries     & Epic healer            \\
        \end{dtabularx}
    \end{dtable!*}
    ...
    \subsection{Divine Spell Mastery}
        ...
        In addition, the number of additional uses you gain from your \textit{divine guidance} ability increases to three.
...
\section{Druid}\label{Druid}
    \begin{dtable!*}
        ...
        \begin{dtabularx}{\textwidth}{l l >{\lcol}X >{\lcol}X l >{\lcol}X >{\lcol}X}
            ...
            8 & 20 & Avatar of elements          & Spell rank (8) & Epic nature mastery         & Wild fusion                & Twin servant            \\
        \end{dtabularx}
    \end{dtable!*}
    ...
    \subsection{Nature Spell Mastery}
        ...
        In addition, whenever you cast a nature spell, you may choose a living plant within \rngmed range of you.
...
\section{Fighter}\label{Fighter}
    \begin{dtable!*}
        ...
        \begin{dtabularx}{\textwidth}{l l >{\lcol}X >{\lcol}X >{\lcol}X >{\lcol}X}
            ...
            8 & 20 & Epic discipline              & Equipment supremacy          & Epic martialist       & Tactical fusion               \\
        \end{dtabularx}
    \end{dtable!*}
    ...
    \subsection{Martial Mastery}
        ...
        \cf{Ftr}[8]{Epic Martialist} The bonus from your \textit{martial power} ability increases to \plus6.
        In addition, the bonus from your \textit{martial expertise} ability increases to \plus3.
...
\section{Monk}\label{Monk}
    \begin{dtable!*}
        ...
        \begin{dtabularx}{\textwidth}{l l >{\lcol}X >{\lcol}X >{\lcol}X >{\lcol}X}
            ...
            8 & 20 & Esoteric supremacy                  & Epic ki                       & Perfection                 & Transcendence         \\
        \end{dtabularx}
    \end{dtable!*}
    ...
    \subsection{Esoteric Warrior}\label{Esoteric Warrior}
        ...
        \cf{Mnk}[8]{Esoteric Supremacy} The bonus from your \textit{esoteric precision} ability increases to \plus4.
        In addition, the bonus to Dexterity-based checks from your \textit{esoteric lore} ability increases to \plus5.
    ...
    \subsection{Perfected Form}
        ...
        \cf{Mnk}[2]{Graceful Athletics} You gain a \plus2 bonus to Reflex defense and Strength-based and Dexterity-based checks.
        ...
        \cf{Mnk}[5]{Greater Graceful Athletics} The bonuses from your \textit{graceful athletics} ability increase to \plus4.
...
\section{Ranger}\label{Ranger}
    ...
    \subsection{Keen Senses}
        ...
        \cf{Rgr}[8]{Epic Senses} The bonus from your \textit{perceive weakness} ability increases to \plus3.
        In addition, you gain a \plus5 bonus to the Awareness skill.
    ...
    \subsection{Wilderness Warrior}
        ...
        \cf{Rgr}[8]{Wilderness Supremacy} The bonus from your \textit{wild force} ability increases to \plus6.
        In adddition, the bonus to Perception-based checks from your \textit{wild lore} ability increases to \plus5.
...
\section{Rogue}\label{Rogue}
    \begin{dtable!*}
        ...
        \begin{dtabularx}{\textwidth}{l l >{\lcol}X >{\lcol}X >{\lcol}X >{\lcol}X}
            ...
            8 & 20 & Epic assassin               & Epic bardic            & Epic trickster      & Master of all trades   \\
        \end{dtabularx}
    \end{dtable!*}
    ...
    \subsection{Combat Trickster}
        ...
        \cf{Rog}[8]{Epic Trickster} The bonus from your \textit{trick power} ability increases to \plus6.
        In addition, the bonus to Dexterity-based checks from your \textit{trick lore} ability increases to \plus5.
...
\section{Sorcerer}\label{Mage}
    \begin{dtable!*}
        ...
        \begin{dtabularx}{\textwidth}{l l >{\lcol}X >{\lcol}X >{\lcol}X >{\lcol}X >{\lcol}X}
            ...
            8 & 20 & Spell rank (8)        & Epic arcane mastery         & Epic augmentation          & Epic wildspell         &                                             \\
        \end{dtabularx}
    \end{dtable!*}
...
\section{Wizard}\label{Wizard}
    \begin{dtable!*}
        ...
        \begin{dtabularx}{\textwidth}{l l >{\lcol}X >{\lcol}X >{\lcol}X >{\lcol}X}
            ...
            8 & 20 & Epic alchemy                 & Spell rank (8)        & Multiple contingency  & Epic arcane mastery         \\
        \end{dtabularx}
    \end{dtable!*}
