...
\section{Mage}\label{Mage}
    ...
    \subsection{Class Abilities}
        ...
        \subsubsection{Arcane Lore}
            ...
            % TODO: how do rituals work?
            You can apply \glossterm{augments} or \glossterm{subspells} to the spell normally, increasing the ritual's level and material component cost appropriately.
