...
\begin{dtabularx}{\textwidth}{l l >{\lcol}X >{\lcol}X >{\lcol}X >{\lcol}X >{\lcol}X}
    ...
    0 & \tdash & Resilient recovery            & Insensible anger         & Savage rush                                & Primal might                                & Animal instincts        \\
    1 & 1      & Battle-scarred                & Rage                     & Fast movement                              & Combat styles                               & Totem animal            \\
    2 & 4      & Unbattered resilience         & Enraged strike           & Savage precision                           & Combat style rank (2), primal force         & Feral explosion         \\
    3 & 7      & Greater resilient recovery    & Greater insensible anger & Savage force                               & Combat style rank (3), glancing strikes     & Totemic force           \\
    4 & 10     & Limitless recovery            & Greater rage             & Greater fast movement, greater savage rush & Combat style rank (4), primal maneuver      & Greater totem animal    \\
    ...
    6 & 16     & Greater unbattered resilience & Supreme insensible anger & Greater savage force                       & Combat style rank (6), greater primal might & Greater totemic force   \\
    7 & 19     & Instant recovery              & Supreme rage             & Supreme fast movement, supreme savage rush & Combat style rank (7), primal maneuver      & Supreme totem animal    \\
\end{dtabularx}
    \end{dtable!*}
    ...
    \subsection{Battleforged Resilience}
        ...
        \cf{Bbn}[0]{Resilient Recovery} You regain a quarter of your maximum \glossterm{damage resistance} when you use the \textit{recover} ability (see \pcref{Recover}).
        ...
        \cf{Bbn}[2]{Unbattered Resilience} At the end of each round, if another creature dealt you damage that round, you regain \glossterm{damage resistance} equal to twice your rank in this archetype.
        This cannot increase your damage resistance above half of your maximum damage resistance.

        \cf{Bbn}[3]{Greater Resilient Recovery} The damage resistance you regain with your \textit{resilient recovery} ability increases to half your maximum damage resistance.

        \cf{Bbn}[4]{Limitless Recovery} You can use the \textit{recover} action an additional time before you take a \glossterm{short rest}.
        ...
        \cf{Bbn}[6]{Greater Unbattered Resilience} The amount of damage resistance you regain with your \textit{unbattered resilience} ability increases to three times your rank in this archetype.

        \cf{Bbn}[7]{Instant Recovery} Once per \glossterm{short rest}, you can use the \textit{recover} ability as a \glossterm{minor action} instead of as a standard action.
    ...
    \subsection{Outland Savage}
        ...
        \cf{Bbn}[1]{Fast Movement} You gain a \plus5 foot bonus to your \glossterm{base speed}.
        ...
        \cf{Bbn}[4]{Greater Fast Movement} The speed bonus from your \textit{fast movement} ability increases to \plus10 feet.
        ...
        \cf{Bbn}[7]{Supreme Fast Movement} The speed bonus from your \textit{fast movement} ability increases to \plus15 feet.
    ...
    \subsection{Totemist}
        ...
        \cf{Bbn}[4]{Greater Totem Animal} The benefit from your \textit{totem animal} ability improves.
        {
            ...
            \subcf{Lion} You gain a \plus5 foot bonus to your \glossterm{base speed}.

            \subcf{Shark} The accuracy bonus increases to \plus4.

            \subcf{Wolf} You gain a \plus5 foot bonus to your \glossterm{base speed}.
        }
...
\end{dtabularx}
    ...
    \subsection{Cleric Domain Abilities}\label{Cleric Domain Abilities}
        ...
        \subsubsection{Travel}
            ...
            \parhead{Gift} You gain two skill points.
            \parhead{Aspect} You gain a \plus5 foot bonus to your \glossterm{base speed}.
    ...
    \subsection{Shifter}\label{Shifter}
...

        {
            ...
            \begin{durationability}{Photosynthesis}
                Duration
                \rankline
                As long as you are in natural sunlight, you gain a \plus5 foot bonus to your \glossterm{base speed}.
                \rankline
    ...
    \subsection{Tactician}
...

        {
            ...
            \begin{durationability}{Hustle}
                \abilitytag{Sustain} (free)
                \rankline
                Each subject gains a \plus5 foot bonus to its \glossterm{base speed} during any phase that it takes the \textit{sprint} action, or if it moves using a \glossterm{standard action}.
        ...
        \cf{Ftr}[4]{Reactive Tactics} You gain a \plus3 bonus to \glossterm{initiative} checks.
...
\end{dtabularx}
    ...
    \subsection{Perfected Form}
        ...
        \cf{Mnk}[1]{Fast Movement} You gain a \plus5 foot bonus to your \glossterm{base speed}.
        ...
        \cf{Mnk}[4]{Greater Fast Movement} The speed bonus from your \textit{fast movement} ability increases to \plus10 feet.
        ...
        \cf{Mnk}[7]{Supreme Fast Movement} The speed bonus from your \textit{fast movement} ability increases to \plus15 feet.
...
\end{dtabularx}
    ...
    \subsection{Boundary Warden}
        ...
        \cf{Rgr}[5]{Greater Experienced Guide} You and your \glossterm{allies} who can see or hear you gain a \plus2 bonus to \glossterm{initiative} checks.
    ...
    \subsection{Scout}
        ...
        \cf{Rgr}[1]{Skirmisher} At the start of each phase, if there is no more than one creature adjacent to you, you gain a \plus5 foot bonus to your \glossterm{base speed} during that phase.
        In addition, you reduce your \glossterm{longshot penalty} by 1 (see \pcref{Weapon Range Limits}).
    ...
    \subsection{Bardic Music}
        ...
        Using a bardic performance ability with an immediate effect does not interfere with your ability to sustain other bardic performance abilities.
        {
            \begin{durationability}{Aria of Alacrity}
                ...
                \rankline
                For the duration of your performance, all \glossterm{allies} within a \arealarge radius from you each gain a \plus5 foot bonus to their \glossterm{base speed}.
