...
\section{Druid}\label{Druid}
    \begin{dtable!*}
        ...
        \begin{dtabularx}{\textwidth}{c >{\lcol}X >{\lcol}X >{\lcol}X >{\lcol}X >{\lcol}X}
            \tb{Rank} & \tb{Elementalist}         & \tb{Nature Spellcasting} & \tb{Nature Spell Mastery}   & \tb{Shifter}               & \tb{Wildspeaker}         \tableheaderrule
    ...
    \subsection{Wildspeaker}\label{Wildspeaker}
        ...
        \begin{itemize}
            ...
            \item Mountain: A Medium goat appears that can move up or down steep slopes without slowing its movement.
                It has a bite \glossterm{natural weapon}.
            \item Forest: A Medium bear appears that has one additional \glossterm{hit point}.
                It has a bite \glossterm{natural weapon} and two claw \glossterm{natural weapons}.
            \item Plains: A Medium lion appears that has a 40 foot \glossterm{land speed}.
                It has a bite \glossterm{natural weapon}.
        ...
        \begin{itemize}
            \item Aquatic: A Large shark appears that has a 50 foot \glossterm{swim speed} and no land speed.
                It has a bite \glossterm{natural weapon}.
            \item Arctic: An Large polar bear appears that has a bonus to \glossterm{resistances} against cold damage equal to your \glossterm{power}.
                It has a bite \glossterm{natural weapon} and two claw \glossterm{natural weapons}.
            ...
            \item Forest: A Large bear appears that has two additional \glossterm{hit points}.
                It has a bite \glossterm{natural weapon} and two claw \glossterm{natural weapons}.
            \item Plains: A Large lion appears that has a 50 foot \glossterm{land speed}.
                It has a bite \glossterm{natural weapon}.
            % TODO: define shallow water
            \item Swamp: A Large crocodile appears that has a 30 foot \glossterm{land speed} and a 40 foot \glossterm{swim speed}.
                It has a bite \glossterm{natural weapon}.
        ...
        \cf{Drd}[7]{Supreme Natural Servant}[Magical] Your \textit{natural servant} gains an additional \glossterm{action point}.
        ...
        Changing the animal's size affects its \glossterm{base speed} and \glossterm{Stealth} skill.
        It may also affect the animal's \glossterm{reach}, \glossterm{overwhelm value}, and \glossterm{overwhelm resistance} (see \pcref{Size in Combat}).
...
\section{Ranger}\label{Ranger}
    ...
    \subsection{Beastmaster}
        ...
        \cf{Rgr}[4]{Beast Companion} Your \textit{animal companion} gains an \glossterm{action point}.
        ...
        \cf{Rgr}[6]{Greater Pack Tactics} You gain a \plus1 bonus to \glossterm{accuracy} against creatures that are \glossterm{overwhelmed}.

        \cf{Rgr}[7]{True Companion} Your \textit{animal companion} gains an additional \glossterm{action point}.
