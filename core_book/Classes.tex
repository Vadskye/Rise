...
\section{Barbarian}\label{Barbarian}
    ...
    \subsection{Battlerager}\label{Rage}
        ...
        You no longer have to \glossterm{attune} to your \textit{rage} ability.
        Instead, you can suppress or resume the ability at will as a \glossterm{free action}.
    ...
    \subsection{Primal Warrior}
        ...
        You can use any \textit{primal exertion} ability you know as a \glossterm{standard action}.
        {
            ...
            \begin{apability}{Brace for Impact}[\glossterm{Swift}]
                ...
                \rankline
                \rank{3} This ability gains the \glossterm{Sustain} (standard) tag.
...
\section{Druid}\label{Druid}
    ...
    \subsection{Natural Influence}
        ...
        In addition to your previous options, you can also choose from among the aspects below.
        {
            ...
            You can use the \textit{venom} ability as a \glossterm{standard action}, 
            \begin{freeability}{Venom}
...
\section{Fighter}\label{Fighter}
    ...
    \subsection{Martial Mastery}
        ...
        You can use any \textit{martial exertion} ability you know as a \glossterm{standard action}.
        {
            ...
            \begin{apability}{Challenge}[\glossterm{Attune} (self)]
    ...
    \subsection{Equipment Training}
        ...
        \cf{Ftr}[2]{Weapon Focus} You can use the \textit{weapon focus} ability by spending an hour training with a weapon.
        \begin{freeability}{Weapon Focus}
...
\section{Monk}\label{Monk}
    ...
    \subsection{Ki}
        ...
        You cannot use more than one \textit{ki manifestation} per round.
        {
            ...
            \begin{apability}{Dance of Falling Feathers}
                At the start of the round, you can use this ability.
                It lasts until the end of the round.
            ...
            \begin{apability}{Tranquil Ward of Unshakeable Peace}[\glossterm{Swift}]
                As a standard action, you can use this ability.
                It lasts until the end of the round.
                You take half damage from all attacks.
    ...
    \subsection{Transcendent Sage}
        ...
        \cf{Mnk}{Serene Strike} You can use the \textit{serene strike} ability as a standard action.
        \begin{apability}{Serene Strike}
...
\section{Paladin}\label{Paladin}
    ...
    \subsection{Devoted Paragon}
        ...
        \begin{apability}{Lay on Hands}[Life]
...
\section{Rogue}\label{Rogue}
    ...
    \subsection{Assassin}
        ...
        \cf{Rog}[5]{Assassinate} You can use the \textit{assassinate} ability as a \glossterm{minor action}.
        \begin{freeability}{Assassinate}
