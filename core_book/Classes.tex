    ...
    \subsection{Battlerager}\label{Rage}
        ...
        \begin{attuneability}{Rage}[\glossterm{Emotion}, \glossterm{Attune} (self), \glossterm{Swift}]
            ...
            \begin{itemize}
                ...
                \item You are unable to take \glossterm{standard actions} that do not cause you to make \glossterm{physical attacks}.
        ...
        \cf{Bbn}[4]{Invigorating Rage} When you use your \textit{rage} ability, you may remove a point of \glossterm{fatigue}.
        If you do, you regain that \glossterm{fatigue} when the ability ends.
        ...
        \cf{Bbn}[7]{Greater Invigorating Rage} You may remove two points of \textit{fatigue} instead of one with your \textit{invigorating rage} ability.
        If you do, you regain two points of \glossterm{fatigue} when the ability ends.
...
\section{Cleric}\label{Cleric}
    ...
    \subsection{Healer}
        ...
        \begin{freeability}{Divine Healing}[\glossterm{Life}, \glossterm{Magical}]
            You or a living \glossterm{ally} you can touch removes a point of \glossterm{fatigue}.
        ...
        \cf{Clr}[3]{Vital Healing} When you cause a creature to remove a point of \glossterm{fatigue} with a \glossterm{magical} ability, you can spend an \glossterm{action point}.
        ...
        \cf{Clr}[4]{Greater Divine Healing} The \glossterm{range} of your \textit{divine healing} ability increases to \rngclose.
        In addition, the target can also remove a \glossterm{condition}.
        ...
        \cf{Clr}[6]{Greater Vital Healing} When you use your \textit{vital healing} ability, the target removes the \glossterm{vital wound} in addition to the point of \glossterm{fatigue}.

        \cf{Clr}[7]{Supreme Divine Healing} The \glossterm{range} of your \textit{divine healing} increases to \rngmed.
        In addition, the target removes an additional point of \glossterm{fatigue}.
    ...
    \subsection{Cleric Domain Abilities}\label{Cleric Domain Abilities}
        ...
        \subsubsection{Life}
            ...
            \end{apability}
            \parhead{Mastery} Whenever you remove any amount of \glossterm{fatigue}, you remove an additional point of fatigue.
...
\section{Paladin}\label{Paladin}
    ...
    \subsection{Stalwart Guardian}
        ...
        \begin{freeability}{Lay on Hands}[Life]
            You or an \glossterm{ally} you can touch removes a point of \glossterm{fatigue}.
            That creature is unaffected by any additional uses of this ability until you take a \glossterm{short rest}.
        \end{freeability}
        ...
        The target of your \textit{lay on hands} ability removes an additional point of \glossterm{fatigue}.
...
\section{Warlock}\label{Warlock}
    ...
    \subsection{Blessings of the Abyss}
        ...
        {
            \parhead{Bloodfeeding} If you inflict a \glossterm{vital wound} with the spell, you remove a point of \glossterm{fatigue}.
            You can only remove \glossterm{fatigue} in this way up to 3 times between \glossterm{short rests}.
        ...
        When you gain this ability, you can exchange any other eldritch augments you know for eldritch augments on this list.
        {
            ...
            \parhead{Greater Bloodfeeding} If you inflict a \glossterm{vital wound} with the spell, you remove two points of \glossterm{fatigue}.
            You can only remove \glossterm{fatigue} in this way up to 3 times between \glossterm{short rests}.
