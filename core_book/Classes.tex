    ...
    \subsection{Huntmaster}
        ...
        Each \textit{hunting style} ability lasts as long as the \textit{quarry} ability you used it with.
        {
            ...
            \begin{freeability}{Lifeseal}[Magical]
                As long as your quarry is adjacent to any member of your \glossterm{hunting party}, it cannot regain \glossterm{hit points}.
            ...
            \begin{freeability}{Swarm Hunter}
                ...
                \rankline
                \rank{4} Your \glossterm{hunting party} reduces their penalties for being \glossterm{surrounded} by 1.
            ...
            \begin{freeability}{Wolfpack}
                ...
                \rank{6} Your quarry is \glossterm{decelerated} instead of slowed.
            \end{freeability}
        }

        \cf{Rgr}[3]{Hunter's Prowess} You gain a \plus1d bonus to your damage with all weapons.

        \cf{Rgr}[4]{Greater Quarry} You can use your \textit{quarry} ability with the \glossterm{Sustain} (free) tag instead of the \glossterm{Attune} (self) tag.
