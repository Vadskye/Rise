...
\section{Cleric}\label{Cleric}
    ...
    \subsection{Cleric Domain Abilities}\label{Cleric Domain Abilities}
        ...
        \subsubsection{Fire}
            ...
            \parhead{Aspect} Whenever you \glossterm{wound} a creature with a \glossterm{critical hit} using fire damage, that creature takes fire \glossterm{standard damage} \minus3d at the end of the next round.
