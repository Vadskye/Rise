...
\end{dtabularx}
    ...
    \subsection{Battleforged Resilience}
        ...
        \cf{Bbn}[2]{Unbattered Resilience}
...
\end{dtabularx}
    ...
    \subsection{Healer}
        ...
        \cf{Clr}[7]{Greater Called to the Needy}
    ...
    \subsection{Preacher}
        ...
        \cf{Clr}[7]{Convert the Irresolute}
