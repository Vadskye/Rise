...
\section{Barbarian}\label{Barbarian}
    ...
    \subsection{Battlerager}\label{Rage}
        ...
        \cf{Bbn}[4]{Invigorating Rage} When you use your \textit{rage} ability, you may regain a \glossterm{hit point}.
        ...
        \cf{Bbn}[7]{Greater Invigorating Rage} You may regain two \textit{hit points} instead of one with your \textit{invigorating rage} ability.
        If you do, you lose two \glossterm{hit points} when the ability ends.
    ...
    \subsection{Battleforged Resilience}
        ...
        \cf{Bbn}[5]{Greater Battle-Scarred} The bonus from your \textit{battle-scarred} ability increases to be equal to your level.
...
\section{Cleric}\label{Cleric}
    ...
    \subsection{Healer}
        ...
        \begin{freeability}{Divine Healing}[\glossterm{Life}, \glossterm{Magical}]
            You or a living \glossterm{ally} you can touch regains a \glossterm{hit point}.
        ...
        \cf{Clr}[3]{Vital Healing} When you cause a creature to regain a \glossterm{hit point} with a \glossterm{magical} ability, you can spend an \glossterm{action point}.
        If you do, the target also removes a \glossterm{vital wound}.
        ...
        \cf{Clr}[6]{Greater Vital Healing} When you use your \textit{vital healing} ability, the target removes a number of \glossterm{vital wounds} equal to the \glossterm{hit points} it regained.

        \cf{Clr}[7]{Supreme Divine Healing} The \glossterm{range} of your \textit{divine healing} increases to \rngmed.
        In addition, the target regains an additional \glossterm{hit point}.
    ...
    \subsection{Cleric Domain Abilities}\label{Cleric Domain Abilities}
        ...
        \subsubsection{Life}
            ...
            \end{apability}
            \parhead{Mastery} Whenever you regain any number of \glossterm{hit points}, you regain an additional \glossterm{hit point}.
...
\section{Paladin}\label{Paladin}
    ...
    \subsection{Stalwart Guardian}
        ...
        \begin{freeability}{Lay on Hands}[Life]
            You or an \glossterm{ally} you can touch regains a \glossterm{hit point}.
        ...
        The target of your \textit{lay on hands} ability regains an additional \glossterm{hit point}.
...
\section{Warlock}\label{Warlock}
    ...
    \subsection{Blessings of the Abyss}
        ...
        {
            \parhead{Bloodfeeding} If you inflict a \glossterm{vital wound} with the spell, you regain a \glossterm{hit point}.
            You can only regain \glossterm{hit points} in this way up to 3 times between \glossterm{short rests}.
        ...
        When you gain this ability, you can exchange any other eldritch augments you know for eldritch augments on this list.
        {
            ...
            \parhead{Greater Bloodfeeding} If you inflict a \glossterm{vital wound} with the spell, you regain two \glossterm{hit points}.
            You can only regain \glossterm{hit points} in this way up to 3 times between \glossterm{short rests}.
