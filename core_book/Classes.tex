...
\end{dtabularx}
    ...
    \subsection{Assassin}
        ...
        \begin{freeability}{Sneak Attack}
            ...
            If the target is \glossterm{unaware} or \glossterm{partially unaware} of your attack, or if the target is \glossterm{threatened} by one of your \glossterm{allies}, you gain a \plus2d bonus to damage with the strike.
