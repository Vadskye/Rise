...
\section{How Classes Work}
    ...
    \subsection{Archetypes}\label{Archetypes}
        ...
        \subsubsection{Archetype Ranks}\label{Archetype Ranks}
            ...
            At 1st level, you are Rank 1 in one archetype, and rank 0 in your other two archetypes.
...
\section{Barbarian}\label{Barbarian}
    ...
    \subsection{Battleforged Resilience}
        ...
        \cf{Bbn}[1]{Battle-Scarred} You gain a bonus equal to your level to your \glossterm{resistances} (see \pcref{Resistances}).

        \cf{Bbn}[2]{Unbattered Resilience} At the end of each round, if you did not resist any damage that round, you regain physical damage resistance equal to your level.

        \cf{Bbn}[3]{Toughened Body} You increase your maximum \glossterm{hit points} by an amount equal to your level.
        In addition, the bonus from your \textit{endurance} ability increases to \plus2.

        \cf{Bbn}[4]{Greater Battle-Scarred} The bonus from your \textit{battle-scarred} ability increases to be equal to twice your level.

        \cf{Bbn}[5]{Greater Unbattered Resilience} The amount of physical damage resistance you regain with your \textit{unbattered resilience} ability increases to twice your level.

        \cf{Bbn}[6]{Greater Toughened Body} You gain a \plus1 bonus to your base Constitution (see \pcref{Constitution}).

        \cf{Bbn}[7]{Supreme Battle-Scarred} The bonus from your \textit{battle-scarred} ability increases to be equal to three times your level.
    ...
    \subsection{Battlerager}\label{Rage}
        ...
        \begin{attuneability}{Rage}[\glossterm{Emotion}, \glossterm{Attune} (self), \glossterm{Swift}]
            ...
            \begin{itemize}
                ...
                \item You gain a bonus to \glossterm{power} equal to your level with \glossterm{mundane} abilities.
            ...
            \end{itemize}
            When this ability ends, you gain a \glossterm{fatigue point}.
        \end{attuneability}

        \cf{Bbn}[2]{Insensible Anger} You reduce your maximum hit points by an amount equal to your level.
        In exchange, you gain a bonus to your \glossterm{resistances} equal to your level.

        \cf{Bbn}[3]{Powerful Anger} You gain a bonus to \glossterm{power} with \glossterm{mundane} abilities equal to half your level.

        \cf{Bbn}[4]{Greater Rage} You no longer gain a \glossterm{fatigue point} when your \textit{rage} ability ends.

        \cf{Bbn}[5]{Greater Insensible Anger} The hit point reduction and resistance bonuses from your \textit{insensible anger} ability both increase to be equal to twice your level.

        \cf{Bbn}[6]{Greater Powerful Anger} You gain a \plus1 bonus to your base Strength (see \pcref{Strength}).

        \cf{Bbn}[7]{Supreme Rage} Your \textit{rage} ability loses the \glossterm{Attune} (self) tag and gains the \glossterm{Sustain} (free) tag, allowing you to more easily enter and exit your rage.
    ...
    \subsection{Outland Savage}
        ...
        \cf{Bbn}[3]{Savage Force} All \glossterm{strikes} you make gain bonus damage dice equal to your weapon's damage dice.
        ...
        \cf{Bbn}[6]{Greater Savage Force} The bonus from your \textit{savage force} ability increases to be equal to twice your weapon's damage dice.
    ...
    \subsection{Primal Warrior}
...

        {
            ...
            \cf{Bbn}[3]{Greater Primal Might} The bonus from your \textit{primal might} ability increases to \plus2.
...

        {
            ...
            \cf{Bbn}[5]{Primal Force} All \glossterm{strikes} you make gain bonus damage dice equal to your weapon's damage dice.
        }

        {
            ...
            \cf{Bbn}[6]{Supreme Primal Might} The bonuses from your \textit{primal might} ability increase to \plus3.
        }
...
\section{Cleric}\label{Cleric}
    ...
    \subsection{Divine Spell Mastery}
        ...
        \cf{Clr}[0]{Wellspring of Power} You gain a \plus1 bonus to \glossterm{power} with \glossterm{magical} abilities.
        ...
        \cf{Clr}[3]{Greater Wellspring of Power}[Magical]
        The bonus from your \textit{wellspring of power} ability increases to be equal to half your level.
        ...
        \cf{Clr}[6]{Supreme Wellspring of Power}[Magical]
        The bonus from your \textit{wellspring of power} ability increases to be equal to your level.
    ...
    \subsection{Healer}
        ...
        \begin{freeability}{Restoration}[\glossterm{Magical}]
            ...
            The target regains \glossterm{hit points} equal to half your \glossterm{power} \add 1d6 per rank.
        \end{freeability}
        ...
        In addition, the healing from your \textit{restoration} ability increases to be equal to half your \glossterm{power} \add 1d8 per rank.
        ...
        In addition, the healing from your \textit{restoration} ability increases to be equal to your \glossterm{power} \add 1d8 per rank.
    ...
    \subsection{Cleric Domain Abilities}\label{Cleric Domain Abilities}
        ...
        \subsubsection{Magic}
            ...
            \parhead{Essence} The power bonus from this domain's gift increases to be equal to half your level.
            \parhead{Mastery} The power bonus from this domain's gift increases to be equal to your level.
...
\section{Druid}\label{Druid}
    ...
    \subsection{Nature Spell Mastery}
        ...
        \cf{Drd}[0]{Wellspring of Power} You gain a \plus1 bonus to \glossterm{power} with \glossterm{magical} abilities.
        ...
        You gain your choice of one of the following abilities.
        {
            ...
            \parhead{Rituals} You gain the ability to perform nature rituals to create unique magical effects (see \pcref{Rituals}).
                The maximum \glossterm{rank} of nature ritual you can learn or perform is equal to the maximum rank of nature spell that you can cast.
                You cannot choose this ability multiple times.
        ...
        \cf{Drd}[3]{Greater Wellspring of Power}[Magical]
        The bonus from your \textit{wellspring of power} ability increases to be equal to half your level.
        ...
        \cf{Drd}[6]{Supreme Wellspring of Power}[Magical]
        The bonus from your \textit{wellspring of power} ability increases to be equal to your level.
    ...
    \subsection{Shifter}\label{Shifter}
...

        {
            \begin{freeability}{Form of the Bear}
                ...
                \rankline
                \rank{3} You gain a bonus to damage with \glossterm{strikes} using natural weapons equal to the weapon's damage dice.
                \rank{5} The Fortitude bonus increases to \plus4.
                \rank{7} The bonus increases to twice the weapon's damage dice.
            \end{freeability}
...
\section{Sorcerer}\label{Mage}
    ...
    \subsection{Arcane Magic}
        ...
        \begin{freeability}{Mage Armor}
            ...
            This functions like body armor that provides a \plus2 bonus to Armor defense and has no \glossterm{encumbrance}.
            It also provides a \plus2 bonus to \glossterm{resistance} against \glossterm{energy damage}.
        ...
        In addition, the bonus to \glossterm{resistance} against \glossterm{energy damage} increases to be equal to half your \glossterm{power}.
        ...
        The defense bonus from the body armor created by your \textit{mage armor} ability increases to \plus3.
        In addition, the bonus to \glossterm{resistance} against \glossterm{energy damage} increases to be equal to your \glossterm{power}.
