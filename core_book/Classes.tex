...
\end{dtabularx}
    ...
    \subsection{Battlerager}\label{Rage}
        ...
        \begin{attuneability}{Rage}[\abilitytag{Emotion}, \abilitytag{Sustain} (free), \abilitytag{Swift}]
...
\end{dtabularx}
    ...
    \subsection{Cleric Domain Abilities}\label{Cleric Domain Abilities}
        ...
        \subsubsection{Evil}
            ...
            \begin{freeability}{Compel Evil}[\abilitytag{Compulsion}]
        ...
        \subsubsection{Good}
            ...
            \begin{freeability}{Compel Good}[\abilitytag{Compulsion}]
                Make an attack vs. Mental against a creature within \rngmed range.
                Creatures who have strict codes prohibiting them from taking evil actions, such as paladins devoted to Good, are immune to this ability.
        ...
        \subsubsection{Law}
            ...
            \begin{freeability}{Compel Law}[\abilitytag{Compulsion}]
        ...
        \subsubsection{Protection}
            ...
            \begin{freeability}{Divine Protection}[\abilitytag{Swift}]
        ...
        \subsubsection{Trickery}
            ...
            \begin{freeability}{Compel Belief}[\abilitytag{Compulsion}, \abilitytag{Sustain} (minor)]
                Make an attack vs. Mental against a creature within \rngmed range.
...
\end{dtabularx}
    ...
    \subsection{Elementalist}\label{Elementalist}
        ...
        \begin{freeability}{Elemental Influence}[\abilitytag{Sustain} (standard)]
    ...
    \subsection{Shifter}\label{Shifter}
...

        {
            ...
            \begin{freeability}{Form of the Constrictor}
                ...
                \rank{7} When you grapple a creature the \textit{grapple} ability, you are not considered to be \grappled (see \pcref{Asymmetric Grappling}).
            \end{freeability}
            ...
            \begin{freeability}{Form of the Viper}
                ...
                \rank{5} On a critical hit with the poison, the target is \nauseated instead of \sickened.
        ...
        This ability does not have the \abilitytag{Swift} tag, so changing in this way does not affect attacks you make or attacks made against you in the same phase.
    ...
    \subsection{Wildspeaker}\label{Wildspeaker}
        ...
        \begin{attuneability}{Animal Speech}[\abilitytag{Sustain} (minor)]
...
\end{dtabularx}
    ...
    \subsection{Tactician}
        ...
        {
            \begin{freeability}{Break Through}[\abilitytag{Sustain} (free)]
            ...
            \begin{freeability}{Dogpile}[\abilitytag{Sustain} (free)]
            ...
            \begin{freeability}{Duck and Cover}[\abilitytag{Sustain} (free)]
            ...
            \begin{freeability}{Group Up}[\abilitytag{Sustain} (free)]
            ...
            \begin{freeability}{Hold The Line}[\abilitytag{Sustain} (free)]
            ...
            \begin{freeability}{Hustle}[\abilitytag{Sustain} (free)]
            ...
            \begin{freeability}{Keep Moving}[\abilitytag{Sustain} (free)]
            ...
            \begin{freeability}{Stand Your Ground}[\abilitytag{Sustain} (free)]
...
\end{dtabularx}
    ...
    \subsection{Ki}
        ...
        {
            \begin{freeability}{Abandon the Fragile Self}[\abilitytag{Swift}]
            ...
            \begin{freeability}{Burst of Blinding Speed}[\abilitytag{Swift}]
                You can use this ability as a \glossterm{free action}.
            ...
            \begin{freeability}{Elegant Whirl of Fluid Motion}[\abilitytag{Swift}]
                You can use this ability as a \glossterm{free action}.
            ...
            \begin{freeability}{Extend the Flow of Ki}[\abilitytag{Swift}]
                You can use this ability as a \glossterm{free action}.
            ...
            \begin{freeability}{Leap of the Heavens}[\abilitytag{Swift}]
                You can use this ability as a \glossterm{free action}.
            ...
            \begin{freeability}{Scale the Highest Tower}[\abilitytag{Swift}]
                You can use this ability as a \glossterm{free action}.
            ...
            \begin{freeability}{Sense the Mystic Truth}[\abilitytag{Swift}]
                You can use this ability as a \glossterm{free action}.
            ...
            \begin{freeability}{Step Between the Mystic Worlds}[\abilitytag{Swift}]
                You can use this ability as a \glossterm{free action}.
            ...
            \begin{freeability}{Surpass the Mortal Limits}[\abilitytag{Swift}]
                You can use this ability as a \glossterm{free action}.
...
\end{dtabularx}
    ...
    \subsection{Beastmaster}
        ...
        \begin{attuneability}{Animal Companion}[\glossterm{Attune} (self), \abilitytag{Emotion}, \glossterm{Magical}]
    ...
    \subsection{Huntmaster}
        ...
        Each \textit{hunting style} ability lasts as long as the \textit{quarry} ability you used it with.
        {
            \begin{freeability}{Anchoring}[Magical]
                ...
                This prevents all \abilitytag{Manifestation}, \glossterm{Planar}, and \glossterm{Teleportation} effects.
        ...
        \cf{Rgr}[4]{Greater Quarry} You can use your \textit{quarry} ability with the \abilitytag{Sustain} (free) tag instead of the \glossterm{Attune} (self) tag.
...
\end{dtabularx}
    ...
    \subsection{Assassin}
        ...
        \begin{freeability}{Assassination}[\abilitytag{Swift}]
...
\end{dtabularx}
    ...
    \subsection{Wild Magic}
        ...
        \cf{Sor}[1]{Wildspell} Whenever you cast a spell that does not have the \glossterm{Attune} or \abilitytag{Sustain} tags, you may use this ability after making all other decisions for the spell (such as targets, intended area, and so on).
        ...
        \cf{Sor}[2]{Chaotic Insight} You learn a spell that does not have the \glossterm{Attune} or \abilitytag{Sustain} tags from any \glossterm{mystic sphere}, even if you do not have access to that mystic sphere.
...
\end{dtabularx}
    ...
    \subsection{Blessings of the Abyss}
        ...
        \begin{freeability}{Abyssal Curse}[\abilitytag{Curse}, \glossterm{Magical}]
    ...
    \subsection{Soulkeeper's Chosen}
        ...
        \begin{attuneability}{Possession}[\abilitytag{Sustain} (free)]
        ...
        \begin{freeability}{Exchange Soul Fragment}[\glossterm{Magical}, \abilitytag{Swift}]
        ...
        \begin{freeability}{Exchange Vitality}[\glossterm{Magical}, \abilitytag{Swift}]
