...
\section{Paladin}\label{Paladin}
    ...
    \subsection{Zealous Warrior}
        ...
        \cf{Pal}[3]{Zealous Offense} You gain a \plus1 bonus to \glossterm{accuracy} with \glossterm{strikes}.
...
\section{Ranger}\label{Ranger}
    \begin{dtable!*}
        ...
        \begin{dtabularx}{\textwidth}{c >{\lcol}X >{\lcol}X >{\lcol}X > {\lcol}X}
            ...
            \\ 7 & Greater wary hunter   & Truesight          & Wild maneuver      & Greater favored enemy
            \\ 8 & Dual quarry    &                    &
        \end{dtabularx}
    \end{dtable!*}
...
\section{Rogue}\label{Rogue}
    \begin{dtable!*}
        ...
        \begin{dtabularx}{\textwidth}{c >{\lcol}X >{\lcol}X >{\lcol}X >{\lcol}X}
            ...
            \\ 3 & Darkstalker          & Skill lore             & Trick power         & Distract
            \\ 4 & Greater sneak attack & Greater skill exemplar & Trick manuever      & Suave lore
            \\ 5 & Assassinate, evasion & Skillful defense       &                     & Greater glibness
            \\ 6 & Hide in plain sight  & Supreme skill exemplar & Greater trick power & Compel belief
            \\ 7 & Supreme sneak attack & Legendary fortune      & Trick maneuver      & Slippery mind
