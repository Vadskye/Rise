...
\section{Barbarian}\label{Barbarian}
    \begin{dtable}
        ...
        \begin{dtabularx}{\columnwidth}{>{\ccol}p{\levelcol} >{\ccol}p{\babcolgood} c >{\lcol}X}
            ...
            \hline
            \barbarianprogressionrow{1}  & \plus2 & Rage, damage reduction \\
    ...
    \subsection{Class Abilities}
        ...
        \cf{Bbn}[14th]{Defensive Rage}[Ex]
        The barbarian no longer takes a penalty to \glossterm{physical defenses} while raging.
...
\section{Spellwarped}\label{Spellwarped}
    ...
    \subsection{Class Abilities}
        ...
        In addition, he may use his Intelligence to determine his \glossterm{physical defenses} in place of his Dexterity or Constitution.
