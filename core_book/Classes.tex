...
\section{Druid}\label{Druid}
    ...
    \subsection{Natural Influence}
        ...
        In addition to your previous options, you can also choose from among the aspects below.
        {
            ...
            You may use your \glossterm{power} in place of your Disguise skill when making Disguise checks to alter your own appearance.
        ...
        In addition to your previous options, you can also choose from among the aspects below.
        {
            ...
            At the end of each \glossterm{action phase}, you heal hit points equal to your \glossterm{power}.
