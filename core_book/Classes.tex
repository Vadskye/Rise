...
\section{Barbarian}\label{Barbarian}
    \begin{dtable}
        ...
        \begin{dtabularx}{\columnwidth}{>{\ccol}p{\levelcol} c >{\lcol}X}
            ...
            \nth{4}  & \plus2 & Uncontrollable rage                \\
            \nth{5}  & \plus3 & Improvised combat       \\
            \nth{6}  & \plus3 & Lesser titanic might              \\
            \nth{7}  & \plus3 & Battle-scarred \\
            \nth{8}  & \plus3 & Improved uncanny dodge         \\
            \nth{9}  & \plus3 & Primal resilience      \\
            \nth{10} & \plus4 & Mindless rage       \\
            \nth{11} & \plus4 &      \\
            \nth{12} & \plus4 & Titanic might     \\
            \nth{13} & \plus4 & Fury of the storm      \\
            \nth{14} & \plus4 &           \\
            \nth{15} & \plus5 & Greater improvised combat                 \\
            \nth{16} & \plus5 & Unfettered rage           \\
            \nth{17} & \plus5 & Greater primal resilience        \\
            \nth{18} & \plus5 & Greater titanic might         \\
            \nth{19} & \plus5 & Endless rage           \\
            \nth{20} & \plus6 & Deathless                 \\
        \end{dtabularx}
    \end{dtable}
    ...
    \subsection{Class Abilities}
        ...
        \cf{Bbn}[4th]{Uncontrollable Rage}
        While raging, the barbarian is immune to \glossterm{Compulsion} effects.

        \cf{Bbn}[5th]{Improvised Combat}
        The barbarian gains a \plus1 bonus to accuracy with \glossterm{combat maneuvers}.

        \cf{Bbn}[6th]{Lesser Titanic Might}
        The barbarian gains a \plus1d bonus to damage with \glossterm{strikes}.

        \cf{Bbn}[7th]{Battle-Scarred}
        The barbarian doubles the benefit of any healing he receives.
        This affects both natural and magical healing.

        \cf{Bbn}[8th]{Greater Uncanny Dodge}
        The barbarian reduces his overwhelm penalties by 2.
        This does not stack with the effects of uncanny dodge.
        If his overwhelm penalty is reduced to 0, he is not considered to be overwhelmed.

        \cf{Bbn}[9th]{Primal Resilience}
        The barbarian gains a \plus2 bonus to Fortitude defense.

        \cf{Bbn}[10th]{Mindless Rage}
        The barbarian is immune to hostile \glossterm{Mind} effects while raging.

        \cf{Bbn}[11th]{}

        \cf{Bbn}[12th]{Titanic Might}
        The damage bonus with \glossterm{strikes} increases to \plus2d.

        \cf{Bbn}[13th]{Fury of the Storm}
        ...
        \cf{Bbn}[15th]{Greater Improvised Combat}
        The accuracy bonus with \glossterm{combat maneuvers} increases to \plus2.

        \cf{Bbn}[16th]{Unfettered Rage}
        ...
        \cf{Bbn}[17th]{Greater Primal Resilience}
        The bonus to Fortitude increases to \plus4.
        In addition, the barbarian gains a \plus2 bonus to Mental defense.

        \cf{Bbn}[18th]{Greater Titanic Might}
        The damage bonus with \glossterm{strikes} increases to \plus3d.

        \cf{Bbn}[19th]{Endless Rage}
        ...
        \cf{Bbn}[20th]{Deathless Rage}
        While raging, the barbarian ignores all penalties from \glossterm{vital damage}.
