...
\section{Spellwarped}
    ...
    \subsection{Invocations}\label{Invocations}
        ...
        \subsubsection{Alteration Invocations}
            ...
            He gains a \plus20 bonus to Maneuver defense against grapple attacks, is immune to critical hits, and can move through spaces that are no more than two inches in width without \glossdef{squeezing}.
