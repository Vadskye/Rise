...
\end{dtabularx}
    ...
    \subsection{Primal Warrior}
...

        {
            ...
            You gain access to two primal \glossterm{combat styles} (see \pcref{Primal Combat Styles}).
...
\end{dtabularx}
    ...
    \subsection{Martial Mastery}
...

        {
            ...
            You gain access to two martial \glossterm{combat styles} (see \pcref{Martial Combat Styles}).
...
\end{dtabularx}
    ...
    \subsection{Esoteric Warrior}\label{Esoteric Warrior}
...

        {
            ...
            You gain access to two esoteric \glossterm{combat styles} (see \pcref{Esoteric Combat Styles}).
...
\end{dtabularx}
    ...
    \subsection{Wild Warrior}
...

        {
            ...
            You gain access to two wild \glossterm{combat styles} (see \pcref{Wild Combat Styles}).
...
\end{dtabularx}
    ...
    \subsection{Combat Trickster}
...

        {
            ...
            You gain access to two trick \glossterm{combat styles} (see \pcref{Trick Combat Styles}).
