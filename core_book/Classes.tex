...
\section{Cleric}\label{Cleric}
    ...
    \subsection{Divine Spell Mastery}
        ...
        \cf{Clr}[2]{Battle Prayer} You gain a \plus2 bonus to \glossterm{concentration} checks to cast divine spells.
...
\section{Warlock}\label{Warlock}
    ...
    \subsection{Pact Spell Mastery}
        ...
        \cf{War}[1]{Spell Knowledge} You learn an additional pact \glossterm{spell}.
    ...
    \subsection{Blessings of the Abyss}
        ...
        \begin{freeability}{Eldritch Blast}[\glossterm{Magical}]
            ...
            \rank{5} You gain a \plus1d bonus to damage with the attack.
            \rank{7} The range increases to \rnglong.
        \end{freeability}
        ...
        {
            \parhead{Bloodfeeding} If a target loses a \glossterm{hit point} from the attack, you gain a \plus2 bonus to your most recent \glossterm{wound roll}.
            The \glossterm{wound roll} for that \glossterm{vital wound} cannot be modified again.

            \parhead{Chaining} You can also target an additional creature or object within range.
            You take a \minus2 penalty to \glossterm{accuracy} against both targets.
            ...
            \parhead{Extended} The range of the ability is doubled.

            \parhead{Fearful} If the attack result beats the target's Mental defense, it is \glossterm{shaken} by you as a \glossterm{condition}.
            You take a \minus2d penalty to damage with the attack.

            \parhead{Precision} You gain a \plus1 bonus to \glossterm{accuracy}.

            \parhead{Sickening} If the attack result beats the target's Fortitude defense, it is \glossterm{sickened} as a \glossterm{condition}.
            You take a \minus2d penalty to damage with the attack.
        }
        ...
        You gain an ability based on the type of whispers you hear with your \textit{whispers of the lost} ability.
        {
            ...
            \subcf{Whispers of the Mighty} You are immune to poisons and diseases.
        }

        \cf{War}[4]{Fiendish Resistance} You gain a bonus equal to half your level to \glossterm{resistances} against \glossterm{energy damage}.
        ...
        When you gain this ability, you can exchange any other eldritch augments you know for eldritch augments on this list.
        {
            ...
            You take a \minus2 penalty to \glossterm{accuracy} against each target.
            ...
            \parhead{Greater Extended} The range of the ability is tripled.

            \parhead{Greater Precision} You gain a \plus2 bonus to \glossterm{accuracy}.
        ...
        \cf{War}[7]{Greater Fiendish Resistance}[Magical] The bonus from your \textit{fiendish resistance} ability increases to be equal to your level.
