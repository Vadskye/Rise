...
\section{Barbarian}\label{Barbarian}
    ...
    \subsection{Battlerager}\label{Rage}
        ...
        \cf{Bbn}[1]{Rage}
        \begin{ability}{Rage}[\glossterm{Attune (self)}, \glossterm{Swift}]
...
\section{Cleric}\label{Cleric}
    \begin{dtable}
        ...
        \begin{dtabularx}{\columnwidth}{c >{\lcol}X >{\lcol}X >{\lcol}X}
            \tb{Rank} & \tb{Divine Spellcasting} & \tb{Divine Spell Mastery}  & \tb{Domain Influence} \\\bottomrule
               1 & Cantrips   & Wellspring of magic         & Domains, domain gift
    ...
    \subsection{Divine Spellcasting}
        ...
        \cf{Clr}[2]{Subspells} You learn a number of \glossterm{subspells} equal to your starting Intelligence \add 2 (minimum 1).
        ...
        \cf{Clr}[4]{Subspell} You gain an additional \glossterm{subspell} for any divine spell you know.
        ...
        \cf*{Clr}[6]{Subspell} You gain an additional \glossterm{subspell} for any divine spell you know.
        ...
        \cf*{Clr}[8]{Subspell} You gain an additional \glossterm{subspell} for any divine spell you know.
    ...
    \subsection{Divine Spell Mastery}
        ...
        \cf{Clr}[1]{Wellspring of Magic}[Magical]
        ...
        \cf{Clr}[6]{Greater Wellspring of Magic}[Magical]
        You gain an additional \glossterm{action point}.
    ...
    \subsection{Cleric Domain Abilities}\label{Cleric Domain Abilities}
        ...
        \subsubsection{Destruction}
            ...
            \begin{ability}{Destructive Attack}
                ...
                \rank{7} The damage bonus increases to \plus4d.
            \end{ability}
            \parhead{Aspect} Whenever you deal damage to a target, you first negate an amount of \glossterm{damage reduction} equal to your \glossterm{magical power}.
            In addition, you negate an amount of \glossterm{hardness} equal to half your \glossterm{magical power}.
            ...
            \end{ability}
            \parhead{Mastery} Whenever you deal physical damage to a creature or object, its \glossterm{damage reduction} is reduced by an amount equal to your \glossterm{magical power}, and its \glossterm{hardness} is reduced by amount equal to half your \glossterm{magical power}.
...
\section{Druid}\label{Druid}
    \begin{dtable}
        ...
        \begin{dtabularx}{\columnwidth}{c >{\lcol}X >{\lcol}X >{\lcol}X}
            \tb{Rank} & \tb{Nature Spellcasting} & \tb{Nature Spell Mastery}  & \tb{Natural Influence} \\\bottomrule
               1 & Cantrips   & Wellspring of magic         & Wild aspect
    ...
    \subsection{Natural Influence}
        ...
        \begin{ability}{Wild Speech}[\glossterm{Attune (self)}]
        ...
        In addition to your previous options, you can also choose from among the aspects below.
        {
            ...
            \subcf{Venom}
            You gains a bite \glossterm{natural weapon} that deals \plus0d damage for a Medium druid.
            As a \glossterm{standard action}, you can use the \textit{venom} ability.
            \begin{ability}{Venom}
                Make a \glossterm{strike} with a \glossterm{natural weapon}.
                If the target takes damage from the strike, it is poisoned as a \glossterm{condition}.
    ...
    \subsection{Nature Spellcasting}
        ...
        \cf{Drd}[2]{Subspells} You learn a number of \glossterm{subspells} equal to your starting Intelligence \add 2 (minimum 1).
        ...
        \cf{Drd}[4]{Subspell} You gain an additional \glossterm{subspell} for any nature spell you know.
        ...
        \cf*{Drd}[6]{Subspell} You gain an additional \glossterm{subspell} for any nature spell you know.
        ...
        \cf*{Drd}[8]{Subspell} You gain an additional \glossterm{subspell} for any nature spell you know.
    ...
    \subsection{Nature Spell Mastery}
        ...
        \cf{Drd}[1]{Wellspring of Magic}[Magical]
        You gain an additional \glossterm{action point}.
        ...
        \cf{Drd}[6]{Greater Wellspring of Magic}[Magical]
        You gain an additional \glossterm{action point}.
...
\section{Fighter}\label{Fighter}
    ...
    \subsection{Martial Mastery}
        ...
        As a standard action, you can spend an \glossterm{action point} to use a \textit{martial exertion} ability.
        {
            ...
            \begin{ability}{Challenge}[\glossterm{Attune (self)}]
...
\section{Mage}\label{Mage}
    \begin{dtable}
        ...
        \begin{dtabularx}{\columnwidth}{c >{\lcol}X >{\lcol}X >{\lcol}X}
            ...
            1 & Cantrips   & Wellspring of magic         & Mage armor
    ...
    \subsection{Arcane Spellcasting}
        ...
        \cf{Mge}[1]{Arcane Spells}[Magical]
        ...
        \cf{Mge}[2]{Subspells}[Magical] Choose two \glossterm{subspells} for any arcane spells you know.
    ...
    \subsection{Arcane Spellcasting}
        ...
        \cf{Mge}[2]{Subspells} You learn a number of \glossterm{subspells} equal to your starting Intelligence \add 2 (minimum 1).
        ...
        \cf{Mge}[4]{Subspell} You gain an additional \glossterm{subspell} for any arcane spell you know.
        ...
        \cf*{Mge}[6]{Subspell} You gain an additional \glossterm{subspell} for any arcane spell you know.
        ...
        \cf*{Mge}[8]{Subspell} You gain an additional \glossterm{subspell} for any arcane spell you know.
    ...
    \subsection{Arcane Lore}
        ...
        \cf{Mge}[1]{Mage Armor}[Magical] As a standard action, you can use the \textit{mage armor} ability.
        ...
        {
            \parhead{Esoteric Insight} You forget a subspell you know.
            ...
            In addition, you automatically succeed at all \glossterm{concentration} checks you make to cast the spell.
            \par If you choose this insight multiple times, you must choose a different spell each time.

            \parhead{Specialization} Choose a school of magic that you know a spell from.
            You learn an additional \glossterm{subspell} from that school of magic.
    ...
    \subsection{Arcane Spell Mastery}
        ...
        \cf{Mge}[1]{Wellspring of Magic}[Magical]
        You gain an additional \glossterm{action point}.
        ...
        \cf{Mge}[6]{Greater Wellspring of Magic}[Magical]
        You gain an additional \glossterm{action point}.
    ...
    \subsection{Ki}
        ...
        You cannot use more than one \textit{ki manifestation} per round.
        {
            ...
            \begin{ability}{Ki Strike}
                ...
                You may use your \glossterm{power} in place of your Perception to determine your \glossterm{accuracy} with the strike, and in place of your Strength to determine your damage with the strike.
        ...
        \cf*{Mnk}[2]{Ki Vessel}[Magical] You gain an additional \glossterm{action point}.

        \cf*{Mnk}[3]{Ki Manifestation}[Magical]
        You learn an additional \textit{ki manifestation}.

        \cf{Mnk}[4]{Dual Manifestation}[Magical] You can use up to two \textit{ki manifestation} abilities per round.
        If you do, the second ability does not cost an action point.

        \cf*{Mnk}[5]{Ki Manifestation}[Magical]
        You learn an additional \textit{ki manifestation}.

        \cf{Mnk}[6]{Ki Wellspring}[Magical] You gain an additional \glossterm{action point}.

        \cf*{Mnk}[7]{Ki Manifestation}[Magical]
        You learn an additional \textit{ki manifestation}.

        \cf{Mnk}[8]{Myriad Manifestation}[Magical] You can use up to three \textit{ki manifestation} abilities per round.
...
\section{Paladin}\label{Paladin}
    ...
    \subsection{Devoted Paragon}
        ...
        \subparhead{Good} When you redirect damage from an ally with this aura, you can redirect all damage from the attack to you instead of only half the damage.
        ...
        \cf{Pal}[6]{Supreme Lay on Hands}[Magical]
        You gain a \plus1d bonus to the healing from your \textit{lay on hands} ability.
    ...
    \subsection{Divine Spellcasting}
        ...
        \cf{Pal}[2]{Subspells} You learn a number of \glossterm{subspells} equal to your starting Intelligence \add 2 (minimum 1).
        You can use these subspells to learn any 1st level subspell of divine spells you know.
        As a \glossterm{standard action}, you can spend an \glossterm{action point} to cast any \glossterm{subspell} you know.
        Whenever you gain access to a new spell or spell level, you can exchange any number of subspells you know for subspells of other spells you know, including subspells of the higher level.
        ...
        \cf{Pal}[4]{Subspell} You gain an additional \glossterm{subspell} for any divine spell you know.
        ...
        \cf*{Pal}[6]{Subspell} You gain an additional \glossterm{subspell} for any divine spell you know.
        ...
        \cf*{Pal}[8]{Subspell} You gain an additional \glossterm{subspell} for any divine spell you know.
...
\section{Rogue}\label{Rogue}
    ...
    \subsection{Assassin}
        ...
        \cf{Rog}[2]{Uncanny Dodge} You gain a \plus1 bonus to \glossterm{overwhelm resistance}.

        \cf*{Rog}[3]{Darkstalker}[Magical] As a standard action, you can spend an \glossterm{action point} to use the \textit{darkstalker} ability.
        \begin{ability}{Darkstalker}[\glossterm{Attune (self)}]
        ...
        % TODO: wording
        \cf{Rog}[5]{Evasion} When you are attacked by an ability that affects an area, you can use your Reflex defense in place of any other defenses against that attack.

        \cf{Rog}[6]{Supreme Sneak Attack} The damage bonus from your \textit{sneak attack} ability increases to \plus4d.

        \cf{Rog}[7]{Greater Darkstalker}[Magical] When you use your \textit{darkstalker} ability, you become undetectable by all of the listed senses, not just one.
    ...
    \subsection{Scoundrel}
        ...
        \cf{Rog}[2]{Tricky Lore} You gain two extra skill points.

        \cf*{Rog}[3]{Combat Trick}
        You learn an additional \textit{combat trick}.

        \cf*{Rog}[4]{Tricky Lore} You gain two extra skill points.

        \cf*{Rog}[5]{Combat Trick}
        You learn an additional \textit{combat trick}.

        \cf{Rog}[6]{Skill Trick} % TODO
...
\section{Warlock}\label{Warlock}
    ...
    \subsection{Pact Spellcasting}
        ...
        \cf{War}[1]{Arcane Spells}[Magical]
        You can cast arcane spells.
        ...
        \cf{War}[1]{Arcane Spell Failure}
        Whenever you cast an arcane spell while using \glossterm{armor}, you must roll 1d10.
        If your result is less than or equal to your \glossterm{encumbrance}, you \glossterm{miscast} your spell.

        \cf{War}[2]{Pact Augments}[Magical] You learn two pact augments from the list below.
        ...
        \cf*{War}[3]{Spell Knowledge}[Magical]
    ...
    \subsection{Blessings of the Abyss}
        ...
        \cf{War}[2]{Armor Tolerance} You reduce your \glossterm{encumbrance} by 2 when determining your \textit{arcane spell failure}.
        ...
        \cf{War}[6]{Supreme Armor Tolerance}[Magical] The penalty reduction from your \textit{armor tolerance} ability improves to 4.
    ...
    \subsection{Pact Magic}
        ...
        \cf{War}[1]{Wellspring of Magic}[Magical] You gain an additional \glossterm{action point}.
        ...
        \cf{War}[4]{Greater Malevolent Boon}[Magical] You can cast arcane spells that make attack rolls without spending \glossterm{action points}.
        ...
        \cf*{War}[6]{Greater Wellspring of Magic}[Magical] You gain an additional \glossterm{action point}.
