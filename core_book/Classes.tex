...
\section{Cleric}\label{Cleric}
    ...
    \subsection{Divine Spellcasting}
        ...
        When you gain access to a new spell or spell level, you can exchange any number of subspells you know for subspells of other spells you know, including subspells of the higher level.
    ...
    \subsection{Cleric Domain Abilities}\label{Cleric Domain Abilities}
        ...
        \subsubsection{Death}
            \parhead{Gift} When you deal damage to a creature with no hit points remaining, it immediately dies.
            This is a \glossterm{Death} effect.
            % Needs wording to clarify interaction with simultaneous damage
            \parhead{Aspect} When you deal damage to a creature, any of your damage in excess of that creature's hit points is dealt as \glossterm{vital damage}.
        ...
        \subsubsection{Destruction}
            ...
            \begin{ability}{Destructive Attack}
                ...
                \rank{7} The damage bonus increases to \plus4d.
            \end{ability}
            \parhead{Aspect} When you deal damage to a target, you first negate an amount of \glossterm{damage reduction} equal to your \glossterm{magical power}.
            ...
            \end{ability}
            \parhead{Mastery} When you deal physical damage to a creature or object, its \glossterm{damage reduction} is reduced by an amount equal to your \glossterm{magical power}, and its \glossterm{hardness} is reduced by amount equal to half your \glossterm{magical power}.
...
\section{Druid}\label{Druid}
    ...
    \subsection{Natural Influence}
        ...
        In addition to your previous options, you can also choose from among the aspects below.
        {
            ...
            % \subcf{Spikes}
            % When a creature adjacent to the druid makes a physical attack against you, the attacking creature takes 1d4 piercing damage \plus1d per two nature power.
        ...
        In addition to your previous options, you can also choose from among the aspects below.
        {
            ...
            % When a creature within \rngmed range of you attacks you, the attacking creature takes 1d6 damage per two nature power of either cold, electricity, or fire damage.
            ...
            However, you take a \minus2 penalty to Strength, which offsets the bonus you gain for increasing your size.
            This is a \glossterm{Sizing} effect.
            \subcf{Wolfpack}
...
\section{Fighter}\label{Fighter}
    ...
    \subsection{Equipment Training}
        ...
        In addition, you treat body armor as if it were an additional encumbrance category lighter than normal when doing so would be beneficical for you.
...
\section{Mage}\label{Mage}
    ...
    \subsection{Arcane Lore}
        ...
        \subparhead{Sorcerer} When you resist a spell with your \glossterm{magic resistance}, you gain the ability to cast that spell once.
    ...
    \subsection{Arcane Spell Mastery}
        ...
        You gain your choice of one of the following abilities.
        {
            ...
            \parhead{Spell Knowledge} You learn an additional arcane spell.
                You can choose this ability multiple times, learning an additional spell each time.
            \parhead{Subspell Knowledge} You learn an additional \glossterm{subspell} for an arcane spell you know.
    ...
    \subsection{Ki}
        ...
        You cannot use more than one \textit{ki manifestation} per round.
        {
            ...
            \begin{ability}{Flash Step}[\glossterm{Teleportation}]
                ...
                When you move, you can teleport horizontally up to ten feet instead.
...
\section{Paladin}\label{Paladin}
    ...
    \subsection{Devoted Paragon}
        ...
        \subparhead{Chaos} When you or an ally in the area rolls a 1 on an attack roll when making a \glossterm{strike}, the creature can reroll the die.
        ...
        \subparhead{Good} When a creature in the area takes damage, you may take half that damage (rounded down) instead.
        Any abilities you have that would reduce or negate the effects of the attack have no effect.
        ...
        \subparhead{Law} When you or an ally in the area rolls a 1 on an attack roll when making a \glossterm{strike}, the attack roll is treated as a 6.
    ...
    \subsection{Huntmaster}
        ...
        When you use your \textit{quarry} ability, you may also use one of your \textit{hunting styles}.
        {
            ...
            \begin{ability}{Merciless}
                When your \glossterm{hunting party} deals damage to your quarry, any damage in excess of its remaining hit points is dealt as \glossterm{vital damage}.
...
\section{Rogue}\label{Rogue}
    ...
    \subsection{Jack of All Trades}
        ...
        \cf{Rog}[7]{Legendary Fortune} When you make a skill attack or check, you roll two dice and take either result.
...
\section{Warlock}\label{Warlock}
    ...
    \subsection{Pact Spellcasting}
        ...
        When you learn a pact spell, you automatically learn one 1st level \glossterm{subspell} of your choice for that spell.
        ...
        When you cast a pact spell while using \glossterm{armor}, you must roll 1d10.
        ...
        \end{itemize}
        When you gain access to a new spell level, you may change which pact augments you know.
