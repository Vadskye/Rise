...
\end{dtabularx}
    ...
    \subsection{Battleforged Resilience}
        ...
        \cf{Bbn}[2]{Battleforged Endurance} You gain a \plus1 bonus to your \glossterm{fatigue tolerance}, and a \plus1 bonus to \glossterm{vital rolls}.
        ...
        \cf{Bbn}[5]{Greater Battleforged Endurance} The bonuses from your \textit{battleforged endurance} ability increases to \plus2.
    ...
    \subsection{Primal Warrior}
...

        {
            ...
            You gain access to three primal \glossterm{combat styles} (see \pcref{Primal Combat Styles}).
...
\end{dtabularx}
    ...
    \subsection{Martial Mastery}
...

        {
            ...
            You gain access to three martial \glossterm{combat styles} (see \pcref{Martial Combat Styles}).
...
\end{dtabularx}
    ...
    \subsection{Esoteric Warrior}\label{Esoteric Warrior}
...

        {
            ...
            You gain access to three esoteric \glossterm{combat styles} (see \pcref{Esoteric Combat Styles}).
...
\end{dtabularx}
    ...
    \subsection{Wild Warrior}
...

        {
            ...
            You gain access to three wild \glossterm{combat styles} (see \pcref{Wild Combat Styles}).
...
\end{dtabularx}
    ...
    \subsection{Combat Trickster}
...

        {
            ...
            You gain access to three trick \glossterm{combat styles} (see \pcref{Trick Combat Styles}).
...
\end{dtabularx}
    ...
    \subsection{Alchemist}
        ...
        \cf{Wiz}[0]{Alchemical Infusion} Whenever you create or use an alchemical item, you may use your \glossterm{magical} \glossterm{power} in place of the item's normal power to determine its effects.
        In addition, you may add your magical power to the damage dealt by any alchemical items you use in place of the item's normal damage modifier.
        This does not affect the damage dice rolled by the item.
        ...
        \cf{Wiz}[3]{Alchemical Precision} You gain a \plus1 bonus to accuracy with alchemical items.
        In addition, increase the distance that you can throw any thrown alchemical item by 30 feet.
        ...
        \cf{Wiz}[6]{Greater Alchemical Precision} The accuracy bonus from your \textit{greater alchemical infusion} ability increases to \plus2.
        In addition, the distance increase from your \textit{alchemical precision} ability increases to 60 feet.
