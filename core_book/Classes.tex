    ...
    \subsection{Battlerager}\label{Rage}
        ...
        \begin{attuneability}{Rage}[\glossterm{Emotion}, \glossterm{Attune} (self), \glossterm{Swift}]
            ...
            \begin{itemize}
                ...
                \item At the end of each round, if you did not make a physical attack that round, this ability ends.
                    If this ability ends this way, you do not regain the \glossterm{action point} spent to \glossterm{attune} to it.
            \end{itemize}
        \end{attuneability}
...
\section{Fighter}\label{Fighter}
    ...
    \subsection{Combat Discipline}
        ...
        \cf{Ftr}[8]{Supreme Discipline}
        Your \textit{discipline} ability gains the \glossterm{Swift} tag.
        When you use it, the penalties from the removed condition do not affect you during the current phase.
        In addition, the ability removes any number of conditions.
    ...
    \subsection{Ki}
        ...
        You cannot use more than one \textit{ki manifestation} per round.
        {
            \begin{freeability}{Abandon the Fragile Self}
                ...
                \rankline
                \rank{3} You ignore the first two conditions that would be applied to you this round.
                \rank{5} You ignore the first three conditions that would be applied to you this round.
