...
\section{Barbarian}\label{Barbarian}
    \begin{dtable!*}
        ...
        \begin{dtabularx}{\textwidth}{l l l >{\lcol}X >{\lcol}X >{\lcol}X >{\lcol}X}
            ...
            2 & 2  & Toughened body                 & Seething anger         & Fast movement            & Maneuver rank (2), primal lore         \\
            3 & 5  & Battle-scarred                 & Powerful anger         & Savage precision         & Maneuver rank (3), primal force         \\
            4 & 8  & Greater battleforged endurance & Greater rage           & Savage instincts         & Maneuver rank (4), primal maneuver      \\
            5 & 11 & Greater toughened body         & Greater seething anger & Greater fast movement    & Maneuver rank (5), greater primal lore  \\
            6 & 14 & Greater battle-scarred         & Greater powerful anger & Greater savage precision & Maneuver rank (6), greater primal force \\
            7 & 17 & Supreme battleforged endurance & Supreme rage           & Greater savage instincts & Maneuver rank (7), primal maneuver      \\
    ...
    \subsection{Primal Warrior}
        ...
        \cf{Bbn}[3]{Primal Force} You gain a \plus1 bonus to Strength-based \glossterm{checks} and Constitution-based \glossterm{checks}.
        ...
        \cf{Bbn}[5]{Greater Primal Lore} You gain two additional \glossterm{skill points}.
        ...
        \cf{Bbn}[6]{Greater Primal Force} The bonuses from your \textit{primal force} ability increase to \plus2.
...
\section{Cleric}\label{Cleric}
    \begin{dtable!*}
        ...
        \begin{dtabularx}{\textwidth}{l l >{\lcol}X >{\lcol}X >{\lcol}X >{\lcol}X}
            ...
            2 & 2  & Spell rank (2)                       & Insightful caster           & Domain gift          & Vital healer           \\
            ...
            5 & 11 & Spell rank (5)                       & Greater insightful caster   & Domain essence       & Greater vital healer   \\
...
\section{Druid}\label{Druid}
    \begin{dtable!*}
        ...
        \begin{dtabularx}{\textwidth}{l l >{\lcol}X >{\lcol}X l >{\lcol}X >{\lcol}X}
            ...
            2 & 2  & Elemental magic           & Spell rank (2)                       & Combat caster               & Shifting defense           & Animal speech           \\
            ...
            5 & 11 & Elemental spell           & Spell rank (5)                       & Greater combat caster       & Greater shifting defense   & Plant speech            \\
...
\section{Fighter}\label{Fighter}
    \begin{dtable!*}
        ...
        \begin{dtabularx}{\textwidth}{l l >{\lcol}X >{\lcol}X >{\lcol}X >{\lcol}X}
            ...
            2 & 2  & Enduring discipline         & Weapon training              & Maneuver rank (2), martial lore                & Tactical advice               \\
            3 & 5  & Disciplined power           & Equipment efficiency         & Maneuver rank (3), defensive expertise         & Tactical coordination         \\
            4 & 8  & Disciplined reaction        & Greater armor expertise      & Maneuver rank (4), martial maneuver            & Battle tactic                 \\
            5 & 11 & Greater enduring discipline & Weapon expertise             & Maneuver rank (5), greater martial lore        & Greater battle tactics        \\
            6 & 14 & Greater disciplined power   & Greater equipment efficiency & Maneuver rank (6), greater defensive expertise & Greater tactical coordination \\
            7 & 17 & Disciplined vitality        & Supreme armor expertise      & Maneuver rank (7), martial maneuver            & Battle tactic                 \\
    ...
    \subsection{Martial Mastery}
        ...
        \cf{Ftr}[2]{Martial Lore} You gain two additional \glossterm{skill points}.

        \cf*{Ftr}[3]{Maneuver Rank}[Magical] You become a rank 3 martial maneuverist.
        This can improve the effectiveness of your maneuvers and give you access to maneuvers that require a minimum rank of 3.

        \cf{Ftr}[3]{Defensive Expertise} You gain a \plus1 bonus to Armor defense.
        ...
        \cf{Ftr}[5]{Greater Martial Lore} You gain two additional \glossterm{skill points}.
...
\section{Monk}\label{Monk}
    \begin{dtable!*}
        ...
        \begin{dtabularx}{\textwidth}{l l >{\lcol}X >{\lcol}X >{\lcol}X >{\lcol}X}
            ...
            2 & 2  & Maneuver rank (2), esoteric lore             & Ki strike                     & Perfect body                   & Transcend frailty     \\
            3 & 5  & Maneuver rank (3), esoteric fluidity         & Ki power                      & Perfect precision              & Inner peace           \\
            4 & 8  & Maneuver rank (4), esoteric maneuver         & Ki manifestation              & Greater fast movement          & Feel the flow of life \\
            5 & 11 & Maneuver rank (5), greater esoteric lore     & Greater ki barrier            & Greater perfect body           & Transcend flesh       \\
            6 & 14 & Maneuver rank (6), greater esoteric fluidity & Greater ki power              & Greater perfect precision      & Greater inner peace   \\
            7 & 17 & Maneuver rank (7), esoteric maneuver         & Ki manifestation              & Supreme fast movement          & See the flow of life  \\
    ...
    \subsection{Esoteric Warrior}\label{Esoteric Warrior}
        ...
        \cf{Mnk}[3]{Esoteric Fluidity} You gain a \plus1 bonus to Dexterity-based \glossterm{checks}, except \glossterm{initiative} checks.
        ...
        \cf{Mnk}[5]{Greater Esoteric Lore} You gain two additional \glossterm{skill points}.
...
\section{Paladin}\label{Paladin}
    \begin{dtable!*}
        ...
        \begin{dtabularx}{\textwidth}{l l >{\lcol}X >{\lcol}X >{\lcol}X >{\lcol}X >{\lcol}X}
            ...
            2 & 2  & Aligned immunity      & Spell rank (2) & Combat caster               & Enduring defender           & Zealous offense          \\
            ...
            5 & 11 & Devoted mind          & Spell rank (5) & Greater combat caster       & Greater enduring defender   & Pass judgment            \\
            ...
            8 & 20 & Epic paragon          & Spell rank (8) & Epic divine expertise       & Epic guardian               & Epic zeal                \\
        \end{dtabularx}
    \end{dtable!*}
    ...
    \subsection{Divine Magic}
        ...
        \cf{Pal}[8]{Epic Spell Knowledge} You learn two additional divine spells.
...
\section{Ranger}\label{Ranger}
    \begin{dtable!*}
        ...
        \begin{dtabularx}{\textwidth}{l l >{\lcol}X >{\lcol}X >{\lcol}X > {\lcol}X}
            ...
            2 & 2  & Handling lore            & Hunting style              & Farsight                  & Maneuver rank (2), wild lore            \\
            3 & 5  & Pack tactics             & Hunter's instincts         & Perceive weakness         & Maneuver rank (3), wild force           \\
            4 & 8  & Greater animal companion & Tracker                    & Blindsight                & Maneuver rank (4), wild maneuver        \\
            5 & 11 & Greater handling lore    & Hunting style              & Greater farsight          & Maneuver rank (5), greater wild lore    \\
            6 & 14 & Greater pack tactics     & Greater hunter's instincts & Greater perceive weakness & Maneuver rank (6), greater wild force   \\
            7 & 17 & Supreme animal companion & Greater tracker            & Greater blindsight        & Maneuver rank (7), wild maneuver        \\
    ...
    \subsection{Wilderness Warrior}
        ...
        \cf{Rgr}[3]{Wild Senses} You gain a \plus1 bonus to Perception-based checks, except \glossterm{initiative} checks.
        ...
        \cf{Rgr}[5]{Greater Wild Lore} The bonus to Perception-based checks from your \textit{wild lore} ability increases to \plus3.
...
\section{Rogue}\label{Rogue}
    \begin{dtable!*}
        ...
        \begin{dtabularx}{\textwidth}{l l >{\lcol}X >{\lcol}X >{\lcol}X >{\lcol}X}
            ...
            2 & 2  & Evasion                     & Bardic lore            & Maneuver rank (3), trick lore             & Dabbler                 \\
            3 & 5  & Darkstalker                 & Bardic combat training & Maneuver rank (3), tricky agility         & Versatile power         \\
            4 & 8  & Hide in plain sight         & Bardic performance     & Maneuver rank (3), trick manuever         & Skill exemplar          \\
            5 & 11 & Greater evasion             & Dual performance       & Maneuver rank (3), greater trick lore     & Greater dabbler         \\
            6 & 14 & Assassination               & Loremaster             & Maneuver rank (3), greater tricky agility & Greater versatile power \\
            7 & 17 & Greater hide in plain sight & Bardic performance     & Maneuver rank (3), trick maneuver         & Greater skill exemplar  \\
            8 & 20 & Epic assassin               & Epic bardic            & Maneuver rank (3), epic trickster         & Master of all trades    \\
        \end{dtabularx}
    \end{dtable!*}
    ...
    \subsection{Combat Trickster}
        ...
        \cf{Rog}[3]{Tricky Agility} You gain a \plus1 bonus to Dexterity-based checks, except \glossterm{initiative} checks.
        ...
        \cf{Rog}[5]{Greater Trick Lore} You gain two additional \glossterm{skill points}.

        \cf*{Rog}[6]{Maneuver Rank}[Magical] You become a rank 6 trick maneuverist.
        This can improve the effectiveness of your maneuvers and give you access to maneuvers that require a minimum rank of 6.

        \cf{Rog}[6]{Greater Tricky Agility} The bonus from your \textit{tricky agility} ability increases to \plus2.
...
\section{Sorcerer}\label{Mage}
    \begin{dtable!*}
        ...
        \begin{dtabularx}{\textwidth}{l l >{\lcol}X >{\lcol}X >{\lcol}X >{\lcol}X >{\lcol}X}
            ...
            2 & 2  & Spell rank (2), mage armor           & Combat caster               & Draconic focus             & Mystic tolerance         & Chaotic miscast, wild soul                  \\
            3 & 5  & Spell rank (3), spell knowledge      & Wellspring of power         & Draconic precision         & Augment                  & Chaotic exertion                            \\
            4 & 8  & Spell rank (4)                       & Mystic insight              & Draconic hide              & Spell absorption         & Controlled chaos                            \\
            5 & 11 & Spell rank (5), greater mage armor   & Greater combat caster       & Draconic heart             & Greater mystic tolerance & Greater chaotic miscast, greater wild  soul \\
            6 & 14 & Spell rank (6), spell knowledge      & Greater wellspring of power & Greater draconic precision & Augment                  & Greater chaotic exertion                    \\
    ...
    \subsection{Arcane Magic}
        ...
        \cf{Sor}[3]{Spell Knowledge} You learn an additional arcane \glossterm{spell}.
        ...
        In addition, the bonus to \glossterm{resistances} against \glossterm{energy damage} increases to be equal to your level.

        \cf*{Sor}[6]{Spell Rank}[Magical] You become a rank 6 arcane spellcaster.
        This can improve the effectiveness of your spells and give you access to spells that require a minimum rank of 6.

        \cf*{Sor}[6]{Spell Knowledge} You learn an additional arcane \glossterm{spell}.
...
\section{Warlock}\label{Warlock}
    \begin{dtable!*}
        ...
        \begin{dtabularx}{\textwidth}{l l >{\lcol}X >{\lcol}X >{\lcol}X >{\lcol}X}
            ...
            2 & 2  & Fiendish resistance          & Spell rank (2), armor tolerance         & Combat caster               & Empowering whispers         \\
            ...
            5 & 11 & Greater fiendish resistance  & Spell rank (5), greater armor tolerance & Greater combat caster       & Greater empowering whispers \\
            ...
            8 & 20 & Abyssal apotheosis           & Spell rank (8)                          & Epic pact mastery           & Epic possession             \\
        \end{dtabularx}
    \end{dtable!*}
    ...
    \subsection{Pact Magic}
        ...
        \cf{War}[3]{Spell Knowledge} You learn an additional pact \glossterm{spell}.
...
\section{Wizard}\label{Wizard}
    ...
    \subsection{Arcane Magic}
        ...
        \cf{Wiz}[3]{Spell Knowledge} You learn an additional arcane \glossterm{spell}.
        ...
        \cf{Wiz}[6]{Spell Knowledge} You learn an additional arcane \glossterm{spell}.
        ...
        \cf{Wiz}[8]{Epic Spell Knowledge} You learn two additional pact spells.
