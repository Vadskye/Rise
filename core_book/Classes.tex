...
\section{Cleric}\label{Cleric}
    ...
    \subsection{Divine Spell Mastery}
        ...
        \cf{Clr}[2]{Expanded Spell Knowledge}
        You learn an additional divine spell (see \pcref{Divine Spells}).
        In addition, you gain the ability to perform divine rituals to create unique magical effects (see \pcref{Rituals}).
        ...
        \cf{Clr}[4]{Spell Mastery}
        You gain a \plus1 bonus to \glossterm{spellpower} with divine spells.
        ...
        \cf{Clr}[7]{Greater Spell Mastery} 
        The bonus from your \textit{spell mastery} ability increases to \plus2.
...
\section{Druid}\label{Druid}
    ...
    \subsection{Nature Spell Mastery}
        ...
        \cf{Drd}[2]{Expanded Spell Knowledge}
        You learn an additional nature spell (see \pcref{Nature Spells}).
        In addition, you gain the ability to perform nature rituals to create unique magical effects (see \pcref{Rituals}).
        ...
        \cf{Drd}[4]{Spell Mastery}
        You gain a \plus1 bonus to \glossterm{spellpower} with nature spells.
        ...
        \cf{Drd}[7]{Greater Spell Mastery} 
        The bonus from your \textit{spell mastery} ability increases to \plus2.
...
\section{Mage}\label{Mage}
    ...
    \subsection{Arcane Spell Mastery}
        ...
        \cf{Mge}[2]{Expanded Spell Knowledge}
        You learn an additional arcane spell (see \pcref{Arcane Spells}).
        In addition, you gain an additional ability depending on your \textit{arcane essence}.
        \subparhead{Sorcerer} You learn an additional \glossterm{subspell}.
        \subparhead{Wizard} You gain the ability to perform arcane rituals to create unique magical effects (see \pcref{Rituals}).
        ...
        \cf{Mge}[7]{Greater Spell Mastery} 
        The bonus from your \textit{spell mastery} ability increases to \plus2.
