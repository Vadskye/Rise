    ...
    \subsection{Divine Spell Mastery}
        ...
        You gain your choice of one of the following abilities.
        {
            ...
            \parhead{Mystic Sphere Access} You gain access to an additional divine \glossterm{mystic sphere} (see \pcref{Divine Mystic Spheres}).
                You can choose this ability multiple times, gaining access to an additional mystic sphere each time.
        }
...
\section{Paladin}\label{Paladin}
    ...
    \subsection{Devoted Paragon}
        ...
        \subparhead{Evil} When a target takes damage, it increases that damage by an amount equal to half your \glossterm{power}.
        ...
        \subparhead{Evil} The damage increases to be equal to your \glossterm{power}.
    ...
    \subsection{Zealous Warrior}
        ...
        \cf{Pal}[5]{Zealous Offense} You gain a \plus1 bonus to \glossterm{accuracy} with \glossterm{physical attacks}.
        ...
        The \glossterm{threat} bonus from your \textit{unfaltering champion} ability increases to \plus4.
