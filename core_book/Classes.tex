...
\section{Barbarian}\label{Barbarian}
    \begin{dtable!*}
        ...
        \begin{dtabularx}{\textwidth}{l l l >{\lcol}X >{\lcol}X >{\lcol}X >{\lcol}X}
            ...
            2 & 2  & Toughened body                 & Seething anger         & Fast movement            & Maneuver rank (2), primal maneuver      \\
            3 & 5  & Battle-scarred                 & Powerful anger         & Savage precision         & Maneuver rank (3), primal lore          \\
            4 & 8  & Greater battleforged endurance & Greater rage           & Savage instincts         & Maneuver rank (4), primal force         \\
            5 & 11 & Greater toughened body         & Greater seething anger & Greater fast movement    & Maneuver rank (5), primal maneuver      \\
            6 & 14 & Greater battle-scarred         & Greater powerful anger & Greater savage precision & Maneuver rank (6), primal endurance     \\
            7 & 17 & Supreme battleforged endurance & Supreme rage           & Greater savage instincts & Maneuver rank (7), greater primal force \\
            8 & 20 & Epic resilience                & Epic rage              & Epic savagery            & Maneuver rank (8), epic primality       \\
        \end{dtabularx}
    \end{dtable!*}
    ...
    \subsection{Battleforged Resilience}
        ...
        \cf{Bbn}[2]{Toughened Body} You gain a \plus2 bonus to Fortitude defense and a \plus1 bonus to \glossterm{vital rolls}.
        ...
        \cf{Bbn}[4]{Greater Battleforged Endurance} The number of hit points granted by your \textit{battleforged endurance} ability increases to 4.

        \cf{Bbn}[5]{Greater Toughened Body} The Fortitude bonus from your \textit{toughened body} ability increases to \plus4.
        In addition, the bonus to \glossterm{vital rolls} increases to \plus2.

        \cf{Bbn}[6]{Greater Battle-Scarred}
        The bonus from your \textit{battle-scarred} ability increases to be equal to your level.

        \cf{Bbn}[7]{Supreme Battleforged Endurance} The number of hit points granted by your \textit{battleforged endurance} ability increases to 6.

        \cf{Bbn}[8]{Epic Resilience} You gain a bonus equal to your level to \glossterm{resistances}.
    ...
    \subsection{Battlerager}\label{Rage}
        ...
        \begin{attuneability}{Rage}[\glossterm{Emotion}, \glossterm{Attune} (self), \glossterm{Swift}]
            ...
            \begin{itemize}
                \item You increase your current \glossterm{hit points} by four.
                    This can allow your current hit points to exceed your normal maximum hit points.
                    When this ability ends, you lose four hit points.
        ...
        \cf{Bbn}[3]{Powerful Anger} You gain a \plus1 bonus to \glossterm{power} with \glossterm{mundane} abilities.

        \cf{Bbn}[4]{Greater Rage} The bonus to \glossterm{power} from your \textit{rage} ability increases to \plus4.

        \cf{Bbn}[5]{Greater Seething Anger} The bonuses from your \textit{seething anger} ability increase to \plus4.

        \cf{Bbn}[5]{Greater Powerful Anger} The bonus from your \textit{powerful anger} ability increases to \plus2.

        \cf{Bbn}[7]{Supreme Rage} The bonus to \glossterm{power} from your \textit{rage} ability increases to \plus6.

        \cf{Bbn}[8]{Epic Rage} Your \textit{rage} ability loses the \glossterm{Attune} (self) tag and gains the \glossterm{Sustain} (free) tag, allowing you to more easily enter and exit your rage.
        Your \textit{rage} ability also no longer imposes defense penalties.
        In addition, when you use your \textit{rage} ability, you can grow by one \glossterm{size category}.

        \subection{Outland Savage}
        This archetype improves your mobility and combat prowess with direct, brutal abilities.

        \cf{Bbn}[1]{Exotic Weaponry} You gain proficiency with improvised weapons (see \pcref{Improvised Weapons}).
        In addition, you gain proficiency with \glossterm{exotic weapons} from all weapon groups you are proficient with.

        \cf{Bbn}[2]{Fast Movement} You gain a \plus10 foot bonus to your \glossterm{base speed}.

        \cf{Bbn}[3]{Savage Precision} You gain a \plus2 bonus to \glossterm{accuracy} with the \textit{dirty trick}, \textit{disarm}, \textit{grapple}, \textit{overrun}, \textit{shove}, and \textit{trip} abilities (see \pcref{Special Combat Abilities}).
        In addition, you gain a \plus2 bonus to \glossterm{accuracy} with grapple actions (see \pcref{Grapple Actions}).
        ...
        \cf{Bbn}[6]{Greater Savage Precision} The bonuses from your \textit{savage precision} ability increase to \plus3.

        \cf{Bbn}[7]{Greater Savage Instincts} The bonuses from your \textit{savage instincts} ability increase to \plus4.

        \cf{Bbn}[8]{Epic Savagery} The bonuses from your \textit{savage precision} and \textit{savage instincts} abilities increase to \plus6.
        In addition, the speed bonus from your \textit{fast movement} ability increases to \plus30 feet.
    ...
    \subsection{Primal Warrior}
        ...
        {
            \cf{Bbn}[2]{Maneuver Rank}[Magical] You become a rank 2 primal maneuverist.
            This gives you access to maneuvers that require a minimum rank of 2.

            \cf{Bbn}[2]{Primal Maneuver}
            You learn an additional primal \glossterm{maneuver} (see \pcref{Primal Maneuvers}).
        }

        {
            \cf*{Bbn}[3]{Maneuver Rank}[Magical] You become a rank 3 primal maneuverist.
            This can improve the effectiveness of your maneuvers and give you access to maneuvers that require a minimum rank of 3.

            \cf{Bbn}[3]{Primal Lore} You gain two additional \glossterm{skill points}.
        }

        {
            \cf*{Bbn}[4]{Maneuver Rank}[Magical] You become a rank 4 primal maneuverist.
            This can improve the effectiveness of your maneuvers and give you access to maneuvers that require a minimum rank of 4.

            \cf{Bbn}[4]{Primal Force} You gain a \plus1 bonus to Strength-based \glossterm{checks} and Constitution-based \glossterm{checks}.
        }

        {
            \cf*{Bbn}[5]{Maneuver Rank}[Magical] You become a rank 5 primal maneuverist.
            This can improve the effectiveness of your maneuvers and give you access to maneuvers that require a minimum rank of 5.
        ...
        {
            \cf*{Bbn}[6]{Maneuver Rank}[Magical] You become a rank 6 primal maneuverist.
            This can improve the effectiveness of your maneuvers and give you access to maneuvers that require a minimum rank of 6.

            \cf{Bbn}[6]{Primal Endurance} You gain a +2 bonus to Fortitude defense.
        }

        {
            \cf*{Bbn}[7]{Maneuver Rank}[Magical] You become a rank 7 primal maneuverist.
            This can improve the effectiveness of your maneuvers and give you access to maneuvers that require a minimum rank of 7.

            \cf{Bbn}[7]{Greater Primal Force} The bonuses from your \textit{primal force} ability increase to \plus2.
        }

        {
            \cf*{Bbn}[8]{Maneuver Rank}[Magical] You become a rank 8 primal maneuverist.
            This can improve the effectiveness of your maneuvers and give you access to maneuvers that require a minimum rank of 8.

            \cf{Bbn}[8]{Epic Primality} The bonuses from your \textit{primal force} ability increase to \plus5.
            In addition, you learn an additional primal \glossterm{maneuver}.
        }
...
\section{Cleric}\label{Cleric}
    \begin{dtable!*}
        ...
        \begin{dtabularx}{\textwidth}{l l >{\lcol}X >{\lcol}X >{\lcol}X >{\lcol}X}
            ...
            2 & 2  & Spell rank (2), spell knowledge      & Insightful caster           & Domain gift          & Vital healer           \\
            ...
            5 & 11 & Spell rank (5), spell knowledge      & Greater insightful caster   & Domain essence       & Greater vital healer   \\
            ...
            8 & 20 & Spell rank (8), epic spell knowledge & Epic divine mastery         & Domain masteries     & Epic healer            \\
        \end{dtabularx}
    \end{dtable!*}
    ...
    \subsection{Divine Magic}
        ...
        You cannot learn spells from mystic spheres you do not have access to.
        ...
        \cf{Clr}[8]{Epic Spell Knowledge} You learn two additional divine spells.
    ...
    \subsection{Divine Spell Mastery}
        ...
        {
            \parhead{Divine Guidance} Once per \glossterm{long rest}, you may use the \textit{desperate exertion} ability without spending an \glossterm{action point} to affect a divine spell you cast (see \pcref{Desperate Exertion}).
        ...
        \cf{Clr}[2]{Insightful Caster} You gain access to an additional divine \glossterm{mystic sphere}, including all \glossterm{cantrips} from that sphere.
        ...
        \cf{Clr}[8]{Epic Divine Mastery} The bonus from your \textit{wellspring of power} ability increases to \plus6.
        In addition, you gain an additional \textit{mystic insight} ability.
    ...
    \subsection{Healer}
        ...
        \begin{apability}{Divine Healing}[\glossterm{Magical}]
            \target{Yourself or a living \glossterm{ally} within \glossterm{reach}.}
            The target gains a \plus5 bonus to the \glossterm{vital roll} for one of its \glossterm{vital wounds}.
        ...
        \cf{Clr}[8]{Epic Healer} The bonus from your \textit{healer's grace} ability increases to \plus4.
        In addition, the number of hit points regained by all of your abilities increases by one.
        Each ability can only gain this benefit once, so abilities that automatically restore hit points each round only regain an additional hit point in the first round.
    ...
    \subsection{Cleric Domain Abilities}\label{Cleric Domain Abilities}
        ...
        \subsubsection{Destruction}
            ...
            \begin{freeability}{Destructive Attack}
                ...
                \rank{5} The damage bonus increases to \plus4d, and the attack deals double damage to objects.
            ...
            \end{freeability}
            \parhead{Mastery} You gain a \plus3 bonus to \glossterm{power}.
        ...
        \subsubsection{Good}
            ...
            \begin{freeability}{Compel Good}[\glossterm{Compulsion}]
                ...
                You have no control over the act the creature takes, but circumstances can make the target more likely to take an action you desire.
            \end{freeability}
            \parhead{Mastery} Once per round, when an \glossterm{ally} within a \areahuge radius \glossterm{emanation} from you loses one or more \glossterm{hit points}, you may lose a single hit point instead.
        ...
        \subsubsection{Life}
            ...
            \parhead{Mastery} You gain a \plus2 bonus to your base Constitution.
        ...
        \subsubsection{Magic}
            ...
            \parhead{Mastery} The power bonus from this domain's gift increases to \plus3.
            You learn an additional \glossterm{augment} (see \pcref{Augments}).
        ...
        \subsubsection{Protection}
            ...
            \parhead{Mastery} The bonus from this domain's essence ability increases to \plus2, and it applies to all defenses instead of only Armor defense.
        ...
        \subsubsection{War}
            ...
            \parhead{Mastery} You gain a \plus1 bonus to \glossterm{accuracy} and \glossterm{power}.
        ...
        \subsubsection{Water}
            ...
            \parhead{Gift} You gain a \plus4 \glossterm{magic bonus} to the Flexibility and Swim skills.
...
\section{Druid}\label{Druid}
    \begin{dtable!*}
        ...
        \begin{dtabularx}{\textwidth}{l l >{\lcol}X >{\lcol}X l >{\lcol}X >{\lcol}X}
            ...
            2 & 2  & Elemental magic           & Spell rank (2), spell knowledge      & Combat caster               & Shifting defense           & Animal speech           \\
            ...
            5 & 11 & Elemental spell           & Spell rank (5), spell knowledge      & Greater combat caster       & Greater shifting defense   & Plant speech            \\
            ...
            8 & 20 & Avatar of elements        & Spell rank (8), epic spell knowledge & Epic nature mastery         & Wild fusion                & Twin servant            \\
        \end{dtabularx}
    \end{dtable!*}
    ...
    \subsection{Elementalist}\label{Elementalist}
        ...
        \cf{Drd}[8]{Avatar of Elements} You gain access to the three elemental \glossterm{mystic spheres} that you did not choose with your \textit{elemental magic} ability.
        In addition, you learn one additional spell from each of those three mystic spheres.
    ...
    \subsection{Nature Spell Mastery}
        ...
        You gain your choice of one of the following abilities.
        {
            ...
            \parhead{Insight Point} You gain an additional \glossterm{insight point}.
                You can choose this ability multiple times, gaining an additional insight point each time.
            \parhead{Natural Spells} Your spells ignore \glossterm{cover} and \glossterm{concealment} provided by living plants, including \glossterm{total cover}.
                This does not allow you to see targets through plants.
                You cannot choose this ability multiple times.
            \parhead{Greater Natural Spells} Whenever you cast a nature spell, you may choose a living plant within \rngmed range of you.
                If you do, you treat that plant as being the origin of that spell.
                This allows you to measure the spell's range from the plant's location, and spells that affect an area around the caster measure their area from the plant's location instead of your own.
                You must have the Natural Spells \textit{mystic insight} ability to choose this ability.
                You cannot choose this ability multiple times.
        ...
        \cf{Drd}[2]{Combat Caster} You reduce your \glossterm{focus penalties} by 2.
        ...
        \cf{Drd}[5]{Greater Combat Caster} You gain a \plus1 bonus to Armor defense and Reflex defense.
        ...
        \cf{Drd}[8]{Epic Nature Mastery} The bonus from your \textit{wellspring of power} ability increases to \plus6.
        In addition, you gain an additional \textit{mystic insight} ability.
    ...
    \subsection{Shifter}\label{Shifter}
        ...
        \cf{Drd}[8]{Wild Fusion} You can have two \textit{wild aspect} abilities active simultaneously.
    ...
    \subsection{Wildspeaker}\label{Wildspeaker}
        ...
        \cf{Drd}[8]{Twin Servant} You may acquire an additional \textit{natural servant}, attuning to each ability separately.
...
\section{Fighter}\label{Fighter}
    \begin{dtable!*}
        ...
        \begin{dtabularx}{\textwidth}{l l >{\lcol}X >{\lcol}X >{\lcol}X >{\lcol}X}
            ...
            2 & 2  & Enduring discipline         & Weapon training              & Maneuver rank (2), martial maneuver            & Tactical advice               \\
            3 & 5  & Disciplined power           & Equipment efficiency         & Maneuver rank (3), martial endurance           & Tactical coordination         \\
            4 & 8  & Disciplined reaction        & Greater armor expertise      & Maneuver rank (4), defensive expertise         & Battle tactic                 \\
            5 & 11 & Greater enduring discipline & Weapon expertise             & Maneuver rank (5), martial maneuver            & Greater battle tactics        \\
            6 & 14 & Greater disciplined power   & Greater equipment efficiency & Maneuver rank (6), greater martial endurance   & Greater tactical coordination \\
            7 & 17 & Disciplined vitality        & Supreme armor expertise      & Maneuver rank (7), greater defensive expertise & Battle tactic                 \\
            8 & 20 & Epic discipline             & Equipment supremacy          & Maneuver rank (8), epic martialist             & Tactical fusion               \\
        \end{dtabularx}
    \end{dtable!*}
    ...
    \subsection{Combat Discipline}
        ...
        \cf{Ftr}[3]{Disciplined Power} You gain a \plus1 bonus to \glossterm{power} with \glossterm{mundane} abilities.
        ...
        The number of hit points you gain from your \textit{enduring discipline} ability increases to 4.

        \cf{Ftr}[6]{Greater Disciplined Power} The bonus from your \textit{disciplined power} ability increases to \plus2.

        \cf{Ftr}[7]{Disciplined Vitality}
        ...
        \cf{Ftr}[8]{Epic Discipline} You are immune to \glossterm{conditions}.
    ...
    \subsection{Equipment Training}
        ...
        \begin{freeability}{Weapon Training}
            ...
            If the weapon is not an exotic weapon, you gain a \plus1 bonus to \glossterm{accuracy} with the weapon.
        ...
        \cf{Ftr}[3]{Equipment Efficiency} You gain an additional \glossterm{action point}.
        You can only use this action point to \glossterm{attune} to magic weapons and magic armor.
        ...
        \cf{Ftr}[6]{Greater Equipment Efficiency} The number of action points you gain from your \textit{efficient equipment} ability increases to two.
        In addition, you can use the ability to attune to any magic item, not just weapons and armor.
        ...
        \cf{Ftr}[8]{Equipment Supremacy} The bonus from your \textit{weapon expertise} ability increases to \plus2.
        In addition, the number of action points you gain from your \textit{efficient equipment} ability increases to three.
    ...
    \subsection{Martial Mastery}
        ...
        \cf{Ftr}[2]{Maneuver Rank}[Magical] You become a rank 2 martial maneuverist.
        This gives you access to maneuvers that require a minimum rank of 2.

        \cf{Ftr}[2]{Martial Maneuver}
        You learn an additional martial \glossterm{maneuver} (see \pcref{Martial Maneuvers}).

        \cf*{Ftr}[3]{Maneuver Rank}[Magical] You become a rank 3 martial maneuverist.
        This can improve the effectiveness of your maneuvers and give you access to maneuvers that require a minimum rank of 3.

        \cf{Ftr}[3]{Martial Endurance} You gain a \plus1 bonus to Fortitude and Mental defense.

        \cf*{Ftr}[4]{Maneuver Rank}[Magical] You become a rank 4 martial maneuverist.
        This can improve the effectiveness of your maneuvers and give you access to maneuvers that require a minimum rank of 4.

        \cf{Ftr}[4]{Defensive Expertise} You gain a \plus1 bonus to Armor defense.

        \cf*{Ftr}[5]{Maneuver Rank}[Magical] You become a rank 5 martial maneuverist.
        This can improve the effectiveness of your maneuvers and give you access to maneuvers that require a minimum rank of 5.

        \cf*{Ftr}[5]{Martial Maneuver}
        You learn an additional martial \glossterm{maneuver} (see \pcref{Martial Maneuvers}).

        \cf*{Ftr}[6]{Maneuver Rank}[Magical] You become a rank 6 martial maneuverist.
        This can improve the effectiveness of your maneuvers and give you access to maneuvers that require a minimum rank of 6.

        \cf{Ftr}[6]{Greater Martial Endurance} The bonus from your \textit{martial endurance} ability increases to \plus2.

        \cf*{Ftr}[7]{Maneuver Rank}[Magical] You become a rank 7 martial maneuverist.
        This can improve the effectiveness of your maneuvers and give you access to maneuvers that require a minimum rank of 7.

        \cf{Ftr}[7]{Greater Defensive Expertise} The bonus from your \textit{defensive expertise} ability increases to \plus2.

        \cf*{Ftr}[8]{Maneuver Rank}[Magical] You become a rank 8 martial maneuverist.
        This can improve the effectiveness of your maneuvers and give you access to maneuvers that require a minimum rank of 8.

        \cf{Ftr}[8]{Epic Martialist} The bonus from your \textit{defensive expertise} ability increases to \plus4.
        In addition, you learn an additional martial \glossterm{maneuver}.
    ...
    \subsection{Tactician}
        ...
        \cf{Ftr}[8]{Tactical Fusion} You can have two \textit{battle tactics} abilities active simultaneously, and you can activate two tactics with the same action.
        Whenever you use a new \textit{battle tactics} ability, you can choose which of your existing tactics to replace.
...
\section{Monk}\label{Monk}
    \begin{dtable!*}
        ...
        \begin{dtabularx}{\textwidth}{l l >{\lcol}X >{\lcol}X >{\lcol}X >{\lcol}X}
            ...
            1 & 1  & Esoteric maneuvers                           & Ki barrier, ki manifestations & Fast movement, unarmed warrior & Clear the mind        \\
            2 & 2  & Maneuver rank (2), esoteric maneuver         & Ki strike                     & Perfect body                   & Transcend frailty     \\
            3 & 5  & Maneuver rank (3), esoteric lore             & Ki power                      & Perfect precision              & Inner peace           \\
            4 & 8  & Maneuver rank (4), esoteric fluidity         & Ki manifestation              & Greater fast movement          & Feel the flow of life \\
            5 & 11 & Maneuver rank (5), esoteric maneuver         & Greater ki barrier            & Greater perfect body           & Transcend flesh       \\
            6 & 14 & Maneuver rank (6), esoteric agility          & Greater ki power              & Greater perfect precision      & Greater inner peace   \\
            7 & 17 & Maneuver rank (7), greater esoteric fluidity & Ki manifestation              & Supreme fast movement          & See the flow of life  \\
            8 & 20 & Maneuver rank (8), esoteric supremacy        & Epic ki                       & Perfection                     & Transcendence         \\
        \end{dtabularx}
    \end{dtable!*}
    ...
    \subsection{Esoteric Warrior}\label{Esoteric Warrior}
        ...
        \cf{Mnk}[2]{Maneuver Rank}[Magical] You become a rank 2 esoteric maneuverist.
        This gives you access to maneuvers that require a minimum rank of 2.

        \cf{Mnk}[2]{Esoteric Maneuver} You learn an additional esoteric \glossterm{maneuver} (see \pcref{Esoteric Maneuvers}).

        \cf{Mnk}[3]{Maneuver Rank}[Magical] You become a rank 3 esoteric maneuverist.
        This can improve the effectiveness of your maneuvers and give you access to maneuvers that require a minimum rank of 3.

        \cf{Mnk}[3]{Esoteric Lore} You gain two additional \glossterm{skill points}.
        ...
        \cf{Mnk}[4]{Maneuver Rank}[Magical] You become a rank 4 esoteric maneuverist.
        This can improve the effectiveness of your maneuvers and give you access to maneuvers that require a minimum rank of 4.

        \cf{Mnk}[4]{Esoteric Fluidity} You gain a \plus1 bonus to Dexterity-based \glossterm{checks}, except \glossterm{initiative} checks.

        \cf{Mnk}[5]{Maneuver Rank}[Magical] You become a rank 5 esoteric maneuverist.
        This can improve the effectiveness of your maneuvers and give you access to maneuvers that require a minimum rank of 5.

        \cf*{Mnk}[5]{Esoteric Maneuver} You learn an additional esoteric \glossterm{maneuver} (see \pcref{Esoteric Maneuvers}).

        \cf{Mnk}[6]{Maneuver Rank}[Magical] You become a rank 6 esoteric maneuverist.
        This can improve the effectiveness of your maneuvers and give you access to maneuvers that require a minimum rank of 6.

        \cf{Mnk}[6]{Esoteric Agility} You gain a \plus2 bonus to Reflex defense.

        \cf{Mnk}[7]{Maneuver Rank}[Magical] You become a rank 7 esoteric maneuverist.
        This can improve the effectiveness of your maneuvers and give you access to maneuvers that require a minimum rank of 7.

        \cf{Mnk}[7]{Greater Esoteric Fluidity} The bonus from your \textit{esoteric fluidity} ability increases to \plus2.

        \cf{Mnk}[8]{Maneuver Rank}[Magical] You become a rank 8 esoteric maneuverist.
        This can improve the effectiveness of your maneuvers and give you access to maneuvers that require a minimum rank of 8.

        \cf{Mnk}[8]{Esoteric Supremacy} The bonus from your \textit{esoteric fluidity} ability increases to \plus5.
        In addition, you learn an additional esoteric \glossterm{maneuver}.
    ...
    \subsection{Ki}
        ...
        \cf{Mnk}[8]{Epic Ki}[Magical] The bonus from your \textit{ki power} ability increases to \plus6.
        In addition, after using a \textit{ki manifestation} ability, you can use another one after the end of the current round instead of the end of the next round.
    ...
    \subsection{Perfected Form}
        ...
        \cf{Mnk}[2]{Perfect Body} You gain a \plus1 bonus to the base value of one physical \glossterm{attribute} of your choice: Strength, Dexterity, or Constitution.

        \cf{Mnk}[3]{Perfect Precision} You gain a \plus1 bonus to \glossterm{accuracy} with attacks using weapons from the monk weapons and unarmed weapons \glossterm{weapon groups}, and to any attack using a free hand.
        ...
        \cf{Mnk}[5]{Greater Perfect Body} The bonus from your \textit{perfect body} ability applies to the base value of all physical attributes, not just the one you chose.

        \cf{Mnk}[6]{Greater Perfect Precision} The bonuses from your \textit{perfect precision} ability increase to \plus2.

        \cf{Mnk}[7]{Supreme Fast Movement} The speed bonus from your \textit{fast movement} ability increases to \plus30 feet.

        \cf{Mnk}[8]{Perfection} You gain a \plus1 bonus to the base value of all of your \glossterm{attributes}.
    ...
    \subsection{Transcendent Sage}
        ...
        \cf{Mnk}[8]{Transcendence} You are immune to \glossterm{conditions}.
...
\section{Paladin}\label{Paladin}
    \begin{dtable!*}
        ...
        \begin{dtabularx}{\textwidth}{l l >{\lcol}X >{\lcol}X >{\lcol}X >{\lcol}X >{\lcol}X}
            ...
            2 & 2  & Aligned immunity      & Spell rank (2), spell knowledge & Combat caster               & Enduring defender           & Zealous offense          \\
            ...
            5 & 11 & Devoted mind          & Spell rank (5), spell knowledge & Greater combat caster       & Greater enduring defender   & Pass judgment            \\
            ...
            8 & 20 & Epic paragon          & Divine spell conduit            & Epic divine expertise       & Epic guardian               & Epic zeal                \\
        \end{dtabularx}
    \end{dtable!*}
    ...
    \subsection{Divine Magic}
        ...
        You automatically learn all \glossterm{cantrips} from any mystic sphere you have access to.
        In addition, you learn one rank 1 \glossterm{spells} from your chosen \glossterm{mystic sphere}.
        You can also spend \glossterm{insight points} to learn one additional divine spell per \glossterm{insight point}.
        You cannot learn spells from mystic spheres you do not have access to.
        Unless otherwise noted in a spell's description, casting a spell requires a \glossterm{standard action}.
        ...
        \cf{Pal}[2]{Spell Knowledge} You learn an additional divine \glossterm{spell} (see \pcref{Divine Spells}).
        ...
        \cf*{Pal}[5]{Spell Knowledge} You learn an additional divine \glossterm{spell} (see \pcref{Divine Spells}).
        ...
        \cf{Pal}[8]{Divine Spell Conduit} You gain a \plus2 bonus to \glossterm{accuracy} with divine spells and a \plus4 bonus to \glossterm{power} with divine spells.
    ...
    \subsection{Divine Spell Expertise}
        ...
        \cf{Pal}[5]{Greater Combat Caster} You gain a \plus1 bonus to Armor defense and Reflex defense.
        ...
        \cf{Pal}[8]{Epic Divine Expertise} The bonus from your \textit{wellspring of power} ability increases to \plus6.
        In addition, the bonus from your \textit{greater battle caster} ability increases to \plus3.
    ...
    \subsection{Stalwart Guardian}
        ...
        \cf{Pal}[8]{Epic Guardian} Whenever you deal damage to a creature, that creature is \glossterm{goaded} by you as a \glossterm{condition}.
        In addition, the bonuses from your \textit{stalwart resilience} ability increase to \plus3.
    ...
    \subsection{Zealous Warrior}
        ...
        \begin{freeability}{Smite}
            ...
            \rank{5} The damage bonus increases to \plus3d. In addition, you may choose to have the smite deal half damage to targets that share your alignment.
            \rank{7} The damage bonus increases to \plus4d. In addition, you may choose to have the smite deal full damage to targets that share your alignment.
        \end{freeability}
        ...
        \cf{Pal}[4]{Zealous Fixation} You roll twice for \glossterm{miss chances} and take your preferred result.
        In addition, you gain a \plus2 bonus to any roll that you use the \textit{desperate exertion} ability on.
        This bonus stacks with the normal \plus2 bonus provided by that ability.

        \cf{Pal}[5]{Pass Judgment}[Magical] You can use the \textit{pass judgment} ability as a \glossterm{minor action}.
        \begin{freeability}{Pass Judgment}
            ...
            \rankline
            \rank{7} This ability does not end when you use it again, allowing you to pass judgment on any number of different creatures.
        \end{freeability}

        \cf{Pal}[6]{Greater Zealous Offense} The bonus from your \textit{zealous offense} ability increases to \plus2.

        \cf{Pal}[7]{Greater Zealous Fixation} Whenever you hit a creature with a \glossterm{strike}, you ignore all \glossterm{miss chances} against that creature with your attacks until you take a \glossterm{short rest}.

        \cf{Pal}[8]{Epic Zeal} The bonus from your \textit{zealous offense} ability increases to \plus4.
        In addition, the damage bonus from your \textit{smite} ability increases to \plus6d.
...
\section{Ranger}\label{Ranger}
    \begin{dtable!*}
        ...
        \begin{dtabularx}{\textwidth}{l l >{\lcol}X >{\lcol}X >{\lcol}X > {\lcol}X}
            ...
            2 & 2  & Handling lore            & Hunting style              & Farsight                  & Maneuver rank (2), wild maneuver            \\
            3 & 5  & Pack tactics             & Hunter's instincts         & Perceive weakness         & Maneuver rank (3), wild lore           \\
            4 & 8  & Greater animal companion & Tracker                    & Blindsight                & Maneuver rank (4), wild senses        \\
            5 & 11 & Greater handling lore    & Hunting style              & Greater farsight          & Maneuver rank (5), wild maneuver    \\
            6 & 14 & Greater pack tactics     & Greater hunter's instincts & Greater perceive weakness & Maneuver rank (6), wild agility   \\
            7 & 17 & Supreme animal companion & Greater tracker            & Greater blindsight        & Maneuver rank (7), greater wild senses        \\
            8 & 20 & Twin companion           & Dual quarry                & Epic senses               & Maneuver rank (8), wilderness supremacy \\
        \end{dtabularx}
    \end{dtable!*}
    ...
    \subsection{Beastmaster}
        ...
        \begin{attuneability}{Animal Companion}[\glossterm{Attune} (self), \glossterm{Emotion}, \glossterm{Magical}]
            ...
            \begin{itemize}
                \item Its \glossterm{wound resistance} and \glossterm{vital resistance} are equal to the normal values based on your level \add your base Constitution (see \pcref{Resistance Values}).
                \item It has 10 \glossterm{hit points}.
                \item Each of its \glossterm{defenses} is normally equal to 5 \add your level.
                \item Its \glossterm{accuracy} is normally equal to your \glossterm{accuracy}.
        ...
        \cf{Rgr}[3]{Pack Tactics} Any \glossterm{overwhelmed} creature that is \glossterm{threatened} by you or your animal companion takes a \minus1 penalty to \glossterm{accuracy}.
        ...
        \cf{Rgr}[6]{Greater Pack Tactics} The penalty from your \textit{pack tactics} ability increases to \minus2.
        ...
        \cf{Rgr}[8]{Twin Companion} You may acquire an additional \textit{animal companion}, attuning to each ability separately.
    ...
    \subsection{Keen Senses}
        ...
        \cf{Rgr}[2]{Farsight} You reduce your \glossterm{range increment} penalties for attacking at long range by 1.
        In addition, you gain a \plus2 bonus to the Awareness skill (see \pcref{Awareness}).
        ...
        \cf{Rgr}[5]{Greater Farsighted} The penalty reduction from your \textit{farsighted} ability increases to 2.
        In addition, the Awareness bonus from that ability increases to \plus5.
        ...
        \cf{Rgr}[8]{Epic Senses} The bonus from your \textit{perceive weakness} ability increases to \plus4.
        In addition, the Awareness bonus from your \textit{farsighted} ability increases to \plus10.
        Finally, the range of your \glossterm{blindsight} and \glossterm{blindsense} abilities increase by 200 feet.
    ...
    \subsection{Huntmaster}
        ...
        \cf{Rgr}[7]{Greater Tracker} The bonus to the Survival skill from your \textit{tracker} ability increases to \plus6.
    ...
    \subsection{Wilderness Warrior}
        ...
        \cf{Rgr}[2]{Maneuver Rank}[Magical] You become a rank 2 wild maneuverist.
        This gives you access to maneuvers that require a minimum rank of 2.

        \cf{Rgr}[2]{Wild Maneuver}
        You learn an additional wild \glossterm{maneuver} (see \pcref{Wild Maneuvers}).

        \cf*{Rgr}[3]{Maneuver Rank}[Magical] You become a rank 3 wild maneuverist.
        This can improve the effectiveness of your maneuvers and give you access to maneuvers that require a minimum rank of 3.

        \cf{Rgr}[3]{Wild Lore} You gain two additional \glossterm{skill points}.

        \cf*{Rgr}[4]{Maneuver Rank}[Magical] You become a rank 4 wild maneuverist.
        This can improve the effectiveness of your maneuvers and give you access to maneuvers that require a minimum rank of 4.

        \cf{Rgr}[4]{Wild Senses} You gain a \plus1 bonus to Perception-based checks, except \glossterm{initiative} checks.

        \cf*{Rgr}[5]{Maneuver Rank}[Magical] You become a rank 5 wild maneuverist.
        This can improve the effectiveness of your maneuvers and give you access to maneuvers that require a minimum rank of 5.

        \cf*{Rgr}[5]{Wild Maneuver}
        You learn an additional wild \glossterm{maneuver} (see \pcref{Wild Maneuvers}).

        \cf*{Rgr}[6]{Maneuver Rank}[Magical] You become a rank 6 wild maneuverist.
        This can improve the effectiveness of your maneuvers and give you access to maneuvers that require a minimum rank of 6.

        \cf{Rgr}[6]{Wild Agility} You gain a \plus2 bonus to Reflex defense.

        \cf*{Rgr}[7]{Maneuver Rank}[Magical] You become a rank 7 wild maneuverist.
        This can improve the effectiveness of your maneuvers and give you access to maneuvers that require a minimum rank of 7.

        \cf{Rgr}[7]{Greater Wild Senses} The bonus from your \textit{wild senses} ability increases to \plus2.

        \cf*{Rgr}[8]{Maneuver Rank}[Magical] You become a rank 8 wild maneuverist.
        This can improve the effectiveness of your maneuvers and give you access to maneuvers that require a minimum rank of 8.

        \cf{Rgr}[8]{Wilderness Supremacy} The bonus from your \textit{wild senses} ability increases to \plus5.
        In addition, you learn an additional wild \glossterm{maneuver}.
...
\section{Rogue}\label{Rogue}
    \begin{dtable!*}
        ...
        \begin{dtabularx}{\textwidth}{l l >{\lcol}X >{\lcol}X >{\lcol}X >{\lcol}X}
            ...
            2 & 2  & Evasion                     & Bardic lore            & Maneuver rank (2), trick maneuver         & Dabbler                 \\
            3 & 5  & Darkstalker                 & Bardic combat training & Maneuver rank (3), tricky lore            & Versatile power         \\
            4 & 8  & Hide in plain sight         & Bardic performance     & Maneuver rank (4), tricky finesse         & Skill exemplar          \\
            5 & 11 & Greater evasion             & Dual performance       & Maneuver rank (5), trick maneuver         & Greater dabbler         \\
            6 & 14 & Assassination               & Loremaster             & Maneuver rank (6), tricky agility         & Greater versatile power \\
            7 & 17 & Greater hide in plain sight & Bardic performance     & Maneuver rank (7), greater tricky finesse & Greater skill exemplar  \\
            8 & 20 & Epic assassin               & Epic bardic            & Maneuver rank (8), epic trickster         & Master of all trades    \\
        \end{dtabularx}
    \end{dtable!*}
    ...
    \subsection{Assassin}
        ...
        \begin{freeability}{Sneak Attack}
            Make a \glossterm{strike} with a \glossterm{light weapon} or a \glossterm{projectile weapon} against a creature within \rngclose range.
            ...
            In addition, the maximum range increases to \rngmed range.
            \rank{7} The damage bonus increases to \plus5d.
            In addition, the maximum range increases to \rnglong range.
        \end{freeability}

        % TODO: wording
        \cf{Rog}[2]{Evasion} You gain a \plus2 bonus to your Reflex defense.
        ...
        \cf{Rog}[8]{Epic Assassin}[Magical] When you use your \textit{darkstalker} ability, you become undetectable by any number of the listed senses, not just one.
        In addition, you gain a \plus5 bonus to the Stealth skill.
    ...
    \subsection{Bard}
        ...
        \cf{Rog}[8]{Epic Bard} The range and area affected by all of your \textit{bardic performance} abilities is doubled.
        In addition, you gain a \plus2 bonus to \glossterm{accuracy} with all of your \textit{bardic performance} abilities.
    ...
    \subsection{Combat Trickster}
        ...
        \cf{Rog}[2]{Trick Maneuver}
        You learn an additional trick \glossterm{maneuver} (see \pcref{Trick Maneuvers}).

        \cf*{Rog}[3]{Maneuver Rank}[Magical] You become a rank 3 trick maneuverist.
        This can improve the effectiveness of your maneuvers and give you access to maneuvers that require a minimum rank of 3.

        \cf{Rog}[3]{Trick Lore} You gain two additional \glossterm{skill points}.

        \cf*{Rog}[4]{Maneuver Rank}[Magical] You become a rank 4 trick maneuverist.
        This can improve the effectiveness of your maneuvers and give you access to maneuvers that require a minimum rank of 4.

        \cf{Rog}[4]{Tricky Finesse} You gain a \plus1 bonus to Dexterity-based checks, except \glossterm{initiative} checks.

        \cf*{Rog}[5]{Maneuver Rank}[Magical] You become a rank 5 trick maneuverist.
        This can improve the effectiveness of your maneuvers and give you access to maneuvers that require a minimum rank of 5.

        \cf*{Rog}[5]{Trick Maneuver}
        You learn an additional trick \glossterm{maneuver} (see \pcref{Trick Maneuvers}).

        \cf*{Rog}[6]{Maneuver Rank}[Magical] You become a rank 6 trick maneuverist.
        This can improve the effectiveness of your maneuvers and give you access to maneuvers that require a minimum rank of 6.

        \cf{Rog}[6]{Tricky Agility} You gain a \plus2 bonus to Reflex defense.

        \cf*{Rog}[7]{Maneuver Rank}[Magical] You become a rank 7 trick maneuverist.
        This can improve the effectiveness of your maneuvers and give you access to maneuvers that require a minimum rank of 7.

        \cf{Rog}[7]{Greater Tricky Finesse} The bonus from your \textit{tricky finesse} ability increases to \plus2.

        \cf*{Rog}[8]{Maneuver Rank}[Magical] You become a rank 8 trick maneuverist.
        This can improve the effectiveness of your maneuvers and give you access to maneuvers that require a minimum rank of 8.

        \cf{Rog}[8]{Epic Trickster} The bonus from your \textit{tricky agility} ability increases to \plus5.
        In addition, you learn an additional trick \glossterm{maneuver}.
    ...
    \subsection{Jack of All Trades}
        ...
        \cf{Rog}[3]{Versatile Power} You gain a \plus1 bonus to \glossterm{power}.

        \cf{Rog}[4]{Skill Exemplar} You gain two additional skill points.
        In addition, you gain a \plus1 bonus to all skills.

        \cf{Rog}[5]{Greater Dabbler} You gain an additional \glossterm{insight point}.

        \cf{Rog}[6]{Versatile Power} The bonus from your \textit{versatile power} ability increases to \plus2.

        \cf{Rog}[7]{Greater Skill Exemplar} The skill bonus from your \textit{skill exemplar} ability increases to \plus3.

        \cf{Rog}[8]{Master of All Trades} You gain six additional skill points.
        In addition, the skill bonus from your \textit{skill exemplar} ability increases to \plus6.
...
\section{Sorcerer}\label{Mage}
    \begin{dtable!*}
        ...
        \begin{dtabularx}{\textwidth}{l l >{\lcol}X >{\lcol}X >{\lcol}X >{\lcol}X >{\lcol}X}
            ...
            1 & 1  & Spellcasting, mage armor             & Mystic insight              & Draconic bloodline         & Innate magic             & Wildspell                                   \\
            2 & 2  & Spell rank (2), spell knowledge      & Combat caster               & Draconic focus             & Mystic tolerance         & Chaotic miscast, wild soul                  \\
            3 & 5  & Spell rank (3)                       & Wellspring of power         & Draconic precision         & Augment                  & Chaotic exertion                            \\
            4 & 8  & Spell rank (4), greater mage armor   & Mystic insight              & Draconic hide              & Spell absorption         & Controlled chaos                            \\
            5 & 11 & Spell rank (5), spell knowledge      & Greater combat caster       & Draconic heart             & Greater mystic tolerance & Greater chaotic miscast, greater wild  soul \\
            6 & 14 & Spell rank (6)                       & Greater wellspring of power & Greater draconic precision & Augment                  & Greater chaotic exertion                    \\
            7 & 17 & Spell rank (7), supreme mage armor   & Mystic insight              & Greater draconic hide      & Greater spell absorption & Greater controlled chaos                    \\
            8 & 20 & Spell rank (8), epic spell knowledge & Epic arcane mastery         & Epic augmentation          & Epic wildspell           &                                             \\
        \end{dtabularx}
    \end{dtable!*}
    ...
    \subsection{Arcane Magic}
        ...
        \cf{Sor}[1]{Mage Armor}[Magical] You can use the \textit{mage armor} ability as a standard action.
        \begin{freeability}{Mage Armor}
            You create a translucent suit of magical armor on your body and over your hands.
            This functions like body armor that provides a \plus2 bonus to Armor defense and has no \glossterm{encumbrance}.
            It also provides a \plus2 bonus to \glossterm{resistances} against \glossterm{energy damage}.
        ...
        \cf{Sor}[4]{Greater Mage Armor}[Magical]
        The defense bonus from the body armor created by your \textit{mage armor} ability increases to \plus3.
        In addition, the bonus to \glossterm{resistances} against \glossterm{energy damage} increases to be equal to half your \glossterm{power}.
        ...
        \cf{Sor}[7]{Greater Mage Armor}[Magical]
        The defense bonus from the body armor created by your \textit{mage armor} ability increases to \plus3.
        In addition, the bonus to \glossterm{resistances} against \glossterm{energy damage} increases to be equal to your \glossterm{power}.

        \cf*{Sor}[8]{Spell Rank}[Magical] You become a rank 8 arcane spellcaster.
        This can improve the effectiveness of your spells and give you access to spells that require a minimum rank of 8.

        \cf{Sor}[8]{Epic Spell Knowledge} You learn two additional divine spells.
    ...
    \subsection{Arcane Spell Mastery}
        ...
        \cf{Sor}[2]{Combat Caster} You reduce your \glossterm{focus penalties} by 2.
        ...
        \cf{Sor}[8]{Epic Arcane Mastery} The bonus from your \textit{wellspring of power} ability increases to \plus6.
        In addition, you gain an additional \textit{mystic insight} ability.
    ...
    \subsection{Draconic Magic}
        ...
        \cf{Sor}[8]{Draconic Apotheosis} The bonus from your \textit{draconic precision} ability increases to \plus3, and the bonuses from your \textit{draconic hide} ability increase to \plus2.
        In addition, you gain access to rank 8 spells from the \glossterm{mystic sphere} granted by your \textit{draconic bloodline} ability.
    ...
    \subsection{Innate Arcanist}
        ...
        \cf{Sor}[8]{Epic Augmentation} You can apply \glossterm{augments} to arcane as if you were able to cast rank 9 spells.
        This does not give you access to rank 8 spells or rank 8 spell upgrades.
    ...
    \subsection{Wild Magic}
        ...
        \begin{dtable}
            ...
            \begin{dtabularx}{\textwidth}{l X}
                ...
                2 & Whenever you attack with the spell, you roll twice and take the lower result \\
                ...
                8 & Whenever you deal damage with the spell, you roll twice for the spell and take the higher result \\
                9 & Whenever you attack with the spell, you roll twice and take the higher result \\
        ...
        \cf{Sor}[8]{Epic Wildspell} You replace your normal wild magic effects from your \textit{wildspell} ability with the effects from the table below.
        \begin{dtable}
            \lcaption{Wild Magic Effects}
            \begin{dtabularx}{\textwidth}{l X}
                \tb{Roll} & \tb{Effect} \tableheaderrule
                ...
                3 & Whenever you attack with the spell, you roll twice and take the higher result \\
                4 & Whenever you deal damage with the spell, you roll twice for the spell and take the higher result \\
                5 & Any \glossterm{conditions} inflicted by the spell become a \glossterm{Curse} instead of a condition, and are removed when the target takes a \glossterm{short rest} \\
                6 & The spell's damage is doubled, but it deals no damage if you do not beat a target's \glossterm{vital resistance} \\
                7 & The spell's area is tripled \\
                8 & Each target \glossterm{wounded} by the spell this round is also \glossterm{stunned} as a \glossterm{condition} \\
                9 & You gain a \plus5 bonus to \glossterm{accuracy} with the spell, but you take the minimum possible result whenever the spell would deal damage \\
...
\section{Warlock}\label{Warlock}
    \begin{dtable!*}
        ...
        \begin{dtabularx}{\textwidth}{l l >{\lcol}X >{\lcol}X >{\lcol}X >{\lcol}X}
            ...
            1 & 1  & Eldritch blast               & Spellcasting, armor tolerance           & Mystic insight              & Possession                  \\
            2 & 2  & Fiendish resistance          & Spell rank (2), spell knowledge         & Combat caster               & Empowering whispers         \\
            3 & 5  & Abyssal jaunt                & Spell rank (3)                          & Wellspring of power         & Exchange soul fragment      \\
            4 & 8  & Abyssal substitution         & Spell rank (4), greater armor tolerance & Mystic insight              & Greater possession          \\
            5 & 11 & Greater fiendish resistance  & Spell rank (5), spell knowledge         & Greater combat caster       & Greater empowering whispers \\
            6 & 14 & Abyssal curse                & Spell rank (6)                          & Greater wellspring of power & Exchange vitality           \\
            7 & 17 & Greater abyssal substitution & Spell rank (7), supreme armor tolerance & Mystic insight              & Supreme possession          \\
            8 & 20 & Abyssal apotheosis           & Spell rank (8), epic spell knowledge    & Epic pact mastery           & Epic possession             \\
        \end{dtabularx}
    \end{dtable!*}
    ...
    \subsection{Blessings of the Abyss}
        ...
        \begin{freeability}{Eldritch Blast}[\glossterm{Magical}]
            ...
            \rank{7} The damage increases to \glossterm{standard damage} \plus4d.
                In addition, the range increases to \rngmed range.
        \end{freeability}
        ...
        \begin{freeability}{Abyssal Jaunt}[\glossterm{Magical}]
            ...
            \hit The target is teleported briefly into the Abyss and takes fire \glossterm{standard damage}.
            At the end of the round, it returns to its original location, or into the closest open space if that location is occupied.
            \crit As above, except that the target takes double damage, and it does not return until the end of the next round.
        ...
        In addition, you gain a \plus1 bonus to \glossterm{power} with abilities that deal fire damage.
        ...
        Any other aspects of the ability remain unchanged.
        In addition, the bonus to power from your \textit{abyssal substitution} ability increases to \plus2.

        \cf{War}[8]{Abyssal Apotheosis} You gain a \plus2 bonus to \glossterm{accuracy} with abilities from this archetype.
        In addition, the bonus from your \textit{abyssal substitution} ability increases to \plus4, and the bonus from your \textit{fiendish resilience} ability increases to be equal to twice your level.
    ...
    \subsection{Pact Magic}
        ...
        \cf{War}[4]{Greater Armor Tolerance}[Magical] The penalty reduction from your \textit{armor tolerance} ability increases to 3.
        ...
        \cf{War}[7]{Supreme Armor Tolerance}[Magical] The penalty reduction from your \textit{armor tolerance} ability increases to 4.

        \cf*{War}[8]{Spell Rank}[Magical] You become a rank 8 pact spellcaster.
        This can improve the effectiveness of your spells and give you access to spells that require a minimum rank of 8.

        \cf{War}[8]{Epic Spell Knowledge} You learn two additional pact spells.
    ...
    \subsection{Pact Spell Mastery}
        ...
        \cf{War}[2]{Combat Caster} You reduce your \glossterm{focus penalties} by 2.
        ...
        \cf{War}[5]{Greater Combat Caster} You gain a \plus1 bonus to Armor defense and Reflex defense.
        ...
        \cf{War}[8]{Epic Pact Mastery} The bonus from your \textit{wellspring of power} ability increases to \plus4.
        In addition, the penalty reduction from your \textit{armor tolerance} ability increases to 5, and you become proficient with an additional \glossterm{usage class} of armor.
        You must already be proficient with medium armor to become proficient with heavy armor in this way.
    ...
    \subsection{Soulkeeper's Chosen}
        ...
        You gain an ability based on the type of whispers you hear with your \textit{whispers of the lost} ability.
        {
            ...
            \subcf{Spiteful Whispers} Whenever you miss a creature with an attack, you gain a \plus2 bonus to \glossterm{accuracy} against the creature you missed during the next round.
        ...
        \cf{War}[8]{Epic Possession}[Magical] Your soulkeeper does not influence your actions during your \textit{possession} ability, and that ability no longer imposes a penalty to your Mental defense.
        In addition, the bonus to \glossterm{power} from that ability increases to \plus8.
...
\section{Wizard}\label{Wizard}
    \begin{dtable!*}
        ...
        \begin{dtabularx}{\textwidth}{l l >{\lcol}X >{\lcol}X >{\lcol}X >{\lcol}X}
            ...
            2 & 2  & Alchemical infusion          & Spell rank (2), mage armor           & Ritualist             & Insightful caster           \\
            3 & 5  & Alchemical discovery         & Spell rank (3), spell knowledge      & Scholastic insight    & Wellspring of power         \\
            4 & 8  & Alchemical expertise         & Spell rank (4)                       & Ritual expertise      & Mystic insight              \\
            5 & 11 & Experienced quaffing         & Spell rank (5), greater mage armor   & Contingency           & Greater insightful caster   \\
            6 & 14 & Alchemical discovery         & Spell rank (6), spell knowledge      & Scholastic insight    & Greater wellspring of power \\
            7 & 17 & Greater alchemical expertise & Spell rank (7)                       & Malleable contingency & Mystic insight              \\
            8 & 20 & Epic alchemy                 & Spell rank (8), epic spell knowledge & Multiple contingency  & Epic arcane mastery         \\
        \end{dtabularx}
    \end{dtable!*}
    ...
    \subsection{Alchemist}
        ...
        \cf{Wiz}[7]{Greater Alchemical Expertise} The skill bonus from your \textit{alchemical expertise} ability increases to \plus6 and the accuracy bonus increases to \plus2.

        \cf{Wiz}[8]{Epic Alchemy} The accuracy bonus from your \textit{alchemical expertise} ability increases to \plus4.
        In addition, the difficulty rating to craft a new alchemical item with your \textit{portable workshop} ability does not increase with each successful craft.
    ...
    \subsection{Arcane Magic}
        ...
        \cf{Wiz}[1]{Mage Armor}[Magical] You can use the \textit{mage armor} ability as a standard action.
        \begin{freeability}{Mage Armor}
            You create a translucent suit of magical armor on your body and over your hands.
            This functions like body armor that provides a \plus2 bonus to Armor defense and has no \glossterm{encumbrance}.
            It also provides a \plus2 bonus to \glossterm{resistances} against \glossterm{energy damage}.
        ...
        \cf{Wiz}[4]{Greater Mage Armor}[Magical]
        The defense bonus from the body armor created by your \textit{mage armor} ability increases to \plus3.
        In addition, the bonus to \glossterm{resistances} against \glossterm{energy damage} increases to be equal to half your \glossterm{power}.
        ...
        \cf{Wiz}[7]{Greater Mage Armor}[Magical]
        The defense bonus from the body armor created by your \textit{mage armor} ability increases to \plus3.
        In addition, the bonus to \glossterm{resistances} against \glossterm{energy damage} increases to be equal to your \glossterm{power}.
        ...
        \cf{Wiz}[8]{Epic Spell Knowledge} You learn two additional divine spells.
    ...
    \subsection{Arcane Scholar}
        ...
        \cf{Wiz}[1]{Scholastic Lore} You gain a \plus2 bonus to the Spellsense skill and all Knowledge skills.
        ...
        \cf{Wiz}[8]{Multiple Contingency} You may have up to three separate \textit{contingency} abilities active at the same time.
        ...
        In addition, the Contingency augment no longer increases the rank of the spell it is applied to.
    ...
    \subsection{Arcane Spell Mastery}
        ...
        \cf{Wiz}[2]{Insightful Caster} You gain access to an additional arcane \glossterm{mystic sphere}, including all \glossterm{cantrips} from that sphere.
        ...
        \cf{Wiz}[5]{Greater Insightful Caster} You learn two additional divine \glossterm{spells}.
        ...
        \cf{Wiz}[8]{Epic Arcane Mastery} The bonus from your \textit{wellspring of power} ability increases to \plus6.
        In addition, the bonus to resistances from your \textit{greater mage armor} ability increases to be equal to twice your level.
