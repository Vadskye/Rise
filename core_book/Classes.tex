...
\section{Barbarian}\label{Barbarian}
    ...
    \subsection{Class Abilities}
        ...
        \begin{itemize}
            ...
            \item Each round, the barbarian must spend a \glossterm{swift action} to maintain his rage.
...
\section{Cleric}\label{Cleric}
    ...
    \subsection{Class Abilities}
        ...
        To cast a spell, a cleric must spend an \glossterm{action point}.
        As he gains power, he becomes able to cast weaker spells freely.
        He may cast spells at least two levels lower than his highest level spell known without spending an action point.
...
\section{Druid}\label{Druid}
    ...
    \subsection{Class Abilities}
        ...
        As she gains power, she becomes able to cast weaker spells freely.
        She may cast spells at least two levels lower than her highest level spell known without spending an action point.
...
\section{Mage}\label{Mage}
    \begin{dtable}
        ...
        \begin{dtabularx}{\columnwidth}{>{\ccol}p{\levelcol} >{\ccol}p{\babcolpoor} c >{\lcol}X}
            \tb{Level} & \tb{Combat Prowess} & \tb{Spells} & \tb{Special} \\
            \hline
            \wizardprogressionrow{1}  & 2  & Rituals, spells \\
            \wizardprogressionrow{2}  & 3  &                 \\
            \wizardprogressionrow{3}  & 3  & Arcane insight  \\
            \wizardprogressionrow{4}  & 4  & Arcane essence      \\
            \wizardprogressionrow{5}  & 4  & Arcane insight  \\
            \wizardprogressionrow{6}  & 5  & Inherent magic  \\
            \wizardprogressionrow{7}  & 5  & Arcane insight  \\
            \wizardprogressionrow{8}  & 6  &                 \\
            \wizardprogressionrow{9}  & 6  & Arcane insight  \\
            \wizardprogressionrow{10} & 7  & Inherent magic  \\
            \wizardprogressionrow{11} & 7  & Arcane insight  \\
            \wizardprogressionrow{12} & 8  &                 \\
            \wizardprogressionrow{13} & 8  & Arcane insight  \\
            \wizardprogressionrow{14} & 9  & Inherent magic  \\
            \wizardprogressionrow{15} & 9  & Arcane insight  \\
            \wizardprogressionrow{16} & 10 &                 \\
            \wizardprogressionrow{17} & 10 & Arcane insight  \\
            \wizardprogressionrow{18} & 11 & Inherent magic  \\
            \wizardprogressionrow{19} & 11 & Arcane insight  \\
            \wizardprogressionrow{20} & 12 & Archmage        \\
        \end{dtabularx}
    \end{dtable}
    ...
    \subsection{Base Class Abilities}
        ...
        \cf{Mag}{Weapon and Armor Proficiency}
    ...
    \subsection{Class Abilities}
        ...
        A sorcerer casts spells with her Willpower.
        ...
        As she gains power, she becomes able to cast weaker spells freely.
        She may cast spells at least two levels lower than her highest level spell known without spending an action point.
        In addition, she may always cast cantrips without spending a action point.
        ...
        \cf{Mag}[3rd]{Arcane Insight}\label{Arcane Insight}
        ...
        \begin{itemize}
            \item Arcane Defense: The mage gains a \plus1 bonus to defenses against spells.
        ...
        When the mage chooses a spell in this way, the mage may also choose specific augments for that spell, as long as the spell's effective level does not exceed half the mage's character level.
        ...
        \cf{Mag}[20th]{Archmage}
        The mage no longer needs to spend action points to cast spells of any level.
        If he has any spell points, he loses those spell points and gains the same number of legend points.
...
\section{Ranger}\label{Ranger}
    \begin{dtable}
        ...
        \begin{dtabularx}{\columnwidth}{>{\ccol}p{\levelcol} >{\ccol}p{\babcolgood} c >{\lcol}X}
            ...
            \rangerprogressionrow{13} & \plus4 & Implacable hunter                     \\
