...
\section{Cleric}\label{Cleric}
    ...
    \subsection{Healer}
        ...
        \begin{freeability}{Mitigate Vital Wound}[\glossterm{Magical}]
            ...
            The target can roll again for its most recent \glossterm{vital roll} with a \plus2 bonus.
...
\section{Paladin}\label{Paladin}
    ...
    \subsection{Stalwart Guardian}
        ...
        \begin{freeability}{Lay on Hands}[Life]
            ...
            If you do, the target's most recent \glossterm{vital wound} is removed instead of having its \glossterm{vital roll} modified.
            \rank{7} The bonus increases to \plus5.
        \end{freeability}
