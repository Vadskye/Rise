...
\section{Barbarian}\label{Barbarian}
    \begin{dtable}
        ...
        \begin{dtabularx}{\columnwidth}{c >{\lcol}X >{\lcol}X >{\lcol}X}
            \tb{Rank} & \tb{Battleforged Resilience} & \tb{Battlerager}  & \tb{Primal Warrior} \\\bottomrule
               1 & Fury of the storm         & Rage                       & Primal power
    ...
    %     This archetype improves your 

    %     \cf{Bbn}[1]{Fast Movement} You gain a \plus10 foot bonus to your \glossterm{base speed}.

    %     \cf{Bbn}[2]{Wilderness Lore} You gain two additional \glossterm{skill points}.

    %     \cf{Bbn}[3]{Savage Force} You gain a \plus2 bonus to \glossterm{accuracy} with the \textit{dirty trick}, \textit{disarm}, \textit{grapple}, \textit{shove}, and \textit{trip} abilities (see \pcref{Special Combat Abilities}).

    %     \cf{Bbn}[4]{} 

    %     \cf{Bbn}[5]{Greater Fast Movement} The speed bonus from your \textit{fast movement} ability increases to \plus20 feet.

    %     \cf{Bbn}[6]{Greater Savage Force} The accuracy bonus from your \textit{savage force} ability increases to \plus3.
...
\section{Monk}\label{Monk}
    \begin{dtable}
        ...
        \begin{dtabularx}{\columnwidth}{c >{\lcol}X >{\lcol}X >{\lcol}X}
            \tb{Rank} & \tb{Ki} & \tb{Transcendent Sage} & \tb{Esoteric Warrior} \\\bottomrule
               1 & Ki barrier, ki strike                 & Clear the mind      & Unarmed warrior, grapple expertise
    ...
    \subsection{Esoteric Warrior}\label{Esoteric Warrior}
        ...
        \cf{Mnk}[1]{Grapple Expertise}
        You gain a \plus1 bonus to accuracy with the \textit{grapple} ability and all grapple actions (see \pcref{Grapple Actions}).
        ...
        \cf{Mnk}[6]{Greater Grapple Expertise}
        The bonus from your \textit{grapple expertise} ability increases to \plus2.
