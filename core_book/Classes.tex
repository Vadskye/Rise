...
\section{Druid}\label{Druid}
    ...
    \subsection{Natural Influence}
        ...
        \subcf{15th -- Wings}
        You grow wings, granting you a \glossterm{fly speed} equal to your land speed, allowing you to fly (see \pcref{Flying}).
...
\section{Monk}\label{Monk}
    ...
    \subsection{Unfettered Warrior}
        ...
        When not wearing armor or \glossterm{} by weight (see \pcref{Encumbrance}), you gain a \plus2 bonus to Armor defense.
