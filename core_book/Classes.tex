...
\begin{dtabularx}{\textwidth}{l l >{\lcol}X >{\lcol}X >{\lcol}X >{\lcol}X}
    ...
    1         & 1              & Sneak attack        & Bardic performances      & Maneuver rank (1), trick lore             & Skill exemplar          \\
    ...
    4         & 10             & Hide in plain sight & Virtuoso                 & Maneuver rank (4), tricky force           & Greater skill exemplar  \\
    ...
    \subsection{Bard}
        ...
        However, targets do not stop being affected by your performance simply by travelling beyond the initial range of the bardic performance ability.
        {
            ...
            \begin{freeability}{Ballad of Belligerence}[\glossterm{Auditory}, \glossterm{Emotion}, \glossterm{Sustain} (minor)]
                \target{All \glossterm{enemies} in a \arealarge radius from you}
            ...
            \begin{freeability}{Cacaphony}[\glossterm{Auditory}]
                \targets{All \glossterm{enemies} within a \areamed radius from you}
            ...
            \begin{freeability}{Vigorous Verse}[\glossterm{Auditory}, \glossterm{Emotion}, \glossterm{Sustain} (minor)]
                ...
                \rankline
                \rank{3} The number of hit points increases to 10.
                \rank{5} The number of hit points increases to 20.
                \rank{7} The number of hit points increases to 40.
            \end{freeability}
        }
...
\end{dtabularx}
    ...
    \subsection{Blessings of the Abyss}
        ...
        \begin{freeability}{Eldritch Blast}[\glossterm{Magical}]
            ...
            \rankline
            The damage increases by \plus1d for each rank beyond 1.
            \rank{3} On a \glossterm{glancing blow}, the target takes half damage.
            \rank{5} The damage increases by an additional \plus1d.
            \rank{7} The damage increases by an additional \plus1d.
        \end{freeability}
