...
\section{Barbarian}\label{Barbarian}
    \begin{dtable!*}
        ...
        \begin{dtabularx}{\textwidth}{c >{\lcol}X >{\lcol}X >{\lcol}X >{\lcol}X}
            ...
            1 & Battleforged endurance         & Rage                   & Reckless strike          & Primal maneuvers       \\
            2 & Toughened body                 & Seething anger         & Fast movement            & Primal prowess         \\
            3 & Battle-scarred                 & Painless rage          & Savage force             & Primal power           \\
            4 & Greater battleforged endurance & Enduring anger         & Savage precision         & Primal maneuver        \\
            5 & Greater toughened body         & Powerful rage          & Greater fast movement    & Greater primal prowess \\
            6 & Greater battle-scarred         & Greater painless rage  & Greater savage force     & Greater primal power   \\
            7 & Supreme battleforged endurance & Greater seething anger & Greater savage precision & Primal maneuver        \\
            8 &                                & Titanic rage           &                          &                        \\
        \end{dtabularx}
    \end{dtable!*}
    ...
    \subsection{Outland Savage}
        ...
        \cf{Bbn}[1]{Reckless Strike} You can use the \textit{reckless strike} ability as a standard action.
        \begin{freeability}{Reckless Strike}[\glossterm{Swift} (see text)]
        ...
        \cf{Bbn}[4]{Savage Precision} You gain a \plus1 bonus to \glossterm{accuracy} with the \textit{dirty trick}, \textit{disarm}, \textit{grapple}, \textit{overrun}, \textit{shove}, and \textit{trip} abilities (see \pcref{Special Combat Abilities}).
        ...
        \cf{Bbn}[7]{Greater Savage Precision} The bonuses from your \textit{savage force} ability increase to \plus3.
...
\section{Wizard}\label{Wizard}
    \begin{dtable!*}
        ...
        \begin{dtabularx}{\textwidth}{c >{\lcol}X >{\lcol}X >{\lcol}X >{\lcol}X}
            \tb{Rank} & \tb{Arcane Magic}     & \tb{Arcane Spell Mastery}   & \tb{Arcane Scholar}   & \tb{Brewer}          \tableheaderrule
            1         & Mystic spheres        & Mystic knowledge            & Scholastic lore       & Arcane brew         \\
            2         & Spells                & Mage armor                  & Ritualist             & Skilled brewer      \\
            3         & Spell rank (3), spell & Wellspring of power         & Scholastic insight    & Tempting concoction \\
            4         & Spell rank (4)        & Mystic knowledge            & Ritual expertise      & Esoteric concoction \\
            5         & Spell rank (5)        & Greater mage armor          & Contingency           & Efficient brewer    \\
            6         & Spell rank (6), spell & Greater wellspring of power & Scholastic insight    & Poison spell        \\
            7         & Spell rank (7)        & Mystic knowledge            & Malleable contingency & Blended concoction  \\
            8         & Spell rank (8)        &                             &                       &                     \\
        \end{dtabularx}
    \end{dtable!*}
    ...
    \classbasics{Archetypes} Mages have the Arcane Magic, Arcane Spell Mastery, Arcane Scholar, and Brewer \glossterm{archetypes}.
    ...
    \subsection{Brewer}
        This archetype improves your ability to create unusual concoctions to aid your allies and harm your foes.

        \cf{Wiz}[1]{Arcane Brew} You can use the \textit{arcane brew} ability with an hour of effort brewing liquid in a cauldron or similar receptacle.
        \begin{freeability}{Arcane Brew}
            Choose a \glossterm{targeted} arcane spell you know that does not have the \glossterm{Sustain}, \glossterm{Attune} (self), or \glossterm{AP} tags.
        ...
        \cf{Wiz}[2]{Skilled Brewer} You gain two additional \glossterm{skill points}.
        In addition, you gain \plus1 bonus to \glossterm{potency} with any poisons you create.

        \cf{Wiz}[3]{Tempting Concoction} You can use the \textit{tempting concoction} ability as a \glossterm{standard action}.
        \begin{attuneability}{Tempting Concoction}[\glossterm{Emotion}, \glossterm{Magical}, \glossterm{Subtle}]
            \targets{See text}
            Choose one liquid \glossterm{poison} or \textit{arcane brew} you created, or an object containing one of those liquids, within \rngclose range.
            Whenever an \glossterm{enemy} notices the chosen object, make an attack vs. Mental against it.
            If the brew or poison is not concealed inside a less suspicious object, such as a tankard of ale or an apple, you take a \minus4 penalty to \glossterm{accuracy}.
        ...
        \cf{Wiz}[4]{Esoteric Concoction} You can use esoteric natural ingredients in place of expensive ingredients when creating poisons.
        ...
        \cf{Wiz}[5]{Efficient Brewer} You can create poisons in half the normal time.
        In addition, the bonus from your \textit{skilled brewer} ability increases to \plus2.

        \cf{Wiz}[6]{Poison Spell} You can use the \textit{poison spell} ability when you cast a spell that does not have the \glossterm{Attune} or \glossterm{Sustain} tags.
        ...
        \cf{Wiz}[7]{Blended Concoction} You can create poisons that combine two poison effects into a single dose.
