...
\section{Barbarian}\label{Barbarian}
    ...
    \subsection{Class Abilities}
        ...
        The feat must be drawn from the list of combat feats in \tref{Combat Feats}, and he must still meet all prerequisites for the feat.
...
\section{Cleric}\label{Cleric}
    \begin{dtable}
        ...
        \begin{dtabularx}{\columnwidth}{>{\ccol}p{2em} >{\ccol}p{\babcolavg} c c >{\lcol}X}
            ...
            \clericprogressionrow{14} & \plus4 & 9  & Devotion feat, greater domain invocation \\
...
\section{Fighter}\label{Fighter}
    \begin{dtable}
        ...
        \begin{dtabularx}{\columnwidth}{>{\ccol}p{\levelcol} >{\ccol}p{\babcolgood} >{\lcol}X}
            ...
            \fighterprogressionrow{3}  & Combat discipline                    \\
            \fighterprogressionrow{4}  & Martial assault                      \\
            \fighterprogressionrow{5}  & Armor discipline                     \\
            \fighterprogressionrow{6}  & Combat feat                          \\
            \fighterprogressionrow{7}  & Improved weapon discipline           \\
            \fighterprogressionrow{8}  & Martial assault                      \\
            \fighterprogressionrow{9}  & Improved combat discipline           \\
            \fighterprogressionrow{10} & Combat feat, swift warrior           \\
            \fighterprogressionrow{11} & Improved armor discipline            \\
            \fighterprogressionrow{12} & Martial assault                      \\
            \fighterprogressionrow{13} & Greater weapon discipline            \\
            \fighterprogressionrow{14} & Combat feat                          \\
            \fighterprogressionrow{15} & Greater combat discipline            \\
            \fighterprogressionrow{16} & Martial assault                      \\
            \fighterprogressionrow{17} & Greater armor discipline             \\
            \fighterprogressionrow{18} & Combat feat                          \\
            \fighterprogressionrow{19} & True discipline                      \\
            \fighterprogressionrow{20} & Combat supremacy                     \\
        \end{dtabularx}
    \end{dtable}
    ...
    \subsection{Class Abilities}
        ...
        He gains an additional bonus feat at his 6th fighter level and every four fighter levels thereafter.

        \cf{Ftr}[3rd]{Combat Discipline}
        ...
        \cf{Ftr}[4th]{Martial Assault}
        The fighter gains the ability to perform special attacks called martial assaults.
        Each martial assault replaces a specific number of \glossterm{strikes}, and must be performed as part of a \glossterm{standard attack}.
        He chooses a single martial assault from the list below.
        Some martial assaults have minimum fighter levels, as indicated in the title of the ability.
        At his 6th fighter level, and every four fighter levels thereafter, the fight gains an additional martial assault.
        All martial assaults are extraordinary abilities unless otherwise noted.

        \cf{Ftr}[5th]{Armor Discipline}
        ...
        \cf{Ftr}[9th]{Improved Combat Discipline}
        ...
        \cf{Ftr}[11th]{Improved Armor Discipline}
        ...
        \cf{Ftr}[15th]{Greater Combat Discipline}
        ...
        \cf{Ftr}[17th]{Greater Armor Discipline}
