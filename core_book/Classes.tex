...
\begin{dtabularx}{\textwidth}{l l l >{\lcol}X >{\lcol}X >{\lcol}X >{\lcol}X}
    ...
    2 & 4      & Endurance                     & Enraged strike           & Savage precision                           & Combat style rank (2), primal force         \\
    ...
    5 & 13     & Greater endurance             & Immutable anger          & Greater savage precision                   & Combat style rank (5), greater primal force \\
...
\end{dtabularx}
    ...
    \subsection{Basic Class Abilities}
        ...
        \cf{Bbn}{Defenses}
        You gain the following bonuses to your \glossterm{defenses}: \plus1 Armor, \plus8 Fortitude, \plus6 Reflex, \plus4 Mental.
    ...
    \subsection{Battleforged Resilience}
        ...
        \cf{Bbn}[2]{Endurance} You gain a \plus1 bonus to your \glossterm{fatigue tolerance}, and a \plus1 bonus to \glossterm{vital rolls}.
        ...
        \cf{Bbn}[5]{Greater Endurance} The bonuses from your \textit{endurance} ability increases to \plus2.
    ...
    \subsection{Battlerager}\label{Rage}
        ...
        \begin{attuneability}{Rage}[\glossterm{Emotion}, \glossterm{Sustain} (free), \glossterm{Swift}]
        ...
        \cf{Bbn}[5]{Immutable Anger} You become immune to hostile \glossterm{Emotion} effects.
    ...
    \subsection{Outland Savage}
        ...
        In addition, you gain a \plus1 bonus to \glossterm{accuracy} with those abilities.
    ...
    \subsection{Primal Warrior}
        ...
        {
            \cf{Bbn}[1]{Primal Combat Style}
            You can channel your primal energy into ferocious attacks.
            You gain access to one primal \glossterm{combat style} (see \pcref{Primal Combat Styles}).
            You may spend \glossterm{insight points} to gain access to one additional primal combat style per insight point.

            In addition, you learn two rank 1 \glossterm{maneuvers} from primal combat styles you have access to.
        ...
        {
            \cf{Bbn}[2]{Combat Style Rank} You become a rank 2 primal combat style user.
        ...
        {
            \cf*{Bbn}[3]{Combat Style Rank} You become a rank 3 primal combat style user.
        ...
        {
            \cf*{Bbn}[4]{Combat Style Rank} You become a rank 4 primal combat style user.
            ...
            You learn an additional \glossterm{maneuver} from a primal combat style you have access to (see \pcref{Primal Combat Styles}).
        }

        {
            \cf*{Bbn}[5]{Combat Style Rank} You become a rank 5 primal combat style user.
        ...
        {
            \cf*{Bbn}[6]{Combat Style Rank} You become a rank 6 primal combat style user.
        ...
        {
            \cf*{Bbn}[7]{Combat Style Rank} You become a rank 7 primal combat style user.
...
\end{dtabularx}
    ...
    \subsection{Basic Class Abilities}
        ...
        \cf{Clr}{Defenses}
        You gain the following bonuses to your \glossterm{defenses}: \plus1 Armor, \plus6 Fortitude, \plus4 Reflex, \plus8 Mental.
    ...
    \subsection{Divine Spell Mastery}
        ...
        This can allow you to apply the benefits of insights like \textit{signature spell} to higher rank spells.
        {
            ...
            \parhead{Personal Attunement} You gain an additional \glossterm{attunement point}.
                You cannot choose this ability multiple times.
        ...
        \cf{Clr}[2]{Divine Guidance} Once per \glossterm{long rest}, you may use the \textit{desperate exertion} ability without gaining any \glossterm{fatigue points} to affect a divine spell you cast (see \pcref{Desperate Exertion}).
    ...
    \subsection{Healer}
        ...
        In addition, it only costs you one \glossterm{fatigue point} instead of two to use the \textit{desperate exertion} ability to affect a Medicine check.
    ...
    \subsection{Cleric Domain Abilities}\label{Cleric Domain Abilities}
        ...
        \subsubsection{Protection}
            ...
            \parhead{Aspect} At the start of each phase, you may choose an \glossterm{ally} adjacent to you.
            That creature gains a \plus1 bonus to all defenses during that phase.
            ...
            While this ability is active, you cannot gain a defense bonus from this ability, even if another cleric with this ability chooses you.
            You can \glossterm{suppress} or \glossterm{resume} this ability as a \glossterm{free action}, which can allow you to be protected by another cleric with this ability.
...
\end{dtabularx}
    ...
    \subsection{Basic Class Abilities}
        ...
        \cf{Drd}{Defenses}
        You gain the following bonuses to your \glossterm{defenses}: \plus1 Armor, \plus6 Fortitude, \plus5 Reflex, \plus7 Mental.
    ...
    \subsection{Nature Spell Mastery}
        ...
        \cf{Drd}[1]{Mystic Insight}[Magical]
        You gain your choice of one of the following abilities.
        Whenever you increase your rank in this archetype, you may change your choice.
        This can allow you to apply the benefits of insights like \textit{signature spell} to higher rank spells.
        {
        ...
        \cf{Drd}[2]{Natural Guidance} Once per \glossterm{long rest}, you may use the \textit{desperate exertion} ability without gaining any \glossterm{fatigue points} to affect a nature spell you cast (see \pcref{Desperate Exertion}).
    ...
    \subsection{Wildspeaker}\label{Wildspeaker}
        ...
        \cf{Drd}[0]{Animal Speech}[Magical] You can use the \textit{animal speech} ability as a standard action.
        ...
        They can be compelled to attack despite this protection with a Creature Handling check against a \glossterm{difficulty rating} equal to 10 \add twice your rank in this archetype.
        ...
        \cf{Drd}[3]{Plant Speech}[Magical] When you use your \textit{animal speech} ability, you can choose a plant instead of an animal.
        ...
        \cf{Drd}[5]{Greater Nature's Ally}[Magical] Your \textit{nature's ally} ability also protects you and your allies from plant creatures and elementals.
...
\end{dtabularx}
    ...
    \subsection{Basic Class Abilities}
        ...
        \cf{Ftr}{Defenses}
        You gain the following bonuses to your \glossterm{defenses}: \plus2 Armor, \plus8 Fortitude, \plus4 Reflex, \plus5 Mental.
    ...
    \subsection{Combat Discipline}
        ...
        \begin{freeability}{Discipline}
            ...
            \rankline
            \rank{3} This ability gains the \glossterm{Swift} tag.
            ...
            When you do, you gain a \glossterm{fatigue point}.
            \rank{7} You can remove any number of \glossterm{conditions} instead of only one.
        \end{freeability}
    ...
    \subsection{Martial Mastery}
        ...
        {
            \cf{Ftr}[1]{Martial Combat Style}
            You can channel your martial prowess into a wide variety of dangerous attacks.
            You gain access to one martial \glossterm{combat style} (see \pcref{Martial Combat Styles}).
            You may spend \glossterm{insight points} to gain access to one additional martial combat style per insight point.

            In addition, you learn two rank 1 \glossterm{maneuvers} from martial combat styles you have access to.
            You may spend \glossterm{insight points} to learn to one additional maneuver per insight point.
            Unless otherwise noted in an ability's description, using a maneuver requires a \glossterm{standard action}.
        ...
        {
            \cf{Ftr}[2]{Combat Style Rank} You become a rank 2 martial combat style user.
            This gives you access to maneuvers that require a minimum rank of 2.
        ...
        {
            \cf*{Ftr}[3]{Combat Style Rank} You become a rank 3 martial combat style user.
            This gives you access to maneuvers that require a minimum rank of 3 and can improve the effectiveness of your existing maneuvers.
        ...
        {
            \cf*{Ftr}[4]{Combat Style Rank} You become a rank 4 martial combat style user.
            This gives you access to maneuvers that require a minimum rank of 4 and can improve the effectiveness of your existing maneuvers.

            \cf{Ftr}[4]{Martial Maneuver}
            You learn an additional \glossterm{maneuver} from a martial combat style you have access to (see \pcref{Martial Combat Styles}).
        }

        {
            \cf*{Ftr}[5]{Combat Style Rank} You become a rank 5 martial combat style user.
            This gives you access to maneuvers that require a minimum rank of 5 and can improve the effectiveness of your existing maneuvers.
        ...
        {
            \cf*{Ftr}[6]{Combat Style Rank} You become a rank 6 martial combat style user.
            This gives you access to maneuvers that require a minimum rank of 6 and can improve the effectiveness of your existing maneuvers.
        ...
        {
            \cf*{Ftr}[7]{Combat Style Rank} You become a rank 7 martial combat style user.
            This gives you access to maneuvers that require a minimum rank of 7 and can improve the effectiveness of your existing maneuvers.
    ...
    \subsection{Tactician}
        ...
        \cf*{Ftr}[3]{Tactical Insight} You gain an additional \glossterm{insight point}.
        ...
        \cf*{Ftr}[6]{Tactical Insight} You gain an additional \glossterm{insight point}.

        \cf{Ftr}[7]{Greater Reactive Tactics} The bonus from your \textit{reactive tactics} ability increases to \plus10.
        In addition, all of your \textit{battle tactics} abilities gain the \glossterm{Swift} tag, so their bonuses and penalties take effect in the phase that you active them.
...
\end{dtabularx}
    ...
    \subsection{Basic Class Abilities}
        ...
        \cf{Mnk}{Defenses}
        You gain the following bonuses to your \glossterm{defenses}: \plus2 Armor, \plus4 Fortitude, \plus6 Reflex, \plus6 Mental.
    ...
    \subsection{Esoteric Warrior}\label{Esoteric Warrior}
        ...
        {
            \cf{Mnk}[1]{Esoteric Combat Style}
            You can perform a wide variety of unusual attacks.
            You gain access to one esoteric \glossterm{combat style} (see \pcref{Esoteric Combat Styles}).
            You may spend \glossterm{insight points} to gain access to one additional esoteric combat style per insight point.

            In addition, you learn two rank 1 \glossterm{maneuvers} from esoteric combat styles you have access to.
            You may spend \glossterm{insight points} to learn to one additional maneuver per insight point.
            Unless otherwise noted in an ability's description, using a maneuver requires a \glossterm{standard action}.
        ...
        {
            \cf{Mnk}[2]{Combat Style Rank} You become a rank 2 esoteric combat style user.
            This gives you access to maneuvers that require a minimum rank of 2.
        ...
        {
            \cf*{Mnk}[3]{Combat Style Rank} You become a rank 3 esoteric combat style user.
            This gives you access to maneuvers that require a minimum rank of 3 and can improve the effectiveness of your existing maneuvers.
        ...
        {
            \cf*{Mnk}[4]{Combat Style Rank} You become a rank 4 esoteric combat style user.
            This gives you access to maneuvers that require a minimum rank of 4 and can improve the effectiveness of your existing maneuvers.

            \cf{Mnk}[4]{Esoteric Maneuver}
            You learn an additional \glossterm{maneuver} from an esoteric combat style you have access to (see \pcref{Esoteric Combat Styles}).
        }

        {
            \cf*{Mnk}[5]{Combat Style Rank} You become a rank 5 esoteric combat style user.
            This gives you access to maneuvers that require a minimum rank of 5 and can improve the effectiveness of your existing maneuvers.
        ...
        {
            \cf*{Mnk}[6]{Combat Style Rank} You become a rank 6 esoteric combat style user.
            This gives you access to maneuvers that require a minimum rank of 6 and can improve the effectiveness of your existing maneuvers.
        ...
        {
            \cf*{Mnk}[7]{Combat Style Rank} You become a rank 7 esoteric combat style user.
            This gives you access to maneuvers that require a minimum rank of 7 and can improve the effectiveness of your existing maneuvers.
    ...
    \subsection{Ki}
        ...
        After you use a \textit{ki manifestation}, you cannot use a \textit{ki manifestation} until after the end of the next round.
        {
            ...
            \begin{freeability}{Flash Step}[\glossterm{Teleportation}]
                ...
                \rank{5} You can use this ability to move even if you are \glossterm{immobilized} or \glossterm{grappled}.
...
\end{dtabularx}
    ...
    \subsection{Basic Class Abilities}
        ...
        \cf{Pal}{Defenses}
        You gain the following bonuses to your \glossterm{defenses}: \plus2 Armor, \plus6 Fortitude, \plus4 Reflex, \plus6 Mental.
    ...
    \subsection{Devoted Paragon}
        ...
        \cf{Pal}[0]{Devoted Endurance} You gain \plus2 bonus to your \glossterm{fatigue tolerance}.
        ...
        \subparhead{Chaos} You are immune to the \glossterm{slowed}, \glossterm{decelerated}, and \glossterm{immobilized} effects.
        \subparhead{Evil} You are immune to poisons and diseases.
        \subparhead{Good} You are immune to the \glossterm{shaken}, \glossterm{frightened}, and \glossterm{panicked} effects.
        \subparhead{Law} You are immune to the \glossterm{dazed}, \glossterm{stunned}, \glossterm{disoriented}, and \glossterm{confused} effects.
        ...
        \cf{Pal}[5]{Greater Aligned Immunity}
    ...
    \subsection{Stalwart Guardian}
        ...
        If a vital wound is removed in this way, you gain two \glossterm{fatigue points}.
        ...
        This is a \glossterm{Swift} effect, so it protects against attacks made during the same phase.
    ...
    \subsection{Zealous Warrior}
        ...
        \cf{Pal}[7]{Zealous Fixation} Whenever you hit a creature with a \glossterm{strike}, you ignore \glossterm{concealment} and all \glossterm{miss chances} against that creature with your attacks until you take a \glossterm{short rest} or until you hit a different creature with a strike.
...
\begin{dtabularx}{\textwidth}{l l >{\lcol}X >{\lcol}X >{\lcol}X > {\lcol}X}
    ...
    0 & \tdash & Beast affinity           & Huntmaster               & Keen vision        & Wild senses                            \\
    ...
    3 & 7      & Power of beasts          & Endurance hunter         & Blindsight         & Combat style rank (3), glancing strikes    \\
    ...
    6 & 16     & Greater power of beasts  & Greater endurance hunter & Greater blindsight & Combat style rank (6), greater wild senses \\
...
\end{dtabularx}
    ...
    \subsection{Basic Class Abilities}
        ...
        \cf{Rgr}{Defenses}
        You gain the following bonuses to your \glossterm{defenses}: \plus2 Armor, \plus6 Fortitude, \plus6 Reflex, \plus4 Mental.
    ...
    \subsection{Huntmaster}
        ...
        In addition, using the \textit{desperate exertion} ability on a Survival check to follow tracks only causes you to gain one \glossterm{fatigue point} instead of two.
        ...
        Each \textit{hunting style} ability lasts as long as the \textit{quarry} ability you used it with.
        {
            \begin{freeability}{Anchoring}[Magical]
                ...
                \rankline
                \rank{4} This effect instead applies if your quarry is within \medrange of at least two members of your hunting party.
                \rank{6} This effect instead applies if your quarry is within \medrange of any member of your hunting party.
            \end{freeability}
        ...
        \cf{Rgr}[3]{Endurance Hunter} You gain a \plus2 bonus to your \glossterm{fatigue tolerance}.
        ...
        \cf{Rgr}[6]{Greater Endurance Hunter} The obnus from your \textit{endurance hunter} ability increases to \plus4.
    ...
    \subsection{Wild Warrior}
        ...
        {
            \cf{Rgr}[1]{Wild Combat Style}
            You can channel your wild energy into ferocious attacks.
            You gain access to one wild \glossterm{combat style} (see \pcref{Wild Combat Styles}).
            You may spend \glossterm{insight points} to gain access to one additional wild combat style per insight point.

            In addition, you learn two rank 1 \glossterm{maneuvers} from wild combat styles you have access to.
            You may spend \glossterm{insight points} to learn to one additional maneuver per insight point.
            Unless otherwise noted in an ability's description, using a maneuver requires a \glossterm{standard action}.
        ...
        {
            \cf{Rgr}[2]{Combat Style Rank} You become a rank 2 wild combat style user.
            This gives you access to maneuvers that require a minimum rank of 2.
        ...
        {
            \cf*{Rgr}[3]{Combat Style Rank} You become a rank 3 wild combat style user.
            This gives you access to maneuvers that require a minimum rank of 3 and can improve the effectiveness of your existing maneuvers.
        ...
        {
            \cf*{Rgr}[4]{Combat Style Rank} You become a rank 4 wild combat style user.
            This gives you access to maneuvers that require a minimum rank of 4 and can improve the effectiveness of your existing maneuvers.

            \cf{Rgr}[4]{Wild Maneuver}
            You learn an additional \glossterm{maneuver} from a wild combat style you have access to (see \pcref{Wild Combat Styles}).
        }

        {
            \cf*{Rgr}[5]{Combat Style Rank} You become a rank 5 wild combat style user.
            This gives you access to maneuvers that require a minimum rank of 5 and can improve the effectiveness of your existing maneuvers.
        ...
        {
            \cf*{Rgr}[6]{Combat Style Rank} You become a rank 6 wild combat style user.
            This gives you access to maneuvers that require a minimum rank of 6 and can improve the effectiveness of your existing maneuvers.
        ...
        {
            \cf*{Rgr}[7]{Combat Style Rank} You become a rank 7 wild combat style user.
            This gives you access to maneuvers that require a minimum rank of 7 and can improve the effectiveness of your existing maneuvers.
...
\end{dtabularx}
    ...
    \subsection{Basic Class Abilities}
        ...
        \cf{Rog}{Defenses}
        You gain the following bonuses to your \glossterm{defenses}: \plus1 Armor, \plus4 Fortitude, \plus8 Reflex, \plus6 Mental.
    ...
    \subsection{Assassin}
        ...
        In addition, using the \textit{desperate exertion} ability on a Stealth check only causes you to gain one \glossterm{fatigue point} instead of two.
    ...
    \subsection{Combat Trickster}
...

        {
            ...
            You gain access to one trick \glossterm{combat style} (see \pcref{Trick Combat Styles}).
            You may spend \glossterm{insight points} to gain access to one additional trick combat style per insight point.

            In addition, you learn two rank 1 \glossterm{maneuvers} from trick combat styles you have access to.
            You may spend \glossterm{insight points} to learn to one additional maneuver per insight point.
            Unless otherwise noted in an ability's description, using a maneuver requires a \glossterm{standard action}.
        ...
        {
            \cf{Rog}[2]{Combat Style Rank} You become a rank 2 trick combat style user.
            This gives you access to maneuvers that require a minimum rank of 2.
        ...
        {
            \cf*{Rog}[3]{Combat Style Rank} You become a rank 3 trick combat style user.
            This gives you access to maneuvers that require a minimum rank of 3 and can improve the effectiveness of your existing maneuvers.
        ...
        {
            \cf*{Rog}[4]{Combat Style Rank} You become a rank 4 trick combat style user.
            This gives you access to maneuvers that require a minimum rank of 4 and can improve the effectiveness of your existing maneuvers.

            \cf{Rog}[4]{Trick Maneuver}
            You learn an additional \glossterm{maneuver} from a trick combat style you have access to (see \pcref{Trick Combat Styles}).
        }

        {
            \cf*{Rog}[5]{Combat Style Rank} You become a rank 5 trick combat style user.
            This gives you access to maneuvers that require a minimum rank of 5 and can improve the effectiveness of your existing maneuvers.
        ...
        {
            \cf*{Rog}[6]{Combat Style Rank} You become a rank 6 trick combat style user.
            This gives you access to maneuvers that require a minimum rank of 6 and can improve the effectiveness of your existing maneuvers.
        ...
        {
            \cf*{Rog}[7]{Combat Style Rank} You become a rank 7 trick combat style user.
            This gives you access to maneuvers that require a minimum rank of 7 and can improve the effectiveness of your existing maneuvers.
...
\end{dtabularx}
    ...
    \subsection{Basic Class Abilities}
        ...
        \cf{Sor}{Defenses}
        You gain the following bonuses to your \glossterm{defenses}: \plus0 Armor, \plus4 Fortitude, \plus6 Reflex, \plus10 Mental.
    ...
    \subsection{Draconic Magic}
        ...
        \cf{Sor}[5]{Draconic Spell} You learn an additional spell from your dragon's mystic sphere.

        \cf{Sor}[5]{Energy Immunity} You become immune to your dragon's damage type.

        \cf{Sor}[6]{Greater Draconic Hide} The resistance bonuses from your \textit{stalwart resilience} ability both increase to be equal to twice your rank in this archetype.
    ...
    \subsection{Wild Magic}
        ...
        \cf{Sor}[2]{Chaotic Insight} You learn a spell that does not have the \glossterm{Attune} or \glossterm{Sustain} tags from any \glossterm{mystic sphere}, even if you do not have access to that mystic sphere.
        As normal, you can change which spell you learn with this ability as you gain access to new spell ranks.
...
\end{dtabularx}
    ...
    \subsection{Blessings of the Abyss}
        ...
        \cf{War}[1]{Abyssal Blast} You can use the \textit{eldritch blast} ability as a standard action.
        ...
        \cf{War}[2]{Abyssal Sphere} Choose one of the following \glossterm{mystic spheres}: \sphere{aeromancy}, \sphere{aquamancy}, \sphere{pyromancy}, or \sphere{terramancy}.
        If you already have access to that mystic sphere, you learn two spells from that sphere.
        Otherwise, you gain access to that mystic sphere, including all \glossterm{cantrips} from that sphere.
        ...
        \cf{War}[4]{Abyssal Substitution} Whenever you use an ability that deals \glossterm{energy damage} or any subtype of energy damage, you can change the type of the damage to be fire damage in place of all of its normal damage types.
        ...
        \cf{War}[7]{Abyssal Fusion} Whenever you use an ability that deals \glossterm{energy damage} or any subtype of energy damage, you can choose to have it deal fire damage in addition to its normal damage types.
        Any other aspects of the ability remain unchanged.
    ...
    \subsection{Pact Spell Mastery}
        ...
        \cf{War}[1]{Mystic Insight}[Magical]
        You gain your choice of one of the following abilities.
        Whenever you increase your rank in this archetype, you may change your choice.
        This can allow you to apply the benefits of insights like \textit{signature spell} to higher rank spells.
        {
        ...
        \cf{War}[2]{Soulkeeper's Guidance} Once per \glossterm{long rest}, you may use the \textit{desperate exertion} ability without gaining any \glossterm{fatigue points} to affect a pact spell you cast (see \pcref{Desperate Exertion}).
        ...
        \cf*{War}[7]{Mystic Insight}[Magical]
        You gain an additional \textit{mystic insight} ability.
    ...
    \subsection{Soulkeeper's Chosen}
        ...
        \begin{attuneability}{Possession}[\glossterm{Sustain} (free)]
            ...
            \begin{itemize}
                ...
                \item You gain a bonus equal to your rank in this archetype to your \glossterm{power} with \glossterm{magical} abilities.
...
\begin{dtabularx}{\textwidth}{l l >{\lcol}X >{\lcol}X >{\lcol}X >{\lcol}X}
    ...
    3 & 7      & Greater alchemical infusion & Spell rank (3), greater mage armor & Contingency          & Wellspring of power         \\
    4 & 10     & Experienced quaffing        & Spell rank (4), spell knowledge    & Scholastic insight   & Mystic insight              \\
    5 & 13     & Alchemical discovery        & Spell rank (5)                     & Greater ritualist    & Greater arcane attunement   \\
    6 & 16     & Supreme alchemical infusion & Spell rank (6), supreme mage armor & Scholastic insight   & Greater wellspring of power \\
...
\end{dtabularx}
    ...
    \subsection{Alchemist}
        ...
        \cf{Wiz}[2]{Alchemical Discovery} You gain your choice of one of the following benefits.
        {
            ...
            \parhead{Potent Construction} Alchemical items you create gain a bonus to power equal to your rank in this archetype.
    ...
    \subsection{Arcane Scholar}
        ...
        In addition, using the \textit{desperate exertion} ability on a Knowledge check only causes you to gain one \glossterm{fatigue point} instead of two.
...

        {
            ...
            If you lead a ritual from that \glossterm{mystic sphere}, it requires half the normal amount of time to perform and causes half the normal number of \glossterm{fatigue points}, to a minimum of zero fatigue points.
            \par You can choose this insight multiple times, choosing a different \glossterm{mystic sphere} each time.
        }

        \cf{Wiz}[3]{Contingency} You gain the ability to prepare a spell so it takes effect automatically if specific circumstances arise.
        ...
        \cf{Wiz}[5]{Greater Ritualist} Whenever you lead a ritual, it requires half the normal number of \glossterm{fatigue points} and half the normal time to complete, to a minimum of zero fatigue points.
