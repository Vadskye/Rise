...
\section{Ranger}\label{Ranger}
    ...
    \subsection{Class Abilities}
        ...
        Whenever the ranger damages his quarry with a physical attack, it is dimensionally anchored, as the \spell{dimensional anchor} spell, for 2 rounds.
