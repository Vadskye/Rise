...
\section{Sorcerer}\label{Mage}
    \begin{dtable!*}
        ...
        \begin{dtabularx}{\textwidth}{l l >{\lcol}X >{\lcol}X >{\lcol}X >{\lcol}X >{\lcol}X}
            ...
            5 & 11 & Spell rank (5)        & Greater mage armor          & Draconic heart             & Greater mystic tolerance & Greater wild power       \\
    ...
    \subsection{Wild Magic}
        ...
        \cf{Sor}[1]{Wildspell} Whenever you cast a spell, you may use this ability after making all other decisions for the spell (such as targets, intended area, and so on).
