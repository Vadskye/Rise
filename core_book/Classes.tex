...
\section{Barbarian}\label{Barbarian}
    \begin{dtable!*}
        ...
        \begin{dtabularx}{\textwidth}{c >{\lcol}X >{\lcol}X >{\lcol}X >{\lcol}X}
            ...
            \\ 5 & Soulscarred               & Greater rage               & Greater primal power & Savage resilience
            \\ 6 & Greater fury of the storm & Greater intimidating anger & Primal prowess       & Greater savage precision, greater savage force
            \\ 7 & Greater battle-scarred    & Greater invigorating rage  & Primal maneuver      & Supreme fast movement
    ...
    \subsection{Battlerager}\label{Rage}
        ...
        \begin{apability}{Rage}[\glossterm{Emotion}, \glossterm{Sustain} (free), \glossterm{Swift}]
            ...
            \begin{itemize}
                ...
                \item At the end of each round, if you did not make a physical attack that round, you gain a point of \glossterm{fatigue}.
        ...
        \cf{Bbn}[4]{Invigorating Rage} During your \textit{rage} ability, you remove a point of \glossterm{fatigue} at the end of each round if you dealt damage to another creature with a \glossterm{mundane} ability that round.

        \cf{Bbn}[5]{Greater Rage} The \glossterm{power} bonus from your \textit{rage} ability increases to \plus4.

        \cf{Bbn}[6]{Greater Intimidating Anger}
...
\section{Cleric}\label{Cleric}
    ...
    \subsection{Divine Spellcasting}
        ...
        Some spells are considered \glossterm{cantrips}.
        As a \glossterm{standard action}, you can cast any \glossterm{cantrip} spells from any mystic sphere you have access to.

        In addition to \glossterm{cantrips}, you learn one 1st level \glossterm{spell} from your chosen \glossterm{mystic spheres}.
        ...
        Many spells also cost \glossterm{action points}, as indicated by the presence of an \glossterm{AP} tag (see \pcref{Ability Tags}).
    ...
    \subsection{Healer}
        ...
        \begin{freeability}{Divine Healing}[\glossterm{Life}, \glossterm{Magical}]
            ...
            The target removes a point of \glossterm{fatigue}.
        \end{freeability}
        ...
        \cf{Clr}[3]{Vital Healing} When you cause a creature to remove a point of \glossterm{fatigue} with a \glossterm{magical} ability, you can spend a \glossterm{reserve action point}.
        If you do, you cause the target to remove a \glossterm{vital wound} instead of a point of \glossterm{fatigue}.
        You can only use this ability once per round.

        \cf{Clr}[4]{Greater Divine Healing} When you use your \textit{divine healing} ability, you can spend an \glossterm{action point}.
        If you do, the target removes an additional point of \glossterm{fatigue}.
        In addition, the \glossterm{range} of that ability increases to \rngclose.

        \cf{Clr}[5]{Greater Divine Cleanse} Your \textit{divine cleanse} ability gains the \glossterm{Swift} tag.
        This means that any effects of the removed condition do not affect the target during the current phase.

        \cf{Clr}[6]{Greater Vital Healing} You can use your \textit{vital healing} ability by spending a \glossterm{recovery action point} instead of a \glossterm{reserve action point}.

        \cf{Clr}[7]{Supreme Divine Healing} When you use your \textit{divine healing} ability, the target removes two points of \glossterm{fatigue} instead of one. 
    ...
    \subsection{Cleric Domain Abilities}\label{Cleric Domain Abilities}
        ...
        \subsubsection{Death}
            ...
            The \glossterm{wound threshold} of each enemy in the area is reduced by an amount equal to your \glossterm{power}.
        ...
        \subsubsection{Life}
            ...
            \parhead{Aspect} You gain a bonus equal to your \glossterm{power} to your \glossterm{wound threshold}.
            ...
            \parhead{Mastery} At the end of each round, you remove a point of \glossterm{fatigue}.
        ...
        \subsubsection{Magic}
            ...
            \parhead{Essence} Once per round, when you cast a spell, you may spend an \glossterm{action point}.
            If you do, remove a point of \glossterm{fatigue}.
            \parhead{Mastery} When you use this domain's essence ability, you remove two points of \glossterm{fatigue} instead of one.
...
\section{Druid}\label{Druid}
    ...
    \subsection{Shifter}\label{Shifter}
...

        {
            ...
            \begin{freeability}{Form of the Oak}
                ...
                \rankline
                \rank{3} You gain a \glossterm{magic bonus} equal to half your \glossterm{power} to \glossterm{damage reduction} against \glossterm{physical damage}.
                \rank{5} The damage reduction increases to be equal to your \glossterm{power}.
            ...
            \begin{freeability}{Photosynthesis}
                ...
                \rankline
                \rank{3} As long as you are in natural sunlight, at the end of each round you may spend an \glossterm{action point}.
    ...
    \subsection{Beastmaster}
        ...
        \begin{attuneability}{Animal Companion}[\glossterm{Attune} (self), \glossterm{Emotion}, \glossterm{Magical}]
            ...
            Its \glossterm{fatigue threshold} is equal to your \glossterm{power}.
            Its \glossterm{wound threshold} is equal to three times your \glossterm{power}.
...
\section{Fighter}\label{Fighter}
    \begin{dtable!*}
        ...
        \begin{dtabularx}{\textwidth}{c >{\lcol}X >{\lcol}X >{\lcol}X >{\lcol}X}
            ...
            \\ 2 & Disciplined threat          & Weapon training         & Martial lore          & Guided strike
            \\ 3 & Disciplined defense         & Greater armor expertise & Martial power         & Battle lore
            \\ 4 & Greater discipline          & Weapon expertise        & Martial maneuver      & Battle tactic
            \\ 5 & Greater disciplined threat  & Supreme armor expertise & Greater martial power & Brave leader, greater guided strike
            \\ 6 & Disciplined mind            & Greater weapon training & Steady expertise      & Greater battle tactics
            \\ 7 & Greater disciplined defense & Armored juggernaut      & Martial maneuver      & Battle tactic
    ...
    \subsection{Combat Discipline}
        ...
        \cf{Ftr}[1]{Discipline} You can use the \textit{discipline} ability as a \glossterm{minor action}.
    ...
    \subsection{Battle Leader}
        ...
        \cf{Ftr}[5]{Greater Guided Strike} When you use your \textit{guided strike} ability, the target also gains a \plus2 bonus to \glossterm{accuracy} with the strike.
...
\section{Mage}\label{Mage}
    ...
    \subsection{Arcane Scholar}
        ...
        For example, you could specify ``when I fall at least 50 feet'' or ``when I take a \glossterm{vital wound}'', but not ``when there is an invisible creature within 50 feet of me'' or ``when my \glossterm{wound threshold} is 20 or lower.''
    ...
    \subsection{Innate Arcanist}
        ...
        Once per round, when you are the target of a spell, you may spend an \glossterm{action point}.
        If you do, remove a point of \glossterm{fatigue}.
        You can use this ability even if the spell has an attack that fails.
    ...
    \subsection{Ki}
        ...
        You cannot use more than one \textit{ki manifestation} per round.
        {
            \begin{apability}{Abandon the Fragile Self}[\glossterm{Swift}]
                ...
                \rankline
                \rank{3} You are also immune to all \glossterm{conditions} during the current phase, preventing new conditions from being applied to you.
                \rank{5} The immunity to conditions lasts until the end of the round.
                \rank{7} The immunity to conditions lasts until the end of the next round.
            \end{apability}
            ...
            \begin{apability}{See the Flow of Life}
                ...
                \rankline
                \rank{3} The range of the ability is increased to 100 feet.
                \rank{5} This ability gains the \glossterm{Sustain} (minor) tag.
                \rank{7} This ability gains the \glossterm{Attune} tag in place of the \glossterm{Sustain} (minor) tag.
            \end{apability}
        ...
        \cf{Mnk}[2]{Ki Strike} You can use the \textit{ki strike} ability as a standard action.
        ...
        \cf{Mnk}[8]{Supreme Ki Barrier} The shield from your \textit{ki barrier} ability increases to \plus2.

        \cf{Mnk}[8]{Supreme Ki Strike} The damage bonus from your \textit{greater ki strike} ability increases to \plus2d.
...
\section{Paladin}\label{Paladin}
    ...
    \subsection{Zealous Warrior}
        ...
        \cf{Pal}[2]{Recovering Smite} You can use the \textit{recovering smite} ability as a standard action.
        ...
        \cf{Pal}[3]{Zealous Power} You gain a \plus1 bonus to \glossterm{power} with \glossterm{mundane} abilities.
    ...
    \subsection{Stalwart Guardian}
        ...
        In addition, you gain a bonus equal to your \glossterm{power} to your \glossterm{wound threshold}.
...
\section{Ranger}\label{Ranger}
    \begin{dtable!*}
        ...
        \begin{dtabularx}{\textwidth}{c >{\lcol}X >{\lcol}X >{\lcol}X > {\lcol}X}
            ...
            \\ 4 & Wary hunter    & Perceive weakness  & Wild maneuver      & Monster familiarity
            \\ 5 & Hunting style  & Blindsight         & Wilderness mastery & Favored enemy
    ...
    \subsection{Huntmaster}
        ...
        Each \textit{hunting style} ability lasts as long as the \textit{quarry} ability you used it with.
        {
            ...
            \begin{freeability}{Coordinated Stealth}
                Your quarry takes a \minus4 penalty to Awareness checks to notice members of your \glossterm{hunting party}.
            ...
            \begin{freeability}{Cover Weaknesses}
                ...
                \rankline
                \rank{4} Your hunting party gains a bonus equal to half your level to \glossterm{damage reduction} against your quarry's attacks.
                \rank{6} The damage reduction increases to be equal to your level.
            ...
            \begin{freeability}{Lifeseal}[Magical]
                As long as your quarry is \glossterm{threatened} by at least two members of your \glossterm{hunting party}, it cannot remove \glossterm{fatigue}.
            ...
            \begin{freeability}{Swarm Hunter}
                ...
                \rank{6} The bonus to overwhelm resistance applies to all members of your \glossterm{hunting party}.
...
\section{Warlock}\label{Warlock}
    ...
    \subsection{Blessings of the Abyss}
        ...
        {
            \parhead{Bloodreaving} If you inflict a \glossterm{vital wound} with the spell, you remove a point of \glossterm{fatigue}.
