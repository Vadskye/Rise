...
\section{Mage}\label{Mage}
    \begin{dtable}
        ...
        \begin{dtabularx}{\columnwidth}{>{\ccol}p{\levelcol} >{\ccol}p{\babcolpoor} c >{\lcol}X}
            \tb{Level} & \tb{Combat Prowess} & \tb{Spells} & \tb{Special} \\
            \hline
            \wizardprogressionrow{1}  & 3  & Arcane essence, rituals, spells \\
            \wizardprogressionrow{2}  & 4  & Arcane defense \\
            \wizardprogressionrow{3}  & 4  & Arcane insight \\
            \wizardprogressionrow{4}  & 5  & Arcane essence \\
            \wizardprogressionrow{5}  & 5  & Arcane insight \\
            \wizardprogressionrow{6}  & 6  & Inherent magic \\
            \wizardprogressionrow{7}  & 6  & Arcane insight \\
            \wizardprogressionrow{8}  & 7  & Arcane essence \\
            \wizardprogressionrow{9}  & 7  & Arcane insight \\
            \wizardprogressionrow{10} & 8  & Inherent magic \\
            \wizardprogressionrow{11} & 8  & Arcane insight \\
            \wizardprogressionrow{12} & 9  & Arcane essence \\
            \wizardprogressionrow{13} & 9  & Arcane insight \\
            \wizardprogressionrow{14} & 10  & Inherent magic \\
            \wizardprogressionrow{15} & 10  & Arcane insight \\
            \wizardprogressionrow{16} & 11 & Arcane essence \\
            \wizardprogressionrow{17} & 11 & Arcane insight \\
            \wizardprogressionrow{18} & 12 & Inherent magic \\
            \wizardprogressionrow{19} & 12 & Arcane insight \\
            \wizardprogressionrow{20} & 13 & Archmage       \\
        \end{dtabularx}
    \end{dtable}
