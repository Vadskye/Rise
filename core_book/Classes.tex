...
\section{Druid}\label{Druid}
    \begin{dtable}
        ...
        \begin{dtabularx}{\columnwidth}{>{\ccol}p{\levelcol} >{\ccol}p{3.5em} c >{\lcol}X}
            ...
            \nth{12} & 4 & 5 \add 2 & \tdash                       \\
            \nth{13} & 4 & 5 \add 2 & Nature's champion            \\
            \nth{14} & 4 & 6 \add 3 & \tdash                       \\
    ...
    \subsection{Class Abilities}
        ...
        \subsubsection{Natural Influence}
            ...
            \cf{Drd}[5]{Nature's Servant}
            You gain two extra skill points which must be spent on the Creature Handling, Knowledge (geography), Knowledge (nature), or Survival skills.

            \cf{Drd}[9]{Spell Knowledge}
            You learn an additional spell from the nature \glossterm{spell list} (see \pcref{Nature Spells}).

            \cf{Drd}[13]{Nature's Champion}
            You gain two extra skill points which must be spent on the Creature Handling, Knowledge (geography), Knowledge (nature), or Survival skills.
            In addition, you gain a \plus1 bonus to those skills.
