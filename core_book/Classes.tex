...
\section{Cleric}\label{Cleric}
    ...
    \subsection{Cleric Domain Abilities}\label{Cleric Domain Abilities}
        ...
        \subsubsection{War}
            ...
            \parhead{Aspect} Whenever you miss by 2 or less with a \glossterm{strike}, the target takes half damage from the strike.
            This is called a \glossterm{glancing blow}.
            \parhead{Essence} You deal half damage to your allies with \glossterm{magical} abilities.
            \parhead{Mastery} You gain a bonus equal to your rank in this archetype to your \glossterm{power} with all abilities.
    ...
    \subsection{Shifter}\label{Shifter}
...

        {
            ...
            \begin{freeability}{Form of the Bull}
                ...
                The weapon deals 1d8 damage, and has the Forceful weapon tag (see \pcref{Weapon Tags}).
        ...
        \cf{Drd}[3]{Glancing Strikes} Whenever you miss by 2 or less with a \glossterm{strike} using a \glossterm{natural weapon}, the target takes half damage from the strike.
        This is called a \glossterm{glancing blow}.
...
\section{Paladin}\label{Paladin}
    ...
    \subsection{Zealous Warrior}
        ...
        \cf{Pal}[3]{Zealous Fixation} Whenever you hit a creature with a \glossterm{strike}, you ignore \glossterm{concealment} and all \glossterm{miss chances} against that creature with your attacks until you take a \glossterm{short rest} or until you hit a different creature with a strike.
        ...
        \cf{Pal}[4]{Greater Smite} You gain a \plus1d bonus to your damage with the strike from your \textit{smite} ability.
...
\section{Rogue}\label{Rogue}
    ...
    \subsection{Combat Trickster}
...

        {
            ...
            \cf{Rog}[5]{Tricky Force} You gain a \plus1d bonus to your damage with all weapons.
        }
