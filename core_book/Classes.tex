...
\section{Barbarian}\label{Barbarian}
    ...
    \subsection{Battleforged Resilience}
        ...
        \cf{Bbn}[2]{Toughened Body} You gain a \plus2 bonus to Fortitude defense and a \plus1 bonus to your \glossterm{fatigue tolerance} (see \pcref{Fatigue Tolerance}).
        ...
        In addition, the bonus to \glossterm{fatigue tolerance} increases to \plus2.
    ...
    \subsection{Primal Warrior}
        ...
        {
            \cf*{Bbn}[8]{Maneuver Rank} You become a rank 8 primal maneuverist.
            This gives you access to maneuvers that require a minimum rank of 8 and can improve the effectiveness of your existing maneuvers.
...
\section{Cleric}\label{Cleric}
    ...
    \subsection{Divine Magic}
        ...
        This gives you access to spells that require a minimum rank of 8 and can improve the effectiveness of your existing spells.
    ...
    \subsection{Healer}
        ...
        \begin{freeability}{Divine Healing}[\glossterm{Magical}]
            ...
            \rankline
            \rank{5} The target can remove an additional \glossterm{vital wound}.
            \rank{7} The range increases to \rngmed.
        \end{freeability}
        ...
        \cf{Clr}[7]{Wellspring of Health} When you use your \textit{divine healing} ability,
            ...
            you do not gain any \glossterm{fatigue points} from the ability.
    ...
    \subsection{Cleric Domain Abilities}\label{Cleric Domain Abilities}
        ...
        \subsubsection{Magic}
            ...
            \parhead{Essence} The power bonus from this domain's gift increases to \plus2.
            \parhead{Mastery} The power bonus from this domain's gift increases to \plus5.

        \subsubsection{Protection}
            \parhead{Gift} You gain a \plus1 bonus to Armor defense.
            \parhead{Aspect} You gain a bonus equal to half your level to your \glossterm{resistances} against \glossterm{energy damage}.
            \parhead{Essence} The bonus from this domain's aspect increases to be equal to your level.
            \parhead{Mastery} The bonus from this domain's gift increases to \plus2, and it applies to all defenses instead of only Armor defense.
        ...
        \subsubsection{War}
            ...
            \parhead{Essence} Whenever you deal damage to an ally with a \glossterm{magical} ability, that damage is considered \glossterm{environmental damage}.
...
\section{Druid}\label{Druid}
    ...
    \subsection{Nature Magic}
        ...
        \cf{Drd}[8]{Epic Spell Knowledge} You learn two additional divine spells.
    ...
    \subsection{Shifter}\label{Shifter}
...

        {
            ...
            \begin{freeability}{Form of the Oak}
                ...
                \rankline
                \rank{3} You gain a bonus equal to half your level to \glossterm{resistances} against \glossterm{physical damage}.
                \rank{5} The resistance bonus increases to be equal to your level.
...
\section{Fighter}\label{Fighter}
    ...
    \subsection{Combat Discipline}
        ...
        You increase your maximum \glossterm{hit points} by 1.
        In addition, you gain a \plus1 bonus to your \glossterm{fatigue tolerance} (see \pcref{Fatigue Tolerance}).
        ...
        The number of hit points you gain from your \textit{enduring discipline} ability increases to 2.
        In addition, the bonus to your fatigue tolerance increases to \plus2.
    ...
    \subsection{Equipment Training}
        ...
        \cf{Ftr}[3]{Equipment Efficiency} You gain an additional \glossterm{attunement point}.
        ...
        \cf{Ftr}[6]{Greater Equipment Efficiency} The number of attunement points you gain from your \textit{efficient equipment} ability increases to two.
        ...
        In addition, the number of attunement points you gain from your \textit{efficient equipment} ability increases to three.
    ...
    \subsection{Martial Mastery}
        ...
        \cf*{Ftr}[8]{Maneuver Rank} You become a rank 8 martial maneuverist.
        This gives you access to maneuvers that require a minimum rank of 8 and can improve the effectiveness of your existing maneuvers.
...
\section{Monk}\label{Monk}
    \begin{dtable!*}
        ...
        \begin{dtabularx}{\textwidth}{l l >{\lcol}X >{\lcol}X >{\lcol}X >{\lcol}X}
            ...
            4 & 8  & Maneuver rank (4), esoteric fluidity         & Greater ki barrier, ki manifestation & Greater fast movement          & Feel the flow of life         \\
            5 & 11 & Maneuver rank (5), esoteric maneuver         & Ki focus                             & Greater perfect body           & Transcend flesh               \\
            6 & 14 & Maneuver rank (6), esoteric agility          & Greater ki power                     & Greater perfect precision      & Greater inner peace           \\
            7 & 17 & Maneuver rank (7), greater esoteric fluidity & Supreme ki barrier, ki manifestation & Supreme fast movement          & Greater feel the flow of life \\
    ...
    \subsection{Esoteric Warrior}\label{Esoteric Warrior}
        ...
        \cf*{Mnk}[8]{Maneuver Rank} You become a rank 8 esoteric maneuverist.
        This gives you access to maneuvers that require a minimum rank of 8 and can improve the effectiveness of your existing maneuvers.
    ...
    \subsection{Ki}
        ...
        \cf{Mnk}[2]{Ki Strike} You can treat all strikes you make as \glossterm{magical}, allowing you to use your \glossterm{power} with magical abilities to determine their damage.
        ...
        \cf{Mnk}[4]{Greater Ki Barrier}[Magical] The defense bonus from the body armor provided by your \textit{ki barrier} ability increases to \plus3.
        ...
        \cf{Mnk}[5]{Ki Focus} You gain a \plus2 bonus to Mental defense.
        ...
        \cf{Mnk}[7]{Supreme Ki Barrier}[Magical] The defense bonus from the body armor provided by your \textit{ki barrier} ability increases to \plus4.
    ...
    \subsection{Transcendent Sage}
        ...
        \cf{Mnk}[4]{Feel the Flow of Life}[Magical] You become so attuned to the natural energy of life that you can sense it even when sight fails you.
        You gain the \glossterm{lifesense} ability with a 100 foot range.
        In addition, you gain the \glossterm{lifesight} ability with a 20 foot range.
        ...
        \cf{Mnk}[7]{Greater Feel the Flow of Life}[Magical]
...
\section{Paladin}\label{Paladin}
    ...
    \subsection{Devoted Paragon}
        ...
        \subparhead{Evil} When a target removes a \glossterm{condition}, it gains a \glossterm{fatigue point}.
    ...
    \subsection{Divine Spell Expertise}
        ...
        \cf{Pal}[2]{Combat Caster} You reduce your \glossterm{focus penalty} by 2.
    ...
    \subsection{Stalwart Guardian}
        ...
        \begin{freeability}{Lay on Hands}
            ...
            \rankline
            \rank{3} Instead of regaining hit points, you can cause the target to remove a \glossterm{condition} of its choice affecting it.
            \rank{5} Instead of regaining hit points, you can cause the target remove one of its \glossterm{vital wounds}.
            If it does, you gain two \glossterm{fatigue points}.
        ...
        In addition, you gain a \plus1 bonus to \glossterm{fatigue tolerance} (see \pcref{Fatigue Tolerance}).

        \cf{Pal}[3]{Stalwart Resilience}
        You gain a bonus to your \glossterm{resistances} against \glossterm{physical damage} equal to half your level.
        ...
        The bonuses from your \textit{enduring defender} ability increase to \plus2.

        \cf{Pal}[6]{Greater Stalwart Resilience} The bonus from your \textit{stalwart resilience} ability increases to be equal to your level.
...
\section{Ranger}\label{Ranger}
    \begin{dtable!*}
        ...
        \begin{dtabularx}{\textwidth}{l l >{\lcol}X >{\lcol}X >{\lcol}X > {\lcol}X}
            ...
            4 & 8  & Greater animal companion & Endurance tracker          & Blindsight                & Maneuver rank (4), wild senses          \\
            ...
            7 & 17 & Supreme animal companion & Greater endurance tracker  & Greater blindsight        & Maneuver rank (7), greater wild senses  \\
    ...
    \subsection{Beastmaster}
        ...
        \begin{attuneability}{Animal Companion}[\glossterm{Attune} (self), \glossterm{Emotion}, \glossterm{Magical}]
            ...
            \begin{itemize}
                \item Its \glossterm{bleed resistance} and \glossterm{vital resistance} are equal to the normal values based on your level \add your base Constitution (see \tref{Resistance Values}).
                \item It has 10 \glossterm{hit points}.
    ...
    \subsection{Huntmaster}
        ...
        \cf{Rgr}[4]{Endurance Tracker} You gain a \plus1 bonus to your \glossterm{fatigue tolerance} (see \pcref{Fatigue Tolerance}).
        In addition, you gain a \plus3 bonus to the Survival skill.
        ...
        \cf{Rgr}[7]{Greater Endurance Tracker} The bonus to your fatigue tolerance from your \textit{endurance tracker} ability increases to \plus2.
        In addition, the bonus to the Survival skill increases to \plus6.
    ...
    \subsection{Wilderness Warrior}
        ...
        \cf*{Rgr}[8]{Maneuver Rank} You become a rank 8 wild maneuverist.
        This gives you access to maneuvers that require a minimum rank of 8 and can improve the effectiveness of your existing maneuvers.
...
\section{Rogue}\label{Rogue}
    ...
    \subsection{Combat Trickster}
        ...
        \cf*{Rog}[8]{Maneuver Rank} You become a rank 8 trick maneuverist.
        This gives you access to maneuvers that require a minimum rank of 8 and can improve the effectiveness of your existing maneuvers.
    ...
    \subsection{Jack of All Trades}
        ...
        \cf{Rog}[6]{Greater Versatile Power} The bonus from your \textit{versatile power} ability increases to \plus2.
...
\section{Sorcerer}\label{Mage}
    \begin{dtable!*}
        ...
        \begin{dtabularx}{\textwidth}{l l >{\lcol}X >{\lcol}X >{\lcol}X >{\lcol}X >{\lcol}X}
            ...
            3 & 5  & Spell rank (3)                       & Wellspring of power         & Draconic precision         & Innate enhancement         & Chaotic exertion                            \\
            ...
            6 & 14 & Spell rank (6)                       & Greater wellspring of power & Greater draconic precision & Greater innate enhancement & Greater chaotic exertion                    \\
            ...
            8 & 20 & Spell rank (8), epic spell knowledge & Epic arcane mastery         & Epic innate enhancement    & Epic wildspell             &                                             \\
        \end{dtabularx}
    \end{dtable!*}
    ...
    \subsection{Arcane Magic}
        ...
        \cf{Sor}[7]{Supreme Mage Armor}[Magical]
        The defense bonus from the body armor created by your \textit{mage armor} ability increases to \plus3.
        In addition, the bonus to \glossterm{resistances} against \glossterm{energy damage} increases to be equal to your \glossterm{power}.
    ...
    \subsection{Draconic Magic}
        ...
        \cf{Sor}[1]{Draconic Bloodline} Choose a type of dragon from among the dragons on \trefnp{Draconic Bloodline Types}.
        ...
        In addition, you treat all damage of the type your dragon resists as \glossterm{environmental damage}, preventing you from losing hit points from attacks that do not beat your \glossterm{bleed resistance} (see \pcref{Environmental Damage}).
    ...
    \subsection{Innate Arcanist}
        ...
        \cf{Sor}[3]{Innate Enhancement} You gain a \plus1 \glossterm{magic bonus} to \glossterm{accuracy} and \glossterm{defenses}.
        Because this is a magic bonus, it does not stack with other magic bonuses.
        ...
        \cf*{Sor}[6]{Greater Innate Enhancement} The bonus from your \textit{personal enhancement} ability increases to \plus2.
        ...
        \cf{Sor}[8]{Epic Innate Enhancement} The bonus from your \textit{personal enhancement} ability increases to \plus4.
    ...
    \subsection{Wild Magic}
        ...
        \begin{dtable}
            ...
            \begin{dtabularx}{\textwidth}{l X}
                ...
                7 & Each target that \glossterm{bleeds} from the spell's damage this round is also \glossterm{dazed} as a \glossterm{condition} \\
        ...
        \cf{Sor}[3]{Chaotic Exertion} Once per \glossterm{long rest}, you can use the \textit{desperate exertion} ability without gaining any \glossterm{fatigue points}.
        ...
        \begin{dtable}
            ...
            \begin{dtabularx}{\textwidth}{l X}
                ...
                8 & Each target that \glossterm{bleeds} from the spell this round is also \glossterm{stunned} as a \glossterm{condition} \\
...
\section{Warlock}\label{Warlock}
    ...
    \subsection{Soulkeeper's Chosen}
        ...
        \begin{freeability}{Exchange Vitality}[\glossterm{Magical}]
            When you use this ability, you gain two \glossterm{fatigue points}.

            You remove one of your \glossterm{vital wounds}.
...
\section{Wizard}\label{Wizard}
    \begin{dtable!*}
        ...
        \begin{dtabularx}{\textwidth}{l l >{\lcol}X >{\lcol}X >{\lcol}X >{\lcol}X}
            ...
            1 & 1  & Portable workshop            & Spellcasting, mage armor             & Scholastic lore       & Mystic insight              \\
            2 & 2  & Alchemical infusion          & Spell rank (2), spell knowledge      & Ritualist             & Insightful caster           \\
            3 & 5  & Alchemical discovery         & Spell rank (3)                       & Scholastic insight    & Wellspring of power         \\
            4 & 8  & Alchemical expertise         & Spell rank (4), greater mage armor   & Ritual expertise      & Mystic insight              \\
            5 & 11 & Experienced quaffing         & Spell rank (5), spell knowledge      & Contingency           & Greater insightful caster   \\
            6 & 14 & Alchemical discovery         & Spell rank (6)                       & Scholastic insight    & Greater wellspring of power \\
            7 & 17 & Greater alchemical expertise & Spell rank (7), supreme mage armor   & Malleable contingency & Mystic insight              \\
    ...
    \subsection{Arcane Magic}
        ...
        \cf{Wiz}[7]{Supreme Mage Armor}[Magical]
        The defense bonus from the body armor created by your \textit{mage armor} ability increases to \plus3.
        In addition, the bonus to \glossterm{resistances} against \glossterm{energy damage} increases to be equal to your \glossterm{power}.
    ...
    \subsection{Arcane Scholar}
        ...
        \cf{Wiz}[5]{Contingency} You gain the ability to prepare a spell so it takes effect automatically if specific circumstances arise.
