...
\end{dtabularx}
    ...
    \subsection{Basic Class Abilities}
        ...
        \begin{itemize}
            ...
            \item A \plus4 bonus to your \glossterm{fatigue tolerance}, which makes it easier for you to use powerful abilities that fatigue you (see \pcref{Fatigue Points}).
        \end{itemize}
...
\end{dtabularx}
    ...
    \subsection{Basic Class Abilities}
        ...
        \begin{itemize}
            ...
            \item A \plus1 bonus to your \glossterm{fatigue tolerance}, which makes it easier for you to use powerful abilities that fatigue you (see \pcref{Fatigue Points}).
        \end{itemize}
...
\end{dtabularx}
    ...
    \subsection{Basic Class Abilities}
        ...
        \begin{itemize}
            ...
            \item Nine \glossterm{skill points}, which you can spend to learn skills (see \pcref{Skills}).
            \item One \glossterm{attunement point}, which you can use to attune to items and abilities that affect you (see \pcref{Attunement Points}).
            \item A \plus2 bonus to your \glossterm{fatigue tolerance}, which makes it easier for you to use powerful abilities that fatigue you (see \pcref{Fatigue Points}).
        \end{itemize}
...
\end{dtabularx}
    ...
    \subsection{Basic Class Abilities}
        ...
        \begin{itemize}
            ...
            \item Six \glossterm{skill points}, which you can spend to learn skills (see \pcref{Skills}).
            \item One \glossterm{attunement point}, which you can use to attune to items and abilities that affect you (see \pcref{Attunement Points}).
            \item A \plus3 bonus to your \glossterm{fatigue tolerance}, which makes it easier for you to use powerful abilities that fatigue you (see \pcref{Fatigue Points}).
        \end{itemize}
