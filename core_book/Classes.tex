...
\end{dtabularx}
    ...
    \subsection{Battleforged Resilience}
        ...
        \cf{Bbn}[2]{Resilient Recovery} You regain half of your maximum \glossterm{physical resistance} and \glossterm{energy resistance} when you take the \textit{recover} action (see \pcref{Recover}).
