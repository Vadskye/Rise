...
\section{Barbarian}\label{Barbarian}
    \begin{dtable}
        ...
        \begin{dtabularx}{\columnwidth}{c >{\lcol}X >{\lcol}X >{\lcol}X}
            ...
            \\ 2 & Battle-scarred            & Cleansing rage         & Athletic prowess
            \\ 3 & Battleforged fortitude    & Focused rage           & Primal exertion
            \\ 4 & Soulscarred               & Fearsome rage          & Athletic prowess
            \\ 5 & Greater fury of the storm & Greater cleansing rage & Primal exertion
            \\ 6 & Agile defense             & Greater fearsome rage  & Primal prowess
    ...
    \subsection{Battlerager}\label{Rage}
        ...
        \begin{attuneability}{Rage}[\glossterm{Attune} (self), \glossterm{Swift}]
            ...
            \begin{itemize}
                ...
                \item You take a \minus1 penalty to \glossterm{accuracy} with \glossterm{strikes}.
        ...
        \cf{Bbn}[2]{Cleansing Rage}
        When you use your \textit{rage} ability, if you are not already in a rage, you can remove one \glossterm{condition} affecting you.

        \cf{Bbn}[3]{Focused Rage}
        Your \textit{rage} ability no longer imposes a penalty to \glossterm{accuracy} with \glossterm{strikes}.

        \cf{Bbn}[4]{Fearsome Rage}
        As long as your \textit{rage} ability is active, you radiate an aura of fear in a \arealarge radius emanation.
        At the end of each \glossterm{action phase}, make an attack vs. Mental against all creatures in the area that you did not already attack with this ability.
        On a hit, each target is \glossterm{shaken} by you as a \glossterm{condition}.

        \cf{Bbn}[5]{Greater Cleansing Rage} 
        You can remove two conditions with your \textit{cleansing rage} ability instead of only one.

        \cf{Bbn}[6]{Greater Fearsome Rage}
        If you hit a target with your \textit{fearsome rage} ability, the target is \glossterm{frightened} by you instead of \glossterm{shaken}.
    ...
    \subsection{Primal Warrior}
        ...
        You can use any \textit{primal exertion} ability you know as a \glossterm{standard action}.
        {
            \begin{apability}{Battle Cry}[\glossterm{Mind}]
                You and all allies within a \arealarge radius burst from you heal hit points equal to \glossterm{standard damage}.
            ...
            \begin{apability}{Leaping Strike}
                ...
                \rankline
                \rank{4} You gain a \plus1d bonus to damage with the strike per 10 feet of height you travelled downward towards your foe during the leap before making the strike, up to a maximum of \plus2d.
                \rank{6} The maximum damage bonus increases to \plus4d.
                \rank{8} The maximum damage bonus increases to \plus6d.
            \end{apability}
...
\section{Cleric}\label{Cleric}
    ...
    \subsection{Cleric Domain Abilities}\label{Cleric Domain Abilities}
        ...
        \subsubsection{Destruction}
            \parhead{Gift} When you deal damage to a target, you first negate an amount of \glossterm{damage reduction} equal to your \glossterm{magical power}.
...
\section{Druid}\label{Druid}
    ...
    \subsection{Natural Influence}
        ...
        As a \glossterm{minor action}, you can gain the effects of one wild aspect that you know.
        ...
        %TODO: wording
        In addition, you gain the ability maintain the effects of up to two \textit{wild aspects} simultaneously.
        ...
        You learn an additional \textit{wild aspect}.
        In addition, you gain the ability maintain the effects of up to three \textit{wild aspects} simultaneously.
        When you activate a new \textit{wild aspect}, you can choose which of your wild aspects remain active. 
        In addition to your previous options, you can also choose from among the aspects below.
        {
        ...
        You learn an additional \textit{wild aspect}.
        In addition, you gain the ability maintain the effects of up to four \textit{wild aspects} simultaneously.
        When you activate a new \textit{wild aspect}, you can choose which of your wild aspects remain active. 
        In addition to your previous options, you can also choose from among the aspects below.
        {
...
\section{Monk}\label{Monk}
    ...
    \subsection{Ki}
        ...
        \begin{freeability}{Ki Strike}
            Make a melee \glossterm{strike}.
            % TODO: wording
            Because this is a \glossterm{magical} ability, you use your \glossterm{magical power} in place of your \glossterm{mundane power} to determine your damage with the strike.
        \end{freeability}
