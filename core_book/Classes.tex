...
\section{Fighter}\label{Fighter}
    ...
    \subsection{Class Abilities}
        ...
        \subsubsection{Combat Discipline}
            ...
            The bonus to the hit points you gain from the \textit{focused recovery} ability increases to \plus2d.
...
\section{Monk}\label{Monk}
    \begin{dtable}
        ...
        \begin{dtabularx}{\columnwidth}{>{\ccol}p{\levelcol} c >{\lcol}X}
            ...
            \bottomrule
            \nth{1}  & \plus1 & Manifest ki, unarmed warrior, unfettered defense \\
            \nth{2}  & \plus1 & Flurry of blows                                  \\
            \nth{3}  & \plus1 & Mental reserves                                  \\
            \nth{4}  & \plus2 & Manifest ki                                      \\
            \nth{5}  & \plus2 & Intuitive reaction                               \\
            \nth{6}  & \plus2 & Transcend frailty                                \\
            \nth{7}  & \plus3 & Manifest ki                                      \\
            \nth{8}  & \plus3 & Stunning fist                                    \\
            \nth{9}  & \plus3 & Serenity                                         \\
            \nth{10} & \plus4 & Manifest ki                                      \\
            \nth{11} & \plus4 & Greater intuitive reaction                       \\
            \nth{12} & \plus4 & Transcend flesh                                  \\
            \nth{13} & \plus5 & Manifest ki                                      \\
            \nth{14} & \plus5 & Greater flurry of blows                          \\
            \nth{15} & \plus5 & Inner peace                                      \\
            \nth{16} & \plus6 & Manifest ki                                      \\
            \nth{17} & \plus6 & Greater unfettered defense                       \\
            \nth{18} & \plus6 & Transcend limits                                 \\
            \nth{19} & \plus7 & Manifest ki                                      \\
            \nth{20} & \plus7 & Transcend mortality                              \\
        \end{dtabularx}
    \end{dtable}
    ...
    \subsection{Class Abilities}
        ...
        \subsubsection{Transcendent Sage}
            ...
            \cf{Mnk}[20]{Transcend Mortality}[Mag]
