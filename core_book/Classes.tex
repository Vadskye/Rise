...
\section{Witch}\label{Witch}
    ...
    \subsection{Brewer}
        ...
        \begin{freeability}{Witch's Brew}
            Choose a \glossterm{targeted} spell you know that does not have the \glossterm{Sustain}, \glossterm{Attune} (self), or \glossterm{AP} tags.
            ...
            \rank{5} The bonus to \glossterm{accuracy} increases to \plus2.
