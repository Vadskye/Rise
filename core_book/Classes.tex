...
\section{Cleric}\label{Cleric}
    ...
    \subsection{Class Abilities}
        ...
        This can emulate the effects of a spell from one of the deity's domains of a level no greater than half of his level.
...
\section{Ranger}\label{Ranger}
    \begin{dtable}
        ...
        \begin{dtabularx}{\columnwidth}{>{\ccol}p{\levelcol} >{\ccol}p{\babcolgood} c >{\lcol}X}
            ...
            \rangerprogressionrow{13} & \plus4 & Unerring pursuit                       \\
    ...
    \subsection{Class Abilities}
        ...
        \cf{Rgr}[13th]{Unerring Pursuit}[Mag]
        The ranger's ability to hunt down his quarry improves to supernatural levels.
        Once per day, the ranger may concentrate for a full round to duplicate the effects of the \spell{find the path} ritual targeted at his quarry.
        This ability is not a Divination effect, so abilities such as the \spell{nondetection} ritual do not prevent it from functioning.
