...
\end{dtabularx}
    ...
    \subsection{Bardic Music}
        ...
        Using a bardic performance ability with an immediate effect does not interfere with your ability to sustain other bardic performance abilities.
        {
            ...
            \begin{freeability}{Partita of Provocation}[\glossterm{Auditory}, \glossterm{Emotion}, \glossterm{Sustain} (minor)]
                \target{\glossterm{Enemies} within a \arealarge radius from you}
                Make an attack vs. Mental against each target.
                \hit For the duration of your performance, each target takes a \minus2 penalty to \glossterm{accuracy} against creatures other than you.
