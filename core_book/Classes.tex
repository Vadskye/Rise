...
\section{Barbarian}\label{Barbarian}
    ...
    \subsection{Primal Warrior}
        ...
        {
            \subcf{Battle Cry} You and all allies within a \arealarge radius burst from you gain \glossterm{temporary hit points} equal to twice your Willpower.
            ...
            \par At 15th level, any hit against a target means it is \frightened by you instead of shaken, and a \glossterm{critical hit} against a target means it is \panicked by you instead of frightened.

            \subcf{Gut Punch} Make a \glossterm{strike} and compare its attack result against the target's Fortitude defense.
            ...
            \subcf{Potent Maneuver} You can use a \glossterm{combat maneuver} with a \plus2 bonus to accuracy.

            At 9th level, the accuracy bonus increases to \plus3.
            \par At 15th level, the accuracy bonus increases to \plus4.

            \subcf{Reaping Charge} You can move up to half your movement speed in a straight line.
            Choose either the right or left side of the line.
            You can make a melee \glossterm{strike} against each creature and object on that side of the line that you \glossterm{threaten} at any point during your movement.
            ...
            At 9th level, you gain a \plus1 bonus to accuracy with each strike.
            \par At 15th level, the accuracy bonus increases to \plus2.
        }
        ...
        As a standard action, you can spend an \glossterm{action point} to use a \textit{primal exertion} ability.
        {
            ...
            This ability lasts as long as you \glossterm{sustain} it as a standard action.
            ...
            \par At 15th level, the accuracy bonus increases to \plus3.
            ...
            \subcf{Thunderous Shout} Make a Constitution vs. Fortitude attack against all creatures and objects in an \arealarge cone-shaped burst from you.
            Success against a target means it takes \glossterm{standard damage} \plus1d.
            A \glossterm{critical hit} deals double damage.
            Your \glossterm{power} with this ability is equal to your level or your Constitution, whichever is higher.

            \par At 15th level, a successful hit also causes a target to be \deafened as a condition.

            \subcf{War Cry} You and all allies within an \arealarge radius burst from you gain \glossterm{damage reduction} against physical damage equal to your Willpower.
            This lasts as long as you \glossterm{sustain} this ability as a \glossterm{swift action}.
        ...
        As a standard action, you can spend an \glossterm{action point} to use a \textit{primal exertion} ability.
        {
            ...
            \subcf{Grasp of the Titans} Make a \glossterm{grapple} attack.
            You gain a \plus10 bonus to accuracy.

            % TODO: timing?
            \subcf{Stunning Leap} You make a Jump check to leap and move as normal for the leap, up to a maximum distance equal to your land speed (see \pcref{Leap}).
            ...
            Success against a creature means it is \stunned as a \glossterm{condition}.
        }

        \cf{Brb}[18]{Primal Supremacy}
        Whenever you resolve a \textit{primal exertion} ability, if it missed against all targets and had no effects on a miss, you regain the \glossterm{action point} spent to use the ability.
...
\section{Fighter}\label{Fighter}
    \begin{dtable}
        ...
        \begin{dtabularx}{\columnwidth}{>{\ccol}p{\levelcol} >{\lcol}X}
            \tb{Level} & \tb{Abilities} \\\bottomrule
            \nth{1}     & Disciplined warrior, weapon adaptation
            \\ \nth{2}  & Armored agility
            \\ \nth{3}  & Martial exertion
            \\ \nth{4}  & Discipline
            \\ \nth{5}  & Weapon focus
            \\ \nth{6}  & Maneuver supremacy
            \\ \nth{7}  & Focused recovery
            \\ \nth{8}  & Greater armored agility
            \\ \nth{9}  & Martial exertion
            \\ \nth{10} & Swift warrior
            \\ \nth{11} & Weapon master
            \\ \nth{12} & Greater maneuver supremacy
            \\ \nth{13} & Greater discipline
            \\ \nth{14} & Supreme armored agility
            \\ \nth{15} & Martial exertion
            \\ \nth{16} & Greater focused recovery
            \\ \nth{17} & Greater weapon focus
            \\ \nth{18} & Martial supremacy
    ...
    \subsection{Martial Mastery}
        ...
        As a standard action, you can spend an \glossterm{action point} to use a \textit{martial exertion} ability.
        {
            ...
            If your attack result hits the target's Mental defense, it suffers a \minus2 penalty to accuracy on all attacks against creatures other than you as a \glossterm{condition}.
            This effect immediately ends if you are \glossterm{defeated}.

            At 9th level, a \glossterm{critical hit} increases the penalty to \minus5.
            \par At 15th level, the penalty is increased to \minus5 for any hit, and a \glossterm{critical hit} increases the penalty to \minus10.
            ...
            If your attack result hits the target's Mental defense, it suffers a \minus2 penalty to accuracy on attacks against you and on defenses against your attacks as a \glossterm{condition}.

            At 9th level, a \glossterm{critical hit} increases the penalties to \minus5.
            \par At 15th level, the penalties are increased to \minus5 for any hit, and a \glossterm{critical hit} increases the penalties to \minus10.
            ...
            \subcf{Rally the Troops} You and all allies within an \arealarge radius can each remove one \glossterm{condition}.
        ...
        \cf{Ftr}[6]{Maneuver Supremacy} You gain a \plus1 bonus to \glossterm{accuracy} with combat maneuvers.

        \cf*{Ftr}[9]{Martial Exertion}
        ...
        As a standard action, you can spend an \glossterm{action point} to use a \textit{martial exertion} ability.
        {
            ...
            \subcf{Distracting Blow} Make a \glossterm{strike}.
            ...
            \subcf{Heartseeking Strike} Make a \glossterm{strike}.
            The strike is considered a \glossterm{critical hit} if it hits the target's Armor defense by 5, instead of by 10.

            \par At 15th level, you regain the action point spent if the attack hits without being a \glossterm{critical hit}.
        ...
        \cf{Ftr}[12]{Greater Maneuver Supremacy} The accuracy bonus from your \textit{maneuver supremacy} ability increases to \plus2.

        \cf*{Ftr}[15]{Martial Exertion} 
        You learn an additional \textit{martial exertion} from the list below.
        As a standard action, you can spend an \glossterm{action point} to use a \textit{martial exertion} ability.
        {
            \subcf{Swordbreaker} Make a \glossterm{disarm} attack.
            You gain a \plus10 bonus to accuracy.
        }

        \cf{Ftr}[18]{Martial Supremacy}
        Whenever you resolve a \textit{martial exertion} ability, if it missed against all targets and had no effects on a miss, you regain the \glossterm{action point} spent to use the ability.
    ...
    \subsection{Combat Discipline}
        ...
        \cf{Ftr}[4]{Discipline} As a \glossterm{swift action}, you can spend an \glossterm{action point} to use this ability.
        \begin{ability}
            \begin{spelleffects}
...
\section{Monk}\label{Monk}
    \begin{dtable}
        ...
        \begin{dtabularx}{\columnwidth}{>{\ccol}p{\levelcol} >{\lcol}X}
            \tb{Level} & \tb{Abilities} \\\bottomrule
            \nth{1}     & Ki strike, unarmed warrior, unfettered defense
            \\ \nth{2}  & Unfettered athletics
            \\ \nth{3}  & Meditate
            \\ \nth{4}  & Ki manifestation
            \\ \nth{5}  & Intuitive reaction
            \\ \nth{6}  & Sage lore
            \\ \nth{7}  & Distant ki
            \\ \nth{8}  & Unfettered athletics
            \\ \nth{9}  & Transcend frailty
            \\ \nth{10} & Ki manifestation
            \\ \nth{11} & Greater intuitive reaction
            \\ \nth{12} & Meditative strike
            \\ \nth{13} & Greater distant ki
            \\ \nth{14} & Greater unfettered defense
            \\ \nth{15} & Transcend flesh
            \\ \nth{16} & Ki manifestation
    ...
    \subsection{Ki}
        ...
        This does not take an action, but you can only use one ki manifestation per round.
        {
            ...
            At 10th level, you also cannot be followed until the end of the round (see \pcref{Following}).
            At 16th level, the speed bonus increases to \plus50 feet.
        ...
        \cf{Mnk}[7]{Distant Ki} When you use your \textit{ki strike} ability, your \glossterm{reach} is increased by 5 feet for the strike.

        \cf*{Mnk}[10]{Ki Manifestation}
        You learn an additional \textit{ki manifestation} from the list below.
        At the start of each round, you can spend an \glossterm{action point} to use a \textit{ki manifestation}.
        This does not take an action, but you can only use one \textit{ki manifestation} per round.
        {
            ...
            At 16th level, you can even attempt to move to locations outside of \glossterm{line of sight} and \glossterm{line of effect}, up to the limit of your remaining movement speed.
            If your intended destination is invalid, the distance you tried to teleport is taken from your remaining movement, but you suffer no other ill effects.
        ...
        \cf{Mnk}[13]{Greater Distant Ki} Your \textit{distant ki} ability increases your \glossterm{reach} by 10 feet instead of by 5 feet.

        \cf*{Mnk}[16]{Ki Manifestation}
        You learn an additional \textit{ki manifestation} from the list below.
        At the start of each round, you can spend an \glossterm{action point} to use a \textit{ki manifestation}.
        This does not take an action, but you can only use one \textit{ki manifestation} per round.
        {
            \subcf{Abandon the Fragile Self} You remove all \glossterm{conditions} affecting you.
            In addition, you are immune to all conditions until the end of the round.

            \subcf{Sevenfold Ward of True Perception} You take half damage from all attacks until the end of the round.
            However, you also take a \minus2 penalty to all defenses until the end of the round.

            \subcf{Step Between the Mystic Worlds} Until the end of the round, you cannot be directly targeted by \glossterm{magical} abilities.
            This does not protect you from abilities that affect an area.
        }

        \cf{Mnk}[19]{Ki Vessel} Your \textit{ki strike} ability does not cost an \glossterm{action point} to use.
    ...
    \subsection{Transcendent Sage}
        ...
        \cf{Mnk}[3]{Meditate} As a standard action, you can use this ability.
        If you do, you may remove all \glossterm{conditions} affecting you.

        \cf{Mnk}[6]{Sage Lore} You gain two additional skill points that must be spent on monk class skills.

        \cf{Mnk}[9]{Transcend Frailty}
        You are immune to being \glossterm{deafened}, \glossterm{fatigued}, and \glossterm{sickened}.

        \cf{Mnk}[12]{Meditative Strike} If you use your \textit{medidate} ability during the \glossterm{action phase}, you may also make a \glossterm{strike} during the \glossterm{delayed action phase}.

        \cf{Mnk}[15]{Transcend Flesh}
...
\section{Ranger}\label{Ranger}
    ...
    \subsection{Wilderness Warrior}
        ...
        \cf{Rgr}[6]{Wilderness Lore} You gain two extra skill points which must be spent on the Creature Handling, Heal, Knowledge (geography), Knowledge (nature), Ride, or Survival skills.

        \cf*{Rgr}[9]{Wild Exertion}
    ...
    \subsection{Master of the Hunt}
        ...
        At the start of each round, you can spend an \glossterm{action point} to choose a \glossterm{quarry}.
        ...
        \begin{ability}
            ...
            \end{spelltargetinginfo}
            \begin{spelleffects}
                \spelleffect You and any allies within range gain a \plus1 bonus to \glossterm{accuracy} with \glossterm{strikes} against the target.
        ...
        Whenever you use your \textit{quarry} ability, you may also use one of your \textit{hunting styles}.
        {
            ...
            The accuracy bonus from your \textit{quarry} ability is replaced with a \plus1 bonus to \glossterm{strike damage} against the quarry.
            ...
            The accuracy bonus from your \textit{quarry} ability applies to all attacks your \glossterm{hunting party} makes against the quarry, instead of only to \glossterm{strikes}.

            At 10th level, whenever your hunting party uses both a \glossterm{strike} and a non-strike attack on the target in the same phase, the accuracy bonus is increased to \plus2 until the end of the round.
        ...
        Whenever you use your \textit{quarry} ability, you may also use one of your \textit{hunting styles}.
        {
            ...
            At the end of each round, the quarry takes life damage equal to your level if at least two members of your \glossterm{hunting party} are within \rngmed range of it.
        ...
        Whenever you use your \textit{quarry} ability, you can also gain the benefit of one hunting style you know.
        {
            ...
            Instead, the quarry takes a penalty to accuracy with \glossterm{strikes} equal to the number of members of your \glossterm{hunting party} threatening it.
            ...
            \subcf{Pack Leader}
            Your \textit{quarry} ability does not grant a bonus to accuracy.
            Instead, gain a bonus to accuracy with \glossterm{strikes} against the quarry equal to the number of members of your \glossterm{hunting party} threatening it.
        }
...
\section{Rogue}\label{Rogue}
    ...
    \subsection{Assassin}
        ...
        \cf{Rog}[17]{Swift Assassination} You can use your \textit{assassinate} ability as a \glossterm{swift action}.
    ...
    \subsection{Scoundrel}
        ...
        {
            \subcf{Bewildering Blow} Make a \glossterm{strike}.
            If your attack result hits the target's Mental defense, the target is \dazed as a \glossterm{condition}.
            A \glossterm{critical hit} against Mental defense means the target is \stunned instead of dazed.
            ...
            A \glossterm{critical hit} against Fortitude defense means the target is \immobilized instead of slowed.
        }

        % \parhead{Distant Precision} If you have the \textit{sneak attack} ability, the maximum range at which you can use that ability increases to \rnglong.

        % \parhead{Merciful} You take no penalties when using weapons to deal \glossterm{nonlethal damage}.

        %TODO: make poison work
        %\subcf{Swift Poisoner}
        %The rogue can apply poison to a weapon you are holding as a swift action.

        % \parhead{Tricky Maneuvers} You gain a \plus1 bonus to \glossterm{accuracy} with \glossterm{combat maneuvers}.
