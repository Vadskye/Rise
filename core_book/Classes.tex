...
\section{Cleric}\label{Cleric}
    ...
    \subsection{Cleric Domain Abilities}\label{Cleric Domain Abilities}
        ...
        \subsubsection{Air}
            \parhead{Gift} You add the Jump skill to your class skill list and gain a \plus5 bonus to Jump attacks and checks (see \pcref{Jump}).
        ...
        \subsubsection{Water}
            \parhead{Gift} You add Swim to your cleric class skill list and gain a \plus5 bonus to Swim attacks and checks.
...
\section{Warlock}\label{Warlock}
    ...
    \classbasics{Archetypes} Warlocks have the Spellcasting, Infernal Pact, and Pact Magic \glossterm{archetypes}.
    ...
    \subsection{Basic Class Abilities}
        ...
        You have the following \glossterm{class skills}:
        \begin{itemize}
            \item \subparhead{Intelligence} Disguise, Knowledge (arcana, planes, religion), Linguistics.
            \item \subparhead{Perception} Awareness, Sense Motive, Spellcraft.
            \item \subparhead{Other} Bluff, Intimidate, Persuasion.
        \end{itemize}
        You gain 4 \glossterm{skill points} which can only be spent on those class skills.
    ...
    \subsection{Pact Magic}
        ...
        \begin{itemize}
            \item Pact augments can only be applied to arcane spells, and cannot be applied to \glossterm{subspells}.
        ...
        Your \glossterm{power} with pact augments is equal to your \glossterm{spellpower} with the spell you apply them to.
        {
            ...
            \augment{1}{Dark Expansion} The spell's area is increased by one size category, to a maximum of \areahuge.
            ...
            \augment{3}{Abyssal Blessing} You gain a \plus1 bonus to accuracy and a \plus1d bonus to damage with the spell.
            ...
            \augment{7}{Greater Abyssal Blessing} You gain a \plus2 bonus to accuracy and a \plus2d bonus to damage with the spell.
            \par This augment can be applied to any spell that makes an attack.
        }
