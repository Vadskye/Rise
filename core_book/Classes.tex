...
\section{Barbarian}\label{Barbarian}
    ...
    \classbasics{Archetypes} Barbarians have the Battlerager, Primal Warrior, Battleforged Resilience, and Outlander \glossterm{archetypes}.
    ...
    \subsection{Battlerager}\label{Rage}
        ...
        \cf{Bbn}[2]{Intimidating Anger}
        You gain a \plus2 bonus to the \glossterm{Intimidate} skill and to \glossterm{threat}.

        \cf{Bbn}[3]{Tireless Rage} You are no longer \glossterm{fatigued} after raging, and you can use the ability again before taking a \glossterm{short rest}.

        \cf{Bbn}[4]{Focused Anger} You gain a \plus2 bonus to Mental defense.
        ...
        \cf{Bbn}[7]{Endless Rage}
        You can use your \textit{rage} ability without spending an \glossterm{action point}.
    ...
    \subsection{Outlander}
        ...
        \cf{Bbn}[2]{Exotic Weaponry} You gain proficiency with \glossterm{exotic weapons} from one weapon group of your choice that you are proficient with.

        \cf{Bbn}[2]{Savage Force} You gain a \plus1 bonus to \glossterm{accuracy} with the \textit{dirty trick}, \textit{disarm}, \textit{grapple}, \textit{overrun}, \textit{shove}, and \textit{trip} abilities (see \pcref{Special Combat Abilities}).
        In addition, you gain a \plus1 bonus to \glossterm{accuracy} with grapple actions (see \pcref{Grapple Actions}).

        \cf{Bbn}[3]{Outland Lore} You gain two additional \glossterm{skill points}.

        \cf{Bbn}[4]{Greater Fast Movement} The speed bonus from your \textit{fast movement} ability increases to \plus20 feet.

        \cf{Bbn}[5]{Greater Savage Force} The accuracy bonus from your \textit{savage force} ability increases to \plus2.

        \cf{Bbn}[6]{Greater Exotic Weaponry} You gain proficiency with \glossterm{exotic weapons} from all weapon groups you are proficient with.
...
\section{Cleric}\label{Cleric}
    ...
    \subsection{Divine Spellcasting}
        ...
        \cf{Clr}[5]{Spell} You gain an additional \glossterm{spell} for any divine \glossterm{mystic sphere} you know.
...
\section{Mage}\label{Mage}
    ...
    \subsection{Innate Arcanist}
        ...
        \cf{Mge}[2]{Limited Components} You reduce your \glossterm{encumbrance} by 2 when determining your \textit{arcane spell failure}.

        \cf{Mge}[3]{Spell Knowledge} You learn an additional \glossterm{spell}.

        \cf{Mge}[4]{Magic Resistance} You gain a \plus2 bonus to \glossterm{defenses} against \glossterm{magical} abilities.

        \cf{Mge}[5]{Greater Limited Components} The penalty reduction from your \textit{limited components} ability increases to 4.

        \cf*{Mge}[6]{Spell Knowledge} You learn an additional \glossterm{spell}.
...
\section{Paladin}\label{Paladin}
    ...
    \subsection{Devoted Paragon}
        ...
        \subparhead{Chaos} You are immune to hostile \glossterm{Compulsion} effects.
        \subparhead{Evil} You are immune to hostile \glossterm{Disease} and \glossterm{Poison} effects.
        \subparhead{Good} You are immune to hostile \glossterm{Life} effects.
        \subparhead{Law} You are immune to hostile \glossterm{Emotion} effects.
    ...
    \begin{dtable}
        ...
        \begin{dtabularx}{\columnwidth}{c >{\lcol}X >{\lcol}X >{\lcol}X}
            \tb{Rank} & \tb{Huntmaster}  & \tb{Keen Senses} & \tb{Wilderness Warrior} \\\bottomrule
               1 & Tracking lore & Keen vision        & Wild power
...
\section{Warlock}\label{Warlock}
    ...
    \subsection{Pact Spellcasting}
        ...
        For each \glossterm{mystic sphere} you have access to, you learn one 1st level spell from that \glossterm{mystic sphere}.
        As a \glossterm{standard action}, you can cast any \glossterm{spell} you know.
        ...
        \cf{War}[3]{Spell Level}[Magical] You gain the ability to cast 2nd level arcane spells.
        This does not grant you knowledge of 2nd level spells directly, but allows you to use \glossterm{augments} to increase the effective level of your existing spells up to 2nd level.

        \cf{War}[3]{Pact Augments}[Magical] You learn one pact augment from the list below.
        ...
        \cf*{War}[4]{Spell Level}[Magical] You gain the ability to cast 3rd level arcane spells.

        \cf*{War}[5]{Spell Level}[Magical] You gain the ability to cast 4th level arcane spells.

        \cf{War}[5]{Pact Augment}[Magical] You learn an additional \textit{pact augment}.

        \cf*{War}[6]{Spell Level}[Magical] You gain the ability to cast 5th level arcane spells.

        \cf*{War}[7]{Spell Level}[Magical] You gain the ability to cast 6th level arcane spells.

        \cf*{War}[7]{Pact Augment}[Magical] You learn an additional \textit{pact augment}.
    ...
    \subsection{Blessings of the Abyss}
        ...
        \cf{War}[1]{Whispers of the Lost}[Magical]
    ...
    \subsection{Pact Magic}
        ...
        When you do, you take a \minus2 penalty to \glossterm{power} with the spell.
