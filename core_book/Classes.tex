...
\section{Monk}\label{Monk}
    ...
    \subsection{Ki}
        ...
        \cf*{Mnk}[2]{Ki Vessel}[Magical] You gain an additional \glossterm{reserve action point}.
        ...
        \cf{Mnk}[6]{Ki Wellspring}[Magical] You gain an additional \glossterm{reserve action point}.
...
\section{Warlock}\label{Warlock}
    ...
    \subsection{Pact Magic}
        ...
        \cf{War}[1]{Wellspring of Magic}[Magical] You gain an additional \glossterm{reserve action point}.
        ...
        \cf*{War}[6]{Greater Wellspring of Magic}[Magical] You gain an additional \glossterm{reserve action point}.
