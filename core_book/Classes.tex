...
\end{dtabularx}
    ...
    \subsection{Huntmaster}
        ...
        \cf{Rgr}[0]{Tracker} You gain a \plus4 bonus to the Survival skill.
        In addition using the \textit{desperate exertion} ability on a Survival roll to follow tracks only causes you to gain one \glossterm{fatigue point} instead of two.
