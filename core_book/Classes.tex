...
\section{Warlock}\label{Warlock}
    \begin{dtable}
        ...
        \begin{dtabularx}{\columnwidth}{c >{\lcol}X >{\lcol}X >{\lcol}X}
            ...
            \\ 2 & Pact augments          & Spell knowledge             & Eldritch augment
            \\ 3 & Mystic sphere          & Wellspring of power         & Empowering Whispers
            \\ 4 & Pact augment           & Spell knowledge             & Fiendish resistance
            \\ 5 & Infernal power         & Greater armor tolerance     & Eldritch Augment
            \\ 6 & Pact augment           & Spell knowledge             & Greater Empowering Whispers
            \\ 7 & Greater infernal power & Greater wellspring of power & Greater eldritch augment
            \\ 8 & Dual pact              &                             &
        \end{dtabularx}
    \end{dtable}
