    ...
    \subsection{Shifter}\label{Shifter}
...

        {
            ...
            \begin{freeability}{Photosynthesis}
                ...
                \rankline
                \rank{3} As long as you are in natural sunlight, you heal hit points equal to half your \glossterm{power} at the end of each \glossterm{action phase}.
                ...
                \rank{5} The healing increases to be equal to your \glossterm{power}.
...
\section{Fighter}\label{Fighter}
    ...
    \subsection{Combat Discipline}
        ...
        \begin{freeability}{Disciplined Threat}[Sustain (free)]
