...
\section{Cleric}\label{Cleric}
    ...
    \subsection{Class Abilities}
        ...
        \subsubsection{Spellcasting}
            ...
            You learn how to use one of the \glossterm{standard augments} (see \pcref{Standard Augments}).
        ...
        \subsubsection{Divine Spell Mastery}
            ...
            Choose a \glossterm{custom augment} for a spell you know.
            You can apply that augment to that spell (see \pcref{Augments}).
            At 6th level, and every two levels thereafter, you learn an additional custom augment for a spell you know.

            \cf{Clr}[8]{Expanded Spell Knowledge}
            You learn an additional spell from the divine \glossterm{spell list}.
...
\section{Druid}\label{Druid}
    ...
    \subsection{Base Class Abilities}
        ...
        You gain the ability to speak to and understand animals of that type for 5 minutes.
    ...
    \subsection{Class Abilities}
        ...
        You gain a \plus5 bonus to accuracy with grapple attacks.
...
\section{Ranger}\label{Ranger}
    ...
    \subsection{Class Abilities}
        ...
        If he does, you are unable to designate a new quarry until he rests for 5 minutes.
...
\section{Spellwarped}\label{Spellwarped}
    ...
    \subsection{Class Abilities}
        ...
        He does not need a free hand to wield the shield, and suffers no arcane spell failure for its use, though you are still affected by its \glossterm{encumbrance penalty}.
