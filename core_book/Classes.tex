    ...
    \begin{dtable}
        ...
        \begin{dtabularx}{\columnwidth}{c >{\lcol}X >{\lcol}X >{\lcol}X}
            \tb{Rank} & \tb{Battleforged Resilience} & \tb{Battlerager}  & \tb{Primal Warrior} \\\bottomrule
               1 & Fury of the storm         & Rage                  & Primal exertions
    ...
    \subsection{Primal Warrior}
        ...
        As a standard action, you can spend an \glossterm{action point} to use a \textit{primal exertion} ability.
        {
            \begin{ability}{Battle Cry}[\glossterm{Mind}, \glossterm{Sustain} (minor)]
                ...
                \rankline
                \rank{3} The healing increases to twice your Willpower.
                \rank{5} The area increases to a \areahuge radius.
                \rank{7} The healing increases to three times your Willpower.
            \end{ability}
            ...
            \begin{ability}{Brace for Impact}[\glossterm{Swift}]
                ...
                \rankline
                \rank{3} You can \glossterm{sustain} this ability as a standard action.
                \rank{5} You also gain damage reduction equal to your level.
                \rank{7} The damage reduction increases to twice your level.
            \end{ability}
            ...
            \begin{ability}{Demoralizing Shout}[\glossterm{Mind}]
                ...
                \rankline
                \rank{3} If you do not hit any targets with the attack, you regain the action point spent to use this ability.
                \rank{5} The area increases to a \areahuge radius.
                \rank{7} A critical hit makes each target \panicked instead of frightened.
            ...
            \begin{ability}{Ground Pound}
                ...
                \rankline
                \rank{3} The area increases to a \areamed radius burst.
                \rank{5} You gain a \plus1d bonus to damage with the strike.
                \rank{7} The area increases to a \arealarge radius burst.
            \end{ability}
            ...
            \begin{ability}{Leaping Strike}
                ...
                \rankline
                \rank{3} You gain a \plus1d bonus to damage with the strike per 10 feet of height you travelled downward towards your foe during the leap, up to a maximum of \plus2d.
                \rank{5} The maximum damage bonus increases to \plus4d.
                \rank{7} The maximum damage bonus increases to \plus6d.
            \end{ability}
            ...
            \begin{ability}{Potent Maneuver}
                ...
                \rankline
                \rank{3} The accuracy bonus increases to \plus4.
            ...
            \begin{ability}{Power Attack}
                ...
                \rankline
                \rank{3} If you miss with the strike, you regain the action point spent to use this ability.
            ...
            \begin{ability}{Rapid Assault}
                ...
                \rankline
                \rank{3} If you missed all of your targets, you regain the action point spent to use this ability.
                \rank{5} You gain a \plus1d bonus to damage with both strikes.
            ...
            \begin{ability}{Reaping Charge}
                ...
                \rankline
                \rank{3} You do not have to choose a side of the line.
            ...
            \begin{ability}{Strip the Flesh}
                ...
                \rankline
                \rank{3} If you hit with the strike, the target continues taking the same damage at the end of each \glossterm{action phase} until it becomes \glossterm{bloodied}.
            ...
            \begin{ability}{Thunderous Shout}[\glossterm{Sonic}]
                ...
                \rankline
                \rank{3} A hit also makes each target \glossterm{deafened} as a \glossterm{condition}.
                \rank{5} The area increases to \arealarge.
                \rank{7} The damage increases by \plus1d.
            \end{ability}
            ...
            \begin{ability}{Whirlwind Spin}
                ...
                \rankline
                \rank{3} The damage penalty is reduced to \minus1d.
                \rank{5} The damage penalty is removed.
                \rank{7} You gain a \plus1d bonus to damage with the strike.
            \end{ability}
        }

        \cf{Bbn}[2]{Athletic Prowess} You gain two additional skill points.

        \cf*{Bbn}[3]{Primal Exertion}
        You learn an additional \textit{primal exertion}.

        \cf*{Bbn}[4]{Athletic Prowess} You gain two additional skill points.

        \cf*{Bbn}[5]{Primal Exertion}
        You learn an additional \textit{primal exertion}.

        \cf{Bbn}[6]{Primal Prowess}
        You gain a \plus2 bonus to Strength-based and Dexterity-based checks.

        \cf*{Bbn}[7]{Primal Exertion}
        You learn an additional \textit{primal exertion}.
...
\section{Cleric}\label{Cleric}
    \begin{dtable}
        ...
        \begin{dtabularx}{\columnwidth}{c >{\lcol}X >{\lcol}X >{\lcol}X}
            \tb{Rank} & \tb{Divine Spellcasting} & \tb{Divine Spell Mastery}  & \tb{Domain Influence} \\\bottomrule
               1 & Divine spells   & Wellspring of magic         & Domains, domain gift
            \\ 2 & Subspells                 & Mystic knowledge            & Domain gift
            \\ 3 & Subspell                  & Augments                    & Domain aspect
            \\ 4 & Cantrip expertise         & Mystic knowledge            & Domain aspect
            \\ 5 & Subspell                  & Augment                     & Domain essence
            \\ 6 & Subspell                  & Greater wellspring of magic & Domain essence
            \\ 7 & Greater cantrip expertise & Mystic knowledge            & Domain mastery
    ...
    \subsection{Divine Spellcasting}
        ...
        As a \glossterm{standard action}, you can cast the \glossterm{cantrip} version of any spell you know.
        The maximum spell level you can cast is equal to half your level (minimum 1) or your Willpower, whichever is power.
        For details about spellcasting, see \pcref{Spell and Ritual Mechanics}.

        In addition, choose one \glossterm{subspell} from either spell you learned.
        As a \glossterm{standard action}, you can spend an \glossterm{action point} to cast any \glossterm{subspell} you know.
        For details about subspells, see \pcref{Subspells}.

        \cf{Clr}[2]{Subspells} Choose two \glossterm{subspells} for any divine spells you know.
        ...
        You cannot know more than two divine subspells of the same level, other than 1st level.

        \cf{Clr}[3]{Subspell}
        You learn an additional \glossterm{subspell} for a divine spell you know.

        \cf{Clr}[4]{Cantrip Expertise}
        You gain a \plus1 bonus to \glossterm{accuracy} with \glossterm{cantrips} for divine spells.
        ...
        \cf{Clr}[7]{Greater Cantrip Expertise}
        The bonus from your \textit{cantrip expertise} ability increases to \plus2.
    ...
    \subsection{Divine Spell Mastery}
        ...
        \cf{Clr}[1]{Wellspring of Magic}
        You gain an additional \glossterm{action point}.

        \cf{Clr}[2]{Mystic Knowledge}
        You gain your choice of one of the following abilities.
        {
            ...
            \parhead{Spell Knowledge} You learn an additional divine spell.
                You can choose this ability multiple times, learning an additional spell each time.
            \parhead{Subspell Knowledge} You learn an additional \glossterm{subspell} for a divine spell you know.
        ...
        \cf{Clr}[6]{Greater Wellspring of Magic}
        You gain an additional \glossterm{action point}.

        \cf*{Clr}[7]{Mystic Knowledge}
        You can an additional \textit{mystic knowledge} ability.

        \cf{Clr}[8]{Mystic Supremacy}
    ...
    \subsection{Cleric Domain Abilities}\label{Cleric Domain Abilities}
        ...
        \subsubsection{Destruction}
            \parhead{Gift} As a standard action, you can spend an \glossterm{action point} to use the \textit{destructive attack} ability.
            \begin{ability}{Destructive Attack}
                ...
                \rank{7} The damage bonus increases to \plus4d.
            \end{ability}
            \parhead{Aspect} Whenever you deal damage to a target, you first negate an amount of \glossterm{hardness} and \glossterm{damage reduction} equal to your \glossterm{magical power}.
            ...
            \begin{ability}{Lay Waste}
                ...
                \hit For each target, if its \glossterm{hardness} is lower than your \glossterm{magical power}, it crumbles into a fine power and is irreparably \glossterm{broken}.
            \end{ability}
            \parhead{Mastery} Whenever you deal damage to a creature or object, its damage reduction and hardness (if any) are reduced by an amount equal to your \glossterm{magical power}.
        ...
        \subsubsection{Earth}
            ...
            \parhead{Aspect} You gain \glossterm{damage reduction} equal to your \glossterm{magical power} against damage from \glossterm{physical attacks}.
        ...
        \subsubsection{Fire}
            ...
            \parhead{Aspect} Whenever you would take fire damage, you heal half that many hit points instead.
        ...
        \subsubsection{Knowledge}
            ...
            \begin{ability}{Share Knowledge}
                You make a Knowledge check of any kind with a bonus equal to your \glossterm{magical power}.
        ...
        \subsubsection{Life}
            \parhead{Gift} You gain additional hit points equal to your \glossterm{magical power}.
            % TODO: wording?
            \parhead{Aspect} You gain a \plus1d bonus to healing from all abilities you use that heal hit points measured in a dice pool.
            ...
            \parhead{Mastery} At the end of each \glossterm{action phase}, you heal hit points equal to your \glossterm{magical power}.

        \subsubsection{Magic}
            \parhead{Gift} You learn an additional subspell for a divine spell you know.
            \parhead{Aspect} You learn an additional divine spell.
            \parhead{Essence} You gain \glossterm{magic resistance} equal to 5 \add your \glossterm{magical power}.
            ...
            If you resist an ability with your magic resistance, you heal hit points equal to your \glossterm{magical power}.
...
\section{Druid}\label{Druid}
    \begin{dtable}
        ...
        \begin{dtabularx}{\columnwidth}{c >{\lcol}X >{\lcol}X >{\lcol}X}
            \tb{Rank} & \tb{Nature Spellcasting} & \tb{Nature Spell Mastery}  & \tb{Natural Influence} \\\bottomrule
               1 & Nature spells   & Wellspring of magic         & Wild aspect
            \\ 2 & Subspells                 & Mystic knowledge            & Wild speech
            \\ 3 & Subspell                  & Augments                    & Wild aspect
            \\ 4 & Cantrip expertise         & Mystic knowledge            & Natural lore
            \\ 5 & Subspell                  & Augment                     & Wild aspect
            \\ 6 & Subspell                  & Greater wellspring of magic & Nature's champion
            \\ 7 & Greater cantrip expertise & Mystic knowledge            & Wild aspect
    ...
    \subsection{Natural Influence}
        ...
        \cf{Drd}[2]{Wild Speech}[Magical] As a standard action, you can spend an \glossterm{action point} to use this ability.
        \begin{ability}{Wild Speech}[\glossterm{Attune}]
        ...
        {
            \subcf{A Thousand Faces}
            You may use your \glossterm{magical power} in place of your Disguise skill when making Disguise checks to alter your own appearance.
            In addition, you can disguise yourself as a standard action by spending an \glossterm{action point}. 
            \subcf{Constrict}
        ...
        \cf{Drd}[4]{Natural Lore}
        You gain two extra skill points.

        \cf*{Drd}[5]{Wild Aspect}[Magical]
        You learn an additional \textit{wild aspect}.
        In addition to your previous options, you can also choose from among the aspects below.
        {
            % \subcf{Elemental Retribution}
            ...
            % A creature can only be dealt damage by this effect once per round.
            \subcf{Beetle's Carapace} You gain a \plus1 bonus to Armor defense.
            \subcf{Fluid Motion} You are immune to effects that restrict your mobility, and you suffer no penalties for acting underwater.
            ...
            However, you take a \minus2 penalty to \glossterm{mundane power}, which offsets the bonus you gain for increasing your size.
            This is a \glossterm{Sizing} effect.
            \subcf{Wolfpack}
            ...
            When you poison a target, and at the end of each \glossterm{action phase} in subsequent rounds, you make an attack vs. Fortitude against all creatures you have poisoned in this way.
        ...
        In addition to your previous options, you can also choose from among the aspects below.
        {
            \subcf{Natural Renewal}
            At the end of each \glossterm{action phase}, you heal hit points equal to your \glossterm{magical power}.
            \subcf{Stable Foundation} As long as you are on solid ground, you gain a \plus1 bonus to all defenses.
            \subcf{Wings}
            You grow wings, granting you a \glossterm{fly speed} equal to your \glossterm{base speed} (see \pcref{Flying}).
            % TODO: standard flight limitation
            \subcf{Solar Radiance}
    ...
    \subsection{Nature Spellcasting}
        ...
        As a \glossterm{standard action}, you can cast the \glossterm{cantrip} version of any spell you know.
        The maximum spell level you can cast is equal to half your level (minimum 1) or your Perception, whichever is lower.
        For details about spellcasting, see \pcref{Spell and Ritual Mechanics}.
        ...
        \cf{Drd}[2]{Subspells} Choose two \glossterm{subspells} for any nature spells you know.
        You learn those subspells.
        Whenever you gain access to a new spell or spell level, you can exchange any number of subspells you know for subspells of other spells you know.
        You cannot know more than two nature subspells of the same level, other than 1st level.

        \cf{Drd}[3]{Subspell}
        You learn an additional \glossterm{subspell} for a nature spell you know.

        \cf{Drd}[4]{Cantrip Expertise}
        You gain a \plus1 bonus to \glossterm{accuracy} with \glossterm{cantrips} for nature spells.
        ...
        \cf{Drd}[7]{Greater Cantrip Expertise}
        The bonus from your \textit{cantrip expertise} ability increases to \plus2.
    ...
    \subsection{Nature Spell Mastery}
        ...
        You gain your choice of one of the following abilities.
        {
            ...
            \parhead{Spell Knowledge} You learn an additional nature spell.
                You can choose this ability multiple times, learning an additional spell each time.
            \parhead{Subspell Knowledge} You learn an additional \glossterm{subspell} for a nature spell you know.
                You can choose this ability multiple times, learning an additional subspell each time.
        }
        ...
        \cf*{Drd}[4]{Mystic Knowledge}
        You can an additional \textit{mystic knowledge} ability.

        \cf{Drd}[5]{Augment}
        You learn an additional \glossterm{augment} that you can apply to nature spells.

        \cf{Drd}[6]{Greater Wellspring of Magic}
        You gain an additional \glossterm{action point}.

        \cf*{Drd}[7]{Mystic Knowledge}
        You can an additional \textit{mystic knowledge} ability.

        \cf{Drd}[8]{Mystic Supremacy}
        The maximum spell level you can cast is increased to 11.
...
\section{Fighter}\label{Fighter}
    ...
    \subsection{Martial Mastery}
        ...
        As a standard action, you can spend an \glossterm{action point} to use a \textit{martial exertion} ability.
        {
            ...
            \begin{ability}{Counterattack}
                ...
                \rankline
                \rank{3} If the target did not attack you in the same phase, you regain the action point spent to use this ability.
                \rank{5} The accuracy bonus increases to \plus3 and the damage bonus increases to \plus3d.
                \rank{7} The accuracy bonus increases to \plus4 and the damage bonus increases to \plus4d.
            \end{ability}
            ...
            \begin{ability}{Daunting Blow}[\glossterm{Mind}]
                ...
                \rankline
                \rank{3} You gain a \plus1 bonus to accuracy on the strike.
                \rank{5} The accuracy bonus increases to \plus2.
                \rank{7} The accuracy bonus increases to \plus3.
            \end{ability}
            ...
            \begin{ability}{Rally the Troops}
                ...
                \rankline
                \rank{3} The area increases to \arealarge.
                \rank{5} Each target can instead remove two conditions.
                \rank{7} Each target can instead remove any number of conditions.
            \end{ability}
            ...
            \begin{ability}{Strip the Flesh}
                ...
                \rankline
                \rank{3} If you hit with the strike, the target continues taking the same damage at the end of each \glossterm{action phase} in subsequent rounds until it becomes \glossterm{bloodied}.
                This is a \glossterm{condition}, and can be removed by abilities that remove conditions.
                \rank{5} You gain a \plus1d bonus to damage with the strike.
                \rank{7} The damage bonus increases to \plus2d.
            \end{ability}
        ...
        \cf*{Ftr}[3]{Martial Exertion}
        You learn an additional \textit{martial exertion}.

        \cf*{Ftr}[4]{Martial Lore} You gain two additional skill points.

        \cf*{Ftr}[5]{Martial Exertion} 
        You learn an additional \textit{martial exertion}.

        \cf{Ftr}[6]{Exertion Expertise} You gain a \plus1d bonus to damage when using any of your \textit{martial exertion} abilities.

        \cf*{Ftr}[7]{Martial Exertion}
        You learn an additional \textit{martial exertion}.
    ...
    \subsection{Equipment Training}
        ...
        \cf{Ftr}[6]{Greater Weapon Focus} You can use your \textit{weapon focus} ability as a \glossterm{minor action}.
    ...
    \subsection{Combat Discipline}
        ...
        \cf{Ftr}[2]{Discipline} As a \glossterm{minor action}, you can spend an \glossterm{action point} to use the \textit{discipline} ability.
...
\section{Mage}\label{Mage}
    \begin{dtable}
        ...
        \begin{dtabularx}{\columnwidth}{c >{\lcol}X >{\lcol}X >{\lcol}X}
            ...
            1 & Arcane spells   & Wellspring of magic         & Mage armor
            \\ 2 & Subspells                 & Mystic knowledge            & Arcane insights
            \\ 3 & Subspell                  & Augments                    & Essence lore
            \\ 4 & Cantrip expertise         & Mystic knowledge            & Arcane insight
            \\ 5 & Subspell                  & Augment                     & Greater essence lore
            \\ 6 & Subspell                  & Greater wellspring of magic & Arcane insight
            \\ 7 & Greater cantrip expertise & Mystic knowledge            & Supreme essence lore
    ...
    \subsection{Arcane Spellcasting}
        ...
        \cf{Mge}[1]{Arcane Spells}
        You can cast arcane spells.
        You learn two arcane spells from the arcane \glossterm{spell list} (see \pcref{Arcane Spells}).
        As a \glossterm{standard action}, you can cast the \glossterm{cantrip} version of any spell you know.
        For details about spellcasting, see \pcref{Spell and Ritual Mechanics}.

        \subparhead{Sorcerer} The maximum spell level you can cast is equal to half your level (minimum 1).
        \subparhead{Wizard} The maximum spell level you can cast is equal to half your level (minimum 1) or your Intelligence, whichever is lower.

        In addition, choose one \glossterm{subspell} from either spell you learned.
        As a \glossterm{standard action}, you can spend an \glossterm{action point} to cast any \glossterm{subspell} you know.
        For details about subspells, see \pcref{Subspells}.

        \cf{Mge}[2]{Subspells} Choose two \glossterm{subspells} for any arcane spells you know.
        You learn those subspells.
        Whenever you gain access to a new spell or spell level, you can exchange any number of subspells you know for subspells of other spells you know.
        You cannot know more than two arcane subspells of the same level, other than 1st level.

        \cf{Mge}[3]{Subspell}
        You learn an additional \glossterm{subspell} for an arcane spell you know.

        \cf{Mge}[4]{Cantrip Expertise}
        You gain a \plus1 bonus to \glossterm{accuracy} with \glossterm{cantrips} for arcane spells.
        ...
        \cf{Mge}[7]{Greater Cantrip Expertise}
        The bonus from your \textit{cantrip expertise} ability increases to \plus2.
    ...
    \subsection{Arcane Lore}
        ...
        \cf{Mge}[1]{Mage Armor} As a standard action, you can use the \textit{mage armor} ability.
...

        {
            ...
            \parhead{Innate Spell} Choose a spell you know.
            ...
            \parhead{Signature Spell} Choose a spell you know.
            You gain a \plus1 bonus to \glossterm{accuracy} with the spell.
            In addition, you automatically succeed at all Concentration checks you make to cast the spell.
            \par If you choose this insight multiple times, you must choose a different spell each time.

            \parhead{Specialization} Choose a school of magic that you know a spell from.
        ...
        % TODO: wording
        \subparhead{Sorcerer} Whenever a spell resolves, if you were a target of the spell, you heal hit points equal to that spell's \glossterm{power}.
        ...
        \cf*{Mge}[4]{Arcane Insight}
        You learn an additional \textit{arcane insight}.

        \cf{Mge}[5]{Greater Essence Lore}[Magical]
        You gain an ability based on your choice of arcane essence.
        \subparhead{Sorcerer} You gain \glossterm{magic resistance} equal to 5 \add your \glossterm{power}.
        ...
        Any spells which require decisions, such as the \spell{dimension door} subspell, must have those decisions made at the time it is cast.
    ...
    \subsection{Arcane Spell Mastery}
        ...
        \cf{Mge}[1]{Wellspring of Magic}
        You gain an additional \glossterm{action point}.

        \cf{Mge}[2]{Mystic Knowledge}
        You gain your choice of one of the following abilities.
        {
            ...
            \parhead{Spell Knowledge} You learn an additional arcane spell.
                You can choose this ability multiple times, learning an additional spell each time.
            \parhead{Subspell Knowledge} You learn an additional \glossterm{subspell} for a arcane spell you know.
                You can choose this ability multiple times, learning an additional subspell each time.
        }
        ...
        \cf*{Mge}[4]{Mystic Knowledge}
        You can an additional \textit{mystic knowledge} ability.

        \cf{Mge}[5]{Augment}
        You learn an additional \glossterm{augment} that you can apply to arcane spells.

        \cf{Mge}[6]{Greater Wellspring of Magic}
        You gain an additional \glossterm{action point}.

        \cf*{Mge}[7]{Mystic Knowledge}
        You can an additional \textit{mystic knowledge} ability.

        \cf{Mge}[8]{Mystic Supremacy}
        The maximum spell level you can cast is increased to 11.
...
\section{Monk}\label{Monk}
    ...
    \subsection{Ki}
        ...
        You cannot use more than one \textit{ki manifestation} per round.
        {
            \begin{ability}{Abandon the Fragile Self}[\glossterm{Swift}]
                ...
                \rankline
                \rank{3} This ability lasts until the end of the next round.
                \rank{5} You can also remove one condition affecting you when you use this ability.
            ...
            \begin{ability}{Burst of Blinding Speed}
                ...
                \rankline
                \rank{3} You can also ignore \glossterm{difficult terrain}.
                \rank{5} You can also move or stand on liquids as if they were solid.
                \rank{7} The speed bonus increases to \plus60 feet, up to a maximum of triple your original speed.
            \end{ability}
            ...
            \begin{ability}{Dance of Falling Feathers}
                ...
                \rankline
                \rank{3} This ability's effect lasts as long as you \glossterm{sustain} it as a \glossterm{minor action}.
                \rank{5} You can control the speed of your fall, up to a maximum of 120 feet per round and a minimum of 30 feet per round.
                \rank{7} Your maximum falling speed becomes 180 feet per round and your minimum falling speed becomes 10 feet per round.
            \end{ability}
            ...
            \begin{ability}{Elegant Whirl of Fluid Motion}
                ...
                \rankline
                \rank{3} You also gain a \plus1 bonus to Armor and Reflex defenses.
                \rank{5} The Acrobatics bonus increases to \plus10.
            ...
            \begin{ability}{Flash Step}[\glossterm{Teleportation}]
                ...
                \rankline
                \rank{3} The distance you can teleport is increased to half your movement speed.
                \rank{5} You can teleport in multiple steps within the same phase.
            ...
            \begin{ability}{Ki Strike}
                ...
                You may use your \textit{ki power} in place of your Perception to determine your \glossterm{accuracy} with the strike, and in place of your Strength to determine your damage with the strike.
                If the strike misses, you regain the action point spent to use this ability.

                \rankline
                \rank{3} Your \glossterm{reach} is increased by 5 feet for the strike.
                \rank{5} The bonus to your reach increases to 10 feet. 
                \rank{7} This ability does not cost an action point to use.
            \end{ability}
            ...
            \begin{ability}{Scale the Highest Tower}
                ...
                \rankline
                \rank{3} You also take no penalty for climbing without using your hands.
                \rank{5} The Climb bonus increases to \plus10.
                \rank{7} You also take no penalty for climbing with only one limb, such as an arm or leg.
            \end{ability}
            ...
            \begin{ability}{See the Flow of Life}
                ...
                \rankline
                \rank{3} Range is increased to 100 feet.
                \rank{5} The effect lasts as long as you \glossterm{sustain} it as a \glossterm{minor action}.
                \rank{7} The effect lasts as long as you \glossterm{attune} to it.
            \end{ability}
            ...
            \begin{ability}{Step Between the Mystic Worlds}[\glossterm{Swift}]
                ...
                \rankline
                \rank{3} The defense bonus is increased to \plus4.
                \rank{5} The defense bonus is increased to \plus6.
                \rank{7} You cannot be directly targeted by \glossterm{magical} abilities.
            \end{ability}
        ...
        \cf*{Mnk}[2]{Ki Vessel} You gain an additional \glossterm{action point}.

        \cf*{Mnk}[3]{Ki Manifestation}
        You learn an additional \textit{ki manifestation}.

        \cf{Mnk}[4]{Dual Manifestation} You can use up to two \textit{ki manifestation} abilities per round.
        If you do, the second ability does not cost an action point.

        \cf*{Mnk}[5]{Ki Manifestation}
        You learn an additional \textit{ki manifestation}.

        \cf{Mnk}[6]{Ki Wellspring} You gain an additional \glossterm{action point}.

        \cf*{Mnk}[7]{Ki Manifestation}
        You learn an additional \textit{ki manifestation}.

        \cf{Mnk}[8]{Myriad Manifestation} You can use up to three \textit{ki manifestation} abilities per round.
    ...
    \subsection{Unfettered Warrior}\label{Unfettered Warrior}
        ...
        \cf{Mnk}[3]{Intuitive Reaction}
        You are not \unaware when attacked by surprise.
        In addition, you gain a \plus2 bonus to \glossterm{initiative}.

        \cf*{Mnk}[4]{Greater Unarmed Warrior} The damage bonus from your \textit{unarmed warrior} increases to \plus3d.

        \cf{Mnk}[5]{Greater Intuitive Reaction}
        The initiative bonus from your \textit{intuitive reaction} ability increases to \plus5.

        \cf{Mnk}[6]{Greater Unfettered Defense}
        Your bonus to Armor defense from your \textit{unfettered defense} ability improves to \plus2.

        \cf{Mnk}[7]{Supreme Intuitive Reaction}
    ...
    \subsection{Transcendent Sage}
        ...
        \cf{Mnk}{Serene Strike} As a standard action, you can spend an \glossterm{action point} to use the \textit{serene strike} ability.
        ...
        \cf{Mnk}[3]{Transcend Frailty}
        You are immune to being \glossterm{deafened}, \glossterm{fatigued}, and \glossterm{sickened}.

        \cf{Mnk}[4]{Greater Serene Strike} The damage bonus to the strike with your \textit{serene strike} ability increases to \plus2d.

        \cf{Mnk}[5]{Transcend Flesh}
...
\section{Paladin}\label{Paladin}
    \begin{dtable}
        ...
        \begin{dtabularx}{\columnwidth}{c >{\lcol}X >{\lcol}X >{\lcol}X}
            \tb{Rank} & \tb{Devoted Paragon} & \tb{Divine Spellcasting}  & \tb{Zealous Warrior} \\\bottomrule
               1 & Lay on hands               & Divine spells  & Smite
            \\ 2 & Aligned aura               & Subspells                 & Unfaltering champion
            \\ 3 & Greater lay on hands       & Subspell                  & Unfaltering zeal
            \\ 4 & Unbending devotion         & Cantrip expertise         & Greater smite
            \\ 5 & Greater aligned aura       & Subspell                  & Greater unfaltering champion
            \\ 6 & Supreme lay on hands       & Subspell                  & Supreme smite
            \\ 7 & Greater unbending devotion & Greater cantrip expertise & Supreme unfaltering champion
            \\ 8 & Aligned soul               &                           &
        \end{dtabularx}
    \end{dtable}
    ...
    \subsection{Devoted Paragon}
        ...
        \cf{Pal}[1]{Lay on Hands}[Magical] As a standard action, you can spend an \glossterm{action point} to use the \textit{lay on hands} ability.
        \begin{ability}{Lay on Hands}
            ...
            In addition, the target can remove one \glossterm{condition} affecting it.
        \end{ability}
        ...
        \subparhead{Chaos} Whenever you or an ally in the area rolls a 1 on an attack roll when making a \glossterm{strike}, the creature can reroll the die.
        ...
        \cf{Pal}[6]{Supreme Lay on Hands}
        You gain a \plus1d bonus to the healing from your \textit{lay on hands} ability.
        In addition, you can remove an additional \glossterm{condition} from the target.

        \cf{Pal}[7]{Greater Unbending Devotion}
    ...
    \subsection{Divine Spellcasting}
        ...
        \cf{Pal}[2]{Subspells} Choose two \glossterm{subspells} for any divine spells you know.
        You learn those subspells.
        Whenever you gain access to a new spell or spell level, you can exchange any number of subspells you know for subspells of other spells you know.
        You cannot know more than two divine subspells of the same level, other than 1st level.
        ...
        \cf{Pal}[7]{Greater Cantrip Expertise}
        The bonus from your \textit{cantrip expertise} ability increases to \plus2.
    ...
    \subsection{Zealous Warrior}
        ...
        \cf{Pal}[1]{Smite}[Magical] As a standard action, you can spend an \glossterm{action point} to use the \textit{smite} ability.
        \begin{ability}{Smite}
            Make a \glossterm{strike}.
        ...
        \cf{Pal}[4]{Greater Smite} The damage bonus from your \textit{smite} ability increases to \plus3d.
        ...
        \cf{Pal}[6]{Supreme Smite} The damage bonus from your \textit{smite} ability increases to \plus4d.
...
\section{Ranger}\label{Ranger}
    ...
    \subsection{Wilderness Warrior}
        ...
        \cf{Rgr}[2]{Wilderness Lore} You gain two extra skill points.

        \cf*{Rgr}[3]{Wild Exertion}
        You learn an additional \textit{wild exertion}.

        \cf*{Rgr}[4]{Wilderness Lore} You gain two extra skill points.

        \cf*{Rgr}[5]{Wild Exertion} 
        You learn an additional \textit{wild exertion}.
        ...
        \cf*{Rgr}[7]{Wild Exertion} 
        You learn an additional \textit{wild exertion}.

    \subsection{Huntmaster}
        This archetype grants you and your allies abilities to hunt down specific foes.

        \cf{Rgr}[1]{Quarry}\label{Quarry} As a \glossterm{minor action}, you can spend an \glossterm{action point} to use the \textit{quarry} ability.
        ...
        Whenever you use your \textit{quarry} ability, you may also use one of your \textit{hunting styles}.
        {
            ...
            \begin{ability}{Merciless}
                ...
                \rankline
                \rank{5} Any vital damage dealt in this way is doubled.
                \rank{7} The accuracy bonus against your quarry is increased to \plus2 if it is \glossterm{bloodied}.
            \end{ability}

            \begin{ability}{Mystic Guidance}
            ...
            \begin{ability}{Wolfpack}
                ...
                \rankline
                \rank{5} The quarry is \immobilized instead of moving at half speed.
...
\section{Rogue}\label{Rogue}
    ...
    \subsection{Assassin}
        ...
        \cf{Rog}[1]{Sneak Attack} As a standard action, you can use the \textit{sneak attack} ability.
        ...
        \cf{Rog}[2]{Stealth Lore} You gain two extra skill points.

        \cf*{Rog}[3]{Darkstalker} As a standard action, you can spend an \glossterm{action point} to use the \textit{darkstalker} ability.
        ...
        \cf{Rog}[4]{Greater Sneak Attack}
        The damage bonus from your \textit{sneak attack} ability increases to \plus3d.

        \cf{Rog}[5]{Assassinate} As a \glossterm{minor action}, you can use the \textit{assassinate} ability.
        ...
        \cf{Rog}[6]{Supreme Sneak Attack} The damage bonus from your \textit{sneak attack} ability increases to \plus4d.

        \cf{Rog}[7]{Greater Darkstalker} When you use your \textit{darkstalker} ability, you become undetectable by all of the listed senses, not just one.
    ...
    \subsection{Jack of All Trades}
        ...
        \cf{Rog}[7]{Legendary Fortune} Whenever you make a skill attack or check, you roll two dice and take either result.

    \subsection{Scoundrel}
        This archetype grants you abilities to use in combat and improves your combat prowess.

        \cf{Rog}[1]{Combat Tricks}
        ...
        \cf{Rog}[2]{Uncanny Dodge} You gain a \plus2 bonus to Reflex defense and \glossterm{initiative} checks.
        ...
        \cf*{Rog}[5]{Combat Trick}
        You learn an additional \textit{combat trick}.

        \cf{Rog}[6]{Greater Uncanny Dodge}
    ...
    \subsection{Bard}
        ...
        {
            \begin{ability}{Mesmerizing Performance}[\glossterm{Delusion}, \glossterm{Mind}]
            ...
            \begin{ability}{Inspiring Performance}[\glossterm{Delusion}, \glossterm{Mind}]
...
\section{Warlock}\label{Warlock}
    \begin{dtable}
        ...
        \begin{dtabularx}{\columnwidth}{c >{\lcol}X >{\lcol}X >{\lcol}X}
            \tb{Rank} & \tb{Arcane Spellcasting} & \tb{Blessings of the Abyss}  & \tb{Pact Magic} \\\bottomrule
               1 & Arcane spells          & Whispers of the lost         & Wellspring of magic
    ...
    \subsection{Pact Spellcasting}
        ...
        Whenever you learn an arcane spell, you automatically learn one 1st level \glossterm{subspell} of your choice for that spell.
        You cannot learn subspells for arcane spells you know by any other means.
        As a \glossterm{standard action}, you can spend an \glossterm{action point} to cast any \glossterm{subspell} you know.
        For details about subspells, see \pcref{Subspells}.

        \cf{War}[2]{Pact Augments} You learn two pact augments from the list below.
        Pact augments function like other \glossterm{augments} (see \pcref{Augments}), with the following exceptions.
        \begin{itemize}
            \item Pact augments can only be applied to arcane spells, including \glossterm{cantrips}.
        ...
        {
            \augment{0}{Infernal Focus} You gain a \plus10 bonus to Concentration checks to cast the spell (see \pcref{Concentration}).
            ...
            \augment{0}{Soulrending} Whenever a creature is dealt damage by the spell, if it has no hit points remaining, it dies.
            ...
            \augment{1}{Untraceable} You do not need verbal or somatic \glossterm{components} to cast the spell.
            ...
            \augment{2}{Bloodreaving} Whenever a creature takes damage from the spell, you heal hit points equal to the damage dealt.
            \par This augment can be applied to any spell that deals damage.

            % TODO: taking damage multiple times in the same round abuse?
            \augment{2}{Exsanguinating} Whenever a creature takes damage from the spell, it begins bleeding as a \glossterm{condition}.
            ...
            \augment{4}{Dark Miasma} Whenever a creature takes damage from the spell, it becomes \glossterm{sickened} as a \glossterm{condition}.
            \par This augment can be applied to any spell that deals damage.

            \augment{4}{Unholy Terror} Whenever a creature takes damage from the spell, it becomes \glossterm{shaken} by you as a \glossterm{condition}.
            \par This augment can be applied to any spell that deals damage.

            \augment{5}{Soulclaiming} Whenever a creature takes damage from the spell, its soul becomes marked by your soulkeeper as a \glossterm{condition}.
        ...
        \cf*{War}[3]{Spell Knowledge}
        You learn an additional arcane spell (see \pcref{Arcane Spells}).

        \cf{War}[4]{Pact Augment} You learn an additional \textit{pact augment}.

        \cf{War}[5]{Infernal Power}
        You gain a \plus1 bonus to \glossterm{power} with arcane spells.

        \cf{War}[6]{Pact Augment} You learn an additional \textit{pact augment}.

        \cf{War}[7]{Greater Infernal Power}
        The bonus from your \textit{infernal power} ability increases to \plus2.

        \cf{War}[8]{Dual Pact} You can apply two different \textit{pact augments} to the same spell, paying separate action points for each.
    ...
    \subsection{Blessings of the Abyss}
        ...
        \cf{War}[1]{Whispers of the Lost} You hear the voices of souls lost to the Abyss, linked to you through your soulkeeper.
        ...
        \cf{War}[2]{Armor Tolerance} You reduce your \glossterm{encumbrance} by 2 when determining your \glossterm{arcane spell failure}.

        \cf{War}[3]{Abyssal Lore} You gain two additional skill points.

        \cf{War}[4]{Greater Armor Tolerance} The penalty reduction from your \textit{armor tolerance} ability improves to 3.

        \cf{War}[5]{Greater Whispers of the Lost} You gain an additional ability depending on the voices you chose with your \textit{whispers of the lost} ability.
        {
            \subcf{Mentoring Whispers} You gain a \plus1 bonus to \glossterm{accuracy} and \glossterm{power} with arcane spells.
            ...
            In addition, you reduce your \glossterm{vital damage penalties} by an amount equal to half your level.
        }

        \cf{War}[6]{Supreme Armor Tolerance} The penalty reduction from your \textit{armor tolerance} ability improves to 4.

        \cf{War}[7]{Abyssal Defense} You gain a \plus1 bonus to Fortitude, Reflex, and Mental defenses.
    ...
    \subsection{Pact Magic}
        ...
        \cf{War}[1]{Wellspring of Magic} You gain an additional \glossterm{action point}.

        \cf{War}[2]{Malevolent Boon}
        When you cast an arcane spell that makes an attack roll, if you miss, you may regain the \glossterm{action point} spent to cast the spell (if any).
        ...
        \cf{War}[4]{Greater Malevolent Boon} You can cast arcane spells that make attack rolls without spending \glossterm{action points}.
        ...
        \cf*{War}[6]{Greater Wellspring of Magic} You gain an additional \glossterm{action point}.
