        ...
        \subsubsection{Martial Supremacy}
            ...
            \begin{ability}
                \begin{spelleffects}
                    ...
                    You take a \minus1d penalty to \glossterm{strike damage} on the strikes.
...
\section{Rogue}\label{Rogue}
    ...
    \subsection{Class Abilities}
        ...
        \subsubsection{Assassin}
            ...
            \cf{Rog}[8]{Assassination} As a standard action, you can use this ability.
            \begin{ability}
                \begin{spelltargetinginfo}
                    \spellquicktargeting{One creature}{\rngmed}
                \end{spelltargetinginfo}
        ...
        \subsubsection{Jack of All Trades}
            ...
            \cf{Rog}{Skill Lore} You gain two extra skill points which must be spent on rogue class skills.

            \cf{Rog}[4]{Skill Lore} You gain two extra skill points which must be spent on rogue class skills.

            \cf{Rog}[7]{Lucky Slip} Once per round, when you are hit by a \glossterm{strike}, you can spend an \glossterm{action point} to use this ability.
            If you do, the attacking creature rerolls the attack roll.

            \cf{Rog}[10]{Skill Exemplar} You gain a \plus1 bonus to all skills.
            ...
            \cf{Rog}[16]{Greater Skill Exemplar} The skill bonus from your \textit{skill exemplar} ability increases to \plus2.

            \cf{Rog}[19]{Twist of Fate} You can use your \textit{lucky slip} ability against any successful attack, not just a \glossterm{strike}.
        ...
        \subsubsection{Agile Trickster}
            ...
            \subparhead{Surprise the Unwary}
            % Slightly vague wording, but better than ``could not see''
            You gain a \plus1d bonus to \glossterm{strike damage} against creatures who could not target you at the start of the round.
            The target does not have to be \unaware of your attack.

            \cf{Rog}[6]{Perceive Weakness}
            You gain a \plus1d bonus to \glossterm{strike damage}.
