...
\section{Barbarian}\label{Barbarian}
    ...
    \subsection{Class Abilities}
        ...
        The barbarian gains a bonus combat feat that only functions while he is raging.
        The feat must be drawn from the list of combat feats in \tref{Combat Feats}.
...
\section{Cleric}\label{Cleric}
    ...
    \subsection{Cleric Domain Abilities}
        ...
        \subsubsection{Domain Masteries}\label{Domain Masteries}
            ...
            The cleric gains \glossterm{spell resistance} equal to 10 \add divine power.
            Whenever the cleric resists a spell with this spell resistance, he regains a spell slot of a level up to one lower than the level of the resisted spell.
...
\section{Fighter}\label{Fighter}
    \begin{dtable}
        ...
        \begin{dtabularx}{\columnwidth}{>{\ccol}p{\levelcol} >{\ccol}p{\babcolgood} >{\lcol}X}
            ...
            \fighterprogressionrow{9}  & Style fusion                         \\
    ...
    \subsection{Class Abilities}
        ...
        \cf{Ftr}[9th]{Style Fusion}
        The fighter gains a limited ability to combine the effects of multiple Style feats (see \pcref{Style Feats}).
        He may use a single \glossterm{free action} to initiate two styles at once, or change which two styles he is using.
        However, he can only use two styles at once a number of rounds per day equal to his Intelligence or half his fighter level, whichever is higher.
...
\section{Ranger}\label{Ranger}
    ...
    \subsection{Class Abilities}
        ...
        In addition, he may use his ranger level in place of the Survival skill to follow tracks.
...
\section{Rogue}\label{Rogue}
    \begin{dtable}
        ...
        \begin{dtabularx}{\columnwidth}{>{\ccol}p{\levelcol} >{\ccol}p{\babcolavg} c >{\lcol}X}
            ...
            \rogueprogressionrow{5}  & \plus3d6  & Lucky strike         \\
            ...
            \rogueprogressionrow{9}  & \plus5d6  & Lucky slip         \\
            ...
            \rogueprogressionrow{13} & \plus7d6  & Lucky break         \\
    ...
    \subsection{Class Abilities}
        ...
        \cf{Rog}[5th]{Lucky Strike}
        The rogue gains an additional \glossterm{legend point}.
        Whenever she spends a legend point to reroll a \glossterm{strike} that qualifies as a sneak attack, the target is treated as \unaware against the attack.
...
\section{Wizard}\label{Wizard}
    ...
    \subsection{Class Abilities}
        ...
        \cf{Wiz}[5th]{Predictive Spells}[Ex]
