...
\section{Barbarian}\label{Barbarian}
    ...
    \subsection{Battleforged Resilience}
        ...
        \cf{Bbn}[3]{Greater Endurance} You increase your maximum \glossterm{hit points} by an amount equal to your level.
        ...
        \cf{Bbn}[6]{Toughened Body} You gain a \plus1 bonus to your base Constitution (see \pcref{Constitution}).
    ...
    \subsection{Battlerager}\label{Rage}
        ...
        \cf{Bbn}[3]{Powerful Anger} You gain a bonus to \glossterm{power} equal to half your level with \glossterm{mundane} abilities.
...
\section{Cleric}\label{Cleric}
    ...
    \subsection{Divine Spell Mastery}
        ...
        You gain your choice of one of the following abilities.
        {
            ...
            \parhead{Spell Power} Choose an divine \glossterm{spell} you know.
                % TODO: half level or full level?
                You gain a bonus to \glossterm{power} with that spell equal to your level.
    ...
    \subsection{Healer}
        ...
        \begin{freeability}{Restoration}[\glossterm{Magical}]
            ...
            The target regains \glossterm{hit points} equal to half your \glossterm{power} \add 1d8 per rank.
        \end{freeability}
        ...
        In addition, the healing from your \textit{restoration} ability increases to be equal to your \glossterm{power} \add 1d10 per rank.
...
\section{Fighter}\label{Fighter}
    ...
    \subsection{Equipment Training}
        ...
        \cf{Ftr}[4]{Weapon Expertise} All \glossterm{strikes} you make gain bonus damage dice equal to your weapon's damage dice.
        ...
        \cf{Ftr}[7]{Greater Weapon Expertise} The bonus from your \textit{weapon expertise} ability increases to be equal to twice your weapon's damage dice.
    ...
    \subsection{Martial Mastery}
...

        {
            ...
            \cf{Ftr}[3]{Greater Defensive Expertise} The bonus from your \textit{defensive expertise} ability increases to \plus2.
        }
...

        {
            ...
            \cf{Ftr}[5]{Martial Force} All \glossterm{strikes} you make gain bonus damage dice equal to your weapon's damage dice.
        }

        {
            ...
            \cf{Ftr}[6]{Supreme Defensive Expertise} The bonus from your \textit{defensive expertise} ability increase to \plus3.
        }
...
\section{Monk}\label{Monk}
    ...
    \subsection{Esoteric Warrior}\label{Esoteric Warrior}
...

        {
            ...
            \cf{Mnk}[3]{Greater Esoteric Fluidity} The bonus from your \textit{esoteric fluidity} ability increases to \plus2.
        }
...

        {
            ...
            \cf{Mnk}[5]{Esoteric Force} All \glossterm{strikes} you make gain bonus damage dice equal to your weapon's damage dice.
        }

        {
            ...
            \cf{Mnk}[6]{Supreme Esoteric Fluidity} The bonus from your \textit{esoteric fluidity} ability increases to \plus3.
        }
    ...
    \subsection{Ki}
        ...
        \cf{Mnk}[2]{Ki Self} You can treat all strikes you make as \glossterm{magical}, allowing you to use your \glossterm{power} with magical abilities to determine their damage.
        In addition, the bonus to \glossterm{resistance} against \glossterm{energy damage} from your \textit{ki barrier} ability increases to be equal to half your \glossterm{power}.

        \cf{Mnk}[3]{Ki Power} You gain a bonus to \glossterm{power} with \glossterm{magical} abilities equal to half your level.

        \cf{Mnk}[4]{Ki Manifestation}[Magical]
        You learn an additional \textit{ki manifestation}.

        \cf{Mnk}[5]{Greater Ki Self} The defense bonus from the body armor provided by your \textit{ki barrier} ability increases to \plus3.
        ...
        \cf{Mnk}[6]{Ki Focus} You gain a \plus1 bonus to your base Willpower.
    ...
    \subsection{Perfected Form}
        ...
        \cf{Mnk}[2]{Perfect Precision} You gain a \plus1 bonus to \glossterm{accuracy} with attacks using weapons from the monk weapons and unarmed weapons \glossterm{weapon groups}, and to any attack using one or more \glossterm{free hands}.
...
\section{Paladin}\label{Paladin}
    ...
    \subsection{Devoted Paragon}
        ...
        You gain a bonus to \glossterm{power} with all abilities equal to half your level.
        ...
        \cf{Pal}[6]{Greater Paragon Power} The bonus from your \textit{paragon power} ability increases to be equal to your level.
    ...
    \subsection{Stalwart Guardian}
        ...
        \cf{Pal}[2]{Stalwart Resilience} You gain a bonus equal to your level to your \glossterm{resistances} (see \pcref{Resistances}).
        ...
        \cf{Pal}[4]{Greater Lay on Hands} The healing from your \textit{lay on hands} ability increases to be equal to half your power \add 1d8 per rank.
        In addition, when you use that ability, you can choose to remove a \glossterm{condition} of the target's choice from it instead of restoring its hit points.

        \cf{Pal}[5]{Greater Stalwart Resilience} The bonus from your \textit{stalwart resilience} ability increases to be equal to twice your level.

        \cf{Pal}[6]{Supreme Stalwart Defender} The bonus from your \textit{enduring defender} ability increases to \plus3.
        In addition, the bonus from your \textit{greater enduring defender} ability increases to \plus2.
        Finally, you increase your maximum \glossterm{hit points} by an amount equal to your level.

        \cf{Pal}[7]{Supreme Lay on Hands}[Magical] The healing from your \textit{lay on hands} ability increases to be equal to half your power \add 1d10 per rank.
        In addition, when you use that ability, you can choose to remove a \glossterm{vital wound} of the target's choice from it instead of restoring its hit points.
    ...
    \subsection{Zealous Warrior}
        ...
        \begin{freeability}{Smite}
            ...
            Otherwise, you gain a bonus to your \glossterm{power} with the strike equal to your level.
        \end{freeability}

        \cf{Pal}[2]{Zealous Fixation} Whenever you hit a creature with a \glossterm{strike}, you ignore \glossterm{concealment} and all \glossterm{miss chances} against that creature with your attacks until you take a \glossterm{short rest} or until you hit a different creature with a strike.
        ...
        \begin{freeability}{Zealous Purge}
            ...
            If the target loses \glossterm{hit points} from the strike, it stops being \glossterm{attuned} to a number of effects equal to your rank.
            It can freely choose which effects it releases its attunement to.
        \end{freeability}

        \cf{Pal}[4]{Zealous Offense} You gain a \plus1 bonus to \glossterm{accuracy}.

        \cf{Pal}[5]{Greater Zealous Exertion} The bonus from your \textit{zealous exertion} ability increases to \plus5.

        \cf{Pal}[6]{Pass Judgment}[Magical] You can use the \textit{pass judgment} ability as a \glossterm{minor action}.
        ...
        \cf{Pal}[7]{Greater Zealous Offense} The bonus from your \textit{zealous offense} ability increases to \plus2.

        \cf{Pal}[7]{Greater Smite} The bonus to \glossterm{power} from your \textit{smite} ability increases to twice your level.
...
\section{Ranger}\label{Ranger}
    ...
    \subsection{Huntmaster}
        ...
        \cf{Rgr}[3]{Greater Endurance Hunter} The bonus to the Survival skill from your \textit{hunter's instincts} ability increases to \plus4.
        ...
        \cf{Rgr}[4]{Greater Quarry} All \glossterm{strikes} you make against your \textit{quarry} gain bonus damage dice equal to your weapon's damage dice.

        \cf*{Rgr}[5]{Hunting Style}
        You learn an additional \textit{hunting style}.

        \cf{Rgr}[6]{Supreme Endurance Hunter} The bonus to the Survival skill from your \textit{hunter's instincts} ability increases to \plus6.
        In addition, the bonus to Fortitude defense from that ability increases to \plus3.
        Finally, the bonus to your fatigue tolerance from that ability increases to \plus2.

        \cf{Rgr}[7]{Supreme Quarry} The bonus from your \textit{greater quarry} ability increases to be equal to twice your weapon's damage dice.
    ...
    \subsection{Wild Warrior}
...

        {
            ...
            \cf{Rgr}[3]{Greater Wild Senses} The bonus from your \textit{wild senses} ability increases to \plus2.
        }
...

        {
            ...
            \cf{Rgr}[5]{Wild Force} All \glossterm{strikes} you make gain bonus damage dice equal to your weapon's damage dice.
        }

        {
            ...
            \cf{Rgr}[6]{Supreme Wild Senses} The bonuses from your \textit{wild senses} ability increase to \plus3.
        }
...
\section{Rogue}\label{Rogue}
    ...
    \subsection{Assassin}
        ...
        % Unusually high scaling compensates for the light weapon limitation.
        % Smite gives +20 damage at level 20, and this gives +21 damage at level 20 assuming a d6 die.
        % Note that this makes it important that there should not exist a d8 light weapon.
        % We want Sneak Attack to use damage dice instead of a flat bonus to work with Assassination.
        ...
        \begin{freeability}{Sneak Attack}
            ...
            If the target is \unaware or is \glossterm{threatened} by one of your \glossterm{allies}, the strike gains bonus damage dice equal to your weapon's damage dice.
            ...
            \rankline
            \rank{3} The bonus increases to twice your weapon's damage dice.
            \rank{5} The bonus increases to four times your weapon's damage dice.
            In addition, the maximum range increases to \rngmed range.
            \rank{7} The bonus increases to six times your weapon's damage dice.
    ...
    \subsection{Combat Trickster}
...

        {
            ...
            \cf{Rog}[3]{Greater Tricky Finesse} The bonus from your \textit{tricky finesse} ability increases to \plus2.
        }
...

        {
            ...
            \cf{Rog}[5]{Tricky Force} All \glossterm{strikes} you make gain bonus damage dice equal to your weapon's damage dice.
        }

        {
            ...
            \cf{Rog}[6]{Supreme Tricky Finesse} The bonus from your \textit{tricky finesse} ability increases to \plus3.
        }
    ...
    \subsection{Jack of All Trades}
        ...
        \cf{Rog}[3]{Versatile Power} You gain a bonus to \glossterm{power} equal to half your level.
        ...
        \cf{Rog}[6]{Greater Versatile Power} The bonus from your \textit{versatile power} ability increases to be equal to your level.
