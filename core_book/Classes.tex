...
\section{Barbarian}\label{Barbarian}
    ...
    \subsection{Primal Warrior}
        ...
        As a standard action, you can spend an \glossterm{action point} to use a \textit{primal exertion} ability.
        {
            ...
            \par At 6th level, the accuracy bonus increases to \plus3.
            \par At 12th level, the accuracy bonus increases to \plus4.
            \par At 18th level, the accuracy bonus increases to \plus5.
            ...
            \par At 6th level, a critical hit also makes the target \immobilized as a \glossterm{condition}.
            ...
            \par At 6th level, the accuracy bonus increases to \plus4.
            \par At 12th level, the accuracy bonus increases to \plus5.
            \par At 18th level, the accuracy bonus increases to \plus6.
            ...
            \par At 12th level, a hit also makes the target \glossterm{deafened} as a \glossterm{condition}.
            ...
            \par At 6th level, you gain a \plus1 bonus to accuracy with each strike.
...
\section{Fighter}\label{Fighter}
    ...
    \subsection{Martial Mastery}
        ...
        As a standard action, you can spend an \glossterm{action point} to use a \textit{martial exertion} ability.
        {
            ...
            This is a \glossterm{Mind} ability.
            \subparhead{Hit (Mental)} As a \glossterm{condition}, the target suffers a \minus3 penalty to accuracy on all attacks against creatures other than you.
        ...
        % TODO: different wording than ``resolve''?
...
\section{Rogue}\label{Rogue}
    ...
    \subsection{Scoundrel}
        ...
        As a standard action, you can spend an \glossterm{action point} to use a \textit{combat trick} ability.
        {
            ...
            In addition to the strike's normal effects, you also compare the attack result against the target's Mental defense.
            This is a \glossterm{Mind} ability.
            \subparhead{Hit (Mental)} The target is \bewildered as a \glossterm{condition}.
            \subparhead{Critical Hit (Mental)} The target is \disoriented as a \glossterm{condition}.
            \par At 6th level, you gain a \plus1d bonus to damage with the strike.
            \par At 12th level, the damage bous increases to \plus2d.
        ...
        \cf{Rog}[18]{Supreme Trickery}
        Whenever you resolve a \textit{combat trick} ability, if it missed against all targets and had no effects on a miss, you regain the \glossterm{action point} spent to use the ability.
