...
\section{How Classes Work}
    ...
    \subsection{Archetypes}\label{Archetypes}
        ...
        As you gain levels, you gain abilities from those three archetypes, and you gain no abilities from any additional archetypes the class has.
...
\section{Barbarian}\label{Barbarian}
    ...
    \subsection{Battleforged Resilience}
        ...
        \cf{Bbn}[1]{Battle-Scarred} You gain a bonus equal to your rank in this archetype to your \glossterm{resistance} against \glossterm{physical damage} (see \pcref{Resistances}).
        ...
        \cf{Bbn}[4]{Greater Battle-Scarred} The bonus from your \textit{battle-scarred} ability increases to be equal to twice your rank in this archetype.
        ...
        \cf{Bbn}[7]{Supreme Battle-Scarred} The bonus from your \textit{battle-scarred} ability increases to be equal to three times your rank in this archetype.
    ...
    \subsection{Battlerager}\label{Rage}
        ...
        \cf{Bbn}[2]{Insensible Anger} You reduce your maximum hit points by an amount equal to your rank in this archetype.
        In exchange, you gain a bonus equal to your rank in this archetype to your \glossterm{resistances} against both \glossterm{physical damage} and \glossterm{energy damage} (see \pcref{Resistances}).
        ...
        \cf{Bbn}[4]{Greater Rage} The \glossterm{power} bonus from your \textit{rage} ability increases to be equal to three times your rank in this archetype.

        \cf{Bbn}[5]{Greater Insensible Anger} The hit point reduction and resistance bonuses from your \textit{insensible anger} ability both increase to be equal to twice your rank in this archetype.
        ...
        In addition, the \glossterm{power} bonus from your \textit{rage} ability increases to be equal to four times your rank in this archetype.
    ...
    \subsection{Outland Savage}
        ...
        \cf{Bbn}[3]{Savage Force} You gain a \plus1d bonus to your damage dice with all weapons.
    ...
    \subsection{Primal Warrior}
...

        {
            ...
            \cf{Bbn}[2]{Primal Force} You gain a \plus1d bonus to your damage dice with all weapons.
        }
...
\section{Cleric}\label{Cleric}
    ...
    \subsection{Divine Spell Mastery}
        ...
        \cf{Clr}[0]{Mystic Training} You gain a \plus2 bonus to the Spellcraft skill and a \plus1 bonus to Mental defense.
        ...
        You gain a bonus equal to your rank in this archetype to your \glossterm{power} with \glossterm{magical} abilities.
        ...
        The bonus from your \textit{wellspring of power} ability increases to twice your rank in this archetype.
    ...
    \subsection{Healer}
        ...
        \begin{freeability}{Restoration}[\glossterm{Magical}]
            ...
            The target regains \glossterm{hit points} equal to 1d6 plus your \glossterm{power}.

            \rankline
            The healing increases by +1d for every rank beyond 1.
        \end{freeability}
        ...
        \cf{Clr}[4]{Greater Restoration} You gain a \plus1d bonus to the healing from your \textit{restoration} ability.
        ...
        \cf{Clr}[7]{Supreme Restoration} The healing bonus from your \textit{greater restoration} ability increases to \plus2d.
    ...
    \subsection{Cleric Domain Abilities}\label{Cleric Domain Abilities}
        ...
        \subsubsection{Destruction}
            ...
            \begin{freeability}{Destructive Attack}
                ...
                You gain a bonus to your \glossterm{power} with the strike equal to twice your rank with this archetype.
            \end{freeability}
            ...
            \end{freeability}
            \parhead{Mastery} You gain a bonus equal to your rank in this archetype to your \glossterm{power} with all abilities.
        ...
        \subsubsection{Magic}
            ...
            \parhead{Gift} You gain a \plus4 bonus to the Spellcraft skill (see \pcref{Spellcraft}).
            \parhead{Aspect} You learn an additional \glossterm{spell} from a divine \glossterm{mystic sphere} you have access to.
            \parhead{Essence} You gain a bonus equal to your rank in this archetype to your \glossterm{power} with \glossterm{magical} abilities.
            \parhead{Mastery} The power bonus from this domain's essence increases to be equal to twice your rank in this archetype.

        \subsubsection{Protection}
            \parhead{Gift} You gain a \plus1 bonus to Armor defense.
            \parhead{Aspect} You gain a bonus equal to your rank in this archetype to your \glossterm{resistance} against \glossterm{energy damage}.
            \parhead{Essence} The bonus from this domain's aspect increases to be equal to twice your rank in this archetype.
...
\section{Druid}\label{Druid}
    ...
    \subsection{Elementalist}\label{Elementalist}
        ...
        \begin{itemize}
            ...
            \item Fire: You gain a bonus equal to your rank in this archetype to your \glossterm{resistance} against fire damage.
        ...
        \begin{itemize}
            ...
            \item Fire: The bonus to your \glossterm{resistance} increases to be equal to twice your rank in this archetype.
    ...
    \subsection{Shifter}\label{Shifter}
...

        {
            \begin{freeability}{Form of the Bear}
                ...
                \rankline
                \rank{3} You gain a \plus1d bonus to your damage dice with natural weapons.
            ...
            \begin{freeability}{Form of the Oak}
                ...
                In exchange, you gain a bonus equal to your rank in this archetype to your \glossterm{resistance} against \glossterm{physical damage}.
                \rankline
                \rank{3} You also gain a \plus1 bonus to Armor defense.
                \rank{5} The resistance bonus increases to be equal to twice your rank in this archetype.
    ...
    \subsection{Wildspeaker}\label{Wildspeaker}
        ...
        \begin{attuneability}{Natural Servant}[\glossterm{Attune} (self), \glossterm{Magical}]
            ...
            \begin{itemize}
                ...
                \item Its \glossterm{accuracy} is equal to your \glossterm{accuracy}.
                    It gains the benefit of all of your accuracy bonuses.
                    Any \glossterm{magic bonuses} you have do not stack with \glossterm{magic bonuses} applied directly to the creature.
        ...
        \begin{itemize}
            \item Aquatic: A Medium shark appears that has a 40 foot \glossterm{swim speed} and no land speed.
                It has a bite \glossterm{natural weapon}.
            \item Arctic: An Medium polar bear appears that has a bonus equal to your \glossterm{power} to its \glossterm{resistance} against cold damage.
...
\section{Fighter}\label{Fighter}
    ...
    \subsection{Combat Discipline}
        ...
        \cf{Ftr}[3]{Disciplined Power}
        You gain a bonus equal to your rank in this archetype to your \glossterm{power} with \glossterm{mundane} abilities.
        ...
        \cf{Ftr}[6]{Greater Disciplined Power} The bonus from your \textit{disciplined power} ability increases to twice your rank in this archetype.
    ...
    \subsection{Equipment Training}
        ...
        \cf{Ftr}[4]{Weapon Expertise} You gain a \plus1d bonus to your damage dice with all weapons.
        ...
        \cf{Ftr}[7]{Greater Weapon Expertise} The bonus from your \textit{weapon expertise} ability increases to \plus2d.
    ...
    \subsection{Martial Mastery}
...

        {
            ...
            \cf{Ftr}[2]{Martial Force} You gain a \plus1d bonus to your weapon's damage dice.
        }
...
\section{Monk}\label{Monk}
    ...
    \subsection{Esoteric Warrior}\label{Esoteric Warrior}
...

        {
            ...
            \cf{Mnk}[2]{Esoteric Force} You gain a \plus1d bonus to your damage dice with all weapons.
        }
    ...
    \subsection{Ki}
        ...
        In addition, the bonus to \glossterm{resistance} against \glossterm{energy damage} from your \textit{ki barrier} ability increases to be equal to twice your rank in this archetype.
        ...
        In addition, the bonus to \glossterm{resistance} against \glossterm{energy damage} increases to be equal to three times your rank in this archetype.

        \cf{Mnk}[6]{Greater Ki Power} The bonus from your \textit{ki power} ability increases to twice your rank in this archetype.
...
\section{Paladin}\label{Paladin}
    ...
    \subsection{Devoted Paragon}
        ...
        You gain a bonus equal to your rank in this archetype to your \glossterm{power} with all abilities.
        ...
        \cf{Pal}[6]{Greater Paragon Power} The bonus from your \textit{paragon power} ability increases to twice your rank in this archetype.
    ...
    \subsection{Stalwart Guardian}
        ...
        \cf{Pal}[2]{Stalwart Resilience} You reduce your maximum hit points by an amount equal to your rank in this archetype.
        In exchange, you gain a bonus equal to your rank in this archetype to your \glossterm{resistances} against both \glossterm{physical damage} and \glossterm{energy damage} (see \pcref{Resistances}).
        ...
        \cf{Pal}[4]{Greater Lay on Hands} You gain a \plus1d bonus to the healing from your \textit{lay on hands} ability.
        ...
        \cf{Pal}[5]{Greater Stalwart Resilience} The hit point reduction and resistance bonuses from your \textit{stalwart resilience} ability both increase to be equal to twice your rank in this archetype.
        ...
        \cf{Pal}[7]{Supreme Lay on Hands}[Magical] The healing bonus from your \textit{greater lay on hands} ability increases to \plus2d.
    ...
    \subsection{Zealous Warrior}
        ...
        \begin{freeability}{Smite}
            ...
            Otherwise, you gain a bonus to your \glossterm{power} with the strike equal to twice your rank in this archetype.
        \end{freeability}
        ...
        \cf{Pal}[4]{Greater Smite} You gain a \plus1d bonus to damage with the strike from your \textit{smite} ability.
        ...
        \cf{Pal}[7]{Supreme Smite} The bonus from your \textit{greater smite} ability increases to \plus2d.
...
\section{Ranger}\label{Ranger}
    ...
    \subsection{Huntmaster}
        ...
        \cf{Rgr}[4]{Greater Quarry} You gain a \plus1d bonus to your damage dice with all weapons with \glossterm{strikes} against your \textit{quarry}.
...
\section{Rogue}\label{Rogue}
    ...
    \subsection{Jack of All Trades}
        ...
        \cf{Rog}[6]{Greater Versatile Power} The bonus from your \textit{versatile power} ability increases to twice your rank in this archetype.
...
\section{Sorcerer}\label{Mage}
    ...
    \subsection{Arcane Magic}
        ...
        In addition, the bonus to \glossterm{resistance} against \glossterm{energy damage} increases to be equal to twice your rank in this archetype.
    ...
    \subsection{Arcane Spell Mastery}
        ...
        \cf{Sor}[0]{Mystic Training} You gain a \plus2 bonus to the Spellcraft skill and a \plus1 bonus to Mental defense.
    ...
    \subsection{Draconic Magic}
        ...
        \cf{Sor}[3]{Greater Draconic Bloodline} You learn an spell from the mystic sphere associated with your dragon.
        ...
        \cf{Sor}[5]{Greater Draconic Hide} The bonus from your \textit{draconic hide} ability increases to be equal to twice your rank in this archetype.
    ...
    \subsection{Innate Arcanist}
        ...
        \cf{Sor}[0]{Arcane Body} You gain a \plus2 bonus to the Spellcraft skill and a \plus1 bonus to Fortitude defense.
        ...
        \cf{Sor}[3]{Mystic Tolerance} You gain a bonus equal to your rank in this archetype to your \glossterm{resistance} against \glossterm{energy damage}.
        ...
        \cf*{Sor}[5]{Greater Personal Enhancement} The bonuses from your \textit{personal enhancement} ability increase to \plus2.

        \cf{Sor}[6]{Greater Mystic Tolerance} The bonus from your \textit{mystic tolerance} ability increases to be equal to twice your rank in this archetype.
...
\section{Warlock}\label{Warlock}
    ...
    \subsection{Blessings of the Abyss}
        ...
        \cf{War}[2]{Fiendish Resistance} You gain a bonus equal to your rank in this archetype to your \glossterm{resistance} against \glossterm{energy damage}.
        ...
        \cf{War}[4]{Hellfire} You gain a bonus equal to your rank in this archetype to \glossterm{power} with abilities that deal fire damage.

        \cf{War}[5]{Greater Fiendish Resistance}[Magical] The bonus from your \textit{fiendish resistance} ability increases to be equal to twice your level.
        ...
        \cf{War}[7]{Greater Hellfire} The power bonus from your \textit{hellfire} ability increases to twice your rank in this archetype.
...
\section{Wizard}\label{Wizard}
    ...
    \subsection{Arcane Magic}
        ...
        The defense bonus from the body armor created by your \textit{mage armor} ability increases to \plus3.
        In addition, the bonus to \glossterm{resistance} against \glossterm{energy damage} increases to twice your rank in this archetype.
        ...
        The defense bonus from the body armor created by your \textit{mage armor} ability increases to \plus3.
        In addition, the bonus to \glossterm{resistance} against \glossterm{energy damage} increases to three times your rank in this archetype.
    ...
    \subsection{Arcane Spell Mastery}
        ...
        \cf{Wiz}[0]{Mystic Training} You gain a \plus2 bonus to the Spellcraft skill and a \plus1 bonus to Mental defense.
