...
\end{dtabularx}
    ...
    \subsection{Battleforged Resilience}
        ...
        \cf{Bbn}[1]{Battle-Scarred} You gain a bonus equal to three times your rank in this archetype to your \glossterm{resistance} against \glossterm{physical damage} (see \pcref{Resistances}).
        ...
        \cf{Bbn}[4]{Greater Battle-Scarred} The bonus from your \textit{battle-scarred} ability increases to be equal to four times your rank in this archetype.
        ...
        \cf{Bbn}[7]{Supreme Battle-Scarred} The bonus from your \textit{battle-scarred} ability increases to be equal to five times your rank in this archetype.
        ...
        \subsubsection{Typical Character}
            ...
            \parhead{Equipment} Battleaxe, standard shield, scale mail. As you gain levels, use the heaviest armor you can afford.
            \parhead{Legacy Item} Shield.
                ...
                At level 15, choose \mitem{supreme protective shield}, \mitem{greater shield of arrow catching}, and \mitem{covering shield}.
            \parhead{Feats} Shieldbearer, Regenerator, Toughness
    ...
    \subsection{Battlerager}\label{Rage}
        ...
        \cf{Bbn}[3]{Greater Insensible Anger} The resistance bonuses from your \textit{insensible anger} ability both increase to be equal to three times your rank in this archetype.
        ...
        \cf{Bbn}[6]{Supreme Insensible Anger} The resistance bonuses from your \textit{insensible anger} ability both increase to be equal to four times your rank in this archetype.
        ...
        \subsubsection{Typical Character}
            ...
            \parhead{Feats} Greatweapon Warrior, Rapid Reaction, Swift
    ...
    \subsection{Outland Savage}
        ...
        \subsubsection{Typical Character}
            ...
            \parhead{Feats} Savage, Brawler, Swift
    ...
    \subsection{Primal Warrior}
        ...
        \subsubsection{Typical Character}
            ...
            \parhead{Legacy Item} Weapon.
                ...
                At level 9, choose \mitem{greater surestrike} and \mitem{blessed}.
                At level 15, choose \mitem{supreme surestrike}, \mitem{greater shocking}, and \mitem{blessed}.
            \parhead{Feats} Greatweapon Warrior, Weapon Focus, Swift
            \parhead{Combat Styles} Dirty Fighting, Herald of War, Unbreakable Defense
            \parhead{Maneuvers} You can learn most of the maneuvers available at each rank from your combat styles, so it's not meaningful to list specific maneuvers here.
    ...
    \subsection{Totemist}
        ...
        Each totem animal grants you abilities that are associated with that animal.
        {
            ...
            In addition, you reduce your \glossterm{range increment} penalties by 1 (see \pcref{Range Increments}).
        ...
        \cf{Bbn}[4]{Greater Totem Animal} The benefit from your \textit{totem animal} ability improves.
        {
            ...
            \subcf{Eagle} The range increment penalty reduction increases to 2.
        ...
        \cf{Bbn}[7]{Supreme Totem Animal} The benefit from your \textit{totem animal} ability improves further.
        {
            ...
            \subcf{Eagle} The range increment penalty reduction increases to 3.
        ...
        \subsubsection{Typical Character}
            ...
            \parhead{Feats} Sniper, Weapon Focus, Swift
...
\end{dtabularx}
    ...
    \subsection{Preacher}
        ...
        \cf{Clr}[3]{Bless the Worthy} You can use the \textit{bless the worthy} abiity as a standard action.
        \begin{instantability}{Bless the Worthy}
            All \glossterm{allies} within a \hugearea radius from you gain a \plus2 bonus to \glossterm{accuracy} during the next round.
            In addition, one of those allies can remove a \glossterm{condition}.
        ...
        \begin{instantability}{Condemn the Fearful}
            ...
            \rankline
            \rank{7} The area increases to a \largearea radius, and the effect becomes a \glossterm{condition} on a critical hit.
        \end{instantability}

        \cf{Clr}[6]{Greater Inspiring Oration} The bonus from your \textit{inspiring oration} ability increases to \plus4.

        \cf{Clr}[7]{Convert the Irresolute} You can use the \textit{convert the irresolute} abiity as a standard action.
...
\end{dtabularx}
    ...
    \subsection{Airdancer}\label{Airdancer}
        ...
        \cf{Mnk}[5]{Greater Evasion} You can use your Reflex defense with a \minus4 penalty in place of any other defense against abilities that affect an area.
...
\end{dtabularx}
    ...
    \subsection{Stalwart Guardian}
        ...
        \cf{Pal}[2]{Stalwart Resilience} You gain a bonus equal to twice your rank in this archetype to your \glossterm{resistances} against both \glossterm{physical damage} and \glossterm{energy damage} (see \pcref{Resistances}).
        ...
        \cf{Pal}[5]{Greater Stalwart Resilience} The resistance bonuses from your \textit{stalwart resilience} ability both increase to be equal to three times your rank in this archetype.
...
\end{dtabularx}
    ...
    \subsection{Assassin}
        ...
        If you do, you take a \minus10 penalty to the Stealth check.
        ...
        \cf{Rog}[5]{Greater Evasion} You can use your Reflex defense with a \minus4 penalty in place of any other defense against abilities that affect an area.
        This does not protect you from abilities that affect multiple specific targets without affecting an area.
        Using this ability also does not cause your \textit{evasion} ability to reduce damage from the attack if it was not already against Armor or Reflex defense.
...
\end{dtabularx}
    ...
    \subsection{Draconic Magic}
        ...
        \cf{Sor}[3]{Draconic Hide} You gain a bonus equal to twice your rank in this archetype to your \glossterm{resistances} against both \glossterm{physical damage} and \glossterm{energy damage} (see \pcref{Resistances}).
        ...
        \cf{Sor}[6]{Greater Draconic Hide} The resistance bonuses from your \textit{draconic hide} ability both increase to be equal to three times your rank in this archetype.
    ...
    \subsection{Innate Arcanist}
        ...
        \cf{Sor}[1]{Mystic Tolerance} You gain a bonus equal to three times your rank in this archetype to your \glossterm{resistance} against \glossterm{energy damage}.
        ...
        \cf{Sor}[4]{Greater Mystic Tolerance} The bonus from your \textit{mystic tolerance} ability increases to be equal to four times your rank in this archetype.
        ...
        \cf{Sor}[7]{Supreme Mystic Tolerance} The bonus from your \textit{mystic tolerance} ability increases to be equal to five times your rank in this archetype.
...
\end{dtabularx}
    ...
    \subsection{Keeper of Forbidden Knowledge}
        ...
        Each secret grants great power at a cost.
        {
            ...
            It also provides a \plus6 bonus to \glossterm{resistance} against \glossterm{physical damage}, and a \plus3 bonus to \glossterm{resistance} against \glossterm{energy damage}.
        ...
        {
            \parhead{Secret of Bloodforging} The resistance bonuses provided by the armor increase to a \plus16 bonus against physical damage and a \plus8 bonus against energy damage.
        ...
        {
            \parhead{Secret of Bloodforging} The resistance bonuses provided by the armor increase to a \plus40 bonus against physical damage and a \plus20 bonus against energy damage.
    ...
    \subsection{Soulkeeper's Chosen}
        ...
        \cf{War}[6]{Supreme Empowering Whispers} You gain an additional ability depending on the voices you chose with your \textit{whispers of the lost} ability.
        {
            ...
            \subcf{Whispers of the Mighty} You gain a bonus to your \glossterm{resistances} to both energy damage and physical damage equal to twice your rank in this archetype.
        }
...
\begin{dtabularx}{\textwidth}{l l >{\lcol}X >{\lcol}X >{\lcol}X >{\lcol}X >{\lcol}X}
    \tb{Rank} & \tb{Min Level} & \tb{Alchemist}               & \tb{Arcane Magic}                  & \tb{Arcane Scholar}  & \tb{Arcane Spell Mastery}   & \tb{School Specialization}  \tableheaderrule
    0 & \tdash & Alchemical infusion          & Cantrips, mage armor               & Deep knowledge       & Mystic sphere               & School specialist             \\
...
\end{dtabularx}
    ...
    \subsection{School Specialist}
        ...
        {
            \subcf{Abjuration} You gain a bonus equal to twice your rank in this archetype to your \glossterm{resistances} against both \glossterm{physical damage} and \glossterm{energy damage} (see \pcref{Resistances}).
        ...
        {
            \subcf{Abjuration} The bonus to resistances increases to three times your rank in this archetype.
        ...
        {
            \subcf{Abjuration} The bonus to resistances increases to four times your rank in this archetype.
