...
\begin{dtabularx}{\textwidth}{l l >{\lcol}X >{\lcol}X l >{\lcol}X >{\lcol}X}
    ...
    3 & 7      & Greater elemental balance & Spell rank (3)                  & Wellspring of power         & Greater shifting defense, natural force         & Plant speech            \\
    ...
    6 & 16     & Elemental versatility     & Spell rank (6)                  & Greater wellspring of power & Greater natural force, supreme shifting defense & Universal speech        \\
...
\end{dtabularx}
    ...
    \subsection{Shifter}\label{Shifter}
        ...
        \cf{Drd}[3]{Natural Force} You gain a \plus1d bonus to your damage with natural weapons.
        ...
        \cf{Drd}[6]{Greater Natural Force} The bonus from your \textit{natural force} ability increases to \plus2d.
