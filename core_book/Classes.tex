...
\section{Barbarian}\label{Barbarian}
    ...
    \subsection{Battlerager}\label{Rage}
        ...
        Your \textit{rage} ability no longer imposes a penalty to \glossterm{accuracy} with \glossterm{physical attacks}.

        \cf{Bbn}[4]{Tireless Rage} You are no longer \glossterm{fatigued} after raging, and you can use the ability again before taking a \glossterm{short rest}.
...
\section{Mage}\label{Mage}
    ...
    \subsection{Arcane Lore}
        ...
        \begin{freeability}{Mage Armor}
            ...
            This does not stack with the benefits of using a physical shield.
