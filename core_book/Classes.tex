...
\section{Barbarian}\label{Barbarian}
    \begin{dtable}
        ...
        \begin{dtabularx}{\columnwidth}{c >{\lcol}X >{\lcol}X >{\lcol}X}
            ...
            \\ 4 & Soulscarred               & tireless rage              & Primal maneuver
            \\ 5 & Greater fury of the storm & Greater intimidating anger & Greater primal power
            \\ 6 & Agile defense             & Greater rage               & Primal maneuver
            \\ 7 & Greater battle-scarred    & Endless rage               & Primal prowess
            \\ 8 & Battleforged supremacy    & Titanic rage               & Primal maneuver, supreme primal power
        \end{dtabularx}
    \end{dtable}
    ...
    \subsection{Primal Warrior}
        ...
        \cf*{Bbn}[6]{Primal Maneuver}
        You learn an additional primal \glossterm{maneuver} (see \pcref{Primal Maneuvers}).

        \cf{Bbn}[7]{Primal Prowess}
        You gain a \plus2 bonus to Strength-based and Dexterity-based checks.

        \cf{Bbn}[8]{Supreme Primal Power}
        The bonus from your \textit{primal power} ability increases to \plus4.

        \cf*{Bbn}[8]{Primal Maneuver}
        You learn an additional primal \glossterm{maneuver} (see \pcref{Primal Maneuvers}).
...
\section{Fighter}\label{Fighter}
    \begin{dtable}
        ...
        \begin{dtabularx}{\columnwidth}{c >{\lcol}X >{\lcol}X >{\lcol}X}
            ...
            \\ 4 & Greater disciplined threat  & Weapon master           & Martial maneuver
            \\ 5 & Greater discipline          & Supreme armor expertise & Greater martial power
            \\ 6 & Greater disciplined defense & Greater weapon focus    & Martial maneuver
            \\ 7 & Legendary discipline        & Armored juggernaut      & 
            \\ 8 &                             &                         & Martial maneuver, supreme martial power
        \end{dtabularx}
    \end{dtable}
    ...
    \subsection{Martial Mastery}
        ...
        \cf*{Ftr}[6]{Martial Maneuver} 
        You learn an additional \textit{martial maneuver}.

        \cf{Ftr}[8]{Supreme Martial Power} The bonus from your \textit{martial power} ability increases to \plus4.
...
\section{Monk}\label{Monk}
    \begin{dtable}
        ...
        \begin{dtabularx}{\columnwidth}{c >{\lcol}X >{\lcol}X >{\lcol}X}
            ...
            \\ 7 & Ki manifestation     & Transcend mortality   & Supreme unarmed warrior
...
\section{Ranger}\label{Ranger}
    \begin{dtable}
        ...
        \begin{dtabularx}{\columnwidth}{c >{\lcol}X >{\lcol}X >{\lcol}X}
            ...
            \\ 2 & Tracker        & Learned perception & Wild maneuvrers
            \\ 3 & Hunting styles & Blindsense         & Wilderness lore
            \\ 4 & Hunting lore   & Perceive weakness  & Wild maneuver
            \\ 5 & Hunting style  & Blindsight         & Greater wild power
            \\ 6 & Fluid style    & Farsight           & Wild maneuver
            \\ 7 & Hunting style  & Truesight          & Wilderness mastery
            \\ 8 & Dual quarry    &                    & Supreme wild power, wild maneuver
        \end{dtabularx}
    \end{dtable}
    ...
    \subsection{Wilderness Warrior}
        ...
        \cf{Rgr}[5]{Greater Wild Power} The bonus from your \textit{wild power} ability increases to \plus2.

        \cf*{Rgr}[6]{Wild Maneuver} 
        You learn an additional \textit{wild maneuver}.
        ...
        \cf{Rgr}[8]{Supreme Wild Power} The bonus from your \textit{wild power} ability increases to \plus4.

        \cf*{Rgr}[8]{Wild Maneuver} 
        You learn an additional \textit{wild maneuver}.
...
\section{Rogue}\label{Rogue}
    \begin{dtable}
        ...
        \begin{dtabularx}{\columnwidth}{c >{\lcol}X >{\lcol}X >{\lcol}X}
            ...
            \\ 4 & Greater sneak attack & Greater skill exemplar & Tricky maneuver
            \\ 5 & Assassinate, evasion & Skillful defense       & Greater trick power
            \\ 6 & Hide in plain sight  & Supreme skill exemplar & Trick maneuver
            \\ 7 & Supreme sneak attack & Legendary fortune      & 
            \\ 8 & Greater darkstalker  &                        & Supreme trick power, trick maneuver
        \end{dtabularx}
    \end{dtable}
    ...
    \subsection{Scoundrel}
        ...
        \cf{Rog}[5]{Greater Trick Power} The bonus from your \textit{trick power} ability increases to \plus2.

        \cf*{Rog}[6]{Trick Maneuver}
        You learn an additional \textit{trick maneuver}.

        % \cf{Rog}[7]{Skill Trick} % TODO

        \cf{Rog}[8]{Supreme Trick Power}
        The bonus from your \textit{trick power} ability increases to \plus4.

        \cf*{Rog}[8]{Trick Maneuver}
        You learn an additional \textit{trick maneuver}.
