...
\section{Barbarian}\label{Barbarian}
    ...
    \subsection{Primal Warrior}
        ...
        \cf{Bbn}[2]{Primal Prowess} You gain two additional \glossterm{skill points}.
        ...
        \cf{Bbn}[5]{Greater Primal Prowess} The bonus from your \textit{primal prowess} ability increases to \plus3.
