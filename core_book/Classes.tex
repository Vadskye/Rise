...
\section{Druid}\label{Druid}
    \begin{dtable!*}
        ...
        \begin{dtabularx}{\textwidth}{c >{\lcol}X >{\lcol}X >{\lcol}X >{\lcol}X}
            \tb{Rank} & \tb{Elementalist}         & \tb{Nature Spellcasting} & \tb{Nature Spell Mastery}   & \tb{Shifter} \tableheaderrule
            1         & Elemental balance         & Spellcasting             & Natural spells              & Wild aspects               \\
            2         & Elemental sphere          & Natural focus            & Mystic knowledge            & Shifting defense           \\
            3         & Elemental influence       & Spell rank (3)           & Wellspring of power         & Shift body                 \\
            4         & Greater elemental balance & Spell rank (4)           & Mystic knowledge            & Wild aspect                \\
            5         & Elemental sphere          & Spell rank (5)           & Greater natural spells      & Greater shifting defense   \\
            6         & Elemental control         & Spell rank (6)           & Mystic knowledge            & Greater shift body         \\
            7         & Supreme elemental balance & Spell rank (7)           & Greater wellspring of power & Triple aspect, wild aspect \\
    ...
    \subsection{Elementalist}\label{Wildspeaker}
    ...
    \subsection{Nature Spellcasting}
        ...
        \cf{Drd}[2]{Natural Focus} Your nature spells do not have the \glossterm{Focus} ability tag, allowing you to cast them without lowering your guard in combat.
...
\section{Ranger}\label{Ranger}
    \begin{dtable!*}
        ...
        \begin{dtabularx}{\textwidth}{c >{\lcol}X >{\lcol}X >{\lcol}X > {\lcol}X}
            ...
            1 & Animal speech       & Quarry          & Keen vision         & Wild maneuvers          \\
            2 & Animal companion    & Hunting style   & Learned perception  & Woodland stride         \\
            3 & Beast lore          & Hunter's power  & Blindsense          & Wild reaction           \\
            4 & Greater wild speech & Tracker         & Greater keen vision & Wild maneuver           \\
            5 & Beast companion     & Hunting style   & Perceive weakness   & Greater woodland stride \\
            6 & Beast tamer         & Hunter's power  & Blindsight          & Greater wild reaction   \\
            7 & Supreme wild speech & Greater tracker & Supreme keen vision & Wild maneuver           \\
            8 & True companion      & Dual quarry     &                     &                         \\
        \end{dtabularx}
    \end{dtable!*}
    ...
    \subsection{Beastmaster}
        ...
        \cf{Rgr}[2]{Wild Speech}[Magical] You can use the \textit{wild speech} ability as a standard action.
        ...
        \cf{Rgr}[3]{Beast Tamer} You gain a \plus4 bonus to the Creature Handling skill (see \pcref{Creature Handling}).

        \cf{Rgr}[4]{Beast Companion} When you use your \textit{animal companion} ability,
        you can target a \glossterm{magical beast} \glossterm{ally} with an Intelligence of \minus6 or lower instead of an animal.

        \cf{Rgr}[5]{Greater Wild Speech} When you use your \textit{wild speech} ability, you do not have to target an animal.
        Instead, you understand the speech of animals of any species.

        \cf{Rgr}[6]{Greater Beast Tamer} The bonus from your \textit{beast tamer} ability increaeses to \plus8.

        \cf{Rgr}[7]{True Companion} The maximum \glossterm{challenge rating} of creatures you can affect with your \textit{animal companion} increases to 2.
    ...
    \subsection{Huntmaster}
        ...
        \cf{Rgr}[4]{Tracker} You gain a \plus4 bonus to the Survival skill for the purpose of following tracks.
