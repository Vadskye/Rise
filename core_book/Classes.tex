...
\section{Barbarian}\label{Barbarian}
    \begin{dtable!*}
        ...
        \begin{dtabularx}{\textwidth}{c >{\lcol}X >{\lcol}X >{\lcol}X >{\lcol}X}
            ...
            2 & Toughened body                 & Seething anger         & Fast movement            & Primal lore          \\
            3 & Battle-scarred                 & Painless rage          & Savage precision         & Primal power         \\
            4 & Greater battleforged endurance & Enduring anger         & Savage instincts         & Primal maneuver      \\
            5 & Greater toughened body         & Powerful rage          & Greater fast movement    & Greater primal lore  \\
            6 & Greater battle-scarred         & Greater painless rage  & Greater savage precision & Greater primal power \\
            7 & Supreme battleforged endurance & Greater seething anger & Greater savage instincts & Primal maneuver      \\
            8 &                                & Titanic rage           &                          &                      \\
        \end{dtabularx}
    \end{dtable!*}
    ...
    \subsection{Basic Class Abilities}
        ...
        You are proficient with simple weapons, any three other \glossterm{weapon groups}, light armor, medium armor, and shields.
...
\section{Cleric}\label{Cleric}
    ...
    \subsection{Basic Class Abilities}
        ...
        You are proficient with simple weapons, any one other \glossterm{weapon group}, light and medium armor, and shields.
    ...
    \subsection{Cleric Domain Abilities}\label{Cleric Domain Abilities}
        ...
        \subsubsection{Fire}
            ...
            \parhead{Aspect} Whenever you deal fire damage to a creature with a \glossterm{critical hit}, that creature takes fire \glossterm{standard damage} \minus3d at the end of the next round.
...
\section{Druid}\label{Druid}
    ...
    \subsection{Basic Class Abilities}
        ...
        Druids are proficient with simple weapons, any one other \glossterm{weapon group}, scimitars, sickles, and slings.
...
\section{Fighter}\label{Fighter}
    ...
    \subsection{Basic Class Abilities}
        ...
        You are proficient with simple weapons, any three other \glossterm{weapon groups}, all body armor (light, medium, and heavy \glossterm{usage classes}), and shields.
...
\section{Monk}\label{Monk}
    \begin{dtable!*}
        ...
        \begin{dtabularx}{\textwidth}{c >{\lcol}X >{\lcol}X >{\lcol}X >{\lcol}X}
            \tb{Rank} & \tb{Esoteric Warrior}               & \tb{Ki}                                & \tb{Perfected Form}        & \tb{Transcendent Sage} \tableheaderrule
            1         & Esoteric maneuvers, unarmed warrior & Ki barrier, ki manifestations          & Fast movement              & Clear the mind        \\
            2         & Esoteric lore                       & Ki strike                              & Graceful athletics         & Transcend frailty     \\
            3         & Esoteric precision                  & Ki power                               & Perfect body               & Inner peace           \\
            4         & Esoteric maneuver                   & Ki manifestation                       & Greater fast movement      & Feel the flow of life \\
            5         & Greater esoteric lore               & Greater ki barrier                     & Greater graceful athletics & Transcend flesh       \\
            6         & Greater esoteric precisoin          & Greater ki power                       & Greater perfect body       & Greater inner peace   \\
            7         & Esoteric maneuver                   & Ki manifestation                       & Supreme fast movement      & See the flow of life  \\
    ...
    \subsection{Basic Class Abilities}
        ...
        Monks are proficient with simple weapons, monk weapons, and any one other \glossterm{weapon group}.
...
\section{Paladin}\label{Paladin}
    ...
    \subsection{Basic Class Abilities}
        ...
        Paladins are proficient with simple weapons, any three other \glossterm{weapon groups}, all body armor (light, medium, and heavy \glossterm{usage classes}), and shields.
...
\section{Ranger}\label{Ranger}
    \begin{dtable!*}
        ...
        \begin{dtabularx}{\textwidth}{c >{\lcol}X >{\lcol}X >{\lcol}X > {\lcol}X}
            ...
            2 & Handling lore            & Hunting style              & Learned perception  & Wild lore         \\
            3 & Pack tactics             & Hunter's instincts         & Blindsense          & Wild force           \\
            4 & Greater animal companion & Tracker                    & Greater keen vision & Wild maneuver           \\
            5 & Greater handling lore    & Hunting style              & Perceive weakness   & Greater wild lore \\
            6 & Greater pack tactics     & Greater hunter's instincts & Blindsight          & Greater wild force   \\
    ...
    \subsection{Basic Class Abilities}
        ...
        A ranger is proficient with simple weapons, any three other \glossterm{weapon groups}, light and medium armor, and shields.
...
\section{Rogue}\label{Rogue}
    \begin{dtable!*}
        ...
        \begin{dtabularx}{\textwidth}{c >{\lcol}X >{\lcol}X >{\lcol}X >{\lcol}X}
            \tb{Rank} & \tb{Assassin}               & \tb{Bard}              & \tb{Combat Trickster} & \tb{Jack of All Trades} & \tb{Suave Scoundrel} \tableheaderrule
            1         & Sneak attack                & Bardic performances    & Tricky manuevers      & Skill lore              & Confound         \\
            2         & Evasion                     & Bardic lore            & Trick lore            & Skill exemplar          & Glibness         \\
            3         & Darkstalker                 & Bardic combat training & Trick power           & Dabbler                 & Distract         \\
            4         & Hide in plain sight         & Bardic performance     & Trick manuever        & Skill lore              & Suave lore       \\
            5         & Greater evasion             & Dual performance       & Greater trick lore    & Greater skill exemplar  & Greater glibness \\
            6         & Assassination               & Loremaster             & Greater trick power   & Greater dabbler         & Compel belief    \\
            7         & Greater hide in plain sight & Bardic performance     & Trick maneuver        & Master of masteries     & Slippery mind    \\
    ...
    \subsection{Basic Class Abilities}
        ...
        Rogues are proficient with simple weapons, any two other \glossterm{weapon groups}, light armor, and bucklers.
    ...
    \subsection{Bard}
        ...
        Your performance must simply match the tag of the ability.
        For example, you can use the \textit{palliative poem} ability with a gentle song using Perform (wind instruments) or a distracting joke using Perform (comedy) instead of a poem.
        {
            ...
            \begin{freeability}{Courageous Cadenza}[\glossterm{Auditory}, \glossterm{Emotion}, \glossterm{Sustain} (minor)]
                \target{One \glossterm{ally} within \rngmed range}
            ...
            \begin{freeability}{Frightening Fugue}[\glossterm{Auditory}, \glossterm{Emotion}, \glossterm{Sustain} (minor)]
                ...
                \rankline
                \rank{3} On a \glossterm{critical hit}, the target is \glossterm{frightened}.
                \rank{5} The target is frightened instead of shaken.
                \rank{7} On a critical hit, the target is \glossterm{panicked}.
            \end{freeability}

            \begin{freeability}{Heroic Hymn}[\glossterm{Auditory}, \glossterm{Emotion}, \glossterm{Sustain} (minor)]
                \target{One \glossterm{ally} within \rngmed range}
            ...
            \begin{freeability}{Suggestive Serenade}[\glossterm{Auditory}, \glossterm{Emotion}, \glossterm{Sustain} (minor)]
                \target{One creature within \rngmed range}
...
\section{Wizard}\label{Wizard}
    ...
    \subsection{Basic Class Abilities}
        ...
        You are proficient with simple weapons and one other \glossterm{weapon group}.
        You are proficient with shields, but not with any type of armor.
        Encumbrance from armor interferes with the gestures you make to cast spells, which can cause your spells with \glossterm{somatic components} to fail (see \pcref{Somatic Component Failure}).
