...
\begin{dtabularx}{\textwidth}{l l >{\lcol}X >{\lcol}X >{\lcol}X >{\lcol}X}
    ...
    3 & 7      & Alchemical precision         & Spell rank (3), greater mage armor & Contingency          & Wellspring of power         \\
    ...
    6 & 16     & Greater alchemical precision & Spell rank (6), supreme mage armor & Scholastic insight   & Greater wellspring of power \\
