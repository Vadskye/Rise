...
\section{Cleric}\label{Cleric}
    ...
    \subsection{Cleric Domain Abilities}\label{Cleric Domain Abilities}
        ...
        \subsubsection{Air}
            \parhead{Gift} You add the \sphere{aeromancy} \glossterm{mystic sphere} to your list of divine mystic spheres (see \pcref{Mystic Spheres}).
            In addition, you add the Jump skill to your \glossterm{class skill} list and gain a \plus4 \glossterm{magic bonus} to the Jump skill (see \pcref{Jump}).
        ...
        \subsubsection{Death}
            \parhead{Gift} You radiate an aura of death within a \areasmall radius emanation.
            Once per round, if a creature in the aura dies, you heal hit points equal to your \glossterm{power}.
            \parhead{Aspect} The radius of the aura increases to \arealarge.
            ...
            \end{attuneability}
            \parhead{Mastery} If a living enemy in your aura from this domain takes \glossterm{vital damage}, it immediately dies.
        ...
        \subsubsection{Earth}
            \parhead{Gift} You add the \sphere{terramancy} \glossterm{mystic sphere} to your list of divine mystic spheres (see \pcref{Mystic Spheres}).
            In addition, you gain a \plus2 bonus to Fortitude defense.
        ...
        \subsubsection{Fire}
            \parhead{Gift} You add the \sphere{pyromancy} \glossterm{mystic sphere} to your list of divine mystic spheres (see \pcref{Mystic Spheres}).
            In addition, you gain a \glossterm{magic bonus} to equal to your \glossterm{power} to \glossterm{damage reduction} against fire damage.
            \parhead{Aspect} The damage reduction from this domain's gift increases to be equal to twice your \glossterm{power}.
            In addition, whenever you resist fire damage in this way, you gain a \plus2 bonus to \glossterm{power} with \glossterm{Fire} abilities until the end of the next round.
        ...
        \subsubsection{Strength}
            \parhead{Gift} You add the Climb, Jump, and Swim skills to your cleric \glossterm{class skill} list.
            In addition, you gain two skill points.
            \parhead{Aspect} You reduce the \glossterm{encumbrance} of body armor you wear by 1.
            \parhead{Essence} You gain a \plus4 bonus to Strength for the purpose of checks and determining your carrying capacity.
            \parhead{Mastery} You gain a \plus1 bonus to your starting Strength.

        \subsubsection{Travel}
            \parhead{Gift} You add the \sphere{astromancy} \glossterm{mystic sphere} to your list of divine mystic spheres (see \pcref{Mystic Spheres}).
        ...
        \subsubsection{Trickery}
            \parhead{Gift} You add the \sphere{glamer} \glossterm{mystic sphere} to your list of divine mystic spheres (see \pcref{Mystic Spheres}).
        ...
        \subsubsection{Water}
            \parhead{Gift} You add the \sphere{aquamancy} \glossterm{mystic sphere} to your list of divine mystic spheres (see \pcref{Mystic Spheres}).
            In addition, you add the Swim skill to your cleric \glossterm{class skill} list and gain a \plus4 \glossterm{magic bonus} to the Swim skill.
        ...
        \subsubsection{Wild}
            \parhead{Gift} You add the \sphere{verdamancy} \glossterm{mystic sphere} to your list of divine mystic spheres (see \pcref{Mystic Spheres}).
            ...
            \parhead{Aspect} You gain two skill points.
