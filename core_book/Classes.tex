...
\end{dtabularx}
    ...
    \subsection{Arcane Scholar}
...

        {
            ...
            If you lead a ritual from that \glossterm{mystic sphere}, it requires half the normal amount of time to perform and causes half the normal number of \glossterm{fatigue points}, to a minimum of one fatigue point.
