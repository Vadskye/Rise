...
\begin{dtabularx}{\textwidth}{l l >{\lcol}X >{\lcol}X >{\lcol}X >{\lcol}X >{\lcol}X}
    ...
    6 & 16     & Greater resilient recovery    & Supreme insensible anger & Greater savage force                       & Combat style rank (6), greater primal might & Greater totemic force   \\
    7 & 19     & Supreme unbattered resilience & Supreme rage             & Supreme fast movement, supreme savage rush & Combat style rank (7), primal maneuver      & Supreme totem animal    \\
\end{dtabularx}
    \end{dtable!*}
    ...
    \subsection{Battleforged Resilience}
        ...
        \cf{Bbn}[0]{Unbattered Resilience} At the end of each round, if you did not resist any damage that round, you regain \glossterm{damage resistance} equal to your rank in this archetype (minimum 1).
        ...
        \cf{Bbn}[6]{Greater Resilient Recovery} The damage resistance you regain with your \textit{resilient recovery} ability increases to half your maximum damage resistance.

        % dangerously strong?
        \cf{Bbn}[7]{Supreme Unbattered Resilience} The amount of damage resistance you regain with your \textit{unbattered resilience} ability increases to three times your rank in this archetype.
