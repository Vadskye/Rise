...
\section{Barbarian}\label{Barbarian}
    \begin{dtable}
        ...
        \begin{dtabularx}{\columnwidth}{>{\ccol}p{\levelcol} >{\lcol}X}
            ...
            \nth{16} & Endless rage              \\
            \nth{17} & Fury of the storm         \\
            \nth{18} & Greater titanic might     \\
            \nth{19} & Blood frenzy              \\
            \nth{20} & Deathless rage            \\
        \end{dtabularx}
    \end{dtable}
    ...
    \subsection{Class Abilities}
        ...
        \subsection{Battleforged Resilience}
            ...
            Your reduction of \glossterm{overwhelm penalties} increases to 2.

            \cf{Bbn}[14]{Rapid Recovery}
            At the end of each round, you heal hit points equal to your level.

            \cf{Bbn}[17]{Fury of the Storm}
...
\section{Cleric}\label{Cleric}
    ...
    \classbasics{Alignment} The cleric's alignment must be within one step of your deity's (that is, it may be one step away on either the lawful-chaotic axis or the good-evil axis, but not both).
