...
\section{Barbarian}\label{Barbarian}
    \begin{dtable}
        ...
        \begin{dtabularx}{\columnwidth}{>{\ccol}p{\levelcol} >{\ccol}p{\babcolgood} c >{\lcol}X}
            ...
            \hline
            \barbarianprogressionrow{1}  & \plus2 & Rage, primal rage      \\
            ...
            \barbarianprogressionrow{5}  & \plus3 & Larger than life       \\
            \barbarianprogressionrow{6}  & \plus3 & Rage feat              \\
            \barbarianprogressionrow{7}  & \plus3 & Improved uncanny dodge \\
            \barbarianprogressionrow{8}  & \plus3 & Battle-scarred         \\
            \barbarianprogressionrow{9}  & \plus3 & Primal resilience      \\
            ...
            \barbarianprogressionrow{13} & \plus4 & Larger than belief     \\
            \barbarianprogressionrow{14} & \plus4 & Mindless rage          \\
            \barbarianprogressionrow{15} & \plus5 & Fury of the storm      \\
            \barbarianprogressionrow{16} & \plus5 & Supreme rage           \\
            \barbarianprogressionrow{17} & \plus5 & Endless rage           \\
            \barbarianprogressionrow{18} & \plus5 & Deathless rage         \\
            \barbarianprogressionrow{19} & \plus5 & Titan of battle        \\
            \barbarianprogressionrow{20} & \plus6 & \tdash                 \\
        \end{dtabularx}
    \end{dtable}
    ...
    \subsection{Class Abilities}
        ...
        \begin{itemize}
            ...
            \item \glossterm{Damage reduction} against physical damage equal to his level.
        ...
        He increases the damage die of weapons he wields by one increment (see \pcref{Weapon Size}).
        ...
        In addition, he gains a \plus2 bonus to Mental defense.
        ...
        \cf{Bbn}[13th]{Larger than Belief}[Ex]
        ...
        \cf{Bbn}[15th]{Fury of the Storm}[Ex]
        ...
        \cf{Bbn}[19th]{Titan of Battle}[Ex]
        The barbarian's larger than life ability improves.
...
\section{Cleric}\label{Cleric}
    \begin{dtable}
        ...
        \begin{dtabularx}{\columnwidth}{>{\ccol}p{2em} >{\ccol}p{\babcolavg} c >{\lcol}X}
            ...
            \hline
            \clericprogressionrow{1}  & 2  & Domain gifts, rituals, spells \\
            \clericprogressionrow{2}  & 3  & Devotion, domain invocation   \\
            \clericprogressionrow{3}  & 3  & Domain invocation                        \\
            \clericprogressionrow{4}  & 4  & \tdash             \\
            \clericprogressionrow{5}  & 4  & Domain aspect                        \\
            \clericprogressionrow{6}  & 5  & \tdash                 \\
            \clericprogressionrow{7}  & 5  & Domain aspect                        \\
            \clericprogressionrow{8}  & 6  & \tdash                 \\
            \clericprogressionrow{9}  & 6  & Intercession                        \\
            \clericprogressionrow{10} & 7  & \tdash                  \\
            \clericprogressionrow{11} & 7  & Greater domain invocation                        \\
            \clericprogressionrow{12} & 8  & \tdash     \\
            \clericprogressionrow{13} & 8  & Greater domain invocation                        \\
            \clericprogressionrow{14} & 9  & \tdash     \\
            \clericprogressionrow{15} & 9  & Domain mastery                        \\
            \clericprogressionrow{16} & 10 & \tdash                \\
            \clericprogressionrow{17} & 10 & Domain mastery                        \\
            \clericprogressionrow{18} & 11 & \tdash                \\
            \clericprogressionrow{19} & 11 & Endless devotion              \\
            \clericprogressionrow{20} & 12 & Miracle                       \\
        \end{dtabularx}
    \end{dtable}
    ...
    \subsection{Cleric Domain Abilities}
        ...
        \subsubsection{Domain Gifts}\label{Domain Gifts}
            ...
            \subcf{Death}
            The cleric halves his penalties from \glossterm{critical damage}.
        ...
        \subsubsection{Domain Aspects}\label{Domain Aspects}
            ...
            Whenever the cleric damages a creature, any of his damage in excess of that creature's hit points is dealt as \glossterm{critical damage}.
        ...
        \subsubsection{Domain Masteries}\label{Domain Masteries}
            ...
            Whenever an enemy takes damage in the area, all damage in excess of its hit points is dealt as \glossterm{critical damage}.
...
\section{Druid}\label{Druid}
    \begin{dtable}
        ...
        \begin{dtabularx}{\columnwidth}{>{\ccol}p{\levelcol} >{\centering}p{\babcolavg} >{\ccol}p{3.5em} c >{\lcol}X}
            ...
            \hline
            \druidprogressionrow{1}  & \tdash & 2  & Spells, rituals, wild speech \\
            \druidprogressionrow{2}  & 1      & 3  & Wild aspect                  \\
            \druidprogressionrow{3}  & 1      & 3  & Wild aspect                  \\
            \druidprogressionrow{4}  & 1      & 4  & \tdash                       \\
            \druidprogressionrow{5}  & 2      & 4  & Wild aspect                  \\
            \druidprogressionrow{6}  & 2      & 5  & \tdash                       \\
            \druidprogressionrow{7}  & 2      & 5  & Wild aspect                  \\
            \druidprogressionrow{8}  & 2      & 6  & \tdash                       \\
            \druidprogressionrow{9}  & 3      & 6  & Wild aspect                  \\
            \druidprogressionrow{10} & 3      & 7  & \tdash                       \\
            \druidprogressionrow{11} & 3      & 7  & Wild aspect                  \\
            \druidprogressionrow{12} & 3      & 8  & \tdash                       \\
            \druidprogressionrow{13} & 4      & 8  & Wild aspect                  \\
            \druidprogressionrow{14} & 4      & 9  & \tdash                       \\
            \druidprogressionrow{15} & 4      & 9  & Wild aspect                  \\
            \druidprogressionrow{16} & 4      & 10 & \tdash                       \\
            \druidprogressionrow{17} & 5      & 10 & Wild aspect                  \\
            \druidprogressionrow{18} & 5      & 11 & \tdash                       \\
            \druidprogressionrow{19} & 5      & 11 & Wild aspect                  \\
            \druidprogressionrow{20} & 5      & 12 & Avatar of nature             \\
        \end{dtabularx}
    \end{dtable}
    ...
    \subsection{Class Abilities}
        ...
        \subcf{13th -- Elemental Retribution}
...
\section{Rogue}\label{Rogue}
    \begin{dtable}
        ...
        \begin{dtabularx}{\columnwidth}{>{\ccol}p{\levelcol} >{\ccol}p{\babcolavg} c >{\lcol}X}
            ...
            \hline
            \rogueprogressionrow{1}  & \plus1d6  & Skill exemplar, sneak attack \\
    ...
    \subsection{Class Abilities}
        ...
        With a sap (blackjack) or an unarmed strike, a rogue can make a sneak attack that deals \glossterm{nonlethal damage} instead of lethal damage.
...
\section{Sorcerer}\label{Sorcerer}
    ...
    \subsection{Class Abilities}
        ...
        \cf{Sor}[13th]{Arcane Recovery}[Mag]
...
\section{Spellwarped}\label{Spellwarped}
    \begin{dtable}
        ...
        \begin{dtabularx}{\columnwidth}{>{\ccol}p{\levelcol} >{\ccol}p{\babcolgood} >{\lcol}X}
            ...
            \spellwarpedprogressionrow{2}  & Spellwarped body                            \\
            ...
            \spellwarpedprogressionrow{17} & \tdash                                      \\
            \spellwarpedprogressionrow{18} & Invocation                                  \\
            \spellwarpedprogressionrow{19} & Spellwarped aspect                          \\
...
\section{Wizard}\label{Wizard}
    \begin{dtable}
        ...
        \begin{dtabularx}{\columnwidth}{>{\ccol}p{\levelcol} >{\ccol}p{\babcolpoor} c >{\lcol}X}
            ...
            \wizardprogressionrow{13} & 8  & Shared attunement     \\
    ...
    \subsection{Class Abilities}
        ...
        \cf{Wiz}{Rituals}
        Wizards can perform arcane rituals to create unique magical effects (see \pcref{Rituals}).
        ...
        The spell or ritual must be be cast as a 1st level spell, including any augments.
        ...
        At her 7th wizard level, the wizard gains the ability to attune to an additional spell simultaneously.
        ...
        \cf{Wiz}[13th]{Shared Attunement}[Mag]
