...
\section{Barbarian}\label{Barbarian}
    ...
    \subsection{Primal Warrior}
        ...
        As a standard action, you can spend an \glossterm{action point} to use a \textit{primal exertion} ability.
        {
            ...
            A hit against a target means it is \shaken by you as a \glossterm{condition}.
            A \glossterm{critical hit} means it is \frightened instead of \shaken.

            At 9th level, a \glossterm{critical hit} against a target means it is \frightened by you instead of \shaken.
