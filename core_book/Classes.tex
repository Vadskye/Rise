...
\end{dtabularx}
    ...
    \subsection{Outland Savage}
        ...
        \cf{Bbn}[1]{Fast Movement} You gain a \plus5 foot bonus to your speed with all of your \glossterm{movement modes}.
...
\end{dtabularx}
    ...
    \subsection{Perfected Form}
        ...
        \cf{Mnk}[1]{Fast Movement} You gain a \plus5 foot bonus to your speed with all of your \glossterm{movement modes}.
...
\end{dtabularx}
    ...
    \subsection{Scout}
        ...
        \cf{Rgr}[1]{Skirmisher} At the start of each phase, if there is no more than one creature adjacent to you, you gain a \plus5 foot bonus to your speed with all of your \glossterm{movement modes} during that phase.
        In addition, you reduce your \glossterm{longshot penalty} by 1 (see \pcref{Weapon Range Limits}).
        ...
        \cf{Rgr}[7]{Supreme Skirmisher} The speed bonus from your \textit{skirmisher} ability increases to \plus15 feet.
