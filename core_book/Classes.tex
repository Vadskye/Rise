...
\section{Cleric}\label{Cleric}
    ...
    \subsection{Cleric Domain Abilities}\label{Cleric Domain Abilities}
        ...
        \subsubsection{Strength}
            ...
            \parhead{Aspect} You reduce the \glossterm{encumbrance penalty} of body armor you wear by 2.
...
\section{Ranger}\label{Ranger}
    ...
    \subsection{Master of the Hunt}
        ...
        Whenever you use your \textit{quarry} ability, you may also use one of your \textit{hunting styles}.
        {
            ...
            The accuracy bonus from your \textit{quarry} ability is replaced with a \minus1 penalty to accuracy against the quarry.
            In exchange, your hunting party gains a \plus1d bonus to \glossterm{strike damage} against the quarry.
            ...
            \par At 10th level, your \glossterm{hunting party} gains a \plus2d bonus to damage against the quarry if it is \unaware of every member of the hunting party.
            \par At 16th level, the penalty to Awareness checks increases to \minus10.
            ...
            \par At 10th level, your hunting party gains \glossterm{damage reduction} equal to half your level against the quarry's attacks.
            ...
            Instead, if you \glossterm{threaten} the quarry, it takes a \minus2 penalty to accuracy on attacks against members of your \glossterm{hunting party} other than you.
            ...
            At the end of each \glossterm{action phase}, if your quarry is \glossterm{threatened} by at least two members of your \glossterm{hunting party}, it takes life \glossterm{standard damage} \minus3d.
            \par At 10th level, this damage is instead dealt if at least two members of your \glossterm{hunting party} are within \rngmed range of the quarry.
            ...
            Your \textit{quarry} ability does not grant a bonus to accuracy.
            Instead, the quarry takes a \minus1 penalty to accuracy with \glossterm{physical attacks} if it is threatened by at least one member of your \glossterm{hunting party}.
            \par At 10th level, the penalty increases to \minus2 if the quarry is threatened by at least two members of your hunting party.
            \par At 16th level, the penalty increases to \minus3 if the quarry is threatened by at least three members of your hunting party.
            ...
            \par At 10th level, whenever your hunting party uses both a \glossterm{strike} and a non-strike attack on the target in the same phase, the accuracy bonus is increased to \plus2 until the end of the round, including on the triggering attacks.
            \par At 16th level, the accuracy bonus is increased to \plus2 at all times.

            \subcf{Mystic Suppression}
            Your \textit{quarry} ability does not grant a bonus to accuracy.
            Instead, the quarry takes a \minus1 penalty to accuracy with \glossterm{magical attacks} if it is threatened by at least one member of your \glossterm{hunting party}.
            \par At 10th level, the penalty increases to \minus2 if the quarry is threatened by at least two members of your hunting party.
            \par At 16th level, the penalty increases to \minus3 if the quarry is threatened by at least three members of your hunting party.

            \subcf{Pack Leader}
            Your hunting party other than you gains no benefit from your \textit{quarry} ability.
            In exchange, you gain a \plus1d bonus to \glossterm{strike damage} against your quarry.
            \par At 10th level, the accuracy bonus from your \textit{quarry} ability increases to \plus2.
            ...
            \par At 10th level, the accuracy bonus from your \textit{quarry} ability is increased to \plus2 if the quarry is threatened by at least two members of your \glossterm{hunting party}.
