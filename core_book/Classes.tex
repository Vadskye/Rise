...
\begin{dtabularx}{\textwidth}{l l l >{\lcol}X >{\lcol}X >{\lcol}X >{\lcol}X}
    ...
    4 & 10     & Greater battle-scarred        & Greater rage             & Greater fast movement, greater savage rush & Maneuver rank (4), primal maneuver      \\
    ...
    \subsection{Battlerager}\label{Rage}
        ...
        \begin{attuneability}{Rage}[\glossterm{Emotion}, \glossterm{Sustain} (free), \glossterm{Swift}]
            ...
            \begin{itemize}
                ...
                \item Your current \glossterm{hit points} and maximum hit points are reduced to 0.
                    This hit point loss does not cause you to gain a \glossterm{vital wound}.
                    In exchange, you gain \glossterm{universal resistance} equal to the current hit points you lost this way.
...
\end{dtabularx}
    ...
    \subsection{Cleric Domain Abilities}\label{Cleric Domain Abilities}
        ...
        \subsubsection{Protection}
            ...
            While this ability is active, you cannot gain a defense bonus from this ability, even if another cleric with this ability is adjacent to you.
...
\begin{dtabularx}{\textwidth}{l l >{\lcol}X >{\lcol}X >{\lcol}X >{\lcol}X}
    ...
    3         & 7              & Disciplined force            & Greater armor expertise      & Maneuver rank (3), glancing strikes            & Tactical insight           \\
    4         & 10             & Disciplined reaction         & Weapon expertise             & Maneuver rank (4), martial maneuver            & Reactive tactics           \\
    ...
    6         & 16             & Greater disciplined force    & Supreme armor expertise      & Maneuver rank (6), greater defensive expertise & Tactical insight           \\
    7         & 19             & Greater disciplined reaction & Greater weapon expertise     & Maneuver rank (7), martial maneuver            & Greater reactive tactics   \\
\end{dtabularx}
    \end{dtable!*}
...
\begin{dtabularx}{\textwidth}{l l >{\lcol}X >{\lcol}X >{\lcol}X >{\lcol}X}
    ...
    2         & 4              & Maneuver rank (2), esoteric force            & Greater ki barrier       & Perfect precision         & Feel the flow of life         \\
...
\begin{dtabularx}{\textwidth}{l l >{\lcol}X >{\lcol}X >{\lcol}X >{\lcol}X >{\lcol}X}
    ...
    0 & \tdash & Devoted endurance        & Cantrips                        & Combat caster               & Divine guardian             & Zealous exertion                \\
    ...
    3 & 7      & Paragon power            & Spell rank (3)                  & Wellspring of power         & Greater divine guardian     & Glancing strikes                \\
    ...
    6 & 16     & Greater paragon power    & Spell rank (6)                  & Greater wellspring of power & Supreme divine guardian     & Greater zealous exertion        \\
...
\end{dtabularx}
    ...
    \subsection{Stalwart Guardian}
        ...
        \cf{Pal}[0]{Divine Guardian} Your \glossterm{allies} adjacent to you gain a \plus1 bonus to all defenses.
        A creature that sees an attack against an ally protected in this way can observe that you are the cause of the protection with a \glossterm{difficulty rating} 5 Awareness check.

        While this ability is active, you cannot gain a defense bonus from this ability, even if another paladin with this ability is adjacent to you.
        You can \glossterm{suppress} or \glossterm{resume} this ability as a \glossterm{free action}, which can allow you to be protected by another paladin with this ability.
        ...
        \cf{Pal}[3]{Greater Divine Guardian} The bonus from your \textit{divine guardian} ability increases to \plus2.
        ...
        \cf{Pal}[6]{Supreme Divine Guardian} The bonus from your \textit{divine guardian} ability increases to \plus3.
...
\begin{dtabularx}{\textwidth}{l l >{\lcol}X >{\lcol}X >{\lcol}X > {\lcol}X}
    ...
    2 & 4      & Pack tactics             & Hunting style            & Perceive weakness                & Maneuver rank (2), wild force          \\
    3 & 7      & Power of beasts          & Endurance hunter         & Blindsight         & Maneuver rank (3), glancing strikes    \\
    4 & 10     & Greater animal companion & Greater quarry           & Greater skirmisher                & Maneuver rank (4), wild maneuver       \\
    5 & 13     & Greater pack tactics     & Hunting style            & Greater perceive weakness        & Maneuver rank (5), greater wild force  \\
    6 & 16     & Greater power of beasts  & Greater endurance hunter & Greater blindsight & Maneuver rank (6), greater wild senses \\
    7 & 19     & Supreme animal companion & Supreme quarry           & Supreme skirmisher        & Maneuver rank (7), wild maneuver       \\
\end{dtabularx}
    \end{dtable!*}
...
\begin{dtabularx}{\textwidth}{l l >{\lcol}X >{\lcol}X >{\lcol}X >{\lcol}X}
    ...
    2 & 4      & Evasion             & Combat inspiration                     & Maneuver rank (2), glancing strikes       & Greater dabbler                 \\
    3 & 7      & Darkstalker         & Bardic performance, loremaster         & Maneuver rank (3), trick maneuver         & Versatile power         \\
    4 & 10     & Hide in plain sight & Virtuoso                               & Maneuver rank (4), greater tricky force   & Greater skill exemplar  \\
    5 & 13     & Greater evasion     & Greater combat inspiration             & Maneuver rank (5), greater tricky finesse & Supreme dabbler         \\
    6 & 16     & Assassination       & Bardic performance, greater loremaster & Maneuver rank (6), greater tricky finesse & Greater versatile power \\
