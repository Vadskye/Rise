...
\section{Cleric}\label{Cleric}
    ...
    \subsection{Divine Spell Mastery}
        ...
        {
            \parhead{Divine Guidance} Once per \glossterm{long rest}, you may use the \textit{desperate exertion} ability without gaining a \glossterm{fatigue point} to affect a divine spell you cast (see \pcref{Desperate Exertion}).
    ...
    \subsection{Healer}
        ...
        \cf{Clr}[7]{Wellspring of Health} When you use your \textit{divine healing} ability,
            ...
            you do not gain a \glossterm{fatigue point} from the ability.
...
\section{Paladin}\label{Paladin}
    ...
    \subsection{Stalwart Guardian}
        ...
        \begin{freeability}{Lay on Hands}
            ...
            \rank{5} Instead of regaining hit points, the target can choose to remove a \glossterm{vital wound} affecting it.
...
\section{Sorcerer}\label{Mage}
    ...
    \subsection{Wild Magic}
        ...
        \cf{Sor}[3]{Chaotic Exertion} Once per \glossterm{long rest}, you can use the \textit{desperate exertion} ability without gaining a \glossterm{fatigue point}.
