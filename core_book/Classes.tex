...
\section{Barbarian}\label{Barbarian}
    ...
    \subsection{Battlerager}\label{Rage}
        ...
        \end{itemize}
        This ability lasts as long as you \glossterm{attune} to it.
        When it ends, you become \fatigued and unable to use it again until you take a \glossterm{short rest}.
    ...
    \subsection{Primal Warrior}
        ...
        As a standard action, you can spend an \glossterm{action point} to use a \textit{primal exertion} ability.
        {
            ...
            \subparhead{Hit} Each target is \shaken by you as a \glossterm{condition}.
            \subparhead{Critical Hit} Each target is \frightened by you as a \glossterm{condition}.
            \par At 6th level, if you do not hit any targets with the attack, you regain the action point spent to use this ability.
            \par At 12th level, you can use this ability without spending an action point.
            \par At 18th level, a critical hit makes each target \panicked instead of frightened.
            ...
            \subparhead{Hit} Each target is knocked \prone.
            \subparhead{Critical Hit} As above, and each target is \immobilized as a \glossterm{condition}.
            \par At 6th level, the area increases to an \areamed radius burst.
            \par At 12th level, you can use this ability without spending an action point.
            \par At 18th level, a critical hit makes each target \stunned instead of immobilized.

            \subcf{Gut Punch} Make a \glossterm{strike} with a bludgeoning weapon.
            ...
            \subcf{Strip the Flesh} Make a \glossterm{strike} with a slashing weapon.
            ...
            \subcf{Sweeping Strike} Make a melee \glossterm{strike} with a slashing or bludgeoning weapon against each of up to three creatures you \glossterm{threaten}.
            ...
            \subparhead{Hit} Each target takes sonic \glossterm{standard damage} \minus1d.
            \par At 6th level, a hit also makes each target \glossterm{deafened} as a \glossterm{condition}.
            \par At 12th level, the area increases to \arealarge.
            \par At 18th level, the damage increases by \plus1d.

            \subcf{Whirlwind Spin} Make a melee \glossterm{strike} with a slashing weapon against all creatures you \glossterm{threaten}.
    ...
    \subsection{Cleric Domain Abilities}\label{Cleric Domain Abilities}
        ...
        \subsubsection{Death}
            ...
            \begin{ability}
                ...
                \end{spelltargetinginfo}
                \begin{spelleffects}
                    \spelleffect If each target takes \glossterm{vital damage}, it immediately dies.
                \end{spelleffects}
            \end{ability}
            ...
            \begin{ability}
                ...
                \begin{spelleffects}
                    \begin{spellattack}{Divine power vs. Fortitude}
                        ...
                        \spellsuccess Each target crumbles into a fine powder and is irreparably \glossterm{broken}.
                    \end{spellattack}
                \end{spelleffects}
            \end{ability}
        ...
        \subsubsection{Evil}
            ...
            \begin{ability}
                ...
                \end{spelleffects}
            \end{ability}
            \parhead{Mastery} You can use your domain gift to redirect damage to unwilling creatures.
        ...
        \subsubsection{Knowledge}
            ...
            \begin{ability}
                ...
                \begin{spelleffects}
                    ...
                    Each target also learns the results of your check.
            ...
            \begin{ability}
                ...
                \begin{spelleffects}
                    \begin{spellattack}{Divine power vs. Mental}
                        ...
                        \spellsuccess Each target is unable to break the laws that apply in the area, and any attempt to do so simply fails.
        ...
        \subsubsection{Strength}
            \parhead{Gift} You add Climb, Jump, and Swim to your cleric class skill list.
        ...
        \subsubsection{Travel}
            \parhead{Gift} You add Knowledge (geography), Survival, and Swim to your cleric class skill list.
            In addition, you gain two skill points which must be spent on any combination of those skills.
        ...
        \subsubsection{War}
            ...
            \parhead{Essence} As a \glossterm{minor action}, you can spend an \glossterm{action point} to use this ability.
            % TODO: wording
...
\section{Druid}\label{Druid}
    ...
    \subsection{Natural Influence}
        ...
        This is a \glossterm{condition}, and lasts until removed.
        At the end of each \glossterm{action phase}, you make a \textit{nature power} vs. Fortitude attack against all creatures you have poisoned in this way.
...
\section{Fighter}\label{Fighter}
    ...
    \subsection{Martial Mastery}
        ...
        As a standard action, you can spend an \glossterm{action point} to use a \textit{martial exertion} ability.
        {
            ...
            \subcf{Penetrating Strike} Make a \glossterm{strike} with a piercing weapon.
...
\section{Mage}\label{Mage}
    ...
    \subsection{Arcane Lore}
        ...
        \cf{Mge}{Mage Armor} As a standard action, you can use this ability.
...
\section{Monk}\label{Monk}
    ...
    \subsection{Ki}
        ...
        You cannot use more than one \textit{ki manifestation} per round.
        {
            ...
            \par At 6th level, this ability's effect lasts as long as you \glossterm{sustain} it as a \glossterm{minor action}.
            ...
            \par At 12th level, the effect lasts as long as you \glossterm{sustain} it as a \glossterm{swift action}.
            \par At 18th level, the effect lasts as long as you \glossterm{attune} to it.
    ...
    \subsection{Transcendent Sage}
        ...
        \cf{Mnk}{Serene Strike} As a standard action, you can spend an \glossterm{action point} to use this ability.
...
\section{Paladin}\label{Paladin}
    ...
    \subsection{Devoted Paragon}
        ...
        \cf{Pal}{Lay on Hands}[Magical] As a standard action, you can spend an \glossterm{action point} to use this ability.
    ...
    \subsection{Zealous Warrior}
        ...
        You gain a \plus1 bonus to \glossterm{accuracy} against creatures with an alignment opposed to your \textit{devoted alignment}.

        \cf{Pal}[8]{Unfaltering Zeal}
        You gain a \plus1 bonus to Fortitude and Mental defense.

        \cf{Pal}[10]{Pass Judgment}[Magical] Whenever you use your \textit{smite} ability, you can spend an additional \glossterm{action point} to use this ability.
        ...
        \cf{Pal}[12]{Greater Smite} The damage bonus from your \textit{smite} ability increases to \plus2d.
...
\section{Ranger}\label{Ranger}
    ...
    \subsection{Wilderness Warrior}
        ...
        \cf{Rgr}[3]{Wilderness Lore} You gain two extra skill points which must be spent on Strength or Intelligence-based ranger class skills.

        \cf*{Rgr}[6]{Wild Exertion}
        You learn an additional \textit{wild exertion}.

        \cf*{Rgr}[9]{Wilderness Lore} You gain two extra skill points which must be spent on Strength or Intelligence-based ranger class skills.
    ...
    \subsection{Master of the Hunt}
        ...
        Whenever you use your \textit{quarry} ability, you may also use one of your \textit{hunting styles}.
        {
            ...
            \par At 16th level, this effect instead applies if your quarry is within \rnglong range of any member of your hunting party.
            ...
            \par At 16th level, this penalty increases to \minus4.

            \subcf{Inevitable}[Magical]
            At the end of each \glossterm{action phase}, if your quarry is \glossterm{threatened} by at least two members of your \glossterm{hunting party}, you make a Perception vs. Mental attack against it.
            A hit deals life \glossterm{standard damage} \minus2d.
            \par At 10th level, this damage is instead dealt if at least two members of your \glossterm{hunting party} are within \rngmed range of your quarry.
            \par At 16th level, this effect instead applies if your quarry is within \rnglong range of any member of your hunting party.
            ...
            \par At 16th level, the penalty increases to \minus3 if your quarry is threatened by at least three members of your hunting party.
            ...
            \par At 16th level, the accuracy bonus against your quarry is increased to \plus2 if it is \glossterm{bloodied}.
            ...
            \par At 16th level, the accuracy bonus against your quarry is increased to \plus2.
            ...
            \par At 16th level, the defense bonus increases to \plus2.
            ...
            \par At 16th level, the bonus to overwhelm resistance applies to all members of your \glossterm{hunting party}.
            ...
            \par At 10th level, the accuracy bonus against your quarry increases to \plus2.
            \par At 16th level, your hunting party ignores any effects that would any miss chance on attacks against your quarry.
            ...
            \par At 16th level, the accuracy bonus against your quarry increases to \plus2 if it is threatened by at least two members of your hunting party.
        }

        \cf{Rgr}[7]{Hunting Lore} You gain two extra skill points which must be spent on Dexterity or Perception-based ranger class skills.
...
\section{Rogue}\label{Rogue}
    ...
    \subsection{Scoundrel}
        ...
        As a standard action, you can spend an \glossterm{action point} to use a \textit{combat trick} ability.
        {
            ...
            \subcf{Hamstring} Make a \glossterm{strike} with a slashing or piercing weapon.
            ...
            \subcf{Head Shot} Make a \glossterm{strike} with a bludgeoning weapon.
            In addition to the strike's normal effects, you also compare the attack result against the target's Mental defense.
            This is a \glossterm{Mind} ability.
