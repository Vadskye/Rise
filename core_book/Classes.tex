...
\section{Monk}\label{Monk}
    ...
    \subsection{Ki}
        ...
        It also provides a \plus4 bonus to \glossterm{resistance} against \glossterm{energy damage}.
        ...
        In addition, the bonus to \glossterm{resistance} against \glossterm{energy damage} from your \textit{ki barrier} ability increases to be equal to three times your rank in this archetype.
...
\section{Wizard}\label{Wizard}
    ...
    \subsection{Arcane Magic}
        ...
        The defense bonus from the body armor created by your \textit{mage armor} ability increases to \plus3.
        In addition, the bonus to \glossterm{resistance} against \glossterm{energy damage} increases to four times your rank in this archetype.
