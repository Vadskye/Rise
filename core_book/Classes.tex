...
\section{Druid}\label{Druid}
    ...
    \subsection{Nature Spellcasting}
        ...
        \cf{Drd}[5]{Cantrip Expertise}
        You gain a \plus2 bonus to \glossterm{spellpower} when casting \glossterm{cantrips}.

        \cf*{Drd}[6]{Subspell}
        You learn an additional \glossterm{subspell} for a nature spell you know.

        \cf*{Drd}[7]{Greater Cantrip Expertise}
        The bonus from your \textit{cantrip expertise} ability increases to \plus4.
