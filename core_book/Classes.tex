...
\section{Monk}\label{Monk}
    \begin{dtable!*}
        ...
        \begin{dtabularx}{\textwidth}{c >{\lcol}X >{\lcol}X >{\lcol}X >{\lcol}X}
            ...
            2 & Ki strike                              & Transcend frailty     & Esoteric lore                    & Graceful athletics         \\
            3 & Ki power                               & Inner peace           & Esoteric precision              & Perfect body               \\
            4 & Ki manifestation                       & Feel the flow of life & Esoteric maneuver                    & Greater fast movement      \\
            5 & Greater ki barrier                     & Transcend flesh       & Greater esoteric lore            & Greater graceful athletics \\
            6 & Greater ki power                       & Greater inner peace   & Greater esoteric precisoin              & Greater perfect body       \\
