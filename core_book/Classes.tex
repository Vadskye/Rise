...
\section{Barbarian}\label{Barbarian}
    ...
    \subsection{Battlerager}\label{Rage}
        ...
        \cf{Bbn}[5]{Powerful Rage} The \glossterm{power} bonus from your \textit{rage} ability increases to \plus4.
        ...
        \cf{Bbn}[7]{Greater Seething Anger}
...
\section{Warlock}\label{Warlock}
    \begin{dtable}
        ...
        \begin{dtabularx}{\columnwidth}{c >{\lcol}X >{\lcol}X >{\lcol}X}
            ...
            \\ 7 & Spell level (6), spell & Greater wellspring of power & Greater fiendish resistance
            \\ 8 & Spell level (7)        &                             &
        \end{dtabularx}
    \end{dtable}
    ...
    \subsection{Blessings of the Abyss}
        ...
        \cf{War}[3]{Fiendish Resistance} You gain a bonus equal to half your level to \glossterm{resistances} against \glossterm{energy damage}.
        ...
        \cf{War}[6]{Greater Fiendish Resistance}[Magical] The bonus from your \textit{fiendish resistance} ability increases to be equal to your level.
