...
\section{Barbarian}\label{Barbarian}
    ...
    \subsection{Primal Warrior}
        ...
        As a standard action, you can spend an \glossterm{action point} to use a \textit{primal exertion} ability.
        {
            ...
            \subcf{War Cry} You and all allies within an \arealarge radius burst from you gain \glossterm{damage reduction} equal to your Willpower against damage from \glossterm{physical attacks}.
            This lasts as long as you \glossterm{sustain} this ability as a \glossterm{swift action}.
...
\section{Cleric}\label{Cleric}
    ...
    \subsection{Cleric Domain Abilities}\label{Cleric Domain Abilities}
        ...
        \subsubsection{Life}
            ...
            \parhead{Mastery} At the end of each round, you heal hit points equal to your \textit{divine power}.
...
\section{Ranger}\label{Ranger}
    ...
    \subsection{Master of the Hunt}
        ...
        At the start of each round, you can spend an \glossterm{action point} to choose a quarry.
        ...
        \begin{ability}
            ...
            \end{spelltargetinginfo}
            \begin{spelleffects}
                \spelleffect You and any allies within range gain a \plus1 bonus to \glossterm{accuracy} with \glossterm{physical attacks} against the target.
