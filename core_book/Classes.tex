...
\end{dtabularx}
    ...
    \subsection{Battleforged Resilience}
        ...
        \cf{Bbn}[2]{Resilient Recovery} You regain both \glossterm{physical resistance} and \glossterm{energy resistance} equal to twice your rank in this archetype when you take the \textit{recover} action (see \pcref{Recover}).
