...
\end{dtabularx}
    ...
    \subsection{Wild Magic}
        ...
        \cf{Sor}[2]{Chaotic Insight} You learn a spell that does not have the \glossterm{Attune} or \glossterm{Sustain} tags from any arcane \glossterm{mystic sphere}, even if you do not have access to that mystic sphere.
        ...
        \cf{Sor}[5]{Greater Chaotic Insight} The number of spells you learn with your \textit{chaotic insight} ability increases to two.
