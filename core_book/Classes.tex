...
\section{Barbarian}\label{Barbarian}
    \begin{dtable}
        ...
        \begin{dtabularx}{\columnwidth}{c >{\lcol}X >{\lcol}X >{\lcol}X}
            ...
            \\ 2 & Battlefield lore          & Intimidating anger         & Primal exertions
            \\ 3 & Battle-scarred            & Focused rage               & Athletic prowess
            \\ 4 & Soulscarred               & tireless rage              & Primal exertion
            \\ 5 & Greater fury of the storm & Greater intimidating anger & Greater primal smash
            \\ 6 & Agile defense             & Greater rage               & Primal exertion
            \\ 7 & Greater battle-scarred    & Endless rage               & Primal prowess
            \\ 8 & Battleforged supremacy    & Titanic rage               & Primal dominance, primal exertion
        \end{dtabularx}
    \end{dtable}
    ...
    %     \cf{Bbn}[3]{Savage Maneuvers} You gain a \plus2 bonus to \glossterm{accuracy} with the \textit{dirty trick}, \textit{disarm}, \textit{grapple}, \textit{shove}, and \textit{trip} abilities (see \pcref{Special Combat Abilities}).

    %     \cf{Bbn}[4]{} 

    %     \cf{Bbn}[5]{Greater Fast Movement} The speed bonus from your \textit{fast movement} ability increases to \plus20 feet.

    %     \cf{Bbn}[6]{Greater Savage Maneuvers} The accuracy bonus from your \textit{savage maneuvers} ability increases to \plus3.
