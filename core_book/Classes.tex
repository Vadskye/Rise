...
\end{dtabularx}
    ...
    \subsection{Cleric Domain Abilities}\label{Cleric Domain Abilities}
        ...
        \subsubsection{Protection}
            ...
            \begin{freeability}{Divine Protection}[\glossterm{Swift}]
                Choose an \glossterm{ally} adjacent to you.
                It gains a \plus1 bonus to all defenses until the end of the round.
                Because this ability has the \glossterm{Swift} tag, this bonus applies against attacks made in the current phase.
