...
\section{Barbarian}\label{Barbarian}
    \begin{dtable}
        ...
        \begin{dtabularx}{\columnwidth}{c >{\lcol}X >{\lcol}X >{\lcol}X}
            ...
            \\ 2 & Battle-scarred            & Determined rage         & Athletic prowess
            \\ 3 & Battleforged fortitude    & Focused rage            & Primal exertion
            \\ 4 & Soulscarred               & Fearsome rage           & Athletic prowess
            \\ 5 & Greater fury of the storm & Deathless rage          & Primal exertion
            \\ 6 & Agile defense             & Greater fearsome rage   & Primal prowess
            \\ 7 & Greater battle-scarred    & Greater deathless rage  & Primal exertion
            \\ 8 & Battleforged supremacy    & Greater determined rage & Primal dominance
        \end{dtabularx}
    \end{dtable}
    ...
    \subsection{Battlerager}\label{Rage}
        ...
        \cf{Bbn}[5]{Deathless Rage}
        You reduce your \glossterm{vital damage penalties} by an amount equal to half your level while raging.
        ...
        The penalty reduction from your \textit{deathless rage} ability increases to be equal to your level.
