...
\section{Barbarian}\label{Barbarian}
    \begin{dtable!*}
        ...
        \begin{dtabularx}{\textwidth}{c >{\lcol}X >{\lcol}X >{\lcol}X >{\lcol}X}
            ...
            1    & Battleforged endurance         & Rage                   & Primal maneuvers       & Fast movement
            \\ 2 & Toughened body                 & Seething anger         & Primal prowess         & Exotic weaponry, savage precision
            \\ 3 & Battle-scarred                 & Painless rage          & Primal power           & Savage force
            \\ 4 & Greater battleforged endurance & Enduring anger         & Primal maneuver        & Greater fast movement
            \\ 5 & Greater toughened body         & Powerful rage          & Greater primal prowess & Greater savage precision
            \\ 6 & Greater battle-scarred         & Greater painless rage  & Greater primal power   & Greater savage force
            \\ 7 & Supreme battleforged endurance & Greater seething anger & Primal maneuver        & Supreme fast movement
            \\ 8 &                                & Titanic rage           &
        \end{dtabularx}
    \end{dtable!*}
        ...
        \begin{attuneability}{Rage}[\glossterm{Emotion}, \glossterm{Attune} (self), \glossterm{Swift}]
            ...
            \begin{itemize}
                \item You increase your maximum \glossterm{hit points} by two and regain two \glossterm{hit points}.
                    At the end of your rage, you lose two \glossterm{hit points} and your maximum \glossterm{hit points} are restored to normal.
...
\section{Cleric}\label{Cleric}
    ...
    \subsection{Divine Spell Mastery}
        ...
        \cf{Clr}[2]{Battle Priest} You reduce your \glossterm{focus penalties} by 1.
    ...
    \subsection{Cleric Domain Abilities}\label{Cleric Domain Abilities}
        ...
        \subsubsection{Death}
            ...
            The \glossterm{wound resistance} of each enemy in the area is reduced by an amount equal to half your \glossterm{power}.
        ...
        \subsubsection{Fire}
            ...
            \parhead{Gift} You gain a bonus to equal to your \glossterm{power} to \glossterm{resistances} against fire damage.
...
\section{Druid}\label{Druid}
    ...
    \subsection{Shifter}\label{Shifter}
        ...
        \cf{Drd}[3]{Shifting Defense} You gain a \plus1 bonus to Armor, Fortitude, Reflex, or Mental defense.
        ...
        \cf{Drd}[6]{Greater Shifting Defense}
...
\section{Fighter}\label{Fighter}
    \begin{dtable!*}
        ...
        \begin{dtabularx}{\textwidth}{c >{\lcol}X >{\lcol}X >{\lcol}X >{\lcol}X}
            ...
            \\ 3 & Disciplined stance           & Equipment efficiency         & Martial power         & Brave leader
            \\ 4 & Disciplined reaction         & Greater armor expertise      & Martial maneuver      & Battle tactic
            \\ 5 & Greater enduring discipline  & Weapon expertise             & Greater martial power & Expanded battle tactics
            \\ 6 & Disciplined vitality         & Greater equipment efficiency & Steady expertise      & Greater brave leader
    ...
    \subsection{Battle Leader}
        ...
        \cf{Ftr}[3]{Brave Leader} You gain a \plus2 bonus to Mental defense.

        \cf{Ftr}[4]{Battle Tactic} You learn an additional \textit{battle tactic}.

        \cf{Ftr}[5]{Expanded Battle Tactics} The area affected by your \textit{battle tactics} increases to an \areahuge emanation.

        \cf{Ftr}[6]{Greater Brave Leader} The bonus from your \textit{brave leader} ability increases to \plus4.
...
\section{Mage}\label{Mage}
    \begin{dtable!*}
        ...
        \begin{dtabularx}{\textwidth}{c >{\lcol}X >{\lcol}X >{\lcol}X >{\lcol}X}
            ...
            \\ 3 & Spell level (2) & Wellspring of power         & Scholastic insight    & Augment
            \\ 4 & Spell level (3), spell & Mystic knowledge     & Ritual expertise      & Stilled caster
            \\ 5 & Spell level (4) & Greater mage armor          & Contingency           & Greater innate magic
            \\ 6 & Spell level (5) & Mystic knowledge            & Scholastic insight    & Augment
...
\section{Monk}\label{Monk}
    ...
    \subsection{Ki}
        ...
        Whenever you use a \textit{ki manifestation}, you lose a \glossterm{hit point}.
...
\section{Paladin}\label{Paladin}
    \begin{dtable!*}
        ...
        \begin{dtabularx}{\textwidth}{c >{\lcol}X >{\lcol}X >{\lcol}X >{\lcol}X}
            ...
            1    & Aligned aura         & Spellcasting         & Smite                                   & Lay on hands
            \\ 2 & Aligned immunity      & Mystic spheres         & Zealous conviction                                & Stalwart champion
            \\ 3 & Paragon power         & Spell level (2)        & Zealous power                                   & Stalwart resilience
            \\ 4 & Greater aligned aura  & Spell level (3)        & Greater smite                                   & Greater lay on hands
            \\ 5 & Devoted mind          & Spell level (4), spell & Greater zealous conviction & Greater stalwart champion
            \\ 6 & Greater paragon power & Spell level (5)        & Greater zealous power                                   & Greater stalwart resilience
            \\ 7 & Supreme aligned aura  & Spell level (6)        & Supreme smite                        & Supreme lay on hands
    ...
    \subsection{Devoted Paragon}
        ...
        This does not affect bonus dice rolled for exploding attacks (see \pcref{Exploding Attacks}).
        \subparhead{Evil} Each target takes a \minus2 penalty to \glossterm{resistances}.
        ...
        \subparhead{Evil} The penalty increases to be equal to half your \glossterm{power}.
...
\section{Ranger}\label{Ranger}
    \begin{dtable!*}
        ...
        \begin{dtabularx}{\textwidth}{c >{\lcol}X >{\lcol}X >{\lcol}X > {\lcol}X}
            ...
            \\ 2 & Hunting style       & Learned perception  & Woodland stride         & Exotic weaponry
            \\ 3 & Tracker             & Blindsense          & Wild reaction           & Slayer's power
            \\ 4 & Wary hunter         & Greater keen vision & Wild maneuver           & Favored enemy
            \\ 5 & Hunting style       & Perceive weakness   & Greater woodland stride & Monster familiarity
            \\ 6 & Greater tracker     & Blindsight          & Greater wild reaction   & Greater slayer's power
            \\ 7 & Greater wary hunter & Supreme keen vision & Wild maneuver           & Greater favored enemy
            \\ 8 & Dual quarry         &                     &
        \end{dtabularx}
    \end{dtable!*}
...
\section{Rogue}\label{Rogue}
    \begin{dtable!*}
        ...
        \begin{dtabularx}{\textwidth}{c >{\lcol}X >{\lcol}X >{\lcol}X >{\lcol}X}
            \tb{Rank} & \tb{Assassin} & \tb{Jack of All Trades}  & \tb{Combat Trickster} & \tb{Suave Scoundrel} \tableheaderrule
               1 & Sneak attack         & Skill lore             & Tricky manuevers         & Confound
            \\ 2 & Evasion              & Skill exemplar         & Trick lore          & Glibness
            \\ 3 & Darkstalker          & Dabbler                & Trick power         & Distract
            \\ 4 & Greater sneak attack & Skill lore             & Trick manuever      & Suave lore
            \\ 5 & Assassinate, evasion & Greater skill exemplar &                     & Greater glibness
            \\ 6 & Hide in plain sight  & Greater dabbler        & Greater trick power & Compel belief
            \\ 7 & Supreme sneak attack & Master of masteries    & Trick maneuver      & Slippery mind
    ...
    \subsection{Assassin}
        ...
        \cf{Rog}[5]{Evasive Defense} You gain a \plus1 bonus to Armor defense and Reflex defense.
...
\section{Warlock}\label{Warlock}
    \begin{dtable!*}
        ...
        \begin{dtabularx}{\textwidth}{c >{\lcol}X >{\lcol}X >{\lcol}X >{\lcol}X}
            \tb{Rank} & \tb{Pact Spellcasting} & \tb{Pact Spell Mastery}  & \tb{Blessings of the Abyss} & \tb{Soulkeeper's Chosen} \tableheaderrule
            1    & Spellcasting  & Armor tolerance             & Eldritch blast & Possession
            \\ 2 & Mystic sphere          & Spell knowledge             & Fiendish resistance          & Empowering whispers
            \\ 3 & Spell level (2)        & Wellspring of power         & Abyssal jaunt                & Influence possession
            \\ 4 & Spell level (3), spell & Spell knowledge             & Abyssal substitution         & Exchange soul fragment
            \\ 5 & Spell level (4)        & Greater armor tolerance     & Greater fiendish resistance  & Powerful possession
            \\ 6 & Spell level (5)        & Spell knowledge             & Abyssal curse                & Greater empowering whispers
            \\ 7 & Spell level (6), spell & Greater wellspring of power & Greater abyssal substitution & Control possession
            \\ 8 & Spell level (7)        &                             &                              &
        \end{dtabularx}
    \end{dtable!*}
    ...
    \subsection{Pact Spell Mastery}
        ...
        \cf{War}[1]{Mystic Knowledge}[Magical] You gain your choice of one of the following abilities.
        {
            \parhead{Spell Knowledge} You learn an additional pact \glossterm{spell} (see \pcref{Pact Mystic Spheres}).
                You can choose this ability multiple times, gaining access to an additional spell each time.
            \parhead{Rituals} The maximum level of pact ritual you can learn or perform is equal to the maximum pact level of pact spell that you can cast.
    ...
    \subsection{Soulkeeper's Chosen}
        ...
        \begin{attuneability}{Possession}
            ...
            \begin{itemize}
                ...
                \item You are unable to control your actions. Instead, your soulkeeper chooses your actions for you.
                \item At the start of each phase, if either you or your soulkeeper choose to end this ability, the ability ends.
                    If the ability ends this way, you regain the \glossterm{action point} you spent to attune to this ability the next time you take a \glossterm{short rest}.
            \end{itemize}
        \end{attuneability}
        ...
        \cf{War}[3]{Influence Possession} During your \textit{possession} ability, whenever your soulkeeper chooses an action for you to perform, you can choose not to perform that action.
        If you do, you take no action in that phase and the ability ends.
