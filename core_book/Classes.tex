    ...
    \begin{dtable!*}
        ...
        \begin{dtabularx}{\textwidth}{c >{\lcol}X >{\lcol}X >{\lcol}X >{\lcol}X}
            \tb{Rank} & \tb{Divine Spellcasting} & \tb{Divine Spell Mastery}  & \tb{Domain Influence} & \tb{Healer} \\\bottomrule
               1 & Mystic spheres         & Wellspring of magic         & Domains, domain gift & Divine healing
    ...
    \begin{dtable!*}
        ...
        \begin{dtabularx}{\textwidth}{c >{\lcol}X >{\lcol}X >{\lcol}X >{\lcol}X}
            \tb{Rank} & \tb{Nature Spellcasting} & \tb{Nature Spell Mastery} & \tb{Shifter} & \tb{Beastmaster} \\\bottomrule
               1 & Mystic spheres         & Wellspring of magic         & Shifting defense  & Animal speech
...
\section{Mage}\label{Mage}
    ...
    \subsection{Arcane Lore}
...

        {
            ...
            \parhead{Spell Knowledge} You learn an additional \glossterm{spell}.
            ...
            \parhead{Innate Sphere} You can only gain this arcane insight if you are a sorcerer.
            Choose a \glossterm{mystic sphere} you have access to.
            You no longer need \glossterm{verbal components} or \glossterm{somatic components} to cast spells from that \glossterm{mystic sphere}.
            \par You can choose this insight multiple times, choosing a different \glossterm{mystic sphere} each time.

            \parhead{Memorized Sphere} You can only gain this arcane insight if you are a wizard and if you have the ability to perform arcane rituals.
            ...
            If you lead any rituals from that \glossterm{mystic sphere}, they take half the normal amount of time to perform and cost half the normal number of action points (minimum 1).
            \par You can choose this insight multiple times, choosing a different \glossterm{mystic sphere} each time.
        }
