...
\section{Cleric}\label{Cleric}
    ...
    \subsection{Divine Spellcasting}
        ...
        You gain a \plus1 bonus to \glossterm{spellpower} with \glossterm{cantrips} for divine spells.
...
\section{Druid}\label{Druid}
    ...
    \subsection{Nature Spellcasting}
        ...
        You gain a \plus1 bonus to \glossterm{spellpower} with \glossterm{cantrips} for nature spells.
...
\section{Mage}\label{Mage}
    ...
    \subsection{Arcane Spellcasting}
        ...
        \subparhead{Sorcerer} Your \glossterm{spellpower} with arcane spells is equal to your level or your Willpower, whichever is higher.
        The maximum spell level you can cast is equal to half your level (minimum 1).
        \subparhead{Wizard} Your \glossterm{spellpower} with arcane spells is equal to your character level or your Intelligence, whichever is higher.
        ...
        You gain a \plus1 bonus to \glossterm{spellpower} with \glossterm{cantrips} for arcane spells.
    ...
    \subsection{Arcane Lore}
...

        {
            ...
            You gain a \plus1 bonus to \glossterm{spellpower} with the spell.
        ...
        \cf{Mge}[8]{Archmage}
        You gain a \plus2 bonus to \glossterm{spellpower} with arcane spells.
...
\section{Warlock}\label{Warlock}
    ...
    \subsection{Pact Spellcasting}
        ...
        You learn two arcane spells from the arcane \glossterm{spell list} (see \pcref{Arcane Spells}).
        As a \glossterm{standard action}, you can cast the \glossterm{cantrip} version of any spell you know.
        Your \glossterm{spellpower} with arcane spells is equal to your level or your Willpower, whichever is higher.
        The maximum spell level you can cast is equal to half your level (minimum 1).
        For details about spellcasting, see \pcref{Spell and Ritual Mechanics}.
        ...
        You gain a \plus1 bonus to \glossterm{spellpower} with arcane spells.
    ...
    \subsection{Blessings of the Abyss}
        ...
        {
            \subcf{Mentoring Whispers} You gain a \plus1 bonus to \glossterm{spellpower} with arcane spells.
