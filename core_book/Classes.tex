...
\begin{dtabularx}{\textwidth}{l l >{\lcol}X >{\lcol}X >{\lcol}X >{\lcol}X >{\lcol}X}
    ...
    0         & \tdash         & Cantrips, mage armor               & Combat caster               & Draconic bloodline         & Arcane body                  & Chaotic exertion           \\
...
\end{dtabularx}
    ...
    \subsection{Pact Spell Mastery}
        ...
        \cf{War}[2]{Soulkeeper's Guidance} Once per \glossterm{long rest}, you may use the \textit{desperate exertion} ability without gaining any \glossterm{fatigue points} to affect a divine spell you cast (see \pcref{Desperate Exertion}).
