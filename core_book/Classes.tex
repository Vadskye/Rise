...
\end{dtabularx}
    ...
    \subsection{Healer}
        ...
        \begin{instantability}{Restoration}[\glossterm{Magical}]
            Instant
            \rankline
            Choose yourself or one living \glossterm{ally} within your \glossterm{reach}.
            The subject regains 1d6 \glossterm{hit points}.
        ...
        \begin{instantability}{Divine Healing}[\glossterm{Magical}]
            Instant
            \rankline
    ...
    \subsection{Cleric Domain Abilities}\label{Cleric Domain Abilities}
        ...
        \subsubsection{Evil}
            ...
            \begin{durationability}{Compel Evil}[\abilitytag{Compulsion}]
                Duration
                \rankline
        ...
        \subsubsection{Good}
            ...
            \begin{instantability}{Compel Good}[\abilitytag{Compulsion}]
                Instant
                \rankline
                Make an attack vs. Mental against a creature within \rngmed range.
                Creatures who have strict codes prohibiting them from taking evil actions, such as paladins devoted to Good, are immune to this ability.
        ...
        \subsubsection{Law}
            ...
            \begin{durationability}{Compel Law}[\abilitytag{Compulsion}]
        ...
        \subsubsection{Protection}
            ...
            \begin{durationability}{Divine Protection}[\abilitytag{Swift}]
                Duration
                \rankline
        ...
        \subsubsection{Trickery}
            ...
            \begin{durationability}{Compel Belief}[\abilitytag{Compulsion}, \abilitytag{Sustain} (minor)]
                Duration
                \rankline
                Make an attack vs. Mental against a creature within \rngmed range.
...
\end{dtabularx}
    ...
    \subsection{Ki}
        ...
        {
            \begin{durationability}{Abandon the Fragile Self}[\abilitytag{Swift}]
                Duration
                \rankline
            ...
            \begin{durationability}{Burst of Blinding Speed}[\abilitytag{Swift}]
                Duration
                \rankline
                You can use this ability as a \glossterm{free action}.
            ...
            \begin{durationability}{Elegant Whirl of Fluid Motion}[\abilitytag{Swift}]
                Duration
                \rankline
                You can use this ability as a \glossterm{free action}.
            ...
            \begin{durationability}{Extend the Flow of Ki}[\abilitytag{Swift}]
                Duration
                \rankline
                You can use this ability as a \glossterm{free action}.
            ...
            \begin{durationability}{Leap of the Heavens}[\abilitytag{Swift}]
                Duration
                \rankline
                You can use this ability as a \glossterm{free action}.
            ...
            \begin{durationability}{Scale the Highest Tower}[\abilitytag{Swift}]
                Duration
                \rankline
                You can use this ability as a \glossterm{free action}.
            ...
            \begin{durationability}{Sense the Mystic Truth}[\abilitytag{Swift}]
                Duration
                \rankline
                You can use this ability as a \glossterm{free action}.
            ...
            \begin{durationability}{Step Between the Mystic Worlds}[\abilitytag{Swift}]
                Duration
                \rankline
                You can use this ability as a \glossterm{free action}.
            ...
            \begin{durationability}{Surpass the Mortal Limits}[\abilitytag{Swift}]
                Duration
                \rankline
                You can use this ability as a \glossterm{free action}.
...
\end{dtabularx}
    ...
    \subsection{Huntmaster}
        ...
        {
            \begin{durationability}{Anchoring}[Magical]
                Duration
                \rankline
            ...
            \begin{durationability}{Lifeseal}[Magical]
                Duration
                \rankline
            ...
            \begin{durationability}{Mystic Guidance}[Magical]
                Duration
                \rankline
...
\end{dtabularx}
    ...
    \subsection{Assassin}
        ...
        \begin{durationability}{Assassination}[\abilitytag{Swift}]
            Duration
            \rankline
...
\end{dtabularx}
    ...
    \subsection{Blessings of the Abyss}
        ...
        \begin{instantability}{Abyssal Blast}[\glossterm{Magical}]
            Instant
            \rankline
        ...
        \begin{durationability}{Abyssal Jaunt}[\glossterm{Magical}]
            Duration
            \rankline
        ...
        \begin{durationability}{Abyssal Curse}[\abilitytag{Curse}, \glossterm{Magical}]
            Duration
            \rankline
    ...
    \subsection{Soulkeeper's Chosen}
        ...
        \begin{instantability}{Exchange Soul Fragment}[\glossterm{Magical}, \abilitytag{Swift}]
            Instant
            \rankline
        ...
        \begin{instantability}{Exchange Vitality}[\glossterm{Magical}, \abilitytag{Swift}]
            Instant
            \rankline
