...
\end{dtabularx}
    ...
    \subsection{Totemist}
        ...
        Each totem animal grants you abilities that are associated with that animal.
        {
            ...
            \subcf{Crocodile} Whenever you damage a creature with a melee \glossterm{strike}, you can \glossterm{push} it into any space adjacent to you.
        ...
        \cf{Bbn}[4]{Greater Totem Animal} The benefit from your \textit{totem animal} ability improves.
        {
            ...
            \subcf{Crocodile} Whenever you make a creature lose \glossterm{hit points} with a melee \glossterm{strike}, you can choose to either \glossterm{grapple} it or knock it \glossterm{prone}.
