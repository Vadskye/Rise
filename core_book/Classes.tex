...
\section{Barbarian}\label{Barbarian}
    \begin{dtable}
        ...
        \begin{dtabularx}{\columnwidth}{c >{\lcol}X >{\lcol}X >{\lcol}X}
            ...
            \\ 5 & Greater fury of the storm & Greater intimidating anger & Greater primal smash
            \\ 6 & Agile defense             & Greater rage               & Primal maneuver
            \\ 7 & Greater battle-scarred    & Endless rage               & Primal prowess
            \\ 8 & Battleforged supremacy    & Titanic rage               & Primal dominance, primal maneuver
        \end{dtabularx}
    \end{dtable}
    ...
    \subsection{Primal Warrior}
        ...
        You gain a \plus2 bonus to \glossterm{power} with \glossterm{mundane} abilities.
...
\section{Fighter}\label{Fighter}
    \begin{dtable}
        ...
        \begin{dtabularx}{\columnwidth}{c >{\lcol}X >{\lcol}X >{\lcol}X}
            \tb{Rank} & \tb{Combat Discipline} & \tb{Equipment Training}  & \tb{Martial Mastery} \\\bottomrule
               1 & Disciplined Threat          & Armor expertise         & Martial maneuvers
            \\ 2 & Discipline                  & Weapon focus            & Martial lore
            \\ 3 & Disciplined defense         & Greater armor expertise & Martial maneuver
            \\ 4 & Greater disciplined threat  & Weapon master           & Martial lore
            \\ 5 & Greater discipline          & Supreme armor expertise & Martial maneuver
            \\ 6 & Greater disciplined defense & Greater weapon focus    & Master of arms
            \\ 7 & Legendary discipline        & Armored juggernaut      & Martial maneuver
            \\ 8 &                             &
        \end{dtabularx}
    \end{dtable}
    ...
    \subsection{Martial Mastery}
        ...
        \cf{Ftr}[7]{Master of Arms} You gain a \plus2 bonus to \glossterm{power} with \glossterm{mundane} abilities.
    ...
    \begin{dtable}
        ...
        \begin{dtabularx}{\columnwidth}{c >{\lcol}X >{\lcol}X >{\lcol}X}
            \tb{Rank} & \tb{Huntmaster}  & \tb{Keen Senses} & \tb{Wilderness Warrior} \\\bottomrule
               1 & Quarry         & Keen vision        & Wild maneuvers
            \\ 2 & Tracker        & Learned perception & Wilderness lore
            \\ 3 & Hunting styles & Blindsense         & Wild maneuver
            ...
            \\ 7 & Hunting style  & Truesight          & Wild maneuver
            \\ 8 & Dual quarry    &                    &
        \end{dtabularx}
    \end{dtable}
    ...
    \begin{dtable}
        ...
        \begin{dtabularx}{\columnwidth}{c >{\lcol}X >{\lcol}X >{\lcol}X}
            \tb{Rank} & \tb{Assassin} & \tb{Jack of All Trades}  & \tb{Scoundrel} \\\bottomrule
               1 & Sneak attack         & Skill lore             & Trick maneuvers
            \\ 2 & Uncanny Dodge        & Skill exemplar         & Tricky lore
            \\ 3 & Darkstalker          & Skill lore             & Trick maneuver
            ...
            \\ 7 & Greater darkstalker  & Legendary fortune      & Trick maneuver
            \\ 8 &                      &                        &
        \end{dtabularx}
    \end{dtable}
