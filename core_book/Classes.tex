    ...
    \subsection{Beastmaster}
        ...
        \begin{attuneability}{Animal Companion}[\glossterm{Attune} (self), \glossterm{Emotion}, \glossterm{Magical}]
            ...
            \begin{itemize}
                ...
                \item Its \glossterm{accuracy} is normally equal to the your level \add your base Perception.
...
\section{Rogue}\label{Rogue}
    ...
    \classbasics{Archetypes} Rogues have the Assassin, Bard, Jack of All Trades, Combat Trickster, and Suave Scoundrel \glossterm{archetypes}.
...
\section{Sorcerer}\label{Mage}
    \begin{dtable!*}
        ...
        \begin{dtabularx}{\textwidth}{c >{\lcol}X >{\lcol}X >{\lcol}X >{\lcol}X}
            \tb{Rank} & \tb{Arcane Magic}     & \tb{Arcane Spell Mastery}   & \tb{Draconic Magic}         & \tb{Innate Arcanist} \tableheaderrule
            1         & Mystic spheres        & Mystic insight              & Draconic bloodline          & Nonverbal caster     \\
            2         & Innate focus          & Mage armor                  & Draconic focus              & Innate magic         \\
            3         & Spell rank (3), spell & Wellspring of power         & Draconic precision          & Augment              \\
            4         & Spell rank (4)        & Mystic insight              & Draconic hide               & Stilled caster       \\
            5         & Spell rank (5)        & Greater mage armor          & Greater draconic focus      & Greater innate magic \\
            6         & Spell rank (6), spell & Greater wellspring of power & Greater draconic precision  & Augment              \\
            7         & Spell rank (7)        & Mystic insight              & Greater draconic hide       & Spell absorption     \\
            8         & Spell rank (8)        &                             &                            \\
        \end{dtabularx}
    \end{dtable!*}
    ...
    \classbasics{Archetypes} Sorcerers have the Arcane Magic, Arcane Spell Mastery, Draconic Magic, and Innate Arcanist \glossterm{archetypes}.
...
\section{Wizard}\label{Wizard}
    \begin{dtable!*}
        ...
        \begin{dtabularx}{\textwidth}{c >{\lcol}X >{\lcol}X >{\lcol}X >{\lcol}X}
            \tb{Rank} & \tb{Alchemist}               & \tb{Arcane Magic}     & \tb{Arcane Spell Mastery}   & \tb{Arcane Scholar}   \tableheaderrule
            1         & Portable workshop            & Mystic spheres        & Mystic insight              & Scholastic lore       \\
            2         & Alchemical infusion          & Spells                & Mage armor                  & Ritualist             \\
            3         & Alchemical discovery         & Spell rank (3), spell & Wellspring of power         & Scholastic insight    \\
            4         & Alchemical expertise         & Spell rank (4)        & Mystic insight              & Ritual expertise      \\
            5         & Experienced quaffing         & Spell rank (5)        & Greater mage armor          & Contingency           \\
            6         & Alchemical discovery         & Spell rank (6), spell & Greater wellspring of power & Scholastic insight    \\
            7         & Greater alchemical expertise & Spell rank (7)        & Mystic insight              & Malleable contingency \\
            8         &                              & Spell rank (8)        &                             &                       \\
        \end{dtabularx}
    \end{dtable!*}
    ...
    \subsection{Alchemist}
        ...
        \cf{Wiz}[2]{Alchemical Infusion} Whenever you create or use an alchemical item, you may use your magical power in place of the item's normal power to determine its effects.
