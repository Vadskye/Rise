...
\section{Cleric}\label{Cleric}
    ...
    \subsection{Healer}
        ...
        \cf{Clr}[1]{Mitigate Vital Wound} You can use the \textit{mitigate vital wound} ability as a standard action.
        \begin{freeability}{Mitigate Vital Wound}[\glossterm{Magical}]
            Choose yourself or a living \glossterm{ally} within \rngmed range.
            The target can make a new \glossterm{vital roll} to determine the effect of one of its \glossterm{vital wounds}.
            The roll uses all modifiers that originally applied to that vital roll, plus a \plus2 \glossterm{vitality bonus} (see \pcref{Vital Rolls}).
            It can decide whether to keep its original roll or use the new roll.
            In either case, the \glossterm{vital roll} for that \glossterm{vital wound} cannot be modified again.
        ...
        \begin{apability}{Divine Healing}[\glossterm{Magical}]
            You or a living \glossterm{ally} within \rngmed range removes a \glossterm{vital wound}.
        ...
        \cf{Clr}[4]{Reflexive Healing} When you suffer a \glossterm{vital wound} that makes you \glossterm{unconscious}, you automatically use your \textit{mitigate vital wound} ability on yourself at the end of the round.
...
\section{Paladin}\label{Paladin}
    ...
    \subsection{Stalwart Guardian}
        ...
        \begin{freeability}{Lay on Hands}[Life]
            One \glossterm{ally} within your \glossterm{reach} gains a \plus2 \glossterm{vitality bonus} to one of its \glossterm{vital rolls} (see \pcref{Vital Rolls}).

            \rankline
            \rank{3} The bonus increases to \plus3.
            \rank{5} When you use this ability, you can spend an \glossterm{action point}.
            If you do, the target removes one of its \glossterm{vital wounds} instead of gaining a vitality bonus to a vital roll.
            \rank{7} The bonus increases to \plus5.
        \end{freeability}
...
\section{Sorcerer}\label{Mage}
    ...
    \subsection{Wild Magic}
        ...
        This bonus stacks with the normal \plus2 bonus that ability provides.
