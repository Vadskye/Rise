...
\end{dtabularx}
    ...
    \subsection{Preacher}
        ...
        \begin{instantability}{Denounce the Heathens}
            ...
            \rankline
            \rank{3} The area increases to a \largearea radius, and the effect becomes a \glossterm{condition} on a critical hit.
...
\begin{dtabularx}{\textwidth}{l l >{\lcol}X >{\lcol}X >{\lcol}X >{\lcol}X}
    ...
    4 & 10     & Disciplined reaction         & Weapon expertise             & Combat style rank (4), martial maneuver            & Sentinel's challenge          & Reactive tactics           \\
    ...
    7 & 19     & Greater disciplined reaction & Greater weapon expertise     & Combat style rank (7), martial maneuver            & Sentinel's goad               & Greater reactive tactics   \\
\end{dtabularx}
    \end{dtable!*}
...
\begin{dtabularx}{\textwidth}{l l >{\lcol}X >{\lcol}X >{\lcol}X >{\lcol}X}
    ...
    3         & 7              & Combat style rank (3), glancing strikes          & Ki power                 & Perfect body              & Transcend time, transcendent power              \\
    ...
    6         & 16             & Combat style rank (6), greater esoteric fluidity & Greater ki power         & Greater perfect body      & Transcend mortality, greater transcendent power \\
