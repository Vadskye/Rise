...
\section{Druid}\label{Druid}
    ...
    \subsection{Class Abilities}
        ...
        \subsubsection{Natural Influence}
            ...
            You gain two extra skill points which must be spent on the Creature Handling, Heal, Knowledge (geography), Knowledge (nature), or Survival skills.
            ...
            You gain a \plus2 bonus to the Creature Handling, Heal, Knowledge (geography), Knowledge (nature), and Survival skills.
