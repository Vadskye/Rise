...
\section{Cleric}\label{Cleric}
    ...
    \subsection{Healer}
        ...
        \begin{freeability}{Divine Healing}[\glossterm{Life}, \glossterm{Magical}]
            You or a living \glossterm{ally} you can touch are healed for hit points equal to \glossterm{standard damage}.
        \end{freeability}
        ...
        \begin{freeability}{Divine Cleanse}[\glossterm{Magical}]
            You or an \glossterm{ally} within \rngclose range can remove one \glossterm{condition}.
        \end{freeability}
...
\section{Paladin}\label{Paladin}
    ...
    \subsection{Stalwart Guardian}
        ...
        \begin{freeability}{Lay on Hands}[Life]
            You or an \glossterm{ally} you can touch are healed for hit points equal to \glossterm{standard damage}.
        \end{freeability}
