...
\begin{spellsection}{Avatar of Might}[8]
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Transmutation [Enhancement, Physical]}{Nature, Strength}
        \miscastexplode
    \end{spellfooter}
\end{spellsection}
...
\begin{spellsection}{Mighty Throw}[3]
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Transmutation [Enhancement, Physical]}{Divine, Nature, Strength, Wild}
...
\begin{spellsection}{Seismic Slam}[6]
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Transmutation [Enhancement, Physical]}{Strength}
