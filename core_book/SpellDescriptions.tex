...
\begin{spellsection}{Avatar of Growth}[5]
    ...
    \begin{spellsubcontent}
        ...
        \begin{spelleffects}
            ...
            This is a \glossterm{Physical} effect, and does not allow \glossterm{spell resistance}.
            \spelldur \durbrief
        \end{spelleffects}
    \end{spellsubcontent}
    \begin{spellfooter}
...
\begin{spellsection}{Earthspike}[2]
    ...
    \begin{spellfooter}
        ...
        \spellnotes This is a \glossterm{Physical} effect, and does not allow \glossterm{spell resistance}.
        \miscastrandom
    \end{spellfooter}
    \begin{spellaugments}
...
\begin{spellsection}{Flame Blade}[2]
    ...
    \begin{spellfooter}
        ...
        \spellnotes \glossterm{Spell resistance} applies when a foe is struck by the weapon, but not when the blade is created.
        \firespellnotes
        \miscastexplode
    \end{spellfooter}
    \begin{spellaugments}
...
\begin{spellsection}{Fungal Growth}[3]
    ...
    \begin{spellfooter}
        ...
        \spellnotes Unlike most \glossterm{Creation} spells, this spell allows \glossterm{spell resistance}.
        \miscastexplode
    \end{spellfooter}
    \begin{spellaugments}
    ...
    \begin{spellcontent}
        ...
        \begin{spelleffects}
            ...
            \begin{itemize}
                ...
                \item You gain \glossterm{spell resistance} equal to 10 \add your spellpower.
...
\begin{spellsection}{Invulnerability}[4]
    ...
    \begin{spellaugments}
        ...
        % \spellaugment{4}{Empowered}{The damage reduction is equal to twice your spellpower.}
        \spellaugment{5}{Spellshield}{You also gain \glossterm{spell resistance} equal to 10 \add your spellpower.}
    \end{spellaugments}
\end{spellsection}
    ...
    \begin{spellcontent}
        ...
        \begin{spelleffects}
            \begin{spellattack}{Strength or Spellpower vs. Fortitude (shove)}
                ...
                \par This is a \glossterm{Physical} effect, and does not allow \glossterm{spell resistance}.
...
\begin{spellsection}{Protection from Alignment}[1]
    ...
    \begin{spellaugments}
        \spellaugment{3}{Mass}{The spell can affect up to five targets.}
        \spellaugment{3}{Protection from Spells}{The target gains \glossterm{spell resistance} against spells with the chosen alignment, and spells cast by creatures with the chosen alignment.}
...
\begin{spellsection}{Resist Magic}[3]
    ...
    \begin{spellcontent}
        ...
        \end{spelltargetinginfo}
        \begin{spelleffects}
            \spelleffect The target gains \glossterm{spell resistance} equal to 10 \add your spellpower.
