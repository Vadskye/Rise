...
\begin{spellsection}{Avatar of Might}[8]
    ...
    \end{spellsubcontent}
    \begin{spellfooter}
        \spellinfo{Transmutation [Imbuement, Physical]}{Nature, Strength}
        \miscastexplode
    \end{spellfooter}
\end{spellsection}
...
\begin{spellsection}{Black Tentacles}[5]
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Conjuration/Transmutation [Creation, Imbuement]}{Arcane}
        \miscastyou
    \end{spellfooter}
    \begin{spellaugments}
...
\begin{spellsection}{Boon of Many Eyes}[4]
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Transmutation [Imbuement]}{Arcane, Knowledge}
        \miscastrandom
    \end{spellfooter}
\end{spellsection}
...
\begin{spellsection}{Divine Might}[5]
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Transmutation [Imbuement, Shaping, Sizing]}*{Divine, Strength}
...
\begin{spellsection}{Earthen Blade}[1]
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Transmutation [Earth, Imbuement, Shaping]}{Earth, Nature, War}
        \miscastexplode
    \end{spellfooter}
    \begin{spellaugments}
...
\begin{spellsection}{Forcecage}[8]
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Evocation [Physical, Telekinesis]}{Arcane}
...
\begin{spellsection}{Golem Heart}[7]
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Transmutation [Imbuement]}{Arcane, Earth, Nature, Strength}
        \miscastexplode
    \end{spellfooter}
\end{spellsection}
...
\begin{spellsection}{Longstrider}[1]
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Transmutation [Imbuement]}{Nature, Travel}
        \miscastexplode
    \end{spellfooter}
    \begin{spellaugments}
...
\begin{spellsection}{Phantasmal Killer}[4]
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Enchantment/Illusion [Death, Mind]}*{Arcane, Trickery}
        \miscastrandom
    \end{spellfooter}
    \begin{spellaugments}
        \spellaugment{3}{Mass}{The spell can affect up to five targets.}
...
\begin{spellsection}{Poison}[4]
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Vivimancy [Flesh, Physical]}{Destruction, Divine, Nature}
        \spellnotes \physicalspellnotes
        \miscastrandom
    \end{spellfooter}
\end{spellsection}
...
\begin{spellsection}{Shadow Wall}[6]
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Evocation/Illusion [Figment, Telekinesis, Unreal]}{Arcane, Trickery}
...
\begin{spellsection}{Wall of Force}[5]
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Evocation [Physical, Telekinesis, Wall]}{Arcane}
