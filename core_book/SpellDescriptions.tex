...
\begin{spellsection}{Antilife Shell}[7]
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Vivimancy [Barrier]}{Divine, Nature}
...
\begin{spellsection}{Death Ward}[4]
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Vivimancy [Positive, Shielding]}*{Divine, Protection}
...
\begin{spellsection}{Prohibition}[6]
    ...
    \begin{spellsubcontent}
        ...
        \end{spelltargetinginfo}
        \begin{spelleffects}
            \spelleffect \spelldamage{}[d8] of the chosen damage type. You know a creature broke the rule, but not which creature.
        \end{spelleffects}
    \end{spellsubcontent}
    \begin{spellfooter}
...
\begin{spellsection}{Repulsion}[6]
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Evocation [Barrier]}{Arcane}
...
\begin{spellsection}{Shadow Wall}[6]
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Evocation/Illusion [Barrier, Figment, Unreal]}{Arcane, Trickery}
...
\begin{spellsection}{Shadowstep}[5]
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Conjuration/Illusion [Figment, Glamer, Teleportation, Unreal]}*{Arcane, Travel, Trickery}
