...
\begin{spellsection}{Boulder Drop}[4]
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Conjuration [Creation, Physical]}{Arcane, Nature}
        \miscastexplode
    \end{spellfooter}
    \begin{spellaugments}
...
\begin{spellsection}{Martial Transformation}[5]
    ...
    \end{spellfooter}
    \begin{spellaugments}
        \spellaugment{3}{Damaging Transformation}{The target may also use your spellpower in place all other bonuses to physical damage. It still rolls damage with its weapon normally.}
    \end{spellaugments}
\end{spellsection}
...
\begin{spellsection}{Scorching Ray}[4]
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Evocation [Destructive, Fire]}{Arcane, Destruction, Nature}
        \miscastrandom
    \end{spellfooter}
    \begin{spellaugments}
        \spellaugment{3}{Mass}{The spell can affect up to five targets. Its damage becomes \spelldamage{fire}[d8].}
...
\begin{spellsection}{Wall of Antimagic}[4]
    ...
    \begin{spellcontent}
        ...
        \end{spelltargetinginfo}
        \begin{spelleffects}
            \spelleffect This spell creates a translucent wall that selectively blocks magical abilities.
            The wall blocks line of effect for spells, spell-like abilities, and supernatural abilities, except for abilities that you allow to pass through the wall.
