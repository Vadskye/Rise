    ...
    \begin{spellcontent}
        ...
        \begin{spelleffects}
            \begin{spellattack}{Spellpower vs. Mental}
                ...
                \spellcritical As above, except that the effect is permanently.
            \end{spellattack}
            \spelldur \durlong
    \end{spellcontent}
    \begin{spellfooter}
...
\begin{spellsection}{Mighty Throw}[3]
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Transmutation [Imbuement, Physical]}{Divine, Nature, Strength, Wild}
...
\begin{spellsection}{Seismic Slam}[6]
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Transmutation [Imbuement, Physical]}{Strength}
...
\begin{spellsection}{True Seeing}[6]
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Divination/Transmutation [Imbuement]}{Arcane, Divine, Knowledge}
