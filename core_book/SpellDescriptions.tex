    ...
    \begin{spellcontent}
        ...
        \begin{spelleffects}
            \begin{spellattack}{Spellpower vs. Mental}
                \spellsuccess Whenever the target takes physical damage, it takes additional physical damage equal to your spellpower.
...
\begin{spellsection}{Air Walk}[4]
    ...
    \begin{spellcontent}
        ...
        \end{spelltargetinginfo}
        \begin{spelleffects}
            \spelleffect The target can walk on air as if it were solid ground. The magic only affects the target's legs and feet.
...
\begin{spellsection}{Antimagic Field}[7]
    ...
    \begin{spellfooter}
        ...
        \spellnotes The effects of instantaneous conjurations, such as the \spell{create water} ritual, are not affected by this spell because the conjuration itself is no longer in effect, only its result.
...
\begin{spellsection}{Avatar of Translocation}[7]
    ...
    \begin{spellsubcontent}
        \begin{spelltargetinginfo}
            \spellquicktargeting{One Large or smaller willing creature}{\rngmed}
    ...
    \end{spellfooter}
    \begin{spellaugments}
        \spellaugment{1}{Giant}{The teleporation ability can affect a target one size category larger. This augment can be used multiple times.}
        \spellaugment{1}{Persistent}{The spell's duration becomes \durext.}
    \end{spellaugments}
\end{spellsection}
...
\begin{spellsection}{Barkskin}[2]
    ...
    \begin{spellcontent}
        ...
        \end{spelltargetinginfo}
        \begin{spelleffects}
            \spelleffect The target gains \glossterm{damage reduction} against physical damage equal to your spellpower.
...
\begin{spellsection}{Black Tentacles}[5]
    ...
    \begin{spellcontent}
        ...
        \begin{spelleffects}
            ...
            A square with a tentacle is \glossterm{difficult terrain}.
...
\begin{spellsection}{Bleed}[5]
    ...
    \begin{spellcontent}
        ...
        \begin{spelleffects}
            \begin{spellattack}{Spellpower vs. Fortitude}
                \spellsuccess \spelldamage{slashing}. In addition, the target takes one point of vital damage after this damage is dealt, regardless of its current hit points.
                \spellcritical As above, except the target takes vital damage equal to your spellpower.
                \spellfailure Half damage, and no additional effects.
            \end{spellattack}
        \end{spelleffects}
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Vivimancy [Flesh]}{Arcane, Death, Nature}
        \miscastrandom
    \end{spellfooter}
    \begin{spellaugments}
        \spellaugment{5}{Empowered}{The damage increases to \spelldamageemp{slashing}, and the automatic vital damage dealt is doubled.}
    \end{spellaugments}
\end{spellsection}
...
\begin{spellsection}{Bless}[1]
    ...
    \begin{spellaugments}
        \spellaugment{3}{Mass}{The spell can affect up to five targets.}
        \spellaugment{4}{Empowered}{The target gains an additional legend point. This augment can be used multiple times.}
    \end{spellaugments}
\end{spellsection}
...
\begin{spellsection}{Boon of Many Eyes}[4]
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Transmutation [Enhancement]}{Arcane, Knowledge, Nature}
        \miscastrandom
    \end{spellfooter}
\end{spellsection}
...
\begin{spellsection}{Boon of Mastery}[3]
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Divination [Knowledge]}{Arcane, Knowledge, Nature}
        \miscastrandom
    \end{spellfooter}
    \begin{spellaugments}
...
\begin{spellsection}{Confusion}[4]
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Enchantment [Compulsion, Mind]}{Arcane, Chaos, Divine, Trickery}
        \miscastrandom
    \end{spellfooter}
    \begin{spellaugments}
...
\begin{spellsection}{Cripple}[4]
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Vivimancy [Flesh]}{Arcane, Nature}
        \miscastrandom
    \end{spellfooter}
    \begin{spellaugments}
        \spellaugment{3}{Mass}{The spell can affect up to five targets. Its damage becomes \spelldamage{life}[d8].}
        \spellaugment{4}{Empowered}{The damage increases to \spelldamageemp{life}. If the Mass augment is applied, the damage instead increases to \spelldamage{life}[d10].}
    \end{spellaugments}
\end{spellsection}
...
\begin{spellsection}{Cure Wounds}[1]
    ...
    \end{spellfooter}
    \begin{spellaugments}
        \spellaugment{1}{Moderate Wounds}{For every 10 points of healing, this spell can instead cure 1 vital damage.}
        \spellaugment{2}{Serious Wounds}{For every 5 points of healing, this spell can instead cure 1 vital damage.}
        \spellaugment{3}{Critical Wounds}{For every 2 points of healing, this spell can instead cure 1 vital damage.}
...
\begin{spellsection}{Death Knell}[3]
    ...
    \begin{spellcontent}
        ...
        \begin{spelleffects}
            \begin{spellattack}{Spellpower vs. Fortitude}
                \spellsuccess \spelldamage{life}. In addition, for 2 rounds, the target automatically dies if it takes vital damage while it has no hit points remaining.
...
\begin{spellsection}{Deep Slumber}[5]
    \begin{spellheader}
        \spelldesc{You fill your foe with an overpowering urge to sleep, rendering it comatose.}
    \end{spellheader}
    \begin{spellcontent}
        \begin{spelltargetinginfo}
            \spellquicktargeting{One creature}{\rngmed}
...
\begin{spellsection}{Delay Damage}[3]
    ...
    \begin{spellcontent}
        ...
        \end{spelltargetinginfo}
        \begin{spelleffects}
            \spelleffect Whenever you take damage, half of the damage (rounded down) is not dealt to you immediately. This damage is tracked separately. At the end of the spell's duration, you take all of the delayed damage at once. When this happens, any damage in excess of your hit points is dealt as vital damage.
            \spelldur \durmed
        \end{spelleffects}
        \begin{spellfooter}
...
\begin{spellsection}{Dimension Door}[4]
    ...
    \end{spellfooter}
    \begin{spellaugments}
        \spellaugment{1}{Companion}{You can touch a Large or smaller willing creature to bring them with you. This augment can be selected multiple times, allowing you to bring an additional creature each time.}
        \spellaugment{1}{Giant Companion}{When using the Companion augment, you can bring along a target one size category larger. This augment can be used multiple times.}
...
\begin{spellsection}{Dimension Slide}[2]
    ...
    \begin{spellcontent}
        \begin{spelltargetinginfo}
            \spellquicktargeting{One Large or smaller willing creature}{\rngclose}
        \end{spelltargetinginfo}
        \begin{spelleffects}
...
\begin{spellsection}{Disintegrate}[6]
    ...
    \begin{spellfooter}
        ...
        \spellnotes This spell affects even objects constructed entirely of telekinetic force, such as the wall created by a a \spell{wall of force} spell, but not magical effects such as the field created by an \spell{antimagic field} spell.
        \miscastrandom
    \end{spellfooter}
    \begin{spellaugments}
...
\begin{spellsection}{Divine Might}[5]
    ...
    \begin{spellcontent}
        ...
        \end{spelltargetinginfo}
        \begin{spelleffects}
            \spelleffect You become larger, as the effect of the \spell{enlarge} spell.
    ...
    \begin{spellcontent}
        ...
        \begin{spelleffects}
            \begin{spellattack}{Spellpower vs. Fortitude}
                ...
                \begin{itemize}
                    \item \plus2 bonus to Fortitude defense.
                    \item \minus1 penalty to Reflex defense.
                    \item \minus4 penalty to Stealth.
                    \item Weapons increase damage die size (see \tref{Weapon Damage and Creature Size}).
...
\begin{spellsection}{Entropic Shield}[2]
    \begin{spellheader}
...
\begin{spellsection}{Fire Shield}[4]
    ...
    \end{spellfooter}
    \begin{spellaugments}
        \spellaugment{4}{Empowered}{The damage increases to \spelldamage{fire}[d8].}
    \end{spellaugments}
\end{spellsection}
...
\begin{spellsection}{Fissure}[6]
    ...
    \begin{spellaugments}
        ...
        \spellaugment{4}{Empowered}{The damage increases to \spelldamageemp{bludgeoning}. If the Mass augment is applied, the damage instead increases to \spelldamage{bludgeoning}[d10].}
    \end{spellaugments}
\end{spellsection}
...
\begin{spellsection}{Fly}[4]
    ...
    \begin{spellcontent}
        ...
        \begin{spelleffects}
            ...
            While \unencumbered, it can fly (see \pcref{Flying}).
        \end{spelleffects}
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Transmutation [Imbuement]}{Arcane}
    ...
    \end{spellfooter}
    \begin{spellaugments}
        \spellaugment{1}{Maneuverable}{The fly speed has good maneuverability (see \pcref{Maneuverability}).}
...
\begin{spellsection}{Harm}[6]
    ...
    \begin{spellcontent}
        ...
        \begin{spelleffects}
            \begin{spellattack}
                \spellsuccess The target takes \spelldamage{life}. If it takes damage in this way, it is \impaired with attacks and checks for 2 rounds. All damage dealt in excess of the target's hit points is dealt as vital damage.
                \spellcritical As above, but double damage.
                \spellfailure As above, but half damage.
            \end{spellattack}
        \end{spelleffects}
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Vivimancy [Life]}{Arcane, Divine, Evil, Nature}
        \miscastrandom
    \end{spellfooter}
    \begin{spellaugments}
...
\begin{spellsection}{Heal}[6]
    ...
    \begin{spellcontent}
        ...
        \end{spelltargetinginfo}
        \begin{spelleffects}
            \spelleffect The target is healed for \spelldamageemp{}.
            For every point of healing granted by this spell, it can instead cure 1 point of vital damage.
        \end{spelleffects}
    \end{spellcontent}
    \begin{spellfooter}
    ...
    \begin{spellaugments}
        ...
        \spellaugment{4}{Empowered}{The healing increases to 1d10 damage per spellpower. If the Mass augment is applied, the healing instead increases to \spelldamage{}.}
    \end{spellaugments}
\end{spellsection}
...
\begin{spellsection}{Ice Spike}[5]
    \begin{spellheader}
        \spelldesc{You create a shard of ice that unerringly seeks a foe, freezing it and slowing its movement.}
    \end{spellheader}
    \begin{spellcontent}
        \begin{spelltargetinginfo}
            \spellquicktargeting{One creature or object}{\rngext}
        ...
        \begin{spelleffects}
            \begin{spellattack}{Spellpower vs. Fortitude}
                \spellsuccess \spelldamage{cold and piercing}, and the target moves at half speed for 2 rounds.
                \spellcritical As above, but double damage.
                \spellfailure As above, but half damage.
            \end{spellattack}
        \end{spelleffects}
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Conjuration/Evocation [Cold, Creation, Physical]}*{Arcane, Nature, Water}
        \miscastexplode
    \end{spellfooter}
    \begin{spellaugments}
...
\begin{spellsection}{Imprisonment}[8]
    ...
    \begin{spellcontent}
        \begin{spelltargetinginfo}
            \spellquicktargeting{One Large or smaller creature}{\rngmed}
        \end{spelltargetinginfo}
        \begin{spelleffects}
            \begin{spellattack}{Spellpower vs. Mental}
                \spellsuccess \spelldamage{physical}. In addition, the target is \slowed for 5 rounds.
                \spellfailure As above, but half damage.
                \spellcritical The target becomes permanently entombed in a state of suspended animation (as the effect of the \spell{temporal stasis} spell) in a small sphere far beneath the surface of the earth. It remains there until an \spell{emancipation} spell is cast at the location where the imprisonment took place.
            \end{spellattack}
        \end{spelleffects}
    \end{spellcontent}
    \begin{spellfooter}
...
\begin{spellsection}{Inflict Wounds}[1]
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Vivimancy [Life]}{Arcane, Death, Divine, Nature}
        \miscastrandom
    \end{spellfooter}
    \begin{spellaugments}
        \spellaugment{2}{Critical Wounds}{All damage dealt in excess of the target's hit points is dealt as vital damage.}
...
\begin{spellsection}{Lifebound}[8]
    ...
    \begin{spellcontent}
        ...
        \begin{spelleffects}
            ...
            \spelleffect The protected creature cannot take vital damage. Any damage it takes while it has no hit points remaining, or vital damage it would take for other reasons, is simply ignored. It is still \disabled when it has no hit points remaining.

            If the targets become farther than 100 feet from each other, or if the unprotected target takes vital damage, the spell immediately ends.
            \spelldur \durshort
        \end{spelleffects}
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Vivimancy [Life, Shielding]}{Arcane, Life, Nature}
...
\begin{spellsection}{Living Missile}[4]
    ...
    \end{spellfooter}
    \begin{spellaugments}
        \spellaugment{2}{Precise}{The ally takes no damage.}
...
\begin{spellsection}{Longstrider}[1]
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Transmutation [Enhancement]}{Nature, Strength, Travel}
        \miscastexplode
    \end{spellfooter}
    \begin{spellaugments}
...
\begin{spellsection}{Telekinesis}[1]
    \begin{spellheader}
    \end{spellheader}
    \begin{spellcontent}
        \begin{spelltargetinginfo}
    ...
    \end{spellfooter}
    \begin{spellaugments}
        \spellaugment{1}{Knock}{As a standard action during the spell's duration, you can expend it to break open a locked or otherwise closed object within range. You make a Strength check to break it open, using your spellpower in place of your Strength.}
        \spellaugment{2}{Devices}{As a swift action, you can concentrate to allow you to make a Devices check within the range of the spell.}
    \end{spellaugments}
\end{spellsection}
...
\begin{spellsection}{Martyr's Gift}[8]
    ...
    \begin{spellcontent}
        ...
        \begin{spelleffects}
            ...
            If you take damage in excess of your hit points in this way, the excess damage is dealt directly as vital damage.
        \end{spelleffects}
    \end{spellcontent}
    \begin{spellfooter}
...
\begin{spellsection}{Maze}[9]
    ...
    \begin{spellcontent}
        \begin{spelltargetinginfo}
            \spellquicktargeting{One Large or smaller creature}{\rnglong}
        \end{spelltargetinginfo}
        \begin{spelleffects}
            \begin{spellattack}{Spellpower vs. Mental}
...
\begin{spellsection}{Phantasmal Killer}[6]
    \begin{spellheader}
        \spelldesc{You make your foe believe see you as if you were the most fearsome creature it can imagine.}
    \end{spellheader}
    \begin{spellcontent}
        \begin{spelltargetinginfo}
            \spellquicktargeting{One creature}{\rngclose}
    ...
    \begin{spellcontent}
        ...
        \begin{spelleffects}
            \begin{spellattack}{Spellpower vs. Mental}
                ...
                \spellcritical Double damage, and if the creature is an \glossterm{outsider} native to another plane, it is sent back to its home plane.
                \spellfailure Half damage, and no additional effects.
            \end{spellattack}
        \end{spelleffects}
    \end{spellcontent}
...
\begin{spellsection}{Polar Ray}[6]
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Evocation [Cold]}{Arcane, Nature, Water}
        \miscastrandom
    \end{spellfooter}
    \begin{spellaugments}
...
\begin{spellsection}{Prismatic Wall}[5]
    ...
    \end{spellsubcontent}
    \begin{spellfooter}
        \spellinfo{Universal [Light]}{Arcane, Protection}
        \miscastexplode
    \end{spellfooter}
\end{spellsection}
...
\begin{spellsection}{Regeneration}[1]
    ...
    \end{spellfooter}
    \begin{spellaugments}
        \spellaugment{3}{Critical Wounds}{At the end of every round, you can heal the target for one vital damage per two spellpower instead of the normal healing.}
...
\begin{spellsection}{Retrieve Object}[1]
    ...
    \begin{spellcontent}
        \begin{spelltargetinginfo}
            \spellquicktargeting{One Medium or smaller unattended object}{\rngmed}
        \end{spelltargetinginfo}
        \begin{spelleffects}
...
\begin{spellsection}{Sever Magic}[8]
    ...
    \begin{spellcontent}
        ...
        \begin{spelleffects}
            \begin{spellattack}{Spellpower vs. Mental}
                \spellsuccess All other magical abilities and magic items fail to function on the target for 2 rounds. The target cannot activate them or be affected by them, and any existing abilities the target has and and effects on the target are suppressed.
                \spellcritical As above, except that you can choose to allow your magical effects to affect the target normally.
...
\begin{spellsection}{Shadow Duplicate}[8]
    ...
    \begin{spellcontent}
        ...
        \end{spelltargetinginfo}
        \begin{spelleffects}
            \spelleffect You create an illusory duplicate of yourself, as the effect of the \spell{create image} spell. The duplicate looks, sounds, and smells like you, but is intangible. Normally, it mimics your actions perfectly, including speech.
...
\begin{spellsection}{Shadowstep}[5]
    ...
    \begin{spellcontent}
        ...
        \begin{spelleffects}
            ...
            First, you become invisible for 5 rounds, as the effect of the \spell{invisibility} spell.
            Second, you teleport up to 100 feet, as the effect of the \spell{dimension slide} spell.
            Third, an illusory duplicate of you appears in your original location for 5 rounds, as the effect of the \spell{create image} spell.
...
\begin{spellsection}{Share Pain}[2]
    ...
    \begin{spellcontent}
        ...
        \begin{spelleffects}
            ...
            This effect applies after damage reduction and all other similar effects, and hit point loss caused by this effect cannot be reduced in any way.
            If the protecting target takes damage in excess of its hit points in this way, the excess damage is dealt directly as vital damage.
            \spelldur \durshort \dismissable
        \end{spelleffects}
    \end{spellcontent}
    \begin{spellfooter}
...
\begin{spellsection}{Shining Beacon}[3]
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Illusion [Figment, Light, Visual]}{Arcane, Nature}
        \miscastexplode
    \end{spellfooter}
    \begin{spellaugments}
...
\begin{spellsection}{Shocking Grasp}[1]
    ...
    \begin{spellcontent}
        \begin{spelltargetinginfo}
            \spellquicktargeting{One creature or object}{5 ft.}
        \end{spelltargetinginfo}
        \begin{spelleffects}
            \begin{spellattack}{Spellpower vs. Reflex}
...
\begin{spellsection}{Shrink}[1]
    ...
    \begin{spellcontent}
        ...
        \begin{spelleffects}
            \begin{spellattack}{Spellpower vs. Fortitude}
                ...
                \begin{itemize}
                    \item \minus2 penalty to Fortitude defense.
                    \item \plus2 bonus to Reflex defense.
                    \item \plus4 bonus to Stealth.
                    \item Weapons decrease damage die size (see \tref{Weapon Damage and Creature Size}).
    ...
    \end{spellfooter}
    \begin{spellaugments}
        \spellaugment{1}{Tiny}{The spell can affect a target one size category smaller. This augment can be used multiple times.}
        \spellaugment{3}{Mass}{The spell can affect up to five targets.}
    \end{spellaugments}
\end{spellsection}
...
\begin{spellsection}{Spider Climb}[2]
    ...
    \begin{spellaugments}
        ...
        \spellaugment{3}{Mass}{The spell can affect up to five targets.}
        \spellaugment{2}{Sticky}{When climbing, the target treats all surfaces as if they had handholds, which can lower the difficulty of climbing on surfaces. In addition, it does not need to use free hands to climb with this spell.}
    \end{spellaugments}
\end{spellsection}
...
\begin{spellsection}{Storm of Vengeance}[9]
    ...
    \begin{spellcontent}
        ...
        \end{spelltargetinginfo}
        \begin{spelleffects}
            \spelleffect An enormous storm cloud occupies the top 200 feet of the area, as the effect of the \spell{fog cloud} spell. Within the area, lightning strikes and thunder rolls. Sunlight is blocked by the dark cloud. This may cause the area to have shadowy illumination, granting everything in it \concealment.
...
\begin{spellsection}{Strip the Flesh}[7]
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Vivimancy [Flesh]}{Arcane, Death, Evil, Nature}
        \spellnotes \physicalspellnotes
        \miscastrandom
    \end{spellfooter}
\end{spellsection}
...
\begin{spellsection}{Transmute Flesh and Stone}[5]
    ...
    \end{spellsubcontent}
    \begin{spellfooter}
        \spellinfo{Transmutation [Shaping]}{Arcane, Earth, Nature}
        \miscastrandom
    \end{spellfooter}
    \begin{spellaugments}
        \spellaugment{1}{Giant}{The spell can affect a target one size category larger. This augment can be used multiple times.}
...
\begin{spellsection}{True Seeing}[6]
    ...
    \begin{spellcontent}
        ...
        \end{spelltargetinginfo}
        \begin{spelleffects}
            \spelleffect The target sees through normal and magical darkness, sees the truth behind visual figments and glamers, and sees the true form of creatures and objects affected by \glossterm{Shaping} abilities.
    ...
    \begin{spellfooter}
        ...
        \spellnotes This spell does not negate mundane \glossterm{concealment}, and it does not reveal the truth behind nonmagical disguises (see \pcref{Disguise}). In addition, the spell's effects cannot be further enhanced with known magic, so its benefits do not apply when seeing through \glossterm{Scrying} effects.
        \miscastexplode
    \end{spellfooter}
    \begin{spellaugments}
        \spellaugment{2}{Widened}{The effect extends out to a 100 foot range.}
        \spellaugment{3}{Mass}{The spell can affect up to five targets.}
    \end{spellaugments}
\end{spellsection}
...
\begin{spellsection}{Web}[5]
    ...
    \begin{spellcontent}
        ...
        \end{spelltargetinginfo}
        \begin{spelleffects}
            \spelleffect The area is filled with webs, making it difficult terrain. The webs are thick and strong, but too widely spaced to significantly obscure sight. % info about how to destroy webs
            \spelldur \durshort \dismissable
        \end{spelleffects}
    \end{spellcontent}
    \begin{spellsubcontent}
