...
\begin{itemize}
    \item \minus2 penalty to starting Strength.
...
\parhead{Attributes} \plus1 starting Constitution. In addition, being Small gives gnomes a \minus2 penalty to starting Strength.
\parhead{Speed} 25 feet.
\parhead{Special Abilities}
\begin{itemize}
...
\parhead{Size} Small. This gives several benefits and penalties, as described at \pcref{Small Characters}.
\parhead{Attributes} \plus1 starting Dexterity. In addition, being Small gives halflings a \minus2 penalty to starting Strength.
\parhead{Speed} 25 feet.
\parhead{Special Abilities}
\begin{itemize}
