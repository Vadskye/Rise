...
A Small character has the following effects based on their size.
  \begin{itemize}
    ...
    \item Weight limits are three-quarters that of a Medium character (see \pcref{Encumbrance}).
  \end{itemize}
...
\parhead{Attributes} \plus1 Constitution.
\parhead{Speed} 25 feet.
\parhead{Special Abilities}
\begin{itemize}
...
\parhead{Size} Small.
\parhead{Attributes} \plus1 Dexterity.
