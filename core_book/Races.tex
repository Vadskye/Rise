...
\end{itemize}
\parhead{Racial Bonus Feat} Any from the following list: Any Casting feat (see \pcref{Casting Feats}), \featref*{Agility}, \featref*{Awareness Specialization}, \featref*{Sniper}.
...
\end{itemize}
\parhead{Racial Bonus Feat} Any Casting feat (see \pcref{Casting Feats}), or any from the following list: \featref*{Blindfighter}, \featref*{Craft Specialization}, \featref*{Stealth Specialization}, \featref*{Toughness}.
