...
\end{itemize}
\parhead{Racial Bonus Feat} Any Magic feat (see \pcref{Magic Feats}), or any from the following list: \featref*{Blindfighter}, \featref*{Close-Quarters Fighting}, \featref*{Craft Mastery}, \featref*{Toughness}.
