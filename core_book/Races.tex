...
A Small character has the following effects based on their size.
  \begin{itemize}
    \item \minus1d penalty to \glossterm{strike damage}.
...
\begin{itemize}
    \itemhead*{Skilled}: Humans get 3 bonus \glossterm{skill points} at 1st level. They can spend those skill points on any skills.
\end{itemize}
\parhead{Racial Defense Bonus}: \plus2 Fortitude, Reflex, and Mental.
...
\end{itemize}
\parhead{Racial Defense Bonus}: \plus3 Fortitude, \plus2 Mental, \plus1 Reflex.
\parhead{Racial Bonus Feat} Any from the following list: \featref*{Blindfighter}, \featref*{Craft Specialization}, \featref*{Iron Will}, \featref*{Toughness}.
...
\end{itemize}
\parhead{Racial Defense Bonus}: \plus3 Reflex, \plus2 Mental, \plus1 Fortitude.
...
\parhead{Attributes} \plus1 starting Constitution.
\parhead{Speed} 25 feet.
\parhead{Special Abilities}
\begin{itemize}
    ...
    \itemhead*{Mystic Essence}: Gnomes gain an additional \glossterm{action point}.
\end{itemize}
\parhead{Racial Defense Bonus}: \plus3 Fortitude, \plus2 Mental, \plus1 Reflex.
...
\end{itemize}
\parhead{Racial Defense Bonus}: \plus2 Fortitude, Reflex, Mental.
...
\end{itemize}
\parhead{Racial Defense Bonus}: \plus3 Fortitude, \plus2 Reflex, \plus1 Mental.
...
\parhead{Size} Small.
\parhead{Attributes} \plus1 starting Dexterity.
\parhead{Speed} 25 feet. This gives several benefits and penalties, as described at \pcref{Small Characters}.
\parhead{Special Abilities}
\begin{itemize}
    \itemhead*{Halfling Luck}: \plus1 to all defenses.
\end{itemize}
\parhead{Racial Defense Bonus}: \plus3 Reflex, \plus2 Fortitude, \plus1 Mental.
