...
\section{Uncommon Species}\label{Uncommon Species}
    ...
    \subsection{Vampire}
        ...
        \subsubsection{Vampire Archetype}
            ...
            \cf{Vmp}[1]{Gentle Fangs} Whenever you deal damage using your bite natural weapon, you can choose not to reduce the target's hit points below 0, or you can treat the damage as \glossterm{subdual damage}.
