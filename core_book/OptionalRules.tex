        ...
        \subsubsection{Semi-Randomized Point Buy}
            ...
            \begin{dtable}
                ...
                \begin{dtabularx}{\columnwidth}{X X X}
                    \tb{Roll} & \tb{Attribute Score} & \tb{Point Cost} \tableheaderrule
                    3-5   & \minus2 & 0\fn{1} \\
                    6-8   & \minus1 & 0\fn{2} \\
                    9-12  & 0       & 0             \\
                    13-14 & 1       & 1             \\
...
\section{Species}
    ...
    \subsection{Changeling}
        ...
        \parhead{Species Feat Options} Class Versatility or any Skill feat.
    ...
    \subsection{Drakkenfel}
        ...
        \begin{itemize}
            ...
            \itemhead{Energy Resistance} A drakkenfel gains a bonus to equal to its level to \glossterm{resistances} against the energy type associated with its \textit{draconic essence}.
    ...
    \subsection{Dryaidi}
        ...
        \end{itemize}
        \parhead{Species Feat Options} Class Versatility, Innate Magic, Regenerator, or Toughness.
    ...
    \subsection{Tieflings}
        ...
        \end{itemize}
        \parhead{Species Feat Options} \featref*{Class Versatility}, \featref*{Executioner}, \featref*{Skill Specialization: Bluff}, \featref*{Skill Specialization: Intimidate}, or \featref*{Spellwarped}
