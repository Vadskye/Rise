...
\section{Races}
    ...
    \subsection{Changeling}
        ...
        \end{itemize}
        \parhead{Racial Bonus Feat} Class Versatility or any Skill feat.
    ...
    \subsection{Drakkenfel}
        ...
        \end{itemize}
        \parhead{Racial Bonus Feat} Scaleless.
    ...
    \subsection{Dryaidi}
        ...
        \parhead{Special Abilities}
        \begin{itemize}
            \itemhead{Ingrain} As a standard action, a dryaidi use the \textit{ingrain} ability.
                \begin{ability}{Ingrain}
                    The dryaidi's land speed becomes 5 feet.
                    It gains a \plus4 bonus to defenses against attacks that would move it.
    ...
    \subsection{Tieflings}
        ...
        \begin{itemize}
            ...
            \itemhead{Energy Resistance} A tiefling has \glossterm{damage reduction} against cold, electricity, and fire equal to twice its level.
        \end{itemize}
