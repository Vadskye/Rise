...
\section{Uncommon Species}\label{Uncommon Species}
    ...
    \subsection{Dragon}
        ...
        \subsubsection{Basic Class Abilities}
            ...
            In addition, you gain a \plus4 bonus to your level when determining your maximum \glossterm{hit points} (see \pcref{Hit Points}).
    ...
    \subsection{Oozeborn}
        ...
        \subsubsection{Oozeborn Archetype}
            ...
            \cf{Ooz}[1]{Acidic Slam} You gain a slam \glossterm{natural weapon}, which deals 1d10 damage and requires a free hand to use, except that it also has the Long \glossterm{weapon tag} (see \pcref{Natural Weapons}).
    ...
    \subsection{Tieflings}
        ...
        \subsubsection{Tiefling Archetype}
            ...
            \begin{magicalactiveability}{Abyssal Hop}
                ...
                \hit Each target takes \damagerankonelow{fire}.
                \miss \glossterm{Glancing blow}.
