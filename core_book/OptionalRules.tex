...
\section{Uncommon Species}\label{Uncommon Species}
    ...
    \subsection{Dragon}
        ...
        \subsubsection{Dragon Archetype}
            ...
            \cf{Dgn}[3]{Draconic Flight}[\sparkle] Your wings grow larger, granting you a limited ability to fly.
    ...
    \subsection{Naiadi}
        ...
        \subsubsection{Naiadi Archetype}
            ...
            \cf{Nai}[1]{Water Bond}[\sparkle] You can form a bond with a fresh stream, lake, or other Gargantuan or larger body of fresh water (not salt water).
