...
\section{Species}
    ...
    \subsection{Dragon}
        ...
        \subsubsection{Basic Class Abilities}
            ...
            \begin{itemize}
                ...
                \item \subparhead{Dexterity} Agility, Flexibility, Stealth.
    ...
    \subsection{Tieflings}
        ...
        \begin{itemize}
            ...
            \itemhead*{Fire Tolerance} (Magical): Tieflings gain a \plus4 bonus to \glossterm{defenses} against attacks that deal fire damage.
...
\end{longtablewrapper}
    ...
    \begin{feat}{Infernal Heritage}{Bloodline}
        ...
        In addition, the defense bonus from your tiefling \textit{fire tolerance} ability increases to \plus6.
