...
\section{Uncommon Species}\label{Uncommon Species}
    ...
    \subsection{Harpy}
        ...
        \subsubsection{Basic Class Abilities}
            ...
            In addition, you gain a \plus1 bonus to your level when determining your maximum \glossterm{hit points} (see \pcref{Hit Points}).
    ...
    \subsection{Oozeborn}
        ...
        \subsubsection{Basic Class Abilities}
            ...
            \begin{itemize}
                \item Four \glossterm{attunement points}, which you can use to attune to items and abilities that affect you (see \pcref{Attunement Points}).
                \item A \glossterm{fatigue tolerance} equal to 6 \add your Constitution.
                    Your fatigue tolerance makes it easier for you to use powerful abilities that fatigue you (see \pcref{Fatigue}).
            ...
            \begin{itemize}
                \item Hellfire Conduit: You can use the \textit{infernal rebuke} ability as a standard action.
                    \begin{magicalactiveability}{Infernal Rebuke}
                        ...
                        \hit The target takes 2d6 \add \glossterm{power} fire damage.
