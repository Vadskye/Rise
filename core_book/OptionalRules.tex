...
\section{Uncommon Species}\label{Uncommon Species}
    ...
    \subsection{Tieflings}
        ...
        \subsubsection{Tiefling Archetype}
            \cf{Tif}[0]{Abyssal Tolerance} You are \glossterm{impervious} to fire damage.

            \cf{Tif}[1]{Infernal Rebuke} You can use the \textit{infernal rebuke} ability as a standard action.
            ...
            \cf{Tif}[3]{Greater Infernal Darkness} The maximum radius affected by your \textit{infernal darkness} ability increases to a \arealarge radius.
            ...
            \begin{itemize}
                \item Abysswalker: You can use your \ability{abyssal hop} ability to teleport as a move action instead of as a standard action.
            ...
            \cf{Tif}[7]{Greater Infernal Darkness} You can use your \textit{infernal darkness} ability as a \glossterm{minor action}.
