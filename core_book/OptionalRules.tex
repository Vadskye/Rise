...
\end{longtablewrapper}
    ...
    \begin{feat}{Naiad Heritage}{Bloodline}
        ...
        As long as your bonded water remains clean, pure, and large enough to be a valid subject of bonding, you increase your maximum \glossterm{hit points} by 1 and gain a \plus1 bonus to Mental defense.
        If your bonded water becomes contaminated or shrinks below the minimum size, you reduce your maximum \glossterm{hit points} by 1 and take a \minus2 penalty to Mental defense until you sever the bond.
        ...
        \ff[4]{Freshwater Fountain} The volume of water you can create with the \spell{create water} cantrip increases by five times.

        \ff[7]{Greater Enchanting Appearance} The bonuses from your \textit{enchanting appearance} species ability increase to \plus4.

        \ff[10]{Greater Water Bond} The number of hit points granted by your \textit{water bond} ability increases to 2, and the bonus to Mental defense increases to \plus2.
        ...
        \ff[19]{Supreme Water Bond} The number of hit points granted by your \textit{water bond} ability increases to 3, and the bonus to Mental defense increases to \plus3.
    \end{feat}
