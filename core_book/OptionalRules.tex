...
\section{Uncommon Species}\label{Uncommon Species}
    ...
    \subsection{Drow}
        ...
        \begin{itemize}
            ...
            \itemhead{Deep Darkness}[Magical] A drow can use the \textit{deep darkness} ability as a \glossterm{standard action}.
                ...
                \end{durationability}
            \itemhead{Drow Prejudice} Most people have negative associations with drow.
                Draw have an Opposition relationship with most people that they meet, which influences people's behavior and makes Persuasion checks harder (see \pcref{Persuasion}).
    ...
    \subsection{Oozeborn}
        ...
        \subsubsection{Oozeborn Archetype}
            ...
            \cf{Ooz}[1]{Acidic Body} You gain a slam \glossterm{natural weapon}, which deals 1d8 damage and requires a free hand to use, except that it also has the Long \glossterm{weapon tag} (see \pcref{Natural Weapons}).
