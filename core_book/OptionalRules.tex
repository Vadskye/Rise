...
\section{Uncommon Species}\label{Uncommon Species}
    ...
    \subsection{Oozeborn}
        ...
        \parhead{Size} Medium.
        \parhead{Attributes} \minus1 base Intelligence, \plus1 to the base value of any other attribute
        \parhead{Speed} 30 feet.
        \parhead{Special Abilities}
        \begin{itemize}
            \itemhead{Acid Tolerance} Oozeborn are \glossterm{impervious} to acid damage.
            \itemhead{Amorphous Form} Oozeborn gain a \plus5 bonus to the Flexibility skill (see \pcref{Flexibility}).
                ...
                \end{durationability}
            \itemhead{Compressible} An oozeborn can compress its head and shoulders down to a minimum of a one inch radius, allowing it to squeeze through very small areas.
            ...
            \itemhead{Darkvision} Oozeborn can see in the dark clearly up to 60 feet.
            ...
            \itemhead{Easily Poisoned} Oozeborn are \glossterm{vulnerable} to \glossterm{poisons}.
        \end{itemize}
        \parhead{Automatic Languages} Common.
