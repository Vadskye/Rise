...
\section{Racial Templates}
    ...
    \begin{dtable}
        ...
        \begin{dtabularx}{\columnwidth}{>{\ccol}p{\levelcol} >{\ccol}p{\babcolgood} >{\lcol}X}
            ...
            \hline
            1st & \plus1 & Claws, draconic heritage, keen senses, scales       \\
            2nd & \plus2 & Bite, breath weapon, draconic magic, draconic wings \\
            3rd & \plus3 & Energy immunity, flight, mighty breath              \\
            4th & \plus4 & Draconic apotheosis                                 \\
        \end{dtabularx}
    \end{dtable}
        ...
        \subsubsection{Class Abilities}
            ...
            \begin{enumerate}
                ...
                \item The damage dealt by his draconic natural weapons increases by one increment (see \pcref{Weapon Sizes}).
