...
\section{Uncommon Species}\label{Uncommon Species}
    ...
    \subsection{Dragon}
        ...
        \parhead{Size} Small. This gives a dragon a 20 foot \glossterm{base speed} and a \plus4 bonus to the Stealth skill, among other effects (see \pcref{Size Categories}).
        ...
        \subsubsection{Basic Class Abilities}
            ...
            \begin{itemize}
                ...
                \item A \glossterm{fatigue tolerance} equal to 3 \add your Constitution \add half your Willpower.
    ...
    \subsection{Drakkenfel}
        ...
        \parhead{Size} Small. This gives a drakkenfel a 20 foot \glossterm{base speed} and a \plus4 bonus to the Stealth skill, among other effects (see \pcref{Size Categories}).
    ...
    \subsection{Naiadi}
        ...
        \subsubsection{Naiadi Archetype}
            ...
            \cf{Nai}[0]{Greater Enchanting Appearance} The bonuses from your \textit{enchanting appearance} species ability increase to \plus4.
            ...
            \cf[Nai][6]{Greater Aqueous Form} When you cast the \spell{aqueous form} spell, it does not have the \abilitytag{Attune} (self) tag.
    ...
    \subsection{Oozeborn}
        ...
        \subsubsection{Oozeborn Archetype}
            ...
            \cf{Ooz}[0]{Amorphous Form} Your natural form is a loosely spherical blob.
                You have a \minus5 foot penalty to your \glossterm{land speed}, but you gain a \plus5 bonus to the Flexibility skill (see \pcref{Flexibility}).
            ...
            Anything you absorb in this way takes a single point of \glossterm{subdual} acid damage at the end of each round while it remains absorbed.
