...
\section{Classes}
    \subsection{Faebonder}
        ...
        The faebonder class functions like warlock class, with the following exceptions:
        \begin{itemize}
    ...
    \subsection{Favored Soul}
        ...
        \begin{itemize}
            ...
            \item A fae warlock cannot choose the \textit{blessings of the abyss} archetype. However, the \textit{domain influence} cleric archetype is considered to be part of their class, and they may choose that archetype without spending insight points to multiclass.
    ...
    \subsection{Shaman}
        ...
        The shaman class functions like cleric class, with the following exceptions:
        \begin{itemize}
            ...
            \item A shaman cannot gain access to more than two \textit{mystic spheres} from the shaman class by any means.
