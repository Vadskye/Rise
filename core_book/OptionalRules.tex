...
\section{Uncommon Species}\label{Uncommon Species}
    ...
    \subsection{Dryaidi}
        ...
        \begin{itemize}
            \itemhead{Ingrain} A dryaidi use the \textit{ingrain} ability as a standard action.
                ...
                \end{activeability}
            \itemhead{Photosynthesis} While in sunlight, a dryaidi gains a \plus5 foot bonus to its land speed.
    ...
    \subsection{Harpy}
        ...
        \subsubsection{Harpy Archetype}
            ...
            \cf{Hrp}[1]{Winged Combat} At the start of each phase, you can make a short hop off of solid ground to hover in your space using your wings.
            ...
            In addition, you ignore movement penalties from \glossterm{difficult terrain}.

            \cf{Hrp}[4]{Greater Winged Combat} You can use your \textit{winged combat} any number of times in the same round.
            You must still land between each phase.
    ...
    \subsection{Oozeborn}
        ...
        \subsubsection{Oozeborn Archetype}
            ...
            Anything you absorb in this way takes a single point of \glossterm{environmental} acid damage at the end of each round while it remains absorbed.
