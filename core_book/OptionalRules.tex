...
\section{Epic Fates}
    ...
    \subsection{Ascendant}
        ...
        \subsubsection{Ascendant Ranks}
            ...
            \parhead{Rank 1 -- Energetic Soul} All damage dealt by your attacks is energy damage in addition to its other types.
            ...
            \parhead{Rank 2 -- See Through the Weave} You can see everything within 60 feet of you perfectly, regardless of obstacles of any kind or light levels.
            This is similar to \trait{blindsight}, except that it also ignores solid obstacles.
            ...
            Instead, you gain a bonus to your \glossterm{damage resistance} equal to the number of hit points you would normally have from your level and Constitution (see \tref{Hit Points and Damage Resistance}).
    ...
    \subsection{Hero of Legend}
        ...
        \subsubsection{Hero of Legend Ranks}
            \parhead{Rank 1 -- Worthy Hero} You and all \glossterm{allies} who can see or hear you are immune to being shaken, frightened, and panicked.
    ...
    \subsection{Mutant}
        ...
        \subsubsection{Mutant Ranks}
            ...
            Each of your natural weapons has the \weapontag{Sweeping} (7) weapon tag in addition to its other weapon tags, though the tag works slightly differently than normal.
            You must choose a different natural weapon for each target that you sweep into in this way.
            If you have two copies of the same type of natural weapon, you treat each copy as a separate weapon for this purpose.
            ...
            Unlike normal, this stacks with other effects that increase your size category.
            ...
            Wings also grow from your back, granting you a \glossterm{fly speed} equal to your base speed with a 60 foot \glossterm{height limit}.
            Above that height limit, you have a \glossterm{glide speed} equal to your base speed instead.
    ...
    \subsection{Paradox}
        ...
        \subsubsection{Paradox Ranks}
            \parhead{Rank 1 -- Temporal Aberration} Whenever you would make a \glossterm{movement}, you can make two different movements and then decide which one was the movement you actually made.
            ...
            In addition, your actions, and events involving you, cannot be observed in any effect that sees or predicts the future.
...
\section{Uncommon Species}\label{Uncommon Species}
    ...
    \subsection{Eladrin}
        ...
        \begin{raggeditemize}
            ...
            \begin{activeability}{Fae Step}[\abilitytag{Magical}]
                \rankline
    ...
    \subsection{Oozeborn}
        ...
        \subsubsection{Oozeborn Archetype}
            ...
            You can use any of your arms as a slam natural weapon, and you treat your slam natural weapon as a light weapon instead of a medium weapon.
            This reduces your penalties if you use the \ability{offhand strike} ability (see \pcref{Offhand Strike}).
