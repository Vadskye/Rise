...
\section{Epic Fates}
    ...
    \subsection{Ascendant}
        ...
        \subsubsection{Ascendant Ranks}
            ...
            Instead, you gain a bonus to your \glossterm{damage resistance} equal to the number of hit points you would normally have from your level and Constitution (see \tref{Classes}).
