...
\section{Uncommon Species}\label{Uncommon Species}
    ...
    \subsection{Incarnation}
        ...
        \begin{itemize}
            ...
            \itemhead{Glowing} If appropriate to an incarnation's associated element or energy, it may naturally shed light as a torch.
        ...
        \cf{Inc}[7]{Essence Flare+} This ability can also make you \glossterm{briefly} \trait{incorporeal}.
