...
\section{Uncommon Species}\label{Uncommon Species}
    ...
    \subsection{Automaton}
        ...
        \begin{itemize}
            \itemhead{Artificial Life} Automatons are not alive. They ignore abilities which only affect living creatures, including poisons and most healing abilities.
            \itemhead{Manual Repair} The Medicine skill has no effect on an automaton. Instead, a Craft skill relevant to the automaton's body can be used to achieve the same effects that a Medicine skill would have on a living creature.
    ...
    \subsection{Dragon}
        ...
        \subsubsection{Dragon Archetype}
            ...
            \cf{Dgn}[6]{Draconic Flight+} The maximum height from your \textit{draconic flight} ability increases to 60 feet.
    ...
    \subsection{Naiadi}
        ...
        \subsubsection{Naiadi Archetype}
            ...
            \cf{Nai}[4]{Greater Water Bond} The bonuses from your \textit{water bond} ability increase to \plus2 Mental defense, \plus1 power, and three times your rank in this archetype to your hit points.
            ...
            \cf{Nai}[7]{Supreme Water Bond} The bonuses from your \textit{water bond} ability increase to \plus3 Mental defense, \plus2 power, and three times your rank in this archetype to your hit points.
    ...
    \subsection{Tieflings}
        ...
        \subsubsection{Tiefling Archetype}
            ...
            \begin{magicalactiveability}{Abyssal Hop}
                ...
                \rank{2} The damage bonus from your power increases to \plus1d per 2 power.
