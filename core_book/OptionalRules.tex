...
\section{Epic Fate}
    ...
    \subsection{Hero of Legend}
        ...
        \subsubsection{Hero of Legend Ranks}
            ...
            \parhead{Rank 3 -- Sheltering Aura} Your \textit{heroic intervention} ability from this epic fate affects any number of \glossterm{allies} within a \areasmall radius \glossterm{emanation} from you.
            ...
            \parhead{Rank 4 -- Inspiring Hero} The area of your \textit{heroic intervention} ability increases to a \areahuge radius \glossterm{emanation}.
        ...
        \begin{itemize}
            ...
            \itemhead*{Infernal Darkness} (Magical): A tiefling can use the \textit{infernal darkness} ability as a \glossterm{standard action}.
                \begin{attuneability}{Infernal Darkness}[\glossterm{Sustain} (minor)]
                    ...
                    You can choose this ability's radius, up to a maximum of a \areasmall radius.
...
\end{longtablewrapper}
    ...
    \begin{feat}{Infernal Heritage}{Bloodline}
        ...
        \begin{freeability}{Infernal Rebuke}
            ...
            \rank{3} The damage increases by an additional \plus1d.
        ...
        \ff[7]{Greater Infernal Darkness} The maximum radius affected by your \textit{infernal darkness} ability increases to a \areamed radius.
