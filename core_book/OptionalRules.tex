...
\section{Uncommon Species}\label{Uncommon Species}
    ...
    \subsection{Dragon}
        ...
        \subsubsection{Basic Class Abilities}
            ...
            % 4 insight, 6 skill, 8 AP, 6 fatigue, 2 armor, -1 weapons = 25 points
    ...
    \subsection{Drakkenfel}
        ...
        \begin{itemize}
            ...
            \itemhead{Damage Tolerance} A drakkenfel gains \plus4 bonus to \glossterm{defenses} against attacks that deal damage of the type associated with its \textit{draconic essence}.
    ...
    \subsection{Naiadi}
        ...
        \begin{itemize}
            ...
            \itemhead{Water Affinity} A naiaidi has a \glossterm{swim speed} equal to the \glossterm{base speed} for their size.
    ...
    \subsection{Tieflings}
        ...
        \begin{itemize}
            ...
            \itemhead*{Fire Tolerance} (Magical): Tieflings are \glossterm{invulnerable} to fire damage.
        ...
        \parhead{Automatic Languages} Common, Infernal, any one \glossterm{common language}.
...
\end{longtablewrapper}
    ...
    \begin{feat}{Infernal Heritage}{Bloodline}
        ...
        \ff[3]{Greater Infernal Presence} The bonuses from your \textit{infernal presence} ability increase to \plus4.
        ...
        \ff[12]{Supreme Infernal Presence} The bonuses from your \textit{infernal presence} ability increase to \plus6.

        \ff[15]{Supreme Infernal of Darkness} You can use your \textit{infernal darkness} ability as a \glossterm{minor action}.
        ...
        \ff[21]{Cloak of Darkness} When you use your \textit{infernal darkness} ability, you can change the area to be an \glossterm{emanation} from you instead of a \glossterm{zone} within range.
        In addition, you can sustain that ability as a \glossterm{free action} instead of as a minor action.
    \end{feat}
    ...
    \begin{feat}{Naiad Heritage}{Bloodline}
        ...
        \ff[7]{Aqueous Form}[Magical] You can cast the \spell{aqueous form} spell.
        When you do, you do not require verbal or somatic \glossterm{casting components}, and your spellcasting rank is considered to be equal to your rank in their highest rank archetype.

        \ff[7]{Freshwater Fountain}[Magical] The volume of water you can create with the \spell{create water} cantrip increases by five times.

        \ff[10]{Greater Water Bond}[Magical] The bonus to Mental defense from your \textit{water bond} ability increases to \plus2.

        \ff[13]{Supreme Enchanting Appearance} The bonuses from your \textit{enchanting appearance} species ability increase to \plus6.

        \ff[16]{Fluidseeker}[Magical] You gain a \plus1 bonus to \glossterm{accuracy} against creatures significantly composed of water or watery fluids.
        This is true of almost all living creatures.

        \ff[19]{Supreme Water Bond}[Magical] The number of hit points granted by your \textit{water bond} ability increases to twice your level, and the bonus to Mental defense increases to \plus3.
    \end{feat}
