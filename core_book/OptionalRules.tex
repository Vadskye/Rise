...
\section{Uncommon Species}\label{Uncommon Species}
    ...
    \subsection{Dryaidi}
        ...
        \begin{itemize}
            ...
            \itemhead{Unhurried and Unfaltering} Dryaidi have a \minus10 penalty to speed with all \glossterm{movement modes}.
                However, a dryaidi's land speed cannot be reduced below 20 feet.
                In addition, dryaidi ignore \glossterm{difficult terrain} from inanimate natural sources, such as \glossterm{heavy undergrowth}.
        \end{itemize}
