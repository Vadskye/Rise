...
\section{Species}
    ...
    \subsection{Tieflings}
        ...
        \begin{itemize}
            ...
            \itemhead*{Energy Resistance} (Magical): Tieflings gain a bonus equal to their level to \glossterm{resistances} against fire damage.
        ...
        \end{itemize}
        \parhead{Species Bonus Feats} \featref*{Class Versatility}, \featref*{Executioner}, \featref*{Skill Specialization: Bluff}, \featref*{Skill Specialization: Intimidate}, \featref*{Spellwarped}
...
%     In exchange for special bonuses, a character with a species template must take a minimum number of levels in the template class.
    ...
    %         \tb{Level} & \tb{Special} \tableheaderrule
