...
\section{Uncommon Species}\label{Uncommon Species}
    ...
    \subsection{Dragon}
        ...
        \subsubsection{Dragon Archetype}
            ...
            In addition, you gain \glossterm{low-light vision}, allowing you to see farther in light (see \pcref{Low-Light Vision}).
    ...
    \subsection{Eladrin}
        ...
        \begin{raggeditemize}
            ...
            \itemhead{Low-light Vision} Eladrin treat sources of light as if they had double their normal illumination range.
