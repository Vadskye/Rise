...
\section{Uncommon Species}\label{Uncommon Species}
    ...
    \subsection{Animal Hybrid}
        ...
        \subsubsection{Sample Animal Hybrids}
            ...
            \begin{itemize}
                ...
                \itemhead{Low-light Vision} A hybrid wolf has \stdability{low-light vision}, allowing it to see clearly in \glossterm{shadowy illumination} (see \pcref{Low-light Vision}).
            \end{itemize}
    ...
    \subsection{Awakened Animal}
        ...
        \subsubsection{Sample Awakened Animals}
            ...
            \begin{itemize}
                ...
                \itemhead{Low-light Vision} A cat has \stdability{low-light vision}, allowing it to see clearly in \glossterm{shadowy illumination} (see \pcref{Low-light Vision}).
    ...
    \subsection{Dragon}
        ...
        \subsubsection{Dragon Archetype}
            \cf{Dgn}[0]{Draconic Senses} You have \glossterm{darkvision} with a 60 foot range, allowing you to see in complete darkness (see \pcref{Darkvision}).
    ...
    \subsection{Drakkenfel}
        ...
        \parhead{Size} Small.
        \parhead{Attributes} \minus1 base Strength, either \plus1 base Dexterity or \plus1 base Constitution.
        \parhead{Speed} 25 feet.
        \parhead{Special Abilities}
        \begin{itemize}
            \itemhead{Bite} A drakkenfel's mouth can be used to bite (see \pcref{Natural Weapons}). A drakkenfel's bite attack deals 1d8 damage.
            ...
            \itemhead{Damage Tolerance} A drakkenfel is \glossterm{impervious} to damage of the type associated with its \textit{draconic essence}.
            \itemhead{Low-light Vision} Drakkenfel have \stdability{low-light vision}, allowing them to see clearly in \glossterm{shadowy illumination} (see \pcref{Low-light Vision}).
    ...
    \subsection{Drow}
        ...
        \parhead{Size} Medium.
        \parhead{Attributes} \minus1 base Constitution, \plus1 base Dexterity
        \parhead{Speed} 30 feet.
        \parhead{Special Abilities}
        \begin{itemize}
            \itemhead{Darkvision} Drow have \stdability{darkvision} with a 120 foot range, allowing them to see in complete darkness (see \pcref{Darkvision}).
            ...
            \itemhead{Poison Tolerance} Drow are \glossterm{impervious} to poison.
    ...
    \subsection{Eladrin}
        ...
        \parhead{Size} Medium.
        \parhead{Attributes} \minus1 base Constitution, either \plus1 base Dexterity or \plus1 base Willpower
        \parhead{Speed} 30 feet.
        \parhead{Special Abilities}
        \begin{raggeditemize}
            ...
            \itemhead{Low-light Vision} Eladrin have \stdability{low-light vision}, allowing them to see clearly in \glossterm{shadowy illumination} (see \pcref{Low-light Vision}).
    ...
    \subsection{Kit}
        ...
        \begin{itemize}
            ...
            \itemhead{Low-light Vision} Kit have \stdability{low-light vision}, allowing them to see clearly in \glossterm{shadowy illumination} (see \pcref{Low-light Vision}).
        \end{itemize}
    ...
    \subsection{Naiadi}
        ...
        \begin{itemize}
            ...
            \itemhead{Low-light Vision} Naiadi have \stdability{low-light vision}, allowing them to see clearly in \glossterm{shadowy illumination} (see \pcref{Low-light Vision}).
    ...
    \subsection{Orc}
        ...
        \parhead{Special Abilities}
        \begin{itemize}
            \itemhead{Darkvision} Orcs have \stdability{darkvision} with a 60 foot range, allowing them to see in complete darkness (see \pcref{Darkvision}).
    ...
    \subsection{Oozeborn}
        ...
        \parhead{Size} Medium.
        \parhead{Attributes} \minus1 base Intelligence, \plus1 base Constitution.
        \parhead{Speed} 25 feet.
        \parhead{Special Abilities}
        \begin{itemize}
        ...
        \subsubsection{Oozeborn Archetype}
            \cf{Ooz}[0]{Acid Tolerance} You are \glossterm{impervious} to acid damage.
            ...
            \cf{Ooz}[0]{Darkvision} You have \stdability{darkvision} with a 60 foot range, allowing you to see in complete darkness (see \pcref{Darkvision}).

            \cf{Ooz}[1]{Acidic Body} You gain a slam \glossterm{natural weapon}, which deals 1d10 damage and requires a free hand to use (see \pcref{Natural Weapons}).
            ...
            \cf{Ooz}[1]{Poison Dissolution} You are \glossterm{impervious} to poisons.

            \cf{Ooz}[2]{Darkborn Senses} You gain \stdability{blindsense} with a 60 foot range, allowing you to sense your surroundings without light (see \pcref{Blindsense}).
            ...
            \cf{Ooz}[4]{Acidic Apotheosis} You are \glossterm{immune} to acid damage and poisons.

            \cf{Ooz}[5]{Greater Darkborn Senses} The range of your \stdability{blindsense} increases by 60 feet.
            In addition, the range of your \stdability{blindsight} increases by 15 feet.
    ...
    \subsection{Tieflings}
        ...
        \parhead{Special Abilities}
        \begin{itemize}
            \itemhead{Darkvision} Tieflings have \stdability{darkvision} with a 60 foot range, allowing them to see in complete darkness (see \pcref{Darkvision}).
            ...
            \itemhead{Hellfire Tolerance} Tieflings are \glossterm{impervious} to fire damage.
        ...
        \subsubsection{Tiefling Archetype}
            ...
            \begin{freeability}{Abyssal Hop}[Instant]
                ...
                \hit Each subject takes 1d6 \add half power fire damage.
                \rankline
            ...
            \begin{itemize}
                \item Hellfire Conduit: You gain a \plus3 bonus to your \glossterm{magical} \glossterm{power}.
            ...
            \cf{Tif}[5]{Greater Hellfire Tolerance} You become \glossterm{immune} to fire damage.
