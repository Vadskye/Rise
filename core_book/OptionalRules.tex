...
\section{Uncommon Species}\label{Uncommon Species}
    ...
    %     These might include having leaves instead of hair, a green skin tone, or rough, barky skin.
    ...
    \subsection{Vampire}
        ...
        \begin{itemize}
            ...
            \itemhead{Darkvision} Vampires have \trait{darkvision} with a 60 foot range, allowing them to see in complete darkness (see \pcref{Darkvision}).
