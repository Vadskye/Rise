...
\section{Epic Fate}
    After 20th level, characters no longer gain levels normally.
    However, they can still increase their personal power as they make progress towards their ultimate fate.

    When you reach 20th level, you may choose an epic fate that you qualify for, or you may delay choosing until you meet the prerequisites for your desired fate.
    ...
    \subsection{Artificial Immortality}
        ...
        \subsubsection{Artifical Immortality Ranks}
            ...
            \parhead{Rank 2 -- Death Familiarity} You become so familiar with the trauma of injury and death that your body adapts to it. You gain a \plus2 bonus to vital rolls, and you can no longer become bloodied.
    ...
    \subsection{Deity}
        ...
        \subsubsection{Deity Ranks}
            ...
            You become an \glossterm{outsider} native to an Outer Plane matching your alignment.
            ...
            You are transported to an Outer Plane matching your alignment, and you gain divine dominion over an amount of territory in that plane.
    ...
    \subsection{Hero of Legend}
        ...
        \subsubsection{Hero of Legend Ranks}
            ...
            \parhead{Rank 2 -- Unstoppable Hero} You gain a \plus4 bonus to all defenses, and you increase your maximum \glossterm{hit points} by 4.
            ...
            \parhead{Rank 4 -- Inspiring Hero} The area of your \textit{heroic intervention} ability increases to a \areaext radius \glossterm{emanation}.
            In addition, each creature with a mind affected by that ability is so inspired by your example that they gain a \plus1 bonus to their base Willpower permanently.
    ...
    \subsection{Slayer}
        ...
        \parhead{Prerequisites} You must be publicly known to be involved with slaying at least one creature with a challenge rating of 4 and a level of at least 20.
        ...
        \subsubsection{Slayer Ranks}
            ...
            In addition, whenever you would inflict any number of \glossterm{vital wound} on a creature, you may inflict twice that many vital wounds.
            ...
            After you do this once, you become an \glossterm{outsider} native to your afterlife plane, since your new body is formed from the raw material of that plane.
...
\section{Species}
    ...
    \subsection{Awakened Animal}
        ...
        \subsubsection{Sample Awakened Animals}
            ...
            \end{itemize}
        \parhead{Species Feat Options} Agility, Awareness Specialization, Climb Specialization, Flexibility Specialization, Stealth Specialization, or Swift.
