...
\section{Uncommon Species}\label{Uncommon Species}
    ...
    \subsection{Oozeborn}
        ...
        \parhead{Size} Medium.
        \parhead{Attributes} \minus1 base Intelligence, either \plus1 base Constitution or \plus1 base Dexterity
        \parhead{Speed} 25 feet.
        \parhead{Special Abilities}
        \begin{itemize}
        ...
        \subsubsection{Basic Class Abilities}
            If choose oozeborn as your base class, you gain the following abilities.
