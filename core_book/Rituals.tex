...
\begin{spellsection}{Binding}[3]
    ...
    \end{spellsubcontent}
    \begin{spellfooter}
        \spellinfo{Abjuration [Antimagic]}{Arcane, Divine}
...
\begin{spellsection}{Fire Trap}[3]
    ...
    \end{spellsubcontent}
    \begin{spellfooter}
        \spellinfo{Abjuration/Evocation [Fire, Trap]}{Arcane, Nature}
...
\begin{spellsection}{Instant Refuge}[7]
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Conjuration/Transmutation [Augment, Teleportation]}{Arcane, Divine}
...
\begin{spellsection}{Instant Retrieval}[7]
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Conjuration/Transmutation [Augment, Teleportation]}{Arcane}
...
\begin{spellsection}{Liveoak}[5]
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Transmutation [Augment]}{Divine}
        \ritualcost{5}
    \end{spellfooter}
    \begin{spellaugments}
...
\begin{spellsection}{Phase Door}[7]
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Conjuration [Creation, Planar]}{Arcane, Divine}
