...
\begin{spellsection}{Fire Trap}[3]
    ...
    \begin{spellfooter}
        ...
        \par Magic traps such as \spell{fire trap} can be detected with the Perception skill and disabled with the Devices skill. The DR is 25 \add spell level, or DR 28 for \spell{fire trap}.
        \ritualcost{3}
    \end{spellfooter}
    \begin{spellaugments}
        \spellaugment{1}{Password}{When performing the ritual, you may specify a password. If the password is spoken aloud, the trap deactivates for 5 rounds.}
...
\begin{spellsection}{Read Magic}[1]
    ...
    \begin{spellcontent}
        ...
        \begin{spelleffects}
            ...
            This effect allows you to identify spells which create writing as part of their effect, such as \spell{glyph of warding} and \spellindirect{symbol of death}{symbol} spells, with a Spellcraft check against a DR equal to 10 \add spell level.
            \spelldur \durlong
        \end{spelleffects}
    \end{spellcontent}
    \begin{spellfooter}
