...
\begin{spellsection}{Alarm}[1]
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Divination [Trap]}{Arcane, Divine}
        \spellnotes A \spell{silence} spell or similar effect can prevent an audible alarm from being heard.

        \glossterm{Magic resistance} cannot prevent creatures or objects from being detected by the alarm.
        \ritualcost*{1}
    \end{spellfooter}
    \begin{spellaugments}
...
\begin{spellsection}{Alter Self}[2]
    ...
    \end{spellfooter}
    \begin{spellaugments}
        \spellaugment{3}{Permanent}{The ritual's duration becomes permanent. You can only make one casting of this ritual permanent. If you use this augment again, the previous effect immediately ends.}
    \end{spellaugments}
\end{spellsection}
...
\begin{spellsection}{Animate Dead}[3]
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Vivimancy [Evil, Negative, Soul]}{Arcane, Divine}
...
\begin{spellsection}{Animal Messenger}[2]
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Enchantment [Compulsion, Mind]}{Arcane, Nature}
...
\begin{spellsection}{Antipathy}[9]
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Enchantment [Delusion, Mind]}{Arcane, Nature}
...
\begin{spellsection}{Arcane Lock}[2]
    ...
    \begin{spellaugments}
        \spellaugment{1}{Password}{When performing the ritual, you may specify a password. If the password is spoken aloud, the alarm deactivates for 5 rounds.}
        \spellaugment{2}{Permanent}{The ritual's duration becomes permanent.}
        \spellaugment{2}{Solid}{The DR to break the object open forcibly increases by an additional 10.}
    \end{spellaugments}
\end{spellsection}
...
\begin{spellsection}{Arcane Mark}[1]
    ...
    \begin{spellaugments}
        \spellaugment{2}{Permanent}{The ritual's duration becomes permanent.}
        \spellaugment{3}{Hidden}{The mark is invisible, rather than visible. Effects such as the \spell{see invisibility} spell can reveal the mark.}
    \end{spellaugments}
\end{spellsection}
...
\begin{spellsection}{Atonement}[5]
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Channeling}{Divine, Nature}
        \ritualcost{5}
    \end{spellfooter}
\end{spellsection}
...
\begin{spellsection}{Binding}[3]
    ...
    \end{spellsubcontent}
    \begin{spellfooter}
        \spellinfo{Abjuration [Thaumaturgy]}{Arcane, Divine}
        ...
        The magic circle is obvious, but a DR 26 Spellcraft check is required to identify that the circle belongs to a \spell{binding} ritual. Alternately, the magic of the trap can be identified with a DR 26 Perception check.
        \ritualcost*{3}
    \end{spellfooter}
    \begin{spellaugments}
...
\begin{spellsection}{Bless Water}[1]
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Transmutation}{Divine}
...
\begin{spellsection}{Commune}[5]
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Divination [Planar]}{Divine}
...
\begin{spellsection}{Comprehend Languages}[2]
    \begin{spellheader}
        \spelldesc{You grant a creature the ability to understand any language.}
    \end{spellheader}
    \begin{spellcontent}
        \begin{spelltargetinginfo}
            \spelltime{1 minute}
    ...
    \end{spellfooter}
    \begin{spellaugments}
        \spellaugment{4}{Permanent}{The ritual's duration becomes permanent. You can only make one casting of this ritual permanent. If you use this augment again, the previous effect immediately ends.}
    \end{spellaugments}
\end{spellsection}
...
\begin{spellsection}{Detect Scrying}[3]
    ...
    \end{spellfooter}
    \begin{spellaugments}
        \spellaugment{2}{Tracing}{When you detect a scrying attempt, you make an opposed spellpower check against the scrying creature (d10 \add spellpower). If you win, you get a visual image of the scrier and an accurate sense of his or her direction and distance from you.}
        \spellaugment{3}{Permanent}{The ritual's duration becomes permanent. You can only make one casting of this ritual permanent. If you use this augment again, the previous effect immediately ends.}
    \end{spellaugments}
\end{spellsection}
    ...
    \begin{spellsubcontent}
        ...
        \begin{spelleffects}
            \begin{spellattack}{Spellpower vs. Reflex}
                ...
                \spellsuccess \spelldamage{arcane}[d8].
                \spellfailure Half damage.
            \end{spellattack}
        \end{spelleffects}
    \end{spellsubcontent}
    \begin{spellfooter}
        \spellinfo{Evocation [Trap]}{Arcane}
        \spellnotes If the target object is destroyed or rendered illegible, the ritual ends without exploding.

        Magic traps such as \spell{explosive runes} can be detected with the Perception skill and disabled with the Devices skill. The DR is 25 \add spell level, or DR 28 for \spell{explosive runes}.
        \ritualcost*{3}
    \end{spellfooter}
    \begin{spellaugments}
...
\begin{spellsection}{Fabricate}[5]
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Transmutation [Shaping]}{Arcane, Nature}
...
\begin{spellsection}{False Vision}[4]
    ...
    \begin{spellfooter}
        \spellinfo{Illusion [Glamer]}{Arcane}
        \spellnotes Creatures can identify the illusion, as the \spell{create image} spell.
        \ritualcost*{5}
    \end{spellfooter}
    \begin{spellaugments}
        \spellaugment{3}{Permanent}{The ritual's duration becomes permanent.}
...
\begin{spellsection}{Fertility/Infertility}[3]
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Transmutation [Imbuement]}{Divine}
...
\begin{spellsection}{Fire Trap}[3]
    ...
    \end{spellsubcontent}
    \begin{spellfooter}
        \spellinfo{Evocation [Fire, Trap]}{Arcane, Nature}
        \spellnotes If the target object is destroyed or rendered unopenable, the ritual ends without exploding.

        \par Magic traps such as the \spell{fire trap} ritual can be detected with the Perception skill and disabled with the Devices skill. The DR is 25 \add spell level, or DR 28 for \spell{fire trap}.
        \ritualcost{3}
    \end{spellfooter}
    \begin{spellaugments}
        \spellaugment{1}{Password}{When performing the ritual, you may specify a password. If the password is spoken aloud, the trap deactivates for 5 rounds.}
...
\begin{spellsection}{Illusory Guise}[1]
    ...
    \begin{spellcontent}
        ...
        \begin{spelleffects}
            ...
            You gain a \plus10 bonus on the check, and you can freely alter the appearance of the target's clothes and equipment, regardless of their original form. However, the glamer does not include sound, smell, texture, or temperature.

            When you finish this ritual, you make a check with a bonus equal to your spellpower \add 10. Creatures can recognize the disguise is created by illusory magic by interacting with it physically, or by making an Awareness check against a DR equal to your check result when finishing the ritual. A creature gets a \plus10 bonus on this Awareness check when using senses which should be present in the glamer, but which are missing.
            \spelldur \durlong \dismissable
        \end{spelleffects}
    \end{spellcontent}
    \begin{spellfooter}
...
\begin{spellsection}{Instant Refuge}[7]
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Conjuration/Transmutation [Imbuement, Teleportation]}{Arcane, Divine}
...
\begin{spellsection}{Instant Retrieval}[7]
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Conjuration/Transmutation [Imbuement, Teleportation]}{Arcane}
...
\begin{spellsection}{Magnificent Mansion}[7]
    ...
    \begin{spellcontent}
        ...
        \begin{spelleffects}
            ...
            near-transparent servants, liveried and obedient, wait upon all who enter. The servants function as the servant created by the \spell{unseen servant} ritual, except that they obey any designated creature, are visible, and can go anywhere in the mansion.
            \spelldur \durext \dismissable
        \end{spelleffects}
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Conjuration [Creation, Planar]}{Sor/Wiz}
...
\begin{spellsection}{Mending}[1]
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Transmutation [Shaping]}{Arcane, Divine, Nature}
        \spellnotes This ritual has no effect on broken or destroyed items.
        \ritualcost*{1}
    \end{spellfooter}
    \begin{spellaugments}
        \spellaugment{2}{Empowered}{For every 5 points of healing granted by this ritual, it can instead heal 1 point of vital damage. This can restore broken items, but has no effect on destroyed items.}
    \end{spellaugments}
\end{spellsection}
...
\begin{spellsection}{Mount}[1]
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Conjuration [Manifestation]}{Arcane}
        \ritualcost{1}
    \end{spellfooter}
\end{spellsection}
...
\begin{spellsection}{Move Earth}[6]
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Transmutation [Earth, Shaping]}{Arcane, Nature}
...
\begin{spellsection}{Nondetection}[3]
    ...
    \begin{spellcontent}
        ...
        \end{spelltargetinginfo}
        \begin{spelleffects}
            \spelleffect The target gains \glossterm{magic resistance} against Awareness and Scrying abilities equal to 10 \add your spellpower.
...
\begin{spellsection}{Overland Flight}[6]
    ...
    \begin{spellcontent}
        ...
        \begin{spelleffects}
            ...
            While it has a fly speed and is \unencumbered, it can fly (see \pcref{Flying}).
    ...
    \end{spellfooter}
    \begin{spellaugments}
        \spellaugment{2}{Accelerated}{The fly speed increases to 60 feet.}
        \spellaugment{1}{Maneuverable}{The fly speed has good maneuverability.}
        \spellaugment{3}{Mass}{The spell can affect up to five targets.}
        \spellaugment{2}{Reinforced}{The target can still fly with this effect while encumbered.}
    \end{spellaugments}
\end{spellsection}
...
\begin{spellsection}{Pass Without Trace}[2]
    ...
    \begin{spellaugments}
        ...
        \spellaugment{5}{Permanent}{The ritual's duration becomes permanent. You can only make one casting of this ritual permanent. If you use this augment again, the previous effect immediately ends.}
    \end{spellaugments}
\end{spellsection}
...
\begin{spellsection}{Passwall}[5]
    ...
    \begin{spellcontent}
        ...
        \end{spelltargetinginfo}
        \begin{spelleffects}
            \spelleffect This ritual creates a passage through nonmagical wooden, plaster, or stone walls, but not through other materials. The material within the area is transported to the Astral plane for the duration of the spell. If the wall's thickness is more than the depth of the passage created, then a single \spell{passwall} makes a niche or short tunnel. Several \spell{passwall} rituals can then form a continuing passage to breach very thick walls. When the effect ends, the material returns and creatures within the passage are ejected out the nearest exit.
            \spelldur \durext \dismissable
        \end{spelleffects}
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Conjuration [Planar]}{Arcane, Divine, Nature}
...
\begin{spellsection}{Persistent Image}[6]
    ...
    \begin{spellcontent}
        ...
        \end{spelltargetinginfo}
        \begin{spelleffects}
            \spelleffect A figment of your design appears within the area, as the \spell{create image} spell.
            \spelldur Thirty days \dismissable
        \end{spelleffects}
    \end{spellcontent}
    \begin{spellfooter}
...
\begin{spellsection}{Remote Senses}[3]
    ...
    \end{spellfooter}
    \begin{spellaugments}
        \spellaugment{2}{Apparition}{A figment of you appears with the sensor, as the \spell{create image} spell. While concentrating on the sensor, you can speak through the figment and be heard. This is an Illusion [Figment] effect.}
...
\begin{spellsection}{Remove Curse}[4]
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Abjuration [Thaumaturgy]}{Arcane, Divine, Nature}
        \ritualcost{4}
    \end{spellfooter}
\end{spellsection}
...
\begin{dtable}
    ...
    \begin{dtabularx}{\columnwidth}{>{\lcol}X >{\lcol}p{4em}}
        ...
        Same plane & \plus0 \\
        Connected or overlapping planes\fn{2} & \minus5 \\
...
\begin{spellsection}{Shape Stone}[3]
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Transmutation [Earth, Shaping]}{Arcane, Divine, Nature}
        \ritualcost{3}
    \end{spellfooter}
\end{spellsection}
...
\begin{spellsection}{Speak with Dead}[3]
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Divination/Vivimancy [Communication, Flesh]}{Arcane, Divine}
...
\begin{spellsection}{Telepathic Bond}[3]
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Divination/Transmutation [Imbuement]}{Arcane}
...
\begin{spellsection}{Teleport}[6]
    ...
    \begin{spellcontent}
        ...
        \end{spelltargetinginfo}
        \begin{spelleffects}
            \spelleffect When you perform this ritual, you specify a destination up to 100 miles away on your current plane, and make an Intelligence check. The DR of the check depends on your familiarity with the destination, as shown on \tref{Teleport DRs}.
...
\begin{dtable}
    \lcaption{Teleport DRs}
    \begin{dtabularx}{\columnwidth}{l X l}
        \tb{Familiarity} & \tb{Destination Description} & \tb{DR} \\
        \bottomrule
        ...
        False Destination & It does not exist, or has changed beyond recognition. & \tdash\fn{1} \\
    \end{dtabularx}
...
\begin{spellsection}{Transfer Imbuement}[2]
    \begin{spellheader}
        \spelldesc{You transfer the magic from one object into another, preserving its nature and strength.}
    \end{spellheader}
    \begin{spellcontent}
        \begin{spelltargetinginfo}
            \spelltime{10 minutes}
            \spellquicktargeting{Two objects (Medium or smaller)}{\rngclose}
        \end{spelltargetinginfo}
        \begin{spelleffects}
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Transmutation [Enhancement]}{Arcane, Divine, Nature}
        \miscastexplode
    \end{spellfooter}
    \begin{spellaugments}
        \spellaugment{2}{Giant}{The ritual can affect targets one size category larger. This augment can be used multiple times.}
...
\begin{spellsection}{Water Breathing}[2]
    ...
    \end{spellfooter}
    \begin{spellaugments}
        \spellaugment{2}{Mass}{The spell can affect up to five targets.}
        \spellaugment{3}{Permanent}{The ritual's duration becomes permanent. You can only make one casting of this ritual permanent. If you use this augment again, the previous effect immediately ends.}
    \end{spellaugments}
\end{spellsection}
...
\begin{spellsection}{Zone of Truth}[2]
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Enchantment [Compulsion, Mind]}{Arcane, Divine}
