...
\glossdef{frightened} A frightened creature takes a \minus4 penalty to \glossterm{defenses} while it is within \rngmed range of the source of its fear.
...
\glossdef{shaken} A shaken creature takes a \minus2 penalty to \glossterm{defenses} while it is within \rngclose range of the source of its fear.
...
\glossdef{stunned} A stunned creature cannot take any actions during the \glossterm{action phase} or \glossterm{delayed action phase}, except to use the \textit{cleanse} ability (see \pcref{Cleanse}).
In addition, it takes a \minus4 penalty to \glossterm{accuracy} and Mental defense.
