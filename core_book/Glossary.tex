...
\glossdef{dual wield}[dual wielding] If you wield two weapons at once, you can attack with both simultaneously whenever you make a \glossterm{strike}.
...
\glossdef{extra damage} Some abilities add extra damage to your damaging attacks, or cause creatures to suffer extra damage from any incoming damaging attacks.
Extra damage applies when damaging attacks hit or get a \glossterm{glancing blow}.
On a glancing blow, extra damage is halved just like the attack's base damage.
...
In addition, many attacks that affect an area inflict a glancing blow even if they miss by more than 2.
...
\glossdef{icy terrain} See \pcref{Cryomancy}.
...
\glossdef{resurrected}[resurrection] When a creature is resurrected, it comes back to life after being dead.
...
\glossdef{weak strike} When you make a weak strike, you roll your \glossterm{weapon damage} twice and take the lower result.
You do not reroll any \glossterm{extra damage} that the strike deals.
...
You gain a \plus1d bonus to your weapon damage per 2 \glossterm{power} (see \pcref{Power}).
