...
\glossdef{damage} Taking damage reduces a creature's \glossterm{damage resistance}, then its \glossterm{hit points}.
For details, see \pcref{Taking Damage}.

\glossdef{damage resistance} Whenever you take damage, you first apply that damage to your damage resistance before it reduces your \glossterm{hit points}.
...
\glossdef{environmental damage}[environmental] Environmental damage does not reduce \glossterm{damage resistance}.
...
\glossdef{injury}[injuries] When a creature loses \glossterm{hit points} from an effect, it is injured by that effect.
...
In addition, there are five resources that are used during gameplay: \glossterm{attunement points}, \glossterm{damage resistance}, \glossterm{fatigue level}, \glossterm{hit points}, and \glossterm{vital wounds}.
...
\glossdef{suppressed}[suppress] Abilities have no effect while they are suppressed.
