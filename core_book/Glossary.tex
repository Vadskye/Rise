...
\glossdef{archetype rank}[archetype ranks] Each ability from an \glossterm{archetype} has a minimum rank required to gain the ability.
...
\glossdef{attune}[attunes] Some abilities last as long as you attune to them.
...
\glossdef{miscast} If your \glossterm{concentration} is disrupted while casting a \glossterm{spell}, you miscast the spell instead.
...
\glossdef{point of origin}[point of origin] A point of origin is the grid intersection, creature, or object that an area originates from.
