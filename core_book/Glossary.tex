...
If the entire effect of a \glossterm{condition} would be to apply a debuff that a creature is immune to, the creature does not gain that condition at all.
...
Minor actions can only be taken during the \glossterm{action phase}.
...
If you would make multiple reactive attacks during the same phase with the same ability, use the same attack roll for all of the attacks.
