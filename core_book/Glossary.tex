...
It has no effect on creatures or objects unless it \glossterm{wounds} them.
...
\glossdef{resistance} You have two resistances: your \glossterm{wound resistance} and your \glossterm{vital resistance}.
...
\glossdef{wound}[wounded] If damage from an attack beats your \glossterm{wound resistance}, the attack wounds you.
Some attacks have additional effects if they wound the target.
For details, see \pcref{Taking Damage}.

\glossdef{wound resistance} You normally lose a single hit point when you are hit by a damaging attack.
You lose an additional \glossterm{hit point} if you take at least as much damage as your \glossterm{wound resistance} from the attack.
