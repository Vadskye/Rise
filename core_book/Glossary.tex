...
It is \glossterm{impervious} to \glossterm{physical damage}, and it ignores all non-damage effects of attacks that deal physical damage.
It moves silently and ignores the effects of abilities that only work if it has a corporeal body, such as the \textit{grapple} or \textit{shove} abilities.
