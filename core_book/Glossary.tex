...
\glossdef{overwhelm penalty} An creature \glossterm{threatened} by at least two creatures suffers a \minus2 penalty to Armor and Reflex defenses.
This penalties are called an overwhelm penalty.
For details, see \pcref{Overwhelm}.

\glossdef{overwhelmed} A creature is overwhelmed if its \glossterm{overwhelm penalty} is at least \minus1.
For details, see \pcref{Overwhelm}.
...
Your power with magical abilities is normally equal to half your Willpower, and your power with mundane abilities is normally equal to half your Strength.
...
A threatened creature may suffer an \glossterm{overwhelm penalty} if there are multiple creatures threatening it (see \pcref{Overwhelm}).
