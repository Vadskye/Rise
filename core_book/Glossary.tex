...
\glossdef{crouching} A crouching creature gains a \plus1 bonus to defenses against physical ranged attacks.
However, it takes a \minus1 penalty to physical \glossterm{accuracy} with \glossterm{melee attacks} and defenses against melee attacks, and moves at half speed.
...
\glossdef{defenseless} A defenseless creature is unable to defend itself in melee combat. It takes a \minus2 penalty to defenses against \glossterm{melee attacks}. Any creature not capable of using a weapon or shield to defend itself, such as most unarmed creatures, is defenseless.
...
\glossdef{encumbrance penalty}[encumbrance penalties] A character's encumbrance penalty applies to all Strength and Dexterity-based checks the character makes.
...
It takes a \minus2 penalty to \glossterm{accuracy} with \glossterm{melee attacks} and to defenses against melee attacks.
It gains a \minus2 bonus to defenses against physical ranged attacks.
...
\glossdef{resolution step} During each \glossterm{phase}, actions are resolved in an ordered series of steps.
These steps are called resolution steps.
...
While squeezing, a creature moves at half speed and takes a \minus2 penalty to physical accuracy, physical checks, and Armor and Reflex defenses.
