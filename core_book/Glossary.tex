...
\glossdef{bleed}[bleeding] When you bleed, you lose a hit point.
Generally, you bleed because an attack did damage in excess of your \glossterm{bleed resistance}.
...
\glossdef{bleed resistance} If you take as at least as much damage as your bleed resistance from a single damage roll, you \glossterm{bleed}.
For details, see \pcref{Bleed Resistance}.
...
\glossdef{bloodied} A bloodied creature has its \glossterm{vital resistance} halved (see \pcref{Vital Resistance}).
You are \glossterm{bloodied} while you have half your maximum \glossterm{hit points} remaining or fewer (rounded down).
...
\glossdef{energy damage}[energy] There are three types of energy damage: cold, electricity, and fire.
For details, see \pcref{Damage Types}.

\glossdef{environmental damage}[environmental] Environmental damage is a type of damage.
It has no effect on creatures or objects unless it does enough damage to make them \glossterm{bleed}.
...
\glossdef{goaded} A goaded creature takes a \minus2 penalty to \glossterm{accuracy} while it is within \rngclose range of the source that goaded it.
...
\begin{itemize}
    \item You must use a free hand (or equivalent limbs) to grapple, preventing you from taking any actions which would require having two free hands.
        If you cannot free a hand, you suffer a \minus10 penalty to accuracy on all \glossterm{mundane} attacks until you have a free hand.
...
\glossdef{ignited} An ignited creature or object has been set on fire.
At the end of each round, the creature or effect that ignited it deals it \glossterm{environmental} fire \glossterm{standard damage}.
...
If a creature being knocked back encounters an obstacle, it and the obstacle each take 1d6 \glossterm{environmental damage} \add 1d per 5 feet of movement remaining.

\glossdef{land speed} A creature's land speed determines how fast it can walk on land.
For details, see \pcref{Movement Mode}.
...
They are immune to \glossterm{Compulsion} and \glossterm{Delusion} abilities.
...
\glossdef{resistance} You have two resistances: your \glossterm{bleed resistance} and your \glossterm{vital resistance}.
...
\glossdef{shaken} A shaken creature takes a \minus2 penalty to \glossterm{accuracy} and Mental defense while it is within \rngclose range of the source of its fear.
...
\glossdef{threaten}[threatened] If you are using a \glossterm{melee} weapon, all enemies within your \glossterm{reach} with that weapon are threatened.
A threatened creature may suffer \glossterm{overwhelm penalties} if there are multiple creatures threatening it (see \pcref{Overwhelm}).
...
It takes a \minus5 penalty to Armor and Reflex defenses against attacks that it is unaware of.
...
You gain a \glossterm{vital wound} if you take damage in excess of your \glossterm{vital resistance} from a single damage roll.
...
\glossdef{vital resistance} You gain a \glossterm{vital wound} if you take at least as much damage as your \glossterm{vital resistance} from a single damage roll.
For details, see \pcref{Vital Resistance}.

\glossdef{vitally wound}[vitally wounded] If damage from an attack beats your \glossterm{vital resistance}, the attack vitally wounds you.
Some attacks have additional effects if they vitally wound the target.
For details, see \pcref{Taking Damage}.

\glossdef{VR} A shorthand for \glossterm{vital resistance}.
