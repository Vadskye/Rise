...
You can dismiss abilities as a non-action (see \pcref{Dismissal}).
...
\glossdef{falling damage} If you fall at least 10 feet, you and the object you land on take bludgeoning damage.
This damage is called falling damage.
A creature with a Medium \glossterm{weight category} takes 1d10 falling damage per 10 feet, to a maximum of 20d10.
...
\glossdef{opposed alignment} Each \glossterm{alignment} has an opposed alignment that is antithetical to its principles and goals.
Good and Evil are opposed alignments, and Chaos and Law are opposed alignments.
For details, see \pcref{Alignment}.

\glossdef{overrun} An overrun is a combat ability that allows you to move directly through creatures.
...
\glossdef{weak strike} When you make a weak strike, you halve flat damage bonuses, such as from your \glossterm{power}.
