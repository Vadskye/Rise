...
\glossterm{Melee} attacks against it gain a \plus2 bonus to \glossterm{accuracy}, while \glossterm{mundane} ranged attacks against it take a \minus2 accuracy penalty.
In addition, it takes a \minus2 accuracy penalty with melee attacks and moves at half speed.
...
If a creature would be impervious to damage for multiple reasons, the damage is still only halved once.
...
\glossdef{push}[pushing] A push is a type of \glossterm{forced movement}.
...
There are are five common resources: \glossterm{attunement points}, \glossterm{fatigue level}, \glossterm{hit points}, \glossterm{insight points}, and \glossterm{skill points}.
