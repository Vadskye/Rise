...
\glossdef{immediate action}[immediate actions] Each round, you can take a single \glossterm{minor action} or immmediate action.
Immediate actions do not need to be declared ahead of time, and can be taken in any phase.
They are resolved immediately, before the triggering action resolves.
For details, see \pcref{Minor and Immediate Actions}.
...
\glossdef{Law} See \pcref{Ability Tags}.
...
It takes a \minus4 penalty to accuracy, checks, and defenses.
...
\glossdef{minor action}[minor actions] Each round, you can take a single minor action or \glossterm{immediate action} in addition to your other actions that round.
...
\glossdef{wounded} A wounded creature has no hit points remaining.
If you take damage in excess of your hit points while wounded, that damage is dealt as \glossterm{vital damage}.
