...
\glossdef{double damage} If an attack deals double damage, you double the result of all damage dice you roll for the attack, including any \glossterm{extra damage}.
The same applies to any other multipliers, like triple damage.
This is different from \glossterm{critical hits}, which double the number of dice you roll for the attack, and which do not affect extra damage.
