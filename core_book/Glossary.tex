...
\glossdef{attack result} An attack result is the total you get on an \glossterm{attack roll}, after taking to account any \glossterm{modifiers} that apply to the roll.
...
\glossdef{check}[checks] A check is a d10 \glossterm{roll} required to accomplish an action that has a chance of failure that is not an attack.
...
\glossdef{check modifier}[check modifiers] A check modifier is a number that you add to or subtract from your d10 \glossterm{roll} when you make a \glossterm{check}.
For details, see \pcref{Checks}.
...
\glossdef{condition} A condition is a negative effect on a creature.
...
\glossdef{delayed action}[delayed actions] A delayed action takes place during the \glossterm{delayed action phase} instead of the \glossterm{action phase}.
...
\glossdef{dual action}[dual actions] A dual action has some effects in both the \glossterm{action phase} and the \glossterm{delayed action phase}.
You can only start a dual action during the action phase.
The most common dual action is casting a \glossterm{spell}, which must be started during the action phase and do not have their effects until the delayed action phase.

\glossdef{dual strike}[dual strikes] A \glossterm{dual strike} is a \glossterm{strike} made with two different weapons simultaneously.
...
\glossdef{initiate}[initiated] After all creatures chose their actions for a particular phase, those actions are initiated.
...
For details, see \pcref{Light Weapons}.
