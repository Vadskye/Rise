...
\glossdef{blindsense}[Blindsense] A creature with blindsense can sense its surroundings without any light, regardless of concealment or invisiblity.
...
Somatic components are only used by arcane and pact spellcasters while \glossterm{vertal components} are used by all spellcasters.
...
\glossdef{darkvision}[Darkvision] A creature with darkvision can see in the dark clearly up to a given range.
...
\glossdef{decelerated} See \pcref{Circumstances and Debuffs}.
...
\glossdef{disoriented} See \pcref{Circumstances and Debuffs}.
...
\glossdef{fascinated} See \pcref{Circumstances and Debuffs}.
...
\glossdef{focus penalty}[focus penalties] When you use a \abilitytag{Focus} ability, you take a \minus4 penalty to Armor and Reflex defenses.
...
\glossdef{lifesense}[Lifesense] A creature with lifesense knows the location of all living creatures within a given range.
...
\glossdef{nauseated} See \pcref{Circumstances and Debuffs}.
...
\glossdef{surrounded} See \pcref{Circumstances and Debuffs}.
...
There are are five common resources: \glossterm{attunement points}, \glossterm{fatigue points}, \glossterm{hit points}, \glossterm{insight points}, and \glossterm{skill points}.
...
\glossdef{sickened} See \pcref{Circumstances and Debuffs}.
...
\glossdef{tremorsense}[Tremorsense] A creature with tremorsense can sense its surroundings without any light, regardless of concealment or invisiblity.
...
\glossdef{truesight} A creature with truesight can ignore all \abilitytag{Sensation} effects within a given range.
