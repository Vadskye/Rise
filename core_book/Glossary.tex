...
The \glossdeflink{taunted} condition is a more severe version of this effect.
...
For example, the Counterattack feat (see \featpref{Counterattack}) allows you to initiate a strike as an immediate action if another creature initiates a strike aginst you.
...
\glossdef{stabilization roll}[stabilization rolls] A roll made when a creature is \glossdeflink{dying} to see if it stabilizes or dies. For details, see \pcref{Injury, Death, and Healing}.
...
For details, see \pcref{Strike Accuracy}, and \pcref{Strike Damage}.
...
If that creature is rendered \helpless, surrenders, or is otherwise unable to fight, this effect immediately ends.
The \glossdeflink{goaded} condition is a less severe version of this effect.
...
\glossdef{unencumbered} An unencumbered creature does not have its motion restricted by armor or weight. See \pcref{Encumbrance} for details.
