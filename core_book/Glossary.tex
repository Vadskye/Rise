...
An creature or object excluded from an ability is not considered a target of the ability, even if it is within the ability's area or otherwise would normally be affected by the ability.
...
\glossdef{movement}[Movement] You can make one movement during the \glossterm{movement phase} of each round.
