...
\glossdef{fatigue level} A creature takes a \glossterm{fatigue penalty} if its fatigue level exceeds your \glossterm{fatigue tolerance}.
...
In addition, there are two resources that are used during gameplay: \glossterm{attunement points} and \glossterm{fatigue level}.
