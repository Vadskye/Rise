...
\glossdef{dazed} All of a dazed creature's abilities gain the \glossterm{Delayed} tag if they did not already have it (see \pcref{Delayed Abilities}).
In addition, the creature takes a \minus2 penalty to \glossterm{accuracy}, \glossterm{checks}, and \glossterm{defenses}.
If the creature can normally take multiple actions per round, only one of its actions is affected in this way.
...
Your accuracy is equal to your \glossterm{power} with the ability you are using, such as your spellpower with spells.
