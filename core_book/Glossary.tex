...
\glossdef{available movement} Your available movement is the maximum distance you can move during the current round.
...
If a brief effect is not created by a creature, it lasts until the end of the next round.
...
\glossdef{poison}[poisoned] Poisons attack Fortitude defense each round to cause debilitating effects or damage.
...
During each round, you will get a turn where you can take actions.
...
\glossdef{speed} Your speed indicates how far you can move during a typical round.
For details, see \pcref{Movement Speed}.
...
At the start of your turn, the ability is dismissed unless you take the action to sustain the ability that round.
