...
Unless otherwise noted, all abilities with a duration can be dismissed, including \glossterm{conditions}.
...
\glossdef{impervious} A creature that is impervious to an attack gains a \plus5 bonus to defenses against it.
