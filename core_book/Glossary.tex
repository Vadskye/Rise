...
\glossdef{encumbrance penalty}[encumbrance penalties] Your encumbrance penalty applies to all Strength and Dexterity-based checks you make.
A character can acquire an encumbrance penalty by wearing armor or by carrying an excessive weight (see \pcref{Carrying Capacity}).
