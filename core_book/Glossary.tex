...
\glossdef{broken} A broken object is damaged and unsuitable for use. Both magical and mundane objects can be repaired for a cost equal to 10\% of their value. You must be able to craft the item originally to repair it.
