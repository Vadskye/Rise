...
\glossdef{walking speed} A creature's walking speed is a \glossterm{movement mode} that determines how fast it can walk on land (see \pcref{Movement Modes}).
Most creatures have an average walking speed.
