...
\glossdef{ability} An ability is a generic term for any special action a creature can perform or effect that a creature or object can cause.
...
In addition, the creature takes a \minus2 penalty to \glossterm{accuracy}, \glossterm{checks}, and \glossterm{defenses}.
...
\glossdef{fatigued} A fatigued creature cannot sprint (see \pcref{Sprint}).
...
Dropping \glossterm{prone} as part of the action gives a \plus5 bonus on this check.
% TODO: make creatures with fire damage reduction immune to being ignited
...
Your \glossterm{accuracy} with this attack is equal to your \glossterm{power} with the ability you are using.
...
\glossdef{magical power} Your \glossterm{power} with \glossterm{magical} abilities is called your magical power.
...
\glossdef{mundane power} Your \glossterm{power} with \glossterm{mundane} abilities is called your mundane power.
It is normally equal to the higher of your level and your Strength.

% clarify - it can make some sound?
\glossdef{muted} A muted creature cannot speak.
...
All physical attacks share a common way of determining their \glossterm{accuracy} (see \pcref{Accuracy}).
...
Your power with an ability usually depends on whether the ability is \glossterm{magical} or \glossterm{mundane}.
...
\glossdef{slowed} A slowed creature moves at half speed.
...
\glossdef{stabilization roll} A roll made when a creature is \glossterm{dying} to see if it stabilizes or dies. For details, see \pcref{Injury, Death, and Healing}.
...
\glossdef{strike damage} Your \glossterm{strike damage} is the amount of damage you deal with a \glossterm{strike}.
...
\glossdef{subritual} A subritual is a particular variant of a \glossterm{ritual} that is cast at a higher level.
