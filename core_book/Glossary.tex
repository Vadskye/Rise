...
\glossterm{astral beacon} An area with an astral beacon is easier to \glossterm{teleport} to using long-distance teleportation abilities.
...
\glossdef{range limits} Ranged weapons have two \glossterm{range limits} listed, with a slash between them, such as 60/180.
...
\glossdef{touch} You can touch an adjacent creature if it is an \glossterm{ally} or if you beat its Reflex defense (see \pcref{Touch}).
