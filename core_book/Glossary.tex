...
Examples include casting a spell, using a cleric's invocation (see Divine Invocation, page \pref{Clr:Divine Invocation}), and many other supernatural abilities.
