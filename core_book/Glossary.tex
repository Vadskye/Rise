...
Whenever you use an ability that allows attunement, you can choose to attune to it.
If you do, your maximum \glossterm{action points} are reduced by 1.
You can stop attuning to any of your abilities as a \glossterm{free action}, which removes the lowering of your maximum action points.
