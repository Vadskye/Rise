...
\parhead*{Augments} Accelerated, Extended
\end{spellfooter}
...
\parhead*{Augments} Accelerated, Extended, Widened
\end{spellfooter}
\begin{spellsubcontent}
\end{spellsubcontent}
\end{spellsection}
...
\parhead*{Augments} Accelerated, Extended, Intensified
\end{spellfooter}
\begin{spellsubcontent}
\end{spellsubcontent}
\end{spellsection}
...
\begin{spellfooter}
\spellinfo{Transmutation}{Nature}
\parhead*{Augments} Accelerated, Widened
\end{spellfooter}
\begin{spellsubcontent}
\end{spellsubcontent}
\end{spellsection}
