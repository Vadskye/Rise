...
\begin{ability}{Light}[\glossterm{Attune} (multiple), \glossterm{Light}, \glossterm{Sensation}]
...
\begin{ability}{Magic Mouth}[\glossterm{Attune} (multiple), \glossterm{Sensation}]
