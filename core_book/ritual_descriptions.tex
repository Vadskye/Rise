...
\parhead{Cantrip} None If you cast this spell as a cantrip, you do not need to spend an \glossterm{action point} to cast it, but you cannot apply any augments to it.
