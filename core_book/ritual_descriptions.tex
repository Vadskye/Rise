...
\fieldhead{Augments} Accelerated, Extended
\end{spellfooter}
...
\fieldhead{Augments} Accelerated, Extended, Widened
\end{spellfooter}
\begin{spellsubcontent}
\end{spellsubcontent}
\end{spellsection}
...
\spellsuccess Arcane \glossterm{standard damage} \minus1d.
...
\fieldhead{Augments} Accelerated, Extended, Intensified
\end{spellfooter}
\begin{spellsubcontent}
\end{spellsubcontent}
\end{spellsection}
...
\begin{spellfooter}
\spellinfo{Transmutation}{Nature}
\fieldhead{Augments} Accelerated, Widened
\end{spellfooter}
\begin{spellsubcontent}
\end{spellsubcontent}
\end{spellsection}
...
\begin{spellfooter}
\spellinfo{Transmutation}{Nature}
\fieldhead{Augments} Accelerated
\end{spellfooter}
\begin{spellsubcontent}
\end{spellsubcontent}
\end{spellsection}
