...
\begin{ability}{Animate Dead}[\glossterm{Attune} (ritual)]
...
\begin{ability}{Bless Water}[\glossterm{Attune} (ritual)]
...
\begin{spellsection}{Blessed Transit}[4]
...
\begin{ability}{Create Object}[\glossterm{Attune} (ritual), \glossterm{Manifestation}]
...
\begin{ability}{Create Water}[\glossterm{Creation}]
...
\begin{ability}{Curse Water}[\glossterm{Attune} (ritual)]
Choose one pint of unattended, nonmagical water within \rngclose range.
...
\begin{spellsection}{Discern Location}[4]
...
\begin{ability}{Endure Elements}[\glossterm{Attune} (ritual)]
...
\begin{ability}{Explosive Runes}[\glossterm{Attune} (ritual), \glossterm{Trap}]
...
Each struck target takes \glossterm{standard damage} \minus1d of the damage type chosen.
...
\begin{spellsection}{Fortify}[1]

\begin{spellheader}
\spelldesc{You fortify a part of a structure, increasing its durability.}
\end{spellheader}
...
\begin{ability}{Gentle Repose}[\glossterm{Attune} (ritual), \glossterm{Temporal}]
...
\begin{spellsection}{Infertility}[2]
...
\begin{spellsection}{Lifeweb Transit}[4]
...
\begin{ability}{Light}[\glossterm{Attune} (ritual), \glossterm{Light}, \glossterm{Sensation}]
...
\begin{ability}{Magic Mouth}[\glossterm{Attune} (ritual), \glossterm{Sensation}]
...
\begin{spellsection}{Mount}[2]


\begin{ability}{Mount}[\glossterm{Attune} (ritual), \glossterm{Manifestation}]
...
\begin{ability}{Mystic Lock}[\glossterm{Attune} (ritual)]
...
\begin{spellsection}{Overland Teleportation}[4]
...
\begin{spellsection}{Private Sanctum}[4]
...
\begin{spellsection}{Purge Curse}[2]
...
\begin{ability}{Read Magic}[\glossterm{Attune} (ritual)]
...
\begin{spellsection}{Reincarnation}[4]
...
\begin{ability}{Restoration}[\glossterm{Flesh}]
Choose a willing creature within \rngclose range.
...
\begin{spellsection}{Resurrection}[3]
...
\begin{spellsection}{Retrieve Legacy}[3]
...
\begin{spellsection}{Scry Creature}[4]
...
\begin{spellsection}{Soul Bind}[5]
...
\begin{ability}{Telepathic Bond}[\glossterm{Attune} (ritual; see text)]
...
\begin{ability}{Water Breathing}[\glossterm{Attune} (ritual)]
