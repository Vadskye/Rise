    ...
    \subsection{Attribute Descriptions}
        ...
        \subsubsection{Strength (Str)}\label{Strength}
            ...
            \begin{itemize}
                ...
                \item Strength can be used for Climb, Jump, Sprint, and Swim checks. If your Strength is negative, you take a penalty to all Strength-based skill checks equal to your Strength.
        ...
        \subsubsection{Dexterity (Dex)}\label{Dexterity}
            ...
            \begin{itemize}
                ...
                \item Dexterity can be used for Balance, Escape Artist, Ride, Sleight of Hand, Stealth, and Tumble checks. If your Dexterity is negative, you take a penalty to all Dexterity-based skill checks equal to your Dexterity.
        ...
        \subsubsection{Intelligence (Int)}\label{Intelligence}
            ...
            \begin{itemize}
                \item Intelligence is added to Craft, Disguise, Heal, Knowledge, and Linguistics checks. If your Intelligence is negative, you take a penalty to all Intelligence-based skill checks equal to your Intelligence.
        ...
        \subsubsection{Perception (Per)}\label{Perception}
            ...
            \begin{itemize}
                ...
                \item Perception can be used for Awareness, Creature Handling, Sense Motive, Spellcraft, and Survival checks. If your Perception is negative, you take a penalty to all Perception-based skill checks equal to your Perception.
        ...
        \subsubsection{Point Buy}
            ...
            \begin{dtable}
                ...
                \begin{dtabularx}{\columnwidth}{X X}
                    ...
                    5       & 8             \\
                \end{dtabularx}
                1 If you reduce an attribute below 0, it is a \glossterm{flawed attribute} (see Flawed Attributes, below).
                You cannot reduce more than two attributes below 0 in this way.
            \end{dtable}

        \subsubsection{Flawed Attributes}\label{Flawed Attributes}
            If you reduce an attribute below 0 at character creation, it is considered a flawed attribute.
            A flawed attribute cannot be increased by the attribute increases you gain as you gain levels (see \pcref{Character Advancement}).
...
\section{Combat Overview}\label{Combat Overview}
    ...
    \subsection{Special Actions}
        ...
        Most full-round actions involve a combination of movement and concentrated effort, such as \glossterm{charging} to strike a distant foe or running at full speed.
    ...
    \subsection{Injury, Death, and Healing}\label{Injury, Death, and Healing}
        ...
        \subsubsection{Hit Points}\label{Hit Points}
            ...
            Your hit points are equal to your \glossterm{hit value} \mtimes your level.
    ...
    \subsection{Circumstances, Bonuses, and Penalties}
        ...
        \subsubsection{Size in Combat}\label{Size in Combat}
            ...
            \begin{dtable*}
                ...
                3 Modifies maneuver accuracy, maneuver defense, and Fortitude defense. The opposite modifier applies to Stealth.  \\
            \end{dtable*}
