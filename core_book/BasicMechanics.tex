...
\section{Combat Overview}\label{Combat Overview}
    ...
    \subsection{Attacks}\label{Attacks}
        ...
        \subsubsection{Standard Attack}\label{Standard Attack}
            ...
            For details, see \pcref{Multiple Attacks}.
    ...
    \subsection{Defenses}\label{Defenses}
        ...
        \subsubsection{Defense Values}\label{Defense Values}
            ...
            \begin{figure}[h]
                \centering 10 \add Base defense bonus or defense attribute \add other bonuses and penalties
            \end{figure}
            ...
            For Fortitude, Reflex, and Mental defense, primary defense bonus is equal to your character level.
    ...
    \subsection{Circumstances, Bonuses, and Penalties}
        ...
        \subsubsection{Overwhelm}\label{Overwhelm}
            ...
            A creature's overwhelm penalties cannot exceed \minus8.
