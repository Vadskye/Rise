...
\section{Weapons}
    ...
    \subsection{Weapon Properties}\label{Weapon Properties}
        ...
        \begin{magicitemdef}{Fixating}[Active]{4}[Melee]{Divination}{as weapon}
            ...
            Until the end of the round, all of your successful \glossterm{strikes} are critical hits against creature that you hit with strikes in both of the last two rounds.
