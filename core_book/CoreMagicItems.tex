...
\section{Apparel}
    ...
    \subsection{Legs}
        ...
        \begin{magicitemdef}{Boots of Swift Passage}[Active]{2}[Legs]{Conjuration [Teleportation]}{leather or textiles}
            \magicitemability{Active}[Move action] If you take three rapid steps in the shape of a triangle, you can teleport to an unoccupied location within \rngclose range of your original location.
