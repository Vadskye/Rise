...
\section{Weapons}
    ...
    \subsection{Weapon Properties}\label{Weapon Properties}
        ...
        \begin{magicitemdef}{Fixating}[Active]{4}[Melee]{Divination}{as weapon}
            \magicitemability{Triggered}[Immediate action] When you hit a foe with this weapon, if you successfully hit that creature with this weapon in both of the last two rounds, you can activate it.
            If you do, the attack becomes a critical hit.
