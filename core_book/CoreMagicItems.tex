...
\section{Apparel}
    ...
    \subsection{Armor Special Abilities}\label{Armor Special Abilities}
        ...
        \begin{magicitemdef}{Bashing}[Passive]{1}[Shield]{Transmutation [Imbuement]}{as shield}
        ...
        \begin{magicitemdef}{Feather}{1}[Body, Shield]{Transmutation (Imbuement)}{as armor}
        ...
        \begin{magicitemdef}{Fortified}[Passive]{3}[Body]{Transmutation [Imbuement]}{as armor}
    ...
    \subsection{Arms}
        ...
        \begin{magicitemdef}{Bracers of Archery}[Passive]{1}[Arms]{Transmutation (Imbuement)}{leather or metal}
        ...
        \begin{magicitemdef}{Throwing Gloves}[Passive]{2}[Arms]{Transmutation [Imbuement]}{leather or textiles}
    ...
    \subsection{Legs}
        ...
        \begin{magicitemdef}{Boots of Elvenkind}[500]{1}[Legs]{Transmutation [Imbuement]}{leather or textiles}
        ...
        \begin{magicitemdef}{Boots of Mobility}[1000]{1}[Legs]{Transmutation [Imbuement]}{leather or textiles}
        ...
        \begin{magicitemdef}{Boots of Striding and Springing}[Passive]{3}[Legs]{Transmutation [Imbuement]}{leather or textiles}
        ...
        \begin{magicitemdef}{Boots of the Winterlands}[Passive]{1}[Legs]{Evocation/Transmutation [Imbuement]}{leather or textiles}
        ...
        \begin{magicitemdef}{Sandals of Sprinting}[500]{1}[Legs]{Transmutation [Imbuement]}{leather or textiles}
    ...
    \subsection{Rings}
        ...
        \begin{magicitemdef}{Animal Friendship}[500]{1}[Ring]{Transmutation [Imbuement]}{bone, metal, or jewelry}
        ...
        \begin{magicitemdef}{Invisibiility}[Active]{2}[Ring]{Illusion [Glamer]}{bone, metal, or jewelry}
    ...
    \subsection{Torso}
        ...
        \begin{magicitemdef}{Amulet of Mighty Fists}{1}[Torso]{Transmutation [Imbuement]}{bone or jewelry}
        ...
        \begin{magicitemdef}{Belt of Dwarvenkind}[Passive]{2}[Torso]{Divination/Transmutation [Imbuement]}{leather or textiles}
...
\section{Weapons}
    ...
    \subsection{Weapon Table}
        ...
        \begin{longtabuwrapper}
            \begin{longtabu}{l X l l l l}
                ...
                \tb{Name} & \tb{Description} & \tb{Cost} & \tb{Item Level} & \tb{Location} & \tb{Page} \\
    ...
    \subsection{Weapon Special Abilities}\label{Weapon Special Abilities}
        ...
        \begin{magicitemdef}{Longshot}[Passive]{2}[Ranged]{Transmutation [Imbuement]}{as weapon}
        ...
        \begin{magicitemdef}{Sweeping}[Active]{0}[Melee]{Transmutation [Imbuement]}{as weapon}
        ...
        \begin{magicitemdef}{Vorpal}[Passive]{8}[Melee]{Transmutation [Imbuement]}{as weapon}
...
\section{Implements}
    ...
    \subsection{Implement Table}
        ...
        \begin{longtabuwrapper}
            \begin{longtabu}{l X l l l l}
                ...
                \mitemref{Curses, Lesser} & Know \spell{curse of blood and bone} spell & \mitempricetable{Active}{2} & Arcane & \mitempref{Curses, Lesser} \\
                \mitemref{Acid} & Know \spell{acid arrow} spell & \mitempricetable{Active}{3} & Arcane & \mitempref{Acid} \\
                \mitemref{Cold, Lesser} & Know \spell{cone of cold} spell & \mitempricetable{Active}{3} & Arcane, Nature & \mitempref{Cold, Lesser} \\
                ...
                \mitemref{Curses} & Know \spell{curse of the wayward mind}, \spell{curse of blood and bone} spells & \mitempricetable{Active}{5} & Arcane & \mitempref{Curses} \\
                ...
                \mitemref{Time, Greater} & Know \spell{time stop}, \spell{slow}, \spell{haste} spells & Arcane & \mitempricetable{Active}{9} & \mitempref{Time, Greater} \\
            \end{longtabu}
        \end{longtabuwrapper}
        \twocolumn
    ...
    \subsection{Implement Enhancement Bonuses}\label{Implement Enhancement Bonuses}
        ...
        \begin{dtable}
            ...
            \begin{dtabularx}{\columnwidth} {>{\ccol}X c c}
                ...
                \plus2 & 750 gp    & 5th  \\
                \plus3 & 3,750 gp  & 9th  \\
                \plus4 & 18,750 gp & 13th \\
                \plus5 & 93,750 gp & 17th \\
            \end{dtabularx}
        \end{dtable}
    ...
    \subsection{Implement Types}
        ...
        \subsubsection{Holy Symbols}
            ...
            \parhead{Special Rules} Most holy symbols are designed to be worn as an amulet in addition to being held in the hand.
    ...
    \subsection{Implement Special Abilities}\label{Implement Special Abilities}
        ...
        \begin{magicitemdef}[Arcane]{Acid}[Active]{3}{Conjuration [Acid, Creation, Physical]}{as staff}
            \magicitemability{Attuned} While wielding this staff, you gain \spell{acid arrow} as a spell known.
            In addition, you can use item uses in place of spell slots to cast spells known from this staff.
        \end{magicitemdef}

        \begin{magicitemdef}[Arcane, Nature]{Cold, Lesser}[Active]{2}{Evocation [Cold]}{as staff}
            \magicitemability{Attuned} While wielding this staff, you gain \spell{cone of cold} as a spell known.
            In addition, you can use item uses in place of spell slots to cast spells known from this staff.
        \end{magicitemdef}

        \begin{magicitemdef}[Arcane, Nature]{Cold}[Active]{5}{Conjuration/Evocation [Cold, Creation, Destructive]}{as staff}
            \magicitemability{Attuned} While wielding this staff, you gain \spell{ice spike} and \spell{cone of cold} as spells known.
            In addition, you can use item uses in place of spell slots to cast spells known from this staff.
        \end{magicitemdef}

        \begin{magicitemdef}[Arcane, Nature]{Cold, Greater}[Active]{7}{Conjuration/Evocation [Cold, Creation, Destructive]}{as staff}
            \magicitemability{Attuned} While wielding this staff, you gain \spell{ice storm}, \spell{ice spike}, and \spell{cone of cold} as spells known.
            In addition, you can use item uses in place of spell slots to cast spells known from this staff.
        \end{magicitemdef}

        \begin{magicitemdef}[Arcane]{Curses, Lesser}[Active]{2}{Vivimancy [Curse]}{as staff}
            \magicitemability{Attuned} You gain \spell{curse of blood and bone} as a spell known.
            In addition, you can use item uses in place of spell slots to cast spells known from this staff.
        \end{magicitemdef}

        \begin{magicitemdef}[Arcane]{Curses}[Active]{5}{Vivimancy [Curse]}{as staff}
            \magicitemability{Attuned} You gain \spell{curse of the wayward mind} and \spell{curse of blood and bone} as spells known.
            In addition, you can use item uses in place of spell slots to cast spells known from this staff.
        \end{magicitemdef}

        \begin{magicitemdef}[Arcane, Nature]{Electricity, Lesser}[Active]{1}{Evocation [Electricity]}{as staff}
            \magicitemability{Attuned} While wielding this staff, you gain \spell{shocking grasp} as a spell known.
            In addition, you can use item uses in place of spell slots to cast spells known from this staff.
        \end{magicitemdef}

        \begin{magicitemdef}[Arcane, Nature]{Electricity}[Active]{3}{Evocation [Electricity]}{as staff}
            \magicitemability{Attuned} While wielding this staff, you gain \spell{lightning bolt} and \spell{shocking grasp} as spells known.
            In addition, you can use item uses in place of spell slots to cast spells known from this staff.
        \end{magicitemdef}

        \begin{magicitemdef}[Arcane, Nature]{Electricity, Greater}[Active]{6}{Evocation [Electricity]}{as staff}
            \magicitemability{Attuned} While wielding this staff, you gain \spell{chain lightning}, \spell{lightning bolt}, and \spell{shocking grasp} as spells known.
            In addition, you can use item uses in place of spell slots to cast spells known from this staff.
        \end{magicitemdef}

        \begin{magicitemdef}[Arcane, Nature]{Fire, Lesser}[Active]{1}{Evocation [Fire]}{as staff}
            \magicitemability{Attuned} While wielding this staff, you gain \spell{burning hands} as a spell known.
            In addition, you can use item uses in place of spell slots to cast spells known from this staff.
        \end{magicitemdef}

        \begin{magicitemdef}[Arcane, Nature]{Fire}[Active]{3}{Evocation [Fire]}{as staff}
            \magicitemability{Attuned} While wielding this staff, you gain \spell{fireball} and \spell{burning hands} as spells known.
            In addition, you can use item uses in place of spell slots to cast spells known from this staff.
        \end{magicitemdef}

        \begin{magicitemdef}[Arcane, Nature]{Fire, Greater}[Active]{7}{Evocation [Fire]}{as staff}
            \magicitemability{Attuned} While wielding this staff, you gain \spell{immolation}, \spell{fireball}, and \spell{burning hands} as spell known.
            In addition, you can use item uses in place of spell slots to cast spells known from this staff.
        \end{magicitemdef}

        \begin{magicitemdef}[Arcane]{Missiles, Lesser}[Active]{1}{Evocation}{as staff}
            \magicitemability{Attuned} While wielding this staff, you gain \spell{magic missile} as a spell known.
            In addition, you can use item uses in place of spell slots to cast spells known from this staff.
        \end{magicitemdef}

        \begin{magicitemdef}[Arcane]{Missiles}[Active]{4}{Evocation}{as staff}
            \magicitemability{Attuned} While wielding this staff, you gain \spell{missile storm} and \spell{magic missile} as spells known.
            In addition, you can use item uses in place of spell slots to cast spells known from this staff.
        \end{magicitemdef}

        \begin{magicitemdef}[Arcane, Nature]{Shielding, Lesser}[Active]{2}{Abjuration [Shielding]}{as staff}
            \magicitemability{Attuned} You gain \spell{inertial shield} as a spell known.
            In addition, you can use item uses in place of spell slots to cast spells known from this staff.
        \end{magicitemdef}

        \begin{magicitemdef}[Arcane, Nature]{Shielding}[Active]{4}{Abjuration/Evocation [Shielding]}{as staff}
            \magicitemability{Attuned} You gain \spell{fire shield} as spells known.
            In addition, you can use item uses in place of spell slots to cast spells known from this staff.
        \end{magicitemdef}

        \begin{magicitemdef}[Arcane]{Time, Lesser}[Active]{1}{Transmutation [Temporal]}{as staff}
            \magicitemability{Attuned} While wielding this staff, you gain \spell{haste} as a spell known.
            In addition, you can use item uses in place of spell slots to cast spells known from this staff.
        \end{magicitemdef}

        \begin{magicitemdef}[Arcane]{Time}[Active]{3}{Transmutation [Temporal]}{as staff}
            \magicitemability{Attuned} While wielding this staff, you gain \spell{slow} and \spell{haste} as spells known.
            In addition, you can use item uses in place of spell slots to cast spells known from this staff.
        \end{magicitemdef}

        \begin{magicitemdef}[Arcane]{Time, Greater}[Active]{9}{Transmutation [Temporal]}{as staff}
            \magicitemability{Attuned} While wielding this staff, you gain \spell{time stop}, \spell{haste}, and \spell{slow} as spells known.
            In addition, you can use item uses in place of spell slots to cast spells known from this staff.
        \end{magicitemdef}
