...
\section{Weapons}
    ...
    \subsection{Weapon Table}
        ...
        \begin{longtabuwrapper}
            \begin{longtabu}{l X l l l l}
                ...
                \mitemref{Thundering} & Can make deafening attack & \mitempricetable{Active}{3} & Any & \mitempref{Thundering} \\
    ...
    \subsection{Weapon Properties}\label{Weapon Properties}
        ...
        \begin{magicitemdef}{Fixating}[Active]{4}[Melee]{Divination}{as weapon}
            ...
            If you do, the attack gains a \plus20 bonus and scores a critical hit if it hits.
