...
\section{Item Description Format}
    ...
    An item's base power can affect its item power (see \pcref{Item Power}).
    ...
    \subsection{Apparel Table}
        ...
        \begin{longtabuwrapper}
            \begin{longtabu}{l X l l l l}
                ...
                \mitemref{Belt of Heroic Recovery} & Can heal when you roll a 20 & \mitempricetable{Active}{1} & Torso & \mitempref{Heroic Recovery} \\
...
\section{Implements}
    ...
    \subsection{Implement Table}
        ...
        \begin{longtabuwrapper}
            \begin{longtabu}{l X l l l l}
                \tb{Weapons} & \tb{Description} & \tb{Cost} & \tb{Item Level} & \tb{Page} \\
                \mitemref{Bane} & Special ability only works against some creatures & Varies & Varies & \mitempref{Bane} \\
                \mitemref{Sweeping} & Can make extra attack against another foe & \mitempricetable{Active}{0} & \mitempref{Sweeping} \\
                \mitemref{Rebounding} & Returns to you slowly when thrown & \mitempricetable{Passive}{0} & \mitempref{Rebounding} \\
                \mitemref{Forceful} & Can knock struck creature flying & \mitempricetable{Active}{1} & \mitempref{Forceful} \\
                \mitemref{Morphing} & Can transform into similar weapon & \mitempricetable{Active}{1} & \mitempref{Morphing} \\
                \mitemref{Surestrike} & Can reroll missed attack & \mitempricetable{Active}{1} & \mitempref{Surestrike} \\
                \mitemref{Flaming} & Can make powerful fire attack & \mitempricetable{Active}{2} & \mitempref{Flaming} \\
                \mitemref{Freezing} & Can make powerful cold attack & \mitempricetable{Active}{2} & \mitempref{Flaming} \\
                \mitemref{Shocking} & Can make powerful electricity attack & \mitempricetable{Active}{2} & \mitempref{Shocking} \\
                \mitemref{Thundering} & Can make deafening attack & \mitempricetable{Active}{2} & \mitempref{Thundering} \\
                \mitemref{Vampiric} & Can heal based on damage dealt & \mitempricetable{Active}{2} & \mitempref{Vampiric} \\
                \mitemref{Defending} & Grants defensive legend points instead of offensive & \mitempricetable{Passive}{2} & \mitempref{Defending} \\
                \mitemref{Returning} & Returns to you instantly when thrown & \mitempricetable{Passive}{2} & \mitempref{Returning} \\
                \mitemref{Thieving} & Can absorb objects & \mitempricetable{Active}{3} & \mitempref{Thieving} \\
                \mitemref{Transforming} & Can transform into any weapon & \mitempricetable{Active}{3} & \mitempref{Transforming} \\
                \mitemref{Poisoning} & Can instantly duplicate minor poison & \mitempricetable{Active}{3} & \mitempref{Poisoning} \\
                \mitemref{Fixating} & Can automatically critical after striking foe repeatedly & \mitempricetable{Active}{5} & \mitempref{Fixating} \\
                \mitemref{Disorienting} & Can disorient foe & \mitempricetable{Active}{6} & \mitempref{Disorienting} \\
                \mitemref{Toxic} & Can instantly coat itself with major poison & \mitempricetable{Active}{6} & \mitempref{Poisoning} \\
                \mitemref{Soulreaving} & Deals delayed damage instead of immediate damage & \mitempricetable{Passive}{7} & \mitempref{Soulreaving} \\
                \mitemref{Vorpal} & Deals massive damage on a natural 20 & \mitempricetable{Passive}{8} & \mitempref{Vorpal} \\

                \tb{Wands} & \tb{Description} & \tb{Cost} & \tb{Item Level} & \tb{Page} \\
                \mitemref{Distant} & Can double spell's range & \mitempricetable{Active}{2} & \mitempref{Distant} \\
                \mitemref{Flamespell} & Can ignite creature & \mitempricetable{Active}{3} & \mitempref{Flamespell} \\
                \mitemref{Frostspell} & Can fatigue creature & \mitempricetable{Active}{3} & \mitempref{Frostspell} \\
                \mitemref{Thunderspell} & Can stagger creature & \mitempricetable{Active}{3} & \mitempref{Thunderspell} \\
            \end{longtabu}
        \end{longtabuwrapper}
        \twocolumn
    ...
    \subsection{Weapon Special Abilities}\label{Weapon Special Abilities}
        ...
        \begin{magicitemdef}{Disorienting}[Active]{6}[Melee, Ranged]{Enchantment [Compulsion]}{as weapon}
            \magicitemability{Triggered}[Immediate action] When you hit a foe with this weapon, you can activate it to make the struck creature \disoriented for 5 rounds.
    ...
    \subsection{Wands}
        ...
        \subsubsection{Wand Enhancement Bonuses}\label{Wand Enhancement Bonuses}
            ...
            \begin{magicitemdef}{Distant}[Active]{2}{Universal}{as wand}
                \magicitemability{Triggered}[Immediate action] When you cast a spell affected by this wand, you can activate it.
...
\section{Tools}
    ...
    \subsection{Potions and Oils}
        ...
        Both potions and oils can only mimic the effects of spells with a casting time of a standard action or less.
        Potions can contain the effects of spells with a single target, or which affect the caster.
        Oils can only contain the effects of spells with a single target.
    ...
    \subsection{Wondrous Items}
        ...
        \begin{magicitemdef}{Witch's Broom}[Passive]{7}{Divination/Transmutation [Augment, Communication]}{wood}
