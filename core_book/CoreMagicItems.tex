        ...
        \subsubsection{Prices}\label{Armor Prices}
            ...
            \begin{dtable}
                ...
                \begin{dtabularx}{\columnwidth} {>{\ccol}X c c}
                    \tb{Enhancement Bonus} & \tb{Base Price} & \tb{Item Level} \tableheaderrule
                    \plus1 & 100 gp    & 2nd  \\
                    \plus2 & 500 gp    & 4th  \\
                    \plus3 & 2,500 gp  & 8th  \\
...
\section{Implements}
    ...
    \subsection{Implement Properties}\label{Implement Properties}
        ...
        \begin{magicitemdef}[Divine]{Sympathetic}[Active]{3}{Vivimancy [Life]}{as implement}
            ...
            If you do, you heal a willing creature within \rngclose range for hit points equal to the item's \glossterm{standard damage}.
...
\section{Tools}
    ...
    \subsection{Scrolls}
        ...
        You use your own \glossterm{power} to determine the effects of the spell.
    ...
    \subsection{Potions and Oils}
        ...
        \begin{dtable}
            ...
            \begin{dtabularx}{\columnwidth}{l X}
                \tb{Mishap Result} & \tb{Mishap Effect}                                       \tableheaderrule
    ...
    \subsection{Rituals}
        ...
        \begin{dtable}
            ...
            \begin{dtabularx}{\columnwidth}{X l l l }
                \tb{Ritual Level} & \tb{Cost to Perform} & \tb{Cost to Scribe} & \tb{Item Level} \tableheaderrule
    ...
    \subsection{Wondrous Items}
        ...
        \begin{dtable*}
            ...
            \begin{dtabularx}{\textwidth}{l l X X X}
                \tb{Size} & \tb{Bag Weight} & \tb{Weight Limit} & \tb{Base Price} & \tb{Item Level} \tableheaderrule
        ...
        \begin{magicitemdef}{Candle of Truth}[Active]{2}{Enchantment [Compulsion]}{alchemy}
    ...
    \subsection{Special Material Descriptions}
        ...
        \begin{dtable*}
            ...
            \begin{dtabularx}{\columnwidth}{l l X l l}
                \tb{Material Name} & \tb{Material Type} & \tb{Effect} & \tb{Weapon Price (Level)} & \tb{Armor Price (Level)} \tableheaderrule
        ...
        Adamantine weapons grant a \plus1d bonus to damage with attacks that deal only \glossterm{physical damage}.
        Adamantine body armor grants double its normal bonus to \glossterm{resistances} against \glossterm{physical damage}.
