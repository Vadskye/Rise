...
\section{Weapons}
    ...
    \subsection{Weapon Properties}\label{Weapon Properties}
        ...
        \begin{magicitemdef}{Vampiric}[Active]{2}[Melee]{Necromancy [Life]}{as weapon}
            \magicitemability{Active}[Move action] If you lick the striking part of this weapon, you regain hit points equal to the physical damage dealt by the weapon on its last successful attack.
...
\section{Tools}
    ...
    \subsection{Scrolls}
        ...
        The spellpower of a spell cast from a scroll is normally equal to twice the spell's level.
