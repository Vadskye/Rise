...
\tb{Magic Item}  & \tb{Feat}  & \tb{Item Cost}  & \tb{Material Components\fn{2}} & \tb{Magic Supplies Cost}  & \tb{Base Price} \\
\hline
Armor  & Craft Magic Arms and Armor & Armor  & Cost \x 50 (usually none) & 1/2 the value on Table: Armor and Shields & Value on Table: Armor and Shields \\
Shield   & Craft Magic Arms and Armor & Shield  & \x 50 (usually none) & 1/2 the value on Table: Armor and Shields & Value on Table: Armor and Shields \\
Weapon  & Craft Magic Arms and Armor & Weapon  & \x 50 (usually none)  & 1/2 the value on Table: Weapons  & Value on Table: Weapons \\
Potion  & Brew Potion &   -   & Cost (usually none) & 1/2 \x 25 \x level of spell \x level of caster & 25 \x level of spell \x level of caster \\
Ring  & Forge Ring  &  -  &  \x 50  & Special, see Table: Estimating Magic Item Gold Price Values, below & Special, see Table: Estimating Magic Item Gold Price Values, below \\
Rod  & Craft Rod  & \fn{1}  & \x 50 (often none) & Special, see Table: Estimating Magic Item Gold Price Values, below & Special, see Table: Estimating Magic Item Gold Price Values, below \\
Scroll  & Scribe Scroll  &  -   & Cost (usually none) & 1/2 \x 12.5 \x level of spell \x level of caster & 12.5 \x level of spell \x level of caster \\
Staff  & Craft Staff  & Quarterstaff (0 gp) & \x 50 / (\# of charges used to activate spell) & See Creating Staffs, below  & See Creating Staffs, below \\
Wand  & Craft Wand  &  -   & \x 50  &  1/2 \x 375 \x level of spell \x level of caster   & 375 \x level of spell \x level of caster \\
Wondrous Item  & Craft Wondrous Item  & -  & \x 50 (usually none) & Special, see Table: Estimating Magic Item Gold Price Values, below & Special, see Table: Estimating Magic Item Gold Price Values, below \\
\end{dtabularx}
...
\tb{Effect}  & \tb{Base Price}  & \tb{Example} \\
\hline
Ability bonus  & Bonus squared  \x 2,000 gp  & Gloves of Dexterity \plus2 \\
Armor bonus  & Bonus squared  \x 1,000 gp  & \plus1 chainmail \\
Bonus spell  & Spell level  \x 2,000 gp  & Pearl of power \\
AD bonus (deflection)  & Bonus squared  \x 1,000 gp  & Ring of protection \plus3 \\
AD bonus (dodge)  & Bonus squared  \x 1,500 gp & Ioun stone, dusty rose prism \\
AD Bonus (natural armor)  & Bonus squared  \x 1,000 gp  & Amulet of natural armor \plus1 \\
Save bonus  & Bonus squared  \x 1,000 gp  & Cloak of resistance \plus5 \\
Skill bonus  & Bonus squared  \x 100 gp  & Cloak of elvenkind \\
...
Spell resistance  & SR \x 5000  & Mantle of spell resistance \\
Weapon bonus  & Bonus squared  \x 1,000 gp  & \plus1 longsword \\
Attack bonus & Bonus squared \x 1,000 gp & Bracers of archery \\
Damage bonus & Bonus squared \x 1,000 gp &  \\
\tb{Spell Effect}  & \tb{Base Price}  & \tb{Example} \\
%I would prefer the numbers at 20 and 40, but the difference is not worth the inconvenient prices.
Single use, spell completion  & Spell level \x caster level  \x 25 gp  & Scroll of \spell{haste} \\
Single use, use-activated  & Spell level \x caster level  \x 50 gp  & Potion of \spell{cure light wounds} \\
25 charges, spell trigger  & Spell level \x caster level  \x 250 gp  & Wand of \spell{fireball} \\
Command word or other activation & Spell level \x caster level  \x 1,000 gp\fn{1} & Cape of the mountebank \\
Use-activated or continuous  & Spell level  \x caster level  \x 1,000 gp\fn{2} & Lantern of revealing \\
\tb{Special}  & \tb{Base Price Adjustment}  & \tb{Example} \\
...
\tb{Component}  & \tb{Extra Cost}  & \tb{Example} \\
