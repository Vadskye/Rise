...
\section{Crew Roles}\label{Crew Roles}
  ...
  \subsection{Pilot}
    ...
    \cf{Pil}[2]{Evasive Maneuvers} As a standard action, you can choose one enemy ship you are aware of.
      Your ship \glossterm{briefly} gains a \plus1 bonus to its Armor and Reflex defenses.
  ...
  \subsection{Warder}
    ...
    \cf{Wrd}[1]{Active Defense} As a standard action, you can \glossterm{briefly} give the ship a \plus2 bonus to all defenses.
