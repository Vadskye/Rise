...
\section{Ship Statistics}
  ...
  \subsection{Elite Ships}\label{Elite Ships}
    ...
    \begin{raggeditemize}
      ...
      \item Elite ships can take an additional \glossterm{elite action} each turn, just like elite monsters.
...
\section{Ship Resources and Strain}
  Ships do not have normal resources like characters do, such as stamina and insight points.
  However, ships do have a strain level.
  This functions similarly to a character's stamina.
...
\section{Ship Movement}
  A ship can take one \glossterm{move action} on the pilot's turn.
  Ships without a pilot do not move normally, though they may drift.
  ...
  \subsection{Ship Heading}
    ...
    \subsubsection{Reversing}
      ...
      First, the ship must not have used more than half its movement during its previous turn to travel forward.
...
\section{Ship Armor}\label{Ship Armor}
  ...
  \begin{raggeditemize}
    ...
    \item Medium armor: Ships with medium armor gain a \plus2 bonus to Armor defense.
      ...
      In addition, their \glossterm{speed} is calculated as if they were one size category smaller (see \pcref{Ship Size}).
    ...
    \item Heavy armor: Ships with heavy armor gain a \plus3 bonus to Armor defense.
      ...
      In addition, their \glossterm{speed} is calculated as if they were two size categories smaller (see \pcref{Ship Size}).
  ...
  %             With customization, a ship can gain a \plus1 bonus to Armor defense, a \plus2 bonus to any other defense, or become \resistant to one of the following damage types: acid, cold, electricity, or fire.
...
\section{Ship Weapons}\label{Ship Weapons}
  ...
  \subsection{Ship Weapon Tags}\label{Ship Weapon Tags}
    ...
    % +1dr for Slow Reload to Slow Load, +1dr for (1) to (2), then +1dr for each subsequent turn
    \weapontagdef{Slow Load} This weapon requires multiple turns to load before it can fire.
    The number of turns required to finish loading before it can be fired is indicated in its description.
    For example, a weapon with Slow Load (1) could be fired every other turn.
    Only turns where the weapon is being fully crewed count towards this load time.

    \weapontagdef{Volatile} This weapon must be fired immediately after being loaded.
    If it is not fired during the turn after its loading time is completed, the loading is wasted, and the weapon must be loaded again before it can fire.
...
\section{Crew Roles}\label{Crew Roles}
  ...
  Fully defining life on a ship is outside the scope of this simplified version of ship combat.
  ...
  A sufficiently large ship can have more than one member of each crew role other than pilot.
  ...
  \subsection{Boatswain}
    ...
    \cf{Bsn}[1]{Ensure Competence} Whenever a crew member on the ship makes a ship-related check that you are aware of, you can spend two \glossterm{stamina}.
    ...
    \cf{Bsn}[2]{Specialized Encouragement}
      \begin{activeability}{Specialized Encouragement}{Standard action}
        ...
        \begin{raggeditemize}
          \item Evasion: The ship \briefly gains a \plus1 bonus to all defenses.
          \item Travel: The ship \briefly gains a \plus10 foot bonus to its \glossterm{speed}.
          \item Weapons: Attacks with the ship's weapons \briefly gain a \plus1 accuracy bonus.
          \item Desperate Rally: The ship \briefly gains the Evasion, Travel, and Weapons benefits from this ability.
        ...
        Changing your location to be able to provide a different benefit with this ability typically takes one turn of movement for each size category by which the ship is larger than Huge.
    ...
    \cf{Bsn}[5]{Ensure Competence+} When you use this ability to affect a creature other than yourself, you only spend one \glossterm{stamina}.
  ...
  \subsection{Fixer}
    ...
    \cf{Fix}[2]{Temporary Seal} You can make a Craft check relevant to the ship to temporarily stop a leak in a ship without expensive materials.
      ...
      This does not remove the vital wound, and this ability has a \glossterm{limit} of one leak.
    ...
    \cf{Fix}[6]{Temporary Seal+} The ability's limit increases to two leaks.
  ...
  \subsection{Gunner}
    ...
    \cf{Gun}[3]{Weapons Coordination} As a \glossterm{minor action}, you can choose one ship weapon whose crew can see or hear you.
      Until your next turn, that weapon gains your benefits from this crew role as if you were the one firing it.
  ...
  \subsection{Pilot}
    ...
    A ship can only have one pilot.

    \cf{Pil}[1]{Desperate Sprint} As a standard action, you can increase the ship's strain level by one.
      If you do, the ship moves up to its speed without reducing its \glossterm{available movement}.

    \cf{Pil}[2]{Evasive Maneuvers} As a standard action, you can choose one enemy ship you are aware of.
      Your ship \briefly gains a \plus1 bonus to its Armor and Reflex defenses against that ship.
    ...
    \cf{Pil}[7]{Desperate Sprint+} When you use this ability, the ship also \briefly gains a \plus20 bonus to its speed.
  ...
  \subsection{Warder}
    ...
    \cf{Wrd}[1]{Active Defense} As a standard action, you can \briefly give the ship a \plus2 bonus to all defenses.
    ...
    \cf{Wrd}[2]{Specialized Ward} As a standard action, you can activate one of the following effects.
      ...
      \begin{raggeditemize}
        \item Desperate Fortification: Whenever the ship would take damage, that damage is halved.
          At the end of your turn, if the ship took damage in excess of your rank in this crew role since your last turn, it increases its strain level by two.
        ...
        \item Mystic Ward: The ship gains a \plus1 \glossterm{enhancement bonus} to all defenses against \magical attacks.
      \end{raggeditemize}
    ...
    \cf{Wrd}[3]{Ship of Magic} You gain a \plus1 accuracy with \magical abilities, including magical ship weapons, while on the ship.
      ...
      If you do, the stamina cost required to perform the ritual is reduced by an amount equal to twice your rank in this crew role.
    ...
    \cf{Wrd}[6]{Ship of Magic+} The accuracy bonus increases to \plus2.
      In addition, the stamina cost reduction increases to three times your rank in this crew role.

    \cf{Wrd}[7]{Specialized Ward} The benefits from this ability improve.
      \begin{raggeditemize}
        \item Desperate Fortification: The threshold for gaining strain increases to three times your rank in this crew role.
