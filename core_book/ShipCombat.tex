...
\section{Crew Roles}\label{Crew Roles}
  ...
  \subsection{Boatswain}
    ...
    \cf{Bsn}[2]{Specialized Encouragement}
      \begin{activeability}{Specialized Encouragement}{Standard action}
        ...
        \begin{raggeditemize}
          \item Evasion: The ship \momentarily gains a \plus1 bonus to all defenses.
          \item Travel: The ship \momentarily gains a \plus10 foot bonus to its movement speed.
          \item Weapons: Attacks with the ship's weapons \momentarily gain a \plus1 accuracy bonus.
          \item Desperate Rally: The ship \momentarily gains the Evasion, Travel, and Weapons benefits from this ability.
  ...
  \subsection{Pilot}
    ...
    \cf{Pil}[2]{Evasive Maneuvers} As a standard action, you can choose one enemy ship you are aware of.
      Your ship \momentarily gains a \plus1 bonus to its Armor and Reflex defenses against that ship.
  ...
  \subsection{Warder}
    ...
    \cf{Wrd}[1]{Active Defense} As a standard action, you can \momentarily give the ship a \plus2 bonus to all defenses.
