\chapter{Ship Combat}
    ...
    \subsection{Ship HP and DR}
        ...
        Armor also gives ships a bonus to their damage resistance, as listed in \pcref{Ship Armor}.
    ...
    \subsection{Ship Size}
        ...
        \begin{dtable}
            \lcaption{Ship Size}
            \begin{dtabularx}{\columnwidth}{l l l l >{\lcol}X >{\lcol}X}
                \tb{Size}  & \tb{Min Level} & \tb{Elite?} & \tb{Crew}\fn{1} & \tb{Armor}      & \tb{Space} & \tb{Speed} \tableheaderrule
