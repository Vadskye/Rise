...
\section{Combat Statistics}\label{Combat Statistics}
  ...
  \begin{raggeditemize}
    ...
    \item Defenses: These affect how likely you are to avoid being hit by attacks.
    ...
    \item Injury point: If your hit points drop below your injury point, you are \glossterm{injured}.
      This has no direct effects, but some attacks against you are more effective if you are injured.
...
\section{Resources}
  ...
  \begin{raggeditemize}
    ...
    \item Stamina: Spent to use special abilities. If your current stamina drops below 0, you take a penalty to your accuracy and checks.
...
\section{Narrative Customization}
  ...
  For details, see \pcref{Alignment}, \pcref{Age and Appearance}, and \pcref{Backgrounds}.
...
\section{Classes}
  ...
  The eleven classes are summarized below.
...
\section{Skills}
  ...
  The twenty-two skills are summarized below.

  \begin{raggeditemize}
    \item Analysis: This represents your ability to make logical deductions, search areas for hidden features, and inspect items.
    \item Athletics: This represents your ability to move with power, such as climbing, jumping, and swimming.
    \item Awareness: This represents your ability to observe things which you might otherwise fail to notice.
    \item Craft: This represents your ability to construct objects from raw materials.
    ...
    \item Knowledge: This represents your understanding of particular aspects of the world.
    \item Medicine: This represents your practical understanding of how to tend to the wounds of living creatures.
    \item Might: This represents your ability exert your strength in burst of power, such as by breaking or throwing objects.  
    \item Perform: This represents your ability to create particular forms of entertainment.
    \item Persuasion: This represents your ability to convince people to think what you want them to.
    \item Poise: This represents your ability to maintain your balance on unsteady terrain and control horses and other mounts.
    \item Profession: This represents your practical understanding of a particular profession.
