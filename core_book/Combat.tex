...
\section{Making Attacks}\label{Attacks}
    ...
    \subsection{Attack Rolls}\label{Attack Rolls}
        ...
        \subsubsection{Critical Hits}\label{Critical Hits}
            ...
            You cannot normally get a critical hit with a melee attack against a creature that is two or more size categories larger than you (see \pcref{Size Categories}).
    ...
    \subsection{Dealing Damage}\label{Dealing Damage}
        ...
        \subsubsection{Dice Pools}\label{Dice Pools}
            ...
            Some modifiers add \glossterm{die increments} to increase the value of a dice pool.
    ...
    \subsection{Weapon Damage}\label{Weapon Damage}
        ...
        You gain a \plus1d bonus to your weapon damage for every 2 \glossterm{power} you have (see \pcref{Power}).
        Strikes are typically \glossterm{mundane}, so you would use your \glossterm{mundane power}.
        However, you might use your \glossterm{magical power} instead for \glossterm{magical} strikes.

        \subsubsection{Weak Strikes}
            Some abilities make weak strikes, which deal less damage than normal strikes.
            When you make a weak strike, you roll your \glossterm{weapon damage} twice and take the lower result.
...
\section{Universal Abilities}\label{Universal Abilities}
    ...
    \subsection{Strikes}\label{Strikes}
        ...
        \begin{activeability}{Basic Strike -- Melee}
            ...
            If you do, you take a \minus1 accuracy penalty to both attacks for each non-\weapontag{Light} weapon you attack with in this way.

            \hit The target takes \glossterm{weapon damage} from each weapon you hit with (see \pcref{Weapon Damage}).
        ...
        \begin{activeability}{Basic Strike -- Projectile}
            ...
            \hit The target takes damage from the weapon (see \pcref{Weapon Damage}).
            \crit You roll twice as many damage dice with the attack, as normal for critical hits (see \pcref{Critical Hits}).
        \end{activeability}
        ...
        \begin{activeability}{Basic Strike -- Thrown}
            \label{Thrown Strike}
            \rankline
            Choose one or two non-projectile weapons that you are wielding and are able to attack with.
            ...
            If you do, your \glossterm{range limits} are 10/30, and you take a \minus2 accuracy penalty since you are not \glossterm{proficient} with that usage of the weapon (see \pcref{Weapon Proficiency}).
        ...
        \subsubsection{Dual Wielding}\label{Dual Wielding}
            ...
            Both attacks must have the same primary target, and each attack deals its full \glossterm{weapon damage} if it hits.

            Dual-wielding has three downsides.
            First, you cannot get a \glossterm{glancing blow} with either weapon while attacking with two weapons at once (see \pcref{Glancing Blows}).
            If you would miss by 1 or 2, it is considered a full miss instead of a glancing blow.
            Second, it works best with \weapontag{Light} weapons.
            For each non-Light weapon you dual-wield with, you take a \minus1 accuracy penalty with both attacks.
            Third, \glossterm{extra damage} never applies more than once to a single strike.
            Extra damage applies if you hit with either weapon, but you don't double extra damage if you hit with both weapons.
            You can choose which weapon is considered to deal the extra damage after determining which weapons hit.
    ...
    \subsection{Special Combat Abilities}\label{Special Combat Abilities}
        ...
        \begin{activeability}{Trip}[\abilitytag{Size-Based}]
            ...
            In addition, if you made the attack with a Tripping weapon and the attack also beat the target's Armor defense, the target takes \glossterm{weapon damage} based on your weapon.
