...
\section{Combat Time}\label{Combat Time}
    ...
    \subsection{Actions}\label{Actions}
        ...
        \subsubsection{Move Actions}\label{Move Actions}
            ...
            You can take one move action during the \glossterm{movement phase} of each round.
            In addition, you can choose to replace your standard action during the action phase with an additional move action.
...
\section{Universal Abilities}\label{Universal Abilities}
    ...
    \subsection{Special Combat Abilities}\label{Special Combat Abilities}
        ...
        \begin{activeability}{Disarm}[\abilitytag{Size-Based}]
            \rankline
            ...
            In addition, if it is \glossterm{attended}, your attack result beat the target's Fortitude defense, and the object is not well secured, you can choose to knock it loose.
            ...
            In addition, objects held in two hands are considered well secured.
        \end{activeability}
