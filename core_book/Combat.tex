...
\section{Movement and Positioning}\label{Movement and Positioning}
    ...
    \subsection{Movement Modes}\label{Movement Modes}
        ...
        It must not be carrying weight in excess of its maximum \glossterm{weight limits} (see \pcref{Weight Limits}).
    ...
    \subsection{Flying Mechanics}\label{Flying Mechanics}
        A creature with a fly speed cannot fly while it is carrying weight in excess of its maximum \glossterm{weight limits} (see \pcref{Weight Limits}).
