...
\section{Combat Time}\label{Combat Time}
    ...
    \subsection{Resolving Actions}\label{Resolving Actions}
        ...
        \subsubsection{Swift Abilities}\label{Swift Abilities}
            ...
            Almost all healing abilities are also Swift, so they heal creatures before they take damage from incoming attacks.
            Swift abilities don't get much more complicated than that.
        ...
        \subsubsection{Action Resolution Summary} 
            \begin{enumerate*}
                \item Start of phase effects resolve globally
                ...
                \item End of phase effects resolve globally
            \end{enumerate*}
...
\section{Awareness and Surprise}\label{Awareness and Surprise}
    ...
    \subsection{Surprise Attacks}\label{Surprise Attacks}
        ...
        Generally, this should start in \glossterm{action phase}, though sometimes the \glossterm{movement phase} is more advantageous for the attackers.
