...
\section{Making Attacks}\label{Attacks}
    ...
    \subsection{Attack Rolls}\label{Attack Rolls}
        ...
        \subsubsection{Glancing Blows}\label{Glancing Blows}
            ...
            If you get a glancing blow with a damaging attack, you roll half as many damage dice, including any \glossterm{extra damage}.
            % If you removed largest dice, going from 2d10 to 2d10+1d4 would actually reduce glancing blow damage
            You can choose which of your dice to keep.
            If you would normally only roll one die, the glancing blow has no effect and is treated as a miss.
        ...
        \subsubsection{Critical Hits}\label{Critical Hits}
            ...
            For every increment of 10 by which you beat the target's defense, you double the number of damage dice you roll, including any \glossterm{extra damage}.
...
\section{Universal Abilities}\label{Universal Abilities}
    ...
    \subsection{Strikes}\label{Strikes}
        ...
        However, wielding two weapons can allow you to use the \ability{offhand strike} ability (see \pcref{Offhand Strike}).
    ...
    \subsection{Special Combat Abilities}\label{Special Combat Abilities}
        ...
        \begin{activeability}{Offhand Strike}
            \rankline
            Make a \glossterm{strike} with a \minus2 accuracy penalty.
            ...
            \glossterm{Extra damage} from any source does not apply to this strike.
            ...
            Your Dexterity must be at least 2 to use this ability.
