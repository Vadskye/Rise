...
\section{Movement and Positioning}\label{Movement and Positioning}
    ...
    \subsection{Jumping}\label{Jumping}
        ...
        A jump's maximum horizontal distance with a running start of at least 10 feet is equal to a quarter of your \glossterm{base speed}, plus 5 feet per Strength.
        If you do not have a running start, your horizontal jump distance is halved.
        A jump's maximum vertical height is equal to half your forward jump distance.

        Jumping off of terrain that is not solid ground, such as a wall, halves your jump distance.
...
\section{Universal Abilities}\label{Universal Abilities}
    ...
    \subsection{Special Combat Abilities}\label{Special Combat Abilities}
        ...
        \begin{activeability}{Recover}[\abilitytag{Exertion}, \abilitytag{Swift}]
            ...
            You regain all of your \glossterm{damage resistance} and half of your total \glossterm{hit points}.
