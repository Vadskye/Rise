...
\section{Aerial Movement}\label{Aerial Movement}
    ...
    \trait{Incorporeal} and \trait{floating} creatures do not fall in this way.
    ...
    \subsection{Gliding}\label{Gliding}
        ...
        Since \trait{incorporeal} and \trait{floating} creatures cannot fall, they also cannot glide.
