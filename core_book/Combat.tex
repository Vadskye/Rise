...
\section{Movement and Positioning}\label{Movement and Positioning}
    ...
    \subsection{Movement Abilities}\label{Movement Abilities}
        ...
        \begin{instantability}{Block}
            ...
            Usually, blocking a target requires that you beat the target on an opposed \glossterm{initiative} check.
        ...
        \begin{instantability}{Follow}
            ...
            If you fail at the initiative check, or if you cannot tell where the target went, you stop moving when you become adjacent to the position where it disappeared.
        \end{instantability}
