...
\section{Making Attacks}\label{Attacks}
    ...
    \subsection{Dealing Damage}\label{Dealing Damage}
        ...
        \subsubsection{Dice Pools}\label{Dice Pools}
            ...
            Dice smaller than 1d6 are rarely used in dice pools.
            \begin{itemize}
...
\section{Universal Abilities}\label{Universal Abilities}
    ...
    \subsection{Strikes}\label{Strikes}
        ...
        Your \glossterm{damage} with a strike is normally determined by your \glossterm{mundane power} and the damage dice for the weapon you hit with (see \pcref{Strike Damage}).
        ...
        \subsubsection{Strike Damage}\label{Strike Damage}
            ...
            Almost all strikes are considered \glossterm{mundane} abilities, so you would normally use your \glossterm{mundane power} to determine their damage (see \pcref{Power}).
