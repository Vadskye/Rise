...
\section{Movement and Positioning}\label{Movement and Positioning}
    ...
    \subsection{Combining Movement Modes}
        You can move using multiple different movement modes in the same phase.
        ...
        However, if you climb 10 feet and then are unable to swim or move on land, such as if you are partway up a cliff, you cannot move any farther.
