...
\section{Incarnation}
    ...
    \cf{Inc}[1]{Essence Pulse} You can use the \textit{essence pulse} ability as a standard action.
    ...
    \begin{raggeditemize}
        \item Tethered: The fatigue tolerance bonus increases to \plus2.
            In addition, when you use the \ability{desperate exertion} ability to affect an attack that deals damage of your essential damge type, you can use this ability.
        ...
        \item Untethered: The height limit of your fly speed increases to 30 feet.
            In addition, the defense bonus against critical hits from strikes increases to \plus10.
    \end{raggeditemize}

    \cf{Inc}[7]{Essence Incarnate} You can use this ability as a \glossterm{minor action}.
    When you do, you increase your \glossterm{fatigue level} by one, and you gain a benefit depending on whether you are tethered or untethered.
    ...
    \subsection{Vampire Archetype}
        ...
        \begin{magicalattuneability}{Creature of the Night}{\abilitytag{Attune}}
            ...
            \begin{raggeditemize}
                ...
                \item Mist: While in your mist form, you become \trait{floating} and \trait{intangible}.
                    You cannot speak and have no \glossterm{free hands}.
