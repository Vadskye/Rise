...
\skill{Balance}{Dex}
    ...
    \subsection{Common Balance Tasks}
        ...
        \parhead{Rapid Stand}\label{Rapid Stand} You make a \glossterm{difficulty value} 15 Balance check as a \glossterm{free action} to stand up from a prone position.
