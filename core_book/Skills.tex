...
\skill{Endurance}{Con}
    ...
    %     Ignoring your fatigue is a \glossterm{Swift} ability.
...
\skill{Perform}{Varies}
        ...
        While you are performing, you cannot use \glossterm{Focus} abilities.
...
\skill{Spellsense}{Per}
    ...
    \subsection{Notice Magical Effect}
        ...
        This ability has the \glossterm{Detection} tag, so you can detect magical effects through solid objects (see \pcref{Detection}).
...
\skill{Stealth}{Dex}
    ...
    \subsection{Avoid Notice}
        ...
        If it was originally \glossterm{unaware} of you, it stays unaware of you, and if it was originally \glossterm{partially aware} of you, it stays partially aware of you.
        ...
        Generally, success with sight-based senses causes creatures to become \glossterm{aware} of you, while success with other senses causes creatures to be \glossterm{partially aware} of you.
    ...
    \subsection{Hide [Hidden]}
        ...
        Success means that the observer becomes \glossterm{partially aware} of you instead of fully aware of you.
