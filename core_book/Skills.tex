...
\skill{Climb}{Str}
    ...
    \subsection{Climbing}
        You can make a Climb check as a \glossterm{move action} while you are touching a slope, a wall, or some other steep incline (or even a ceiling with handholds).
        ...
        Success means you can move a distance equal to the size of your space during the current phase, as described on \trefnp{Climb Speeds}.
