    ...
    \subsection{Skill Training}\label{Skill Training}
        ...
        \begin{itemize}
            ...
            \itemhead{Mastered} Mastering a skill costs two skill points.
                Your modifier with a mastered skill is equal to the skill's key attribute \add 2 or your level \add 2, whichever is higher.
                If the skill does not have a key attribute, your modifier is equal to your level.
        \end{itemize}
