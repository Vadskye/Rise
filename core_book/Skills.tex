...
\skill{Craft}{Int}
    ...
    \subsection{Identify Item}
        You can make a Craft check to identify an item of an unknown nature or purpose.
        This is most commonly used with Craft (alchemy) to identify potions or unusual alchemical items.
        You cannot use this ability to identify magical effects, since those are not caused by an item's physical construction.
        ...
        As a rough guideline, uncommon items with few distinguishing characteristics have a base \glossterm{difficulty value} of 5 \add twice the item's rank.
        If an item is intentionally crafted to be misleading or hard to identify, this \glossterm{difficulty value} increases by 10 or more.
...
\skill{Knowledge}{Int}
    ...
    Typical fields of study are listed below, but the GM may create additional fields or decide that some fields are irrelevant in a particular setting.
        \begin{itemize}
            \item Arcana (arcane spells, constructs, dragons, magical beasts)
            ...
            \item Local (myths and legends, laws and customs, history, nobility and royalty, nearby terrain and climate, nearby monsters)
            \item Nature (nature spells, animals, fae, monstrous humanoids, plants, seasons, weather)
