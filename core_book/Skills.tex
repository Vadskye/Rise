...
\section{Skill Overview}
    ...
    \subsection{Skill Modifiers}
        ...
        If you are \glossterm{trained} in a skill, your bonus with that skill is equal to 4 \add the higher of its associated attribute (if any) and half your level.
