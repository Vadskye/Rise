...
\section{Skill Description Format}
    ...
    \subsection{High Jump}
        As part of movement, you can make an Jump check to jump up. You achieve a height equal to one quarter of your Jump check result in feet. If you do not have a running start, making a high jump is more difficult (see \pcref{Running Start}).
