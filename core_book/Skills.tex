...
\section{Acquiring Skills}
    ...
    \subsection{Skill Points}\label{Skill Points}
        ...
        \subsubsection{Other Skill Points}
            ...
            You gain additional skill points equal to half your Intelligence (minimum 0).  Some other abilities, such as the Skill Savant feat (see \featpcref{Skill Savant}), can also grant additional skill points. Unless otherwise noted, these skill points can be spent on any skills.
...
\section{Skill Description Format}
    ...
    \subsection{Agile Charge}
        You can make a DR 20 Acrobatics check while \glossterm{charging} to change directions while charging.
    ...
    \subsection{Handling Creatures}
        ...
        \parhead{Push} As a standard action, you can make a DR 25 check to convince a willing creature to perform an action it is not trained to perform, but which it is physically capable of performing. This also covers making a creature perform a forced march and similar activities.
    ...
    \skill{Jump}{Str}
        ...
        Jumping without a running start is difficult, and you take a \minus10 penalty to all Jump checks.
    ...
    \subsection{Rebounding Leap}\label{Rebounding Leap}
        ...
        In addition, you take a \minus10 penalty to the check (after the halving), because rebounding off of an object in midair is difficult.
    ...
    \subsection{Track}\label{Track}
        ...
        A creautre can use the Awareness skill to notice signs of passage, but the Survival skill is necessary to follow tracks for any distance.
