    ...
    \subsection{Skill Training}\label{Skill Training}
        ...
        \begin{itemize}
            ...
            \itemhead{Trained} Becoming trained in a skill costs one skill point.
                ...
                If the skill does not have a key attribute, your modifier is equal to half your level \add 1.
            \itemhead{Mastered} Mastering a skill costs two skill points.
                ...
                If the skill does not have a key attribute, your modifier is equal to your level \add 3.
        \end{itemize}
...
\section{Skill Description Format}
    ...
    \subsection{Rapid Stand}
        ...
        Success means you stand up as a \glossterm{minor action}.
    ...
    \subsection{Accelerate Recovery}\label{Accelerate Recovery}
        If you tend to a creature during a \glossterm{short rest}, you can make a DR 10 Heal check to accelerate its recovery.
        ...
        % For a normal creature with 5 * level HP,
        % normal rest fully heals in 10 rests, or 50 minutes
        % DR 10 = 1x level per rest, so 5 rests, or 25 minutes
        % DR 15 = 2x level per rest, so 2.5 rests, or 15 minutes
        % DR 20 = 3x level per rest, so 2 rests, or 10 minutes
        % DR 30 = 5x level per rest, so 1 rest, or 5 minutes
        ...
        For every creature beyond that, you take a cumulative \minus2 penalty to your Heal check for all creatures.
