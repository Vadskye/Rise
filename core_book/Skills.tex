...
\skill{Acrobatics}{Dex}
    ...
    \subsection{Rapid Stand}
        As a \glossterm{minor action}, you can use the \textit{rapid stand} ability.
        \begin{ability}{Rapid Stand}[Swift]
            As a \glossterm{minor action}, you can make a DR 15 Acrobatics check to stand up from a prone position quickly.
...
\skill{Heal}{Int}
    ...
    \subsection{Accelerate Recovery}\label{Accelerate Recovery}
        ...
        Success means that it heals twice the normal number of hit points and \glossterm{vital damage} from its rest.
