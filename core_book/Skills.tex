...
\section{Skill Description Format}
    ...
    \subsection{Sprint}
        ...
        You can sprint for a number of rounds equal to twice your Constitution (minimum 2). After that time, you must rest for 5 minutes before you can sprint again. You can sprint in any movement mode that you have a speed for.
