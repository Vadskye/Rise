...
\skill{Craft}{Int}
    ...
    \subsection{Create Forgery}
        ...
        Forgeries which have a function, such as a weapon, are always defective in some way which makes them unsuitable for sustained usage, though they may function once or twice.
