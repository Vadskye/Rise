    ...
    \subsection{Create Item}
        ...
        \begin{dtable!*}
            ...
            \begin{dtabularx}{\textwidth}{>{\lcol}X l l l}
                ...
                Alchemical item or potion   & Alchemy          & 5 \add item level      & Eight hours                \\
...
\skill{Jump}{Str}
    ...
    \subsection{Rebounding Leap}\label{Rebounding Leap}
        While in midair, if you make contact with a solid object or \glossterm{ally} that can support your weight, you can jump off of it, as the \textit{leap} ability.
