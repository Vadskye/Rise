    ...
    \subsection{Class Skills}
        ...
        \begin{dtable!*}
            ...
            \begin{dtabularx}{\textwidth}{>{\lcol}p{12em} *{11}{>{\ccol}X} >{\ccol}p{4em}}
                ...
                Escape Artist     & C        & \tdash   & \tdash   & C        & \tdash   & C        & \tdash   & \tdash   & C        & \tdash   & Dex          \\
                Ride              & C        & \tdash   & \tdash   & C        & \tdash   & \tdash   & C        & \tdash   & \tdash   & C        & Dex          \\
                Sleight of Hand   & \tdash   & \tdash   & \tdash   & \tdash   & \tdash   & \tdash   & \tdash   & \tdash   & C        & \tdash   & Dex          \\
                Stealth           & \tdash   & \tdash   & \tdash   & \tdash   & \tdash   & C        & \tdash   & C        & C        & \tdash   & Dex          \\
                Craft             & C        & C        & C        & C        & C        & C        & C        & C        & C        & C        & Int          \\
                ...
                Heal              & C        & C        & C        & \tdash   & \tdash   & C        & C        & C        & \tdash   & \tdash   & Int          \\
