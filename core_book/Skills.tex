    ...
    \subsection{Skill Training}\label{Skill Training}
        ...
        \begin{itemize}
            ...
            \itemhead{Trained} Becoming trained in a skill costs one skill point.
                In addition, if the base value for one of your attributes is at least 2, you become trained in all of your \glossterm{class skills} associated with that attribute.
