...
\skill{Awareness}{Per}
    ...
    \subsection{Search}\label{Search}
        You can use the \textit{search} ability to closely investigate a small area.
        \begin{ability}{Search}
            As a standard action, you can use this ability.
            If you do, make a Awareness check to notice things in a single 5-ft.\ square within 10 feet of you.
...
\skill{Bluff}{---}
    ...
    \subsection{Conceal Threat}\label{Conceal Threat}
        ...
        \begin{ability}{Conceal Threat}[\glossterm{Sustain} (minor)]
            As a \glossterm{minor action}, you can use this ability.
            If you do, choose a \glossterm{threat} value you wish to portray and make a Bluff check.
...
\skill{Deduction}{Int}
    ...
    \begin{dtable}
        ...
        \begin{dtabularx}{\columnwidth}{l X X}
            \tb{Evidence Quality} & \tb{Example} & \tb{Modifier} \\
            \bottomrule
            ...
            Almost all evidence is irrelevant or misleading & Determining a historical truth by reading military propaganda & \minus10\plus\fn{1} \\
            All evidence is irrelevant or misleading & Determining a historical truth by reading a cookbook & \tdash\fn{2} \\

            \tb{Complexity} & \tb{Example} & \tb{Modifier} \\
            \bottomrule
            ...
            Exceptionally complex logic & A difficult logic puzzle & \minus10\plus \\
        \end{dtabularx}
...
\skill{Intimidate}{Varies}
    ...
    \subsection{Augment Threat}\label{Augment Threat}
        ...
        \begin{ability}{Augment Threat}[\glossterm{Sustain} (minor)]
            As a \glossterm{minor action}, you can use this ability.
        ...
        Your Intimidate check is opposed by the Sense Motive checks of anyone observing you.
        Success means that you gain a \plus5 bonus to \glossterm{threat} against anyone observing you.
