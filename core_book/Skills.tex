        ...
        \subsubsection{Opposed Checks}
            ...
            \begin{dtable}
                ...
                \begin{dtabularx}{\columnwidth}{*{3}{>{\lcol}X}}
                    ...
                    Lie                                 & Deception (\tdash)       & Sense Motive (Per)                   \\
...
\skill{Deception}{---}
    ...
    \subsection{Distract}\label{Distract}
        ...
        Your Deception check is opposed by your target's Sense Motive check.
...
\newpage
\skill{Heal}{Int}
        The Heal skill allows you to tend to the injuries and afflictions of others.
        In order to heal a creature, you must be able to see and touch it.
    ...
    \subsection{First Aid}\label{First Aid}
        As a standard action, you can make a Heal check to prevent a willing creature from dying from a \glossterm{vital wound} with a negative \glossterm{vital roll}.
        The \glossterm{difficulty rating} is equal to 5.
        Success means that the target gains a \plus1 bonus to the \glossterm{vital roll} for its most recent \glossterm{vital wound}, up to a maximum of 0.
        For every 10 points by which you succeed, the bonus increases by 1.
        After you modify the \glossterm{vital roll} this way, it cannot be modified again.
    ...
    \subsection{Treat Condition}\label{Treat Condition}
        As a standard action, you can make a Heal check to treat some specific conditions, such as from a caltrop.
