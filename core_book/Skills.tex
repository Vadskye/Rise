    ...
    \subsection{Class Skills}
        ...
        \begin{dtable!*}
            ...
            \begin{dtabularx}{\textwidth}{>{\lcol}p{12em} *{11}{>{\ccol}X} >{\ccol}p{4em}}
                \tb{Skill}        & \tb{Bbn} & \tb{Clr} & \tb{Drd} & \tb{Ftr} & \tb{Mge} & \tb{Mnk} & \tb{Pal} & \tb{Rgr} & \tb{Rog} & \tb{Sor} & \tb{War} & \tb{Key Ability} \\
                \bottomrule                                                                
                ...
                Perform           & \tdash   & \tdash   & \tdash   & \tdash   & \tdash   & C        & \tdash   & \tdash   & C        & \tdash   & \tdash   & Varies\fn{1}     \\
                Profession        & C        & C        & C        & C        & C        & C        & C        & C        & C        & C        & C        & Varies\fn{1}     \\
                Bluff             & C        & C        & C        & C        & C        & C        & C        & C        & C        & C        & C        & \tdash\fn{2}     \\
                Persuasion        & C        & C        & C        & C        & C        & C        & C        & C        & C        & C        & C        & \tdash\fn{2}     \\
            \end{dtabularx}
            C\@: class skill \\
...
\skill{Creature Handling}{Per}
    ...
    \subsection{Handling Creatures}
        ...
        \begin{ability}{\labeltext{Pacify}}[\glossterm{Compulsion}, \glossterm{Mind}]
