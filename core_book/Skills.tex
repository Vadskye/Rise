...
\section{Skill Overview}
    ...
    \subsection{Special Skill Checks}
        ...
        \subsubsection{Group Skill Checks}
            ...
            In addition, that character gains a \plus1 bonus for each other character who also attempted the check without getting a \glossterm{critical failure}.
...
\skill{Balance}{Dex}
    ...
    \subsection{Agile Charge}\label{Agile Charge}
        You can make a \glossterm{difficulty value} 15 Balance check while using the \ability{charge} ability to change directions while charging (see \pcref{Charge}).
