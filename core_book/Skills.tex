...
\skill{Ride}{Dex}
    ...
    \subsection{Common Ride Tasks}
        ...
        \parhead{Take Cover} You can make a DV 15 Ride check as a move action to drop low and take \glossterm{cover} behind your mount.
...
\skill{Swim}{Str}
    ...
    \subsection{Common Swim Tasks}
        \parhead{Move} You can make a Swim check as a \glossterm{move action} while you are in water or a similar liquid.
        This requires two \glossterm{free hands}, or one free hand if you take a \minus5 penalty.
