    ...
    \subsection{Class Skills}
        ...
        \begin{dtable!*}
            ...
            \begin{dtabularx}{\textwidth}{>{\lcol}p{12em} *{11}{>{\ccol}X} >{\ccol}p{4em}}
                \tb{Skill}        & \tb{Bbn} & \tb{Clr} & \tb{Drd} & \tb{Ftr} & \tb{Mge} & \tb{Mnk} & \tb{Pal} & \tb{Rgr} & \tb{Rog} & \tb{War} & \tb{Key Ability} \\
                \bottomrule                                                                
...
\skill{Awareness}{Per}
    ...
    \subsection{Discern Illusion [Hidden]}
        Whenever you observe the effect of a \glossterm{Sensation} ability, you can make an Awarenss check to notice its unreal nature.
