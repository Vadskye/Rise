...
\section{Skill Overview}
    ...
    \subsection{Skill Training}\label{Skill Training}
        ...
        You can spend \glossterm{skill points} to become \glossterm{trained} or \glossterm{mastered} in skills (see \pcref{Skill Points}).
...
\skill{Climb}{Str}
    ...
    \subsection{Wallrun}\label{Wallrun}
        As part of movement, you can make a Climb check to run along a wall rather than climbing it. The \glossterm{difficulty rating} is 5 higher than normal for the wall, but this does not require free hands. Success means you move up to half your land speed horizontally, or up to a quarter of your land speed vertically. Failure means you fall. Critical failure means you are prone when you land. For every round you spend running on a wall, the \glossterm{difficulty rating} increases by 10.
...
\skill{Endurance}{Con}
    ...
    \subsection{Delay Vital Wound}\label{Delay Vital Wound}
        Whenever you receive a \glossterm{vital wound}, you can make an Endurance check.
        The \glossterm{difficulty rating} starts at 15 and increases by 10 in each subsequent round.
        Success means that you delay the special effect of the vital wound on you until the end of the next round, when you must make this check again.
...
\skill{Spellsense}{Per}
    ...
    \subsection{Notice Magical Effect}
        ...
        The \glossterm{difficulty rating} is for an \glossterm{unattended} magical item or active magical effect is equal to 15 \sub the \glossterm{power} of the effect.
...
\skill{Stealth}{Dex}
    ...
    \subsection{Avoid Notice}
        ...
        If you move at up to half your speed during the action, you take a \minus5 penalty to the Stealth check.
        Moving up to your full speed increases the penalty to \minus10.
    ...
    \subsection{Hide [Hidden]}
        ...
        This can be achieved by teleporting at least ten feet, moving through total darkness, moving behind total cover, or similar activities.
...
\skill{Swim}{Str}
    ...
    \subsection{Swimming}
        ...
        Success means you gain a \glossterm{swim speed} equal to one quarter of your \glossterm{base speed}.
