...
\skill{Heal}{Int}
    ...
    \subsection{First Aid}\label{First Aid}
        ...
        The \glossterm{difficulty rating} is equal to 10 \add 10 for each point by which the vital roll is below -1.
        Success means that the target treats the \glossterm{vital roll} as a 0 instead of its original value, which prevents it from dying.
    ...
    \subsection{Treat Condition}\label{Treat Condition}
        As a standard action, you can make a Heal check to treat some specific conditions.
