...
\section{Skill Description Format}
    ...
    \subsection{Disguise Creature}
        ...
        \begin{dtable}
            ...
            3 You cannot disguise yourself as a different size category without the Legendary Disguise feat (see \pcref{Legendary Disguise}).
        \end{dtable}
    ...
    \skill{Linguistics}{Int}
        ...
        For every two ranks in Linguistics that you have, you may learn a new \glossterm{common language}, in addition to your starting languages (see \tref{Common Languages}). In place of two common languages, you may learn a \glossterm{rare language} (see \pcref{Rare Languages}). Rare languages are more difficult to learn, and are usually only spoken by unusual creatures.
