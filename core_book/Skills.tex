...
\skill{Stealth}{Dex}
    ...
    \subsection{Avoid Notice}
        ...
        If a creature would automatically know your location with an ability like \stdability{lifesense} or \stdability{tremorsense}, it gains a \plus10 bonus to Awareness checks to observe you.
