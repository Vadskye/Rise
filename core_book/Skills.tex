...
\skill{Spellsense}{Per}
    ...
    \subsection{Notice Magical Effect}
        ...
        The \glossterm{difficulty value} for an \glossterm{unattended} magical item or an active magical effect is equal to 15 \sub twice the \glossterm{rank} of the effect.
