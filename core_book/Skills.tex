...
\skill{Craft}{Int}
    ...
    \subsection{Common Craft Tasks}
        ...
        \parhead{Repair Item} You can make a Craft check to repair a \glossterm{broken} item. This takes as much time as creating an item two ranks lower than the item (to a minimum of 0), and does not require any raw materials other than the broken item.
