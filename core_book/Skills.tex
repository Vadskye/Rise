...
\skill{Awareness}{Per}
    ...
    \subsection{Senses}\label{Senses}
        ...
        \parhead{Sight} The \glossterm{difficulty value} to see something depends on the obviousness of the sight, as shown on \trefnp{Sight-based Difficulty value}, and other modifiers given at \trefnp{Awareness Difficulty Modifiers}.

        \begin{dtable}
            \lcaption{Sight-based Difficulty value}
        ...
        \parhead{Sound} The \glossterm{difficulty value} to hear a sound depends on the intensity of the sound, as shown on \trefnp{Sound-based Difficulty value}, and other modifiers given at \trefnp{Awareness Difficulty Modifiers}.
        ...
        \begin{dtable}
            \lcaption{Sound-based Difficulty value}
            \begin{dtabularx}{\columnwidth}{X l}
                \tb{Situation}                        & \tb{Base Difficulty value\fn{1}} \tableheaderrule
        ...
        \parhead{Scent} The \glossterm{difficulty value} to smell something depends on the intensity of the scent, as shown on \trefnp{Scent-based Difficulty value}, and other modifiers given at \trefnp{Awareness Difficulty Modifiers}.
        ...
        \begin{dtable}
            \lcaption{Scent-based Difficulty value}
            \begin{dtabularx}{\columnwidth}{X l}
                \tb{Situation}                               & \tb{Base Difficulty value\fn{1}} \tableheaderrule
...
\skill{Balance}{Dex}
    ...
    \subsection{Agile Charge}\label{Agile Charge}
        You can make a \glossterm{difficulty value} 15 Balance check while \glossterm{charging} to change directions while charging.
    ...
    \subsection{Balance}\label{Balance}
        ...
        The \glossterm{difficulty value} of Balance checks to balance varies with the surface, as described in \trefnp{Balancing Difficulty value}.
        ...
        \begin{dtable}
            \lcaption{Balancing Difficulty value}
...
\skill{Climb}{Str}
    ...
    \subsection{Climb}
        ...
        The \glossterm{difficulty value} of the check depends on the difficulty of the task and the conditions of the climbing surface, as shown on \trefnp{Climb Difficulty value} and \trefnp{Climb Difficulty Modifiers}.
        ...
        \begin{dtable}
            \lcaption{Climb Difficulty value}
...
\skill{Craft}{Int}
    ...
    \subsection{Create Item}
        ...
        In addition, each item requires the expenditure of raw materials with a value equal to an item two levels lower than the item you are trying to craft.
        ...
        \begin{dtable!*}
            ...
            \begin{dtabularx}{\textwidth}{>{\lcol}X l l l}
                \tb{Item}                   & \tb{Craft Skill} & \tb{Difficulty value} & \tb{Crafting Time} \tableheaderrule
    ...
    \subsection{Appraise Item}
        ...
        The \glossterm{difficulty value} is equal to 5 \add the item's level.
...
\skill{Devices}{Int}
    ...
    With enough skill, you can even manipulate magical devices.
        ...
        The \glossterm{difficulty value} of a Devices check depends on the device being manipulated. In addition, some actions are easier than others, and modify the \glossterm{difficulty value} accordingly. Standard \glossterm{difficulty value} are listed on \trefnp{Devices Difficulty value}.

        \begin{dtable}
            \lcaption{Devices Difficulty value}
...
\skill{Endurance}{Con}
    ...
    \subsection{Hold Breath}\label{Hold Breath}
        ...
        If there is no air to breathe, you gain a \glossterm{vital wound} instead and continue holding your breath.
        ...
        If you are staying still, you can stay underwater for a number of minutes equal to half your Endurance modifier with no risk of drowning.
...
\skill{Flexibility}{Dex}
    ...
    \subsection{Escape Bindings}
        ...
        \begin{dtable}
            \lcaption{Flexibility Difficulty value}
...
\skill{Linguistics}{Int}
        ...
        If you are trained in Linguistics, you learn an additional \glossterm{common language} (see \pcref{Language Rarity}).
        If you have mastered Linguistics, you instead learn two common languages or one \glossterm{rare language}.
...
\skill{Perform}{Varies}
    The Perform skills represent your ability to create particular forms of entertainment.
        ...
        While you are performing, you cannot use \abilitytag{Focus} abilities.
...
\skill{Survival}{Per}
    ...
    \subsection{Navigate Wilderness}
        You can make a Survival check while moving overland to avoid natural hazards and getting lost. The \glossterm{difficulty value} depends on the terrain, as shown on \trefnp{Terrain Difficulty value}. Success means that you and any group you lead can move without any trouble. Failure means you may encounter a natural hazard, depending on the terrain. Critical failure means you become lost.
    ...
    \subsection{Sustenance}
        You can make a Survival check to move overland at half speed while hunting and foraging. The \glossterm{difficulty value} depends on the terrain, as shown on \trefnp{Terrain Difficulty value}. Success means that you can feed yourself, and require no additional food or water. For every 2 points by which you succeed, you can provide food and water to an additional person.
        ...
        \begin{dtable}
            \lcaption{Terrain Difficulty value}
            \begin{dtabularx}{\columnwidth}{l X X}
    ...
    \subsection{Track}\label{Track}
        ...
        The \glossterm{difficulty value} of the check depends on how easy the tracks are to notice, as shown on \trefnp{Track Difficulty value} and \trefnp{Track Difficulty Modifiers}.
        ...
        \begin{dtable}
            \lcaption{Track Difficulty value}
...
\skill{Swim}{Str}
    ...
    \subsection{Swimming}
        ...
        The \glossterm{difficulty value} depends on the turbulence of the water, as shown on \trefnp{Swim Difficulty value}.
        ...
        \begin{dtable}
            \lcaption{Swim Difficulty value}
            \begin{dtabularx}{\columnwidth}{>{\lcol}X >{\lcol}X}
