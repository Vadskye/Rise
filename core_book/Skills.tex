...
\skill{Awareness}{Per}
    ...
    \subsection{Common Awareness Tasks}
        ...
        \parhead{Notice Disguise} If you succeed at an opposed Awareness vs. Disguise check, you can determine whether a creature or object is disguised.
        \parhead{Notice Forgery} If you succeed at an opposed Awareness vs. Craft check, you can determine whether an object is a forgery.
    ...
    \subsection{Common Awareness Modifiers}
        ...
        Minor obstructions, short distances (generally between 30 and 120 feet), and slightly similar backgrounds increase the \glossterm{difficulty value} by \plus2.
        Significant obstructions, long distances (generally more than 120 feet), and very similar backgrounds increase the DV by \plus5 or more.
...
\skill{Balance}{Dex}
    ...
    \subsection{Common Balance Modifiers}
        ...
        Slightly impaired surfaces increase the \glossterm{difficulty value} by \plus2.
        Significantly impaired surfaces increase the DV by \plus5 or more.
...
\skill{Climb}{Str}
    ...
    \subsection{Common Climb Tasks}
        ...
        This requires two \glossterm{free hands}, and the target must be two or more size categories larger than you.
        Success means you are climbing on the creature as if it was a surface with a \glossterm{difficulty value} equal to its Reflex defense.
        ...
        This requires two \glossterm{free hands}.
        ...
        For every consecutive phase that you use this ability on the same wall, the DV increases by 5.
