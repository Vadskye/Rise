...
\skill{Climb}{Str}
    ...
    \subsection{Common Climb Tasks}
        \parhead{Creature Climb}\label{Creature Climb} As a standard action, you can make a Climb vs. Reflex attack against a creature you touch.
        ...
        The creature takes a \minus4 accuracy penalty with \glossterm{strikes} against you.
