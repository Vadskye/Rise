...
\section{Skill Overview}
    ...
    \subsection{Skill Training}
        You can become trained in skills by having a high base attribute or by spending skill points.
    ...
    \subsection{Key Attributes With Skills}\label{Key Attributes With Skills}
        ...
        In addition, if your base value for an attribute is at least 3, you are automatically trained in your \glossterm{class skills} associated with that attribute.
    ...
    \subsection{Class Skills}\label{Class Skills}
        ...
        You are automatically \glossterm{trained} in all \glossterm{class skills} associated with each of your attributes that has a base value of 2 or higher.
    ...
    \subsection{Modifiers}
        ...
        \begin{dtable}
            ...
            \begin{dtabularx}{\columnwidth}{X l}
                ...
                2000\plus feet away            & \plus20 or more          \\
                ...
                2500\plus creature or objects  & \minus20 or less         \\
...
\skill{Stealth}{Dex}
    ...
    \subsection{Avoid Notice}
        ...
        This is a \minus10 penalty if you move at no more than half your speed.
        If you use the \textit{sprint} ability or move faster than half your speed, this penalty increases to \minus20.
