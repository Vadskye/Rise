...
\skill{Ride}{Dex}
    ...
    \subsection{Take Cover}
        You can make a DR 10 Ride check as a move action to drop low and take \glossterm{cover} behind your mount. This requires the use of both your hands. Failure means you can't get low enough and gain no benefit from the action. Critical failure means you fall off your mount. You can leave this cover and resume your normal position as a move action that does not require a Ride check.
