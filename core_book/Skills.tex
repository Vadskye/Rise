...
\skill{Agility}{Dex}
    ...
    \subsection{Agile Charge}\label{Agile Charge}
        You can make a \glossterm{difficulty rating} 15 Agility check while \glossterm{charging} to change directions while charging.
...
\skill{Jump}{Str}
    ...
    \subsection{Share Impact}
        ...
        This does not reduce the falling damage you take, and you cannot combine this ability with the \textit{jump down} ability to reduce your falling damage.
