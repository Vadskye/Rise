...
\skill{Acrobatics}{Dex}
    ...
    \subsection{Agile Charge}
        You can make a \glossterm{difficulty rating} 10 Acrobatics check while \glossterm{charging} to change directions while charging.
    ...
    \subsection{Balance}\label{Balance}
        ...
        The \glossterm{difficulty rating} of Acrobatics checks to balance varies with the surface, as described in \trefnp{Balancing Difficulty Ratings}}.
        In addition, if you are forcibly moved while on a slippery or narrow surface, you must make an Acrobatics check against the same \glossterm{difficulty rating}.\@
        ...
        \begin{dtable}
            ...
            \begin{dtabularx}{\columnwidth}{l X}
                ...
                \tb{Surface Condition}        & \tb{Modifier} \\
                Water covered                 & \plus2        \\
    ...
    \subsection{Rapid Stand}\label{Rapid Stand}
        ...
        \begin{freeability}{Rapid Stand}[Swift]
            You make a \glossterm{difficulty rating} 15 Acrobatics check to stand up from a prone position quickly.
...
\skill{Awareness}{Per}
    ...
    \subsection{Senses}\label{Senses}
        ...
        \parhead{Sight} The \glossterm{difficulty rating} to see something depends on the obviousness of the sight, as shown on \trefnp{Sight-based Difficulty Ratings}, and other modifiers given at \trefnp{Awareness Modifiers}.
...
\skill{Bluff}{---}
    ...
    \subsection{Secret Message}
        ...
        Anyone witnessing the exchange may make a Sense Motive check against the same \glossterm{difficulty rating} to identify the hidden message.
...
\skill{Climb}{Str}
    ...
    \subsubsection{Grab Edge}\label{Grab Edge}
        ...
        You can pull yourself up from a grabbed edge as a move action that requires a Climb check against the edge's \glossterm{difficulty rating}\@.
...
\skill{Escape Artist}{Dex}
    ...
    \subsection{Escape Bindings}
        As a standard action, you can make an Escape Artist check to escape bindings and restraints. The \glossterm{difficulty ratings} of various restraints are given on the table below.

        \begin{dtable}
            \lcaption{Escape Artist Difficulty Ratings}
...
\skill{Heal}{Int}
    ...
    \subsection{Accelerate Recovery}\label{Accelerate Recovery}
        You can make a \glossterm{difficulty rating} 10 Heal check to accelerate the recovery of up to four willing creatures during a \glossterm{long rest}.
    ...
    \subsection{First Aid}\label{First Aid}
        ...
        The \glossterm{difficulty rating} is equal to 5.
        Success means that the target gains a \plus1 bonus to the \glossterm{wound roll} for its most recent \glossterm{vital wound}, up to a maximum of 0.
        For every 10 points by which you succeed, the bonus increases by 1.
        After you modify the \glossterm{wound roll} this way, it cannot be modified again.
...
\skill{Knowledge}{Int}
    ...
    \subsection{Identify Monster}
        You can make a Knowledge check reactively to identify a monster and recall its special powers or vulnerabilities. In general, the \glossterm{difficulty rating} is equal to 5 \add the monster's level. Success allows you to remember the monster's name and its most well-known features. For every 5 points by which you beat the \glossterm{difficulty rating}, you remember an additional piece of useful information. Failure indicates you don't remember anything important about the monster. Critical failure means you remember incorrect information.
...
\skill{Persuasion}{---}
        ...
        The base \glossterm{difficulty rating} for a Persuasion check against a group is equal to 5 \add the highest level of any character in the group or the highest Sense Motive of any character in the group, whichever is higher.
...
\skill{Sense Motive}{Per}
    ...
    \subsection{Discern Lies [Hidden]}
        ...
        The \glossterm{difficulty rating} is equal to the speaking creature's Bluff check result.
    ...
    \subsection{Discern Secret Message}
        ...
        The \glossterm{difficulty rating} is equal to the \glossterm{difficulty rating} of the secret message (see \pcref{Bluff}).
    ...
    \subsection{Social Assessment}\label{Social Assessment}
        You can make a \glossterm{difficulty rating} 5 Sense Motive check to get a general assessment of a social situation.
...
\skill{Spellcraft}{Per}
    ...
    \subsection{Identify Potion}
        You can make a \glossterm{difficulty rating} Spellcraft check to identify a potion.
...
\skill{Stealth}{Dex}
        ...
        \parhead{Size and Stealth}\label{Size and Stealth} A creature larger or smaller than Medium gains an bonus or penalty to the Stealth skill equal to \plus2 per size larger than Medium, or \minus2 for per size smaller than Medium: Fine \plus8, Diminutive \plus6, Tiny \plus4, Small \plus2, Large \minus2, Huge \minus4, Gargantuan \minus6, Colossal \minus8.
...
\skill{Survival}{Per}
    ...
    \subsection{Track}\label{Track}
        ...
        The \glossterm{difficulty rating} of the check depends on how easy the tracks are to notice, as shown on \trefnp{Track Difficulty Ratings} and \trefnp{Track Modifiers}.
