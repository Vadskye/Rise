...
\skill{Awareness}{Per}
    ...
    \subsection{Notice Subtle Effects}\label{Notice Subtle Effects}
        When you are affected by a \abilitytag{Subtle} ability, there are no obvious signs.
        However, you can still make an Awareness check to notice the ability in two circumstances: when the effect is initially applied, and when the effect ends.
        The \glossterm{difficulty value} to notice the effect when it is first applied to you is 20 \add twice the \glossterm{rank} of the ability, and 5 lower when it ends.

        Success means that you notice that something is affecting you, but not exactly what that effect might be.
        Critical success means you know in general terms what the effect does, such as recognizing that you are feeling unnaturally well-disposed towards a particular creature.
        Failure means you notice nothing.
    ...
    \subsection{Senses}\label{Senses}
        ...
        Creatures with \trait{scent} reduce the \glossterm{difficulty value} of scent-based Awareness checks by 10.
        ...
        In general, multiple strong sources of a scent can reduce the \glossterm{difficulty value} by 5 or more.
        An unusually weak scent can increase the \glossterm{difficulty value} by 5 or more.
...
\skill{Perform}{Varies}
    The Perform skills represent your ability to create particular forms of entertainment.
        ...
        For example, if you create a complex and challenging tune on a harp, you can add your Dexterity to the Perform check.
        On the other hand, if you issue a bombastic series of trumpet blasts, you can add your Constitution to the Perform check.
