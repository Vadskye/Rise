...
\skill{Climb}{Str}
    ...
    \subsection{Climbing}
        ...
        Success means you can move a distance equal to the size of your space (see \pcref{Size Categories}).
        ...
        \begin{dtable}
            ...
            \begin{dtabularx}{\columnwidth}{l X}
                \tb{Modifier\fn{1}} & \tb{Description} \tableheaderrule
    ...
    \subsubsection{Grab Edge}\label{Grab Edge}
        ...
        Your ability to grab an edge depends on your reach.
        Typically, a bipedal creature can reach a maximum vertical distance equal to one and a half times its height.
        Quadrupedal creatures can typically reach a maximum vertical distance equal to their height.
