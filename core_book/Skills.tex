    ...
    \subsection{Skill Training}\label{Skill Training}
        ...
        \begin{itemize}
            \itemhead{Untrained} Becoming untrained in a skill costs no skill points.
                ...
                Your modifier with an untrained skill is equal to the skill's \glossterm{key attribute}.
            ...
            \itemhead{Trained} Becoming trained in a skill costs one skill point.
                Your modifier with a trained skill is equal to 2 \add either the skill's \glossterm{key attribute} (if any) or half your level, whichever is higher.
...
\skill{Creature Handling}{Per}
    ...
    \subsection{Handling Creatures}
        ...
        As a standard action, you can use the \textit{push} ability to convince a creature to perform an action it does not know.
        ...
        \begin{ability}{Push}
            ...
            This can include convincing creatures to perform \glossterm{forced marches} and similar activities.
        \end{ability}
