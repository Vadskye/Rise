...
\skill{Knowledge}{Int}
    ...
    \subsection{Identify Monster}
        ...
        Success allows you to remember the monster's name and its most well-known features.
        For every 5 points by which you succeed, you remember an additional piece of useful information.
        In addition to any specific information listed in the monster's description, you can remember your choice of one of the following standard pieces of information:
        \begin{itemize}
            \item Alignment
            \item Approximate value for any one of its attributes, to the nearest increment of 5 (-5, 0, 5, 10, and so on)
