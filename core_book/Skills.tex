...
\section{Acquiring Skills}
    ...
    \subsection{Skill Points}\label{Skill Points}
        ...
        \subsubsection{Class Skill Points}
            ...
            You get a base allotment of 4, 6, or 8 skill points, depending on your character's class.
            These skill points can only be spent on the \glossterm{class skills} associated with your class.

        \subsubsection{Other Skill Points}

            You gain additional skill points equal to twice your starting Intelligence.
            If your Intelligence is negative, you instead lose skill points equal to your Intelligence, starting with normal skill points before removing class skill points.
            Some other abilities, such as the Skill Savant feat (see \featpcref{Skill Savant}), can also grant additional skill points.
            Unless otherwise noted, all skill points other than skill points from your class can be spent on any skills.

    \subsection{Skill Training}\label{Skill Training}

        You can spend one skill point to become trained in a skill, or two skill points to master a skill.
        Your training determines your base modifier for attacks and checks using that skill, as described below.
        This is called your \glossterm{skill training modifier}.
        ...
        \begin{itemize}
            ...
            \itemhead{Trained} Becoming trained in a skill costs one skill point.
                Your modifier with a trained skill is equal to the skill's \glossterm{key attribute} or half your level \add 1, whichever is higher.
                If the skill does not have a key attribute, your modifier is equal to half your level.
            \itemhead{Mastered} Mastering a skill costs two skill points.
                Your modifier with a mastered skill is equal to 3 \add either the skill's key attribute or your level, whichever is higher.
                If the skill does not have a key attribute, your modifier is equal to your level \add 2.
        \end{itemize}
...
\section{Skill Description Format}
    ...
    \sssecfake{Tasks}\label{Tasks} A task is a particular way to use a skill.
    Each skill has a number of tasks listed.
    These tasks are simply examples, and do not list everything the skill can be used for.
    You should be creative with your skills, rather than only using the tasks written here.

    \subsection{Hidden Tasks}\label{Hidden Tasks}
        Some tasks are called \glossterm{hidden tasks}, and are marked with a [Hidden] tag in the task name.
        These tasks rely on hidden information that your character should not have access to.
        ...
        Usually, you should not even know that your character made a check unless you learn a result from it.

        If you are suspicious of a situation, you can ask the GM to make a relevant check for your character.
    ...
    \subsection{Rapid Stand}
        ...
        Success means you stand up as a \glossterm{swift action}.
        Critical success means you stand up as a \glossterm{free action}.
    ...
    \subsection{Discern Illusion [Hidden]}
        Whenever you observe a \glossterm{Figment} or \glossterm{Glamer}, you can make an Awarenss check to notice its unreal nature.
    ...
    \subsection{Distract}\label{Distract}
        ...
        Success means they take a \minus5 penalty to Awareness and Sense Motive checks against targets other than you for 1 round.
    ...
    \subsection{Impersonate}\label{Impersonate}
        ...
        Anyone observing you can oppose your check with a Sense Motive check to identify the impersonation (see \pcref{Identify Impersonation}).
        ...
        Observers who do not know your impersonation is inaccurate can take similar penalties; see Identify Impersonation for details.
    ...
    \subsection{Handling Creatures}
        ...
        \parhead{Pacify}\label{Pacify} As a standard action, you can use this ability.
        \begin{ability}
            \begin{spelltargetinginfo}
                \spellquicktargeting{One creature}{\rngmed}
            \end{spelltargetinginfo}
            \begin{spelleffects}
                \begin{spellattack}{Creature Handling vs. Mental}
                    \spellspecial The target's defense is increased as normal for Creature Handling attacks and checks if it is not an animal.
                    You take a \minus10 penalty to accuracy against an actively hostile target.
                    \spellsuccess The target takes no actions.
                    If it is threatened or damaged, this effect is automatically broken.
                    \spelldur Sustain (standard)
                    \spelltags{Compulsion, Mind}
                \end{spellattack}
            \end{spelleffects}
        \end{ability}
    ...
    \subsection{Training Creatures}\label{Training Creatures}
        ...
        If you have other means of communicating the destination to the creature, such as the \textit{wild speech} druid ability (see \pcref{Wild Speech}), that check is unnecessary.
        ...
        \parhead{Bonus Tricks} Some trainers can teach creatures bonus tricks in addition to their normal maximum number of tricks known.
    ...
    \subsection{Disguise Creature}\label{Disguise Creature}
        ...
        \parhead{Creation Time} Creating a disguise takes 30 minutes. You can take a \minus5 penalty to reduce the time to 5 minutes, a \minus10 penalty to reduce the time to 5 rounds, or a \minus15 penalty to reduce the time to 1 round.
        ...
        \begin{dtable}
            ...
            3 You cannot disguise yourself as a different size category without the Disguise Specialization feat (see page \featpref{Disguise Specialization}).
        \end{dtable}
    ...
    \subsection{Demoralize}\label{Demoralize}
        ...
        \begin{ability}
            ...
            \end{spelltargetinginfo}
            \begin{spelleffects}
                \begin{spellattack}{Intimidate vs. Mental}
    ...
    \skill{Linguistics}{Int}
        ...
        If you are trained in Linguistics, you learn additional \glossterm{common languages} equal to one quarter of your level.
        If you have mastered Linguistics, you instead learn additional common languages equal to half your level.
    ...
    \subsection{Discern Enchantment [Hidden]}
        ...
        If the creature's behavior is currently being altered by a \glossterm{Compulsion} effect, the DR is 10, and success means you identify the presence of a Compulsion.
        If the creature's behavior is currently being altered by a \glossterm{Delusion} effect, the DR is 20, and success means you identify the presence of a Delusion.
        Failure means you do not notice any such effects on the creature.

        You can also use this ability to identify \glossterm{Subtle} effects on yourself, using the same DRs.
    ...
    \subsection{Sprint}
        ...
        After that time, you must take a \glossterm{short rest} before you can sprint again. You can sprint in any movement mode that you have a speed for.
    ...
    \subsection{Track}\label{Track}
        ...
        While tracking, you move at half your normal speed (or at your normal speed with a \minus2 penalty on the check, or at up to twice your normal speed with a \minus10 penalty on the check).
