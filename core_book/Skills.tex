...
\skill{Heal}{Int}
    ...
    \subsection{First Aid}\label{First Aid}
        ...
        Success means that the target gains a \plus1 \glossterm{vitality bonus} to the \glossterm{vital roll} for one of its \glossterm{vital wounds}, up to a maximum of 0.
