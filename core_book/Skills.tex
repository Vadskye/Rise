...
\skill{Endurance}{Con}
    ...
    \subsection{Delay Vital Wound}\label{Delay Vital Wound}
        ...
        The \glossterm{difficulty rating} starts at 10 and increases by 10 in each subsequent round.
...
\skill{Stealth}{Dex}
    ...
    \subsection{Avoid Notice}
        ...
        Making a \glossterm{strike} and taking other similar large-scale actions imposes a \minus10 penalty to the Stealth check if the weapon is a light weapon, or a \minus20 penalty otherwise.
