...
\begin{dtable}
    ...
    \begin{dtabularx}{\columnwidth}{l c *{3}{>{\ccol}X}}
        \tb{Race} & \tb{Adulthood} & \tb{Barbarian Rogue Spellwarped} & \tb{Fighter Mage Paladin Ranger} & \tb{Cleric Druid Monk} \\
        \bottomrule
...
\begin{dtable}
    ...
    \end{dtabularx}
    1 At middle age, \minus1 to Str, Dex, and Con; \plus1 to Int, Per, and Wil. \\
    2 At old age, \minus2 to Str, Dex, and Con; \plus1 to Int, Per, and Wil. \\
    3 At venerable age, \minus3 to Str, Dex, and Con; \plus1 to Int, Per, and Wil.
\end{dtable}
