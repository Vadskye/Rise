...
\section{Planes}\label{Planes}
    ...
    \subsection{General Cosmology}
        ...
        \parhead{Inner Planes} The inner planes are manifestations of the basic building blocks of the universe.
        Each plane in this group is predominantly composed of a single element or type of energy.
        There are four inner planes: Air, Earth, Fire, and Water.

        \parhead{Outer Planes} The outer planes are manifestations of the nine alignments that define the morality of the universe.
        ...
        There are nine outer planes, one for each alignment combination (see \pcref{Alignment}).
    ...
    \subsection{Plane Descriptions}
        ...
        \subsubsection{Inner Planes}
            ...
            The Plane of Water is the most densely populated Inner Plane, both by sentient creatures and monsters.
