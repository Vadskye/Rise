    ...
    \subsection{Height and Weight}
        ...
        \begin{dtable}
            ...
            \begin{dtabularx}{\columnwidth}{l *{3}{>{\lcol}X} >{\lcol}p{5em}}
                \tb{Species} & \tb{Base Height} & \tb{Height Modifier} & \tb{Base Weight} & \bt{Weight Modifier} \\
                \bottomrule
