...
\begin{ability}[\nth{5}]{Discordant Song}[\glossterm{Compulsion}, \glossterm{Mind}]
Make an attack vs. Mental against all enemies in a \areamed radius from you.
...
\begin{ability}[\nth{3}]{Web}[\glossterm{Manifestation}, \glossterm{Sustain} (minor)]
...
\begin{ability}{Cantrip}[\glossterm{Telekinesis}]
...
When this spell resolves, and the end of each \glossterm{action phase} in subsequent rounds, all allies in the area heal hit points equal to \glossterm{standard damage} \minus4d.
\end{ability}
\vspace{0.25em}
