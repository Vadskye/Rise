...
The target gains a \plus10 foot bonus to its speed in all its movement modes.
You can cast this subspell as a \glossterm{minor action}.
\end{ability}
\vspace{0.25em}
...
Choose a willing creature within \rngmed range.
The target gains a \plus30 foot bonus to its speed in all its movement modes, up to a maximum of double its \glossterm{base speed}.
In addition, it gains a \plus2 bonus to Reflex defense.
...
\begin{ability}[\nth{2}]{Foresight}
This subspell functions like the \spell{revelation} spell, except that the target also gains a \plus2 bonus to Reflex defense and \glossterm{initiative} checks.
\end{ability}
\vspace{0.25em}
