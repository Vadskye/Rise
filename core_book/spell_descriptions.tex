...
\spelltgt{One willing creature (Medium or smaller) within \rngclose range}
...
\spelltags{\glossterm{Air}, \glossterm{Attune} (shared), \glossterm{Imbuement}}
...
\begin{spellcantrip}
The spell's casting time becomes a standard action, and it gains the \glossterm{Sustain} (minor) tag in place of the \glossterm{Attune} tag.
\end{spellcantrip}
...
\spelltgt{One creature or object within \rngmed range}
...
\spelltgts{All in \arealarge, 10 ft. wide line}
...
\spelltags{\glossterm{Air}, \glossterm{Attune} (shared), \glossterm{Shaping}}
...
\spelltags{\glossterm{Air}, \glossterm{Attune} (shared)}
...
\spelltgt{One creature, object, or active magical effect within \rngmed range}
...
\spelltags{\glossterm{Sustain} (minor), \glossterm{Thaumaturgy}}
...
\begin{spellcantrip}
The spell gains the \glossterm{Sustain} (standard) tag in place of the \glossterm{Sustain} (minor) tag.
\end{spellcantrip}
...
\spelltgt{One magical object (Large or smaller) within \rngmed range}
...
\spelltags{\glossterm{Attune}, \glossterm{Thaumaturgy}}
...
\spelltgt{One object within \rngmed range}
...
\spellburst{\arealarge radius within \rngmed range}
...
\spelltgts{All in \areasmall radius within \rngclose range}
...
\spelltgt{Location or locations within \rngclose range}
...
\spelltags{\glossterm{Attune} (shared), \glossterm{Shaping}, \glossterm{Water}}
...
\subspell{6}{Greater Aqueous Blade}
...
\subspell{9}{Supreme Aqueous Blade}
...
\spelltgt{One creature within \rngmed range}
...
\subspell{2}{Dimensional Jaunt -- Plane of Fire}
...
\subspell{4}{Dimensional Jaunt -- Plane of Earth}
...
\subspell{8}{Dimensional Jaunt -- Deep Astral Plane}
...
\spelltgt{One creature within \rngclose range}
...
\spelltags{\glossterm{Attune} (shared), \glossterm{Shielding}}
...
\spellzone{\areamed radius from your location}
\spelltime{Standard action}
...
\spelltags{\glossterm{Sustain} (minor)}
...
The target also gains a \plus1 bonus to Armor defense.
...
\spelltags{\glossterm{Attune} (shared)}
...
\begin{spellcantrip}
The spell's casting time becomes a standard action, and it gains the \glossterm{Sustain} (minor) tag in place of the \glossterm{Attune} (shared) tag.
\end{spellcantrip}
...
\spelltags{\glossterm{Attune} (shared), \glossterm{Fire}}
...
\spelltags{\glossterm{Attune}, \glossterm{Shaping}, \glossterm{Sizing}}
...
\subspell{6}{Divine Might, Greater}
...
\subspell{6}{Greater Blessed Blade}
...
\subspell{9}{Divine Might, Supreme}
...
\subspell{9}{Supreme Blessed Blade}
...
\spelltgt{One willing creature within \rngmed range}
...
\spelltags{\glossterm{Attune} (shared), \glossterm{Temporal}}
...
\spelltags{\glossterm{Sustain} (minor), \glossterm{Temporal}}
...
If this would reduce any of the target's resources below 0, it takes \glossterm{standard damage} \plus3d from the paradox and becomes \glossterm{stunned} as a \glossterm{condition}.
...
\spelltgts{All enemies in \areamed radius from you}
...
\spelltgt{One living creature within \rngclose range}
...
\subspell{3}{Corruption of Blood and Bone}
...
\spelltgts{All creatures in \areamed radius}
...
\spelltags{\glossterm{Emotion}, \glossterm{Mind}, \glossterm{Sustain} (standard)}
...
\spelltags{\glossterm{Attune}, \glossterm{Emotion}, \glossterm{Mind}, \glossterm{Subtle}}
...
\spelltags{\glossterm{Attune} (shared), \glossterm{Glamer}, \glossterm{Visual}}
...
\spelltgt{One object (Small or smaller) within \rngclose range}
\spellemanation{\areamed radius from the target within \rngclose range}
\spelltime{Standard action}
...
\spelltags{\glossterm{Attune}, \glossterm{Glamer}, \glossterm{Light}}
...
\spelltags{\glossterm{Attune} (shared), \glossterm{Figment}, \glossterm{Visual}}
...
\subspell{5}{Greater Mirror Image}
...
\spelltgts{Enemies in \areamed radius}
...
\spelltgts{All in \arealarge, 5 ft.\ wide vertical line}
...
\spelltgt{One creature or object within \rnglong range}
...
\spellzone{\areasmall radius within \rngclose range}
...
\spelltags{\glossterm{Manifestation}, \glossterm{Sustain} (minor)}
...
\spelltgts{Enemies in an \areasmall radius from you}
...
\spelltgts{All in \areamed radius, 100 ft.\ high cylinder within \rnglong range}
...
\spelltgts{All creatures in \areasmall radius within \rngmed range}
...
\spelltags{\glossterm{Figment}, \glossterm{Light}, \glossterm{Sustain} (minor), \glossterm{Visual}}
...
\subspell{2}{Pinpoint}
You gain a \plus2 bonus to accuracy on the attack.
...
\spelltgt{One willing creature (Small or larger) within \rngmed range}
...
\spelltags{\glossterm{Attune} (shared), \glossterm{Shaping}, \glossterm{Sizing}}
...
\spelltgt{One willing creature (Large or smaller) within \rngmed range}
...
\spelltags{\glossterm{Attune} (shared), \glossterm{Shaping}}
...
\spelltgts{One or more unattended, nonmagical objects (Large or smaller); see text within \rngclose range}
...
\spelltgts{All in \arealarge cone}
...
\spellsuccess Fire \glossterm{standard damage} \plus1d.
...
\spelltgt{One openable object (Large or smaller) within \rngclose range}
...
\spelltags{\glossterm{Attune}, \glossterm{Fire}, \glossterm{Trap}}
...
\spelltgts{All in \arealarge, 10 ft.\ wide shapeable line within \rngmed range}
...
\subspell{5}{Greater Blast Furnace}
...
A hit deals \glossterm{standard damage} \minus2d.
...
In addition, the ignited effect deals \glossterm{standard damage} \minus3d instead of the normal 1d6 damage each round.
...
\spelltags{\glossterm{Attune} (shared), \glossterm{Enhancement}}
...
\spelltgts{All creatures in \areamed radius emanation from you}
...
\spelltags{\glossterm{Attune}, \glossterm{Detection}}
...
\subspell{7}{Greater Boon of Mastery}
...
\spelltgt{One square within \rngmed range}
...
\spelltags{\glossterm{Attune}, \glossterm{Scrying}}
...
\spelltgt{One magical sensor within \rngmed range}
...
\spelltgt{One unoccupied square within \rngmed range}
...
\spelltgt{One Medium or smaller creature or object within \rngclose range}
...
\spelltgt{One unattended object within \rngclose range}
...
\spelltgt{One unattended object or willing creature (Medium or smaller) within \rngclose range}
...
\subspell{6}{Accelerated Levitate}
...
\spelltgts{Enemies in the \areamed radius emanation from you}
...
\spelltags{\glossterm{Life}, \glossterm{Sustain} (minor)}
...
\spelltgts{Allies in \areamed radius emanation from you}
...
\subspell{4}{Cure Critical Wounds}
...
\spelltgt{Location within \rngmed range}
...
\end{spellcontent}
\begin{spellfooter}
\spellinfo{Conjuration, Transmutation}{Arcane}
...
\spellzone{20 ft.\ high wall: \arealarge line or \areasmall radius within \rngmed range}
...
\subspell{4}{Blade Barrier, Contracting}
...
\subspell{6}{Create Ballista, Dual Track}
