...
When this spell resolves, and the end of each \glossterm{action phase} in subsequent rounds, all allies in the area heal hit points equal to \glossterm{standard damage} \minus3d.
\end{ability}
\vspace{0.25em}
