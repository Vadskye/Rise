...
\fieldhead{Augments} Quickened, Silent, Stilled, Widened
\end{spellfooter}
\begin{spellsubcontent}
\begin{spellcantrip}
The spell's duration becomes Sustain (standard)
...
Creatures in the spell's area that worship your deity heal hit points equal to \glossterm{standard damage} \minus1d.