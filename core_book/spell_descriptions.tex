...
\end{spelltargetinginfo}
\begin{spelleffects}
\spelleffect The target gains a \plus1d bonus to damage with all attacks that deal damage measured in dice.
\spelldur Attunement (shared)
\end{spelleffects}
\end{spellcontent}
\begin{spellfooter}
...
It gains a \plus2 bonus to \glossterm{physical defenses} and Stealth (see \pcref{Stealth}).
