...
\fieldhead{Augments} Extended, Quickened, Silent, Stilled
\end{spellfooter}
\begin{spellsubcontent}
\begin{spellcantrip}
The spell's duration becomes Sustain (shared, swift).
\end{spellcantrip}
\end{spellsubcontent}
\end{spellsection}
...
\spellsuccess Damage dealt to the target by \glossterm{physical attacks} is increased by \plus1d. Damage not measured in dice is unaffected.
...
\fieldhead{Augments} Extended, Mass, Quickened, Silent, Stilled
...
\subsubsection{Subspells}
\augment{3}{Complete}
The damage increase applies to all damage, not just damage dealt by \glossterm{physical attacks}.
...
\fieldhead{Augments} Intensified, Quickened, Silent, Stilled, Widened
\end{spellfooter}
\begin{spellsubcontent}
\begin{spellcantrip}
...
\fieldhead{Augments} Extended, Intensified, Mass, Quickened, Silent, Stilled
\end{spellfooter}
\begin{spellsubcontent}
\begin{spellcantrip}
...
\end{spelltargetinginfo}
\begin{spelleffects}
\spelleffect The target gains a \plus2 bonus to \glossterm{accuracy}.
\spelldur Attunement (shared)
\end{spelleffects}
\end{spellcontent}
\begin{spellfooter}
...
\spellsuccess Acid \glossterm{standard damage} \plus1d.
\spellcritical As above, but double damage.
\end{spellattack}
...
\begin{spelleffects}
\begin{spellattack}{Spellpower vs. Fortitude}
\spellsuccess The target is healed for hit points equal to \glossterm{standard damage} \plus1d.
\end{spellattack}
\spelltags{\glossterm{Life}}
\end{spelleffects}
\end{spellcontent}
...
\fieldhead{Augments} Extended, Quickened, Silent, Stilled, Widened
\end{spellfooter}
\begin{spellsubcontent}
\begin{spellcantrip}
...
\begin{spelleffects}
\begin{spellattack}{Spellpower vs. Fortitude}
\spellsuccess Life \glossterm{standard damage} \plus1d.
\spellcritical As above, but double damage.
\end{spellattack}
\spelltags{\glossterm{Life}}
\end{spelleffects}
...
\fieldhead{Augments} Extended, Intensified, Quickened, Silent, Stilled, Widened
\end{spellfooter}
\begin{spellsubcontent}
\begin{spellcantrip}
...
\begin{augmenteffects}
\spelleffect
The target weapon gains a \plus2d bonus to \glossterm{strike damage}.
...
\begin{spellsubcontent}
\begin{spellcantrip}
The spell's duration becomes Sustain (shared, standard).
\end{spellcantrip}
\end{spellsubcontent}
\end{spellsection}
\subsubsection{Subspells}
