...
\parhead{Cantrip} The spell requires a \glossterm{standard action} to cast, and it gains the \glossterm{Sustain} (minor) tag in place of the \glossterm{Attune} (shared) tag. If you cast this spell as a cantrip, you do not need to spend an \glossterm{action point} to cast it, but you cannot apply any augments to it.
...
\parhead{Cantrip} The spell requires a \glossterm{standard action} to cast, and it gains the \glossterm{Sustain} (minor) tag in place of the \glossterm{Attune} tag. If you cast this spell as a cantrip, you do not need to spend an \glossterm{action point} to cast it, but you cannot apply any augments to it.
