...
\begin{ability}[\nth{1}]{Windblade}[\glossterm{Air}, \glossterm{Attune} (shared), \glossterm{Shaping}]
...
\begin{ability}[\nth{3}]{Greater Windblade}[\glossterm{Air}, \glossterm{Attune} (shared), \glossterm{Shaping}]
Choose a willing creature within \rngclose range.
...
\begin{ability}[\nth{4}]{Control Weather}[\glossterm{Air}, \glossterm{Attune}]
...
\begin{ability}[\nth{1}]{Dampen}[\glossterm{Attune} (shared)]
...
\begin{ability}[\nth{2}]{Aqueous Blade}[\glossterm{Attune} (shared), \glossterm{Shaping}, \glossterm{Water}]
Choose a willing creature within \rngclose range.
...
\begin{ability}[\nth{4}]{Blink}[\glossterm{Attune} (shared), \glossterm{Planar}, \glossterm{Teleportation}]
Choose a willing creature within \rngclose range.
...
\begin{ability}[\nth{2}]{Blessed Blade}[\glossterm{Attune} (shared), \glossterm{Fire}]
Choose a willing creature within \rngclose range.
...
\begin{ability}[\nth{2}]{Blessing of the Mighty}[\glossterm{Attune} (shared)]
...
\begin{ability}[\nth{4}]{Divine Shield}[\glossterm{Attune} (shared)]
Choose a willing creature within \rngclose range.
...
\begin{ability}[\nth{1}]{Haste}[\glossterm{Attune} (shared), \glossterm{Temporal}]
...
\begin{ability}[\nth{3}]{Greater Haste}[\glossterm{Attune} (shared), \glossterm{Temporal}]
Choose a willing creature within \rngmed range.
...
\begin{ability}[\nth{7}]{Greater Time Lock}[\glossterm{Attune}, \glossterm{Temporal}]
...
\begin{ability}[\nth{1}]{Icecraft}[\glossterm{Attune}, \glossterm{Cold}]
...
\begin{ability}[\nth{2}]{Charm}[\glossterm{Attune}, \glossterm{Emotion}, \glossterm{Mind}, \glossterm{Subtle}]
Make an attack vs. Mental against a creature within \rngmed range.
...
\begin{ability}[\nth{3}]{Magnetic Blade}[\glossterm{Attune}, \glossterm{Electricity}]
...
\begin{ability}[\nth{1}]{Hidden Blade}[\glossterm{Attune} (shared), \glossterm{Sensation}, \glossterm{Visual}]
Choose a willing creature within \rngclose range.
...
\begin{ability}[\nth{1}]{Suppress Light}[\glossterm{Attune}, \glossterm{Light}, \glossterm{Sensation}]
...
\begin{ability}[\nth{2}]{Disguise Image}[\glossterm{Attune} (shared), \glossterm{Sensation}, \glossterm{Visual}]
Choose a willing creature within \rngclose range.
...
\begin{ability}[\nth{6}]{Displacement}[\glossterm{Attune} (shared), \glossterm{Sensation}, \glossterm{Visual}]
Choose a willing creature within \rngmed range.
...
\begin{ability}[\nth{2}]{Alter Appearance}[\glossterm{Attune} (shared), \glossterm{Shaping}]
...
\begin{ability}[\nth{3}]{Stoneskin}[\glossterm{Attune} (shared)]
Choose a willing creature within \rngclose range.
...
\begin{ability}[\nth{4}]{Flame Aura}[\glossterm{Attune} (shared), \glossterm{Fire}]
Choose a willing creature within \rngclose range.
...
\begin{ability}[\nth{4}]{Levitate}[\glossterm{Attune}]
Choose a Medium or smaller willing creature or unattended object within \rngclose range.
% TODO: Wording
...
\begin{ability}[\nth{3}]{Enhance Magic}[\glossterm{Attune} (shared), \glossterm{Mystic}]
Choose a willing creature within \rngmed range.
...
\begin{ability}[\nth{4}]{Dimensional Lock}[\glossterm{Attune}, \glossterm{Mystic}]
...
\begin{ability}[\nth{6}]{Greater Enhance Magic}[\glossterm{Attune} (shared), \glossterm{Mystic}]
