...
\parhead{Cantrip} The spell requires a standard action to cast, and it gains the \glossterm{Sustain} (minor) tag in place of the \glossterm{Attune} (shared) tag.
...
\begin{ability}[\nth{6}]{Innate}
This subspell functions like the \spell{aeromancy} spell, except that you can cast it without spending an action point.
\end{ability}
\vspace{0.25em}
...
\begin{ability}{Antimagic}[\glossterm{Sustain} (minor), \glossterm{Thaumaturgy}]
...
\parhead{Cantrip} The spell gains the \glossterm{Sustain} (standard) tag in place of the \glossterm{Sustain} (minor) tag.
...
\begin{ability}[\nth{2}]{Alter Magic Aura}[\glossterm{Attune}, \glossterm{Thaumaturgy}]
...
\begin{ability}[\nth{2}]{Dimensional Anchor}[\glossterm{Thaumaturgy}]
...
\begin{ability}[\nth{2}]{Suppress Item}[\glossterm{Sustain} (minor), \glossterm{Thaumaturgy}]
Make a Spellpower vs. Mental attack against one Large or smaller magical object in \rngmed range.
...
\begin{ability}[\nth{3}]{Banishing}[\glossterm{Thaumaturgy}]
...
\begin{ability}[\nth{5}]{Dimensional Lock}[\glossterm{Attune}, \glossterm{Thaumaturgy}]
...
\begin{ability}[\nth{6}]{Innate}
This subspell functions like the \spell{antimagic} spell, except that you can cast it without spending an action point.
\end{ability}
\vspace{0.25em}


\begin{ability}[\nth{7}]{Antimagic Field}[\glossterm{Sustain} (minor), \glossterm{Thaumaturgy}]
...
\parhead{Cantrip} The spell's area becomes a 5 ft.\ wide, \areamed line.
...
\begin{ability}[\nth{2}]{Create Water}[\glossterm{Manifestation}, \glossterm{Water}]
...
\begin{ability}[\nth{6}]{Innate}
This subspell functions like the \spell{aquamancy} spell, except that you can cast it without spending an action point.
\end{ability}
\vspace{0.25em}
...
\parhead{Cantrip} The spell deals \minus2d damage.
...
\begin{ability}[\nth{6}]{Innate}
This subspell functions like the \spell{astromancy} spell, except that you can cast it without spending an action point.
\end{ability}
\vspace{0.25em}


\begin{ability}[\nth{8}]{Dimensional Jaunt -- Deep Astral Plane}
...
\parhead{Cantrip} The spell's casting time becomes a standard action, and it gains the \glossterm{Sustain} (minor) tag in place of the \glossterm{Attune} (shared) tag.
...
\begin{ability}[\nth{6}]{Innate}
This subspell functions like the \spell{barrier} spell, except that you can cast it without spending an action point.
\end{ability}
\vspace{0.25em}
...
\begin{ability}[\nth{6}]{Innate}
This subspell functions like the \spell{bless} spell, except that you can cast it without spending an action point.
\end{ability}
\vspace{0.25em}
...
\begin{ability}[\nth{3}]{Temporal Shunt}[\glossterm{Temporal}]
Make a Spellpower vs. Mental attack against a creature within \rngmed range.
\hit The target takes physical \glossterm{standard damage} \plus1d.
\end{ability}
\vspace{0.25em}
...
\begin{ability}[\nth{6}]{Innate}
This subspell functions like the \spell{chronomancy} spell, except that you can cast it without spending an action point.
\end{ability}
\vspace{0.25em}
...
\begin{ability}[\nth{6}]{Innate}
This subspell functions like the \spell{compel} spell, except that you can cast it without spending an action point.
\end{ability}
\vspace{0.25em}
...
\begin{ability}[\nth{6}]{Innate}
This subspell functions like the \spell{corruption} spell, except that you can cast it without spending an action point.
\end{ability}
\vspace{0.25em}
...
\parhead{Cantrip} The spell deals no damage.
...
\begin{ability}[\nth{6}]{Innate}
This subspell functions like the \spell{cryomancy} spell, except that you can cast it without spending an action point.
\end{ability}
\vspace{0.25em}
...
\begin{ability}[\nth{6}]{Innate}
This subspell functions like the \spell{delusion} spell, except that you can cast it without spending an action point.
\end{ability}
\vspace{0.25em}
...
\parhead{Cantrip} The spell's casting time becomes a standard action, and it gains the \glossterm{Sustain} (minor) tag in place of the \glossterm{Attune} tag.
...
\begin{ability}[\nth{6}]{Innate}
This subspell functions like the \spell{distort image} spell, except that you can cast it without spending an action point.
\end{ability}
\vspace{0.25em}
...
\begin{ability}[\nth{6}]{Innate}
This subspell functions like the \spell{divine judgment} spell, except that you can cast it without spending an action point.
\end{ability}
\vspace{0.25em}
...
You gain a \plus2 bonus to accuracy against creatures wearing metal armor or otherwise carrying a significant amount of metal.
...
\begin{ability}[\nth{6}]{Innate}
This subspell functions like the \spell{electromancy} spell, except that you can cast it without spending an action point.
\end{ability}
\vspace{0.25em}
...
\hit The target takes \glossterm{standard damage} \minus3d, and is poisoned as a \glossterm{condition}.
...
\begin{ability}[\nth{6}]{Innate}
This subspell functions like the \spell{fabrication} spell, except that you can cast it without spending an action point.
\end{ability}
\vspace{0.25em}
...
\parhead{Cantrip} The spell affects a single target within range instead of creating a burst.
...
\begin{ability}[\nth{6}]{Innate}
This subspell functions like the \spell{flare} spell, except that you can cast it without spending an action point.
\end{ability}
\vspace{0.25em}
...
\begin{ability}[\nth{6}]{Innate}
This subspell functions like the \spell{polymorph} spell, except that you can cast it without spending an action point.
\end{ability}
\vspace{0.25em}
...
\begin{ability}[\nth{6}]{Innate}
This subspell functions like the \spell{protection from alignment} spell, except that you can cast it without spending an action point.
\end{ability}
\vspace{0.25em}
...
\begin{ability}[\nth{6}]{Innate}
This subspell functions like the \spell{pyromancy} spell, except that you can cast it without spending an action point.
\end{ability}
\vspace{0.25em}
...
\begin{ability}[\nth{6}]{Innate}
This subspell functions like the \spell{revelation} spell, except that you can cast it without spending an action point.
\end{ability}
\vspace{0.25em}
...
\begin{ability}[\nth{6}]{Innate}
This subspell functions like the \spell{scry} spell, except that you can cast it without spending an action point.
\end{ability}
\vspace{0.25em}
...
\begin{ability}[\nth{6}]{Innate}
This subspell functions like the \spell{summon monster} spell, except that you can cast it without spending an action point.
\end{ability}
\vspace{0.25em}
...
\parhead{Cantrip} You take a \minus2 penalty to accuracy with the spell.
...
\begin{ability}[\nth{6}]{Innate}
This subspell functions like the \spell{telekinesis} spell, except that you can cast it without spending an action point.
\end{ability}
\vspace{0.25em}
...
\parhead{Cantrip} You cannot choose for the spell to heal the target, and the spell deals \minus2d damage.
...
\begin{ability}[\nth{6}]{Innate}
This subspell functions like the \spell{vital surge} spell, except that you can cast it without spending an action point.
\end{ability}
\vspace{0.25em}
...
\begin{ability}[\nth{6}]{Innate}
This subspell functions like the \spell{weaponcraft} spell, except that you can cast it without spending an action point.
\end{ability}
\vspace{0.25em}
