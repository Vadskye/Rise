...
\spellnotes Magic traps such as \spell{symbol of terror} can be detected with the Perception skill and disabled with the Devices skill. The DR in each case is 25 \add spell level, or 32 for \spell{symbol of terror}.
\ritualcost*{7}
\end{spellsection}
...
\begin{spellsection}{Glyph of Warding}[3]
    ...
    \begin{spellfooter}
        ...
        \spellnotes Magic traps such as \spell{glyph of warding} can be detected with the Perception skill and disabled with the Devices skill. The DR is 25 \add spell level, or DR 28 for \spell{glyph of warding}.
        \ritualcost*{3}
    \end{spellfooter}
\end{spellsection}
...
\begin{spellsection}{Glyph of Warding, Greater}[7]
    ...
    \begin{spellfooter}
        ...
        \spellnotes Magic traps such as \spell{greater glyph of warding} can be detected with the Perception skill and disabled with the Devices skill. The DR is 25 \add spell level, or DR 32 for \spell{greater glyph of warding}.
        \ritualcost*{7}
    \end{spellfooter}
\end{spellsection}
...
\begin{spellsection}[Greater]{Legend Lore}[7]
    ...
    \begin{spellcontent}
        ...
        \begin{spelleffects}
            ...
            If the person or thing is at hand, or if you are in the place in question, the DR is 20. If you only know detailed information about the subject, the DR is 30. If you only know rumors about the subject, the DR is 40.
...
\begin{spellsection}{Neutralize Poison}[4]
    ...
    \begin{spellfooter}
        ...
        \spellnotes This does not reverse instantaneous effects from poison, such as hit point damage, or effects that don't go away on their own.
        \ritualcost*{4}
    \end{spellfooter}
\end{spellsection}
...
\begin{spellsection}{Sepia Snake Sigil}[4]
    ...
    \begin{spellfooter}
        ...
        \spellnotes Magic traps such as \spell{sepia snake sigil} can be detected with the Perception skill and disabled with the Devices skill. The DR in each case is 25 \add spell level, or 28 for \spell{sepia snake sigil}.
        \ritualcost{3}
    \end{spellfooter}
\end{spellsection}
...
\begin{spellsection}{Symbol of Death}[7]
    ...
    \begin{spellfooter}
        ...
        \spellnotes Magic traps such as \spell{symbol of death} can be detected with the Perception skill and disabled with the Devices skill. The DR in each case is 25 \add spell level, or 32 for \spell{symbol of death}.
...
\begin{spellsection}{Symbol of Destruction}[7]
    ...
    \begin{spellfooter}
        ...
        \spellnotes Magic traps such as \spell{symbol of destruction} can be detected with the Perception skill and disabled with the Devices skill. The DR in each case is 25 \add spell level, or 32 for \spell{symbol of destruction}.
        \par This ritual can be made permanent with a \spell{permanency} spell. A permanent trap that is disabled becomes inactive for 10 minutes, then can be triggered again as normal.
        \ritualcost*{7}
    \end{spellfooter}
\end{spellsection}
...
\begin{spellsection}{Symbol of Insanity}[6]
    ...
    \begin{spellfooter}
        ...
        \spellnotes Magic traps such as \spell{symbol of insanity} can be detected with the Perception skill and disabled with the Devices skill. The DR in each case is 25 \add spell level, or 31 for \spell{symbol of insanity}.
        \ritualcost*{6}
    \end{spellfooter}
\end{spellsection}
...
\begin{spellsection}{Symbol of Pain}[5]
    ...
    \begin{spellfooter}
        ...
        \spellnotes Magic traps such as \spell{symbol of pain} can be detected with the Perception skill and disabled with the Devices skill. The DR in each case is 25 \add spell level, or 30 for \spell{symbol of pain}.
        \ritualcost*{5}
    \end{spellfooter}
\end{spellsection}
...
\begin{spellsection}{Symbol of Persuasion}[4]
    ...
    \begin{spellfooter}
        ...
        \spellnotes Magic traps such as \spell{symbol of persuasion} can be detected with the Perception skill and disabled with the Devices skill. The DR in each case is 25 \add spell level, or 29 for \spell{symbol of persuasion}.
        \ritualcost*{4}
    \end{spellfooter}
\end{spellsection}
...
\begin{spellsection}{Symbol of Sleep}[7]
    ...
    \begin{spellfooter}
        \spellinfo{Abjuration/Enchantment [Compulsion, Warding] [Mind-Affecting, Trap]}{Arcane}
        \spellnotes Magic traps such as \spell{symbol of sleep} can be detected with the Perception skill and disabled with the Devices skill. The DR in each case is 25 \add spell level, or 32 for \spell{symbol of sleep}.
        \ritualcost*{7}
    \end{spellfooter}
\end{spellsection}
...
\begin{spellsection}{Teleportation Circle}[9]
    ...
    \begin{spellfooter}
        ...
        \spellnotes Magic traps such as \spell{teleportation circle} can be detected with the Perception skill and disabled with the Devices skill. The DR in each case is 25 \add spell level, or 34 for \spell{teleportation circle}.
        \ritualcost*{9}
    \end{spellfooter}
\end{spellsection}
