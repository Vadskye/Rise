...
\section{Weapons}\label{Weapons}
    ...
    \subsection{Weapon Mechanics}
        ...
        \subsubsection{Weapon Tags}\label{Weapon Tags}
            ...
            \parhead{Forceful} Whenever you \glossterm{wound} a target of your size or smaller with a strike using this weapon, you can \glossterm{knockback} the target up to 10 feet.
...
\section{Consumable Items}\label{Consumable Items}
    ...
    \subsection{Poison}\label{Poison}
        ...
        \subsubsection{Poison Transmission}\label{Poison Transmission}\label{Transmission}
            ...
            \parhead{Wound} An wound poison affects any creature \glossterm{wounded} by something carrying the poison.
