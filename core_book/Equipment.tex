...
% Magic consumables are a loosely limited slot, but being consumable is important.
% Standard action attacks are on par with spells.
% Attuned elixirs are one rank behind self-attune spells.
\begin{longcolumn}
\section{Consumables}
