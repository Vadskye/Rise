    ...
    \subsection{Weapon Table}
        ...
        \begin{longtablewrapper}
            ...
            \begin{longtable}{p{10em} c c c >{\ccol}p{7em} c >{\ccol}p{12em}}
                \lcaption{Weapons}                     \\
                \tb{Name}                          & \tb{Usage Class} & \tb{Accuracy} & \tb{Damage} & \tb{Damage Type\fn{1}}   & \tb{Item Level (Cost)}\fn{2} & \tb{Special}                          \tableheaderrule
        ...
        \begin{dtable!*}
            ...
            \begin{dtabularx}{\textwidth}{p{10em} c c c >{\ccol}p{7em} c >{\ccol}X}
                \tb{Exotic Weapons}           & \tb{Usage Class} & \tb{Accuracy} & \tb{Damage} & \tb{Damage Type\fn{1}} & \tb{Item Level (Cost)}\fn{2} & \tb{Special} \tableheaderrule
                Armor                                &         &        &        &                      &        &                                 \\
