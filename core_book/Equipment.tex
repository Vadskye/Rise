...
\section{Wealth And Item Levels}\label{Wealth}
    ...
    \subsection{Item Levels}\label{Item Levels}
        ...
        These effects are summarized in \trefnp{Item Levels}.
        A magic item's \glossterm{power} is equal to half its level (see \pcref{Item Power}).
        ...
        \begin{dtable}
            ...
            \begin{dtabularx}{\columnwidth}{c c >{\ccol}X}
                \tb{Item Level} & \tb{Typical Gear Price} & \tb{Typical Consumable Price} \tableheaderrule
                0   & 2 gp or less  & 4 sp or less \\
                1/2 & 10 gp         & 2 gp         \\
                1   & 50 gp         & 10 gp        \\
                2   & 125 gp        & 25 gp        \\
                3   & 250 gp        & 50 gp        \\
        ...
        Items with an level of 0 or 1 may be found among common folk, though few commoners would have more than one magic item of any value.
    ...
    \subsection{Typical Wealth By Level}
        ...
        This does not include the character's legacy item, if any (see \pcref{Legacy Items}).
    ...
    \subsection{Weapon Groups}\label{Weapon Groups}
        ...
        \begin{dtable!*}
            ...
            \begin{dtabularx}{\textwidth}{l >{\lcol}X >{\lcol}X}
                ...
                Spears             & Greatspear, javelin, lance, ranseur, partisan, spear                             & Pike                                                  \\
    ...
    \subsection{Armor Table}
        ...
        \begin{dtable!*}
            ...
            \begin{dtabularx}{\textwidth}{l c c c c c >{\lcol}X c}
                ...
                Extras\fn{3}          &              &                        &                  &              &                &                   &              \\
                \tind Armor spikes    & \tdash       & \minus1                & \plus1           & \tdash       & \tdash         & Metal             & 1/2 (10 gp)  \\
