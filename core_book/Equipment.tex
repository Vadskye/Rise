    ...
    \subsection{Weapon Table}
        ...
        \begin{dtable!*}
            ...
            \begin{dtabularx}{\textwidth}{p{10em} c c c >{\ccol}p{7em} c >{\ccol}X}
                ...
                Armor                                &         &        &        &                      &        &                                 \\
                \tind Armblade\fn{3}                 & Light   & \plus2 & 1d6    & Slashing             & 1 (50 gp)    & Grappling, Keen                 \\
                \tind Spiked knee\fn{3}              & Light   & \plus1 & 1d6    & Piercing             & 1 (50 gp)    & Grappling, Impact               \\
                Axes                                 &         &        &        &                      &              &                                 \\
                ...
                Bows                                 &         &        &        &                      &              &                                 \\
                \tind Flatbow\fn{3}                  & Heavy   & \plus1 & 1d8    & \tdash               & 1 (50 gp)    & Projectile (90 ft.)             \\
                \tind Heartseeker arrows (20)        & \tdash  & \plus0 & \tdash & Piercing             & 3 (50 gp)    & Ammunition, Impact              \\
                \tind Takedown bow\fn{3}             & Special & \plus0 & 1d8    & \tdash               & 2 (125 gp)   & Projectile (90 ft. or 50 ft.)   \\
                Club-like weapons                    &         &        &        &                      &              &                                 \\
                ...
                Crossbows                            &         &        &        &                      &              &                                 \\
                \tind Repeating heavy crossbow\fn{3} & Heavy   & \plus0 & 1d10   & \tdash               & 4 (500 gp)   & Projectile (60 ft.)             \\
                \tind Repeating light crossbow\fn{3} & Medium  & \plus0 & 1d8    & \tdash               & 3 (250 gp)   & Projectile (60 ft.)             \\
    ...
    \subsection{Armor Table}
        ...
        \begin{dtable!*}
            ...
            \begin{dtabularx}{\textwidth}{l c c c c c c >{\lcol}X c}
                ...
                \tind Tower shield    & \plus3\fn{3} & \tdash  & \tdash  & \plus2\fn{2} & \tdash       & \tdash   & Metal or wood     & 1 (50 gp)   \\
                Extras                &              &         &         &              &              &          &                   &             \\
