...
\section{Weapons}\label{Weapons}
    ...
    \subsection{Weapon Usage Classes}\label{Weapon Usage Classes}
        ...
        \parhead{Medium Weapon} A medium weapon can be used in one hand.
    ...
    \subsection{Weapon Qualities}
        ...
        \begin{longtabuwrapper}
            \begin{longtabu}{p{12em} c c c >{\ccol}p{10em} c c >{\ccol}X}
                ...
                \tind Greatsword                       & Heavy            & \plus1        & \plus1d           & Slashing                 & 25 gp     & 8 lb.       & Long, Sweeping (1)           \\
                ...
                Headed weapons                         &                  &               &                   &                          &           &             &                              \\
                \tind Battleaxe                        & Medium           & \plus0        & \plus1d           & Slashing                 & 10 gp     & 6 lb.       & \tdash                       \\
                ...
                \tind Sledgehammer                     & Heavy            & \plus0        & \plus2d           & Bludgeoning              & 12 gp     & 5 lb.       & Sweeping (1)                 \\
        ...
        \begin{dtable!*}
            \begin{dtabularx}{\textwidth}{p{12em} c c c >{\ccol}p{10em} c c >{\ccol}X}
                ...
                Blades                               &                  &               &                   &                        &           &             &                                \\
                \tind Katana                         & Medium           & \plus2        & \plus0d           & Slashing               & 75 gp     & 6 lb.       & \tdash                               \\
                \tind Kukri                          & Light            & \plus2        & \minus1d          & Slashing               & 8 gp      & 2 lb.       & Sweeping                               \\
    ...
    \subsection{Weapon Tags}\label{Weapon Tags}
        ...
        You can change your grip as a \glossterm{move action}.
        \parhead{Sweeping} When you make a \glossterm{strike} with this weapon, you may also target one or more additional creatures or objects you \glossterm{threaten}.
