...
\section{Using Items}
    ...
    \subsection{Manipulating Objects}\label{Manipulating Objects}
        ...
        However, you can use a minor action or a standard action in place of a free action, allowing you to manipulate up to three objects per round.
    ...
    \subsection{Moving Items Between Hands}\label{Moving Items Between Hands}
        In general, you can move weapons and similar handheld objects around between your hands freely, as long as you are strong enough to hold their combined weight in one hand.
...
\section{Weapons}\label{Weapons}
    ...
    \subsection{Individual Weapon Descriptions}
        ...
        This makes them easy to make use for \glossterm{dual strikes} (see \pcref{Moving Items Between Hands}).
