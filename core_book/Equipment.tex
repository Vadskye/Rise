...
\section{Armor}\label{Armor}
    ...
    \subsection{Armor Table}
        ...
        \begin{dtable!*}
            ...
            \begin{dtabularx}{\textwidth}{l c c c c c >{\lcol}X c}
                ...
                Heavy armor           &              &                        &                  &              &                &                   &              \\
                \tind Layered hide    & \plus4       & \plus8                 & \plus5           & \minus10 ft. & \mult0         & Leather           & 2nd (125 gp) \\
                \tind Plated mail     & \plus4       & \plus10                & \plus7           & \minus10 ft. & \mult0         & Metal             & 3rd (250 gp) \\
    ...
    \subsection{Individual Armor Descriptions}
        ...
        When you take the \textit{total defense} action with a tower shield, you gain a \plus2 bonus to Armor defense in addition to the normal bonuses from taking that action (see \pcref{Total Defense}).
