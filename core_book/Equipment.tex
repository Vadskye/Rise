...
\section{Weapons}\label{Weapons}
    ...
    \subsection{Weapon Mechanics}
        ...
        \subsubsection{Ranged Weapons}
            ...
            Ranged weapons always have a defined \glossterm{range increment} (see \pcref{Range Increments}).
        ...
        \subsubsection{Weapon Tags}\label{Weapon Tags}
            ...
            \parhead{Mounted}\label{Mounted Weapon} If you are mounted, and mount moves in the same phase that you make a \glossterm{strike} with a Mounted weapon, you gain a bonus to damage with the strike equal to your \glossterm{power}.
            ...
            \parhead{Thrown} This weapon is designed to be thrown. Thrown weapons have a range increment listed in their description, which indicates the distance they can be easily thrown. See \pcref{Thrown Weapons}.
    ...
    \subsection{Weapon Table}
        ...
        \begin{dtable!*}
            \begin{dtabularx}{\textwidth}{p{12em} c c c >{\ccol}p{10em} c >{\ccol}X}
                \tb{Exotic Weapons}           & \tb{Usage Class} & \tb{Accuracy} & \tb{Damage} & \tb{Damage Type\fn{1}} & \tb{Cost} & \tb{Special} \tableheaderrule
                Armor                                &         &        &        &                      &        &                                 \\
                Axes                                 &         &        &        &                      &        &                                 \\
                \tind Dwarven throwing axe           & Light   & \plus2 & 1d6    & Slashing             & 8 gp   & Impact, Thrown (20 ft.)         \\
                \tind Dwarven waraxe                 & Medium  & \plus0 & 1d10   & Slashing             & 75 gp  & Thrown (20 ft.), Versatile Grip \\
                \tind Orcish greataxe                & Heavy   & \plus0 & 2d6    & Slashing             & 60 gp  & Impact, Sweeping (1)            \\
                Blades                               &         &        &        &                      &        &                                 \\
                \tind Boot dagger\fn{2}              & Light   & \plus2 & 1d6    & Piercing             & 20 gp  & Compact, Stealthy               \\
                \tind Falchion                       & Medium  & \plus0 & 1d8    & Slashing             & 15 gp  & Sweeping (2), Versatile Grip    \\
                \tind Katana                         & Heavy   & \plus1 & 1d10   & Slashing             & 75 gp  & Keen, Sweeping (1)              \\
                \tind Kukri                          & Light   & \plus2 & 1d6    & Slashing             & 8 gp   & Keen, Sweeping (1)              \\
                Bows                                 &         &        &        &                      &        &                                 \\
                \tind Flatbow\fn{2}                  & Heavy   & \plus1 & 1d8    & \tdash               & 30 gp  & Projectile (90 ft.)             \\
                \tind Heartseeker arrows (20)        & \tdash  & \plus0 & \tdash & Piercing             & 20 gp  & Ammunition, Impact              \\
                \tind Takedown bow\fn{2}             & Special & \plus0 & 1d8    & \tdash               & 200 gp & Projectile (90 ft. or 50 ft.)   \\
                Club-like weapons                    &         &        &        &                      &        &                                 \\
                Crossbows                            &         &        &        &                      &        &                                 \\
                \tind Repeating heavy crossbow\fn{2} & Heavy   & \plus0 & 1d10   & \tdash               & 400 gp & Projectile (60 ft.)             \\
                \tind Repeating light crossbow\fn{2} & Medium  & \plus0 & 1d8    & \tdash               & 250 gp & Projectile (60 ft.)             \\
                \tind Repeating bolts (5)            & \tdash  & \plus0 & \tdash & Piercing             & 1 gp   & Ammunition                      \\
                Flexible weapons                     &         &        &        &                      &        &                                 \\
                \tind Three-section staff            & Heavy   & \plus0 & 1d10   & Bludgeoning          & 40 gp  & Disarming, Long, Tripping       \\
                Headed weapons                       &         &        &        &                      &        &                                 \\
                \tind Heavy pick                     & Heavy   & \plus0 & 2d6    & Piercing             & 40 gp  & Keen, Impact                    \\
                Monk weapons                         &         &        &        &                      &        &                                 \\
                Polearms                             &         &        &        &                      &        &                                 \\
                \tind Fauchard                       & Heavy   & \plus0 & 1d10   & Slashing             & 25 gp  & Long, Sweeping (2)              \\
                \tind War scythe                     & Heavy   & \plus0 & 2d6    & Slashing or piercing & 35 gp  & Sweeping (2)                    \\
                Simple weapons                       &         &        &        &                      &        &                                 \\
                Spear                                &         &        &        &                      &        &                                 \\
                \tind Pike\fn{2}                     & Heavy   & \plus0 & 2d6    & Piercing             & 15 gp. & Long                            \\
                Thrown weapons                       &         &        &        &                      &        &                                 \\
                \tind Bolas                          & Light   & \plus2 & 1d4    & Bludgeoning          & 5 gp   & Thrown (10 ft.), Tripping       \\
                \tind Dwarven throwing axe           & Light   & \plus2 & 1d6    & Slashing             & 8 gp   & Impact, Thrown (20 ft.)         \\
                \tind Dwarven waraxe                 & Medium  & \plus0 & 1d10   & Slashing             & 75 gp  & Thrown (20 ft.), Versatile Grip \\
                \tind Net\fn{2}                      & Medium  & \plus0 & \tdash & \tdash               & 20 gp  & Thrown (10 ft.)                 \\
                Unarmed weapons                      &         &        &        &                      &        &                                 \\
            \end{dtabularx}
            1 When two types are given, the weapon is both types if the entry specifies ``and,'' or either type (attacker's choice) if the entry specifies ``or.'' \\
            2 This weapon has special rules. \\
        ...
        \begin{dtable!*}
            ...
            \begin{dtabularx}{\textwidth}{p{12em} c c c >{\ccol}p{15em} >{\ccol}X}
                \tb{Natural Weapons} & \tb{Usage Class} & \tb{Accuracy} & \tb{Damage} & \tb{Damage Type\fn{1}}   & \tb{Special} \tableheaderrule
                Bite                 & Medium           & \plus0        & 1d8         & Piercing and bludgeoning & Grappling \\
                Claw                 & Light            & \plus2        & 1d6         & Slashing and piercing    & \tdash    \\
                Constrict\fn{2}      & Medium           & \plus0        & 1d10        & Bludgeoning              & Grappling \\
                Gore                 & Medium           & \plus0        & 1d8         & Piercing                 & Impact    \\
                Ram                  & Medium           & \plus0        & 1d8         & Bludgeoning              & Forceful  \\
                Slam                 & Medium           & \plus0        & 1d10        & Bludgeoning              & \tdash    \\
    ...
    \subsection{Armor Table}
        ...
        \begin{dtable!*}
            ...
            \begin{dtabularx}{\textwidth}{l c c c c c c >{\lcol}X c}
                \tb{Armor}            & \tb{Defense} & \tb{Physical Resist} & \tb{Energy Resist} & \tb{Encumbrance} & \tb{Speed}   & \tb{Dex} & \tb{Material}     & \tb{Cost}  \tableheaderrule
                Light armor              &              &         &         &              &              &          &                   &            \\
                \tind Leather            & \plus2       & \plus1  & \plus3  & \plus1       & \tdash       & \tdash   & Leather           & 10 gp      \\
                \tind Studded leather    & \plus2       & \plus3  & \plus3  & \plus2       & \tdash       & \tdash   & Leather and metal & 25 gp      \\
                \tind Chain shirt        & \plus2       & \plus4  & \plus2  & \plus2       & \tdash       & \tdash   & Metal             & 40 gp      \\
                \tind Buckler            & \plus1       & \tdash  & \tdash  & \tdash       & \tdash       & \tdash   & Metal or wood     & 15 gp      \\
                Medium armor             &              &         &         &              &              &          &                   &            \\
                \tind Hide               & \plus3       & \plus3  & \plus5  & \plus3       & \minus5 ft.  & \tdash   & Leather           & 30 gp      \\
                \tind Scale mail         & \plus3       & \plus7  & \plus2  & \plus5       & \minus5 ft.  & \tdash   & Metal             & 75 gp      \\
                \tind Breastplate        & \plus3       & \plus6  & \plus3  & \plus4       & \minus5 ft.  & \tdash   & Metal             & 150 gp     \\
                \tind Standard shield    & \plus2       & \tdash  & \tdash  & \tdash\fn{1} & \tdash       & \tdash   & Metal or wood     & 15 gp      \\
                Heavy armor              &              &         &         &              &              &          &                   &            \\
                \tind Layered hide       & \plus4       & \plus4  & \plus6  & \plus5       & \minus10 ft. & \mult1/2 & Leather           & 100 gp     \\
                \tind Plated mail        & \plus4       & \plus7  & \plus4  & \plus6       & \minus10 ft. & \mult1/2 & Metal             & 250 gp     \\
                \tind Half-plate         & \plus4       & \plus8  & \plus4  & \plus7       & \minus10 ft. & \mult1/2 & Metal             & 500 gp     \\
                \tind Full plate         & \plus4       & \plus8  & \plus5  & \plus6       & \minus10 ft. & \mult1/2 & Metal             & 1,000 gp   \\
                \tind Tower shield       & \plus3\fn{2} & \tdash  & \tdash  & \plus2\fn{1} & \tdash       & \tdash   & Metal or wood     & 30 gp      \\
                Extras                   &              &         &         &              &              &          &                   &            \\
                \tind Armor spikes       & \tdash       & \minus1 & \minus1 & \plus1       & \tdash       & \tdash   & Metal             & \plus50 gp \\
                \tind Locked gauntlet    & \tdash       & \tdash  & \tdash  & Special      & \tdash       & \tdash   & Metal             & 8 gp       \\
                \tind Shield spikes      & \tdash       & \tdash  & \tdash  & \tdash       & \tdash       & \tdash   & Metal             & \plus10 gp \\
            \end{dtabularx}
...
\begin{dtabularx}{\textwidth}{l c c c c c >{\lcol}X}
    \tb{Material}     & \tb{Defense} & \tb{Physical Resist} & \tb{Energy Resist} & \tb{Encumbrance} & \tb{Material} & \tb{Cost}              \tableheaderrule
    \tind Adamantine           & \tdash  & \mult3   & \mult3 & \plus2  & Metal   & \mult10, \plus10,000 gp  \\
    \tind Adamantine, pure     & \tdash  & \mult5   & \mult5 & \plus3  & Metal   & \mult50, \plus250,000 gp \\
    \tind Cold iron            & Special & \mult1/2 & \tdash & \tdash  & Metal   & \mult5, \plus2,000 gp    \\
    \tind Diamondsteel         & \tdash  & \tdash   & \mult3 & \tdash  & Metal   & \mult10, \plus10,000 gp  \\
    \tind Diamondsteel, pure   & \tdash  & \mult2   & \mult5 & \tdash  & Metal   & \mult50, \plus250,000 gp \\
    \tind Deepforged           & \tdash  & \mult2   & \mult2 & \tdash  & Metal   & \mult10, \plus10,000 gp  \\
    \tind Dragonhide           & \tdash  & \tdash   & \mult2 & \tdash  & Leather & \mult5, \plus2,000 gp    \\
    \tind Dragonhide, ancient  & \tdash  & \mult2   & \mult4 & \tdash  & Leather & \mult20, \plus50,000 gp  \\
    \tind Dragonscale          & \tdash  & \tdash   & \mult2 & \tdash  & Metal   & \mult5, \plus2,000 gp    \\
    \tind Dragonscale, ancient & \tdash  & \tdash   & \mult4 & \tdash  & Metal   & \mult20, \plus50,000 gp  \\
    \tind Elvenweave           & \tdash  & \mult2   & \mult2 & \tdash  & Leather & \mult10, \plus10,000 gp  \\
    \tind Ironwood             & \tdash  & \tdash   & \tdash & \tdash  & Metal   & \mult2, \plus400 gp      \\
    \tind Mithral              & \tdash  & \tdash   & \tdash & \minus2 & Metal   & \mult5, \plus2,000 gp    \\
    \tind Mithral, pure        & \tdash  & \mult2   & \mult2 & \minus3 & Metal   & \mult20, \plus50,000 gp  \\
    \tind Starmetal            & \tdash  & \mult2   & \tdash & \plus1  & Metal   & \mult5, \plus2,000 gp    \\
    \tind Starmetal, pure      & \tdash  & \mult4   & \mult2 & \plus2  & Metal   & \mult20, \plus50,000 gp  \\
\end{dtabularx}
        \end{dtable!*}

        \parhead{Adamantine} Adamantine armor increases the \glossterm{encumbrance penalty} of the armor by 2, but it triples the \glossterm{resistance} provided by the armor against both \glossterm{physical damage} and \glossterm{energy damage}.
        It costs ten times as much as armor of that type would normally cost, plus an additional 10,000 gp.

        \parhead{Adamantine, Pure} Pure adamantine armor increases the \glossterm{encumbrance penalty} of the armor by 3, but it quintuples the \glossterm{resistance} provided by the armor against both \glossterm{physical damage} and \glossterm{energy damage}.
        ...
        \parhead{Deepforged} Deepforged body armor doubles the \glossterm{resistance} provided by the armor against both \glossterm{physical damage} and \glossterm{energy damage}.
        It costs ten times as much as armor of that type would normally cost, plus an additional 10,000 gp.

        \parhead{Diamondsteel} Diamondsteel body armor triples the \glossterm{resistance} provided by the armor against \glossterm{energy damage}.
        It costs ten times as much as armor of that type would normally cost, plus an additional 10,000 gp.

        \parhead{Diamondsteel, Pure} Pure diamondsteel body armor quintuples the \glossterm{resistance} provided by the armor against \glossterm{energy damage}.
        In addition, it double the \glossterm{resistance} provided by the armor against \glossterm{physical damage}.
        It costs fifty times as much as armor of that type would normally cost, plus an additional 250,000 gp.

        \parhead{Dragonhide} Dragonhide body armor doubles the \glossterm{resistance} provided by the armor against \glossterm{energy damage}.
        It costs five times as much as armor of that type would normally cost, plus an additional 2,000 gp.

        \parhead{Dragonhide, Ancient} Ancient dragonhide body armor quadruples the \glossterm{resistance} provided by the armor against \glossterm{energy damage}, and doubles the resistance provided by the armor against \glossterm{physical damage}.
        It costs twenty times as much as armor of that type would normally cost, plus an additional 50,000 gp.

        \parhead{Dragonscale} Dragonscale body armor doubles the \glossterm{resistance} provided by the armor against \glossterm{energy damage}.
        It costs five times as much as armor of that type would normally cost, plus an additional 2,000 gp.

        \parhead{Dragonscale, Ancient} Ancient dragonscale body armor quadruples the \glossterm{resistance} provided by the armor against \glossterm{energy damage}, and double the resistance provided by the armor against \glossterm{physical damage}.
        It costs twenty times as much as armor of that type would normally cost, plus an additional 50,000 gp.

        \parhead{Elvenweave} Deepforged body armor doubles the \glossterm{resistance} provided by the armor against both \glossterm{physical damage} and \glossterm{energy damage}.
        It costs ten times as much as armor of that type would normally cost, plus an additional 10,000 gp.
        ...
        \parhead{Mithral} Mithral armor reduces the \glossterm{encumbrance penalty} of the armor by 2.
        It costs five times as much as armor of that type would normally cost, plus an additional 2,000 gp.

        \parhead{Mithral, Pure} Pure mithral armor reduces the \glossterm{encumbrance penalty} of the armor by 3, and doubles its \glossterm{resistance} provided by the armor against both \glossterm{energy damage} and \glossterm{physical damage}.
        It costs twenty times as much as armor of that type would normally cost, plus an additional 50,000 gp.

        \parhead{Starmetal} Starmetal body armor increases the \glossterm{encumbrance penalty} of the armor by 1, but it doubles the \glossterm{resistance} provided by the armor against \glossterm{physical damage}.
        It costs five times as much as armor of that type would normally cost, plus an additional 2,000 gp.

        \parhead{Starmetal, Pure} Pure starmetal body armor increases the \glossterm{encumbrance penalty} of the armor by 2, but it quadruples the \glossterm{resistance} provided by the armor against \glossterm{physical damage} and doubles the resistance provided by the armor against \glossterm{energy damage}.
        It costs twenty times as much as armor of that type would normally cost, plus an additional 50,000 gp.
...
\section{Goods And Services}
    ...
    \begin{dtable!*}
        ...
        \begin{dtabularx}{\textwidth}{>{\lcol}X c >{\lcol}X c >{\lcol}X c}
            ...
            Backpack (empty)         & 2 gp  & \tind Good               & 1 lb.         & Alchemist's lab     & 500 gp \\
            Barrel (empty)           & 2 gp  & \tind Amazing            & 1 lb.         & Artisan's tools     & 5 gp   \\
            Basket (empty)           & 4 sp  & Manacles                 & 2 lb.         & Disguise kit        & 50 gp  \\
            Bedroll                  & 1 sp  & Manacles, masterwork     & 2 lb.         & Holy symbol, wooden & 1 gp   \\
            Bell                     & 1 gp  & Mirror, small steel      & 1/2 lb.       & Holy symbol, silver & 25 gp  \\
            Blanket, winter          & 5 sp  & Mug/Tankard, clay        & 1 lb.         & Hourglass           & 25 gp  \\
            Block and tackle         & 5 gp  & Oil (1-pint flask)       & 1 lb.         & Magnifying glass    & 100 gp \\
            Bottle, wine, glass      & 2 gp  & Paper (sheet)            & \tdash        & Scale, merchant's   & 2 gp   \\
            Bucket (empty)           & 5 sp  & Parchment (sheet)        & \tdash        & Thieves' tools      & 30 gp  \\
            Caltrops                 & 1 gp  & Pick, miner's            & 10 lb.        &                     &        \\
            Candle                   & 1 cp  & Pitcher, clay            & 5 lb.         &                     &        \\
            Canvas (sq.\ yd.)        & 1 sp  & Piton                    & 1/2 lb.       &                     &        \\
            Case, map or scroll      & 1 gp  & Pole, 10 foot            & 8 lb.         &                     &        \\
            Chain (10 ft.)           & 30 gp & Pot, iron                & 10 lb.        &                     &        \\
            Chalk, 1 piece           & 1 cp  & Pouch, belt (empty)      & 1/2 lb.\fn{1} &                     &        \\
            Chest (empty)            & 2 gp  & Ram, portable            & 20 lb.        &                     &        \\
            Crowbar                  & 2 gp  & Rations, trail (per day) & 1 lb.\fn{1}   &                     &        \\
            Firewood (per day)       & 1 cp  & Rope, hempen (60 ft.)    & 10 lb.        &                     &        \\
            Fishhook                 & 1 sp  & Rope, silk (60 ft.)      & 5 lb.         &                     &        \\
            Fishing net, 25 sq.\ ft. & 4 gp  & Sack (empty)             & 1/2 lb.\fn{1} &                     &        \\
            Flask (empty)            & 3 cp  & Sealing wax              & 1 lb.         &                     &        \\
            Flint and steel          & 1 gp  & Sewing needle            & \tdash        &                     &        \\
            Grappling hook           & 1 gp  & Signal whistle           & \tdash        &                     &        \\
            Hammer                   & 5 sp  & Signet ring              & \tdash        &                     &        \\
            Ink (1 oz.\ vial)        & 8 gp  & Sledge                   & 10 lb.        &                     &        \\
            Inkpen                   & 1 sp  & Soap (per lb.)           & 1 lb.         &                     &        \\
            Jug, clay                & 3 cp  & Spade or shovel          & 8 lb.         &                     &        \\
            Ladder, 10 foot          & 2 sp  & Spyglass                 & 1 lb.         &                     &        \\
            Lamp, common             & 1 sp  & Tent                     & 20 lb.\fn{1}  &                     &        \\
            Lantern, bullseye        & 12 gp & Torch                    & 1 lb.         &                     &        \\
            Lantern, hooded          & 7 gp  & Vial, ink or potion      & 1/10 lb.      &                     &        \\
            Lock                     &       & Waterskin                & 4 lb.\fn{1}   &                     &        \\
            \tind Very simple        & 20 gp & Whetstone                & 1 lb.         &                     &        \\
        \end{dtabularx}
    ...
    \begin{dtable!*}
        \begin{dtabularx}{\textwidth}{>{\lcol}X c >{\lcol}X c >{\lcol}X c}
            ...
            \tb{Food, Drink, and Lodging} &           & \tind Warhorse, heavy & 400 gp       & Service             & \multicolumn{2}{l}{Cost}          \\
            Item                          & Cost      & \tind Warhorse, light & 150 gp       & Coach cab           & \multicolumn{2}{l}{3 cp per mile} \\
            Ale                           &           & \tind Warpony         & 100 gp       & Hireling, trained   & \multicolumn{2}{l}{3 sp per day}  \\
            \tind Gallon                  & 2 sp      & Saddle                &              & Hireling, untrained & \multicolumn{2}{l}{1 sp per day}  \\
            \tind Mug                     & 4 cp      & \tind Military        & 20 gp        & Messenger           & \multicolumn{2}{l}{2 cp per mile} \\
            Banquet (per person)          & 10 gp     & \tind Pack            & 5 gp         & Road or gate toll   & \multicolumn{2}{l}{1 cp}          \\
            Bread, per loaf               & 2 cp      & \tind Riding          & 10 gp        & Ship's passage      & \multicolumn{2}{l}{1 sp per mile} \\
    ...
    \subsection{Mounts and Related Gear}
        ...
        \par Flying creatures can't fly in barding that gives them an \glossterm{encumbrance penalty} (see \pcref{Flying Mechanics}).
...
\begin{dtable*}
    ...
    \begin{dtabularx}{\textwidth}{l l l l >{\lcol}X >{\lcol}X >{\lcol}X l}
        \tb{Poison}         & \tb{Transmission}                & \tb{Form}                      & \tb{Base Accuracy}                             & \tb{Type}
