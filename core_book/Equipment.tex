...
\section{Weapons}\label{Weapons}
    ...
    \subsection{Weapon Groups}\label{Weapon Groups}
        ...
        \begin{dtable!*}
            ...
            \begin{dtabularx}{\textwidth}{l >{\lcol}X >{\lcol}X}
                ...
                Simple weapons     & Club, dagger, heavy crossbow, quarterstaff                          & \tdash                                                     \\
    ...
    \subsection{Weapon Table}
        ...
        \begin{longtablewrapper}
            ...
            \begin{longtable}{p{10em} c c c >{\ccol}p{7em} c >{\ccol}p{12em}}
                ...
                Armor weapons                      &        &         &        &                          &              &                                                \\
                \tind Armor spikes\fn{3}           & Medium & \tdash  & 1d4    & Piercing                 & \tdash       & \tdash                                      \\
                \tind Standard shield\fn{3}        & Medium & \plus0  & 1d3    & Bludgeoning              & 0 (10 gp)  & Forceful                                       \\
                \tind Spiked shield\fn{3}          & Medium & \plus0  & 1d4    & Piercing                 & 1 (50 gp)  & Forceful                                       \\
                ...
                \tind Handaxe                      & Light  & \plus2  & 1d4    & Slashing                 & 0 (10 gp)  & Thrown (30/60)                                 \\
                ...
                % \tind Flanged mace                 & Medium & \plus0  & 1d8   & Bludgeoning              & 0 (10 gp)  & Versatile Grip                                 \\
                ...
                \tind Spear\fn{3}                  & Medium & \plus0  & 1d6    & Piercing                 & 0 (10 gp)  & Thrown (30/60), Versatile Grip                 \\
                ...
                Armor                          &         &        &        &                          &              &                                \\
                \tind Armblade\fn{3}           & Light   & \plus2 & 1d4    & Slashing                 & 1 (40 gp)  & Grappling, Keen                \\
                \tind Spiked knee\fn{3}        & Light   & \plus1 & 1d4    & Piercing                 & 1 (40 gp)  & Grappling, Impact              \\
                Axes                           &         &        &        &                          &              &                                \\
                ...
                Blades                         &         &        &        &                          &              &                                \\
                \tind Boot dagger\fn{3}        & Light   & \plus2 & 1d4    & Piercing                 & 0 (10 gp)  & Compact, Stealthy              \\
                ...
                \tind Dwarven throwing axe     & Light   & \plus2 & 1d4    & Slashing                 & 0 (10 gp)  & Impact, Thrown (60/120)        \\
                \tind Dwarven waraxe           & Medium  & \plus0 & 1d8   & Slashing                 & 1 (40 gp)  & Thrown (30/60), Versatile Grip \\
                \tind Net\fn{3}                & Medium  & \plus0 & \tdash & \tdash                   & 0 (10 gp)  & Thrown (15/30)                  \\
            \end{longtable}
        ...
        \begin{dtable!*}
            ...
            \begin{dtabularx}{\textwidth}{p{12em} c c c >{\ccol}p{15em} >{\ccol}X}
                ...
                Claw\fn{2}             & Light            & \plus2        & 1d4         & Slashing               & Versatile Grip \\
                Gore                   & Medium           & \plus0        & 1d6         & Piercing               & Impact         \\
                Punch/kick\fn{2}\fn{3} & Light            & \plus0        & 1d3         & Bludgeoning            & Subdual        \\
                Ram                    & Medium           & \plus0        & 1d6         & Bludgeoning            & Forceful       \\
                Slam\fn{2}             & Medium           & \plus0        & 1d10        & Bludgeoning            & \tdash         \\
    ...
    \subsection{Individual Weapon Descriptions}
        ...
        If you are trained in the Balance skill or have a Dexterity of at least 2, attacking with this natural weapon does not require a \glossterm{free hand}.
        In addition, you cannot use the \ability{offhand strike} ability to attack with a punch or kick.
...
\section{Tools, Goods, and Mounts}
    ...
    A subset of particularly expensive items is included in \tref{Consumable Tools} and \tref{Permanent Tools}.
