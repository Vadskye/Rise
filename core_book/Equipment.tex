...
\section{Armor}\label{Armor}
    ...
    \subsection{Individual Armor Descriptions}
        ...
        When you take the \textit{total defense} action with a tower shield, you gain a \plus3 bonus to Armor defense in addition to the normal bonuses from taking that action (see \pcref{Total Defense}).
