    ...
    \subsection{Getting Into And Out Of Armor}
        ...
        \begin{dtable!*}
            ...
            \begin{dtabularx}{\textwidth}{>{\lcol}X c c c c c c}
                \tb{Armor} & \tb{Defense Bonus} & \tb{Dex Multiplier} & \tb{Encumbrance} & \tb{Material} & \tb{Cost} & \tb{Weight\fn{1}} \tableheaderrule
                Light armor &  &  &  &  &  &  \\
                ...
                \tind Full plate       & \plus5        & 1/2\x  & \plus6       & Metal             & 500 gp     & 50 lb.      \\
                Shields                &               &        &              &                   &            &             \\
            ...
            2 Speed is reduced by 5 feet while wearing medium armor (see \pcref{Armor Usage Classes}). \\
            3 Speed is reduced by 10 feet (see \pcref{Armor Usage Classes}). \\
...
\section{Goods And Services}
    ...
    \subsection{Adventuring Gear}
        ...
        \parhead{Chain} Chain has hardness 10 and a \glossterm{wound threshold} of 10. It can be burst with a DR 26 Strength check.
        ...
        \parhead{Rope, Hempen} This rope has a \glossterm{wound threshold} of 4 and can be burst with a DR 23 Strength check.
        \parhead{Rope, Silk} This rope has a \glossterm{wound threshold} of 5 and can be burst with a DR 24 Strength check.
