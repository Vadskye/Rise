...
\section{Armor}\label{Armor}
    ...
    \subsection{Armor Table}
        ...
        \parhead{Damage Resistance} This value indicates how much the armor increases your \glossterm{damage resistance} (see \pcref{Resistances}).
        ...
        \begin{dtable!*}
            ...
            \begin{dtabularx}{\textwidth}{l c c c c c >{\lcol}X c}
                \tb{Armor}            & \tb{Defense} & \tb{Damage Resistance} & \tb{Encumbrance} & \tb{Speed}   & \tb{Dex} & \tb{Material}     & \tb{Item Level (Cost)}\fn{1}  \tableheaderrule
                Light armor           &              &         &              &              &          &                   &              \\
                \tind Leather         & \plus2       & \plus1  & \plus1       & \tdash       & \tdash   & Leather           & 1/2 (10 gp)  \\
                \tind Studded leather & \plus2       & \plus2  & \plus2       & \tdash       & \tdash   & Leather and metal & 1st (50 gp)  \\
                \tind Chain shirt     & \plus2       & \plus3  & \plus2       & \tdash       & \tdash   & Metal             & 1st (50 gp)  \\
                \tind Buckler         & \plus1       & \tdash  & \tdash       & \tdash       & \tdash   & Metal or wood     & 1/2 (10 gp)  \\
                Medium armor          &              &         &              &              &          &                   &              \\
                \tind Hide            & \plus3       & \plus3  & \plus3       & \minus5 ft.  & \tdash   & Leather           & 1st (50 gp)  \\
                \tind Scale mail      & \plus3       & \plus4  & \plus5       & \minus5 ft.  & \tdash   & Metal             & 1st (50 gp)  \\
                \tind Breastplate     & \plus3       & \plus4  & \plus4       & \minus5 ft.  & \tdash   & Metal             & 2nd (125 gp) \\
                \tind Standard shield & \plus2       & \tdash  & \tdash\fn{2} & \tdash       & \tdash   & Metal or wood     & 1/2 (10 gp)  \\
                Heavy armor           &              &         &              &              &          &                   &              \\
                \tind Layered hide    & \plus4       & \plus5  & \plus5       & \minus10 ft. & \mult1/2 & Leather           & 2nd (125 gp) \\
                \tind Plated mail     & \plus4       & \plus6  & \plus6       & \minus10 ft. & \mult1/2 & Metal             & 3rd (250 gp) \\
                \tind Half-plate      & \plus4       & \plus7  & \plus7       & \minus10 ft. & \mult1/2 & Metal             & 4th (500 gp) \\
                \tind Full plate      & \plus4       & \plus8  & \plus6       & \minus10 ft. & \mult1/2 & Metal             & 5th (800 gp) \\
                \tind Tower shield    & \plus3\fn{3} & \tdash  & \plus2\fn{2} & \tdash       & \tdash   & Metal or wood     & 1st (50 gp)  \\
                Extras                &              &         &              &              &          &                   &              \\
                \tind Armor spikes    & \tdash       & \minus1 & \plus1       & \tdash       & \tdash   & Metal             & \tdash       \\
...
\begin{dtabularx}{\textwidth}{l c c c c >{\lcol}X}
    \tb{Material}              & \tb{Damage Resistance} & \tb{Encumbrance} & \tb{Special Effect}                    & \tb{Material} & \tb{Item Level}              \tableheaderrule
    % metal high resistance, encum
    \tind Adamantine           & \mult4                 & \plus2           & \tdash                                 & Metal         & \plus9  \\
    \tind Adamantine, pure     & \mult8                 & \plus2           & \tdash                                 & Metal         & \plus15 \\
    % magic defense                                                          
    \tind Cold iron            & \mult1/2               & \tdash           & \plus1 defense vs magic                & Metal         & \plus6  \\
    \tind Cold iron, pure      & \mult1/2               & \tdash           & \plus2 defense vs magic                & Metal         & \plus12 \\
    % metal resistance                                                       
    \tind Deepforged           & \mult2                 & \tdash           & \tdash                                 & Metal         & \plus6  \\
    \tind Deepforged, pure     & \mult4                 & \tdash           & \tdash                                 & Metal         & \plus12 \\
    % metal crit resistance                                                  
    \tind Diamondsteel         & \tdash                 & \tdash           & \plus4 defense vs strike crits         & Metal         & \plus6  \\
    \tind Diamondsteel, pure   & \mult2                 & \tdash           & \plus4 defense vs crits                & Metal         & \plus12 \\
    % offset leather resistance, energy defense bonus                        
    \tind Dragonhide           & \mult3                 & \tdash           & \plus4 defense vs specific energy type & Leather       & \plus9  \\
    \tind Dragonhide, ancient  & \mult6                 & \tdash           & \plus6 defense vs specific energy type & Leather       & \plus15 \\
    % offset metal resistance, energy defense bonus                          
    \tind Dragonscale          & \mult3                 & \tdash           & \plus4 defense vs specific energy type & Metal         & \plus9  \\
    \tind Dragonscale, ancient & \mult6                 & \tdash           & \plus6 defense vs specific energy type & Metal         & \plus15 \\
    % leather resistance                                                     
    \tind Elvenweave           & \mult2                 & \tdash           & \tdash                                 & Leather       & \plus6  \\
    \tind Elvenweave, pure     & \mult4                 & \tdash           & \tdash                                 & Leather       & \plus12 \\
    % idk                                                                    
    \tind Ironwood             & \tdash                 & \tdash           & \tdash                                 & Metal         & \plus3  \\
    % metal encumbrance reduction                                            
    \tind Mithral              & \tdash                 & \minus2          & \tdash                                 & Metal         & \plus6  \\
    \tind Mithral, pure        & \mult2                 & \minus3          & Reduce usage class                     & Metal         & \plus12 \\
    % metal resistance, recovery, encumbrance penalty                        
    \tind Starmetal            & \mult2                 & \plus2           & Recover resistances                    & Metal         & \plus6  \\
    \tind Starmetal, pure      & \mult4                 & \plus2           & Recover resistances                    & Metal         & \plus12 \\
\end{dtabularx}
        \end{dtable!*}
        ...
        \parhead{Diamondsteel} Diamondsteel body armor grants you a \plus4 bonus to defenses when determining whether a \glossterm{strike} gets a \glossterm{critical hit} against you instead of a normal hit.
        The armor's item level is increased by 6, which increases the typical cost to buy the item (see \pcref{Item Levels}).

        \parhead{Diamondsteel, Pure} Pure diamondsteel body armor grants you a \plus4 bonus to defenses when determining whether any attack gets a \glossterm{critical hit} against you instead of a normal hit.
        ...
        It provides a \plus4 bonus to \glossterm{defenses} against attacks that deal damage of the type dealt by that dragon's breath weapon.
        The armor's item level is increased by 9, which increases the typical cost to buy the item (see \pcref{Item Levels}).
        ...
        It provides a \plus6 bonus to \glossterm{defenses} against attacks that deal damage of the type dealt by that dragon's breath weapon.
        The armor's item level is increased by 15, which increases the typical cost to buy the item (see \pcref{Item Levels}).
        ...
        In addition, it reduces the \glossterm{encumbrance} of the armor by 3, and it causes the armor to be considered one \glossterm{usage class} lighter, to a minimum of a light usage class (see \pcref{Armor Usage Classes}).
        The armor's item level is increased by 12, which increases the typical cost to buy the item (see \pcref{Item Levels}).
        ...
        When you use the \textit{recover} ability while wearing starmetal body armor, you also regain an amount of \glossterm{damage resistance} equal to the damage resistance provided by the armor, ignoring magical enhancements.
        The armor's item level is increased by 6, which increases the typical cost to buy the item (see \pcref{Item Levels}).
