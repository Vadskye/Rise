...
\section{Weapons}\label{Weapons}
  ...
  \subsection{Weapon Special Materials}\label{Weapon Special Materials}
    ...
    \subsubsection{Weapon Special Material Prices}
      ...
      Unlike other weapons, adamantine weapons are not \glossterm{lightweight}, so \abilitytag{Heavy} adamantine weapons typically require a minimum Strength of 1.
      ...
      Unlike other weapons, pure adamantine weapons are not \glossterm{lightweight}, so \abilitytag{Heavy} adamantine weapons typically require a minimum Strength of 1.
