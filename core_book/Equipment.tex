    ...
    \subsection{Weapon Table}
        ...
        \begin{dtable!*}
            \begin{dtabularx}{\textwidth}{p{12em} c c c >{\ccol}p{10em} c >{\ccol}X}
                ...
                Armor                                &         &        &        &                      &        &                                 \\
                \tind Armblade\fn{2}                 & Light   & \plus2 & 1d6    & Slashing             & 10 gp  & Grappling, Keen                 \\
                \tind Spiked knee\fn{2}              & Light   & \plus1 & 1d6    & Piercing             & 10 gp  & Grappling, Impact               \\
                Axes                                 &         &        &        &                      &        &                                 \\
    ...
    \subsection{Armor Table}
        ...
        \begin{dtable!*}
            ...
            \begin{dtabularx}{\textwidth}{l c c c c c c >{\lcol}X c}
                ...
                Heavy armor              &              &         &         &              &              &          &                   &            \\
                \tind Layered hide       & \plus4       & \plus3  & \plus6  & \plus5       & \minus10 ft. & \mult1/2 & Leather           & 100 gp     \\
