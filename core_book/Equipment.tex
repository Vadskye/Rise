    ...
    \subsection{Weapon Special Materials}\label{Weapon Special Materials}
        ...
        \begin{dtable!*}
            ...
            \begin{dtabularx}{\textwidth}{l >{\lcol}X l}
                ...
                \tind Adamantine, pure    & \plus2d, double damage to objects         & \plus6 \\
                ...
                \tind Mithral             & \plus1 accuracy, \minus1d damage          & \plus4 \\
                \tind Mithral, pure       & \plus2 accuracy, \minus2d damage          & \plus6 \\
                % just vulnerabilities  
    ...
    \subsection{Armor Special Materials}\label{Armor Special Materials}
        ...
        \begin{dtable!*}
            ...
            \begin{dtabularx}{\textwidth}{l l l l >{\ccol}X l}
                \tb{Material}        & \tb{Item Rank} & \tb{Damage Resistance} & \tb{Encumbrance} & \tb{Special Effect}                & \tb{Material} \tableheaderrule
                % metal high resistance, encum
                Adamantine           & \plus3         & \mult4                 & \plus2           & \tdash                             & Metal   \\
                Adamantine, pure     & \plus5         & \mult8                 & \plus2           & \tdash                             & Metal   \\
                % magic defense                                                                  
                Cold iron            & \plus2         & \mult1/2               & \tdash           & \plus1 defense vs magic            & Metal   \\
                Cold iron, pure      & \plus4         & \mult1/2               & \tdash           & \plus2 defense vs magic            & Metal   \\
                % metal resistance                                                               
                Deepforged           & \plus2         & \mult2                 & \tdash           & \tdash                             & Metal   \\
                Deepforged, pure     & \plus4         & \mult4                 & \tdash           & \tdash                             & Metal   \\
                % metal crit resistance                                                  
                Diamondsteel         & \plus2         & \tdash                 & \tdash           & \plus4 defense vs strike crits     & Metal   \\
                Diamondsteel, pure   & \plus4         & \mult2                 & \tdash           & \plus4 defense vs crits            & Metal   \\
                % offset leather resistance, energy defense bonus                        
                Dragonhide           & \plus3         & \mult3                 & \tdash           & Impervious to specific energy type & Leather \\
                Dragonhide, ancient  & \plus5         & \mult6                 & \tdash           & Immune to specific damage type     & Leather \\
                % offset metal resistance, energy defense bonus                          
                Dragonscale          & \plus3         & \mult3                 & \tdash           & Impervious to specific energy type & Metal   \\
                Dragonscale, ancient & \plus5         & \mult6                 & \tdash           & Immune to specific energy type     & Metal   \\
                % leather resistance                                                             
                Elvenweave           & \plus2         & \mult2                 & \tdash           & \tdash                             & Leather \\
                Elvenweave, pure     & \plus4         & \mult4                 & \tdash           & \tdash                             & Leather \\
                % idk                                                                            
                Ironwood             & \plus1         & \tdash                 & \tdash           & \tdash                             & Metal   \\
                % metal encumbrance reduction                                            
                Mithral              & \plus2         & \tdash                 & \minus2          & \tdash                             & Metal   \\
                Mithral, pure        & \plus4         & \mult2                 & \minus3          & Improve Dex multiplier             & Metal   \\
                % metal resistance, recovery, encumbrance penalty                        
                Starmetal            & \plus2         & \mult2                 & \plus2           & Recover damage resistance          & Metal   \\
                Starmetal, pure      & \plus4         & \mult4                 & \plus2           & Recover damage resistance          & Metal   \\
            \end{dtabularx}
        \end{dtable!*}
