...
\section{Wealth And Item ranks}\label{Wealth}\label{Wealth and Item Ranks}
    ...
    \subsection{Typical Wealth Acquisition}
        In general, a typical character finds one non-consumable item appropriate for them per level.
    ...
    \subsection{Weapon Table}
        ...
        \begin{longtablewrapper}
            ...
            \begin{longtable}{p{10em} c c c >{\ccol}p{7em} c >{\ccol}p{12em}}
                ...
                \tind Standard spiked shield\fn{3} & Medium & \plus0  & 1d6    & Piercing                 & 0 (10 gp)  & Forceful                                       \\
                ...
                \tind Sickle                       & Light  & \plus1  & 1d6    & Slashing                 & 0 (10 gp)  & Sweeping (1), Tripping                         \\
...
\begin{dtabularx}{\textwidth}{l c c c c >{\lcol}X}
    ...
    \tind Mithral, pure        & \mult2                 & \minus3          & Reduce usage class                 & Metal         & \plus4 \\
