...
\section{Weapons}\label{Weapons}
    ...
    \subsection{Weapon Groups}\label{Weapon Groups}
        ...
        \begin{dtable!*}
            ...
            \begin{dtabularx}{\textwidth}{l >{\lcol}X >{\lcol}X}
                ...
                Headed weapons     & Battleaxe, greataxe, handaxe, light hammer, pickaxe, sickle, sledgehammer, warhammer & Dwarven waraxe                            \\
    ...
    \subsection{Weapon Qualities}
        ...
        \parhead{Usage Class} Describes whether the weapon's \glossterm{usage class} is light, medium, or heavy (see \pcref{Usage Class}).
        ...
        \begin{longtablewrapper}
            \begin{longtable}{p{11em} c c c >{\ccol}p{7em} c c >{\ccol}p{8em}}
                ...
                \tind Greatclub                    & Heavy  & \plus0  & \plus2d  & Bludgeoning              & 5 gp    & 8 lb.   & Impact                       \\
                ...
                \tind Flanged mace                 & Medium & \plus0  & \plus0d  & Bludgeoning              & 8 gp    & 4 lb.   & Impact                       \\
                ...
                \tind Light hammer                 & Light  & \plus1  & \minus1d & Bludgeoning              & 2 gp    & 2 lb.   & Impact, Throwing (20 ft.)    \\
                ...
                \tind Sledgehammer                 & Heavy  & \plus0  & \plus2d  & Bludgeoning              & 12 gp   & 5 lb.   & Impact                       \\
                \tind Warhammer                    & Medium & \plus0  & \plus0d  & Bludgeoning              & 12 gp   & 5 lb.   & Impact                       \\
        ...
        \begin{dtable!*}
            ...
            \begin{dtabularx}{\textwidth}{p{12em} c c c >{\ccol}p{15em} >{\ccol}X}
                ...
                Slam                 & Light            & \plus0        & \plus0d     & Bludgeoning              & \tdash    \\
    ...
    \subsection{Weapon Tags}\label{Weapon Tags}
        ...
        \parhead{Disarming} When you use the \textit{disarm} ability with this weapon, you can knock loose objects that are held in a hand, but not objects that are well secured (see \pcref{Disarm}).
        \parhead{Forceful} You can use the \textit{shove} ability with this weapon instead of with a free hand (see \pcref{Shove}).
        When you successfully shove a creature with this weapon, the target takes damage as if you hit it with a strike using the weapon with a \minus3d penalty to damage.
        In addition, you can \glossterm{knockback} the foe instead of pushing it.
        ...
        You can change your grip as a \glossterm{free action} that requires the hand or hands used to hold the weapon.
        As normal, you cannot combine that action with other actions using the same hands, so you cannot change your grip and attack with the weapon in the same phase.
        \parhead{Sweeping} When you make a \glossterm{strike} with this weapon, you may also target one or more secondary creatures or objects you \glossterm{threaten}.
        Each secondary target must be within 5 feet of the primary target.
    ...
    \subsection{Weapon Descriptions}
        ...
        \parhead{Crossbow, Hand} You can draw a hand crossbow back by hand. Loading a hand crossbow is a \glossterm{free action} that requires one hand (but not the hand wielding the crossbow).
        ...
        \par You can fire a crossbow while \prone without penalty.
        \parhead{Crossbow, Light} You draw a light crossbow back by pulling a lever. Loading a light crossbow is a \glossterm{free action} that requires both hands.
        \par You can fire a crossbow while \prone without penalty.
    ...
    \subsection{Getting Into And Out Of Armor}
        ...
        \begin{dtable!*}
            ...
            \begin{dtabularx}{\textwidth}{l c c c c c c >{\lcol}X c c}
                ...
                Light armor           &              &         &         &              &              &          &                   &            &             \\
                \tind Leather         & \plus2       & \plus0  & \plus1  & \plus1       & \tdash       & \tdash   & Leather           & 10 gp      & 15 lb.      \\
                ...
                Medium armor          &              &         &         &              &              &          &                   &            &             \\
                \tind Hide            & \plus3       & \plus2  & \plus2  & \plus3       & \minus5 ft.  & \tdash   & Leather           & 30 gp      & 25 lb.      \\
                ...
                Heavy armor           &              &         &         &              &              &          &                   &            &             \\
                \tind Reinforced hide & \plus4       & \plus3  & \plus3  & \plus5       & \minus10 ft. & \mult1/2 & Leather           & 100 gp     & 40 lb.      \\
    ...
    \subsection{Special Materials}
        ...
        \begin{dtable!*}
            ...
            \begin{dtabularx}{\textwidth}{l c c c c c c >{\lcol}X c}
                ...
                \tind Mithral     & \tdash  & \tdash   & \tdash & \minus2 & Special & Metal   & \mult5, \plus2,000 gp   & \mult1/2 \\
        ...
        \parhead{Ironwood} The most common special material is ironwood, which is made from wood magically treated using the \spell{ironwood} ritual to be as strong as steel. Ironwood armor functions exactly like  armor of the same type, except that it is made of wood. This allows druids to wear it without penalty.
    ...
    \subsection{Poisons}\label{Poisons}
        ...
        \begin{dtable*}
            ...
            \begin{dtabularx}{\textwidth}{l l l l >{\lcol}X >{\lcol}X l}
                ...
                Asp venom           & Contact   & Liquid & 5  & Lose a hit point, sickened while poison lasts & Lose two hit points, nauseated while poison lasts & Venom      \\
        ...
        \subsubsection{Creating Poisons}\label{Creating Poisons}
            ...
            For every 5 points by which you beat this \glossterm{difficulty rating}, the created poison's accuracy increases by 1.
