...
\begin{dtable*}
    ...
    \begin{dtabularx}{\textwidth}{l l l l >{\lcol}X >{\lcol}X >{\lcol}X l}
        ...
        Asp venom           & Contact                          & Liquid                         & 5                                              & Venom
                            & \tdash                           & Sickened while poison lasts    & Nauseated while poison lasts                  \\
        Arsenic             & Ingestion                        & Powder                         & 5                                              & Plant
                            & Lose 1d6 \glossterm{hit points}  & \tdash                         & Gain a \glossterm{vital wound}, poison ends   \\
        Sassone leaf        & Contact                          & Powder                         & 6                                              & Plant
                            & Lose 1d6 \glossterm{hit points}  & \tdash                         & Lose 1d10 \glossterm{hit points}, poison ends \\
