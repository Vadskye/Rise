...
\section{Weapons}\label{Weapons}
    ...
    \subsection{Weapon Mechanics}
        ...
        \subsubsection{Weapon Tags}\label{Weapon Tags}
            ...
            You only take a \minus5 penalty to Stealth when trying to conceal strikes with the weapon instead of the normal \minus10 penalty for concealing a strike (see \pcref{Stealth}).
    ...
    \subsection{Weapon Table}
        ...
        \begin{dtable!*}
            \begin{dtabularx}{\textwidth}{p{12em} c c c >{\ccol}p{10em} c c >{\ccol}X}
                ...
                Armor                                &         &        &           &                      &        &        &                                 \\
                Blades                               &         &        &           &                      &        &        &                                 \\
                \tind Boot dagger\fn{2}              & Light   & \plus2 & 1d6       & Piercing             & 20 gp  & 2 lb.  & Compact, Quiet                         \\
