...
\section{Weapons}\label{Weapons}
    ...
    \subsection{Weapon Mechanics}
        ...
        \subsubsection{Weapon Groups}\label{Weapon Groups}
            ...
            \begin{dtable!*}
                ...
                \begin{dtabularx}{\textwidth}{l >{\lcol}X >{\lcol}X}
                    ...
                    Headed weapons     & Light hammer, pick, sickle, sledgehammer, warhammer                              & Heavy pick                                            \\
        ...
        \subsubsection{Weapon Tags}\label{Weapon Tags}
            ...
            While short hafting a Long weapon, you ignore the weapon's Long property, but you take a \minus1 penalty to accuracy with it.
            ...
            However, you take a \minus1 penalty to \glossterm{accuracy} with the weapon.
            You can change your grip as a \glossterm{free action} that requires the hand or hands used to hold the weapon.
            As normal, you cannot combine that action with other actions using the same hands, so you cannot change your grip and attack with the weapon in the same phase.
            However, you can change your grip during the \glossterm{action phase} and then attack with your new grip during the \glossterm{delayed action phase}.
            \parhead{Stealthy}
    ...
    \subsection{Weapon Table}
        ...
        \begin{longtablewrapper}
            \begin{longtable}{p{11em} c c c >{\ccol}p{7em} c c >{\ccol}p{8em}}
                ...
                \tind Shepherd's axe               & Light  & \plus2  & 1d6    & Bludgeoning or slashing  & 6 gp    & 3 lb.   & Reach               \\
        ...
        \begin{dtable!*}
            \begin{dtabularx}{\textwidth}{p{12em} c c c >{\ccol}p{10em} c c >{\ccol}X}
                ...
                Blades                               &         &        &           &                      &        &        &                                 \\
                \tind Boot dagger\fn{2}              & Light   & \plus2 & 1d6       & Piercing             & 20 gp  & 2 lb.  & Compact, Stealthy                         \\
                ...
                Headed weapons                       &         &        &           &                      &        &        &                                 \\
                \tind Heavy pick                  & Heavy   & \plus0 & 2d6       & Piercing             & 40 gp  & 10 lb. & Keen, Impact                    \\
                Monk weapons                         &         &        &           &                      &        &        &                                 \\
                Polearms                             &         &        &           &                      &        &        &                                 \\
