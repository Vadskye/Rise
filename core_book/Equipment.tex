...
\section{Weapons}\label{Weapons}
    ...
    \subsection{Individual Weapon Descriptions}
        ...
        Attacking with a boot dagger does not require a \glossterm{free hand}, but you must make an Balance check with a \glossterm{difficulty rating} of 10 during each phase that you attack with it.
