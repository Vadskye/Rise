...
\section{Weapons}\label{Weapons}
    ...
    \subsection{Weapon Tags}\label{Weapon Tags}
        ...
        \weapontagdef{Resonating} Whenever you hit and damage a creature with a strike using this weapon, it \glossterm{briefly} takes a -2 penalty to its Armor defense against your strikes.
