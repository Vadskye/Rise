...
\section{Weapons}\label{Weapons}
    ...
    \subsection{Weapon Mechanics}
        ...
        \subsubsection{Weapon Usage Classes}\label{Weapon Usage Classes}
            ...
            In addition to their higher base damage, you gain the benefits of holding weapons in two hands (see \pcref{Two-Handed Melee Weapons}).
        ...
        \subsubsection{Natural Weapons}\label{Natural Weapons}
            ...
            A creature with multiple natural weapons can fight with both at once (see \pcref{Offhand Strike}). You are only considered to have one unarmed strike, so you cannot dual wield with only your unarmed strike (but see the unarmed warrior monk ability, \pref{Mnk:Unarmed Warrior}).
        ...
        \subsubsection{Weapon Tags}\label{Weapon Tags}
            ...
            However, you are unable to attack enemies adjacent to you, and you take a \minus2 penalty to \glossterm{accuracy} with the weapon.
            You can change your grip as a \glossterm{free action} that requires the hand or hands used to hold the weapon.
            As normal, you cannot combine that action with other actions using the same hands, so you cannot change your grip and attack with the weapon in the same phase.
    ...
    \subsection{Weapon Table}
        ...
        \begin{longtablewrapper}
            \begin{longtable}{p{11em} c c c >{\ccol}p{7em} c c >{\ccol}p{8em}}
                ...
                \tind Handaxe                      & Light  & \plus1  & 1d6    & Slashing                 & 4 gp    & 2 lb.   & Thrown (20 ft.)               \\
                \tind Light hammer                 & Light  & \plus1  & 1d6    & Bludgeoning              & 2 gp    & 2 lb.   & Forceful, Thrown (20 ft.)               \\
                \tind Javelin\fn{2}                & Medium & \plus1  & 1d6    & Piercing                 & 1 gp    & 2 lb.   & Thrown (30 ft.)                 \\
                \tind Shuriken (5)                 & Light  & \plus2  & 1d6    & Piercing and slashing    & 1 gp    & 1/2 lb. & Ammunition, Thrown (10 ft.)     \\
        ...
        \begin{dtable!*}
            \begin{dtabularx}{\textwidth}{p{12em} c c c >{\ccol}p{10em} c c >{\ccol}X}
                \tb{Exotic Weapons}           & \tb{Usage Class} & \tb{Accuracy} & \tb{Damage} & \tb{Damage Type\fn{1}} & \tb{Cost} & \tb{Weight} & \tb{Special} \tableheaderrule
                Armor                                &         &        &           &                      &        &        &                                 \\
                Blades                               &         &        &           &                      &        &        &                                 \\
                \tind Boot dagger\fn{2}              & Light   & \plus2 & 1d6       & Piercing             & 20 gp  & 2 lb.  & Compact                         \\
                \tind Falchion                       & Medium  & \plus0 & 1d8       & Slashing             & 15 gp  & 4 lb.  & Sweeping (2), Versatile Grip    \\
                \tind Katana                         & Heavy   & \plus1 & 1d10      & Slashing             & 75 gp  & 6 lb.  & Keen, Sweeping (1)              \\
                \tind Kukri                          & Light   & \plus2 & 1d6       & Slashing             & 8 gp   & 2 lb.  & Keen, Sweeping (1)              \\
                Bows                                 &         &        &           &                      &        &        &                                 \\
                \tind Flatbow\fn{2}                  & Heavy   & \plus1 & 1d8       & \tdash               & 30 gp  & 3 lb.  & Projectile (90 ft.)            \\
                \tind Heartseeker arrows (20)        & \tdash  & \plus0 & \tdash    & Piercing             & 20 gp  & 3 lb.  & Ammunition, Impact              \\
                \tind Takedown bow\fn{2}             & Special & \plus0 & 1d8       & \tdash               & 200 gp & 4 lb.  & Projectile (90 ft. or 50 ft.)  \\
                Club-like weapons                    &         &        &           &                      &        &        &                                 \\
                Crossbows                            &         &        &           &                      &        &        &                                 \\
                \tind Repeating heavy crossbow\fn{2} & Heavy   & \plus0 & 1d10      & \tdash             & 400 gp & 12 lb. & Projectile (60 ft.)            \\
                \tind Repeating light crossbow\fn{2} & Medium  & \plus0 & 1d8       & \tdash             & 250 gp & 6 lb.  & Projectile (60 ft.)             \\
                \tind Repeating bolts (5)            & \tdash  & \plus0 & \tdash    & Piercing               & 1 gp   & 1 lb.  & Ammunition                      \\
                Flexible weapons                     &         &        &           &                      &        &        &                                 \\
                \tind Three-section staff            & Heavy   & \plus0 & 1d10      & Bludgeoning             & 40 gp  & 6 lb.  & Disarming, Reach, Tripping      \\
                Headed weapons                       &         &        &           &                      &        &        &                                 \\
                \tind Dwarven throwing axe           & Light   & \plus2 & 1d6       & Slashing             & 8 gp   & 3 lb.  & Impact, Thrown (20 ft.)       \\
                \tind Dwarven waraxe                 & Medium  & \plus0 & 1d10      & Slashing             & 75 gp  & 8 lb.  & Thrown (20 ft.), Versatile Grip \\
                \tind Heavy pickaxe                  & Heavy   & \plus0 & 2d6       & Piercing             & 40 gp  & 10 lb. & Keen, Impact                    \\
                \tind Orcish greataxe                & Heavy   & \plus0 & 2d6       & Slashing             & 60 gp  & 10 lb. & Impact, Sweeping (1)            \\
                Monk weapons                         &         &        &           &                      &        &        &                                 \\
                Polearms                             &         &        &           &                      &        &        &                                 \\
                \tind Fauchard                       & Heavy   & \plus0 & 1d10      & Slashing             & 25 gp  & 12 lb. & Long, Sweeping (2)              \\
                \tind War scythe                     & Heavy   & \plus0 & 2d6       & Slashing or piercing & 35 gp  & 14 lb. & Sweeping (2)                    \\
                Simple weapons                       &         &        &           &                      &        &        &                                 \\
                Spear                                &         &        &           &                      &        &        &                                 \\
                \tind Pike\fn{2}                     & Heavy   & \plus0 & 2d6       & Piercing             & 15 gp. & 10 lb. & Long, Reach                     \\
                Thrown weapons                       &         &        &           &                      &        &        &                                 \\
                \tind Bolas                          & Light   & \plus2 & 1d4       & Bludgeoning          & 5 gp   & 2 lb.  & Thrown (10 ft.), Tripping       \\
                \tind Dwarven throwing axe           & Light   & \plus2 & 1d6       & Slashing             & 8 gp   & 3 lb.  & Impact, Thrown (20 ft.)       \\
                \tind Dwarven waraxe                 & Medium  & \plus0 & 1d10      & Slashing             & 75 gp  & 8 lb.  & Thrown (20 ft.), Versatile Grip \\
                \tind Net\fn{2}                      & Medium  & \plus0 & \tdash    & \tdash               & 20 gp  & 6 lb.  & Thrown (10 ft.)                 \\
                Unarmed weapons                      &         &        &           &                      &        &        &                                 \\
            \end{dtabularx}
            1 When two types are given, the weapon is both types if the entry specifies ``and,'' or either type (attacker's choice) if the entry specifies ``or.'' \\
            2 This weapon has special rules. \\
...
\section{Armor}\label{Armor}
    ...
    \subsection{Armor Table}
        ...
        \parhead{Physical Resist} This value indicates how much the armor increases your \glossterm{resistance} against \glossterm{physical damage} (see \pcref{Resistance}).

        \parhead{Energy Resist} This value indicates how much the armor increases your \glossterm{resistance} against \glossterm{energy damage} (see \pcref{Resistance}).
        ...
        \begin{dtable!*}
            ...
            \begin{dtabularx}{\textwidth}{l c c c c c c >{\lcol}X c c}
                ...
                Light armor              &              &         &         &              &              &          &                   &            &             \\
                \tind Leather            & \plus2       & \plus1  & \plus3  & \plus1       & \tdash       & \tdash   & Leather           & 10 gp      & 15 lb.      \\
                \tind Studded leather    & \plus2       & \plus3  & \plus3  & \plus2       & \tdash       & \tdash   & Leather and metal & 25 gp      & 20 lb.      \\
                \tind Chain shirt        & \plus2       & \plus4  & \plus2  & \plus2       & \tdash       & \tdash   & Metal             & 40 gp      & 25 lb.      \\
                \tind Buckler            & \plus1       & \tdash  & \tdash  & \tdash       & \tdash       & \tdash   & Metal or wood     & 15 gp      & 5 lb.       \\
                Medium armor             &              &         &         &              &              &          &                   &            &             \\
                \tind Hide               & \plus3       & \plus3  & \plus5  & \plus3       & \minus5 ft.  & \tdash   & Leather           & 30 gp      & 25 lb.      \\
                \tind Scale mail         & \plus3       & \plus7  & \plus2  & \plus5       & \minus5 ft.  & \tdash   & Metal             & 75 gp      & 30 lb.      \\
                \tind Breastplate        & \plus3       & \plus6  & \plus3  & \plus4       & \minus5 ft.  & \tdash   & Metal             & 150 gp     & 30 lb.      \\
                \tind Standard shield    & \plus2       & \tdash  & \tdash  & \tdash\fn{1} & \tdash       & \tdash   & Metal or wood     & 15 gp      & 10 lb.      \\
                Heavy armor              &              &         &         &              &              &          &                   &            &             \\
                \tind Layered hide       & \plus4       & \plus4  & \plus6  & \plus5       & \minus10 ft. & \mult1/2 & Leather           & 100 gp     & 40 lb.      \\
                \tind Plated mail        & \plus4       & \plus7  & \plus4  & \plus6       & \minus10 ft. & \mult1/2 & Metal             & 250 gp     & 35 lb.      \\
                \tind Half-plate         & \plus4       & \plus8  & \plus4  & \plus7       & \minus10 ft. & \mult1/2 & Metal             & 500 gp     & 50 lb.      \\
                \tind Full plate         & \plus4       & \plus8  & \plus5  & \plus6       & \minus10 ft. & \mult1/2 & Metal             & 1,000 gp   & 50 lb.      \\
...
\begin{dtabularx}{\textwidth}{l c c c c c >{\lcol}X c}
    \tb{Material}     & \tb{Defense} & \tb{Physical Resist} & \tb{Energy Resist} & \tb{Encumbrance} & \tb{Material} & \tb{Cost}              & \tb{Weight} \tableheaderrule
    \tind Adamantine           & \tdash  & \mult3   & \mult3 & \plus2  & Metal   & \mult10, \plus10,000 gp  & \mult2   \\
    \tind Adamantine, pure     & \tdash  & \mult5   & \mult5 & \plus3  & Metal   & \mult50, \plus250,000 gp & \mult3   \\
    \tind Cold iron            & Special & \mult1/2 & \tdash & \tdash  & Metal   & \mult5, \plus2,000 gp    & \tdash   \\
    \tind Diamondsteel         & \tdash  & \tdash   & \mult3 & \tdash  & Metal   & \mult10, \plus10,000 gp  & \tdash   \\
    \tind Diamondsteel, pure   & \tdash  & \mult2   & \mult5 & \tdash  & Metal   & \mult50, \plus250,000 gp & \tdash   \\
    \tind Deepforged           & \tdash  & \mult2   & \mult2 & \tdash  & Metal   & \mult10, \plus10,000 gp  & \tdash   \\
    \tind Dragonhide           & \tdash  & \tdash   & \mult2 & \tdash  & Leather & \mult5, \plus2,000 gp    & \tdash   \\
    \tind Dragonhide, ancient  & \tdash  & \mult2   & \mult4 & \tdash  & Leather & \mult20, \plus50,000 gp  & \tdash   \\
    \tind Dragonscale          & \tdash  & \tdash   & \mult2 & \tdash  & Metal   & \mult5, \plus2,000 gp    & \tdash   \\
    \tind Dragonscale, ancient & \tdash  & \tdash   & \mult4 & \tdash  & Metal   & \mult20, \plus50,000 gp  & \tdash   \\
    \tind Elvenweave           & \tdash  & \mult2   & \mult2 & \tdash  & Leather & \mult10, \plus10,000 gp  & \tdash   \\
    \tind Ironwood             & \tdash  & \tdash   & \tdash & \tdash  & Metal   & \mult2, \plus400 gp      & \tdash   \\
    \tind Mithral              & \tdash  & \tdash   & \tdash & \minus2 & Metal   & \mult5, \plus2,000 gp    & \mult1/2 \\
    \tind Mithral, pure        & \tdash  & \mult2   & \mult2 & \minus3 & Metal   & \mult20, \plus50,000 gp  & \mult1/2 \\
    \tind Starmetal            & \tdash  & \mult2   & \tdash & \plus1  & Metal   & \mult5, \plus2,000 gp    & \tdash   \\
    \tind Starmetal, pure      & \tdash  & \mult4   & \mult2 & \plus2  & Metal   & \mult20, \plus50,000 gp  & \tdash   \\
\end{dtabularx}
        \end{dtable!*}

        \parhead{Adamantine} Adamantine armor weighs twice as much and increases the \glossterm{encumbrance penalty} of the armor by 2, but it triples the \glossterm{resistance} provided by the armor against both \glossterm{physical damage} and \glossterm{energy damage}.
        It costs ten times as much as armor of that type would normally cost, plus an additional 10,000 gp.

        \parhead{Adamantine, Pure} Pure adamantine armor weighs three times as much and increases the \glossterm{encumbrance penalty} of the armor by 3, but it quintuples the \glossterm{resistance} provided by the armor against both \glossterm{physical damage} and \glossterm{energy damage}.
        ...
        \parhead{Mithral} Mithral armor weighs half as much and reduces the \glossterm{encumbrance penalty} of the armor by 2.
        It costs five times as much as armor of that type would normally cost, plus an additional 2,000 gp.

        \parhead{Mithral, Pure} Pure mithral armor weighs half as much, reduces the \glossterm{encumbrance penalty} of the armor by 3, and doubles its \glossterm{resistance} provided by the armor against both \glossterm{energy damage} and \glossterm{physical damage}.
        It costs twenty times as much as armor of that type would normally cost, plus an additional 50,000 gp.
