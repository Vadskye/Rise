...
\section{Weapons}\label{Weapons}
    ...
    \subsection{Weapon Encumbrance}\label{Weapon Encumbrance}
        ...
        In addition, light weapons are easier to use while making dual strikes (see \pcref{Dual Strike}) or while grappling.
    ...
    \subsection{Natural Weapons}\label{Natural Weapons}
        ...
        A creature with multiple natural weapons of the same type can designate one as a primary attack and one as a secondary attack, allowing it to fight with both at once (see \pcref{Dual Strike}). You are only considered to have one unarmed strike, so you cannot dual wield with only your unarmed strike (but see the unarmed warrior monk ability, \pref{Mnk:Unarmed Warrior}).
    ...
    \subsection{Weapon Qualities}
        ...
        \parhead{Damage} The Damage column gives the damage dealt by the weapon on a successful hit. The damage given is for weapons used by Medium creatures. Weapons used by Small creatures have a damage die that is one \glossterm{die increment} smaller (see \pcref{Size in Combat}).
        ...
        \begin{longtabuwrapper}
            \begin{longtabu}{p{12em} c c >{\ccol}p{10em} c c >{\ccol}X}
                ...
                Armor weapons &&&&&& \\
                \tind Shield, heavy\fn{4} & Medium & \minus2d & Bludgeoning & special & special & Forceful \\
                \tind Shield, light\fn{4} & Light & \minus3d & Bludgeoning & special & special & Forceful \\
                \tind Spiked armor\fn{4} & Light & \minus1d & Piercing & special & special & Grappling \\
                \tind Spiked shield, heavy\fn{4} & Medium & \minus1d & Piercing & special & special & Forceful \\
                \tind Spiked shield, light\fn{4} & Light & \minus2d & Piercing & special & special & Forceful \\
                ...
                \tind Waraxe, dwarven\fn{4} & Medium & \plus1d & Slashing & 75 gp & 8 lb. & Exotic Grip \\

                Blades, heavy &&&&&& \\
                \tind Falchion & Heavy & \plus1d & Slashing & 50 gp & 8 lb. & \tdash \\
                \tind Greatsword & Heavy & \plus1d & Slashing & 25 gp & 8 lb. & \tdash \\
                \tind Katana\fn{4} & Medium & \plus1d & Slashing & 75 gp & 6 lb. & \tdash \\
                ...
                \tind Shortbow\fn{4} & Medium (Ranged) & \minus1d & Piercing & 30 gp & 2 lb. & Projectile (50 ft.) \\
                ...
                \tind Javelin & Medium (Ranged) & \minus1d & Piercing & 1 gp & 2 lb. & Thrown (30 ft.) \\
                \tind Shuriken (5) & Light (Ranged) & \minus2d & Piercing and slashing & 1 gp & 1/2 lb. & Ammunition, Thrown (10 ft.) \\
                \tind Sling\fn{4} & Light (Ranged) & \minus2d & Bludgeoning & 2 gp & 0 lb. & Projectile (50 ft.) \\
                ...
                \tind Unarmed strike & Light & \minus3d & Bludgeoning & \tdash & \tdash & Subdual, Unarmed \\
            \end{longtabu}
            1 Relative to your normal \glossterm{strike damage}.
        ...
        \begin{dtable!*}
            \begin{dtabularx}{\textwidth}{p{12em} c c >{\ccol}p{10em} c c >{\ccol}X}
                ...
                \tind Urgrosh, dwarven\fn{4} & Heavy & \plus0d/\minus1d & Slashing or piercing & 50 gp & 12 lb. & Bracing, Double \\
                Blunt weapons &&&&&& \\
                Blades, heavy &&&&&& \\
                ...
                Headed weapons &&&&&& \\
                \tind Hammer, gnome hooked\fn{4} & Heavy & \plus0d/\minus1d & Bludgeoning or piercing & 20 gp & 6 lb. & Double, Impact, Tripping \\
                Monk weapons &&&&&& \\
                Polearms &&&&&& \\
                Simple weapons &&&&&& \\
                Spear &&&&&& \\
                \tind Urgrosh, dwarven\fn{4} & Heavy & \plus0d/\minus1d & Slashing or piercing & 50 gp & 12 lb. & Bracing, Double, Impact \\
                Thrown weapons &&&&&& \\
    ...
    \subsection{Weapon Tags}
        ...
        \parhead{Double} This weapon has more than one striking surface. You can fight with both ends simultaneously, just like wielding two weapons at once (see \pcref{Dual Strike}). Alternately, you can attack with one end at a time. If you have the ability to use a double weapon in one hand, you can only fight with one end at a time, not both.
        \parhead{Exotic Grip} If you have proficiency with exotic weapons, you can use this in one hand.
        ...
        \parhead{Forceful} You can use this weapon to make shove attacks to push people away from you. % TODO: why does this matter
        ...
        \parhead{Reach}\label{Reach Weapon} This weapon strikes at double your natural reach (so 10 feet for a typical Small or Medium creature). However, it cannot attack a creature within your natural reach.
        ...
        \parhead{Tripping} You can use this weapon to make trip attacks.  % TODO: why does this matter
        ...
        \parhead{Unbalanced} If you roll either a 1 or 2 when attacking this weapon, you get a \glossterm{critical miss} (see \pcref{Critical Miss}).
    ...
    \subsection{Weapon Descriptions}
        ...
        \parhead{Katana} This weapon must be held in two hands unless you have proficiency with exotic weapons.
        ...
        \parhead{Rapier} A rapier is treated as a medium weapon if it is used as a secondary weapon when making dual strikes (see \pcref{Dual Strike}).
        ...
        \parhead{Urgrosh, Dwarven} This weapon has an axe head which deals \plus0d damage, and a spear which deals \minus1d damage. The spear is a bracing weapon. You must be proficient with axes to use the axe head, and proficient with spears to use the spear head.
        \parhead{Waraxe, Dwarven} This weapon must be held in two hands unless you have proficiency with exotic weapons.
...
\section{Armor}\label{Armor}
    ...
    \subsection{Armor Qualities}
        ...
        \subparhead{Shields} Most shields do not affect a character's Dexterity. However, a tower shield halves a character's Dexterity. This is not cumulative with the halving from wearing heavy armor.
        ...
        \subsubsection{Armor Proficiency}\label{Armor Proficiency}
            ...
            In addition, you apply that armor's \glossterm{encumbrance penalty} as a penalty to your \glossterm{accuracy} with \glossterm{physical attacks}.
    ...
    \subsection{Getting Into And Out Of Armor}
        ...
        \begin{dtable!*}
            ...
            \begin{dtabularx}{\textwidth}{>{\lcol}X c c c c c c}
                \tb{Armor} & \tb{Defense Bonus} & \tb{Dex Multiplier} & \tb{Encumbrance Penalty} & \tb{Material} & \tb{Cost} & \tb{Weight\fn{1}} \\
                \bottomrule
                Light armor &  &  &  &  &  &  \\
                \tind Leather          & \plus1        & 1\x    & \minus1       & Leather           & 10 gp      & 15 lb.      \\
                \tind Studded leather  & \plus2        & 1\x    & \minus1       & Leather and metal & 25 gp      & 20 lb.      \\
                \tind Chain shirt      & \plus2        & 1\x    & \minus2       & Metal             & 40 gp      & 25 lb.      \\
                Medium armor           &               &        &               &                   &            &             \\
                \tind Hide             & \plus2        & 1\x    & \minus2       & Leather           & 15 gp      & 25 lb.      \\
                \tind Scale mail       & \plus3        & 1\x    & \minus3       & Metal             & 50 gp      & 30 lb.      \\
                \tind Breastplate      & \plus4        & 1\x    & \minus3       & Metal             & 150 gp     & 30 lb.      \\
                Heavy armor            &               &        &               &                   &            &             \\
                \tind Half-plate       & \plus5        & 1/2\x  & \minus4       & Metal             & 200 gp     & 50 lb.      \\
                \tind Full plate       & \plus6        & 1/2\x  & \minus4       & Metal             & 500 gp     & 50 lb.      \\
                Shields                &               &        &               &                   &            &             \\
                \tind Buckler          & \plus1\fn{2}  & \tdash & \minus1       & Metal or wood     & 15 gp      & 5 lb.       \\
                \tind Shield, light    & \plus1        & \tdash & \minus1\fn{3} & Metal or wood     & 5 gp       & 5 lb.       \\
                \tind Shield, heavy    & \plus2        & \tdash & \minus2\fn{3} & Metal or wood     & 15 gp      & 10 lb.      \\
                \tind Shield, tower    & \plus3\fn{4}  & 1/2\x  & \minus4\fn{3} & Metal or wood     & 30 gp      & 45 lb.      \\
                Extras                 &               &        &               &                   &            &             \\
                \tind Armor spikes     & \minus1\fn{5} & \tdash & \minus2       & Metal             & \plus50 gp & \plus10 lb. \\
                \tind Gauntlet, locked & \tdash        & \tdash & Special       & Metal             & 8 gp       & \plus5 lb.  \\
                \tind Shield spikes    & \tdash        & \tdash & \minus1       & Metal             & \plus10 gp & \plus5 lb.  \\
            \end{dtabularx}
    ...
    \subsection{Armor Descriptions}
        ...
        Like a normal gauntlet, a locked gauntlet lets you deal normal damage rather than \glossterm{subdual damage} with an unarmed strike.
...
The goo does not have an Armor defense, and can be hit automatically.  % that doesn't make sense
...
The creature detonating the stone makes an attack with a \plus5 \glossterm{accuracy} against the Fortitude defense of all creatures within an \areasmall radius burst from the stone.
    ...
    \subsection{Poisons}\label{Poisons}
        ...
        \begin{dtable*}
            ...
            \begin{dtabularx}{\textwidth}{l l l l l X l}
                ...
                Dragon bile         & Contact   & Liquid & 10 & Sickened, 1d8 damage per round & \glossterm{standard damage}, \glossterm{nausated} as a \glossterm{condition} & Venom      \\
