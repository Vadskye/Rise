...
\section{Armor}\label{Armor}
    ...
    \subsection{Special Materials}
        Armor and shields can be made from special materials, which can alter the properties of the item.
        ...
        \parhead{Dragonhide} Dragonhide armor gains a \plus1 bonus to its \glossterm{resistances}, and provides its \glossterm{resistances} against both \glossterm{physical damage} and \glossterm{energy damage}.
        It costs five times as much as armor of that type would normally cost, plus an additional 5,000 gp.

        \parhead{Dragonscale} Dragonscale armor gains a \plus1 bonus to its \glossterm{resistances}, and provides its \glossterm{resistances} against both \glossterm{physical damage} and \glossterm{energy damage}.
        It costs five times as much as armor of that type would normally cost, plus an additional 5,000 gp.
