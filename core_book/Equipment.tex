...
\section{Weapons}\label{Weapons}
    ...
    \subsection{Weapon Tags}\label{Weapon Tags}
        ...
        While holding this weapon in two hands, you gain a \plus1 damage bonus to your \glossterm{weapon damage} with it, plus \plus1 per 3 \glossterm{power}.
        This bonus is in addition to the normal bonus that you gain from your power with weapons (see \pcref{Weapon Damage}).
    ...
    \subsection{Weapon Table}
        ...
        \begin{longtablewrapper}
            ...
            \begin{longtable}{p{12em} c c >{\ccol}p{7em} c >{\ccol}p{16em}}
                ...
                \tind Titanbow\fn{2}              & \minus2        & 1d6         & \tdash                   & 1 (40 gp)                  & Heavy, Projectile (60/180)                         \\
                Club-like weapons                 &               &             &                          &                             &                                             \\
    ...
    \subsection{Individual Weapon Descriptions}
        ...
        \parhead{Titanbow} You need both hands to fire a bow. One hand is free when not firing the bow. Loading a bow is a free action that requires one \glossterm{free hand} while holding the titanbow in another hand. A titanbow is too unwieldy to use while you are mounted.
    ...
    \subsection{Armor Table}
        ...
        \begin{dtable!*}
            ...
            \begin{dtabularx}{\textwidth}{l c c c c c >{\lcol}X c}
                ...
                Light armor           &              &                        &                  &              &                &               &              \\
                \tind Padded          & \plus3       & \plus3                 & \tdash           & \tdash       & \tdash         & Leather       & 0 (10 gp)    \\
                \tind Buff leather    & \plus3       & \plus4                 & \plus1           & \tdash       & \tdash         & Leather       & 1 (40 gp)    \\
                \tind Mail shirt      & \plus3       & \plus4                 & \plus1           & \tdash       & \tdash         & Metal         & 1 (40 gp)    \\
                \tind Buckler         & \plus1       & \tdash                 & \tdash           & \tdash       & \tdash         & Metal or wood & 0 (10 gp)    \\
                Medium armor          &              &                        &                  &              &                &               &              \\
                \tind Rawhide         & \plus4       & \plus4                 & \plus2           & \tdash       & \mult1/2       & Leather       & 1 (40 gp)    \\
                \tind Scale           & \plus4       & \plus5                 & \plus4           & \tdash       & \mult1/2       & Metal         & 1 (40 gp)    \\
                \tind Brigandine      & \plus4       & \plus6                 & \plus4           & \tdash       & \mult1/2       & Metal         & 2 (200 gp)   \\
                \tind Standard shield & \plus2       & \tdash                 & \tdash\fn{1}     & \tdash       & \mult1/2       & Metal or wood & 0 (10 gp)    \\
                Heavy armor           &              &                        &                  &              &                &               &              \\
                \tind Layered hide    & \plus5       & \plus6                 & \plus4           & \minus10 ft. & \mult0         & Leather       & 1 (40 gp)    \\
                \tind Half plate      & \plus5       & \plus8                 & \plus6           & \minus10 ft. & \mult0         & Metal         & 2 (200 gp)   \\
                \tind Full plate      & \plus5       & \plus10                & \plus6           & \minus10 ft. & \mult0         & Metal         & 3 (1,000 gp) \\
