...
\section{Weapons}\label{Weapons}
    ...
    \subsection{Weapon Qualities}
        ...
        \begin{longtablewrapper}
            \begin{longtable}{p{11em} c c c >{\ccol}p{7em} c c >{\ccol}p{8em}}
                ...
                Polearms                               &                  &               &                   &                          &           &             &                              \\
                \tind Glaive                           & Heavy            & \plus0        & \plus1d           & Slashing                 & 8 gp      & 10 lb.      & Reach, Sweeping (1)          \\
                \tind Guisarme                         & Heavy            & \plus0        & \plus1d           & Slashing                 & 9 gp      & 12 lb.      & Reach, Tripping              \\
                \tind Halberd                          & Heavy            & \plus0        & \plus2d           & Piercing or slashing     & 10 gp     & 12 lb.      & Reach                        \\
                \tind Quarterstaff                     & Heavy            & \plus1        & \minus1d/\minus1d & Bludgeoning              & \tdash    & 4 lb.       & Double                       \\
                ...
                \tind Lance                            & Heavy            & \plus0        & \plus1d           & Piercing                 & 10 gp     & 10 lb.      & Mounted, Reach               \\
                \tind Longspear                        & Heavy            & \plus0        & \plus2d           & Piercing                 & 5 gp      & 9 lb.       & Reach                        \\
    ...
    \subsection{Weapon Tags}\label{Weapon Tags}
        ...
        \parhead{Long} This weapon can be held in an extended grip to strike more distant creatures.
        This is called ``long hafting''.
        While long hafting a Long weapon, you can use it to attack at double your natural \glossterm{reach} (so 10 feet for a typical Small or Medium creature).
        ...
        \parhead{Reach}\label{Reach Weapon} This weapon can be used to attack at double your natural reach (so 10 feet for a typical Small or Medium creature).
        ...
        While short hafting a Reach weapon, you ignore the weapon's Reach property, but you take a \minus2 penalty to accuracy with it.
        You can change your grip as a \glossterm{free action} that requires the hand or hands used to hold the weapon.
