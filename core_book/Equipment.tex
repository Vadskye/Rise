...
\section{Goods And Services}
    ...
    \begin{dtable!*}
        ...
        \begin{dtabularx}{\textwidth}{>{\lcol}X c >{\lcol}X c >{\lcol}X c}
            ...
            \multicolumn{2}{>{\columncolor{tbrown}}c}{\tb{Adventuring Gear}} & \tind Average & 40 gp & 1 lb. & \multicolumn{2}{>{\columncolor{tbrown}}c}{\tb{Tools and Skill Kits}} \\
    ...
    \begin{dtable!*}
        \begin{dtabularx}{\textwidth}{>{\lcol}X c c >{\lcol}X c c >{\lcol}X c c}
            ...
            Traveler's outfit             & 1 gp   & 5 lb.     & \tind Pony            & 30 gp        & \tdash       & \tb{Services} &                                    &         \\
