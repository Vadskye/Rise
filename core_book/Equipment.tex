    ...
    \subsection{Weapon Groups}\label{Weapon Groups}
        ...
        \begin{dtable!*}
            ...
            \begin{dtabularx}{\textwidth}{l >{\lcol}X >{\lcol}X}
                ...
                Axes              &                                                                              & Double axe, dwarven waraxe      \\
                ...
                Headed weapons    & Battleaxe, greataxe, handaxe, light hammer, pickaxe, sledgehammer, warhammer &                                 \\
    ...
    \subsection{Weapon Qualities}
        ...
        \begin{dtable!*}
            \begin{dtabularx}{\textwidth}{p{12em} c c c >{\ccol}p{10em} c c >{\ccol}X}
                ...
                \tind Orc double axe                 & Heavy            & \plus0        & \plus2d/\plus2d   & Slashing               & 60 gp     & 15 lb.      & Double                         \\
                Monk weapons                         &                  &               &                   &                        &           &             &                                \\
                Polearms                             &                  &               &                   &                        &           &             &                                \\
                Simple weapons                       &                  &               &                   &                        &           &             &                                \\
                Spear                                &                  &               &                   &                        &           &             &                                \\
