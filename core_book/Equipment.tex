...
\begin{dtable!*}
    ...
    \begin{dtabularx}{\textwidth}{>{\lcol}X >{\ccol}p{6em} >{\ccol}p{5em} >{\ccol}p{6em} >{\ccol}p{7em} c c c}
        ...
        Light armor &  &  &  &  &  &  &  \\
        \tind Leather          & \plus1        & 1\mtimes   & \minus1  & 10\%       & Leather       & 10 gp        & 15 lb. \\
        \tind Studded leather  & \plus2        & 1\mtimes   & \minus2  & 15\%       & Leather       & 25 gp        & 20 lb. \\
        \tind Chain shirt      & \plus2        & 1\mtimes   & \minus2  & 20\%       & Metal         & 40 gp        & 25 lb. \\
        Medium armor           &               &            &          &            &               &              &        \\
        \tind Hide             & \plus3        & 1\mtimes   & \minus4  & 20\%       & Leather       & 15 gp        & 25 lb. \\
        \tind Scale mail       & \plus3        & 1\mtimes   & \minus4  & 25\%       & Metal         & 50 gp        & 30 lb. \\
        \tind Breastplate      & \plus4        & 1\mtimes   & \minus3  & 25\%       & Metal         & 150 gp       & 30 lb. \\
        Heavy armor            &               &            &          &            &               &              &        \\
        \tind Half-plate       & \plus5        & 1/2\mtimes & \minus6  & 40\%       & Metal         & 250 gp       & 50 lb. \\
        \tind Full plate       & \plus6        & 1/2\mtimes & \minus6  & 35\%       & Metal         & 500 gp       & 50 lb. \\
        Shields                &               &            &          &            &               &              &        \\
        \tind Buckler          & \plus1        & \x         & \minus1  & 5\%        & Metal         & 15 gp        & 5 lb.  \\
        \tind Shield, light    & \plus2        & \x         & \minus2  & 5\%\fn{2}  & Metal or wood & 5 gp         & 5 lb.  \\
        \tind Shield, heavy    & \plus3        & \x         & \minus3  & 15\%\fn{2} & Metal or wood & 15 gp        & 10 lb. \\
        \tind Shield, tower    & \plus4\fn{3}  & 1/2\mtimes & \minus10 & 50\%\fn{2} & Metal & 30 gp         & 45 lb.      \\
        Extras                 &               &            &          &            &               &              &        \\
        \tind Armor spikes     & \minus1\fn{4} & \x         & \minus2  & \x         & Metal & \plus50 gp    & \plus10 lb. \\
        \tind Gauntlet, locked & \x            & \x         & Special  & \x\fn{2}   & Metal & 8 gp          & \plus5 lb.  \\
        \tind Shield spikes    & \x            & \x         & \minus1  & \x         & Metal & \plus10 gp    & \plus5 lb.  \\
    \end{dtabularx}
