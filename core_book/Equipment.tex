...
\section{Using Items}
    ...
    \subsection{Storing Items}\label{Storing Items}
        ...
        For each additional weapon or similar item, you increase your \glossterm{encumbrance} by 1.
...
\section{Weapons}\label{Weapons}
    ...
    \subsection{Weapon Tags}\label{Weapon Tags}
        ...
        Heavy thrown weapons are not always physically thrown with two hands, but they require the use of your entire body to propel the weapon, so you are not considered to have any \glossterm{free hands} while throwing a heavy thrown weapon.
