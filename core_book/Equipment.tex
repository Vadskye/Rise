...
\begin{dtabularx}{\textwidth}{l c c c c c >{\lcol}X c}
    ...
    \tind Starmetal            & \tdash  & \mult2   & \tdash & \tdash  & Metal   & \mult5, \plus2,000 gp    & \tdash   \\
    \tind Starmetal, pure      & \tdash  & \mult4   & \mult2 & \tdash  & Metal   & \mult20, \plus50,000 gp  & \tdash   \\
\end{dtabularx}
        \end{dtable!*}
        ...
        \parhead{Starmetal} Starmetal body armor doubles the \glossterm{resistance} provided by the armor against \glossterm{physical damage}.
        It costs five times as much as armor of that type would normally cost, plus an additional 2,000 gp.

        \parhead{Starmetal, Pure} Pure starmetal body armor quadruples the \glossterm{resistance} provided by the armor against \glossterm{physical damage}, and doubles the resistance provided by the armor against \glossterm{energy damage}.
        It costs twenty times as much as armor of that type would normally cost, plus an additional 50,000 gp.
