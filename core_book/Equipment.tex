...
\section{Weapons}\label{Weapons}
    ...
    \subsection{Weapon Qualities}
        ...
        \begin{dtable!*}
            \begin{dtabularx}{\textwidth}{p{12em} c c >{\ccol}p{10em} c c >{\ccol}X}
                \tb{Exotic Weapons} & \tb{Usage Class} & \tb{Damage\fn{1}} & \tb{Damage Type\fn{2}} & \tb{Cost} & \tb{Weight\fn{3}} & \tb{Special} \tableheaderrule
                Armor &&&&&& \\
                Axes &&&&&& \\
        ...
        \begin{dtable!*}
            ...
            \begin{dtabularx}{\textwidth}{p{12em} c c >{\ccol}p{15em} >{\ccol}X}
                \tb{Natural Weapons} & \tb{Usage Class} & \tb{Damage} & \tb{Damage Type\fn{2}} & \tb{Special} \tableheaderrule
                Bite            & Medium & \plus0d  & Piercing and bludgeoning & \tdash    \\
                Claw            & Light  & \plus0d  & Slashing and piercing    & \tdash    \\
                Constrict\fn{2} & Heavy  & \plus1d  & Bludgeoning              & Grappling \\
    ...
    \subsection{Weapon Tags}\label{Weapon Tags}
        ...
        \parhead{Unarmed} This weapon is used as part of an \glossterm{unarmed attack}.
        It cannot be disarmed.
        Unless you are \glossterm{proficient} with your \glossterm{unarmed attack}, you can't defend yourself with this weapon, which usually makes you \defenseless.
...
\section{Goods And Services}
    ...
    \subsection{Adventuring Gear}
        ...
        \parhead{Chain} Chain has \glossterm{damage resistance} of 10 and a \glossterm{wound resistance} of 20. It can be burst with a DR 26 Strength check.
        ...
        \parhead{Rope, Hempen} This rope has a \glossterm{wound resistance} of 4 and can be burst with a DR 23 Strength check.
        \parhead{Rope, Silk} This rope has a \glossterm{wound resistance} of 5 and can be burst with a DR 24 Strength check.
    ...
    \subsection{Special Substances And Items}
        ...
        A typical flask has a \glossterm{range increment} of 10 feet.
        % TODO: untyped damage
        On a hit, if the target is an undead creature or evil outsider, it takes 1d8 damage.
    ...
    \subsection{Tools and Skill Kits}
        ...
        \parhead{Magnifying Glass} This simple lens allows a closer look at small objects. It is also useful as a substitute for flint and steel when starting fires. Lighting a fire with a magnifying glass requires light as bright as sunlight to focus, tinder to ignite, and at least a standard action.
    ...
    \subsection{Poisons}\label{Poisons}
        ...
        \begin{dtable*}
            ...
            \begin{dtabularx}{\textwidth}{l l l l l X l}
                ...
                Nitharit            & Contact   & Powder & 3  & Sickened                     & Nauseated as a \glossterm{condition}, poison ends & Plant      \\
                Sassone leaf        & Contact   & Powder & 6  & Lose a hit point             & Lose two hit points, poison ends                  & Plant      \\
                Dragon bile         & Contact   & Liquid & 10 & Sickened, lose a hit point   & Nauseated                                         & Venom      \\
                Black lotus extract & Contact   & Liquid & 15 & Lose a hit point every round & Gain a \glossterm{vital wound}, poison ends       & Plant      \\
        ...
        \subsubsection{Poison Effects}\label{Poison Effects}
            ...
            Success means the creature suffers the effect of the poison, and gets closer to the poison's secondary effect (see Secondary Effects, below).
            For every 10 points by which the attack succeeds, it counts as an additional successful attack for the purpose of reaching the poison's secondary effect.
            ...
            If the poison successfully attacks a poisoned creature three times, the creature suffers the poison's secondary effect in addition to its primary effect.
