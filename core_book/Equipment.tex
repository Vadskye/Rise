    ...
    \subsection{Weapon Mechanics}
        ...
        \subsubsection{Weapon Groups}\label{Weapon Groups}
            ...
            \begin{dtable!*}
                ...
                \begin{dtabularx}{\textwidth}{l >{\lcol}X >{\lcol}X}
                    ...
                    Thrown weapons     & Dagger, dart, javelin, light hammer, shuriken, sling, throwing axe                    & Bolas, dwarven throwing axe, dwarven waraxe, net      \\
        ...
        \subsubsection{Ranged Weapons}
            ...
            \subsubsection{Thrown Weapons}\label{Thrown Weapons} Thrown weapons are thrown at a target to deal damage. They generally do not break when thrown.
                ...
                The range limits are 10 feet for close range and 50 feet for long range.
    ...
    \subsection{Weapon Table}
        ...
        \begin{longtablewrapper}
            ...
            \begin{longtable}{p{10em} c c c >{\ccol}p{7em} c >{\ccol}p{12em}}
                ...
                \tind Handaxe                      & Light  & \plus2  & 1d6    & Slashing                 & 1/2 (10 gp)  & Impact                         \\
...
\section{Armor}\label{Armor}
        ...
        \subsubsection{Armor for Unusual Creatures}\label{Armor for Unusual Creatures}
            ...
            \begin{dtable}
                ...
                \begin{dtabularx}{\columnwidth}{>{\lcol}X c c c c}
                    ...
                    Tiny or smaller & \mult2 & \mult1/64 & \mult4  & \mult1/64 \\
                    Small           & \mult1   & \mult1/8  & \mult2  & \mult1/8  \\
    ...
    \subsection{Armor Table}
        ...
        \parhead{Cost} The cost of the armor for Medium humanoid creatures.
        ...
        \begin{dtable!*}
            ...
            \begin{dtabularx}{\textwidth}{l c c c c c c >{\lcol}X c}
                ...
                Light armor           &              &         &         &              &              &          &                   &              \\
                \tind Leather         & \plus2       & \plus1  & \plus3  & \tdash       & \tdash       & \tdash   & Leather           & 1/2 (10 gp)  \\
                \tind Studded leather & \plus2       & \plus3  & \plus3  & \plus1       & \tdash       & \tdash   & Leather and metal & 1st (50 gp)  \\
                \tind Chain shirt     & \plus2       & \plus4  & \plus2  & \plus1       & \tdash       & \tdash   & Metal             & 1st (50 gp)  \\
                \tind Buckler         & \plus1       & \tdash  & \tdash  & \tdash       & \tdash       & \tdash   & Metal or wood     & 1/2 (10 gp)  \\
                Medium armor          &              &         &         &              &              &          &                   &              \\
                \tind Hide            & \plus3       & \plus2  & \plus5  & \plus2       & \minus5 ft.  & \tdash   & Leather           & 1st (50 gp)  \\
                \tind Scale mail      & \plus3       & \plus6  & \plus2  & \plus4       & \minus5 ft.  & \tdash   & Metal             & 1st (50 gp)  \\
                \tind Breastplate     & \plus3       & \plus6  & \plus3  & \plus3       & \minus5 ft.  & \tdash   & Metal             & 2nd (125 gp) \\
                \tind Standard shield & \plus2       & \tdash  & \tdash  & \tdash\fn{2} & \tdash       & \tdash   & Metal or wood     & 1/2 (10 gp)  \\
                Heavy armor           &              &         &         &              &              &          &                   &              \\
                \tind Layered hide    & \plus4       & \plus3  & \plus7  & \plus4       & \minus10 ft. & \mult1/2 & Leather           & 2nd (125 gp) \\
                \tind Plated mail     & \plus4       & \plus8  & \plus4  & \plus5       & \minus10 ft. & \mult1/2 & Metal             & 3rd (250 gp) \\
                \tind Half-plate      & \plus4       & \plus10 & \plus5  & \plus6       & \minus10 ft. & \mult1/2 & Metal             & 4th (500 gp) \\
                \tind Full plate      & \plus4       & \plus12 & \plus6  & \plus5       & \minus10 ft. & \mult1/2 & Metal             & 5th (800 gp) \\
    ...
    \subsection{Special Materials}\label{Special Materials}
        ...
        % Cost analysis for breastplate:
        % Regular: 150 gp = IL 3
        % \mult2, \plus 500: 800 gp = IL 5
        % \mult5, \plus2,000: 2750 gp = IL 8
        % \mult10, \plus10,000: 11500 gp = IL 12 (barely)
        % \mult20, \plus50,000: 53,000 gp = IL 15
        % \mult50, \plus250,000: 275,000 gp = IL 19

        % Cost analysis for full plate:
        % Regular: 1,000 gp = IL 6
        % \mult2, \plus 500: 2500 gp = IL 8
        % \mult5, \plus2,000: 7000 gp = IL 11
        % \mult10, \plus10,000: 20,000 gp = IL 13
        % \mult20, \plus50,000: 70,000 gp = IL 16
        % \mult50, \plus250,000: 300,000 gp = IL 20
