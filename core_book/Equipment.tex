...
\section{Weapons}\label{Weapons}
    ...
    \subsection{Weapon Tags}\label{Weapon Tags}
        ...
        \weapontagdef{Ammunition} This weapon is designed to be fired by a \weapontag{Projectile} weapon or thrown in large quantities.
        It is cheaper to buy and craft, but it is usually \glossterm{broken} after being fired or thrown.
        Ammunition cannot have magic weapon properties.
        ...
        \weapontagdef{Impact} When you get a \glossterm{critical hit} with this weapon, you deal maximum \glossterm{weapon damage}.
        This does not affect any \glossterm{extra damage} that applies to the attack.
