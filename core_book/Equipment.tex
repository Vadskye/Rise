...
\parhead{Light Weapons}\pcref{Light Weapons} You can use Dexterity to determine your \glossterm{accuracy} when making a \glossterm{physical attack} with a light weapon.
...
\parhead{Unbalanced} If you roll either a 1 or 2 when attacking this weapon, you \glossterm{critically miss} (see \pcref{Critical Miss}).
...
\subsubsection{Armor Proficiency} 
