...
\section{Wealth and Item Ranks}\label{Wealth}\label{Wealth and Item Ranks}
    ...
    \subsection{Item Ranks}\label{Item Ranks}
        ...
        \parhead{Permenant Items and Consumables}
...
\section{Using Items}
    ...
    \subsection{Manipulating Objects}\label{Manipulating Objects}
        There are three ways to determine how difficult an object is to interact with: its weight, its size, and how it is contained.
        Use the slowest action type from among the three methods.
        As normal, you cannot use the same free action twice in a single round, so you can typically manipulate one object in a meaningful way each round.
        You can use a standard action instead of a free action to manipulate two objects in the same round.
        ...
        Simply dropping an object in your hands is not an action at all, and you can do that any number of times per round.
        Other similarly trivial interactions may not be considered actions at the GM's discretion.
        ...
        \begin{raggeditemize}
            ...
            \itemhead{Size} If an item's size category is no larger than your size category, interacting with that item is a \glossterm{free action} (see \pcref{Size Categories}).
                If it exceeds your size category, the interaction requires a \glossterm{standard action}.
    ...
    \subsection{Moving Items Between Hands}\label{Moving Items Between Hands}
        In general, you can move weapons and similar handheld objects around between your hands freely, without spending an action.
        For example, if you were holding two short swords, you could quickly hold them both in one hand so you could open a door or cast a spell, and then return to holding one in each hand.
...
\section{Weapons}\label{Weapons}
    ...
    \subsection{Weapon Groups}\label{Weapon Groups}
        ...
        \subsubsection{Improvised Weapons}\label{Improvised Weapons}
            ...
            An improvised weapon will generally have a \minus1 accuracy penalty, a smaller damage die, or be missing a weapon tag relative to a similarly structured manufactured weapon.
    ...
    \subsection{Weapon Tags}\label{Weapon Tags}
        ...
        This is not considered an independent action, so you can fire a longbow any number of times per round.
        ...
        While holding a Heavy weapon in two hands, you gain a \plus1 bonus per 3 \glossterm{power} to your \glossterm{weapon damage} with the weapon, with a minimum bonus of \plus0.
        ...
        \weapontagdef{Impact} You reduce your \glossterm{explosion target} for strikes using this weapon by 2 (see \pcref{Exploding Attacks}).
        ...
        Drawing a Light item from a sheath, or returning it to a sheath, is not considered an action, allowing you to do it any number of times on your turn.
        ...
        While holding this weapon in two hands, you gain a \plus1 damage bonus to your \glossterm{weapon damage} with it, plus \plus1 per 3 \glossterm{power}, with a minimum bonus of \plus0.
        This bonus is in addition to the normal bonus that you gain from your power with weapons (see \pcref{Weapon Damage}).
    ...
    \subsection{Weapon Table}
        ...
        \begin{dtable!*}
            ...
            \begin{dtabularx}{\textwidth}{p{12em} c c >{\ccol}p{15em} >{\ccol}X}
                ...
                Ram                     & \plus0        & 1d6         & Bludgeoning      & Resonating  \\
    ...
    \subsection{Individual Weapon Descriptions}
        ...
        This makes them easy to dual wield (see \pcref{Moving Items Between Hands}).
    ...
    \subsection{Weapon Special Materials}\label{Weapon Special Materials}
        ...
        \begin{dtable!*}
            ...
            \begin{dtabularx}{\textwidth}{l >{\lcol}X l}
                ...
                % object damage
                \tind Adamantine          & \plus2 damage, double damage to objects, extra weight & 5 (25,000 gp)   \\
                ...
                \tind Mithral             & Lighter, \minus1 damage                      & 3 (1,000 gp)   \\
                \tind Mithral, pure       & \plus1 accuracy, lighter, \minus2 damage     & 5 (25,000 gp)  \\
                % just vulnerabilities  
                \tind Silvered            & Common vulnerabilities                        & 2 (200 gp)     \\
            \end{dtabularx}
        \end{dtable!*}

        \parhead{Adamantine} An adamantine weapon deals \plus2 \glossterm{weapon damage}.
        In addition, \glossterm{strikes} with it deal double damage to objects that are not made of pure or ordinary adamantine.
        Unlike other weapons, adamantine weapons are not \glossterm{lightweight}, so they typically require a minimum Strength of 1 to wield.
        ...
        However, mithral weapons deal \minus1 \glossterm{weapon damage}.
        ...
        A Heavy mithral weapon loses that tag and instead gains the \weapontag{Versatile Grip} weapon tag.
        However, pure mithral weapons deal \minus2 \glossterm{weapon damage}.
...
\section{Armor}\label{Armor}
    ...
    \subsection{Armor Mechanics}
        ...
        \subsubsection{Armor Proficiency}\label{Armor Proficiency}
            ...
            Since standard shields and leather body armor have no \glossterm{encumbrance}, you can use them without penalizing your attacks.
    ...
    \subsection{Armor Table}
        ...
        \begin{dtable!*}
            ...
            \begin{dtabularx}{\textwidth}{l c c c c c c >{\lcol}X c}
                ...
                Medium armor          &              &                        &                  &                  &              &                &               &              \\
                \tind Rawhide         & \plus4       & \plus4                 & \plus1           & \plus2           & \tdash       & \mult1/2       & Leather       & 1 (40 gp)    \\
                ...
                Heavy armor           &              &                        &                  &                  &              &                &               &              \\
                \tind Layered hide    & \plus5       & \plus6                 & \plus2           & \plus4           & \minus10 ft. & \mult0         & Leather       & 1 (40 gp)    \\
                \tind Half plate      & \plus5       & \plus8                 & \plus2           & \plus6           & \minus10 ft. & \mult0         & Metal         & 2 (200 gp)   \\
                \tind Full plate      & \plus5       & \plus10                & \plus2           & \plus6           & \minus10 ft. & \mult0         & Metal         & 3 (1,000 gp) \\
                \tind Tower shield    & \plus3\fn{2} & \tdash                 & \tdash           & \plus2\fn{1}     & \tdash       & \mult0         & Metal or wood & 1 (40 gp)    \\
                Extras                &              &                        &                  &                  &              &                &               &              \\
