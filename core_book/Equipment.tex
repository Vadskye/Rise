    ...
    \subsection{Weapon Qualities}
        ...
        \begin{longtabuwrapper}
            \begin{longtabu}{p{12em} c c >{\ccol}p{10em} c c >{\ccol}X}
                ...
                \tind Gauntlet                         & Light           & \plus0  & \minus3d          & Bludgeoning              & 2 gp    & 1 lb.   & Unarmed                      \\
                \tind Gauntlet, spiked                 & Light           & \plus0  & \minus2d          & Piercing                 & 5 gp    & 1 lb.   & Unarmed                      \\
                \tind Unarmed strike                   & Light           & \plus0  & \minus3d          & Bludgeoning              & \tdash  & \tdash  & Subdual, Unarmed             \\
            \end{longtabu}
        ...
        \begin{dtable!*}
            \begin{dtabularx}{\textwidth}{p{12em} c c >{\ccol}p{10em} c c >{\ccol}X}
                ...
                Club-like weapons &&&&&& \\
                Crossbows &&&&&& \\
                \tind Repeating heavy crossbow\fn{4} & Heavy (Ranged) & \plus1d & Piercing & 400 gp & 12 lb. & Projectile (100 ft.) \\
                \tind Repeating light crossbow\fn{4} & Medium (Ranged) & \plus0d & Piercing & 250 gp & 6 lb. & Projectile (50 ft.) \\
