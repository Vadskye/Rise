    ...
    \subsection{Weapon Special Materials}\label{Weapon Special Materials}
        ...
        \begin{dtable!*}
            ...
            \begin{dtabularx}{\textwidth}{l >{\lcol}X l}
                ...
                % crit damage
                \tind Diamondsteel        & \plus3 accuracy with critical hits        & \plus3 \\
                \tind Diamondsteel, pure  & \plus6 accuracy with critical hits        & \plus5 \\
                % energy damage
        ...
        \parhead{Diamondsteel, Pure} A pure diamondsteel weapon grants you a \plus6 bonus to \glossterm{accuracy} with \glossterm{strikes} using it for the purpose of determining whether you get a \glossterm{critical hit}.
