    ...
    \subsection{Weapon Qualities}
        ...
        \begin{longtablewrapper}
            \begin{longtable}{p{11em} c c c >{\ccol}p{7em} c c >{\ccol}p{8em}}
                ...
                \tind Estoc                            & Medium           & \plus0        & \plus0d           & Piercing                 & 20 gp     & 4 lb.       & Long                         \\
                \tind Greatsword                       & Heavy            & \plus0        & \plus1d           & Slashing                 & 25 gp     & 8 lb.       & Long, Sweeping (2)           \\
                ...
                \tind Greatclub                        & Heavy            & \minus0       & \plus2d           & Bludgeoning              & 5 gp      & 8 lb.       & \tdash                       \\
                ...
                \tind Heavy flail                      & Heavy            & \plus0        & \plus2d           & Bludgeoning              & 15 gp     & 10 lb.      & Long, Tripping               \\
                ...
                \tind Sledgehammer                     & Heavy            & \plus0        & \plus2d           & Bludgeoning              & 12 gp     & 5 lb.       & Long                         \\
        ...
        \begin{dtable!*}
            ...
            \begin{dtabularx}{\textwidth}{p{12em} c c c >{\ccol}p{15em} >{\ccol}X}
                ...
                Slam            & Heavy & \plus0 & \plus1d  & Bludgeoning              & \tdash    \\
    ...
    \subsection{Getting Into And Out Of Armor}
        ...
        \begin{dtable!*}
            ...
            \begin{dtabularx}{\textwidth}{l c c c c c c >{\lcol}X c c}
                ...
                \tind Full plate      & \plus4       & \plus6  & \plus3  & \plus6       & \minus10 ft. & \mult1/2 & Metal             & 1000 gp    & 50 lb.      \\
...
\section{Goods And Services}
    ...
    \subsection{Adventuring Gear}
        ...
        \par Caltrops may not be effective against opponents with an unusual anatomy.
    ...
    \subsection{Poisons}\label{Poisons}
        ...
        \begin{dtable*}
            ...
            \begin{dtabularx}{\textwidth}{l l l l l X l}
                \tb{Poison}         & \tb{Transmission} & \tb{Form} & \tb{Base Accuracy} & \tb{Primary Effect}                                 & \tb{Secondary Effect}                       & \tb{Type}  \\
        ...
        \subsubsection{Poison Transmission}\label{Poison Transmission}\label{Transmission}
            ...
            \parhead{Injury} An injury poison affects any creature \glossterm{injured} by something carrying the poison.
            Almost all injury poisons take liquid form, and are typically used to coat weapons.
            % TODO: unnecessary?
            An attack that does not cause the target to lose a \glossterm{hit point} cannot transmit injury poisons.
