    ...
    \subsection{Weapon Table}
        ...
        \begin{longtablewrapper}
            \begin{longtable}{p{11em} c c c >{\ccol}p{7em} c c >{\ccol}p{8em}}
                ...
                Crossbows                          &        &         &        &                          &         &         &                                 \\
                \tind Hand crossbow\fn{2}          & Light  & \plus0  & 1d6    & Piercing                 & 100 gp  & 2 lb.   & Projectile (60 ft.)             \\
                \tind Heavy crossbow\fn{2}         & Heavy  & \plus0  & 1d10   & Piercing                 & 50 gp   & 8 lb.   & Projectile (90 ft.)            \\
                \tind Light crossbow\fn{2}         & Medium & \plus0  & 1d8    & Piercing                 & 40 gp   & 4 lb.   & Projectile (60 ft.)             \\
                \tind Crossbow bolts (10)          & \tdash & \plus0  & \tdash & \tdash                   & 1 gp    & 1 lb.   & Ammunition                      \\
                \tind Blunted crossbow bolts (10)  & \tdash & \minus1 & \tdash & \tdash                   & 5 gp    & 1 lb.   & Ammunition, Subdual             \\
        ...
        \begin{dtable!*}
            \begin{dtabularx}{\textwidth}{p{12em} c c c >{\ccol}p{10em} c c >{\ccol}X}
                ...
                Club-like weapons                    &         &        &           &                      &        &        &                                 \\
                Crossbows                            &         &        &           &                      &        &        &                                 \\
                \tind Repeating heavy crossbow\fn{2} & Heavy   & \plus0 & 1d10      & Piercing             & 400 gp & 12 lb. & Projectile (90 ft.)            \\
                \tind Repeating light crossbow\fn{2} & Medium  & \plus0 & 1d8       & Piercing             & 250 gp & 6 lb.  & Projectile (60 ft.)             \\
                \tind Repeating bolts (5)            & \tdash  & \plus0 & 1d8       & \tdash               & 1 gp   & 1 lb.  & Ammunition                      \\
                Flexible weapons                     &         &        &           &                      &        &        &                                 \\
