...
\begin{dtable!*}
    ...
    \begin{dtabularx}{\textwidth}{>{\lcol}X >{\ccol}p{6em} >{\ccol}p{5em} >{\ccol}p{6em} >{\ccol}p{7em} c c c}
        ...
        Medium armor           &               &            &          &            &               &              &        \\
        \tind Hide             & \plus3        & 1\x   & \minus4  & 20\%       & Leather       & 15 gp        & 25 lb. \\
        \tind Scale mail       & \plus3        & 1\x   & \minus4  & 25\%       & Metal         & 50 gp        & 30 lb. \\
        \tind Breastplate      & \plus4        & 1\x   & \minus3  & 25\%       & Metal         & 150 gp       & 30 lb. \\
        Heavy armor            &               &            &          &            &               &              &        \\
        \tind Half-plate       & \plus5        & 1/2\x & \minus6  & 40\%       & Metal         & 250 gp       & 50 lb. \\
