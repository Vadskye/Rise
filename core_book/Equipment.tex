...
\section{Weapons}\label{Weapons}
    ...
    \subsection{Weapon Usage Classes}\label{Weapon Usage Classes}
        ...
        % Being Light grants an automatic +1a/-2d and better dual wielding/grappling, and light weapons cannot be higher than -1d base.
        % Being Medium has no special properties, but many Medium weapons have the Versatile Grip property.
        % Being Heavy grants an automatic +2d, but all heavy weapons require two hands.
        % Extreme weapons are discouraged; although this permits a Heavy weapon with +3d, no such weapon should exist.
        % Trading -2d/+1a or +2d/-1a in either direction is not considered an improvement.
        % +1a costs two improvements, since it's about twice as good as +1d
    ...
    \subsection{Weapon Tags}\label{Weapon Tags}
        ...
        While holding this weapon in two hands, you gain a \plus2d damage bonus with the weapon.
    ...
    \subsection{Weapon Table}
        ...
        \begin{longtablewrapper}
            ...
            \begin{longtable}{p{10em} c c c >{\ccol}p{7em} c >{\ccol}p{12em}}
                ...
                \tind Shepherd's axe               & Light  & \plus1  & 1d4    & Bludgeoning or slashing  & 0 (10 gp) & Long                                           \\
                ...
                \tind Dagger                       & Light  & \plus1  & 1d3    & Piercing or slashing     & 0 (10 gp) & Compact, Thrown (30/60), Stealthy              \\
                ...
                \tind Rapier                       & Light  & \plus2  & 1d3    & Piercing                 & 0 (10 gp) & \tdash                                           \\
                \tind Scimitar                     & Medium & \plus0  & 1d6    & Slashing                 & 0 (10 gp) & Keen, Mounted                                  \\
                \tind Smallsword                   & Light  & \plus1  & 1d4    & Piercing                 & 0 (10 gp) & Keen                                           \\
                ...
                \tind Sap                          & Light  & \plus1  & 1d3    & Bludgeoning              & 0 (10 gp) & Stealthy, Subdual                              \\
                ...
                \tind Nunchaku                     & Light  & \plus1  & 1d4    & Bludgeoning              & 0 (10 gp) & Tripping                                       \\
                \tind Slapjack                     & Light  & \plus1  & 1d4    & Bludgeoning              & 0 (10 gp) & Subdual                                        \\
                \tind Whip\fn{2}                   & Light  & \plus1  & 1d3    & Bludgeoning              & 0 (10 gp) & Long, Subdual, Tripping                        \\

                Headed weapons                     &        &         &        &                          &           &                                                \\
                \tind Light hammer                 & Light  & \plus1  & 1d4    & Bludgeoning              & 0 (10 gp) & Thrown (30/60)                       \\
                ...
                \tind Sickle                       & Light  & \plus1  & 1d4    & Slashing                 & 0 (10 gp) & Tripping                                       \\
                ...
                Monk weapons                       &        &         &        &                          &           &                                                \\
                \tind Jitte                        & Light  & \plus1  & 1d4    & Piercing                 & 0 (10 gp) & Parrying                                       \\
                \tind Kama                         & Light  & \plus1  & 1d4    & Slashing                 & 0 (10 gp) & Tripping                                       \\
                ...
                \tind Shuriken (5)                 & Light  & \plus1  & 1d3    & Piercing and slashing    & 0 (10 gp) & Ammunition, Compact, Thrown (30/60), Stealthy  \\
                ...
                % only 1 improvement
                \tind Club                         & Medium & \plus0  & 1d8   & Bludgeoning              & 0         & \tdash                                         \\
                \tind Dagger                       & Light  & \plus1  & 1d3    & Piercing or slashing     & 0 (10 gp) & Compact, Stealthy, Thrown (30/60)              \\
                % only 1 improvement
                \tind Mace                         & Medium & \plus0  & 1d6    & Bludgeoning              & 0 (10 gp) & Impact                         \\
                % only 1 improvement
                \tind Quarterstaff                 & Heavy  & \plus1  & 1d6    & Bludgeoning              & 0         & Long                                           \\
                ...
                Armor                           &         &        &         &                          &            &                                    \\
                \tind Armblade\fn{2}            & Light   & \plus1 & 1d4     & Slashing                 & 1 (40 gp)  & Grappling, Keen, Supplemental      \\
                \tind Spiked knee\fn{2}         & Light   & \plus1 & 1d3     & Piercing                 & 1 (40 gp)  & Grappling, Impact, Supplemental    \\
                ...
                Blades                          &         &        &         &                          &            &                                    \\
                \tind Boot dagger\fn{2}         & Light   & \plus1 & 1d4     & Piercing                 & 0 (10 gp)  & Compact, Stealthy, Supplemental    \\
                ...
                \tind Kukri                     & Light   & \plus2 & 1d3     & Slashing                 & 0 (10 gp)  & Sweeping (1)                 \\
                \tind Parrying dagger           & Light   & \plus1 & 1d4     & Piercing                 & 0 (10 gp)  & Parrying, Stealthy, Thrown (30/60) \\
                Bows                            &         &        &         &                          &            &                                    \\
                ...
                \tind Gnomish trick mace        & Light   & \plus1 & 1d4     & Bludgeoning              & 0 (10 gp)  & Impact, Tripping                   \\
                \tind Knobkerrie                & Medium  & \plus1 & 1d6     & Bludgeoning              & 0 (10 gp)  & Throwing (30/60)           \\
                ...
                \tind Chain whip                & Medium  & \plus1 & 1d4     & Bludgeoning              & 1 (40 gp)  & Long, Tripping                     \\
                ...
                \tind Dwarven shorthammer       & Light   & \plus2 & 1d3     & Bludgeoning              & 1 (40 gp)  & Impact                   \\
                \tind Heavy pick                & Heavy   & \plus0 & 2d6     & Piercing                 & 1 (40 gp)  & Keen, Impact                       \\
                \tind Obuch                     & Medium  & \plus0 & 1d8     & Bludgeoning              & 1 (40 gp)  & Long, Tripping                     \\
                Monk weapons                    &         &        &         &                          &            &                                    \\
                \tind Sai                       & Light   & \plus1 & 1d4     & Piercing or bludgeoning  & 0 (10 gp)  & Grappling, Parrying                \\
                \tind Three-section staff       & Heavy   & \plus0 & 1d10     & Bludgeoning              & 1 (40 gp)  & Long, Parrying, Tripping           \\
                Polearms                        &         &        &         &                          &            &                                    \\
                ...
                Simple weapons                  &         &        &         &                          &            &                                    \\
                Spear                           &         &        &         &                          &            &                                    \\
                \tind Gnomish smallspear        & Light   & \plus2 & 1d3     & Piercing                 & 0 (10 gp)  & Long                       \\
        ...
        \begin{dtable!*}
            ...
            \begin{dtabularx}{\textwidth}{p{12em} c c c >{\ccol}p{15em} >{\ccol}X}
                ...
                Claw\fn{1}              & Light            & \plus1        & 1d4         & Slashing         & Versatile Grip \\
                ...
                Stinger                 & Medium           & \plus1        & 1d4         & Piercing         & \tdash         \\
                Talon\fn{1}             & Light            & \plus1        & 1d4         & Piercing         & Versatile Grip \\
            \end{dtabularx}
