...
\section{Weapons}\label{Weapons}
    ...
    \subsection{Weapon Groups}\label{Weapon Groups}
        ...
        In addition, you can spend two \glossterm{insight points} to gain proficiency with exotic weapons from a single \glossterm{weapon group} that you are already proficient with (see \pcref{Insight Points}).
    ...
    \subsection{Weapon Tags}\label{Weapon Tags}
        ...
        Heavy thrown weapons are not always physically thrown with two hands, but they require the use of your entire body to propel the weapon.
        You are not considered to have any \glossterm{free hands} while throwing a heavy thrown weapon.
    ...
    \subsection{Weapon Special Materials}\label{Weapon Special Materials}
        ...
        \begin{dtable!*}
            ...
            \begin{dtabularx}{\textwidth}{l >{\lcol}X l}
                ...
                \tind Diamondsteel, pure  & \plus5 accuracy with critical hits                                & 5 (25,000 gp)  \\
                % energy damage
                ...
                % extra damage
                \tind Starmetal           & \plus2 \glossterm{extra damage}, \minus1 accuracy, extra weight   & 2 (200 gp)     \\
        ...
        Unlike other weapons, pure adamantine weapons are not \glossterm{lightweight}, so they typically require a minimum Strength of 1 to wield.
        ...
        \parhead{Dragonfang, Ancient} Damage dealt by an ancient dragonfang weapon is damage of the type dealt by that dragon's breath weapon in addition to its normal damage types (see \tref{Dragon Types}).
        ...
        \parhead{Starmetal} A starmetal weapon deals \plus2 \glossterm{extra damage}.
        However, it also has a \minus1 accuracy penalty.
        Unlike other weapons, starmetal weapons are not \glossterm{lightweight}, so they typically require a minimum Strength of 1 to wield.

        \parhead{Pure Starmetal} A pure starmetal weapon deals \plus1d8 \glossterm{extra damage}.
        However, it also has a \minus1 accuracy penalty.
        Unlike other weapons, pure starmetal weapons are not \glossterm{lightweight}, so they typically require a minimum Strength of 1 to wield.
