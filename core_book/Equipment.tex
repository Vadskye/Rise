...
\section{Weapons}\label{Weapons}
    ...
    \subsection{Drawing and Sheathing Weapons}\label{Drawing and Sheathing Weapons}
        ...
        As a standard action, you can draw or sheathe any of the following equipment combinations: up to two \glossterm{medium weapons}, a medium weapon and a shield, one \glossterm{heavy weapon}, or one concealed weapon.
    ...
    \subsection{Weapon Tags}\label{Weapon Tags}
        ...
        You take a \minus2d damage penalty with the strike, and your \glossterm{power} is halved.
    ...
    \subsection{Individual Weapon Descriptions}
        ...
        Attacking with a boot dagger does not require a \glossterm{free hand}, but you must make a Balance check with a \glossterm{difficulty rating} of 10 during each phase that you attack with it.
    ...
    \subsection{Armor Table}
        ...
        \begin{dtable!*}
            ...
            \begin{dtabularx}{\textwidth}{l c c c c c >{\lcol}X c}
                ...
                \tind Tower shield    & \plus3\fn{2} & \tdash                 & \plus2\fn{1}     & \tdash       & \mult0         & Metal or wood     & 1st (50 gp)  \\
                Extras\fn{3}          &              &                        &                  &              &                &                   &              \\
...
\section{Magic Apparel}
    ...
    \subsection{Body Slots}
        ...
        Amulets are unique, and have powerful effects that are tied to specific class abilities.
        Although you can physically wear more than one amulet on your body without great difficulty, you can only gain the benefit of one amulet at a time.
