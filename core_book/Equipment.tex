...
\section{Weapons}\label{Weapons}
    ...
    \subsection{Weapon Range Limits}\label{Weapon Range Limits}
        ...
        Ranged weapons have two \glossterm{range limits} listed, with a slash between them, such as 120/360.
    ...
    \subsection{Drawing and Sheathing Weapons}\label{Drawing and Sheathing Weapons}
        ...
        Like other free actions, you cannot take this action twice in the same round, so you cannot draw and sheathe a single weapon in the same round.
    ...
    \subsection{Weapon Table}
        ...
        \begin{longtablewrapper}
            ...
            \begin{longtable}{p{10em} c c c >{\ccol}p{7em} c >{\ccol}p{12em}}
                ...
                Bows                               &        &         &        &                          &              &                                                \\
                \tind Longbow\fn{2}                & Heavy  & \plus0  & 1d6    & \tdash                   & 1 (40 gp)  & Projectile (120/360)                           \\
                \tind Shortbow\fn{2}               & Medium & \plus0  & 1d4    & \tdash                   & 1 (40 gp)  & Projectile (90/270), Stealthy                  \\
                ...
                Bows                           &         &        &        &                          &              &                                \\
                \tind Flatbow\fn{2}            & Heavy   & \plus1 & 1d6    & \tdash                   & 1 (40 gp)  & Projectile (120/360)           \\
                \tind Heartseeker arrows (20)  & \tdash  & \plus0 & \tdash & Piercing                 & 2 (40 gp)  & Ammunition, Impact             \\
                \tind Takedown bow\fn{2}       & Special & \plus0 & 1d6    & \tdash                   & 2 (200 gp) & Projectile (120/360 or 60/180) \\
                Club-like weapons              &         &        &        &                          &              &                                \\
    ...
    \subsection{Armor Table}
        ...
        \begin{dtable!*}
            ...
            \begin{dtabularx}{\textwidth}{l c c c c c >{\lcol}X c}
                ...
                \tind Spiked shield   & \plus2       & \tdash                 & \plus1\fn{1}     & \tdash       & \mult1/2       & Metal or wood & 1 (50 gp)    \\
                Heavy armor           &              &                        &                  &              &                &               &              \\
...
\end{dtabularx}
        ...
        When you use the \textit{recover} ability while wearing starmetal body armor, you also regain an amount of \glossterm{damage resistance} equal to half the damage resistance provided by the armor.
        The armor's item rank is increased by 2, which increases the typical cost to buy the item (see \pcref{Item Ranks}).
