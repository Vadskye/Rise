    ...
    \subsection{Weapon Table}
        ...
        \begin{longtablewrapper}
            ...
            \begin{longtable}{p{10em} c c c >{\ccol}p{7em} c >{\ccol}p{12em}}
                \lcaption{Weapons}                     \\
                \tb{Name}                          & \tb{Usage Class} & \tb{Accuracy} & \tb{Damage} & \tb{Damage Type\fn{1}}   & \tb{Item Level (Cost)} & \tb{Special}                          \\
                ...
                Bows                               &        &         &        &                          &             &                                                \\
                \tind Longbow\fn{2}                & Heavy  & \plus0  & 1d8    & \tdash                   & 1 (50 gp)   & Projectile (90 ft.)                            \\
                \tind Shortbow\fn{2}               & Medium & \plus0  & 1d6    & \tdash                   & 1 (50 gp)   & Projectile (60 ft.), Stealthy                  \\
                ...
                \tind Fire arrows (20)\fn{2}       & \tdash & \minus2 & \tdash & Piercing and fire        & 2 (25 gp)   & Ammunition                                     \\
                ...
                Crossbows                          &        &         &        &                          &             &                                                \\
                \tind Hand crossbow\fn{2}          & Light  & \plus0  & 1d6    & \tdash                   & 2 (125 gp)  & Projectile (60 ft.), Stealthy                  \\
                \tind Heavy crossbow\fn{2}         & Heavy  & \plus0  & 1d10   & \tdash                   & 1 (50 gp)   & Projectile (90 ft.)                            \\
                \tind Light crossbow\fn{2}         & Medium & \plus0  & 1d8    & \tdash                   & 1 (50 gp)   & Projectile (60 ft.)                            \\
                ...
                \tind Whip\fn{2}                   & Light  & \plus1  & 1d4    & Bludgeoning              & 1/2 (10 gp) & Disarming, Subdual, Tripping                   \\
                ...
                \tind Spear\fn{2}                  & Medium & \plus0  & 1d8    & Piercing                 & 1/2 (10 gp) & Thrown (20 ft.), Versatile Grip                \\
                ...
                \tind Sling\fn{2}                  & Light  & \plus0  & 1d6    & Bludgeoning              & 1/2 (10 gp) & Projectile (60 ft.)                            \\
                \tind Bullets, sling (20)          & \tdash & \tdash  & \tdash & \tdash                   & 1/2 (2 gp)  & Ammunition                                     \\

                Unarmed weapons                    &        &         &        &                          &             &                                                \\
                \tind Claw sheath\fn{2}            & \tdash & \tdash  & \tdash & \tdash                   & 1 (50 gp)   &                                                \\
        ...
        \begin{dtable!*}
            ...
            \begin{dtabularx}{\textwidth}{p{10em} c c c >{\ccol}p{7em} c >{\ccol}X}
                ...
                Armor                                &         &        &        &                      &        &                                 \\
                \tind Armblade\fn{2}                 & Light   & \plus2 & 1d6    & Slashing             & 1 (50 gp)    & Grappling, Keen                 \\
                \tind Spiked knee\fn{2}              & Light   & \plus1 & 1d6    & Piercing             & 1 (50 gp)    & Grappling, Impact               \\
                Axes                                 &         &        &        &                      &              &                                 \\
                \tind Dwarven throwing axe           & Light   & \plus2 & 1d6    & Slashing             & 1/2 (10 gp)  & Impact, Thrown (20 ft.)         \\
                \tind Dwarven waraxe                 & Medium  & \plus0 & 1d10   & Slashing             & 1 (50 gp)    & Thrown (20 ft.), Versatile Grip \\
                \tind Orcish greataxe                & Heavy   & \plus0 & 2d6    & Slashing             & 1 (50 gp)    & Impact, Sweeping (1)            \\
                Blades                               &         &        &        &                      &              &                                 \\
                \tind Boot dagger\fn{2}              & Light   & \plus2 & 1d6    & Piercing             & 1/2 (10 gp)  & Compact, Stealthy               \\
                \tind Falchion                       & Medium  & \plus0 & 1d8    & Slashing             & 1/2 (10 gp)  & Sweeping (2), Versatile Grip    \\
                \tind Katana                         & Heavy   & \plus1 & 1d10   & Slashing             & 1 (50 gp)    & Keen, Sweeping (1)              \\
                \tind Kukri                          & Light   & \plus2 & 1d6    & Slashing             & 1/2 (10 gp)  & Keen, Sweeping (1)              \\
                Bows                                 &         &        &        &                      &              &                                 \\
                \tind Flatbow\fn{2}                  & Heavy   & \plus1 & 1d8    & \tdash               & 1 (50 gp)    & Projectile (90 ft.)             \\
                \tind Heartseeker arrows (20)        & \tdash  & \plus0 & \tdash & Piercing             & 3 (50 gp)    & Ammunition, Impact              \\
                \tind Takedown bow\fn{2}             & Special & \plus0 & 1d8    & \tdash               & 2 (125 gp)   & Projectile (90 ft. or 50 ft.)   \\
                Club-like weapons                    &         &        &        &                      &              &                                 \\
                \tind Gnomish trick mace             & Medium  & \plus1 & 1d8    & Bludgeoning          & 1/2 (10 gp)  & Impact, Tripping                \\
                \tind Knobkerrie                     & Medium  & \plus1 & 1d8    & Bludgeoning          & \tdash       & Impact, Throwing (20 ft.)       \\
                Crossbows                            &         &        &        &                      &              &                                 \\
                \tind Repeating heavy crossbow\fn{2} & Heavy   & \plus0 & 1d10   & \tdash               & 4 (500 gp)   & Projectile (60 ft.)             \\
                \tind Repeating light crossbow\fn{2} & Medium  & \plus0 & 1d8    & \tdash               & 3 (250 gp)   & Projectile (60 ft.)             \\
                \tind Repeating bolts (5)            & \tdash  & \plus0 & \tdash & Piercing             & 1 (10 gp)    & Ammunition                      \\
                Flexible weapons                     &         &        &        &                      &              &                                 \\
                \tind Chain whip                     & Medium  & \plus1 & 1d8    & Bludgeoning          & 1 (50 gp)    & Long, Tripping                  \\
                \tind Meteor hammer                  & Heavy   & \plus0 & 2d6    & Bludgeoning          & 1 (50 gp)    & Long, Tripping                  \\
                \tind Three-section staff            & Heavy   & \plus0 & 1d10   & Bludgeoning          & 1 (50 gp)    & Disarming, Long, Tripping       \\
                Headed weapons                       &         &        &        &                      &              &                                 \\
                \tind Dwarven longhammer             & Heavy   & \plus0 & 2d6    & Bludgeoning          & 1 (50 gp)    & Impact, Long                    \\
                \tind Heavy pick                     & Heavy   & \plus0 & 2d6    & Piercing             & 1 (50 gp)    & Keen, Impact                    \\
                Monk weapons                         &         &        &        &                      &              &                                 \\
                \tind Three-section staff            & Heavy   & \plus0 & 1d10   & Bludgeoning          & 1 (50 gp)    & Disarming, Long, Tripping       \\
                Polearms                             &         &        &        &                      &              &                                 \\
                \tind Fauchard                       & Heavy   & \plus0 & 1d10   & Slashing             & 1 (50 gp)    & Long, Sweeping (2)              \\
                \tind War scythe                     & Heavy   & \plus0 & 2d6    & Slashing or piercing & 1 (50 gp)    & Sweeping (2)                    \\
                Simple weapons                       &         &        &        &                      &              &                                 \\
                Spear                                &         &        &        &                      &              &                                 \\
                \tind Pike\fn{2}                     & Heavy   & \plus0 & 2d6    & Piercing             & 1/2 (10 gp). & Long                            \\
                Thrown weapons                       &         &        &        &                      &              &                                 \\
                \tind Bolas                          & Light   & \plus2 & 1d4    & Bludgeoning          & 1/2 (10 gp)  & Thrown (10 ft.), Tripping       \\
                \tind Dwarven throwing axe           & Light   & \plus2 & 1d6    & Slashing             & 1/2 (10 gp)  & Impact, Thrown (20 ft.)         \\
                \tind Dwarven waraxe                 & Medium  & \plus0 & 1d10   & Slashing             & 1 (50 gp)    & Thrown (20 ft.), Versatile Grip \\
                \tind Net\fn{2}                      & Medium  & \plus0 & \tdash & \tdash               & 1/2 (10 gp)  & Thrown (10 ft.)                 \\
                Unarmed weapons                      &         &        &        &                      &              &                                 \\
            \end{dtabularx}
            1 When two types are given, the weapon is both types if the entry specifies ``and,'' or either type (attacker's choice) if the entry specifies ``or.'' \\
            2 This weapon has special rules. \\
    ...
    \subsection{Armor Table}
        ...
        \begin{dtable!*}
            ...
            \begin{dtabularx}{\textwidth}{l c c c c c c >{\lcol}X c}
                \tb{Armor}            & \tb{Defense} & \tb{Physical Resist} & \tb{Energy Resist} & \tb{Encumbrance} & \tb{Speed}   & \tb{Dex} & \tb{Material}     & \tb{Item Level (Cost)}  \tableheaderrule
                Light armor           &              &         &         &              &              &          &                   &             \\
                \tind Leather         & \plus2       & \plus1  & \plus3  & \plus1       & \tdash       & \tdash   & Leather           & 1/2 (10 gp) \\
                \tind Studded leather & \plus2       & \plus3  & \plus3  & \plus2       & \tdash       & \tdash   & Leather and metal & 1 (50 gp)   \\
                \tind Chain shirt     & \plus2       & \plus4  & \plus2  & \plus2       & \tdash       & \tdash   & Metal             & 1 (50 gp)   \\
                \tind Buckler         & \plus1       & \tdash  & \tdash  & \tdash       & \tdash       & \tdash   & Metal or wood     & 1/2 (10 gp) \\
                Medium armor          &              &         &         &              &              &          &                   &             \\
                \tind Hide            & \plus3       & \plus2  & \plus5  & \plus3       & \minus5 ft.  & \tdash   & Leather           & 1 (50 gp)   \\
                \tind Scale mail      & \plus3       & \plus7  & \plus2  & \plus5       & \minus5 ft.  & \tdash   & Metal             & 1 (50 gp)   \\
                \tind Breastplate     & \plus3       & \plus6  & \plus3  & \plus4       & \minus5 ft.  & \tdash   & Metal             & 2 (125 gp)  \\
                \tind Standard shield & \plus2       & \tdash  & \tdash  & \tdash\fn{1} & \tdash       & \tdash   & Metal or wood     & 1/2 (10 gp) \\
                Heavy armor           &              &         &         &              &              &          &                   &             \\
                \tind Layered hide    & \plus4       & \plus3  & \plus7  & \plus5       & \minus10 ft. & \mult1/2 & Leather           & 2 (125 gp)  \\
                \tind Plated mail     & \plus4       & \plus8  & \plus4  & \plus6       & \minus10 ft. & \mult1/2 & Metal             & 3 (250 gp)  \\
                \tind Half-plate      & \plus4       & \plus10 & \plus5  & \plus7       & \minus10 ft. & \mult1/2 & Metal             & 4 (500 gp)  \\
                \tind Full plate      & \plus4       & \plus12 & \plus6  & \plus6       & \minus10 ft. & \mult1/2 & Metal             & 5 (800 gp)  \\
                \tind Tower shield    & \plus3\fn{2} & \tdash  & \tdash  & \plus2\fn{1} & \tdash       & \tdash   & Metal or wood     & 1 (50 gp)   \\
                Extras                &              &         &         &              &              &          &                   &             \\
...
\begin{dtabularx}{\textwidth}{l c c c c c >{\lcol}X}
    ...
    \tind Adamantine           & \tdash  & \mult3   & \mult3 & \plus2  & Metal   & \plus9  \\
    \tind Adamantine, pure     & \tdash  & \mult5   & \mult5 & \plus3  & Metal   & \plus15 \\
    \tind Cold iron            & Special & \mult1/2 & \tdash & \tdash  & Metal   & \plus6    \\
    \tind Cold iron, pure      & Special & \mult1/2 & \tdash & \tdash  & Metal   & \plus12    \\
    \tind Deepforged           & \tdash  & \mult2   & \mult2 & \tdash  & Metal   & \plus9  \\
    \tind Diamondsteel         & \tdash  & \tdash   & \mult3 & \tdash  & Metal   & \plus9  \\
    \tind Diamondsteel, pure   & \tdash  & \mult2   & \mult5 & \tdash  & Metal   & \plus15 \\
    \tind Dragonhide           & \tdash  & \tdash   & \mult2 & \tdash  & Leather & \plus6    \\
    \tind Dragonhide, ancient  & \tdash  & \mult2   & \mult4 & \tdash  & Leather & \plus12  \\
    \tind Dragonscale          & \tdash  & \tdash   & \mult2 & \tdash  & Metal   & \plus6    \\
    \tind Dragonscale, ancient & \tdash  & \tdash   & \mult4 & \tdash  & Metal   & \plus12  \\
    \tind Elvenweave           & \tdash  & \mult2   & \mult2 & \tdash  & Leather & \plus9  \\
    \tind Ironwood             & \tdash  & \tdash   & \tdash & \tdash  & Metal   & \plus3      \\
    \tind Mithral              & \tdash  & \tdash   & \tdash & \minus2 & Metal   & \plus6    \\
    \tind Mithral, pure        & \tdash  & \mult2   & \mult2 & \minus3 & Metal   & \plus12  \\
    \tind Starmetal            & \tdash  & \mult2   & \tdash & \plus1  & Metal   & \plus6    \\
    \tind Starmetal, pure      & \tdash  & \mult4   & \mult2 & \plus2  & Metal   & \plus12  \\
\end{dtabularx}
        \end{dtable!*}

        \parhead{Adamantine} Adamantine armor increases the \glossterm{encumbrance} of the armor by 2, but it triples the \glossterm{resistance} provided by the armor against both \glossterm{physical damage} and \glossterm{energy damage}.
        The armor's item level is increased by 9, which increases the typical cost to buy the item (see \pcref{Item Levels}).

        \parhead{Adamantine, Pure} Pure adamantine armor increases the \glossterm{encumbrance} of the armor by 3, but it quintuples the \glossterm{resistance} provided by the armor against both \glossterm{physical damage} and \glossterm{energy damage}.
        ...
        \parhead{Elvenweave} Elvenweave body armor doubles the \glossterm{resistance} provided by the armor against both \glossterm{physical damage} and \glossterm{energy damage}.
        The armor's item level is increased by 9, which increases the typical cost to buy the item (see \pcref{Item Levels}).
        ...
        \parhead{Mithral} Mithral armor reduces the \glossterm{encumbrance} of the armor by 2.
        The armor's item level is increased by 6, which increases the typical cost to buy the item (see \pcref{Item Levels}).

        \parhead{Mithral, Pure} Pure mithral armor reduces the \glossterm{encumbrance} of the armor by 3, and doubles its \glossterm{resistance} provided by the armor against both \glossterm{energy damage} and \glossterm{physical damage}.
        The armor's item level is increased by 12, which increases the typical cost to buy the item (see \pcref{Item Levels}).

        \parhead{Starmetal} Starmetal body armor increases the \glossterm{encumbrance} of the armor by 1, but it doubles the \glossterm{resistance} provided by the armor against \glossterm{physical damage}.
        The armor's item level is increased by 6, which increases the typical cost to buy the item (see \pcref{Item Levels}).

        \parhead{Starmetal, Pure} Pure starmetal body armor increases the \glossterm{encumbrance} of the armor by 2, but it quadruples the \glossterm{resistance} provided by the armor against \glossterm{physical damage} and doubles the resistance provided by the armor against \glossterm{energy damage}.
        The armor's item level is increased by 12, which increases the typical cost to buy the item (see \pcref{Item Levels}).
