...
\section{Weapons}\label{Weapons}
    ...
    \subsection{Weapon Mechanics}
        ...
        \subsubsection{Weapon Tags}\label{Weapon Tags}
            ...
            \parhead{Impact} When you get a \glossterm{critical hit} with this weapon, you deal additional damage equal to your \glossterm{power} with the attack.
            This additional damage is not itself multiplied by the critical hit.
            ...
            \parhead{Mounted}\label{Mounted Weapon} If you are mounted, and mount moves in the same phase that you make a \glossterm{strike} with a Mounted weapon, you gain a \plus2 \glossterm{accuracy} bonus with the strike.
            ...
            \parhead{Thrown} This weapon is designed to be thrown (see \pcref{Thrown Weapons}).
