...
\section{Weapons}\label{Weapons}
    ...
    \subsection{Moving Weapons Between Hands}\label{Moving Weapons Between Hands}
    ...
    \subsection{Weapon Table}
        ...
        \begin{longtablewrapper}
            ...
            \begin{longtable}{p{12em} c c >{\ccol}p{7em} c >{\ccol}p{16em}}
                ...
                Bows                              &               &             &                          &                             &                                             \\
                \tind Flatbow\fn{2}               & \plus1        & 1d6         & \tdash                   & 2 (200 gp)                  & Projectile (90/270)                         \\
                \tind Heartseeker arrows (20)     & \plus0        & \tdash      & Piercing                 & 2 (40 gp)                   & Ammunition, Impact                          \\
                \tind Recurve bow\fn{2}           & \plus0        & 1d8         & \tdash                   & 2 (200 gp)                  & Projectile (90/270)                         \\
                \tind Takedown bow\fn{2}          & \plus0        & 1d6/1d4     & \tdash                   & 2 (200 gp)                  & Projectile (90/270 or 60/180)               \\
                \tind Titanbow\fn{2}              & \minus1        & 1d8         & \tdash                  & 2 (200 gp)                  & Heavy, Projectile (60/180)                         \\
                Club-like weapons                 &               &             &                          &                             &                                             \\
    ...
    \subsection{Individual Weapon Descriptions}
        ...
        \parhead{Flatbow} You need both hands to fire a flatbow.
        Notching an arrow in a flatbow requires one \glossterm{free hand} while holding the flatbow in another hand.
        This is not considered an independent action, so you can fire a flatbow any number of times per round.
        ...
        The process requires thickening the arrow shaft, reducing the precision of the arrow.
        \parhead{Longbow} You need both hands to fire a longbow.
        Notching an arrow in a longbow requires one \glossterm{free hand} while holding the longbow in another hand.
        ...
        This makes them easy to dual wield (see \pcref{Moving Weapons Between Hands}).
        ...
        \parhead{Shortbow} You need both hands to fire a shortbow.
        Notching an arrow in a shortbow requires one \glossterm{free hand} while holding the shortbow in another hand.
        This is not considered an independent action, so you can fire a shortbow any number of times per round.
        ...
        \parhead{Titanbow} You need both hands to fire a titanbow.
        Notching an arrow in a longbow requires one \glossterm{free hand} while holding the longbow in another hand.
        This is not considered an independent action, so you can fire a longbow any number of times per round.
