    ...
    \subsection{Weapon Groups}\label{Weapon Groups}
        ...
        \begin{dtable!*}
            ...
            \begin{dtabularx}{\textwidth}{l >{\lcol}X >{\lcol}X}
                ...
                Blades            & Dagger, greatsword, longsword, rapier, short sword, sickle                   & Katana, kukri, two-bladed sword \\
    ...
    \subsection{Weapon Qualities}
        ...
        \begin{longtabuwrapper}
            \begin{longtabu}{p{12em} c c c >{\ccol}p{10em} c c >{\ccol}X}
                ...
                \tind Truncheon                        & Medium           & \minus0       & \plus0d           & Bludgeoning              & \tdash    & 3 lb.       & \tdash                       \\
