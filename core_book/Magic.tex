...
\section{Casting Spells}\label{Casting Spells}
    ...
    \subsection{Miscasting}\label{Miscasting}
        ...
        When a mystic backlash occurs, make an attack against the Mental defense of yourself and all creatures within a 5 foot radius from you.
...
\section{Spell Descriptions}
    ...
    \subsection{Duration}
        ...
        Some abilities have the \glossterm{Attune} (multiple) tag.
        You can use an ability with this tag any number of times, attuning to it separately each time.

        \subparhead{Shared Attunement} Some abilities have the \glossterm{Attune} (shared) tag.
...
\section{Cantrips}\label{Cantrips}
    ...
    You cannot apply \glossterm{augments} to spells that are cast as a cantrip.
