...
\section{Spell Tags}\label{Spell Tags}
    ...
    {
        \onecolumn
        \taburowcolors [2] 2{tbrown .. white} % chktex-file 26 chktex-file 12
        \begin{longtabu}{l X}
            \lcaption{Spell Tags} \\
            \tb{Tag} & \tb{Effect} \\
            Acid & \tdash \\
            ...
            Death & The spell only affects living creatures. A creature killed by a death effect cannot be returned to life by \spell{resurrection}. \\
            ...
            Mind & The spell has no effect on creatures with an Intelligence of \minus8 or lower, or on creatures without minds (such as oozes or constructs). \\
            Morale & \tdash \\
            Negative & \tdash \\
            ...
            Unreal\label{Unreal Spells} & When you cast this spell, you make a check with a bonus equal to 10 \add your spellpower. Creatures can recognize the spell effect as unreal by interacting with it physically, or by making a Awareness check against a DR equal to your check result when casting the spell. A creature gets a \plus10 bonus on this Awareness check when using senses which should be present in the effect, but which are missing.
