...
\begin{itemize}
    \itemhead{Choose spell}: You must choose which spell to cast from among the spells you know. If a spell has multiple versions, you choose which version to use when you cast it. Similarly, if a spell has augments, you must choose which augments to use when you cast it.  \itemhead{Pay spell slot}: If you use spell slots to cast spells, you must expend a spell slot of the spell's level or higher. If you do not have spells slots to spend, your attempt to cast the spell fails. If you are augmenting a spell, you must expend a spell slot of a level no less than the spell's level \add the level of all augments used.
...
If the total damage you took in the current round exceeds your Fortitude or Mental defense, you take a \minus5 penalty to this check.
If the damage exceeds both defenses, you take a \minus10 penalty instead.
