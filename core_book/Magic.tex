...
\section{Spell Descriptions}
    ...
    \subsection{Duration}
        ...
        \parhead{Attunement} The spell lasts as long as you stay attuned to it.
        Attuning to a spell works in the same way as attuning to a magic item, and reduces your maximum action points by 1 (see \pcref{Attunement}).
        If you cast that spell again, all previous castings of the spell are dismissed at the end of the round.
        If you dismiss the spell, you are no longer attuned to it, and your maximum (but not current) action points increase appropriately.
