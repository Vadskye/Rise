...
\section{Casting Spells}\label{Casting Spells}
    ...
    \subsection{Casting Process}
        ...
        \begin{itemize}
            \itemhead{Choose spell}: You must choose which spell to cast from among the spells you know. If a spell has \glossterm{subspells}, you must choose which subspell to use when you cast it.
    ...
    \subsection{Augments}\label{Augments}
        There are a number of \glossterm{augments} that can be applied to spells to increase their power.
        Each augment has a name, a level, and an effect.
        Whenever you cast a spell, you can choose to apply any number of augments you know to the spell.
        For each augment you apply, you increase the spell's level by an amount equal to the augment's level.
        In exchange, the spell gains the effects of that augment.
        If an augment would increase the spell's level beyond the maximum spell level you can cast, you cannot apply the augment to that spell.

        \parhead{Augments and Subspells}
        If a spell changes its properties with a subspell, it may become eligible for different augments.
        ...
        \subsubsection{Augment Descriptions}\label{Augment Descriptions}
            ...
            \augment{1}{Giant} The spell can affect a target one size category larger.
            This augment can be applied multiple times.
            Its effects stack.
            \par This augment can be applied to any spell that has a maximum size category of its targets.
            % TODO: 
...
\section{Rituals}\label{Rituals}
    ...
    \subsection{Ritual Costs}\label{Ritual Costs}
        ...
        \begin{dtable}
            ...
            \end{dtabularx}
            % TODO: how do ritual augments work
