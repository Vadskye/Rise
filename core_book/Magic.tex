...
\section{Spell Descriptions}
    ...
    \subsection{Duration}
        ...
        \parhead{Attunement}\label{Attunement} The ability lasts as long as you stay attuned to it.
        ...
        \subparhead{Multiple Attunement} Some abilities have durations of ``Attunement (multiple)''.
        ...
        % clarify that cantrips and subspells are considered the same ability
        ...
        % If an ability creates an emanation, then the spell stays with that area for its duration. Creatures become subject to the spell when they enter the emanation and are no longer subject to it when they leave.
