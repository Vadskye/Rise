...
\section{Determining Spell Effects}
    ...
    \subsection{Spellpower}
        ...
        \parhead{Magic Resistance} Some creatures have magic resistance, which is a special ability which allows them to resist \glossterm{magical} effects such as spells. You can overcome magic resistance by making an attack with an accuracy equal to your spellpower. See \pcref{Magic Resistance}, for details.
