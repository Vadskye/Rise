...
\section{Spell Tags}\label{Spell Tags}
...

    {
        ...
        \begin{longtabu}{l X}
            ...
            Unreal\label{Unreal Spells} & The spell can be recognized as unreal with a Perception check against a DR equal to 10 \add your spellpower. Creatures get a \plus10 bonus on this Perception check when using senses which should be present in the figment, but which are missing. Alternately, if the figment has a visual manifestation, physical contact can reveal it as unreal.
