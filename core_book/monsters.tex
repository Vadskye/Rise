...
\section{Monster Statistics}
    ...
    \subsection{Monster Roles}
        ...
        \subsubsection{Brute}
            ...
            \parhead{Hit Points} Very high, as barbarian
            \parhead{Damage Resistance} One quarter of total hit points
        ...
        \subsubsection{Skirmisher}
            ...
            \parhead{Hit Points} Medium, as rogue
            \parhead{Damage Resistance} Half of total hit points
        ...
        \subsubsection{Warrior}
            ...
            \parhead{Hit Points} High, as fighter
            \parhead{Damage Resistance} Equal to total hit points
        ...
        \subsubsection{Mystic}
            ...
            \parhead{Hit Points} Low, as wizard
            \parhead{Damage Resistance} Equal to total hit points
    ...
    \subsection{Level Scaling}
        ...
        \begin{itemize}
            ...
            \item Monsters gain a \plus1 bonus to all defenses at 5th level and 17th level.
            \item Monsters gain a \plus1 bonus to \glossterm{accuracy} at 11th level.
        \end{itemize}
    ...
    \begin{dtable*}
        ...
        \begin{dtabularx}{\textwidth}{l l l l l l l >{\lcol}X}
            ...
            5th        & 2             & 10      & 8       & 40      & 32      & \plus2             & \plus1 to all defenses                   \\
            6th        & 2             & 12      & 10      & 48      & 40      & \plus3             & \tdash          \\
            ...
            11th       & 4             & 22      & 20      & 88      & 80      & \plus5             & \plus1 accuracy                   \\
            12th       & 4             & 25      & 24      & 100     & 96      & \plus6             & \tdash   \\
            ...
            17th       & 6             & 45      & 44      & 180     & 180     & \plus8             & \plus1 to all defenses                   \\
            18th       & 6             & 50      & 50      & 200     & 200     & \plus9             & \tdash   \\
    ...
    \subsection{Elite Monsters}\label{Elite Monsters}
        ...
        \begin{itemize}
            % adds about 30-40% more damage from accuracy, and about 20% more damage from power.
            \item Elite monsters gain a \plus2 bonus to their \glossterm{accuracy}, \glossterm{power}, and all \glossterm{defenses}.
            \item Elite monsters have four times the \glossterm{hit points} of standard monsters.
            \item Elite monsters have 50\% more \glossterm{damage resistance} than standard monsters. This is applied after the bonus they get from having higher hit points, since monster damage resistance is based on their hit points.
    ...
    \subsection{Monster Natural Weapons}\label{Monster Natural Weapon}
        ...
        This gives them a \plus1 damage bonus, plus \plus1 per 3 \glossterm{power}.
