...
The various creatures that exist in the world of Rise outside of normal humanoid civilization are collectively called monsters.
...
\section{Monster Statistics}
  ...
  \subsection{Monster Roles}
    ...
    There are five roles: brute, skirmisher, warrior, sniper, and leader.
    ...
    \subsubsection{Leader}
      ...
      \parhead{Defenses} \plus1 to non-Armor defenses.
    ...
    \subsubsection{Skirmisher}
      ...
      \parhead{Defenses} \plus2 Armor and Reflex, \plus1 to other defenses
      \parhead{Durability} \minus4
      \parhead{Injury Point} Half of total hit points.
    ...
    \subsubsection{Warrior}
      ...
      \parhead{Defenses} \plus1 Armor, \plus1 Fortitude.
      \parhead{Durability} \plus2.
  ...
  \subsection{Level Scaling}
    ...
    In general, their automatic level scaling is designed to keep them on par with the power that player characters gain at higher levels, but without the full complexity of high-level PCs.
    ...
    \begin{raggeditemize}
      \item Monsters calculate their \glossterm{injury point} based on their role rather than their rank and level.
      ...
      \item Monsters can have a sum of all attributes other than Intelligence equal to 9 \add their level.
        Since Intelligence doesn't affect a monster's combat statistics, it does not contribute to this limit.
      \item Monsters can have a maximum of 5 \add \glossterm{rank} in any individual attribute.
      \item Monsters gain a \plus3 bonus to all defenses and a \plus2 bonus to durability at level 1.
      ...
      \item Monsters gain a \plus1 accuracy bonus at 9th level and 21st level.
      ...
      \item Monsters gain a \plus1 bonus to their \glossterm{weapon dice increment} at 7th level, 13th level, and 19th level.
    \end{raggeditemize}
    ...
    \begin{dtable}
      ...
      \begin{compresseddtabularx}{\columnwidth}{l l l l >{\lcol}X}
        ...
        1st        & 1         & \plus2          & \tdash           & \plus3 defenses                \\
        2nd        & 1         & \plus3          & \plus1           & \tdash                         \\
        3rd        & 1         & \plus4          & \plus1           & \tdash                         \\
        4th        & 2         & \plus4          & \plus2           & \tdash                         \\
        5th        & 2         & \plus5          & \plus2           & \plus1 power                   \\
        6th        & 2         & \plus6          & \plus3           & \tdash                         \\
        7th        & 3         & \plus6          & \plus3           & \plus1 weapon dice increment \\
        8th        & 3         & \plus7          & \plus4           & \tdash                         \\
        9th        & 3         & \plus8          & \plus4           & \plus1 accuracy                \\
        10th       & 4         & \plus8          & \plus5           & \tdash                         \\
        11th       & 4         & \plus9          & \plus5           & \plus1 power                   \\
        12th       & 4         & \plus10         & \plus6           & \tdash                         \\
        13th       & 5         & \plus10         & \plus6           & \plus1 weapon dice increment \\
        14th       & 5         & \plus11         & \plus7           & \tdash                         \\
        15th       & 5         & \plus12         & \plus7           & \tdash                         \\
        16th       & 6         & \plus12         & \plus8           & \tdash                         \\
        17th       & 6         & \plus13         & \plus8           & \plus1 power                   \\
        18th       & 6         & \plus14         & \plus9           & \tdash                         \\
        19th       & 7         & \plus14         & \plus9           & \plus1 weapon dice increment \\
        20th       & 7         & \plus15         & \plus10          & \tdash                         \\
        21st       & 7         & \plus16         & \plus10          & \plus1 accuracy                \\
  ...
  \subsection{Elite Monsters}\label{Elite Monsters}
    ...
    \begin{raggeditemize}
      \item Elite monsters gain a \plus2 bonus to their \glossterm{power} and a \plus1 bonus to all \glossterm{defenses}.
      \item Elite monsters have three times the \glossterm{hit points} of standard monsters.
      \item Elite monsters can have a 6 higher total attribute sum.
      \item Elite monsters can have a 1 higher limit to each individual attribute.
        % elite actions should be about as strong as regular actions, so 2x more damage
      \item Elite monsters can take an additional \glossterm{elite action} each turn (see \pcref{Elite Actions}).
  ...
  \subsection{Monster Conditions}\label{Monster Conditions}
    ...
    % Conditions should never be worse than brief effects, so this has to be an end of turn trigger.
    \begin{triggeredability}{Elite Cleanse}{Triggered}
      \rankline
      At the end of its turn, the monster rolls 1d10.
      On a 7 or higher, it can remove one \glossterm{condition}.
      On a 10, it can also remove a different condition.
    \end{triggeredability}

  \subsection{Monster Resources}
    Monsters have no resources, and their maximum stamina is 0.
    They are normally unable to use abilities that would cost or otherwise reduce their stamina, such as the \ability{desperate exertion} ability.

    If a monster has an explicitly listed special ability that reduces its stamina, it can use that ability.
    Similarly, monsters that are allied with player characters may choose to reduce their stamina to receive healing from the players, such as from the \spell{restoration} spell.
    This would immediately cause them to suffer stamina penalties, since their maximum stamina is 0.
...
\section{Monster Combat Mechanics}
  ...
  \subsection{Monster Actions}\label{Monster Actions}
    ...
    \subsubsection{Elite Actions}\label{Elite Actions}
      Elite monsters can take an additional \glossterm{elite action} each turn.
      Every elite monster has at least one special ability that requires an elite action to use.
      ...
      In general, elite monsters should be designed to attack multiple different PCs in every turn.
