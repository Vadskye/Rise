...
\section{Monster Mechanics}
    ...
    \subsection{Challenge Rating}\label{Challenge Rating}
        ...
        Monsters that can survive \glossterm{vital wounds} do not normally make \glossterm{wound rolls}.
        ...
        In addition, its \glossterm{wound resistance} is one quarter of its normal value after taking into account all other modifiers.
