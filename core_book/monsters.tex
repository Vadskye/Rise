    ...
    \subsection{Challenge Rating}\label{Challenge Rating}
        ...
        \begin{dtable}
            ...
            \begin{dtabularx}{\textwidth}{l X X X}
                \tb{CR} & \tb{Hit Points} & \tb{Vital Wound Max} & \tb{Bonuses}\fn{1} \tableheaderrule
                1/2     & \tdash\fn{2}    & 1                    & \plus0 \\
                1       & \mult1/2        & 1                    & \plus0 \\
                2       & \mult1          & 2                    & \plus1 \\
                3       & \mult2          & 3                    & \plus2 \\
                4       & \mult4          & 4                    & \plus3 \\
        ...
        \subsubsection{Condition Removal}
            ...
            CR 3 monsters gain a \plus1 bonus to this roll, and CR 4 monsters gain a \plus2 bonus to this roll.
        ...
        \subsubsection{Action Points and Attunement}
            Monsters do not normally have \glossterm{action points}.
            However, CR 2 or higher monsters can \glossterm{attune} to a number of abilities equal to their CR minus 1 without spending action points.
            If the monster breaks its attunement to an ability, it can reattune after taking a \glossterm{short rest}.
