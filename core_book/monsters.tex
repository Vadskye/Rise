...
\section{Monster Statistics}
    ...
    \subsection{Level Scaling}
        ...
        \begin{itemize}
            ...
            \item High-CR monsters become more resistant to conditions at 12th level and 21st level (see \pcref{Conditions on Monsters})
        \end{itemize}
    ...
    \begin{dtable}
        ...
        \begin{dtabularx}{\columnwidth}{l l >{\lcol}X >{\lcol}X >{\lcol}X}
            ...
            19th             & 7             & \plus10       & 16            & 4d8\plus16 \\
            20th             & 7             & \plus11       & 17            & 4d8\plus16 \\
            21st             & 7             & \plus11       & 18            & 4d8\plus16 \\
        \end{dtabularx}
