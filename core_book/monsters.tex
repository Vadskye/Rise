...
\section{Monster Statistics}
    ...
    \subsection{Challenge Rating}\label{Challenge Rating}
        ...
        \begin{dtable*}
            ...
            \begin{dtabularx}{\textwidth}{l l l l X X l l}
                \tb{CR} & \tb{HP}  & \tb{DR} & \tb{Defenses} & \tb{Power Scaling}\fn{1} & \tb{Max Attribute} & \tb{Max Rank} & \tb{Damage}\fn{2} \tableheaderrule
                1/2     & \mult1/2 & \mult0  & \plus0        & \mult1/2         & 3                  & \minus1 & \minus1d \\
                1       & \mult1   & \mult1  & \plus0        & \mult1           & 4                  & \tdash & \tdash   \\
                2       & \mult2   & \mult2  & \plus0        & \mult2           & 5                  & \tdash & \plus1d  \\
                4       & \mult4   & \mult6  & \plus1        & \mult2           & 6                  & \plus1 & \plus1d  \\
                6       & \mult6   & \mult10 & \plus2        & \mult2           & 7                  & \plus1 & \plus2d  \\
            \end{dtabularx}
    ...
    \subsection{Level Scaling}
        ...
        \begin{itemize}
            ...
            \item Monsters gain a \plus1 bonus to power with all abilities that gradually increases at 3rd level and every 3 levels thereafter, as described in \tref{Monster Advancement}
...
\section{Monster Combat Mechanics}
    ...
    \subsection{Monster Actions}
        ...
        CR 2 or higher monsters can take \glossterm{minor actions}, though many monsters do not have any relevant minor actions to take.
