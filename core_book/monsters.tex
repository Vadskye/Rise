    ...
    \subsection{Challenge Rating}\label{Challenge Rating}
        ...
        \begin{dtable}
            ...
            \begin{dtabularx}{\textwidth}{l X l l l l l}
                \tb{CR} & \tb{Max Attribute} & \tb{HP}  & \tb{DR} & \tb{Power Scaling}\fn{1} & \tb{Damage}\fn{2} \tableheaderrule
                1/2     & 3                  & \mult1/2 & \mult0  & \mult1/2 & \minus1d \\
                1       & 4                  & \mult1   & \mult1  & \mult1 & \tdash   \\
                2       & 5                  & \mult2   & \mult2  & \mult2 & \plus1d  \\
                4       & 6                  & \mult4   & \mult6  & \mult3 & \plus1d  \\
                6       & 7                  & \mult6   & \mult10 & \mult4 & \plus2d  \\
            \end{dtabularx}
