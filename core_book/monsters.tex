...
\section{Monster Mechanics}
    ...
    \subsection{Challenge Rating}
        ...
        \parhead{Bonuses} For each challenge rating a monster has above 1, it gains a \plus1 bonus to \glossterm{accuracy} and \glossterm{defenses} and a \plus1d bonus to all damage it deals.
