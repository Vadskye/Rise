...
\section{Monster Statistics}
  ...
  \subsection{Monster Roles}
    ...
    \subsubsection{Brute}
      ...
      Brutes have a relatively high \glossterm{injury point}, but they can still absorb a remarkable amount of punishment.
    ...
    \subsubsection{Skirmisher}
      ...
      \parhead{Defenses} \plus4 Armor, \plus4 Brawn, \plus3 Fortitude, \plus5 Reflex, \plus4 Mental
    ...
    \subsubsection{Sniper}
      ...
      \parhead{Defenses} \plus3 Armor, \plus3 Brawn, \plus3 Fortitude, \plus5 Reflex, \plus5 Mental
      \parhead{Durability} \plus2.
      \parhead{Injury Point} Three-quarters of total hit points.
    ...
    \subsubsection{Warrior}
      ...
      \parhead{Defenses} \plus5 Armor, \plus3 Brawn, \plus4 Fortitude, \plus3 Reflex, \plus3 Mental
      \parhead{Durability} \plus4.
      \parhead{Injury Point} One quarter of total hit points.
  ...
  \subsection{Level Scaling}
    ...
    \begin{dtable}
      ...
      \begin{dtabularx}{\columnwidth}{l l l >{\lcol}X l}
        ...
        5th        & 2         & \plus3          & \plus2           & \plus1 to all defenses   \\
        6th        & 2         & \plus4          & \plus3           & \tdash                   \\
        7th        & 3         & \plus4          & \plus3           & \plus1 accuracy          \\
        8th        & 3         & \plus5          & \plus4           & \tdash                   \\
        9th        & 3         & \plus6          & \plus4           & \plus1 to two attributes \\
        10th       & 4         & \plus6          & \plus5           & \tdash                   \\
        11th       & 4         & \plus7          & \plus5           & \plus1 to all defenses   \\
        ...
        17th       & 6         & \plus11         & \plus8           & \plus1 to all defenses   \\
        18th       & 6         & \plus12         & \plus9           & \tdash                   \\
        19th       & 7         & \plus12         & \plus9           & \plus1 accuracy          \\
