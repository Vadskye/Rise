...
\section{Monster Combat Mechanics}
    ...
    \subsection{Monster Actions}
        ...
        Monsters may want to inflict debuffs on multiple attackers to reduce the damage they take, which may require dealing enough damage to gain the benefit of HP-based debuffs.
