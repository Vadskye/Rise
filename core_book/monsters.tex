...
\section{Monster Mechanics}
    ...
    \subsection{Challenge Rating}\label{Challenge Rating}
        ...
        \subsubsection{Half CR Monsters}\label{Half CR Monsters}
            Monsters with a CR of 1/2 have no \glossterm{hit points} or \glossterm{bleed resistance}.
            Their \glossterm{vital resistance} is one quarter of the normal value after taking into account all other modifiers, so they are generally dispatched in a single blow.
            In addition, sum all damage they take from different sources in the same phase before comparing the result to their \glossterm{vital resistance}.
            This is rarely necessary, but monsters with a CR of 1/2 are not intended to be difficult to kill, and certain characters with a flurry of very low-damage attacks may have difficulty killing them without this rule.
