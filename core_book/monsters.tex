...
\end{spellsubcontent}
\end{monsection}
\begin{monsection}{Salamander}{3}[1]
\vspace{-1em}\spelltwocol{}{Medium outsider}\vspace{-1em}
\begin{spellcontent}
\begin{spelltargetinginfo}
\spelltwocol{
...
\textbf{Ref} 10;
\textbf{Ment} 8
\pari \textbf{Strike} Spear \plus3 (2d8) or tail slam \plus3 (2d8)
\end{spelltargetinginfo}
\begin{spelleffects}
\pari
\textbf{Tail Grab}:
...
\end{spellsubcontent}
\end{monsection}
\begin{monsection}{Salamander Battlemaster}{4}[3]
\vspace{-1em}\spelltwocol{}{Medium outsider}\vspace{-1em}
\begin{spellcontent}
\begin{spelltargetinginfo}
\spelltwocol{
...
\textbf{Ref} 11;
\textbf{Ment} 10
\pari \textbf{Strike} Spear \plus5 (2d8) or tail slam \plus5 (2d8)
\pari \textbf{Actions} Two in action phase, one in delayed action phase
\end{spelltargetinginfo}
\begin{spelleffects}
\pari
