...
\pari
\textbf{Enslave}:
The aboleth spends an action point and makes a \plus14 vs. Mental attack against a creature in Medium range.
...
\pari
\textbf{Mind Crush}:
The aboleth makes a \plus14 vs. Mental attack against a creature in Long range.
\hit The target takes 6d10 psionic damage.
...
\pari
\textbf{Psionic Blast}:
The aboleth makes a \plus14 vs. Mental attack against enemies in a Large cone.
...
\pari
\textbf{Drag Prey}:
The ankheg makes a shove attack with an accuracy of \plus14.
...
\pari
\textbf{Spit Acid}:
The ankheg makes a \plus7 vs. Reflex attack against everything in a 5 ft. wide Medium line.
\hit Each target takes 2d6 acid damage, and creatures are \glossterm{sickened} as a \glossterm{condition}.
...
\pari
\textbf{Petrifying Gaze}:
The basilisk makes a \plus5 vs. Fortitude attack against one creature in Medium range.
...
\pari
\textbf{Electrobolt}:
The arrowhawk makes a \plus5 vs. Reflex attack against one creature or object in Medium range.
...
\pari
\textbf{Fire Breath}:
The hell hound makes a \plus5 vs. Reflex attack against everything in a Medium cone.
...
\vspace{0.5em}
\pari
\textbf{Mournful Dirge}:
The dirgewalker makes a \plus6 vs. Mental attack against all creatures in a Medium radius.
