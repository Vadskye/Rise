...
\section{Monster Mechanics}
    ...
    \subsection{Challenge Rating}\label{Challenge Rating}
        ...
        \subsubsection{Condition Removal}
            ...
            At the end of each round, monsters with CR 3 and CR 4 roll 1d10.
            CR 4 monsters gain a \plus1 bonus to this roll.
        ...
        \subsubsection{Action Points and Attunement}
            ...
            However, CR 2 or higher monsters can \glossterm{attune} to a number of abilities equal to their CR without spending action points.
