...
\section{Monster Mechanics}
    ...
    \subsection{Challenge Rating}\label{Challenge Rating}
        ...
        \parhead{Accuracy and Defense Bonuses} For each challenge rating a monster has above 1, it gains a \plus1 bonus to \glossterm{accuracy} and \glossterm{defenses}.
