...
\pari
\textbf{Enslave}:
Spend an action point and make a \plus14 vs. Mental attack against a creature in Medium range.
...
\pari
\textbf{Mind Crush}:
Make a \plus14 vs. Mental attack against a creature in Long range.
\hit 6d10 psionic damage.
...
\pari
\textbf{Psionic Blast}:
Make a \plus14 vs. Mental attack against enemies in a Large cone.
\hit 4d10 psionic damage.
...
\spelltwocol{\textbf{Spit Acid}: \plus7 vs Reflex}{Everything in 5 ft. wide Medium line}
\par
