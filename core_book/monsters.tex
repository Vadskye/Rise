...
\section{Monster Statistics}
    ...
    \subsection{Challenge Rating}\label{Challenge Rating}
        ...
        \begin{dtable}
            ...
            \begin{dtabularx}{\textwidth}{l l l X l l}
                \tb{CR} & \tb{HP}  & \tb{Resists} Wound Max} & \tb{AP} & \tb{Accuracy} & \tb{Defenses} \tableheaderrule
                1/2     & \mult1/2 & \mult0           & 0       & \plus0        & \plus0 \\
                1       & \mult1   & \mult0           & 1       & \plus0        & \plus0 \\
                2       & \mult1   & \mult1           & 1       & \plus1        & \plus1 \\
                3       & \mult2   & \mult2           & 2       & \plus2        & \plus2 \\
                4       & \mult4   & \mult2\fn{1}     & 3       & \plus3        & \plus3 \\
            \end{dtabularx}
