    ...
    \subsection{Challenge Rating}\label{Challenge Rating}
        ...
        \begin{dtable}
            ...
            \begin{dtabularx}{\textwidth}{l l l l X X l}
                \tb{CR} & \tb{HP}  & \tb{DR} & \tb{Defenses} & \tb{Power}\fn{1} & \tb{Max Attribute} & \tb{Damage}\fn{2} \tableheaderrule
                1/2     & \mult1/2 & \mult0  & \plus0        & \mult1/2         & 3                  & \minus1d \\
                1       & \mult1   & \mult1  & \plus0        & \mult1           & 4                  & \tdash   \\
                2       & \mult2   & \mult2  & \plus0        & \mult2           & 5                  & \plus1d  \\
                4       & \mult4   & \mult6  & \plus1        & \mult2           & 6                  & \plus1d  \\
                6       & \mult6   & \mult10 & \plus2        & \mult2           & 7                  & \plus2d  \\
            \end{dtabularx}
