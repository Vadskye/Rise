...
\section{Monster Mechanics}
    ...
    \subsection{Challenge Rating}\label{Challenge Rating}
        ...
        \parhead{Vital Wounds} Monsters do not normally make \glossterm{vital rolls} like player characters do.
        ...
        Monsters that can survive \glossterm{vital wounds} do not normally make \glossterm{vital rolls}.
        ...
        \parhead{CR 1 Monsters} A monster with a challenge rating of 1 has half the normal value for its maximum \glossterm{hit points}.

        \parhead{1/2 CR Monsters} A monster with a challenge rating of 1/2 has no \glossterm{hit points} or \glossterm{damage resistance}.
        In addition, its \glossterm{vital resistance} is one quarter of its normal value after taking into account all other modifiers.

        \parhead{Action Points} For each challenge rating a monster has above 1, it gains an \glossterm{action point}.

        \parhead{Accuracy and Defense Bonuses} For each challenge rating a monster has above 1, it gains a \plus1 bonus to \glossterm{accuracy}, \glossterm{defenses}, and \glossterm{power}.
