...
\end{spelltargetinginfo}
\begin{spelleffects}
\pari \spelltwocol{\textbf{Rend} }{Two targets within reach}
\par The bear makes a claw strike against both targets.
\end{spelleffects}
\end{spellcontent}
\begin{spellsubcontent}
\begin{spellfooter}
...
\end{spelltargetinginfo}
\begin{spelleffects}
\pari \spelltwocol{\textbf{Hex} \plus3 vs Mental}{One target within \rngmed range}
...
\end{spelltargetinginfo}
\begin{spelleffects}
\pari \spelltwocol{\textbf{Acid Spit} \plus6 vs Reflex}{One target within \rngclose range}
...
\end{spelltargetinginfo}
\begin{spelleffects}
\pari \spelltwocol{\textbf{Shapeshift} }{}
\par
...
\end{spelltargetinginfo}
\begin{spelleffects}
\pari \spelltwocol{\textbf{Lightning Javelin} \plus16 vs Reflex}{All in a \arealarge line}
\par \textit{Hit}: 5d10 electricity damage.
\pari \spelltwocol{\textbf{Thunderstrike} }{}
\par
