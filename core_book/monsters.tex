...
\section{Monster Statistics}
  ...
  \subsection{Level Scaling}
    ...
    \begin{raggeditemize}
      ...
      \item Monsters gain a \plus1 bonus to two attributes at 3rd level and every 3 levels thereafter.
        This replaces the attribute bonus player characters receive.
  ...
  \subsection{Monster Resources}
    ...
    They are normally unable to use universal abilities that would cause them to reduce their stamina, such as the \ability{desperate exertion} ability.
