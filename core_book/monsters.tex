...
\section{Monster Statistics}
  ...
  \subsection{Monster Roles}
    ...
    \subsubsection{Brute}
      ...
      \parhead{Hit Points} Very high, as barbarian hit points
      \parhead{Damage Resistance} Low, as wizard hit points without Constitution
    ...
    \subsubsection{Leader}
      ...
      \parhead{Hit Points} High, as fighter hit points
      \parhead{Damage Resistance} Medium, as cleric hit points without Constitution
    ...
    \subsubsection{Mystic}
      ...
      \parhead{Hit Points} Medium, as cleric hit points
      \parhead{Damage Resistance} High, as fighter hit points without Constitution
    ...
    \subsubsection{Warrior}
      ...
      \parhead{Hit Points} High, as fighter hit points
      \parhead{Damage Resistance} Very high, as barbarian hit points without Constitution
  ...
  \subsection{Elite Monsters}\label{Elite Monsters}
    ...
    \begin{itemize}
      ...
      \item Elite monsters have five times the \glossterm{damage resistance} of standard monsters.
