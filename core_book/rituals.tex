Warning: Spell(Animate Dead) is missing required property 'cantrip'
...
\spelltwocol{\spelltgt{One or more corpses}}{\spellrng{\rngclose}}
\spelltime{One hour}
...
\spelltags{\glossterm{Evil}, \glossterm{Negative}, \glossterm{Soul}}
\end{spelleffects}
\end{spellcontent}
\begin{spellfooter}
...
\begin{spellcontent}
\begin{spelltargetinginfo}
\spelltwocol{\spelltgt{One animal}}{\spellrng{\rngclose}}
\spelltime{24 hours}
...
\end{spellsubcontent}
\end{spellsection}
\begin{spellsection}{Binding}[self.base_level]
\begin{spellcontent}
\begin{spelltargetinginfo}
\spelltwocol{\spellzone{small radius}}{\spellrng{\rngclose}}
\spelltime{One hour}
\end{spelltargetinginfo}
\begin{spelleffects}
\spelleffect
...
\begin{spellcontent}
\begin{spelltargetinginfo}
\spelltwocol{\spelltgt{One pint of unattended, nonmagical water}}{\spellrng{\rngclose}}
...
\begin{spellcontent}
\begin{spelltargetinginfo}
\spelltwocol{\spelltgts{Up to five willing ritual participants (Medium or smaller)}}{\spellrng{\rngmed}}
\spelltime{One minute}
\end{spelltargetinginfo}
\begin{spelleffects}
\spelleffect
...
\spelltags{\glossterm{Translocation}}
\end{spelleffects}
\end{spellcontent}
\begin{spellfooter}
\spellinfo{Conjuration}{Dviine}
\parhead*{Augments} Extended, Quickened, Silent, Stilled
\end{spellfooter}
\begin{spellsubcontent}
\end{spellsubcontent}
\end{spellsection}
\begin{spellsection}{Create Object}[self.base_level]
\begin{spellcontent}
\begin{spelltargetinginfo}
\spellrng{\rngclose}
\spelltime{One hour}
...
\end{spellsubcontent}
\end{spellsection}
\begin{spellsection}{Curse Water}[self.base_level]
\begin{spellcontent}
\begin{spelltargetinginfo}
\spelltwocol{\spelltgt{One pint of unattended, nonmagical water}}{\spellrng{\rngclose}}
\spelltime{One minute}
...
\begin{spellcontent}
\begin{spelltargetinginfo}
\spelltwocol{\spelltgt{One creature or object}}{\spellrng{Same plane (Unrestricted)}}
\spelltime{24 hours}
...
\spelltwocol{\spelltgt{One creature or object}}{\spellrng{Any plane (Unrestricted)}}
\spelltime{24 hours}
\parhead*{Action Points} 49
...
\end{spellsubcontent}
\end{spellsection}
\begin{spellsection}{Explosive Runes}[self.base_level]
\begin{spellcontent}
\begin{spelltargetinginfo}
\spelltwocol{\spelltgt{One object with writing on it (Small or smaller)}}{\spellrng{\rngclose}}
\spelltime{One hour}
\end{spelltargetinginfo}
\begin{spelleffects}
\spelleffect
...
\spellsuccess \spelldamage{arcane}[1d4].
...
\parhead*{Augments} Extended, Intensified, Quickened, Silent, Stilled
\end{spellfooter}
\begin{spellsubcontent}
\end{spellsubcontent}
\end{spellsection}
...
\end{spellsubcontent}
\end{spellsection}
\begin{spellsection}{Gate}[self.base_level]
\begin{spellcontent}
\begin{spelltargetinginfo}
\spellrng{\rngclose}
\spelltime{One week}
...
\spelltags{\glossterm{Planar}, \glossterm{Translocation}}
\end{spelleffects}
\end{spellcontent}
\begin{spellfooter}
\spellinfo{Conjuration}{Arcane, Divine, Nature}
...
\begin{spellcontent}
\begin{spelltargetinginfo}
\spelltwocol{\spelltgt{One unattended nonmagical object}}{\spellrng{\rngclose}}
\spelltime{One minute}
\end{spelltargetinginfo}
\begin{spelleffects}
\spelleffect
...
\end{spellsubcontent}
\end{spellsection}
\begin{spellsection}{Infertility}[self.base_level]
\begin{spellcontent}
\begin{spelltargetinginfo}
\spellzone{One mile radius from your location}
\end{spelltargetinginfo}
...
\begin{spellfooter}
\spellinfo{Transmutation}{Nature}
\parhead*{Augments} Quickened, Silent, Stilled
\end{spellfooter}
\begin{spellsubcontent}
\end{spellsubcontent}
\end{spellsection}
\begin{spellsection}{Lifeweb Transit}[self.base_level]
\begin{spellcontent}
\begin{spelltargetinginfo}
\spelltwocol{\spelltgts{Up to five willing ritual participants (Medium or smaller)}}{\spellrng{\rngmed}}
\spelltime{One hour}
...
\begin{spellcontent}
\begin{spelltargetinginfo}
\spelltwocol{\spelltgt{One creature or object (Medium or smaller)}}{\spellrng{\rngclose}}
\spelltime{One minute}
\end{spelltargetinginfo}
\begin{spelleffects}
\spelleffect
...
\end{spellsubcontent}
\end{spellsection}
\begin{spellsection}{Magic Mouth}[self.base_level]
\begin{spellcontent}
\begin{spelltargetinginfo}
\spelltwocol{\spelltgt{one creature or object}}{\spellrng{\rngclose}}
\spelltime{24 hours}
...
\end{spellsubcontent}
\end{spellsection}
\begin{spellsection}{Mystic Lock}[self.base_level]
\begin{spellcontent}
\begin{spelltargetinginfo}
\spelltwocol{\spelltgt{One Large or smaller closable, nonmagical object, such as a door or box}}{\spellrng{\rngclose}}
\spelltime{One minute}
\end{spelltargetinginfo}
\begin{spelleffects}
\spelleffect
...
\end{spellsubcontent}
\end{spellsection}
\begin{spellsection}{Plane Shift}[self.base_level]
\begin{spellcontent}
\begin{spelltargetinginfo}
\spelltwocol{\spelltgts{Up to five willing ritual participants (Medium or smaller)}}{\spellrng{\rngclose}}
\spelltime{24 hours}
\end{spelltargetinginfo}
\begin{spelleffects}
\spelleffect
...
\end{spellsubcontent}
\end{spellsection}
\begin{spellsection}{Purify Sustenance}[self.base_level]
\begin{spellcontent}
\begin{spelltargetinginfo}
\spelltwocol{\spellburst{Five cubic feet}}{\spellrng{\rngclose}}
\spelltgts{All food and water in the area}
\spelltime{One hour}
\end{spelltargetinginfo}
\begin{spelleffects}
\spelleffect
...
\end{spellsubcontent}
\end{spellsection}
\begin{spellsection}{Regeneration}[self.base_level]
\begin{spellcontent}
\begin{spelltargetinginfo}
\spelltwocol{\spelltgt{One willing creature}}{\spellrng{\rngclose}}
\spelltime{24 hours}
...
\end{spellsubcontent}
\end{spellsection}
\begin{spellsection}{Reincarnation}[self.base_level]
\begin{spellcontent}
\begin{spelltargetinginfo}
\spellspecial The target must have been part of the original creature's body at the time of death.
\spelltwocol{\spelltgt{One piece of a humanoid corpse (Diminuitive or larger)}}{\spellrng{\rngclose}}
\spelltime{24 hours}
\parhead*{Action Points} 25
\end{spelltargetinginfo}
\begin{spelleffects}
...
\spelltags{\glossterm{Creation}, \glossterm{Life}, \glossterm{Soul}}
\end{spelleffects}
\end{spellcontent}
\begin{spellfooter}
...
\begin{spellcontent}
\begin{spelltargetinginfo}
\spelltwocol{\spelltgt{One intact humanoid corpse}}{\spellrng{\rngclose}}
\spelltime{24 hours}
\parhead*{Action Points} 16
\end{spelltargetinginfo}
\begin{spelleffects}
...
\end{spellsubcontent}
\end{spellsection}
\begin{spellsection}{Sending}[self.base_level]
\begin{spellcontent}
\begin{spelltargetinginfo}
\spellspecial
...
\spelldur Sustain (standard); maximum 5 rounds
\spelltags{\glossterm{Communication}}
\end{spelleffects}
\end{spellcontent}
\begin{spellfooter}
\spellinfo{Divination}{Arcane, Divine, Nature}
...
The image does not have to be perfect, but it must unambiguously identify the target.
If you specify its appearance incorrectly, or if the target has changed its appearance, you may accidentally target a different creature, or the ritual may simply fail.
\spelltwocol{\spelltgt{One creature}}{\spellrng{Any plane (Unrestricted)}}
\spelltime{One hour}
\end{augmenttargetinginfo}
\end{spellcontent}
...
\begin{spellcontent}
\begin{spelltargetinginfo}
\spelltwocol{\spelltgt{One intact corpse}}{\spellrng{\rngclose}}
\spelltime{One hour}
\end{spelltargetinginfo}
\begin{spelleffects}
\spellspecial
...
\end{spellsubcontent}
\end{spellsection}
\begin{spellsection}{Telepathic Bond}[self.base_level]
\begin{spellcontent}
\begin{spelltargetinginfo}
\spelltwocol{\spelltgts{Up to five willing ritual participants}}{\spellrng{\rngmed}}
\spelltime{24 hours}
\end{spelltargetinginfo}
\begin{spelleffects}
\spelleffect
...
\begin{spellcontent}
\begin{spelltargetinginfo}
\spelltwocol{\spelltgts{One willing creature (Medium or smaller)}}{\spellrng{\rngmed}}
\spelltime{One minute}
\end{spelltargetinginfo}
\begin{spelleffects}
\spelleffect
