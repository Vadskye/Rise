\section{Cantrip Descriptions}
    ...
    Cantrips are arcane spells that do not require an \glossterm{action point} to cast.
...
\begin{spellsection}{Draining Touch}
    ...
    \begin{spellcontent}
        \begin{spelltargetinginfo}
            \spelltwocol{\spelltgt{One living creature}}{\spellrng{Adjacent}}
        \end{spelltargetinginfo}
        \begin{spelleffects}
...
\begin{spellsection}{Glimpse the Future}[1]
    ...
    \begin{spellcontent}
        ...
        \end{spelltargetinginfo}
        \begin{spelleffects}
            \spelleffect The target gains an offensive \glossterm{legend point}. It can only spend this legend point on attacks.
            \spelldur 1 round.
        \end{spelleffects}
    \end{spellcontent}
    \begin{spellfooter}
