...
\tb{Item Name} & \tb{Market Price} & \tb{Item Level} & \tb{Description} \\
\hline
...
\begin{comment}
\parhead{Apparatus of the Crab} This item appears to be a large, sealed iron barrel, but it has a secret catch (Search DR 20 to locate) that opens a hatch in one end. Anyone who crawls inside finds ten (unlabeled) levers: The device has the following characteristics: hp 200; hardness 15; Spd 20 ft., swim 20 ft.; AD 20 (\minus1 size, \plus11 natural); Atk \plus12 melee (2d8, 2 pincers).

\begin{dtable}
\begin{dtabularx}{\columnwidth}{l >{\lcol}X}
\tb{Lever (1d10)} & \tb{Lever Function} \\
\hline
...
\tooldescription{Bag of Holding}{(I) 2,500 gp (5th); (II) 5,000 (7th); (III) 7,500 (8th); (IV) 10,000}{10th}{(I) 4th; (II) 6th; (III) 8th; (IV) 10th}{(I, II) Faint transmutation; (III, IV) Moderate transmutation}{\tdash} This appears to be a common cloth sack about 2 feet by 4 feet in size. The bag of holding opens into a nondimensional space: Its inside is larger than its outside dimensions. Regardless of what is put into the bag, it weighs a fixed amount. This weight, and the limits in weight and volume of the bag's contents, depend on the bag's type, as shown on the table below.

\begin{dtable}
\begin{dtabularx}{\columnwidth}{l l >{\lcol}X >{\lcol}X}
\tb{Bag} & \tb{Bag Weight} & \tb{Weight Limit} & \tb{Space Limit}\\
\hline
...
\begin{dtable}
\begin{dtabularx}{\columnwidth}{l >{\lcol}X l >{\lcol}X l >{\lcol}X}
\tb{d\%} & \tb{Gray} & \tb{d\%} & \tb{Rust} & \tb{d\%} & \tb{Tan} \\
\hline
...
While the chime is resonating, no spell requiring a verbal component can be cast within a 30-foot radius of it unless the caster can make a Concentration check (DR 15 \add \my{twice the spell's level}).

\prereq{Craft Wondrous Item, \my{sound burst}}

%Price: Lower level spells are added on, no price modifier except /2 for 3/day
\subsubsection{Crystal Ball} This is a crystal sphere about 6 inches in diameter. A character can use the device to see over virtually any distance or into other planes of existence, as with the spell scrying (Will DR \my{14 \add 1/2 character level} negates). As with the \spell{scrying} spell, it takes an hour to use a crystal ball. Any crystal ball can be used up to three times per day.
...
\tb{Crystal Ball Type} & \tb{Market Price} & \tb{Item Level} & \tb{Caster Level} & \tb{Aura} \\
\hline
...
Crystal ball with \spell{true seeing} & 74,000 gp & \tdash & 14th & Strong divination \\
\end{dtabularx}
...
\tooldescription{Darkskull}{12,000}{10th}{8th}{Moderate evocation [evil]}{\tdash} This skull, carved from ebony, is wholly evil. Wherever the skull goes, the area around it is treated as though a \my{\spell{desecrate}} spell had been cast with the skull as the touched point of origin.
...
\tb{Playing Card} & \tb{Tarot Card} & \tb{Creature} \\
\hline
...
\tooldescription{Dimensional Shackles}{13,500}{11th}{10th}{Moderate abjuration}{\tdash} These shackles have golden runes traced across their cold iron surface. Any creature bound within them is affected as if a \spell{dimensional anchor} spell were cast upon her (no save). They fit any Small to Large creature. The DR to break or slip out of the shackles is 30.
...
\tooldescription{Efficient Quiver}{2,000}{5th}{6th}{Faint transmutation}{\tdash} This appears to be a typical arrow container capable of holding about twenty arrows. It has three distinct portions, each with an \my{extradimensional} space allowing it to store far more than would normally be possible. The first and smallest one can contain up to sixty objects of the same general size and shape as an arrow. The second slightly longer compartment holds up to eighteen objects of the same general size and shape as a javelin. The third and longest portion of the case contains as many as six objects of the same general size and shape as a bow (spears, staffs, or the like). Once the owner has filled it, the quiver can produce any item she wishes, as if from a regular quiver or scabbard. The efficient quiver weighs the same no matter what is placed inside it.
...
\begin{dtable*}
\begin{dtabularx}{\textwidth}{>{\lcol}X l l l >{\lcol}X}
\tb{Token Type} & \tb{Market Price} & \tb{Item Level} & \tb{Caster Level} & \tb{Aura} \\
\hline
...
\begin{itemize}
\item Calm rough waters in a 1-mile radius. This effect dispels a summoned water elemental if it fails a DR 16 Will save.
...
\item Causes aquatic creatures with Intelligence scores of 1 or 2 within 500 feet to become panicked as if they had been targeted by a fear spell (Will DR 16 partial). Those who successfully save are shaken for 3d6 rounds.
\end{itemize}
...
76?90 & Bronze & 2d4, 4th level & One performance feat \\
91?100 & Iron & 1d4\plus1, 5th level & Three performance feats &
...
\tooldescription{Incense of Meditation}{5,000}{7th}{10th}{Moderate SOMETHING}{8 hours (mental)} This small rectangular block of sweet smelling incense is visually indistinguishable from nonmagical incense until lit. When it is burning, the special fragrance and pearly-hued smoke of this special incense are recognizable by anyone making a DR 15 Spellcraft check.
...
\tooldescription{Lens of Detection}{3,750}{6th}{6th}{Faint divination}{\tdash} This circular prism enables its user to detect minute details, granting a \plus5 bonus on Search checks.
...
\prereq{Craft Wondrous Item, creator must have a Performance feat, \my{bestow curse,} sound burst}
...
If the rats are under the control of another creature, add the HD of the controller to the Perform check DR. Once control is assumed, another check is required each round to maintain it if the other creature is actively seeking to reassert its control.
...
\tooldescriptiondc{Rope of Entanglement}{3,500}{6th}{6th}{Faint transmutation}{Standard (command)}{11} A rope of entanglement looks just like any other hempen rope about 30 feet long. Upon command, the rope lashes forward 20 feet or upward 10 feet to entangle a victim. \my{A creature struck by the rope can attempt a Reflex save to avoid becoming entangled.} An entangled creature can break free with a DR 20 Strength check or a DR 20 Escape Artist check.

The rope has AD 22, 12 hit points, and hardness 10, and it has damage reduction 5/slashing as well. The rope repairs damage to itself at a rate of 1 point per 5 minutes, but if a rope of entanglement is severed (all 12 hit points lost to damage), it is destroyed.
...
\tooldescription{Stone of Good Luck (Luckstone)}{24,000}{14th}{8th}{Moderate enchantment}{\tdash} This stone is typically a bit of rough polished agate or some similar mineral. Its possessor gains a \plus2 enhancement bonus on saving throws \my{and checks}.
...
\tb{Special Bead Type} & \tb{Special Bead Ability} & \tb{Market Price} & \tb{Item Level} & \tb{Caster level} & \tb{Aura} \\
\hline
...
\tooldescription{Sustaining Spoon}{3,000}{6th}{6th}{Faint conjuration}{\tdash} This unremarkable eating utensil is typically fashioned from horn. If the spoon is placed in an empty container the vessel fills with a thick, pasty gruel. Although this substance has a flavor similar to that of warm, wet cardboard, it is highly nourishing and contains everything necessary to sustain any herbivorous, omnivorous, or carnivorous creature. The spoon can produce sufficient gruel each day to feed up to four humans.

\prereq{Craft Wondrous Item, create food and water}

\tooldescription{Tome of Clear Thought}{\bpl{1}{33,000}{15th}, \bpl{2}{66,000}{20th}, (\plus3) 99,000}{\tdash}{18th}{Strong universal}{48 hours} This heavy book contains instruction on improving memory and logic, but entwined within the words is a powerful magical effect. If anyone reads this book, which takes a total of 48 hours over a minimum of six days, she gains an inherent bonus of from \plus1 to \my{\plus3} (depending on the type of tome) to her Intelligence score. Once the book is read, the magic disappears from the pages and it becomes a normal book. \my{Because this is an inherent bonus, the reader will gain extra skill points if she increases her attribute.}

\prereq{Craft Wondrous Item, wish}

\tooldescription{Tome of Leadership and Influence}{\bpl{1}{33,000}{15th}, \bpl{2}{66,000}{20th}, (\plus3) 99,000}{\tdash}{18th}{Strong universal}{48 hours} This ponderous book details suggestions for persuading and inspiring others, but entwined within the words is a powerful magical effect. If anyone reads this book, which takes a total of 48 hours over a minimum of six days, he gains an inherent bonus of from \plus1 to \my{\plus3} (depending on the type of tome) to his Charisma score. Once the book is read, the magic disappears from the pages and it becomes a normal book. \my{Because this is an inherent bonus, the reader will gain extra skill points if she increases her attribute.}

\prereq{Craft Wondrous Item, wish}

\tooldescription{Tome of Understanding}{\bpl{1}{33,000}{15th}, \bpl{2}{66,000}{20th}, (\plus3) 99,000}{\tdash}{18th}{Strong universal}{48 hours} This thick book contains tips for improving instinct and perception, but entwined within the words is a powerful magical effect. If anyone reads this book, which takes a total of 48 hours over a minimum of six days, she gains an inherent bonus of from \plus1 to \my{\plus3} (depending on the type of tome) to her Wisdom score. Once the book is read, the magic disappears from the pages and it becomes a normal book. \my{Because this is an inherent bonus, the reader will gain extra skill points if she increases her attribute.}
