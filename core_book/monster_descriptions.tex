...
\textbf{Ref} 15;
\textbf{Ment} 28
\pari \textbf{Strike} Tentacle \plus12 (8d10)
...
\hit The target takes 9d10 psionic damage and is \glossterm{stunned} as a \glossterm{condition}.
...
\hit Each target takes 7d10 psionic damage and is \glossterm{stunned} as a \glossterm{condition}.
\end{ability}
...
\begin{ability}{Whirlwind}[\glossterm{Sustain} (standard)]
...
\textbf{Ref} 11;
\textbf{Ment} 11
\pari \textbf{Strike} Slam \plus8 (6d10) or hoof \plus8 (5d10)
...
\textbf{Ref} 8;
\textbf{Ment} 5
\pari \textbf{Strike} Bite \plus2 (2d8) or claw \plus2 (2d6)
...
\textbf{Ref} 8;
\textbf{Ment} 7
\pari \textbf{Strike} Bite \plus4 (4d6) or claw \plus4 (2d10)
\pari \textbf{Immune} staggered
...
\textbf{Ref} 11;
\textbf{Ment} 10
\pari \textbf{Strike} Bite \plus8 (4d8)
...
\textbf{Ref} 12;
\textbf{Ment} 13
\pari \textbf{Strike} Bite \plus9 (7d10)
...
\textbf{Ref} 13;
\textbf{Ment} 14
\pari \textbf{Strike} Talon \plus10 (8d10)
...
\textbf{Ref} 12;
\textbf{Ment} 8
\pari \textbf{Strike} Club \plus3 (1d8) or sling \plus3 (1d8)
...
\begin{ability}{Shout of Running}[\glossterm{Sustain} (standard)]
All other willing allies who can hear the shouter can use the \textit{sprint} ability without spending action points.
\end{ability}

\vspace{0.5em}
\begin{ability}{Shout of Stabbing}[\glossterm{Sustain} (standard)]
...
\textbf{Ref} 12;
\textbf{Ment} 14
\pari \textbf{Strike} Greataxe \plus6 (4d10)
...
\begin{ability}{Hit Everyone Else}[\glossterm{Sustain} (standard)]
...
\textbf{Ref} 8;
\textbf{Ment} 11
\pari \textbf{Strike} Greataxe \plus3 (2d10)
...
\vspace{0.5em}
\begin{ability}{Hit That One Over There}[\glossterm{Sustain} (standard)]
...
\textbf{Ref} 8;
\textbf{Ment} 11
\pari \textbf{Strike} Greatstaff \plus3 (2d8)
...
\textbf{Ref} 11;
\textbf{Ment} 10
\pari \textbf{Strike} Bite \plus7 (4d8)
...
This ability functions like the \textit{shove} ability (see \pcref{Shove}), except that the ankheg's accuracy is \plus13.
...
\hit Each target takes 2d10 acid damage, and creatures are \glossterm{sickened} as a \glossterm{condition}.
\end{ability}
...
\textbf{Ref} 11;
\textbf{Ment} 12
\pari \textbf{Strike} Bite \plus8 (6d10) or claw \plus8 (5d10)
...
\hit Each target takes 4d8 electricity damage, and is \glossterm{dazed} as a \glossterm{condition}.
\end{ability}
...
\textbf{Ref} 13;
\textbf{Ment} 16
\pari \textbf{Strike} Bite \plus13 (9d10) or slam \plus13 (9d10)
...
\textbf{Ref} 15;
\textbf{Ment} 9
\pari \textbf{Strike} Claw \plus7 (4d8)
...
\textbf{Ref} 12;
\textbf{Ment} 7
\pari \textbf{Strike} Talon \plus6 (2d8)
...
\textbf{Ref} 8;
\textbf{Ment} 10
\pari \textbf{Strike} Bite \plus5 (5d10)
...
\textbf{Ref} 9;
\textbf{Ment} 11
\pari \textbf{Strike} Bite \plus6 (5d10)
...
\textbf{Ref} 13;
\textbf{Ment} 10
\pari \textbf{Strike} Bite \plus7 (4d10)
...
\textbf{Ref} 14;
\textbf{Ment} 13
\pari \textbf{Strike} Claw \plus7 (2d6)
...
\textbf{Ref} 14;
\textbf{Ment} 15
\pari \textbf{Strike} Longbow \plus8 (2d10) or snakes \plus8 (2d8)
...
\begin{ability}{Flame Aura}[\glossterm{Sustain} (standard)]
...
\textbf{Ref} 14;
\textbf{Ment} 14
\pari \textbf{Strike} Spear \plus6 (4d8) or tail slam \plus6 (4d8)
...
\textbf{Ref} 17;
\textbf{Ment} 19
\pari \textbf{Strike} Draining touch \plus9 vs. Reflex (4d6)
...
\textbf{Ref} 16;
\textbf{Ment} 16
\pari \textbf{Strike} Claw \plus6 (2d10)
...
\begin{ability}{Animating Caper}[\glossterm{Attune}]
