...
\begin{monsection}{Zombie}[Warrior]{2}[1]
\vspace{-1em}\spelltwocol{}{Medium undead}\vspace{-1em}
\begin{spellcontent}
\begin{spelltargetinginfo}
\spelltwocol{
...
\textbf{Ref} 6;
\textbf{Ment} 8
\pari \textbf{Strike} Slam \plus2 (1d8)
...
\vspace{0.5em}\parhead{Soft Flesh}
The zombie has \glossterm{damage reduction} 4 against piercing and bludgeoning damage.
