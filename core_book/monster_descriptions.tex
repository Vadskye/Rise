...
\hit The target takes 2d6 life damage and is \glossterm{sickened} as a \glossterm{condition}.",
\end{ability}
...
\hit Each target takes 4d6 acid damage, and creatures are \glossterm{sickened} as a \glossterm{condition}.
\end{ability}
...
\hit Each target takes 4d10 electricity damage, and is \glossterm{dazed} as a \glossterm{condition}.
\end{ability}
