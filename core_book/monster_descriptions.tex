...
All other willing allies who can hear the shouter gain a \plus1d bonus to damage with \glossterm{strikes}.
\end{ability}
...
The ankheg makes a \plus8 vs. Armor attack against everything in a 5 ft. wide Medium line.
...
The behir makes a \plus9 vs. Armor attack against everything in a \areamed cone.
...
The frost worm makes a \plus14 vs. Fortitude attack against everything in a \arealarge cone from it.
...
It makes a \plus14 vs. Fortitude attack against everything in a \areahuge radius from it.
...
The arrowhawk makes a \plus6 vs. Fortitude attack against one creature or object in Medium range.
...
The hell hound makes a \plus4 vs. Armor attack against everything in a Medium cone.
