...
\hit Each target takes 5d10 electricity damage, and is \glossterm{dazed} as a \glossterm{condition}.
\end{freeability}
...
The banshee makes a \plus3 vs. Fortitude attack against everything in a Large radius.
...
The arrowhawk makes a \plus5 vs. Fortitude attack against one creature or object in Medium range.
...
The dirgewalker makes a \plus9 vs. Mental attack against all creatures in a Medium radius.
