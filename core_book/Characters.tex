...
\section{Species}\label{Species}
    ...
    \subsection{Gnomes}
        ...
        \parhead{Special Abilities}
        \begin{raggeditemize}
            \magicalitemhead{Fae Light} A gnome can use the \textit{fae light} ability as a standard action.
...
\section{Resources}\label{Resources}
    ...
    \subsection{Attunement Points}\label{Attunement Points}
        ...
        \subsubsection{Attunement}\label{Attunement}
            ...
            \parhead{Deep Attunement}\label{Deep Attunement} This ability require investing two attunement points instead of only one.
