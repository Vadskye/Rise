...
\section{Character Advancement}\label{Character Advancement}
    ...
    \begin{dtable!*}
        ...
        \begin{dtabularx}{\textwidth}{l l >{\lcol}X >{\lcol}X l}
            ...
            5th        & \tdash              & \plus2                          & \tdash                              & 70     \\ % +25 xp
            6th        & \tdash              & \plus3                          & \plus1 \glossterm{attunement point} & 100    \\ % +30 xp
            ...
            12th       & \tdash              & \plus6                          & \plus1 \glossterm{attunement point} & 1,000  \\ % +300 xp
...
\section{Resources}\label{Resources}
    ...
    \subsection{Attunement Points}\label{Attunement Points}
        Many spells and items require you to \glossterm{attune} to them before you can access their special effects (see \pcref{Attuned Abilities}).
        Most effects require you to invest a single \glossterm{attunement point}.
        You can stop attuning to the effect as a \glossterm{free action}, which allows you to use that attunement point elsewhere.
        However, \glossterm{deep attunement} effects are more costly.
        They require two attunement points, and you cannot recover those points until you complete a \glossterm{short rest}.

        Your \glossterm{class} gives you a certain number of attunement points.
        At 6th level and 12th level, you gain an additional attunement point.
...
\section{Sample Characters}
    ...
    \subsection{Cleric}
        ...
        \subsubsection{Divine Magic}
            ...
            \parhead{Insight Points} 1 point for an additional mystic insight (choosing an extra mystic sphere), 2 points for an additional mystic sphere, and 2 points for additional spells known.
        ...
        \subsubsection{Preacher}
            ...
            \parhead{Insight Points} 2 points for additional mystic insights (including an extra mystic sphere), 4 points for additional spells known.
    ...
    \subsection{Druid}
        ...
        \subsubsection{Elementalist}
            ...
            \parhead{Insight Points} 2 points for a mystic sphere, 1 point for a mystic insight (choosing an extra mystic sphere), 3 points for spells
        ...
        \subsubsection{Nature Magic}
            ...
            \parhead{Insight Points} 1 point for a mystic insight (choosing an extra mystic sphere), 3 points for spells
        ...
        \subsubsection{Wildspeaker}
            ...
            \parhead{Insight Points} 1 point for a mystic insight, 3 points for spells.
    ...
    \subsection{Paladin}
        ...
        \subsubsection{Divine Magic}
            ...
            They lack the flexibility of more dedicated spellcasting classes because they lack the \ability{mystic insight} ability and access to a variety of mystic spheres.
        ...
        \subsubsection{Zealous Warrior}
            ...
            Thanks to your \ability{smite} ability, you have high damage dice and devastatingly powerful critical hits.
            Your defenses are unimpressive, but you have enough damage resistance to avoid being too squishy.
            ...
            Alternately, you could focus more heavily on ranged combat, since \ability{smite} works at any range.
