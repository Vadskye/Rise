...
\section{Character Advancement}\label{Character Advancement}
    ...
    \subsection{Legacy Items}\label{Legacy Items}
        ...
        The maximum rank for the ability you choose is 2, and it must be appropriate for the category of item you chose: weapon, armor, apparel, or implement.
        ...
        You choose a new item ability of the appropriate item type with a maximum rank that is one higher than your highest rank when you choose the ability.
        In addition, you can change all of your lower level legacy item abilities into new abilities.
        Each new ability can have a maximum rank that is one rank higher than the previous maximum rank for that ability.
        This is summarized below.
        \begin{raggeditemize}
            \item 3rd level character: One property with max rank 2
            \item 9th level character: One property with max rank 4, one property with max rank 3
            \item 15th level character: One property with max rank 6, one property with max rank 5, and one property with max rank 4
            \item 21st level character: One property with max rank 8, one property with max rank 7, one property with max rank 6, and one property with max rank 5
        \end{raggeditemize}
