...
\section{Character Advancement}\label{Character Advancement}
    ...
    \begin{raggeditemize}
        \item Your \glossterm{hit points} increase (see \trefnp{Character Advancement}).
    ...
    \begin{dtable}
        ...
        \begin{dtabularx}{\columnwidth}{l >{\lcol}X l >{\lcol}X l l}
            \tb{Level} & \tb{Max Rank}\fn{1} & \tb{HP} & \tb{Legacy Item} & \tb{AP} & \tb{XP} \tableheaderrule
            1st        & 1                   & 11      & \tdash           & (Class) & 0      \\
            2nd        & \tdash              & 12      & \tdash           & \tdash  & 20     \\
            3rd        & \tdash              & 13      & 1                & \tdash  & 50     \\
            4th        & 2                   & 15      & \tdash           & \tdash  & 90     \\
            5th        & \tdash              & 17      & \tdash           & \plus1  & 150    \\
            6th        & \tdash              & 19      & \tdash           & \tdash  & 230    \\
            7th        & 3                   & 22      & \tdash           & \tdash  & 350    \\
            8th        & \tdash              & 25      & \tdash           & \tdash  & 510    \\
            9th        & \tdash              & 28      & 2                & \tdash  & 750    \\
            10th       & 4                   & 31      & \tdash           & \tdash  & 1,050  \\
            11th       & \tdash              & 35      & \tdash           & \plus1  & 1,550  \\
            12th       & \tdash              & 39      & \tdash           & \tdash  & 2,200  \\
            13th       & 5                   & 44      & \tdash           & \tdash  & 3,150  \\
            14th       & \tdash              & 50      & \tdash           & \tdash  & 4,450  \\
            15th       & \tdash              & 56      & 3                & \tdash  & 6,350  \\
            16th       & 6                   & 63      & \tdash           & \tdash  & 8,900  \\
            17th       & \tdash              & 70      & \tdash           & \plus1  & 13,000 \\
            18th       & \tdash              & 78      & \tdash           & \tdash  & 18,000 \\
            19th       & 7                   & 88      & \tdash           & \tdash  & 25,500 \\
            20th       & \tdash              & 100     & \tdash           & \tdash  & 36,000 \\
            21st       & \tdash              & 115     & 4                & \tdash  & 60,000 \\
        \end{dtabularx}
        1. See \pcref{Archetype Ranks}. \\
        2. See \pcref{Legacy Items}. \\
        3. See \pcref{Attunement Points}. \\
    \end{dtable}
