...
\section{Character Advancement}\label{Character Advancement}
    ...
    \begin{dtable!*}
        ...
        \begin{dtabularx}{\textwidth}{l l l l l l >{\lcol}X}
            \tb{Level}\fn{1}       & \tb{Max Rank}\fn{2} & \tb{HP} & \tb{DR} & \tb{Accuracy, Defenses, Skills} & \tb{XP} & \tb{Special}                \tableheaderrule
...
\section{Character Statistics}\label{Character Statistics}
    ...
    \subsection{Power}\label{Power}
        ...
        For example, you gain a \plus1d bonus to damage with a basic \glossterm{strike} for every 2 power you have (see \pcref{Strikes}).
