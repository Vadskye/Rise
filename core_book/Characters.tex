...
\section{Character Advancement}\label{Character Advancement}
    ...
    \begin{dtable}
        ...
        \begin{dtabularx}{\columnwidth}{l >{\lcol}X l >{\lcol}X l l}
            ...
            21st       & \tdash              & 115     & 7, 7, 6, 5       & \tdash  & 60,000 \\
        \end{dtabularx}
    ...
    \subsection{Legacy Items}\label{Legacy Items}
        ...
        You choose a new item ability of the appropriate item type with a maximum rank that is one higher than your highest rank when you choose the ability (maximum 7).
        ...
        \begin{raggeditemize}
            ...
            \item 21st level character: Two properties with max rank 7, one property with max rank 6, and one property with max rank 5
        \end{raggeditemize}
