...
\section{Species}\label{Species}
    ...
    \subsection{Humans}
        ...
        \end{itemize}
        \parhead{Automatic Language} Common, any two \glossterm{common languages} or one \glossterm{rare language} (see \tref{Communication and Languages}).
    ...
    \subsection{Half-Elves}\label{Half-Elves}
        ...
        \end{itemize}
        \parhead{Automatic Language} Common, Elven, any two \glossterm{common languages} or one \glossterm{rare language} (see \tref{Communication and Languages}).
