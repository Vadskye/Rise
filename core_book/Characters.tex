...
\section{Resources}\label{Resources}
    ...
    \subsection{Insight Points}\label{Insight Points}
        ...
        In addition, there are two ways that every character can spend insight points.
        First, you can spend two \glossterm{insight points} to become a \glossterm{multiclass} character (see \pcref{Multiclass Characters}).
        Second, you can spend two \glossterm{insight points} to gain proficiency with \glossterm{exotic weapons} from a single \glossterm{weapon group} that you are already proficient with.
