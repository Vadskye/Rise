...
\section{Character Statistics}\label{Character Statistics}
    ...
    \subsection{Damage Resistance}\label{Damage Resistance}
        ...
        The amount of damage resistance you have is defined in \tref{Character Advancement and Gaining Levels}.
    ...
    \subsection{Hit Points}\label{Hit Points}
        ...
        The amount of hit points you have is defined in \tref{Character Advancement and Gaining Levels}.
        You add your level and your Constitution to find your effective level for the purpose of determining your hit points.
        For example, a level 3 character with 2 Constitution would have 10 hit points, as would a level 5 character with 0 Constitution.
    ...
    \subsection{Power}\label{Power}
        ...
        For example, a strike with a broadsword would normally deal 1d6 damage \plus1d per 2 power.
...
\section{Character Advancement and Gaining Levels}\label{Character Advancement and Gaining Levels}
    ...
    These effects are summarized in \trefnp{Character Advancement and Gaining Levels}.

    \begin{dtable!*}
        \lcaption{Character Advancement and Gaining Levels}
        \begin{dtabularx}{\textwidth}{l l l l l l >{\lcol}X}
            \tb{Level}\fn{1} & \tb{HP} & \tb{DR} & \tb{Max Rank}\fn{2} & \tb{Accuracy, Defenses, Skills, Power} & \tb{XP} & \tb{Special}                        \tableheaderrule
            1st              & 6       & 0       & 1                   & \tdash                                 & 0       & \tdash                              \\
            2nd              & 7       & 1       & \tdash              & \plus1                                 & 10      & \tdash                              \\ % +10 xp
            3rd              & 8       & 2       & \tdash              & \plus1                                 & 25      & \plus1 to two attributes            \\ % +15 xp
            4th              & 9       & 3       & 2                   & \plus2                                 & 45      & \plus1 \glossterm{insight point}    \\ % +20 xp
            5th              & 10      & 4       & \tdash              & \plus2                                 & 70      & \plus1 \glossterm{attunement point} \\ % +25 xp
            6th              & 12      & 5       & \tdash              & \plus3                                 & 100     & Legacy item: rank 3                 \\ % +30 xp
            7th              & 14      & 6       & 3                   & \plus3                                 & 140     & \plus1 \glossterm{insight point}    \\ % +40 xp
            8th              & 16      & 7       & \tdash              & \plus4                                 & 200     & \plus1 \glossterm{attunement point} \\ % +60 xp
            9th              & 18      & 8       & \tdash              & \plus4                                 & 300     & \plus1 to two attributes            \\ % +100 xp
            10th             & 20      & 9       & 4                   & \plus5                                 & 450     & \tdash                              \\ % +150 xp
            11th             & 22      & 10      & \tdash              & \plus5                                 & 700     & \tdash                              \\ % +250 xp
            12th             & 25      & 12      & \tdash              & \plus6                                 & 1,000   & Legacy item: ranks 5 and 3          \\ % +300 xp
            13th             & 28      & 14      & 5                   & \plus6                                 & 1,400   & \tdash                              \\ % +400 xp
            14th             & 32      & 16      & \tdash              & \plus7                                 & 2,000   & \tdash                              \\ % +600 xp
            15th             & 36      & 18      & \tdash              & \plus7                                 & 3,000   & \plus1 to two attributes            \\ % +1000 xp
            16th             & 40      & 20      & 6                   & \plus8                                 & 4,500   & \tdash                              \\ % +1,500 xp
            17th             & 45      & 22      & \tdash              & \plus8                                 & 7,000   & \tdash                              \\ % +2,500 xp
            18th             & 50      & 25      & \tdash              & \plus9                                 & 10,000  & Legacy item: ranks 7 and 5          \\ % +3,000 xp
            19th             & 56      & 28      & 7                   & \plus9                                 & 14,000  & \tdash                              \\
            20th             & 63      & 31      & \tdash              & \plus10                                & 20,000  & \tdash                              \\
            21st             & 70      & 35      & \tdash              & \plus10                                & 30,000  & \plus1 to two attributes            \\
        \end{dtabularx}
