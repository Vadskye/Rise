...
\section{Character Advancement}\label{Character Advancement}
    ...
    \subsection{Legacy Items}\label{Legacy Items}
        ...
        In addition, you can change all of your lower level legacy item abilities into new abilities up to 3 levels higher than they were previously.
        This is summarized below.
        \begin{itemize*}
            3rd level character: One property with max level 5
            9th level character: One property with max level 11, one property with max level 8
            15th level character: One property with max level 17, one property with max level 14, and one property with max level 11
            21st level character: One property with max level 21, one property with max level 20, one property with max level 17, and one property with max level 14
        \end{itemize*}
    ...
    \subsection{Barbarian}
        ...
        \subsubsection{Outland Savage}
            ...
            \parhead{Legacy Item} Apparel.
                ...
                At level 15, choose \mitem{supreme phasestep boots}, \mitem{enlarging belt}, and \mitem{cleansing belt}.
        ...
        \subsubsection{Primal Warrior}
            ...
            \parhead{Insight Points} 1 point for an additional combat style, 3 points for additional maneuvers.
            \parhead{Skills} Awareness, Balance, Climb, Endurance, Intimidate, Medicine, Jump, Swim, Survival.
            ...
            \parhead{Legacy Item} Weapon.
                ...
                At level 9, choose \mitem{greater flaming} and \mitem{tireless}.
                At level 15, choose \mitem{supreme flaming}, \mitem{honed}, and \mitem{tireless}.
        ...
        \subsubsection{Totemist}
            ...
            \parhead{Skills} Awareness, Balance, Climb, Creature Handling, Endurance, Jump, Survival.
            ...
            \parhead{Legacy Item} Weapon.
                ...
                At level 9, choose \mitem{greater bloodfuel} and \mitem{tireless}.
                At level 15, choose \mitem{supreme bloodfuel}, \mitem{impactful}, and \mitem{tireless}.
    ...
    \subsection{Cleric}
        ...
        \subsubsection{Divine Magic}
            ...
            \parhead{Legacy Item} 1-handed implement.
                ...
                At level 15, choose \mitem{greater splitting staff}, \mitem{extending staff}, and \mitem{staff of focus}.
        ...
        \subsubsection{Healer}
            ...
            \parhead{Legacy Item} 1-handed implement.
                ...
                At level 9, choose \mitem{splitting staff} and \mitem{staff of focus}.
                At level 15, choose \mitem{greater splitting staff}, \mitem{reaching staff}, and \mitem{staff of focus}.
        ...
        \subsubsection{Preacher}
            ...
            \parhead{Legacy Item} Apparel.
                At level 3, choose \mitem{amulet of denunciation}.
                At level 9, choose \mitem{preacher's amulet} and \mitem{ring of blessed protection}.
                At level 15, choose \mitem{greater preacher's amulet}, \mitem{boots of freedom}, and \mitem{ring of blessed protection}.
