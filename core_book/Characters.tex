...
\section{Attributes}\label{Attributes}
    ...
    \subsection{Extraordinary Attributes}
        ...
        For each point by which your base attribute exceeds 5, you increase your total attribute by one quarter of your level.

        For example, a 20th level character might have a base Strength of 6.
        Their total Strength would be equal to 5 \add one and a quarter times their level, for a total of 30.
