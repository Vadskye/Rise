...
\section{Attributes}\label{Attributes}
    ...
    \subsection{Strength (Str)}\label{Strength}
        {
            ...
            \begin{raggeditemize}
                ...
                \item You add half your total Strength to your \glossterm{power} with \glossterm{mundane} abilities, such as normal weapon attacks (see \pcref{Power}).
                \item Your base Strength can reduce your total \glossterm{encumbrance} from \glossterm{armor} (see \pcref{Encumbrance}).
    ...
    \subsection{Dexterity (Dex)}\label{Dexterity}
        {
            ...
            It has the following effects:
            \begin{raggeditemize}
                \item You add your base Dexterity to your Reflex defense.
                \item You add your base Dexterity to your Armor defense.
                    This bonus can be reduced if you use medium or heavy armor (see \tref{Armor and Shields}).
                \item You add your base Dexterity to your to your \glossterm{initiative} checks (see \pcref{Initiative}).
    ...
    \subsection{Constitution (Con)}\label{Constitution}
        {
            ...
            It has the following effects:
            \begin{raggeditemize}
                \item You add your total Constitution to your \glossterm{hit points} (see \pcref{Hit Points}).
                \item You add your total Constitution to your \glossterm{damage resistance} (see \pcref{Damage Resistance}).
                \item You add your base Constitution to your \glossterm{fatigue tolerance} (see \pcref{Fatigue}).
                \item You add your base Constitution to your Fortitude defense.
    ...
    \subsection{Intelligence (Int)}\label{Intelligence}
        {
            ...
            \begin{raggeditemize}
                ...
                \item You add your base Intelligence to the number of \glossterm{insight points} you gain (see \pcref{Insight Points}).
    ...
    \subsection{Perception (Per)}\label{Perception}
        {
            ...
            It has the following effects:
            \begin{raggeditemize}
                \item You add half your base Perception to your \glossterm{accuracy} with all attacks (see \pcref{Accuracy}).
                \item You add your base Perception to your \glossterm{initiative} (see \pcref{Initiative}).
                \item Your Perception affects Perception-based \glossterm{skills}: Awareness, Creature Handling, Social Insight, and Survival (see \pcref{Skills}).
            \end{raggeditemize}
        }
    ...
    \subsection{Willpower (Wil)}\label{Willpower}
        {
            ...
            It has the following effects:
            \begin{raggeditemize}
                \item You add half your total Willpower to your \glossterm{power} with \glossterm{magical} abilities, such as spells (see \pcref{Power}).
                \item You add your base Willpower to your Mental defense.
                \item You add your base Willpower to your \glossterm{fatigue tolerance} (see \pcref{Fatigue}).
            \end{raggeditemize}
        }
    ...
    \subsection{Extraordinary Attributes}
        ...
        For each point by which your base attribute exceeds 5, you increase your total attribute by one, plus one quarter of your level.

        For example, a 20th level character might have a base Strength of 6.
        Their total Strength would be equal to 6 \add one and a quarter times their level, for a total of 31.
...
\section{Species}\label{Species}
    ...
    \subsection{Dwarves}
        ...
        \parhead{Special Abilities}
        \begin{raggeditemize}
            \itemhead{Darkvision} Dwarves have \stdability{darkvision} with a 60 foot range, allowing them to see in complete darkness (see \pcref{Darkvision}).
    ...
    \subsection{Elves}
        ...
        \begin{raggeditemize}
            ...
            \itemhead{Low-light Vision} Elves have \stdability{low-light vision}, allowing them to see clearly in \glossterm{shadowy illumination} (see \pcref{Low-light Vision}).
    ...
    \subsection{Gnomes}
        ...
        \begin{raggeditemize}
            \itemhead{Fae Light}[Magical] A gnome can use the \textit{fae light} ability as a \glossterm{minor action}.
                ...
                \end{freeability}
            \itemhead{Low-light Vision} Gnomes have \stdability{low-light vision}, allowing them to see clearly in \glossterm{shadowy illumination} (see \pcref{Low-light Vision}).
    ...
    \subsection{Half-Elves}\label{Half-Elves}
        ...
        \begin{raggeditemize}
            ...
            \itemhead{Low-light Vision} Half-elves have \stdability{low-light vision}, allowing them to see clearly in \glossterm{shadowy illumination} (see \pcref{Low-light Vision}).
    ...
    \subsection{Half-Orcs}
        ...
        \parhead{Special Abilities}
        \begin{raggeditemize}
            \itemhead{Darkvision} Half-orcs have \stdability{darkvision} with a 60 foot range, allowing them to see in complete darkness (see \pcref{Darkvision}).
...
\section{Character Advancement}\label{Character Advancement}
    ...
    \begin{dtable}
        ...
        \begin{dtabularx}{\columnwidth}{l >{\lcol}X l >{\lcol}X l}
            \tb{Level} & \tb{Max Rank}\fn{1} & \tb{HP} & \tb{Legacy Item} & \tb{XP} \tableheaderrule
            1st        & 1                   & 11      & \tdash           & 0      \\
            2nd        & \tdash              & 12      & \tdash           & 20     \\
            3rd        & \tdash              & 13      & 2                & 50     \\
            4th        & 2                   & 15      & \tdash           & 90     \\
