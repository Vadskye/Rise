...
\section{Species}\label{Species}
    ...
    \subsection{Dwarves}
        ...
        \begin{raggeditemize}
            ...
            \itemhead{Slow and Steady} Dwarves have a \minus10 foot penalty to their \glossterm{land speed}.
                However, wearing heavy \glossterm{body armor} does not reduce a dwarf's movement speed (see \pcref{Armor Usage Classes}).
                In addition, they reduce the \glossterm{encumbrance} of body armor they wear by 1.
            \itemhead{Stable} Dwarves reduce the distance they are moved by unwilling \glossterm{knockback} and \glossterm{push} effects by 15 feet.
        \end{raggeditemize}
