...
\section{Character Advancement}\label{Character Advancement}
    ...
    \begin{dtable!*}
        ...
        \begin{dtabularx}{\textwidth}{l l l l l l >{\lcol}X}
            \tb{Level}\fn{1} & \tb{Max Rank}\fn{2} & \tb{HP} & \tb{DR} & \tb{Accuracy, Defenses, Skills, Power} & \tb{XP} & \tb{Special}                \tableheaderrule
            1st              & 1                   & 6       & 0       & \tdash                                 & 0       & \tdash                     \\
            2nd              & \tdash              & 7       & 1       & \plus1                                 & 10      & \tdash                     \\ % +10 xp
            3rd              & \tdash              & 8       & 2       & \plus1                                 & 25      & \plus1 to two attributes   \\ % +15 xp
            4th              & 2                   & 9       & 3       & \plus2                                 & 45      & \plus1 \glossterm{insight point}                     \\ % +20 xp
            5th              & \tdash              & 10      & 4       & \plus2                                 & 70      & \plus1 \glossterm{attunement point}                     \\ % +25 xp
            6th              & \tdash              & 12      & 5       & \plus3                                 & 100     & Legacy item: rank 3        \\ % +30 xp
            7th              & 3                   & 14      & 6       & \plus3                                 & 140     & \plus1 \glossterm{insight point}                     \\ % +40 xp
            8th              & \tdash              & 16      & 7       & \plus4                                 & 200     & \plus1 \glossterm{attunement point}                     \\ % +60 xp
            9th              & \tdash              & 18      & 8       & \plus4                                 & 300     & \plus1 to two attributes   \\ % +100 xp
            10th             & 4                   & 20      & 9       & \plus5                                 & 450     & \tdash                     \\ % +150 xp
            11th             & \tdash              & 22      & 10      & \plus5                                 & 700     & \tdash                     \\ % +250 xp
            12th             & \tdash              & 25      & 12      & \plus6                                 & 1,000   & Legacy item: ranks 5 and 3 \\ % +300 xp
            13th             & 5                   & 28      & 14      & \plus6                                 & 1,400   & \tdash                     \\ % +400 xp
            14th             & \tdash              & 32      & 16      & \plus7                                 & 2,000   & \tdash                     \\ % +600 xp
            15th             & \tdash              & 36      & 18      & \plus7                                 & 3,000   & \plus1 to two attributes   \\ % +1000 xp
            16th             & 6                   & 40      & 20      & \plus8                                 & 4,500   & \tdash                     \\ % +1,500 xp
            17th             & \tdash              & 44      & 22      & \plus8                                 & 7,000   & \tdash                     \\ % +2,500 xp
            18th             & \tdash              & 50      & 24      & \plus9                                 & 10,000  & Legacy item: ranks 7 and 5 \\ % +3,000 xp
            19th             & 7                   & 56      & 27      & \plus9                                 & 14,000  & \tdash                     \\
            20th             & \tdash              & 63      & 31      & \plus10                                & 20,000  & \tdash                     \\
            21st             & \tdash              & 70      & 35      & \plus10                                & 30,000  & \plus1 to two attributes   \\
        \end{dtabularx}
        1. For some statistics, like your \glossterm{hit points}, you add your attributes to your level when calculating the total. If this total is more than 21 or less than 1, see the relevant section below this table to calculate your value. \\
...
\section{Character Statistics}\label{Character Statistics}
    ...
    \subsection{Damage Resistance}\label{Damage Resistance}
        ...
        If the sum exceeds 21, use double the damage resistance you would have if your value was 6 lower.
        For example, a level 21 creature with 4 Willpower would have 54 damage resistance.
    ...
    \subsection{Hit Points}\label{Hit Points}
        ...
        If the sum exceeds 21, use double the hit points you would have if your value was 6 lower.
        For example, a level 21 creature with 4 Constitution would have 112 hit points.
    ...
    \subsection{Power}\label{Power}
        ...
        You have two types of power: your \glossterm{magical power} affects your \magical abilities, and your \glossterm{mundane power} affects your \glossterm{mundane} abilities.
        ...
        For example, you gain a \plus1d bonus to your \glossterm{weapon damage} for every 2 power you have (see \pcref{Strikes}).
