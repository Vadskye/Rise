    ...
    \subsection{Willpower (Wil)}\label{Willpower}
        {
            ...
            It has the following effects:
            \begin{raggeditemize}
                \item You add half your Willpower in \glossterm{dice increments} to your damage and healing with \magical abilities (see \pcref{Dice Bonuses From Attributes}).
