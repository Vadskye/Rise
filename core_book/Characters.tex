    ...
    \subsection{Strength (Str)}\label{Strength}
        {
            ...
            \begin{raggeditemize}
                ...
                \item You add half your Strength in \glossterm{dice increments} to your damage with \glossterm{mundane} abilities (see \pcref{Damage Dice}).
    ...
    \subsection{Willpower (Wil)}\label{Willpower}
        {
            ...
            It has the following effects:
            \begin{raggeditemize}
                \item You add half your Willpower in \glossterm{dice increments} to your damage with \glossterm{magical} abilities (see \pcref{Damage Dice}).
                \item You add your Willpower to your Mental defense.
                \item You add your Willpower to your \glossterm{fatigue tolerance} (see \pcref{Fatigue}).
            \end{raggeditemize}
        }
