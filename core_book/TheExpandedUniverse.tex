...
\section{Expanding the Cosmology}
  Rise normally assumes there is only one Material Plane, which is a single solar system in scope.
  ...
  Technically, that should be unstable since the solar systems should be pulled towards each other by gravity over time, but you can handwave it by saying that staggeringly powerful magic keeps the systems apart.
  Or you can just hope that your players don't think too hard about the physics of that universe.
...
\sectiongraphic*{Secrets of the Universe}{width=\columnwidth}{the universe/secrets of the universe}
  ...
  \subsectiongraphic*{Gaia}{width=\columnwidth}{the universe/nature}
    ...
    This amounts to trillions of deaths every day feeding her, and she is unambiguously the strongest entity in Rise.
    ...
    Druids are granted power by Gaia, but they need not agree to any particular ideology, and their usage of that power is virtually never policed or revoked by Gaia herself in the way that a misbehaving cleric might be punished by their deity.
    Gaia welcomes a diversity of viewpoints, for nature is almost infinitely diverse.
    She has a wealth of power, so she does not need to jealously hoard her gifts like deities must.
