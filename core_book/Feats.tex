...
\end{longtabuwrapper}
    ...
    \begin{feat}{Innate Magic}{Casting, Magical}
        ...
        You increase your \glossterm{focus penalty} with spells by 2.
        In addition, you automatically fail to use \glossterm{Focus} spells during the \glossterm{delayed action phase} if you already lost a \glossterm{hit point} earlier in the round.
        This does not affect spells that do not have the \glossterm{Focus} tag.
        ...
        \ff[10]{Greater Mental Casting} The increase to your \glossterm{focus penalty} with spells from your \textit{mental casting} ability is removed.
        ...
        \ff[19]{Supreme Mental Casting} The automatic spell failure from your \textit{mental casting} ability is removed.
        In addition, you reduce your \glossterm{focus penalty} by 1.
    \end{feat}
    ...
    \begin{feat}{Iron Will}{General}
        ...
        \ff[10]{Greater Mental Discipline} The bonus from your \textit{mental discipline} ability increases to \plus3.

        \ff[13]{Greater Mind over Matter} The number of additional \glossterm{hit points} from your \textit{mind over matter} ability increases to two.

        \ff[16]{Greater Unclouded Mind} You are immune to being \glossterm{stunned}.

        \ff[19]{Supreme Mental Discipline} The bonus from your \textit{mental discipline} ability increases to \plus4.
    \end{feat}
    ...
    \begin{feat}{Spellsword}{Spell}
        ...
        \ff[1]{Combat Focus} You reduce your \glossterm{focus penalties} by 1.
        ...
        \ff[10]{Greater Combat Focus} The penalty reduction from your \textit{combat focus} ability increases to 2.

        \ff[13]{Greater Imbue Weapon}[Magical] You can maintain two separate attunements to your \textit{imbue weapon} ability.

        \ff[16]{Greater Spellsword Conduit}[Magical] The accuracy bonus from your \textit{spellsword conduit} ability increases to \plus2.

        \ff[19]{Supreme Combat Focus} The penalty reduction from your \textit{combat focus} ability increases to 3.
    \end{feat}
