...
% Feat names must follow ``have'', ``are (a)'', or ``can''.
        \begin{longtabuwrapper}
            \begin{longtabu}{>{\lcol}p{10em} >{\lcol}p{15em} >{\lcol}X >{\lcol}p{8em} >{\lcol}p{3em}}
                ...
                \featref{Spellgifted} & 5th level, Wil 9 & Gain spell-like abilities & \tdash & \featpref{Spellgifted} \\
                ...
                \featref{Versatility} & 5th level & Improve class abilities when multiclassing & \tdash & \featpref{Versatility} \\

                \tb{Bloodline Feats} & \tb{Prerequisites} & \tb{Benefit} & \tb{Feat Types} & \tb{Page} \\
                \featref{Celestial Heritage} & Non-evil & Gain holy abilities & \tdash & \featpref{Celestial Heritage} \\
                \tind \featref{Celestial Apotheosis} & 9th level, Celestial Heritage, non-evil & Gain wings and holy judgment & \tdash & \featpref{Celestial Apotheosis} \\
                \featref{Celestial Spell Conduit} & 5th level, 2nd level spells, Celestial Heritage, non-evil & Heal allies when you cast spells & \tdash & \featpref{Celestial Spell Conduit} \\
                ...
                \featref{Draconic Heritage} & \tdash & Gain draconic abilities & \tdash & \featpref{Draconic Heritage} \\
                \tind \featref{Draconic Apotheosis} & 9th level, Draconic Heritage & Gain wings, improved draconic abilities & \tdash & \featpref{Draconic Apotheosis} \\

                \tb{Class Feats} & \tb{Prerequisites} & \tb{Benefit} & \tb{Feat Types} & \tb{Page} \\
                ...
                \featref{Battlemaster} & Fighter 9, Int 9 & Grant feats to allies & \tdash & \featpref{Battlemaster} \\
                ...
                \featref{Conjurer} & 5th level, 2nd level Conjuration spell & Improve Conjuration spells you cast & \tdash & \featpref{Conjurer} \\
                ...
                \featref{Diviner} & 5th level, 2nd level Divination spell & Improve Divination spells you cast & \tdash & \featpref{Diviner} \\
                \featref{Enchant Item} & 1st level spells & Gain ability to create magic items & \tdash & \featpref{Enchant Item} \\
                \featref{Enchanter} & 5th level, 2nd level Enchantment spell & Improve Enchantment spells you cast & \tdash & \featpref{Enchanter} \\
                ...
                \featref{Vivimancer} & 5th level, 2nd level Vivimancy spell & Improve Vivimancy spells you cast & \tdash & \featpref{Vivimancer} \\

                \tb{Skill Feats} & \tb{Prerequisites} & \tb{Benefit} & \tb{Feat Types} & \tb{Page} \\
                \featref{Acrobatics Mastery} & Acrobatics 5 & Improve Acrobatics checks & \tdash & \featpref{Acrobatics Mastery} \\
                \featref{Awareness Mastery} & Awareness 5 & Improve Awareness checks & \tdash & \featpref{Awareness Mastery} \\
                \featref{Bluff Mastery} & Bluff 5 & Improve Bluff checks & \tdash & \featpref{Bluff Mastery} \\
                \featref{Climb Mastery} & Climb 5 & Improve Climb checks & \tdash & \featpref{Climb Mastery} \\
                \featref{Craft Magic Item} & Craft (any) 5 & Gain ability to craft magic items & \tdash & \featpref{Craft Magic Item} \\
                \featref{Craft Mastery} & Craft 5 & Improve Craft checks & \tdash & \featpref{Craft Mastery} \\
                \featref{Creature Handling Mastery} & Creature Handling 5 & Improve Creature Handling checks & \tdash & \featpref{Creature Handling Mastery} \\
                \featref{Device Mastery} & Devices 5 & Improve Devices checks & \tdash & \featpref{Device Mastery} \\
                \featref{Disguise Mastery} & Disguise 5 & Improve Disguise checks & \tdash & \featpref{Disguise Mastery} \\
                \featref{Escape Artist Mastery} & Escape Artist 5 & Improve Escape Artist checks & \tdash & \featpref{Escape Artist Mastery} \\
                \featref{Heal Mastery} & Heal 5 & Improve Heal checks & \tdash & \featpref{Heal Mastery} \\
                \featref{Inspiring Performer} & Perform 5 & Perform to improve abilities of allies & Performance & \featpref{Inspiring Performer} \\
                \featref{Intimidate Mastery} & Intimidate 5 & Improve Intimidate checks & \tdash & \featpref{Intimidate Mastery} \\
                \featref{Jump Mastery} & Jump 5 & Improve Jump checks & \tdash & \featpref{Jump Mastery} \\
                \featref{Knowledge Mastery} & Knowledge (any) 5 & Improve Knowledge checks & \tdash & \featpref{Knowledge Mastery} \\
                \featref{Linguistic Mastery} & Linguistics 5 & Improve Linguistics checks & \tdash & \featpref{Linguistic Mastery} \\
                \featref{Mesmerizing Performer} & Perform (any) 5 & Perform to influence and distract foes & Performance & \featpref{Mesmerizing Performer} \\
                \featref{Mocking Performer} & Perform (any) 5 & Perform to impair foes & Performance & \featpref{Mocking Performer} \\
                \featref{Persuasion Mastery} & Persuasion 5 & Improve Persuasion checks & \tdash & \featpref{Persuasion Mastery} \\
                \featref{Perform Mastery} & Perform 5 & Improve Perform checks & \tdash & \featpref{Perform Mastery} \\
                \featref{Ride Mastery} & Ride 5 & Improve Ride checks & \tdash & \featpref{Ride Mastery} \\
                \featref{Sense Motive Mastery} & Sense Motive 5 & Improve Sense Motive checks & \tdash & \featpref{Sense Motive Mastery} \\
                \featref{Skill Savant} & \tdash & Gain skill points, skill bonuses & \tdash & \featpref{Skill Savant} \\
                \featref{Sleight of Hand Mastery} & Sleight of Hand 5 & Improve Sleight of Hand checks & \tdash & \featpref{Sleight of Hand Mastery} \\
                \featref{Spellcraft Mastery} & Spellcraft 5 & Improve Spellcraft checks & \tdash & \featpref{Spellcraft Mastery} \\
                \featref{Sprint Mastery} & Sprint 5 & Improve Sprint checks & \tdash & \featpref{Sprint Mastery} \\
                \featref{Stealth Mastery} & Stealth 5 & Improve Stealth checks & \tdash & \featpref{Stealth Mastery} \\
                \featref{Sprint Mastery} & Sprint 5 & Improve Sprint checks & \tdash & \featpref{Sprint Mastery} \\
                \featref{Supreme Inspiration} & 9th level, Perform 14 & Perform to greatly inspire allies & \tdash & \featpref{Supreme Inspiration} \\
                \featref{Survival Mastery} & Survival 5 & Improve Survival checks & \tdash & \featpref{Survival Mastery} \\
                \featref{Swim Mastery} & Swim 5 & Improve Swim checks & \tdash & \featpref{Swim Mastery} \\
                \featref{Trapfinder} & Awareness 5 & Improve ability to notice traps & \tdash & \featpref{Trapfinder} \\
    ...
    \subsection{Combat Feat Table}
        ...
        \begin{longtabuwrapper}
            \begin{longtabu}{>{\lcol}p{10em} >{\lcol}p{15em} >{\lcol}X >{\lcol}p{8em} >{\lcol}p{3em}}
                ...
                \tb{Name} & \tb{Prerequisites} & \tb{Benefit} & \tb{Feat Types} & \tb{Page} \\
                ...
                \featref{Mounted Combat} & Ride 5 & Fight better while mounted & \tdash & \featpref{Mounted Combat} \\
...
\section{Feat Descriptions}
    ...
    At 7th level, and every 4 levels thereafter, the bonus to physical damage and the bonus to Fortitude and Mental defenses increases by \plus1.
    ...
    \feat{Blindfighter}{Awareness, Combat}
    ...
    At 7th level, if you have 10 ranks in Climb, you gain a \glossterm{climb speed} equal to your land speed.
    ...
    \feat{Counterattack}{Awareness, Combat, Reaction, Style}
    ...
    At 7th level, if you have 10 ranks in any Craft skill, it takes you one hour per 100 gp of material components to create a magic item. % 900-3250 gp mats, 9-32 hrs

    At 11th level, if you have 14 ranks in any Craft skill, it takes you one hour per 500 gp of material components to create a magic item. % 5000-18500 gp, 10-37 hrs

    At 15th level, if you have 18 ranks in any Craft skill, it takes you one hour per 2,500 gp of material components to create a magic item. % 27500-200000 gp, 11-80 hrs
    ...
    \featben You gain a \plus2 bonus to Awareness, Knowledge, and Sense Motive checks.
    ...
    At 15th level, the bonus to Awareness and Sense Motive checks increases to \plus4.
    ...
    \featpres 5th level, 2nd level or higher \glossterm{Enchantment} spell known.
    ...
    At 7th level, you gain a \plus2 bonus to Bluff, Intimidate, and Persuasion checks.
    ...
    \feat{Heavy Weapon Fighting}{Combat, Power}
    \featpre Strength 3.
    ...
    \parhead{Inspire Courage} As a standard action, you can make a DR 12 Perform check to inspire courage in another willing creature within \rngmed range of you.
    ...
    \parhead{Inspire Resilience} As a standard action, you can make a DR 20 Perform check to inspire resilience in another willing creature within \rngmed range of you.
    ...
    \feat{Mage Slayer}{Combat, Reaction, Style}
    \featpre 5th level.
    ...
    You can use any combination of performance abilities a number of times per day equal to half the ranks you have in your highest Perform skill.
    For details on how performances work, see \pcref{Performance Feats}.
    \parhead{Mocking Performance} As a standard action, you can make a DR 10 Perform check to demoralize a creature within \rngmed range of you.
    ...
    \parhead{Taunting Performance} As a standard action, you can make a DR 15 Perform check to taunt a creature within \rngmed range of you on behalf of one of your allies.
    ...
    \feat{Point Blank Shot}{Combat, Precision}
    \featben You gain a \plus2 bonus to damage with physical ranged attacks against targets within half of your \glossterm{ranged increment}.
    ...
    \feat{Precise Attack}{Combat, Precision, Style}
    \featpres Perception 3.
    ...
    \feat{Precise Shot}{Combat, Precision}
    \featpres 5th level, Perception 6.
    ...
    \feat{Reflexive Dodge}{Combat, Reaction}
    \featpres 13th level, Dexterity 12.
    ...
    \feat{Shielded Fighting}{Combat, Defense}
    ...
    At 3rd level, you gain a \plus1 bonus with all skills.

    At 7th level, the skill bonus increases to \plus2.

    At 11th level, the skill bonus increases to \plus3.
    ...
    At 11th level, if you have 14 ranks in Spellcraft, you gain a \plus2 bonus on accuracy, checks, and defenses against spells and magical effects you identify with a successful Spellcraft check.

    \feat{Spellgifted}{General}
    \featpres 5th level, Willpower 6.
    ...
    The spell's level must be no greater than half your total levels in classes that cannot cast spells, \sub 1.
    ...
    If the weapon hits a creature before the spell dissipates, you can spend an \glossterm{immediate action} to activate the spell.
    ...
    At 15th level, if you have 18 ranks in Stealth, the penalty for hiding while observed is reduced to \minus5.
    ...
    You can use any combination of performance abilities a number of times per day equal to half the ranks you have in your highest Perform skill.
    For details on how performances work, see \pcref{Performance Feats}.
    \parhead{Inspire Serenity} As a standard action, you can make a DR 24 Perform check to clear the mind of a willing creature within \rngmed range of you.
    ...
    \parhead{Inspire Mastery} As a standard action, you can make a DR 26 Perform check to inspire mastery in another willing creature within \rngmed range of you.
    ...
    \feat{Two-Weapon Fighting}{Combat, Finesse}
    \featpre Dexterity 3.
    ...
    \featpres 5th level, 2nd level or higher \glossterm{Vivimancy} spell known.
