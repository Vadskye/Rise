...
\begin{longtabuwrapper}
    \begin{longtabu}{>{\lcol}p{10em} >{\lcol}p{15em} >{\lcol}X >{\lcol}p{8em} >{\lcol}p{3em}}
        ...
        \featref{Domain Spell Flexibility} & Domain spell & Can choose any spell as a domain spell & \tdash & \featpref{Domain Spell Flexibility} \\
...
\begin{itemize}
    ...
    \item Spears: When you are charged by a creature, you can brace a spear you wield as an \glossterm{immediate action}.
