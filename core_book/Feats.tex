...
\end{longtabuwrapper}
    ...
    \begin{feat}{Acrobatics Specialization}{Skill}
        ...
        \ff[10]{Air Dancer}[Mag] You can attempt to move on surfaces that cannot support your weight.
    ...
    \begin{feat}{Bluff Specialization}{Skill}
        ...
        \ff[10]{Dual Speech}[Mag] Whenever you speak, you can spend an \glossterm{action point} to use the \textit{dual speech} ability.
