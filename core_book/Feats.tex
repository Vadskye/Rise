...
\end{longtabuwrapper}
    ...
    \begin{feat}{Spell Focus: Barrier}{Magical, Spell}
        ...
        \ff[9]{Abjurant Shield} When you cast the \spell{barrier} spell, you can use the \textit{abjurant shield} ability.
    ...
    \begin{feat}{Spell Focus: Pyromancy}{Magical, Spell}
        ...
        \ff[9]{Potent Pyromancy} You gain a \plus1 bonus to \glossterm{power} with the \spell{pyromancy} spell.
    ...
    \begin{feat}{Spell Focus: Summon}{Magical, Spell}
        ...
        \ff[9]{Guided Summons} Creatures you create with the \spell{summoning} spell gain a \plus1 bonus to \glossterm{accuracy}.
    ...
    \begin{feat}{Spell Focus: Vital Surge}{Magical, Spell}
        ...
        \ff[6]{Reciprocal Healing} When you heal a creature with the \spell{vital surge} spell, you also heal hit points equal to your \glossterm{power} with the spell.
        You can only gain this healing once per time you cast the spell.

        \ff[9]{Potent Vital Surge} You gain a \plus1 bonus to \glossterm{power} with the \spell{vital surge} spell.
    ...
    \begin{feat}{Spell Focus: Weaponcraft}{Magical, Spell}
        ...
        \begin{ability}{Disable Weapon}[\glossterm{Swift}]
            Choose a weapon you created with the \spell{weaponcraft} ability.
        ...
        \ff[9]{Potent Weaponcraft} You gain a \plus1 bonus to \glossterm{power} with the \spell{weaponcraft} spell. 
        ...
        \ff[18]{Greater Potent Weaponcraft} The bonus from your \textit{potent weaponcraft} ability increases to \plus2.
    \end{feat}
