...
\end{longtabuwrapper}
    ...
    \begin{feat}{Acrobatics Specialization}{Skill}
        ...
        \ff[7]{Surface Tolerance} You reduce DR modifiers for surface conditions on Acrobatics checks to balance by 2.
        ...
        \ff[19]{Greater Surface Tolerance} The DR modifier reduction from your \textit{surface tolerance} ability increases to 5.
    ...
    \begin{feat}{Awareness Specialization}{Skill}
        ...
        \ff[7]{Distance Tolerance} You reduce DR modifiers for distance on Awareness rolls by 2.
        ...
        \ff[19]{Greater Distance Tolerance} The reduction of DR modifiers for distance increases to 5.
    ...
    \begin{feat}{Bluff Specialization}{Skill}
        ...
        \ff[19]{Greater Deceive Magic}[Magical] When you impersonate a creature, if your Bluff check is high enough, magical abilities treat you as if you were that creature.
    ...
    \begin{feat}{Brawler}{Combat}
        ...
        \ff[4]{Grapple Expertise} You gain a \plus2 bonus to \glossterm{accuracy} with the \textit{grapple} ability (see \pcref{Grapple}).
        ...
        \ff[16]{Greater Grapple Expertise} The bonus from your \textit{grapple expertise} ability increases to \plus3.
    ...
    \begin{feat}{Celestial Heritage}{Bloodline, Magical}
        ...
        \ff[19]{Greater Divine Favor} The bonuses from your \textit{divine favor} ability increase to \plus2.
    ...
    \begin{feat}{Class Versatility}{Class}
        ...
        \ff[13]{Expanded Versatility} You gain the \textit{versatile expertise} ability again.

        \ff[19]{Expanded Versatility} You gain the \textit{versatile expertise} ability again.
    \end{feat}
    ...
    \begin{feat}{Creature Handling Specialization}{Skill}
        ...
        \ff[4]{Sustained Pacify} You can sustain the \textit{pacify} ability from the Creature Handling skill as a minor action, rather than as a standard action (see \pcref{Pacify}).
        ...
        \ff[13]{Battleforged Training} You can teach a creature the Battleforged trick.
        ...
        \ff[19]{Rapid Pacify} You can use the \textit{pacify} ability from the Creature Handling skill as a minor action, rather than as a standard action.
    ...
    \begin{feat}{Devices Specialization}{Skill}
        ...
        \ff[19]{Durable Improvization} Devices you create with the \textit{improvise} ability last for twice as many uses before they break.
    ...
    \begin{feat}{Duelist}{Combat}
        ...
        \ff[19]{Legendary Duelist} You are treated as being threatened by one fewer creature than you actually are for the purpose of abilities from this feat.
    \end{feat}
    ...
    \begin{feat}{Eldritch Knight}{Spell}
        ...
        \ff[4]{Imbue Weapon}[Magical] When you cast a spell that affects a single target, you can use the \textit{imbue weapon} ability.
    ...
    \begin{feat}{Executioner}{Combat}
        ...
        \ff[7]{Blood Sense}[Magical] You automatically know the location of all \glossterm{bloodied} living creatures within 50 feet of you, regardless of concealment or invisibility.
        You must have \glossterm{line of effect} to a creature to see it in this way.

        \ff[10]{Greater Execution} You gain a \plus1d bonus to damage with the strike from your \textit{execution} ability.

        \ff[13]{Greater Purge the Weak} The accuracy bonus from your \textit{purge the weak} ability increases to \plus2.

        \ff[16]{Greater Blood Sense}[Magical] Your \textit{blood sense} ability allows you to know the location of all living creatures within range, not just bloodied living creatures.
        You must have \glossterm{line of effect} to a creature to see it.

        \ff[19]{Supreme Execution} The damage bonus from your \textit{greater execution} ability increases to \plus2d.
    ...
    \begin{feat}{Guardian}{Combat}
        ...
        \ff[7]{Defender} You gain a \plus2 bonus to \glossterm{threat}.

        \ff[10]{Redirection}[Magical] When you use your \textit{protect} ability, you can use the \textit{redirection} ability.
        ...
        \ff[13]{Certain Bind} You gain a \plus1 bonus to \glossterm{accuracy} with your \textit{binding strike} ability.

        \ff[13]{Greater Defender} The threat bonus from your \textit{defender} ability increases to \plus4.

        \ff[16]{Expanded Redirection}[Magical] When you use your \textit{redirection} ability, you redirect the effects of all attacks, not just \glossterm{strikes}.

        \ff[19]{Supreme Certain Bind} The accuracy bonus from your \textit{certain bind} ability increases to \plus3.

        \ff[19]{Supreme Defender} The bonus from your \textit{defender} ability increases to \plus6.
    ...
    \begin{feat}{Heal Specialization}{Skill}
        ...
        \ff[13]{Supreme Healing Touch} You can use your \textit{healing touch} ability without spending an \glossterm{action point}.

        \ff[13]{Greater Purging Touch} You can use your \textit{purging touch} ability without spending an \glossterm{action point}.

        \ff[16]{Supreme Specialization} The bonus from your \textit{specialization} ability increases to \plus6.

        \ff[19]{Lifesaver} You can stabilize dying creatures as a \glossterm{minor action}.
    \end{feat}
    ...
    \begin{feat}{Intimidate Specialization}{Skill}
        ...
        \ff[4]{Demoralizing Blow} You can use the \textit{demoralizing blow} ability as a standard action.
        ...
        \ff[7]{Frightening Demoralization} If you get a \glossterm{critical hit} when you use the \textit{demoralize} or \textit{demoralizing blow} abilities, the target is \frightened by you instead of being shaken.
    ...
    \begin{feat}{Jump Specialization}{Skill}
        ...
        \ff[4]{Instant Leap} You must move at least five feet before jumping to have a running start, rather than twenty feet (see \pcref{Running Start}).
        ...
        \ff[19]{Greater Instant Leap} You are always considered to have a running start when jumping, even when rebounding off of objects (see \pcref{Rebounding Leap}).
    ...
    \begin{feat}{Leadership}{Combat}
        ...
        \ff[10]{Greater Battle Command} The target of your \textit{battle command} ability also gains a \plus2 bonus to \glossterm{power} with \glossterm{mundane} abilities.
        ...
        \ff[19]{Supreme Battle Command} The power bonus from your \textit{greater battle command command} ability increases to \plus4.
    ...
    \begin{feat}{Martial Training}{Combat}
        ...
        \ff[13]{Greater Honed Strike} The damage bonus from your \textit{honed strike} ability increases to \plus2d.

        \ff[16]{Practiced Accuracy} You gain a \plus1 bonus to \glossterm{accuracy} with \glossterm{physical attacks}.

        \ff[19]{Equipment Training} You gain an additional \textit{equipment training} ability of your choice.

        \ff[19]{Supreme Honed Strike} The damage bonus from your \textit{honed strike} ability increases to \plus3d.
    \end{feat}
    ...
    \begin{feat}{Mystic Archer}{Casting, Magical}
        ...
        \ff[4]{Missile Storm} You can use the \textit{missile storm} ability as a standard action.
        ...
        \ff[7]{Guided Projectiles} Your attacks with projectiles ignore \glossterm{cover}, but not \glossterm{total cover}.

        \ff[10]{Imbue Detonating Projectile} When you cast a spell that affects an area and does not have the \glossterm{Attune} or \glossterm{Sustain} tags,
        ...
        \ff[13]{Phasing Projectiles}[Teleportation] When attacking with projectiles, you can ignore all physical obstacles in single five-foot span.
        ...
        \ff[16]{Greater Missile Storm} When you use your \textit{missile storm} ability, you may target any number of creatures.

        \ff[19]{Mystic Precision} You gain a \plus1 bonus to \glossterm{accuracy}.
    ...
    \begin{feat}{Sniper}{Combat}
        ...
        \ff[19]{Greater Sniper Shot} The power bonus from your \textit{sniper shot} ability increases to \plus8.
    ...
    \begin{feat}{Sphere Focus: Aeromancy}{Casting, Magical}
        ...
        \ff[19]{Supreme Personal Updraft} You gain a \glossterm{fly speed} equal to your \glossterm{base speed} (see \pcref{Flying}).
    \end{feat}
    ...
    \begin{feat}{Stealth Specialization}{Skill}
        ...
        \ff[7]{Movement Tolerance} Your penalties for moving while hiding are reduced by 2.
        ...
        \ff[19]{Greater Movement Tolerance} The reduction of penalties for moving increases to 5.
    ...
    \begin{feat}{Survival Specialization}{Skill}
        ...
        \ff[19]{Greater Rapid Tracker} If you use the \textit{track} ability as a \glossterm{minor action}, the check penalty is reduced to \minus5 instead of \minus10.
    ...
    \begin{feat}{Swim Specialization}{Skill}
        ...
        \ff[4]{Underwater Tolerance} You reduce your penalties for fighting underwater by 2, except for penalties to physical ranged attacks.
    ...
    \begin{feat}{Two-Weapon Fighting}{Combat}
        ...
        \ff[19]{Greater Two-Weapon Defense} The bonus from your \textit{two-weapon defense} ability increases to \plus2.
    \end{feat}
