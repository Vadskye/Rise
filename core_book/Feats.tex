...
\end{longcolumn}
    ...
    \begin{feat}{Twin-Weapon Fighting}{Combat}
        ...
        \begin{itemize}
            ...
            \item Two Weapons As One: When you make a dual strike, if you hit with one weapon, you gain a \plus4 accuracy bonus against the same target with the second weapon.
        \end{itemize}
