...
\end{longtabuwrapper}
    ...
    \begin{feat}{Intimidate Specialization}{Skill}
        ...
        \ff[1]{Demoralizing Blow} You can use the \textit{demoralizing blow} ability as a standard action.
    ...
    \begin{feat}{Sense Motive Specialization}{Skill}
        ...
        \ff[1]{Read Mind}[Magical] You can use the \textit{read mind} ability as a standard action.
