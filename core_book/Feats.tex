...
\end{longtablewrapper}
    ...
    \begin{feat}{Leadership}{Combat}
        ...
        \begin{freeability}{Bolster}[\abilitytag{Emotion}]
            One \glossterm{ally} within \medrange \glossterm{briefly} gains a \plus2 bonus to \glossterm{vital rolls} and can remove a \glossterm{condition}.
    ...
    \begin{feat}{Wardweaver}{Casting, Magical}
        ...
        \ff[3]{Barrier Spell} You learn a spell with the \abilitytag{Barrier} ability tag from any \glossterm{mystic sphere} that your \glossterm{magic source} gives access to, even if you do not have access to that mystic sphere.
        When you gain access to new spell ranks, you can change which Barrier spell you know.

        \ff[6]{Personal Ward} You gain a \plus1 bonus to your Armor defense.
        ...
        \ff[15]{Personal Ward} The bonus from your \textit{innate shield} ability increases to \plus2.
