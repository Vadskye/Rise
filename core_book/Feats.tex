...
\end{longtablewrapper}
    ...
    \begin{feat}{Battle Armory}{Combat}
        ...
        \ff[1]{Rapid Redraw} When you sheathe a weapon as a \glossterm{free action}, you can also draw a different weapon with that same hand as part of that action.
        In addition, sheathing and drawing weapons becomes a \glossterm{Swift} ability for you, so you can draw a weapon and attack with it in the same phase.
        ...
        \ff[6]{Versatile Force} You gain a \plus2 bonus to your \glossterm{mundane} \glossterm{power}.
