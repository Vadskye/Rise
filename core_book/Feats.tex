...
\begin{longtabuwrapper}
    \begin{longtabu}{>{\lcol}p{10em} >{\lcol}p{15em} >{\lcol}X >{\lcol}p{8em} >{\lcol}p{3em}}
        ...
        \featref{Blind-Fight} & Per 3 & Fight better when unable to see & Awareness, Style & \featpref{Blind-Fight} \\
...
\featpres Combat prowess 18, Dexterity 15.
\featben While in this style, you can dodge attacks more easily.
Whenever you are hit by a \glossterm{physical attack}, but before the effects of the attack are resolved, you can dodge it as a \glossterm{immediate action}.
If you do, the attack misses automatically, and you ignore its effects.
You must be aware of the attack to negate it in this way.
\stylereq None.
