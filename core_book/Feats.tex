...
\end{longtabuwrapper}
    ...
    \begin{feat}{Reaper}{Combat}
        ...
        \ff[1]{Cleave} If you get a \glossterm{critical hit} with a melee strike using a slashing or bludgeoning weapon during the \glossterm{action phase}, you can make an additional strike during the \glossterm{delayed action phase}.
