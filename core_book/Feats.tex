...
\end{longtablewrapper}
    ...
    \begin{feat}{Sphere Focus: Electromancy}{Casting, Magical}
        ...
        \ff[12]{Energetic Rush} You gain a \plus10 foot bonus to your land speed.
    ...
    \begin{feat}{Swiftrunner}{General}
        ...
        \ff[12]{Greater Sprinter} When you use the \textit{sprint} ability, you can move up to four times your movement speed.
