...
\end{longtabuwrapper}
    ...
    \begin{feat}{Sphere Focus: Aquamancy}{Casting, Magical}
        ...
        \ff[1]{Astromancy Focus} You gain a \plus1 bonus to \glossterm{accuracy} with abilities from the \sphere{aquamancy} \glossterm{mystic sphere}. 
        ...
        \ff[15]{Greater Astromancy Focus} The bonus from your \textit{aquamancy focus} ability increases to \plus2.
    ...
    % TODO: reduce level of power upgrades
