...
\end{longtablewrapper}
    ...
    \begin{feat}{Celestial Heritage}{Bloodline, Magical}
        ...
        \begin{freeability}{Holy Smite}[Magical]
            ...
            Because this is a \glossterm{magical} ability, you use your Willpower to determine your damage instead of your Strength (see \pcref{Attribute Dice Increments}).
        ...
        Each \glossterm{ally} in the radius of brilliant illumination regains 1d4 \glossterm{hit points}.
    ...
    \begin{feat}{Regenerator}{General}
        ...
        \begin{instantability}{Regenerative Recovery}
            ...
            Unlike normal, your Strength does not modify this dice pool (see \pcref{Attribute Dice Increments}).
