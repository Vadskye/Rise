...
\end{longtabuwrapper}
    ...
    \begin{feat}{Boongiver}{types}
        ...
        \ff[1]{Reciprocal Boon} Whenever you cast a spell with a duration of Attunement (shared) that targets a single creature other than yourself, you can use this ability.
