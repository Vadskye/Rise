...
\end{longtabuwrapper}
    ...
    \begin{feat}{Null}{General}
        ...
        Instead, each time you would gain a legacy item upgrade, you instead increase your maximum \glossterm{action points} at the start of each session.
    ...
    \begin{feat}{Sphere Focus: Channel Divinity}{Casting, Magical}
        ...
        \ff[4]{Divine Intervention} You gain a \plus5 bonus to any roll that you use the \textit{desperate exertion} ability on (see \pcref{Desperate Exertion}).
        ...
        \ff[13]{Divine Servant} Once per day, if you pray to your deity in an area sacred to your deity, you can regain a spent \glossterm{action point} if you have no \glossterm{action points} remaining.
