...
\end{longtabuwrapper}
    ...
    \begin{feat}{Blindfighter}{Combat}
        ...
        \ff[16]{Greater Blind Feint} When you use your \glossterm{blind feint} ability, the target is \glossterm{unaware} of the attack.
    ...
    \begin{feat}{Celestial Heritage}{Bloodline, Magical}
        ...
        \ff[15]{Greater Empowered Blessing} The damage bonus from your \glossterm{holy blessing} ability increases to \plus4d.
    ...
    \begin{feat}{Conjurer}{Magical, Spell}
        ...
        \ff[3]{Lesser Astral Spell Transit} Your attacks with spells ignore \glossterm{cover}, but not \glossterm{total cover}.
        ...
        \ff[15]{Greater Fortified Manifestations} Objects and creatures you create with \glossterm{Manifestation} abilities have damage reduction equal to your spellpower.

        \ff[17]{Greater Astral Spell Transit} When determining whether you have \glossterm{line of effect} to a particular location with a spell, you can ignore a single solid obstacle up to five feet thick.
    ...
    \begin{feat}{Eldritch Knight}{General, Spell}
        ...
        \ff[1]{Lesser Armor Tolerance} You reduce your chance of arcane spell failure from wearing armor by 10\%.
        ...
        \ff[16]{Greater Armor Tolerance} The reduction of arcane spell failure increases to 30\%. 
    ...
    \begin{feat}{Escape Artist Specialization}{Skill}
        ...
        \ff[12]{Greater Rapid Escape} You can escape bindings and grapples as a \glossterm{swift action}.
        ...
        \ff[18]{Greater Escape Magic}[Magical] You can use your \textit{escape magic} ability as a \glossterm{swift action}.
    \end{feat}
    ...
    \begin{feat}{Heal Specialization}{Skill}
        ...
        \ff[14]{Greater Lifesaver} You can stabilize dying creatures as a \glossterm{swift action}.
    ...
    \begin{feat}{Reaper}{Combat}
        ...
        If you do, you can make a melee \glossterm{strike} against each of up to three adjacent creatures.
        ...
        If you do, you can move up to half your movement speed in a straight line.
        Choose either the right or left side of the line.
        You can make a melee \glossterm{strike} against each creature and object on that side of the line that you threaten at any point during your movement.
        ...
        \ff[8]{Wide Sweep} When you use your \textit{sweeping strike} ability, you can target up to five adjacent creatures.
        ...
        \ff[14]{Greater Reaping Charge} You can move up to your full movement speed when you use your \textit{reaping charge} ability, rather than half your movement speed.
    ...
    \begin{feat}{Sprint Specialization}{Skill}
        ...
        \ff[10]{Greater Swiftness} The speed bonus from your \textit{swift} ability increases to \plus20 feet.
