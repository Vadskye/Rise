...
\end{longtabuwrapper}
    ...
    \begin{feat}{Abjurer}{Magical, Spell}
        ...
        \begin{ability}{Counterspell}
            ...
            If the target is casting a spell, and your maximum spell level with abjuration spells at least as high as their spell's level, their spell has no effect when it resolves.
        \end{ability}
    ...
    \begin{feat}{Enchanter}{Magical, Spell}
        ...
        \ff[3]{Mind Scour} You gain the \textit{mind scour} ability.
        \begin{ability}{Mind Scour}[\glossterm{Mind}]
            As a \glossterm{standard action}, you can spend an \glossterm{action point} to use this ability.
    ...
    \begin{feat}{Illusionist}{Magical, Spell}
        ...
        \ff[3]{Reflexive Illusion} You gain a \plus1 bonus to Disguise, Sleight of Hand, and Stealth.
        ...
        \ff[11]{Greater Reflexive Illusion} The bonus from your \textit{reflexive illusion} ability increases to \plus2.
    ...
    \begin{feat}{Reaper}{Combat}
        ...
        \ff[2]{Sweeping Blow} You gain the \textit{sweeping blow} ability.
    ...
    \begin{feat}{Transmuter}{Magical, Spell}
        ...
        \ff[3]{Alter Self} You gain the \textit{alter self} ability.
        ...
        \ff[5]{Alter Object} You gain the \textit{alter object} ability.
        ...
        \ff[9]{Alter Poison} You gain the \textit{alter poison} ability.
