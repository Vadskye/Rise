...
\end{longtabuwrapper}
    ...
    \begin{feat}{Sphere Focus: Aquamancy}{Casting, Magical}
        ...
        \ff[3]{Greater Create Water} When you use the \spell{create water} cantrip, you can create up to one gallon of water per \glossterm{power}.
        ...
        \ff[18]{Supreme Create Water} When you use the \spell{create water} cantrip, you can create up to ten gallons of water per \glossterm{power}.
    \end{feat}
    ...
    \begin{feat}{Sphere Focus: Bless}{Casting, Magical}
        ...
        \ff[1]{Bless Focus} You gain a \plus1 bonus to \glossterm{accuracy} with abilities from the \sphere{bless} \glossterm{mystic sphere}.

        \ff[6]{Spell} You learn a spell from the \sphere{bless} \glossterm{mystic sphere}.
        When you gain access to a new spell level, you can change which spell you know from that \glossterm{mystic sphere}.

        \ff[15]{Greater Bless Focus} The bonus from your \textit{bless focus} ability increases to \plus2.
    \end{feat}
    ...
    \begin{feat}{Sphere Focus: Scry}{Casting, Magical}
        \featpre Access to the \sphere{Scry} \glossterm{mystic sphere}.

        \ff[1]{Scry Focus} You gain a \plus1 bonus to \glossterm{accuracy} with abilities from the \sphere{scry} \glossterm{mystic sphere}.

        \ff[6]{Spell} You learn a spell from the \sphere{scry} \glossterm{mystic sphere}.
        When you gain access to a new spell level, you can change which spell you know from that \glossterm{mystic sphere}.

        \ff[15]{Greater Scry Focus} The bonus from your \textit{scry focus} ability increases to \plus2.
    \end{feat}
