...
\section{Gaining Feats}
    ...
    \subsection{Species Bonus Feats}\label{Species Bonus Feats}
        ...
        \subsubsection{Uncommon Species}
            ...
            \parhead{Animal Hybrid} Any feat strongly associated with the chosen animal. For example, a hybrid shark might choose from Awareness Specialization, Survival Specialization, Swift, or Swim Specialization. A hybrid wolf might choose from Awareness Specialization, Rapid Reaction, Stealth Specialization, Survival Specialization, or Swift.

            \parhead{Awakened Animal} Any feat strongly associated with the chosen animal. For example, an awakened cat might choose from Awareness Specialization, Climb Specialization, Flexibility Specialization, Rapid Reaction, Stealth Specialization, or Swift.
            ...
            \parhead{Kit} Skill Specialization: Balance, Skill Specialization: Deception, Skill Specialization: Social Insight, Skill Specialization: Stealth, Swift.
            ...
            \parhead{Orc} Intimidate Specialization, Toughnes, or any Combat feat (see \pcref{Combat Feats}).
...
\end{longtablewrapper}
    ...
    \begin{feat}{Duelist}{Combat}
        ...
        \ff[3]{Defensive Stance} You gain a \plus1 bonus to Armor defense as long as you wield a melee weapon.
    ...
    \begin{feat}{Leadership}{Combat}
        ...
        \ff[9]{Inspiring Presence} Your \glossterm{allies} within a \arealarge \glossterm{emanation} from you gain a \plus1 bonus to Mental defense.
        ...
        \ff[18]{Greater Inspiring Presence} The bonus from your \textit{inspiring presence} ability increases to \plus2.
    ...
    \begin{feat}{Spellsword}{Magical, Spell}
        ...
        \ff[3]{Magical Strikes} Whenever you make a melee \glossterm{strike}, you can choose to treat that as a \glossterm{magical} ability.
        This allows you to use your \glossterm{power} with magical abilities to determine your damage.
