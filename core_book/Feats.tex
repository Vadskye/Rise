...
\end{longcolumn}
    ...
    \begin{feat}{Brawler}{Combat}
        ...
        \ff[1]{Brawling Expertise} You gain a \plus1 bonus to \glossterm{accuracy} with all \abilitytag{Brawling} abilities (see \pcref{Special Combat Abilities}).
        ...
        \ff[12]{Brawling Expertise+} The bonus from your \textit{brawling expertise} ability increases to \plus3.
