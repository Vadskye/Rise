...
\end{longtablewrapper}
    ...
    \begin{feat}{Boongiver}{Casting, Magical}
        ...
        \ff[12]{Greater Boon Lore} The number of additional \abilitytag{Attune} spells you gain from your \textit{boon lore} ability increases to two.
    ...
    \begin{feat}{Celestial Heritage}{Bloodline, Magical}
        ...
        \ff[3]{Celestial Soul} You gain a \plus5 bonus to your \glossterm{resistance} against \glossterm{energy damage}.
        ...
        \ff[9]{Greater Celestial Soul} The bonus from your \textit{celestial soul} ability increases to \plus10.
        ...
        \ff[15]{Supreme Celestial Soul} The bonus from your \textit{celestial soul} ability increases to \plus20.
    ...
    \begin{feat}{Deception Specialization}{Skill}
        ...
        \begin{freeability}{Deceive Magic}[\abilitytag{Swift}]
            ...
            The attack takes a \minus10 accuracy penalty.
    ...
    \begin{feat}{Draconic Heritage}{Bloodline}
        ...
        \ff[18]{Greater Draconic Flight} The height limit from your \textit{draconic flight} ability increases to 60 feet.
    ...
    \begin{feat}{Endurance Specialization}{Skill}
        ...
        Success means that you do not increase your \glossterm{fatigue level} for using the ability.
        Failure means you increase your \glossterm{fatigue level} for using the ability like normal.
    ...
    \begin{feat}{Medicine Specialization}{Skill}
        ...
        \begin{instantability}{Healing Touch}
            ...
            The target regains 2d6 \add half \glossterm{power} \glossterm{hit points}.
    ...
    \begin{feat}{Null}{General}
        ...
        \ff[3]{Mundane Resilience} You gain a \plus4 bonus to your \glossterm{resistance} against both \glossterm{physical damage} and \glossterm{energy damage}.
    ...
    \begin{feat}{Regenerator}{General}
        ...
        \begin{instantability}{Regenerative Recovery}
            ...
            You regain \glossterm{hit points} equal to 1d10 plus half your \glossterm{power}.
            After you use this ability, you cannot use it or any other \abilitytag{Healing} ability until after the end of the next round.
        ...
        \ff[6]{Regenerative Rest} When you take a \glossterm{short rest}, you can remove a single \glossterm{vital wound} affecting you.
        If you do, you increase your \glossterm{fatigue level} by three.

        \ff[9]{Greater Diehard} The bonus from your \textit{diehard} ability increases to \plus3.

        \ff[12]{Greater Regenerative Rest} Your \textit{regenerative rest} ability only causes you to increase your fatigue level by two.
        ...
        \ff[21]{Supreme Regenerative Rest} Your \textit{regenerative rest} ability only causes you to increase your fatigue level by one.
    \end{feat}
    ...
    \begin{feat}{Sphere Focus: Aeromancy}{Casting, Magical}
        ...
        \ff[12]{Greater Favorable Winds} The bonuses from your \textit{favorable winds} ability increase to \plus2.
        ...
        \ff[18]{Supreme Personal Updraft} You gain a \glossterm{fly speed} equal to your \glossterm{base speed} with a maximum height of 120 feet (see \pcref{Flying}).
        At the start of each phase, you can increase your \glossterm{fatigue level} by one to ignore this height limit until the end of the round.
    \end{feat}
    ...
    \begin{feat}{Sphere Focus: Channel Divinity}{Casting, Magical}
        ...
        \ff[6]{Divine Servant} Once per \glossterm{long rest}, if you pray to your deity in an area sacred to your deity, you can reset your \glossterm{fatigue level} to 0.
    ...
    \begin{feat}{Sphere Focus: Enchantment}{Casting, Magical}
        ...
        \ff[6]{Mind Fragments} When you use \abilitytag{Compulsion} abilities, you can affect creatures that are immune to \abilitytag{Compulsion} abilities due to not having a mind.
    ...
    \begin{feat}{Sphere Focus: Pyromancy}{Casting, Magical}
        ...
        \ff[3]{Fire Resistance} You gain a bonus equal to your level to your \glossterm{resistance} against fire damage.
    ...
    \begin{feat}{Stealth Specialization}{Skill}
        ...
        \ff[12]{Greater Movement Tolerance} Your penalties for moving while hiding are reduced by 10.
