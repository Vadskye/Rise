...
\end{longtablewrapper}
    ...
    \begin{feat}{Deception Specialization}{Skill}
        ...
        \begin{freeability}{Dual Speech}[\abilitytag{Sustain} (minor)]
            ...
            \featlevel{15} You can also speak with a fourth voice, using separate words and vocal patterns.
        \end{freeability}
    ...
    \begin{feat}{Duelist}{Combat}
        ...
        \ff[21]{Greater Defensive Stance} The bonus from your \textit{defensive stance} ability increases to \plus3.
    \end{feat}
    ...
    \begin{feat}{Executioner}{Combat}
        ...
        \ff[21]{Supreme Bloody Resilience} The Fortitude defense bonus from your \textit{bloody resilience} ability increases to \plus4.
        % TODO: is this the right value?
        In addition, the hit point bonus increases to \plus24.
    \end{feat}
    ...
    \begin{feat}{Shieldbearer}{Combat}
        ...
        \ff[21]{Supreme Forceful Block} The penalty from your \textit{forceful block} ability increases to \minus5.
    \end{feat}
    ...
    \begin{feat}{Sphere Focus: Telekinesis}{Casting, Magical}
        ...
        \ff[21]{Greater Levitation} Your \glossterm{maneuverability} with the fly speed from your \textit{angelic flight} ability increases to perfect (see \pcref{Flying Maneuverability}).
    \end{feat}
    ...
    \begin{feat}{Sphere Focus: Verdamancy}{Casting, Magical}
        ...
        \ff[18]{Supreme Residual Undergrowth} The undergrowth you create with your \textit{residual undergrowth} ability does not impede the movement of your \glossterm{allies}.
    ...
    \begin{feat}{Whirlwind Warrior}{Combat}
        ...
        \ff[6]{Wind Dance} You gain a \plus1 bonus to Armor defense.
        ...
        \ff[15]{Greater Wind Dance} The bonus from your \textit{wind dance} ability increases to \plus2.
