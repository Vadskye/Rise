...
\end{longtablewrapper}
    ...
    \begin{feat}{Endurance Specialization}{Skill}
        ...
        If you gain a new vital wound, you immediately suffer the full effect of the previous vital wound, though you can delay the new vital wound normally.

        \ff[16]{Supreme Specialization} The bonus from your \textit{specialization} ability increases to \plus9.

        \ff[19]{Multiple Delay} You can delay your two most recent \glossterm{vital wounds} and \glossterm{conditions} with your \textit{delay vital wound} and \textit{delay condition} abilities.
    \end{feat}
    ...
    \begin{feat}{Heal Specialization}{Skill}
        ...
        \begin{freeability}{Healing Touch}[\glossterm{Life}]
            One \glossterm{ally} within your \glossterm{reach} gains a \plus2 bonus to its most recent \glossterm{vital roll}.
    ...
    \begin{feat}{Sphere Focus: Terramancy}{Casting, Magical}
        ...
        \ff[13]{Body of Stone} You gain a \plus1 bonus to \glossterm{vital rolls}.
