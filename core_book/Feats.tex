...
\end{longtabuwrapper}
    ...
    \begin{feat}{Executioner}{Combat}
        ...
        \ff[14]{Greater Bloodfeeder}[Life, Magical] Whenever a creature dies, if you dealt damage to it that round and you used your \textit{strip the flesh} ability on it since the last time it took a \glossterm{short rest}, you regain an \glossterm{action point}.
