...
\begin{longtabuwrapper}
    \begin{longtabu}{>{\lcol}p{10em} >{\lcol}p{15em} >{\lcol}X >{\lcol}p{8em} >{\lcol}p{3em}}
        ...
        \featref{Charming Wild Speech}  & Druid 7, wild speech              & Charm target with wild speech & \tdash & \featpref{Charming Wild Speech} \\
            \tind \featref{Dominating Wild Speech}  & Druid 15, Charming Wild Speech       & Dominate target with wild speech & \tdash & \featpref{Dominating Wild Speech} \\
        ...
        \featref{Elemental Speech}      & Druid 9, wild speech              & Speak with an element & \tdash & \featpref{Elemental Speech} \\
        ...
        \featref{Plant Speech}          & Druid 5, wild speech              & Speak with plants & \tdash & \featpref{Plant Speech} \\
        ...
        \featref{Vermin Speech}         & Druid 3, wild speech              & Speak with vermin & \tdash & \featpref{Vermin Speech} \\
...
\featpres Druid level 7, wild speech ability.
...
\featpres Druid level 15, wild speech ability, Charming Wild Speech.
...
\featpres Druid level 9, wild speech ability.
...
\featpres Druid level 5, wild speech ability.
...
\featpres Druid level 3, wild speech ability.
