...
\end{longtablewrapper}
    ...
    \begin{feat}{Endurance Specialization}{Skill}
        ...
        \ff[12]{Greater Delay Vital Wound} When you use the \textit{delay vital wound} ability, the \glossterm{difficulty value} does not increase for each subsequent round (see \pcref{Delay Vital Wound}).

        \ff[15]{Supreme Specialization} The bonus from your \textit{specialization} ability increases to \plus7.

        \ff[18]{Greater Delay Condition} You can delay up to two \glossterm{conditions} with your \textit{delay condition} ability.

        \ff[21]{Supreme Delay Vital Wound} You can delay up to two \glossterm{vital wounds} with your \textit{delay vital wound} ability.
    \end{feat}
    ...
    \begin{feat}{Medicine Specialization}{Skill}
        ...
        \begin{instantability}{Purging Touch}
            Instant
            \rankline
            Make a Medicine check on yourself or an \glossterm{ally} within your \glossterm{reach}.
            ...
            \rankline
            \featlevel{12} You can target an additional ally within your reach.
            \featlevel{18} You can target an additional ally within your reach.
        \end{instantability}
