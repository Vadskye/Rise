...
\end{longtablewrapper}
    ...
    \begin{feat}{Sphere Focus: Channel Divinity}{Casting, Magical}
        ...
        \ff[6]{Font of Divinity} Choose a spell with the \abilitytag{Attune} (self) tag from the \sphere{channel divinity} mystic sphere.
    ...
    \begin{feat}{Sphere Focus: Fabrication}{Casting, Magical}
        ...
        In addition, you can cast that spell with the \abilitytag{Sustain} (minor) tag instead of the \abilitytag{Attune} (self) tag.
