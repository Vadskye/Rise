...
\begin{longtabuwrapper}
    \begin{longtabu}{>{\lcol}p{10em} >{\lcol}p{15em} >{\lcol}X >{\lcol}p{8em} >{\lcol}p{3em}}
        ...
        \featref{Draconic Heritage} & \tdash & Resist damage from chosen dragon's energy type & Bloodline, Draconic & \featpref{Draconic Heritage} \\
        ...
        \featref{Fae Heritage} & \tdash & Gain minor spell-like abilities & Bloodline & \featpref{Fae Heritage} \\
        ...
        \featref{Insightful Fighter}    & Adaptive style                    & Use Perception for adaptive style (and battlemaster) & \tdash & \featpref{Insightful Fighter} \\
        ...
        \featref{Legendary Disguise} & Disguise 15 ranks & Alter magical auras with disguise & \tdash & \featpref{Legendary Disguise} \\
...
\begin{longtabuwrapper}
    \begin{longtabu}{>{\lcol}p{10em} >{\lcol}p{15em} >{\lcol}X >{\lcol}p{8em} >{\lcol}p{3em}}
        ...
        \featref{Hydra Strike} & Str 5, Dex 5, Con 5 & Attack all defenses for bonus damage & \tdash & \featpref{Hydra Strike} \\
