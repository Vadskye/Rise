...
\section{Types Of Feats}
    ...
    \parhead{Magic} Magic feats improve your spellcasting abilities.
    All magic feats except for the Ritual Caster feat are useless to characters who cannot cast spells (see \featpcref{Ritual Caster}).
...
% Feat names must follow ``have'', ``are (a)'', or ``can''.
        \begin{longtabuwrapper}
            \begin{longtabu}{>{\lcol}p{10em} >{\lcol}p{15em} >{\lcol}X >{\lcol}p{8em} >{\lcol}p{3em}}
                ...
                \featref{Spellbreaker} & 9th level, Wil 9 & Gain spell resistance & \tdash & \featpref{Spellbreaker} \\
                ...
                \tb{Magic Feats}\label{Magic Feats} & \tb{Prerequisites} & \tb{Benefit} & \tb{Feat Types} & \tb{Page} \\
                ...
                \featref{Acrobatics Mastery} & Acrobatics 4 & Improve Acrobatics checks & \tdash & \featpref{Acrobatics Mastery} \\
                \featref{Awareness Mastery} & Awareness 4 & Improve Awareness checks & \tdash & \featpref{Awareness Mastery} \\
                \featref{Bluff Mastery} & Bluff 4 & Improve Bluff checks & \tdash & \featpref{Bluff Mastery} \\
                \featref{Climb Mastery} & Climb 4 & Improve Climb checks & \tdash & \featpref{Climb Mastery} \\
                \featref{Craft Magic Item} & Craft (any) 4 & Gain ability to craft magic items & \tdash & \featpref{Craft Magic Item} \\
                \featref{Craft Mastery} & Craft 4 & Improve Craft checks & \tdash & \featpref{Craft Mastery} \\
                \featref{Creature Handling Mastery} & Creature Handling 4 & Improve Creature Handling checks & \tdash & \featpref{Creature Handling Mastery} \\
                \featref{Device Mastery} & Devices 4 & Improve Devices checks & \tdash & \featpref{Device Mastery} \\
                \featref{Disguise Mastery} & Disguise 4 & Improve Disguise checks & \tdash & \featpref{Disguise Mastery} \\
                \featref{Escape Artist Mastery} & Escape Artist 4 & Improve Escape Artist checks & \tdash & \featpref{Escape Artist Mastery} \\
                \featref{Heal Mastery} & Heal 4 & Improve Heal checks & \tdash & \featpref{Heal Mastery} \\
                \featref{Inspiring Performer} & Perform 4 & Perform to improve abilities of allies & Performance & \featpref{Inspiring Performer} \\
                \featref{Intimidate Mastery} & Intimidate 4 & Improve Intimidate checks & \tdash & \featpref{Intimidate Mastery} \\
                \featref{Jump Mastery} & Jump 4 & Improve Jump checks & \tdash & \featpref{Jump Mastery} \\
                \featref{Knowledge Mastery} & Knowledge (any) 4 & Improve Knowledge checks & \tdash & \featpref{Knowledge Mastery} \\
                \featref{Linguistic Mastery} & Linguistics 4 & Improve Linguistics checks & \tdash & \featpref{Linguistic Mastery} \\
                ...
                \featref{Persuasion Mastery} & Persuasion 4 & Improve Persuasion checks & \tdash & \featpref{Persuasion Mastery} \\
                \featref{Perform Mastery} & Perform 4 & Improve Perform checks & \tdash & \featpref{Perform Mastery} \\
                \featref{Ride Mastery} & Ride 4 & Improve Ride checks & \tdash & \featpref{Ride Mastery} \\
                \featref{Sense Motive Mastery} & Sense Motive 4 & Improve Sense Motive checks & \tdash & \featpref{Sense Motive Mastery} \\
                \featref{Skill Savant} & \tdash & Gain skill points & \tdash & \featpref{Skill Savant} \\
                \featref{Sleight of Hand Mastery} & Sleight of Hand 4 & Improve Sleight of Hand checks & \tdash & \featpref{Sleight of Hand Mastery} \\
                \featref{Spellcraft Mastery} & Spellcraft 4 & Improve Spellcraft checks & \tdash & \featpref{Spellcraft Mastery} \\
                \featref{Sprint Mastery} & Sprint 4 & Improve Sprint checks & \tdash & \featpref{Sprint Mastery} \\
                \featref{Stealth Mastery} & Stealth 4 & Improve Stealth checks & \tdash & \featpref{Stealth Mastery} \\
                \featref{Sprint Mastery} & Sprint 4 & Improve Sprint checks & \tdash & \featpref{Sprint Mastery} \\
                \featref{Supreme Inspiration} & 9th level, Perform 9 & Perform to greatly inspire allies & \tdash & \featpref{Supreme Inspiration} \\
                \featref{Survival Mastery} & Survival 4 & Improve Survival checks & \tdash & \featpref{Survival Mastery} \\
                \featref{Swim Mastery} & Swim 4 & Improve Swim checks & \tdash & \featpref{Swim Mastery} \\
...
\section{Feat Descriptions}
    ...
    At 7th level, if you have 6 ranks in Acrobatics, you gain a \plus5 bonus to Acrobatics checks.

    At 11th level, if you have 9 ranks in Acrobatics, you can balance on surfaces that cannot support your weight.
    ...
    \feat{All Energy Becomes One}{Class}
    ...
    At 7th level, if you have 6 ranks in Awareness, you gain a \plus5 bonus to Awareness checks.
    ...
    \featpre Bluff 4 ranks.
    \featben Whenever you make a Bluff check, you may roll twice and take the higher result.

    At 3rd level, \tdash.

    At 7th level, if you have 6 ranks in Bluff, you gain a \plus5 bonus to Bluff checks.

    At 11th level, if you have 9 ranks in Bluff, your lies can change how creatures perceive reality.
    ...
    \feat{Celestial Apotheosis}{Bloodline}
    ...
    \feat{Celestial Heritage}{Bloodline}
    ...
    \feat{Celestial Spell Conduit}{Bloodline}
    ...
    At 11th level, if you have 9 ranks in Climb, you can climb surfaces that are perfectly smooth.
    ...
    \feat{Controlling Wild Speech}{Class}
    ...
    At 11th level, if you can cast 4th level spells and have 9 ranks in Spellcraft, your spell does not need to have the same school or ability tags as the target's spell to force a spellpower check.

    At 15th level, if you can cast 6th level spells and have 11 ranks in Spellcraft, you may counter up to five creatures within \rngmed range of you at once.
    ...
    At 11th level, if you have 9 ranks in any Craft skill, it takes you one hour per 500 gp of material components to create a magic item. % 5000-18500 gp, 10-37 hrs

    At 15th level, if you have 11 ranks in any Craft skill, it takes you one hour per 2,500 gp of material components to create a magic item. % 27500-200000 gp, 11-80 hrs
    ...
    At 7th level, if you have 6 ranks in Craft, you gain a \plus5 bonus to Craft checks.

    At 11th level, if you have 9 ranks in Craft, \tdash.

    \feat{Creature Handling Mastery}{Skill}
    \featpre Creature Handling 4 ranks.
    ...
    At 7th level, if you have 6 ranks in Creature Handling, you gain a \plus5 bonus to Creature Handling checks.

    At 11th level, if you have 9 ranks in Creature Handling, you can pacify and push creatures as a swift action.
    ...
    \featpre Devices 4 ranks.
    \featben Whenever you make a Devices check, you may roll twice and take the higher result.

    At 3rd level, \tdash.

    At 7th level, if you have 6 ranks in Devices, you gain a \plus5 bonus to Devices checks.

    At 11th level, if you have 9 ranks in Devices, you can disable spell effects on objects or areas as if they were merely complex devices.
    ...
    At 7th level, if you have 6 ranks in Disguise, you gain a \plus5 bonus to Disguise checks.
    ...
    At 15th level, your scales become more pronounced, increasing the bonus to Armor defense to \plus2.
    ...
    At 7th level, if you have 6 ranks in Escape Artist, you gain a \plus5 bonus to Escape Artist checks.

    At 11th level, if you have 9 ranks in Escape Artist, you can attempt to escape from magic itself, slipping hostile spells off of your body so they dissipate harmlessly.
    ...
    If no dice would be rolled, you simply gain a \plus1 bonus to damage.
    ...
    At 11th level, if you know a 4th level or higher Evocation spell, your damage reduction from this feat increases to twice your spellpower.
    ...
    At 11th level, if you have 9 ranks in Intimidate, you can inspire fear in this way once per round without spending an action.
    ...
    At 7th level, if you have 6 ranks in Heal, you gain a \plus5 bonus to Heal checks.

    At 11th level, if you have 9 ranks in Heal, you can heal wounds with incredible speed.
    ...
    \feat{Inspiring Performer}{Performance, Skill}
    ...
    In addition, it gains a bonus defensive \glossterm{legend point} which lasts as long as you sustain the performnace.
    If the legend point has not been used when you end the performance, it is wasted.
    ...
    At 7th level, if you have 6 ranks in Intimidate, you gain a \plus5 bonus to Intimidate checks.

    At 11th level, if you have 9 ranks in Intimidate, you can demoralize creatures as a \glossterm{swift action}.

    \feat{Jump Mastery}{Skill}
    \featpre Jump 4 ranks.
    ...
    At 7th level, if you have 6 ranks in Jump, you gain a \plus5 bonus to Jump checks.

    At 11th level, if you have 9 ranks in Jump, your maximum horizontal distance when leaping is equal to twice your check result, rather than being equal to your check result.
    ...
    At 7th level, if you have 6 ranks in any Knowledge skill, you gain a \plus5 bonus to all Knowledge checks.

    At 11th level, if you have 9 ranks in any Knowledge skill, you gain a \plus2 bonus on accuracy, checks, and defenses against non-humanoid creatures you identify with a successful Knowledge check.

    \feat{Legendary Speed}{Combat, Style}
    \featpres 13th level, Dexterity 12.
    \featben You can make a \glossterm{strike} as a swift action.

    At 19th level, if you have 15 Dexterity, you can make an additional strike whenever you make a \glossterm{standard attack}.
    ...
    \featpre Linguistics 4 ranks.
    \featben Whenever you make a Linguistics check, you may roll twice and take the higher result.

    At 3rd level, \tdash.

    At 7th level, if you have 6 ranks in Linguistics, you gain a \plus5 bonus to Linguistics checks.

    At 11th level, if you have 9 ranks in Linguistics, you can speak, read, and understand all languages.
    ...
    At 11th level, you gain \glossterm{spell resistance} equal to 10 \add your level.
    ...
    \feat{Mesmerizing Performer}{Performance, Skill}
    ...
    \feat{Mocking Performer}{Performance, Skill}
    \featpre Perform (any) 4 ranks.
    ...
    At 7th level, you learn how to taunt your foes to attack a creature of your choice.
    ...
    At 11th level, you can affect a number of creatures with \textit{mocking performance} equal to one fifth of your Perform check result.

    At 15th level, you can affect a number of creatures with \textit{demoralizing performance} equal to one fifth of your Perform check result.

    At 19th level, you can affect a number of creatures with \textit{taunting performance} equal to one fifth of your Perform check result.
    ...
    \featpre Persuasion 4 ranks.
    \featben Whenever you make a Persuasion check, you may roll twice and take the higher result.

    At 3rd level, \tdash.

    At 7th level, if you have 6 ranks in Persuasion, you gain a \plus5 bonus to Persuasion checks.

    At 11th level, if you have 9 ranks in Persuasion, you can compel creatures to obey your suggestions.
    ...
    At 7th level, if you have 6 ranks in any Perform skill, you gain a \plus5 bonus to Disguise checks.
    ...
    At 7th level, if you have 6 ranks in Ride, you gain a \plus5 bonus to Ride checks.

    At 11th level, if you have 9 ranks in Ride, you can attempt to ride unwilling creatures.
    ...
    \featpre Sense Motive 4 ranks.
    \featben Whenever you make a Sense Motive check, you may roll twice and take the higher result.

    At 3rd level, \tdash.

    At 7th level, if you have 6 ranks in Sense Motive, you gain a \plus5 bonus to Sense Motive checks.

    At 11th level, if you have 9 ranks in Sense Motive, you can read the minds of creatures.
    ...
    \featpre Sleight of Hand 4 ranks.
    \featben Whenever you make a Sleight of Hand check, you may roll twice and take the higher result.

    At 3rd level, \tdash.

    At 7th level, if you have 6 ranks in Sleight of Hand, you gain a \plus5 bonus to Sleight of Hand checks.

    At 11th level, if you have 9 ranks in Sleight of Hand, you can hide objects in impossible ways.
    ...
    \feat{Spellbreaker}{General}
    \featpres 9th level, Willpower 9.
    \featben You gain \glossterm{spell resistance} equal to 10 \add your Willpower.

    At 15th level, if you have 12 Willpower, you can reflect spells.
    When you resist a \glossterm{targeted spell} with this spell resistance, you can choose for the spell to be reflected back at the caster.
    ...
    \feat{Spellcasting Versatility}{Magic}
    ...
    \featpre Spellcraft 4 ranks.
    \featben Whenever you make a Spellcraft check, you may roll twice and take the higher result.

    At 3rd level, \tdash.

    At 7th level, if you have 6 ranks in Spellcraft, you gain a \plus5 bonus to Spellcraft checks.

    At 11th level, if you have 9 ranks in Spellcraft, you gain a \plus2 bonus on accuracy, checks, and defenses against spells and magical effects you identify with a successful Spellcraft check.

    \feat{Spellgift}{General}
    ...
    \feat{Spellwoven Performance}{Magic, Skill}
    \featpres 5th level, 1st level spells, any Performance feat.
    \featben You can cast spells while sustaining a performance, including for performance abilities (see \pcref{Performace Feats}).
    ...
    At 7th level, if you have 6 ranks in Sprint, you gain a \plus5 bonus to Sprint checks.

    At 11th level, if you have 9 ranks in Sprint, you can sprint for a number of minutes equal to twice your Constitution (minimum 2).
    After that time, you must rest for 5 minutes before you can sprint again.

    \feat{Stealth Mastery}{Skill}
    \featpre Stealth 4 ranks.
    ...
    At 7th level, if you have 6 ranks in Stealth, you gain a \plus5 bonus to Stealth checks.

    At 11th level, if you have 9 ranks in Stealth, you can use the Stealth skill to hide even while being observed.
    ...
    \feat{Supreme Inspiration}{Performance, Skill}
    ...
    At 7th level, if you have 6 ranks in Survival, you gain a \plus5 bonus to Survival checks.

    At 11th level, if you have 9 ranks in Survival, you are immune to harmful planar effects.
    ...
    At 7th level, if you have 6 ranks in Swim, you gain a \plus5 bonus to Swim checks.

    At 11th level, if you have 9 ranks in Swim, you do not suffer any penalties to physical melee attacks, checks, or physical defenses for being underwater.
    ...
    At 7th level, if you have a 6 Dexterity, the accuracy bonus increases to \plus2.

    At 11th level, if you have a 9 Dexterity, the damage bonus increases to \plus2.
    ...
    \feat{Versatile Wild Speech}{Class}
