...
\begin{longtabuwrapper}
    \begin{longtabu}{>{\lcol}p{11em} >{\lcol}p{15em} >{\lcol}X >{\lcol}p{8em} >{\lcol}p{3em}}
        ...
        \featref{Herbalist} & Mastered Survival & Mastered Knowledge (nature) & Brew potions with natural ingredients & \tdash & \featpref{Herbalist} \\
...
\end{longtabuwrapper}
    ...
    \begin{feat}{Herbalist}{Skill}
        ...
        \ff[4]{Potent Poisons} You gain a \plus1 bonus to \glossterm{potency} with any poisons you make.
