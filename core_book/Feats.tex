...
\end{longtablewrapper}
    ...
    \begin{feat}{Shieldbearer}{Combat}
        ...
        \ff[3]{Forceful Block} Whenever a creature misses you with a melee \glossterm{strike}, that creature takes a \minus2 penalty to Armor defense during the next round.
    ...
    \begin{feat}{Spellwarped}{General, Magical}
        ...
        You require \glossterm{verbal components}, but not \glossterm{somatic components}, to cast spells from your chosen sphere.
