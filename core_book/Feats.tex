...
\end{longtabuwrapper}
    ...
    \begin{feat}{Mystic Archer}{Magical, Spell}
        ...
        \begin{ability}{Imbue Projectile}[\glossterm{Attune}]
            Whenever you cast a spell that affects a single target, you can spend an \glossterm{action point} to use this ability.
            If you do, the spell does not have its effect immediately.
        ...
        \ff[7]{Greater Imbue Projectile} You gain the \textit{greater imbue projectile} ability.
        \begin{ability}{Greater Imbue Projectile}[\glossterm{Attune}]
        ...
        \ff[9]{Greater Missile Storm} When you use your \textit{missile storm} ability, you may target any number of creatures.
        ...
        \ff[15]{Supreme Missile Storm} The damage penalty with your \textit{missile storm} ability is removed.
    ...
    \begin{feat}{Savage}{Combat}
        ...
        \ff[10]{Greater Trample} You gain a \plus1d bonus to damage with your \textit{trample} ability.
        ...
        \ff[16]{Supreme Trample} The damage bonus from your \textit{greater trample} ability increases to \plus2d.

        \ff[18]{Unstoppable} You can use the \textit{overrun} ability without spending an \glossterm{action point}.
    \end{feat}
