...
\end{longtablewrapper}
    ...
    \begin{feat}{Sphere Focus: Bless}{Casting, Magical}
        ...
        \ff[6]{Sustained Blessing} You can cast spells from the \sphere{Bless} mystic sphere with the \abilitytag{Sustain} (minor) tag instead of the \abilitytag{Attune} (self) tag.
