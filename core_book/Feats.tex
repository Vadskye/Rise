...
\end{longtablewrapper}
    ...
    \begin{feat}{Blindfighter}{Combat}
        ...
        \ff[18]{Greater Blindsight} The range of your blindsight increases by 90 feet.
    ...
    \begin{feat}{Celestial Heritage}{Bloodline, Magical}
        ...
        \ff[3]{Healing Light}[Magical] When you use the \textit{recover} ability, you emit \glossterm{brilliant illumination} in a \medarea radius from you, and \glossterm{shadowy illumination} in twice that radius.
        Each \glossterm{ally} in the radius of brilliant illumination regains 1d6 \glossterm{hit points}.
        The light lasts until the end of the next round.
        ...
        \ff[15]{Greater Celestial Soul} The bonus from your \textit{celestial soul} ability increases to \plus8.
    ...
    \begin{feat}{Precognition}{General}
        ...
        \ff[12]{Greater Precognitive Reaction} You gain a \plus3 bonus to \glossterm{initiative} checks.
    ...
    \begin{feat}{Sphere Focus: Cryomancy}{Casting, Magical}
        ...
        \ff[3]{Cold Tolerance} You gain a \plus4 bonus to \glossterm{defenses} against attacks that deal cold damage.
        ...
        \ff[12]{Greater Cold Tolerance} The bonus from your \textit{cold tolerance} ability increases to \plus6.
    ...
    \begin{feat}{Sphere Focus: Electromancy}{Casting, Magical}
        ...
        \ff[3]{Electricity Tolerance} You gain a \plus4 bonus to \glossterm{defenses} against attacks that deal electricity damage.
        ...
        \ff[12]{Greater Electricity Tolerance} The bonus from your \textit{electricity resistance} ability increases to \plus6.
    ...
    \begin{feat}{Sphere Focus: Pyromancy}{Casting, Magical}
        ...
        \ff[3]{Fire Tolerance} You gain a \plus4 bonus to \glossterm{defenses} against attacks that deal fire damage.
        ...
        \ff[12]{Greater Fire Tolerance} The from your \textit{fire resistance} ability increases to \plus6.
    ...
    \begin{feat}{Sphere Focus: Vivimancy}{Casting, Magical}
        ...
        \ff[6]{Life Suppression} You gain a \plus4 bonus to defenses against attacks that only affect living creatures.
    ...
    \begin{feat}{Swift}{General}
        ...
        \ff[1]{Rapid Movement} You gain a \plus5 foot bonus to your \glossterm{base speed}.
