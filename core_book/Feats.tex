...
\end{longcolumn}
    ...
    \begin{feat}{Executioner}{Combat}
        ...
        \ff[1]{Finishing Blow} You gain a \plus1 accuracy bonus against creatures that are \textit{marked for execution}.
        ...
        In addition, you do not need \glossterm{line of sight} or \glossterm{line of effect} to see creatures that are \textit{marked for execution}.
