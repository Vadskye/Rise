...
\begin{longtabuwrapper}
    \begin{longtabu}{>{\lcol}p{11em} >{\lcol}p{15em} >{\lcol}X >{\lcol}p{8em} >{\lcol}p{3em}}
        ...
        \featref{Innate Magic}              & Wil 2, Spellcasting ability       & Cast spells without words or gestures        & Magical & \featpref{Innate Magic}              \\
...
\end{longtabuwrapper}
    ...
    \begin{feat}{Innate Magic}{Casting, Magical}
        ...
        You take a \minus6 penalty to \glossterm{concentration} checks to cast spells (see \pcref{Concentration}).

        \ff[3]{Innate Creativity} You learn an additional \glossterm{spell}.
        When you gain access to new spell levels, you can change which spell you know.

        \ff[6]{Greater Innate Creativity} You learn an additional \glossterm{mystic sphere}.

        \ff[9]{Greater Mental Casting} The penalty to \glossterm{concentration} checks from your \textit{mental casting} ability is reduced to \minus3.

        \ff[12]{Innate Power} You gain a \plus1 bonus to \glossterm{power} with \glossterm{spells}.

        \ff[15]{Supreme Innate Creativity} You gain an additional \glossterm{insight point}.

        \ff[18]{Supreme Mental Casting} The penalty to \glossterm{concentration} checks from your \textit{mental casting} ability is removed.
    \end{feat}
    ...
    \begin{feat}{Knowledge Specialization}{Skill}
        ...
        \ff[1]{Specialization} You gain a \plus2 bonus to Knowledge.
    ...
    \begin{feat}{Perform Specialization}{Skill}
        ...
        \ff[1]{Specialization} You gain a \plus2 bonus to Perform.
    ...
    \begin{feat}{Sense Motive Specialization}{Skill}
        ...
        \ff[2]{Read Mind}[Magical] You can use the \textit{read mind} ability as a standard action.
