...
\end{longtablewrapper}
    ...
    \begin{feat}{Boongiver}{Casting, Magical}
        ...
        \begin{freeability}{Benevolent Transferance}
            ...
            \featlevel{19} The targets can transfer any number of attuned spells between each other.
        \end{freeability}
        ...
        \ff[13]{Greater Boon Lore} The number of additional \glossterm{Attune} spells you gain from your \textit{boon lore} ability increases to two.
    ...
    \begin{feat}{Draconic Heritage}{Bloodline}
        ...
        \begin{freeability}{Breath Weapon}
            Make an attack vs. Reflex against everything in the area defined by your \textit{draconic ancestry} ability (see \trefnp{Dragon Types}).
    ...
    \begin{feat}{Greatweapon Warrior}{Combat}
        ...
        \ff[1]{Power Attack} Whenever you make a strike with a weapon you wield in two hands, you may take a \minus1 penalty to \glossterm{accuracy}.
        If you do, you gain a \plus1d bonus to damage.

        \ff[4]{Cleave} Whenever you wield a melee weapon in two hands, it gains the Sweeping (1) tag (see \pcref{Weapon tags}).
        ...
        \ff[7]{Destructive Force} You gain a \plus2 bonus to \glossterm{accuracy} with the \textit{disarm} ability with weapons you wield in two hands (see \pcref{Disarm}).
        In addition, whenever you make a strike with a weapon you wield in two hands, it deals double damage to objects.

        \ff[10]{Greater Power Attack} The damage bonus from your \textit{power attack} ability increases to \plus2d.

        \ff[13]{Greater Cleave} The tag granted by your \textit{cleave} ability changes to be Sweeping (2).
        If the weapon already has the Sweeping tag, you instead increase the number of secondary targets by 2.

        \ff[16]{Greater Destructive Force} The accuracy bonus from your \textit{destructive force} ability increases to \plus4.
        In addition, the damage multiplier from your \textit{destructive force} ability increases to triple damage.

        \ff[19]{Supreme Power Attack} The damage bonus from your \textit{power attack} ability increases to \plus3d.
    \end{feat}
    ...
    \begin{feat}{Medicine Specialization}{Skill}
        ...
        \begin{freeability}{Healing Touch}[\glossterm{Life}]
            ...
            \rankline
            \featlevel{10} The number of hit points regained increases to two, regardless of whether the target is bloodied.
    ...
    \begin{feat}{Metacaster}{Casting, Magical}
        ...
        \begin{dtable}
            ...
            \begin{dtabularx}{\columnwidth}{l >{\lcol}X}
                ...
                1 & Dazed, dazzled, sickened, slowed \\
    ...
    \begin{feat}{Mystic Archer}{Casting}
        ...
        \ff[13]{Greater Guided Projectiles} Your attacks with projectiles ignore \glossterm{concealment}, and you can roll twice for miss chances with projectile attacks (such as when attacking creatures you cannot see).
        ...
        \ff[19]{Supreme Guided Projectiles} You gain a \plus1 bonus to \glossterm{accuracy} with projectile attacks.
    ...
    \begin{feat}{Null}{General}
        ...
        \begin{freeability}{Sever Magic}
            ...
            \featlevel{13} A struck target stops being attuned to an additional effect of its choice.
    ...
    \begin{feat}{Savage}{Combat}
        ...
        In addition, you gain a \plus1 bonus to \glossterm{power} with \glossterm{mundane} abilities.
        ...
        \ff[7]{Trample} You can use the \textit{trample} ability as a standard action.
        This ability functions like the \textit{overrun} ability, except that creatures may not choose to avoid you.
        In addition, if you move through a creature's space, it takes \glossterm{standard damage} \minus2d.
        ...
        \ff[13]{Limitless Savagery} Using the \textit{overrun} and \textit{trample} does not cause you to lose a \glossterm{hit point}.

        \ff[16]{Knockback Force} When you use the \textit{shove} ability, you can \glossterm{knockback} the target up to 20 feet instead of \glossterm{pushing} it.

        \ff[19]{Supreme Brute Force} The accuracy bonus from your \textit{brute force} ability increases to \plus6.
        In addition, the power bonus increases to \plus3.
    \end{feat}
    ...
    \begin{feat}{Shieldbearer}{Combat}
        ...
        \ff[4]{Forceful Block} Whenever a creature misses you with a melee \glossterm{strike}, that creature takes a \minus2 penalty to Armor defense until the end of the next round.

        \ff[7]{Arrow Deflection} You and each \glossterm{ally} adjacent to you gain a \plus2 bonus to Armor defense against \glossterm{mundane} ranged attacks from weapons or projectiles that are at least one \glossterm{size category} smaller than you.

        \ff[10]{Greater Shield Expertise} The bonus from your \textit{shield expertise} ability increases to \plus2.

        \ff[13]{Greater Forceful Block} The penalty from your \textit{forceful block} ability increases to \minus3.

        \ff[16]{Greater Arrow Deflection} The bonus from your \textit{arrow deflection} ability increases to \plus4.

        \ff[19]{Greater Shield Expertise} The bonus from your \textit{shield expertise} ability increases to \plus3.
    \end{feat}
    ...
    \begin{feat}{Spellsense Specialization}{Skill}
        ...
        \begin{freeability}{Detect Spellcasting}[\glossterm{Knowledge}, \glossterm{Subtle}]
            ...
            \featlevel{16} You can target up to five creatures within range.
        \end{freeability}
    ...
    \begin{feat}{Spellsword}{Magical, Spell}
        ...
        \ff[4]{Spellsword Conduit} You can cast spells using a melee weapon as if it were an implement (see \pcref{Implements}).
        ...
        \ff[10]{Personal Enhancement} You gain a \plus1 \glossterm{magic bonus} to \glossterm{accuracy} and a \plus2 \glossterm{magic bonus} to \glossterm{power}.

        \ff[13]{Defensive Enhancement} You gain a \plus1 \glossterm{magic bonus} to all defenses.

        \ff[16]{Greater Spellsword Conduit} Whenever you cast a spell using a melee weapon as an implement, you gain a \plus1 bonus to \glossterm{accuracy} with the spell.

        \ff[19]{Greater Personal Enhancement} The accuracy bonus from your \textit{personal enhancement} ability increases to \plus2, and the power bonus increases to \plus4.
    \end{feat}
    ...
    \begin{feat}{Spellwarped}{General, Magical}
        ...
        You do not require \glossterm{verbal components} or \glossterm{somatic components} to cast spells from your chosen sphere.
        ...
        \ff[4]{Spell Rank} You become a rank 2 spellcaster in your chosen \glossterm{mystic sphere}.
        This gives you access to spells that require a minimum rank of 2.

        \ff[4]{Spell Knowledge} You learn one spell from your \glossterm{mystic sphere}.

        \ff[7]{Spell Rank} You become a rank 3 spellcaster in your chosen \glossterm{mystic sphere}.
        ...
        \ff[10]{Spell Rank} You become a rank 4 spellcaster in your chosen \glossterm{mystic sphere}.
        ...
        \ff[13]{Spell Rank} You become a rank 5 spellcaster in your chosen \glossterm{mystic sphere}.
        ...
        \ff[13]{Spell Knowledge} You learn one spell from your \glossterm{mystic sphere}.

        \ff[16]{Spell Rank} You become a rank 6 spellcaster in your chosen \glossterm{mystic sphere}.
        ...
        \ff[19]{Spell Rank} You become a rank 7 spellcaster in your chosen \glossterm{mystic sphere}.
    ...
    \begin{feat}{Sphere Focus: Aeromancy}{Casting, Magical}
        ...
        \ff[4]{Favorable Winds} You gain a \plus1 bonus to \glossterm{accuracy} with ranged \glossterm{strikes}.

        \ff[7]{Personal Updraft} You gain a \glossterm{glide speed} equal to your \glossterm{base speed} (see \pcref{Gliding}).
        ...
        \ff[10]{Personal Aeromancy} You gain an additional \glossterm{action point}.
        You can only use this action point to \glossterm{attune} to spells and rituals from the \sphere{Aeromancy} \glossterm{mystic sphere}.

        \ff[13]{Greater Favorable Winds} The bonus from your \textit{favorable winds} ability increases to \plus2.

        \ff[16]{Spell} You learn a spell from the \sphere{Aeromancy} \glossterm{mystic sphere}.
    ...
    \begin{feat}{Sphere Focus: Aquamancy}{Casting, Magical}
        ...
        \ff[7]{Slippery Escapist} You gain a \plus2 bonus to the Flexibility skill.
        In addition, you gain a \plus2 bonus to defenses against the \textit{grapple} ability (see \pcref{Grapple}).

        \ff[10]{Personal Aquamancy} You gain an additional \glossterm{action point}.
        You can only use this action point to \glossterm{attune} to spells and rituals from the \sphere{Aquamancy} \glossterm{mystic sphere}.
        ...
        \ff[16]{Spell} You learn a spell from the \sphere{Aquamancy} \glossterm{mystic sphere}.
        When you gain access to a new spell level, you can change which spell you know from that mystic sphere.
    ...
    \begin{feat}{Sphere Focus: Astromancy}{Casting, Magical}
        ...
        \ff[4]{Efficient Transit} You learn how to transport creatures and objects more smoothly between planes.
        ...
        \ff[7]{Astral Spell Transit} You double your range with abilities from the \sphere{Astromancy} \glossterm{mystic sphere}.

        \ff[10]{Personal Astromancy} You gain an additional \glossterm{action point}.
        You can only use this action point to \glossterm{attune} to spells and rituals from the \sphere{Astromancy} \glossterm{mystic sphere}.

        \ff[13]{Greater Efficient Transit} The difficulty rating increase from your \textit{efficient transit} effect increases to 20.
        ...
        \ff[16]{Spell} You learn a spell from the \sphere{Astromancy} \glossterm{mystic sphere}.
        When you gain access to a new spell level, you can change which spell you know from that mystic sphere.

        \ff[19]{Greater Astral Spell Transit} When determining whether you have \glossterm{line of effect} to a particular location with abilites from the \sphere{Astromancy} \glossterm{mystic sphere}, you can ignore any number of physical obstacles with a combined depth of five feet or less.
    ...
    \begin{feat}{Sphere Focus: Barrier}{Casting, Magical}
        ...
        \ff[7]{Hardened Barriers} You gain a bonus equal to your \glossterm{power} to the \glossterm{vital resistance} of objects you create with the \sphere{Barrier} \glossterm{mystic sphere}.

        \ff[10]{Personal Barrier} You gain an additional \glossterm{action point}.
        You can only use this action point to \glossterm{attune} to spells and rituals from the \sphere{Barrier} \glossterm{mystic sphere}.

        \ff[13]{Innate Shield} You gain a \plus1 bonus to Armor defense.

        \ff[16]{Spell} You learn a spell from the \sphere{Barrier} \glossterm{mystic sphere}.
        When you gain access to a new spell level, you can change which spell you know from that mystic sphere.

        \ff[19]{Greater Hardened Barriers} The bonus from your \textit{hardened barriers} ability increases to three times your \glossterm{power}.
    \end{feat}
    ...
    \begin{feat}{Sphere Focus: Bless}{Casting, Magical}
        ...
        \ff[4]{Inspiring Blessing} Each creature that is \glossterm{attuned} to a spell you cast from the \sphere{Bless} \glossterm{mystic sphere} increases its current \glossterm{hit points} by 1.
        ...
        \ff[13]{Greater Inspiring Blessing} The number of hit points granted by your \textit{inspiring blessing} ability increases to two.
    ...
    \begin{feat}{Sphere Focus: Biomancy}{Casting, Magical}
        ...
        \ff[4]{Biological Control} You gain a \plus2 bonus to Fortitude defense.
        ...
        \ff[7]{Biological Cleanse} You can use the \textit{biological cleanse} ability as a \glossterm{minor action}.
        \begin{freeability}{\labeltext{Biological Cleanse}}
            \target{Yourself}
            ...
            \rankline
            \featlevel{13} This ability can target any \glossterm{ally} within your \glossterm{reach}.
            \featlevel{19} This ability can target any \glossterm{ally} within \rngmed range.
        \end{freeability}

        \ff[10]{Personal Biomancy} You gain an additional \glossterm{action point}.
        You can only use this action point to \glossterm{attune} to spells and rituals from the \sphere{Biomancy} \glossterm{mystic sphere}.

        \ff[13]{Greater Biological Control} The bonus from your \textit{biological control} ability increases to \plus4.
        ...
        \ff[16]{Spell} You learn a spell from the \sphere{Biomancy} \glossterm{mystic sphere}.
        When you gain access to a new spell level, you can change which spell you know from that mystic sphere.

        \ff[19]{Greater Personal Biomancy} The number of action points you gain from your \textit{personal biomancy} ability increases to 2.
    \end{feat}
    ...
    \begin{feat}{Sphere Focus: Channel Divinity}{Casting, Magical}
        ...
        \ff[7]{Divine Servant} Once per \glossterm{long rest}, if you pray to your deity in an area sacred to your deity, you can regain a spent \glossterm{action point}.
        This takes a \glossterm{minor action}.

        \ff[10]{Personal Channeling} You gain an additional \glossterm{action point}.
        You can only use this action point to \glossterm{attune} to spells and rituals from the \sphere{Channel Divinity} \glossterm{mystic sphere}.

        \ff[13]{Greater Divine Intervention} The bonus from your \textit{divine intervention} ability increases to \plus6.

        \ff[16]{Spell} You learn a spell from the \sphere{Channel Divinity} \glossterm{mystic sphere}.
        When you gain access to a new spell level, you can change which spell you know from that mystic sphere.

        \ff[19]{Greater Personal Channeling} The number of action points you gain from your \textit{personal channeling} ability increases to 2.
    \end{feat}
    ...
    \begin{feat}{Sphere Focus: Chronomancy}{Casting, Magical}
        ...
        \ff[7]{Accelerated Mind} You can perform primarily mental tasks more quickly as normal.
        ...
        \ff[16]{Spell} You learn a spell from the \sphere{Chronomancy} \glossterm{mystic sphere}.
        When you gain access to a new spell level, you can change which spell you know from that mystic sphere.

        \ff[19]{Greater Accelerated Mind} You can perform \glossterm{mundane} mental tasks that would normally take \glossterm{standard actions} as \glossterm{minor actions}.
    ...
    \begin{feat}{Sphere Focus: Compel}{Casting, Magical}
        ...
        \ff[7]{Mental Dominance} You gain a \plus2 bonus to Mental defense and the Persuasion skill.
        ...
        \ff[16]{Spell} You learn a spell from the \sphere{Compel} \glossterm{mystic sphere}.
        When you gain access to a new spell level, you can change which spell you know from that mystic sphere.

        \ff[19]{Greater Mind Fragments} The accuracy penalty from your \textit{mind fragments} ability is removed.
    \end{feat}
    ...
    \begin{feat}{Sphere Focus: Cryomancy}{Casting, Magical}
        ...
        \ff[7]{Frozen Blood} You are immune to \glossterm{poisons}.

        \ff[10]{Personal Cryomancy} You gain an additional \glossterm{action point}.
        You can only use this action point to \glossterm{attune} to spells and rituals from the \sphere{Cryomancy} \glossterm{mystic sphere}.
        ...
        \ff[16]{Spell} You learn a spell from the \sphere{Cryomancy} \glossterm{mystic sphere}.
        When you gain access to a new spell level, you can change which spell you know from that mystic sphere.

        \ff[19]{Greater Frozen Blood} When you would be \glossterm{bloodied}, you are \glossterm{chilled} instead.
        If you are immune to being \glossterm{chilled}, this ability has no effect, and you are still \glossterm{bloodied}.
    \end{feat}
    ...
    \begin{feat}{Sphere Focus: Delusion}{Casting, Magical}
        ...
        \ff[7]{Persistent Delusion} Whenever a creature removes a \glossterm{condition} that you gave it with a spell from the \sphere{Delusion} \glossterm{mystic sphere}, the effects of the condition linger until the end of the next round after the condition was removed.
        This ability does not affect the duration of effects that are not \glossterm{conditions}.  

        \ff[10]{Personal Delusion} You gain an additional \glossterm{action point}.
        You can only use this action point to \glossterm{attune} to spells and rituals from the \sphere{Delusion} \glossterm{mystic sphere}.
        ...
        \ff[16]{Spell} You learn a spell from the \sphere{Delusion} \glossterm{mystic sphere}.
        When you gain access to a new spell level, you can change which spell you know from that mystic sphere.

        \ff[19]{Greater Persistent Delusion} The additional time that your conditions last from your \textit{persistent delusion} ability increases to one minute after the condition was removed.
    \end{feat}
    ...
    \begin{feat}{Sphere Focus: Electromancy}{Casting, Magical}
        ...
        \ff[4]{Lingering Shock} When you \glossterm{wound} a creature with a \glossterm{critical hit} using electricity damage, that creature is \glossterm{dazed} as a \glossterm{condition}.

        \ff[7]{Energetic Rush} You gain a \plus2 bonus to Reflex defense and a \plus5 foot bonus to your \glossterm{base speed}.

        \ff[10]{Personal Electromancy} You gain an additional \glossterm{action point}.
        You can only use this action point to \glossterm{attune} to spells and rituals from the \sphere{Electromancy} \glossterm{mystic sphere}.
        ...
        \ff[16]{Spell} You learn a spell from the \sphere{Electromancy} \glossterm{mystic sphere}.
        When you gain access to a new spell level, you can change which spell you know from that mystic sphere.

        \ff[19]{Greater Energetic Rush} The bonus to Reflex defense from your \textit{energetic rush} ability increases to \plus4, and the speed bonus increases to \plus10 feet.
    \end{feat}
    ...
    \begin{feat}{Sphere Focus: Fabrication}{Casting, Magical}
        ...
        \ff[7]{Persistent Manifestation} Once per round, you can \glossterm{sustain} a spell from the Fabrication mystic sphere as a \glossterm{free action}.

        \ff[10]{Personal Fabrication} You gain an additional \glossterm{action point}.
        You can only use this action point to \glossterm{attune} to spells and rituals from the \sphere{Fabrication} \glossterm{mystic sphere}.
        ...
        \ff[16]{Spell} You learn a spell from the \sphere{Fabrication} \glossterm{mystic sphere}.
        When you gain access to a new spell level, you can change which spell you know from that mystic sphere.
    ...
    \begin{feat}{Sphere Focus: Photomancy}{Casting, Magical}
        ...
        \ff[4]{Augmented Vision} You gain a \plus2 bonus to the Awareness skill.
        ...
        \ff[7]{Certain Sight} You are immune to being \glossterm{dazzled} and \glossterm{blinded}.

        \ff[10]{Personal Photomancy} You gain an additional \glossterm{action point}.
        You can only use this action point to \glossterm{attune} to spells and rituals from the \sphere{Photomancy} \glossterm{mystic sphere}.
        ...
        \ff[16]{Spell} You learn a spell from the \sphere{Photomancy} \glossterm{mystic sphere}.
        When you gain access to a new spell level, you can change which spell you know from that mystic sphere.
    ...
    \begin{feat}{Sphere Focus: Polymorph}{Casting, Magical}
        ...
        \ff[7]{Malleable Flesh} You gain a \plus5 bonus to defenses when determining whether a \glossterm{strike} gets a \glossterm{critical hit} against you instead of a normal hit.

        \ff[10]{Personal Polymorph} You gain an additional \glossterm{action point}.
        You can only use this action point to \glossterm{attune} to spells and rituals from the \sphere{Polymorph} \glossterm{mystic sphere}.
        ...
        \ff[16]{Spell} You learn a spell from the \sphere{Polymorph} \glossterm{mystic sphere}.
        When you gain access to a new spell level, you can change which spell you know from that mystic sphere.
    ...
    \begin{feat}{Sphere Focus: Pyromancy}{Casting, Magical}
        ...
        \ff[4]{Lingering Flame} Whenever you \glossterm{wound} a creature with a \glossterm{critical hit} using fire damage, that creature takes \glossterm{environmental} fire \glossterm{standard damage} at the end of the next round.
        ...
        \ff[7]{Friendly Fire} Whenever you deal fire damage to your \glossterm{allies}, you deal half damage, and that damage is treated as \glossterm{environmental damage}.

        \ff[10]{Personal Pyromancy} You gain an additional \glossterm{action point}.
        You can only use this action point to \glossterm{attune} to spells and rituals from the \sphere{Pyromancy} \glossterm{mystic sphere}.
        ...
        \ff[16]{Spell} You learn a spell from the \sphere{Pyromancy} \glossterm{mystic sphere}.
        When you gain access to a new spell level, you can change which spell you know from that mystic sphere.

        \ff[19]{Great Combustion} You double the area of all of your spells and rituals from the \textit{pyromancy} \glossterm{mystic sphere}.
    \end{feat}
    ...
    \begin{feat}{Sphere Focus: Revelation}{Casting, Magical}
        ...
        \ff[4]{Truthsense} You gain a \plus2 bonus to all Knowledge skills and the Social Insight skill.
        ...
        \ff[10]{Personal Revelation} You gain an additional \glossterm{action point}.
        You can only use this action point to \glossterm{attune} to spells and rituals from the \sphere{Revelation} \glossterm{mystic sphere}.

        \ff[13]{Greater Truthsense} The bonus from your \textit{truthsense} ability increases to \plus4.

        \ff[16]{Spell} You learn a spell from the \sphere{Revelation} \glossterm{mystic sphere}.
        When you gain access to a new spell level, you can change which spell you know from that mystic sphere.
    ...
    \begin{feat}{Sphere Focus: Summoning}{Casting, Magical}
        ...
        \ff[7]{Augmented Summons} Creatures you create with abilities from the \sphere{Summoning} spell gain an \glossterm{action point}.
        Most summoned creatures cannot use the \textit{recover} action or similar abilities, since the actions they can take are listed in the description of the spell or ritual.
        However, your summoned creatures can use this action point to \glossterm{attune} to abilities.

        \ff[10]{Personal Summoning} You gain an additional \glossterm{action point}.
        You can only use this action point to \glossterm{attune} to spells and rituals from the \sphere{Summoning} \glossterm{mystic sphere}.
        ...
        \ff[16]{Spell} You learn a spell from the \sphere{Summoning} \glossterm{mystic sphere}.
        When you gain access to a new spell level, you can change which spell you know from that mystic sphere.
        ...
        In addition, creatures you summon can use the \textit{recover} and \textit{cleanse} actions if you command them to.
        They cannot use the \textit{recover} action more than once between \glossterm{short rests}.
    \end{feat}
    ...
    \begin{feat}{Sphere Focus: Telekinesis}{Casting, Magical}
        ...
        \begin{freeability}{Telekinetic Strike}[Magical]
            ...
            \featlevel{16} The damage bonus increases to \plus2.
        \end{freeability}

        \ff[7]{Partial Levitation} You gain a \plus4 bonus to the Jump skill.
        ...
        \ff[10]{Personal Telekinesis} You gain an additional \glossterm{action point}.
        You can only use this action point to \glossterm{attune} to spells and rituals from the \sphere{Telekinesis} \glossterm{mystic sphere}.
        ...
        \ff[16]{Spell} You learn a spell from the \sphere{Telekinesis} \glossterm{mystic sphere}.
        When you gain access to a new spell level, you can change which spell you know from that mystic sphere.

        \ff[19]{Levitation} As long as you are no more than 100 feet above a surface that could support your weight, you can choose to float in midair, unaffected by gravity.
    ...
    \begin{feat}{Sphere Focus: Terramancy}{Casting, Magical}
        ...
        \ff[7]{Earthen Alloys} You may treat iron, steel, and worked stone as if they earth for the purpose of spells from the \sphere{Terramancy} \glossterm{mystic sphere}.

        \ff[10]{Personal Terramancy} You gain an additional \glossterm{action point}.
        You can only use this action point to \glossterm{attune} to spells and rituals from the \sphere{Terramancy} \glossterm{mystic sphere}.

        \ff[13]{Body of Stone} You gain a \plus1 bonus to Armor defense.

        \ff[16]{Spell} You learn a spell from the \sphere{Terramancy} \glossterm{mystic sphere}.
        When you gain access to a new spell level, you can change which spell you know from that mystic sphere.

        \ff[19]{Greater Earthen Alloys} You may treat sand, glass, and metal of any kind as if it were earth for the purpose of spells from the \sphere{Terramancy} \glossterm{mystic sphere}.
    \end{feat}
    ...
    \begin{feat}{Sphere Focus: Thaumaturgy}{Casting, Magical}
        ...
        \ff[7]{Mystic Power} You gain a \plus1 bonus to \glossterm{power} with \glossterm{magical} abilities.

        \ff[10]{Personal Thaumaturgy} You gain an additional \glossterm{action point}.
        You can only use this action point to \glossterm{attune} to spells and rituals from the \sphere{Thaumaturgy} \glossterm{mystic sphere}.
        ...
        \ff[16]{Spell} You learn a spell from the \sphere{Thaumaturgy} \glossterm{mystic sphere}.
        When you gain access to a new spell level, you can change which spell you know from that mystic sphere.

        \ff[19]{Greater Mystic Power} The bonus from your \textit{mystic power} ability increases to \plus2.
    \end{feat}
    ...
    \begin{feat}{Sphere Focus: Umbramancy}{Casting, Magical}
        ...
        \ff[4]{Reflexive Concealment} You gain a \plus2 bonus to the Sleight of Hand and Stealth skills.

        \ff[4]{Greater Suppress Light} You can cast the \spell{suppress light} \glossterm{cantrip} from the Umbramancy mystic sphere as a \glossterm{minor action}.
        In addition, that cantrip no longer has the \glossterm{Focus} keyword for you.

        \ff[7]{Darkvision} You gain \glossterm{darkvision} with a 50 foot range, allowing you to see in complete darkness clearly.
        If you already have that ability, you increase its range by 50 feet.

        \ff[10]{Personal Umbramancy} You gain an additional \glossterm{action point}.
        You can only use this action point to \glossterm{attune} to spells and rituals from the \sphere{Umbramancy} \glossterm{mystic sphere}.

        \ff[13]{Greater Reflexive Concealment} The bonuses from your \textit{reflexive concealment} ability increase to \plus4.

        \ff[13]{Supreme Suppress Light} You can both cast and \glossterm{sustain} the \spell{suppress light} cantrip as a \glossterm{free action}.

        \ff[16]{Spell} You learn a spell from the \sphere{Umbramancy} \glossterm{mystic sphere}.
        When you gain access to a new spell level, you can change which spell you know from that mystic sphere.

        \ff[19]{Darksight} The range of your \glossterm{darkvision} ability increases by 200 feet.
    ...
    \begin{feat}{Sphere Focus: Verdamancy}{Casting, Magical}
        ...
        \ff[7]{Creative Genesis} You can cast spells from the \sphere{Verdamancy} \glossterm{mystic sphere} as if non-arable ground of any kind was arable earth.

        \ff[10]{Personal Verdamancy} You gain an additional \glossterm{action point}.
        You can only use this action point to \glossterm{attune} to spells and rituals from the \sphere{Verdamancy} \glossterm{mystic sphere}.
        ...
        \ff[16]{Spell} You learn a spell from the \sphere{Verdamancy} \glossterm{mystic sphere}.
        When you gain access to a new spell level, you can change which spell you know from that mystic sphere.

        % Seems weird for an 19th level; should stay in sync with the druid wild aspect
        \ff[19]{Supreme Verdant Allies} You treat all living creatures as if they were plants for the purpose of abilities from this feat and abilities from the \sphere{Verdamancy} \glossterm{mystic sphere}.
    \end{feat}
    ...
    \begin{feat}{Sphere Focus: Vivimancy}{Casting, Magical}
        ...
        \ff[7]{Life Suppression} You gain a \plus4 bonus to defenses against abilities that only affect living creatures.

        \ff[10]{Personal Vivimancy} You gain an additional \glossterm{action point}.
        You can only use this action point to \glossterm{attune} to spells and rituals from the \sphere{Vivimancy} \glossterm{mystic sphere}.
        ...
        \ff[16]{Spell} You learn a spell from the \sphere{Vivimancy} \glossterm{mystic sphere}.
        When you gain access to a new spell level, you can change which spell you know from that mystic sphere.
    ...
    \begin{feat}{Two-Weapon Fighting}{Combat}
        ...
        \ff[1]{Offhand Force} You gain a \plus1d bonus to damage with the \textit{offhand strike} ability.

        \ff[4]{Dual Precision} You gain a \plus1 bonus to \glossterm{accuracy} with \glossterm{strikes} while you wield two weapons.

        \ff[7]{Two-Weapon Defense} While wielding two melee weapons, you gain a \plus1 bonus to Armor defense.
        This bonus is considered to come from a shield, and does not stack with the benefits of using a physical shield.

        \ff[10]{Greater Offhand Force} The bonus from your \textit{offhand force} ability increases to \plus2d.

        \ff[13]{Greater Dual Precision} The bonus from your \textit{dual precision} ability increases to \plus2.

        \ff[16]{Greater Two-Weapon Defense} The bonus from your \textit{two-weapon defense} ability increases to \plus2.

        \ff[19]{Supreme Offhand Force} The bonus from your \textit{offhand force} ability increases to \plus3d.
    \end{feat}
