...
\end{longtablewrapper}
    ...
    \begin{feat}{Battle Armory}{Combat}
        ...
        \magicalff[6]{Legacy Armory} You do not choose an individual item as a \glossterm{legacy item} (see \pcref{Legacy Items}).
    ...
    \begin{magicalfeat}{Blood Magic}{Casting, Magical}
        ...
        \ff[12]{Blood-Sworn Allegiance} You can swear a blood oath to your allies.
        ...
        \ff[18]{Bloodbind+} You are always considered to have \glossterm{line of effect} with \magical abilities to a creature bound by your \textit{bloodbind} ability, regardless of intervening obstacles.
        This allows you to cast spells on them through solid walls.

        \ff[18]{Bloodspell+} The power bonus from your \textit{bloodspell} ability increases to \plus4.
    \end{magicalfeat}
    ...
    \begin{magicalfeat}{Boongiver}{Casting, Magical}
        ...
        \ff[6]{Sustain Attunement} Whenever you cast an \abilitytag{Attune} spell that is not a \glossterm{deep attunement}, you can choose to replace its \abilitytag{Attune} tag with the \abilitytag{Sustain (minor)} tag.

        \ff[12]{Versatile Boon Lore} You learn additional \glossterm{spell}.
        ...
        \ff[18]{Share Boon+} You can use your \textit{share boon} ability on up to three different spells at once.
    ...
    \begin{magicalfeat}{Celestial Heritage}{Bloodline, Magical}
        ...
        \ff[6]{Healing Radiance} When you use the \textit{recover} ability, you \glossterm{briefly} emit \glossterm{brilliant illumination} in a \largearea radius \glossterm{zone} from you, and \glossterm{shadowy illumination} in twice that radius.
        ...
        \ff[12]{Angel Wings} You gain feathery wings that sprout from your back.
        ...
        \ff[18]{Angel Wings+} Your \glossterm{maneuverability} with the fly speed from your \textit{angelic flight} ability increases to perfect (see \pcref{Flying Maneuverability}).

        % TODO: unclear scaling
        \ff[18]{Healing Radiance+} The healing provided by your \textit{healing light} ability increases to twice your power.
    \end{magicalfeat}
    ...
    \begin{feat}{Draconic Heritage}{Bloodline}
        ...
        \ff[18]{Draconic Scales+} The Armor defense bonus from your \textit{draconic scales} ability increases to \plus2.
    ...
    \begin{magicalfeat}{Entropist}{General, Magical}
        ...
        \ff[1]{Sudden Entropy} You can use the \textit{sudden entropy} ability as a standard action.
        \begin{magicalactiveability}{Sudden Entropy}
            \rankline
            Make an attack vs. Fortitude against one creature or object within \shortrange.
            \hit The target takes \damageranktwo{}.
        ...
        \ff[6]{Friend of Chaos} Whenever you roll to determine a random effect, such as a \glossterm{miss chance} or a sorcerer's \textit{wild magic} ability, you may roll twice and keep whichever result you prefer.
        ...
        \ff[12]{Entropic Defense} Whenever you are hit by a \glossterm{critical hit}, there is a 50\% chance that the attack is treated as a regular hit against you instead of a critical hit.
        This is not affected by your \textit{entropic defense} ability, since the attacker rolls this chance instead of you.

        \ff[18]{Master of Chaos} Whenever you roll to determine a random effect, you can use this ability.
    ...
    \begin{magicalfeat}{Ghostblade}{Combat, Magical}
        ...
        \ff[6]{Spectral Armament} The equipment you choose as your \glossterm{legacy item} becomes ghostly and translucent (see \pcref{Legacy Items}).
        ...
        \begin{magicalactiveability}{Spectral Strike}
            ...
            Each creature that loses \glossterm{hit points} from this strike is \slowed as a \glossterm{condition} if your attack result also beats its Fortitude defense.
        ...
        \ff[12]{Ghost Step+} When you use your \textit{ghost step} ability, you can also become \trait{incorporeal} for the duration of the movement.
        This grants you the defensive benefits of being incorporeal during the current phase.

        \ff[18]{Spectral Armament+} The effect of your \glossterm{legacy item} improves.
    ...
    \begin{feat}{Greatweapon Warrior}{Combat}
        ...
        \ff[12]{Power Attack+} The damage from your \textit{power attack} ability increases to 1d6 per 3 power.

        \ff[18]{Power Attack+} The damage from your \textit{power attack} ability increases to 1d6 per 2 power.
    \end{feat}
    ...
    \begin{feat}{Intimidate Specialization}{Skill}
        ...
        \ff[6]{Enduring Demoralize} When you use the \textit{demoralize} ability, the target is \shaken by you as a \glossterm{condition} instead of being briefly shaken.
        On a critical hit, the target is \frightened by you instead of shaken.
        For details, see \pcref{Demoralize}.

        \ff[12]{Specialization+} The bonus from your \textit{specialization} ability increases to \plus6.

        \ff[18]{Threatening Presence} Creatures that are shaken, frightened, or panicked by you suffer a penalty to their Armor, Fortitude, and Reflex defenses equal to the penalty they suffer to their Mental defense.
    \end{feat}
    ...
    \begin{feat}{Iron Will}{General}
        ...
        \ff[6]{Unclouded Mind} You are immune to being \dazed, \stunned, and \confused.
    ...
    \begin{feat}{Leadership}{Combat}
        ...
        \ff[6]{Encouraging Presence} As long as you are conscious, your \glossterm{allies} who can see or hear you are immune to being \shaken, \frightened, and \panicked.
        ...
        \ff[18]{Unyielding Presence} As long as you are conscious, your \glossterm{allies} who can see or hear you are immune to being \dazed, \stunned, and \confused.
    \end{feat}
    ...
    \begin{feat}{Maneuverist}{Combat}
        ...
        \ff[6]{Maneuver Expertise} You gain a \plus1 accuracy bonus with your rank 1 maneuvers.
        ...
        \ff[12]{Maneuver Expertise+} You gain a \plus1 accuracy bonus with your rank 3 maneuvers.
        ...
        \ff[18]{Maneuver Expertise+} You gain a \plus1 accuracy bonus with your rank 5 maneuvers.
    ...
    \begin{magicalfeat}{Mental Magic}{Casting, Magical}
        ...
        \ff[6]{Fractured Mind} Once per round, you can sustain an ability with the \abilitytag{Sustain} (minor) tag as a \glossterm{free action}.

        \ff[12]{Potent Mind} You gain a \plus1 bonus to your \glossterm{magical power}.

        \ff[18]{Fractured Mind+} You can also use your \textit{fractured mind} ability to sustain abilities with the \abilitytag{Sustain} (standard) tag.
        Whenever you sustain a Sustain (standard) ability in this way, you increase your \glossterm{fatigue level} by one.

        \ff[18]{Potent Mind+} The magical power bonus from your \textit{potent mind} ability increases to \plus2.
    \end{magicalfeat}
    ...
    \begin{magicalfeat}{Metacaster}{Casting, Magical}
        ...
        \ff[6]{Adaptive Metamagic} Choose one spell you know.
        ...
        \ff[12]{Spell Fusion} You can use the \textit{spell fusion} ability as a \glossterm{standard action}.
        ...
        \ff[18]{Adaptive Metamagic+} You can choose an additional spell you know with your \textit{adaptive metamagic} ability.
    ...
    \begin{magicalfeat}{Mystic Archer}{Casting, Magical}
        ...
        \ff[1]{Magical Strikes} Whenever you make a ranged \glossterm{strike} with a \weapontag{Projectile} weapon, you can choose to treat that as a \magical ability.
        ...
        \ff[1]{Imbue Projectile} You can use the \textit{imbue projectile} ability as a standard action.
        When you cast a spell as a \glossterm{standard action}, if that spell does not have the \abilitytag{Attune} or \abilitytag{Sustain} tags,
        ...
        \begin{magicalattuneability}{Imbue Projectile}{\abilitytag{Attune}}
            ...
            You must make any attack rolls required for the spell separately from your attack roll with the strike, and the spell takes effect even if the strike misses the target's defenses.
            ...
            After the spell takes effect, your attunement to this ability ends.
        \end{magicalattuneability}

        \ff[6]{Guided Projectiles} Your \glossterm{strikes} with \weapontag{Projectile} weapons ignore all \glossterm{miss chances}, such as from \glossterm{concealment}.
        This does not prevent your attacks from failing for other reasons.

        \ff[12]{Phasing Projectiles} Your \glossterm{strikes} with \weapontag{Projectile} weapons ignore \glossterm{cover}.
        ...
        \ff[18]{Imbue Projectile+} Your \textit{imbue projectile} ability loses the \abilitytag{Attune} tag.
    ...
    \begin{feat}{Null}{General}
        ...
        \begin{activeability}{Sever Magic}
            ...
            \rankline
            You gain a \plus2 accuracy bonus with the strike at for every 3 levels beyond 6.
        \end{activeability}

        \ff[6]{Personal Legacy} You do not gain any legacy item upgrades (see \pcref{Legacy Items}).
    ...
    \begin{feat}{Perform Specialization}{Skill}
        ...
        \ff[6]{Synergistic Performance} You can use any Perform skill you are \glossterm{trained} with in place of other related skills.
    ...
    \begin{magicalfeat}{Prepared Spellcasting}{Magical, Spell}
        ...
        \ff[6]{Ritual Book} You gain the ability to perform rituals to create unique magical effects (see \pcref{Rituals}).
        ...
        \ff[12]{Study of Magic} You gain a \plus1 bonus to your \glossterm{magical power}.

        \ff[18]{Spellbook+} You can choose up to six spells to be in your spellbook instead of only three.
        ...
        \ff[18]{Study of Magic+} The bonus from your \textit{study of magic} ability increases to \plus2.
    \end{magicalfeat}
    ...
    \begin{feat}{Regenerator}{General}
        ...
        \ff[6]{Diehard} You gain a \plus4 bonus to \glossterm{vital rolls}.
    ...
    \begin{feat}{Sleight of Hand Specialization}{Skill}
        ...
        \magicalff[18]{Extradimensional Concealment} When you use the \textit{conceal object} ability, you can use the \textit{extradimensional pocket} ability.
    ...
    \begin{feat}{Sniper}{Combat}
        ...
        \ff[18]{Steady Shot+} The penalty reduction from your \textit{steady shot} ability increases to 4, allow you to ignore longshot penalties.
    \end{feat}
    ...
    \begin{magicalfeat}{Spellsword}{Magical, Spell}
        ...
        \ff[1]{Energized Weaponry} Whenever you deal damage with a spell, your melee \glossterm{strikes} \glossterm{briefly} deal damage of that type in addition to their normal damage types.
        In addition, you can cast spells using a non-\weapontag{Projectile} weapon as if it were an implement (see \pcref{Implements}).

        \ff[6]{Spellstrike} You can use the \ability{spellstrike} ability as a standard action.
        ...
        \ff[12]{Spellsword Conduit} Whenever you deal damage with a melee \glossterm{strike}, you \glossterm{briefly} gain a \plus2 accuracy bonus with spells against each damaged creature.

        \ff[18]{Energized Weaponry+} You can also make a single damage type permanent with this ability.
        Whenever you deal damage with a spell, you can replace the permanent damage type.

        \ff[18]{Spellsword Conduit+} The accuracy bonus increases to \plus4.
    \end{magicalfeat}
    ...
    \begin{magicalfeat}{Spellwarped}{General, Magical}
        ...
        \ff[6]{Spell Knowledge} You learn one spell from your \glossterm{mystic sphere}.
        ...
        \ff[18]{Spell Knowledge} You learn one spell from your \glossterm{mystic sphere}.
    ...
    \begin{magicalfeat}{Sphere Focus: Aeromancy}{Casting, Magical}
        ...
        \ff[1]{Distant Winds} You gain a \plus15 foot bonus to your range with abilities from the \sphere{Aeromancy} \glossterm{mystic sphere}.

        \ff[6]{Intrinsic Aeromancy} You learn an additional spell with the \abilitytag{Attune} tag from the \sphere{Aeromancy} mystic sphere.
        ...
        \ff[12]{Airborne} You gain a \glossterm{fly speed} equal to the \glossterm{base speed} for your size with a maximum height of 30 feet (see \pcref{Flight}).
        As a \glossterm{free action}, you can increase your \glossterm{fatigue level} by one to ignore this height limit until the end of the round.

        \ff[18]{Distant Winds+} The range bonus from your \textit{distant winds} ability increases to \plus60 feet.
    \end{magicalfeat}
    ...
    \begin{magicalfeat}{Sphere Focus: Aquamancy}{Casting, Magical}
        ...
        \ff[6]{Intrinsic Aquamancy} You learn an additional spell with the \abilitytag{Attune} tag from the \sphere{Aquamancy} mystic sphere.
        The spell can be up to rank 3, even if you do not have access to rank 3 spells.
        If that spell is a \glossterm{deep attunement}, you only need to spend one \glossterm{attunement point} to attune to it.
        Otherwise, you can attune to it without spending an \glossterm{attunement point}.
        When you gain access to new spell ranks, you can change which spell you know with this ability, including spells with a higher rank.

        \ff[12]{Partially Liquid} You gain a \plus4 bonus to the Flexibility skill.
        ...
        \ff[18]{Partially Liquid+} You are immune to \glossterm{critical hits} from \glossterm{strikes}.
    \end{magicalfeat}

    \begin{magicalfeat}{Sphere Focus: Astromancy}{Casting, Magical}
        \featpre Access to the \sphere{Astromancy} \glossterm{mystic sphere}.

        \ff[1]{Astral Spell Transit} You gain a \plus15 foot bonus to your range with abilities from the \sphere{Astromancy} \glossterm{mystic sphere}.

        \ff[6]{Intrinsic Astromancy} You learn an additional spell with the \abilitytag{Attune} tag from the \sphere{Astromancy} mystic sphere.
        The spell can be up to rank 3, even if you do not have access to rank 3 spells.
        If that spell is a \glossterm{deep attunement}, you only need to spend one \glossterm{attunement point} to attune to it.
        Otherwise, you can attune to it without spending an \glossterm{attunement point}.
        When you gain access to new spell ranks, you can change which spell you know with this ability, including spells with a higher rank.

        \ff[12]{Efficient Transit} You learn how to transport creatures and objects more smoothly between planes.
        ...
        \ff[18]{Astral Spell Transit+} The range increase from your \textit{astral spell transit} ability increases to \plus30 feet.
    ...
    \begin{magicalfeat}{Sphere Focus: Channel Divinity}{Casting, Magical}
        ...
        \ff[6]{Intrinsic Channeling} You learn an additional spell with the \abilitytag{Attune} tag from the \sphere{Channel Divinity} mystic sphere.
        The spell can be up to rank 3, even if you do not have access to rank 3 spells.
        If that spell is a \glossterm{deep attunement}, you only need to spend one \glossterm{attunement point} to attune to it.
        Otherwise, you can attune to it without spending an \glossterm{attunement point}.
        When you gain access to new spell ranks, you can change which spell you know with this ability, including spells with a higher rank.

        \ff[12]{Font of Divinity} Choose a spell with the \abilitytag{Attune} tag from the \sphere{channel divinity} mystic sphere that is not a \glossterm{deep attunement}.
        ...
        \ff[18]{Greater Aspect of Divinity} The bonus from your \textit{aspect of divinity} ability increases to twice your level.
    \end{magicalfeat}
    ...
    \begin{magicalfeat}{Sphere Focus: Chronomancy}{Casting, Magical}
        ...
        \ff[1]{Accelerated Mind} You can perform primarily mental tasks more quickly as normal.
        ...
        \ff[6]{Intrinsic Chronomancy} You learn an additional spell with the \abilitytag{Attune} tag from the \sphere{Chronomancy} mystic sphere.
        The spell can be up to rank 3, even if you do not have access to rank 3 spells.
        If that spell is a \glossterm{deep attunement}, you only need to spend one \glossterm{attunement point} to attune to it.
        Otherwise, you can attune to it without spending an \glossterm{attunement point}.
        When you gain access to new spell ranks, you can change which spell you know with this ability, including spells with a higher rank.

        \ff[12]{Thief of Time} Whenever you cast a spell from the \sphere{Chronomancy} mystic sphere that deals damage to another creature or causes another creature to be \slowed, you \glossterm{briefly} gain a \plus20 foot bonus to your land speed.

        \ff[18]{Accelerated Mind+} Once per round, you can perform a purely mental action that would normally require a \glossterm{minor action} as a \glossterm{free action}.
    ...
    \begin{magicalfeat}{Sphere Focus: Cryomancy}{Casting, Magical}
        ...
        \ff[1]{Frozen Blood} You are \glossterm{impervious} to cold damage, \glossterm{poisons}, and \glossterm{diseases}.

        \ff[6]{Icy Carapace} You learn the \spell{icy shell} spell, or another spell from the \sphere{Cryomancy} mystic sphere if you already know that spell.
        In addition, the number of layers you can create with \spell{icy shell} increases by one.

        \ff[12]{Frozen Blood+} You are immune to cold damage, \glossterm{poisons}, and \glossterm{diseases}.

        \ff[18]{Icy Carapace+} The number of bonus layers you gain from your \textit{icy carapace} ability increases to two.
    \end{magicalfeat}
    ...
    \begin{magicalfeat}{Sphere Focus: Electromancy}{Casting, Magical}
        ...
        \ff[1]{Electricity Tolerance} You are \trait{impervious} to electricity damage.

        \ff[1]{Extended Chain} The distance that your abilities can \glossterm{chain} is increased to 30 feet instead of 15 feet.

        \ff[6]{Intrinsic Electromancy} You learn an additional spell with the \abilitytag{Attune} tag from the \sphere{Electromancy} mystic sphere.
        The spell can be up to rank 3, even if you do not have access to rank 3 spells.
        If that spell is a \glossterm{deep attunement}, you only need to spend one \glossterm{attunement point} to attune to it.
        Otherwise, you can attune to it without spending an \glossterm{attunement point}.
        When you gain access to new spell ranks, you can change which spell you know with this ability, including spells with a higher rank.

        \ff[12]{Electricity Immunity} You are \trait{immune} to electricity damage.

        \ff[12]{Static Buildup} Whenever you use the \ability{sprint} ability, you gain a \plus2 accuracy bonus with your next spell from the \sphere{Electromancy} mystic sphere.
        This bonus disappears if not used before the end of the next round.

        \ff[18]{Extra Chain} All of your \glossterm{targeted} spells from the \sphere{electromancy} mystic sphere \glossterm{chain} one additional time, even if they did not originally chain.
    ...
    \begin{magicalfeat}{Sphere Focus: Enchantment}{Casting, Magical}
        ...
        \ff[12]{Intrinsic Enchantment} You learn an additional spell with the \abilitytag{Attune} tag from the \sphere{Enchantment} mystic sphere.
        The spell can be up to rank 5, even if you do not have access to rank 5 spells.
        If that spell is a \glossterm{deep attunement}, you only need to spend one \glossterm{attunement point} to attune to it.
        Otherwise, you can attune to it without spending an \glossterm{attunement point}.
        When you gain access to new spell ranks, you can change which spell you know with this ability, including spells with a higher rank.

        \ff[18]{Hidden Influence+} The accuracy bonus from your \textit{subtle influence} ability also applies against \partiallyunaware creatures.
        In addition, the \glossterm{difficulty value} increase from that ability increases to \plus20.

        \ff[18]{Mind Fragments+} You no longer treat those creatures as being impervious.
    \end{magicalfeat}
    ...
    \begin{magicalfeat}{Sphere Focus: Fabrication}{Casting, Magical}
        ...
        \ff[1]{Fabricate Trinket+} The maximum size of the trinket you can create with your \textit{fabricate trinket} cantrip increases by one size category.
        You can cast it with the \abilitytag{Sustain} (minor) tag instead of the \abilitytag{Attune} tag.

        \ff[1]{Mighty Creator} You can use your \glossterm{power} in place of your Craft skill to create items with spells from the \sphere{Fabrication} mystic sphere.

        \ff[6]{Intrinsic Fabrication} You learn an additional spell with the \abilitytag{Attune} tag from the \sphere{Fabrication} mystic sphere.
        The spell can be up to rank 3, even if you do not have access to rank 3 spells.
        If that spell is a \glossterm{deep attunement}, you only need to spend one \glossterm{attunement point} to attune to it.
        Otherwise, you can attune to it without spending an \glossterm{attunement point}.
        When you gain access to new spell ranks, you can change which spell you know with this ability, including spells with a higher rank.

        \ff[12]{Fabricated Armaments} You gain a \plus2 bonus to \glossterm{accuracy} with \glossterm{strikes} using weapons you created with spells from the Fabrication mystic sphere.
        In addition, you gain a \plus1 bonus to the Armor defense provided by body armor from the Fabrication mystic sphere.

        \ff[18]{Fabricate Trinket+} The size increase from your \textit{fabricate trinket+} ability increases to two size categories.
    ...
    \begin{magicalfeat}{Sphere Focus: Photomancy}{Casting, Magical}
        ...
        \ff[6]{Intrinsic Photomancy} You learn an additional spell with the \abilitytag{Attune} tag from the \sphere{Photomancy} mystic sphere.
        The spell can be up to rank 3, even if you do not have access to rank 3 spells.
        If that spell is a \glossterm{deep attunement}, you only need to spend one \glossterm{attunement point} to attune to it.
        Otherwise, you can attune to it without spending an \glossterm{attunement point}.
        When you gain access to new spell ranks, you can change which spell you know with this ability, including spells with a higher rank.

        \ff[12]{Solar Beacon} Whenever you make a creature lose \glossterm{hit points} with a spell from the \sphere{Photomancy} mystic sphere, that creature suffers consequences as if it had been struck by a beam of natural sunlight.
        This can be deadly for some creatures.

        \ff[12]{Unwavering Sight} You are immune to being \dazzled and \blinded.

        \ff[18]{Piercing Sight} You can see through solid objects and spell effects up to one inch thick.
    ...
    \begin{magicalfeat}{Sphere Focus: Polymorph}{Casting, Magical}
        ...
        \ff[1]{Augmented Body} You can use the \textit{augmented body} ability whenever you finish a \glossterm{short rest}.
        ...
        \ff[6]{Intrinsic Polymorph} You learn an additional spell with the \abilitytag{Attune} tag from the \sphere{Polymorph} mystic sphere.
        The spell can be up to rank 3, even if you do not have access to rank 3 spells.
        If that spell is a \glossterm{deep attunement}, you only need to spend one \glossterm{attunement point} to attune to it.
        Otherwise, you can attune to it without spending an \glossterm{attunement point}.
        When you gain access to new spell ranks, you can change which spell you know with this ability, including spells with a higher rank.

        \ff[12]{Malleable Flesh} You gain a \plus4 bonus to the Flexibility skill.
        In addition, you gain a \plus4 bonus to your defenses when determining whether a \glossterm{strike} gets a \glossterm{critical hit} against you instead of a normal hit.

        \ff[18]{Augmented Body+} The bonus from your \textit{augmented body} increases to \plus2.
    \end{magicalfeat}
    ...
    \begin{magicalfeat}{Sphere Focus: Prayer}{Casting, Magical}
        ...
        \ff[6]{Sustained Blessing} Whenever you cast a spell from the \sphere{Prayer} mystic sphere with the \abilitytag{Attune} (target) tag that is not a \glossterm{deep attunement}, you can choose to replace that tag with the \abilitytag{Sustain} (minor) tag.
        ...
        \ff[12]{Sustained Blessing+} When you used your \textit{sustained blessing} ability, you can replace the tag with \abilitytag{Sustain} (free) instead of \abilitytag{Sustain} (minor).
        You can still only sustain one spell in this way at a time.

        \ff[18]{Shared Boon+} When you use your \textit{shared boon} ability, you can also target yourself or a third ally within range.
    \end{magicalfeat}
    ...
    \begin{magicalfeat}{Sphere Focus: Pyromancy}{Casting, Magical}
        ...
        \ff[1]{Fire Tolerance} You are \trait{impervious} to fire damage.

        \ff[6]{Intrinsic Pyromancy} You learn an additional spell with the \abilitytag{Attune} tag from the \sphere{Pyromancy} mystic sphere.
        The spell can be up to rank 3, even if you do not have access to rank 3 spells.
        If that spell is a \glossterm{deep attunement}, you only need to spend one \glossterm{attunement point} to attune to it.
        Otherwise, you can attune to it without spending an \glossterm{attunement point}.
        When you gain access to new spell ranks, you can change which spell you know with this ability, including spells with a higher rank.

        \ff[12]{Friendly Fire} Whenever you deal fire damage to your \glossterm{allies}, you deal half damage.

        \ff[12]{Fire Immunity} You are \trait{immune} to fire damage.

        \ff[18]{Spreading Flame+} When you use your \textit{spreading flame} ability, you can still get a glancing blow with the spell.
    \end{magicalfeat}
    ...
    \begin{magicalfeat}{Sphere Focus: Revelation}{Casting, Magical}
        ...
        \ff[6]{Intrinsic Revelation} You learn an additional spell with the \abilitytag{Attune} tag from the \sphere{Revelation} mystic sphere.
        The spell can be up to rank 3, even if you do not have access to rank 3 spells.
        If that spell is a \glossterm{deep attunement}, you only need to spend one \glossterm{attunement point} to attune to it.
        Otherwise, you can attune to it without spending an \glossterm{attunement point}.
        When you gain access to new spell ranks, you can change which spell you know with this ability, including spells with a higher rank.

        \ff[12]{Blind Seer} You gain \trait{blindsense} with a 90 foot range (see \pcref{Blindsense}).
        If you already have blindsense, you increase its range by 90 feet.
        In addition, you gain \trait{blindsight} with a 30 foot range, allowing you to see without light (see \pcref{Blindsight}).
        If you already have blindsight, the range of your blindsight increases by 30 feet.

        \ff[18]{Oracle+} You can use your \textit{oracle} ability once per \glossterm{short rest} instead of once per long rest.
    \end{magicalfeat}

    \begin{magicalfeat}{Sphere Focus: Summoning}{Casting, Magical}
        \featpre Access to the \sphere{Summoning} \glossterm{mystic sphere}.

        \ff[1]{Resummon} You can use the \textit{resummon} ability as a \glossterm{standard action}.
        ...
        \ff[6]{Empower Summon} You can use the \textit{empower summon} ability as a \glossterm{minor action}.
        \begin{freeability}{Empower Summon}[\abilitytag{Swift}]
        ...
        \ff[12]{Generosity} Whenever you \glossterm{attune} to an item or spell that is not a \glossterm{deep attunement}, you may use this ability.
        ...
        \ff[12]{Resummon+} You can use your \textit{resummon} ability as a \glossterm{minor action}.

        \ff[18]{Empower Summon+} The bonuses from your \textit{empower summon} ability increase to \plus4.
    \end{magicalfeat}
    ...
    \begin{magicalfeat}{Sphere Focus: Telekinesis}{Casting, Magical}
        ...
        \ff[12]{Intrinsic Telekinesis} You learn an additional spell with the \abilitytag{Attune} tag from the \sphere{Telekinesis} mystic sphere.
        The spell can be up to rank 5, even if you do not have access to rank 5 spells.
        If that spell is a \glossterm{deep attunement}, you only need to spend one \glossterm{attunement point} to attune to it.
        Otherwise, you can attune to it without spending an \glossterm{attunement point}.
        When you gain access to new spell ranks, you can change which spell you know with this ability, including spells with a higher rank.

        \ff[18]{Multiple Hands} When you use the \spell{distant hand} cantrip, you can create two hands instead of one.
    ...
    \begin{magicalfeat}{Sphere Focus: Terramancy}{Casting, Magical}
        ...
        \ff[1]{Earthen Alloys} You may treat iron, steel, and worked stone as if they were unworked stone for the purpose of spells from the \sphere{Terramancy} \glossterm{mystic sphere}.

        \ff[6]{Rocky Carapace} You learn the \spell{rocky shell} spell, or another spell from the \sphere{Terramancy} mystic sphere if you already know that spell.
        In addition, the number of layers you can create with that spell increases by one.

        \ff[12]{Earthen Alloys+} You may treat dirt, sand, glass, and all kinds of metal except for cold iron as if they were stone for the purpose of spells from the \sphere{Terramancy} \glossterm{mystic sphere}.

        \ff[18]{Rocky Carapace+} The number of bonus layers you gain from your \textit{rocky carapace} ability increases to two.
    \end{magicalfeat}
    ...
    \begin{magicalfeat}{Sphere Focus: Thaumaturgy}{Casting, Magical}
        ...
        \ff[1]{Mystic Power} You gain a \plus1 bonus to your \glossterm{magical power}.

        \ff[6]{Intrinsic Thaumaturgy} You learn an additional spell with the \abilitytag{Attune} tag from the \sphere{Thaumaturgy} mystic sphere.
        The spell can be up to rank 3, even if you do not have access to rank 3 spells.
        If that spell is a \glossterm{deep attunement}, you only need to spend one \glossterm{attunement point} to attune to it.
        Otherwise, you can attune to it without spending an \glossterm{attunement point}.
        When you gain access to new spell ranks, you can change which spell you know with this ability, including spells with a higher rank.

        \ff[12]{Countermagic} You can use the \textit{countermagic} ability as a standard action.
        \begin{magicalactiveability}{Countermagic}[\abilitytag{Swift}]
            ...
            \rankline
            You gain a \plus2 accuracy bonus with this attack for every 3 levels beyond 12.
        \end{magicalactiveability}

        \ff[12]{Mystic Power+} The bonus from your \textit{mystic power} ability increases to \plus2.

        \ff[18]{Instant Countermagic} You can use your \textit{countermagic} ability as a \glossterm{minor action}.
    ...
    \begin{magicalfeat}{Sphere Focus: Toxicology}{Casting, Magical}
        ...
        \ff[6]{Intrinsic Toxicology} You learn an additional spell with the \abilitytag{Attune} tag from the \sphere{Toxicology} mystic sphere.
        The spell can be up to rank 3, even if you do not have access to rank 3 spells.
        If that spell is a \glossterm{deep attunement}, you only need to spend one \glossterm{attunement point} to attune to it.
        Otherwise, you can attune to it without spending an \glossterm{attunement point}.
        When you gain access to new spell ranks, you can change which spell you know with this ability, including spells with a higher rank.

        \ff[12]{Poisonous Venom} You can also inflict the poison you store with your \textit{poisonous blood} ability on other creatures with attacks.
        ...
        \ff[18]{Poisonous Blood+} You can store up to 10 poison doses with your \textit{poisonous blood} ability.
    \end{magicalfeat}

    \begin{magicalfeat}{Sphere Focus: Umbramancy}{Casting, Magical}
        \featpre Access to the \sphere{Umbramancy} \glossterm{mystic sphere}.

        \ff[1]{Lightbane} You can cast the \spell{suppress light} \glossterm{cantrip} from the Umbramancy mystic sphere as a \glossterm{minor action}, and you can \glossterm{sustain} it as a \glossterm{free action}.

        \ff[6]{Intrinsic Umbramancy} You learn an additional spell with the \abilitytag{Attune} tag from the \sphere{Umbramancy} mystic sphere.
        The spell can be up to rank 3, even if you do not have access to rank 3 spells.
        If that spell is a \glossterm{deep attunement}, you only need to spend one \glossterm{attunement point} to attune to it.
        Otherwise, you can attune to it without spending an \glossterm{attunement point}.
        When you gain access to new spell ranks, you can change which spell you know with this ability, including spells with a higher rank.

        \ff[12]{Shadow Jumper} While you are \sphereterm{shadowed}, the distance you can teleport with spells from the \sphere{Umbramancy} mystic sphere is doubled.

        \ff[18]{Lightbane+} When you cast your \textit{suppress light} cantrip, you can choose to completely block all light in the area instead of dimming it to be \glossterm{shadowy illumination}.
    ...
    \begin{magicalfeat}{Sphere Focus: Verdamancy}{Casting, Magical}
        ...
        \ff[6]{Residual Undergrowth} Whenever you cast a spell from the \textit{verdamancy} sphere, you may create either \glossterm{light undergrowth} or \glossterm{heavy undergrowth} in the area of the spell.
        ...
        \ff[12]{Intrinsic Verdamancy} You learn an additional spell with the \abilitytag{Attune} tag from the \sphere{Verdamancy} mystic sphere.
        The spell can be up to rank 3, even if you do not have access to rank 3 spells.
        If that spell is a \glossterm{deep attunement}, you only need to spend one \glossterm{attunement point} to attune to it.
        Otherwise, you can attune to it without spending an \glossterm{attunement point}.
        When you gain access to new spell ranks, you can change which spell you know with this ability, including spells with a higher rank.
    ...
    \begin{magicalfeat}{Sphere Focus: Vivimancy}{Casting, Magical}
        ...
        \ff[1]{Personal Vitality} You gain a bonus equal to your level to your \glossterm{hit points}.

        \ff[6]{Intrinsic Vivimancy} You learn an additional spell with the \abilitytag{Attune} tag from the \sphere{Vivimancy} mystic sphere.
        The spell can be up to rank 3, even if you do not have access to rank 3 spells.
        If that spell is a \glossterm{deep attunement}, you only need to spend one \glossterm{attunement point} to attune to it.
        Otherwise, you can attune to it without spending an \glossterm{attunement point}.
        When you gain access to new spell ranks, you can change which spell you know with this ability, including spells with a higher rank.

        \ff[12]{Life Suppression} You are no longer considered a living creature for the purpose of attacks against you.
        This means that attacks which only affect living creatures have no effect against you.

        \ff[18]{Personal Vitality+} The hit point bonus increases to twice your level.
    \end{magicalfeat}
    ...
    \begin{magicalfeat}{Telepath}{General, Magical}
        ...
        \ff[6]{Mental Assault} You can use the \textit{mental assault} ability as a standard action.
        \begin{magicalactiveability}{Mental Assault}[\abilitytag{Compulsion}]
            ...
            \hit The target takes \damagerankone{psychic} and becomes \dazed as a \glossterm{condition}.
            If it loses \glossterm{hit points} from this damage, it becomes \stunned instead.
            ...
            \featlevel{18} The target is always stunned instead of dazed.
            If it loses hit points, it becomes \confused instead.
        \end{magicalactiveability}

        \ff[12]{Read Mind} You can use the \textit{read mind} ability as a standard action.
        ...
        \ff[12]{Telepathy+} You can maintain mental channels with up to 5 creatures at once with your telepathy.
        You can send separate thoughts to each creature.

        \ff[18]{Mindsight} You can perfectly see intelligent creatures within the maximum range of your telepathy.
        This functions like \trait{blindsight}, except that it only allows you to see creatures with an Intelligence of 0 or higher.

        \ff[18]{Telepathy++} The range of your telepathy increases by 120 feet.
    \end{magicalfeat}
    ...
    \begin{magicalfeat}{Twinhand Spellcaster}{Casting, Magical}
        ...
        \ff[6]{Freehand Implement} You can gain the benefits of up to two magical implements, such as staves or wands, without having to hold them in your hands.
        ...
        \ff[12]{Twinspell} You can use the \textit{twinspell} ability as a \glossterm{standard action}.
        ...
        \ff[18]{Twinhand Precision+} The bonus from your \textit{twinhand precision} ability increases to \plus2.
    \end{magicalfeat}
    ...
    \begin{magicalfeat}{Wardweaver}{Casting, Magical}
        ...
        \ff[6]{Defensive Barriers} You gain a \plus1 bonus to your Armor defense.
        ...
        \ff[12]{Barrier Spell} You learn a spell with the \abilitytag{Barrier} ability tag from any \glossterm{mystic sphere} that your \glossterm{magic source} gives access to, even if you do not have access to that mystic sphere.
        When you gain access to new spell ranks, you can change which Barrier spell you know.

        \ff[18]{Defensive Barriers+} Your Armor defense bonus from your \textit{defensive barriers} ability increases to \plus2.
        In addition, objects you create with \abilitytag{Barrier} abilities gain an additional \plus2 bonus to their defenses.

        \ff[18]{Hardened Barriers+} The damage resistance bonus from your \textit{hardened barriers} ability increases to twice your \glossterm{power}.
    \end{magicalfeat}
    ...
    \begin{feat}{Whirlwind Warrior}{Combat}
        ...
        \begin{sustainability}{Cyclone}{\abilitytag{Sustain} (standard)}
            ...
            % TODO: double check AOEish damage scaling is right?
            \rankline
            \featlevel{9} You gain a \plus1 accuracy bonus with the strike.
            \featlevel{12} The accuracy bonus increases to \plus2.
            \featlevel{15} The accuracy bonus increases to \plus4.
        ...
        \ff[18]{Storm's Heart} You gain a \plus2 bonus to all defenses against creatures that you are sharing space with.
    \end{feat}
