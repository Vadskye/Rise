...
\end{longtablewrapper}
    ...
    \begin{feat}{Agility Specialization}{Skill}
        ...
        \ff[6]{Acrobatic Fall} You take half damage from \glossterm{falling damage}.
    ...
    \begin{feat}{Awareness Specialization}{Skill}
        ...
        \ff[3]{Extraordinary Senses} You gain one of the following senses: \glossterm{blindsense} (20 ft.), \glossterm{darkvision} (50 ft.), \glossterm{low-light vision}, \glossterm{scent}, or \glossterm{tremorsense} (20 ft.).

        \ff[6]{Quick Scan} When you use the \textit{search} ability, you can notice things in a \areasmall radius within \rngclose range (see \pcref{Search}).

        \ff[9]{Greater Specialization} The bonus from your \textit{specialization} ability increases to \plus6.

        \ff[12]{Greater Extraordinary Senses} You gain one of the following senses: \glossterm{blindsense} (100 ft.), \glossterm{blindsight} (20 ft.), \glossterm{darkvision} (200 ft.), \glossterm{tremorsense} (100 ft.), or \glossterm{tremorsight} (20 ft.).
    ...
    \begin{feat}{Blindfighter}{Combat}
        ...
        \ff[15]{Greater Blindsight} The range of your blindsight increases by 50 feet.
        ...
        \ff[21]{Supreme Sight} The range of your blindsight improves to 200 feet.
    ...
    \begin{feat}{Blood Magic}{Casting, Magical}
        ...
        \ff[1]{Fortified Blood} You treat your level as if it was 1 higher than it actually is for the purpose of determining your \glossterm{hit points} (see \tref{Hit Points}).

        \ff[3]{Bloodspell} Whenever you cast a spell, you may use this ability.
        ...
        \ff[9]{Greater Fortified Blood} The level increase from your \textit{fortified blood} ability increases to 2.

        \ff[12]{Greater Bloodspell} The bonus to \glossterm{power} from your \textit{bloodspell} ability increases to \plus4.
        ...
        \ff[18]{Greater Fortified Blood} The level increase from your \textit{fortified blood} ability increases to 3.

        \ff[21]{Supreme Bloodspell} The bonus to \glossterm{power} from your \textit{bloodspell} ability increases to \plus8.
    \end{feat}
    ...
    \begin{feat}{Brawler}{Combat}
        ...
        \ff[3]{Takedown} Whenever you hit a target with the \textit{grapple} ability, the target also takes damage as if you had hit with your unarmed attack.

        \ff[6]{Greater Grapple Expertise} The bonus from your \textit{grapple expertise} ability increases to \plus3.
        ...
        \ff[12]{Greater Grapple Expertise} The bonus from your \textit{grapple expertise} ability increases to \plus4.
    ...
    \begin{feat}{Celestial Heritage}{Bloodline, Magical}
        ...
        \ff[12]{Angelic Flight} You can use the \textit{angelic flight} ability as a \glossterm{free action}.
        \begin{freeability}{Angelic Flight}[Magical]
            ...
            If you have used this ability since you last landed on the ground, you also gain a \glossterm{fatigue point}.
        \end{freeability}

        \ff[15]{Supreme Celestial Soul} The bonus from your \textit{celestial soul} ability increases to be equal to your level.

        \ff[18]{Greater Angelic Flight} Your \textit{angelic flight} ability lasts until the end of the next round.
    \end{feat}
    ...
    \begin{feat}{Climb Specialization}{Skill}
        ...
        \ff[3]{Climb Speed} You gain a \glossterm{climb speed} equal to half your \glossterm{base speed}.
        A successful Climb check to move allows you to travel a distance equal to your climb speed.

        \ff[6]{Damage Tolerance} Taking damage while climbing does not force you to make an additional Climb check to avoid falling.

        \ff[9]{Greater Specialization} The bonus from your \textit{specialization} ability increases to \plus6.

        \ff[12]{Greater Climb Speed} Your \glossterm{climb speed} increases to be equal to your \glossterm{base speed}.
        ...
        \ff[18]{Greater Impossible Climber} You take no penalty for climbing with no free hands.
    \end{feat}
    ...
    \begin{feat}{Draconic Heritage}{Bloodline}
        ...
        \begin{freeability}{Breath Weapon}
            ...
            \rankline
            The damage increases by \plus1d at 6th level and every 3 levels thereafter.
            \featlevel{9} The area affected by your breath weapon increases.
                A line breath weapon becomes a \areahuge, 15 ft.\ wide line.
                A cone breath weapon becomes a \arealarge cone.
            \featlevel{15} You gain a \plus1d bonus to damage.
        ...
        \ff[6]{Draconic Wings} You gain scaly wings that sprout from your back.
        These wings grant you a glide speed equal to your \glossterm{base speed} (see \pcref{Gliding}).
        The wings themselves are \glossterm{mundane}, but the ability to fly and glide with them is \glossterm{magical}.

        \ff[9]{Draconic Scales} You gain a \plus1 bonus to Armor defense.

        \ff[12]{Draconic Flight}[Magical] You can use the \textit{draconic flight} ability as a \glossterm{free action}.
        ...
        \ff[15]{Greater Draconic Scales} The gonus from your \textit{draconic scales} ability increases to \plus2.

        \ff[18]{Greater Draconic Flight} Your \textit{draconic flight} ability lasts until the end of the next round.
    \end{feat}
    ...
    \begin{feat}{Duelist}{Combat}
        ...
        \ff[3]{Parry} You gain a \plus1 bonus to Armor defense as long as you wield a melee weapon and are not \glossterm{threatened} by more than one creature.
        ...
        \ff[9]{Duel Focus} You are treated as being \glossterm{threatened} by one fewer creature than you actually are for the purpose of abilities from this feat.

        \ff[12]{Greater Parry} The bonus from your \textit{parry} ability increases to \plus2.

        \ff[15]{Greater Riposte} The bonus from your \textit{riposte} ability increases to \plus2.

        \ff[18]{Greater Duel Focus} The reduction in number of creatures threatening you from your \textit{duel focus} ability increases to two creatures.
    \end{feat}
    ...
    \begin{feat}{Executioner}{Combat}
        ...
        \begin{freeability}{Execution}
            ...
            \featlevel{12} The automatic damage bonus increases to \plus2d.
            \featlevel{18} Both circumstantial damage bonuses increase to \plus2d.
        \end{freeability}

        \ff[3]{Blood Sense}[Magical] You automatically know the location of all creatures that are \textit{marked for execution} within 50 feet of you, regardless of concealment or invisibility.
        ...
        \ff[15]{Supreme Blood Sense}[Magical] The range of your \textit{blood sense} ability increases to 200 feet.
    \end{feat}
    ...
    \begin{feat}{Greatweapon Warrior}{Combat}
        ...
        \ff[3]{Cleave} Whenever you wield a melee weapon in two hands, it gains the Sweeping (1) tag (see \pcref{Sweeping}).
        ...
        \ff[9]{Greater Power Attack} The damage bonus from your \textit{power attack} ability increases to \plus2d.

        \ff[12]{Greater Cleave} The tag granted by your \textit{cleave} ability changes to be Sweeping (2).
        ...
        \ff[18]{Supreme Power Attack} The damage bonus from your \textit{power attack} ability increases to \plus3d.
    \end{feat}
    ...
    \begin{feat}{Intimidate Specialization}{Skill}
        ...
        \ff[6]{Threatening Presence} You are considered to be \glossterm{threatening} each \glossterm{enemy} within a \arealarge emanation from you for the purpose of determining their \glossterm{overwhelm penalty}. 
        ...
        \ff[18]{Fearsome Foe} You are considered an additional creature for the purpose of determining the \glossterm{overwhelm penalty} you inflict on other creatures.
    ...
    \begin{feat}{Iron Will}{General}
        ...
        \ff[12]{Greater Mind over Matter} You treat your level as if it was 1 higher than it actually is for the purpose of determining your \glossterm{hit points}.
    ...
    \begin{feat}{Jump Specialization}{Skill}
        ...
        \ff[3]{Featherlight Leap} You can use the \textit{featherlight leap} ability as a \glossterm{free action}.
        ...
        \ff[6]{Instant Leap} You suffer no penalty for jumping without a running start (see \pcref{Running Start}).

        \ff[9]{Greater Specialization} The bonus from your \textit{specialization} ability increases to \plus6.

        \ff[12]{Impact Tolerance} You are immune to \glossterm{falling damage}.

        \ff[15]{Supreme Specialization} The bonus from your \textit{specialization} ability increases to \plus9.

        \ff[18]{Greater Featherlight Leap} Your maximum height for jumps is always equal to your Jump check result.
    ...
    \begin{feat}{Martial Training}{Combat}
        ...
        \ff[6]{Martial Power} You gain a \plus2 bonus to \glossterm{power} with \glossterm{mundane} abilities.
    ...
    \begin{feat}{Medicine Specialization}{Skill}
        ...
        \begin{freeability}{Healing Touch}[\glossterm{Life}]
            ...
            \rank{3} The healing increases by an additional \plus1d.
            \rank{5} The healing increases by an additional \plus1d.
            \rank{7} The healing increases by an additional \plus1d.
        \end{freeability}
    ...
    \begin{feat}{Mental Magic}{Casting, Magical}
        ...
        \ff[3]{Potent Mind} You gain a \plus2 bonus to \glossterm{power} with \glossterm{magical} abilities.
    ...
    \begin{feat}{Metacaster}{Casting, Magical}
        ...
        \begin{dtable}
            ...
            \begin{dtabularx}{\columnwidth}{l >{\lcol}X}
                ...
                1 & Chilled, dazed, dazzled, sickened, slowed \\
    ...
    %     \ff[6]{Widened Backlash} The area affected by your \glossterm{miscast backlash} increases to a \areamed radius centered on you.

    %     \ff[9]{Toughened Body} You gain an additional \glossterm{hit point}.

    %     \ff[12]{Resilient Channeler} The penalty to defenses from your \textit{overchannel} ability is removed.

    %     \ff[15]{Empowered Miscast} You gain a \plus2 bonus to \glossterm{power} with your \glossterm{miscast backlash}.

    %     \ff[18]{Greater Widened Backlash} The area affected by your \glossterm{miscast backlash} increases to a \areamed radius centered on you.
    % \end{feat}
    ...
    \begin{feat}{Null}{General}
        ...
        \ff[15]{Greater Disruptive Presence} Your \textit{disruptive presence} ability affects all enemies in a \arealarge radius \glossterm{emanation} from you.
    ...
    \begin{feat}{Perform Specialization}{Skill}
        ...
        \ff[6]{Lingering Performance}[Magical] Whenever you stop performing, the effects of the performance linger until the end of the next round as if you were still performing.
        ...
        \ff[12]{Greater Synergistic Performance} The penalty from your \textit{synergistic performance} ability is removed.
    ...
    \begin{feat}{Precognition}{General}
        ...
        \ff[9]{Foresight} During the \glossterm{movement phase}, you choose your action after all other creatures have chosen their actions.
        ...
        \ff[12]{Greater Precognitive Precision} You gain a \plus1 bonus to \glossterm{accuracy}.

        \ff[15]{Greater Precognitive Reaction} The bonuses from your \textit{precognitive reaction} ability increase to \plus4.

        \ff[18]{Greater Foresight} The range of your \textit{foresight} ability increases to \rnglong range.
    \end{feat}
    ...
    \begin{feat}{Prepared Spellcasting}{Magical, Spell}
        ...
        \ff[3]{Study of Magic} You gain a \plus2 bonus to \glossterm{power} with \glossterm{magical} abilities.
    ...
    \begin{feat}{Regenerator}{General}
        ...
        \begin{freeability}{Regenerative Recovery}
            ...
            \rankline
            The healing increases by \plus1d at 6th level and every 3 levels thereafter.
        \end{freeability}
    ...
    \begin{feat}{Savage}{Combat}
        ...
        \ff[3]{Wall Slam} If you use the \textit{shove} ability to move a creature, and the creature's movement is interrupted by a solid obstacle, the obstacle and creature both take bludgeoning damage equal to 1d10 plus your \glossterm{power}.
        ...
        If you knockback a creature into a solid obstacle or another creature in this way, both objects or creatures take bludgeoning damage equal to the damage from your \textit{wall slam} ability.
    ...
    \begin{feat}{Shieldbearer}{Combat}
        ...
        \ff[3]{Forceful Block} Whenever a creature misses you with a melee \glossterm{strike}, that creature takes a \minus2 penalty to Armor defense until the end of the next round.

        \ff[6]{Arrow Deflection} You and each \glossterm{ally} adjacent to you gain a \plus2 bonus to Armor defense against \glossterm{mundane} ranged attacks from weapons or projectiles that are at least one \glossterm{size category} smaller than you.
    ...
    \begin{feat}{Social Insight Specialization}{Skill}
        ...
        \ff[18]{Greater Truthsense} The area of your \textit{truthsense} ability increases to a 200 foot radius.
    \end{feat}
    ...
    \begin{feat}{Spellsense Specialization}{Skill}
        ...
        \ff[12]{Mystic Power} You gain a \plus4 bonus \glossterm{power} with \glossterm{magical} abilities.
    ...
    \begin{feat}{Spellsword}{Magical, Spell}
        ...
        \ff[9]{Personal Enhancement} You gain a \plus1 \glossterm{magic bonus} to \glossterm{accuracy}, \glossterm{defenses}, and \glossterm{power}.
    ...
    \begin{feat}{Spellwarped}{General, Magical}
        ...
        \ff[3]{Spell Rank} You become a rank 2 spellcaster in your chosen \glossterm{mystic sphere}.
        This gives you access to spells that require a minimum rank of 2.

        \ff[6]{Spell Rank} You become a rank 3 spellcaster in your chosen \glossterm{mystic sphere}.
        ...
        \ff[9]{Spell Rank} You become a rank 4 spellcaster in your chosen \glossterm{mystic sphere}.
        ...
        \ff[12]{Spell Rank} You become a rank 5 spellcaster in your chosen \glossterm{mystic sphere}.
        ...
        \ff[15]{Spell Rank} You become a rank 6 spellcaster in your chosen \glossterm{mystic sphere}.
        ...
        \ff[18]{Spell Rank} You become a rank 7 spellcaster in your chosen \glossterm{mystic sphere}.
    ...
    \begin{feat}{Sphere Focus: Aeromancy}{Casting, Magical}
        ...
        \ff[18]{Supreme Personal Updraft} As long as you are within 100 feet of the ground, you gain a \glossterm{fly speed} equal to your \glossterm{base speed} (see \pcref{Flying}).
    \end{feat}
    ...
    \begin{feat}{Sphere Focus: Barrier}{Casting, Magical}
        ...
        \begin{freeability}{Burst Ward}[\glossterm{Swift}]
            ...
            \rankline
            \featlevel{9} You also gain a \plus1 bonus to all defenses.
            \featlevel{15} The defense bonus increases to \plus2.
        \end{freeability}

        \ff[6]{Hardened Barriers} You gain a bonus equal to your level to the \glossterm{vital resistance} of objects you create with the \sphere{Barrier} \glossterm{mystic sphere}.
        ...
        \ff[12]{Innate Shield} You gain a \plus1 bonus to Armor defense.

        \ff[15]{Spell} You learn a spell from the \sphere{Barrier} \glossterm{mystic sphere}.
        When you gain access to a new spell level, you can change which spell you know from that mystic sphere.

        \ff[18]{Greater Hardened Barriers} The bonus from your \textit{hardened barriers} ability increases to three times your level.
    \end{feat}
    ...
    \begin{feat}{Sphere Focus: Bless}{Casting, Magical}
        ...
        \ff[3]{Inspiring Blessing} Each creature that is \glossterm{attuned} to a spell you cast from the \sphere{Bless} \glossterm{mystic sphere} increases its current \glossterm{hit points} by an amount equal to half your \glossterm{power} (minimum 1).
        This can allow the target's current hit points to exceed its normal maximum hit points.
        When this effect ends, the creature loses hit points equal to the hit points it gained this way.
    ...
    \begin{feat}{Sphere Focus: Biomancy}{Casting, Magical}
        ...
        \ff[3]{Biological Control} You gain a \plus2 bonus to Fortitude defense.
        ...
        \ff[6]{Biological Cleanse} You can use the \textit{biological cleanse} ability as a \glossterm{minor action}.
        \begin{freeability}{\labeltext{Biological Cleanse}}
            ...
            \rankline
            \featlevel{12} This ability can target any \glossterm{ally} within your \glossterm{reach}.
            \featlevel{18} This ability can target any \glossterm{ally} within \rngmed range.
        \end{freeability}

        \ff[9]{Personal Biomancy} You gain an additional \glossterm{attunement point}.
        ...
        \ff[12]{Greater Biological Control} The bonus from your \textit{biological control} ability increases to \plus4.
        ...
        \ff[15]{Spell} You learn a spell from the \sphere{Biomancy} \glossterm{mystic sphere}.
        When you gain access to a new spell level, you can change which spell you know from that mystic sphere.

        \ff[18]{Greater Personal Biomancy} The number of attunement points you gain from your \textit{personal biomancy} ability increases to 2.
    \end{feat}
    ...
    \begin{feat}{Sphere Focus: Cryomancy}{Casting, Magical}
        ...
        \ff[6]{Lingering Chill} Whenever you make a creature lose \glossterm{hit points} with cold damage, that creature is \glossterm{chilled} until the end of the next round.
        ...
        \ff[18]{Greater Lingering Chill} The \glossterm{chilled} effect from your \textit{lingering chill} ability becomes a \glossterm{condition} that lasts until it is removed.
    \end{feat}
    ...
    \begin{feat}{Sphere Focus: Enchantment}{Casting, Magical}
        ...
        \ff[15]{Spell} You learn a spell from the \sphere{Compel} \glossterm{mystic sphere}.
        When you gain access to a new spell level, you can change which spell you know from that mystic sphere.
    ...
    \begin{feat}{Sphere Focus: Pyromancy}{Casting, Magical}
        ...
        \ff[3]{Fire Resistance} You gain a bonus equal to your \glossterm{power} to your \glossterm{resistances} against fire damage.
        ...
        \ff[6]{Lingering Flame} Whenever you make a creature lose \glossterm{hit points} with fire damage, that creature takes 1d8 fire damage at the end of the next round.
        That creature then becomes immune to this effect until it takes a \glossterm{short rest}.
        This damage increases by \plus1d at 6th level and every 3 levels thereafter.
    ...
    \begin{feat}{Sphere Focus: Summoning}{Casting, Magical}
        ...
        \begin{freeability}{Resummon}
            ...
            \rankline
            \featlevel{12} The range increases to \rnglong.
        ...
        \ff[12]{Greater Fortified Summons} Creatures you summon treat your level as being 1 higher than it actually is for the purpose of determining their \glossterm{hit points}.
    ...
    \begin{feat}{Sphere Focus: Thaumaturgy}{Casting, Magical}
        ...
        \ff[6]{Mystic Power} You gain a \plus2 bonus to \glossterm{power} with \glossterm{magical} abilities.
    ...
    \begin{feat}{Sphere Focus: Umbramancy}{Casting, Magical}
        ...
        \ff[6]{Darkvision} You gain \glossterm{darkvision} with a 50 foot range, allowing you to see in complete darkness clearly.
        ...
        \ff[18]{Darksight} The range of your \glossterm{darkvision} ability increases by 200 feet.
    ...
    \begin{feat}{Sphere Focus: Verdamancy}{Casting, Magical}
        ...
        \ff[6]{Creative Genesis} You can cast spells from the \sphere{Verdamancy} \glossterm{mystic sphere} as if non-arable ground of any kind was arable earth.
        ...
        \ff[18]{Supreme Verdant Allies} You treat all living creatures as if they were plants for the purpose of abilities from this feat and abilities from the \sphere{Verdamancy} \glossterm{mystic sphere}.
    \end{feat}
    ...
    \begin{feat}{Stealth Specialization}{Skill}
        ...
        \ff[3]{Ambush the Unwary} You gain a \plus2 bonus to \glossterm{power} against \glossterm{unaware} creatures.

        \ff[6]{Movement Tolerance} Your penalties for moving while hiding are reduced by 5.
        This allows you to move at half speed without penalty.

        \ff[9]{Greater Specialization} The bonus from your \textit{specialization} ability increases to \plus6.

        \ff[12]{Hide in Plain Sight} You can use the \textit{hide} ability even while observed.
        ...
        \ff[18]{Greater Hide in Plain Sight} Creatures observing you while you try to hide gain a \plus5 bonus to checks to notice you instead of a \plus10 bonus.
    \end{feat}
    ...
    \begin{feat}{Swim Specialization}{Skill}
        ...
        \ff[3]{Underwater Tolerance} You reduce your penalties for fighting underwater by 2, except for penalties to \glossterm{mundane} ranged attacks (see \pcref{Underwater Combat}).

        \ff[6]{Swim Speed} You gain a \glossterm{swim speed} equal to your \glossterm{base speed}.
    ...
    \begin{feat}{Toughness}{General}
        ...
        \ff[3]{Durability} You treat your level as if it was 1 higher than it actually is for the purpose of determining your \glossterm{hit points} (see \tref{Hit Points}).
        ...
        \ff[12]{Greater Durability} The level increase from your \textit{durability} ability increases to 2.
    ...
    \begin{feat}{Two-Weapon Fighting}{Combat}
        ...
        \ff[3]{Dual Precision} You gain a \plus1 bonus to \glossterm{accuracy} with \glossterm{strikes} while you wield two weapons.

        \ff[6]{Two-Weapon Defense} While wielding two melee weapons, you gain a \plus1 bonus to Armor defense.
        ...
        \ff[12]{Greater Dual Precision} The bonus from your \textit{dual precision} ability increases to \plus2.

        \ff[15]{Greater Two-Weapon Defense} The bonus from your \textit{two-weapon defense} ability increases to \plus2.

        \ff[18]{Supreme Offhand Force} The bonus from your \textit{offhand force} ability increases to \plus3d.
    \end{feat}
    ...
    \begin{feat}{Whirlwind Warrior}{Combat}
        ...
        \ff[9]{Eye of the Storm} You reduce your \glossterm{overwhelm penalty} by 1.
