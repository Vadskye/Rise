...
\end{longtablewrapper}
    ...
    \begin{feat}{Sphere Focus: Pyromancy}{Casting, Magical}
        ...
        \ff[4]{Lingering Flame} Whenever you \glossterm{wound} a creature with a \glossterm{critical hit} using fire damage, that creature takes fire \glossterm{standard damage} \minus2d at the end of the next round.
