...
\end{longtabuwrapper}
    ...
    \begin{feat}{Draconic Heritage}{Bloodline}
        ...
        You gain a bonus equal to twice your \glossterm{power} to your \glossterm{resistances} against the damage type dealt by that dragon's breath weapon.
    ...
    \begin{feat}{Heal Specialization}{Skill}
        ...
        \begin{freeability}{Healing Touch}[\glossterm{Life}]
            ...
            You can use this ability up to 3 times between \glossterm{short rests}.

            \rankline
            \rank{10} When you use this ability, you can spend an \glossterm{action point}.
            If you do, the target removes a \glossterm{vital wound} instead of an 
    ...
    \begin{feat}{Regenerator}{General}
        ...
        \ff[19]{Greater Regenerative Recovery} Your \textit{regenerative recovery} ability regains two \glossterm{hit points}.
    \end{feat}
    ...
    \begin{feat}{Sphere Focus: Bless}{Casting, Magical}
        ...
        \ff[4]{Inspiring Blessing} Each creature that is \glossterm{attuned} to a spell you cast from the \sphere{Bless} \glossterm{mystic sphere} gains a \plus1 bonus to Mental defense.

        \ff[7]{Spell} You learn a spell from the \sphere{bless} \glossterm{mystic sphere}.
        When you gain access to a new spell level, you can change which spell you know from that \glossterm{mystic sphere}.

        \ff[10]{Dual Blessing} Whenever you cast an \glossterm{Attune} (target) spell from the \sphere{Bless} \glossterm{mystic sphere}, you may target an additional creature.

        \ff[13]{Greater Inspiring Blessing} The bonus from your \textit{inspiring blessing} ability increases to \plus2.

        \ff[16]{Spell} You learn a spell from the \sphere{bless} \glossterm{mystic sphere}.
        When you gain access to a new spell level, you can change which spell you know from that \glossterm{mystic sphere}.

        \ff[19]{Myriad Blessing} The number of additional targets from your \textit{dual blessing} ability increases to ten.
    \end{feat}
    ...
    \begin{feat}{Sphere Focus: Cryomancy}{Casting, Magical}
        ...
        \ff[4]{Lingering Chill} Whenever you deal cold damage to a creature with a \glossterm{critical hit} using a spell from the \sphere{cryomancy} \glossterm{mystic sphere}, the target is \glossterm{chilled} as a \glossterm{condition}.
        ...
        \ff[13]{Greater Lingering Chill} Your \textit{lingering chill} ability also makes the target \glossterm{immobilized} until the end of the next round.
    ...
    \begin{feat}{Sphere Focus: Pyromancy}{Casting, Magical}
        ...
        \ff[4]{Lingering Flame} Whenever you deal fire damage to a creature with a \glossterm{critical hit} using a spell from the \sphere{pyromancy} \glossterm{mystic sphere}, the target is \glossterm{ignited} as a \glossterm{condition}.
    ...
    \begin{feat}{Sphere Focus: Vital Surge}{Casting, Magical}
        ...
        \ff[10]{Reciprocal Healing} When you cause another creature to regain at least \glossterm{hit point} with a spell from the \sphere{vital surge} \glossterm{mystic sphere}, you also regain a \glossterm{hit point}.
        ...
        \ff[19]{Greater Reciprocal Healing} Your \textit{reciprocal healing} ability regains \glossterm{hit points} equal to the \glossterm{hit points} you removed from one creature with the spell.
    \end{feat}
