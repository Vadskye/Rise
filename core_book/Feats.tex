...
\end{longtabuwrapper}
    ...
    \begin{feat}{Metacaster}{Casting, Magical}
        ...
        \begin{dtable}
            ...
            \begin{dtabularx}{\columnwidth}{l >{\lcol}X}
                ...
                2 & Decelerated, exhausted, frightened, ignited (removable)\fn{1}, nauseated, stunned \\
    ...
    \begin{feat}{Sphere Focus: Pyromancy}{Casting, Magical}
        ...
        \ff[4]{Lingering Flame} Whenever you deal fire damage to a creature with a \glossterm{critical hit}, the target takes fire \glossterm{standard damage} \minus3d at the end of the next round.
