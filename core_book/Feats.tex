...
\end{longtabuwrapper}
    ...
    \begin{feat}{Regenerator}{General}
        ...
        \begin{freeability}{name}
            You remove a point of \glossterm{fatigue}.
            After you use this ability a number of times equal to your starting Constitution, you cannot use it again until you take a \glossterm{short rest}.
        \end{freeability}
        ...
        \ff[7]{Diehard} You gain a \plus1 bonus to \glossterm{wound rolls}.
        ...
        \ff[16]{Indestructible} The bonus from your \textit{diehard} ability increases to \plus2.

        \ff[19]{Greater Regenerative Recovery} Your \textit{regenerative recovery} ability removes two points of \glossterm{fatigue}.
    \end{feat}
    ...
    \begin{feat}{Sphere Focus: Vital Surge}{Casting, Magical}
        ...
        \ff[4]{Personal Vitality} You gain a \plus2 bonus to Fortitude defense.

        \ff[7]{Spell} You learn a spell from the \sphere{vital surge} \glossterm{mystic sphere}.
        When you gain access to new spell levels, you can change which spell you know from that \glossterm{mystic sphere}.

        \ff[10]{Reciprocal Healing} When you cause another creature to remove at least one point of \glossterm{fatigue} with a spell from the \sphere{vital surge} \glossterm{mystic sphere}, you also remove a point of \glossterm{fatigue}.
        You can only gain this healing once per spell.

        \ff[13]{Greater Personal Vitality} The bonus from your \textit{personal vitality} ability increases to \plus4.

        \ff[16]{Greater Vital Surge Focus} The bonus from your \textit{vital surge focus} ability increases to \plus2.

        \ff[19]{Greater Reciprocal Healing} Your \textit{reciprocal healing} ability removes fatigue from you equal to the fatigue you removed from one creature with the spell.
    \end{feat}
