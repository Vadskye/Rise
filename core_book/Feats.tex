...
\end{longtablewrapper}
    ...
    \begin{feat}{Draconic Heritage}{Bloodline}
        ...
        \ff[12]{Draconic Flight}[Magical] You gain a \glossterm{fly speed} equal to the \glossterm{base speed} for your size with a maximum height of 30 feet (see \pcref{Flying}).
        At the start of each phase, you can increase your \glossterm{fatigue level} by one to ignore this height limit until the end of the round.
    ...
    \begin{feat}{Sphere Focus: Aeromancy}{Casting, Magical}
        ...
        \ff[18]{Supreme Personal Updraft} You gain a \glossterm{fly speed} equal to the \glossterm{base speed} for your size with a maximum height of 120 feet (see \pcref{Flying}).
        At the start of each phase, you can increase your \glossterm{fatigue level} by one to ignore this height limit until the end of the round.
    \end{feat}
    ...
    \begin{feat}{Sphere Focus: Electromancy}{Casting, Magical}
        ...
        \ff[3]{Energetic Rush} You gain a \plus5 foot bonus to your speed with all of your \glossterm{movement modes}.
    ...
    \begin{feat}{Sphere Focus: Vivimancy}{Casting, Magical}
        ...
        \ff[6]{Hidden Life} You can treat nonliving creatures as if they were living creatures for the purpose of your spells from the \sphere{Vivimancy} \glossterm{mystic sphere}.
