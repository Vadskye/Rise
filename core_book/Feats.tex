...
\end{longtablewrapper}
    ...
    \begin{feat}{Brawler}{Combat}
        ...
        \ff[3]{Takedown} Whenever you hit a target with the \textit{grapple} ability, the target also takes damage as if you had hit with your unarmed attack or a light \glossterm{natural weapon}.
    ...
    \begin{feat}{Celestial Heritage}{Bloodline, Magical}
        ...
        \ff[12]{Angelic Flight}[Magical] You gain a \glossterm{fly speed} equal to your \glossterm{base speed} (see \pcref{Flying}).
    ...
    \begin{feat}{Draconic Heritage}{Bloodline}
        ...
        \ff[12]{Draconic Flight}[Magical] You gain a \glossterm{fly speed} equal to your \glossterm{base speed} (see \pcref{Flying}).
        This fly speed only functions while you are within 30 feet of a solid object beneath you that is at least two size categories larger than you.
        At the start of each phase, you can gain a \glossterm{fatigue point} to ignore this height limit until the end of the round.
    ...
    \begin{feat}{Maneuver Versatility}{Combat}
        ...
        \ff[3]{Maneuver Flexibility} Choose one of the manuever lists that you do not have access to: esoteric, martial, primal, trick, or wild maneuvers.
    ...
    \begin{feat}{Sphere Focus: Aeromancy}{Casting, Magical}
        ...
        This fly speed only functions while you are within 240 feet of a solid object beneath you that is at least two size categories larger than you.
        At the start of each phase, you can gain a \glossterm{fatigue point} to ignore this height limit until the end of the round.
    \end{feat}
