...
\end{longcolumn}
    ...
    \begin{feat}{Battle Armory}{Combat}
        ...
        This still counts against your one free object manipulation per round (see \pcref{Manipulating Objects}).
    ...
    \begin{magicalfeat}{Celestial Ancestry}{Ancestry, Magical}
        ...
        \magicalff[1]{Celestial Benevolence} When you cause an \glossterm{ally} to regain hit points, you can choose to lose any number of hit points, to a minimum of 0 remaining hit points.
        ...
        If this ability is triggered by a \abilitytag{Swift} effect, the transfer is also Swift.
        ...
        \magicalff[18]{Angel Wings+} The height limit increases to 60 feet.
    ...
    \begin{feat}{Combat Style Versatility}{Combat}
        ...
        \ff[12]{Maneuver Fusion} You can use the \textit{maneuver fusion} ability as a \glossterm{standard action}.
    ...
    \begin{feat}{Deception Specialization}{Skill}
        ...
        \magicalff[6]{Forked Tongue} When you speak, you can use the \textit{forked tongue} ability.
    ...
    \begin{magicalfeat}{Entropist}{General, Magical}
        ...
        \begin{magicalactiveability}{Sudden Entropy}
            ...
            \featlevel{9} The base damage increases to 2d6.
            \featlevel{12} The damage bonus from your \glossterm{power} increases to 1d10 per 3 power.
            \featlevel{15} The base damage increases to 2d10.
            \featlevel{18} The damage bonus from your \glossterm{power} increases to 1d10 per 2 power.
        \end{magicalactiveability}
        ...
        However, \glossterm{vital rolls} and the damage type of your \ability{sudden entropy} ability are unaffected by this ability.
        ...
        However, \glossterm{vital rolls} and the damage type of your \ability{sudden entropy} ability cannot be affected by this ability.
    \end{magicalfeat}
    ...
    \begin{feat}{Executioner}{Combat}
        ...
        \ff[12]{Death is Inescapable} When you deal damage to a creature that is marked for execution, the damage is treated as damage of all types.
    ...
    \begin{feat}{Fateweaver}{General, Magical}
        ...
        % Average of +1.5 accuracy, so worse than a typical "-2 defenses" condition. A typical t1.5 debuff would be r3, requiring 9th level.
        % If this gets a one rank discount for being a feat ability, this is reasonably balanced.
        \magicalff[6]{Fateseal} You can use the \textit{fateseal} ability as a standard action.
    ...
    \begin{magicalfeat}{Ghostblade}{Combat, Magical}
        ...
        \begin{magicalactiveability}{Spectral Strike}
            ...
            \featlevel{15} The extra damage increases to 2d8 \plus1 per 2 power.
            \featlevel{18} The extra damage increases to 2d8 \add 1d8 per 3 power.
        \end{magicalactiveability}
    ...
    \begin{feat}{Juggernaut}{Combat}
        ...
        \begin{activeability}{Trample}[\abilitytag{Brawling}, \abilitytag{Size-Based}]
            ...
            In addition, the attack deals \damageranktwo{bludgeoning} damage.
            % TODO: wording
            ...
            \rankline
            \featlevel{9} The damage bonus from your \glossterm{power} increases to be equal to your power.
            \featlevel{12} The base damage increases to 1d10.
            \featlevel{15} The damage bonus increases to 1d8 per 3 power.
            \featlevel{18} The base damage increases to 2d8.
        \end{activeability}
    ...
    \begin{feat}{Medicine Specialization}{Skill}
        ...
        \begin{activeability}{Healing Touch}[\abilitytag{Swift}]
            ...
            The target regains 4d6 \glossterm{hit points} and increases its \glossterm{fatigue level} by one.
            ...
            \rankline
            \featlevel{9} The healing increases to 6d6.
            \featlevel{12} The healing increases to 5d10.
            \featlevel{15} The healing increases to 7d10.
            \featlevel{18} The healing increases to 10d10.
        \end{activeability}
...
w
    ...
    \begin{feat}{Regenerator}{General}
        ...
        \begin{activeability}{Regenerative Recovery}[\abilitytag{Swift}]
            ...
            You regain 2d6 \glossterm{hit points}.
            If you gained any \glossterm{vital wounds} during the previous round, your healing with this ability is doubled.

            \rankline
            \featlevel{3} The healing increases to 2d10.
            \featlevel{6} The healing increases to 4d6.
            \featlevel{9} The healing increases to 6d6.
            \featlevel{12} The healing increases to 5d10.
            \featlevel{15} The healing increases to 7d10.
            \featlevel{18} The healing increases to 10d10.
    ...
    \begin{magicalfeat}{Spellsword}{Magical, Spell}
        ...
        In addition, you can cast spells using a non-\weapontag{Projectile} weapon as if it were an implement (see \pcref{Magic Implements}).
    ...
    \begin{magicalfeat}{Sphere Focus: Photomancy}{Casting, Magical}
        ...
        In addition, the edges of any areas of \glossterm{brilliant illumination} created by the spell become physical barriers.
    ...
    \begin{magicalfeat}{Telepath}{General, Magical}
        ...
        \begin{magicalactiveability}{Mental Assault}[\abilitytag{Compulsion}]
            ...
            \rankline
            % increase to d2
            \featlevel{9} The base damage increases to 1d8.
            % increase to d3
            \featlevel{12} The damage bonus from your power increases to be equal to your power.
            % increase to d4ish
    ...
    \begin{feat}{Whirlwind Warrior}{Combat}
        ...
        \begin{sustainability}{Cyclone}{\abilitytag{Sustain} (standard)}
            ...
            \rankline
            \featlevel{9} The strike deals 1d6 \glossterm{extra damage}.
            \featlevel{12} The extra damage increases to 1d6 per 3 power (minimum 1d6).
            \featlevel{15} The extra damage increases to 1d8 per 3 power.
            \featlevel{18} The strike deals double \glossterm{weapon damage}.
        \end{sustainability}
