...
\end{longtabuwrapper}
    ...
    \begin{feat}{Spell Focus: Summon}{Magical, Spell}
        ...
        \ff[9]{Potent Summoning} You gain a \plus1 bonus to \glossterm{power} with the \spell{summoning} spell.
        ...
        \ff[18]{Greater Potent Summoning} The bonus from your \textit{potent summoning} ability increases to \plus2.
    \end{feat}
