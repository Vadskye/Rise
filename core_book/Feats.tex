...
\end{longtablewrapper}
    ...
    \begin{feat}{Maneuverist}{Combat}
        ...
        \ff[1]{Maneuver Access} You gain access to one martial \glossterm{combat style} (see \pcref{Martial Combat Styles}).
        In addition, you learn one rank 1 \glossterm{maneuvers} that combat style you have access to.
