...
\begin{longtabuwrapper}
    \begin{longtabu}{>{\lcol}p{10em} >{\lcol}p{15em} >{\lcol}X >{\lcol}p{8em} >{\lcol}p{3em}}
        ...
        \featref{Spellwarped} & \tdash & Use one spell & \tdash & \featpref{Spellwarped} \\
...
\end{longtabuwrapper}
    ...
    \begin{feat}{Boongiver}{types}
        ...
        \ff[13]{Supreme Reciprocal Boon} You can use your \textit{reciprocal boon} ability on up to three different spells at once.

        \ff[15]{Regenerative Transferance} When you use your \textit{benevolent transferance} ability successfully, the original target of the spell regains the action point it spent to attune to the spell.
    ...
    \begin{feat}{Spellwarped}{types}
        \featben

        \ff[1]{Spellgift} Choose a spell from the arcane spell list (see \pcref{Arcane Spells}).
        You can cast that spell as a \glossterm{standard action}.
