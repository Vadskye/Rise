...
\end{longtabuwrapper}
    ...
    \begin{feat}{Sphere Focus: Cryomancy}{Casting, Magical}
        ...
        \ff[4]{Lingering Chill} Whenever you deal cold damage to a creature with a \glossterm{critical hit}, that creature is \glossterm{chilled} as a \glossterm{condition}.
    ...
    \begin{feat}{Sphere Focus: Pyromancy}{Casting, Magical}
        ...
        \ff[4]{Lingering Flame} Whenever you deal fire damage to a creature with a \glossterm{critical hit}, that creature takes fire \glossterm{standard damage} \minus3d at the end of the next round.
