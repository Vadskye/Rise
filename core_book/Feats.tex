...
\end{longtablewrapper}
    ...
    \begin{feat}{Boongiver}{Casting, Magical}
        ...
        \begin{instantability}{Replace Attunement}
            Choose a creature other than yourself currently \glossterm{attuned} to a spell you cast.
    ...
    \begin{feat}{Craft Specialization}{Skill}
        ...
        If you sacrifice valuable raw materials, you must destroy trade goods or gold pieces as if you were buying an item with a level two lower than the level of the item  (see \pcref{Item Levels}).
    ...
    \begin{feat}{Deception Specialization}{Skill}
        ...
        \ff[21]{Greater Deceive Magic} When you use your your \textit{deceive magic} ability, the reroll has a \minus2 \glossterm{accuracy} penalty.
    \end{feat}
    ...
    \begin{feat}{Devices Specialization}{Skill}
        ...
        The \glossterm{difficulty value} to affect an arcane spell effect is equal to 15 \add the effect's \glossterm{power}.
    ...
    \begin{feat}{Duelist}{Combat}
        ...
        \begin{freeability}{Duelist Strike}
            ...
            If you are not \surrounded, you gain a \plus1 accuracy bonus with the strike.
            If the target is not \surrounded, you gain an additional \plus1 accuracy bonus.

            \rankline
            \featlevel{6} The accuracy bonus if you are not surrounded increases to \plus2.
            \featlevel{12} The accuracy bonus if you are not surrounded increases to \plus3.
            \featlevel{18} The accuracy bonus if you are not surrounded increases to \plus4.
        \end{freeability}
    ...
    \begin{feat}{Ghostblade}{Combat, Magical}
        ...
        \begin{durationability}{Spectral Strike}
            ...
            \featlevel{18} Each subject is \decelerated instead of slowed.
        \end{durationability}
        ...
        If you chose a weapon, whenever you make a \glossterm{strike} against a creature's Armor defense that misses, if the strike hit that creature's Reflex defense, it is considered a \glossterm{glancing blow} and deals half damage.
    ...
    \begin{feat}{Metacaster}{Casting, Magical}
        ...
        \begin{dtable}
            ...
            \begin{dtabularx}{\columnwidth}{l >{\lcol}X}
                ...
                1 & Dazed, dazzled, goaded (by you), shaken (by you), sickened, slowed \\
    ...
    \begin{feat}{Spellsense Specialization}{Skill}
        ...
        \begin{freeability}{Sense Spellcasting}[\abilitytag{Subtle}]
            ...
            Your \glossterm{accuracy} is equal to your Spellsense skill.
        ...
        \begin{freeability}{Unweave Magic}
            ...
            The \glossterm{difficulty value} is equal to 5 \add the \glossterm{power} of the effect.
            ...
            The \glossterm{difficulty value} to affect those spells is increased by 10.
        \end{freeability}

        \ff[9]{Greater Specialization} The bonus from your \textit{specialization} ability increases to \plus5.

        \ff[12]{Mystic Power} You gain a \plus4 bonus to \glossterm{magical} \glossterm{power}.
    ...
    \begin{feat}{Sphere Focus: Channel Divinity}{Casting, Magical}
        ...
        \ff[6]{Divine Intervention} You gain a \plus2 bonus to any roll that you use the \textit{desperate exertion} ability on (see \pcref{Desperate Exertion}).
        ...
        \ff[12]{Greater Aspect of Divinity} As long as you are attuned to at least two spells from the \sphere{channel divinity} mystic sphere, the bonus from your \textit{aspect of divinity} ability increases to \plus2.
        ...
        \ff[21]{Supreme Aspect of Divinity} As long as you are attuned to at least three spells from the \sphere{channel divinity} mystic sphere, the bonus from your \textit{aspect of divinity} ability increases to \plus3.
    \end{feat}
    ...
    \begin{feat}{Sphere Focus: Enchantment}{Casting, Magical}
        ...
        In addition, the \glossterm{difficulty value} to observe your \abilitytag{Emotion} abilities with Spellsense, and to observe their effects with the Social Insight skill, increases by 10.
    ...
    \begin{feat}{Sphere Focus: Fabrication}{Casting, Magical}
        ...
        \ff[6]{Fabricated Armaments} You gain a \plus1 bonus to \glossterm{accuracy} with \glossterm{strikes} using weapons you created with spells from the Fabrication mystic sphere.
        ...
        \ff[18]{Greater Fabricated Armaments} The bonuses from your \textit{fabricated armaments} ability increase to \plus2.
    ...
    \begin{feat}{Sphere Focus: Pyromancy}{Casting, Magical}
        ...
        \ff[6]{Lingering Flame} Whenever you make a creature lose \glossterm{hit points} with fire damage, that creature \glossterm{briefly} takes 1d10 fire damage at the end of each round.
        When this effect ends, that creature then becomes immune to this effect until it takes a \glossterm{short rest}.
        This damage increases by \plus1d at 9th level and every 3 levels thereafter.
        ...
        \ff[18]{Greater Lingering Flame} You add half your \glossterm{power} to the damage from your \textit{lingering flame} ability.
    ...
    \begin{feat}{Twinhand Spellcaster}{Casting, Magical}
        ...
        \ff[18]{Greater Twinhand Precision} The bonus from your \textit{twinhand precision} ability increases to \plus2.
    ...
    \begin{feat}{Weapon Focus}{Combat}
        ...
        \begin{freeability}{Perfect Strike}
            ...
            You gain your choice of either a \plus1 accuracy bonus or a \plus1d damage bonus with the strike.

            \rankline
            \featlevel{6} The accuracy bonus increases to \plus2, and the damage bonus increases to \plus2d.
            \featlevel{12} The accuracy bonus increases to \plus3, and the damage bonus increases to \plus3d.
            \featlevel{18} The accuracy bonus increases to \plus4, and the damage bonus increases to \plus4d.
        \end{freeability}
