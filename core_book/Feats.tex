...
\begin{longtabuwrapper}
    \begin{longtabu}{>{\lcol}p{10em} >{\lcol}p{15em} >{\lcol}X >{\lcol}p{8em} >{\lcol}p{3em}}
        ...
        \featref{Battlerage} & Combat prowess 4 & Gain ability to rage & \x & \featref{Battlerage} \\
        %\featref{Destructive} & Str 3 & Gain \plus5 to breaking things            & \x & \featpref{Destructive} \\
        \featref{Diehard} & Con 5 & Halve penalties from critical damage         & \x & \featpref{Diehard} \\
        ...
        \featref{Enchant Item} & 1st level spells & Create magic items & \x & \featpref{Enchant Item} \\
        ...
        \featref{Craft Magic Item} & Craft 5 ranks & Create magic items & \x & \featpref{Craft Magic Item} \\
        \featref{Efficient Crafting} & Craft 10 ranks & Craft nonmagical items more cheaply & \x & \featpref{Efficient Crafting} \\
        \featref{Extraordinary Sense} & Awareness 10 ranks & Gain superhuman sense, such as darkvision & \x & \featpref{Extraordinary Sense} \\
        ...
        \featref{Standing Leap} & Jump 10 ranks & Always treated as having running start & \x & \featpref{Standing Leap} \\
...
\begin{longtabuwrapper}
    \begin{longtabu}{>{\lcol}p{10em} >{\lcol}p{15em} >{\lcol}X >{\lcol}p{8em} >{\lcol}p{3em}}
        ...
        \featref{Legendary Strike} & Any three Strike feats & \plus2 to accuracy with strikes & \x & \featpref{Legendary Strike} \\
...
\feat{Imbuement Admixture}{Magic}
