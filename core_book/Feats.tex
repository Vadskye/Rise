...
\end{longtabuwrapper}
    ...
    \begin{feat}{Bardic Exemplar}{Magical, Skill}
        ...
        \begin{ability}{Inspire Courage}[\glossterm{Emotion}, \glossterm{Mind}, \glossterm{Sustain} (minor)]
        ...
        \begin{ability}{Vicious Mockery}[\glossterm{Emotion}, \glossterm{Mind}]
        ...
        \begin{ability}{Song of Serenity}[\glossterm{Emotion}, \glossterm{Mind}, \glossterm{Sustain} (minor)]
            You begin a performance using one of your Perform skills.
    ...
    \begin{feat}{Bluff Specialization}{Skill}
        ...
        \ff[11]{Dual Speech}[Magical] When you speak, you can spend an \glossterm{action point} to use the \textit{dual speech} ability.
    ...
    \begin{feat}{Eldritch Knight}{Spell}
        ...
        \ff[1]{Imbue Weapon}[Magical] When you cast a spell that affects a single target, you can spend an \glossterm{action point} to use the \textit{imbue weapon} ability.
        \begin{ability}{Imbue Weapon}[\glossterm{Attune} (self)]
    ...
    \begin{feat}{Mystic Archer}{Casting, Magical}
        ...
        \ff[1]{Imbue Projectile} When you cast a spell that affects a single target, you can spend an \glossterm{action point} to use the \textit{imbue projectile} ability.
        ...
        \ff[9]{Imbue Detonating Projectile} When you cast a spell that affects an area, you can spend an \glossterm{action point} to use the \textit{imbue detonating projectile} ability.
    ...
    \begin{feat}{Perform Specialization}{Skill}
        ...
        \begin{ability}{Mesmerizing Performance}[\glossterm{Emotion}, \glossterm{Mind}, \glossterm{Sustain} (minor)]
            You begin a performance using one of your Perform skills.
        ...
        \begin{ability}{Inspiring Performance}[\glossterm{Emotion}, \glossterm{Mind}, \glossterm{Sustain} (minor)]
            You begin a performance using one of your Perform skills.
        ...
        \begin{ability}{Mesmeric Suggestion}[\glossterm{Emotion}, \glossterm{Mind}, \glossterm{Subtle}, \glossterm{Sustain} (minor)]
    ...
    \begin{feat}{Persuasion Specialization}{Skill}
        ...
        \begin{ability}{Suggestion}[\glossterm{Emotion}, \glossterm{Mind}, \glossterm{Subtle}, \glossterm{Sustain} (minor)]
            Make an attack vs. Mental against a target within \rngmed range.
            Your \glossterm{accuracy} is equal to your Persuasion skill.
            You must also make a verbal suggestion of a particular course of action to the target.
            If your suggestion does not seem reasonable, you take a \minus5 penalty to accuracy on this attack.
    ...
    \begin{feat}{Sphere Focus: Thaumaturgy}{Casting, Magical}
        ...
        \ff[3]{Counterspell} As a standard action, you can use the \textit{counterspell} ability.
    ...
    \begin{feat}{Sphere Focus: Weaponcraft}{Casting, Magical}
        ...
        \ff[6]{Disable Weapon} As a \glossterm{minor action}, you can use the \textit{disable weapon} ability.
        \begin{ability}{Disable Weapon}[\glossterm{Swift}]
