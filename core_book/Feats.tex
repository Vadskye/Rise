...
\end{longtablewrapper}
    ...
    \begin{feat}{Sphere Focus: Bless}{Casting, Magical}
        ...
        \ff[1]{Inspiring Blessing} Each creature that is \glossterm{attuned} to a spell you cast from the \sphere{Bless} \glossterm{mystic sphere} gains a \plus1 bonus to Mental defense.

        \ff[4]{Personal Blessing} You gain an additional \glossterm{action point}.
        ...
        \ff[10]{Greater Inspiring Blessing} The bonus from your \textit{inspiring blessing} ability increases to \plus2.

        \ff[13]{Greater Personal Blessing} The number of additional action points granted by your \textit{personal blessing} ability increases to 2.

        \ff[16]{Spell} You learn a spell from the \sphere{bless} \glossterm{mystic sphere}.
        When you gain access to a new spell level, you can change which spell you know from that \glossterm{mystic sphere}.

        \ff[19]{Supreme Inspirint Blessing} The bonus from your \textit{inspiring blessing} bonus increases to \plus3.
    \end{feat}
    ...
    \begin{feat}{Sphere Focus: Delusion}{Casting, Magical}
        ...
        \ff[4]{Enchanting Presence} You gain a \plus2 bonus to the Intimidate and Persuasion skills.
