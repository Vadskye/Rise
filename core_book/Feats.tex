...
\end{longtabuwrapper}
    ...
    \begin{feat}{Heal Specialization}{Skill}
        ...
        \ff[5]{Greater Healing Touch}[Magical] For every five points of healing you would restore with your \textit{healing touch} ability, you can instead heal a point of \glossterm{vital damage}.
        ...
        \ff[11]{Supreme Healing Touch} You can use your \textit{healing touch} ability without spending an \glossterm{action point}.
    ...
    \begin{feat}{Sphere Focus: Compel}{Casting, Magical}
        ...
        \ff[3]{Mind Fragments} When you use \glossterm{Compulsion} abilities, you can affect creatures that are immune to \glossterm{Compulsion} abilities due to not having a mind.
    ...
    \begin{feat}{Sphere Focus: Delusion}{Casting, Magical}
        ...
        \ff[9]{Subtle Influence} The DR to identify your \glossterm{Emotion} abilities with Spellcraft, and to identify their effects with the Sense Motive skill, increases by 5.
