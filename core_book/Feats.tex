...
\end{longtablewrapper}
    ...
    \begin{feat}{Intimidate Specialization}{Skill}
        ...
        \ff[6]{Threatening Presence} You are considered to be \glossterm{threatening} each \glossterm{enemy} within a \arealarge emanation from you for the purpose of determining \glossterm{overwhelm penalties}. 
        ...
        \ff[18]{Fearsome Foe} You are considered an additional creature for the purpose of determining \glossterm{overwhelm penalties} you inflict on other creatures.
    ...
    \begin{feat}{Whirlwind Warrior}{Combat}
        ...
        \ff[9]{Eye of the Storm} You reduce your \glossterm{overwhelm penalties} by 1.
