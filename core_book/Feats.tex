...
\begin{longtabuwrapper}
    \begin{longtabu}{>{\lcol}p{10em} >{\lcol}p{15em} >{\lcol}X >{\lcol}p{8em} >{\lcol}p{3em}}
        ...
        \featref{Item Conduit} & 5th level & Gain \plus2 daily item uses & \x & \featpref{Item Conduit} \\
        ...
        \featref{Celestial Heritage} & Nonevil alignment & Gain retributive aura & Celestial & \featpref{Celestial Heritage} \\
            ...
            \tind \featref{Celestial Smiting} & Celestial Heritage & Smite evil more often, more accurately & Celestial & \featpref{Celestial Smiting} \\
        ...
        \featref{Fae Heritage} & \tdash & Gain minor spell-like abilities & \x & \featpref{Fae Heritage} \\
        ...
        \item \featref{Enchantment Admixture} & Enchant Item, 3rd level spells & Combine multiple spells to create items & \tdash & \featpref{Enchantment Admixture} \\
...
This does not actually change the space you occupy, your \glossterm{reach}, or the size of space you can squeeze through, but creatures fooled by the disguise may treat you as if your space and reach were appropriate to your disguised size.
