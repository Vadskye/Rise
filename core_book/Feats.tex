...
\feat{All Energy Becomes One}{Monk}
\featpre Monk 5, Constitution 3, manifest \ki ability.
\featben Whenever you take \glossterm{energy damage} in excess of your \ki power, you can spend an \glossterm{immediate action} to channel the energy into your body.
...
\featpre 3rd level or higher \glossterm{Thaumaturgy} spell known.
...
\featpres Perception 5, combat prowess 4.
\featben You reduce your \glossterm{overwhelm penalties} by 1.
...
\featben You become immune to hostile \glossterm{Mind} effects.

\feat{Mighty Blows}{Combat, Power}
\featpres Str 3.
\featben You gain a \plus1 bonus to damage with \glossterm{physical attacks}.
\parhead{Special} This feat can be taken multiple times. Its effects stack.
...
\featben While in this style, you gain a \plus2 bonus to damage with physical ranged attacks if your target is within half of your \glossterm{range increment}.
\stylereq Wield a ranged weapon.
...
\featben While in this style, you gain a \plus2 bonus to damage with physical melee attacks.
\stylereq Wield a melee weapon.

\feat{Precise Fighting}{Combat, Precision, Style}
\featpres Perception 5, combat prowess 8.
\featben While in this style, you gain a \plus2 bonus to accuracy with \glossterm{physical attacks}.
In exchange, you take a \minus4 penalty to damage with physical attacks (to a minimum of 1).
\stylereq None.
...
\feat{Reflexive Dodge}{Combat, Reaction, Style}
\featpres Combat prowess 16, Dexterity 15.
\featben While in this style, you can dodge attacks with ease.
Once per round, when you are hit by a \glossterm{physical attack}, you can make the attack miss automatically.
...
\subcf{Alteration} If a ritual requires a specific component with a value, you can substitute its equivalent value in ritual components instead.
...
\feat{Supreme Prediction}{Awareness, Combat}
...
\feat{Supreme Speed}{Combat, Style}
\featpres Dexterity 15, combat prowess 16.
\featben While in this style, whenever you make a \glossterm{standard attack}, you may make an additional \glossterm{strike}.
