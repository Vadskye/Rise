...
\end{longtabuwrapper}
    ...
    \begin{feat}{Abjurer}{Magical, Spell}
        ...
        \ff[3]{Counterspell} Whenever you cast a spell, you can choose to cast it as a counterspell instead.
        ...
        \ff[9]{Reactive Counterspell} While you are casting a spell, at any time before it resolves, you can take an \glossterm{immediate action} to turn that spell into a counterspell.
    ...
    \begin{feat}{Guardian}{Combat}
        ...
        \ff[2]{Redirection} Whenever an ally adjacent to you is hit by a \glossterm{strike}, you may use this ability as an \glossterm{immediate action}.
        ...
        \ff[4]{Defend the Weak} You reduce the \glossterm{overwhelm penalties} of allies adjacent to you by 1.
        ...
        \ff[8]{Certain Bind} You gain a \plus1 bonus to accuracy with your \textit{binding strike} ability.

        \ff[10]{Greater Defend the Weak} The penalty reduction from your \textit{defend the weak} ability increases to 2.
        ...
        \ff[14]{Greater Certain Bind} The accuracy bonus with your \textit{binding strike} ability increases to \plus2.

        \ff[16]{Supreme Defend the Weak} The penalty reduction from your \textit{defend the weak} ability increases to 3.

        \ff[18]{Mystic Redirection}[Magical] You can use your \textit{redirection} ability to redirect the effects of any attack, not just \glossterm{mundane} attacks. 
    \end{feat}
    ...
    \begin{feat}{Precognition}{Combat}
        ...
        \ff[10]{Rapid Reaction} You gain a \plus2 bonus to \glossterm{initiative} checks.
        ...
        \ff[16]{Greater Rapid Reaction} The bonus to initiative checks from your \textit{rapid reaction} ability increases to \plus5.
