...
\begin{longtablewrapper}
    \begin{longtable}{>{\lcol}p{11em} >{\lcol}p{12em} l >{\lcol}p{8em} >{\lcol}p{3em}}
        ...
        \featref{Telepathy}          & Int 1, Wil 1             & Communicate with creatures mentally & \tdash             & \featpref{Telepathy}          \\
...
\end{longtablewrapper}
    ...
    \begin{feat}{Telepath}{General}
        \featpre Base Inteligence and Willpower of 1.

        \ff[1]{Telepathy} You gain \glossterm{telepathy} with a 30 foot range (see \pcref{Telepathy}).

        \ff[3]{Mind Crush} You can use the \textit{mind crush} ability as a standard action.
        \begin{instantability}{Mind Crush}[\abilitytag[Emotion]]
            Make an attack vs. Mental against one creature within the range of your \glossterm{telepathy}.
        ...
        \begin{freeability}{Read Mind}[\abilitytag{Emotion}, \abilitytag{Sustain} (standard), \abilitytag{Subtle}]
            Make an attack vs. Mental against a creature within the range of your \glossterm{telepathy}.
        ...
        \ff[9]{Greater Telepathy} The range of your \glossterm{telepathy} ability increases to 60 feet.
        In addition, you automatically know the location of any creature with an Intelligence of 0 or higher within the range of your telepathy.
        ...
        \ff[18]{Supreme Telepathy} The range of your \glossterm{telepathy} ability increases to 120 feet.
        In addition, you can see any creature with an Intelligence of 0 or higher within the range of your telepathy perfectly.
