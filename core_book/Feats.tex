...
\end{longtablewrapper}
    ...
    \begin{feat}{Metacaster}{Casting, Magical}
        ...
        \begin{freeability}{Spell Fusion}
            ...
            Both spells that you fuse in this way must have the same area shape, such as a cone or sphere, and targeting restrictions, such as affecting only living creatures.
            If one spell affects a strictly larger area or strictly more targets than the other, you must use the smaller of the two areas or target counts.
