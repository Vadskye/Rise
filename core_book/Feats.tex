...
\end{longtabuwrapper}
    ...
    \begin{feat}{Heal Specialization}{Skill}
        ...
        \ff[2]{Healing Touch}[Magical] As a standard action, you can spend an \glossterm{action point} to use the \textit{healing touch} ability.
    ...
    \begin{feat}{Intimidate Specialization}{Skill}
        ...
        \ff[2]{Demoralizing Blow} As a standard action, you can use the \textit{demoralizing blow} ability.
    ...
    \begin{feat}{Perform Specialization}{Skill}
        ...
        \ff[2]{Mesmerizing Performance}[Magical] As a standard action, you can spend an \glossterm{action point} to use the \textit{mesmerizing performance} ability.
    ...
    \begin{feat}{Reaper}{Combat}
        ...
        \ff[1]{Sweeping Blow} As a standard action, you can spend an \glossterm{action point} to use the \textit{sweeping blow} ability.
        ...
        \ff[4]{Reaping Assault} As a standard action, you can spend an \glossterm{action point} to use the \textit{reaping assault} ability.
        \begin{ability}{Reaping Assault}
            You move up to your movement speed in a straight line and make a \glossterm{strike} with a slashing or bludgeoning weapon.
    ...
    \begin{feat}{Ride Specialization}{Skill}
        ...
        \ff[2]{Mounted Warrior} Your mount gains a \plus2 bonus to Armor defense, up to a maximum of your own Armor defense.
    ...
    \begin{feat}{Sense Motive Specialization}{Skill}
        ...
        \ff[6]{Read Mind}[Magical] As a standard action, you can spend an \glossterm{action point} to use the \textit{read mind} ability.
    ...
    \begin{feat}{Spellcraft Specialization}{Skill}
        ...
        \ff[2]{Detect Spellcasting}[Magical] As a standard action, you can spend an \glossterm{action point} to use the \textit{detect spellcasting} ability.
