...
\end{longtabuwrapper}
    ...
    \begin{feat}{Acrobatics Specialization}{Skill}
        ...
        \begin{freeability}{Acrobatic Dodge}
            ...
            \rankline
            \featlevel{10} The defense bonus increases to +3.
            \featlevel{16} The defense bonus increases to +4.
        \end{freeability}
    ...
    \begin{feat}{Agility}{General}
        ...
        \begin{freeability}{Spring Attack}
            ...
            \rankline
            \featlevel{10} The damage penalty is removed.
            \featlevel{16} You gain a +1d bonus to damage with the strike.
        \end{freeability}
    ...
    \begin{feat}{Bardic Exemplar}{Magical, Skill}
        ...
        \begin{freeability}{Vicious Mockery}[\glossterm{Emotion}]
            ...
            \rankline
            \featlevel{7} The area increases to a \arealarge radius from you.
            \featlevel{13} The area increases to a \areahuge radius from you.
            \featlevel{19} The accuracy penalty increases to \minus2.
        \end{freeability}
        ...
        \begin{freeability}{Inspire Courage}[\glossterm{Emotion}, \glossterm{Sustain} (minor)]
            ...
            \rankline
            \featlevel{10} The accuracy bonus increases to \plus2.
            \featlevel{16} The defense bonus increases to \plus4.
        \end{freeability}
        ...
        \begin{freeability}{Song of Serenity}[\glossterm{Emotion}, \glossterm{Sustain} (minor)]
            ...
            \rankline
            \featlevel{13} This ability can target up to two \glossterm{allies} within \rngmed range.
            \featlevel{19} This ability can target up to five \glossterm{allies} within \rngmed range.
        \end{freeability}
    ...
    \begin{feat}{Brawler}{Combat}
        ...
        \begin{freeability}{Takedown}
            ...
            \rankline
            \featlevel{10} You gain a \plus1 bonus to accuracy with the strike.
            \featlevel{16} The accuracy bonus increases to \plus2.
        \end{freeability}
    ...
    \begin{feat}{Celestial Heritage}{Bloodline, Magical}
        ...
        \begin{freeability}{Smite}[Magical]
            ...
            \rankline
            \featlevel{10} The damage bonus increases to \plus2d.
            \featlevel{16} The damage bonus increases to \plus3d.
        \end{freeability}
    ...
    \begin{feat}{Duelist}{Combat}
        ...
        \begin{freeability}{Focused Strike}
            ...
            \rankline
            \featlevel{10} The accuracy bonus increases to \plus2.
            \featlevel{16} The damage bonus increases to \plus2d.
        \end{freeability}
    ...
    \begin{feat}{Executioner}{Combat}
        ...
        \begin{freeability}{Execution}
            ...
            \rankline
            \featlevel{10} The damage bonus increases to \plus3d.
            \featlevel{16} The damage bonus increases to \plus4d.
        \end{freeability}
    ...
    \begin{feat}{Guardian}{Combat}
        ...
        \begin{freeability}{Protect}[\glossterm{Swift}]
            ...
            \rankline
            \featlevel{7} The Armor defense penalty is reduced to \minus1.
            \featlevel{13} You may target an additional adjacent \glossterm{ally}.
        ...
        \begin{freeability}{Binding Strike}
            ...
            \rankline
            \featlevel{10} The condition does not end when the target stops being threatened.
            \featlevel{16} The target is also \glossterm{immobilized} as part of the same condition.
        \end{freeability}
    ...
    \begin{feat}{Heal Specialization}{Skill}
        ...
        \begin{freeability}{Healing Touch}[\glossterm{Life}]
            ...
            \rankline
            \featlevel{10} The bonus increases to \plus3.
            \featlevel{16} The bonus increases to \plus4.
        \end{freeability}
    ...
    \begin{feat}{Jump Specialization}{Skill}
        ...
        \begin{freeability}{Featherlight Leap}[\glossterm{Swift}]
            ...
            \rankline
            \featlevel{13} This ability lasts until the end of the current round.
            \featlevel{19} You do not take damage from using this ability.
        \end{freeability}
    ...
    \begin{feat}{Leadership}{Combat}
        ...
        \begin{freeability}{Bolster}[\glossterm{Emotion}]
            ...
            \rankline
            \featlevel{10} You may instead target all \glossterm{allies} within a \areamed radius from you.
            \featlevel{16} You may instead target all \glossterm{allies} within a \arealarge radius from you.
        \end{freeability}
    ...
    \begin{feat}{Martial Training}{Combat}
        ...
        \begin{freeability}{Trained Strike}
            ...
            \rankline
            \featlevel{10} The accuracy bonus increases to \plus2.
            \featlevel{16} The accuracy bonus increases to \plus3.
        \end{freeability}
    ...
    \begin{feat}{Null}{General}
        ...
        \begin{freeability}{Sever Magic}
            ...
            \rankline
            \featlevel{10} You gain a \plus1 bonus to \glossterm{accuracy} with the strike.
            \featlevel{16} The accuracy bonus increases to \plus2.
        \end{freeability}
    ...
    \begin{feat}{Perform Specialization}{Skill}
        ...
        \begin{freeability}{Mesmerizing Performance}[\glossterm{Emotion}, \glossterm{Sustain} (minor)]
            ...
            \rankline
            \featlevel{10} You may target up to ten creatures within range.
        ...
        \begin{freeability}{Inspiring Performance}[\glossterm{Emotion}, \glossterm{Sustain} (minor)]
            ...
            \rankline
            \featlevel{13} The bonus increases to \plus3.
            \featlevel{19} The bonus increases to \plus4.
        \end{freeability}
    ...
    \begin{feat}{Precognition}{Combat}
        ...
        \begin{freeability}{Precognitive Strike}
            ...
            \featlevel{19} You also compare your attack result against the target's Mental defense.
    ...
    \begin{feat}{Sphere Focus: Barrier}{Casting, Magical}
        ...
        \begin{freeability}{Burst Ward}[\glossterm{Swift}]
            ...
            \rankline
            \featlevel{10} This ability lasts until the end of the next round.
            \featlevel{16} You also gain a \plus1 bonus to all defenses.
        \end{freeability}
    ...
    \begin{feat}{Whirlwind Warrior}{Combat}
        ...
        \begin{freeability}{Whirlwind Spin}
            ...
            \rankline
            \featlevel{10} You gain a \plus1d bonus to damage with the strike.
            \featlevel{16} You can move up to 5 feet when you use this ability.
