...
\begin{longtabuwrapper}
    \begin{longtabu}{>{\lcol}p{10em} >{\lcol}p{15em} >{\lcol}X >{\lcol}p{8em} >{\lcol}p{3em}}
        ...
        \featref{Spell Focus: Aquamancy} & \spell{Aquamancy} spell known & \tdash & \featpref{Spell Focus: Aquamancy} \\
        \featref{Spell Focus: Astromancy} & \spell{Astromancy} spell known & \tdash & \featpref{Spell Focus: Astromancy} \\
        \featref{Spell Focus: Barrier} & \spell{Barrier} spell known & \tdash & \featpref{Spell Focus: Barrier} \\
        \featref{Spell Focus: Chronomancy} & \spell{Chronomancy} spell known & \tdash & \featpref{Spell Focus: Chronomancy} \\
        \featref{Spell Focus: Compel} & \spell{Compel} spell known & \tdash & \featpref{Spell Focus: Compel} \\
        \featref{Spell Focus: Delusion} & \spell{Delusion} spell known & \tdash & \featpref{Spell Focus: Delusion} \\
        \featref{Spell Focus: Fabrication} & \spell{Fabrication} spell known & \tdash & \featpref{Spell Focus: Fabrication} \\
        \featref{Spell Focus: Glamer} & \spell{Glamer} spell known & \tdash & \featpref{Spell Focus: Glamer} \\
        \featref{Spell Focus: Polymorph} & \spell{Polymorph} spell known & \tdash & \featpref{Spell Focus: Polymorph} \\
        \featref{Spell Focus: Pyromancy} & \spell{Pyromancy} spell known & \tdash & \featpref{Spell Focus: Pyromancy} \\
        \featref{Spell Focus: Revelation} & \spell{Revelation} spell known & \tdash & \featpref{Spell Focus: Revelation} \\
        \featref{Spell Focus: Summon} & \spell{Summon} spell known & \tdash & \featpref{Spell Focus: Summon} \\
        \featref{Spell Focus: Telekinesis} & \spell{Telekinesis} spell known & \tdash & \featpref{Spell Focus: Telekinesis} \\
        \featref{Spell Focus: Thaumaturgy} & \spell{Thaumaturgy} spell known & \tdash & \featpref{Spell Focus: Thaumaturgy} \\
        \featref{Spell Focus: Vital \spellVital} spell known & \tdash & \tdash & \featpref{Spell Focus: Vital Surge} \\
        \featref{Spell Focus: Weaponcraft} & \spell{Weaponcraft} spell known & \tdash & \featpref{Spell Focus: Weaponcraft} \\
...
\end{longtabuwrapper}
    ...
    \begin{feat}{Draconic Heritage}{Bloodline}
        ...
        \begin{ability}{Breath Weapon}
            Make an attack vs. Reflex attack against everything in the area defined by your \textit{draconic ancestry} ability (see \trefnp{Dragon Types}).
    ...
    \begin{feat}{Eldritch Knight}{Spell}
        ...
        \ff[3]{Combat Caster} You gain a \plus2 bonus to Concentration checks made to cast spells.
        In addition, you reduce your \glossterm{encumbrance} by 1 when determining your \glossterm{arcane spell failure} (if any).
        ...
        \ff[15]{Supreme Combat Caster} The Concentration bonus from your \textit{combat caster} ability increases to \plus6.
        In addition, the \glossterm{encumbrance} reduction increases to 3.

        \ff[18]{Greater Spellsword Conduit} The accuracy bonus from your \textit{spellsword conduit} ability increases to \plus2.
    \end{feat}
    ...
    \begin{feat}{Spellcraft Specialization}{Skill}
        ...
        \begin{ability}{Unweave Magic}[\glossterm{Mystic}]
            ...
            The DR is equal to 10 \add the \glossterm{spellpower} of the effect.
        ...
        \ff[17]{Greater Unweave Magic} You gain a \plus2 bonus to \glossterm{accuracy} with your \textit{unweave magic} ability.

        \ff[20]{Greater Mystic Tolerance} The defense bonus from your \textit{mystic tolerance} ability increases to \plus2.
    \end{feat}

    \begin{feat}{Spell Focus: Aquamancy}{Spell}
        ...
        \begin{ability}{Create Water}[\glossterm{Creation}, \glossterm{Water}]
            You create up to one gallon per \glossterm{spellpower} with the \spell{aquamancy} spell of wholesome, drinkable water anywhere within \rngclose range.
        ...
        \ff[3]{Fire Tolerance} You gain damage reduction against fire damage equal to your \glossterm{spellpower} with the \spell{aquamancy} spell.
        ...
        \ff[12]{Greater Create Water} The volume of water you can create with your \textit{create water} ability increases to ten gallons per \glossterm{spellpower}.

        \ff[12]{Greater Fire Tolerance} Your damage reduction from the \textit{fire tolerance} ability increases to twice your \glossterm{spellpower} with the \spell{aquamancy} spell.
    ...
    \begin{feat}{Spell Focus: Astromancy}{Spell}
    ...
    \begin{feat}{Spell Focus: Barrier}{Spell}
        ...
        \ff[12]{Greater Burst Ward} When you use your \textit{burst ward} ability, you also gain damage reduction equal to your \glossterm{spellpower}.
    ...
    \begin{feat}{Spell Focus: Chronomancy}{Spell}
    ...
    \begin{feat}{Spell Focus: Compel}{Spell}
    ...
    \begin{feat}{Spell Focus: Delusion}{Spell}
    ...
    \begin{feat}{Spell Focus: Fabrication}{Spell}
        \featpre \spell{Fabrication} spell known.
        ...
        \begin{ability}{Fabricate Trinket}[\glossterm{Attune}, \glossterm{Manifestation}]
        ...
        In addition, any objects you create with the \spell{fabrication} spell gain additional hit points equal to your \glossterm{spellpower} with that spell.
        ...
        In addition, the hit points bonus increases to twice your \glossterm{spellpower} with the \spell{fabrication} spell.

        \ff[18]{Greater Potent Fabrication} The bonus from your \textit{potent fabrication} ability increases to \plus2.
    \end{feat}

    \begin{feat}{Spell Focus: Glamer}{Spell}
    ...
    \begin{feat}{Spell Focus: Polymorph}{Spell}
        ...
        \ff[6]{Personal Regeneration} At the end of each \glossterm{action phase}, you heal hit points equal to half your \glossterm{spellpower} with the \spell{polymorph} spell.
        ...
        \ff[15]{Greater Personal Alteration} The healing from your \textit{personal regeneration} ability increases to be equal to your \glossterm{spellpower} with the \spell{polymorph} spell.

        \ff[18]{Greater Potent Polymorph} The bonus from your \textit{potent polymorph} ability increases to \plus2.
    \end{feat}

    \begin{feat}{Spell Focus: Pyromancy}{Spell}
        \featpre \spell{Pyromancy} spell known.

        \ff[1]{Subspell} You learn a subspell from the \spell{pyromancy} spell.
        When you gain access to a new spell levels, you can change which subspell you know from that spell.

        \ff[3]{Fire Tolerance} You gain damage reduction against fire damage equal to your \glossterm{spellpower} with the \spell{pyromancy} spell.
        ...
        Your \glossterm{power} with this ability is equal to your \glossterm{spellpower} with the spell you are casting.
        ...
        \ff[12]{Shared Fire Tolerance} The damage reduction from your \textit{fire tolerance} ability increases to twice your \glossterm{spellpower} with the \spell{pyromancy} spell.
        In addition, all allies within a \areamed radius emanation from you gain damage reduction against fire damage equal to your \glossterm{spellpower} with the \spell{pyromancy} spell.
    ...
    \begin{feat}{Spell Focus: Revelation}{Spell}
    ...
    \begin{feat}{Spell Focus: Summon}{Spell}
        ...
        \ff[6]{Fortified Summoning} Creatures you create with the \spell{summon} spell have \glossterm{damage reduction} equal to your spellpower.
        ...
        \ff[15]{Greater Fortified Summoning} The damage reduction from your \textit{fortified summoning} ability increases to twice your spellpower.

        \ff[18]{Greater Potent Summoning} The bonus from your \textit{potent summoning} ability increases to \plus2d.
    \end{feat}

    \begin{feat}{Spell Focus: Telekinesis}{Spell}
        ...
        \begin{ability}{Distant Hand}[\glossterm{Sustain} (minor), \glossterm{Telekinesis}]
            Choose a Medium or smaller unattended object within \rngclose range.
            You can move it up to five feet in any direction within range, using your \glossterm{spellpower} with the \spell{telekinesis} spell instead of your Strength to determine your maximum carrying capacity.

            In addition, you can manipulate the target as if you were holding it in your hands.
            Any attacks you make with the object or checks you make to manipulate the object have a maximum bonus equal to your \glossterm{spellpower} with the \spell{telekinesis} spell.
        \end{ability}
        ...
        \begin{ability}{Telekinetic Strike}[\glossterm{Telekinesis}]
            Make a strike with a weapon you are controlling using the \textit{distant hand} ability.
            You use your \glossterm{spellpower} with the \spell{telekinesis} spell to determine your accuracy and damage in place of your Perception and Strength.
        \end{ability}
    ...
    \begin{feat}{Spell Focus: Thaumaturgy}{Spell}
        ...
        \ff[6]{Magic Tolerance} You gain \glossterm{magic resistance} equal to 3 \add your \glossterm{spellpower} with the \spell{thaumaturgy} spell.
    ...
    \begin{feat}{Spell Focus: Vital Surge}{Spell}
    ...
    \begin{feat}{Spell Focus: Weaponcraft}{Spell}
