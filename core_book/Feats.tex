...
\end{longtabuwrapper}
    ...
    \begin{feat}{Mystic Archer}{Magical, Spell}
        ...
        \ff[7]{Imbue Detonating Projectlie} Whenever you cast a spell that affects an area, you can spend an \glossterm{action point} to use the \textit{imbue detonating projectile} ability.
    ...
    \begin{feat}{Perform Specialization}{Skill}
        ...
        \ff[4]{Inspire Competence}[Magical] As a standard action, you can spend an \glossterm{action point} to use the \textit{inspiring performance} ability.
        \begin{ability}{Inspire Competence}[\glossterm{Delusion}, \glossterm{Mind}, \glossterm{Sustain} (minor)]
            You begin a performance using one of your Perform skills.
        ...
        \ff[6]{Mass Performance}[Magical] You can target up to two creatures with your \textit{inspire competence} ability.
        ...
        \ff[12]{Greater Inspire Competence}[Magical] The bonus from your \textit{inspire competence} ability increases to \plus4.

        \ff[14]{Greater Mass Performance}[Magical] When you use your \textit{inspire competence} ability, you can target any number of creatures.
