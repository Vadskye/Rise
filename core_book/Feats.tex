...
\end{longtabuwrapper}
    ...
    \begin{feat}{Sense Motive Specialization}{Skill}
        ...
        \ff[2]{Rapid Social Assessment} If you make a social assessment with only one round of observation instead of a full minute, the penalty is reduced by 5 (see \pcref{Social Assessment}).
        ...
        \ff[11]{Immediate Social Assessment} If you make a social assessment with only one round of observation instead of a full minute, you take no penalty (see \pcref{Social Assessment}).
