...
\end{longtabuwrapper}
    ...
    \begin{feat}{Sphere Focus: Summon}{Casting, Magical}
        ...
        \ff[6]{Fortified Summoning} Creatures you create with abilities from the \sphere{summon} spell have gain a \glossterm{magic bonus} equal to half your \glossterm{power} with that ability to \glossterm{damage reduction} against all damage.
        ...
        \ff[15]{Greater Fortified Summoning} The bonus from your \textit{fortified summoning} ability increases to be equal to your \glossterm{power}.
