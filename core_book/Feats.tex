...
\end{longtabuwrapper}
    ...
    \begin{feat}{Celestial Heritage}{Bloodline, Magical}
        ...
        \ff[11]{Angelic Flight} Your \textit{angel wings} grant you a fly speed equal to your land speed, allowing you to fly (see \pcref{Flying}).
    ...
    \begin{feat}{Draconic Heritage}{Bloodline}
        ...
        As a standard action, you can use your draconic wings to fly with a \glossterm{fly speed} equal to your land speed.
