...
\end{longtablewrapper}
    ...
    \begin{feat}{Blood Magic}{Casting, Magical}
        ...
        \ff[1]{Fortified Blood} You treat your level as if it was 1 higher than it actually is for the purpose of determining your \glossterm{hit points} (see \tref{Base Hit Points and Resistances}).
    ...
    \begin{feat}{Greatweapon Warrior}{Combat}
        ...
        If you do, you gain a \plus2 bonus to power.
        ...
        \ff[9]{Greater Power Attack} The power bonus from your \textit{power attack} ability increases to \plus4.
        ...
        \ff[18]{Supreme Power Attack} The power bonus from your \textit{power attack} ability increases to \plus8.
    \end{feat}
    ...
    \begin{feat}{Toughness}{General}
        ...
        \ff[3]{Durability} You treat your level as if it was 1 higher than it actually is for the purpose of determining your \glossterm{hit points} (see \tref{Base Hit Points and Resistances}).
