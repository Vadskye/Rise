...
\end{longtabuwrapper}
    ...
    \begin{feat}{Bardic Exemplar}{Magical, Skill}
        ...
        \begin{ability}{Mocking Performance}[\glossterm{Delusion}, \glossterm{Mind}, \glossterm{Sustain} (minor)]
            ...
            \hit As a \glossterm{condition}, the target suffers a \minus3 penalty to \glossterm{accuracy} with attacks that do not include your chosen creature as a target.
