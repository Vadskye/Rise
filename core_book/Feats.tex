...
\section{Feat Descriptions}
    ...
    At 7th level, if you know a 2nd level or higher Abjuration spell, your Abjuration spells are easier to cast.
    You can cast Abjuration spells as if they were one level lower than their actual level (minimum 1).
    This does not stack with spell level reductions from other feats.

    At 11th level, you gain a \plus1 bonus to all defenses.
    In addition, you gain a \plus4 bonus to spellpower when dispelling effects with \spell{dispel magic} and similar spells.
    ...
    \featben You gain damage reduction against \glossterm{magical} abilities equal to half your sorcerer level or half Constitution, whichever is higher.
    ...
    \featben Whenever you make a \glossterm{strike}, you compre your result against the target's Armor and Fortitude defenses.
    ...
    \parhead{Holy Blessing} As a standard action, you can bless a willing ally within \rngclose range. The target gains a general \glossterm{legend point} that lasts for \durshort duration, until it is used.

    At 3rd level, you learn how to protect your allies by spending a celestial point.
    \parhead{Holy Protection} As a standard action, you can shield a willing ally within \rngmed range from evil for \durshort duration. The target gains damage reduction equal to your celestial power against evil effects and physical attacks made by evil creatures.
    ...
    \featben Whenever you cast a spell, you can spend a celestial point as an \glossterm{immediate action} to heal an ally.
    ...
    At 11th level, if you have 4th level spells, you gain \glossterm{magic resistance} against evil spells and spells cast by evil creatures.
    ...
    At 3rd level, you double the range of all \glossterm{Teleportation} spells you cast.

    At 7th level, if you know a 2nd level or higher Conjuration spell, your Conjuration spells are more powerful.
    You can cast Conjuration spells as if they were one level lower than their actual level (minimum 1).
    This does not stack with spell level reductions from other feats.
    ...
    In addition, it takes you one hour per 100 gp of material components to create a magic item. % 900-3250 gp mats, 9-32 hrs

    At 11th level, if you have 8 ranks in any Craft skill, you can craft items from an additional ability tag of your choice. In addition, it takes you one hour per 500 gp of material components to create a magic item. % 5000-18500 gp, 10-37 hrs
    ...
    \featben You gain a \plus2 bonus to Awareness, and Knowledge attacks and checks.

    At 3rd level, you double the range of all \glossterm{Scrying} spells you cast.
    In addition, once per round you can concentrate on \glossterm{Detection} spell you cast as a \glossterm{free action}.

    At 7th level, if you know a 2nd level or higher Divination spell, your Divination spells are more powerful.
    You can cast Divination spells as if they were one level lower than their actual level (minimum 1).
    This does not stack with spell level reductions from other feats.
    ...
    You can cast Enchantment spells as if they were one level lower than their actual level (minimum 1).
    This does not stack with spell level reductions from other feats.
    ...
    For every two hit points you would restore, you can instead cure one point of critical damage.
    ...
    At 11th level, if you have 14 ranks in any Knowledge skill, you can gain the effect of the \spell{legend lore} ritual as a stanard action.
    ...
    \featpre 13th level, Strength 12.
    \featben Your weight limits are five times their normal values (see \pcref{Weight Limits}).
