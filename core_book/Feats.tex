...
\begin{longtablewrapper}
    ...
    \begin{longtable}{>{\lcol}p{11em} >{\lcol}p{12em} l >{\lcol}p{8em} >{\lcol}p{3em}}
        ...
        \featref{Chameleon}          & Trained Disguise, Dex 1, Int 2 & Adapt your archetypes and abilities & \tdash             & \featpref{Chameleon}          \\
...
\end{longtablewrapper}
    ...
    \begin{feat}{Balance Specialization}{Skill}
        ...
        \ff[8]{Instant Stand} You can use the \textit{rapid stand} ability as a \glossterm{free action} instead of a \glossterm{minor action} (see \pcref{Rapid Stand}).
    ...
    \begin{feat}{Battle Armory}{Combat}
        ...
        \ff[3]{Swift Draw} Sheathing and drawing weapons becomes a \abilitytag{Swift} ability for you, so you can draw a weapon and attack with it in the same phase.
    ...
    \begin{feat}{Celestial Heritage}{Bloodline, Magical}
        ...
        \begin{activeability}{Rebuke Evil}
            ...
            \rankline
            \featlevel{3} The damage increases to 1d8.
        ...
        \ff[15]{Angelic Flight}[Magical] You gain a \glossterm{fly speed} equal to the \glossterm{base speed} for your size with a maximum height of 30 feet (see \pcref{Flying}).
        ...
        \ff[21]{Healing Light+} The healing provided by your \textit{healing light} ability increases to twice your power, and it also heals yourself.
        In addition, the radius of brilliant illumination increases to a \hugearea radius.
    \end{feat}

    \begin{feat}{Chameleon}{General}
        \featpre Disguise as a trained skill, Dexterity 1, Intelligence 2.
    ...
    \begin{feat}{Deception Specialization}{Skill}
        ...
        \ff[15]{Greater Specialization} The bonus from your \textit{specialization} ability increases to \plus6.

        \ff[21]{Deceive Magic}[\glossterm{Magical}] When you would be hit by a \glossterm{magical} attack, you can use this ability in response.
    ...
    \begin{feat}{Draconic Heritage}{Bloodline}
        ...
        \ff[15]{Draconic Flight}[Magical] You gain a \glossterm{fly speed} equal to 10 feet faster than the \glossterm{base speed} for your size with a maximum height of 60 feet (see \pcref{Flying}).
        Your \glossterm{maneuverability} with this fly speed is poor (see \pcref{Flying Maneuverability}).
        At the start of each phase, you can increase your \glossterm{fatigue level} by one to ignore this height limit until the end of the round.

        \ff[21]{Draconic Ancestry+} You become immune to damage of the type dealt by your dragon's breath weapon.

        \ff[21]{Draconic Scales+} The Armor defense bonus from your \textit{draconic scales} ability increases to \plus2.
    \end{feat}
    ...
    \begin{feat}{Entropist}{General, Magical}
        ...
        \ff[1]{Entropic Defense} Whenever you are hit by a \glossterm{critical hit}, you may use this ability.
    ...
    \begin{feat}{Executioner}{Combat}
        ...
        \ff[15]{Blood Sense+}[Magical] The range of the lifesight from your \textit{blood sense} ability increases by 120 feet.
    ...
    \begin{feat}{Juggernaut}{Combat}
        ...
        \begin{ability}{Trample}
            ...
            \rankline
            \featlevel{6} The damage increases to 1d8.
            \featlevel{9} The damage increases to 2d6.
            \featlevel{12} The damage increases to 2d8.
            \featlevel{15} The damage increases to 4d6.
            \featlevel{18} The damage increases to 4d8.
            \featlevel{21} The damage increases to 5d10.
        \end{ability}
    ...
    \begin{feat}{Martial Training}{Combat}
        ...
        \ff[21]{Equipment Training+} You gain two additional \textit{equipment training} abilities of your choice.
    \end{feat}
    ...
    \begin{feat}{Medicine Specialization}{Skill}
        ...
        \ff[21]{Lifesaver} You can use the \textit{first aid} ability as a \glossterm{minor action}.
    \end{feat}
    ...
    \begin{feat}{Metacaster}{Casting, Magical}
        ...
        \begin{activeability}{Spell Fusion}
            ...
            After you use this ability, you are unable to take any actions during the \glossterm{action phase} or \glossterm{delayed action phase} of the following round.
        \end{activeability}
    ...
    \begin{feat}{Perform Specialization}{Skill}
        ...
        \ff[15]{Greater Specialization} The bonus from your \textit{specialization} ability increases to \plus5.
    ...
    \begin{feat}{Rapid Reaction}{General}
        ...
        \ff[3]{Sidestep} If you have movement remaining with your \glossterm{land speed} after the \glossterm{movement phase}, you may use that movement during the \glossterm{action phase} or the \glossterm{delayed action phase} as a \glossterm{free action}.
    ...
    \begin{feat}{Regenerator}{General}
        ...
        \ff[15]{Diehard+} The bonus from your \textit{diehard} ability increases to \plus3.
    ...
    \begin{feat}{Shieldbearer}{Combat}
        ...
        \ff[9]{Arrow Deflection} While you wield a shield, you and each \glossterm{ally} adjacent to you gain a \plus2 bonus to Armor defense against ranged \glossterm{strikes} from weapons or projectiles that are at least one \glossterm{size category} smaller than you.
    ...
    \begin{feat}{Sphere Focus: Aquamancy}{Casting, Magical}
        ...
        In addition, if you have a swim speed, you gain a \plus10 foot \glossterm{magic bonus} to your swim speed.
        ...
        In addition, the speed bonus from that ability increases to \plus20 feet, and the penalty reduction increases to \minus4.
    ...
    \begin{feat}{Sphere Focus: Astromancy}{Casting, Magical}
        ...
        \ff[6]{Astral Spell Transit} You gain a \plus30 foot bonus to your range with abilities from the \sphere{Astromancy} \glossterm{mystic sphere}.
        ...
        \ff[12]{Greater Astral Spell Transit} The range increase from your \textit{astral spell transit} ability increases to \plus60 feet.
        ...
        \ff[21]{Supreme Astral Spell Transit} The range increase from your \textit{astral spell transit} ability increases to \plus120 feet.
    ...
    \begin{feat}{Sphere Focus: Chronomancy}{Casting, Magical}
        ...
        \ff[3]{Accelerated Reaction} You gain a \plus2 bonus to your Reflex defense.
        ...
        \ff[12]{Accelerated Movement} You gain a \plus10 foot bonus to your speed with all of your \glossterm{movement modes}.

        \ff[15]{Spell} You learn a spell from the \sphere{Chronomancy} \glossterm{mystic sphere}.
        When you gain access to a new spell level, you can change which spell you know from that mystic sphere.

        \ff[18]{Greater Accelerated Reaction} The defense bonus from your \textit{accelerated reaction} ability increases to \plus4.

        \ff[21]{Greater Accelerated Mind} Once per round, you can perform a purely mental action that would normally require a \glossterm{minor action} as a \glossterm{free action}.
    ...
    \begin{feat}{Sphere Focus: Cryomancy}{Casting, Magical}
        ...
        \ff[18]{Cold Immunity} You are \trait{immune} to cold damage.

        \ff[18]{Supreme Frozen Blood} You are immune to being \slowed and \immobilized.

        \ff[21]{Greater Icy Carapace} The number of bonus layers you gain from your \textit{icy carapace} ability increases to two.
    \end{feat}
    ...
    \begin{feat}{Sphere Focus: Electromancy}{Casting, Magical}
        ...
        \ff[12]{Static Discharge} When you cast a spell from the \sphere{Electromancy} mystic sphere while your \ability{static buildup} ability is active, you may make an attack vs. Reflex against all enemies adjacent to you.
        On a hit, each target is \glossterm{briefly} \dazed.

        \ff[15]{Spell} You learn a spell from the \sphere{Electromancy} \glossterm{mystic sphere}.
        When you gain access to a new spell level, you can change which spell you know from that mystic sphere.

        \ff[18]{Electricity Immunity} You are \trait{immune} to electricity damage.

        \ff[18]{Greater Static Buildup} The bonus from your \textit{static buildup} ability increases to \plus2.

        \ff[21]{Greater Magnetic Attraction} The bonus from your \textit{magnetic attraction} ability increases to \plus2.
    ...
    \begin{feat}{Sphere Focus: Pyromancy}{Casting, Magical}
        ...
        \ff[18]{Fire Immunity} You are \trait{immune} to fire damage.

        \ff[18]{Supreme Friendly Fire} Your \glossterm{allies} are immune to fire damage from your abilities.

        \ff[21]{Greater Spreading Flame} When you use your \textit{spreading flame} ability, you do not reduce your power with that spell.
    \end{feat}
    ...
    \begin{feat}{Sphere Focus: Toxicology}{Casting, Magical}
        ...
        \begin{activeability}{Cleanse Toxins}
            ...
            \target{Yourself or one adjacent \glossterm{ally}}
    ...
    \begin{feat}{Swiftrunner}{General}
        ...
        \ff[3]{Wall Runner} You gain a \plus5 bonus to checks with the \textit{wallrun} ability (see \pcref{Wallrun}).
        ...
        \ff[12]{Greater Sprinter} The bonus to your \glossterm{fatigue tolerance} from your \textit{sprinter} ability increases to \plus2.

        \ff[15]{Greater Wall Runner} You can move at full speed while wallrunning vertically, instead of at only half speed.
        ...
        \ff[21]{Greater Rapid Movement} The speed bonus from your \textit{rapid movement} ability increases to \plus20 feet.
    \end{feat}
    ...
    \begin{feat}{Swim Specialization}{Skill}
        ...
        \ff[21]{Greater Earth Swimmer} Your swim speed in earth increases to be 10 feet slower than the \glossterm{base speed} for your size.
    ...
    \begin{feat}{Toughness}{General}
        ...
        \ff[3]{Durability} You gain a bonus equal to your level to your maximum \glossterm{hit points}.
    ...
    \begin{feat}{Two-Weapon Fighting}{Combat}
        ...
        \ff[9]{Dual Precision} You gain a \plus1 bonus to \glossterm{accuracy} with \glossterm{strikes} while wielding two weapons that you are proficient with.
    ...
    \begin{feat}{Whirlwind Warrior}{Combat}
        ...
        \ff[6]{Storm Dancer} You reduce your penalties for \squeezing with other creatures by 1, and your movement speed is not reduced while squeezing with other creatures.
        This does not reduce your penalties for squeezing in tight spaces.

        \ff[9]{Eye of the Storm} You gain a \plus1 bonus to your Armor defense while you are adjacent to at least two other creatures.

        \ff[12]{Greater Storm Dancer} You take no penalties for squeezing with other creatures.

        \ff[15]{Greater Unfettered Movement} You can move through spaces occupied by enemies as if they were unoccupied.

        \ff[18]{Greater Eye of the Storm} The Armor defense bonus from your \textit{eye of the storm} ability increases to \plus2.

        \ff[21]{Greater Cyclone} Your \glossterm{power} is not halved with the strike from your \ability{cyclone} ability.
    \end{feat}
