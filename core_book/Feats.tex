...
\end{longtabuwrapper}
    ...
    \begin{feat}{Null}{General}
        ...
        \begin{freeability}{Sever Magic}
            ...
            \hit If the attack deals damage, the target stops being \glossterm{attuned} to one ability of its choice that it is currently attuned to.
            This ability does not affect attunement to magic items.
            \crit If the attack deals damage, the target breaks its attunement to all abilities that it is attuned to other than \glossterm{magic items}.
