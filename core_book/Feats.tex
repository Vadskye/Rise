...
\end{longtabuwrapper}
    ...
    \begin{feat}{Sphere Focus: Summon}{Casting, Magical}
        ...
        \ff[6]{Fortified Summoning} Creatures you create with abilities from the \sphere{summon} spell have \glossterm{damage reduction} equal to your \glossterm{power} with that ability.
