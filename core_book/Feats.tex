...
\begin{longtabuwrapper}
    \begin{longtabu}{>{\lcol}p{10em} >{\lcol}p{15em} >{\lcol}X >{\lcol}p{8em} >{\lcol}p{3em}}
        ...
        \featref{Class Versatility} & \tdash & Swap for abilities from additional class & \featpref{Class VersatilityClass Versatility} \\
        \tind \featref{Class Dedication} & Class Versatility feat & Gain archetype from additional class & \featpref{} \\
...
\end{longtabuwrapper}
    ...
    \begin{feat}{Acrobatics Specialization}{Skill}
        ...
        \ff[12]{Surface Tolerance, Greater} The reduction of DR modifiers for surface conditions increases to 5.
        ...
        \ff[16]{Specialization, Greater} The bonus to Acrobatics increases to \plus6.
    ...
    \begin{feat}{Awareness Specialization}{Skill}
        ...
        \ff[16]{Specialization, Greater} The bonus to Awareness increases to \plus6.
    ...
    \begin{feat}{Bluff Specialization}{Skill}
        ...
        \ff[2]{Sustained Distraction} If you successfully distract a creature with the \textit{distract ability} of the Bluff skill, you can sustain that distraction on that creature with a \glossterm{swift action} as long as you continue to be distracting.
        ...
        \ff[16]{Specialization, Greater} The bonus to Bluff increases to \plus6.
    ...
    \begin{feat}{Class Dedication}{Class}
        ...
        \ff[1]{Additional Archetype} Choose an archetype from a class you have chosen with the \textit{additional class} ability of the Class Versatility feat (see \pcref{Class Versatility}).
    ...
    \begin{feat}{Class Versatility}{Class}
        ...
        \ff[10]{Extraordinary Versatility} You can choose a third class with your \textit{additional class} ability.
    ...
    \begin{feat}{Climb Specialization}{Skill}
        ...
        \ff[16]{Specialization, Greater} The bonus to Climb increases to \plus6.
    ...
    \begin{feat}{Craft Specialization}{Skill}
        ...
        \ff[16]{Specialization, Greater} The bonus to Craft skills increases to \plus6.
    ...
    \begin{feat}{Creature Handling Specialization}{Skill}
        ...
        \ff[16]{Specialization, Greater} The bonus to Creature Handling increases to \plus6.
    ...
    \begin{feat}{Devices Specialization}{Skill}
        ...
        \ff[16]{Specialization, Greater} The bonus to Devices increases to \plus6.
    ...
    \begin{feat}{Disguise Specialization}{Skill}
        ...
        \ff[16]{Specialization, Greater} The bonus to Disguise increases to \plus6.
    \end{feat}
    ...
    \begin{feat}{Escape Artist Specialization}{Skill}
        ...
        \ff[12]{Rapid Escape, Greater} You can escape bindings and grapples as a \glossterm{swift action}.

        \ff[14]{Constraint Tolerance, Greater} The penalty reduction from your \textit{constraint tolerance} ability increases to 2.
        This typically allows you to ignore all penalties for \glossterm{squeezing}.

        \ff[16]{Specialization, Greater} The bonus to Escape Artist increases to \plus6.
    ...
    \begin{feat}{Intimidate Specialization}{Skill}
        ...
        \ff[16]{Specialization, Greater} The bonus to Intimidate increases to \plus6.
    \end{feat}
    ...
    \begin{feat}{Heal Specialization}{Skill}
        ...
        \ff[16]{Specialization, Greater} The bonus to Heal increases to \plus6.
    ...
    \begin{feat}{Perform Specialization}{Skill}
        ...
        \ff[16]{Specialization, Greater} The bonus to Perform increases to \plus6.
    ...
    \begin{feat}{Jump Specialization}{Skill}
        ...
        \ff[16]{Specialization, Greater} The bonus to Jump increases to \plus6.
    ...
    \begin{feat}{Knowledge Specialization}{Skill}
        ...
        \ff[16]{Specialization, Greater} The bonus to Knowledge increases to \plus6.
    \end{feat}
    ...
    \begin{feat}{Linguistics Specialization}{Skill}
        ...
        \ff[16]{Specialization, Greater} The bonus to Linguistics increases to \plus6.
    \end{feat}
    ...
    \begin{feat}{Ride Specialization}{Skill}
        ...
        \ff[16]{Specialization, Greater} The bonus to Ride increases to \plus6.
    ...
    \begin{feat}{Persuasion Specialization}{Skill}
        ...
        \ff[16]{Specialization, Greater} The bonus to Persuasion increases to \plus6.
    \end{feat}
    ...
    \begin{feat}{Sense Motive Specialization}{Skill}
        ...
        \ff[16]{Specialization, Greater} The bonus to Sense Motive increases to \plus6.
    \end{feat}
    ...
    \begin{feat}{Sleight of Hand Specialization}{Skill}
        ...
        \ff[16]{Specialization, Greater} The bonus to Sleight of Hand increases to \plus6.
    \end{feat}
    ...
    \begin{feat}{Spellcraft Specialization}{Skill}
        ...
        \ff[16]{Specialization, Greater} The bonus to Spellcraft increases to \plus6.
    \end{feat}
    ...
    \begin{feat}{Sprint Specialization}{Skill}
        ...
        \ff[16]{Specialization, Greater} The bonus to Sprint increases to \plus6.
    \end{feat}
    ...
    \begin{feat}{Stealth Specialization}{Skill}
        ...
        \ff[16]{Specialization, Greater} The bonus to Stealth increases to \plus6.
    ...
    \begin{feat}{Survival Specialization}{Skill}
        ...
        \ff[16]{Specialization, Greater} The bonus to Survival increases to \plus6.
    \end{feat}
    ...
    \begin{feat}{Swim Specialization}{Skill}
        ...
        \ff[16]{Specialization, Greater} The bonus to Swim increases to \plus6.
    \end{feat}
