...
\section{Gaining Feats}
    ...
    At 3rd, 6th, and 9th level, you also gain any feat of your choice that you qualify for.
...
\end{longtabuwrapper}
    ...
    \begin{feat}{Creature Handling Specialization}{Skill}
        ...
        \cf[19]{Greater Efficient Training} You can teach a creature with 4 hours of work, split as you choose (see \pcref{Training Creatures}).
        In addition, the number of bonus tricks you can teach from your \textit{efficient training} ability increases to four.

        \ff[19]{Rapid Pacify} You can use the \textit{pacify} ability from the Creature Handling skill as a \glossterm{minor action}, rather than as a standard action.
    \end{feat}
    ...
    \begin{feat}{Intimidate Specialization}{Skill}
        ...
        \ff[4]{Greater Demoralize} When you use the \textit{demoralize} ability, the target is \frightened by you instead of being shaken.
    ...
    \begin{feat}{Regenerator}{General}
        ...
        \ff[1]{Regenerative Rest} When you take a \glossterm{short rest}, you can heal \glossterm{vital damage} equal to half your Constitution in addition to your normal healing (see \pcref{Vital Damage}).
        ...
        \ff[19]{Indestructible} The penalty reduction from your \textit{diehard} ability increases to be equal to your Constitution.
    \end{feat}
    ...
    \begin{feat}{Sphere Focus: Cryomancy}{Casting, Magical}
        ...
        \ff[4]{Lingering Chill} Whenever you get a \glossterm{critical hit} against a target with a spell from the \sphere{cryomancy} \glossterm{mystic sphere}, the target is \glossterm{fatigued} as a \glossterm{condition}.
        ...
        \ff[13]{Greater Lingering Chill} The \glossterm{fatigued} condition from your \textit{lingering chill} ability is replaced with the \glossterm{exhausted} condition.
