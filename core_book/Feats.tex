...
\end{longtablewrapper}
    ...
    \begin{feat}{Blood Magic}{Casting, Magical}
        ...
        \ff[4]{Fortified Blood} You increase your maximum \glossterm{hit points} by 1.
        In addition, you become \glossterm{bloodied} when you have one fewer \glossterm{hit point} remaining than normal.

        \ff[7]{Bloodbind} Whenever you \glossterm{injure} a living creature using a spell, you can choose to bind the target's blood to yours.
        ...
        In addition, you also gain a \plus1 bonus to \glossterm{accuracy} with the spell.

        \ff[13]{Greater Fortified Blood} The number of additional \glossterm{hit points} you gain from your \textit{fortified blood} ability increases to 2.
    ...
    \begin{feat}{Endurance Specialization}{Skill}
        ...
        \ff[4]{Delay Wound} Whenever you receive a \glossterm{vital wound}, you can make an Endurance check.
        ...
        It still counts against your total number of vital wounds for determining your penalties on \glossterm{wound rolls} (see \pcref{Wound Roll}).
        You must repeat this check at the end of each subsequent round to continue to delay the effects of the wound.
        Failure means that the vital wound has its normal effect on you.

        You can only delay your most recent vital wound in this way.
        If you gain a new vital wound, you immediately suffer the full effect of the previous vital wound, though you can delay the new wound normally.
        ...
        \ff[13]{Delay Condition} Whenever you gain a \glossterm{condition}, you can make an Endurance check.
        ...
        You can only delay your most recent condition in this way.
        If you gain a new condition, you immediately suffer the full effect of the previous condition, though you can delay the new condition normally.

        \ff[16]{Supreme Specialization} The bonus from your \textit{specialization} ability increases to \plus9.

        \ff[19]{Multiple Delay} You can delay your two most recent \glossterm{vital wounds} and \glossterm{conditions} with your \textit{dealy wound} and \textit{delay condition} abilities.
    \end{feat}
    ...
    \begin{feat}{Sphere Focus: Cryomancy}{Casting, Magical}
        ...
        \ff[4]{Lingering Chill} Whenever you \glossterm{injure} a creature with a \glossterm{critical hit} using cold damage, that creature is \glossterm{chilled} as a \glossterm{condition}.
    ...
    \begin{feat}{Sphere Focus: Pyromancy}{Casting, Magical}
        ...
        \ff[4]{Lingering Flame} Whenever you \glossterm{injure} a creature with a \glossterm{critical hit} using fire damage, that creature takes fire \glossterm{standard damage} \minus2d at the end of the next round.
    ...
    \begin{feat}{Sphere Focus: Terramancy}{Casting, Magical}
        ...
        \ff[13]{Body of Stone} You gain a \plus1 bonus to \glossterm{wound rolls}.
    ...
    \begin{feat}{Sphere Focus: Vivimancy}{Casting, Magical}
        ...
        \ff[10]{Greater Personal Vitality} The bonus to Fortitude defense from your \textit{fortified life} ability increases to \plus2.
        In addition, you are immune to being \glossterm{nauseated}.

        \ff[13]{Life Suppression} You gain a \plus4 bonus to defenses against abilities that only affect living creatures.

        \ff[16]{Greater Vivimancy Focus} The bonus from your \textit{vivimancy focus} ability increases to \plus2.

        \ff[19]{Greater Life Suppression} You are no longer considered a living creature for the purpose of abilities used by your \glossterm{enemies}.
    \end{feat}
