...
\end{longtablewrapper}
    ...
    \begin{feat}{Blood Magic}{Casting, Magical}
        ...
        \ff[1]{Fortified Blood} You treat your level as if it was 1 higher than it actually is for the purpose of determining your \glossterm{hit points} (see \tref{Character Advancement}).
    ...
    \begin{feat}{Toughness}{General}
        ...
        \ff[3]{Durability} You treat your level as if it was 1 higher than it actually is for the purpose of determining your \glossterm{hit points} (see \tref{Character Advancement}).
