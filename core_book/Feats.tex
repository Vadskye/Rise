...
\end{longtabuwrapper}
    ...
    \begin{feat}{Agility}{General}
        ...
        \ff[16]{Greater Spring Attack} You gain a \plus1d bonus to damage on the strike from your \textit{spring attack} ability.
    ...
    \begin{feat}{Duelist}{Combat}
        ...
        \ff[6]{Riposte} You gain a \plus1d bonus to damage with melee \glossterm{strikes} as long as you are not \glossterm{threatened} by more than one creature.
        ...
        \ff[9]{Focused Precision} The accuracy bonus from your \textit{focused strike} ability increases to \plus3.
        ...
        \ff[15]{Greater Focused Strike} The damage bonus from your \textit{focused strike} ability increases to \plus3d.
    ...
    \begin{feat}{Leadership}{Combat}
        ...
        \ff[9]{Greater Battle Command} The target of your \textit{battle command} ability also gains a \plus1d bonus to damage with \glossterm{strikes}.
        ...
        \ff[18]{Supreme Battle Command} The damage bonus from your \textit{potent command} ability increases to \plus2d.
    ...
    \begin{feat}{Sniper}{Combat}
        ...
        \begin{freeability}{Aim}[\glossterm{Sustain} (minor)]
            ...
            You gain a \plus1 bonus to accuracy on \glossterm{strikes} against the target.
        ...
        \ff[18]{Greater Sniper Shot} The bonus to damage from your \textit{sniper shot} ability increases to \plus4d.
    ...
    \begin{feat}{Sphere Focus: Weaponcraft}{Casting, Magical}
        ...
        \ff[9]{Greater Personal Weapon} When attacking with a weapon created with the \spell{personal weapon} \glossterm{cantrip}, you gain a \plus1 \glossterm{magic bonus} to \glossterm{accuracy} and a \plus1d \glossterm{magic bonus} to damage.
        ...
        \ff[18]{Supreme Personal Weapon} The accuracy bonus from your \textit{greater personal weapon} increases to \plus2, and the damage bonus increases to \plus2d.
    \end{feat}
    ...
    \begin{feat}{Whirlwind Warrior}{Combat}
        ...
        \ff[9]{Greater Whirlwind Spin} You gain a \plus1d bonus to damage with your \textit{whirlwind spin}.
        ...
        \ff[20]{Supreme Whirlwind Spin} The damage bonus from your \textit{greater whirlwind spin} ability increases to \plus3d.
    \end{feat}
