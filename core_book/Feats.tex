...
\end{longtabuwrapper}
    ...
    \begin{feat}{Reaper}{Combat}
        ...
        \begin{ability}{Sweeping Blow}
            ...
            You take a \minus1 penalty to \glossterm{accuracy} on each strike.
        \end{ability}
        ...
        \begin{ability}{Reaping Assault}
            ...
            You take a \minus2 penalty to \glossterm{accuracy} on each strike.
        \end{ability}
        ...
        \ff[10]{Certain Reap} The accuracy penalty with strikes from your \textit{reaping assault} ability is reduced to \minus1.
        ...
        \ff[14]{Greater Powerful Sweep} The damage bonus from your \textit{powerful sweep} ability increases to \plus2d.

        \ff[16]{Greater Certain Reap} The accuracy penalty with strikes from your \textit{reaping assault} ability is removed.
