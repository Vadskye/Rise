...
\end{longtablewrapper}
    ...
    \begin{feat}{Ghostblade}{Combat, Magical}
        ...
        \begin{instantability}{Spectral Strike}
            ...
            \rankline
            \featlevel{12} The effect becomes a \glossterm{condition}.
            \featlevel{18} Each creature that loses hit points is \decelerated instead of slowed.
        \end{instantability}

        \ff[9]{Greater Ghost Step} You can use your \textit{ghost step} ability to affect any movement you make during the \glossterm{movement phase}.
        In addition, when you use the \textit{sprint} ability, you can become \glossterm{incorporeal} for the duration of the movement.
        ...
        \begin{instantability}{Spectral Reap}
            Make a \glossterm{strike}.
            The attack is made against each subject's Reflex defense instead of its Armor defense.
            Each creature damaged by the strike is \glossterm{briefly} \slowed.

            \rankline
            \featlevel{21} Each creature is \decelerated instead of slowed.
        \end{instantability}

        \ff[18]{Supreme Ghost Step} You can use your \textit{greater ghost step} ability to affect any movement you make during the \glossterm{movement phase}.
