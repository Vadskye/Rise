...
\end{longcolumn}
    ...
    \begin{magicalfeat}{Sphere Focus: Enchantment}{Casting, Magical}
        ...
        \magicalff[6]{Mind Fragments} When you use abilities from the \sphere{enchantment} mystic sphere, you can affect creatures that are immune to those abilities due to being \trait{mindless} or \trait{simple-minded}.
