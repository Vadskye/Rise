...
\begin{longtabuwrapper}
    \begin{longtabu}{>{\lcol}p{10em} >{\lcol}p{15em} >{\lcol}X >{\lcol}p{8em} >{\lcol}p{3em}}
        ...
        \featref{Class Versatility} & \tdash & Swap for abilities from additional class & \featpref{Class Versatility} \\
        \tind \featref{Class Dedication} & Class Versatility feat & Gain archetype from additional class & \featpref{Class Dedication} \\
...
\end{longtabuwrapper}
    ...
    \begin{feat}{Celestial Heritage}{Bloodline, Magical}
        ...
        \ff[15]{Empowered Blessing} The accuracy bonus from your \glossterm{holy blessing} ability increases to \plus3.
    ...
    \begin{feat}{Class Versatility}{Class}
        ...
        \begin{itemize}
            ...
            \item \plus1d bous to \glossterm{strike damage}.
    ...
    \begin{feat}{Martial Training}{Combat}
        ...
        \begin{itemize}
            ...
            \item You reduce the \glossterm{encumbrance penalty} of \glossterm{body armor} you wear by 1, and the \glossterm{arcane spell failure} chance by 5\%.
        ...
        \ff[6]{Combat Prowess} You gain a \plus1 bonus to \glossterm{accuracy} with \glossterm{physical} attacks.
    ...
    \begin{feat}{Vivimancer}{Magical, Spell}
        ...
        \begin{ability}
            ...
            \end{spelltargetinginfo}
            \begin{spelleffects}
                \spelleffect The target is healed for hit points equal to your \glossterm{standard damage}.
