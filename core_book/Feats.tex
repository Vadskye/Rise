...
\end{longtablewrapper}
    ...
    \begin{feat}{Sphere Focus: Channel Divinity}{Casting, Magical}
        ...
        \ff[4]{Divine Intervention} You gain a \plus2 bonus to any roll that you use the \textit{desperate exertion} ability on (see \pcref{Desperate Exertion}).
        ...
        \ff[13]{Greater Divine Intervention} The bonus from your \textit{divine intervention} ability increases to \plus4.
