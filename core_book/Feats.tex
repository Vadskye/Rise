...
\end{longtabuwrapper}
    ...
    \begin{feat}{Sphere Focus: Aquamancy}{Casting, Magical}
        ...
        \ff[3]{Fire Tolerance} You gain a bonus equal to your \glossterm{power} to your \glossterm{damage reduction} against fire damage.
        ...
        \ff[12]{Greater Fire Tolerance} Your bonus from the \textit{fire tolerance} ability increases to twice your \glossterm{power}.
    ...
    \begin{feat}{Sphere Focus: Pyromancy}{Casting, Magical}
        ...
        \ff[3]{Fire Tolerance} You gain a bonus equal to your \glossterm{power} to your damage reduction against fire damage.
        ...
        \ff[9]{Potent Pyromancy} You gain a \plus1 bonus to \glossterm{accuracy} with abilities from the \sphere{pyromancy} \glossterm{mystic sphere}.
    ...
    \begin{feat}{Sphere Focus: Summon}{Casting, Magical}
        ...
        \ff[6]{Fortified Summoning} Creatures you create with abilities from the \sphere{summon} spell gain additional hit points equal to your \glossterm{power}.
        ...
        \ff[15]{Greater Fortified Summoning} The bonus from your \textit{fortified summoning} ability increases to be equal to twice your \glossterm{power}.
    ...
    \begin{feat}{Sphere Focus: Thaumaturgy}{Casting, Magical}
        ...
        \ff[6]{Magic Tolerance} You gain a \plus2 bonus to \glossterm{defenses} against \glossterm{magical} abilities.
        ...
        \ff[15]{Greater Magic Tolerance} The bonus from your \textit{magic tolerance} ability increases to \plus4.
