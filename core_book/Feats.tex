...
\end{longtabuwrapper}
    ...
    \begin{feat}{Agility}{Combat}
        ...
        \ff[1]{Dodge Roll} You gain the \textit{dodge roll} ability.
        \begin{ability}{Dodge Roll}[\glossterm{Swift}]
            As a \glossterm{standard action}, you can use this ability.
            If you do, you gain a \plus4 bonus to Armor and Reflex defenses until the end of the round.
    ...
    \begin{feat}{Bardic Exemplar}{Magical, Skill}
        ...
        \ff[1]{Inspire Courage} You gain the \textit{inspire courage} ability.
        ...
        \ff[3]{Vicious Mockery} You gain the \textit{vicious mockery} ability.
        \begin{ability}{Vicious Mockery}[\glossterm{Delusion}, \glossterm{Mind}]
            As a standard action, you can spend an \glossterm{action point} to use this ability.
            When you do, you make a brief performance using one of your Perform skills.
    ...
    \begin{feat}{Conjurer}{Magical, Spell}
        ...
        \ff[3]{Resummon} You gain the \textit{resummon} ability.
        \begin{ability}{Resummon}
            As a \glossterm{minor action}, you can spend an \glossterm{action point} to use this ability.
            If you do, you may teleport any number of creatures or objects that you summoned with \glossterm{Summoning} abilities into unoccupied spaces on stable ground within \rngclose range of you.
        \end{ability}
        ...
        \ff[9]{Remanifest} You gain the \textit{remanifest} ability.
        \begin{ability}{Remanifest}
            As a \glossterm{minor action}, you can spend an \glossterm{action point} to use this ability.
            If you do, you may teleport one object that you created with a \glossterm{Manifestation} ability into unoccupied space on stable ground within \rngclose range of you.
        \end{ability}
    ...
    \begin{feat}{Disguise Specialization}{Skill}
        ...
        \ff[10]{Disguise Size}[Magical] You gain the \textit{disguise size} ability.
    ...
    \begin{feat}{Perform Specialization}{Skill}
        ...
        \ff[2]{Mesmerizing Performance}[Magical] You gain the \textit{mesmerizing performance} ability.
        ...
        \ff[4]{Inspire Competence}[Magical] You gain the \textit{inspiring performance} ability.
        ...
        \begin{ability}{Mesmeric Suggestion}[\glossterm{Delusion}, \glossterm{Mind}, \glossterm{Subtle}, \glossterm{Sustain} (minor)]
            As a standard action, you can spend an \glossterm{action point} to use this ability.
            When you do, make a Perform vs. Mental attack against a target within \rngmed range.
    ...
    \begin{feat}{Persuasion Specialization}{Skill}
        ...
        \begin{ability}{Suggestion}[\glossterm{Delusion}, \glossterm{Mind}, \glossterm{Subtle}, \glossterm{Sustain} (minor)]
            As a standard action, you can spend an \glossterm{action point} to use this ability.
            When you do, make a Persuasion vs. Mental attack against a target within \rngmed range.
            You must also make a verbal suggestion of a particular course of action to the target.
            If your suggestion does not seem reasonable, you take a \minus5 penalty to accuracy on this attack.
            Exceptionally unreasonable suggestions can impose even greater penalties, and exceptionally reasonable suggestions can give accuracy bonuses.
