...
\end{longtablewrapper}
    ...
    \begin{feat}{Sphere Focus: Summoning}{Casting, Magical}
        ...
        \begin{freeability}{Resummon}
            Choose one creature or object that you summoned with a currently active ability from the \sphere{Summoning} \glossterm{mystic sphere} with the \glossterm{Attune} or \glossterm{Sustain} tags.
