...
\end{longcolumn}
    ...
    \begin{magicalfeat}{Sphere Focus: Pyromancy}{Casting, Magical}
        ...
        If you do, you cannot get a \glossterm{glancing blow} with that spell against anything other than yourself, even if the spell would normally cause a glancing blow on a miss.
