...
\end{longtabuwrapper}
    ...
    \begin{feat}{Bardic Exemplar}{Magical, Skill}
        ...
        \begin{ability}
            ...
            \end{spelltargetinginfo}
            \begin{spelleffects}
                \spelleffect Each target gains a \plus2 bonus to accuracy with all attacks.
                \spelldur Sustain (minor).
                Sustaining this ability requires continuing the performance you started when you used this ability.
    ...
    \begin{feat}{Celestial Heritage}{Bloodline, Magical}
        ...
        \begin{ability}
            ...
            \end{spelltargetinginfo}
            \begin{spelleffects}
                \spelleffect The target gains a \plus1 bonus to \glossterm{accuracy} with all attacks.
        ...
        \begin{ability}
            ...
            \begin{spelleffects}
                \begin{spellattack}{Draconic power vs. Reflex}
                    \spellsuccess Each target takes \glossterm{standard damage}.
    ...
    \begin{feat}{Perform Specialization}{Skill}
        ...
        \begin{ability}
            ...
            \begin{spelleffects}
                \begin{spellattack}{Perform vs. Mental}
                    \spellspecial If a target thinks that you or your allies are threatening it, you take a \minus5 penalty to accuracy on the attack against that target.
                    \spellsuccess Each target is \fascinated by you.
                ...
                \end{spellattack}
                \spelldur Sustain (minor). Sustaining this ability requires continuing the performance you started when you used this ability. If a target can neither see nor hear your performance, the effect immediately ends for that creature.
