...
\end{longtablewrapper}
    ...
    \begin{feat}{Awareness Specialization}{Skill}
        ...
        \ff[6]{Quick Scan} When you use the \textit{search} ability, you can notice things in a \areatiny radius within \rngshort range (see \pcref{Search}).
    ...
    \begin{feat}{Draconic Heritage}{Bloodline}
        ...
        \begin{freeability}{Breath Weapon}
            ...
            \featlevel{9} The area affected by your breath weapon increases.
                A line breath weapon becomes a \arealarge, 15 ft.\ wide line.
            ...
            \featlevel{15} You gain a \plus1d bonus to damage.
                ...
                A line breath weapon becomes a \arealarge, 20 ft.\ wide line.
    ...
    \begin{dtable}
        ...
        \begin{dtabularx}{\columnwidth}{l >{\lcol}X >{\lcol}X}
            ...
            Black & Acid & \areasmall, 10 ft. wide line \\
            Blue & Electricity & \areasmall, 10 ft. wide line \\
            Brass & Fire & \areasmall, 10 ft. wide line \\
            Bronze & Electricity & \areasmall, 10 ft. wide line \\
            Copper & Acid & \areasmall, 10 ft. wide line \\
    ...
    \begin{feat}{Intimidate Specialization}{Skill}
        ...
        \ff[6]{Threatening Presence} You are considered to be \glossterm{threatening} each \glossterm{enemy} within a \areamed emanation from you for the purpose of determining their \glossterm{overwhelm penalty}. 
    ...
    \begin{feat}{Leadership}{Combat}
        ...
        \ff[3]{Encouraging Presence} Your \glossterm{allies} within a \areamed \glossterm{emanation} from you are immune to being \glossterm{shaken}, \glossterm{frightened}, and \glossterm{panicked}.
        ...
        \ff[9]{Inspiring Presence} Your \glossterm{allies} within a \areamed \glossterm{emanation} from you gain a \plus2 bonus to Mental defense.

        \ff[12]{Brave Leader} You are immune to being \glossterm{shaken}, \glossterm{frightened}, and \glossterm{panicked}.

        \ff[15]{Sustaining Presence} Your \glossterm{allies} within a \areamed \glossterm{emanation} from you gain a \plus2 bonus to \glossterm{vital rolls}.

        \ff[18]{Supreme Presence} The area of your \textit{presence} abilities from this feat increases to a \arealarge \glossterm{emanation} from you.
    \end{feat}
    ...
    %     \ff[6]{Widened Backlash} The area affected by your \glossterm{miscast backlash} increases to a \areasmall radius centered on you.
    ...
    %     \ff[18]{Greater Widened Backlash} The area affected by your \glossterm{miscast backlash} increases to a \areasmall radius centered on you.
    % \end{feat}
    ...
    \begin{feat}{Null}{General}
        ...
        \ff[6]{Disruptive Presence} All enemies within an \areasmall radius from you have a 50\% chance to \glossterm{miscast} any spell they cast.
        ...
        \ff[15]{Greater Disruptive Presence} Your \textit{disruptive presence} ability affects all enemies in a \areamed radius \glossterm{emanation} from you.
    ...
    \begin{feat}{Social Insight Specialization}{Skill}
        ...
        \ff[12]{Truthsense} Whenever a creature within a \areamed radius \glossterm{emanation} from you that you can hear and see speaks the truth with no attempt at evasion, concealment, or creative wording, you automatically recognize that.
        ...
        \ff[18]{Greater Truthsense} The area of your \textit{truthsense} ability increases to a \areahuge radius.
    \end{feat}
    ...
    \begin{feat}{Sphere Focus: Barrier}{Casting, Magical}
        ...
        \ff[6]{Hardened Barriers} You gain a bonus equal to your level to the \glossterm{hit points} of objects you create with the \sphere{Barrier} \glossterm{mystic sphere}.
        ...
        \ff[18]{Greater Hardened Barriers} The bonus from your \textit{hardened barriers} ability increases to twice your level.
    \end{feat}
