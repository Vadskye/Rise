...
\end{longtabuwrapper}
    ...
    \begin{feat}{Celestial Heritage}{Bloodline, Magical}
        ...
        \begin{freeability}{Angelic Flight}[Magical]
            ...
            If you used this ability last round, you also lose a \glossterm{hit point}.
        \end{freeability}
    ...
    \begin{feat}{Creature Handling Specialization}{Skill}
        ...
        \begin{itemize}
            \item It gains a bonus equal to its level to its \glossterm{wound resistance}.
        ...
        \begin{itemize}
            \item It gains a bonus equal to twice its level to its \glossterm{wound resistance}.
    ...
    \begin{feat}{Executioner}{Combat}
        ...
        \begin{freeability}{Execution}
            ...
            % TODO: wording?
            If the strike does not beat the target's \glossterm{wound resistance}, it deals no damage.
        ...
        In addition, you can see all living creatures within range that have a \glossterm{vital wound} perfectly instead of only knowing their location.
    ...
    \begin{feat}{Heal Specialization}{Skill}
        ...
        \begin{freeability}{Healing Touch}[\glossterm{Life}]
            ...
            \rankline
            \rank{10} The bonus increases to \plus3.
            \rank{16} The bonus increases to \plus4.
        \end{freeability}
    ...
    \begin{feat}{Iron Will}{General}
        ...
        \ff[4]{Mind over Matter} You gain an additional \glossterm{hit point}.
    ...
    \begin{feat}{Regenerator}{General}
        ...
        \ff[1]{Diehard} You gain a \plus1 bonus to \glossterm{wound rolls}.
        ...
        \ff[10]{Greater Diehard} The bonus from your \textit{diehard} ability increases to \plus2.

        \ff[13]{Greater Regenerative Rest} Your \textit{regenerative rest} ability removes an additional \glossterm{vital wound}.

        \ff[16]{Greater Regenerative Recovery} Your \textit{regenerative recovery} ability causes you to regain an additional \glossterm{hit point}.

        \ff[19]{Supreme Diehard} The bonus from your \textit{diehard} ability increases to \plus3.
    \end{feat}
    ...
    \begin{feat}{Sphere Focus: Fabrication}{Casting, Magical}
        ...
        In addition, any objects you create with abilities from the \sphere{fabrication} \glossterm{mystic sphere} gain a bonus equal to your \glossterm{power} to their \glossterm{wound resistance}.
        ...
        In addition, the \glossterm{wound resistance} bonus increases to twice your \glossterm{power}.
    ...
    \begin{feat}{Sphere Focus: Summon}{Casting, Magical}
        ...
        \ff[4]{Fortified Summons} Creatures you create with abilities from the \sphere{summon} spell gain an additional \glossterm{hit point}.
        ...
        \ff[13]{Greater Fortified Summons} The number of additional \glossterm{hit points} from your \textit{fortified summoning} ability increases to two.
    ...
    \begin{feat}{Sphere Focus: Vital Surge}{Casting, Magical}
        ...
        \ff[4]{Lifebind} Whenever you deal damage to a living creature using a spell from the \sphere{vital surge} \glossterm{mystic sphere}, you can choose to bind the target's life force to yours.
        ...
        \ff[10]{Greater Lifebind} You are always considered to have \glossterm{line of effect} to the target bound by your \textit{lifebind} ability, regardless of intervening obstacles.
        The target must still be within the normal \glossterm{range} of your spells.

        \ff[13]{Personal Vitality} You gain a \plus2 bonus to Fortitude defense.

        \ff[16]{Greater Vital Surge Focus} The bonus from your \textit{vital surge focus} ability increases to \plus2.

        \ff[19]{Supreme Lifebind} As long as the target of your \textit{lifebind} ability is on the same plane as you, it is always within the \glossterm{range} of your \glossterm{magical} abilities.
    \end{feat}
    ...
    \begin{feat}{Toughness}{General}
        ...
        \ff[4]{Durability} You gain an additional \glossterm{hit point}.
        ...
        \ff[13]{Greater Durability} The number of additional \glossterm{hit points} from your \textit{durability} ability increases to two.
