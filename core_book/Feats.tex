...
\end{longtabuwrapper}
    ...
    \begin{feat}{Heal Specialization}{Skill}
        ...
        \ff[6]{Vital Healing}[Magical] For every five points of healing you would restore with your \textit{healing touch} ability, you can instead heal a point of \glossterm{vital damage}.
