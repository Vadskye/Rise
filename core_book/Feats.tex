...
\section{Feat Descriptions}
    ...
    \featpre Mage level 1.
    \featben You gain damage reduction against \glossterm{magical} abilities equal to half your mage level or half Constitution, whichever is higher.
    This damage reduction applies against your own abilities, including miscast effects.

    At mage level 3, you take half damage from your own spell and miscast effects (before applying damage reduction).

    At mage level 7, the damage reduction increases to be equal to your mage level or Constitution, whichever is higher.
