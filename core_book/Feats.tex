...
\end{longtablewrapper}
    ...
    \begin{feat}{Sphere Focus: Astromancy}{Casting, Magical}
        ...
        \ff[19]{Greater Astral Spell Transit} When determining whether you have \glossterm{line of effect} to a particular location with abilites from the \sphere{Astromancy} \glossterm{mystic sphere}, you can ignore any number of physical obstacles with a combined thickness of five feet or less.
