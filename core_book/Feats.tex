...
\end{longtablewrapper}
    ...
    \begin{feat}{Perform Specialization}{Skill}
        ...
        \ff[12]{Greater Inspiring Performance} The bonus from your \textit{inspiring performance} ability increases to \plus3.

        \ff[15]{Supreme Specialization} The bonus from your \textit{specialization} ability increases to \plus7.

        \ff[18]{Greater Inspiring Performance} The bonus from your \textit{inspiring performance} ability increases to \plus4.
