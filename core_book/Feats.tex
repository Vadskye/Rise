...
\end{longtablewrapper}
    ...
    \begin{feat}{Sphere Focus: Pyromancy}{Casting, Magical}
        ...
        \ff[4]{Lingering Flame} Whenever you deal fire damage to a creature with a \glossterm{critical hit}, that creature takes fire \glossterm{standard damage} \minus2d at the end of the next round.
