...
\end{longtabuwrapper}
    ...
    \begin{feat}{Abjurer}{Magical, Spell}
        ...
        \ff[3]{Counterspell} Whenever you cast a spell, you can use this ability.
        ...
        \ff[9]{Delayed Counterspell} At the start of the \glossterm{delayed action phase}, if you are casting a spell, you can use your \textit{counterspell} ability on that spell.
    ...
    \begin{feat}{Bardic Exemplar}{Magical, Skill}
        ...
        This effect lasts as long as you sustain the performance as a \glossterm{minor action}.
        If the target can neither see nor hear your performance, the effect immediately ends.
        This is a \glossterm{Delusion}, \glossterm{Mind} ability.
        In addition, it may have the \glossterm{Auditory} or \glossterm{Visual} tags, depending on the nature of the performance.
        ...
        \ff[13]{Battle Cry} As a \glossterm{minor action}, you can spend an \glossterm{action point} to use this ability.
        When you do, you begin a performance using one of your Perform skills.
    ...
    \begin{feat}{Blindfighter}{Combat}
        ...
        \ff[8]{Blind Feint} Whenever you are attacked by a creature who incorrectly thinks you are \glossterm{unaware} of the attack, you gain a \plus1d bonus to \glossterm{strike damage} against that creature until the end of the next round, including during the current phase.
    ...
    \begin{feat}{Bluff Specialization}{Skill}
        ...
        \ff[10]{Dual Speech}[Mag] Whenever you speak, you can spend an \glossterm{action point} to use this ability.
    ...
    \begin{feat}{Boongiver}{types}
        ...
        \ff[1]{Reciprocal Boon} Whenever you cast a spell that targets a single creature other than yourself and that requires the target to attune to the effect, you can use this ability.
        ...
        \ff[3]{Benevolent Transferance} As a \glossterm{minor action}, you can use this ability.
    ...
    \begin{feat}{Celestial Heritage}{Bloodline, Magical}
        ...
        \ff[1]{Holy Blessing} As a \glossterm{minor action}, you can spend an \glossterm{action point} to use this ability.
    ...
    \begin{feat}{Duelist}{Combat}
        ...
        \ff[1]{Focused Strike} As a standard action, you can spend an \glossterm{action point} to use this ability.
    ...
    \begin{feat}{Eldritch Knight}{General, Spell}
        ...
        \ff[2]{Spellstrike}[Magical] As a standard action during the \glossterm{action phase}, you can spend an \glossterm{action point} to use this ability.
    ...
    \begin{feat}{Enchanter}{Magical, Spell}
        ...
        If you do, make a \glossterm{spellpower} vs. Mental attack against a creature within \rngmed range.
        On a hit, the target takes physical \glossterm{standard damage}, and its Mental defense is lowered by 3 as a \glossterm{condition}.
        On a critical hit, the target takes double damage and the penalty is increased to \minus6.
    ...
    \begin{feat}{Evoker}{Magical, Spell}
        ...
        \ff[5]{Energy Affinity} Choose an energy type cold, electricity, fire, or sonic.
        You gain a \plus1 bonus to accuracy with attacks that deal damage of that type.
    ...
    \begin{feat}{Executioner}{Combat}
        ...
        \ff[1]{Execution} As a standard action, you can spend an \glossterm{action point} to use this ability.
    ...
    \begin{feat}{Guardian}{Combat}
        ...
        \ff[1]{Binding Strike} As a standard action, you can spend an \glossterm{action point} to use this ability.
        ...
        \subparhead{Hit (Mental)} The target is \glossterm{immobilized} as a \glossterm{condition}.
        This effet immediately ends if you are \glossterm{defeated} or if you stop being adjacent to the target.
        \subparhead{Critical Hit (Mental)} As above, but the effect does not end if you stop being adjacent to the target.

        \ff[2]{Protect} As a \glossterm{minor action}, you can use this ability to focus on defending an ally.
        ...
        \ff[8]{Redirection}[Magical] When you use your \textit{protect} ability, you can spend an \glossterm{action point} to use this ability.
        If you do, you suffer all effects from \glossterm{strikes} that hit the target in place of the target.
    ...
    \begin{feat}{Illusionist}{Magical, Spell}
        ...
        This effect lasts as long as you \glossterm{sustain} it as a \glossterm{minor action}.
        This is a \glossterm{Figment} ability.
    ...
    \begin{feat}{Intimidate Specialization}{Skill}
        ...
        \ff[2]{Demoralizing Blow} As a standard action, you can use this ability.
        If you do, make a \glossterm{strike}.
    ...
    \begin{feat}{Iron Will}{General}
        ...
        \ff[8]{Greater Resilience} The bonus hit points from your \textit{resilience} ability increase to twice your Constitution.
    ...
    \begin{feat}{Leadership}{Combat}
        ...
        \ff[1]{Bolster} As a standard action, you can spend an \glossterm{action point} to use this ability.
        ...
        \ff[2]{Battle Command} As a standard action, you can use this ability.
    ...
    \begin{feat}{Miscaster}{Magical, Spell}
        ...
        \ff[3]{Overchannel} Whenever you cast a spell, you can use this ability.
    ...
    \begin{feat}{Precognition}{Combat}
        ...
        \ff[1]{Precognitive Strike} As a standard action, you can use this ability.
        If you do, make a \glossterm{strike}.
        You can use your Intelligence in place of your Perception to determine your accuracy with this strike.

        \ff[2]{Combat Prediction} At the start of each phase, you can spend an \glossterm{action point} to use this ability.
    ...
    \begin{feat}{Reaper}{Combat}
        ...
        \ff[1]{Cleave} For each \glossterm{critical hit} you get with a melee strike using a slashing or bludgeoning weapon during the \glossterm{action phase}, you can make an additional strike during the \glossterm{delayed action phase}.
        Each additional strike must target a different creature adjacent to the original strike's target.

        % TODO: this seems too strong
        \ff[2]{Sweeping Blow} As a standard action, you can spend an \glossterm{action point} to use this ability.
        If you do, you can make a melee \glossterm{strike} with a slashing or bludgeoning weapon against each of up to three creatures you \glossterm{threaten}.

        \ff[4]{Reaping Assault} As a standard action, you can spend an \glossterm{action point} to use this ability.
        If you do, you can move up to your movement speed in a straight line.
        You can make a melee \glossterm{strike} with a slashing or bludgeoning weapon against each creature and object that you \glossterm{threaten} at any point during your movement, except for the space you start in and the space you end in.
        You take a \minus2d penalty to damage on each strike.

        \ff[6]{Mobile Cleave} When you use your \textit{cleave} ability, you can move up to ten feet before making the strike.
        ...
        \ff[8]{Powerful Sweep} You gain a \plus1d bonus to damage on strikes with your \textit{sweeping blow} ability.

        \ff[10]{Powerful Reap} The damage penalty with strikes from your \textit{reaping assault} ability is reduced to \minus1d.

        \ff[12]{Greater Mobile Cleave} The maximum distance you can move with your \textit{mobile cleave} ability increases to be equal to your movement speed.

        \ff[14]{Greater Powerful Sweep} You gain a \plus1d bonus to damage with strikes from your \textit{sweeping blow} ability.

        \ff[16]{Greater Powerful Reap} The damage penalty with strikes from your \textit{reaping assault} ability is removed.
    ...
    \begin{feat}{Regenerator}{General}
        ...
        \ff[16]{Healing Burst} As a \glossterm{minor action}, you can spend an \glossterm{action point} to use this ability.
    ...
    \begin{feat}{Sense Motive Specialization}{Skill}
        ...
        This effect lasts as long as you \glossterm{sustain} it as a \glossterm{minor action}.
        This ability is a \glossterm{Mind} ability.
    ...
    \begin{feat}{Survival Specialization}{Skill}
        ...
        This effect lasts as long as you \glossterm{attune} to it.
        This ability is a \glossterm{Knowledge} ability.
    ...
    \begin{feat}{Transmuter}{Magical, Spell}
        ...
        If is a \glossterm{Shaping} ability.
        ...
        This is a \glossterm{Shaping} ability.
    ...
    \begin{feat}{Vivimancer}{Magical, Spell}
        ...
        This is a \glossterm{Life} ability.
        ...
        \ff[11]{Lifebound Resilience} At the end of each \glossterm{action phase}, you heal hit points equal to half your spellpower.
