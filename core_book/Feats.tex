...
\end{longtabuwrapper}
    ...
    \begin{feat}{Sphere Focus: Bless}{Casting, Magical}
        ...
        \ff[4]{Restorative Blessing} Whenever a creature \glossterm{attunes} to a spell you cast from the \sphere{bless} \glossterm{mystic sphere}, it heals hit points equal to your \glossterm{power}.
