...
\end{longtabuwrapper}
    ...
    \begin{feat}{Celestial Heritage}{Bloodline, Magical}
        ...
        You can use the wings for a number of rounds equal to 5 \add your Willpower between \glossterm{short rests}.
        ...
        In addition, your \textit{angel wings} ability has no time limit.
    \end{feat}
    ...
    \begin{feat}{Draconic Heritage}{Bloodline}
        ...
        These wings grant you a glide speed equal to your \glossterm{base speed} (see \pcref{Gliding}).
        The wings themselves are \glossterm{mundane}, but the ability to fly and glide with them is \glossterm{magical}.
        You can use the wings for a number of rounds equal to 5 \add your Constitution between \glossterm{short rests}.
        ...
        In addition, your \textit{draconic wings} ability has no time limit.
    \end{feat}
    ...
    \begin{feat}{Sphere Focus: Aeromancy}{Casting, Magical}
        ...
        You can glide for a number of minutes equal to 5 \add your Willpower between \glossterm{short rests}.
        ...
        In addition, your \textit{greater personal updraft} ability has no time limit.
    \end{feat}
    ...
    \begin{feat}{Whirlwind Warrior}{Combat}
        ...
        \ff[10]{Eye of the Storm} You gain a \plus1 bonus to \glossterm{overwhelm resistance}.
        ...
        \ff[19]{Greater Eye of the Storm} The bonus from your \textit{eye of the storm} ability increases to \plus2.
    \end{feat}
