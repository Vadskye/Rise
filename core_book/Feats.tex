...
\end{longtabuwrapper}
    ...
    \begin{feat}{Bardic Exemplar}{Magical, Skill}
        ...
        \ff[1]{Inspire Competence} You can use the \textit{inspire competence} ability as a \glossterm{minor action}.
        \begin{freeability}{Inspiring Performance}[\glossterm{Emotion}, \glossterm{Sustain} (minor)]
            ...
            One \glossterm{ally} within \rngmed range gains a \plus2 \glossterm{magic bonus} to \glossterm{checks} and \glossterm{power}.

            At the end of each round, if the target can neither see nor hear your performance, the effect ends.
            This ability may have the \glossterm{Auditory} or \glossterm{Visual} tags, depending on the nature of your performance.

            \rankline
            \featlevel{13} The bonus to checks increases to \plus3.
            \featlevel{19} The bonus to \glossterm{power} increases to \plus4.
        \end{freeability}

        \ff[4]{Inspire Courage} You can use the \textit{inspire courage} ability as a \glossterm{minor action}.
        \begin{freeability}{Inspire Courage}[\glossterm{Emotion}, \glossterm{Sustain} (minor)]
            \targets{All \glossterm{allies} within a \arealarge emanation from you}
            You begin a performance using one of your Perform skills.
            This ability may have the \glossterm{Auditory} or \glossterm{Visual} tags, depending on the nature of your performance.
            At the end of each round, if a target can neither see nor hear your performance, the effect ends for that target.

            Each target gains a \plus1 \glossterm{magic bonus} to \glossterm{accuracy} and Mental defense.

            \rankline
            \featlevel{10} The bonus to Mental defense increases to \plus2.
            \featlevel{16} The bonus to accuracy increases to \plus2.
        \end{freeability}

        \ff[7]{Hybrid Performance} You can sustain two different \glossterm{magical} abilities from this feat or the Perform Specialization feat as part of the same \glossterm{minor action}.
        In addition, you can use two different \glossterm{magical} abilities from this feat as part of the same \glossterm{minor action}.

        \ff[10]{Song of Serenity} You can use the \textit{song of serenity} ability as a \glossterm{minor action}.
        \begin{freeability}{Song of Serenity}[\glossterm{Emotion}, \glossterm{Sustain} (minor)]
            ...
            The target is immune to hostile \glossterm{Emotion} and \glossterm{Compulsion} effects.
            It immediately removes all \glossterm{conditions} caused by those effects.

            \rankline
            \featlevel{13} This ability can target up to two \glossterm{allies} within range.
            \featlevel{19} This ability can target up to five \glossterm{allies} within range.
        \end{freeability}

        \ff[13]{Song of Freedom} You can use the \textit{song of freedom} ability as a \glossterm{minor action}.
        \begin{freeability}{Song of Freedom}[\glossterm{Emotion}, \glossterm{Sustain} (minor)]
            \target{One \glossterm{ally} within \rngmed range}
            You begin a performance using one of your Perform skills.
            This ability may have the \glossterm{Auditory} or \glossterm{Visual} tags, depending on the nature of your performance.
            At the end of each round, if a target can neither see nor hear your performance, the effect ends for that target.

            The target suffers no ill effects from \glossterm{conditions} it has.
            This does not remove any conditions or prevent the application of additional conditions.

            \rankline
            \featlevel{19} This ability can target up to two \glossterm{allies} within range.
        \end{freeability}

        \ff[16]{Inspire Greatness} You can use the \textit{inspire greatness} ability as a \glossterm{minor action}.
        \begin{freeability}{Inspire Greatness}[\glossterm{Emotion}, \glossterm{Sustain} (minor)]
            \target{One \glossterm{ally} within \rngmed range}
            You begin a performance using one of your Perform skills.
            This ability may have the \glossterm{Auditory} or \glossterm{Visual} tags, depending on the nature of your performance.
            At the end of each round, if the target can neither see nor hear your performance, the effect ends for that target.

            The target increases its maximum \glossterm{hit points} by two and regains two \glossterm{hit points}.
            In addition, it gains a \plus2 \glossterm{magic bonus} to \glossterm{wound rolls}.
            When this ability ends, it loses two \glossterm{hit points} and its maximum \glossterm{hit points} are restored to normal.
        \end{freeability}

        \ff[19]{Greater Hybrid Performance} You can sustain three different \glossterm{magical} abilities from this feat or the Perform Specialization feat as part of the same \glossterm{minor action}.
        In addition, you can use three different \glossterm{magical} abilities from this feat as part of the same \glossterm{minor action}.
    \end{feat}
    ...
    \begin{feat}{Brawler}{Combat}
        ...
        \ff[1]{Unarmed Warrior} You become \glossterm{proficient} with the unarmed weapons \glossterm{weapon group} (see \pcref{Unarmed Weapons}).
        ...
        \ff[7]{Greater Unarmed Warrior} The damage bonus from your \textit{unarmed warrior} increases to \plus2d.
        ...
        \ff[16]{Supreme Unarmed Warrior} The damage bonus from your \textit{unarmed warrior} ability increases to \plus3d.
    ...
    \begin{feat}{Leadership}{Combat}
        ...
        \begin{freeability}{Bolster}[\glossterm{Emotion}]
            One \glossterm{ally} within \rngclose range can remove its most recent \glossterm{condition}.
    ...
    \begin{feat}{Metacaster}{Casting, Magical}
        ...
        \begin{dtable}
            ...
            \begin{dtabularx}{\columnwidth}{l >{\lcol}X}
                ...
                1 & Dazed, dazzled, fatigued, ignited (removable)\fn{1}, sickened, slowed \\
                2 & Decelerated, exhausted, frightened, nauseated, stunned \\
                3 & Blinded, confused, decelerated, disoriented, ignited (non-removable), immobilized, panicked \\
                4 & Asleep\fn{2}, paralyzed \\
            \end{dtabularx}
            1. The rank 1 version of the \glossterm{ignited} condition can be removed with a \glossterm{difficulty rating} 10 Dexterity check. The rank 3 version can only be removed by removing the condition, as normal for conditions.
    ...
    \begin{feat}{Mystic Archer}{Casting}
        ...
        \begin{freeability}{Imbued Shot}[\glossterm{Magical}]
            Make a ranged \glossterm{magical strike} with a \plus1 bonus to \glossterm{accuracy} using a \glossterm{projectile weapon} you wield.
    ...
    \begin{feat}{Perform Specialization}{Skill}
        ...
        \ff[4]{Vicious Mockery} You can use the \textit{vicious mockery} ability as a standard action.
        \begin{freeability}{Vicious Mockery}[\glossterm{Emotion}]
            ...
            \rankline
            \featlevel{10} The area increases to a \arealarge radius from you.
            \featlevel{16} The area increases to a \areahuge radius from you.
        \end{freeability}

        \ff[7]{Mesmerizing Performance}[Magical] You can use the \textit{mesmerizing performance} ability as a standard action.
        \begin{freeability}{Mesmerizing Performance}[\glossterm{Emotion}, \glossterm{Sustain} (minor)]
            \targets{Up to five creatures within \rngmed range}
            You begin a performance using one of your Perform skills.
            Make an attack vs. Mental against each target.
            Your accuracy is equal to the Perform skill used for your performance.
            ...
            \rankline
            \featlevel{13} You may target up to ten creatures within range.
            \featlevel{19} You may target any number of creatures within range.
        \end{freeability}

        \ff[10]{Greater Specialization} The bonus from your \textit{specialization} ability increases to \plus6.

        \ff[13]{Discordant Cacaphony}[Magical] You can use the \textit{discordant cacaphony} ability as a standard action.
        \begin{freeability}{Discordant Cacaphony}
            \targets{\glossterm{Enemies} within a \areamed radius from you}
            You begin a performance using one of your Perform skills.
            Make an attack vs. Mental against each target.
            Your accuracy is equal to the Perform skill used for your performance.
            \hit If this performance has the \glossterm{Auditory} tag, each target takes energy \glossterm{standard damage}.
            Otherwise, each target is \glossterm{dazed}.
            \crit As above.

            This ability may have the \glossterm{Auditory} or \glossterm{Visual} tags, depending on the nature of your performance.

            \rankline
            \featlevel{19} The area increases to a \arealarge radius.
        \end{freeability}
    ...
    \begin{feat}{Spellsword}{Spell}
        ...
        \begin{freeability}{Imbued Blow}[\glossterm{Magical}]
            Make a melee \glossterm{magical strike} with a \plus1 bonus to \glossterm{accuracy}.
        ...
        When you do, you reduce your \glossterm{focus penalty} by 1.
    ...
    \begin{feat}{Sphere Focus: Aeromancy}{Casting, Magical}
        ...
        \ff[13]{Favorable Winds} You gain a \plus2 \glossterm{magic bonus} to accuracy with ranged \glossterm{strikes}.
    ...
    \begin{feat}{Sphere Focus: Electromancy}{Casting, Magical}
        ...
        \ff[13]{Greater Lingering Shock} Your \textit{lingering shock} ability makes the target \glossterm{stunned} instead of \glossterm{dazed}.
    ...
    \begin{feat}{Sphere Focus: Revelation}{Casting, Magical}
        ...
        \ff[1]{Revelation Focus} You gain a \plus1 bonus to \glossterm{accuracy} with abilities from the \sphere{telekinesis} \glossterm{mystic sphere}.

        \ff[4]{Truthsense} You gain a \plus2 \glossterm{magic bonus} to all Knowledge skills and the Sense Motive skill.
    ...
    \begin{feat}{Sphere Focus: Terramancy}{Casting, Magical}
        ...
        \ff[13]{Greater Heart of Stone} You gain a \plus1 bonus to \glossterm{wound rolls}.
    ...
    \begin{feat}{Sphere Focus: Weaponcraft}{Casting, Magical}
        ...
        \ff[10]{Greater Personal Weapon} When attacking with a weapon created with the \spell{personal weapon} \glossterm{cantrip}, you gain a \plus1 bonus to \glossterm{accuracy}.
        ...
        \ff[19]{Supreme Personal Weapon} The accuracy bonus from your \textit{greater personal weapon} increases to \plus2.
    \end{feat}
