...
\end{longtablewrapper}
    ...
    \begin{feat}{Null}{General}
        ...
        Instead, each time you would gain a legacy item upgrade, you instead reduce your \glossterm{fatigue penalties} by 1 and increase the number of times you can use the \textit{recover} ability between \glossterm{short rests} by 1 (see \pcref{Recover}).
