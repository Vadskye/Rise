...
\end{longtablewrapper}
    ...
    \begin{feat}{Celestial Heritage}{Bloodline, Magical}
        ...
        \ff[15]{Greater Healing Light} You add half your \glossterm{power} to the healing from your \textit{healing light} ability.
    ...
    \begin{feat}{Sphere Focus: Thaumaturgy}{Casting, Magical}
        ...
        If you successfully counter a spell with that ability after using it as a minor action, you increase your \glossterm{fatigue level} by one.
    \end{feat}
