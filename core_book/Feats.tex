...
\end{longtabuwrapper}
    ...
    \begin{feat}{Creature Handling Specialization}{Skill}
        ...
        \begin{itemize}
            \item It gains a bonus equal to its level to its \glossterm{wound threshold}.
        ...
        \begin{itemize}
            \item It gains a bonus equal to twice its level to its \glossterm{wound threshold}.
    ...
    \begin{feat}{Executioner}{Combat}
        ...
        \ff[1]{Blood Sense}[Magical] You automatically know the location of all living creatures with a \glossterm{vital wound} within 50 feet of you, regardless of concealment or invisibility.
        ...
        \begin{apability}{Execution}
            Make a \glossterm{strike}.
            You gain a \plus3d bonus to damage on the strike.
            % TODO: wording?
            If the strike does not beat the target's \glossterm{wound threshold}, the target takes no damage.
        \end{apability}

        \ff[7]{Purge the Weak} You gain a \plus1 bonus to \glossterm{accuracy} against creatures with a \glossterm{vital wound}.

        \ff[10]{Greater Blood Sense}[Magical] Your \textit{blood sense} ability allows you to know the location of all living creatures within range, not just living creatures with a \glossterm{vital wound}.
        You can automatically identify which of those creatures have a \glossterm{vital wound}.
    ...
    \begin{feat}{Leadership}{Combat}
        ...
        \begin{freeability}{Battle Command}[\glossterm{Swift}]
            ...
            If the target makes a \glossterm{strike} during the current phase, it can roll the \glossterm{attack roll} twice and take the higher result.
        \end{freeability}
        ...
        \begin{apability}{Bolster}[\glossterm{Emotion}]
            ...
            Each target may either remove one point of \glossterm{fatigue} or remove one \glossterm{condition} of its choice.
        \end{apability}

        \ff[7]{Commanding Presence} You gain a \plus2 bonus to the Intimidate and Persuasion skills.

        \ff[10]{Greater Bolster} The area affected by your \textit{bolster} ability increases to an \arealarge radius burst from you.
        ...
        \ff[13]{War Leader} Each creature within an \areamed emanation from you may use your level in place of its \glossterm{accuracy} with \glossterm{strikes}.

        \ff[16]{Supreme Bolster} Each target affected by your \textit{bolster} ability can both remove a point of \glossterm{fatigue} and remove a \glossterm{condition}.

        \ff[16]{Supreme Battle Command} The accuracy bonus from your \textit{greater battle command} ability increases to \plus2.

        \ff[19]{Greater War Leader} The area affected by your \textit{war leader} ability increases to a \areahuge radius.
    \end{feat}
    ...
    \begin{feat}{Sphere Focus: Fabrication}{Casting, Magical}
        ...
        In addition, any objects you create with abilities from the \sphere{fabrication} \glossterm{mystic sphere} gain a bonus equal to your \glossterm{power} to their \glossterm{wound threshold}.
        ...
        In addition, the \glossterm{wound threshold} bonus increases to twice your \glossterm{power}.
    ...
    \begin{feat}{Sphere Focus: Polymorph}{Casting, Magical}
        ...
        \ff[10]{Personal Regeneration} At the end of each \glossterm{action phase}, if you did not gain any \glossterm{fatigue} that phase, you remove a point of \glossterm{fatigue}.
    ...
    \begin{feat}{Sphere Focus: Summon}{Casting, Magical}
        ...
        \ff[4]{Fortified Summons} Creatures you create with abilities from the \sphere{summon} spell gain a bonus equal to your \glossterm{power} to their \glossterm{wound threshold}.
    ...
    \begin{feat}{Sphere Focus: Vital Surge}{Casting, Magical}
        ...
        \ff[4]{Reciprocal Healing} When you cause another creature to remove at least one point of \glossterm{fatigue} with a spell from the \sphere{vital surge} \glossterm{mystic sphere}, you also remove a point of \glossterm{fatigue}.
        ...
        \ff[10]{Personal Vitality} At the end of each \glossterm{action phase}, if you have at least three points of \glossterm{fatigue}, you remove a point of \glossterm{fatigue}.
