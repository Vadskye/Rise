...
\end{longtabuwrapper}
    ...
    \begin{feat}{Heal Specialization}{Skill}
        ...
        \ff[7]{Vital Healing Touch}[Magical] For every five points of healing you would restore with your \textit{healing touch} ability, you can instead heal a point of \glossterm{vital damage}.
        ...
        \ff[13]{Greater Healing Touch} You gain a \plus1d bonus to healing with your \textit{healing touch} ability.

        \ff[13]{Lifesaver} You can use the \textit{first aid} ability as a \glossterm{minor action} (see \pcref{First Aid}).

        \ff[16]{Supreme Specialization} The bonus from your \textit{specialization} ability increases to \plus6.

        \ff[19]{Greater Vital Healing Touch} For every two points of healing you would restore with your \textit{healing touch} ability, you can instead heal a point of \glossterm{vital damage}.
    \end{feat}
    ...
    \begin{feat}{Miscaster}{Casting, Magical}
        ...
        \ff[10]{Toughened Body} You gain additional hit points equal to your level.
    ...
    \begin{feat}{Null}{General}
        ...
        \ff[4]{Legendary Legacy} You do not gain any legacy item upgrades (see \pcref{Legacy Items}).
        Instead, each time you would gain a legacy item upgrade, you instead increase your minimum \glossterm{legend points} at the start of each session.
    ...
    \begin{feat}{Persuasion Specialization}{Skill}
        ...
        \ff[19]{Greater Suggestion} When you use your \textit{suggestion} ability, you may target any number of creatures within a \areamed radius within range.
    \end{feat}
    ...
    \begin{feat}{Sleight of Hand Specialization}{Skill}
        ...
        \ff[13]{Extradimensional Concealment}[Magical] When you use the \textit{conceal object} ability, you can use the \textit{extradimensional pocket} ability.
        \begin{ability}{Extradimensional Pocket}[\glossterm{Attune} (self), \glossterm{Magical}]
    ...
    \begin{feat}{Sniper}{Combat}
        ...
        \ff[19]{Greater Sniper Shot} The bonus from your \textit{sniper shot} ability increases to \plus8.
    \end{feat}
    ...
    \begin{feat}{Sphere Focus: Summon}{Casting, Magical}
        ...
        \ff[10]{Augmented Summons} Creatures you create with abilities from the \sphere{summon} spell gain an \glossterm{action point}.
    ...
    \begin{feat}{Sphere Focus: Thaumaturgy}{Casting, Magical}
        ...
        \ff[13]{Greater Counterspell} When you use your \textit{counterspell} ability, you can target two creatures instead of one.
