...
\section{Gaining Feats}
    ...
    \subsection{Species Bonus Feats}\label{Species Bonus Feats}
        ...
        \subsubsection{Uncommon Species}
            ...
            \parhead{Eladrin} Boongiver, Chameleon, Combat Style Versatility, Deception Specialization, Persuasion Specialization, or Spellwarped.

            \parhead{Kit} Skill Specialization: Balance, Skill Specialization: Deception, Skill Specialization: Social Insight, Skill Specialization: Stealth, Swiftrunner.

            \parhead{Naiadi} Boongiver, Leadership, Mental Magic, Perform Specialization, Persuasion Specialization, Sphere Focus: Aquamancy, or Swim Specialization.

            \parhead{Orc} Intimidate Specialization, Toughness, or any Combat feat (see \pcref{Combat Feats}).

            \parhead{Oozeborn} Blindfighter, Chameleon, Climb Specialization, Flexibility Specialization, Juggernaut, Regenerator, Sphere Focus: Toxicology, Toughness,

            \parhead{Tiefling} \featref*{Deception Specialization}, \featref*{Executioner}, \featref*{Intimidate Specialization}, \featref*{Spellwarped}, or \featref*{Sphere Focus: Pyromancy}.
...
\end{longtablewrapper}
    ...
    \begin{feat}{Awareness Specialization}{Skill}
        ...
        \ff[3]{Extraordinary Senses} You gain one of the following senses: \stdability{blindsense} (30 ft.), \stdability{darkvision} (60 ft.), \stdability{low-light vision}, \glossterm{scent}, or \stdability{tremorsense} (30 ft.).
        ...
        \ff[12]{Greater Extraordinary Senses} You gain one of the following senses: \stdability{blindsense} (120 ft.), \stdability{blindsight} (30 ft.), \stdability{darkvision} (240 ft.), \stdability{tremorsense} (120 ft.), or \stdability{tremorsight} (30 ft.).
    ...
    \begin{feat}{Battle Armory}{Combat}
        ...
        \ff[1]{Swift Draw} Sheathing and drawing weapons becomes a \glossterm{Swift} ability for you, so you can draw a weapon and attack with it in the same phase.
    ...
    \begin{feat}{Blindfighter}{Combat}
        ...
        \ff[1]{Blind Awareness} When you make an attack with a miss chance, you can roll the miss chance twice and take the better result.
        In addition, you are not \partiallyunaware against foes if you know their location.

        \ff[3]{Blindsense} You gain \stdability{blindsense} with a 60 foot range, allowing you to sense your surroundings without light (see \pcref{Blindsense}).
    ...
    \begin{feat}{Blood Magic}{Casting, Magical}
        \featpre Access to a \glossterm{mystic sphere}, base Constitution of 2.
    ...
    \begin{feat}{Boongiver}{Casting, Magical}
        ...
        \begin{instantability}{Benevolent Transferance}
            Choose an \glossterm{ally} currently \glossterm{attuned} to a spell you cast.
            In addition, choose another \glossterm{ally} to transfer the spell to.
            ...
            If the new target spends an \glossterm{attunement point} to attune to the spell, the spell's effect is transferred from the first target to the second.
            The spell's old target immediately regains the \glossterm{attunement point} it spent to attune to the spell.
        \end{instantability}

        \ff[9]{Replace Attunement} You can use the \textit{replace attunement} ability as a \glossterm{standard action}.
        \begin{instantability}{Replace Attunement}
            Choose an \glossterm{ally} currently \glossterm{attuned} to a spell you cast.
            % TODO: specify casting time if there exist any longer casting time spells
            You may cast another \abilitytag{Attune} (target) spell on that ally as part of this action.
            If you do, it stops being attuned to the previous spell and becomes attuned to the new spell without spending or regaining any \glossterm{attunement points}.
            After you use this ability, you \glossterm{briefly} cannot use it again.
        \end{instantability}
        ...
        \ff[18]{Expert Boon Manipulation} You can use your \textit{benevolent transferance} ability as a \glossterm{minor action}.
    ...
    \begin{feat}{Celestial Heritage}{Bloodline, Magical}
        ...
        \begin{freeability}{Holy Smite}[Magical]
            ...
            \rankline
            \featlevel{6} The damage bonus increases to \plus4.
            \featlevel{12} The damage bonus increases to \plus8.
            \featlevel{18} The damage bonus increases to \plus16.
        \end{freeability}
    ...
    \begin{feat}{Chameleon}{General}
        ...
        \begin{itemize}
            \item Martial: The power bonus increases to \plus4.
        ...
        \begin{itemize}
            \item Martial: The defense bonus increases to \plus2, and the power bonus increases to \plus8.
    ...
    \begin{feat}{Duelist}{Combat}
        ...
        \ff[3]{Defensive Stance} You gain a \plus1 bonus to your Armor defense as long as you wield a melee weapon.
    ...
    \begin{feat}{Endurance Specialization}{Skill}
        ...
        When you use the \textit{delay vital wound} ability, the \glossterm{difficulty value} does not increase for each subsequent round (see \pcref{Delay Vital Wound}).
    ...
    \begin{feat}{Flexibility Specialization}{Skill}
        ...
        \begin{freeability}{Escape Magic}
            ...
            The \glossterm{difficulty value} for each effect is equal to 10 \add the effect's \glossterm{power}.
    ...
    \begin{feat}{Ghostblade}{Combat, Magical}
        ...
        \ff[1]{Ghost Step} When you use the \textit{sprint} ability, you can become \glossterm{invisible} for the duration of the movement (see \pcref{Sprint}).
        ...
        If you chose body armor or a shield, you are \glossterm{impervious} to cold damage.
        ...
        \begin{durationability}{Spectral Strike}
            ...
            \rankline
            \featlevel{12} Each subject is no longer immune to being slowed after the first successful slow effect.
            \featlevel{18} The slowing effect becomes a \glossterm{condition} instead of a brief effect.
        \end{durationability}

        \ff[9]{Greater Ghost Step} When you use your \textit{ghost step} ability, you can also become \glossterm{incorporeal} for the duration of the movement.
        ...
        \begin{durationability}{Spectral Reap}
            ...
            For the duration of the movement, you can move through creatures and objects as if you were \glossterm{incorporeal}, but you do not gain the defensive benefits of being incorporeal during this phase.
        ...
        If you chose a weapon, whenever you make a \glossterm{strike}, you can make the strike against each subject's Reflex defense in place of its Armor defense.
    ...
    \begin{feat}{Intimidate Specialization}{Skill}
        ...
        \ff[6]{Threatening Presence} Creatures that are shaken, frightened, or panicked by you suffer the full penalties for those conditions as long as they are within \distrange of you instead of the normal \medrange limit.
        ...
        \ff[18]{Greater Threatening Presence} Creatures that are suffering penalties for being shaken, frightened, or panicked by you also take a \minus2 penalty to all defenses in addition to the normal penalties.
    ...
    \begin{feat}{Iron Will}{General}
        ...
        \ff[15]{Greater Unclouded Mind} You are immune to being \confused.
    ...
    \begin{feat}{Jump Specialization}{Skill}
        ...
        \ff[3]{Instant Leap} You are always considered to have a running start when jumping (see \pcref{Running Start}).
    ...
    \begin{feat}{Knowledge Specialization}{Skill}
        ...
        \ff[12]{Greater Knowledge Savant} The number of extra trained skills from your \textit{knowledge savant} ability increases to four.
    ...
    \begin{feat}{Leadership}{Combat}
        ...
        \ff[3]{Encouraging Presence} As long as you are conscious, your \glossterm{allies} within a \arealarge \glossterm{emanation} from you are immune to being \shaken and \frightened.

        \ff[6]{Bolster} You can use the \textit{bolster} ability as a standard action.
        \begin{freeability}{Bolster}[\abilitytag{Emotion}]
            One \glossterm{ally} within \medrange can remove a \glossterm{brief} effect or \glossterm{condition}.
        ...
        \ff[12]{Resolute Presence} As long as you are conscious, your \glossterm{allies} within a \arealarge \glossterm{emanation} from you are immune to being \dazed and \stunned.

        \ff[15]{Expansive Presence} The area of your \textit{encouraging presence} and \textit{resolute presence} abilities increases to a \hugearea \glossterm{emanation} from you.

        \ff[18]{Greater Brave Leader} The bonus from your \textit{brave leader} ability increases to \plus3.

        \ff[21]{Unyielding Presence} As long as you are conscious, your \glossterm{allies} within a \areahuge \glossterm{emanation} from you are immune to being \confused, \panicked, and \paralyzed.
    \end{feat}
    ...
    \begin{feat}{Mental Magic}{Casting, Magical}
        ...
        \ff[6]{Potent Mind} You gain a \plus2 bonus to \glossterm{magical} \glossterm{power}.
    ...
    \begin{feat}{Metacaster}{Casting, Magical}
        \featpre Access to a \glossterm{mystic sphere}, base Intelligence of 1.
        ...
        \begin{dtable}
            ...
            \begin{dtabularx}{\columnwidth}{l >{\lcol}X}
                ...
                1 & Dazed, dazzled, goaded (by you), shaken (by you), slowed \\
    ...
    \begin{feat}{Mystic Archer}{Casting}
        ...
        When you do, you use your \glossterm{power} with magical abilities to determine your damage.
    ...
    \begin{feat}{Precognition}{General}
        ...
        \ff[1]{Precognitive Offense} You can use your Intelligence in place of your Perception to determine your \glossterm{initiative} and your \glossterm{accuracy} with \glossterm{mundane} abilities.

        \ff[3]{Combat Prediction} You can use the \textit{combat prediction} ability as a standard action.
        \begin{freeability}{Combat Prediction}[\abilitytag{Subtle}, \abilitytag{Sustain} (free)]
    ...
    \begin{feat}{Prepared Spellcasting}{Magical, Spell}
        \featpre Access to a \glossterm{mystic sphere}, base Intelligence of 2.
        ...
        \ff[6]{Study of Magic} You gain a \plus2 bonus to your \glossterm{magical} \glossterm{power}.
        ...
        \ff[21]{Greater Expanded Spellbook} You can choose up to seven spells to be in your spellbook instead of only three.
    \end{feat}
    ...
    \begin{feat}{Shieldbearer}{Combat}
        ...
        \ff[1]{Forceful Block} Whenever a creature misses you with a melee \glossterm{strike}, if you are wielding a shield, that creature \glossterm{briefly} takes a \minus1 penalty to Armor defense.
    ...
    \begin{feat}{Sniper}{Combat}
        ...
        \begin{freeability}{Aim}[\abilitytag{Sustain} (minor)]
    ...
    \begin{feat}{Spellsword}{Magical, Spell}
        ...
        \ff[1]{Magical Strikes}[\abilitytag{Magical}] Whenever you make a melee \glossterm{strike}, you can choose to treat that as a \glossterm{magical} ability.
        When you do, you use your \glossterm{power} with magical abilities to determine your damage.
        ...
        \ff[9]{Personal Enhancement} You gain a \plus6 \glossterm{magic bonus} to \glossterm{hit points} and \glossterm{damage resistance}, and a \plus3 \glossterm{magic bonus} to \glossterm{power}.
        ...
        \ff[15]{Greater Personal Enhancement} The bonuses to hit points and damage resistance from your \textit{personal enhancement} ability increase to \plus12.
        In addition, the bonus to power increases to \plus6.
        ...
        \ff[21]{Supreme Personal Enhancement} The bonuses to hit points and damage resistance from your \textit{personal enhancement} ability increase to \plus24.
        In addition, the bonus to power increases to \plus12.
    ...
    \begin{feat}{Sphere Focus: Barrier}{Casting, Magical}
        ...
        \ff[3]{Innate Shield} You gain a \plus1 bonus to your Armor defense.
    ...
    \begin{feat}{Sphere Focus: Bless}{Casting, Magical}
        ...
        \ff[6]{Sustained Blessing} Whenever you cast a spell from the \sphere{Bless} mystic sphere with the \abilitytag{Attune} (self) tag, you can choose to replace that tag with the \abilitytag{Sustain} (minor) tag.
    ...
    \begin{feat}{Sphere Focus: Channel Divinity}{Casting, Magical}
        ...
        \ff[6]{Font of Divinity} Choose a spell with the \glossterm{Attune} (self) tag from the \sphere{channel divinity} mystic sphere.
    ...
    \begin{feat}{Sphere Focus: Enchantment}{Casting, Magical}
        ...
        In addition, the \glossterm{difficulty value} to observe the effects of your \abilitytag{Emotion} abilities with the Social Insight skill increases by 10.
    ...
    \begin{feat}{Sphere Focus: Fabrication}{Casting, Magical}
        ...
        You can cast it with the \abilitytag{Sustain} (minor) tag instead of the \abilitytag{Attune} (self) tag.
        In addition, you can use your \glossterm{magical} \glossterm{power} in place of your Craft skill to create items with spells from the \sphere{Fabrication} mystic sphere.

        \ff[6]{Greater Forge} You learn the \spell{forge} spell from the Fabrication mystic sphere.
        In addition, you can cast that spell with the \abilitytag{Sustain} (minor) tag instead of the \glossterm{Attune} (self) tag.
    ...
    \begin{feat}{Sphere Focus: Photomancy}{Casting, Magical}
        ...
        In addition, you gain \stdability{low-light vision}, allowing you to see clearly in \glossterm{shadowy illumination} (see \pcref{Low-light Vision}).
    ...
    \begin{feat}{Sphere Focus: Polymorph}{Casting, Magical}
        ...
        \begin{freeability}{Alter Poison}[\glossterm{Shaping}]
    ...
    \begin{feat}{Sphere Focus: Revelation}{Casting, Magical}
        ...
        \ff[6]{Blindsense} You gain \stdability{blindsense} with a 60 foot range (see \pcref{Blindsense}).
        ...
        \ff[18]{Blindsight} The range of your \stdability{blindsense} ability increases by 90 feet.
        In addition, you gain \stdability{blindsight} with a 30 foot range.
    ...
    \begin{feat}{Sphere Focus: Toxicology}{Casting, Magical}
        ...
        \ff[21]{Greater Innate Venom} When you transfer a poison dose with your \textit{innate venom} ability, the subject immediately suffers the penalties for the initial poison stage.
    \end{feat}
    ...
    \begin{feat}{Sphere Focus: Umbramancy}{Casting, Magical}
        ...
        \ff[6]{Darkvision} You gain \stdability{darkvision} with a 60 foot range, allowing you to see in complete darkness (see \pcref{Darkvision}).
        ...
        \ff[18]{Darksight} The range of your \stdability{darkvision} increases by 240 feet.
    ...
    \begin{feat}{Swim Specialization}{Skill}
        ...
        \ff[6]{Swimming Blitz} You can use the \textit{sprint} ability without increasing your \glossterm{fatigue level} if you swim for the entire duration of the movement.
        After you use this ability, you \glossterm{briefly} cannot use it again.
    ...
    \begin{feat}{Telepath}{General, Magical}
        ...
        \begin{durationability}{Mental Assault}
            ...
            \hit As a \glossterm{condition}, the subject is \dazed while it has any \glossterm{damage resistance} remaining, and \stunned while it does not.
        ...
        \begin{durationability}{Read Mind}
            ...
            Whether you hit or miss, you cannot attack the subject with this ability again until it takes a \glossterm{short rest}.
        ...
        Unlike abilities like \stdability{blindsense}, the Stealth skill does not prevent you from learning the location of creatures in this way.
        ...
        Unlike abilities like \stdability{blindsight}, the Stealth skill does not prevent you from seeing creatures in this way.
    ...
    \begin{feat}{Toughness}{General}
        ...
        \ff[6]{Ailment Tolerance} You are immune to poisons and diseases.
        ...
        \ff[15]{Greater Ailment Tolerance} You are immune to being \paralyzed.
    ...
    \begin{feat}{Whirlwind Warrior}{Combat}
        ...
        \ff[9]{Eye of the Storm} You reduce your penalties for \glossterm{squeezing} with other creatures by 1, and your movement speed is not reduced while squeezing with other creatures.
