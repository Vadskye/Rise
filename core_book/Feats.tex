...
\end{longtablewrapper}
    ...
    \begin{feat}{Metacaster}{Casting, Magical}
        ...
        \begin{dtable}
            ...
            \begin{dtabularx}{\columnwidth}{l >{\lcol}X}
                ...
                2 & Decelerated, frightened (by you), stunned \\
    ...
    \begin{feat}{Persuasion Specialization}{Skill}
        ...
        \begin{freeability}{Compel Attention}[\abilitytag{Auditory}, \abilitytag{Compulsion}, \abilitytag{Sustain} (minor), \abilitytag{Subtle}]
            ...
            It takes a \minus20 penalty to Awareness and Spellsense checks to observe anything unrelated to your conversation.
    ...
    \begin{feat}{Spellsense Specialization}{Skill}
        ...
        \begin{freeability}{Unweave Magic}
            Make a Spellsense check on one \glossterm{magical} effect within \rngmed range that is sustained or has a specific duration.
            ...
            The \glossterm{difficulty value} is equal to 5 \add the \glossterm{rank} of the effect.
            ...
            \featlevel{18} You can target up to two spell effects within range.
        \end{freeability}
    ...
    \begin{feat}{Sphere Focus: Terramancy}{Casting, Magical}
        ...
        \ff[6]{Earthen Alloys} You may treat iron, steel, and worked stone as if they were earth for the purpose of spells from the \sphere{Terramancy} \glossterm{mystic sphere}.
        ...
        \ff[18]{Greater Earthen Alloys} You may treat sand, glass, and all kinds of metal except for cold iron as if it were earth for the purpose of spells from the \sphere{Terramancy} \glossterm{mystic sphere}.
    ...
    \begin{feat}{Twinhand Spellcaster}{Casting, Magical}
        ...
        \ff[15]{Greater Freehand Implement} You gain an additional \glossterm{attunement point}.
