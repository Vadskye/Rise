...
\end{longtablewrapper}
    ...
    \begin{feat}{Celestial Heritage}{Bloodline, Magical}
        ...
        These wings grant you a \glossterm{fly speed} equal to the \glossterm{base speed} for your size with a maximum height of 30 feet (see \pcref{Flying}).
        ...
        \ff[21]{Angel Wings+} Your \glosserm{maneuverability} with the fly speed from your \textit{angelic flight} ability increases to perfect (see \pcref{Flying Maneuverability}).
    \end{feat}
    ...
    \begin{feat}{Draconic Heritage}{Bloodline}
        ...
        These wings grant you a \glossterm{fly speed} equal to 10 feet faster than the \glossterm{base speed} for your size (see \pcref{Flying}).
    ...
    \begin{feat}{Sphere Focus: Aeromancy}{Casting, Magical}
        ...
        \ff[9]{Airborne} You gain a \glossterm{fly speed} equal to the \glossterm{base speed} for your size with a maximum height of 30 feet (see \pcref{Flying}).
        At the start of each phase, you can increase your \glossterm{fatigue level} by one to ignore this height limit until the end of the round.
    ...
    \begin{feat}{Sphere Focus: Bless}{Casting, Magical}
        ...
        \ff[1]{Shared Boon} When you cast a targeted spell from the \sphere{Bless} mystic sphere that does not have the \abilitytag{Sustain} or \abilitytag{Attune} tags on a single \glossterm{ally}, you can target an additional ally within range.

        \ff[3]{Sustained Blessing} Whenever you cast a spell from the \sphere{Bless} mystic sphere with the \abilitytag{Attune} (target) tag that is not a \glossterm{deep attunement}, you can choose to replace that tag with the \abilitytag{Sustain} (minor) tag.
        ...
        \ff[9]{Intrinsic Blessing} You learn an additional spell with the \abilitytag{Attune} tag from the \sphere{Bless} mystic sphere.
        If that spell is a \glossterm{deep attunement}, you only need to spend one \glossterm{attunement point} to attune to it.
        Otherwise, you can attune to it without spending an \glossterm{attunement point}.
        When you gain access to new spell ranks, you can change which spell you know with this ability.
    ...
    \begin{feat}{Sphere Focus: Chronomancy}{Casting, Magical}
        ...
        \ff[1]{Thief of Time} Whenever you cast a spell from the \sphere{Chronomancy} mystic sphere that deals damage to another creature or causes another creature to be \slowed, you \glossterm{briefly} gain a \plus10 foot bonus to your speed with all of your movement modes.
    ...
    \begin{feat}{Sphere Focus: Telekinesis}{Casting, Magical}
        ...
        \ff[21]{Agile Levitation} You gain a \glossterm{fly speed} equal to the \glossterm{base speed} for your size with a maximum height of 30 feet (see \pcref{Flying}).
        At the start of each phase, you can increase your \glossterm{fatigue level} by one to ignore this height limit until the end of the round.
    \end{feat}
    ...
    \begin{feat}{Sphere Focus: Thaumaturgy}{Casting, Magical}
        ...
        \begin{activeability}{Countermagic}[\abilitytag{Swift}]
            ...
            If the target uses a \glossterm{magical} ability as a standard action this round, you can attempt to counter that ability.
            You and the target each make an opposed level \glossterm{check}.
            ...
            \rankline
            \featlevel{9} You gain a \plus2 bonus to the check.
            \featlevel{15} The bonus increases to \plus4.
            \featlevel{21} The bonus increases to \plus6.
        \end{activeability}
    ...
    \begin{feat}{Sphere Focus: Toxicology}{Casting, Magical}
        ...
        \begin{activeability}{Cleanse Toxins}
            ...
            \featlevel{15} You can use this ability as a \glossterm{minor action}.
            \featlevel{21} You can use this ability as a \glossterm{free action}.
        \end{activeability}
    ...
    \begin{feat}{Telepath}{General, Magical}
        ...
        \ff[21]{Mental Domination} Whenever a creature that is \stunned by your \textit{mental assault} ability reaches 0 hit points, you can \glossterm{attune} to this ability.
