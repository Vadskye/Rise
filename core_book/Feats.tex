...
\begin{longcolumn}
    ...
    \begin{longtable}{>{\lcol}p{13em} >{\lcol}p{10em} l >{\lcol}p{8em} >{\lcol}p{3em}}
        ...
        \featref{Juggernaut}               & Str 1, Con 2        & Shove and overrun foes to deal damage      & \tdash  & \featpref{Juggernaut}               \\
...
\end{longcolumn}
    ...
    \begin{feat}{Ascetic}{General}
        ...
        \ff[1]{Deny Wealth} You cannot knowingly own, consume, or use any item that is individually worth more than 1gp.
    ...
    \begin{magicalfeat}{Barbaric Ancestry}{Ancestry, Magical}
        ...
        \begin{magicalsustainability}{Ancestral Totem}{\abilitytag{Manifestation}, \abilitytag{Sustain} (minor)}
            ...
            Its \glossterm{damage resistance} is equal to half its hit points, ignoring any \glossterm{magic bonuses} to hit points.
    ...
    \begin{feat}{Executioner}{Combat}
        ...
        \ff[6]{Purge the Weak} You gain a \plus1 accuracy bonus against creatures that are \textit{marked for execution}.
        ...
        \magicalff[12]{Blood Sense+} The lifesense range increases by 120 feet.
        ...
        \ff[18]{Purge the Weak+} The accuracy bonus increases to \plus2, and you also explode on an 8.
    \end{feat}

    \begin{feat}{Fateweaver}{General, Magical}
        \featpre Perception 2.

        \magicalff[1]{Inevitable Attack} Whenever you would make an attack roll, you can instead choose to treat the result of your roll as a 5.
        ...
        \begin{magicalactiveability}{Fateseal}
            ...
            Whenever you or one of your \glossterm{allies} make an attack roll against it, the result of the roll cannot be less than a 6.
        ...
        \magicalff[18]{Fated Victory} The fixed results from your \textit{inevitable attack} and \textit{inevitable check} abilities each increase to 7.
    \end{feat}
    ...
    \begin{feat}{Whirlwind Warrior}{Combat}
        ...
        \begin{sustainability}{Cyclone}{\abilitytag{Sustain} (standard)}
            ...
            On a miss with either strike, you still deal half damage.
