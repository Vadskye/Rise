...
\begin{longtabuwrapper}
    \begin{longtabu}{>{\lcol}p{10em} >{\lcol}p{15em} >{\lcol}X >{\lcol}p{8em} >{\lcol}p{3em}}
        ...
        \featref{Expanded Spell Lore} & Any spell & Learn more subspells and augments & \tdash & \featpref{Expanded Spell Lore} \\
...
\end{longtabuwrapper}
    ...
    \begin{feat}{Abjurer}{Magical, Spell}
        ...
        The shielded creature gains a \plus1 bonus to Armor defense as long as the spell lasts.
        ...
        \ff[5]{Personal Shield} You gain a \plus1 bonus to Armor defense.
    ...
    \begin{feat}{Acrobatics Specialization}{Skill}
        ...
        \ff[4]{Agile Fall} You treat all falls as if they were 10 feet shorter than their actual distance for the purpose of determining \glossterm{}.
        ...
        \ff[10]{Air Dancer}[Magical] You can attempt to move on surfaces that cannot support your weight.
        ...
        \ff[14]{Rapid Air Dancer} You can move at full speed with your \textit{air dancer} ability.

        \ff[16]{Supreme Specialization} The bonus from your \textit{specialization} ability increases to \plus6.

        \ff[18]{Persistent Air Dancer} For each round that you spend using your \textit{air dancer} ability, the DR increases by 2 instead of by 5.
    \end{feat}

    \begin{feat}{Agility}{Combat}
        \featpre Starting Dexterity of 2.

        \ff[1]{Dodge Roll} As a \glossterm{standard action}, you can use the \textit{dodge roll} ability.
        \begin{ability}{Dodge Roll}[\glossterm{Swift}]
            You gain a \plus4 bonus to Armor and Reflex defenses until the end of the round.
            In addition, you can move up to half your movement speed.
            This movement resolves at the same time as normal actions during the current phase, rather than at the same time as other \glossterm{Swift} abilities resolve.
        \end{ability}

        \ff[2]{Lightning Reflexes} You gain a \plus2 bonus to Reflex defense.

        \ff[4]{Rapid Reaction} You gain a \plus2 bonus to \glossterm{initiative} checks.

        \ff[6]{Mobile Dodge} If you move at least ten feet during a single phase, you gain a \plus1 bonus to Armor defense until the end of the round.
        Teleportation, being thrown, and other special movement effects do not grant you this bonus.

        \ff[8]{Whirlwind Dodge} When you use your \textit{dodge roll} ability, you also do not suffer \glossterm{overwhelm penalties} until the end of the round.
        ...
        \ff[14]{Tumble} When you use your \textit{dodge roll} ability, you can move through space occupied by other creatures.

        \ff[16]{Supreme Rapid Reaction} The bonus to initiative from your \textit{rapid reaction} ability increases to \plus10.
    ...
    \begin{feat}{All Energy Becomes One}{Class, Magical}
        ...
        \ff[13]{Greater Resist Energy} The damage reduction from your \textit{resist energy} ability increases to be equal to twice your \textit{ki power}.
    ...
    \begin{feat}{Awareness Specialization}{Skill}
        ...
        \ff[4]{Broad Search} When you use the \textit{search} ability, you can search a 10-ft.\ square within 30 feet of you (see \pcref{Search}).
        ...
        \ff[12]{Greater Broad Search} When you use the \textit{search} ability, you can search all spaces within 30 feet of you (see \pcref{Search}).
    ...
    \begin{feat}{Bardic Exemplar}{Magical, Skill}
        ...
        \ff[3]{Vicious Mockery} As a standard action, you can spend an \glossterm{action point} to use the \textit{vicious mockery} ability.
        ...
        \ff[7]{Greater Inspire Courage} Each target affected by your \textit{inspire courage} ability is immune to \glossterm{Fear} abilities.

        \ff[9]{Greater Vicious Mockery} Your \textit{vicious mockery} ability gains the \glossterm{Sustain} (minor) tag.
        ...
        \ff[11]{Greater Song of Serenity} When you use your \textit{song of serenity} ability, you can target up to five creatures.

        \ff[13]{Supreme Inspire Courage} A creature affected by your \textit{inspire courage} ability may use your level in place of its accuracy with any attack.

        \ff[15]{Supreme Mocking Performance} The penalties from your \textit{vicious mockery} ability increase to \minus2 accuracy and a \minus4 penalty to Mental defense.

        \ff[17]{Supreme Song of Serenity} Each target affected by your \textit{song of serenity} is immune to being \glossterm{bloodied} as long as it has hit points remaining.
        This can prevent the target from becoming \glossterm{staggered}.
        When the effect ends, or if a target has no hit points remaining, it becomes bloodied and staggered appropriately.

        \ff[19]{Hybrid Performance} You can sustain two different \glossterm{magical} abilities from this feat or the Perform Specialization feat as part of the same \glossterm{minor action}.
    \end{feat}
    ...
    \begin{feat}{Bluff Specialization}{Skill}
        ...
        \ff[10]{Dual Speech}[Magical] Whenever you speak, you can spend an \glossterm{action point} to use the \textit{dual speech} ability.
    ...
    \begin{feat}{Celestial Heritage}{Bloodline, Magical}
        ...
        \begin{ability}{Holy Blessing}[\glossterm{Attune} (shared)]
            ...
            This ability does not stack with the \spell{bless} spell.
        \end{ability}

        \ff[3]{Holy Protection} As a standard action, you can spend an \glossterm{action point} to use the \textit{holy protection} ability.
        ...
        You can use these wings to glide at a rate equal to your \glossterm{base speed} (see \pcref{Gliding}).
        The wings themselves are \glossterm{mundane}, but the ability to glide and fly with them is \glossterm{magical}.

        \ff[7]{Greater Holy Blessing} The damage bonus from your \textit{holy blessing} ability applies to all abilities that deal damage or grant healing measured in dice.

        \ff[9]{Greater Holy Protection} The damage reduction from your \textit{holy protection} ability also applies against non-physical effects.

        \ff[11]{Angelic Flight} Your \textit{angel wings} grant you a fly speed equal to your \glossterm{base speed}, allowing you to fly (see \pcref{Flying}).
        ...
        \ff[13]{Supreme Holy Blessing} The damage bonus from your \textit{holy blessing} ability increases to \plus2d.

        \ff[15]{Holy Retribution} Whenever an evil creature makes a \glossterm{strike} against the target of your \textit{holy protection} ability, you make a \textit{celestial power} vs. Mental attack against the attacking creature.
        \hit The attacker takes divine \glossterm{standard damage} \minus1d.

        \ff[17]{Greater Angelic Flight} You no longer have a limit on how long you can fly with your \textit{angelic flight} ability.

        \ff[19]{Holy Champion} You gain a \plus2 bonus to your \textit{celestial power}.
    \end{feat}
    ...
    \begin{feat}{Climb Specialization}{Skill}
        ...
        \ff[10]{Greater Climb Speed} Your climb speed increases to be equal to your \glossterm{base speed}.
    ...
    \begin{feat}{Conjurer}{Magical, Spell}
        ...
        \ff[3]{Resummon} As a \glossterm{minor action}, you can spend an \glossterm{action point} to use the \textit{resummon} ability.
        \begin{ability}{Resummon}
            You may teleport any number of creatures or objects that you summoned with \glossterm{Summoning} abilities into unoccupied spaces on stable ground within \rngclose range of you.
        \end{ability}

        % This isn't meaningful as long as spells don't have cover anyway
        ...
        \ff[7]{Regenerating Manifestations} Whenever you cast a spell, objects and creatures you have created with \glossterm{Manifestation} abilities heal hit points equal to your spellpower.

        \ff[9]{Remanifest} As a \glossterm{minor action}, you can spend an \glossterm{action point} to use the \textit{remanifest} ability.
        \begin{ability}{Remanifest}
            You may teleport one object that you created with a \glossterm{Manifestation} ability into unoccupied space on stable ground within \rngclose range of you.
        \end{ability}

        \ff[11]{Greater Astral Spell Transit} You double the range of all spells you cast.
        ...
        \ff[15]{Extended Relocation} The range of your \textit{resummon} and \textit{remanifest} abilities increases to \rnglong.

        \ff[17]{Supreme Astral Spell Transit} When determining whether you have \glossterm{line of effect} to a particular location with a spell, you can ignore all physical obstacles in a single five-foot span.
        This can allow you to cast spells through solid walls, though it does not grant you the ability to see through the wall.

        \ff[19]{Greater Fortified Manifestation} The hit point bonus from your \textit{fortified manifestation} ability increases to twice your spellpower, and the damage bonus increases to \plus2d.
    \end{feat}
    ...
    \begin{feat}{Craft Specialization}{Skill}
        ...
        \ff[8]{Greater Specialization} The bonus to Crafrom your \textit{specialization} ability increases to \plus4.

        \ff[10]{Rapid Creation} Crafting magic items takes you one hour per 500 gp of material components.

        \ff[12]{Greater Crafting Savant} The number of extra skill points from your \textit{crafting savant} ability increases to four.

        \ff[14]{Rapid Creation} Crafting magic items takes you one hour per 2,500 gp of material components.

        \ff[16]{Supreme Specialization} The bonus to Crafrom your \textit{specialization} ability increases to \plus6.
    ...
    \begin{feat}{Creature Handling Specialization}{Skill}
        ...
        \ff[8]{Greater Specialization} The bonus to Creatufrom your \textit{specialization} ability increases to \plus4.
        ...
        \ff[16]{Supreme Specialization} The bonus to Creatufrom your \textit{specialization} ability increases to \plus6.
    ...
    \begin{feat}{Disguise Specialization}{Skill}
        ...
        \ff[10]{Disguise Size}[Magical] As a \glossterm{standard action}, you can spend an action point to use the \textit{disguise size} ability.
    ...
    \begin{feat}{Draconic Heritage}{Bloodline}
        ...
        \ff[6]{Breath Weapon} As a \glossterm{standard action}, you can spend an \glossterm{action point} to use the \textit{breath weapon} ability.
        ...
        As a standard action, you can use your draconic wings to fly with a \glossterm{fly speed} equal to your \glossterm{base speed}.
        ...
        \ff[18]{Greater Draconic Flight}[Magical] You gain a fly speed equal to your \glossterm{base speed}.
    \end{feat}
    ...
    \begin{feat}{Duelist}{Combat}
        ...
        \ff[2]{Duel Expertise} You gain a \plus2 bonus to \glossterm{accuracy} with the \textit{disarm} and \textit{feint} abilities (see \pcref{Disarm}, and \pcref{Feint}).

        \ff[4]{Parry} You gain a \plus1 bonus to Armor defense as long as you are not \glossterm{threatened} by more than one creature.

        \ff[6]{Greater Focused Strike} You gain a \plus1 bonus to \glossterm{accuracy} with your \textit{focused strike} ability.

        \ff[8]{Greater Duel Expertise} The accuracy bonus from your \textit{duel expertise} ability increases to \plus3. 

        \ff[10]{Riposte} You gain a \plus1d bonus to damage as long as you are not \glossterm{threatened} by more than one creature.

        \ff[12]{Supreme Focused Strike} The accuracy bonus from your \textit{greater focused strike} ability increases to \plus2.

        \ff[14]{Supreme Duel Expertise} The accuracy bonus from your \textit{duel expertise} ability increases to \plus4. 

        \ff[16]{Greater Parry} The bonus from your \textit{parry} ability increases to \plus2.
    ...
    \begin{feat}{Eldritch Knight}{Spell}
        ...
        \ff[1]{Lesser Armor Tolerance} You reduce your \glossterm{encumbrance} from \glossterm{armor} by 1.

        \ff[2]{Spellstrike}[Magical] As a standard action during the \glossterm{action phase}, you can spend an \glossterm{action point} to use the \textit{spellstrike} ability.
        ...
        \ff[6]{Armor Tolerance} The reduction of \glossterm{encumbrance} increases to 2.
        ...
        \ff[16]{Greater Armor Tolerance} The reduction of \glossterm{encumbrance} increases to 3.
    ...
    \begin{feat}{Enchanter}{Magical, Spell}
        ...
        \ff[19]{Mental Torment} Whenever you target a creature with a Mind ability, you may have that creature take a \minus1 penalty to Mental defense.
    ...
    \begin{feat}{Escape Artist Specialization}{Skill}
        ...
        \ff[6]{Accelerated Squeeze} You can use the \textit{tight squeeze} ability as a move action.

        \ff[8]{Greater Specialization} The bonus to Escafrom your \textit{specialization} ability increases to \plus4.

        \ff[10]{Escape Magic}[Magical] As a standard action, you can spend an \glossterm{action point} to use the \textit{escape magic} ability.
        ...
        \ff[16]{Supreme Specialization} The bonus to Escafrom your \textit{specialization} ability increases to \plus6.

        \ff[18]{Greater Escape Magic}[Magical] You can use your \textit{escape magic} ability as a \glossterm{minor action}.
    \end{feat}

    \begin{feat}{Expanded Spell Lore}{Spell}
        \featpre Any spell known.

        \ff[1]{Spell Knowledge} You learn an additional spell from any \glossterm{magic source} you have access to.

        \ff[3]{Rituals} You gain the ability to cast \glossterm{rituals} from any single \glossterm{magic source} you have access to.
        If you could already perform rituals from that source, you learn an additional 1st level ritual from that source instead.

        \ff[5]{Subspell Knowledge} You learn an additional \glossterm{subspell} from any spell you know.

        \ff[7]{Spell Knowledge} You learn an additional spell from any \glossterm{magic source} you have access to.

        \ff[9]{Subspell Knowledge} You learn an additional \glossterm{subspell} from any spell you know.

        \ff[11]{Augment Knowledge} You learn an additional \glossterm{augment} (see \pcref{Augments}).

        \ff[13]{Subspell Knowledge} You learn an additional \glossterm{subspell} from any spell you know.

        \ff[15]{Ritual Mastery} You can scribe rituals for half the normal cost.

        \ff[17]{Subspell Knowledge} You learn an additional \glossterm{subspell} from any spell you know.

        \ff[19]{Augment Knowledge} You learn an additional \glossterm{augment} (see \pcref{Augments}).
    ...
    \begin{feat}{Evoker}{Magical, Spell}
        ...
        \ff[9]{Greater Energy Resistance} The damage reduction from your \textit{energy resistance} ability increases to twice your spellpower.

        \ff[11]{Greater Energy Affinity} You gain a \plus1 bonus to accuracy with attacks that deal \glossterm{energy damage}.

        \ff[13]{Devastating Evocation} The area affected by your Evocation spells that affect areas doubles.

        \ff[17]{Supreme Energy Affinity} The damage bonus from your \textit{energy affinity} ability increases to \plus2d.
    \end{feat}
    ...
    \begin{feat}{Executioner}{Combat}
        ...
        \ff[4]{Bloodfeeder}[Life, Magical] Whenever a creature dies, if you dealt damage to it that round, you heal hit points equal to its level.

        \ff[6]{Greater Execution} When you use your \textit{execution} ability, you gain a \plus1d bonus to damage with the strike.

        \ff[8]{Greater Purge the Weak} The accuracy bonus from your \textit{purge the weak} ability applies to all attacks, not just physical attacks.

        \ff[10]{Blood Sense}[Magical] You automatically know the location of all living creatures within 50 feet of you, regardless of concealment or invisibility.
        You must have \glossterm{line of effect} to a creature to see it.

        \ff[12]{Greater Bloodfeeder}[Life, Magical] Whenever a creature dies, if you dealt damage to it that round and you used your \textit{execution} ability on it since the last time it took a \glossterm{short rest}, you regain an \glossterm{action point}.

        \ff[14]{Supreme Execution} The damage bonus with your \textit{execution} ability increases to \plus2d.

        \ff[16]{Supreme Purge the Weak} The accuracy bonus from your \textit{purge the weak} ability increases to \plus2.

        \ff[18]{Blood Sight}[Magical] Your \textit{blood sense} ability allows you to see creatures perfectly instead of only knowing their location.
    \end{feat}
    ...
    \begin{feat}{Guardian}{Combat}
        ...
        \ff[2]{Protect} As a \glossterm{minor action}, you can use the \textit{protect} ability.
        ...
        \ff[4]{Defender} You gain a \plus2 bonus to \glossterm{threat}.

        \ff[6]{Certain Bind} You gain a \plus1 bonus to accuracy with your \textit{binding strike} ability.

        \ff[8]{Redirection}[Magical] When you use your \textit{protect} ability, you can spend an \glossterm{action point} to use the \textit{redirection} ability.
        ...
        \ff[10]{Greater Defender} The bonus from your \textit{defender} ability increases to \plus4.
        ...
        \ff[16]{Supreme Defender} The bonus from your \textit{defender} ability increases to \plus6.
    ...
    \begin{feat}{Heal Specialization}{Skill}
        ...
        \ff[10]{Purging Touch}[Magical] As a standard action, you can spend an \glossterm{action point} to use the \textit{purging touch} ability.
    ...
    \begin{feat}{Illusionist}{Magical, Spell}
        ...
        \ff[7]{Control Image} While your \textit{create image} ability is active, you can use the \textit{control image} ability as a standard action.
    ...
    \begin{feat}{Iron Will}{General}
        ...
        \ff[1]{Resilience} You gain additional hit points equal to your Willpower.

        \ff[2]{Mental Discipline} You gain a \plus2 bonus to Mental defense.
    ...
    \begin{feat}{Jump Specialization}{Skill}
        ...
        \ff[4]{Featherlight Leap} You gain the \textit{featherlight leap} ability.
        ...
        \ff[6]{Impact Tolerance} When calculating your \glossterm{falling damage}, you treat all falls as they were fifty feet shorter than they actually are.

        \ff[8]{Greater Specialization} The bonus from your \textit{specialization} ability increases to \plus4.

        \ff[10]{Greater Featherlight Leap} You do not need to spend an \glossterm{action point} to use your \textit{featherlight leap} ability.

        \ff[12]{Greater Instant Leap} You are always considered to have a running start when jumping, even when rebounding off of objects (see \pcref{Rebounding Leap}).

        \ff[14]{Greater Impact Tolerance} You are immune to \glossterm{falling damage}. 

        \ff[16]{Supreme Specialization} The bonus from your \textit{specialization} ability increases to \plus6.

        \ff[18]{Supreme Instant Leap} You take no penalty to the Jump check for making rebounding leaps off of objects in midair (see \pcref{Rebounding Leap}).
    \end{feat}
    ...
    \begin{feat}{Leadership}{Combat}
        ...
        \ff[2]{Battle Command} As a standard action, you can use the \textit{battle command} ability.
    ...
    \begin{feat}{Linguistics Specialization}{Skill}
        ...
        \ff[4]{Language Focus} By spending a day in focused concentration on learning a specific \glossterm{common language}, you can use the \textit{language focus} ability.
        ...
        \ff[10]{Greater Language Focus} You can use your \textit{language focus} ability to learn \glossterm{rare languages} in addition to common languages.
    ...
    \begin{feat}{Martial Training}{Combat}
        ...
        \ff[2]{Honed Strike} As a standard action, you can spend an \glossterm{action point} to use the \textit{honed strike} ability.
    ...
    \begin{feat}{Miscaster}{Magical, Spell}
        ...
        \ff[11]{Resilient Channeler} In the round after you use your \textit{overchannel} ability, you can cast both cantrips and spells, but not \glossterm{subspells}.
    ...
    \begin{feat}{Mystic Archer}{Magical, Spell}
        ...
        \ff[7]{Imbue Detonating Projectile} Whenever you cast a spell that affects an area, you can spend an \glossterm{action point} to use the \textit{imbue detonating projectile} ability.
    ...
    \begin{feat}{Null}{General}
        ...
        \ff[2]{Null Severance} As a standard action, you can spend an \glossterm{action point} to use the \textit{null severance} ability.
    ...
    \begin{feat}{Perform Specialization}{Skill}
        ...
        \ff[4]{Inspiring Performance}[Magical] As a standard action, you can spend an \glossterm{action point} to use the \textit{inspiring performance} ability.
        ...
        \ff[6]{Mass Performance}[Magical] You can target up to two creatures with your \textit{inspiring performance} ability.
        In addition, you can target any number of creatures with your \textit{mesmerizing performance} ability.

        \ff[8]{Greater Specialization} The bonus from your \textit{specialization} ability increases to \plus4.

        \ff[10]{Mesmeric Suggestion}[Magical] As a standard action, you can spend an \glossterm{action point} to use the \textit{mesmeric suggestion} ability.
        ...
        \ff[12]{Greater Inspiring Performance}[Magical] The bonus from your \textit{inspiring performance} ability increases to \plus4.

        \ff[14]{Greater Mass Performance}[Magical] When you use your \textit{inspiring performance} ability, you can target any number of creatures.
    ...
    \begin{feat}{Persuasion Specialization}{Skill}
        ...
        \ff[6]{Center of Attention} When you use your \textit{compel attention} ability, you may target up to five creatures.

        \ff[8]{Greater Specialization} The bonus from your \textit{specialization} ability increases to \plus4.

        \ff[10]{Suggestion} As a standard action, you can spend an \glossterm{action point} to use the \textit{suggestion} ability.
    ...
    \begin{feat}{Precognition}{Combat}
        ...
        \ff[2]{Combat Prediction} At the start of each phase, you can spend an \glossterm{action point} to use the \textit{combat prediction} ability.
    ...
    \begin{feat}{Regenerator}{General}
        ...
        \ff[2]{Diehard} You reduce your penalties from \glossterm{vital damage} by an amount equal to half your Constitution.
        ...
        \ff[16]{Healing Burst} As a \glossterm{minor action}, you can spend an \glossterm{action point} to use the \textit{healing burst} ability.
    ...
    \begin{feat}{Ride Specialization}{Skill}
        ...
        \ff{Mounted Warrior} Your mount gains a \plus2 bonus to Armor defense, up to a maximum of your own Armor defense.
    ...
    \begin{feat}{Sense Motive Specialization}{Skill}
        ...
        \ff[8]{Greater Specialization} The bonus to Senfrom your \textit{specialization} ability increases to \plus4.

        \ff[16]{Supreme Specialization} The bonus to Senfrom your \textit{specialization} ability increases to \plus6.
    \end{feat}
    ...
    \begin{feat}{Sleight of Hand Specialization}{Skill}
        ...
        \ff[16]{Supreme Specialization} The bonus to Sleight from your \textit{specialization} ability increases to \plus6.
    \end{feat}
    ...
    \begin{feat}{Spellcraft Specialization}{Skill}
        ...
        \ff[4]{Unweave Magic} As a standard action, you can spend an \glossterm{action point} to use the \textit{unweave magic} ability.
    ...
    \begin{feat}{Survival Specialization}{Skill}
        ...
        \ff[10]{Planar Tolerance} You are immune to harmful effects imposed by being on other planes.

        \ff[14]{Find the Path} As a standard action, you can spend an \glossterm{action point} to use the \textit{find the path} ability.
    ...
    \begin{feat}{Swim Specialization}{Skill}
        ...
        \ff[4]{Swim Speed} You gain a \glossterm{swim speed} equal to your \glossterm{base speed}.
        A successful Swim check to move allows you to move a distance equal to your swim speed.

        \ff[8]{Greater Specialization} The bonus from your \textit{specialization} ability increases to \plus4.

        \ff[10]{Underwater Tolerance} You do not suffer any penalties to accuracy, checks, or defenses for being underwater.
    ...
    \begin{feat}{Toughness}{General}
        ...
        \ff[2]{Fortitude} You gain a \plus2 bonus to Fortitude defense.
    ...
    \begin{feat}{Transmuter}{Magical, Spell}
        ...
        In addition, as a stard action, you can spend an \glossterm{action point} to use the \textit{alter poison} ability.
    ...
    \begin{feat}{Whirlwind Warrior}{Combat}
        ...
        \ff[1]{Whirlwind Strike} As a standard action, you can spend an \glossterm{action point} to use the \textit{whirlwind strike} ability.
        ...
        \ff[2]{Spring Attack} As a standard action, you can spend an \glossterm{action point} to use the \textit{spring attack} ability.
