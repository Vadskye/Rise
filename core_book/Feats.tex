...
\end{longcolumn}
    ...
    \begin{magicalfeat}{Sphere Focus: Enchantment}{Casting, Magical}
        ...
        \magicalff[6]{Mind Fragments} When you use \abilitytag{Emotion} abilities and attacks that deal psychic damage, you can affect creatures that are immune to those abilities due to not having a mind or being simple-minded.
