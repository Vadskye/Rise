...
\end{longtablewrapper}
    ...
    \begin{feat}{Blood Magic}{Casting, Magical}
        ...
        In exchange, you gain a \plus2 bonus to \glossterm{power} with the spell, the spell does not require \glossterm{components}, and it loses the \abilitytag{Focus} tag (if it had it).
