...
\end{longtabuwrapper}
    ...
    \begin{feat}{Executioner}{Combat}
        ...
        \begin{ability}
            ...
            \begin{spelleffects}
                ...
                At the end of the current phase, if the target is not \glossterm{bloodied}, it takes additional damage equal to the damage you dealt to it with your strike.
            \end{spelleffects}
        \end{ability}
        ...
        \ff[8]{Salt the Wound} When you use your \textit{strip the flesh} ability, the target continues taking damage at the end of each \glossterm{action phase} until it becomes \glossterm{bloodied}.
    ...
    \begin{feat}{Regenerator}{General}
        ...
        \ff[1]{Regenerative Rest} Whenever you take a \glossterm{short rest}, you can heal \glossterm{vital damage} equal to half your Constitution in addition to your normal healing.

        \ff[2]{Diehard} You reduce your penalties from \glossterm{vital damage} by an amount equal to your Constitution.

        \ff[4]{Regenerative Recovery} When you use the \textit{recover} action, you heal \plus1d hit points.
        In addition, if you have taken \glossterm{vital damage}, the healing from the \textit{recovery} ability heals vital damage instead of hit points until you have no vital damage remaining.

        \ff[6]{Fast Healing} At the end of each \glossterm{action phase}, you heal hit points equal to half your Constitution.

        \ff[8]{Regeneration} If you have taken \glossterm{vital damage}, the healing from your \textit{fast healing} ability heals vital damage instead of hit points until you have no vital damage remaining.

        \ff[10]{Unkillable} The penalty reduction from your \textit{diehard} ability increases to be equal to twice your Constitution.

        \ff[12]{Greater Fast Healing} The healing from your \textit{fast healing} ability increases to be equal to your Constitution.

        \ff[14]{Greater Regenerative Recovery} The bonus to healing from your \textit{regenerative recovery} ability increases to \plus2d.

        \ff[16]{Regenerative Burst} As a \glossterm{minor action}, you can spend an \glossterm{action point} to use this ability.
        If you do, you heal hit points equal to your \glossterm{standard damage} \minus1d.

        \ff[18]{Indestructible} The penalty reduction from your \textit{diehard} ability increases to be equal to three times your Constitution.
    \end{feat}
