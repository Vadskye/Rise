...
\end{longtabuwrapper}
    ...
    \begin{feat}{Acrobatics Specialization}{Skill}
        ...
        \ff[4]{Acrobatic Dodge} You can use the \textit{acrobatic dodge} ability as a \glossterm{standard action}.
        \begin{freeability}{Acrobatic Dodge}
            ...
            \rankline
            \rank{10} The defense bonus increases to +3.
            \rank{16} YThe defense bonus increases to +4.
        \end{freeability}

        \ff[7]{Combat Tumble} During each phase, you may move through one creature's space during movement.
    ...
    \begin{feat}{Agility}{General}
        ...
        \begin{freeability}{Spring Attack}
            ...
            \rankline
            \rank{10} The damage penalty is removed.
            \rank{16} You gain a +1d bonus to damage with the strike.
        \end{freeability}
    ...
    \begin{feat}{Bardic Exemplar}{Magical, Skill}
        ...
        \begin{freeability}{Vicious Mockery}[\glossterm{Emotion}]
            ...
            \rankline
            \rank{7} The area increases to a \arealarge radius from you.
            \rank{13} The area increases to a \areahuge radius from you.
            \rank{19} The accuracy penalty increases to \minus2.
        \end{freeability}
        ...
        \begin{freeability}{Inspire Courage}[\glossterm{Emotion}, \glossterm{Sustain} (minor)]
            \targets{One \glossterm{ally} within \rngmed range}
            ...
            \rankline
            \rank{10} The accuracy bonus increases to \plus2.
            \rank{16} The defense bonus increases to \plus4.
        \end{freeability}
        ...
        \begin{freeability}{Song of Serenity}[\glossterm{Emotion}, \glossterm{Sustain} (minor)]
            \target{One \glossterm{ally} wtihin \rngmed range}
            You begin a performance using one of your Perform skills.
            This ability may have the \glossterm{Auditory} or \glossterm{Visual} tags, depending on the nature of your performance.
            If a target can neither see nor hear your performance, the effect immediately ends for that target.
            ...
            \rankline
            \rank{13} This ability can target up to two \glossterm{allies} within \rngmed range.
            \rank{19} This ability can target up to five \glossterm{allies} within \rngmed range.
        \end{freeability}

        \ff[10]{Hybrid Performance} You can sustain two different \glossterm{magical} abilities from this feat or the Perform Specialization feat as part of the same \glossterm{minor action}.

        \ff[16]{Greater Hybrid Performance} You can sustain three different \glossterm{magical} abilities from this feat or the Perform Specialization feat as part of the same \glossterm{minor action}.
    \end{feat}
    ...
    \begin{feat}{Bluff Specialization}{Skill}
        ...
        \begin{freeability}{Dual Speech}[\glossterm{Sustain} (minor)]
            ...
            \rankline
            \rank{10} You can speak entirely different words with your two voices.
            \rank{16} You can also speak with a third voice, using separate words and vocal patterns.
        \end{freeability}
        ...
        \begin{ability}{Deceive Magic}[\glossterm{AP}, \glossterm{Swift}]
    ...
    \begin{feat}{Boongiver}{Casting, Magical}
        ...
        \begin{ability}{Share Boon}
            The spell's \glossterm{Attune} tag changes to \glossterm{Attune} (target).
            Choose one \glossterm{ally} within \rngclose range.
            ...
            If you use it again, the original ally's attunement to the old spell is released, as the \textit{release attunement} ability (see \pcref{Release Attunement}).
        \end{ability}
        ...
        \begin{freeability}{Benevolent Transferance}
            ...
            \rankline
            \rank{13} You can use this ability as a \glossterm{minor action}.
            \rank{19} This ability gains the \glossterm{Swift} tag.
        \end{freeability}
        ...
        \begin{freeability}{Personal Boon}
            ...
            Your attunement to the other spell is released, as the \textit{release attunement} ability (see \pcref{Release Attunement}).
        \end{freeability}
    ...
    \begin{feat}{Brawler}{Combat}
        ...
        \ff[4]{Takedown} You can use the \textit{takedown} ability as a standard action.
        \begin{freeability}{Takedown}
            ...
            \rankline
            \rank{10} You gain a \plus1 bonus to accuracy with the strike.
            \rank{16} The accuracy bonus increases to \plus2.
        \end{freeability}

        \ff[7]{Grapple Expertise} You gain a \plus2 bonus to \glossterm{accuracy} with the \textit{grapple} ability (see \pcref{Grapple}), as well as with all grapple actions (see \pcref{Grapple Actions}).

        \ff[10]{Greater Unarmed Warrior} The damage bonus from your \textit{unarmed warrior} increases to \plus3d.

        \ff[13]{Pin Mastery} You can use the \textit{pin} ability with only one free hand (see \pcref{Pin}).
    ...
    \begin{feat}{Celestial Heritage}{Bloodline, Magical}
        ...
        \begin{freeability}{Smite}[Magical]
            ...
            \rankline
            \rank{10} The damage bonus increases to \plus2d.
            \rank{16} The damage bonus increases to \plus3d.
        \end{freeability}
        ...
        \ff[10]{Greater Divine Favor} The bonuses from your \textit{divine favor} ability increase to \plus2.
    ...
    \begin{feat}{Draconic Heritage}{Bloodline}
        ...
        \begin{freeability}{Breath Weapon}
            ...
            \rankline
            \rank{10} The area affected by your breath weapon increases.
                A line breath weapon becomes a \areahuge, 15 ft.\ wide line.
                A cone breath weapon becomes a \arealarge cone.
            \rank{16} You gain a \plus1d bonus to damage.
        ...
        \ff[10]{Greater Draconic Ancestry} You become immune to the damage type dealt by your dragon's breath weapon.
    ...
    \begin{feat}{Duelist}{Combat}
        ...
        \begin{freeability}{Focused Strike}
            ...
            \rankline
            \rank{10} The accuracy bonus increases to \plus2.
            \rank{16} The damage bonus increases to \plus2d.
        \end{freeability}
    ...
    \begin{feat}{Executioner}{Combat}
        ...
        \begin{freeability}{Execution}
            ...
            \rankline
            \rank{10} The damage bonus increases to \plus3d.
            \rank{16} The damage bonus increases to \plus4d.
        \end{freeability}
    ...
    \begin{feat}{Guardian}{Combat}
        ...
        \begin{freeability}{Protect}[\glossterm{Swift}]
            Choose an adjacent \glossterm{ally}.
            The target gains a \plus2 bonus to Armor defense this round.
            ...
            \rankline
            \rank{7} The Armor defense penalty is reduced to \minus1.
            \rank{13} You may target an additional adjacent \glossterm{ally}.
            \rank{19} The Armor defense penalty is removed.
        \end{freeability}
        ...
        \begin{freeability}{Binding Strike}
            ...
            This effect immediately ends if the target is not \glossterm{threatened} by you.
            \crit As above, except that the condition does not end when the target stops being threatened.

            \rankline
            \rank{10} The condition does not end when the target stops being threatened.
            \rank{16} The target is also \glossterm{immobilized} as part of the same condition.
        \end{freeability}

        \ff[7]{Threatening Guardian} You gain a \plus2 bonus to \glossterm{threat}.

        \ff[10]{Resolute Defender} You gain a \plus1 bonus to Mental defense.

        \ff[13]{Defensive Training} You gain a \plus1 bonus to Armor defense.

        \ff[16]{Greater Threatening Guardian} The bonus from your \textit{threatening guardian} ability increases to \plus4.

        \ff[19]{Greater Resolute Defender} The bonus from your \textit{resolute defender} ability increases to \plus2.
    \end{feat}
    ...
    \begin{feat}{Heal Specialization}{Skill}
        ...
        \begin{freeability}{Healing Touch}[\glossterm{Life}]
            ...
            \rankline
            \rank{10} For every five hit points you would heal, you can instead heal a point of \glossterm{vital damage}.
            \rank{16} For every two hit points you would heal, you can instead heal a point of \glossterm{vital damage}.
        \end{freeability}
        ...
        \begin{freeability}{Purging Touch}
            ...
            \rankline
            \rank{13} You can target any number of \glossterm{allies} within your reach.
            \rank{19} You gain a \plus5 bonus to the check.
        \end{freeability}
    ...
    \begin{feat}{Jump Specialization}{Skill}
        ...
        \begin{freeability}{Featherlight Leap}[\glossterm{Swift}]
            ...
            \rankline
            \rank{13} This ability lasts until the end of the current round.
            \rank{19} You do not take damage from using this ability.
        \end{freeability}

        \ff[10]{Greater Specialization} The bonus from your \textit{specialization} ability increases to \plus4.

        \ff[13]{Impact Tolerance} You take half damgae from \glossterm{falling damage}.
    ...
    \begin{feat}{Leadership}{Combat}
        ...
        \ff[1]{Inspiring Leader} \glossterm{Allies} that can see or hear you gain a \plus1 bonus to Mental defense.

        \ff[4]{Bolster} You can use the \textit{bolster} ability as a standard action.
        \begin{freeability}{Bolster}[\glossterm{Emotion}]
            One \glossterm{ally} within \rngclose range can remove one \glossterm{condition}.

            \rankline
            \rank{10} You may instead target all \glossterm{allies} within a \areamed radius from you.
            \rank{16} You may instead target all \glossterm{allies} within a \arealarge radius from you.
        \end{freeability}

        \ff[7]{Battle Command} You can use the \textit{battle command} ability as a standard action.
        \begin{freeability}{Battle Command}[\glossterm{Swift}]
            ...
            \rankline
            \rank{13} The damage bonus increases to \plus2d.
            \rank{19} The damage bonus increases to \plus3d.
        \end{freeability}

        \ff[10]{Greater Inspiring Leader} The bonus from your \textit{inspiring leader} ability increases to \plus2.

        \ff[13]{Commanding Presence} You gain a \plus2 bonus to the Intimidate and Persuasion skills.

        \ff[16]{todo} 

        \ff[19]{Greater Inspiring Leader} The bonus from your \textit{inspiring leader} ability increases to \plus2.
    \end{feat}
    ...
    \begin{feat}{Martial Training}{Combat}
        ...
        \begin{freeability}{Trained Strike}
            ...
            \rankline
            \rank{10} The accuracy bonus increases to \plus2.
            \rank{16} The accuracy bonus increases to \plus3.
        \end{freeability}
    ...
    \begin{feat}{Mystic Archer}{Casting}
        ...
        \begin{freeability}{Missile Storm}[\glossterm{Magical}]
            ...
            \rankline
            \rank{13} The strike targets up to ten creatures or objects within range.
            \rank{19} The strike targets any number of creatures or objects within range.
        \end{freeability}
    ...
    \begin{feat}{Null}{General}
        ...
        \begin{freeability}{Sever Magic}
            ...
            \rankline
            \rank{10} You gain a \plus1 bonus to \glossterm{accuracy} with the strike.
            \rank{16} The accuracy bonus increases to \plus2.
        \end{freeability}
    ...
    \begin{feat}{Perform Specialization}{Skill}
        ...
        \begin{freeability}{Mesmerizing Performance}[\glossterm{Emotion}, \glossterm{Sustain} (minor)]
            ...
            \rankline
            \rank{10} You may target up to ten creatures within range.
            \rank{16} You may target any number of creatures within range.
        \end{freeability}
        ...
        \begin{freeability}{Inspiring Performance}[\glossterm{Emotion}, \glossterm{Sustain} (minor)]
            ...
            \rankline
            \rank{13} The bonus increases to \plus3.
            \rank{19} The bonus increases to \plus4.
        \end{freeability}
        ...
        \begin{freeability}{Mesmeric Suggestion}[\glossterm{Emotion}, \glossterm{Subtle}, \glossterm{Sustain} (minor)]
            ...
            \rankline
            \rank{19} You may target up to five creatures within range.
        \end{freeability}
    ...
    \begin{feat}{Persuasion Specialization}{Skill}
        ...
        \begin{freeability}{Compel Attention}[\glossterm{Auditory}, \glossterm{Compulsion},\\\glossterm{Sustain} (minor), \glossterm{Subtle}]
            ...
            \rankline
            \rank{10} You may target up to five creatures within range.
            \rank{16} You may target any number of creatures within range.
        \end{freeability}
    ...
    \begin{feat}{Precognition}{Combat}
        ...
        \begin{freeability}{Precognitive Strike}
            ...
            \rank{13} The accuracy bonus increases to \plus2.
            \rank{19} You also compare your attack result against the target's Mental defense.
        ...
        \begin{freeability}{Combat Prediction}
            ...
            \rankline
            \rank{10} You may target two creatures within range.
            \rank{16} You may target three creatures within range.
        \end{freeability}
        ...
        \ff[13]{Precognitive Defense} You gain a \plus1 bonus to Armor defense.

        \ff[16]{Greater Precognitive Reaction} The bonuses from your \textit{precognitive reaction} ability increase to \plus4.

        \ff[19]{Greater Foresight} The range of your \textit{foresight} ability increases to \rngmed range.
    \end{feat}
    ...
    \begin{feat}{Sense Motive Specialization}{Skill}
        ...
        \begin{freeability}{Read Mind}[\glossterm{Emotion}, \glossterm{Sustain} (minor)]
            ...
            \rankline
            \rank{13} The range increases to \rnglong range.
            \rank{19} You can use this ability as a \glossterm{minor action}.
        \end{freeability}
    ...
    \begin{feat}{Spellcraft Specialization}{Skill}
        ...
        \begin{freeability}{Detect Spellcasting}[\glossterm{Knowledge}, \glossterm{Subtle}]
            ...
            \rankline
            \rank{10} The range increases to \rnglong.
            \rank{16} You gain the critical hit effect on any hit.
        \end{freeability}
        ...
        \begin{freeability}{Unweave Magic}[\glossterm{Mystic}]
            ...
            \rankline
            \rank{13} You can target up to two spell effects within range.
            \rank{19} You can affect spells with the \glossterm{Attune} tag.
    ...
    \begin{feat}{Sphere Focus: Barrier}{Casting, Magical}
        ...
        \begin{freeability}{Burst Ward}[\glossterm{Swift}]
            ...
            \rankline
            \rank{10} This ability lasts until the end of the next round.
            \rank{16} You also gain a \plus1 bonus to all defenses.
        \end{freeability}
    ...
    \begin{feat}{Sphere Focus: Thaumaturgy}{Casting, Magical}
        ...
        \begin{freeability}{Counterspell}[\glossterm{Swift}]
            ...
            \rankline
            \rank{10} You may target an additional creature within range.
            \rank{16} You may cause each target to \glossterm{miscast} its spell instead of causing the spell to have no effect.
        \end{freeability}
        ...
        \ff[13]{Thaumatic Substitution} Whenever you cast a spell that deals damage, you may change the type of damage to thaumatic damage.
    ...
    \begin{feat}{Two-Weapon Fighting}{Combat}
        ...
        \ff[7]{Dual Precision} When you make a \glossterm{strike} using two weapons, your \glossterm{attack rolls} \glossterm{explode} on either a 9 or a 10.
        This does not affect attack rolls that have already \glossterm{exploded}.
        ...
        \ff[16]{Greater Dual Precision} The effect of your \textit{dual precision} ability also applies to attack rolls that have already \glossterm{exploded}.
    ...
    \begin{feat}{Whirlwind Warrior}{Combat}
        ...
        \begin{freeability}{Whirlwind Spin}
            ...
            \rankline
            \rank{10} You gain a \plus1d bonus to damage with the strike.
            \rank{16} You can move up to 5 feet when you use this ability.
