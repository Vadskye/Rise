...
\end{longtablewrapper}
    ...
    \begin{feat}{Endurance Specialization}{Skill}
        ...
        \ff[21]{Ignore Vital Wound} Whenever you gain a \glossterm{vital wound}, you can choose to ignore its effect after making the \glossterm{vital roll}.
    ...
    \begin{feat}{Jump Specialization}{Skill}
        ...
        \ff[9]{Featherlight Leap} When you move with a Jump check, your maximum height is equal to your Jump check result, rather than half your Jump check result (see \pcref{Jump}).
    ...
    \begin{magicalfeat}{Sphere Focus: Telekinesis}{Casting, Magical}
        ...
        This gives you a \plus1 bonus to your Willpower for the purpose of determining your \glossterm{weight limits}, and allows you to make attacks with \weapontag{Heavy} weapons using your \ability{telekinetic strike} ability.
    ...
    \begin{feat}{Two-Weapon Fighting}{Combat}
        ...
        % \ff[1]{Two-Weapon Glance} While you are twin-wielding, you can get \glossterm{glancing blows} while \glossterm{dual wielding}.
