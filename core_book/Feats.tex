...
\end{longtablewrapper}
    ...
    \begin{feat}{Blood Magic}{Casting, Magical}
        ...
        \ff[7]{Bloodbind} Whenever you make a living creature \glossterm{bleed} using a spell, you can choose to bind the target's blood to yours.
    ...
    \begin{feat}{Boongiver}{Casting, Magical}
        ...
        \ff[16]{Personal Boon} You gain an additional \glossterm{attunement point}.
    ...
    \begin{feat}{Craft Specialization}{Skill}
        ...
        \ff[13]{Item Attunement} You gain an additional \glossterm{attunement point}.
        You can only use this \glossterm{attunement point} to \glossterm{attune} to the effects of items (see \pcref{Item Attunement}).

        \ff[16]{Supreme Specialization} The bonus from your \textit{specialization} ability increases to \plus9.

        \ff[19]{Greater Item Attunement} You gain an additional \glossterm{attunement point}.
        You can only use this \glossterm{attunement point} to \glossterm{attune} to the effects of items (see \pcref{Item Attunement}).
    \end{feat}
    ...
    \begin{feat}{Deception Specialization}{Skill}
        ...
        \ff[13]{Deceive Magic}[\glossterm{Magical}] When you would be hit by a \glossterm{magical} attack, you can use this ability in response.
    ...
    \begin{feat}{Greatweapon Warrior}{Combat}
        ...
        \ff[4]{Cleave} Whenever you wield a melee weapon in two hands, it gains the Sweeping (1) tag (see \pcref{Sweeping}).
    ...
    \begin{feat}{Metacaster}{Casting, Magical}
        ...
        \ff[7]{Spell Fusion} You can use the \textit{spell fusion} ability as a \glossterm{standard action}.
        ...
        \ff[13]{Greater Spell Fusion} Using your \textit{spell fusion} ability does not prevent you from acting during the \glossterm{movement phase} of the following round.
        ...
        \ff[19]{Supreme Spell Fusion} Using your \textit{spell fusion} ability does not prevent you from taking \glossterm{minor actions} during the following round.
    \end{feat}
    ...
    \begin{feat}{Mystic Archer}{Casting}
        ...
        \ff[7]{Imbue Projectile} When you cast a spell that does not have the \glossterm{Attune} or \glossterm{Sustain} tags,
    ...
    \begin{feat}{Rapid Reaction}{General}
        ...
        \ff[4]{Evasive Reaction} You take half damage from abilities that affect an area.
        ...
        \ff[13]{Greater Evasive Reaction} You can use your Reflex defense in place of any other defense against abilities that affect an area.
    ...
    \begin{feat}{Regenerator}{General}
        ...
        \ff[4]{Regenerative Rest} When you take a \glossterm{short rest}, you can remove a \glossterm{vital wound} affecting you.
    ...
    \begin{feat}{Spellsword}{Magical, Spell}
        ...
        \ff[7]{Imbue Weapon} When you cast a spell that does not have the \glossterm{Attune} or \glossterm{Sustain} tags,
    ...
    \begin{feat}{Sphere Focus: Aeromancy}{Casting, Magical}
        ...
        \ff[10]{Personal Aeromancy} You gain an additional \glossterm{attunement point}.
    ...
    \begin{feat}{Sphere Focus: Aquamancy}{Casting, Magical}
        ...
        \ff[10]{Personal Aquamancy} You gain an additional \glossterm{attunement point}.
    ...
    \begin{feat}{Sphere Focus: Astromancy}{Casting, Magical}
        ...
        \ff[10]{Personal Astromancy} You gain an additional \glossterm{attunement point}.
        ...
        \ff[19]{Greater Astral Spell Transit} The range increase from your \textit{astral spell transit} ability increases to be quadruple your normal range.
    \end{feat}
    ...
    \begin{feat}{Sphere Focus: Barrier}{Casting, Magical}
        ...
        \ff[10]{Personal Barrier} You gain an additional \glossterm{attunement point}.
    ...
    \begin{feat}{Sphere Focus: Bless}{Casting, Magical}
        ...
        \ff[10]{Personal Blessing} You gain an additional \glossterm{attunement point}.
        ...
        \ff[19]{Greater Personal Blessing} The number of additional attunement points granted by your \textit{personal blessing} ability increases to two.
    \end{feat}
    ...
    \begin{feat}{Sphere Focus: Biomancy}{Casting, Magical}
        ...
        \ff[10]{Personal Biomancy} You gain an additional \glossterm{attunement point}.
        You can only use this attunement point to \glossterm{attune} to spells and rituals from the \sphere{Biomancy} \glossterm{mystic sphere}.
        ...
        \ff[19]{Greater Personal Biomancy} The number of attunement points you gain from your \textit{personal biomancy} ability increases to 2.
    \end{feat}
    ...
    \begin{feat}{Sphere Focus: Channel Divinity}{Casting, Magical}
        ...
        \ff[7]{Divine Servant} Once per \glossterm{long rest}, if you pray to your deity in an area sacred to your deity, you can remove all of your \glossterm{fatigue points}.
        This takes a \glossterm{minor action}.

        \ff[10]{Personal Channeling} You gain an additional \glossterm{attunement point}.
        ...
        \ff[19]{Greater Personal Channeling} The number of attunement points you gain from your \textit{personal channeling} ability increases to 2.
    \end{feat}
    ...
    \begin{feat}{Sphere Focus: Cryomancy}{Casting, Magical}
        ...
        \ff[4]{Lingering Chill} Whenever you make a creature \glossterm{bleed} with a \glossterm{critical hit} using cold damage, that creature is \glossterm{chilled} as a \glossterm{condition}.

        \ff[7]{Frozen Blood} You are immune to \glossterm{poisons}.

        \ff[10]{Personal Cryomancy} You gain an additional \glossterm{attunement point}.
    ...
    \begin{feat}{Sphere Focus: Delusion}{Casting, Magical}
        ...
        \ff[10]{Personal Delusion} You gain an additional \glossterm{attunement point}.
        You can only use this attunement point to \glossterm{attune} to spells and rituals from the \sphere{Delusion} \glossterm{mystic sphere}.
    ...
    \begin{feat}{Sphere Focus: Electromancy}{Casting, Magical}
        ...
        \ff[4]{Lingering Shock} When you make a creature \glossterm{bleed} with a \glossterm{critical hit} using electricity damage, that creature is \glossterm{dazed} as a \glossterm{condition}.

        \ff[7]{Energetic Rush} You gain a \plus2 bonus to Reflex defense and a \plus5 foot bonus to your \glossterm{base speed}.

        \ff[10]{Personal Electromancy} You gain an additional \glossterm{attunement point}.
    ...
    \begin{feat}{Sphere Focus: Fabrication}{Casting, Magical}
        ...
        \ff[10]{Personal Fabrication} You gain an additional \glossterm{attunement point}.
    ...
    \begin{feat}{Sphere Focus: Photomancy}{Casting, Magical}
        ...
        \ff[10]{Personal Photomancy} You gain an additional \glossterm{attunement point}.
    ...
    \begin{feat}{Sphere Focus: Polymorph}{Casting, Magical}
        ...
        \ff[10]{Personal Polymorph} You gain an additional \glossterm{attunement point}.
    ...
    \begin{feat}{Sphere Focus: Pyromancy}{Casting, Magical}
        ...
        \ff[4]{Lingering Flame} Whenever you make a creature \glossterm{bleed} with a \glossterm{critical hit} using fire damage, that creature takes \glossterm{environmental} fire \glossterm{standard damage} at the end of the next round.
        Since this damage is environmental damage, it has no effect if it does not make the target \glossterm{bleed} (see \pcref{Environmental Damage}).
        ...
        \ff[10]{Personal Pyromancy} You gain an additional \glossterm{attunement point}.
    ...
    \begin{feat}{Sphere Focus: Revelation}{Casting, Magical}
        ...
        \ff[10]{Personal Revelation} You gain an additional \glossterm{attunement point}.
    ...
    \begin{feat}{Sphere Focus: Summoning}{Casting, Magical}
        ...
        \ff[7]{Resummon} You can use the \textit{resummon} ability as a \glossterm{minor action}.
        \begin{freeability}{Resummon}
            ...
            \rankline
            \featlevel{13} The range increases to \rnglong.
            \featlevel{19} You can choose two creatures or objects to teleport in this way instead of only one.
                Each chosen creature or object can be teleported to a different location within range.
        \end{freeability}

        \ff[10]{Personal Summoning} You gain an additional \glossterm{attunement point}.
        ...
        \ff[13]{Greater Fortified Summons} The number of additional \glossterm{hit points} from your \textit{fortified summoning} ability increases to 4.

        \ff[16]{Spell} You learn a spell from the \sphere{Summoning} \glossterm{mystic sphere}.
        When you gain access to a new spell level, you can change which spell you know from that mystic sphere.

        \ff[19]{Augmented Summons} Creatures you create with abilities from the \sphere{Summoning} spell gain an \glossterm{attunement point}.
    \end{feat}
    ...
    \begin{feat}{Sphere Focus: Telekinesis}{Casting, Magical}
        ...
        \ff[10]{Personal Telekinesis} You gain an additional \glossterm{attunement point}.
    ...
    \begin{feat}{Sphere Focus: Terramancy}{Casting, Magical}
        ...
        \ff[10]{Personal Terramancy} You gain an additional \glossterm{attunement point}.
    ...
    \begin{feat}{Sphere Focus: Thaumaturgy}{Casting, Magical}
        ...
        \ff[10]{Personal Thaumaturgy} You gain an additional \glossterm{attunement point}.
    ...
    \begin{feat}{Sphere Focus: Umbramancy}{Casting, Magical}
        ...
        \ff[10]{Personal Umbramancy} You gain an additional \glossterm{attunement point}.
    ...
    \begin{feat}{Sphere Focus: Verdamancy}{Casting, Magical}
        ...
        \ff[10]{Personal Verdamancy} You gain an additional \glossterm{attunement point}.
    ...
    \begin{feat}{Sphere Focus: Vivimancy}{Casting, Magical}
        ...
        \ff[10]{Personal Vivimancy} You gain an additional \glossterm{attunement point}.
