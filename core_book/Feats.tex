...
\begin{longcolumn}
    ...
    \begin{longtable}{>{\lcol}p{13em} >{\lcol}p{10em} l >{\lcol}p{8em} >{\lcol}p{3em}}
        ...
        \featref{Barbaric Heritage}         & Str \add Dex \add Con is 3 & Gain aid from barbarian ancestors     & Bloodline          & \featpref{Barbaric Heritage}  \\
...
\end{longcolumn}
    ...
    \begin{magicalfeat}{Barbaric Heritage}{Bloodline, Magical}
        ...
        \begin{magicalsustainability}{Ancestral Totem}{\abilitytag{Manifestation}, \abilitytag{Sustain} (minor)}
            ...
            Its \glossterm{hit points} and \glossterm{damage resistance} are equal to the standard value for your level (see \tref{Character Advancement}).
