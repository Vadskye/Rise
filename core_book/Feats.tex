...
\end{longtablewrapper}
    ...
    \begin{feat}{Rapid Reaction}{General}
        ...
        \ff[15]{Greater Evasive Reaction} You can use your Reflex defense with a \minus4 penalty in place of any other defense against abilities that affect an area.
