...
\end{longtabuwrapper}
    ...
    \begin{feat}{Intimidate Specialization}{Skill}
        ...
        \ff[13]{Supreme Demoralize} When you use the \textit{demoralize} ability, each target is \frightened by you instead of being shaken.

        \ff[16]{Supreme Specialization} The bonus from your \textit{specialization} ability increases to \plus9.

        \ff[19]{Fearsome Foe} You gain a \plus1 bonus to your \glossterm{overwhelm value}.
    \end{feat}
    ...
    \begin{feat}{Iron Will}{General}
        ...
        In addition, the \glossterm{focus penalty} reduction increases to 2.
        ...
        In addition, the \glossterm{focus penalty} reduction increases to 3.
    \end{feat}
    ...
    \begin{feat}{Leadership}{Combat}
        ...
        \begin{freeability}{Battle Command}[\glossterm{Swift}]
            ...
            \rankline
            \featlevel{7} The target also gains a \plus1 bonus to \glossterm{accuracy} with the attack.
        ...
        \ff[16]{Sustaining Presence} Your \glossterm{allies} within a \arealarge \glossterm{emanation} from you gain a \plus2 bonus to \glossterm{wound rolls}.
    ...
    \begin{feat}{Martial Training}{Combat}
        ...
        \begin{itemize}
            \item You gain proficiency with a category of \glossterm{armor}: light, medium, or heavy body armor, or shields.
    ...
    \begin{feat}{Mental Magic}{Casting, Magical}
        ...
        \ff[4]{Focused Mind} You reduce your \glossterm{focus penalty} by 1.
        ...
        \ff[13]{Focused Mind} The penalty reduction from your \textit{innate focus} ability increases to 2.
    ...
    \begin{feat}{Mystic Archer}{Casting}
        ...
        \begin{freeability}{Imbued Shot}[\glossterm{Magical}]
            ...
            \featlevel{13} The accuracy bonus increases to \plus2.
            \featlevel{19} The accuracy bonus increases to \plus3.
        \end{freeability}

        \ff[4]{Guided Projectiles}[Magical] Your attacks with projectiles ignore \glossterm{cover}, but not \glossterm{total cover}.

        \ff[7]{Imbue Projectile} When you cast a spell that affects a single target and does not have the \glossterm{AP}, \glossterm{Attune}, or \glossterm{Sustain} tags,
        ...
        \begin{attuneability}{Imbue Projectile}[\glossterm{Attune} (self), \glossterm{Magical}]
            ...
            If you use your \textit{imbued shot} ability to attack with that projectile, the spell takes effect on the target of your \textit{imbued shot} ability.
        ...
        \begin{attuneability}{Imbue Detonating Projectile}[\glossterm{Attune} (self), \glossterm{Magical}]
            ...
            % TODO: clarify how to choose which corner things take effect in
            If you use your \textit{imbued shot} ability to attack with that projectile, the spell takes effect centered on the target of your \textit{imbued shot} ability.
            After the spell takes effect this way, your attunement to the ability that imbued that projectile ends.
            The next time you take a \glossterm{short rest}, you regain the \glossterm{action point} you spent to attune to that ability.
        \end{attuneability}
        ...
        \ff[19]{Powerful Imbuement} You gain a \plus2 bonus to \glossterm{power} with spells that you store with your \textit{imbue projectile} and \textit{imbue detonating projectile} abilities.
    \end{feat}
    ...
    \begin{feat}{Regenerator}{General}
        ...
        \ff[1]{Diehard} You gain a \plus2 bonus to \glossterm{wound rolls}.
        ...
        \begin{freeability}{Regenerative Recovery}
            ...
            \featlevel{19} You may use this ability a number of times equal to twice your starting Constitution.
        \end{freeability}
        ...
        \ff[16]{Enduring Constitution} You gain a \plus1 bonus to your starting Constitution.
    ...
    \begin{feat}{Sense Motive Specialization}{Skill}
        ...
        This ability does not work if the creature is using the Bluff skill in any way, even if it is speaking the truth.
