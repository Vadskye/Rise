...
\end{longtablewrapper}
    ...
    \begin{feat}{Spellwarped}{General, Magical}
        ...
        \ff[4]{Spell} You learn one rank 1 \glossterm{spell} from your chosen \glossterm{mystic sphere}.
        ...
        \ff[7]{Spell Rank} You gain the ability to cast rank 3 spells from your chosen \glossterm{mystic sphere}.

        \ff[10]{Spell Rank} You gain the ability to cast rank 4 spells from your chosen \glossterm{mystic sphere}.

        \ff[13]{Spell Rank} You gain the ability to cast rank 5 spells from your chosen \glossterm{mystic sphere}.

        \ff[16]{Spell Rank} You gain the ability to cast rank 6 spells from your chosen \glossterm{mystic sphere}.

        \ff[19]{Spell Rank} You gain the ability to cast rank 7 spells from your chosen \glossterm{mystic sphere}.
    \end{feat}
