...
\end{longtablewrapper}
    ...
    \begin{feat}{Brawler}{Combat}
        ...
        \ff[1]{Unarmed Warrior} You gain a \plus1 bonus to accuracy and a \plus1d bonus to damage with the punch/kick \glossterm{natural weapon} (see \pcref{Natural Weapons}).
