...
\end{longtablewrapper}
    ...
    \begin{feat}{Sphere Focus: Astromancy}{Casting, Magical}
        ...
        \ff[7]{Personal Translocation} You can use the \textit{personal translocation} ability as a \glossterm{move action}.
        ...
        \ff[13]{Astral Spell Transit} You double your range with abilities from the \sphere{Astromancy} \glossterm{mystic sphere}.

        \ff[16]{Spell} You learn a spell from the \sphere{Astromancy} \glossterm{mystic sphere}.
        When you gain access to a new spell level, you can change which spell you know from that mystic sphere.

        \ff[19]{Greater Astral Spell Transit} When determining whether you have \glossterm{line of effect} to a particular location with abilites from the \sphere{Astromancy} \glossterm{mystic sphere}, you can ignore all physical obstacles in a single five-foot span.
