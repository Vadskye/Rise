...
\end{longtabuwrapper}
    ...
    \begin{feat}{Regenerator}{General}
        ...
        \ff[2]{Diehard} You reduce your penalties from \glossterm{vital damage} by an amount equal to one quarter of your maximum hit points.
        ...
        \ff[18]{Indestructible} The penalty reduction from your \textit{diehard} ability increases to be equal to three quarters of your maximum hit points.
    \end{feat}
