...
\end{longtabuwrapper}
    ...
    \begin{feat}{Acrobatics Specialization}{Skill}
        ...
        \begin{freeability}{Combat Tumble}
            You can move up to your normal movement speed.
            During this movement, you can move through one enemy as if its space was \glossterm{difficult terrain}.
        \end{freeability}
    ...
    \begin{feat}{Agility}{General}
        ...
        \ff[10]{Greater Spring Attack} The damage penalty from your \textit{spring attack} ability is removed.
        ...
        \ff[16]{Supreme Spring Attack} You gain a \plus1d bonus to damage with your \textit{spring attack} ability.
    ...
    \begin{feat}{Bardic Exemplar}{Magical, Skill}
        ...
        \begin{freeability}{Vicious Mockery}[\glossterm{Emotion}]
            You make a brief performance using one of your Perform skills.
            Make an attack vs. Mental against all enemies within a \arealarge radius from you.
        ...
        \begin{freeability}{Inspire Courage}[\glossterm{Emotion}, \glossterm{Sustain} (minor)]
            You begin a performance using one of your Perform skills.
            Choose a willing creature within \rngmed range.
            The target gains a \plus1 \glossterm{magic bonus} to \glossterm{accuracy} and a \plus2 \glossterm{magic bonus} to Mental defense.
        ...
        \begin{freeability}{Song of Serenity}[\glossterm{Emotion}, \glossterm{Sustain} (minor)]
            You begin a performance using one of your Perform skills.
            Choose a willing creature within \rngmed range.
            The target is immune to hostile \glossterm{Emotion} effects.
            It immediately removes all \glossterm{conditions} caused by \glossterm{Emotion} effects.
    ...
    \begin{feat}{Boongiver}{Casting, Magical}
        ...
        \ff[4]{Benevolent Transferance} You can use the \textit{benevolent transferance} ability as a \glossterm{standard action}.
        ...
        \ff[13]{Rapid Transferance} You can use your \textit{benevolent transferance} ability as a \glossterm{minor action}.
    ...
    \begin{feat}{Celestial Heritage}{Bloodline, Magical}
        ...
        \ff[10]{Greater Holy Smite} The damage bonus from your \textit{holy smite} ability increases to \plus2d.
        ...
        \begin{freeability}{Angelic Flight}[Magical]
            ...
            In addition, you take \glossterm{subdual damage} equal to your level.
        \end{freeability}

        \ff[16]{Supreme Holy Smite} The damage bonus from your \textit{holy smite} ability increases to \plus3d.
    ...
    \begin{feat}{Devices Specialization}{Skill}
        ...
        \ff[4]{Rapid Improvisation} It takes you only five rounds to make a device of up to Tiny size with the \textit{improvise} ability (see \pcref{Improvise}).

        % TODO: wording
        \ff[7]{Lesser Disable Arcana}[Magical] You can affect spell effects on objects or areas with the Devices skill as if they were merely complex devices.
        ...
        The DR to affect an arcane spell effect is equal to 15 \add the effect's \glossterm{power}.

        \ff[10]{Greater Specialization} The bonus from your \textit{specialization} ability increases to \plus4.

        \ff[13]{Greater Rapid Improvization} It takes you only a standard action to make a device of up to Tiny size with the \textit{improvise} ability (see \pcref{Improvise}).

        \ff[16]{Supreme Specialization} The bonus from your \textit{specialization} ability increases to \plus6.

        \ff[19]{Greater Disable Arcana}[Magical] You can affect all magical effects on objects or areas with the Devices skill, not just spell effects.
    \end{feat}
    ...
    \begin{feat}{Duelist}{Combat}
        ...
        \ff[10]{Greater Focused Strike} The accuracy bonus from your \textit{focused strike} ability increases to \plus2.
        ...
        \ff[16]{Supreme Focused Strike} The damage bonus from your \textit{focused strike} ability increases to \plus2d.
    ...
    \begin{feat}{Executioner}{Combat}
        ...
        \begin{freeability}{Execution}
            ...
            If the target is \glossterm{bloodied}, you gain a \plus1 bonus to \glossterm{accuracy} and a \plus1d bonus to damage with the strike.
        \end{freeability}
        ...
        \ff[10]{Greater Execution} The accuracy bonus from your \textit{execution} ability increases to \plus2.
        ...
        \ff[16]{Supreme Execution} The damage bonus from your \textit{execution} ability increases to \plus2d.
    ...
    \begin{feat}{Guardian}{Combat}
        ...
        \ff[10]{Redirection}[Magical] When you use your \textit{protect} ability, you can also choose to suffer all effects from \glossterm{strikes} that hit the target in place of the target until the end of the round.
    ...
    \begin{feat}{Heal Specialization}{Skill}
        ...
        \begin{freeability}{Healing Touch}[\glossterm{Life}, \glossterm{Magical}]
            Make a Heal check on a willing creature within your \glossterm{reach}.
            The target is healed for \glossterm{standard damage} \minus1d.
            Your \glossterm{power} with this ability is equal to your bonus with the Heal skill.
        \end{freeability}
    ...
    \begin{feat}{Jump Specialization}{Skill}
        ...
        \ff[7]{Featherlight Leap} You can use the \textit{featherlight leap} ability as a \glossterm{free action}.
        ...
        \ff[13]{Greater Featherlight Leap} You do not take damage from using your \textit{featherlight leap} ability.
    ...
    \begin{feat}{Leadership}{Combat}
        ...
        \begin{freeability}{Bolster}[\glossterm{Emotion}]
            Choose any number of willing creatures other than yourself within an \areamed radius from you.
            Each target can remove one \glossterm{condition} of its choice.
        \end{freeability}

        \ff[7]{Commanding Presence} You gain a \plus2 bonus to the Intimidate and Persuasion skills.

        \ff[10]{Greater Bolster} The area affected by your \textit{bolster} ability increases to a \arealarge radius.
        ...
        \ff[16]{Supreme Bolster} The area affected by your \textit{bolster} ability increases to a \areahuge radius.
    ...
    \begin{feat}{Martial Training}{Combat}
        ...
        \ff[4]{Trained Strike} You can use the \textit{trained strike} ability as a standard action.
        ...
        \ff[10]{Greater Trained Strike} The accuracy bonus from your \textit{trained strike} ability increases to \plus2.
        ...
        \ff[16]{Supreme Trained Strike} The accuracy bonus from your \textit{trained strike} ability increases to \plus3.
    ...
    \begin{feat}{Mystic Archer}{Casting}
        ...
        \ff[1]{Guided Projectiles}[Magical] Your attacks with projectiles ignore \glossterm{cover}, but not \glossterm{total cover}.

        \ff[4]{Imbue Projectile} When you cast a spell that affects a single target and does not have the \glossterm{AP}, \glossterm{Attune}, or \glossterm{Sustain} tags,
        ...
        \begin{freeability}{Imbued Shot}
            As a standard action, you can make a ranged \glossterm{strike} using a projectile you have imbued with the \textit{imbued projectile} or \textit{imbue detonating projectile} ability.
            ...
            The next time you take a \glossterm{short rest}, you regain the \glossterm{action point} you spent to attune to that ability.
        \end{freeability}
        ...
        \ff[10]{Phasing Projectiles}[\glossterm{Magical}, \glossterm{Teleportation}] When attacking with projectiles, you can ignore all physical obstacles in single one-foot span.
        ...
        \ff[13]{Imbue Detonating Projectile} When you cast a spell that affects an area and does not have the \glossterm{AP}, \glossterm{Attune}, or \glossterm{Sustain} tags,
            you can use the \textit{imbue detonating projectile} ability.
        \begin{attuneability}{Imbue Detonating Projectile}[\glossterm{Attune} (self), \glossterm{Magical}]
        ...
        \ff[19]{Greater Phasing Projectiles}[\glossterm{Magical}, \glossterm{Teleportation}] Your \textit{phasing projectiles} ability improves, allowing you to ignore obstacles in up to five one-foot spans.
    ...
    \begin{feat}{Perform Specialization}{Skill}
        ...
        \begin{freeability}{Mesmerizing Performance}[\glossterm{Emotion}, \glossterm{Sustain} (minor)]
            You begin a performance using one of your Perform skills.
        ...
        \begin{freeability}{Inspiring Performance}[\glossterm{Emotion}, \glossterm{Sustain} (minor)]
            You begin a performance using one of your Perform skills.
            One other willing creature within \rngmed range gains a \plus2 \glossterm{magic bonus} to \glossterm{checks}.
        ...
        \begin{freeability}{Mesmeric Suggestion}[\glossterm{Emotion}, \glossterm{Subtle}, \glossterm{Sustain} (minor)]
    ...
    \begin{feat}{Precognition}{Combat}
        ...
        \ff[10]{Greater Precognitive Strike} You gain a \plus1d bonus to damage with your \textit{precognitive strike} ability.
        ...
        \ff[16]{Precognitive Defense} You gain a \plus1 bonus to Armor defense.

        \ff[19]{Supreme Precognitive Strike} When you use your \textit{precognitive strike} ability, you also compare your attack result against the target's Mental defense.
    ...
    \begin{feat}{Sense Motive Specialization}{Skill}
        ...
        \begin{freeability}{Read Mind}[\glossterm{Emotion}, \glossterm{Sustain} (minor)]
            ...
            This grants you a \plus5 bonus to Bluff, Persuasion, and Intimidate attacks and checks against the target.
        \end{freeability}
    ...
    \begin{feat}{Sleight of Hand Specialization}{Skill}
        ...
        \begin{freeability}{Extradimensional Retrieval}
    ...
    \begin{feat}{Spellsword}{Spell}
        ...
        \ff[4]{Imbue Weapon} When you cast a spell that affects a single target and does not have the \glossterm{AP}, \glossterm{Attune}, \glossterm{Sustain} tags,
        ...
        \begin{freeability}{Imbued Strike}
            As a standard action, you can make a melee \glossterm{strike} using a weapon you have imbued with the \textit{imbue weapon} ability.
            If you do, the spell affects the target of the strike.
    ...
    \begin{feat}{Sphere Focus: Telekinesis}{Casting, Magical}
        ...
        \begin{freeability}{Telekinetic Strike}[Magical]
            Make a \glossterm{magical strike} with a weapon you are controlling using the \spell{distant hand} cantrip.
        \end{freeability}
    ...
    \begin{feat}{Two-Weapon Fighting}{Combat}
        ...
        In addition, the damage bonus increases to \plus3d.
