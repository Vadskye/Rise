...
\end{longtabuwrapper}
    ...
    \begin{feat}{Guardian}{Combat}
        ...
        \ff[19]{Greater Protect} When you use your \textit{protect} ability, you may target any number of your \glossterm{allies} adjacent to you.
    \end{feat}
    ...
    \begin{feat}{Heal Specialization}{Skill}
        ...
        \begin{freeability}{Healing Touch}[\glossterm{Life}]
            Make a Heal check on an \glossterm{ally} within your \glossterm{reach}.
        ...
        \begin{freeability}{Purging Touch}
            Make a Heal check on an \glossterm{ally} you can touch.
    ...
    \begin{feat}{Leadership}{Combat}
        ...
        \begin{freeability}{Battle Command}[\glossterm{Swift}]
            Choose an \glossterm{ally} within \rngmed range of you.
        ...
        In addition, the ability can also target you.
        ...
        \ff[16]{Supreme Bolster} Each target of your \textit{bolster} ability can remove two conditions instead of one.
    ...
    \begin{feat}{Metacaster}{Casting, Magical}
        ...
        \ff[4]{Blend Damage} Whenever you cast a spell that deals damage, you can change the type of damage it deals based on the \glossterm{mystic spheres} you have access to.
        ...
        \begin{dtable}
            ...
            \begin{dtabularx}{\columnwidth}{l >{\lcol}X}
                ...
                Chronomancy & \tdash \\
                Compel & \tdash \\  % TODO: probably add psychic damage
                Corruption & Life \\
                Cryomancy & Cold \\
                Delusion & \tdash \\
                ...
                Glamer & \tdash \\
                Photomancy & \tdash \\  % TODO: Maybe add solar damage??
                Polymorph & Physical \\
                Pyromancy & Fire \\
                Revelation & \tdash \\
                Summon & \tdash \\
        ...
        \ff[10]{Blend Conditions} When you cast a spell that inflicts a \glossterm{condition} with a standard effect, you can change that effect to another effect of the same rank.
        ...
        \begin{dtable}
            ...
            \begin{dtabularx}{\columnwidth}{l >{\lcol}X}
                \tb{Rank} & \tb{Condition effects}
                1 & Dazed, fatigued, ignited, sickened, slowed \\
        ...
        \ff[16]{Greater Blend Damage} When you cast a spell that deals damage, you can change the damage type to have any combination of damage types provided by the \glossterm{mystic spheres} you have access to and the original spell's damage type.
    ...
    \begin{feat}{Perform Specialization}{Skill}
        ...
        \begin{freeability}{Inspiring Performance}[\glossterm{Emotion}, \glossterm{Sustain} (minor)]
            You begin a performance using one of your Perform skills.
            One \glossterm{ally} within \rngmed range gains a \plus2 \glossterm{magic bonus} to \glossterm{checks}.
    ...
    \begin{feat}{Sphere Focus: Weaponcraft}{Casting, Magical}
        ...
        \begin{freeability}{Disable Weapon}[\glossterm{Swift}]
            ...
            Since this ability has the \glossterm{Swift} tag, you can use this ability to prevent the weapon from attacking you or your \glossterm{allies} in the current phase.
        \end{freeability}
