...
\end{longtablewrapper}
    ...
    \begin{feat}{Deception Specialization}{Skill}
        ...
        \begin{attuneability}{Undetectable Lies}
    ...
    \begin{feat}{Ghostblade}{Combat, Magical}
        ...
        \begin{activeability}{Spectral Reap}
            \abilitytag{Magical}
            \rankline
    ...
    \begin{feat}{Herbalist}{Skill}
        ...
        \begin{attuneability}{Tempting Concoction}
            \abilitytag{Emotion}, \glossterm{Magical}, \abilitytag{Subtle}
            \rankline
    ...
    \begin{feat}{Sniper}{Combat}
        ...
        \begin{sustainability}{Aim}[\abilitytag{Sustain} (minor)]
            \abilitytag{Subtle}
            \rankline
    ...
    \begin{feat}{Telepath}{General, Magical}
        ...
        \begin{sustainability}{Read Mind}[\abilitytag{Sustain} (standard)]
