...
\end{longtabuwrapper}
    ...
    \begin{feat}{Sphere Focus: Vivimancy}{Casting, Magical}
        ...
        \ff[1]{Vivimancy Focus} You gain a \plus1 bonus to \glossterm{accuracy} with abilities from the \sphere{vivimancy} \glossterm{mystic sphere}.

        \ff[4]{Lifebind} Whenever you deal damage to a living creature using a spell from the \sphere{vivimancy} \glossterm{mystic sphere}, you can choose to bind the target's life force to yours.
        ...
        \ff[7]{Spell} You learn a spell from the \sphere{vivimancy} \glossterm{mystic sphere}.
        When you gain access to new spell levels, you can change which spell you know from that \glossterm{mystic sphere}.
