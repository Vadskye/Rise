...
\cf{Ftr}{Bonus Feats} The fighter gains an additional bonus feat at 10th level and every four fighter levels thereafter (10th, 14th, and 18th).
...
\cf{rgr}{Ranger Lore} At 9th level, and every three levels thereafter, the ranger gains an additional ranger lore.
...
\cf{Rgr}{Favored Terrain (Planar) (Ex)} After 10th level, and every four levels thereafter, may gain a new favored terrain. He may choose any plane as a favored terrain in addition to his normal options. He is immune to any hostile planar effects from any plane he has chosen as favored terrain. In addition, he gains a \plus2 competence bonus to Knowledge checks relating to the plane and is always treated as trained in Knowledge (planar) for the purpose of such checks.
...
\cf{Wiz}{Spells} A wizard gains additional spells as she increases in level.
