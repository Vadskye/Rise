...
\spellmat{You must place a black onyx gem worth at least 10 gp per level of the undead to be created into the mouth or eye socket of each corpse you intend to animate. The magic of the ritual turns these gems into worthless, burned-out shells.}
...
\begin{spelltarget}{One pint of water}
    \spelleffect The target becomes holy water. Large bodies of water can be made holy by performing this ritual multiple times.
\end{spelltarget}
...
\end{spelltarget}
\spellmat{One ounce of fresh flesh or blood that belongs to the target.}
...
\spellmat{300 gp in black onyx gems}.
\ritualcost{5}
