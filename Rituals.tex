...
\spelldur{Instantaneous}
\spelldef{Fortitude negates (object)}
\spellsr{Yes (Fortitude)}
\begin{spelleffect}
...
\spelldur{\durext}
\spelldef{None or Will disbelief (if interacted with); see text}
\spellsr{No}
\begin{spelleffect}
...
\end{spelleffect}
\spellfocus{The chest (which costs 2,500 gp) and its replica (which costs 50 gp).}
...
\spelldur{Thirty days (D)}
\spelldef{None or Will negates (object)}
...
\spelldur{Instantaneous}
\spelldef{None and Will negates (object)}
\spellsr{Yes (Will)}
\begin{spelleffect}
...
\spelltgts{You and up to four touched creatures}
\spelldur{\durext (D); see text}
\spelldef{No and Will negates (harmless)}
