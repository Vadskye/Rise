...
\spelltabular
\spellinfo{Conjuration/Necromancy (Creation, Soul) [Planar]}{Arcane, Divine}
\spelltime{1 hour}
\spelltwocol{\spelltgts{You plus one additional willing creature touched per two caster levels}}{\spellrng{Touch}}
\spelldur{See text}
\spellsr{Yes (Fortitude)}
\spellattack{None}
\end{tabularx}
...
\spelltabular
\spellinfo{Transmutation (Imbuement) [Magic]}{Divine}
\spelltime{10 minutes}
\spellcmp{Verbal, Somatic, Focus}
\spelltwocol{\spelltgt{Wooden quarterstaff touched}}{\spellrng{Touch}}
\spelldur{Permanent until discharged \dismissable}
\spellsr{Yes (Will)}
\spellattack{Will negates (object)}
\end{tabularx}
