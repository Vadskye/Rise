...
\spelldur{Instantaneous}
\spellsr{Yes (Will)}
\spellattack{Will negates (harmless)}
\begin{spelleffect}
...
\spelldur{Instantaneous}
\spellsr{Yes (Will)}
\spellattack{Will negates (harmless, object)}
\begin{spelleffect}
...
\spelldur{\durext (D)}
\spellsr{Yes (harmless)}
\spellattack{Fortitude negates (harmless)}
\begin{spelleffect}
...
\spellattack{No and Will negates (harmless)}
\begin{spelleffect}
