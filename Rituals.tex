...
\spellschool{Transmutation (Alteration)}
\spellskill{Craft (any), Engineering}
\spelllvl{Arcane 5}
\spelltime{See text}
\spellrng{\rngclose}
...
\spellschool{Divination (Knowledge)}
\spellskill{Craft (traps), Engineering, Perception}
...
\spellsection{Shape Metal}
\spellschool{Transmutation (Alteration)}
\spellskill{Craft (metal)}
\spelllvl{Arcane 4, Divine 4}
\begin{spelleffect}
    This ritual functions like \spell{shape wood}, except that it requires Craft (metal) and shapes metal instead of wood. 
\end{spelleffect}

\spellsection{Shape Stone}
\spellschool{Transmutation (Alteration) [Earth]}
\spellskill{Craft (stone)}
\spelllvl{Arcane 3, Divine 3}
\begin{spelleffect}
    This ritual functions like \spell{shape wood}, except that it requires Craft (stone) and shapes stone instead of wood.
\end{spelleffect}

\spellsection{Shape Wood}
\spellschool{Transmutation (Alteration)}
\spellskill{Craft (wood)}
\spelllvl{Arcane 2, Divine 2}
\spelltime{10 minutes}
\spellrng{Touch}
\spelltgt{Nonmagical wood touched, affecting up to 10 cubic feet}
\spelldur{Instantaneous}
\spellsave{No}
\spellsr{Yes (Fortitude)}
\begin{spelleffect}
    You use the Craft check required to perform this ritual to shape an existing piece of wood, or part of a larger piece of wood, to suit your purposes. You gain a \plus10 enhancement bonus on the check, and you need no additional tools, but you can only affect wood.
\end{spelleffect}
