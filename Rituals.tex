...
\longcol{\spelltime{1 minute}} \\
\spellarea{Up to ten 10-foot cubes} & \spellrng{\rngclose} \\
\spelldur{One week \dismissable}
\spellsr{No}
\spellattack{None}
\end{tabularx}
...
\spellschool{Transmutation (Alteration)} & \spelllists{Arcane, Divine, Nature} \\
\longcol{\spelltime{10 minutes}} \\
\spellarea{One 5-foot cube per three caster levels} & \spellrng{Touch} \\
\spelldur{\durext \dismissable}
\spellsr{No}
\spellattack{None}
\end{tabularx}
...
\longcol{\spelltime{1 minute}} \\
\longcol{\spellarea{\areamed radius immobile emanation centered on you}} \\
\spelldur{\durext \dismissable}
\spellsr{No}
\spellattack{None}
\end{tabularx}
