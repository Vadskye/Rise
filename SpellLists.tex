...
\begin{spelllist}
  ...
  \spellhead{Minor Image} As \spell{silent image}, plus some sound.
...
\begin{spelllist}
  ...
  \spellhead[4]{Order's Wrath} Bewilders and deals 4d6 damage to nonlawful creatures.
  \spellheadc[5]{Command}{Mass} As \spell{command}, but affects multiple creatures.
...
\begin{spelllist}
  ...
  \spellhead[8]{Protection from Spells} Subject gains spell resistance and \plus5 to saves vs spells.
...
\begin{swspelllist}
  ...
  \spellhead{Moment of Prescience} Roll twice with bonus for single attack, save, or opposed check.
  \spellheadrestricted{}
...
\begin{swspelllist}
  \spellhead[Abjur]{Protection from Spells}\M\F Subject gains spell resistance and \plus5 to saves vs spells.
  \spellheadc{Spell Immunity}{Greater} As spell immunity, but up to 8th-level spells.
