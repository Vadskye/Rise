...
Most spells on the sorcerer/wizard spell list are common spells, and are freely available to all sorcerers and wizards. If a spell's name is italicized, it is a restricted spell. Restricted spells can only be learned by certain sorcerer and wizard class features, and are not generally available. See the class descriptions for more details.
...
\begin{swspelllist}
  ...
  \spellheadc[Evoc]{Combat Telekinesis} Attack with weapon telekinetically.
