...
\begin{spelllist}
  \spellhead{Confusion} Subject acts randomly.
...
\begin{spelllist}
  \spellhead{Analyze Dweomer}\F Reveals all magical aspects of subjects.
...
\begin{spelllist}
  ...
  \spellhead{Cure Light Wounds} Cures 2d8 damage.
  \spellhead{Delay Poison} Stops poison from harming subject.
...
\begin{spelllist}
  ...
  \spellhead{Hold Person} Paralyzes one humanoid for short duration.
  \spellhead{Inflict Moderate Wounds} Touch deals 4d8 damage.
...
\begin{spelllist}
  ...
  \spellhead{Inflict Serious Wounds} Touch deals 6d8 damage.
...
\begin{spelllist}
  ...
  \spellhead{Inflict Critical Wounds} Touch deals 8d8 damage.
...
\begin{spelllist}
  ...
  \spellhead{Circle of Death}\M Kills 2/level HV of creatures.
  \spellheadc{Cure Moderate Wounds}{Mass} Cures 6d6 damage for many creatures.
  \spellheadc{Dispel Magic}{Greater} As dispel magic, but up to \plus20 on check.
...
\begin{spelllist}
  ...
  \spellhead[3]{Call Lightning} Calls down lightning bolts (3d6 per bolt) from sky.
  ...
  \spellheadc[5]{Call Lightning}{Greater} As \spell{call lightning}, but 5d6 damage per bolt.
  \spellheadc[5]{Windstrike}{Greater} Wind moves and bludgeons target for 10d6 damage.
  \spellhead[6]{Chain Lightning} 5d10 damage; secondary targets take half damage.
...
\begin{spelllist}
  ...
  \spellhead[4]{Chaos Hammer} Bewilders, deals 4d6 damage to nonchaotic creatures.
  ...
  \spellhead[6]{Insanity} Subject acts randomly indefinitely.
...
\begin{spelllist}
  ...
  \spellhead[4]{Enervation} Subject gains two negative levels.
...
\begin{spelllist}
  ...
  \spellhead[2]{}
  \spellhead[3]{Detect Thoughts} Allows ``listening'' to surface thoughts.
  \spellhead[4]{Locate Creature}
  \spellheadc[4]{Moment of Prescience}{Lesser}
  \spellhead[5]{True Seeing}
  \spellhead[6]{Analyze Dweomer}  Reveals all magical aspects of subjects.
  \spellhead[6]{Locate Entity}
  \spellheadc[7]{Arcane Sight}{Greater}You perceive spells and magical auras effortlessly.
  \spellhead[7]{Moment of Prescience}
  \spellheadc[8]{Detect Thoughts}{Greater} Allow ``listening'' to surface thoughts without concentration.
  \spellhead[8]{}
...
\begin{spelllist}
  ...
  \spellhead[2]{Ablative Shield} Immediately reduce damage from foes' spells.
  ...
  \spellhead[4]{Ablative Fortress} Immediately reduce damage from foes' spells in area.
  ...
  \spellhead[6]{Analyze Dweomer}\F Reveals all magical aspects of subjects.
...
\begin{spelllist}
  ...
  \spellhead[5]{Dimension Door} Teleports you within 1,000 feet.
...
\begin{spelllist}
  ...
  \spellhead[7]{}
  \spellheadc[8]{Confusion}{Mass} Multiple subjects act randomly.
  \spellhead[8]{Reverse Gravity} Objects and creatures fall upward.
...
\begin{spelllist}
  ...
  \spellhead[1]{Inflict Light Wounds} Touch deals 2d8 damage.
  \spellhead[2]{Cure Moderate Wounds} Cures 4d8 damage.
  \spellhead[2]{Inflict Moderate Wounds} Touch deals 4d8 damage.
  \spellhead[3]{Cure Serious Wounds} Cures 6d8 damage.
  \spellhead[3]{Inflict Serious Wounds} Touch deals 6d8 damage.
  \spellhead[4]{Cure Critical Wounds} Cures 8d8 damage.
  \spellhead[4]{Inflict Critical Wounds} Touch deals 8d8 damage.
  ...
  \spellheadc[9]{Heal}{Mass} As \spell{heal}, but heals 9d6 for many subjects.
  \spellheadc[9]{Harm}{Mass} As \spell{harm}, but inflicts 9d6 to many subjects.
\end{spelllist}
...
\begin{spelllist}
  ...
  \spellhead[5]{Ice Storm} Hail deals 4d4 damage in small cylinder.
  \spellhead[5]{Wall of Ice} Create plane of ice or hemisphere can trap creatures inside.
  \spellhead[6]{Cone of Cold} 5d6 cold damage and fatigue in medium cone.
...
\begin{spelllist}
  \spellhead{Call Lightning} Calls down lightning bolts (3d6 per bolt) from sky.
  \spellhead{Contagion} Infects subject with chosen disease.
...
\begin{spelllist}
  ...
  \spellheadc{Call Lightning}{Greater} As call lightning, but 5d6 damage per bolt.
...
\begin{swspelllist}
  ...
  \spellhead{Share Pain} Split damage with willing subject.
  \spellheadrestricted{Crush Life} Target takes 2d10 unavoidably.
  \spellheadrestrictedc{Transfer Suffering}{Lesser} Give 4d6 of your damage to touched subject.

  \spellhead[Knock]{Spider Climb} Grants ability to walk on walls and ceilings.
  \spellhead{Totemic Mind} Subject gains \plus2 to Int, Wis, or Cha for medium duration.
  \spellhead{Totemic Power} Subject gains \plus2 to Str, Dex, or Con for medium duration.
...
\begin{swspelllist}
  ...
  \spellhead[Illus]{Invisibility} Subject is invisible until it attacks.
  ...
  \spellhead[Necro]{Bestow Curse} \minus6 to an attribute; \minus4 on attack rolls, saves, checks, and AC; or 25\% chance of losing each action.
  \spellhead{Blindness/Deafness} Makes subject blinded or deafened.
  \spellhead{Contagion} Infects subject with chosen disease.
...
\begin{swspelllist}
  ...
  \spellhead[Necro]{Enervation} Subject gains two negative levels.
...
\begin{swspelllist}
  ...
  \spellheadrestrictedc{Crush Life}{Greater} Target takes 5d10 damage unavoidably and is sickened.
  \spellheadrestricted{}
...
\begin{swspelllist}
  ...
  \spellhead{True Seeing}\M Lets you see all things as they really are.
  \spellheadrestricted{Analyze Dweomer}\F  Reveals all magical aspects of subjects.
  \spellheadrestricted{Moment of Prescience} As lesser moment of prescience, with \plus1/2 levels circumstance bonus.

  \spellhead[Ench]{Insanity} Subject acts randomly indefinitely.
  \spellhead{Power Word Confuse} Suject unavoidably acts randomly.
  ...
  \spellhead{Disintegrate} Deals 12d8 damage, leaving only dust.
  \spellheadc{Telepathic Bond}{Mass} Mental link lets allies communicate.
  \spellheadc{Totemic Mind}{Mass} As \spell{totemic mind}, but affects multiple creatures.
  \spellheadc{Totemic Power}{Mass} As \spell{Totemic power}, but affects multiple creatures.
...
\begin{swspelllist}
  ...
  \spellhead[Conj]{Cloudkill} Fog deals Con damage each round.
  ...
  \spellheadc[Div]{Arcane Sight}{Greater} You perceive spells and magical auras effortlessly.
...
\begin{swspelllist}
  ...
  \spellheadc[Div]{Detect Thoughts}{Greater} Allow ``listening'' to surface thoughts without concentration.
...
\begin{rituallist}
  ...
  \spellhead[Heal]{Remove Disease} Cures all diseases affecting subject.
...
\begin{rituallist}
  ...
  \spellheadc[Planes]{Planar Ally}{Lesser} Exchange services with a 6 HV extraplanar creature.
