...
\spellhead{Haste} Subject moves faster, gets extra attack.
...
\parhead{Greater Channelled Domain Power} You gain a frightful presence for 1 minute, as the dragon ability. The save DC is 10 \add 1/2 turning level \add Charisma modifier.
\parhead{Domain Mastery}
...
%\spellhead{Spellstaff} Stores one spell in wooden quarterstaff.
...
\spellheadrestricted{Ablative Ward} Immediately reduce damage from foes' spells.
...
\spellheadrestricted{Retributive Barrier} Gain DR 5/- that reflects damage at foes.
...
\spellhead{Black Tentacles} Tentacles grapple all within small spread.
...
\begin{swspelllist}
\spellhead[Abjur]{Protection} Protect ally from physical or magical attacks.
\spellhead{Retributive Shield} Damage foes who attack a shielded ally.
\spellhead[Conj]{Conjure Projectile} Summon projectiles that hit a foe for d8 damage.
\spellhead{Acid Orb} Propel a small orb of acid at a foe for d8 damage.
\spellhead[Div]{Premonition} Grant ally temporary combat bonus.
\spellhead{Twist Fate} Know foe's future action and apply penalty of choice.
\spellheadc[Ench]{Confusion}{Lesser} Foe is temporarily confused.
\spellhead{Mind Shackles} Foe believes it is entangled.
\spellhead[Evoc]{Magic Ray} Fire ray of magical energy.
\spellhead{Lesser Telekinesis} Attack with weapon telekinetically.
\spellhead[Illus]{False Foe} Create illusionary creature that acts like an ally.
\spellhead[Necro]{Chill of the Grave} Nauseate weak foe or sicken strong foe.
\spellhead{Draining Touch} Steal life force from touched foe.
...
\spellhead{Make Whole} Repairs an object.
\spellhead[Craft]{Make Whole} Repairs an object.
...
\spellhead[Survival]{Water Breathing} Subjects can breathe underwater.
\end{rituallist}
...
\spellhead{Symbol of Pain} Triggered rune wracks nearby creatures with pain.
\spellhead{Symbol of Sleep} Triggered rune puts nearby creatures into catatonic slumber.
...
\spellhead{Symbol of Fear} Triggered rune panics nearby creatures.
\spellhead{Symbol of Persuasion} Triggered rune charms nearby creatures.
...
\spellhead{Clone}\F Duplicate awakens when original dies.
...
\spellhead{Symbol of Stunning} Triggered rune stuns nearby creatures.
\spellhead{Symbol of Weakness} Triggered rune weakens nearby creatures.
...
\begin{rituallist}
\spellhead[Conj]{Refuge} Alters item to transport its possessor to you.
...
\spellhead{Symbol of Insanity} Triggered rune renders nearby creatures insane.
...
\spellhead[Necro]{Create Greater Undead}\M Creates shadows, wraiths, spectres, or devourers.
\spellhead{Symbol of Death} Triggered rune slays nearby creatures.
\end{rituallist}
