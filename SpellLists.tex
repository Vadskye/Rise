...
\begin{rituallist}
  ...
  \spellhead[Nature]{Fire Trap} Opened object deals fire damage.
...
%\spellhead{Mage's Faithful Hound} Phantom dog can guard, attack.
  ...
  \spellhead[Bluff]{Modify Memory} Alter subject's memories.
...
\begin{rituallist}
  ...
  \spellhead[Nature]{Pass without Trace} Creatures leave no tracks.
  ...
  \spellhead[Survival]{Create Water} Creates pure water.
...
\begin{rituallist}
  \spellhead[Arcana]{Fire Trap} Opened object deals fire damage.
  \spellhead{Remove Curse} Frees object or person from curse.
  \spellheadc[Craft]{Mending}{Greater} Repairs an object.
  \spellhead[Disguise]{Disguise Self}{Greater} Change your appearance at will.
