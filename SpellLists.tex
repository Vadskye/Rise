...
\begin{swspelllist}
  ...
  \spellheadrestricted{Edict} Issue a command that nearby creatures must obey or risk punishment.
...
\begin{spelllist}
  ...
  \spellhead[6]{Edict} Issue a command that nearby creatures must obey or risk punishment.
  \spellhead[6]{Summon Monster VI*} Calls extraplanar creature to fight for you.
  ...
  \spellhead[9]{Prohibition} Punish creatures that take specific action.
  %\spellhead[9]{Imprisonment} Entombs subject beneath the earth.
  \spellhead[9]{Summon Monster IX*} Calls extraplanar creature to fight for you.
\end{spelllist}
