...
\begin{swspelllist}
    ...
    \spellhead{Protection from Alignment} \plus2 to special defenses, \plus4 against chosen alignment.
    \spellhead{Sanctuary} Opponents can't attack subject until it attacks.
    \spellhead*{Ablative Shield} Immediately reduce damage from foes' spells.
    ...
    \spellhead*{Retrieve Object} Teleport an unattended item you can see to your hand.
    ...
    \spellhead*{Forget} A creature forgets something.
    ...
    \spellhead*{Feather Fall} Objects or creatures fall slowly.
  %\spellhead*{Gust of Wind} Blows away or knocks down smaller creatures in large line.
    ...
    \spellhead{Ghoul Touch} Sicken or nauseate creauture.
    \spellhead{Inflict Light Wounds} Deals 2d6 damage.
    \spellhead*{Unliving Heart} Gain 5 temporary HP, treated as undead.
    ...
    \spellhead*{Reduce Person} Humanoid creature halves in size.
\end{swspelllist}
...
\begin{swspelllist}
    ...
    \spellhead*{Ablate Impact} Immediately reduce damage from physical attacks.

    \spellhead[Conj]{Acid Arrow} Ranged touch attack deals 2d8 damage, more over time.
    ...
    \spellhead*{Retrieve Ally} Teleport willing creature next to you.
    ...
    \spellhead*{Foresee Probability} Know creature's next die results.
    ...
    \spellhead{Sound Burst} 2d6 sonic damage in a small radius.
    \spellhead*{Knock} Opens locked or magically sealed door.

    \spellhead[Illus]{Blur} Subject is harder to see.
    \spellhead{Mirror Image} Creates decoy duplicates of you.
    \spellhead{Phantasmal Wound} Subject believes it is grievously wounded.
    \spellhead*{Silent Image} Creates minor illusion of your design.

    \spellhead[Necro]{Blindness/Deafness} Creature is blinded or deafened.
    \spellhead{Inflict Moderate Wounds} Deals 4d6 damage.
    \spellhead{Share Pain} Split damage with willing subject.
    \spellhead*{Death Knell} Gain temporary HP when subject dies.
...
\begin{swspelllist}
    ...
    \spellhead{Protection from Energy} Reduce damage from one kind of energy.
    \spellhead{Share Pain}[Forced] Split damage with unwilling subject.
    \spellhead*{Deflection} Gain \plus2 to physical defenses.
    ...
    \spellhead*{Dimension Slide} Teleports nearby creature short distance.

    \spellhead[Div]{Locate Object}[Greater] Senses direction toward distant visualized objects.
    \spellhead{Read Mind} Learn a creature's surface thoughts.
    \spellhead{Unliving Eyes} Grants lifesight ability.
    \spellhead*{Moment of Prescience}[Lesser] Roll twice for single attack, save, or opposed check.
    ...
    \spellhead*{Telekinetic Maneuver} Telekinetically dirty trick, disarm, grapple, shove, trip your target.
  ...
  %\spellhead{Ray of Exhaustion} Ray makes subject exhausted.
    \spellhead{Share Pain}[Forced] Split damage with unwilling subject.
    \spellhead{Unliving Eyes} Grants lifesight ability.
    \spellhead*{Link Vitality} Two targets share each others' damage and healing.
    ...
    \spellhead*{Enlarge Person} Humanoid creature doubles in size.

    \spellhead[Univ]{Prismatic Beam} Beam of multicolored light has random effects.
\end{swspelllist}
...
\begin{swspelllist}
    ...
    \spellhead*{Dimension Door} Teleports you within 1,000 feet.

    \spellhead[Div]{Discern Vulnerability} Quickly find weaknesses in foe's defenses.
    \spellhead{Locate Creature}[Greater] Senses direction toward distant visualized creatures.
    \spellhead{Moment of Prescience}[Lesser] Roll twice for single attack, save, or opposed check.
    \spellhead*{Precognition} See into the future to gain combat bonuses.
    ...
    \spellhead{Sleep}[Mass] Tire multiple creatures, possibly putting them to sleep.
    \spellhead*{Suggestion} Compels subject to follow stated course of action.

    \spellhead[Evoc]{Ice Storm} Hail deals 4d4 damage in small cylinder.
    ...
    \spellhead*{Telekinetic Force} Move things with your your mind.
    ...
    \spellhead[Necro]{Enervation} Inflict three negative levels.
    \spellhead{Inflict Critical Wounds} Deals 8d6 damage.
    \spellhead{Retributive Shield} Grants DR 8 that reflects damage at foes.
    \spellhead*{Bestow Curse} \minus6 to an attribute; \minus4 on attack rolls, saves, checks, and AC; or 25\% chance of losing each action.

    \spellhead[Trans]{Alter Weapon}[Greater] Change weapon dramatically.
    \spellhead{Fly} Subject flies at speed of 30 ft.
    \spellhead{Invest Magic} All of subject's equipment is magical.
    \spellhead{Stoneskin} \plus3 AC, ignore 8 damage per round.
...
\begin{swspelllist}
    ...
    \spellhead{Fire Shield} Creatures attacking you take damage; you're protected from heat or cold.  \spellhead{Resist Energy}[Greater] As \spell{resist energy}, but all energy types.
    ...
    \spellhead*{Spelltheft} As \spell{dispel magic}, but you gain the effects of dispelled spells.

    \spellhead[Conj]{Acid Arrow}[Greater] As acid arrow, but 5d8 damage initially and more over time.
    ...
    \spellhead*{Retrieve}[Greater] Teleport an item you can see to your hand.
    ...
    \spellhead*{Manipulate Probability} Control creature's next die results.

    \spellhead[Ench]{Fear} Subjects within medium cone flee for short duration.
    \spellhead{}
    \spellhead{Phantasmal Maze} Subject acts as if affected by \spell{maze}.
    ...
    \spellhead{Fire Shield} Creatures attacking you take damage; you're protected from cold.
    \spellhead{Resilient Sphere} Force globe protects but traps one creature or object.
    \spellhead*{Telekinetic Thrust} Hurl objects with the force of your mind.

    \spellhead[Illus]{Mirror Image}[Greater] Creates regenerating decoy duplicates of you.
    \spellhead{Phantasmal Maze} Subject acts as if affected by \spell{maze}.
    \spellhead{Retributive Brilliance} Subject can dazzle or blind attacker once.
    \spellhead*{}

    \spellhead[Necro]{Inflict Light Wounds}[Mass] Deals 5d6 damage to many creatures.
    \spellhead{Waves of Fatigue} Creatures in large cone become fatigued.
    \spellhead*{Drain Life} Deals 10d6 damage and steals life.

    \spellhead[Trans]{Delay Damage} Take half damage now and half later. 
    \spellhead{Totemic Mind}[Greater] Subject gains \plus4 to Int, Wis, or Cha.
    \spellhead{Totemic Power}[Greater] Subject gains \plus4 to Str, Dex, or Con.
    \spellhead{Wall of Stone} Creates a stone wall that can be shaped.
  %\spellhead*{Animate Objects} Objects attack your foes.
    \spellhead*{Reduce Person}[Mass] Reduces several creatures.

    \spellhead[Univ]{Prismatic Wall} Multicolored wall has random effects.
\end{swspelllist}

\subsubsection{6th-level Arcane Spells} 
\begin{swspelllist}
    \spellhead[Abjur]{Banishment} Banish multiple extraplanar creatures. 
    \spellhead{Dispel Magic}[Greater] As dispel magic, but up to \plus20 on check.
    \spellhead{Protection from Energy}[Greater] As \spell{protection from energy}, but against all energy types.
    \spellhead{Repulsion} Creatures can't approach you.
    \spellhead*{Prohibition} Punish creatures that take specific action.
    ...
    \spellhead{Discordant Song} Confuse creatures with sustained music.
    \spellhead*{Charm Person}[Mass] As \spell{charm person}, but affects multiple creatures.
    ...
    \spellhead*{Telekinesis} Moves object, attacks creature, or hurls object or creature.
    ...
    \spellhead*{Persistent Image} As \spell{major image}, but no concentration required.

    \spellhead[Necro]{Cripple} Subject cannot use its limbs. 
    \spellhead{Harm} Touch deals 12d8 damage and 4 Con damage.
    \spellhead{Inflict Moderate Wounds}[Mass] Deals 6d6 damage to many creatures.
    \spellhead*{Link Vitality}[Mass] As \spell{link vitality}, but affects one creature/level.

    \spellhead[Trans]{Disintegrate} Deals 12d8 damage, leaving only dust.
    \spellhead{Totemic Mind}[Mass] As \spell{totemic mind}, but affects multiple creatures.
    \spellhead{Totemic Power}[Mass] As \spell{totemic power}, but affects multiple creatures.
    \spellhead{Transmute Flesh and Stone} Turns subject creature into statue, or restores petrified creature.
    \spellhead*{Slow}[Mass] Many subjects take only one action/round.
\end{swspelllist}
...
\begin{swspelllist}
    ...
    \spellhead*{Dimension Door}[Mass] Teleport you and multiple allies within 1,000 feet.

    \spellhead[Div]{Moment of Prescience} Roll twice with bonus for single attack, save, or opposed check.
    \spellhead{Read Mind}[Greater] Unavoidably learn a creature's surface thoughts.
    \spellhead*{Precognition}[Greater] See into the future to gain combat bonuses and extra attack.

    \spellhead[Ench]{Confusion}[Mass] Multiple creatures act randomly.
    \spellhead{Deep Slumber} Subject falls asleep for a long time.
    \spellhead{Feeblemind} Subject's Intelligence drops to \minus9.
    \spellhead{Heroism}[Greater] Gives combat bonuses, temporary hit points.
    ...
    \spellhead{Shout}[Greater] Yell deals 7d6 sonic damage in large cone; stuns creatures, damages objects.
    \spellhead*{Forcecage}\M Cube or cage of force imprisons all inside.

    \spellhead[Illus]{Invisibility}[Mass] As \spell{invisibility}, but affects multiple creatures.
    ...
    \spellhead{Inflict Serious Wounds}[Mass] Deals 7d6 damage to many creatures.
    \spellhead{Power Word Blind} Blinds bloodied creature.
    \spellhead{Strip the Flesh} Rend foe's skin from its body.
    \spellhead*{Lifebreaker Curse} Target takes permanent damage.
    ...
    \spellhead{Shadow Body} You become a living shadow.
    \spellhead*{Enlarge Person}[Mass] Multiple humanoid creatures double in size.

    \spellhead[Univ]{Prismatic Spray} Cone of multicolored light has random effects.
...
\begin{swspelllist}
    ...
    \spellhead*{Spelltheft}[Greater] As \spell{greater dispel magic}, but you gain the effects of dispelled spells.

    \spellhead[Conj]{Sea of Fog} 200 ft. radius of fog obscures vision.
    \spellhead{Summon Monster VIII} Calls extraplanar creature to fight for you.
    \spellhead*{Maze} Traps subject in extradimensional maze.

    \spellhead[Div]{Precognition}[Greater] See into the future to gain combat bonuses and extra attack.
    \spellhead{Read Mind}[Mass] Learn surface thoughts from multiple creatures.
    \spellhead*{Revelation} Grant target vision of one of three futures.

    \spellhead[Ench]{Hold Person}[Mass] As \spell{hold person}, but affects multiple creatures.
    \spellhead{Scintillating Pattern} Twisting colors bewilder foes.
    \spellhead{Power Word Stun} Stuns a creature.
    \spellhead*{Suggestion}[Mass] As \spell{suggestion}, but shorter and affects multiple creatures.

    \spellhead[Evoc]{Cone of Cold}[Greater] 8d6 cold damage and fatigue in large cone.
    \spellhead{Polar Ray} Ranged touch attack slows and deals 16d6 cold damage.
    \spellhead{}
    \spellhead*{Crushing Hand} Large hand provides cover or crushes your foes.

    \spellhead[Illus]{Scintillating Pattern} Twisting colors bewilder foes.
    ...
    \spellhead{Inflict Critical Wounds}[Mass] Deals 8d6 damage to many creatures.
    \spellhead{Waves of Exhaustion} Creatures in medium cone become exhausted.
    \spellhead*{Horrid Wilting} Deals 8d6 damage to many foes.
    ...
    \spellhead*{Haste}[Mass] Many subjects move faster, get extra attack.
\end{swspelllist}

\subsubsection{9th-level Arcane Spells} 
\begin{swspelllist}
    \spellhead[Abjur]{Mage's Disjunction} Dispels all magic.
    \spellhead*{Prohibition}[Greater] Forcibly prevent creatures from taking specific action.
    ...
    \spellhead*{Etherealness} Travel to Ethereal Plane with companions.

    \spellhead[Div]{Foresight}[Greater] Powerful ``sixth sense'' warns of impending danger.
    \spellhead{Revelation} Grant target vision of one of three futures.
    \spellhead*{Moment of Prescience}[Greater] Roll twice with large bonus for single attack, save, or opposed check.

    \spellhead[Ench]{Hold Monster}[Mass] As \spell{hold monster}, but affects multiple creatures.
    ...
    \spellhead*{Time Stop} You act freely for 1d3\plus1 rounds.

    \spellhead[Univ]{Prismatic Storm} Sphere of multicolored light has random effects.
...
\begin{spelllist}
    ...
    \spellhead{Blindness/Deafness} Creature is blinded or deafened.
    \spellhead{Cure Moderate Wounds} Cures 4d6 damage.
    \spellhead{Daylight} Large radius of bright light.
    \spellhead{Entropic Shield} Ranged attacks against subject have 50\% miss chance.
    \spellhead{Hold Person} Paralyzes one humanoid for short duration.
    \spellhead{Inflict Moderate Wounds} Deals 4d6 damage.
    \spellhead{Locate Creature} Senses direction toward visualized creature.
    ...
    \spellhead{Share Pain}  Split damage with willing subject.
    \spellhead{Silence} Subject cannot make sound.
...
\begin{spelllist}
    ...
    \spellhead{Inflict Serious Wounds} Deals 6d6 damage.
    \spellhead{Locate Object}[Greater] Senses direction toward distant visualized objects.
    \spellhead{Protection from Energy} Reduce damage from one kind of energy.
...
\begin{spelllist}
    ...
    \spellhead{Divine Favor}[Greater] You gain \plus2 Str and attack and damage bonus.
    \spellhead{Enervation} Inflict three negative levels.
    \spellhead{Freedom} Subject moves normally despite impediments.
    \spellhead{Inflict Critical Wounds} Deals 8d6 damage.
    \spellhead{Invest Magic} All of subject's equipment is magical.
    \spellhead{Locate Creature}[Greater] Senses direction toward distant visualized creatures.
    \spellhead{Poison} Touch deals 1d6 Con damage repeatedly.
    \spellhead{Resist Energy}[Greater] As \spell{resist energy}, but all energy types.
    \spellhead{Summon Monster IV} Calls extraplanar creature to fight for you.
\end{spelllist}
...
\begin{spelllist}
    ...
    \spellhead{Command}[Mass] As \spell{command}, but affects multiple creatures.
    \spellhead{Cure Light Wounds}[Mass] Cures 5d6 damage for many creatures.
    \spellhead{Flame Strike} Smite foes with divine fire for 5d6 damage.
    \spellhead{Inflict Light Wounds}[Mass] Deals 5d6 damage to many creatures.
    \spellhead{Magic Circle against Chaos/Evil/Good/Law} Protect allies in a \areamed radius and hedge out opposing outsiders.
...
\begin{spelllist}
    ...
    \spellhead{Cure Moderate Wounds}[Mass] Cures 6d6 damage for many creatures.
    \spellhead{Dispel Magic}[Greater] As dispel magic, but up to \plus20 on check.
    \spellhead{Harm} Touch deals 12d8 damage and 4 Con damage.
...
\begin{spelllist}
    ...
    \spellhead{Cure Serious Wounds}[Mass] Cures 7d6 damage for many creatures.
    \spellhead{Death Ward}[Mass] As \spell{death ward}, but affects multiple creatures.
...
\begin{spelllist}
    ...
    \spellhead{Cure Critical Wounds}[Mass] Cures 8d6 damage for many creatures.
    \spellhead{Earthquake} Intense tremor shakes large radius.
    \spellhead{Energy Drain} Subject gains six negative levels.
    \spellhead{Freedom}[Mass] As \spell{freedom}, but affects multiple creatures.
    \spellhead{Hold Person}[Mass] As \spell{hold person}, but affects multiple creatures.
...
\begin{spelllist}
    ...
    \spellhead[5]{Call Lightning}[Greater] As \spell{call lightning}, but 5d8 damage per bolt.
    \spellhead[5]{Windstrike}[Greater] Wind moves and bludgeons target for 10d6 damage.
    \spellhead[6]{Skysmite} Unerring lightning deals 6d6 damage.
    \spellhead[6]{Zephyr Blade}[Greater] Melee weapon can strike from a distance for full damage.
...
\begin{spelllist}
    ...
    \spellhead[1]{Protection from Alignment} \plus2 to special defenses, \plus4 against chosen alignment.
    \spellhead[2]{Align Weapon} Weapon becomes \plus2 and chaotic.
    \spellhead[2]{Entropic Shield} Ranged attacks against subject have 50\% miss chance.
    ...
    \spellhead[5]{Prismatic Wall}
    \spellhead[5]{Magic Circle against Law} Protect allies in a \areamed radius.
    \spellhead[6]{Discordant Song} Confuse creatures with sustained music.
...
\begin{spelllist}
    ...
    \spellhead[2]{Blindness/Deafness} Creature is blinded or deafened.
    \spellhead[3]{Death Ward} Grants immunity to death spells and negative energy effects.
    \spellhead[3]{}
    \spellhead[4]{Enervation} Inflict three negative levels.
    ...
    \spellhead[6]{}
    \spellhead[6]{Harm} Touch deals 12d8 damage and 4 Con damage.
    \spellhead[7]{Death Ward}[Mass] As \spell{death ward}, but affects multiple creatures.
    ...
    \spellhead[9]{Wail of the Banshee} Scream kills many creatures. 
\end{spelllist}
...
\begin{spelllist}
    ...
    \spellhead[2]{Sound Burst} 2d6 sonic damage in a small radius.
    ...
    \spellhead[7]{Shout}[Greater] Yell deals 7d6 sonic damage in large cone; stuns creatures, damages objects.
...
\begin{spelllist}
    ...
    \spellhead[4]{Stoneskin} \plus3 AC, ignore 8 damage per round.
    ...
    \spellhead[6]{Earthspike}[Mass] Spikes from the ground deal damage to multiple targets.
...
\begin{spelllist}
    ...
    \spellhead[2]{Death Knell} Kill dying creature and gain temporary hp, more for killing powerful creatures.
    \spellhead[3]{Share Pain}[Forced] Split damage with unwilling subject.
    \spellhead[3]{Summon Monster III*} Calls extraplanar creature to fight for you.
    \spellhead[4]{Enervation} Inflict three negative levels.
...
\begin{spelllist}
    ...
    \spellhead[2]{}
    \spellhead[3]{Locate Object}[Greater] Senses direction toward distant visualized objects.
    \spellhead[3]{Read Mind} Learn a creature's surface thoughts.
    \spellhead[4]{Locate Creature}[Greater] Senses direction toward distant visualized creatures.
    \spellhead[4]{Moment of Prescience}[Lesser] Roll twice for single attack, save, or opposed check.
...
\begin{spelllist}
    ...
    \spellhead[2]{Hold Person} Paralyzes one humanoid for short duration.
    ...
    \spellhead[6]{Prohibition} Punish creatures that take specific action.
    \spellhead[6]{Summon Monster VI*} Calls extraplanar creature to fight for you.
    ...
    \spellhead[9]{Prohibition}[Greater] Forcibly prevent creatures from taking specific action.
  %\spellhead[9]{Imprisonment} Entombs subject beneath the earth.
    \spellhead[9]{Summon Monster IX*} Calls extraplanar creature to fight for you.
\end{spelllist}
...
\begin{spelllist}
    ...
    \spellhead[6]{}
    \spellhead[6]{Dispel Magic}[Greater] As dispel magic, but up to \plus20 on check.
...
\begin{spelllist}
    ...
    \spellhead[3]{Protection from Energy} Reduce damage from one kind of energy.
    \spellhead[3]{}
    \spellhead[4]{Spell Resistance} Subject gains spell resistance.
    \spellhead[4]{Stoneskin} \plus3 AC, ignore 8 damage per round.
    \spellhead[5]{}
    \spellhead[5]{Foresight} ``Sixth sense'' warns of impending danger.
    \spellhead[6]{Protection from Energy}[Greater] As \spell{protection from energy}, but against all energy types.
...
\begin{spelllist}
    ...
    \spellhead[3]{}
    \spellhead[4]{Divine Favor}[Greater] You gain \plus2 Str and attack and damage bonus.
    \spellhead[4]{Shout} Deafens all within medium cone and deals 4d6 sonic damage.
    \spellhead[5]{Righteous Might} Your size increases, and you gain combat bonuses.
    \spellhead[5]{Totemic Power}[Greater] Subject gains \plus4 to Str, Dex, or Con.
    \spellhead[6]{Totemic Power}[Mass] As \spell{totemic power}, but affects multiple creatures.
    \spellhead[6]{}
    \spellhead[7]{Enlarge Person}[Mass] Enlarges several creatures.
    \spellhead[7]{Shout}[Greater] Yell deals 7d6 sonic damage in large cone; stuns creatures, damages objects.
    \spellhead[8]{Iron Body} Your body becomes living iron.
    \spellhead[8]{}
    \spellhead[9]{}
...
\begin{spelllist}
    ...
    \spellhead[8]{Freedom}[Mass] As \spell{freedom}, but affects multiple creatures.
    \spellhead[8]{Dimension Door}[Mass] Teleport you and multiple allies within 1,000 feet.
...
\begin{spelllist}
    ...
    \spellhead[2]{Phantasmal Wound} Subject believes it is near death.
    \spellhead[2]{Silence} Subject cannot make sound.
    \spellhead[3]{Confusion} Subject acts randomly.
    ...
    \spellhead[5]{}
    \spellhead[5]{Phantasmal Maze} Subject acts as if affected by \spell{maze}.
    \spellhead[6]{Mislead} Turns you invisible and creates illusory double.
    \spellhead[6]{}
    \spellhead[7]{Invisibility}[Mass] As \spell{invisibility}, but affects multiple creatures.
    \spellhead[7]{Confusion}[Mass] Multiple subjects act randomly.
    \spellhead[8]{}
    \spellhead[8]{Reverse Gravity} Objects and creatures fall upward.
...
\begin{spelllist}
    ...
    \spellhead[5]{Cure Light Wounds}[Mass] Cures 5d6 damage for many creatures.
    \spellhead[5]{Inflict Light Wounds}[Mass] Inflicts 5d6 damage to many creatures.
    \spellhead[6]{Heal} Cures 12d8 damage, all diseases and mental conditions.
    \spellhead[6]{Harm} Touch deals 12d8 damage and 4 Con damage.
    \spellhead[7]{Cure Serious Wounds}[Mass] Cures 7d6 damage for many creatures.
    \spellhead[7]{Inflict Serious Wounds}[Mass] Inflicts 7d6 damage to many creatures.
    \spellhead[8]{Cure Critical Wounds}[Mass] Cures 8d6 damage for many creatures.
    \spellhead[8]{Inflict Critical Wounds}[Mass] Inflicts 8d6 damage to many creatures.
    \spellhead[9]{}
    \spellhead[9]{}
\end{spelllist}
...
\begin{spelllist}
    ...
    \spellhead{Ice Storm} Hail deals 4d4 damage in small cylinder.
    \spellhead{Magic Fang}[Greater] All subject's natural weapons get \plus2 bonus.
    \spellhead{Resist Energy}[Greater] As \spell{resist energy}, but all energy types.
    \spellhead{Stoneskin} \plus3 AC, ignore 8 damage per round.
...
\begin{spelllist}
  %\spellhead{Animate Plants} Plants animate and fight for you.
    \spellhead{Call Lightning}[Greater] As call lightning, but 5d8 damage per bolt.
    ...
    \spellhead{Windstrike}[Greater] Wind moves and bludgeons target for 10d6 damage.
\end{spelllist}

\subsubsection{6th-level Nature Spells}
\begin{spelllist}
    \spellhead{Antilife Shell} Small radius emanation hedges out living creatures.
    \spellhead{Cure Moderate Wounds}[Mass] Cures 5d6 damage for many creatures.
    \spellhead{Dispel Magic}[Greater] As dispel magic, but up to \plus20 on check.
    \spellhead{Earthspike}[Mass] Spikes from the ground impale multiple targets.
...
%\spellhead{Liveoak} Oak becomes treant guardian.
    ...
    \spellhead{Totemic Mind}[Mass] As \spell{totemic mind}, but affects multiple creatures.
    \spellhead{Totemic Power}[Mass] As \spell{totemic power}, but affects multiple creatures.
    \spellhead{Zephyr Blade}[Greater] Melee weapon can strike from a distance for full damage.
\end{spelllist}
...
\begin{spelllist}
    \spellhead{Cone of Cold}[Greater] 8d6 cold damage and fatigue in large cone.
    \spellhead{Cure Critical Wounds}[Mass] Cures 8d6 damage for many creatures.
    \spellhead{Earthquake} Intense tremor shakes large radius.
