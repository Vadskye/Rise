...
\begin{swspelllist}
    ...
    \spellheadc{Precognition}{Lesser} See into the future to gain attack and damage bonus.
...
\begin{swspelllist}
    ...
    \spellheadrestricted{Deflection} Gain \plus2 to physical defenses.
    ...
    \spellheadrestricted{Telekinetic Maneuver} Telekinetically dirty trick, disarm, grapple, shove, trip your target.
...
\begin{swspelllist}
    ...
    \spellheadc[Conj]{Acid Arrow}{Greater} As acid arrow, but 5d8 damage initially and more over time.
    ...
    \spellheadrestricted{Manipulate Probability} Control creature's next die results.
    ...
    \spellheadc[Illus]{Mirror Image}{Greater} Creates regenerating decoy duplicates of you.
    \spellhead{Phantasmal Maze} Subject acts as if affected by \spell{maze}.
    \spellhead{Retributive Brilliance} Subject can dazzle or blind attacker once.
    \spellheadrestricted{}
    ...
    \spellheadrestricted{Drain Life} Deals 10d6 damage and steals life.
...
\begin{swspelllist}
    ...
    \spellheadrestricted{Prohibition} Punish creatures that take specific action.
    ...
    \spellheadc{Invisibility}{Greater} As \spell{invisibility}, but subject can attack and stay invisible.
...
\begin{swspelllist}
    ...
    \spellheadrestricted{Lifebreaker Curse} Target takes permanent damage.
...
\begin{swspelllist}
    ...
    \spellheadrestrictedc{Suggestion}{Mass} As \spell{suggestion}, but shorter and affects multiple creatures.
...
\begin{swspelllist}
    ...
    \spellheadrestrictedc{Prohibition}{Greater} Forcibly prevent creatures from taking specific action.
    ...
    \spellheadrestricted{Etherealness} Travel to Ethereal Plane with companions.
...
\begin{rituallist}
    ...
    \spellheadc[Illus]{Disguise Self}{Greater} Change your appearance at will.
...
\begin{rituallist}
    \spellheadc[Conj]{Create Object}{Greater} Create almost any type of object.
...
%\spellhead[Arcana]{Binding} Utilizes an array of techniques to imprison a creature.
    ...
    \spellheadc[Div]{Scrying}{Greater} As scrying, but faster and longer.
...
\begin{rituallist}
    \spellheadc[Conj]{Teleport}{Greater} As teleport, but no range limit and no off-target arrival.
    ...
    \spellheadc{Sensor Swarm}{Greater} As sensor swarm, but eyes have darkvision and \spell{see invisibility}.
...
\begin{rituallist}
    ...
    \spellheadc[Conj]{Planar Binding}{Greater} As lesser planar binding, but up to 18th level.
...
\begin{spelllist}
    ...
    \spellheadc{Divine Favor}{Greater} You gain \plus2 Str and attack and damage bonus.
...
\begin{spelllist}
    ...
    \spellhead[2]{Death Knell} Kill dying creature and gain temporary hp, more for killing powerful creatures.
    \spellheadc[3]{Share Pain}{Forced} Split damage with unwilling subject.
    \spellhead[3]{Summon Monster III*} Calls extraplanar creature to fight for you.
    \spellhead[4]{Enervation} Inflict three negative levels.
...
\begin{spelllist}
    ...
    \spellheadc[9]{Prohibition}{Greater} Forcibly prevent creatures from taking specific action.
  %\spellhead[9]{Imprisonment} Entombs subject beneath the earth.
    \spellhead[9]{Summon Monster IX*} Calls extraplanar creature to fight for you.
\end{spelllist}
...
\begin{spelllist}
    ...
    \spellhead[3]{}
    \spellheadc[4]{Divine Favor}{Greater} You gain \plus2 Str and attack and damage bonus.
    \spellhead[4]{Shout} Deafens all within medium cone and deals 4d6 sonic damage.
    \spellhead[5]{Righteous Might} Your size increases, and you gain combat bonuses.
