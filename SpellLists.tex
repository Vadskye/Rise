...
\begin{swspelllist}
  ...
  \spellhead[Necro]{Contagion} Infects subject with chosen disease.
...
\begin{swspelllist}
  ...
  \spellhead[Necro]{Retributive Shield} Grants DR 10 that reflects damage at foes.
  \spellheadc{Inflict Light Wounds}{Mass} Deals 5d8 damage to many creatures.
  \spellhead{Stinking Cloud} Fog nauseates creatures inside.
...
\begin{swspelllist}
  ...
  \spellheadrestricted{Mage's Sword}\F Floating magic blade strikes opponents.
...
\begin{swspelllist}
  ...
  \spellhead[Div]{Foresight} ``Sixth sense'' warns of impending danger.
