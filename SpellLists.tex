...
\begin{spelllist}
  ...
  \spellhead[2]{Aid} Ally gains \plus2 attack bonus, 10 \plus1/level temporary hp.
  \spellhead[3]{}
  \spellhead[3]{Summon Monster III*} Calls extraplanar creature to fight for you.
  \spellhead[4]{Death Ward} Grants immunity to death spells and negative energy effects.
...
\begin{spelllist}
  ...
  \spellhead{Cure Moderate Wounds} Cures 4d8 damage.
  \spellhead{Daylight} Large radius of bright light.
  \spellhead{Magic Vestment} Subject's armor becomes \plus2.
  \spellhead{Resist Energy} Ignores 10 (or more) points of damage/attack from specified energy type.
  \spellhead{Share Pain} Split damage with willing subject.
...
\begin{swspelllist}
  ...
  \spellhead[Trans]{Jump} Subject gets bonus on Jump checks.
...
\begin{swspelllist}
  ...
  \spellhead[Trans]{Magic Vestment} Subject's armor becomes \plus2.
  \spellhead{Magic Weapon} Weapon becomes \plus2.
  \spellhead{Spider Climb} Grants ability to walk on walls and ceilings.
  \spellhead{Totemic Mind} Subject gains \plus2 to Int, Wis, or Cha for medium duration.
  \spellhead{Totemic Power} Subject gains \plus2 to Str, Dex, or Con for medium duration.
...
\begin{swspelllist}
  ...
  \spellheadrestricted{Heroism} Gives \plus2 on attacks, checks, and saves.
...
\begin{swspelllist}
  ...
  \spellhead[Ench]{Feeblemind} Subject's Intelligence drops to \minus9.
...
\begin{swspelllist}
  ...
  \spellheadrestrictedc{Heroism}{Greater} Gives combat bonuses, temporary hit points.
