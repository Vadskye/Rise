...
\begin{spelllist}
  ...
  \spellhead[3]{Summon Monster III*} Calls extraplanar creature to fight for you.
  \spellhead[4]{Death Ward} Grants immunity to death spells and negative energy effects.
  \spellhead[4]{Holy Smite} Blinds and deals 4d6 damage to nongood creatures.
...
\begin{spelllist}
  ...
  \spellhead[4]{Locate Creature} Indicates direction to familiar creature.
...
\begin{swspelllist}
  ...
  \spellhead{Death Knell} Kill dying creature and gain temporary hp, more for killing powerful creatures.
...
\begin{swspelllist}
  ...
  \spellheadrestrictedc{Invisibility}{Greater} As \spell{invisibility}, but subject can attack and stay invisible.
