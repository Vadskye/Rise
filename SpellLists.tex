...
\begin{spelllist}
  ...
  \spellhead{Good Hope} Subjects gain \plus2 to attack, 10 \plus1/level temporary hp.
...
\begin{spelllist}
  \spellheadc{Harm}{Mass} As \spell{harm}, but inflicts 9d6 to many subjects.
  \spellheadc{Heal}{Mass} As heal, but heals 9d6 for many subjects.
...
\begin{spelllist}
  ...
  \spellheadc[9]{Heal}{Mass} As heal, but heals 9d6 for many subjects.
  \spellhead[9]{Summon Monster IX*} Calls extraplanar creature to fight for you.
\end{spelllist}
...
\begin{spelllist}
  ...
  \spellhead[3]{Fog Cloud} Medium cylinder of fog obscures vision.
