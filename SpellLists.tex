...
\begin{swspelllist}
  ...
  \spellhead{Stoneskin} \plus3 AC, ignore 10 damage per round.
...
\begin{swspelllist}
    \spellheadp[Abjur]{Mage's Disjunction} Dispels all magic.
...
%\spellhead[Arcana]{Binding} Utilizes an array of techniques to imprison a creature.
    \spellhead[Abjur]{Dimensional Lock} Teleportation and interplanar travel blocked for 30 days.
...
\begin{spelllist}
  ...
  \spellhead[4]{Stoneskin} \plus3 AC, ignore 10 damage per round.
