...
\begin{dtable*}
    ...
    \begin{dtabularx}{\textwidth}{>{\ccol}p{\levelcol} >{\ccol}p{\babcolgood} *{2}{>{\ccol}p{4.5em}} >{\lcol}X}
        ...
        \hline
        \spellwarpedprogressionrow{1}  & Innate magic, invocation, pool regeneration, spellwarp pool \\
...
\parhead{General}
    \subcf{Expanded Pool} The spellwarped increases his maximum number of spellwarp points by 2.
