...
\begin{dtable}
    ...
    \begin{dtabularx}{\columnwidth}{>{\ccol}p{2em} >{\ccol}p{\babcolavg} *{3}{>{\ccol}p{\savecol}} >{\lcol}X}
        ...
        \clericprogressionrow{15} & Devotion feat, devotion \plus5 \\
        ...
        \clericprogressionrow{20} & Devotion \plus6, endless devotion              \\
    \end{dtabularx}
\end{dtable}
...
\begin{dtable}
    ...
    \begin{dtabularx}{\columnwidth}{>{\ccol}p{\levelcol} >{\centering}p{\babcolavg} *{3}{>{\ccol}p{\savecol}} >{\ccol}X}
        \thead{Level} & \thead{Base Attack Bonus} & \thead{Fort} & \thead{Ref} & \thead{Ment} & \thead{Special} \\
        \hline
        \druidprogressionrow{1}  & Attunement \plus2, rituals, spells      \\
        ...
        \druidprogressionrow{5}  & Attunement \plus3, wild aspect     \\
        ...
        \druidprogressionrow{10} & Attunement \plus4, improved natural casting         \\
        ...
        \druidprogressionrow{15} & Attunement \plus5, natural aspect, multiple aspect  \\
        ...
        \druidprogressionrow{20} & Attunement \plus6, greater natural casting          \\
    \end{dtabularx}
\end{dtable}
...
The druid can embody a wild aspect a number of times equal to her Constitution or half her druid level, whichever is higher.
When the druid attunes to nature, she regains all her uses of wild aspect.
...
The druid gains a \plus3 bonus to Creature Handling and Ride checks.
...
\subcf{5th -- Shrink}
As a standard action, the druid can shrink by a size category.
...
\subcf{9th -- Grow}
As a standard action, the druid can grow by a size category.
...
\altcf[2nd]{Natural Casting} The blighter does not gain this ability.

\altcf[10th]{Improved Natural Casting} The blighter does not gain this ability.

\altcf[10th]{Blightcasting}

\altcf[20th]{Greater Natural Casting} The blighter does not gain this ability.
...
\subcf{1st} \spell{excrete slime}, \spell{lesser regeneration}
\subcf{2nd} \spell{fungal growth}
\subcf{3rd} \spell{rotburst}
\subcf{4th} \spell{poison}
\subcf{7th} \spell{greater rotburst}, \spell{regeneration}
...
\altcf[7th]{Multiple Aspect} The rotbringer does not gain this ability.

\altcf[11th]{Natural Aspect} The rotbringer does not gain this ability.
...
\begin{dtable}
    ...
    \begin{dtabularx}{\columnwidth}{>{\ccol}p{\levelcol} >{\ccol}p{\babcolpoor} *{3}{>{\ccol}p{\savecol}} >{\lcol}X}
        ...
        \sorcererprogressionrow{2}  & Cantrip, focused casting              \\
        \sorcererprogressionrow{3}  & Spellsurge \plus2                     \\
...
Every time a sorcerer casts a spell, except cantrips, he must make a wild magic roll.
To make a wild magic roll, roll d20 \add 1 per two sorcerer levels.
...
On a natural 1, the spell is always miscast, regardless of other modifiers.

If the wild magic roll succeeds, the spell is cast normally.
Failure means the spell's miscast effect occurs in addition to the spell's normal effect (see \pcref{Miscasting}).
...
A sorcerer can initiate or end a spellsurge as a swift action.
A spellsurge normally lasts for 5 rounds.
While in a spellsurge, the sorcerer gains bonuses or penalties with some types of magic or aspects of spellcasting, as defined in the ability description.

All spellsurges grant bonuses or penalties based on the sorcerer's spellsurge bonus.
Initially, his spellsurge bonus is \plus2.
...
At all other times, he gains a penalty to wild magic rolls with all spells.
\subcf{Energetic Surge}
The sorcerer gains a bonus to spellpower with acid, cold, electricity, and fire spells.
In exchange, he takes a penalty to his wild magic rolls with all other spells.
\subcf{Focused Surge}
The sorcerer gains a bonus to his concentration checks.
In exchange, all spells he casts require at least a full-round action to cast.
This does not increase the casting time of spells with a casting time of a full-round action or longer.
\subcf{Retributive Surge}
Whenever the sorcerer takes damage, he gains a bonus to spellpower with all spells for 1 round.
At all other times, he takes a penalty to wild magic rolls with all spells.
\subcf{6th -- Empathic Surge}
The sorcerer gains a bonus to spellpower with Mind spells.
In exchange, he takes a penalty to his Mental defense, and to his wild magic rolls with spells that deal damage.
\subcf{6th -- Passive Surge}
The sorcerer gains a bonus to spellpower with all spells.
If he takes damage, he loses this bonus and takes a penalty to his wild magic rolls for  1 round.
\subcf{6th -- Patient Surge}
The sorcerer gains a bonus to his spellpower with all spells.
In exchange, all spells he casts require at least a full-round action to cast.
This does not increase the casting time of spells with a casting time of a full-round action or longer.
\subcf{10th -- Extending Surge}
The sorcerer doubles the range of his spells with a spell level up to his surge bonus.
In exchange, he takes a penalty to his wild magic rolls with all spells.
\subcf{10th -- Silent Surge}
The sorcerer can cast spells with a spell level up to his surge bonus as if they did not have verbal components.
In exchange, he takes a penalty to his wild magic rolls with all spells.
\subcf{10th -- Stilled Surge}
The sorcerer can cast spells with a spell level up to his surge bonus as if they did not have somatic components.
In exchange, he takes a penalty to his wild surges with all spells.
\subcf{14th -- Lifebound Surge}
The sorcerer gains a bonus to his spellpower with all spells.
In exchange, he takes a penalty to his Fortitude defense, and takes damage equal to his spellpower whenever he casts a spell.
\subcf{14th -- Lingering Surge}
The sorcerer gains a bonus to his spellpower with spells that have a non-instantaneous duration.
In exchange, he takes a penalty to his wild magic rolls with spells that are instantaneous.
...
The sorcerer doubles the area affected by his area spells with a spell level up to his surge bonus.
In exchange, he takes a penalty to his wild surges with all spells.
...
The sorcerer gains spell resistance equal to 10 \add either sorcerer level or Constitution.
...
\hline
        \spellwarpedprogressionrow{1}  & Innate magic, spellwarped invocation, spellwarp pool \\
