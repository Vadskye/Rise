...
\begin{dtable}
    ...
    \begin{dtabularx}{\columnwidth}{>{\ccol}p{\levelcol} >{\ccol}p{\babcolpoor} *{3}{>{\ccol}p{\savecol}} >{\lcol}X}
        ...
        \wizardprogressionrow{16} & Augmented attunement     \\
...
\cf{Wiz}[8th]{Persistent Attunement}[Ex]
...
\cf{Wiz}[16th]{Augmented Attunement}[Ex]
