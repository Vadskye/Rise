...
\begin{dtable}
    ...
    \begin{dtabularx}{\columnwidth}{l l X}
        \thead{Progression} & \thead{Combat Prowess} & \thead{Base Defense Bonus}        \\
        \hline
...
\begin{dtable}
    ...
    \begin{dtabularx}{\columnwidth}{>{\ccol}p{\levelcol} >{\ccol}p{\babcolgood} *{3}{>{\ccol}p{\savecol}} >{\lcol}X}
        \thead{Level} & \thead{Combat Prowess} & \thead{Fort} & \thead{Ref} & \thead{Ment} & \thead{Special} \\
        \hline
...
\begin{dtable*}
    ...
    \begin{dtabularx}{\textwidth}{>{\ccol}p{\levelcol} >{\ccol}p{\babcolgood} *{2}{>{\ccol}p{4.5em}} >{\lcol}X}
        \thead{Level} & \thead{Combat Prowess} & \thead{Good Defense}\fn{1} & \thead{Normal Defenses}\fn{1} & \thead{Special} \\
        \hline
