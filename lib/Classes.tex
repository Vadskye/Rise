...
\begin{dtable}
    ...
    \begin{dtabularx}{\columnwidth}{>{\ccol}p{\levelcol} >{\ccol}p{\babcolgood} *{3}{>{\ccol}p{\savecol}} >{\lcol}X}
        ...
        \hline
        \barbarianprogressionrow{1}  & Rage \plus2, damage reduction      \\
        \barbarianprogressionrow{2}  & Fast movement    \\
...
\begin{dtable}
    ...
    \begin{dtabularx}{\columnwidth}{>{\ccol}p{\levelcol} >{\centering}p{\babcolavg} *{3}{>{\ccol}p{\savecol}} >{\ccol}X}
        ...
        \druidprogressionrow{8}  & Charming wild speech           \\
...
\cf{Drd}[8th]{Charming Wild Speech}[Su]
...
The druid's special attack bonus with this ability is equal to her druid level \add her Willpower.
