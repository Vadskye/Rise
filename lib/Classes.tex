...
\begin{dtable}
    ...
    \begin{dtabularx}{\columnwidth}{>{\ccol}p{\levelcol} >{\ccol}p{\babcolpoor} *{3}{>{\ccol}p{\savecol}} >{\lcol}X}
        \thead{Level} & \thead{Base Attack Bonus} & \thead{Fort} & \thead{Ref} & \thead{Ment} & \thead{Special} \\
        \hline
        \sorcererprogressionrow{1}  & Cantrip, spells, wild magic \plus2      \\
        \sorcererprogressionrow{2}  & Cantrip, focused casting \\
        \sorcererprogressionrow{3}  & Arcane adaptation                       \\
        \sorcererprogressionrow{4}  &                                         \\
        \sorcererprogressionrow{5}  & Defensive spellblend, wild magic \plus3 \\
        \sorcererprogressionrow{6}  &                                         \\
        \sorcererprogressionrow{7}  & Arcane adaptation                       \\
        \sorcererprogressionrow{8}  &                                         \\
        \sorcererprogressionrow{9}  & Offensive spellblend                    \\
        \sorcererprogressionrow{10} & Wild magic \plus4                       \\
        \sorcererprogressionrow{11} & Arcane adaptation                       \\
        \sorcererprogressionrow{12} &                                         \\
        \sorcererprogressionrow{13} & Improved defensive spellblend           \\
        \sorcererprogressionrow{14} &                                         \\
        \sorcererprogressionrow{15} & Arcane adaptation, wild magic \plus5    \\
        \sorcererprogressionrow{16} &                                         \\
        \sorcererprogressionrow{17} & Improved offensive spellblend           \\
        \sorcererprogressionrow{18} &                                         \\
        \sorcererprogressionrow{19} & Arcane adaptation                       \\
        \sorcererprogressionrow{20} & Greater wild magic, wild magic \plus6   \\
    \end{dtabularx}
\end{dtable}
...
At his 7th sorcerer level, and every four sorcerer levels thereafter, the sorcerer gains an additional arcane adaptation.
...
This does not prevent the sorcerer from losing the ability to cast spells of the same level temporarily.
...
\subcf{7th -- Improved Focused Casting}
