...
\section{Monk}
    ...
    \subsection{Class Abilities}
        ...
        As an immediate action, when the monk would take \glossterm{energy} damage, she can gain damage reduction against all energy damage equal to her \ki power until the end of the round.
        ...
        \subcf{6th -- Dance of Falling Feathers}
...
\section{Spellwarped}
    ...
    \subsection{Invocations}\label{Invocations}
        ...
        \subsubsection{Telekinesis Invocations}
            ...
            As a standard action, the spellwarped can \immobilize a creature within \rngmed range for 2 rounds.
...
\section{Multiclass Characters}\label{Multiclass Characters}
    ...
    \subsection{Spellcasters and Multiclassing}\label{Spellcasters and Multiclassing}
        ...
        No class abilities or other abilities can be gained in this way.
