...
\begin{dtable}
    ...
    \begin{dtabularx}{\columnwidth}{>{\ccol}p{\levelcol} >{\ccol}p{\babcolgood} *{3}{>{\ccol}p{\savecol}} >{\lcol}X}
        ...
        \barbarianprogressionrow{7}  & Grit                          \\
        ...
        \barbarianprogressionrow{12} & Chaotic rage                  \\
...
At 5th level, and every 5 levels thereafter, the bonus to physical damage and the bonus toFortitude and Mental defenses increases by \plus1.
...
\cf{Bbn}[7th]{Grit}[Ex]
The barbarian ignores \glossterm{critical damage penalties} for the purpose of his physical attacks and checks, and can choose not to fall unconscious from critical damage.
This does not prevent him from dying from critical damage.
