...
\begin{dtable}
    ...
    \begin{dtabularx}{\columnwidth}{>{\ccol}p{\levelcol} >{\ccol}p{\babcolgood} *{3}{>{\ccol}p{\savecol}} >{\lcol}X}
        ...
        \barbarianprogressionrow{10} & Rage feat, rage \plus4              \\
        \barbarianprogressionrow{11} & Chaotic rage                        \\
        \barbarianprogressionrow{12} & Fury of the storm                   \\
        \barbarianprogressionrow{13} & \x                                  \\
        \barbarianprogressionrow{14} & Rage feat                           \\
        ...
        \barbarianprogressionrow{18} & Rage feat                           \\
...
\begin{dtable}
    ...
    \begin{dtabularx}{\columnwidth}{>{\ccol}p{2em} >{\ccol}p{\babcolavg} *{3}{>{\ccol}p{\savecol}} >{\lcol}X}
        \tb{Level} & \tb{Combat Prowess} & \tb{Fort} & \tb{Ref} & \tb{Ment} & \tb{Special} \\
        \hline
        \clericprogressionrow{1}  & Devotion \plus2, domain gifts, spells \\
        \clericprogressionrow{2}  & Domain invocations, rituals                         \\
        \clericprogressionrow{3}  & Domain spell                                        \\
        \clericprogressionrow{4}  & Devotion feat                                       \\
        \clericprogressionrow{5}  & Devotion \plus3, domain spell                       \\
        \clericprogressionrow{6}  & Domain aspect                                       \\
        \clericprogressionrow{7}  & Domain spell                                        \\
        \clericprogressionrow{8}  & Domain aspect                                       \\
        \clericprogressionrow{9}  & Domain spell                                        \\
        \clericprogressionrow{10} & Devotion \plus4, greater domain invocation          \\
        \clericprogressionrow{11} & Domain spell                                        \\
        \clericprogressionrow{12} & Greater domain invocation                           \\
        \clericprogressionrow{13} & Domain spell                                        \\
        \clericprogressionrow{14} & Devotion feat                                       \\
        \clericprogressionrow{15} & Devotion \plus5, domain spell                       \\
        \clericprogressionrow{16} & Domain mastery                                      \\
        \clericprogressionrow{17} & Domain spell                                        \\
        \clericprogressionrow{18} & Domain mastery                                      \\
        \clericprogressionrow{19} & Endless devotion, domain spell                      \\
...
\subcf{Vitality -- Critical Healer}
...
As a swift action, the cleric can surround himself in a mantle of whirling air for 5 rounds.
Physical attacks have a 50\% chance to miss him while this effect is active.
\subcf{Chaos -- Maw of Chaos}
This power functions like the Chaos channeled domain power, except that it affects all number of creatures within a \arealarge radius burst of the cleric.
He may freely exclude any creatures he sees from the effect after determining whether positive or negative energy is channeled.
\subcf{Death -- Invoke Death}
This power functions like the Death channeled domain power, except that if the target has no hit points remaining after taking damage from this effect, it immediately dies.
This is a death effect.
...
He gains the effect of the \spell{stoneskin} spell, with a spellpower equal to his divine power.
\subcf{Evil -- Invoke Evil}
All nonevil creatures within an \arealarge radius burst of the cleric are \staggered for 2 rounds.
\subcf{Fire -- Blazing Inferno}
The cleric makes a divine power vs. Reflex attack against all enemies within an \arealarge radius burst of him.
Success deals \spelldamage{fire}[d8].
Failure deals half damage.
\subcf{Good -- Invoke Good}
All nonevil creatures within an \arealarge radius burst of the cleric are \dazed for 2 rounds.
\subcf{Knowledge -- See the Truth}
As a swift action, the cleric can gain the benefit of the \spell{true seeing} spell until the end of the round.
\subcf{Law -- Invoke Law}
All nonlawful creatures within an \arealarge radius burst of the cleric are \immobilized for 2 rounds.
\subcf{Magic -- Font of Magic}
This power functions like the Magic channeled domain power, except it affects all creatures within an \arealarge radius of the cleric.
The cleric may freely exclude any creatures he can see from the effect.
\subcf{Protection -- Divine Shield}
All allies within an \arealarge burst of the cleric gain damage reduction against all damage equal to the cleric's divine power for 5 rounds.
\subcf{Strength -- Titanic Strength}
This invocation functions like the \spell{enlarge} spell, except that it increases the target's size by two size categories.
\subcf{Travel -- Invoke Speed}
As a swift action, the cleric can quadruple his movement speed with all forms of movement until the end of the round.
...
\subcf{Vitality -- Endless Life}
Target creature within \rngmed range heals \spelldamage{}.
In addition, for 5 rounds, the target heals hit points equal to the cleric's divine power at the end of each round.
...
This lasts for the normal duration of the spell or for 5 rounds, whichever is shorter.
\subcf{Water -- Aquatic Globe}
The cleric creates water out of thin air in an immobile \areahuge radius zone centered on his original location for 5 rounds.
...
\subcf{Wild -- Nature Rises}
All enemies within an \arealarge radius burst of the cleric, and who are within 10 feet of the ground, are attacked by animated plants that grow from nowhere.
The plants deal \spelldamage{bludgeoning}[d6].
In addition, the ground in the area is \difficultterrain for 5 rounds for the cleric's enemies, as the plants impede their motion.
...
\begin{dtable}
    ...
    \begin{dtabularx}{\columnwidth}{>{\ccol}p{\levelcol} >{\centering}p{\babcolavg} *{3}{>{\ccol}p{\savecol}} >{\lcol}X}
        \tb{Level} & \tb{Combat Prowess} & \tb{Fort} & \tb{Ref} & \tb{Ment} & \tb{Special} \\
        \hline
        \druidprogressionrow{1}  & Metal abhorrence, spells, wild speech \\
        \druidprogressionrow{2}  & Rituals, wild aspect                  \\
        \druidprogressionrow{3}  & Natural casting (10 ft.)     \\
        \druidprogressionrow{4}  & Wild aspect                  \\
        \druidprogressionrow{5}  & Multiple aspect (x2)         \\
        \druidprogressionrow{6}  & Wild aspect                  \\
        \druidprogressionrow{7}  & \x                           \\
        \druidprogressionrow{8}  & Wild aspect                  \\
        \druidprogressionrow{9}  & Multiple aspect (x3)         \\
        \druidprogressionrow{10} & Wild aspect                  \\
        \druidprogressionrow{11} & Natural casting (Close)      \\
        \druidprogressionrow{12} & Natural aspect               \\
        \druidprogressionrow{13} & Multiple aspect (x4)         \\
        \druidprogressionrow{14} & Natural aspect               \\
        \druidprogressionrow{15} & Timeless body                \\
        \druidprogressionrow{16} & Natural aspect               \\
        \druidprogressionrow{17} & Multiple aspect (x5)         \\
        \druidprogressionrow{18} & Natural aspect               \\
...
She gains a \plus5 bonus to accuracy with grapple attacks when grappling with her bare hands.
...
\subcf{Fire Shield} The druid gains the effects of the warm version of the \spell{fire shield} spell.
...
\begin{dtable}
    ...
    \begin{dtabularx}{\columnwidth}{>{\ccol}p{\levelcol} >{\ccol}p{\babcolavg} *{3}{>{\ccol}p{\savecol}} >{\lcol}X}
        ...
        \monkprogressionrow{4}  & Channel \ki, \ki strike \plus2               \\
        \monkprogressionrow{5}  & Flurry of blows                              \\
        \monkprogressionrow{6}  & Channel \ki                                  \\
        \monkprogressionrow{7}  & \Ki strike \plus3, perfect motion            \\
        \monkprogressionrow{8}  & Channel \ki                                  \\
        \monkprogressionrow{9}  & Improved uncanny dodge                       \\
        \monkprogressionrow{10} & Channel \ki, \ki strike \plus4               \\
        \monkprogressionrow{11} & Perfect soul                                 \\
        \monkprogressionrow{12} & Channel \ki                                  \\
        \monkprogressionrow{13} & Perfect mind, \ki strike \plus5              \\
        \monkprogressionrow{14} & Channel \ki                                  \\
        \monkprogressionrow{15} & Perfect body                                 \\
        \monkprogressionrow{16} & Channel \ki, \ki strike \plus6               \\
        \monkprogressionrow{17} & Perfect life                                 \\
        \monkprogressionrow{18} & Channel \ki                                  \\
        \monkprogressionrow{19} & \Ki strike \plus7, true perfection           \\
        \monkprogressionrow{20} & Channel \ki, transcend mortality             \\
    \end{dtabularx}
\end{dtable}
...
\cf{Mnk}{Inherent Ki} A monk's fists, and all weapons she uses, gain a \plus1 \glossterm{enhancement bonus}.
This functions like an enhancement bonus on a weapon, increasing her damage and offensive legend points per day (see \pcref{Weapon Enhancement Bonuses}).
...
\subcf{All Energy Becomes One}
As an immediate action, when the monk would take energy damage, she can gain damage reduction against that type of energy damage equal to twice her \ki power until the end of the round.
...
\subcf{4th -- Dance of the Wayward Strike}
...
\subcf{6th -- Focus the Wayward Mind}
...
\subcf{6th -- Ki-Disrupting Strike}
...
\subcf{6th -- See the Flow of Life}
...
\subcf{8th -- Dance of the Foolish Blow}
...
\norepeatnotes
\subcf{12th -- Awaken the Pacifist Heart}
...
\subcf{12th -- Empty Step}
As a swift action, the monk can step into the Ethereal Plane until the end of the round, as the \spell{ethereal jaunt} spell.
She may return as a free action.
\subcf{14th -- Flash Burst}
...
\subcf{16th -- Empty Body} As a move action, the monk can step into the Ethereal Plane for 5 rounds, as the \spell{ethereal jaunt}
spell.
For the duration of the effect, she may switch between the planes as a swift action during the movement phase.
\subcf{18th -- Ki-Shattering Strike}
...
In addition, she gains a \plus20 bonus to Maneuver defense against grapple attacks, as well as on grapple attacks or Escape Artist checks made to escape a grapple or a pin.
...
\begin{dtable}
    ...
    \begin{dtabularx}{\columnwidth}{>{\ccol}p{\levelcol} >{\ccol}p{\babcolgood} *{3}{>{\ccol}p{\savecol}} >{\lcol}X}
        ...
        \paladinprogressionrow{19} &                                              \\
        \paladinprogressionrow{20} & Divine presence                              \\
    \end{dtabularx}
\end{dtable}
...
If the target shares the paladin's devoted alignment, it is instead healed for 1d8 damage per divine power.
\subcf{4th -- Resounding Smite*}
The struck creature is knocked prone.
\subcf{4th -- Seeking Smite*}
...
The paladin's smite makes a Divine power vs. Mental attack against the struck creature.
...
She appears in the space closest to her original location.
A paladin who has other movement modes, such as flight, can also teleport next to enemies only accessible using that movement mode.
\subcf{12th -- Prohibition} This invocation functions like the \spell{prohibition} spell.
...
The paladin is automatically sees through figments.
...
\parhead{Any Alignment}
\subcf{Aura of Courage}
Allies in the area are immune to \glossterm{Fear} effects.
\subcf{8th -- Worthy Foe}
Enemies in the area are \taunted by the paladin.

\parhead{Chaotic Divine Presences}
\subcf{Aura of Fortunate Blows}
...
This attack deals 1d8 fire damage \add 1 per spellpower.
A failed attack deals half damage.
...
If his attack succeeds, he crushes it with telekinetic force for 1d8 points of bludgeoning damage \add 1 per spellpower.
A failed attack deals half damage.
...
\parhead{4th -- Crush}
This invocation functions like the lesser crush attack, except that it deals \spelldamage{bludgeoning}.
...
This attack deals \spelldamage{bludgeoning}.
...
\begin{dtable}
    ...
    \begin{dtabularx}{\columnwidth}{>{\ccol}p{\levelcol} >{\ccol}p{\babcolpoor} *{3}{>{\ccol}p{\savecol}} >{\lcol}X}
        ...
        \wizardprogressionrow{3}  & Arcane insight, specialization \\
...
\cf{Wiz}[3rd]{Specialization}
The wizard may choose to specialize in a particular school of magic, or she may be a generalist.
Generalist wizards may learn \glossterm{restricted spells} on the arcane spell list as if they were not restricted.
In addition, they learn additional rituals for free.

Specialist wizards must choose a school of magic to specialize in.
They may learn restricted spells from that school as if they were not restricted.
In addition, they gain additional spells known.
However, specialist wizards must choose two spell schools to ban.
...
The wizard gains a greater understanding of magic, depending on whether she is a generalist or a specialist.
A generalist wizard learns an additional ritual.
She pays no cost to scribe it into her ritual book.

A specialist wizard gains an additional spell known.
The spell must be from her chosen school, including restricted spells.
If she trades her knowledge of this spell when she gains a level, she may only trade it for knowledge of another spell from her chosen school.

In either case, the spell or ritual's level cannot exceed half her wizard level -- normally, the highest level of spells that she can cast.
