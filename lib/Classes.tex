...
This power functions like the \spell{enlarge} spell, except that it increases the target's size by two size categories.
...
A sorcerer knows a number of spells equal to his level.
The spells may be of any spell level he has access to.
