...
\parhead{Throwing Other Weapons} It is possible to throw a weapon that is not designed to be thrown. The range increment is 10 feet. You are treated as being nonproficient with the weapon, preventing you from gaining the \plus4 proficiency bonus. If the attack hits, the weapon deals its normal damage.
...
\tind Chainmail 			& \plus5 		& 1/2\mult 	& \minus3 & 30\% & 30 ft. & 20 ft. & 50 gp     & 40 lb.\\
...
You can hold items in a hand holding
Defending yourself with a buckler requires the free use of the hand, so you .
Using a buckler does not occupy your hand, allowing you to hold items with 
You can use 
, leaving you free to use another weapon or cast spells with that hand.
However, you must choose to either defend yourself with the arm or 

You can use a bow or crossbow without penalty while carrying it. You can also use your shield arm to wield a weapon (whether you are using an off-hand weapon or using your off hand to help wield a heavy weapon), but you take a \minus1 penalty on attack rolls while doing so. If you use a weapon in the hand with the buckler, you don't get the buckler's defense bonus for the rest of the round.
...
\subparhead{Wooden or Steel} Wooden and steel shields offer the same basic protection, though they respond differently to special attacks.
\parhead{Shield, Tower} This massive wooden shield is nearly as tall as an average human. You must have a Strength of 3 to use a tower shield. If you attempt to use a tower shield with a lower Strength, you are automatically treated as being both \defenseless and nonproficient with the shield.
...
\begin{dtable*}
    ...
    \begin{dtabularx}{\textwidth}{l l l l l X l}
        \tb{Poison}         & \tb{Transmission} & \tb{Form} & \tb{Potency} & \tb{Primary Effect}            & \tb{Terminal Effect}                              & \tb{Price} \\
...
\parhead{Gas} Gaseous poisons are difficult to store, but 
