...
% If starred, skip the onecolumn/twocolumn.
% Also, fix the lcaption command which breaks html bookmark generation in bizarre ways
\DeclareDocumentEnvironment{longtablewrapper}{s}
{
    \IfValueF{#1}{\onecolumn}
    \small
...
\DeclareDocumentCommand{\poisonspaceless}{}{🧪}
\DeclareDocumentCommand{\potionspaceless}{}{⚗️}
