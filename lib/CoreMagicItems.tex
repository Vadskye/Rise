    ...
    \subsection{Implement Table}
        ...
        \begin{longtabuwrapper}
            \begin{longtabu}{l X l l l l}
                ...
                \mitemref{Distant}[wand] & Can double spell's range & \mitempricetable{Active}{2} & \mitempref{Distant} \\
                \mitemref{Flamespell}[wand] & Can ignite creature & \mitempricetable{Active}{3} & \mitempref{Flamespell} \\
                \mitemref{Frostspell}[wand] & Can fatigue creature & \mitempricetable{Active}{3} & \mitempref{Frostspell} \\
                \mitemref{Thunderspell}[wand] & Can stagger creature & \mitempricetable{Active}{3} & \mitempref{Thunderspell} \\
            \end{longtabu}
        \end{longtabuwrapper}
        \twocolumn
