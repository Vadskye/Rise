...
\begin{magicitemdef}{Flaming}[Active]{2}[Melee, Ranged]{Evocation [Fire]}{as weapon}
    \magicitemability{Active}[Standard action] If you speak a command word, you can ignite this weapon in flames and make a single strike with it. The next time you hit with the weapon, the target takes 1d8 fire damage per two item power in addition to the damage from your attack.
...
\begin{magicitemdef}{Shocking}[Active]{2}[Melee, Ranged]{Evocation [Electricity]}{as weapon}
    ...
    The next time you hit with the weapon, the target takes 1d8 electricity damage per two item power in addition to the damage from your attack.
