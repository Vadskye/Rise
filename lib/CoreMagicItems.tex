...
\begin{magicitemdef}{Throwing Gloves}[Passive]{2}[Arms]{Transmutation [Augment]}{leather or textiles}
    \magicitemability{Passive} You can throw any item as if it was designed to be thrown, granting you a \plus4 bonus to the attack.
...
You gain a bonus to damage with damaging spells equal to the weapon's enhancement bonus.
In addition, each \plus1 of enhancement bonus grants you an additional offensive legend point each day.
