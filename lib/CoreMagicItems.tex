...
\end{comment}
        ...
        \begin{magicitemdef}{Heroic Vengeance}[Active]{3}[Ring]{Abjuration [Retributive]}{bone, metal, or jewelry}
            \magicitemability{Triggered}[Immediate action] When a foe within \rngmed range rolls a natural 20 on an attack against you, you can activate this item. If you do, the attacking creature takes 1d10 divine damage per item power.
        \end{magicitemdef}
