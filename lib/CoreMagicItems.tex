...
\begin{magicitemdef}{Flaming}[Active]{2}[Melee, Ranged]{Evocation [Fire]}{as weapon}
    \magicitemability{Active}[Standard action] If you speak a command word, you can ignite this weapon in flames and make a single attack with it. The next time you hit with the weapon, the target takes 1d8 fire damage per two item power in addition to the damage from your attack.
...
\begin{magicitemdef}{Freezing}[Active]{2}[Melee, Ranged]{Evocation [Cold]}{as weapon}
    \magicitemability{Active}[Standard action] If you speak a command word, you can surround this weapon in bitter cold and make a single attack with it. If this attack hits, the target takes 1d8 cold damage per two item power in addition to the damage from your attack.
...
\begin{magicitemdef}{Poisoning}[Active]{2}[Melee]{Conjuration/Transmutation [Creation, Temporal]}{as weapon}
    \magicitemability{Active}[Standard action] If you place a poison into a small slot in the hilt (or similar gripping surface) of this weapon, that poison can be used to quickly coat the weapon's striking surface in battle.
    \magicitemability{Active}[Swift action] If you press a small button on the hilt (or similar gripping surface) of this weapon, the weapon's striking surface becomes coated in the poison stored in the slot.

    After you activate this ability, it takes 5 rounds for the weapon to create more poins.
