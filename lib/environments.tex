...
% args: modifier, name, tags
\DeclareDocumentEnvironment{ability}{o m o}
{
    % abilities should always stay on the same page
    \begin{thesamepage}
    \setlength\multicolsep{0pt}
    % the name and tags go on a single row
    \begin{multicols}{2}
        \IfValueTF{#1}
        {
            \lowercase{\hypertarget{ability:#1~#2}{}}\label{ability:#1~#2}
            \hypertarget{ability:#1~#2}
                {\subsubsection{#2,~#1}}
        }
        {
            \lowercase{\hypertarget{ability:#2}{}}\label{ability:#2}
