...
\DeclareDocumentEnvironment{magicalsustainability}{s m o}
{
    \IfValueTF{#1}{
...
\DeclareDocumentEnvironment{magicalattuneability}{s m o}
{
    \IfValueTF{#1}{
...
\DeclareDocumentEnvironment{feat}{m m o}
{
    \subsection[#1~#2]{
        \protect
        \hypertargetraised{feat:#1}{
            \protect
            \hyperlink{ft:#1}{#1~[#2]\IfValueT{#3}{#3}}
        }
    }
    \label{feat:#1}
}
