...
\parhead{Bonus Languages} Any (other than secret languages, such as Druidic). See \pcref{Linguistics}.
...
\parhead{Bonus Languages} Giant, Gnome, Goblin, Orc, Terran, and Undercommon.
...
\parhead{Bonus Languages} Draconic, Gnoll, Gnome, Goblin, Orc, and Sylvan.
...
\parhead{Bonus Languages} Draconic, Dwarven, Elven, Giant, Goblin, and Orc.
...
\parhead{Automatic Languages} Common, Elven.
\parhead{Bonus Languages} Any (other than secret languages, such as Druidic).
...
\parhead{Bonus Languages} Draconic, Giant, Gnoll, and Goblin.
...
\parhead{Bonus Languages} Dwarven, Elven, Gnome, Goblin, and Orc.
