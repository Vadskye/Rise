...
\newcommand{\exposed}{\debuff{exposed} \reminder{\minus4 defenses vs.\ next attack}\xspace}
...
\newcommand{\sickened}{\debuff{sickened} \reminder{can't explode, subtract rank from damage}\xspace}
...
\newcommand{\stasis}{\debuff{stasis} \reminder{frozen in place}\xspace}
...
\newcommand{\steeled}{\buff{steeled} \reminder{crits deal less damage}\xspace}

\newcommand{\resistant}{\buff{resistant} \reminder{\plus4 defenses}\xspace}
