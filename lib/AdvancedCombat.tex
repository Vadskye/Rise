...
If your base attack bonus is \plus6 or higher, you can make multiple attacks as part of a full attack.This progression is shown on \trefnp{Attacks per Round}.
\begin{dtable}
    \lcaption{Attacks per Round}
    \begin{dtabularx}{\columnwidth}{*{3}{>{\lcol}X}}
        \thead{Base Attack Bonus} & \thead{Attacks per Round} \\
\hline
        1-5     & 1 \\
        6-10    & 2 \\
        11-15   & 3 \\
...
Some special abilities, such as the \spell{haste} spell, also grant you the ability to make multiple attacks. In all cases, making multiple attacks requires using a standard action to make a full attack. Additionally, any penalties imposed by taking multiple attacks do not affect any other attacks you make.

\subsection{Special Attacks}

\subsubsection{Feint}\label{Feint}
Instead of striking to deal damage, you can feint to leave your foe off-balance. You make an attack with a melee weapon as normal, except that you target the creature's Reflex defense instead of its Armor defense. Success means you deal no damage, but you gain a \plus5 bonus to physical attacks against the creature for 1 round.
...
A combat maneuver is an attempt to physically hinder your foe with your body, such as by shoving or tripping it. Unless otherwise noted, using a combat maneuver requires a free hand and replaces a physical attack made during a full attack. You make an attack against a creature within your reach, adding your maneuver modifier to the roll instead of your attack modifier. If your result equals or exceeds your foe's Maneuver defense, your attack hits, and your foe is affected by the maneuver.
...
\begin{figure}[h]
    \centering Base attack bonus or attack attribute \add special size modifier \add other bonuses and penalties
\end{figure}
...
\parhead{Disarm}\label{Disarm} You can strike an item your foe is wearing or holding. Success means you hit the object, and can choose whether or not to deal damage to it. If the item is not well secured, the item falls to the ground in the foe's square. If you take a foe's item using your bare hand, you can hold it rather than letting it fall to the ground. You can choose whether or not to deal damage to the object.

You can perform a disarm with any melee weapon, using either Strength or Dexterity.
...
\parhead{Block}\label{Block} As a move action, you can remain stationary to impede the movement of nearby foes. All squares you threaten are considered \difficultterrain to your foes.
...
\parhead{Example} Felix the 1st-level fighter is wielding two short swords against an evil goblin. The goblin has an Armor defense of 15. Felix has a Strength of 3 and a base attack bonus of \plus4. This means his attack bonus is \plus4. If he attacks with both weapons at once, he takes no penalty to his attack roll, because both weapons are light. If he rolls an 11 or higher, he hits the goblin. His damage bonus is \plus1 from his Strength, so he rolls 1d6\plus1 for each weapon. If he rolls a 4 and a 2, he would keep the 4, dealing a total of 5 damage.
