...
If your combat prowess is at least 6, you can make multiple attacks as part of a full attack. This progression is shown on \trefnp{Attacks per Round}.
\begin{dtable}
    \lcaption{Attacks per Round}
    \begin{dtabularx}{\columnwidth}{*{3}{>{\lcol}X}}
        \thead{Combat Prowess} & \thead{Attacks per Round} \\
        \hline
        1-5     & 1 \\
        6-10    & 2 \\
        11-15   & 3 \\
...
\par If you can make multiple attacks from a high combat prowess, you can deal additional damage if your attack hits. For every 5 points by which your attack hits, you deal double damage, up to a maximum multiplier equal to the number of attacks you can make. For example, if your combat prowess is \plus11 and you hit by 10, your attack would deal triple damage.
...
\parhead{Example} Felix the 1st-level fighter is wielding two short swords against an evil goblin. The goblin has an Armor defense of 15. Felix has a Strength of 3 and a combat prowess of 4. This means his attack bonus is \plus4. If he attacks with both weapons at once, he takes no penalty to his attack roll, because both weapons are light. If he rolls an 11 or higher, he hits the goblin. His damage bonus is \plus1 from his Strength, so he rolls 1d6\plus1 for each weapon. If he rolls a 4 and a 2, he would keep the 4, dealing a total of 5 damage.
