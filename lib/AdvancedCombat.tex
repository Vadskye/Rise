...
A creature with a \glossterm{climb speed} can move at the indicated speed while climbing. In addition, it has a \plus5 bonus to Climb checks (see \pcref{Climb}). It can always choose to take 10 on Climb checks, even if rushed or threatened. It cannot make an accelerated climb.
