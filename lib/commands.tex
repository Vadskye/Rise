...
\newcommand{\decelerated}{\debuff{decelerated} \reminder{\minus4 Ref, quarter speed}\xspace}
...
\newcommand{\prone}{\debuff{prone} \reminder{quarter speed, \minus2 accuracy, Armor, and Ref}\xspace}
...
\newcommand{\unaware}{\debuff{unaware} \reminder{\minus4 Armor and Ref}\xspace}
