...
\newcommand{\goaded}{\conditionlink{goaded} \reminder{20\% failure on attacks not against goading creature}\xspace}
...
\newcommand{\taunted}{\conditionlink{taunted} \reminder{50\% failure on attacks not against taunting creature}\xspace}
\newcommand{\unaware}{\conditionlink{unaware} \reminder{critically hit on every attack}\xspace}
