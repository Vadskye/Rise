...
\DeclareDocumentCommand{\epicfate}{m m}
{
  \parhead{Rank #1 -- #2}
}

\DeclareDocumentCommand{\magicalepicfate}{m m}
{
  \parhead{Rank #1 -- #2 \sparkle}
}
...
\newcommand{\brief}{\glossterm{brief}}
\newcommand{\briefly}{\glossterm{briefly}}

% Temporary while naming conventions are sorted out
% Briefly means "Until the end of your next turn (immovable if you delay)"
% Momentary means "Until the start of your next turn"
\newcommand{\momentary}{\glossterm{momentary}}
\newcommand{\momentarily}{\glossterm{momentarily}}

% Enduring means "Until the end of the next round" or "Until the end of your next turn (movable if you delay)"
\newcommand{\enduring}{\glossterm{enduring}}
\newcommand{\enduringly}{\glossterm{enduringly}}
