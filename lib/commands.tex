...
\newcommand{\blinded}{\conditionlink{blinded} \reminder{unable to see}\xspace}
\newcommand{\bloodied}{\conditionlink{bloodied} \reminder{\minus4 Fort, Ment}\xspace}
\newcommand{\charmed}{\conditionlink{charmed} \reminder{likes its charmer}\xspace}
\newcommand{\confused}{\conditionlink{confused} \reminder{acts randomly}\xspace}
\newcommand{\defenseless}{\conditionlink{defenseless} \reminder{\minus2 defense vs.\ melee}\xspace}
\newcommand{\disoriented}{\conditionlink{disoriented} \reminder{moves randomly}\xspace}
\newcommand{\dominated}{\conditionlink{dominated} \reminder{obeys its dominator}\xspace}
\newcommand{\exhausted}{\conditionlink{exhausted} \reminder{half speed, can't sprint, \minus2 to all}}
\newcommand{\fascinated}{\conditionlink{fascinated} \reminder{can't act until threatened}}
\newcommand{\fatigued}{\conditionlink{fatigued} \reminder{half speed, can't sprint}\xspace}
\newcommand{\frightened}{\conditionlink{frightened} \reminder{\minus4 to all while near its fear}\xspace}
\newcommand{\dazed}{\conditionlink{dazed} \reminder{actions are delayed}\xspace}
\newcommand{\partiallyblinded}{\conditionlink{dazzled} \reminder{\minus2 to strikes, loses special vision}\xspace}
...
\newcommand{\grappled}{\conditionlink{grappled} \reminder{physically wrestling}\xspace}
\newcommand{\goaded}{\conditionlink{goaded} \reminder{\minus2 to attacks not against goading creature}\xspace}
\newcommand{\helpless}{\conditionlink{helpless}\xspace}
\newcommand{\ignited}{\conditionlink{ignited} \reminder{1d6 damage/round, \minus2 all}\xspace}
\newcommand{\immobilized}{\conditionlink{immobilized} \reminder{can't leave its location}\xspace}
\newcommand{\nauseated}{\conditionlink{nauseated} \reminder{\minus4 all}\xspace}
\newcommand{\panicked}{\conditionlink{panicked} \reminder{flees or cowers from its fear}\xspace}
\newcommand{\paralyzed}{\conditionlink{paralyzed} \reminder{can't move}\xspace}
\newcommand{\petrified}{\conditionlink{petrified} \reminder{turned to stone}\xspace}
\newcommand{\prone}{\conditionlink{prone} \reminder{\minus2 in melee, \plus2 vs ranged}}
\newcommand{\shaken}{\conditionlink{shaken} \reminder{\minus2 to all while near its fear}\xspace}
\newcommand{\sickened}{\conditionlink{sickened} \reminder{\minus2 to all}\xspace}
\newcommand{\slowed}{\conditionlink{slowed} \reminder{moves at half speed}\xspace}
\newcommand{\staggered}{\conditionlink{staggered} \reminder{\minus4 to all}\xspace}
\newcommand{\stunned}{\conditionlink{stunned} \reminder{can't take actions}\xspace}
\newcommand{\taunted}{\conditionlink{taunted} \reminder{\minus4 to attacks not against taunting creature}\xspace}
\newcommand{\unaware}{\conditionlink{unaware} \reminder{critically hit on every hit}\xspace}
...
\newcommand{\concealment}{concealment \reminder{\plus2 to physical defenses}}
