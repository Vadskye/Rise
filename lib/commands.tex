...
\DeclareDocumentCommand{\maybedamage}{o}
{
...
{1d4\maybedamage[#1] \plus1 per 3 power}
\newcommand{\damagerankzerolow}[1]
{1d6\maybedamage[#1]}

\newcommand{\damagerankone}[1]
{1d6\maybedamage[#1] \plus1 per 2 power}
\newcommand{\damagerankonehigh}[1]
{1d6\maybedamage[#1] \plus1 per 2 power} % Same as d1, unfortunately
\newcommand{\damagerankonelow}[1]
{1d10\maybedamage[#1]}

\newcommand{\damageranktwo}[1]
{1d8\maybedamage[#1] \plus1 per 2 power}
\newcommand{\damageranktwohigh}[1]
{1d6 per 3 power\maybedamage[#1]}
\newcommand{\damageranktwolow}[1]
{2d6\maybedamage[#1]}

\newcommand{\damagerankthree}[1]
{1d8\maybedamage[#1] \plus1 per power}
\newcommand{\damagerankthreehigh}[1]
{1d6\maybedamage[#1] plus 1d6 per 3 power}
\newcommand{\damagerankthreelow}[1]
{3d6\maybedamage[#1]}

\newcommand{\damagerankfour}[1]
{1d10\maybedamage[#1] plus 1d6 per 3 power}
\newcommand{\damagerankfourhigh}[1]
{1d8 per 3 power\maybedamage[#1]}
\newcommand{\damagerankfourlow}[1]
{4d6\maybedamage[#1]}

\newcommand{\damagerankfive}[1]
{1d8\maybedamage[#1] plus 1d8 per 3 power}
\newcommand{\damagerankfivehigh}[1]
{1d6\maybedamage[#1] plus 1d6 per 2 power}
\newcommand{\damagerankfivelow}[1]
{6d6\maybedamage[#1]}

\newcommand{\damageranksix}[1]
{2d8\maybedamage[#1] plus 1d8 per 3 power}
\newcommand{\damageranksixhigh}[1]
{1d8 per 2 power\maybedamage[#1]}
\newcommand{\damageranksixlow}[1]
{5d10\maybedamage[#1]} % many options

\newcommand{\damagerankseven}[1]
{2d8\maybedamage[#1] plus 1d8 per 2 power}
\newcommand{\damageranksevenhigh}[1]
{1d10\maybedamage[#1] plus 1d10 per 2 power}
\newcommand{\damageranksevenlow}[1]
{7d10\maybedamage[#1]}

\newcommand{\damagerankeight}[1]
{4d8\maybedamage[#1] plus 1d8 per 2 power}
\newcommand{\damagerankeighthigh}[1]
{1d6 per power\maybedamage[#1]}
\newcommand{\damagerankeightlow}[1]
{10d10\maybedamage[#1]}

\newcommand{\damageranknine}[1]
{5d6\maybedamage[#1] plus 1d6 per power}
\newcommand{\damagerankninehigh}[1]
{1d8 per power\maybedamage[#1]}
