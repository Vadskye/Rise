...
\newcommand{\longreminder}[1]{\textit{(#1)}}
...
% 0.55 / 0.45 is chosen to make sure "Medium natural humanoid" fits on one line.
...
\newcommand{\brief}{\glossterm{brief}\xspace}
\newcommand{\briefly}{\glossterm{briefly}\xspace}
