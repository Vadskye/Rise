...
\newcommand{\confusionexplanation}{A confused creature cannot take actions normally. At the beginning of each round, it randomly decides to take one of four actions that round: babble incoherently, flee from its enemies as if panicked, attack the nearest creature, or act normally. A confused character who can't carry out the indicated action does nothing but babble incoherently.\xspace}
