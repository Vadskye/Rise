...
{1d4\maybedamage[#1] \plus1 per 2 power}
...
{1d6\maybedamage[#1] \plus1 per power}
\newcommand{\damageranktwolow}[1]
{1d8+1d6\maybedamage[#1]}
...
{1d8\maybedamage[#1] plus 1d8 per 2 power}
\newcommand{\damageranksixlow}[1]
{7d8\maybedamage[#1]} % many options
...
{1d6\maybedamage[#1] plus 1d6 per power}
\newcommand{\damagerankeightlow}[1]
{11d10\maybedamage[#1]}

\newcommand{\damageranknine}[1]
{2d8\maybedamage[#1] plus 1d8 per power}
