...
%   level, if any
%   ability name
\DeclareDocumentCommand{\cf}{m o m}
{
    \IfValueTF{#2}
    {
        { \subsubsection{Rank~#2~--~#3} }
    }
    {
        { \subsubsection{#3} }
    }
...
\DeclareDocumentCommand{\sparkle}{}{\,\includegraphics[width=0.75\fsize]{emoji/sparkles}}

\DeclareDocumentCommand{\magical}{}{\glossterm{magical}\sparkle}
