...
\DeclareDocumentCommand{\termdef}{m o m}
{
    ...
    {
        \hypertargetraised{\lowercase#3:#1}{}
        \hypertargetraised{\lowercase#3:#1s}{}
    }
    % Enable this to test for missing glossary definitions
    % \label{#1}\label{#1s}
    % Enable this to test for unnecessary glossary entries
...
\DeclareDocumentCommand{\stdability}{o m}
{
    \IfValueTF{#1}
    {\termlink[#1]{#2}{stdability}}
    {\termlink{#2}{stdability}}
}
\DeclareDocumentCommand{\stdabilitydef}{m}
{
    \termdef{#1}{stdability}\label{#1}
}
