...
\newcommand{\midair}{\debuff{midair} \reminder{\minus2 Armor, Brawn, Ref}\xspace}
...
\newcommand{\partiallyunaware}{\debuff{partially unaware} \reminder{50\% miss chance, \minus2 defenses}\xspace}
...
\newcommand{\fortified}{\buff{fortified} \reminder{\plus2 Fort and Ment}\xspace}
