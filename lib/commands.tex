...
\newcommand{\confused}{\debuff{confused} \reminder{\minus2 defenses, acts randomly}\xspace}
...
\newcommand{\goaded}{\debuff{goaded} \reminder{\minus1 accuracy vs. non-goading creatures}\xspace}
...
\newcommand{\slowed}{\debuff{slowed} \reminder{half speed, \minus1 Ref}\xspace}
