...
\newcommand{\blinded}{\glossterm{blinded} \reminder{unable to see}\xspace}
\newcommand{\bloodied}{\glossterm{bloodied} \reminder{\minus4 Fort, Ment}\xspace}
\newcommand{\charmed}{\glossterm{charmed} \reminder{likes its charmer}\xspace}
\newcommand{\confused}{\glossterm{confused} \reminder{acts randomly}\xspace}
\newcommand{\defenseless}{\glossterm{defenseless} \reminder{\minus2 defense vs.\ melee}\xspace}
\newcommand{\disoriented}{\glossterm{disoriented} \reminder{moves randomly}\xspace}
\newcommand{\dominated}{\glossterm{dominated} \reminder{obeys its dominator}\xspace}
\newcommand{\exhausted}{\glossterm{exhausted} \reminder{half speed, can't sprint, \minus2 to all}}
\newcommand{\fascinated}{\glossterm{fascinated} \reminder{can't act until threatened}}
\newcommand{\fatigued}{\glossterm{fatigued} \reminder{half speed, can't sprint}\xspace}
\newcommand{\frightened}{\glossterm{frightened} \reminder{\minus4 to all while near its fear}\xspace}
\newcommand{\dazed}{\glossterm{dazed} \reminder{actions are delayed}\xspace}
\newcommand{\partiallyblinded}{\glossterm{dazzled} \reminder{\minus2 to strikes, loses special vision}\xspace}
\newcommand{\deafened}{\glossterm{deafened} \reminder{unable to hear}\xspace}
\newcommand{\disabled}{\glossterm{disabled} \reminder{at 0 hit points}\xspace}
\newcommand{\grappled}{\glossterm{grappled} \reminder{physically wrestling}\xspace}
\newcommand{\goaded}{\glossterm{goaded} \reminder{\minus2 to attacks not against goading creature}\xspace}
\newcommand{\helpless}{\glossterm{helpless}\xspace}
\newcommand{\ignited}{\glossterm{ignited} \reminder{1d6 damage/round, \minus2 all}\xspace}
\newcommand{\immobilized}{\glossterm{immobilized} \reminder{can't leave its location}\xspace}
\newcommand{\nauseated}{\glossterm{nauseated} \reminder{\minus4 all}\xspace}
\newcommand{\panicked}{\glossterm{panicked} \reminder{flees or cowers from its fear}\xspace}
\newcommand{\paralyzed}{\glossterm{paralyzed} \reminder{can't move}\xspace}
\newcommand{\petrified}{\glossterm{petrified} \reminder{turned to stone}\xspace}
\newcommand{\prone}{\glossterm{prone} \reminder{\minus2 in melee, \plus2 vs ranged}}
\newcommand{\shaken}{\glossterm{shaken} \reminder{\minus2 to all while near its fear}\xspace}
\newcommand{\sickened}{\glossterm{sickened} \reminder{\minus2 to all}\xspace}
\newcommand{\slowed}{\glossterm{slowed} \reminder{moves at half speed}\xspace}
\newcommand{\staggered}{\glossterm{staggered} \reminder{\minus4 to all}\xspace}
\newcommand{\stunned}{\glossterm{stunned} \reminder{can't take actions}\xspace}
\newcommand{\taunted}{\glossterm{taunted} \reminder{\minus4 to attacks not against taunting creature}\xspace}
\newcommand{\unaware}{\glossterm{unaware} \reminder{critically hit on every hit}\xspace}
