...
\DeclareDocumentCommand{\sense}{o m}
{
    \IfValueTF{#1}
    {\termlink[#1]{#2}{sense}}
    {\termlink{#2}{sense}}
}
\DeclareDocumentCommand{\sensedef}{m m}
{
    \termdef{#1}[#2]{sense}
    \label{#1}
}

\DeclareDocumentCommand{\creatureorigin}{o m}
{
    \IfValueTF{#1}
    {\termlink[#1]{#2}{creatureorigin}}
    {\termlink{#2}{creatureorigin}}
}
\DeclareDocumentCommand{\creatureorigindef}{m m}
{
    \termdef{#1}[#2]{creatureorigin}
    \label{#1}
}
...
\DeclareDocumentCommand{\creaturesubtype}{o m}
{
    \IfValueTF{#1}
    {\termlink[#1]{#2}{creaturesubtype}}
    {\termlink{#2}{creaturesubtype}}
}
\DeclareDocumentCommand{\creaturesubtypedef}{m m}
{
    \termdef{#1}[#2]{creaturesubtype}
    \label{#1}
}
