...
\begin{swspelllist}
    ...
    \SLavatarofshielding[Abjur]
    \SLantimagicfield*

    \SLicestorm[Conj]
    \SLavataroftranslocation*
...
\begin{rituallist}
    ...
    \spellhead[Div]{Find the Path} Shows most direct way to a location.
...
\begin{rituallist}
    ...
    \spellhead{Restore Attributes}[Lesser] Dispels magical ability penalty or repairs 1d4 ability damage.
...
\begin{rituallist}
    ...
    \spellhead{Remove Curse} Frees object or person from curse.
    \spellhead{Restore Attributes} Restores level and attribute score drains.
    \spellhead{Sending} Delivers short message anywhere, instantly.
...
\begin{rituallist}
    ...
    \spellhead{Restore Attributes}[Greater] As restore attributes, plus other conditions.
