...
\createspell{\SLacidarrowgreater}{Acid Arrow}[Greater]
    {Propel acid to deal lingering damage and stagger.}
...
\createspell{\SLbestowcurse}{Bestow Curse}
    {\minus6 to an attribute score; \minus4 on accuracy, saves, and checks; or 25\% chance of losing each action.}
...
\createspell{\SLenlargemass}{Enlarge}[Mass]
...
\createspell{\SLshrinkmass}{Shrink}[Mass]
...
\createspell{\SLresistmagic}{Spell Resistance}
...
\createspell{\SLwavesofexhaustion}{Waves of Exhaustion}
    {Exhaust creatures in large cone.}
...
\createspell{\SLboonofmastery}{Boon of Mastery}
    {Grant ally \plus5 to all skills.}
\createspell{\SLboonofmasterygreater}{Boon of Mastery}[Greater]
    {Grant ally \plus10 to all skills.}
\createspell{\SLboonofperception}{Boon of Perception}
    {Grant ally \plus5 to perceptual skills.}
\createspell{\SLboonofprecision}{Boon of Precision}
    {Increase ally's critical range and multiplier.}
\createspell{\SLinvulnerabilitylesser}{Invulnerability}[Lesser]
...
\createspell{\SLmaskofthedeceiver}{Mask of the Deceiver}
    {Grant ally \plus5 to Bluff, Persuasion.}
