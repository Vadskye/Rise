...
\begin{spellsection}{Augment Attack}
    ...
    \begin{spellcontent}
        ...
        \begin{spelleffects}
            ...
            The bonus damage is equal to \spelldamage{1}{}[d6].
            \spelldur 1 round.
        \end{spelleffects}
    \end{spellcontent}
    \begin{spellfooter}
    ...
    \begin{spellcontent}
        ...
        \begin{spelleffects}
            \begin{spellattack}{Spellpower vs. Armor defense}
                \spellsuccess \spelldamage{1}{piercing}[d6]
            \end{spellattack}
        \end{spelleffects}
    \end{spellcontent}
    \begin{spellfooter}
    ...
    \begin{spellcontent}
        ...
        \begin{spelleffects}
            \begin{spellattack}{Spellpower vs. Fortitude}
                \spellsuccess \spelldamage{1}{life}[d6]. You gain temporary hit points equal to half the damage you deal. You can't gain more hit points than the target had.
...
\begin{spellsection}{Magic Ray}
    ...
    \begin{spellcontent}
        ...
        \begin{spelleffects}
            \begin{spellattack}{Spellpower vs. Reflex}
                \spellsuccess \spelldamage{1}{force}[d6].
            \end{spellattack}
        \end{spelleffects}
    \end{spellcontent}
    \begin{spellfooter}
