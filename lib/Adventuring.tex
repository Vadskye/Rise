...
\parhead{Armor Class} Objects are easier to hit than creatures because they usually don't move, but many are tough enough to shrug off some damage from each blow. An object's Armor defense is equal to 10 \add its size modifier \add its Dexterity. An inanimate object has a Dexterity of 0 (\minus10 penalty to AD). Furthermore, if you take a move action to focus on the object, you automatically hit with melee weapons and get a \plus4 bonus with ranged weapons on any attacks you make during your turn against the object.
