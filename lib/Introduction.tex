...
This result is compared to a number representing how difficult the action is, or \term{Difficulty Class} (DC).
...
The specific actions you can take during a combat turn are covered in more detail in \pcref{Combat Overview}.
...
\parhead{Taking 20} It's not impossible for you to trip over a tree root while walking normally, but you shouldn't roll every time you try to take a step.
...
\parhead{Narrative Time} In most cases, the exact time of day, and exactly how long an action takes, is not very important.
...
There are four important decisions required to create a character.

\begin{enumerate*}
    \item \textbf{Personality}: Who is your character?
        What do they want?
        What is their background?
        It's good to have some idea of what kind of character you want to play, or else the number of options available can feel overwhelming.
        However, you don't need to decide everything about your character before you start creating it.
        In fact, you can figure out their personality as you start playing the game.
        You should keep your character's personality and style in mind as you make other decisions, however.
    \item \textbf{Attributes}: Is your character strong and stupid, frail but agile, or just generally talented?
    ...
    \item \textbf{Race}: Is your character a surly dwarf, an agile elf, or a dim-witted half-orc?
...
Thus, a double (\mult2) and a double (\mult2) applied to the same number results in a triple (\mult3, because 2 \add 1 = 3).
...
Similarly, a blinded creature attempting to negotiate difficult terrain would need to spend 20 feet of movement to move 5 feet (doubling the cost twice, for a total multiplier of \mult4), rather than as 15 feet (adding 100\% twice).
