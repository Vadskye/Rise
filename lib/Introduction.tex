...
This result is compared to a number representing how difficult the action is, or \glossterm{Difficulty Rating} (DR).
...
Races are described in more detail at \pcref{Races}
