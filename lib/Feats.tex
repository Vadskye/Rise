...
\begin{longtabuwrapper}
    \begin{longtabu}{>{\lcol}p{10em} >{\lcol}p{15em} >{\lcol}X >{\lcol}p{3em}}
        ...
        \midrule
        \thead{Magic Style Feats} & \thead{Prerequisites} & \thead{Benefit} & \thead{Page} \\
...
\featpre Two attacks.
\featben In place of two attacks, you can make a physical attack with a \plus5 bonus.
If you hit, you deal damage normally.
You may trade additional attacks to make this strike.
For each attack you trade, you gain an additional \plus5 bonus.
...
This grants you a \plus4 bonus to attacks with the weapon and allows you to defend yourself with it, just as if you were using another melee weapon you are proficient with.
...
\featben You gain a \plus2 bonus to attack with strikes.
...
\featpre Dex 3.
\featben You gain a \plus2 bonus to attack when attacking with two weapons at once (see \pcref{Two-Weapon Fighting}).
...
\begin{itemize}
    ...
    \item Spears: If a creature charges you, you gain a \plus5 bonus to physical attacks against it until the end of the round.
