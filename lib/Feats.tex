...
\begin{longtabuwrapper}
    \begin{longtabu}{>{\lcol}p{10em} >{\lcol}p{15em} >{\lcol}X >{\lcol}p{3em}}
        ...
        \featref{Brutal Magic} & Base attack bonus \plus4, 1st level spells & Gain spellpower bonus after making physical attack & \featpref{Brutal Magic} \\
        ...
        \featref{Resilient Magic} & 2nd level Abjuration spell & Spells persist for 1 round after being dispelled & \featpref{Resilient Magic} \\
...
\feat{Brutal Magic}{Combat, Magic}
\featpres Base attack bonus \plus4, 1st level spells.
\featben If you deal lethal damage in excess of your spellpower with physical attacks during a single round, you gain a \plus2 bonus to spellpower for 1 round.
...
If hit, you deal double damage.
If your attack result also beats the foe's Maneuver defense, you can shove the creature using that attack result.
...
\begin{dtable}
    ...
    \begin{dtabularx}{\columnwidth}{l l X}
        \thead{Class} & \thead{Ability} & \thead{Effect} \\
        ...
        Ranger & Quarry & \plus1 use per day \\
...
The free attack gains the normal bonus for striking a prone target (\minus4 to physical defenses).
...
\featpre Ability to cast an Abjuration spell of at least 2nd level.
...
\feat{Retributive Magic}{Magic}
\featpre Ability to cast an Abjuration spell of at least 1st level.
\featben If you take lethal damage in excess of your spellpower during a single round, you gain a \plus2 bonus to spellpower for 1 round.
This bonus does not stack with itself.
