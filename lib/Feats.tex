...
\begin{longtabuwrapper}
    \begin{longtabu}{>{\lcol}p{10em} >{\lcol}p{15em} >{\lcol}X >{\lcol}p{3em}}
        ...
        \featref{Skill Mastery}\fn{1} & Any skill 5 ranks & Roll twice for checks with selected skill & \featpref{Skill Mastery} \\
        \tind \featref{Skill Specialization}\fn{1} & Any skill 10 ranks, Skill Mastery with skill & \plus5 to skill & \featpref{Skill Specialization} \\
