...
\begin{longtabuwrapper}
    \begin{longtabu}{>{\lcol}p{10em} >{\lcol}p{15em} >{\lcol}X >{\lcol}p{8em} >{\lcol}p{3em}}
        ...
        \featref{Extra Ability}         & Class ability with limited uses   & Gain additional uses of class feature & \x & \featpref{Extra Ability} \\
        ...
        \featref{Enhanced Senses} & 1st level Awareness spell & \plus2 to Awareness and Social Insight, later \plus4 & \x & \featpref{Enhanced Senses} \\
        ...
        \featref{Legendary Social Insight} & Social Insight 15 ranks & Read creature's mind & \x & \featpref{Legendary Social Insight} \\
...
\featben You gain a \plus2 bonus to Awareness and Social Insight checks.
...
\featben You gain additional uses of your chosen class ability. The number of uses you gain depends on the class feature chosen, as shown on \trefnp{Extra Ability Uses}.
\begin{dtable}
...
\feat{Legendary Social Insight}{Skill}
\featpre Social Insight 15 ranks.
\featben When you make a Social Insight check, if the result is 30 or higher, you may treat it as an attack against the Mental defense of one creature that you can see.
