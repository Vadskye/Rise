...
\begin{longtabuwrapper}
    \begin{longtabu}{>{\lcol}p{10em} >{\lcol}p{15em} >{\lcol}X >{\lcol}p{6em} >{\lcol}p{3em}}
        ...
        \midrule
        \thead{Combat Feats} & \thead{Prerequisites (Prowess 4)} & \thead{Benefit} & \thead{Feat Types} & \thead{Page} \\
        ...
        \midrule
        \thead{Combat Feats} & \thead{Prerequisites (Prowess 8)} & \thead{Benefit} & \thead{Feat Types} & \thead{Page} \\
        ...
        \midrule
        \thead{Combat Feats} & \thead{Prerequisites (Prowess 12)} & \thead{Benefit} & \thead{Feat Types} & \thead{Page} \\
        ...
        \midrule
        \thead{Combat Feats} & \thead{Prerequisites (Prowess 18)} & \thead{Benefit} & \thead{Feat Types} & \thead{Page} \\
...
\begin{longtabuwrapper}
    \begin{longtabu}{>{\lcol}p{10em} >{\lcol}p{15em} >{\lcol}X >{\lcol}p{6em} >{\lcol}p{3em}}
        ...
        \midrule
        \thead{Style Feats} & \thead{Prerequisites (Prowess 4)} & \thead{Benefit} & \thead{Feat Types} & \thead{Page} \\
        ...
        \midrule
        \thead{Style Feats} & \thead{Prerequisites (Prowess 8)} & \thead{Benefit} & \thead{Feat Types} & \thead{Page} \\
        ...
        \midrule
        \thead{Style Feats} & \thead{Prerequisites (Prowess 12)} & \thead{Benefit} & \thead{Feat Types} & \thead{Page} \\
        \featref{Legendary Style} & Any three Style feats & Use two styles at once & \x & \featpref{Legendary Style} \\

        \midrule
        \thead{Style Feats} & \thead{Prerequisites (Prowess 16)} & \thead{Benefit} & \thead{Feat Types} & \thead{Page} \\
