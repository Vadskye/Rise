...
\begin{longtabuwrapper}
    \begin{longtabu}{>{\lcol}p{10em} >{\lcol}p{15em} >{\lcol}X >{\lcol}p{3em}}
        ...
        \featref{Skill Focus}\fn{1} & \x &  \plus4 bonus to checks with selected skill & \featpref{Skill Focus} \\
...
Choose a skill.
\featben You gain a \plus4 bonus to all checks involving that skill.
\parhead{Special}
