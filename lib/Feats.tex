...
{\small
    ...
    \begin{longtabu}{>{\lcol}p{10em} >{\lcol}p{15em} >{\lcol}X >{\lcol}p{6em} >{\lcol}p{3em}}
        ...
        \midrule
        \thead{Style Feats} & \thead{Prerequisites (BAB \plus12)} & \thead{Benefit} & \thead{Feat Types} & \thead{Page} \\
        \featref{Legendary Style} & Any three Style feats & Use two styles at once & \x & \featpref{Legendary Style} \\

        \midrule
        \thead{Style Feats} & \thead{Prerequisites (BAB \plus16)} & \thead{Benefit} & \thead{Feat Types} & \thead{Page} \\
