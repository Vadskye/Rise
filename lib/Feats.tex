...
{\small
    ...
    \begin{longtabu}{>{\lcol}p{10em} >{\lcol}p{15em} >{\lcol}X >{\lcol}p{3em}}
        ...
        \featref{Combat Casting} & \x &  \plus3 bonus to Concentration checks to cast spells, reroll 1/day & \featpref{Combat Casting} \\
...
\featben You gain a \plus3 bonus to Concentration checks made to cast a spell or use a spell-like ability.
