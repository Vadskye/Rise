...
\begin{longtabuwrapper}
    \begin{longtabu}{>{\lcol}p{10em} >{\lcol}p{15em} >{\lcol}X >{\lcol}p{3em}}
        ...
        \featref{Personal Magic} & \x & Personalized magic grants various benefits & \featref{Personal Magic} \\
        ...
        \featref{Creative Magic} & 4th level spells & Gain spellpower bonus with spells not cast recently & \\
        \featref{Peaceful Magic} & 3rd level Abjuration spell & Gain spellpower bonus after not taking damage & \featpref{Peaceful Magic} \\
        ...
        \featref{Unliving Conduit} & 2nd level Vivimancy spell & Gan spellpower bonus when undead are near & \featpref{Unliving Conduit} \\
