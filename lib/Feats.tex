...
\begin{longtabuwrapper}
    \begin{longtabu}{>{\lcol}p{10em} >{\lcol}p{15em} >{\lcol}X >{\lcol}p{3em}}
        ...
        \featref{Augment Summoning} & 2nd level Summoning spell & \plus2 to spellpower with Summoning spells & \featpref{Augment Summoning} \\
        ...
        \featref{Counterspell} & Spellcraft 10 ranks, 2nd level spells & Counter spells cast by foe & \featpref{Counterspell} \\
            \tind \featref{Improved Counterspell} & Counterspell & Counter spells more easily & \featpref{Improved Counterspell} \\
        ...
        \featref{Dispel Mastery} & 3rd level Antimagic spell & Dispel more effectively & \featpref{Dispel Mastery} \\
        ...
        \featref{Fire Mastery} & 3rd level Fire spell & Fire spells can ignite foes & \featpref{Fire Mastery} \\
        \featref{Foresight} & 3rd level Divination spell & Cannot be caught unaware & \featpref{Foresight} \\
        ...
        \featref{Personal Magic} & \x & Personalized magic grants various benefits & \featpref{Personal Magic} \\
        ...
        \featref{Somatic Strike} & Combat prowess 8, 4th level spells & Make strike in place of somatic components & \featpref{Somatic Strike} \\
        \featref{Summoning Mastery} & 4th level Summoning spell & Maintain one Summoning spell indefinitely with no effort & \featpref{Summoning Mastery} \\
        \featref{Sympathetic Resistance} & 2nd level Abjuration spell & Casting damaging spells grants brief damage reduction & \featpref{Sympathetic Resistance} \\
        ...
        \featref{Brutal Magic} & 4th level spells & Gain spellpower bonus after making physical strike & \featpref{Brutal Magic} \\
        \featref{Creative Magic} & 6th level spells & Gain spellpower bonus with spells not cast recently & \featpref{Creative Magic} \\
        \featref{Devastating Magic} & 8th level spells & Spells trigger critical successes more easily & \featpref{Devastating Magic} \\
        \featref{Natural Magic} & Survival 10 ranks, 4th level spells & Gain spellpower bonus in natural environments & \featpref{Natural Magic} \\
        \featref{Peaceful Magic} & 5th level Abjuration spell & Gain spellpower bonus after not taking damage & \featpref{Peaceful Magic} \\
        \featref{Retributive Magic} & 4th level Abjuration spell & Gain spellpower bonus after taking damage & \featpref{Retributive Magic} \\
        \featref{Unliving Conduit} & 4th level Vivimancy spell & Gan spellpower bonus when undead are near & \featpref{Unliving Conduit} \\
        ...
        \featref{Legendary Linguist} & Linguistics 15 ranks & Speak all languages & \featpref{Legendary Linguist} \\
        ...
        \featref{Ranged Legerdemain} &  2nd level Telekinesis spell & Use Disable Device or Sleight of Hand at range & \featpref{Ranged Legerdemain} \\
...
\begin{longtabuwrapper}
    \begin{longtabu}{>{\lcol}p{10em} >{\lcol}p{15em} >{\lcol}X >{\lcol}p{6em} >{\lcol}p{3em}}
        ...
        \featref{Chargebreaker} & Dex 5 & Bonus damage if target approached you & Reaction, Style & \featpref{Chargebreaker} \\
...
\featpres Intelligence 10, three strikes.
...
\feat{Natural Magic}{Magic, Style}
\featpres Survival 10 ranks, 4th level spell known.
\featben While in a natural environment, you gain a \plus2 bonus to spellpower with all spells except Enchantment and Illusion spells.
