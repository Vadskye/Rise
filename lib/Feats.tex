...
\begin{longtabuwrapper}
    \begin{longtabu}{>{\lcol}p{10em} >{\lcol}p{15em} >{\lcol}X >{\lcol}p{8em} >{\lcol}p{3em}}
        ...
        \featref{Deathless} & Con 10 & Immune to death effects                    & \x & \featpref{Deathless} \\
        ...
        \featref{Pierce Delusions} & Per 10 & Immune to delusion effects          & \x & \featpref{Pierce Delusions} \\
        \featref{Rapid Recovery} & Con 3 & Naturally heal quickly & \x \featpref{Rapid Recovery} \\
        \featref{Stubborn} & Wil 10 & Immune to compulsion effects                & \x & \featpref{Stubborn} \\
        ...
        \midrule
        \label{cap:Class Feats} \tb{Class Feats} & \tb{Prerequisites} & \tb{Benefit} & \tb{Feat Types} & \tb{Page} \\
        ...
        \featref{Extra Ability}         & Class feature with limited uses   & Gain additional uses of class feature & \x & \featpref{Extra Ability} \\
        ...
        \featref{Invulnerable Rage}     & Rage, barbarian 14                & Improve damage reduction while raging & Rage & \featpref{Invulnerable Rage} \\
        ...
        \featref{Overpowering Rage}     & Rage, barbarian 10                & Gain combat maneuver bonus while raging & Rage & \featpref{Overpowering Rage} \\
        ...
        \featref{Rapid Rage}            & Rage, barbarian 2                 & \plus10 foot speed while raging  & Rage & \featpref{Rapid Rage} \\
        ...
        \featref{Wild Suppresssion}     & Wild magic, sorcerer 3            & Suppress spell instead of miscasting it & \x \featpref{Wild Suppresssion} \\
        ...
        \featref{Augment Summoning} & 2nd level Summoning spell & \plus2 to spellpower with Summoning spells & \x & \featpref{Augment Summoning} \\
        ...
        \featref{Spell Focus}\fn{1} & 2nd level spells &  \plus2 spellpower with specific school of magic & \x & \featpref{Spell Focus} \\
        ...
        \featref{Summoning Mastery} & 4th level Summoning spell & Maintain one Summoning spell indefinitely with no effort & \x & \featpref{Summoning Mastery} \\
        ...
        \featref{Vital Flow} & 2nd level Positive spell & Automatically heal every round & \x & \featpref{Vital Flow} \\
        ...
        \featref{Brutal Magic} & 4th level spells & Gain spellpower bonus after making physical strike & \x & \featpref{Brutal Magic} \\
        \featref{Creative Magic} & 6th level spells & Gain spellpower bonus with spells not cast recently & \x & \featpref{Creative Magic} \\
        \featref{Devastating Magic} & 8th level spells & Spells trigger critical successes more easily & \x & \featpref{Devastating Magic} \\
        \featref{Peaceful Magic} & 5th level Abjuration spell & Gain spellpower bonus after not taking damage & \x & \featpref{Peaceful Magic} \\
        \featref{Retributive Magic} & 4th level Abjuration spell & Gain spellpower bonus after taking damage & \x & \featpref{Retributive Magic} \\
        \featref{Unliving Conduit} & 4th level Vivimancy spell & Gan spellpower bonus when undead are near & \x & \featpref{Unliving Conduit} \\
        ...
        \featref{Extend Spell} & 2nd level spells & Double spell's range (\plus1) & \x & \featpref{Extend Spell} \\
        \featref{Imbued Spellstrike} & 2nd level spells & Combine spell with weapon strike (\plus1) & \x & \featpref{Imbued Spellstrike} \\
            \tind \featref{Improved Imbued Spellstrike} & 3rd level spells, Imbued Spellstrike & Imbue weapon with spell's power up to 5 minutes (\plus2) & \x & \featpref{Improved Imbued Spellstrike} \\
        \featref{Quicken Spell} & 3rd level spells & Cast spell as swift action, but lose next action (\plus2) & \x & \featpref{Quicken Spell} \\
        \featref{Patient Spell} & 2nd level spells & Cast spell slowly for spellpower bonus & \x & \featpref{Patient Spell} \\
        \featref{Reach Spell} & 3rd level spells & Cast touch spell at Close range (\plus2) & \x & \featpref{Reach Spell} \\
        ...
        \featref{Fascinating Performance} & Perform 4 ranks & Fascinate group of creatures & \x & \featpref{Fascinating Performance} \\
            \tind \featref{Suggestive Performance} & Perform 10 ranks, Fascinating Performance & Suggest action to fascinated creatures & \x & \featpref{Suggestive Performance} \\
        \featref{Freeing Performance} & Perform 12 ranks  & Dispel magical effects on ally & \x & \featpref{Freeing Performance} \\
        \featref{Inspire Competence} & Perform 4 ranks  & Grant allies bonuses to skill checks & \x & \featpref{Inspire Competence} \\
        \featref{Inspire Courage} & Perform 6 ranks  & Grant allies bonuses to accuracy and defenses against fear & \x & \featpref{Inspire Courage} \\
        \featref{Inspire Greatness} & Perform 12 ranks  & Grant allies bonuses to defenses & \x & \featpref{Inspire Greatness} \\
        \featref{Inspire Heroics} & Perform 20 ranks  & Grant allies temporary hit points and extra strike & \x & \featpref{Inspire Heroics} \\
        \featref{Inspire Spellpower} & Perform 10 ranks  & Grant allies bonus to spellpower & \x & \featpref{Inspire Spellpower} \\
        \featref{Legendary Performance} & Perform 15 ranks, any three Performance feats & Sustain two performances at once & \x & \featpref{Legendary Performance} \\
        \featref{Rapid Performance} & Perform 14 ranks, any three Performance feats & Perform as a swift action & \x & \featpref{Rapid Performance} \\
        \featref{Recover Performance} & Perform 10 ranks, any other Performance feat & Reroll failed performance attempt & \x & \featpref{Recover Performance} \\
        \featref{Spellwoven Performance} & Perform 10 ranks, any other Performance feat & Cast some spells while performing & \x & \featpref{Spellwoven Performance} \\
        ...
        \featref{Legendary Leaper} & Athletics 15 ranks & Always treated as having running start & \x & \featpref{Legendary Leaper} \\
        ...
        \featref{Legendary Sprinter} & Athletics 15 ranks & You can sprint for much longer & \x & \featpref{Legendary Sprinter} \\
        ...
        \featref{Skill Mastery}\fn{1} & Any skill 5 ranks & Roll twice for checks with selected skill & \x & \featpref{Skill Mastery} \\
        \tind \featref{Skill Specialization}\fn{1} & Any skill 10 ranks, Skill Mastery with skill & \plus5 to skill & \x & \featpref{Skill Specialization} \\
...
\featpre 2nd level or higher \glossterm{Summoning} spell known.
...
\featben At the end of each round, if you dealt damage with a physical attack that round, you gain a \plus2 bonus to spellpower during the next round.
...
This has no effect on creatures with a level that exceeds your spellpower.
...
This bonus does not stack with the bonus from the Spell Focus or Spell Specialization feats.
...
\begin{dtable}
    ...
    \begin{dtabularx}{\columnwidth}{l l X}
        ...
        Monk & \Ki manifestation & \plus2 uses per day \\
...
You can affect one creature per two Perform ranks you have.
All affected creatures gain temporary hit points equal to your check result and can take an extra strike at a \minus5 penalty when making a standard attack.
...
\featpre Rage ability, barbarian level 14.
...
\featpre 3rd level or higher \glossterm{Abjuration} spell known.
...
\begin{itemize}
    ...
    \item The DC to identify your spells and rituals with Spellcraft is increased by 10 (see \pcref{Spellcraft}).
...
In the turn after you cast it, you cannot act during the action phase.
...
\feat{Rapid Rage}{Class, Rage}
\featpre Rage ability, barbarian level 2.
\featben When you enter a rage, you can use this feat. If you do, during the rage you gain a \plus10 foot bonus to land speed.
\parhead{Special} You can only gain the benefit of one Rage feat at a time.
...
If you succeed, you can climb the creature as if it were a solid object with a Climb DC equal to its Maneuver defense.
...
Choose a skill.
\featpre 10 ranks in the chosen skill, Skill Mastery in the chosen skill.
...
\featpre 4th level or higher \glossterm{Summoning} spell.
...
The DC is equal to 10 \add the creature's level.
...
As a swift action, you can make a special check with a bonus equal to your combat prowess or your Intelligence (whichever is higher) \add 2 per round you have seen the creature fight.
The DC is equal to 15 \add the creature's level.
...
\featpre Dex 3.
\featben You gain a \plus2 bonus to accuracy when attacking with two weapons at once (see \pcref{Dual Wielding}).
...
\featpre 2nd level or higher \glossterm{Vivimancy} spell known.
...
\featpre 2nd level or higher \glossterm{Positive} spell known.
