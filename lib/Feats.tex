...
\begin{longtabuwrapper}
    \begin{longtabu}{>{\lcol}p{10em} >{\lcol}p{15em} >{\lcol}X >{\lcol}p{6em} >{\lcol}p{3em}}
        ...
        \featref{Deadly Aim} & Per 5 & Trade attack bonus for ranged damage & Precision & \featpref{Deadly Aim} \\
        \featref{Insightful Defense} & Per 5 & Use Perception for defenses & Awareness, Defense, Style & \featpref{Insightful Defense} \\
        \featref{Power Attack} & Str 5 & Trade attack bonus for melee damage & Power & \featpref{Power Attack} \\
...
In exchange, you take a \minus2 penalty to attack with physical ranged attacks.
...
Your attack bonus is equal to your level or your Constitution, whichever is higher.
...
In exchange, you take a \minus2 penalty to attack with physical melee attacks.
This bonus increases by \plus1 for each physical attack you can make per round beyond the first.
