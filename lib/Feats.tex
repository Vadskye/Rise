...
\begin{longtabuwrapper}
    \begin{longtabu}{>{\lcol}p{10em} >{\lcol}p{15em} >{\lcol}X >{\lcol}p{8em} >{\lcol}p{3em}}
        ...
        \featref{Celestial Heritage} & Nonevil alignment & Gain retributive aura & Bloodline, Celestial & \featpref{Celestial Heritage} \\
            ...
            \tind \featref{Celestial Body} & Nonevil alignment, Celestial Heritage & Gain physical damage reduction & Bloodline, Celestial & \featpref{Celestial Body} \\
            \tind \featref{Celestial Smiting} & Nonevil alignment, Celestial Heritage & Smite evil more often, more accurately & Bloodline, Celestial & \featpref{Celestial Smiting} \\
            \tind \featref{Celestial Soul} & Nonevil alignment, any three celestial feats & Gain spell resistance against evil & Bloodline, Celestial & \featpref{Celestial Soul} \\
        ...
        \featref{Chaotic Mind} & Paladin of chaos 4 & Alignment and lies cannot be detected & \x \featpref{Chaotic Mind} \\
        \featref{Charming Wild Speech} & Wild speech, druid 7 & Charm target with wild speech & \x & \featpref{Charming Wild Speech} \\
            \tind \featref{Dominating Wild Speech} & Wild speech, druid 15 & Dominate target with wild speech & \x & \featpref{Dominating Wild Speech} \\
        ...
        \featref{Divine Health} & Paladin 4 & Immune to poison and disease & \x \featpref{Divine Health} \\
        ...
        \tind \featref{Ki Specialization} & Ki Focus, manifest \ki, monk 12 & \Ki manifestation lasts all day & \x \featpref{Ki Specialization} \\
        ...
        \featref{Rapid Combat Adaptation} & Adaptive combat, Int 5, fighter 8 & Change combat feats more quickly & \x & \featpref{Rapid Combat Adaptation} \\
            \tind \featref{Instant Combat Adaptation} & Adaptive combat, Rapid Combat Adaptation, Int 10, fighter 18 & Change combat feats instantly & \x & \featpref{Instant Combat Adaptation} \\
        ...
        \featref{Unbending Resolve} & Paladin 6 & Immune to compulsion and delusion effects & \x \featpref{Unbending Resolve} \\
        ...
        \featref{Track} & \x &  Use Survival skill to track & \x & \featpref{Track} \\
...
\featpre Paladin level 4, Chaos devoted alignment.
...
\feat{Instant Combat Adaptation}{Class}
\featpre Adaptive combat ability, Rapid Combat Adaptation, Intelligence 10, fighter level 18.
...
\feat{Rapid Combat Adaptation}{Class}
