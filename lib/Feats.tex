...
\begin{longtabuwrapper}
    \begin{longtabu}{>{\lcol}p{10em} >{\lcol}p{15em} >{\lcol}X >{\lcol}p{8em} >{\lcol}p{3em}}
        ...
        \featref{Weapon Proficiency}\fn{2} & \x & Gain proficiency with weapon group & Equipment & \featpref{Weapon Proficiency} \\
        ...
        \featref{Maneuver Focus} & \x & \plus2 to accuracy with maneuver, special ability & Maneuver & \featpref{Improved Dirty Trick} \\
