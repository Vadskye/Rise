...
\begin{longtabuwrapper}
    \begin{longtabu}{>{\lcol}p{10em} >{\lcol}p{15em} >{\lcol}X >{\lcol}p{3em}}
        ...
        \featref{Diehard} & Con 10 & Halve penalties from critical damage & \featpref{Diehard} \\
        ...
        \featref{Brutal Magic} & Combat prowess 4, 1st level spells & Gain spellpower bonus after making physical strike & \featpref{Brutal Magic} \\
        ...
        \featref{Imbued Spellstrike} & 2nd level spells & Combine spell with weapon strike (\plus1) & \featpref{Imbued Spellstrike} \\
...
\begin{longtabuwrapper}
    \begin{longtabu}{>{\lcol}p{10em} >{\lcol}p{15em} >{\lcol}X >{\lcol}p{6em} >{\lcol}p{3em}}
        \tb{Strike Feats} & \tb{Prerequisites (two strikes)} & \tb{Benefit} & \tb{Feat Types} & \tb{Page} \\
        ...
        \midrule
        \tb{Strike Feats} & \tb{Prerequisites (three strikes)} & \tb{Benefit} & \tb{Feat Types} & \tb{Page} \\
        ...
        \midrule
        \tb{Strike Feats} & \tb{Prerequisites (four strikes)} & \tb{Benefit} & \tb{Feat Types} & \tb{Page} \\
...
\featpre Intelligence 5, two strikes.
\featben In place of two strikes, you can make a physical attack.
...
\featben As a swift action, you can spend a celestial point to make your next physical strike a smite.
...
This bonus increases by \plus2 for each strike you can make per round beyond the first.
...
\featpres Perception 15, four strikes.
