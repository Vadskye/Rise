...
\section{Races}
    ...
    \subsection{Awakened Animal}
        ...
        \subsection{Changeling}
            ...
            \end{itemize}
            \parhead{Racial Bonus Feat} Any one from the following list: Open Minded, Skill Focus (Bluff, Disguise, Intimidate, Persuasion, or Social Insight).
...
\section{Racial Templates}
    ...
    \end{dtable}
        ...
        \subsubsection{Class Abilities}
            ...
            \cf{Drg}{Weapon and Armor Proficiency}
