...
\newcommand{\entangled}{\conditionlink{entangled} \reminder{move at half speed, unable to sprint or charge, impaired with physical actions}\xspace}
...
\newcommand{\prone}{\conditionlink{prone} \reminder{\minus4 to melee accuracy and defense, \plus4 vs ranged attacks, move action to stand}}
