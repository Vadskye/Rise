...
\section{Skill Description Format}
    ...
    \skill{Perform}{Varies}
        ...
        All performances require some method of creating sound.
        In general, there are two types of performances: instrumental performances and vocal performances.
        Instrumental performances require an instrument of some sort, which always requires at least one hand to manipulate the instrument.
        Vocal performances are simpler, since they don't require an instrument.
        However, vocal performances are always in a particular language, and typically don't affect creatures that don't understand that language.
