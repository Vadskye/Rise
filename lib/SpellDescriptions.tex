...
\begin{spellsection}{Acid Fog}[6]
    ...
    \begin{spellcontent}
        ...
        \begin{spelleffects}
            ...
            At the end of every round, make a Spellpower vs. Fortitude attack against everything in the fog. Success against a target means it takes 1d6 acid damage per four spellpower.
            \spelldur \durshort
        \end{spelleffects}
    \end{spellcontent}
    \begin{spellfooter}
    ...
    \begin{spellcontent}
        ...
        \begin{spelleffects}
            \begin{spellattack}{Spellpower vs. Mental}
                ...
                \par If the target is unable to avoid the object of her aversion, she takes a \minus4 penalty to accuracy, defenses, and checks as long as she is close to it.
...
\begin{spellsection}{Black Tentacles}[5]
    ...
    \begin{spellcontent}
        ...
        \end{spelltargetinginfo}
        \begin{spelleffects}
            \spelleffect Ground within the area is considered difficult terrain. At the end of every round, make a Spellpower vs. Maneuver defense against all creatures in the area that are within 5 feet of the ground. Success against a creature means it takes \spelldamage{bludgeoning}[d6]. A critical success causes the target to be \immobilized for the duration of the spell. It can escape with a grapple or Escape Artist check against a DC equal to 10 \add your spellpower.
        \end{spelleffects}
    \end{spellcontent}
    \begin{spellfooter}
...
\begin{spellsection}{Blade Barrier}[4]
    ...
    \begin{spellcontent}
        ...
        \begin{spelleffects}
            ...
            Whenever a creature passes through the wall, make a Spellpower vs. Reflex attack against it. Success means the creature takes \spelldamage{force}[d6]. Failure means it takes half damage.
            \spelldur \durshort \dismissable
        \end{spelleffects}
    \end{spellcontent}
    \begin{spellfooter}
...
\begin{spellsection}{Blasphemy}[6]
    ...
    \begin{spellcontent}
        ...
        \begin{spelleffects}
            \begin{spellattack}{Spellpower vs. Mental}
                \spellsuccess \spelldamage{divine}[d6].
...
\begin{spellsection}{Boon of Awareness}[1]
    \begin{spellheader}
        \spelldesc{Your ally becomes acutely awareness of his surroundings.}
    \end{spellheader}
    \begin{spellcontent}
        \begin{spelltargetinginfo}
        ...
        \end{spelltargetinginfo}
        \begin{spelleffects}
            \spelleffect The target gains a bonus to Awareness checks equal to your spellpower, up to a maximum modifier equal to twice your spellpower.
            \spelldur \durshort
        \end{spelleffects}
    \end{spellcontent}
    \begin{spellfooter}
...
\begin{spellsection}{Boon of Knowledge}[2]
    ...
    \begin{spellcontent}
        ...
        \end{spelltargetinginfo}
        \begin{spelleffects}
            \spelleffect Choose a Knowledge skill.
            The target gains a bonus to checks with that skill equal to your spellpower, up to a maximum modifier equal to twice your spellpower.
            In addition, it is treated as being trained in that skill.
            \spelldur \durshort
        \end{spelleffects}
    \end{spellcontent}
    \begin{spellfooter}
...
\begin{spellsection}{Boon of Many Eyes}[4]
    ...
    \begin{spellcontent}
        ...
        \end{spelltargetinginfo}
        \begin{spelleffects}
            \spelleffect The target reduces its \glossterm{overwhelm penalties} by an amount equal to half your spellpower.
...
\begin{spellsection}{Boon of Precision}[6]
    \begin{spellheader}
...
\begin{spellsection}{Burning Hands}[1]
    ...
    \begin{spellcontent}
        ...
        \begin{spelleffects}
            \begin{spellattack}{Spellpower vs. Reflex}
                \spellsuccess \spelldamage{fire}[d6]
                \spellfailure Half damage.
            \end{spellattack}
        \end{spelleffects}
    \end{spellcontent}
...
\begin{spellsection}{Calm Emotions}[3]
    ...
    \begin{spellfooter}
        ...
        \spellnotes Any aggressive action against or damage dealt to a nearby creature immediately breaks the spell on all calmed creatures.
...
\begin{spellsection}{Chain Lightning}[6]
    ...
    \begin{spellcontent}
        ...
        \begin{spelleffects}
            \begin{spellattack}{Spellpower vs. Reflex}
                \spellsuccess \spelldamage{electricity}[d6].
                \spellfailure Half damage.
...
\begin{spellsection}{Cloak of Chaos}[8]
    ...
    \begin{spellcontent}
        ...
        \begin{spelleffects}
            ...
            In addition, whenever a lawful creature within 30 feet of the target makes a physical attack against it, you make a Spellpower vs. Mental attack against the attacking creature. Success means the creature takes \spelldamage{divine}[d6].
            \spelldur \durshort \dismissable
        \end{spelleffects}
    \end{spellcontent}
    \begin{spellfooter}
...
\begin{spellsection}{Cone of Cold}[3]
    ...
    \begin{spellcontent}
        ...
        \begin{spelleffects}
            \begin{spellattack}{Spellpower vs. Reflex}
                \spellsuccess \spelldamage{cold}[d6]. In addition, the target moves at half speed for 5 rounds.
...
\begin{spellsection}[Greater]{Cone of Cold}[6]
    ...
    \begin{spellcontent}
        ...
        \begin{spelleffects}
            \begin{spellattack}{Spellpower vs. Reflex}
                \spellsuccess \spelldamage{cold}[d6]. In addition, the target moves at half speed.
                \spellfailure As above, but half damage.
            \end{spellattack}
        \end{spelleffects}
    \end{spellcontent}
...
\begin{spellsection}{Create Ballista}[3]
    ...
    \begin{spellcontent}
        ...
        \begin{spelleffects}
            ...
            Success means the target takes \spelldamage{piercing}[d6].
...
\begin{spellsection}{Death Knell}[6]
    ...
    \begin{spellcontent}
        ...
        \begin{spelleffects}
            \begin{spellattack}{Spellpower vs. Fortitude}
                \spellsuccess \spelldamage{life}. In addition, for 5 rounds, the target automatically dies if it has no hit points remaining.
...
\begin{spellsection}{Energy Conversion}[7]
    \begin{spellheader}
    \end{spellheader}
    \begin{spellcontent}
        \begin{spelleffects}
            ...
            As a standard action, you can expend a charge to fire a bolt of energy at a creature or object within \rngclose range of you. If you do, make a Spellpower vs. Reflex attack against the target. Success means it takes \spelldamage{energy}[d8]. The damage type is the same as the type of the charge expended.
        \end{spelleffects}
    \end{spellcontent}
    \begin{spellfooter}
...
\begin{spellsection}{Excrete Slime}[1]
    ...
    \begin{spellcontent}
        ...
        \end{spelltargetinginfo}
        \begin{spelleffects}
            \spelleffect You are coated in slime. Whenever a creature hits you with a melee attack, make a Spellpower vs. Reflex attack against the attacking creature. Success means the creature takes \spelldamage{acid}[d6].
            \spelldur \durshort
        \end{spelleffects}
    \end{spellcontent}
    \begin{spellfooter}
...
\begin{spellsection}{Eyebite}[3]
    \begin{spellcontent}
        ...
        \begin{spelleffects}
            \begin{spellattack}{Spellpower vs. Fortitude}
                \spellsuccess \spelldamage{life}. In addition, the target's vision is \impaired. This affects all sight-related actions, including physical attacks and targeted spells.
...
\begin{spellsection}{Fire Seeds}[5]
    ...
    \begin{spellcontent}
        ...
        \end{spelltargetinginfo}
        \begin{spelleffects}
            \spelleffect The targets are imbued with fiery energy capable of dealing up to \spelldamage{fire}[d6]. You may freely decide the distribution of dice between the target berries.
...
\begin{spellsection}{Flame Strike}[5]
    ...
    \begin{spellcontent}
        ...
        \begin{spelleffects}
            \begin{spellattack}{Spellpower vs. Reflex}
                \spellsuccess \spelldamage{fire and divine}[d6]
                \spellfailure Half damage.
            \end{spellattack}
        \end{spelleffects}
    \end{spellcontent}
...
\begin{spellsection}{Glitterdust}[4]
    \begin{spellheader}
...
\begin{spellsection}{Heroism}[4]
    ...
    \begin{spellcontent}
        ...
        \end{spelltargetinginfo}
        \begin{spelleffects}
            \spelleffect The target becomes immune to fear and gains temporary hit points equal to twice your spellpower. In addition, it gains an offensive legend point.
            \spelldur \durshort \dismissable
        \end{spelleffects}
    \end{spellcontent}
    \begin{spellfooter}
    ...
    \begin{spellcontent}
        ...
        \begin{spelleffects}
            \begin{spellattack}{Spellpower vs. Fortitude}
                ...
                \spellsuccess \spelldamage{physical}[d6]
                \spellfailure Half damage.
            \end{spellattack}
        \end{spelleffects}
    \end{spellcontent}
...
\begin{spellsection}{Ice Storm}[6]
    \begin{spellheader}
    ...
    \begin{spellsubcontent}
        ...
        \end{spelltargetinginfo}
        \begin{spelleffects}
            \spelleffect \spelldamage{cold and bludgeoning}[d4]
        \end{spelleffects}
    \end{spellsubcontent}
    \begin{spellfooter}
...
\begin{spellsection}[Mass]{Inflict Critical Wounds}[8]
    ...
    \begin{spellcontent}
        ...
        \end{spelltargetinginfo}
        \begin{spelleffects}
            \spellspecial This spell functions like \spell{inflict critical wounds}, except that it heals or inflicts \spelldamage{}[d6].
        \end{spelleffects}
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Vivimancy [Negative]}{Arcane, Divine}
...
\begin{spellsection}[Mass]{Inflict Light Wounds}[5]
    ...
    \begin{spellcontent}
        ...
        \end{spelltargetinginfo}
        \begin{spelleffects}
            \spellspecial This spell functions like \spell{inflict light wounds}, except that it heals or inflicts \spelldamage{}[d6].
        \end{spelleffects}
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Vivimancy [Negative]}{Arcane, Divine}
...
\begin{spellsection}[Mass]{Inflict Moderate Wounds}[6]
    ...
    \begin{spellcontent}
        ...
        \end{spelltargetinginfo}
        \begin{spelleffects}
            \spellspecial This spell functions like \spell{inflict moderate wounds}, except that it heals or inflicts \spelldamage{}[d6].
        \end{spelleffects}
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Vivimancy [Negative]}{Arcane, Divine}
...
\begin{spellsection}[Mass]{Inflict Serious Wounds}[7]
    ...
    \begin{spellcontent}
        ...
        \end{spelltargetinginfo}
        \begin{spelleffects}
            \spellspecial This spell functions like \spell{inflict serious wounds}, except that it heals or inflicts \spelldamage{}[d6].
        \end{spelleffects}
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Vivimancy [Negative]}{Arcane, Divine}
...
\begin{spellsection}{Living Missile}[4]
    ...
    \begin{spellcontent}
        ...
        \begin{spelleffects}
            ...
            \begin{spellattack}{Spellpower vs. Reflex}
                \spellsuccess The target takes 1d10 bludgeoning damage per two spellpower. The ally takes half this damage.
...
\begin{spellsection}{Missile Storm}[4]
    ...
    \begin{spellcontent}
        ...
        \end{spelltargetinginfo}
        \begin{spelleffects}
            \spelleffect \spelldamage{force}[d4]
        \end{spelleffects}
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Evocation [Force]}{Arcane}
...
\begin{spellsection}{Prismatic Storm}[9]
    ...
    \begin{spellcontent}
        ...
        \begin{spelleffects}
            \begin{spellattack}{Spellpower vs. Special}
                \spellspecial The target is struck by a randomly colored beam of light. The beam color determines the effect and the defense used, as shown on \tref{Prismatic Beam Effects}. The damaging effects deal \spelldamage{}[d6].
            \end{spellattack}
        \end{spelleffects}
    \end{spellcontent}
    \begin{spellfooter}
...
\begin{spellsection}{Prohibition}[6]
    ...
    \begin{spellsubcontent}
        ...
        \end{spelltargetinginfo}
        \begin{spelleffects}
            \spelleffect \spelldamage{}[d6]. You know a creature broke the rule, but not which creature.
        \end{spelleffects}
    \end{spellsubcontent}
    \begin{spellfooter}
...
\begin{spellsection}{Resist Magic}[4]
    \begin{spellheader}
    \end{spellheader}
    \begin{spellcontent}
        \begin{spelltargetinginfo}
...
\begin{spellsection}{Scorching Ray}[2]
    ...
    \begin{spellcontent}
        ...
        \begin{spelleffects}
            \begin{spellattack}{Spellpower vs. Reflex}
                \spellsuccess \spelldamage{fire}. In addition, the target is \ignited for 5 rounds.
                \spellfailure Half damage, and no additional effects.
            \end{spellattack}
        \end{spelleffects}
    \end{spellcontent}
...
\begin{spellsection}{Searing Light}[2]
    ...
    \begin{spellcontent}
        ...
        \begin{spelleffects}
            \begin{spellattack}{Spellpower vs. Reflex}
                \spellspecial You gain a \plus5 bonus to accuracy against creatures vulnerable to bright light.
    ...
    \begin{spellcontent}
        ...
        \begin{spelleffects}
            \begin{spellattack}{Spellpower vs. Fortitude}
                ...
                \spellsuccess \spelldamage{sonic}[d6]. In addition, the target is \deafened for 5 rounds.
                \spellfailure Half damage, and no additional effects.
            \end{spellattack}
        \end{spelleffects}
    \end{spellcontent}
...
\begin{spellsection}{Sound Burst}[2]
    ...
    \begin{spellcontent}
        ...
        \begin{spelleffects}
            \begin{spellattack}{Spellpower vs. Fortitude}
                \spellsuccess \spelldamage{sonic}[d6].
                \spellfailure Half damage.
            \end{spellattack}
        \end{spelleffects}
    \end{spellcontent}
...
\begin{spellsection}{Storm of Vengeance}[9]
    ...
    \begin{spellcontent}
        ...
        \begin{spelleffects}
            ...
            At the end of every round, the storm has an additional effect, as shown on \tref{Storm of Vengeance Effects}. Damaging effects deal \spelldamage{}[d6].
...
\begin{spellsection}{Strip the Flesh}[6]
    ...
    \begin{spellcontent}
        ...
        \begin{spelleffects}
            \begin{spellattack}{Spellpower vs. Fortitude}
                \spellsuccess \spelldamage{slashing}. In addition, all damage the target takes is doubled for 5 rounds. This does not apply to the initial damage dealt by this spell.
                \spellfailure Half damage, and no additional effects.
            \end{spellattack}
        \end{spelleffects}
    \end{spellcontent}
    ...
    \begin{spellcontent}
        ...
        \begin{spelleffects}
            \begin{spellattack}{Spellpower vs. Reflex}
                ...
                \spellsuccess \spelldamage{solar}[d6]
...
\begin{spellsection}{Wail of the Banshee}[9]
    ...
    \begin{spellcontent}
        ...
        \begin{spelleffects}
            \begin{spellattack}{Spellpower vs. Fortitude}
                \spellsuccess \spelldamage{sonic}[d6]. If the target is living and has no hit points remaining, it dies.
            \end{spellattack}
        \end{spelleffects}
    \end{spellcontent}
    \begin{spellfooter}
...
\begin{spellsection}[Greater]{Wall of Fire}[5]
    ...
    \begin{spellcontent}
        ...
        \end{spelltargetinginfo}
        \begin{spelleffects}
            \spellspecial This spell functions like \spell{wall of fire}, except that it is larger and can be shaped. The damage dealt to a creature passing through the wall is \spelldamage{fire}[d6].
            \spelldur \durshort
        \end{spelleffects}
    \end{spellcontent}
    \begin{spellfooter}
