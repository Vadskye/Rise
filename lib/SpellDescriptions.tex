...
\begin{spellsection}{Magic Missile}[1]
    ...
    \begin{spellcontent}
        ...
        \end{spelltargetinginfo}
        \begin{spelleffects}
            \spelleffect You strike one target creature with a missile that deals d8 force damage. At spellpower 6, and every 4 spellpower thereafter, you create an additional missile. You can direct each missile to strike the same or different targets.
        \end{spelleffects}
    \end{spellcontent}
    \begin{spellfooter}
