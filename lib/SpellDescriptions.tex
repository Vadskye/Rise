...
\begin{spellsection}{Call Lightning}[4]
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Evocation [Destructive, Electricity]}{Nature}
...
\begin{spellsection}{Charm Person}[2]
    ...
    \begin{spellaugments}
        ...
        \spellaugment{3}{Mass}{The spell can affect up to five targets.}
        \spellaugment{3}{Persistent}{The spell lasts for one month.}
    \end{spellaugments}
\end{spellsection}
...
\begin{spellsection}{Death Ward}[2]
    \begin{spellheader}
        \spelldesc{You shield your ally from deadly spells and abilities.}
    \end{spellheader}
    \begin{spellcontent}
        \begin{spelltargetinginfo}
...
\begin{spellsection}{Earthspike}[1]
    ...
    \end{spellfooter}
    \begin{spellaugments}
        \spellaugment{2}{Piercing}{The spell targets Reflex defense instead of Armor defense.}
        ...
        \spellaugment{3}{Impaling}{If the attack succeeds, the struck creature is \immobilized for 2 rounds.}
    \end{spellaugments}
\end{spellsection}
...
\begin{spellsection}{Fireball}[3]
    ...
    \begin{spellaugments}
        ...
        \spellaugment{3}{Immolating}{The targets are also \ignited for 5 rounds.}
    \end{spellaugments}
\end{spellsection}
...
\begin{spellsection}{Fog Cloud}[2]
    ...
    \begin{spellaugments}
        ...
        \spellaugment{3}{Shielding}{The spell's area becomes an emanation centered on you that moves with you. When you move, new fog does not form immediately. At the end of each round, the fog in your previous location disappears, and new fog forms around your current location.}[Abjuration]
...
\begin{spellsection}{Holy Smite}[2]
    \begin{spellheader}
    \end{spellheader}
    \begin{spellcontent}
        \begin{spelltargetinginfo}
...
\begin{spellsection}{Living Missile}[4]
    ...
    \end{spellfooter}
    \begin{spellaugments}
        \spellaugment{3}{Mass}{The spell can affect up to five willing allies. Its damage becomes \spelldamage{bludgeoning}[d8]. All allies must be thrown at the same target.}
    \end{spellaugments}
\end{spellsection}
...
\begin{spellsection}{Mark of Scrying}[4]
    ...
    \begin{spellaugments}
        ...
        \spellaugment{3}{Persistent}{The mark lasts for one month.}
    \end{spellaugments}
\end{spellsection}
...
\begin{spellsection}{Summon Monster}[1]
    ...
    \begin{spellcontent}
        ...
        \begin{spelleffects}
            ...
            \par When you learn this spell, you choose two creatures from the 1st-level list on \tref{Summon Monster List}. You can only summon those creatures with this spell.
...
\begin{spellsection}{Water Walk}[3]
    ...
    \begin{spellcontent}
        ...
        \begin{spelleffects}
            ...
            \par If the target is underwater, it rises toward the surface at 60 feet per round.
            \spelldur \durlong
        \end{spelleffects}
    \end{spellcontent}
    \begin{spellfooter}
