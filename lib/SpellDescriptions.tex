    ...
    \begin{spellcontent}
        ...
        \begin{spelleffects}
            \begin{spellattack}{Spellpower vs. Mental}
                ...
                \spellfailure As above, but half damage.
                \spellcritical Double damage, and the target becomes permanently entombed in a state of suspended animation (as the \spell{temporal stasis} spell) in a small sphere far beneath the surface of the earth. It remains there until an \spell{emancipation} spell is cast at the location where the imprisonment took place.
            \end{spellattack}
        \end{spelleffects}
    \end{spellcontent}
    \begin{spellfooter}
