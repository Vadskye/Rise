...
\begin{spellsection}{Acid Fog}[6]
    ...
    \begin{spellcontent}
        ...
        \begin{spelleffects}
            ...
            At the end of every round, make a Spellpower vs. Fortitude attack against everything in the fog. Success against a target means it takes 1d8 acid damage per four spellpower.
            \spelldur \durshort
        \end{spelleffects}
    \end{spellcontent}
    \begin{spellfooter}
...
\begin{spellsection}{Black Tentacles}[4]
    \begin{spellheader}
...
\begin{spellsection}{Blink}[6]
    ...
    \begin{spellcontent}
        ...
        \end{spelltargetinginfo}
        \begin{spelleffects}
            \spelleffect The target spends half its time on the Astral Plane.
            All attacks against it have a 50\% chance to fail.
            \spelldur \durshort \dismissable
        \end{spelleffects}
    \end{spellcontent}
    \begin{spellfooter}
...
\begin{spellsection}{Boon of Many Eyes}[4]
    ...
    \begin{spellcontent}
        ...
        \end{spelltargetinginfo}
        \begin{spelleffects}
            \spelleffect The target gains a \plus5 bonus to Awareness checks.
...
\begin{spellsection}{Boon of Mastery}[3]
    ...
    \begin{spellcontent}
        ...
        \end{spelltargetinginfo}
        \begin{spelleffects}
            \spelleffect The target gains a \plus5 bonus to all skills.
            \spelldur \durshort
        \end{spelleffects}
    \end{spellcontent}
    \begin{spellfooter}
...
\begin{spellsection}[Greater]{Boon of Mastery}[6]
    \begin{spellheader}
    ...
    \begin{spellcontent}
        ...
        \end{spelltargetinginfo}
        \begin{spelleffects}
            \spelleffect The target gains a \plus10 bonus to all skills.
            \spelldur \durshort
        \end{spelleffects}
    \end{spellcontent}
    \begin{spellfooter}
...
\begin{spellsection}{Boon of Perception}[1]
    ...
    \begin{spellcontent}
        ...
        \end{spelltargetinginfo}
        \begin{spelleffects}
            \spelleffect The target gains a \plus5 bonus to Awareness, Sense Motive, and Spellcraft checks.
            \spelldur \durshort
        \end{spelleffects}
    \end{spellcontent}
    \begin{spellfooter}
...
\begin{spellsection}{Cone of Cold}[3]
    ...
    \begin{spellcontent}
        ...
        \begin{spelleffects}
            \begin{spellattack}{Spellpower vs. Reflex}
                \spellsuccess \spelldamage{cold}[d8]. In addition, the target moves at half speed for 5 rounds.
...
\begin{spellsection}{Shadow Umbra}[7]
    \begin{spellheader}
    ...
    \begin{spellcontent}
        ...
        \begin{spelleffects}
            \begin{spellattack}{Spellpower vs. Reflex}
                ...
                \spellsuccess \spelldamage{solar}[d8]
...
\begin{spellsection}[Greater]{Wall of Fire}[5]
    ...
    \begin{spellcontent}
        ...
        \end{spelltargetinginfo}
        \begin{spelleffects}
            \spellspecial This spell functions like \spell{wall of fire}, except that it is larger and can be shaped. The damage dealt to a creature passing through the wall is \spelldamage{fire}[d8].
            \spelldur \durshort
        \end{spelleffects}
    \end{spellcontent}
    \begin{spellfooter}
