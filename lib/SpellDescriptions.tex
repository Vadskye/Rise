...
\begin{spellsection}{Ablative Shield}[1]
    ...
    \begin{spellaugments}
        ...
        \spellaugment{2}{Empowered}{Damage is negated, rather than converted into nonlethal damage.}
    \end{spellaugments}
\end{spellsection}
    ...
    \begin{spellsubcontent}
        ...
        \begin{spelleffects}
            \begin{spellattack}{Spellpower vs. Fortitude}
                ...
                \spellcritical As above, except that the doubling of physical damage lasts for thirty days.
...
\begin{spellsection}{Avatar of Shielding}[7]
    ...
    \begin{spellcontent}
        ...
        \end{spelltargetinginfo}
        \begin{spelleffects}
            \spelleffect At any time during the spell's duration, you can concentrate as a standard action. If you do, an ally gains damage reduction, as described below.
            \spelldur \durlong
        \end{spelleffects}
    \end{spellcontent}
    \begin{spellsubcontent}
...
\begin{spellsection}{Bleed}[5]
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Vivimancy [Flesh]}{Death, Vivimancy}
        \miscastrandom
    \end{spellfooter}
\end{spellsection}
    ...
    \begin{spellcontent}
        ...
        \begin{spelleffects}
            \begin{spellattack}{Spellpower vs. Mental}
                ...
                \spellcritical As above, except that the target is \confused for 5 rounds instead of disoriented.
                \spellfailure Half damage.
            \end{spellattack}
        %\spelldur 5 rounds
        \end{spelleffects}
...
\begin{spellsection}{Circle of Death}[7]
    \begin{spellheader}
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Vivimancy [Death]}{Divine, Evil}
        \miscastexplode
    \end{spellfooter}
\end{spellsection}

\begin{spellsection}{Circle of Healing}[7]
    \begin{spellheader}
...
\begin{spellsection}{Create Image}[2]
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Illusion [Figment, Unreal]}{Illusion, Trickery}
...
\begin{spellsection}{Death Knell}[3]
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Vivimancy [Death]}{Death, Vivimancy}
...
\begin{spellsection}{Deep Slumber}[4]
    \begin{spellheader}
...
\begin{spellsection}{Deflection}[3]
    ...
    \end{spellfooter}
    \begin{spellaugments}
        \spellaugment{3}{Empowered}{You gain an additional defensive legend point. Both legend points regenerate independently after being spent.}
    \end{spellaugments}
\end{spellsection}
...
\begin{spellsection}{Divine Judgment}[7]
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Evocation}{Divine}
        \miscastrandom
    \end{spellfooter}
    \begin{spellaugments}
        \spellaugment{2}{Persistent}{The target's body cannot be used to restore it to life, such as with the \spell{resurrection} ritual. (See \pcref{Raising the Dead}, for details).}
    \end{spellaugments}
\end{spellsection}
...
\begin{spellsection}{Dimensional Army}[9]
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Conjuration [Teleporation]}{Conjuration, Travel}
        \miscastexplode
    \end{spellfooter}
\end{spellsection}
    ...
    \begin{spellcontent}
        ...
        \begin{spelleffects}
            \begin{spellattack}{Spellpower vs. Mental}
                ...
                \spellcritical The target is dominated for 2 rounds. It obeys your commands unquestioningly, as an automaton. If you have a shared language, you can command the target to perform any task, and it will obey you immediately. If you lack a shared language, you can still issue simple commands, such as ``attack'' or ``follow''.

                When this effect's duration ends, you must make another Spellpower vs. Mental attack against the target. If you succeed, the target remains dominated for another 2 rounds. If you fail, the target breaks free of your control. If you critically succeed, the target remains dominated for an additional 24 hours. If the effect's duration is extended, this attack must be repeated each time it ends until the domination is broken.
...
\begin{spellsection}{Enlarge}[2]
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Transmutation [Alteration, Sizing]}{Nature, Strength, Transmutation}
    ...
    \begin{spellcontent}
        ...
        \begin{spelleffects}
            \begin{spellattack}{Spellpower vs. Fortitude}
                ...
                \spellcritical As above, except that the target is \blinded for 2 rounds.
                \spellfailure Half damage, and no additional effects.
            \end{spellattack}
        \end{spelleffects}
    \end{spellcontent}
...
\begin{spellsection}{Fissure}[6]
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Evocation [Earth, Physical]}{Earth, Nature, Wild}
        \miscastrandom
    \end{spellfooter}
    \begin{spellaugments}
        \spellaugment{1}{Giant}{The spell can affect a target one size category larger. This augment can be used multiple times.}
...
\begin{spellsection}{Forget}[1]
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Enchantment [Delusion]}{Enchantment}
        \miscastrandom
    \end{spellfooter}
    \begin{spellaugments}
...
\begin{spellsection}{Fungal Growth}[3]
    ...
    \end{spellfooter}
    \begin{spellaugments}
        \spellaugment{2}{Deep Growth}{The DC to remove the fungus with a Heal check increases by 10.}
...
\begin{spellsection}{Gaseous Form}[3]
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Transmutation [Alteration]}{Transmutation, Travel}
        \miscastexplode
    \end{spellfooter}
    \begin{spellaugments}
...
\begin{spellsection}{Grease}[1]
    ...
    \begin{spellaugments}
        \spellaugment{2}{Widened}{The spell's area becomes a \areamed radius.}
        \spellaugment{3}{Slick}{The DC of the Balance check is equal to 10 \add your spellpower.}
    \end{spellaugments}
\end{spellsection}
...
\begin{spellsection}{Harm}[6]
    ...
    \end{spellfooter}
    \begin{spellaugments}
        \spellaugment{3}{Mass}{The spell can affect up to five targets. Its damage becomes \spelldamage{negative}[d8].}
    \end{spellaugments}
\end{spellsection}
...
\begin{spellsection}{Haste}[1]
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Transmutation [Temporal]}{Strength, Transmutation}
    ...
    \begin{spellcontent}
        ...
        \begin{spelleffects}
            \begin{spellattack}{Spellpower vs. Mental}
                ...
                \spellcritical As above, except that the target is \stunned instead of dazed.
                \spellfailure Half damage, and no additional effects.
            \end{spellattack}
        \end{spelleffects}
    \end{spellcontent}
...
\begin{spellsection}{Inflict Wounds}[1]
    ...
    \end{spellfooter}
    \begin{spellaugments}
        \spellaugment{1}{Moderate Wounds}{For every 10 points of damage dealt in excess of the target's hit points, it takes 1 point of critical damage.}
        \spellaugment{2}{Serious Wounds}{For every 5 points of damage dealt in excess of the target's hit points, it takes 1 point of critical damage.}
        \spellaugment{3}{Critical Wounds}{For every 2 points of damage dealt in excess of the target's hit points, it takes 1 point of critical damage.}
        \spellaugment{3}{Mass}{The spell can affect up to five targets. Its damage and healing become \spelldamage{}[d8].}
    \end{spellaugments}
\end{spellsection}
...
\begin{spellsection}{Invulnerability}[4]
    ...
    \end{spellfooter}
    \begin{spellaugments}
        \spellaugment{3}{Complete}{You do not need to choose an energy type when casting the spell, and the damage reduction cannot be overcome.}
...
\begin{spellsection}{Knock}[2]
    ...
    \begin{spellfooter}
        ...
        \spellnotes If this spell is cast on an \spellindirect{arcane lock}{arcane locked} door, make a spellpower check against a DC of 10 \add the spellpower of the \spell{arcane lock}. If you succeed, the \spell{arcane lock} is suppressed for 10 minutes. If you fail, you may still bypass the door with the checks above, if possible.
        \miscastrandom
    \end{spellfooter}
    \begin{spellaugments}
        \spellaugment{1}{Giant}{The spell can affect a target one size category larger. This augment can be used multiple times.}
...
\begin{spellsection}{Lifegiving Roots}[8]
    \begin{spellheader}
...
\begin{spellsection}{Living Missile}[4]
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Abjuration/Evocation}{Arcane, Chaos}
        \miscastexplode
    \end{spellfooter}
    \begin{spellaugments}
    ...
    \begin{spellcontent}
        ...
        \begin{spelleffects}
            \begin{spellattack}{Spellpower vs. Mental}
                ...
                \spellcritical As above, except that the target is \paralyzed instead of slowed.
                \spellfailure Half damage, and no additional effects.
            \end{spellattack}
        \end{spelleffects}
    \end{spellcontent}
...
\begin{dtable*}
    ...
    \begin{dtabularx}{\textwidth}{l >{\lcol}p{3.6em} l >{\lcol}X l}
        ...
        3 & Yellow   & Reflex    & Electricity damage and partially blinded for 2 rounds      & Half damage, partially blinded \\
...
\begin{spellsection}{Resist Magic}[3]
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Abjuration [Shielding]}{Abjuration, Protection}
...
\begin{spellsection}{Reverse Gravity}[8]
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Transmutation}{Air, Chaos, Transmutation}
...
\begin{spellsection}{Silence}[2]
    ...
    \begin{spellcontent}
        ...
        \begin{spelleffects}
            \begin{spellattack}{Spellpower vs. Mental}
                \spellsuccess The target becomes unable to make noise.  Extraordinarily loud noises, such as the yell of a giant, are merely muffled by the spell rather than completely silenced. The DC to hear such sounds produced by the target is increased by 40. Sonic attacks function normally.
...
\begin{spellsection}{Strip the Flesh}[7]
    ...
    \begin{spellcontent}
        ...
        \begin{spelleffects}
            \begin{spellattack}{Spellpower vs. Fortitude}
                ...
                This does not apply to the initial damage dealt by this spell.
                \spellcritical As above, except that the doubling of damage lasts for thirty days.
                Effects which accelerate natural healing, such as the Heal skill, also reduce the duration of this effect.
                \spellfailure Half damage, and no additional effects.
            \end{spellattack}
        \end{spelleffects}
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Vivimancy [Flesh, Physical]}{Arcane, Death}
        \spellnotes \physicalspellnotes
        \miscastrandom
    \end{spellfooter}
\end{spellsection}
...
\begin{spellsection}{Swarm of Bats}[2]
    ...
    \begin{spellcontent}
        ...
        \begin{spelleffects}
            \begin{spellattack}{Spellpower vs. Fortitude}
                \spellsuccess The target is \impaired with vision-related attacks and checks for 2 rounds.
            \end{spellattack}
        \end{spelleffects}
    \end{spellcontent}
    \begin{spellfooter}
...
\begin{spellsection}{Third Eye}[8]
    ...
    \end{spellfooter}
    \begin{spellaugments}
        \spellaugment{1}{Persistent}{The spell's duration becomes \durlong.}
    \end{spellaugments}
\end{spellsection}
...
\begin{spellsection}{Unliving Heart}[1]
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Vivimancy [Life]}{Vivimancy}
        \miscastexplode
    \end{spellfooter}
    \begin{spellaugments}
