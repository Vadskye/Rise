...
\begin{spellsection}{Enervation}[4]
    ...
    \begin{spellcontent}
        ...
        \end{spelltargetinginfo}
        \begin{spelleffects}
            \spelleffect If the target is living, it gains two \conditionlink{negative levels}. This imposes a \minus2 penalty to the target's accuracy, special defenses, and checks, and a penalty to its current and maximum hit points equal to twice its level.
    ...
    \begin{spellcontent}
        ...
        \begin{spelleffects}
            ...
            \begin{spellattacktriggered}{If the target is living, make a Spellpower vs. Fortitude attack.}
                \spellsuccess The target gains eight \conditionlink{negative levels}. This imposes a \minus8 penalty to the target's accuracy, special defenses, and checks, and a penalty to its current and maximum hit points equal to eight times the creature's level.
                \spellsuccess The target gains four \conditionlink{negative levels}. This imposes a \minus4 penalty to the target's accuracy, special defenses, and checks, and a penalty to its current and maximum hit points equal to four times the creature's level.
            \end{spellattacktriggered}
        \end{spelleffects}
    \end{spellcontent}
    \begin{spellfooter}
...
\begin{spellsection}{Stoneskin}[4]
    ...
    \begin{spellcontent}
        ...
        \end{spelltargetinginfo}
        \begin{spelleffects}
            \spelleffect The target gains damage reduction against physical damage equal to your spellpower. Adamantine weapons ignore this damage reduction and negate it for 1 round. In addition, the target is immune to critical hits as long as it has this damage reduction.
            \spelldur \durpersonallong
        \end{spelleffects}
    \end{spellcontent}
    \begin{spellfooter}
