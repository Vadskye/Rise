...
\begin{spellsection}[Mass]{Earthspike}[4]
    ...
    \begin{spellcontent}
        \begin{spelltargetinginfo}
            ...
            \spelltgts{All enemies in the area within 10 feet of natural earth or stone}
        \end{spelltargetinginfo}
        \begin{spelleffects}
            \begin{spellattack}{Spellpower vs. Armor defense}
...
\begin{spellsection}[Greater]{Missile Storm}[8]
    \begin{spellheader}
        \spelldesc{You unleash a titanic swarm of missiles which seek out and destroy your foes.}
    \end{spellheader}
    \begin{spellcontent}
        \begin{spelltargetinginfo}
            \spellburst{200 ft. radius centered on you}
            \spelltgts{All enemies in the area}
        \end{spelltargetinginfo}
        \begin{spelleffects}
            \spelleffect \spelldamage{force}[d6]
...
\begin{spellsection}{Swarm of Bats}[1]
    ...
    \begin{spellcontent}
        ...
        \begin{spelleffects}
            \begin{spellattack}{Spellpower vs. Fortitude}
                \spellsuccess The target is \impaired with vision-related attacks and checks.
            \end{spellattack}
        \end{spelleffects}
    \end{spellcontent}
    \begin{spellfooter}
