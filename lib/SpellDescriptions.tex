...
\begin{spellsection}{Haste}[5]
    ...
    \begin{spellcontent}
        ...
        \end{spelltargetinginfo}
        \begin{spelleffects}
            \spelleffect The target's speed increases, as \spell{lesser haste}. In addition, when it takes a full attack action, it may make an additional attack with a \minus5 penalty to accuracy.
            \spelldur \durshort
        \end{spelleffects}
    \end{spellcontent}
    \begin{spellfooter}
