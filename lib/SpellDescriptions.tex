...
\begin{spellsection}{Blade Barrier}[4]
    ...
    \begin{spellcontent}
        ...
        \begin{spelleffects}
            ...
            Whenever a creature passes through the wall, make a Spellpower vs. Reflex attack against it. Success means the creature takes \spelldamage{4}{force}[d6]. Failure means it takes half damage.
            \spelldur \durshort \dismissable
        \end{spelleffects}
    \end{spellcontent}
    \begin{spellfooter}
...
\begin{spellsection}{Bleed}[5]
    ...
    \begin{spellcontent}
        ...
        \begin{spelleffects}
            \begin{spellattack}{Spellpower vs. Fortitude}
                \spellsuccess \spelldamage{5}{slashing}. In addition, the target takes one point of critical damage after this damage is dealt, regardless of its current hit points.
                \spellfailure Half damage, and no additional effects.
            \end{spellattack}
        \end{spelleffects}
    \end{spellcontent}
...
\begin{spellsection}{Cloak of Chaos}[8]
    ...
    \begin{spellcontent}
        ...
        \begin{spelleffects}
            ...
            In addition, whenever a lawful creature within 30 feet of the target makes a physical attack against it, you make a Spellpower vs. Mental attack against the attacking creature. Success means the creature takes \spelldamage{9}{divine}[d6].
            \spelldur \durshort \dismissable
        \end{spelleffects}
    \end{spellcontent}
    \begin{spellfooter}
...
\begin{spellsection}{Create Ballista}[3]
    ...
    \begin{spellcontent}
        ...
        \begin{spelleffects}
            ...
            Success means the target takes \spelldamage{3}{piercing}[d6].
...
\begin{spellsection}{Energy Conversion}[7]
    ...
    \begin{spellcontent}
        \begin{spelleffects}
            ...
            As a standard action, you can expend a charge to fire a bolt of energy at a creature or object within \rngclose range of you. If you do, make a Spellpower vs. Reflex attack against the target. Success means it takes \spelldamage{7}{energy}[d8]. The damage type is the same as the type of the charge expended.
        \end{spelleffects}
    \end{spellcontent}
    \begin{spellfooter}
...
\begin{spellsection}{Excrete Slime}[1]
    ...
    \begin{spellcontent}
        ...
        \end{spelltargetinginfo}
        \begin{spelleffects}
            \spelleffect You are coated in slime. Whenever a creature hits you with a melee attack, make a Spellpower vs. Reflex attack against the attacking creature. Success means the creature takes \spelldamage{1}{acid}[d6].
            \spelldur \durshort
        \end{spelleffects}
    \end{spellcontent}
    \begin{spellfooter}
...
\begin{spellsection}{Ice Storm}[6]
    ...
    \begin{spellsubcontent}
        ...
        \end{spelltargetinginfo}
        \begin{spelleffects}
            \spelleffect \spelldamage{6}{cold and bludgeoning}[d4]
        \end{spelleffects}
    \end{spellsubcontent}
    \begin{spellfooter}
...
\begin{spellsection}{Telekinetic Blast}[5]
    ...
    \begin{spellcontent}
        ...
        \begin{spelleffects}
            \begin{spellattack}{Spellpower vs. Mental}
                \spellsuccess \spelldamage{5}{bludgeoning}[d6].
    ...
    \begin{spellcontent}
        ...
        \begin{spelleffects}
            \begin{spellattack}{Spellpower vs. Fortitude and Maneuver defense (shove)}
                \spellsuccess[Fortitude] \spelldamage{2}{bludgeoning}.
