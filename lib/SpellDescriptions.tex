...
\begin{spellsection}{Boon of Perception}[1]
    ...
    \begin{spellcontent}
        ...
        \end{spelltargetinginfo}
        \begin{spelleffects}
            \spelleffect Whenever the target makes Awareness, Social Insight, and Spellcraft checks, it rolls twice and takes the higher result.
            \spelldur \durshort
        \end{spelleffects}
    \end{spellcontent}
    \begin{spellfooter}
    ...
    \end{spellfooter}
    \begin{spellaugments}
        \spellaugment{3}{Empowered}{The target also gains a \plus5 bonus to Awareness, Social Insight, and Spellcraft checks.}
    \end{spellaugments}
\end{spellsection}
