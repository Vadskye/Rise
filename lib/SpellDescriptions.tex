...
\begin{spellsection}{Create Sound}[1]
    ...
    \begin{spellfooter}
        ...
        \spellnotes Creatures can identify the illusion, as \spell{create image}. This spell can be made permanent with a \spell{permanency} ritual.
        \miscastexplode
    \end{spellfooter}
\end{spellsection}
...
\begin{spellsection}{Longeye}[2]
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Divination [Awareness]}{Arcane, Nature}
        \miscastexplode
    \end{spellfooter}
    \begin{spellaugments}
        \spellaugment{3}{Mass}{The spell can affect up to five targets.}
