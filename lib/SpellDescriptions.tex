...
\begin{spellsection}{Wall of Thorns}[2]
    ...
    \begin{spellcontent}
        \begin{spelltargetinginfo}
            \spelltwocol{\spellzone{20 ft. line, 5 ft. wide, 10 ft. high}}{\spellrng{\rngmed}}
        \end{spelltargetinginfo}
        \begin{spelleffects}
...
\begin{spellsection}{Web}[8]
    ...
    \begin{spellfooter}
        \spellinfo{Conjuration [Creation, Physical]}{Arcane}
        \spellnotes The strands of web can be destroyed. Any five-foot square that takes fire damage equal to your spellpower, or twice your spellpower in slashing or bludgeoning damage, is destroyed. A magic flaming sword can slash them away as easily as a hand brushes away cobwebs. Any fire can set the webs alight and burn away 5 square feet in 1 round. All creatures within flaming webs is \ignited from the flames.
