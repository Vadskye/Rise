...
\begin{itemize}
    ...
    \item For every 5 Strength you have, you gain a \plus1 bonus to damage with physical attacks. If your Strength is negative, you take a penalty to damage with physical attacks equal to your Strength.
\end{itemize}
...
\begin{itemize}
    ...
    \item For every 5 Dexterity you have, you gain a \plus1 bonus to physical defenses (Armor, Maneuver, Reflex). If your Dexterity is negative, you take a penalty to your physical defenses equal to your Dexterity.
\end{itemize}
...
\begin{itemize}
    ...
    \item For every 5 Perception you have, you gain a \plus1 bonus to attack with physical attacks. If your Perception is negative, you take a penalty to attack with physical attacks equal to your Perception.
\end{itemize}
...
\parhead{Proficiency Bonus} You gain a \plus4 bonus to attacks made with a weapon you are proficient with.
