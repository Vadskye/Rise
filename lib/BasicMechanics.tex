...
\parhead{Disabled} At the end of each round, if you have no hit points remaining after resolving all other effects in the round, you become disabled. While disabled, you are \staggered. In addition, you  You are also still bloodied, and continue to take the \minus5 penalty to Fortitude and Mental defenses.
