...
\parhead{Concentration Checks}\label{Concentration Checks} To make a concentration check, roll d20 \add (higher of level, Constitution, or Willpower) \minus overwhelm penalties. If the result equals or exceeds a DC equal to 10 \add half damage taken \add (twice the level of the spell you are casting), you cast the spell successfully. Failure means you miscast the spell (see \pcref{Miscasting}).
