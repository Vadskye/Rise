...
\begin{spellsection}{Antipathy}[9]
    ...
    \begin{spellcontent}
        ...
        \end{spelltargetinginfo}
        \begin{spelleffects}
            \spelleffect When you perform this ritual, choose an alignment (chaotic, good, evil, or lawful) or creature type.
            When a creature of the chosen type enters the area, you make an attack against it, as described below.
            \begin{spellattack}{Spellpower vs. Mental}
...
\begin{spellsection}{Apparition}[5]
    ...
    \begin{spellcontent}
        ...
        \end{spelltargetinginfo}
        \begin{spelleffects}
            \spelleffect A magic sensor appears at a location within range, as \spell{clairaudience/clairvoyance}. You can hear and see through the sensor. In addition, a figment of you appears in the same location, as \spell{create image}. You can speak through the figment.
...
\begin{spellsection}{Awaken}[7]
    ...
    \begin{spellcontent}
        ...
        \end{spelltargetinginfo}
        \begin{spelleffects}
            \spelleffect The target becomes sentient. Its Intelligence becomes 1d6 \add 4. Its type changes from animal to magical beast. It gains the ability to speak and understand one language that you know.
        \end{spelleffects}
    \end{spellcontent}
    \begin{spellfooter}
...
\begin{spellsection}{Contagion}[3]
    ...
    \begin{spellcontent}
        \begin{spelltargetinginfo}
            \spelltime{10 minutes}
            \spellquicktargeting{One creature}{10 miles \rngunrestricted}
        \end{spelltargetinginfo}
        \begin{spelleffects}
...
\begin{spellsection}{Disguise Self}[1]
    ...
    \begin{spellcontent}
        ...
        \end{spelltargetinginfo}
        \begin{spelleffects}
            \spelleffect When you perform this ritual, you make a Disguise check.
            You gain a \plus10 bonus on the check, and you can freely alter the appearance of your clothes and equipment, regardless of their original form.
            \spelldur \durlong \dismissable
        \end{spelleffects}
    \end{spellcontent}
    \begin{spellfooter}
    ...
    \end{spellfooter}
    \begin{spellaugments}
        \spellaugment{3}{Malleable}{As a standard action, you can concentrate to alter your appearance, just as if you had performed this ritual again.}
        \spellaugment{4}{Permanent}{The ritual's duration becomes permanent.}
    \end{spellaugments}
\end{spellsection}
...
\begin{spellsection}{Instant Refuge}[7]
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Conjuration/Transmutation [Translocation] [Teleportation]}{Divine}
...
\begin{spellsection}{Invisibility Purge}[2]
    ...
    \begin{spellcontent}
        ...
        \begin{spelleffects}
            ...
            \spellemanation{\arealarge radius from the focus}
...
\begin{spellsection}{Lifebound Spell}[6]
    ...
    \begin{spellfooter}
        ...
        \spellnotes This ritual does not increase the duration of the target effect.
        It has no effect on spells or rituals that do not have a duration.
        \miscastexplode
    \end{spellfooter}
\end{spellsection}
...
\begin{spellsection}[Greater]{Mending}[3]
    ...
    \begin{spellcontent}
        ...
        \end{spelltargetinginfo}
        \begin{spelleffects}
            \spelleffect The target is healed for \spelldamage{}. For every 5 points of healing granted by this ritual, it can instead cure 1 point of critical damage.
        \end{spelleffects}
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Transmutation [Alteration]}{Arcane, Divine, Nature}
...
\begin{spellsection}{Restore Attributes}[4]
    \begin{spellheader}
    \end{spellheader}
    \begin{spellcontent}
        \begin{spelltargetinginfo}
...
\begin{spellsection}[Greater]{Restore Attributes}[7]
    \begin{spellheader}
    \end{spellheader}
    \begin{spellcontent}
        \begin{spelltargetinginfo}
...
\begin{spellsection}[Lesser]{Restore Attributes}[2]
    \begin{spellheader}
    \end{spellheader}
    \begin{spellcontent}
        \begin{spelltargetinginfo}
...
\begin{spellsection}{Shape Wood}[2]
    ...
    \begin{spellcontent}
        ...
        \begin{spelleffects}
            ...
            \spelleffect When you perform this ritual, you make a Craft (wood) check to change the target's shape. You gain a \plus10 bonus on the check, and you need no additional tools.
        \end{spelleffects}
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Transmutation [Alteration]}{Arcane, Divine, Nature}
...
\begin{spellsection}{Sympathy}[9]
    ...
    \begin{spellcontent}
        ...
        \begin{spelleffects}
            ...
            \begin{spelltargets}{All creatures in the outer area of the chosen alignment or type}l[Spellpower vs. Mental]
...
\begin{spellsection}{Telepathic Bond}[3]
    ...
    \end{spellcontent}
    \begin{spellfooter}
        \spellinfo{Divination/Transmutation [Communication]}{Arcane}
...
\begin{spellsection}{Zone of Truth}[2]
    ...
    \begin{spellcontent}
        ...
        \begin{spelleffects}
            ...
            \begin{spelltargets}{All creatures in the area}[Spellpower vs. Mental]
