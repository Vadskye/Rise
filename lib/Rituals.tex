    ...
    \begin{spellcontent}
        ...
        \begin{spelleffects}
            ...
            \begin{spellattack}{Magic vs. Will}
                ...
                \spellspecial Your attack is modified based on how well you know the subject and what sort of physical connection (if any) you have to that creature, as shown on \tref{Scrying Modifiers}.
            \end{spellattack}
        \end{spelleffects}
    \end{spellcontent}
    \begin{spellfooter}
