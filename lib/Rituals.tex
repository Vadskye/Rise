...
\begin{spellsection}{Teleport}[6]
    ...
    \begin{spellcontent}
        ...
        \end{spelltargetinginfo}
        \begin{spelleffects}
            \spelleffect When you perform this ritual, you specify a destination up to 100 miles away on your current plane, and make an Intelligence check. The DR of the check depends on your familiarity with the destination, as shown on \tref{Teleport DCs}.
