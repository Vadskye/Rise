...
\begin{dtable*}
    ...
    \begin{dtabularx}{\textwidth}{l X X X X}
        \tb{Spell Level} & \tb{Specific Action\fn{1} (Item Level)} & \tb{Difficult Trigger\fn{2} (Item Level)} & \tb{Easy Trigger\fn{3} (Item Level)} & \tb{Continuous\fn{4} (Item Level)} \\
        \hline
        Cantrip\fn{5} & 100 gp (2nd)      & 100 gp (3rd)      & 200 gp (3rd)      & 200 gp (3rd)      \\
    ...
    4 For effects with \durext duration. Effects with shorter durations must have the spell level increased to have Extreme duration. \\
