...
\DeclareDocumentEnvironment{spelleffects}{s}
{
    %\IfBooleanF{#1}{\spellline}
    \begin{topandbottomborders}
}
{
    \end{topandbottomborders}
    %\IfBooleanF{#1}{\spellline}
}

\DeclareDocumentEnvironment{spellsubeffects}{s}
{
    %\IfBooleanF{#1}{\spellline}
}
{
...
\DeclareDocumentEnvironment{spellfooter}{s}
{
    %\IfBooleanF{#1}{\spellline}
}
{
