    ...
    pub fn description(
        ...
        let main_attack = match self {
            ...
            Self::CausedDamage(size) => format!(
                "At the end of each round, the $name makes a {accuracy} attack vs. {defense} against each \\glossterm<enemy> within a {size} radius \\glossterm<emanation> of it that dealt damage to it during that round.",
                accuracy = accuracy,
                size = size,
                defense = defense,
            ),
            Self::CausedHpLoss(size) => format!(
                "At the end of each round, the $name makes a {accuracy} attack vs. {defense} against each \\glossterm<enemy> within a {size} radius \\glossterm<emanation> of it that caused it to lose \\glossterm<hit points> during that round.",
                accuracy = accuracy,
                size = size,
                defense = defense,
            ),
            ...
            Self::MadeMeleeAttack => format!(
                "At the end of each round, the $name makes a {accuracy} attack vs. {defense} against each creature that made a \\glossterm{{melee}} attack against it using a free hand or non-Long weapon during that round.",
                accuracy = accuracy,
                defense = defense,
            ),
