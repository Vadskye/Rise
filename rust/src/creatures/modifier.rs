...
impl Modifier {
    pub fn description(&self) -> String {
        match self {
            ...
            Self::EnableGlancingStrikes => "enable glancing strikes".to_string(),
    ...
    pub fn name(&self) -> String {
        match self {
            ...
            Self::EnableGlancingStrikes => format!("enable glancing strikes"),
    ...
    pub fn modifier_type(&self) -> ModifierType {
        match self {
            ...
            Self::EnableGlancingStrikes => ModifierType::EnableGlancingStrikes,
