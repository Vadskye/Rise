...
impl Modifier {
    pub fn description(&self) -> String {
        match self {
            ...
            Self::ExplosionTarget(v) => format!("{} {}", self.name(), v.to_string()),
    ...
    pub fn name(&self) -> String {
        match self {
            ...
            Self::ExplosionTarget(_) => "explosion target".to_string(),
    ...
    pub fn modifier_type(&self) -> ModifierType {
        match self {
            ...
            Self::ExplosionTarget(_) => ModifierType::ExplosionTarget,
