        ...
        fn monster(self) -> Monster {
            ...
            modifiers.push(Modifier::PassiveAbility(PassiveAbility {
                description: r"
                    ...
                    While in its bat form, it gains \trait{blindsense} (120 ft.) and an average fly speed with a 60 ft. height limit.
                    While in its mist form, it becomes \trait{floating} and \trait{intangible}, and gains a slow fly speed with a 30 ft. height limit.
                    ...
                    active_abilities: vec![
                        ActiveAbility::Strike(StrikeAbility {
                            effect: r"
                                The $name makes a $accuracy melee strike with its bite.
                                \hit $fullweapondamage.
                                At the end of the round, the $name regains hit points equal to the hit points the target lost from the attack, ignoring negative damage and any damage increase from critical hits.
