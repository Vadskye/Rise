...
pub fn animates() -> Vec<MonsterEntry> {
        ...
        special_attacks: Some(vec![
            Attack {
                ...
                hit: AttackEffect::Damage(
                    DamageEffect {
                        damage_dice: damage_dice::DamageDice::single_target_damage(4),
                        damage_modifier: 0,
            ...
            Attack {
                ...
                hit: AttackEffect::Damage(
                    DamageEffect {
                        damage_dice: damage_dice::DamageDice::aoe_damage(4),
                        damage_modifier: 0,
                        damage_types: vec![DamageType::Cold],
    ...
    monsters.push(MonsterEntry::MonsterGroup(
        monster_group::MonsterGroup::new("Treants", vec![
            create_treant(
    ...
    monsters.push(MonsterEntry::MonsterGroup(
        monster_group::MonsterGroup::new("Animated Objects", vec![
