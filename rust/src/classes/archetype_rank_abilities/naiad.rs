    ...
    vec![
        RankAbility {
            ...
            description: r"
                ...
                As long as your bonded water remains clean, pure, and large enough to be a valid subject of bonding, you gain a \plus1 \glossterm{enhancement bonus} to your \glossterm{magical power} and \glossterm{mundane power}, and a \plus2 \glossterm{enhancement bonus} to your \glossterm{vital rolls}.
