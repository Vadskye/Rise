        ...
        RankAbility {
            ...
            description: r"
                ...
                Each covenant grants great power at a cost.
                {
                    ...
                    \subcf{Covenant of Bloodsharing} Once per round, when you cause a living creature other than yourself to lose \glossterm{hit points}, you can regain \glossterm{hit points} equal to half your \glossterm{power} (minimum 1).
