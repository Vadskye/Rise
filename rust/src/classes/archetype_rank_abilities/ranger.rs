    ...
    let mut abilities = vec![
        RankAbility {
            ...
            description: r"
                ...
                You gain access to one of the following \glossterm{combat styles}: \combatstyle{flurry of blows}, \combatstyle{mobile assault}, or \combatstyle{penetrating precision}.
