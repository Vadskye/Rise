        ...
        RankAbility {
            ...
            description: r"
                \begin{activeability}{Sneak Attack}
                    ...
                    The strike deals 1d6 \glossterm{extra damage} against each creature that is \unaware or \partiallyunaware of your attack.
    ...
    vec![
        ...
        RankAbility {
            ...
            description: r"
                ...
                If you have a Perform \glossterm{trained skill} that you can use to make an auditory performance, you gain a \plus1 bonus to \glossterm{accuracy} with any \textit{bardic performance} ability using that perform skill.
    ...
    let mut abilities = vec![
        RankAbility {
            ...
            description: r"
                ...
                You gain access to one of the following \glossterm{combat styles}: \combatstyle{dirty fighting}, \combatstyle{ebb and flow}, or \combatstyle{mobile assault}.
