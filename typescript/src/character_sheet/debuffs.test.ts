...
t.test('midair debuff', (t) => {
  ...
  getAttrs(
    ['armor_defense', 'reflex', 'armor_defense_debuff_explanation', 'reflex_debuff_explanation'],
    (attrs) => {
      // 10 level -> +5 defense
      ...
      t.equal(
        attrs.armor_defense_debuff_explanation,
        '-4 (midair)',
        'Armor defense explanation should mention midair',
      );
      t.equal(
        attrs.reflex_debuff_explanation,
        '-4 (midair)',
        'Reflex defense explanation should mention midair',
      );
      t.end();
    },
  );
