  ...
  spells: [
    {
      ...
      effect: `
        ...
        % dr3l
        When it does, it regains 2d10 hit points and increases its \\glossterm{stamina} by one.
      `,
      rank: 1,
    ...
    // TODO: proper EA math
    {
      ...
      effect: `
        ...
        \\begin{mdframeditemize}
          \\item You are \\resistant to \\atFire attacks, but \\vulnerable to \\atCold and \\atElectricity attacks.
