...
export const prayer: MysticSphere = {
  ...
  spells: [
...

    {
      ...
      effect: `
        Choose up to five creatures from among yourself and your \\glossterm{allies} within \\medrange.
        Whenever a target misses with an \\glossterm{attack}, it can choose to \\glossterm{reroll} that attack and keep the higher result.
...

    {
      ...
      effect: `
        Choose up to five creatures from among yourself and your \\glossterm{allies} within \\medrange.
        Each target is \\resistant to \\glossterm{poisons}.
...

    {
      ...
      effect: `
        Choose up to five creatures from among yourself and your \\glossterm{allies} within \\medrange.
        Each target is \\resistant to \\abilitytag{Compulsion} and \\abilitytag{Emotion} effects.
