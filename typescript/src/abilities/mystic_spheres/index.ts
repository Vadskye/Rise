...
export type MysticSphereSource = 'arcane' | 'bardic' | 'divine' | 'domain' | 'nature' | 'pact' | 'soulkeeper';

export const PRIMARY_MYSTIC_SPHERE_SOURCES = ['arcane', 'bardic', 'divine', 'nature', 'pact'] as const;
