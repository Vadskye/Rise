...
// This contains maneuvers that are useful for the combat simulator or for writing monsters,
// but are outside of any defined combat style and not written directly into the book.
...
export const nonstyleManeuvers: CombatStyle = {
  name: 'Non-Style Maneuvers',
  shortDescription:
    'Standard maneuvers outside of defined combat styles. Should not appear in the book text directly.',
  ...
  maneuvers: [
    ...
    // Same as Leadership feat ability
    {
      ...
      effect: `
        ...
        Until your next turn, the target becomes \\focused and gains a \\plus1 accuracy bonus.
      `,
      rank: 1,
      roles: ['boon'],
    },
    ...
    {
      name: 'Ranged Sneak Attack 1',
      effect: `
        Make a strike against a creature within \\shortrange.
        The strike deals 1d4 \\glossterm{extra damage} if the target is \\unaware or \\partiallyunaware of your attack, or if they are adjacent to one of your \\glossterm{allies}.
        This extra damage is doubled if the target is fully unaware of your attack.
        It does not apply if the target is immune to \\glossterm{critical hits}.
      `,
