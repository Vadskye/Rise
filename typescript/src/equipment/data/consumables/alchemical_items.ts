  ...
  return [
    ...
    createAlchemicalItem({
      ...
      description: `
        ...
        Otherwise, it regains $dr7l \\glossterm{hit points} and increases its \\glossterm{stamina} by one.
      `,
      upgrades: [
        {
          rank: 6,
    ...
    createAlchemicalItem({
      ...
      description: `
        You can throw this item as a standard action.
        When you do, make an attack vs. Reflex against something within \\shortrange.
        \\hit If the target is \\creaturetype{undead} or an evil \\creaturetype{soulforged}, it regains $dr7l \\glossterm{hit points} and increases its \\glossterm{stamina} by one.
