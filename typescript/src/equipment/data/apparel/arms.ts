      ...
      item: {
        ...
        upgrades: [
          ...
          },
          {
            ...
            description: "You also gain a +1 \\glossterm{enhancement bonus} to your \\glossterm{mundane power}.",
          },
        ],
        tags: ['Attune'],
        rarity: 'Common',
...
function gloves(): Apparel[] {
  return [
    ...
    { kind: 'Gloves', item: reliableSkillItem("Gloves of Reliable Finesse", "Craft, Devices, or Sleight of Hand", "finesse-based") },
    {
      kind: 'Gloves',
      item: {
      ...
      item: {
        ...
        upgrades: [
          ...
          },
          {
            rank: 7,
            short_description: "Can create daggers with special materials",
            description: "The daggers can also be made of pure adamantine, pure mithral, or sanctified silver.",
          },
        ],
