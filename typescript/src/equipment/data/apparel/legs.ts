...
function boots(): Apparel[] {
  return [
        ...
        upgrades: [
          {
            ...
            description: "You can also move through \\glossterm{mundane}, \\glossterm{inanimate} objects that are no more than six inches thick.",
          },
        ],
        tags: ['Attune'],
        rarity: 'Common',
        ...
        upgrades: [
          {
            ...
            description: "The effect lasts \\glossterm{briefly} instead of only during the current turn.",
          },
        ],
        tags: ['Attune'],
        rarity: 'Common',
      ...
      item: {
        ...
        upgrades: [
          ...
          },
          {
            rank: 6,
            short_description: "Can teleport next to distant bonded ally",
            description: "The teleportation does not require \\glossterm{line of sight} or \\glossterm{line of effect}.",
          },
        ],
        tags: ['Attune'],
        rarity: 'Common',
        ...
        upgrades: [
          {
            ...
            description: "The boots also keep you warm, protecting you in environments as cold as -50 degrees Fahrenheit.",
          },
        ],
        tags: ['Cold', 'Attune'],
        rarity: 'Relic',
        ...
        upgrades: [
          {
            ...
            description: "The boots also keep you cool, protecting you in environments as warm as 140 degrees Fahrenheit.",
          },
        ],
        tags: ['Attune'],
        rarity: 'Relic',
    ...
    { kind: 'Boots', item: reliableSkillItem("Boots of Reliable Motion", "Balance, Climb, Jump, or Swim", "movement-based") },
    {
      kind: 'Boots',
      item: {
        ...
        upgrades: [
          {
            ...
            description: "When you use the \\ability{recover} ability, you can also use the \\ability{sprint} ability immediately afterward.",
          },
        ],
        tags: ['Attune'],
        rarity: 'Common',
        ...
        upgrades: [
          {
            ...
            description: "You are also immune to push, fling, and teleportation effects from attacks that are critical hits.",
          },
        ],
        tags: ['Attune'],
        rarity: 'Common',
