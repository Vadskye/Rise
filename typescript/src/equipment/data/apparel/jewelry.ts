  ...
  return [
      ...
      item: {
        ...
        upgrades: [
          ...
          },
          {
            ...
            description: "The effect is also permanent if the creature's character rank is less than yours, even if it is not simple-minded.",
          },
        ],
        tags: ['Attune'],
        rarity: 'Common',
        ...
        upgrades: [
          {
            ...
            description: "The penalty reduction increases to 2, which normally removes the defense penalty entirely.",
          },
        ],
        tags: ['Attune'],
        rarity: 'Common',
        ...
        upgrades: [
          {
            ...
            description: "You also gain a +1 \\glossterm{enhancement bonus} to your \\magical \\glossterm{power}.",
          },
        ],
        tags: ['Attune'],
        rarity: 'Common',
    ...
    },
    {
      ...
      item: {
        ...
        rank: 2,
        short_description: "Grants +1d8 healing with \\ability{divine aid} and \\ability{lay on hands}",
        description: `
        ...
        upgrades: [
          {
            rank: 4,
            short_description: "Grants +2d8 healing with \\ability{divine aid} and \\ability{lay on hands}",
            description: "The extra healing increases to 2d8.",
          },
          {
            rank: 6,
            short_description: "Grants +4d8 healing with \\ability{divine aid} and \\ability{lay on hands}",
    ...
    },
    {
      ...
      item: {
        ...
        rank: 5,
        short_description: "Deal extra damage with \\ability{smite} using \\weapontag{Heavy} weapons",
        description: `
      ...
      item: {
        ...
        upgrades: [
          ...
          },
          {
            ...
            description: "You also reduce your \\glossterm{longshot penalty} with \\ability{sneak attack} by 2.",
          },
        ],
        tags: ['Attune'],
        rarity: 'Common',
    ...
    },
    {
      ...
      item: {
        ...
        upgrades: [
          {
            rank: 5,
            short_description: "Increase \\ability{skill exemplar} bonus with untrained skills by 3",
            description: "The bonus increases to +3.",
          },
          {
            rank: 7,
            short_description: "Increase \\ability{skill exemplar} bonus with untrained skills by 5",
        ...
        upgrades: [
          {
            ...
            description: "You also need only a quarter of your normal amount of sleep (or similar activity, such as elven trance) each day.",
          },
        ],
        ...
        upgrades: [
          {
            ...
            description: "You can invest up to two spells in the ring. When you activate the ring, you choose which spell to use.",
          },
        ],
        tags: ['Attune'],
        rarity: 'Common',
