        ...
        upgrades: [
          {
            ...
            description: "The belt has ten pockets instead of five, and each pocket is a one foot cube instead of a six inch cube.",
          },
        ],
        tags: ['Attune'],
        rarity: 'Common',
        ...
        upgrades: [
          {
            ...
            description: "While you have no remaining \\glossterm{hit points}, you also take half damage from all sources.",
          },
        ],
        tags: ['Attune'],
        rarity: 'Common',
        ...
        upgrades: [
          {
            ...
            description: "The damage increases to $dr6l, and the area increases to a \\medarea radius.",
          },
        ],
        tags: ['Fire', 'Attune'],
        rarity: 'Common',
