...
export function torso(): RawApparel[] {
  return [...belts(), ...cloaks()];
}

function belts(): RawApparel[] {
  return [
    {
      kind: 'Belt',
      item: {
    ...
    },
    {
      ...
      item: {
        ...
        description: `
            At the end of your turn, if you do not have a \\glossterm{stamina penalty}, you automatically remove one of your \\glossterm{vital wounds}.
            ...
            When you remove a vital wound in this way, you reduce your \\glossterm{stamina} by three.
        `,
        magical: true,
        upgrades: [],
        tags: [],
    ...
    },
    {
      ...
      item: {
        ...
        description: `
            ...
            When you do, you regain $dr3l hit points and reduce your \\glossterm{stamina} by one.
        `,
        magical: true,
        upgrades: [
          {
  ...
  return [
    {
      ...
      item: {
        ...
        description: `
            ...
            When it does, you reduce your \\glossterm{stamina} by one, and the mount does not make a \\glossterm{vital roll} for the vital wounds.
