...
function body(item: Omit<StandardItem, 'magical' | 'rarity' | 'tags' | 'upgrades'> & Partial<Pick<StandardItem, 'upgrades' | 'tags'>>): MagicArmor {
  return {
    kind: 'Body',
    item: {
      magical: true,
...
export const bodyArmor = (): MagicArmor[] => [
  ...
  body({
    ...
    upgrades: [
      { rank: 3, short_description: "Grants +3 durability", description: "The bonus increases to +3." },
      { rank: 5, short_description: "Grants +4 durability", description: "The bonus increases to +4." },
      { rank: 7, short_description: "Grants +5 durability", description: "The bonus increases to +5." },
    ],
  }),
  body({
    name: "Hidden Armor",
    ...
    upgrades: [
      { 
        ...
        description: "The sound and texture of the armor are also appropriate to its disguised form while disguised, and the Awareness DV increases to 25." 
      },
    ],
  }),
  body({
  ...
  body({
    ...
    description: "If your Dexterity is at least 3, you gain a +1 \\glossterm{enhancement bonus} to your Armor defense.",
    upgrades: [
      { 
        rank: 6, 
  ...
  body({
    ...
    `,
    upgrades: [
      { rank: 5, short_description: "Grants +6 durability, but -1 vital rolls", description: "The bonus increases to +6." },
      { rank: 7, short_description: "Grants +8 durability, but -1 vital rolls", description: "The bonus increases to +8." },
    ],
  }),
  body({
  ...
  body({
    ...
    `,
    upgrades: [
      { rank: 4, short_description: "Grants Fortitude instead of Armor defense and +4 durability", description: "The durability bonus increases to +4." },
      { rank: 6, short_description: "Grants Fortitude instead of Armor defense and +5 durability", description: "The durability bonus increases to +5." },
    ],
  }),
  body({
    ...
    upgrades: [
      { rank: 5, short_description: "Regain 4d10 HP per turn", description: "The healing increases to 4d10." },
      { rank: 7, short_description: "Regain 8d10 HP per turn", description: "The healing increases to 8d10." },
    ],
    tags: ['Attune (deep)'],
  }),
  body({
    ...
    upgrades: [
      { 
        ...
        description: "This item does not require \\glossterm{deep attunement}, but it requires 6 Constitution." 
      },
    ],
  }),
];
