...
export const magicRangedWeapons = (): MagicWeapon[] => [
  ...
  ranged({
    ...
    upgrades: [
      {
        rank: 5,
        short_description: '+1d4 damage, hits an extra target while returning',
        description: 'The weapon also deals 1d4 \\glossterm{extra damage} when thrown.',
      },
      {
        rank: 7,
        short_description: '+1d8 damage, hits an extra target while returning',
  ...
  ranged({
    ...
    upgrades: [
      {
        rank: 6,
        short_description: 'Can pass through obstacles',
        description:
