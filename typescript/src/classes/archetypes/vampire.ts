  ...
  return [
    {
      ...
      rank: 1,
      description: `
        Whenever you \\glossterm{injure} a \\trait{blooded} creature with blood using your bite natural weapon, you can increase your \\glossterm{stamina} by one.
    ...
    },
    {
      ...
      rank: 7,
      description: `
        You can use this ability without reducing your stamina.
