...
tap.test('Barbarian Archetypes', (t) => {
  ...
  t.equal(getArchetypeRankAbilities('PrimalWarrior').length, 7);
...
tap.test('Fighter Archetypes', (t) => {
  ...
  t.equal(getArchetypeRankAbilities('MartialMastery').length, 7);
...
tap.test('Monk Archetypes', (t) => {
  ...
  t.equal(getArchetypeRankAbilities('EsotericWarrior').length, 8);
...
tap.test('Ranger Archetypes', (t) => {
  ...
  t.equal(getArchetypeRankAbilities('WildernessWarrior').length, 7);
  t.end();
});
