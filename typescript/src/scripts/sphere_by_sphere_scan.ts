...
for (const [sphereName, spells] of spheresMap.entries()) {
  ...
  for (const s of spells) {
    ...
    if (
      ...
      textLower.includes('object') ||
      textLower.includes('stick') ||
      textLower.includes('item') ||
      textLower.includes('bomb') ||
      textLower.includes('seed') ||
      textLower.includes('grenade') ||
      textLower.includes('shrapnel')
    ) {
      flags.push('OBJECT/WEAPON/ITEM');
    }
    if (
      textLower.includes('creature') ||
      textLower.includes('summon') ||
      textLower.includes('attendant') ||
      textLower.includes('servant') ||
      textLower.includes('golem') ||
    ...
    if (
      textLower.includes('entangle') ||
      textLower.includes('slowed') ||
      textLower.includes('prone') ||
      textLower.includes('swallow') ||
      textLower.includes('pin') ||
      textLower.includes('grapple')
    ) {
