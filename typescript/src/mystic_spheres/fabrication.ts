  ...
  spells: [
...

    {
      ...
      effect: `
        ...
        Any \\glossterm{strikes} that you make with a weapon created with this ability are \\glossterm{magical} abilities, so you use your your Willpower to determine your damage instead of your Strength (see \pcref{Attribute Dice Increments}).
...

    {
      ...
      effect: `
        ...
        Any attack with this ammunition is considered a \\glossterm{magical} attack, so you use your Willpower to determine your damage instead of your Strength (see \pcref{Attribute Dice Increments}).
      `,
      rank: 1,
      scaling: {
...

    {
      ...
      effect: `
        ...
        This strike is considered a \\glossterm{magical} attack, so you use your your Willpower to determine your damage instead of your Strength (see \pcref{Attribute Dice Increments}).
