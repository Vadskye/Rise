...
\parhead{Attack Action} A attack action is always used to attack a foe with a weapon (or your fists). If someone you're fighting becomes distracted or lets their guard down, you get a free attack action against them, called an attack of opportunity.
...
\subsubsection{Actions Each Round}
Each round, you can take one standard action, one move action, and one swift action. If you want, you can take a full-round action instead of your standard and move actions.

\parhead{Downgrading Actions} You can always ``downgrade'' an action: turning a standard action into a move action, for example. If you really wanted to, you could take three swift actions on your turn, but that's usually not a good idea.
