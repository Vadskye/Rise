...
\begin{dtable*}
    ...
    \begin{tabularx}{\textwidth}{>{\ccol}p{2em} >{\ccol}p{7em} *{3}{>{\ccol}p{\savecol}} >{\lcol}X}
        \thead{Level} & \thead{Base Attack Bonus} & \thead{Fort} & \thead{Ref} & \thead{Will} & \thead{Special} \\
        \clericprogressionrow{1}  & Matters of faith, lesser domain aspect \\
...
\cf{Clr}{Devotion} A cleric's spells wax and wane in power with the strength of their devotion, and the extent to which they call on that devotion to create effects. Each cleric has a devotion pool with 10 devotion points in it. After regaining spells for the day, a cleric's devotion pool is full.
