...
\classbasics{Class Skills}
\subparhead{Intelligence} Heal, Knowledge (arcana, local, religion, the planes).
...
Every living thing in the area other than the druid takes damage equal to the druid's level once per ten minutes.
...
In addition, the druid's bonus to spellpower from attuning lasts for 1 hour, regardless of whether she is in a natural environment.

\altcf{Spells} As normal, except that a blighter adds all general Necromancy arcane spells to her spell list.
...
\subparhead{Pyromancy} Jump, Perform, Tumble.
\subparhead{Telekinesis} Climb, Devices, Sleight of Hand.
\subparhead{Temporal} Awareness, Sleight of Hand, Tumble.
