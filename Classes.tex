...
\subcf{Air} Dexterity or Perception
\subcf{Chaos} Willpower
\subcf{Death} Constitution
\subcf{Destruction} Strength or Willpower
\subcf{Earth} Constitution or Willpower
\subcf{Evil} Strength or Willpower
\subcf{Fire} Dexterity or Constitution
\subcf{Good} Perception or Willpower
\subcf{Knowledge} Intelligence
\subcf{Law} Perception or Willpower
\subcf{Magic} Intelligence
\subcf{Protection} Constitution or Willpower
\subcf{Strength} Strength
\subcf{Travel} Any physical attribute
\subcf{Trickery} Dexterity or Intelligence
\subcf{Vitality} Constitution
\subcf{War} Any 
\subcf{Water} Dexterity or Perception
...
If the cleric's devotion pool is empty, he takes a \minus5 penalty to caster level. If it has at least 5 points in it, the cleric gains a \plus5 bonus to caster level.
...
When a cleric channels energy, he affects all creatures in a \areamed radius burst centered on him, including himself if he desires. The cleric may choose to exclude a number of other creatures from the effect equal to 1 \add half his Perception. The amount of damage dealt (if negative energy is channeled) or healed (if positive energy is channeled) is equal to 1d6 damage per two cleric levels. The cleric must make a special attack vs. Fortitude against unwilling targets. The energy burst deals or heals half damage if the attack fails.

Channeling energy is a standard action. A cleric can channel energy a number of times per day equal to 3 \add half his Willpower. A cleric must be able to present his holy symbol to use this ability. The abilities used 
