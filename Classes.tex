...
\subcf{Brutal Ambush*} The rogue rolls d8s instead of d6s for her sneak attack dice on this ambush attack.
...
\subcf{Hamstring*} A foe damaged by this ambush attack has its land speed halved for 5 rounds. Despite the name, this can be used on foes who do not have hamstrings.
...
\subcf{Tricky Maneuver} When performing a maneuver against a foe she would be able to sneak attack, the rogue gains a circumstance bonus to attack equal to the number of sneak attack dice she would roll. Ambush attack dice are not included, and performing a tricky maneuver does not prevent the rogue from executing an ambush attack against the foe. The benefits of this trick apply even against foes immune to critical hits.
