...
When attacking, the barbarian ignores an amount of hardness equal to his barbarian level.
...
\subcf{Strength}
The cleric channels energy as normal, except that he also gains a \plus2 enhancement bonus to Strength for 1 round.
...
If the effect is dispelled or suppressed, he can resume it as a swift action.
\subcf{Vitality -- }
\subcf{War -- Warmaster's Power} The cleric continuously gains the benefits of the \spell{greater divine favor}
spell, with a caster level equal to his cleric level \add half his domain attribute.
If the effect is dispelled or suppressed, he can resume it as a swift action.
...
\subcf{Wild -- Natural Power}
Whenever the cleric is in natural terrain, he gains a \plus2 bonus to caster level and the improved natural casting ability, as the druid class feature (see Improved Natural Casting, \pref{Drd:Improved Natural Casting}).
...
The druid gains a \plus2 enhancement bonus to Creature Handling and Ride checks.
...
\subcf{Bear's Endurance}
The druid gains a \plus2 enhancement bonus to Constitution.
\subcf{Bull's Strength}
...
\subcf{Shrink}
The druid shrinks by a size category, halving her height, length, and width, and dividing her weight by 8.
...
See \pcref{Climbing}, for more details.
\subcf{9th -- Grow}
The druid grows by a size category, doubling her height, length, and width, and multiplying her weight by 8.
...
\subcf{9th -- Venom}
When the druid embodies this apsect, she transforms one of her natural weapons to become poisonous.
...
\subcf{Flurry of Blows}
As a swift action, the monk can make a physical attack at a \minus5 penalty.
...
\subcf{2nd -- Divine Favor} This power functions like the \spell{divine favor}
spell.
...
\subcf{4th -- Align Weapon} This power functions like the \spell{align weapon}
spell.
\subcf{4th -- Bewildering Smite*}
The paladin's smite challenges her foe's mind.
The struck creature is \bewildered for 5 rounds.
\subcf{4th -- Sickening Smite*}
...
\subcf{8th -- Greater Divine Favor} This power functions like the \spell{greater divine favor}
spell.
\subcf{10th -- Dazing Smite*}
...
\subcf{4th -- Touch of Idiocy} This power functions like the \spell{touch of idiocy}
spell.
\subcf{6th -- Confusion} This power functions like the \spell{confusion}
spell.
...
\subcf{8th -- Freedom} This power functions like the \spell{freedom}
spell.
...
Allies in the area gain a \plus2 bonus to Will defense.
...
A creature damaged by the rogue's sneak attack takes a penalty on its Concentration checks equal to number of sneak attack dice the rogue would roll.
...
If the rogue uses a Strike feat (see \pcref{Strike Feats}) on this sneak attack, she may add her Intelligence to the special attack for the strike.
This is an ambush attack, and only works once per creature.
The benefits of this trick apply even against creatures immune to critical hits.
...
\subcf{12th -- Crippling Ambush*}
A creature damaged by this sneak attack takes Strength damage equal to the rogue's Intelligence.
This is an ambush attack, and only works once per creature.

\subcf{12th -- Dispelling Ambush (Su)*}
A creature damaged by this sneak attack is affected by a targeted \spell{dispel magic}.
...
\subcf{16th -- Hide in Plain Sight}
The rogue can use the Stealth skill to hide even while being observed, taking a \minus5 penalty to the Stealth check.
