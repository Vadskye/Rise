...
\begin{dtable}
    ...
    \begin{tabularx}{\columnwidth}{>{\ccol}p{\levelcol} >{\ccol}p{\babcolgood} *{2}{>{\ccol}p{\savecol}} >{\lcol}X}
        ...
        8th & \plus6/\plus1 & \plus9 & \plus7 & Manipulate magic \\
...
\cf{Spl}{Manifest Power (Su)} At 6th level, the spellwarped can spend a spellwarp point to call upon his innate magic to generate a powerful but brief effect.
...
\cf{Spl}{Manipulate Magic (Su)} At 8th level, the spellwarped can channel his innate magic to manipulate other forms of magic. Using this ability costs a spellwarp point. 
