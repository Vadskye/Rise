...
Like other spellcasters, the number of spells a wizard knows and can cast each day is limited. These limitations are given below on \trefnp{Spells per Day} and \trefnp{Wizard Spells Known}. A wizard's spells are drawn from the common spells on the sorcerer/wizard spell list (\pcref{Sorcerer/Wizard Spells}).
