...
\begin{dtable*}
    ...
    \begin{tabularx}{\textwidth}{>{\ccol}p{\levelcol} >{\ccol}p{\babcolgood} *{3}{>{\ccol}p{\babcolavg}} X}
        ...
        \barbarianprogressionrow{1}  & Damage reduction, rage \plus2      \\
        \barbarianprogressionrow{2}  & Endurance, fast movement           \\
        \barbarianprogressionrow{3}  & Channeled rage, uncanny dodge      \\
        \barbarianprogressionrow{4}  & Grit                               \\
        ...
        \barbarianprogressionrow{16} & Improved grit                      \\
