...
\subcf{6th -- Destructive Rage} When attacking objects, the barbarian ignores an amount of hardness equal to his barbarian level.
...
If the cleric's devotion pool has at least 5 points in it, the cleric gains a \plus5 bonus to his cleric level when determining his caster level, spellpower, and the effects of his abilities. If his devotion pool is empty, he takes a \minus5 penalty to his cleric level for the same purposes.
