...
\begin{dtable}
    ...
    \begin{tabularx}{\columnwidth}{>{\ccol}p{\levelcol} >{\ccol}p{\babcolgood} *{3}{>{\ccol}p{\savecol}} >{\lcol}X}
        ...
        1st & \plus0 & \plus2 & \plus1 & \\
        2nd & \plus1 & \plus3 & \plus2 & \\
        3rd & \plus2 & \plus4 & \plus3 & \\
        4th & \plus3 & \plus5 & \plus4 & \\
        5th & \plus3 & \plus6 & \plus4 & \\
        6th & \plus4 & \plus7 & \plus5 & \\
        7th & \plus5 & \plus8 & \plus6 & \\
        8th & \plus6/\plus1 & \plus9 & \plus7 & \\
        9th & \plus6/\plus1 & \plus10 & \plus7 & \\
        10th & \plus7/\plus2 & \plus11 & \plus8 & \\
...
\subcf{Alteration -- Alter Body} The spellwarped gains a \plus2 competence bonus to a physical attribute of his choice. This bonus increases by 1 at 8th level and every 6 spellwarped levels thereafter.
\subcf{Enchantment -- Enhance Mind} The spellwarped gains a \plus2 competence bonus to a mental attribute of his choice. This bonus increases by 1 at 8th level and every 6 spellwarped levels thereafter.
\subcf{Temporal -- Rapid Movement} The spellwarped gains a \plus2 competence bonus to his dodge modifier and a \plus5 foot competence bonus to his movement speed. At 8th level, and every 6 levels thereafter, the dodge bonus increases by 1 and the speed bonus increases by 5 feet.
...
\cf{Spl}{Magic Manipulation (Su)} At 4th level, the spellwarped can manipulate existing magic that matches her choice of totem magic. Using this ability costs a spellwarp point, and it only affects spells or spell-like abilites affecting the spellwarped.
\subcf{Alteration -- ??}
\subcf{Enchantment -- Control Enchantment} As a swift action, the spellwarped can attempt to take control of any mind-affecting spell or spell-like ability affecting him. To do so, he makes a check with a bonus equal to his spellwarped level \add his Charisma against a DC equal to 11 \add the caster level of the effect. If he succeeds, he may dispel or gain control of the spell. If he gains control, he no longer suffers its effects, but the caster of the spell does not know that the effect no longer functions.
\subcf{Temporal -- Accelerate Magic} As a swift action, the spellwarped can increase or decrease the duration of any spell affecting him by two rounds. This can end the effect immediately if it has no time remaining.

\cf{Spl}{Spellwarped Aspect (Ex)} At 5th level, the spellwarped gains a new ability based on his continued exposure to magical energy. The spellwarped gains an additional aspect at 9th level and every four levels thereafter.
\subcf{Alteration -- Damage Reduction} The spellwarped gains physical damage reduction equal to half his class level, allowing him to ignore the first points of damage he takes each round.
\subcf{Alteration -- }
...
\cf{Spl}{Attuned Senses (Su)} At 6th level, the spellwarped learns to recognize the telltale signs of his chosen magic. He must concentrate as a standard action to use this ability, and he may do so any number of times per day.
...
%\cf{Spl}{Surge Feat} At 7th level, the spellwarped learns how to use other kinds of magic to supplement his own. He gains a bonus surge feat for which he meets the prerequisites.

\cf{Spl}{Improved Magic Manipulation (Su)} At 8th level, the spellwarped can use his magic manipulation ability to affect any ally within \rngclose range of him.
...
\subcf{Alteration} The spellwarped can increase or decrease by a size category, as he chooses.

\subcf{Enchantment} The spellwarped becomes immune to hostile mind-affecting effects.

\subcf{Temporal} The spellwarped gains the benefits of the \spell{haste} spell.
