...
\parhead{Hit Value} 7
\parhead{Class Skills} Climb (Str), Jump (Str), Swim (Str), Acrobatics (Dex), Ride (Dex), Perception (Wis), Survival (Wis), Handle Animal (Cha), and Intimidate (Cha)
...
\subsection{Bard}
\parhead{Hit Value} 5
\parhead{Class Skills} Sleight of Hand (Dex), Forgery (Int), Knowledge (all skills, taken individually) (Int), Linguistics (Int), Perception (Wis), Sense Motive (Wis), Spellcraft (Wis), Bluff (Cha), Persuasion (Cha), Disguise (Cha), Perform (Cha), Use Magic Device (Cha)
