...
\norepeatnotes
\parhead{10th -- Slow, Greater} As a standard action, the spellwarp can make a creature within \rngmed range \slowed.
...
\parhead{12th -- Timetheft, Greater} This power functions like the timetheft power, except that it does not require a special attack.
