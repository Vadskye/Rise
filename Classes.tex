...
\cf{Clr}[13th]{Greater Channel Domain}[Su]
...
Greater channeled domain abilities are described at \pcref{Greater Channeled Domains}.
...
\begin{dtable}
    ...
    \begin{dtabularx}{\columnwidth}{>{\ccol}p{\levelcol} >{\ccol}p{\babcolavg} *{3}{>{\ccol}p{\savecol}} >{\lcol}X}
        \thead{Level} & \thead{Base Attack Bonus} & \thead{Fort} & \thead{Ref} & \thead{Ment} & \thead{Special} \\
        \hline
        \monkprogressionrow{1}  & Enlightened defense, \ki power, unarmed warrior \\
...
She chooses one ability from the list below.
