...
\subcf{Protection} The cleric grants each affected creature temporary hit points equal to half the amount that channeling positive energy would have healed. Undead gain temporary hit points as well. The temporary hit points last for 5 rounds.
...
\subcf{Travel} The cleric channels positive energy. All affected creatures gain a \plus10 foot enhancement bonus to movement speed for 1 round.
\subcf{Trickery} The cleric channels trickery and confusion. Affected creatures take no damage and receive no healing, but are bewildered for 5 rounds, making them vulnerable. A Will save negates the effect. A vulnerable creature takes a \minus2 penalty to attack rolls, saving throws, checks, DCs, and AC. This is a mind-affecting effect.
