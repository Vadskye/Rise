...
\cflnl{Pal}{Improved Smiting (Su)} At 5th level, the paladin gains an additional improved smiting ability, and adds the following improved smiting abilities to the list of those that can be selected.
