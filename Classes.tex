...
\subcf{Terrifying Rage (Su)} Any enemy beginning its turn within the barbarian's threatened area must make a Will save or be shaken for 5 rounds. The save DC is equal to 10 \add half the barbarian's level \add his Charisma modifier. This can only affect any individual creature once per 24 hours.
...
\subcf{Bewildering Strike*} A foe damaged by this attack must make a Will save or be bewildered for 5 rounds.
