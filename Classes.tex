...
\cfl{Bbn}{3rd}{Uncanny Dodge (Ex)} A barbarian can react to danger before his senses would normally allow him to do so. He is not helpless while unaware of an attack.
...
\cf{Mnk}{Unfettered Defense (Ex)} A monk knows how to react intuitively to avoid blows. When unarmored and unencumbered, the monk may add her Wisdom to her physical defenses. She loses this bonus when she is helpless.
...
\cfl{Mnk}{3rd}{Uncanny Dodge (Ex)} The monk can react to danger before her senses would normally allow her to do so. She is not helpess when unaware of an attack.
...
%weak after changes?
\cfl{Mnk}{18th}{Uncanny Foresight (Su)} The monk gains the ability to react to situations without premeditation or thought. She is never surprised or unaware, and always acts in the first round of combat.
...
The paladin can lay on hands a number of times per day equal to 1 \add half her Charisma (minimum 1). When using lay on hands on an unwilling target, the paladin must make a touch attack against the creature's Reflex defense. If she hits, she must make a Fortitude attack. A failed Fortitude attack heals or inflicts half damage.
...
\cfl{Rog}{3rd}{Uncanny Dodge (Ex)} The rogue can react to danger before her senses would normally allow her to do so. She is not helpless when unaware of an attack.
...
\subcf{Pyromancy -- Ember} The spellwarped can snap his fingers as a swift action to create a small ember of flame in his hand for 5 minutes. This ember casts light as a torch, and can deal 1 point of fire damage with a successful touch attack against Reflex defense. The ember can be dismissed as a swift action or extinguished as a move action.
...
\parhead{6th -- Disjointed Time} As a standard action, the spellwarped makes a Fortitude attack against a single creature within \rngmed range to chaotically disrupt its local flow of time. If the attack succeeds, the creature takes a \minus4 penalty to attacks, defenses, and checks for 5 rounds.
