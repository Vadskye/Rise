...
\sssecfake{Class Skills}
The monk's class skills (and the key attribute for each skill) are Climb (Str), Jump (Str), Sprint (Str), Swim (Str), Balance (Dex), Escape Artist (Dex), Stealth (Dex), Tumble (Dex), Heal (Int), Awareness (Per), Spellcraft (Per), Survival (Per), Intimidate (Varies), Bluff (\x), and Perform (\x).
