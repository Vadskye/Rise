...
\subcf{Alteration} The spellwarped can change minor aspects of his appearance at will -- removing a mole or lengthening his beard slightly. This can grant him a \plus2 competence bonus to Disguise checks. Major changes are not possible.
\subcf{Enchantment} The spellwarped 
\subcf{Temporal} The spellwarped always knows exactly what time it is, and can track precise increments of time without effort.
...
\subcf{Alteration} The spellwarped gains a \plus2 competence bonus to a physical attribute of his choice. This bonus increases by 1 at 8th level and every 6 spellwarped levels thereafter.
\subcf{Enchantment} The spellwarped gains a \plus2 competence bonus to a mental attribute of his choice. This bonus increases by 1 at 8th level and every 6 spellwarped levels thereafter.
\subcf{Temporal} The spellwarped gains a \plus2 competence bonus to his dodge modifier and a \plus5 foot competence bonus to his movement speed. At 8th level, and every 6 levels thereafter, the dodge bonus increases by 1 and the speed bonus increases by 5 feet.

\cf{Spl}{Invoke Power (Su)} At 3rd level, the spellwarped spend a spellwarp point to attack a foe within \rngclose range as a standard action. If a saving throw is allowed, the DC is equal to 10 \add the spellwarped's class level \add his key attribute.
\subcf{Alteration} The subject becomes smaller for 5 rounds unless it makes a Fortitude save. It takes a \minus2 penalty to Strength, decreases its weapon damage dice by one size, and takes a \minus4 penalty to CMA and CMD. However, it gains a \plus2 bonus to Stealth checks and a \plus1 bonus to attack rolls and armor class. This is a size-affecting effect.
\subcf{Enchantment} The subject is bewildered for 5 rounds, making it vulnerable. If it becomes bloodied, it is instead confused. A Will save negates the effect.
\par \vulnerableexplanation \confusionexplanation This is a mind-affecting effect.
\subcf{Temporal} The subject is slowed for 5 rounds unless it makes a Will save. A slowed creature can take a standard action or a move action each round, but not both. It cannot take full-round actions, but it may take swift actions. Additionally, it takes a \minus2 penalty to attack rolls, Strength and Dexterity-based checks, and armor class.

\cf{Spl}{Spellwarped Aspect (Ex)} At 5th level, the spellwarped gains a new ability based on his continued exposure to magical energy. These are constantly active abilities that depend on his choice of magic. The spellwarped gains an additional aspect at 9th level and every four levels thereafter.
...
\cf{Spl}{Spellwarped <Constant Buff> (Ex)}
\subcf{Alteration}
\subcf{Enchantment}
\subcf{Temporal}

\cf{Spl}{Channel Power} At 5th level, the spellwarped can spend a spellwarp point as a swift action 

\cf{Spl}{Surge Feat} At 6th level, the spellwarped learns how to use other kinds of magic to supplement his own. He gains a bonus surge feat for which he meets the prerequisites.

\cf{Spl}{Invoke Retribution (Su)} At 7th level, the spellwarped can use his invoke power ability as an immediate action after he takes damage.

\cf{Spl}{Improved Spellwarped Surge (Su)} At 8th level, the spellwarped's ability to manifest his chosen form of magic improves. When he uses his spellwarped surge ability, he also gains the appropriate benefit described below.
