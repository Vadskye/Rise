...
\parhead{Good}
\subcf{5th -- Bolstering} The paladin's smite aids her ally. If her smite succeeds, an ally within \rngmed range gains temporary hit points equal to twice the paladin's level.
...
\subcf{Chaotic Mind} The paladin's speech is unaffected by spells with magically detect truth, lies, or alignment. Such spells never detect the paladin, just as if she was not there at all.
...
\subcf{12th -- Freedom} The paladin continuously gains the benefit of the \spell{freedom} spell.
...
\subcf{9th -- Debilitating Aura} All creatures within a \areamed radius of the paladin are vulnerable (\minus2 to attacks, defenses, and checks).
...
\cfl{Pal}{19th}{Martyr's Glorious Retribution (Su)} If the paladin dies in the devoted service of her chosen alignment, she may choose to have her fallen body erupt in an immense burst of divine power. If she does, her body is almost completely consumed, preventing her from being raised with \spell{raise dead} and similar effects that require an intact body. This has two effects. First, a \spell{sunburst} spell immediately takes effect over the area where the paladin fell. Second, a \spell{storm of vengeance} spell begins to take effect, centered on the same area. The spell lasts for 10 rounds, and the lightning strikes target the paladin's enemies. Both of these effects harm only the paladin's foes, and do not harm her allies. However, her allies' vision is still impeded by the \spell{storm of vengeance}.
