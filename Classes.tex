...
\subcf{Trapfinding} As a full-round action, a rogue may move up to 10 feet while searching every square within 10 feet of her for traps. If she detects a trap partway through her movement, she may immediately stop moving.
...
\cf{Rog}{Advanced Combat Trick} At 13th level, and every three levels thereafter, the rogue may choose any of the following advanced combat tricks in addition to her other options for combat tricks. All advanced combat tricks are (Ex) abilities unless otherwise noted.
...
\subcf{Dispelling Ambush (Su)*} A foe damaged by this attack is affected by a targeted \spell{dispel magic}. The caster level for this ability is equal to the rogue's level \add Intelligence.
