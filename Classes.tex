...
\begin{dtable}
    ...
    \begin{tabularx}{\columnwidth}{>{\ccol}p{\levelcol} >{\ccol}p{\babcolgood} *{2}{>{\ccol}p{\savecol}} >{\lcol}X}
        ...
        5th & \plus3 & \plus6 & \plus4 & \\
        6th & \plus4 & \plus7 & \plus5 & Manifest power \\
        7th & \plus5 & \plus8 & \plus6 & Manipulate magic, spellwarped aspect \\
        8th & \plus6/\plus1 & \plus9 & \plus7 & Manifest attack \\
        9th & \plus6/\plus1 & \plus10 & \plus7 & \\
...
\cf{Spl}{Manifest Attack (Su)} A spellwarped can channel his innate magic to smite his foes. As a standard action, he can spend a spellwarp point to manifest an attack. If a saving throw is allowed, the DC is equal to 10 \add the spellwarped's class level \add his key attribute. The spellwarped gains one manifest attack at 1st level, then another at 4th level and every 4 levels thereafter.
\parhead{Alteration}
...
\cf{Spl}{Spellwarped Aspect (Ex)} At 3rd level, the spellwarped gains a new ability based on his continued exposure to magical energy. The spellwarped gains an additional aspect at 7th level and every four levels thereafter.
\subcf{Alteration -- Alter Size} When the spellwarped uses his manifest surge ability, he can increase or decrease by a size category, as he chooses. This is a size-affecting effect, and does not stack with other size-affecting effects.
\subcf{Alteration -- Damage Reduction} The spellwarped gains physical damage reduction against his choice of piercing, slashing, or bludgeoning damage. The amount of damage resisted is equal to half his class level, allowing him to ignore the first points of damage he takes each round.
\subcf{Alteration -- Improved Damage Reduction} The spellwarped's damage reduction applies against all forms of physical damage. The spellwarped must have the damage reduction aspect to gain this aspect.
\subcf{Pyromancy -- Fire Shield} While his manifest surge ability is active, any creature that hits the spellwarped with its body or a melee weapon takes 1d6 fire damage per two spellwarped levels. Each individual creature can take this damage only once per round.
\subcf{Pyromancy -- Flame Weapon} While his manifest surge ability is active, the spellwarped adds half his Charisma to damage in addition to half his Strength. This bonus damage is fire damage.
\subcf{Temporal -- Accelerate Attack} While his manifest surge ability is active, the spellwarped can make an additional attack at his full attack bonus when making a full attack. \textit{Prerequisite:} 7th level spellwarped.
\subcf{Temporal -- Evasion} If the spellwarped makes a successful Reflex save against an attack that normally deals half damage on a successful save, he instead tes no damage. Evasion can only be used if the spellwarped is wearing light armor or no armor. A helpless spellwarped does not gain the benefit of evasion.
\subcf{Temporal -- Fast Movement} The spellwarped gains a \plus10 foot competence bonus to movement speed.
\subcf{Temporal -- Uncanny Dodge} The spellwarped may apply his Dexterity and dodge modifier to his armor class while flat-footed.
...
\cf{Spl}{Manifest Power (Su)} At 6th level, the spellwarped can spend a spellwarp point to call upon his innate magic to generate a powerful effect.
...
\cf{Spl}{Manipulate Magic (Su)} At 7th level, the spellwarped can channel his innate magic to manipulate other forms of magic. Using this ability costs a spellwarp point. 
...
\cf{Spl}{Spell Resistance (Ex)} At 10th level, the spellwarped gains spell resistance. A creature with spell resistance may always make a saving throw when a spell is cast on it. The saving throw type is indicated by the spell. If it succeeds, the spell has no effect on it.

\cf{Spl}{Manifest Power (Su)} At 10th level, the spellwarped can gains the ability to manifest his innate magic more powerfully.
\subcf{Pyromancy -- Become the Flame} As a standard action, the spellwarped can become a being of pure fire for 5 rounds. 
...
\cf{Spl}{Manifest Ultimate Power (Su)} At 18th level, the spellwarped gains the ability to manifest his innate magic to its fullest extent.
\subcf{Pyromancy -- }
