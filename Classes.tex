...
\subcf{11th -- Alter Movement} When the spellwarped gains this aspect, he chooses to gain a climb, glide, or swim speed equal to his base land speed permanently. He may select this aspect multiple times, choosing a different movement mode each time.
...
\subcf{10th -- Heal Wounds} As a standard action, the spellwarped can remove injuries from his body by transforming himself into a healthier version of his body. He heals 1d10 points of damage per two spellwarped levels immediately after using the ability, and an additional 1d10 points per two spellwarped levels in the next round. This also removes any of the following conditions: blinded, diseased, exhausted, fatigued, nauseated, sickened, and poisoned.
\subcf{14th -- }
\subcf{18th -- }
...
\cf{Spl}{Permanent Surge (Su)} At 17th level, the spellwarped can maintain the full power of his innate magic without limit. He can gain the effects of his manifest surge ability indefinitely. He may toggle the ability on or off as a swift action, without expending spellwarp points.
