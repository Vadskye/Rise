...
\cf{Clr}{Lesser Domain Aspect}[Su]
...
\cf{Clr}[5th]{Channeled Domain Power}[Su]
...
\cf{Clr}[10th]{Improved Devotion}[Su]
The cleric's devotion pool stores a maximum of fifteen devotion points.

\cf{Clr}[13th]{Greater Channeled Domain Power}[Su]
...
\cf{Clr}[20th]{Supreme Devotion}[Su]
...
This ability can be used a number of times per day equal to her Perception or half her druid level (minimum 1), whichever is higher.
...
When \monkunencumbered, the monk may use Perception in place of Dexterity to determine her physical defenses (Armor, Manuever, and Reflex).
...
At her 5th monk level, and every three monk levels thereafter, the monk learns an additional \ki power.
...
\cf{Mnk}[18th]{Perfect Motion}{Su} The monk continuously gains the benefits of the \spell[freedom]
spell.
...
\cf{Sor}[3rd]{Defensive Spellblend}[Ex]
...
\cf{Sor}[5th]{Improved Wild Magic}[Ex]
...
\cf{Sor}[11th]{Improved Defensive Spellblend}[Ex]
...
\cf{Sor}[13th]{Spell Resistance}[Ex]
...
\cf{Sor}[15th]{Improved Offensive Spellblend}[Ex]
...
\cf{Wiz}[4th]{Invocation Sequencer}[Ex]
