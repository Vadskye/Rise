...
\cfl{Pal}{2nd}{Improved Smite} The paladin gains an improved smite ability to augment her smite attack. If an improved smite requires a special attack, the attack bonus is equal to the paladin's level \add her Charisma.

The paladin chooses a single improved smite ability from the list below. At 5th level, and every 3 levels thereafter, she gains an additional imrpoved smite. Some improved smites have minimum paladin levels, as indicated in the title of the ability. All improved smites are supernatural abilities unless otherwise noted.
