...
Tricks marked with an asterisk are called ambush tricks. Ambush tricks only function on the first sneak attack the rogue makes against a particular creature in an encounter. If an ambush trick requires a special attack, the attack bonus is equal to the rogue's level \add her Intelligence.
