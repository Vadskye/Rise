...
\cf{Bbn}{Fast Movement (Ex)} At 2nd level, a barbarian gains a \plus10 foot competence bonus to his land speed while unencumbered.
...
\subcf{12th -- Overpowering Rage} The barbarian adds his rage bonus as a competence bonus to his maneuver modifier.
...
\subcf{Air} The cleric adds Athletics to his cleric class skill list. In addition, he gains a competence bonus equal to half his cleric level on Athletics checks made to jump.
...
\subcf{Vitality} The cleric gains a competence bonus equal to half his cleric level on Heal checks.
...
\subcf{Destruction -- }
\subcf{Earth -- Anchored} The cleric gains a \plus4 competence bonus to Maneuver Class against bull rush, overrun, and trip attempts while standing on solid ground.
...
\subcf{Nature -- Natural Power} Whenever the cleric is in natural terrain, he gains a \plus2 competence bonus to caster level and the improved natural casting ability, as the druid class feature (see Improved Natural Casting, \pref{Drd: Improved Natural Casting}).
...
\subcf{Lope} The druid gains the ability to move on all four limbs. When doing so, she gains a \plus20 foot competence bonus to her speed, but she cannot use her hands for anything except moving. When not moving on four legs, her ability to use her hands is unchanged.
...
\subcf{5th -- Scent} The druid gains the scent ability, granting her a \plus10 competence bonus to scent-based Perception checks (see \pcref{Perception}).
...
%\subcf{Earthen Power} The druid gains a \plus2 competence bonus to caster level while she is touching natural earth or stone.
...
\cf{Mnk}{Fast Movement (Ex)} At 2nd level, a monk gains a \plus10 foot competence bonus to her land speed while unarmored and unencumbered.
...
\cf{Rgr}{Quarry (Ex)} A ranger is a deadly hunter. As a swift action, a ranger may designate any foe he sees as his quarry. A ranger gains a \plus2 competence bonus to attack rolls, Perception checks, and Survival checks against his quarry. However, while a ranger is pursuing a quarry, he takes a \minus2 penalty on the same rolls against any target other than his quarry. A ranger may give up pursuing a quarry as a free action. He may not have more than one quarry at once; if he designates a new quarry, the old target is no longer considered his quarry. If the ranger does not see his quarry for more than a week, it is no longer considered his quarry.
...
\subcf{Mountains} The ranger gains a climb speed equal to his land speed. If he already has a climb speed, he gains a \plus10 foot competence bonus to his climb speed.
...
\cf{Rog}{Skill Exemplar (Ex)} At 13th level, the rogue gains a \plus5 competence bonus with a single skill of her choice. At 17th level, she may gain this bonus with an additional skill.
...
\subcf{Brilliant Surge} The sorcerer gains a competence bonus to his caster level with light spells, but takes a penalty to his caster level with Illusion spells.
\subcf{Empathic Surge} The sorcerer gains a competence bonus to caster level with mind-affecting spells, but takes a penalty to Will saves and to caster level with spells that deal damage.
\subcf{Energetic Surge} The sorcerer gains a competence bonus to caster level with acid, cold, electricity, and fire spells, but takes a penalty to his caster level with other spells.
\subcf{6th -- Focused Surge} The sorcerer gains a competence bonus to his concentration checks, but takes a penalty to his caster level with all spells.
\subcf{6th -- Patient Surge} The sorcerer gains a competence bonus to his caster level with all spells, but all spells he casts require at least a full-round action to cast. This does not increase the casting time of spells with a casting time of a full-round action or longer.
...
\subcf{14th -- Lifebound Surge} The sorcerer gains a competence bonus to his caster level with all spells, but takes 1 point of Constitution damage each time he casts a spell.
\subcf{14th -- Lingering Surge} The sorcerer gains a competence bonus to his caster level with spells that have a non-instantaneous duration, but takes a penalty to caster level with spells that are instantaneous.
