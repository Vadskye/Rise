...
\subcf{6th -- Terrifying Rage (Su)} Whenever the barbarian makes a physical attack, he may also make a Will attack against all enemies he threatens. His attack bonus equals his barbarian level \add his Charisma. Affected creatures are shaken for 5 rounds. A shaken creature is vulnerable, causing it to take a \minus2 penalty to attacks, defenses, and checks. This can only affect any individual creature once per 24 hours.
...
\cf{Bbn}{Improved Grit (Ex)} At 16th level, a barbarian's fortitude knows no bounds. If he is affected by Fortitude attack that would deal half damage when resisted, he takes only half damage from the attack, even if he fails to resist it.
...
\subcf{Earth} The cleric channels seismic energy, making a Reflex attack. This deals physical bludgeoning damage to all creatures on the ground. A failed attack deals half damage.
\subcf{Evil} The cleric channels negative energy, except that it has no effect on evil creatures.
\subcf{Fire} The cleric channels fiery energy, making a Reflex attack. This deals fire damage and heals creatures with the fire subtype. A failed attack deals half damage.
...
\subcf{Law} The cleric channels axiomatic energy, making a Will attack. This deals 4 damage per two cleric levels to all creatures within a 40 ft. cube centered on the cleric. A failed attack deals half damage. This has no effect on lawful creatures.
...
\subcf{Trickery} The cleric channels trickery and confusion, making a Will attack against each affected creature. A successful attack deals and heals no damage, but bewilders the subject, making it vulnerable. A vulnerable creature takes a \minus2 penalty to attacks, defenses, and checks. This is a mind-affecting effect.
