...
\subcf{12th -- Spellbreaker Rage (Su)} The barbarian gains spell resistance while raging. A creature with spell resistance may always make a saving throw when a spell is cast on it. The saving throw type is indicated by the spell. If the creature succeeds, the spell has no effect on it.
...
\cf{Mnk}{Perfect Soul (Ex)} At 12th level, a monk gains spell resistance. A creature with spell resistance may always make a saving throw when a spell is cast on it. The saving throw type is indicated by the spell. If the creature succeeds, the spell has no effect on it.
