...
\cf{Pal}{Bulwark of Defense (Ex)} When he reaches 3rd level, an opponent that begins its turn in the paladin's threatened area treats all squares that he threatens as difficult terrain. His strict vigilance and active defensive maneuvers force his opponents to move with care. Creatures must pay double movement cost to move through squares of difficult terrain, and cannot run or charge.
