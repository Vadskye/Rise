...
\begin{dtable}
    ...
    \begin{dtabularx}{\columnwidth}{>{\ccol}p{2em} >{\ccol}p{\babcolavg} *{3}{>{\ccol}p{\savecol}} >{\lcol}X}
        \thead{Level} & \thead{Base Attack Bonus} & \thead{Fort} & \thead{Ref} & \thead{Will} & \thead{Special} \\
        \hline
        \clericprogressionrow{1}  & Devotion, lesser domain aspect, spells, rituals \\
...
Every odd level, including 1st level, she gains a feat (see \pcref{Feats}).
