...
\cf{Clr}{Rituals} Clerics, can perform rituals to create unique magical effects (see \pcref{Rituals}).
...
\begin{dtable}
    ...
    \begin{tabularx}{\columnwidth}{>{\ccol}p{\levelcol} >{\centering}p{\babcolavg} *{3}{>{\ccol}p{\savecol}} >{\ccol}X}
        \thead{Level} & \thead{Base Attack Bonus} & \thead{Fort} & \thead{Ref} & \thead{Will} & \thead{Special} \\
        \druidprogressionrow{1}  & Nature sense, rituals, spells   \\
        \druidprogressionrow{2}  & Wild speech, woodland stride    \\
...
\cf{Drd}{Rituals} Druids can perform rituals to create unique magical effects (see \pcref{Rituals}).
...
\cflt{Drd}{2nd}{Wild Speech}{Su} One of the first lessons a druid learns is how to commune with natural creatures.
...
\begin{dtable*}
    ...
    \begin{tabularx}{\textwidth}{>{\ccol}p{\levelcol} >{\ccol}p{\babcolgood} *{3}{>{\ccol}p{\babcolavg}} >{\lcol}X}
        ...
        \rangerprogressionrow{2}  & Danger sense, favored terrain, wild speech \\
...
\cflt{Rgr}{2nd}{Wild Speech}{Su} A ranger has the ability to communicate with animals.
...
\cf{Wiz}{Rituals} Wizards can perform rituals to create unique magical effects (see \pcref{Rituals}).
