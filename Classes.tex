...
As a character increases in level, he gains additional benefits. Every odd level, including 1st level, he gains a feat (see \pcref{Feats}). Every even level, he increases one of his attributes by one. He cannot increase the same attribute twice in a row. This is shown on \trefnp{Character Advancement and Level-Dependent Bonuses}. If a character has multiple classes, these benefits are gained based on the total character level, not based on class level.
