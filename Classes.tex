...
\begin{dtable}
    ...
    \begin{tabularx}{\columnwidth}{>{\ccol}p{\levelcol} >{\ccol}p{\babcolgood} *{2}{>{\ccol}p{\savecol}} >{\lcol}X}
        ...
        8th & \plus6/\plus1 & \plus9 & \plus7 & Manifest awesome attack \\
...
\cf{Spl}{Manifest Awesome Attack (Su)} At 8th level, the spellwarped can spend a spellwarp point as a standard action to channel his innate magic into a powerful attack.
\subcf{Alteration -- } 
...
\subcf{Temporal -- Stop Time} As a standard action, the spellwarped can completely stop time for a single creature for 5 rounds. A successful Will save negates the effect. The affected creature can take no actions and cannot be moved or even affected in any way until the effect ends.
...
\cf{Spl}{Improved Manipulate Magic (Su)} At 13th level, the spellwarped can use his manipulate magic ability to affect any ally within \rngclose range of him.
