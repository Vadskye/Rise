...
\subcf{Vitality -- }
\subcf{War -- Warmaster's Power} The cleric continuously gains the benefits of the \spell{divine power} spell, with a caster level equal to his cleric level \add half his domain attribute. If the effect is dispelled or suppressed, he can resume it as a swift action.
...
19th & \plus19/\plus14/\plus9/\plus4 & \plus21 & \plus9 & \plus21& Invoke divinity \\
...
\cft{Pal}{Invoke Divinity}{Su} A paladin can invoke divine power to achieve incredible effects. She gains the smite divine invocation.

At 4th level, and every 3 levels thereafter, the paladin gains an additional divine invocation. Some divine invocations have minimum paladin levels, as indicated in the title of the ability. Some divine gifts are also restricted to paladins with specific devoted alignments. All divine invocations are supernatural abilities unless otherwise noted. The paladin's special attack bonus with divine invocations is equal to her paladin level \add her Charisma.

Divine invocations are marked with an asterisk are called smite invocations. Smite invocations function like the paladin's smite ability, except that they also have additional effects. Unless otherwise noted, these additional effects only occur if the smited creature does not share the paladin's devoted alignment.
...
\subcf{Bewildering Smite*} The paladin's smite challenges her foe's mind. If the paladin succeeds on a special attack vs. Will, the struck creature is \bewildered for 5 rounds.
\subcf{Resounding Smite*} The paladin's smite knocks her foe off its feet. The struck creature is knocked prone.
\subcf{Sickening Smite*} The paladin's smite strikes her foe where it is weak. If the paladin succeeds on a special attack vs. Will, the struck creature is \sickened for 5 rounds.
...
\subcf{4th -- Impeding Smite*} The paladin's smite traps her foe in place, unable to escape her wrath. The struck creature's speed is reduced to 5 feet for 1 round.
\subcf{4th -- Penetrating Smite*} The paladin's smite punches through her enemies' defenses. The attack reduces the foe's damage reduction by an amount equal to the paladin's level for 1 round, regardless of the type of damage reduction.
...
\subcf{10th -- Dazing Smite*} The paladin's smite shatters her foe's ability to think. If the paladin succeeds on a special attack vs. Fortitude, the struck creature is \dazed for 1 round.
\subcf{10th -- Coercing Smite*} The paladin's smite compels her foe to briefly join her cause. If she succeeds at an attack vs. Will, the struck creature must obey a \spell{suggestion}, as the spell, of the paladin's choice. The effect lasts for one round.
\subcf{13th -- Dispelling Smite*} The paladin's smite strips away her foe's magical protections. The struck creature is subject to a targeted \spell{dispel magic} with a dispel bonus equal to the paladin's level \add her Charisma.
...
\subcf{7th -- Confusion} As a standard action, the paladin can confuse a creature within \rngmed range, as the \spell{confusion} spell.
...
\subcf{13th -- Mass Confusion} As a standard action, the paladin can confuse many creatures, as the \spell{mass confusion} spell. The paladin must have the confusion divine invocation to select this invocation.
...
\subcf{4th -- Blinding Smite*} The paladin's smite manifests as a bright light. If the paladin succeeds on a special attack vs. Will, the struck creature is \blinded for 1 round. Creatures vulnerable to light (such as vampires) take extra damage equal to twice her paladin level.
...
\cflt{Pal}{2nd}{Discernment}{Su} A paladin can discern truths about creatures she sees as a swift action. When she uses this ability, she learns which creatures within a \arealarge cone have her devoted alignment. The paladin does not learn anything else about their alignments.
...
\cfl{Pal}{5th}{Discern Foe} When the paladin uses her discernment ability, she also learns which creatures within the cone have the alignment opposed to her devoted alignment.
