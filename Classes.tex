...
\subcf{Mental} The spellwarped can manipulate the minds of other creatures and protect his own mind from intrusion. His good save is Will, his key attribute is Charisma, and he treats Sense Motive, Bluff, and Persuasion as class skills. 
...
\subcf{Mental} The spellwarped gains a \plus1 competence bonus to saving throws against mind-affecting spells and effects. This bonus increases by 1 at 5th level and every 5 levels thereafter.
...
\cf{Spl}{Spellwarped Surge (Su)} At 2nd level, the spellwarped can tap into the magical power coursing through his body as a swift action. He can use this ability a number of times per day equal to 1 \add his key attribute, to a maximum of his class level. The effects last for a number of rounds equal to 5 \add his Constitution.
...
\subcf{Mental} The spellwarped gains a \plus2 competence bonus to a mental attribute of his choice. This bonus increases by 1 at 8th level and every 6 spellwarped levels thereafter.
\subcf{Temporal} The spellwarped gains a \plus2 competence bonus to his dodge modifier and a \plus10 foot competence bonus to his movement speed. At 8th level, and every 6 levels thereafter, the dodge bonus increases by 1 and the speed bonus increases by 10 feet.

\cf{Spl}{Spellwarped Appearance (Su)} A spellwarped always shows signs of the magic coursing through his body: strangely or inconsistently colored hair, natural skin markings which often resemble runes, and so on. Anyone observing the spellwarped can make a Perception or Spellcraft check with a DC equal to 20 \sub the spellwarped's class level to recognize that the character is a spellwarped.

\cf{Spl}{Attuned Senses (Su)} At 5nd level, the spellwarped learns to recognize the telltale signs of his chosen magic. He must concentrate as a standard action to use this ability, and he may do so any number of times per day.
\subcf{Alteration} The spellwarped can discern the true form of a creature he sees, ignoring any effects which magically alter its shape. This does not see through mundane disguises.
\subcf{Mental} The spellwarped can detect thoughts, as the \spell{detect thoughts} spell. The saving throw DC is equal to 10 \add his spellwarped level \add his Charisma. If a creature makes its saving throw against this effect, the spellwarped cannot read its thoughts for 24 hours. 
\subcf{Temporal} The spellwarped can accelerate his mind to immediately search everything within a 10 foot radius of him.

\cf{Spl}{Spellwarped Retribution (Su)} At 2nd level, the spellwarped learns to channel his magical power to punish his attackers. This can be used an an immediate action after the spellwarped takes damage. The target must be within \rngclose range. %Uses/day

\subcf{Alteration} The attacker must make a Fortitude save or shrink in size, as \spell{reduce person}, for 5 rounds. This is a size-affecting effect.

\subcf{Mental} The attacker is bewildered for 5 rounds. This is a mind-affecting effect.

\subcf{Temporal} The attacker must make a Will save or be slowed for 5 rounds.
...
\subcf{Mental} The spellwarped becomes immune to hostile mind-affecting effects.

\subcf{Temporal} The spellwarped gains an additional attack per round at his full base attack bonus when making a full attack.
