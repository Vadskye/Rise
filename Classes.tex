...
See the \spell{ironwood} ritual description.) Druids are proficient with shields (except tower shields) but must use only wooden ones.
...
\cflt{Drd}{2nd}{Natural Casting}{Ex}
...
\cflt{Drd}{7th}{Wild Abundance}{Su}
