...
\subcf{12th -- Chaotic Redirection} As an immediate action, when the paladin or any of her allies within \rngmed range is struck by a physical attack, the paladin can redirect the attack to a random foe within \rngmed range. The attack is made against the foe instead of against the ally, using its original attack bonus, and has its normal effects if it hits.
