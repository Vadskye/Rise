...
\subcf{Fearless Rage} The barbarian becomes immune to fear and harmful morale effects. All allies who can see or hear him gain a \plus4 circumstance bonus to saving throws against fear and harmful morale effects.
...
\subcf{Shrink} The druid shrinks by a size category, halving her height, length, and width, and dividing her weight by 8. This gives her a \minus10 foot penalty to her speed, a \plus1 inherent bonus to attack rolls and AC, and a \minus4 penalty to maneuvers and Maneuver Class. This is a size-affecting effect.
...
\subcf{5th -- Grow} The druid grows by a size category, doubling her height, length, and width, and multiplying her weight by 8. This gives her a \plus10 foot bonus to her speed, a \minus1 penalty to attack rolls and AC, and a \plus4 inherent bonus to maneuvers and Maneuver Class. This is a size-affecting effect.
...
%\subcf{Aerial Combat} The druid gains a \plus2 circumstance bonus to attack rolls while either she or her target is airborne.
%\subcf{Aquatic Combat} The druid gains a \plus2 circumstance bonus to attack rolls while both she and her target are touching naturally occuring water (including rain, but not fog or ice). 
%\subcf{Earthen Combat} The druid gains a \plus2 circumstance bonus to attack rolls with melee attacks while both she and her target are touching natural earth or stone.
%\subcf{Fiery Combat} The druid gains a \plus2 circumstance bonus to attack rolls while she or her target is ignited.
...
\cf{Pal}{Smite (Su)} As part of an attack action, a paladin may attempt to smite evil with one normal melee attack. She adds her Charisma (if positive) as a circumstance bonus to attack. If she hits, the paladin gains a circumstance bonus to damage on the attack equal to her paladin level. A paladin can smite evil a number of times per day equal to half the paladin's class level \add the paladin's Charisma, but may only do so once per round.
...
The extra damage increases by 1d6 at 3rd level and every two levels thereafter. It is considered a circumstance bonus to damage. Unlike most damage bonuses, this extra damage is not multiplied if the rogue scores a critical hit.
...
\subcf{Tricky Maneuver} When performing a maneuver against a creature she would be able to sneak attack, the rogue gains a circumstance bonus to attack equal to the number of sneak attack dice she would roll. The benefits of this trick apply even against creatures immune to critical hits.
