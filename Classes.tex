...
2nd  & \plus1                & \plus1 & \plus4  & \plus1 & Danger sense, skill talent \\
3rd  & \plus2                & \plus1 & \plus5  & \plus1 & Sneak attack \plus2d6, uncanny dodge \\
4th  & \plus3                & \plus2 & \plus6  & \plus2 & Evasion, combat trick \\
5th  & \plus3                & \plus2 & \plus7  & \plus2 & Sneak attack \plus3d6 \\
6th  & \plus4                & \plus3 & \plus8  & \plus3 & Improved uncanny dodge, skill talent \\
7th  & \plus5                & \plus3 & \plus9  & \plus3 & Sneak attack \plus4d6 \\
8th  & \plus6/\plus1         & \plus4 & \plus10 & \plus4 & Combat trick \\
9th  & \plus6/\plus1         & \plus4 & \plus11 & \plus4 & Sneak attack \plus5d6 \\
10th & \plus7/\plus2         & \plus5 & \plus12 & \plus5 & Greater uncanny dodge, skill talent \\
11th & \plus8/\plus3         & \plus5 & \plus13 & \plus5 & Sneak attack \plus6d6 \\
12th & \plus9/\plus4         & \plus6 & \plus14 & \plus6 & Combat trick, jack of all trades \\
13th & \plus9/\plus4         & \plus6 & \plus15 & \plus6 & Sneak attack \plus7d6 \\
14th & \plus10/\plus5        & \plus7 & \plus16 & \plus7 & Skill talent \\
15th & \plus11/\plus6/\plus1 & \plus7 & \plus17 & \plus7 & Sneak attack \plus8d6 \\
16th & \plus12/\plus7/\plus2 & \plus8 & \plus18 & \plus8 & Combat trick \\
17th & \plus12/\plus7/\plus2 & \plus8 & \plus19 & \plus8 & Sneak attack \plus9d6 \\
18th & \plus13/\plus8/\plus3 & \plus9 & \plus20 & \plus9 & Master of all trades, skill talent \\
19th & \plus14/\plus9/\plus4 & \plus9 & \plus21 & \plus9 & Sneak attack \plus10d6 \\
20th & \plus15/\plus10/\plus5& \plus10& \plus22 & \plus10& Ambush master, combat trick \\
\end{tabularx}
\end{dtable*}
...
\cf{Rog}{Sneak Attack} If a rogue can catch an opponent when he is unable to defend himself effectively from her attack, she can strike a vital spot for extra damage. She deals 1d6 points of extra damage if the target is flat-footed or is suffering overwhelm penalties from being surrounded by enemies (see \pcref{Overwhelm}). This extra damage is only dealt the first time that the rogue strikes that particular creature in the encounter. Additional sneak attacks against the same creature deal no additional damage.
...
\cf{Rog}{Skill Talent (Ex)} At 2nd level, the rogue's skills improve. She gains an additional skill point, which she can place in any skill, and a bonus skill feat for which she qualifies. At 6th level, and every 4 levels thereafter, she gains an additional skill point and skill feat.
...
\par Tricks marked with an asterisk are called ambush tricks. Ambush tricks only function on the first sneak attack the rogue makes a particular foe in an encounter. If an ambush trick allows a saving throw, the DC is 10 \add the rogue's level \add the rogue's Intelligence. The rogue chooses from the list of combat tricks below.
...
\subcf{Hamstring*} A foe damaged by this sneak attack has its land speed halved for 5 rounds. Despite the name, this can be used on foes who do not have hamstrings.

\subcf{Merciful Blows} The rogue suffers no penalty to attack rolls when attacking for nonlethal damage, and can deal her full sneak attack damage.
...
\subcf{Tricky Maneuver} When performing a maneuver against a foe she would be able to sneak attack, the rogue gains a circumstance bonus to attack equal to the number of sneak attack dice she would roll. The benefits of this trick apply even against foes immune to critical hits.

\cf{Rog}{Persistent Sneak Attack (Ex)} At 4th level, the rogue learns how to strike vital spots more consistently. If she makes additional sneak attacks against a creature that she has already dealt extra sneak attack damage to, she gains extra damage dice equal to half her number of sneak attack dice (rounded down). For example, a 5th level rogue would deal 3d6 points of extra damage on her first sneak attack against a creature, and 1d6 points of damage on every subsequent sneak attack against the same creature. 
...
\cf{Rog}{Advanced Skill Trick} At 11th level, the rogue adds the options below to the list of skill tricks she can choose from. All advanced skill tricks are (Ex) abilities unless otherwise noted.
...
\subcf{Hide in Plain Sight} The rogue can use the Stealth skill to hide even while being observed. She still needs cover or concealment to hide.
...
\cf{Rog}{Jack of All Trades (Ex)} At 12th level, a rogue treats all skills as class skills.

\cf{Rog}{Advanced Combat Trick} At 13th level, and every three levels thereafter, the rogue may adds the options below to the list of combat tricks she can choose from. All advanced combat tricks are (Ex) abilities unless otherwise noted.

\subcf{Ambush Strike*} If the rogue uses a Strike feat (see \pcref{Strike Feats}) on this ambush attack, she may add her Intelligence to the saving throw DC against the strike.

\subcf{Assassination} To use this ability, the rogue must spend a full round studying a foe that has not noticed her and who is not in combat. If she make a melee ambush attack on her next turn against that target, her attack deals maximum damage. If the target becomes aware of her presence before she attacks, this ability has no benefit.

\subcf{Crippling Ambush*} A foe damaged by this ambush attack takes 2 points of Strength damage.

\subcf{Defensive Roll} When the rogue would be reduced to 0 hit points by physical damage, she can attempt to roll the blow to reduce the damage. To use this ability, the rogue must attempt a Reflex saving throw (DC = damage dealt). If the save succeeds, she takes only half damage from the blow, and the damage is nonlethal; if it fails, she takes full damage. This ability cannot be used while flat-footed, and the evasion and improved evasion abilities do not help in any way. This ability can be used number of times per day equal to 1 \add half the rogue's Wisdom (minimum 1).

\subcf{Dispelling Ambush (Su)*} A foe damaged by this ambush attack is affected by a targeted \spell{dispel magic}. The caster level for this ability is equal to the rogue's level \add her Intelligence.
...
At 6th level, and every 4 levels thereafter, the sorcerer learns an additional spellsurge. Some spellsurges have minimum sorcerer levels, as indicated before the name of the ability. The list of spellsurges is given below.
