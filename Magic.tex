...
A wall-shaped spell extends in a single direction from its point of origin. All walls must be contiguous, so every part of the wall is adjacent to another part of the wall. Most walls always go straight. Some walls are shapeable, which means you can freely designate corners in the wall's path when creating it.
