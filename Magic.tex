...
To make a concentration check, roll d20 \add your magic level \add Constitution. If you have more than one magic level, use the sum of your magic levels.
...
\subsubsection{Casting Defensively}
You can make a Concentration check while casting a spell to concentrating on other things, like defending yourself. The DC is equal to 10 \add double the level of the spell you're casting. Success means you can defend yourself normally, but you take a \minus5 penalty to Concentration checks until you finish casting the spell. Failure means you are unable to maintain concentration on both things at once, and you must choose which one to concentrate on.
