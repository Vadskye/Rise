...
Some effects never stack with each other. Exceptions to the normal stacking rules are described below.
\begin{itemize*}
...
\subsection{Ritual Requirements} In order to learn and perform a ritual, you must be able to cast at least one spell of the same level as the ritual. In addition, you must be trained in one of the skills associated with the ritual.
