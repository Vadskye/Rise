...
\begin{itemize}
    ...
    \itemhead{Pay spell slot}: You must expend a spell slot of the spell's level or higher. If you do not have spells slots to spend, your attempt to cast the spell fails.
    \itemhead{Perform spell components}: Almost all spells have verbal and somatic components.
        \begin{itemize}
            ...
            \itemhead{Somatic components}\label{Somatic Components} involve using at least one hand to make gestures with magical significance.
        \end{itemize}
    \itemhead{Concentrate}: You must concentrate to cast spells. If you take damage or are otherwise distracted during a phase in which you attempt to cast a spell, the spell may fail. See \pcref{Concentration}, for details.
...
\parhead{Multiple Casting Classes} If you have levels in more than one spellcasting class, use the caster level appropriate to the class that you are casting the spell from.
...
\begin{figure}[h]
    \centering Caster level or casting attribute \meh{\add enhancement bonus} \add other bonuses and penalties
\end{figure}

\parhead{Casting Attribute} Your casting attribute depends on your class. Wizards use Intelligence, druids use Perception, and clerics and sorcerers use Willpower.
...
\begin{figure}[h]
    \centering Caster level or Willpower \meh{\add enhancement bonus} \add other bonuses and penalties
\end{figure}

\parhead{Reducing Spellpower} You can voluntarily reduce the power of the spells you cast by using a lower spellpower. However, you cannot use a spellpower lower than the minimum caster level required to cast the spell, which is equal to twice the spell's level.
...

{
    ...
    \begin{longtabu}{l X}
        ...
        Mental & The spell has no effect on creatures with an Intelligence of \minus8 or lower. \\
        Morale & \x \\
        Negative & \x \\
...
\section{Arcane, Divine, and Nature Spells}
Wizards and sorcerers cast arcane spells, which involve the direct manipulation of mystic energies. These manipulations require natural talent and strength of will (in the case of sorcerers) or long study (in the case of wizards).

Clerics can cast divine spells. Unlike arcane spells, divine spells do not directly manipulate magical energy. Instead, they call upon divine powers to intercede on the caster's behalf, creating magical effects.

Druid cast nature spells. Nature spells call upon the natural world as a whole, and the divine powers which inhabit it, to act on the druid's behalf.
