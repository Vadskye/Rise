...
\begin{dtable!*}
    \begin{tabularx}{\textwidth}{l c c c >{\lcol}X c c}
        \thead{Weapons} & \thead{Encumbrance} & \thead{Dmg} & \thead{Range Increment} & \thead{Type\footnotetemp{2}} & \thead{Cost} & \thead{Weight\footnotetemp{1}} \\
        Headed weapons &&&&&& \\
...
\begin{dtable!*}
    \begin{tabularx}{\textwidth}{l c c c c >{\lcol}X c c}
        \thead{Exotic Weapons} & \thead{Encumbrance} & \thead{Dmg} & \thead{Type\footnotetemp{2}} & \thead{Cost} & \thead{Weight\footnotetemp{1}} & \thead{Special} \\
        Armor &&&&&& \\
        Axes &&&&&& \\
