...
Blades, heavy &&&&&&& \\
\tind Falchion & Heavy & 1d10 & \mult3 & \x & Slashing & 50 gp & 8 lb. \\
\tind Greatsword & Heavy & 1d10 & 19-20/\mult2 & \x & Slashing & 25 gp & 8 lb. \\
...
\parhead{Sword, Bastard} A bastard sword can be used two-handed without special training. Though it is a heavy weapon, it can be used in one hand by a character with the appropriate training.
...
\parhead{Waraxe, Dwarven} A dwarven waraxe can be used two-handed without special training. Though it is a heavy weapon, it can be used in one hand by a character with the appropriate training. Dwarves do not treat dwarven waraxes as exotic weapons.
