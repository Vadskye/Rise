...
\parhead{Light} A light weapon can be used with more finesse than a medium weapon. The wielder can add either his Dexterity modifier or his Strength modifier to attack rolls with light weapons, whichever he prefers. In addition, light weapons are easier to use in the off-hand or while grappling.
\par Add half the wielder's Strength value (if any) to damage rolls for melee attacks with a light weapon. Using two hands to wield a light weapon gives no advantage on damage; the Strength bonus applies as though the weapon were held in one hand. Characters using the Power Attack feat gain half the normal bonus damage when wielding light weapons.
...
\parhead{Medium} A medium weapon can be used in either the primary hand or the off hand. Add the wielder's Strength value to damage rolls for melee attacks with a medium weapon if it's used in the primary hand, or 1/2 his or her Strength value if it's used in the off hand. If a medium weapon is wielded with two hands during melee combat, add 1-1/2 times the character's Strength value to damage rolls.

A character must have a Strength score of at least 13 to use a medium weapon in one hand. Otherwise, the character must use it in two hands.

\parhead{Heavy} Two hands are required to use a heavy weapon effectively. Apply 1-1/2 times the character's Strength value to damage rolls for attacks with such a weapon when it is wielded in two hands.

A character must have a Strength score of at least 13 to use a heavy weapon effectively. Otherwise, the character is treated as being nonproficient with the weapon.
...
Daggers, darts, javelins, throwing axes, light hammers, shuriken, and nets are thrown weapons. The wielder applies his or her Strength modifier to damage dealt by thrown weapons (except for splash weapons).
...
\parhead{Damage} The Damage columns give the damage dealt by the weapon on a successful hit. The column labeled ``Dmg (S)'' is for Small weapons. The column labeled ``Dmg (M)'' is for Medium weapons. If two damage ranges are given then the weapon is a double weapon. Use the second damage figure given for the double weapon's extra attack. \trefnp{Weapon Damage and Size} gives weapon damage values for weapons of those sizes.

\begin{dtable}
\lcaption{Weapon Damage and Size}
\begin{tabularx}{\columnwidth}{*{5}{l} >{\lcol}X}
\thead{Medium} & \thead{Tiny} & \thead{Large} & \thead{Huge} & \thead{Gargantuan} & \thead{Colossal} \\
1d2  & \x  & 1d3  & 1d4  & 1d8  & 2d6  \\
1d3  & 1   & 1d4  & 1d6  & 1d10 & 2d8  \\
1d4  & 1d2 & 1d6  & 1d8  & 2d6  & 2d10 \\
1d6  & 1d3 & 1d8  & 1d10 & 2d8  & 4d6  \\
1d8  & 1d4 & 1d10 & 2d6  & 2d10 & 4d8  \\
1d10 & 1d6 & 2d6  & 2d8  & 4d6  & 4d10 \\
\end{tabularx}
\end{dtable}
...
\subparhead{Exception} Bonus damage dice over and above a weapon's normal
damage dice are not multiplied when you score a critical hit.
...
\begin{dtable!*}
\lcaption{Weapons}
\begin{tabularx}{\textwidth}{l c c c c c >{\ccol}p{5em} c >{\lcol}X}
...
Armor weapons &&&&&&&& \\
\tind Shield, heavy & Medium & special & 1d3 & 1d4 & \mult2 & \x & special & Bludgeoning \\
\tind Shield, light & Light & special & 1d2 & 1d3 & \mult2 & \x & special & Bludgeoning \\
\tind Spiked armor & Light & special & 1d4 & 1d6 & \mult2 & \x & special & Piercing \\
\tind Spiked shield, heavy & Medium & special & 1d4 & 1d6 & \mult2 & \x & special & Piercing \\
\tind Spiked shield, light & Light & special & 1d3 & 1d4 & \mult2 & \x & special & Piercing \\

Axes &&&&&&&& \\
\tind Axe, throwing & Light & 8 gp & 1d4 & 1d6 & \mult2 & 10 ft. & 2 lb. & Slashing \\
\tind Battleaxe & Medium & 10 gp & 1d6 & 1d8 & \mult3 & \x & 6 lb. & Slashing \\
\tind Greataxe & Heavy & 20 gp & 1d8 & 1d10 & \mult3 & \x & 12 lb. & Slashing \\
\tind Handaxe & Light & 6 gp & 1d4 & 1d6 & \mult3 & \x & 3 lb. & Slashing \\

Blunt weapons &&&&&&& \\
\tind Club & Medium & \x & 1d4 & 1d6 & \mult2 & \x & 3 lb. & Bludgeoning \\
\tind Greatclub & Heavy & 5 gp & 1d8 & 1d10 & \mult2 & \x & 8 lb. & Bludgeoning \\
\tind Mace, heavy & Medium & 12 gp & 1d6 & 1d8 & \mult2 & \x & 8 lb. & Bludgeoning \\
\tind Mace, light & Light & 5 gp & 1d4 & 1d6 & \mult2 & \x & 4 lb. & Bludgeoning \\
\tind Morningstar & Medium & 8 gp & 1d6 & 1d8 & \mult2 & \x & 6 lb. & Bludgeoning and piercing \\
\tind Quarterstaff\fn{5} & Double & \x & 1d4/1d4 & 1d6/1d6 & \mult2 & \x & 4 lb. & Bludgeoning \\
\tind Sap & Light & 1 gp & 1d4\fn{3} & 1d6\fn{3} & \mult2 & \x & 2 lb. & Bludgeoning \\

Blades, heavy &&&&&&&& \\
\tind Falchion & Heavy & 75 gp & 1d6 & 1d10 & \mult3 & \x & 8 lb. & Slashing \\
\tind Greatsword & Heavy & 50 gp & 1d8 & 1d10 & 19-20/\mult2 & \x & 8 lb. & Slashing \\
\tind Longsword & Medium & 15 gp & 1d6 & 1d8 & 19-20/\mult2 & \x & 4 lb. & Slashing \\
\tind Scimitar & Medium & 15 gp & 1d6 & 1d8 & \mult3 & \x & 4 lb. & Slashing \\

Blades, light &&&&&&&& \\
\tind Dagger & Light & 2 gp & 1d3 & 1d4 & 19-20/\mult2 & 10 ft. & 1 lb. & Piercing or slashing \\
\tind Dagger, punching & Light & 2 gp & 1d3 & 1d4 & \mult3 & \x & 1 lb. & Piercing \\
\tind Rapier & Medium & 20 gp & 1d4 & 1d6 & \mult3 & \x & 2 lb. & Piercing \\
\tind Sword, short & Light & 10 gp & 1d4 & 1d6 & 19-20/\mult2 & \x & 2 lb. & Piercing or slashing \\

Bows &&&&&&&& \\
\tind Longbow & Ranged & 75 gp & 1d6 & 1d8 & \mult3 & 100 ft. & 3 lb. & Piercing \\
\tind Longbow, composite & Ranged & 100 gp & 1d6 & 1d8 & \mult3 & 100 ft. & 3 lb. & Piercing \\
\tind Shortbow & Ranged & 30 gp & 1d4 & 1d6 & \mult3 & 50 ft. & 2 lb. & Piercing \\
\tind Shortbow, composite & Ranged & 75 gp & 1d4 & 1d6 & \mult3 & 50 ft. & 2 lb. & Piercing \\
\tind Arrows (20) & \x & 1 gp & \x & \x & \x & \x & 3 lb. & \x \\

Crossbows &&&&&&&& \\
\tind Crossbow, heavy & Ranged & 50 gp & 1d8 & 1d10 & 19-20/\mult2 & 100 ft. & 8 lb. & Piercing \\
\tind Crossbow, light & Ranged & 35 gp & 1d6 & 1d8 & 19-20/\mult2 & 50 ft. & 4 lb. & Piercing \\
\tind Bolts, crossbow (10) & \x & 1 gp & \x & \x & \x & \x & 1 lb. & \x \\

Flexible weapons &&&&&&&& \\
\tind Flail  & Medium & 8 gp & 1d6 & 1d8 & \mult2 & \x & 5 lb. & Bludgeoning \\
\tind Flail, heavy & Heavy & 15 gp & 1d8 & 1d10 & \mult2 & \x & 10 lb. & Bludgeoning \\
...
\thead{Weapons} & \thead{Encumbrance} & \thead{Cost} & \thead{Dmg (S)} & \thead{Dmg (M)} & \thead{Critical} & \thead{Range Increment} & \thead{Weight\footnotetemp{1}} & \thead{Type\footnotetemp{2}} \\
Headed weapons &&&&&&&& \\
\tind Hammer, light & Light & 1 gp & 1d3 & 1d4 & \mult2 & 20 ft. & 2 lb. & Bludgeoning \\
\tind Pick, heavy & Medium & 8 gp & 1d4 & 1d6 & \mult4 & \x & 6 lb. & Piercing \\
\tind Pick, light & Light & 4 gp & 1d3 & 1d4 & \mult4 & \x & 3 lb. & Piercing \\
\tind Scythe & Heavy & 18 gp & 1d6 & 1d8 & 19-20/\mult3 & \x & 10 lb. & Piercing or slashing \\
\tind Sickle & Light & 6 gp & 1d4 & 1d6 & \mult3 & \x & 2 lb. & Slashing \\
\tind Warhammer & Medium & 12 gp & 1d6 & 1d8 & \mult3 & \x & 5 lb. & Bludgeoning \\

Monk weapons &&&&&&&& \\
\tind Kama & Light & 2 gp & 1d4 & 1d6 & \mult2 & \x & 2 lb. & Slashing \\
\tind Nunchaku & Light & 2 gp & 1d4 & 1d6 & \mult2 & \x & 2 lb. & Bludgeoning \\
\tind Quarterstaff\fn{5} & Double & \x & 1d4/1d4 & 1d6/1d6 & \mult2 & \x & 4 lb. & Bludgeoning \\
\tind Sai & Light & 1 gp & 1d3 & 1d4 & \mult2 & \x & 1 lb. & Piercing \\
\tind Shuriken (5) & Ranged & 1 gp & 1 & 1d2 & \mult2 & 10 ft. & 1/2 lb. & Piercing \\
\tind Siangham & Light & 3 gp & 1d4 & 1d6 & \mult2 & \x & 1 lb. & Piercing \\

Polearms &&&&&&&& \\
\tind Glaive\fn{4} & Heavy & 8 gp & 1d8 & 1d10 & \mult3 & \x & 10 lb. & Slashing \\
\tind Guisarme\fn{4} & Heavy & 9 gp & 1d6 & 1d8 & \mult3 & \x & 12 lb. & Slashing \\
\tind Halberd & Heavy & 10 gp & 1d8 & 1d10 & \mult3 & \x & 12 lb. & Piercing or slashing \\
\tind Ranseur\fn{4} & Heavy & 10 gp & 1d6 & 1d8 & \mult3 & \x & 12 lb. & Piercing \\

Simple weapons &&&&&&&& \\
\tind Club & Medium & \x & 1d4 & 1d6 & \mult2 & 10 ft. & 3 lb. & Bludgeoning \\
\tind Crossbow, light & Ranged & 35 gp & 1d6 & 1d8 & 19-20/\mult2 & 80 ft. & 4 lb. & Piercing \\
\tind Dagger & Light & 2 gp & 1d3 & 1d4 & 19-20/\mult2 & 10 ft. & 1 lb. & Piercing or slashing \\
\tind Quarterstaff\fn{5} & Double & \x & 1d4/1d4 & 1d6/1d6 & \mult2 & \x & 4 lb. & Bludgeoning \\
\tind Unarmed strike & Light & \x & 1d2\fn{3} & 1d3\fn{3} & \mult2 & \x & \x & Bludgeoning \\

Spears &&&&&&&& \\
\tind Javelin & Ranged & 1 gp & 1d4 & 1d6 & \mult2 & 30 ft. & 2 lb. & Piercing \\
\tind Lance\fn{4} & Heavy & 10 gp & 1d6 & 1d8 & \mult3 & \x & 10 lb. & Piercing \\
\tind Longspear\fn{4} & Heavy & 5 gp & 1d6 & 1d8 & \mult3 & \x & 9 lb. & Piercing \\
\tind Shortspear & Medium & 1 gp & 1d4 & 1d6 & \mult2 & 20 ft. & 3 lb. & Piercing \\
\tind Spear & Heavy & 2 gp & 1d6 & 1d8 & \mult3 & 20 ft. & 6 lb. & Piercing \\
\tind Trident & Medium & 15 gp & 1d6 & 1d8 & \mult2 & 10 ft. & 4 lb. & Piercing \\

Thrown weapons &&&&&&&& \\
\tind Axe, throwing & Light & 8 gp & 1d4 & 1d6 & \mult2 & 10 ft. & 2 lb. & Slashing \\
\tind Dagger & Light & 2 gp & 1d3 & 1d4 & 19-20/\mult2 & 10 ft. & 1 lb. & Piercing or slashing \\
\tind Dart (5) & Ranged & 1 gp & 1d3 & 1d4 & \mult2 & 20 ft. & 1/2 lb. & Piercing \\
\tind Hammer, light & Light & 1 gp & 1d3 & 1d4 & \mult2 & 20 ft. & 2 lb. & Bludgeoning \\
\tind Javelin & Ranged & 1 gp & 1d4 & 1d6 & \mult2 & 30 ft. & 2 lb. & Piercing \\
\tind Shuriken (5) & Ranged & 1 gp & 1 & 1d2 & \mult2 & 10 ft. & 1/2 lb. & Piercing \\
\tind Sling & Ranged & 2 gp & 1d3 & 1d4 & \mult2 & 50 ft. & 0 lb. & Bludgeoning \\
\tind Bullets, sling (10) & \x & 1 sp & \x & \x & \x & \x & 5 lb. & \x \\

Weaponlike Spells\fn{6} &&&&&&&&\\

Unarmed weapons &&&&&&&&\\
\tind Claw Sheath & \x & 50 gp & \x & \x & \x & \x & 3 lb. & \x \\
\tind Gauntlet & Light & 2 gp & 1d2 & 1d3 & \mult2 & \x & 1 lb. & Bludgeoning \\
\tind Gauntlet, spiked & Light & 5 gp & 1d3 & 1d4 & \mult2 & \x & 1 lb. & Piercing \\
\tind Unarmed strike & Light & \x & 1d2\fn{3} & 1d3\fn{3} & \mult2 & \x & \x & Bludgeoning \\
\end{tabularx}
\end{dtable!*}
...
Armor &&&&&&&& \\
Axes &&&&&&&& \\
\tind Axe, orc double\fn{5} & Double & 60 gp & 1d6/1d6 & 1d8/1d8 & \mult3 & \x & 15 lb. & Slashing \\
\tind Urgrosh, dwarven\fn{5} & Double & 50 gp & 1d6/1d4 & 1d8/1d6 & \mult3 & \x & 12 lb. & Slashing or piercing \\
\tind Waraxe, dwarven & Medium & 30 gp & 1d8 & 1d10 & \mult3 & \x & 8 lb. & Slashing \\
Blunt weapons &&&&&&&& \\
Blades, heavy &&&&&&&& \\
\tind Sword, bastard & Medium & 35 gp & 1d8 & 1d10 & 19-20/\mult2 & \x & 6 lb. & Slashing \\
\tind Sword, two-bladed\fn{5} & Double & 100 gp & 1d6/1d6 & 1d8/1d8 & 19-20/\mult2 & \x & 10 lb. & Slashing \\
Blades, light &&&&&&&& \\
\tind Kukri & Light & 8 gp & 1d3 & 1d4 & 18-20/\mult2 & \x & 2 lb. & Slashing \\
Bows &&&&&&&& \\
Crossbows &&&&&&&& \\
\tind Crossbow, hand & Ranged & 100 gp & 1d3 & 1d4 & 19-20/\mult2 & 30 ft. & 2 lb. & Piercing \\
\tind Crossbow, repeating heavy & Ranged & 400 gp & 1d8 & 1d10 & 19-20/\mult2 & 120 ft. & 12 lb. & Piercing \\
\tind Crossbow, repeating light & Ranged & 250 gp & 1d6 & 1d8 & 19-20/\mult2 & 80 ft. & 6 lb. & Piercing \\
\tind Bolts, hand (10) & \x & 1 gp & \x & \x & \x & \x & 1 lb. & \x \\
\tind Bolts, repeating (5) & \x & 1 gp & \x & \x & \x & 1 lb. & \x &  \\
Flexible weapons &&&&&&&& \\
\tind Chain, spiked\fn{4} & Heavy & 25 gp & 1d6 & 2d4 & \mult2 & \x & 10 lb. & Piercing \\
\tind Flail, dire\fn{5} & Double & 90 gp & 1d6/1d6 & 1d8/1d8 & \mult2 & \x & 10 lb. & Bludgeoning \\
\tind Whip\fn{4} & Light & 1 gp & 1d2\fn{3} & 1d3\fn{3} & \mult2 & \x & 2 lb. & Slashing \\
Headed weapons &&&&&&&& \\
\tind Hammer, gnome hooked\fn{5} & Double & 20 gp & 1d6/1d4 & 1d8/1d6 & \mult2/\mult2 & \x & 6 lb. & Bludgeoning and piercing \\
Monk weapons &&&&&&&& \\
Polearms &&&&&&&& \\
Simple weapons &&&&&&&& \\
Spear &&&&&&&& \\
Thrown weapons &&&&&&&& \\
\tind Bolas & Ranged & 5 gp & 1d3\fn{3} & 1d4\fn{3} & \mult2 & 10 ft. & 2 lb. & Bludgeoning \\
\tind Net & Ranged & 20 gp & \x & \x & 10 ft. & 6 lb. & \x &  \\
Unarmed weapons &&&&&&&&\\
\end{tabularx}
...
\parhead{Longbow, Composite} You need at least two hands to use a bow, regardless of its size. You can use a composite longbow while mounted. All composite bows are made with a particular strength rating (that is, each requires a minimum Strength modifier to use with proficiency). If your Strength bonus is less than the strength rating of the composite bow, you can't effectively use it, so you take a \minus2 penalty on attacks with it. The default composite longbow requires a Strength modifier of \plus0 or higher to use with proficiency. A composite longbow can be made with a high strength rating to take advantage of an above-average Strength score; this feature allows you to add your Strength bonus to damage, up to the maximum bonus indicated for the bow. Each point of Strength bonus granted by the bow adds 100 gp to its cost.
...
\parhead{Rapier} You can use the Weapon Finesse feat to apply your Dexterity modifier instead of your Strength modifier to attack rolls with a rapier sized for you, even though it isn't a light weapon for you. You can't wield a rapier in two hands in order to apply 1\minus1/2 times your Strength bonus to damage.
...
\parhead{Shortbow, Composite} You need at least two hands to use a bow, regardless of its size. You can use a composite shortbow while mounted. All composite bows are made with a particular strength rating (that is, each requires a minimum Strength modifier to use with proficiency). If your Strength bonus is lower than the strength rating of the composite bow, you can't effectively use it, so you take a \minus2 penalty on attacks with it. The default composite shortbow requires a Strength modifier of \plus0 or higher to use with proficiency. A composite shortbow can be made with a high strength rating to take advantage of an above-average Strength score; this feature allows you to add your Strength bonus to damage, up to the maximum bonus indicated for the bow. Each point of Strength bonus granted by the bow adds 75 gp to its cost.
...
\parhead{Sling} Your Strength modifier applies to damage rolls when you use a sling, just as it does for thrown weapons. You can fire, but not load, a sling with one hand. Loading a sling is a move action that requires two hands and provokes attacks of opportunity.
...
\par An unarmed strike is always considered a light weapon. Therefore, you can use the Weapon Finesse feat to apply your Dexterity modifier instead of your Strength modifier to attack rolls with an unarmed strike.
...
\par Armor and shields can take damage from some types of attacks.
\par Here is the format for armor entries (given as column headings on \trefnp{Armor and Shields}, below).

\parhead{Encumbrance} All armor restricts a character's movement to some degree. The heavier the armor, the more restrictive it is. Shields are divided into light shields (including bucklers), heavy shields, or tower shields, while armor can be light, medium, or heavy.
...
\parhead{Armor/Shield Bonus} Each armor grants an armor bonus to AC,
...
armor bonus.
\par Similarly, the shield bonus from a shield doesn't stack with other effects that grant a shield bonus.

\parhead{Dexterity Bonus} This indicates the multiplier that your character applies to his or her Dexterity bonus. Medium and heavy armor limits mobility and agility, halving the character's Dexterity modifier and Dexterity value. This halving is applied in addition to the armor's armor check penalty (if any). A Dexterity penalty is not halved.

Even if a character's Dexterity bonus to AC drops to 0 because of armor, this situation does not count as losing a Dexterity bonus to AC or becoming flat-footed.

Your character's encumbrance (the amount of gear he or she carries) may also affect your character's Dexterity bonus.
\subparhead{Shields} Most shields do not affect a character's Dexterity modifier. However, a tower shield halves a character's Dexterity bonus. This is not cumulative with the halving from wearing medium or heavy armor.
...
\subparhead{Sleeping in Armor} A character who sleeps overnight in medium or heavy armor is automatically fatigued the next day. He or she takes a \minus2 penalty on Strength and Dexterity and can't charge or run. Sleeping in light armor does not cause fatigue.
...
\begin{tabularx}{\textwidth}{>{\lcol}X c >{\ccol}p{6em} >{\ccol}p{5em} >{\ccol}p{6em} >{\ccol}p{7em} c c c}
  &  &  &  &  &  & \multicolumn{2}{c}{\x\x Speed \x\x} &  \\
\thead{Armor} & \thead{Cost} & \thead{Armor/Shield Bonus} & \thead{Dex Modifier} & \thead{Armor Check Penalty} & \thead{Arcane Spell Failure Chance} & \thead{(30 ft.)} & \thead{(20 ft.)} & \thead{Weight\fn{1}} \\
Light armor &  &  &  &  &  &  &  &  \\
\tind Padded & 5 gp          & \plus1 & 1\mult & 0       & 5\%  & 30 ft. & 20 ft. & 10 lb. \\
\tind Leather & 10 gp        & \plus2 & 1\mult & \minus1       & 10\% & 30 ft. & 20 ft. & 15 lb. \\
\tind Studded leather & 25 gp& \plus3 & 1\mult & \minus2 & 15\% & 30 ft. & 20 ft. & 20 lb. \\
Medium armor &  &  &  &  &  &  &  &  \\
\tind Chain shirt & 100 gp   & \plus4 & 1/2\mult & \minus2 & 20\% & 30 ft. & 20 ft. & 25 lb. \\
\tind Hide & 15 gp           & \plus4 & 1/2\mult & \minus4 & 20\% & 30 ft. & 20 ft. & 25 lb. \\
\tind Scale mail & 50 gp     & \plus5 & 1/2\mult & \minus4 & 25\% & 30 ft. & 20 ft. & 30 lb. \\
\tind Chainmail & 100 gp     & \plus6 & 1/2\mult & \minus5 & 30\% & 30 ft. & 20 ft. & 40 lb. \\
\tind Breastplate & 200 gp   & \plus6 & 1/2\mult & \minus4 & 25\% & 30 ft. & 20 ft. & 30 lb. \\
Heavy armor &  &  &  &  &  &  &  &  \\
\tind Splint mail & 200 gp   & \plus7 & 1/2\mult & \minus7 & 40\% & 20 ft. & 15 ft. & 45 lb. \\
\tind Half-plate & 500 gp    & \plus8 & 1/2\mult & \minus8 & 40\% & 20 ft. & 15 ft. & 50 lb. \\
\tind Full plate & 1,000 gp  & \plus8 & 1/2\mult & \minus6 & 35\% & 20 ft. & 15 ft. & 50 lb. \\
Shields &  &  &  &  &  &  &  &  \\
\tind Buckler & 15 gp             & \plus1 & \x & \minus1 & 5\% & \x & \x & 5 lb. \\
\tind Shield, light wooden & 3 gp & \plus1 & \x & \minus2 & 5\% & \x & \x & 5 lb. \\
\tind Shield, light steel & 9 gp  & \plus1 & \x & \minus2 & 5\% & \x & \x & 6 lb. \\
\tind Shield, heavy wooden & 7 gp & \plus2 & \x & \minus3 & 15\% & \x & \x & 10 lb. \\
\tind Shield, heavy steel & 20 gp & \plus2 & \x & \minus3 & 15\% & \x & \x & 15 lb. \\
\tind Shield, tower & 30 gp       & \plus4\fn{2} & 1/2\mult & \minus10 & 50\% & \x & \x & 45 lb. \\
Extras &  &  &  &  &  &  &  &  \\
\tind Armor spikes & \plus50 gp & \minus1\fn{3} & \x & \minus2 & \x & \x & \x & \plus10 lb. \\
\tind Gauntlet, locked & 8 gp & \x & \x & Special & \fn{4} & \x & \x & \plus5 lb. \\
\tind Shield spikes & \plus10 gp & \x & \x & \minus1 & \x & \x & \x & \plus5 lb. \\
\end{tabularx}
