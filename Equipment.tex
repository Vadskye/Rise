...
\parhead{Projectile} This weapon fires projectiles at range. Projectile weapons must be reloaded. The time required to reload a projectile weapon is given in the weapon description.
...
\par You can fire a crossbow from a prone position without penalty. You apply a Strength penalty to damage with a crossbow, but not a Strength bonus.
