...
\lcaption{Weapons}
    ...
    \thead{Weapons} & \thead{Encumbrance} & \thead{Dmg} & \thead{Damage Type\footnotetemp{2}} & \thead{Cost} & \thead{Weight\footnotetemp{1}} & \thead{Special} \\
...
\begin{dtable!*}
    \begin{tabularx}{\textwidth}{p{12em} c c >{\ccol}p{10em} c c >{\ccol}X}
        \thead{Exotic Weapons} & \thead{Encumbrance} & \thead{Dmg} & \thead{Damage Type\footnotetemp{2}} & \thead{Cost} & \thead{Weight\footnotetemp{1}} & \thead{Special} \\
        Armor &&&&&& \\
        Axes &&&&&& \\
