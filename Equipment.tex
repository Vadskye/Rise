...
\parhead{Dexterity Bonus} This indicates the multiplier that your character applies to his or her Dexterity bonus. Medium and heavy armor limits mobility and agility, halving the character's Dexterity. This halving is applied in addition to the armor's armor check penalty (if any). A Dexterity penalty is not halved.
