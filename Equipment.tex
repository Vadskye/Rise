...
\tind Sword, short & Light & 1d6 & 19-20/\mult2 & Piercing or slashing & 10 gp & 2 lb. & \x \\
...
Monk weapons &&&&&&& \\
\tind Kama & Light & 1d6 & \mult2 & Slashing & 2 gp & 2 lb. & Tripping \\
\tind Nunchaku & Light & 1d6 & \mult2 & Bludgeoning & 2 gp & 2 lb. & Disarming \\
\tind Quarterstaff & Heavy & 1d6/1d6 & \mult2 & Bludgeoning & \x & 4 lb. & Double \\
\tind Sai & Light & 1d4 & \mult2 & Piercing & 1 gp & 1 lb. & Disarming \\
\tind Shuriken (5) & Light (Ranged) & 1d4 & \mult2 & Piercing & 1 gp & 1/2 lb. & Thrown (10 ft.) \\
\tind Siangham & Light & 1d6 & \mult2 & Piercing & 3 gp & 1 lb. & Parrying \\

Polearms &&&&&&& \\
\tind Glaive & Heavy & 1d10 & \mult3 & Slashing & 8 gp & 10 lb. & Reach \\
\tind Guisarme & Heavy & 1d10 & \mult2 & Slashing & 9 gp & 12 lb. & Reach, Tripping \\
\tind Halberd & Heavy & 1d10 & \mult2 & Piercing or slashing & 10 gp & 12 lb. & Reach, Tripping \\
\tind Quarterstaff & Heavy & 1d6/1d6 & \mult2 & Bludgeoning & \x & 4 lb. & Double \\
\tind Ranseur & Heavy & 1d10 & \mult2 & Piercing & 10 gp & 12 lb. & Disarming \\

Simple weapons &&&&&&& \\
\tind Club & Medium & 1d6 & \mult2 & Bludgeoning & \x & 3 lb. & 10 ft. \\
\tind Crossbow, light & Medium (Ranged) & 1d8 & 19-20/\mult2 & Piercing & 35 gp & 4 lb. & Projectile (100 ft.) \\
\tind Dagger & Light & 1d4 & 19-20/\mult2 & Piercing or slashing & 2 gp & 1 lb. & Thrown (10 ft.) \\
\tind Quarterstaff & Heavy & 1d6/1d6 & \mult2 & Bludgeoning & \x & 4 lb. & Double \\
\tind Unarmed strike & Light & 1d3 & \mult2 & Bludgeoning & \x & \x & Nonlethal \\

Spears &&&&&&& \\
\tind Javelin & Medium (Ranged) & 1d6 & \mult2 & Piercing & 1 gp & 2 lb. & Thrown (30 ft.) \\
\tind Lance & Heavy & 1d8 & \mult3 & Piercing & 10 gp & 10 lb. & Charging, Reach \\
\tind Longspear & Heavy & 1d8 & \mult3 & Piercing & 5 gp & 9 lb. & Bracing, Reach \\
\tind Shortspear & Light & 1d6 & \mult2 & Piercing & 1 gp & 3 lb. & Thrown (20 ft.) \\
\tind Spear & Medium & 1d8 & \mult2 & Piercing & 2 gp & 6 lb. & Bracing, Thrown (20 ft.) \\

Thrown weapons &&&&&&& \\
\tind Axe, throwing & Light & 1d6 & \mult2 & Slashing & 8 gp & 2 lb. & Thrown (10 ft.) \\
\tind Dagger & Light & 1d4 & 19-20/\mult2 & Piercing or slashing & 2 gp & 1 lb. & Thrown (10 ft.) \\
\tind Dart (5) & Light (Ranged) & 1d4 & \mult2 & Piercing & 1 gp & 1/2 lb. & Thrown (20 ft.) \\
\tind Hammer, light & Light & 1d4 & \mult2 & Bludgeoning & 1 gp & 2 lb. & Thrown (20 ft.) \\
\tind Javelin & Medium (Ranged) & 1d6 & \mult2 & Piercing & 1 gp & 2 lb. & Thrown (30 ft.) \\
\tind Shuriken (5) & Light (Ranged) & 1d2 & \mult2 & Piercing & 1 gp & 1/2 lb. & Thrown (10 ft.) \\
\tind Sling & Light (Ranged) & 1d4 & \mult2 & Bludgeoning & 2 gp & 0 lb. & Thrown (50 ft.) \\
\tind Bullets, sling (20) & \x & \x & \x & \x & 1 gp & 5 lb. & Ammunition \\

Unarmed weapons &&&&&&&\\
\tind Claw Sheath & \x & \x & \x & \x & 50 gp & 3 lb. & Special \\
\tind Gauntlet & Light & 1d3 & \mult2 & Bludgeoning & 2 gp & 1 lb. & Unarmed \\
\tind Gauntlet, spiked & Light & 1d4 & \mult2 & Piercing & 5 gp & 1 lb. & Unarmed \\
\tind Unarmed strike & Light & 1d3 & \mult2 & Bludgeoning & \x & \x & Nonlethal, Unarmed \\
\end{tabularx}
\end{dtable!*}

\begin{dtable!*}
\begin{tabularx}{\textwidth}{l c c c c >{\lcol}X c c}
    \thead{Exotic Weapons} & \thead{Encumbrance} & \thead{Dmg} & \thead{Critical} & \thead{Type\footnotetemp{2}} & \thead{Cost} & \thead{Weight\footnotetemp{1}} & \thead{Special} \\
Armor &&&&&&& \\
Axes &&&&&&& \\
\tind Axe, orc double\fn{5} & Heavy & 1d8/1d8 & \mult3/\mult3 & Slashing & 60 gp & 15 lb. & Double \\
\tind Urgrosh, dwarven\fn{5} & Heavy & 1d8/1d6 & \mult3/\mult3 & Slashing or piercing & 50 gp & 12 lb. & Double \\
\tind Waraxe, dwarven & Heavy & 1d10 & \mult3 & Slashing & 75 gp & 8 lb. & \x \\
Blunt weapons &&&&&&& \\
Blades, heavy &&&&&&& \\
\tind Sword, bastard & Heavy & 1d10 & 19-20/\mult2 & Slashing & 75 gp & 6 lb. & \x \\
\tind Sword, two-bladed\fn{5} & Heavy & 1d8/1d8 & 19-20/\mult2 & Slashing & 100 gp & 10 lb. & Double \\
Blades, light &&&&&&& \\
\tind Kukri & Light & 1d4 & 18-20/\mult2 & Slashing & 8 gp & 2 lb. & \x \\
Bows &&&&&&& \\
Crossbows &&&&&&& \\
\tind Crossbow, hand & Light (Ranged) & 1d4 & 19-20/\mult2 & Piercing & 100 gp & 2 lb. & Projectile (30 ft.) \\
\tind Crossbow, repeating heavy & Heavy (Ranged) & 1d10 & 19-20/\mult2 & Piercing & 400 gp & 12 lb. & Projectile (100 ft.) \\
\tind Crossbow, repeating light & Medium (Ranged) & 1d8 & 19-20/\mult2 & Piercing & 250 gp & 6 lb. & Projectile (50 ft.) \\
\tind Bolts, hand (10) & \x & \x & \x & \x & 1 gp & 1 lb. & Ammunition \\
\tind Bolts, repeating (5) & \x & \x & \x & \x & 1 gp & 1 lb. & Ammunition \\
Flexible weapons &&&&&&& \\
\tind Chain, spiked\fn{4} & Heavy & 1d8 & \mult2 & Piercing & 25 gp & 10 lb. & Reach \\
\tind Flail, dire\fn{5} & Heavy & 1d8/1d8 & \mult2/\mult2 & Bludgeoning & 90 gp & 10 lb. & Disarming, Double, Tripping \\
\tind Whip & Light & 1d3\fn{3} & \mult2 & Slashing & 1 gp & 2 lb. & Nonlethal, Special \\
Headed weapons &&&&&&& \\
\tind Hammer, gnome hooked & Heavy & 1d8/1d6 & \mult2/\mult2 & Bludgeoning and piercing & 20 gp & 6 lb. & Double \\
Monk weapons &&&&&&& \\
Polearms &&&&&&& \\
Simple weapons &&&&&&& \\
Spear &&&&&&& \\
Thrown weapons &&&&&&& \\
\tind Bolas & Light (Ranged) & 1d4\fn{3} & \mult2 & Bludgeoning & 5 gp & 2 lb. & Thrown (10 ft.) \\
\tind Net & Medium (Ranged) & \x & 10 ft. &  & 20 gp & \x & 6 lb. \\
Unarmed weapons &&&&&&&\\
\end{tabularx}
...
\begin{dtable!*}
    ...
    \begin{tabularx}{\textwidth}{l c c c c >{\lcol}X}
        \thead{Natural Weapons} & \thead{Encumbrance} & \thead{Dmg} & \thead{Critical} & \thead{Type\footnotetemp{2}} & \thead{Special} \\
        Bite & Medium & 1d8 & \mult2 & \x & Piercing and bludgeoning  & \x \\
        Claw & Light & 1d6 & \mult2 & \x & Slashing and piercing & \x \\
        Constrict\fn{2} & Heavy & 1d10 & \mult2 & \x & Bludgeoning & \x \\
        Gore & Heavy & 1d8 & \mult2 & \x & Piercing & \x \\
        Slam & Medium & 1d8 & \mult2 & \x & Bludgeoning & \x \\
        Unarmed Strike & Light & 1d3\fn{3} & \mult2 & \x & Bludgeoning & Unarmed \\
    \end{tabularx}
...
\parhead{Ammunition} This weapon is designed to be fired by a projectile weapon. It is treated as an improvised weapon if used to attack otherwise.
...
\parhead{Disarming} You can use this weapon to make disarm attacks. You gain a \plus2 bonus on such attacks, and can apply magical bonuses from the weapon to the attack.
\parhead{Double} This weapon has more than one striking surface, and you can attack with both simultaneously. See \pcref{Double Weapons}.
\parhead{Finesse} You apply your Dexterity instead of your Strength to physical attacks with this weapon, even if it isn't a light weapon for you. You can't wield a finesse weapon in two hands.
\parhead{Impact} You can use this weapon to make shove attacks to push people away from you. You gain a \plus2 bonus on such attacks, and can apply magical bonuses from the weapon to the attack.
...
\parhead{Projectile} This weapon fires projectiles. Projectile weapons have a range increment listed in their description, which indicates the distance they can be easily fired at. See \pcref{Ranged Weapons}.
...
\parhead{Unarmed} Unless you have the Improved Unarmed Strike feat (see \pref{Improved Unarmed Strike}), you can't take attacks of opportunity or defend yourself with this weapon, which makes you defenseless. See \pcref{Attacks of Opportunity}.
...
\par You can fire a crossbow from a prone position without penalty.
\parhead{Dagger} Daggers, including punching daggers, are unusually small, and are considered one size category smaller than normal for a light weapon (that is, three size categories smaller than the creature it is intended for). This typically grants a \plus2 bonus on Sleight of Hand checks to conceal the dagger. A dagger can be used as a light weapon by a creature one size smaller than the dagger is designed for.
...
\parhead{Longbow} You need at least two hands to fire a bow, regardless of its size. One hand is free when not firing the bow. A longbow is too unwieldy to use while you are mounted. If you have a penalty for low Strength, apply it to damage rolls when you use a longbow. If you have a bonus for high Strength, you can apply it to damage rolls when you use a composite longbow (see below) but not a regular longbow.
\parhead{Longbow, Composite} You need at least two hands to fire a bow, regardless of its size. One hand is free when not firing the bow. You can use a composite longbow while mounted. All composite bows are made with a particular strength rating (that is, each requires a minimum Strength to use with proficiency). If your Strength bonus is less than the strength rating of the composite bow, you can't effectively use it, so you take a \minus4 penalty to attacks with it. The default composite longbow requires a Strength of at least 0. A composite longbow's Strength rating is the maximum Strength you can use when calculating damage. Each point of Strength bonus granted by the bow adds 25 gp to its cost.
...
\parhead{Net} A net is used to entangle enemies. When you throw a net, you make a ranged touch attack against your target. A net's maximum range is 10 feet. If you hit, the target is entangled. An entangled creature moves at half speed, cannot run or charge, and takes a \minus2 penalty to physical attacks and defenses, as well as Strength and Dexterity-based checks. If you control the trailing rope by succeeding on an opposed Strength check while holding it, the entangled creature can move only within the limits that the rope allows. If the entangled creature attempts to cast a spell, it must make a DC 15 \add double spell level Concentration check or be unable to cast the spell.
...
\parhead{Shortbow, Composite} You need at least two hands to use a bow, regardless of its size. You can use a composite shortbow while mounted. All composite bows are made with a particular strength rating (that is, each requires a minimum Strength to use with proficiency). If your Strength bonus is less than the strength rating of the composite bow, you can't effectively use it, so you take a \minus4 penalty to attacks with it. The default composite shortbow requires a Strength of at least 0. A composite longbow's Strength rating is the maximum Strength you can use when calculating damage. Each point of Strength bonus granted by the bow adds 25 gp to its cost.
