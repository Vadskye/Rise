...
\parhead{Dexterity Bonus} This indicates the multiplier that your character applies to his or her Dexterity bonus. Medium and heavy armor limits mobility and agility, halving the character's Dexterity and Dexterity value. This halving is applied in addition to the armor's armor check penalty (if any). A Dexterity penalty is not halved.
...
\subparhead{Shields} Most shields do not affect a character's Dexterity. However, a tower shield halves a character's Dexterity bonus. This is not cumulative with the halving from wearing medium or heavy armor.
