...
\begin{dtable!*}
    ...
    \begin{tabularx}{\textwidth}{l c c c c >{\lcol}X}
        \thead{Natural Weapons} & \thead{Encumbrance} & \thead{Dmg} & \thead{Critical} & \thead{Range Increment} & \thead{Type\footnotetemp{2}} \\
        ...
        Unarmed Strike & Light & 1d3\fn{1} & \mult2 & \x & Bludgeoning \\
    \end{tabularx}
    1 This attack deals nonlethal damage.
\end{dtable!*}
